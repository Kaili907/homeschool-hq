# Reteach and varied practice: energy as a system-level account

**High School Physics (Grade 11)** · Unit 5: Energy: Modelling, Accounting, and Conservation · Day 8 of the unit (course day 56) · about 55–75 minutes

**Today's focus:** energy as a system-level account
...
- Explain energy as a system-level account using evidence, a model, or a documented process rather than an unsupported answer.
- Apply energy as a system-level account to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on energy as a system-level account against the stated success criteria and name the next step.
...
- Science brief: energy is conserved: the total energy of a closed system is constant, and energy transfers or transforms rather than being created or destroyed.
- Science brief: an energy account requires a defined system and boundary, since what counts as a transfer depends on where the boundary lies.
- Science brief: energy changes form within the system and is transferred across the boundary by work, by heating, or by radiation.
- Science brief: an account that does not balance indicates an unidentified transfer, not a failure of conservation.

### Evidence check: energy as a system-level account

**Candidate claim:** A case report presents this as acceptable science: “presenting an energy account in which energy is created or destroyed.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: energy is conserved: the total energy of a closed system is constant, and energy transfers or transforms rather than being created or destroyed. |
| E2 | established science reference | Science brief: an energy account requires a defined system and boundary, since what counts as a transfer depends on where the boundary lies. |
| E3 | established science reference | Science brief: energy changes form within the system and is transferred across the boundary by work, by heating, or by radiation. |
| E4 | established science reference | Science brief: an account that does not balance indicates an unidentified transfer, not a failure of conservation. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs11-physics-u05::energy as a system-level account, derived from the reviewed correctness source policy/correctness/ma-hs11-physics.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about energy as a system-level account, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about energy as a system-level account, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about energy as a system-level account, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain energy as a system-level account in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for energy as a system-level account. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about energy as a system-level account, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using energy as a system-level account as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about energy as a system-level account? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about energy as a system-level account that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about energy as a system-level account. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about energy as a system-level account.
...
- Apply energy as a system-level account under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect energy as a system-level account to kinetic and potential energy from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs11-physics-u05-l08` · lesson `ma-hs11-physics-u05-l08` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
