# Independent application A: mass versus weight

**High School Physics (Grade 11)** · Unit 2: Forces and Newton's Second Law · Day 4 of the unit (course day 16) · about 55–75 minutes

**Today's focus:** mass versus weight
...
- Explain mass versus weight using evidence, a model, or a documented process rather than an unsupported answer.
- Apply mass versus weight to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on mass versus weight against the stated success criteria and name the next step.
...
- Science brief: mass is a property of the object and does not change with location; weight is the gravitational force on it and does.
- Science brief: mass measures how strongly an object resists a change in motion and is measured in kilograms.
- Science brief: weight is a force, measured in newtons, equal to mass times the local gravitational field strength.
- Science brief: an object in free fall or in orbit still has weight; what it lacks is a supporting normal force, which is why it feels weightless.

### Evidence check: mass versus weight

**Candidate claim:** A case report presents this as acceptable science: “treating mass and weight as the same quantity or reporting one in the other's units.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: mass is a property of the object and does not change with location; weight is the gravitational force on it and does. |
| E2 | established science reference | Science brief: mass measures how strongly an object resists a change in motion and is measured in kilograms. |
| E3 | established science reference | Science brief: weight is a force, measured in newtons, equal to mass times the local gravitational field strength. |
| E4 | established science reference | Science brief: an object in free fall or in orbit still has weight; what it lacks is a supporting normal force, which is why it feels weightless. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs11-physics-u02::mass versus weight, derived from the reviewed correctness source policy/correctness/ma-hs11-physics.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about mass versus weight, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about mass versus weight, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about mass versus weight, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain mass versus weight in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for mass versus weight. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about mass versus weight, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using mass versus weight as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about mass versus weight? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about mass versus weight that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about mass versus weight. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about mass versus weight.
...
- Apply mass versus weight under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect mass versus weight to free-body diagrams from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs11-physics-u02-l04` · lesson `ma-hs11-physics-u02-l04` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
