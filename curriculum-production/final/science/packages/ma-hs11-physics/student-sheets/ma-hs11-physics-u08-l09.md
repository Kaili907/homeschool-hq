# Performance task build: waves in different media

**High School Physics (Grade 11)** · Unit 8: Waves and Their Mathematics · Day 9 of the unit (course day 93) · about 61–84 minutes

**Today's focus:** waves in different media
...
- Produce performance-task evidence for waves in different media that a reader could check independently.
- Explain waves in different media using evidence, a model, or a documented process rather than an unsupported answer.
- Apply waves in different media to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on waves in different media against the stated success criteria and name the next step.
...
- Science brief: mechanical waves require a medium; electromagnetic waves do not.
- Science brief: sound travels faster in solids than in liquids and faster in liquids than in gases.
- Science brief: the speed of a mechanical wave is set by properties of the medium, principally its stiffness and its density.
- Science brief: light slows on entering a denser transparent medium and returns to its vacuum speed on leaving.

### Evidence check: waves in different media

**Candidate claim:** A case report presents this as acceptable science: “sound travels faster in air than in water or steel.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: mechanical waves require a medium; electromagnetic waves do not. |
| E2 | established science reference | Science brief: sound travels faster in solids than in liquids and faster in liquids than in gases. |
| E3 | established science reference | Science brief: the speed of a mechanical wave is set by properties of the medium, principally its stiffness and its density. |
| E4 | established science reference | Science brief: light slows on entering a denser transparent medium and returns to its vacuum speed on leaving. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs11-physics-u08::waves in different media, derived from the reviewed correctness source policy/correctness/ma-hs11-physics.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about waves in different media, and does it support the candidate claim?
...
**My question.** Write the question you are testing about waves in different media. It has to be a question your evidence could actually answer.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about waves in different media, then name one check that would catch an error or a weak claim.**
...
**Q1.** Build a checkable contribution to the supplied unit performance task — Use mathematical representations to support a claim about frequency, wavelength, and speed in different media, and evaluate when a wave model or a particle model of light serves better. — using the case and E1-E4. Include claim, evidence, reasoning, limitation, and a recorded revision.

>

**Q2.** Explain waves in different media in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for waves in different media. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about waves in different media, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using waves in different media as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E4 is strongest for evaluating the candidate claim about waves in different media? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E4, state one conclusion about waves in different media that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about waves in different media. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about waves in different media.
...
- Apply waves in different media under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect waves in different media to wave properties and terminology from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs11-physics-u08-l09` · lesson `ma-hs11-physics-u08-l09` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
