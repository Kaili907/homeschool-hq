# Independent application A: field models of interaction at a distance

**High School Physics (Grade 11)** · Unit 7: Fields, Electromagnetism, and Induction · Day 4 of the unit (course day 76) · about 55–75 minutes

**Today's focus:** field models of interaction at a distance
...
- Explain field models of interaction at a distance using evidence, a model, or a documented process rather than an unsupported answer.
- Apply field models of interaction at a distance to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on field models of interaction at a distance against the stated success criteria and name the next step.
...
- Science brief: the field model replaces action at a distance with a local interaction: the source establishes a field, and the field acts on whatever is present at a point.
- Science brief: changes in a field propagate at finite speed, not instantaneously.
- Science brief: the field model applies to gravitational, electric, and magnetic interactions, with important differences in sign and in what responds.

### Evidence check: field models of interaction at a distance

**Candidate claim:** A case report presents this as acceptable science: “field changes propagate instantaneously across any distance.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: the field model replaces action at a distance with a local interaction: the source establishes a field, and the field acts on whatever is present at a point. |
| E2 | established science reference | Science brief: changes in a field propagate at finite speed, not instantaneously. |
| E3 | established science reference | Science brief: the field model applies to gravitational, electric, and magnetic interactions, with important differences in sign and in what responds. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs11-physics-u07::field models of interaction at a distance, derived from the reviewed correctness source policy/correctness/ma-hs11-physics.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about field models of interaction at a distance, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about field models of interaction at a distance, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about field models of interaction at a distance, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain field models of interaction at a distance in your own words using at least two specifically named rows from E1-E3. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for field models of interaction at a distance. Decide whether E1-E3 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about field models of interaction at a distance, revise its weakest claim with a named row from E1-E3, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using field models of interaction at a distance as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about field models of interaction at a distance? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about field models of interaction at a distance that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about field models of interaction at a distance. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about field models of interaction at a distance.
...
- Apply field models of interaction at a distance under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect field models of interaction at a distance to electric and magnetic fields from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs11-physics-u07-l04` · lesson `ma-hs11-physics-u07-l04` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
