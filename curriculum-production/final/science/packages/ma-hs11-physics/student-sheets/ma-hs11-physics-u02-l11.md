# Unit assessment: friction and normal forces

**High School Physics (Grade 11)** · Unit 2: Forces and Newton's Second Law · Day 11 of the unit (course day 23) · about 55–75 minutes

**Today's focus:** friction and normal forces
...
- Explain friction and normal forces using evidence, a model, or a documented process rather than an unsupported answer.
- Apply friction and normal forces to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on friction and normal forces against the stated success criteria and name the next step.
...
- Science brief: the normal force is perpendicular to the contact surface and is not always equal to the object's weight.
- Science brief: friction acts parallel to the contact surface and opposes relative sliding or the tendency to slide.
- Science brief: frictional force depends on the normal force and on the surfaces, and to a good approximation not on the contact area.
- Science brief: static friction adjusts up to a maximum to prevent sliding; kinetic friction acts once sliding has begun and is generally smaller.

### Evidence check: friction and normal forces

**Candidate claim:** A case report presents this as acceptable science: “the normal force always equals the object's weight, including on an incline or when another vertical force acts.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: the normal force is perpendicular to the contact surface and is not always equal to the object's weight. |
| E2 | established science reference | Science brief: friction acts parallel to the contact surface and opposes relative sliding or the tendency to slide. |
| E3 | established science reference | Science brief: frictional force depends on the normal force and on the surfaces, and to a good approximation not on the contact area. |
| E4 | established science reference | Science brief: static friction adjusts up to a maximum to prevent sliding; kinetic friction acts once sliding has begun and is generally smaller. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs11-physics-u02::friction and normal forces, derived from the reviewed correctness source policy/correctness/ma-hs11-physics.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about friction and normal forces, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about friction and normal forces, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about friction and normal forces, then name one check that would catch an error or a weak claim.**
...
**Q1.** Without copying a sentence from the brief, evaluate the printed candidate case about friction and normal forces. Cite E1-E4, write the reasoning in your own words, and correct the case claim so it fits exactly what the record establishes.

>

**Q2.** Explain friction and normal forces in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for friction and normal forces. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about friction and normal forces, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using friction and normal forces as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E4 is strongest for evaluating the candidate claim about friction and normal forces? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E4, state one conclusion about friction and normal forces that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about friction and normal forces. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about friction and normal forces.
...
- Apply friction and normal forces under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect friction and normal forces to free-body diagrams from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs11-physics-u02-l11` · lesson `ma-hs11-physics-u02-l11` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
