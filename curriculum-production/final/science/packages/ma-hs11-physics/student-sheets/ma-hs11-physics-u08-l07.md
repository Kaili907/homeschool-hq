# Investigation: wave properties and terminology

**High School Physics (Grade 11)** · Unit 8: Waves and Their Mathematics · Day 7 of the unit (course day 91) · about 61–84 minutes

**Today's focus:** wave properties and terminology
...
- Plan and carry out a safe investigation of wave properties and terminology, or its stated alternative, and record the learner's own data with its uncertainty.
- Explain wave properties and terminology using evidence, a model, or a documented process rather than an unsupported answer.
- Apply wave properties and terminology to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on wave properties and terminology against the stated success criteria and name the next step.
...
- **Physical hazard.** A stretched spring released under tension snaps back hard and can injure eyes.
  - What stops it: Everyone wears eye protection whenever the spring is under tension. Two people hold the ends, never stretch beyond about twice the resting length, never let go while stretched, and release slowly together.
- **Physical hazard.** Bright light sources can damage vision.
  - What stops it: Use a flashlight or LED only. NO LASER of any kind is used in this unit. Never look directly into any light source or point one at another person.
- **Physical hazard.** A snapped or scored CD throws sharp shards.
  - What stops it: Use an intact CD or a sheet diffraction grating. Never cut, score, or snap a disc.
...
**Clearing up.** Coil the spring or rope loosely and put it away, empty the water tray down the drain and dry it, and return the CD or grating to its sleeve. Nothing hazardous is produced.
...
- Science brief: a wave transfers energy without net transport of the medium.
- Science brief: amplitude is maximum displacement from equilibrium; wavelength is the distance between matching points on successive cycles; frequency is cycles per second; period is the time for one cycle.
- Science brief: particles of a medium oscillate about fixed positions while the wave and its energy travel through.
- Science brief: frequency and period are reciprocals of one another.

### Evidence check: wave properties and terminology

**Candidate claim:** A case report presents this as acceptable science: “a wave carries the medium along with it.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a wave transfers energy without net transport of the medium. |
| E2 | established science reference | Science brief: amplitude is maximum displacement from equilibrium; wavelength is the distance between matching points on successive cycles; frequency is cycles per second; period is the time for one cycle. |
| E3 | established science reference | Science brief: particles of a medium oscillate about fixed positions while the wave and its energy travel through. |
| E4 | established science reference | Science brief: frequency and period are reciprocals of one another. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs11-physics-u08::wave properties and terminology, derived from the reviewed correctness source policy/correctness/ma-hs11-physics.correctness.json.

**Supplied unit connections:** wave properties and terminology; the frequency-wavelength-speed relationship; waves in different media; reflection, refraction, and diffraction; wave and particle models of light; evaluating competing models

**Supplied unit performance task:** Use mathematical representations to support a claim about frequency, wavelength, and speed in different media, and evaluate when a wave model or a particle model of light serves better.

### Bound task

**Question:** What does evidence E1 through E4 justify about wave properties and terminology, and does it support the candidate claim?
...
**Model/source rule:** Ideal thin lens: 1/f=1/do+1/di and magnification=-di/do. Negative image distance denotes a virtual image.
...
3. Verify image distance and magnification, draw principal rays for two cases, and distinguish real from virtual images using both calculation and diagram.
...
**Pinned H4 alternative statement (lineage evidence):** Measure wave speed on a rope on the floor - no tension, no recoil - and observe diffraction with a CD held under a household lamp. Or work from published wave-speed tables and a supplied refraction diagram. No spring, no bright source.
...
**My question.** Write the question you are testing about wave properties and terminology. It has to be a question your evidence could actually answer.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about wave properties and terminology, then name one check that would catch an error or a weak claim.**
...
**Q1.** Complete the route you chose. For the document/model route, use its printed procedure and input table; for the H4 physical route, use the printed safe order and your own blank record. Report the route, evidence IDs or model rows, conclusion about wave properties and terminology, uncertainty, and limitation.

>

**Q2.** Explain wave properties and terminology in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for wave properties and terminology. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about wave properties and terminology, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using wave properties and terminology as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E4 is strongest for evaluating the candidate claim about wave properties and terminology? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E4, state one conclusion about wave properties and terminology that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about wave properties and terminology. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about wave properties and terminology.
...
- Apply wave properties and terminology under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect wave properties and terminology to the frequency-wavelength-speed relationship from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Use mathematical representations to support a claim about frequency, wavelength, and speed in different media, and evaluate when a wave model or a particle model of light serves better. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-hs11-physics-u08-l07` · lesson `ma-hs11-physics-u08-l07` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
