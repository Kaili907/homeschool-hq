# Unit assessment: wave and particle models of light

**High School Physics (Grade 11)** · Unit 8: Waves and Their Mathematics · Day 11 of the unit (course day 95) · about 55–75 minutes

**Today's focus:** wave and particle models of light
...
- Demonstrate independent mastery evidence for wave and particle models of light on a fresh task.
- Explain wave and particle models of light using evidence, a model, or a documented process rather than an unsupported answer.
- Apply wave and particle models of light to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on wave and particle models of light against the stated success criteria and name the next step.
...
- Science brief: light shows wave behaviour such as diffraction and interference, and particle behaviour such as the photoelectric effect; neither model alone accounts for all observations.
- Science brief: the wave model explains interference, diffraction, and refraction; the particle model explains the photoelectric effect and the discreteness of light emission and absorption.
- Science brief: which model applies depends on the experiment; the two are not competing claims about which is really true.
- Science brief: photon energy increases with frequency, which is why the effect of light on matter depends on frequency rather than on brightness alone.

### Evidence check: wave and particle models of light

**Candidate claim:** A case report presents this as acceptable science: “one of the two models has been shown to be the correct one and the other abandoned.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: light shows wave behaviour such as diffraction and interference, and particle behaviour such as the photoelectric effect; neither model alone accounts for all observations. |
| E2 | established science reference | Science brief: the wave model explains interference, diffraction, and refraction; the particle model explains the photoelectric effect and the discreteness of light emission and absorption. |
| E3 | established science reference | Science brief: which model applies depends on the experiment; the two are not competing claims about which is really true. |
| E4 | established science reference | Science brief: photon energy increases with frequency, which is why the effect of light on matter depends on frequency rather than on brightness alone. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs11-physics-u08::wave and particle models of light, derived from the reviewed correctness source policy/correctness/ma-hs11-physics.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about wave and particle models of light, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about wave and particle models of light, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about wave and particle models of light, then name one check that would catch an error or a weak claim.**
...
**Q1.** Without copying a sentence from the brief, evaluate the printed candidate case about wave and particle models of light. Cite E1-E4, write the reasoning in your own words, and correct the case claim so it fits exactly what the record establishes.

>

**Q2.** Explain wave and particle models of light in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for wave and particle models of light. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about wave and particle models of light, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using wave and particle models of light as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E4 is strongest for evaluating the candidate claim about wave and particle models of light? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E4, state one conclusion about wave and particle models of light that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about wave and particle models of light. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about wave and particle models of light.
...
- Apply wave and particle models of light under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect wave and particle models of light to wave properties and terminology from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs11-physics-u08-l11` · lesson `ma-hs11-physics-u08-l11` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
