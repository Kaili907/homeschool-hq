# Unit assessment: energy changes in field interactions

**High School Physics (Grade 11)** · Unit 7: Fields, Electromagnetism, and Induction · Day 11 of the unit (course day 83) · about 55–75 minutes

**Today's focus:** energy changes in field interactions
...
- Demonstrate independent mastery evidence for energy changes in field interactions on a fresh task.
- Explain energy changes in field interactions using evidence, a model, or a documented process rather than an unsupported answer.
- Apply energy changes in field interactions to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on energy changes in field interactions against the stated success criteria and name the next step.
...
- Science brief: work is done when a charge or a mass moves through a field along the direction of the force, and energy is transferred as a result.
- Science brief: moving a charge or mass against the field force increases the system's potential energy; moving with it decreases it.
- Science brief: energy is conserved throughout: a generator supplies electrical energy only because mechanical work is supplied to it.

### Evidence check: energy changes in field interactions

**Candidate claim:** A case report presents this as acceptable science: “a generator or an induction device produces energy.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: work is done when a charge or a mass moves through a field along the direction of the force, and energy is transferred as a result. |
| E2 | established science reference | Science brief: moving a charge or mass against the field force increases the system's potential energy; moving with it decreases it. |
| E3 | established science reference | Science brief: energy is conserved throughout: a generator supplies electrical energy only because mechanical work is supplied to it. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs11-physics-u07::energy changes in field interactions, derived from the reviewed correctness source policy/correctness/ma-hs11-physics.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about energy changes in field interactions, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about energy changes in field interactions, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about energy changes in field interactions, then name one check that would catch an error or a weak claim.**
...
**Q1.** Without copying a sentence from the brief, evaluate the printed candidate case about energy changes in field interactions. Cite E1-E3, write the reasoning in your own words, and correct the case claim so it fits exactly what the record establishes.

>

**Q2.** Explain energy changes in field interactions in your own words using at least two specifically named rows from E1-E3. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for energy changes in field interactions. Decide whether E1-E3 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about energy changes in field interactions, revise its weakest claim with a named row from E1-E3, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using energy changes in field interactions as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E3 is strongest for evaluating the candidate claim about energy changes in field interactions? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E3, state one conclusion about energy changes in field interactions that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about energy changes in field interactions. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about energy changes in field interactions.
...
- Apply energy changes in field interactions under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect energy changes in field interactions to electric and magnetic fields from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs11-physics-u07-l11` · lesson `ma-hs11-physics-u07-l11` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
