# Concept model A: current and magnetic field production

**High School Physics (Grade 11)** · Unit 7: Fields, Electromagnetism, and Induction · Day 2 of the unit (course day 74) · about 55–75 minutes
...
_Package `swp-ma-hs11-physics-u07-l02` · lesson `ma-hs11-physics-u07-l02` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
