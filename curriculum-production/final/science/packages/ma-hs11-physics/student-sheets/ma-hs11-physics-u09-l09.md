# Performance task build: digital versus analog information

**High School Physics (Grade 11)** · Unit 9: Electromagnetic Radiation, Information, and a Physics Engineering Capstone · Day 9 of the unit (course day 105) · about 61–84 minutes

**Today's focus:** digital versus analog information
...
- Produce performance-task evidence for digital versus analog information that a reader could check independently.
- Explain digital versus analog information using evidence, a model, or a documented process rather than an unsupported answer.
- Apply digital versus analog information to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on digital versus analog information against the stated success criteria and name the next step.

**Materials:**

- small radio or phone
- aluminium foil
- cardboard boxes
...
- published claim article about radiation
- notebook
...
- **Physical hazard.** Building a device involves cutting and small parts.
  - What stops it: An adult performs all cutting with sharp tools, the learner uses blunt scissors or pre-cut parts, and small parts stay away from young children.
- **Physical hazard.** Aluminium foil laid across both terminals of a cell is a short circuit and a standard ignition demonstration.
  - What stops it: Foil is used for shielding only and never touches both terminals of any cell. The shielding strand runs first and uses no electricity at all.
- **Physical hazard.** Battery-powered builds can short and heat, and a stalled motor draws its full stall current.
  - What stops it: Single 1.5 V cells only - never mains electricity, never a lithium or button cell. Tape the terminals before and after use, disconnect between tests, disconnect immediately if a motor stalls or will not turn, and stop if anything warms.
- **Online hazard.** Evaluating published radiation claims means reading sources of uncertain quality.
  - What stops it: An adult approves each source in advance. No account creation, sign-in, purchase, or personal information is required, and the learner never contacts a site owner.
...
**Clearing up.** Disconnect and remove the cell and tape its terminals; used cells go to household battery recycling in a labelled container, never the general bin. Sweep up off-cuts and small parts and bin them away from young children. Recycle the foil and cardboard. Nothing is left connected or stored with a cell in it.
...
- Science brief: digital signals encode information in discrete values; analog signals vary continuously.
- Science brief: noise added to an analog signal becomes part of it, while a digital signal can be restored by rounding each value to the nearest allowed level.
- Science brief: that restorability is why digital signals survive repeated transmission and copying far better than analog ones.
- Science brief: digitising a continuous signal involves sampling and rounding, so it loses some information; how much depends on the sampling and the levels used.

### Evidence check: digital versus analog information

**Candidate claim:** A case report presents this as acceptable science: “digital signals are unaffected by noise or loss.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: digital signals encode information in discrete values; analog signals vary continuously. |
| E2 | established science reference | Science brief: noise added to an analog signal becomes part of it, while a digital signal can be restored by rounding each value to the nearest allowed level. |
| E3 | established science reference | Science brief: that restorability is why digital signals survive repeated transmission and copying far better than analog ones. |
| E4 | established science reference | Science brief: digitising a continuous signal involves sampling and rounding, so it loses some information; how much depends on the sampling and the levels used. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs11-physics-u09::digital versus analog information, derived from the reviewed correctness source policy/correctness/ma-hs11-physics.correctness.json.

**Supplied unit connections:** the electromagnetic spectrum; absorption of radiation by matter; digital versus analog information; evaluating published claims about radiation; wave-based technologies; energy conversion device design

**Supplied unit performance task:** Complete a physics engineering capstone: design, build, and refine a device that converts one form of energy into another or transmits information, and communicate how wave principles and evidence justify the design.

### Bound task

**Question:** What does evidence E1 through E4 justify about digital versus analog information, and does it support the candidate claim?
...
**Model/source rule:** Efficiency=useful output/input; useful power=useful output/time. Material score is an independent design constraint where 5 is best.
...
3. Calculate efficiency and power, choose a design under two stated criteria, and defend the trade-off without claiming any design creates energy.
...
**Pinned H4 alternative statement (lineage evidence):** Run the shielding test with a radio and household materials only - no build - and complete the capstone as a documented paper design with a modelled energy budget rather than a physical device.
...
**My question.** Write the question you are testing about digital versus analog information. It has to be a question your evidence could actually answer.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about digital versus analog information, then name one check that would catch an error or a weak claim.**
...
**Q1.** Build a checkable contribution to the supplied unit performance task — Complete a physics engineering capstone: design, build, and refine a device that converts one form of energy into another or transmits information, and communicate how wave principles and evidence justify the design. — using the case and E1-E4. Include claim, evidence, reasoning, limitation, and a recorded revision.

>

**Q2.** Explain digital versus analog information in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for digital versus analog information. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about digital versus analog information, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using digital versus analog information as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E4 is strongest for evaluating the candidate claim about digital versus analog information? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E4, state one conclusion about digital versus analog information that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about digital versus analog information. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about digital versus analog information.
...
- Apply digital versus analog information under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect digital versus analog information to the electromagnetic spectrum from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Complete a physics engineering capstone: design, build, and refine a device that converts one form of energy into another or transmits information, and communicate how wave principles and evidence justify the design. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-hs11-physics-u09-l09` · lesson `ma-hs11-physics-u09-l09` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
