# Independent application A: specific heat capacity

**High School Physics (Grade 11)** · Unit 6: Thermal Energy and the Second Law · Day 4 of the unit (course day 64) · about 55–75 minutes

**Today's focus:** specific heat capacity
...
- Explain specific heat capacity using evidence, a model, or a documented process rather than an unsupported answer.
- Apply specific heat capacity to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on specific heat capacity against the stated success criteria and name the next step.
...
- Science brief: specific heat capacity is the energy required to raise the temperature of one kilogram of a substance by one kelvin, and it differs between substances.
- Science brief: for the same energy input and the same mass, a substance with higher specific heat capacity shows a smaller temperature rise.
- Science brief: water has an unusually high specific heat capacity, which is why large bodies of water moderate nearby climates.
- Science brief: the energy transferred is the product of mass, specific heat capacity, and temperature change.

### Evidence check: specific heat capacity

**Candidate claim:** A case report presents this as acceptable science: “equal energy input produces equal temperature change regardless of substance or mass.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: specific heat capacity is the energy required to raise the temperature of one kilogram of a substance by one kelvin, and it differs between substances. |
| E2 | established science reference | Science brief: for the same energy input and the same mass, a substance with higher specific heat capacity shows a smaller temperature rise. |
| E3 | established science reference | Science brief: water has an unusually high specific heat capacity, which is why large bodies of water moderate nearby climates. |
| E4 | established science reference | Science brief: the energy transferred is the product of mass, specific heat capacity, and temperature change. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs11-physics-u06::specific heat capacity, derived from the reviewed correctness source policy/correctness/ma-hs11-physics.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about specific heat capacity, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about specific heat capacity, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about specific heat capacity, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain specific heat capacity in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for specific heat capacity. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about specific heat capacity, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using specific heat capacity as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about specific heat capacity? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about specific heat capacity that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about specific heat capacity. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about specific heat capacity.
...
- Apply specific heat capacity under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect specific heat capacity to temperature versus thermal energy from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs11-physics-u06-l04` · lesson `ma-hs11-physics-u06-l04` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
