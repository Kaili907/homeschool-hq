# Independent application A: evaluating published claims about radiation

**High School Physics (Grade 11)** · Unit 9: Electromagnetic Radiation, Information, and a Physics Engineering Capstone · Day 4 of the unit (course day 100) · about 55–75 minutes

**Today's focus:** evaluating published claims about radiation
...
- Explain evaluating published claims about radiation using evidence, a model, or a documented process rather than an unsupported answer.
- Apply evaluating published claims about radiation to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on evaluating published claims about radiation against the stated success criteria and name the next step.
...
- Science brief: the distinction between ionising and non-ionising radiation is set by photon energy, which depends on frequency, not by the power of the source.
- Science brief: evaluating a claim about radiation means identifying which part of the spectrum is involved, at what intensity, and over what exposure.
- Science brief: a claim's strength depends on the study design and on whether independent work agrees, not on the confidence of the presentation.
- Science brief: the word radiation covers everything from radio waves to gamma rays, so a claim about radiation that does not specify which is not evaluable.

### Evidence check: evaluating published claims about radiation

**Candidate claim:** A case report presents this as acceptable science: “treating all radiation as equivalent in its effects on matter or on people.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: the distinction between ionising and non-ionising radiation is set by photon energy, which depends on frequency, not by the power of the source. |
| E2 | established science reference | Science brief: evaluating a claim about radiation means identifying which part of the spectrum is involved, at what intensity, and over what exposure. |
| E3 | established science reference | Science brief: a claim's strength depends on the study design and on whether independent work agrees, not on the confidence of the presentation. |
| E4 | established science reference | Science brief: the word radiation covers everything from radio waves to gamma rays, so a claim about radiation that does not specify which is not evaluable. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs11-physics-u09::evaluating published claims about radiation, derived from the reviewed correctness source policy/correctness/ma-hs11-physics.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about evaluating published claims about radiation, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about evaluating published claims about radiation, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about evaluating published claims about radiation, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain evaluating published claims about radiation in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for evaluating published claims about radiation. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about evaluating published claims about radiation, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using evaluating published claims about radiation as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about evaluating published claims about radiation? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about evaluating published claims about radiation that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about evaluating published claims about radiation. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about evaluating published claims about radiation.
...
- Apply evaluating published claims about radiation under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect evaluating published claims about radiation to the electromagnetic spectrum from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs11-physics-u09-l04` · lesson `ma-hs11-physics-u09-l04` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
