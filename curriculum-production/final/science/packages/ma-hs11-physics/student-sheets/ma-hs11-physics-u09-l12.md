# Correction and reflection: energy conversion device design

**High School Physics (Grade 11)** · Unit 9: Electromagnetic Radiation, Information, and a Physics Engineering Capstone · Day 12 of the unit (course day 108) · about 55–75 minutes

**Today's focus:** energy conversion device design
...
- Explain energy conversion device design using evidence, a model, or a documented process rather than an unsupported answer.
- Apply energy conversion device design to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on energy conversion device design against the stated success criteria and name the next step.
...
- Science brief: an energy conversion device is evaluated on measured input, measured useful output, and the difference between them.
- Science brief: no device converts all input to useful output, so an efficiency claim of one hundred per cent indicates a measurement or accounting error.
- Science brief: design improvements are tested one change at a time against the stated criteria.

### Evidence check: energy conversion device design

**Candidate claim:** A case report presents this as acceptable science: “a device produces more energy than it receives.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: an energy conversion device is evaluated on measured input, measured useful output, and the difference between them. |
| E2 | established science reference | Science brief: no device converts all input to useful output, so an efficiency claim of one hundred per cent indicates a measurement or accounting error. |
| E3 | established science reference | Science brief: design improvements are tested one change at a time against the stated criteria. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs11-physics-u09::energy conversion device design, derived from the reviewed correctness source policy/correctness/ma-hs11-physics.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about energy conversion device design, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about energy conversion device design, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about energy conversion device design, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain energy conversion device design in your own words using at least two specifically named rows from E1-E3. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for energy conversion device design. Decide whether E1-E3 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about energy conversion device design, revise its weakest claim with a named row from E1-E3, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using energy conversion device design as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about energy conversion device design? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about energy conversion device design that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about energy conversion device design. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about energy conversion device design.
...
- Apply energy conversion device design under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect energy conversion device design to the electromagnetic spectrum from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs11-physics-u09-l12` · lesson `ma-hs11-physics-u09-l12` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
