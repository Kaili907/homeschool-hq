# Correction and reflection: evaluating competing models

**High School Physics (Grade 11)** · Unit 8: Waves and Their Mathematics · Day 12 of the unit (course day 96) · about 55–75 minutes

**Today's focus:** evaluating competing models
...
- Explain evaluating competing models using evidence, a model, or a documented process rather than an unsupported answer.
- Apply evaluating competing models to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on evaluating competing models against the stated success criteria and name the next step.
...
- Science brief: competing models are evaluated on the range of observations each accounts for and on the predictions that distinguish them.
- Science brief: a decisive test is one where the models predict different outcomes, so an observation consistent with both settles nothing.
- Science brief: a model retained for a limited domain is not thereby wrong; its domain is part of the model.

### Evidence check: evaluating competing models

**Candidate claim:** A case report presents this as acceptable science: “selecting between models on evidence consistent with both.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: competing models are evaluated on the range of observations each accounts for and on the predictions that distinguish them. |
| E2 | established science reference | Science brief: a decisive test is one where the models predict different outcomes, so an observation consistent with both settles nothing. |
| E3 | established science reference | Science brief: a model retained for a limited domain is not thereby wrong; its domain is part of the model. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs11-physics-u08::evaluating competing models, derived from the reviewed correctness source policy/correctness/ma-hs11-physics.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about evaluating competing models, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about evaluating competing models, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about evaluating competing models, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain evaluating competing models in your own words using at least two specifically named rows from E1-E3. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for evaluating competing models. Decide whether E1-E3 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about evaluating competing models, revise its weakest claim with a named row from E1-E3, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using evaluating competing models as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about evaluating competing models? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about evaluating competing models that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about evaluating competing models. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about evaluating competing models.
...
- Apply evaluating competing models under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect evaluating competing models to wave properties and terminology from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs11-physics-u08-l12` · lesson `ma-hs11-physics-u08-l12` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
