# Launch and diagnostic: wave properties and terminology

**High School Physics (Grade 11)** · Unit 8: Waves and Their Mathematics · Day 1 of the unit (course day 85) · about 55–75 minutes
...
**The task.** What does evidence E1 through E4 justify about wave properties and terminology, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**Q1.** Use the printed case as today's phenomenon for wave properties and terminology. Record what the candidate claim says, identify the mismatch with E1-E4, and pose a testable question naming what would change and what would be measured or classified.
...
_Package `swp-ma-hs11-physics-u08-l01` · lesson `ma-hs11-physics-u08-l01` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
