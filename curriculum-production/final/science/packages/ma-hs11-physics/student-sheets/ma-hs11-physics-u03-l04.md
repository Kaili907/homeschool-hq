# Independent application A: elastic and inelastic collisions

**High School Physics (Grade 11)** · Unit 3: Momentum, Collisions, and Protective Design · Day 4 of the unit (course day 28) · about 55–75 minutes

**Today's focus:** elastic and inelastic collisions
...
- Explain elastic and inelastic collisions using evidence, a model, or a documented process rather than an unsupported answer.
- Apply elastic and inelastic collisions to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on elastic and inelastic collisions against the stated success criteria and name the next step.
...
- Science brief: momentum is conserved in all collisions; kinetic energy is conserved only in elastic ones.
- Science brief: in an elastic collision total kinetic energy is unchanged; in an inelastic collision some is transferred to deformation, sound, and thermal energy.
- Science brief: in a perfectly inelastic collision the objects move off together, and kinetic energy loss is at its maximum for that momentum.
- Science brief: real macroscopic collisions are never perfectly elastic, though some are close enough to model that way.

### Evidence check: elastic and inelastic collisions

**Candidate claim:** A case report presents this as acceptable science: “kinetic energy is conserved in every collision.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: momentum is conserved in all collisions; kinetic energy is conserved only in elastic ones. |
| E2 | established science reference | Science brief: in an elastic collision total kinetic energy is unchanged; in an inelastic collision some is transferred to deformation, sound, and thermal energy. |
| E3 | established science reference | Science brief: in a perfectly inelastic collision the objects move off together, and kinetic energy loss is at its maximum for that momentum. |
| E4 | established science reference | Science brief: real macroscopic collisions are never perfectly elastic, though some are close enough to model that way. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs11-physics-u03::elastic and inelastic collisions, derived from the reviewed correctness source policy/correctness/ma-hs11-physics.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about elastic and inelastic collisions, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about elastic and inelastic collisions, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about elastic and inelastic collisions, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain elastic and inelastic collisions in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for elastic and inelastic collisions. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about elastic and inelastic collisions, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using elastic and inelastic collisions as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about elastic and inelastic collisions? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about elastic and inelastic collisions that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about elastic and inelastic collisions. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about elastic and inelastic collisions.
...
- Apply elastic and inelastic collisions under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect elastic and inelastic collisions to momentum as mass times velocity from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs11-physics-u03-l04` · lesson `ma-hs11-physics-u03-l04` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
