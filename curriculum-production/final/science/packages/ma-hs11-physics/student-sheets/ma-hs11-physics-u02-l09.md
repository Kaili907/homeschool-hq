# Performance task build: Newton's second law as a mathematical relationship

**High School Physics (Grade 11)** · Unit 2: Forces and Newton's Second Law · Day 9 of the unit (course day 21) · about 61–84 minutes

**Today's focus:** Newton's second law as a mathematical relationship
...
- Produce performance-task evidence for Newton's second law as a mathematical relationship that a reader could check independently.
- Explain Newton's second law as a mathematical relationship using evidence, a model, or a documented process rather than an unsupported answer.
- Apply Newton's second law as a mathematical relationship to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on Newton's second law as a mathematical relationship against the stated success criteria and name the next step.

**Materials:**

- toy car or cart
- string
- pulley or smooth table edge
...
- **Physical hazard.** Falling weights can land on feet or break flooring.
  - What stops it: Keep the hanging mass under 200 g, place a cushion or towel below the drop zone, keep feet clear, and never stand under the hanging mass.
- **Physical hazard.** String under tension can snap back toward the face.
  - What stops it: Wear eye protection whenever the string is under tension, use light loads only, inspect the string along its whole length before each run, and stand to the side of the string line rather than in it.
...
**Clearing up.** Coil the string and put the weights back into a container out of reach of young children. Nothing hazardous is produced.
...
- Science brief: acceleration is proportional to net force and inversely proportional to mass, and it is in the direction of the net force.
- Science brief: for a given mass, doubling the net force doubles the acceleration; for a given net force, doubling the mass halves it.
- Science brief: the relationship applies to the net force, not to any single force acting on the object.
- Science brief: acceleration is always in the direction of the net force, whatever the direction of motion.

### Evidence check: Newton's second law as a mathematical relationship

**Candidate claim:** A case report presents this as acceptable science: “applying the relationship to one individual force rather than the net force.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: acceleration is proportional to net force and inversely proportional to mass, and it is in the direction of the net force. |
| E2 | established science reference | Science brief: for a given mass, doubling the net force doubles the acceleration; for a given net force, doubling the mass halves it. |
| E3 | established science reference | Science brief: the relationship applies to the net force, not to any single force acting on the object. |
| E4 | established science reference | Science brief: acceleration is always in the direction of the net force, whatever the direction of motion. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs11-physics-u02::Newton's second law as a mathematical relationship, derived from the reviewed correctness source policy/correctness/ma-hs11-physics.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about Newton's second law as a mathematical relationship, and does it support the candidate claim?
...
**My question.** Write the question you are testing about Newton's second law as a mathematical relationship. It has to be a question your evidence could actually answer.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about Newton's second law as a mathematical relationship, then name one check that would catch an error or a weak claim.**
...
**Q1.** Build a checkable contribution to the supplied unit performance task — Analyse your own data to support or challenge the claim that net force, mass, and acceleration follow Newton's second law, and account for the friction your model ignored. — using the case and E1-E4. Include claim, evidence, reasoning, limitation, and a recorded revision.

>

**Q2.** Explain Newton's second law as a mathematical relationship in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for Newton's second law as a mathematical relationship. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about Newton's second law as a mathematical relationship, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using Newton's second law as a mathematical relationship as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E4 is strongest for evaluating the candidate claim about Newton's second law as a mathematical relationship? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E4, state one conclusion about Newton's second law as a mathematical relationship that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about Newton's second law as a mathematical relationship. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about Newton's second law as a mathematical relationship.
...
- Apply Newton's second law as a mathematical relationship under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect Newton's second law as a mathematical relationship to free-body diagrams from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Analyse your own data to support or challenge the claim that net force, mass, and acceleration follow Newton's second law, and account for the friction your model ignored. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-hs11-physics-u02-l09` · lesson `ma-hs11-physics-u02-l09` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
