# Reteach and varied practice: velocity and acceleration

**High School Physics (Grade 11)** · Unit 1: Motion, Measurement, and Quantitative Reasoning · Day 8 of the unit (course day 8) · about 55–75 minutes

**Today's focus:** velocity and acceleration
...
- Explain velocity and acceleration using evidence, a model, or a documented process rather than an unsupported answer.
- Apply velocity and acceleration to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on velocity and acceleration against the stated success criteria and name the next step.
...
- Science brief: velocity is the rate of change of position; acceleration is the rate of change of velocity.
- Science brief: acceleration is non-zero whenever speed changes, direction changes, or both.
- Science brief: velocity is a vector: it has magnitude and direction, and speed is its magnitude.
- Science brief: an object moving at constant speed around a curve is accelerating, because its direction, and therefore its velocity, is changing.

### Evidence check: velocity and acceleration

**Candidate claim:** A case report presents this as acceptable science: “acceleration is always in the direction of motion.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: velocity is the rate of change of position; acceleration is the rate of change of velocity. |
| E2 | established science reference | Science brief: acceleration is non-zero whenever speed changes, direction changes, or both. |
| E3 | established science reference | Science brief: velocity is a vector: it has magnitude and direction, and speed is its magnitude. |
| E4 | established science reference | Science brief: an object moving at constant speed around a curve is accelerating, because its direction, and therefore its velocity, is changing. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs11-physics-u01::velocity and acceleration, derived from the reviewed correctness source policy/correctness/ma-hs11-physics.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about velocity and acceleration, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about velocity and acceleration, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about velocity and acceleration, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain velocity and acceleration in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for velocity and acceleration. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about velocity and acceleration, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using velocity and acceleration as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about velocity and acceleration? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about velocity and acceleration that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about velocity and acceleration. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about velocity and acceleration.
...
- Apply velocity and acceleration under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect velocity and acceleration to position, displacement, and reference frames from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs11-physics-u01-l08` · lesson `ma-hs11-physics-u01-l08` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
