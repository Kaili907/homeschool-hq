# Unit assessment: energy transfer and dissipation

**High School Physics (Grade 11)** · Unit 5: Energy: Modelling, Accounting, and Conservation · Day 11 of the unit (course day 59) · about 55–75 minutes

**Today's focus:** energy transfer and dissipation
...
- Demonstrate independent mastery evidence for energy transfer and dissipation on a fresh task.
- Explain energy transfer and dissipation using evidence, a model, or a documented process rather than an unsupported answer.
- Apply energy transfer and dissipation to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on energy transfer and dissipation against the stated success criteria and name the next step.
...
- Science brief: energy transferred to the surroundings as thermal energy is dispersed and becomes far harder to use for work.
- Science brief: dissipation reduces the useful energy available; it does not reduce the total energy.
- Science brief: every real transfer dissipates some energy, which is why no device is completely efficient.

### Evidence check: energy transfer and dissipation

**Candidate claim:** A case report presents this as acceptable science: “dissipated energy has been destroyed.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: energy transferred to the surroundings as thermal energy is dispersed and becomes far harder to use for work. |
| E2 | established science reference | Science brief: dissipation reduces the useful energy available; it does not reduce the total energy. |
| E3 | established science reference | Science brief: every real transfer dissipates some energy, which is why no device is completely efficient. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs11-physics-u05::energy transfer and dissipation, derived from the reviewed correctness source policy/correctness/ma-hs11-physics.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about energy transfer and dissipation, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about energy transfer and dissipation, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about energy transfer and dissipation, then name one check that would catch an error or a weak claim.**
...
**Q1.** Without copying a sentence from the brief, evaluate the printed candidate case about energy transfer and dissipation. Cite E1-E3, write the reasoning in your own words, and correct the case claim so it fits exactly what the record establishes.

>

**Q2.** Explain energy transfer and dissipation in your own words using at least two specifically named rows from E1-E3. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for energy transfer and dissipation. Decide whether E1-E3 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about energy transfer and dissipation, revise its weakest claim with a named row from E1-E3, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using energy transfer and dissipation as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E3 is strongest for evaluating the candidate claim about energy transfer and dissipation? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E3, state one conclusion about energy transfer and dissipation that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about energy transfer and dissipation. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about energy transfer and dissipation.
...
- Apply energy transfer and dissipation under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect energy transfer and dissipation to kinetic and potential energy from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs11-physics-u05-l11` · lesson `ma-hs11-physics-u05-l11` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
