# Performance task build: motion graphs and their slopes

**High School Physics (Grade 11)** · Unit 1: Motion, Measurement, and Quantitative Reasoning · Day 9 of the unit (course day 9) · about 61–84 minutes

**Today's focus:** motion graphs and their slopes
...
- Produce performance-task evidence for motion graphs and their slopes that a reader could check independently.
- Explain motion graphs and their slopes using evidence, a model, or a documented process rather than an unsupported answer.
- Apply motion graphs and their slopes to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on motion graphs and their slopes against the stated success criteria and name the next step.
...
- Science brief: on a position-time graph the slope is velocity; on a velocity-time graph the slope is acceleration and the area under the curve is displacement.
- Science brief: the slope of a position-time graph gives velocity, including its sign, which carries direction.
- Science brief: the slope of a velocity-time graph gives acceleration, and the area between the curve and the time axis gives displacement.
- Science brief: a graph represents the motion; it is not a picture of the path the object took through space.

### Evidence check: motion graphs and their slopes

**Candidate claim:** A case report presents this as acceptable science: “reading a position-time graph as a map of the object's path.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: on a position-time graph the slope is velocity; on a velocity-time graph the slope is acceleration and the area under the curve is displacement. |
| E2 | established science reference | Science brief: the slope of a position-time graph gives velocity, including its sign, which carries direction. |
| E3 | established science reference | Science brief: the slope of a velocity-time graph gives acceleration, and the area between the curve and the time axis gives displacement. |
| E4 | established science reference | Science brief: a graph represents the motion; it is not a picture of the path the object took through space. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs11-physics-u01::motion graphs and their slopes, derived from the reviewed correctness source policy/correctness/ma-hs11-physics.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about motion graphs and their slopes, and does it support the candidate claim?
...
**My question.** Write the question you are testing about motion graphs and their slopes. It has to be a question your evidence could actually answer.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about motion graphs and their slopes, then name one check that would catch an error or a weak claim.**
...
**Q1.** Build a checkable contribution to the supplied unit performance task — Measure a real accelerating motion, produce position, velocity, and acceleration representations from your own data, and report the acceleration with an honest uncertainty. — using the case and E1-E4. Include claim, evidence, reasoning, limitation, and a recorded revision.

>

**Q2.** Explain motion graphs and their slopes in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for motion graphs and their slopes. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about motion graphs and their slopes, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using motion graphs and their slopes as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E4 is strongest for evaluating the candidate claim about motion graphs and their slopes? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E4, state one conclusion about motion graphs and their slopes that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about motion graphs and their slopes. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about motion graphs and their slopes.
...
- Apply motion graphs and their slopes under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect motion graphs and their slopes to position, displacement, and reference frames from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs11-physics-u01-l09` · lesson `ma-hs11-physics-u01-l09` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
