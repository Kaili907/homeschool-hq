# Investigation: the electromagnetic spectrum

**High School Physics (Grade 11)** · Unit 9: Electromagnetic Radiation, Information, and a Physics Engineering Capstone · Day 7 of the unit (course day 103) · about 61–84 minutes

**Today's focus:** the electromagnetic spectrum
...
- Plan and carry out a safe investigation of the electromagnetic spectrum, or its stated alternative, and record the learner's own data with its uncertainty.
- Explain the electromagnetic spectrum using evidence, a model, or a documented process rather than an unsupported answer.
- Apply the electromagnetic spectrum to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on the electromagnetic spectrum against the stated success criteria and name the next step.
...
- Science brief: in order of increasing frequency and decreasing wavelength the spectrum runs radio, microwave, infrared, visible, ultraviolet, X-ray, gamma.
- Science brief: all electromagnetic waves travel at the same speed in vacuum, approximately three times ten to the eighth metres per second.
- Science brief: the regions of the spectrum differ in frequency and wavelength, not in their fundamental nature.
- Science brief: photon energy increases with frequency, so gamma rays carry far more energy per photon than radio waves.

### Evidence check: the electromagnetic spectrum

**Candidate claim:** A case report presents this as acceptable science: “placing the spectrum regions out of order, such as putting ultraviolet below visible in frequency.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: in order of increasing frequency and decreasing wavelength the spectrum runs radio, microwave, infrared, visible, ultraviolet, X-ray, gamma. |
| E2 | established science reference | Science brief: all electromagnetic waves travel at the same speed in vacuum, approximately three times ten to the eighth metres per second. |
| E3 | established science reference | Science brief: the regions of the spectrum differ in frequency and wavelength, not in their fundamental nature. |
| E4 | established science reference | Science brief: photon energy increases with frequency, so gamma rays carry far more energy per photon than radio waves. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs11-physics-u09::the electromagnetic spectrum, derived from the reviewed correctness source policy/correctness/ma-hs11-physics.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about the electromagnetic spectrum, and does it support the candidate claim?
...
**My question.** Write the question you are testing about the electromagnetic spectrum. It has to be a question your evidence could actually answer.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about the electromagnetic spectrum, then name one check that would catch an error or a weak claim.**
...
**Q1.** Complete the route you chose. For the document/model route, use its printed procedure and input table; for the H4 physical route, use the printed safe order and your own blank record. Report the route, evidence IDs or model rows, conclusion about the electromagnetic spectrum, uncertainty, and limitation.

>

**Q2.** Explain the electromagnetic spectrum in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for the electromagnetic spectrum. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about the electromagnetic spectrum, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using the electromagnetic spectrum as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E4 is strongest for evaluating the candidate claim about the electromagnetic spectrum? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E4, state one conclusion about the electromagnetic spectrum that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about the electromagnetic spectrum. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about the electromagnetic spectrum.
...
- Apply the electromagnetic spectrum under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect the electromagnetic spectrum to absorption of radiation by matter from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs11-physics-u09-l07` · lesson `ma-hs11-physics-u09-l07` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
