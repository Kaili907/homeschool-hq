# Reteach and varied practice: Coulomb's law

**High School Physics (Grade 11)** · Unit 4: Gravitation and Electrostatic Forces · Day 8 of the unit (course day 44) · about 55–75 minutes

**Today's focus:** Coulomb's law
...
- Explain Coulomb's law using evidence, a model, or a documented process rather than an unsupported answer.
- Apply Coulomb's law to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on Coulomb's law against the stated success criteria and name the next step.
...
- Science brief: the electrostatic force between two point charges is proportional to the product of the charges and inversely proportional to the square of the distance between them.
- Science brief: like charges repel and unlike charges attract.
- Science brief: coulomb's law has the same inverse-square form as the gravitational law, but electric charge comes in two signs, so the force can attract or repel.
- Science brief: the two charges exert equal and opposite forces on each other regardless of their relative magnitudes.

### Evidence check: Coulomb's law

**Candidate claim:** A case report presents this as acceptable science: “the larger charge exerts the greater force in a pair.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: the electrostatic force between two point charges is proportional to the product of the charges and inversely proportional to the square of the distance between them. |
| E2 | established science reference | Science brief: like charges repel and unlike charges attract. |
| E3 | established science reference | Science brief: coulomb's law has the same inverse-square form as the gravitational law, but electric charge comes in two signs, so the force can attract or repel. |
| E4 | established science reference | Science brief: the two charges exert equal and opposite forces on each other regardless of their relative magnitudes. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs11-physics-u04::Coulomb's law, derived from the reviewed correctness source policy/correctness/ma-hs11-physics.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about Coulomb's law, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about Coulomb's law, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about Coulomb's law, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain Coulomb's law in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for Coulomb's law. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about Coulomb's law, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using Coulomb's law as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about Coulomb's law? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about Coulomb's law that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about Coulomb's law. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about Coulomb's law.
...
- Apply Coulomb's law under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect Coulomb's law to Newton's law of gravitation from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs11-physics-u04-l08` · lesson `ma-hs11-physics-u04-l08` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
