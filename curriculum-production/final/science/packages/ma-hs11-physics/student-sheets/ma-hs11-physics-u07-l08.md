# Reteach and varied practice: current and magnetic field production

**High School Physics (Grade 11)** · Unit 7: Fields, Electromagnetism, and Induction · Day 8 of the unit (course day 80) · about 55–75 minutes

**Today's focus:** current and magnetic field production
...
- Explain current and magnetic field production using evidence, a model, or a documented process rather than an unsupported answer.
- Apply current and magnetic field production to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on current and magnetic field production against the stated success criteria and name the next step.
...
- Science brief: an electric current produces a magnetic field around it.
- Science brief: a current-carrying wire produces a magnetic field encircling it, and the field strength increases with the current.
- Science brief: coiling the wire concentrates the field, and adding an iron core strengthens it further, which is how electromagnets work.
- Science brief: a current-carrying conductor in an external magnetic field experiences a force, which is the basis of the electric motor.

### Evidence check: current and magnetic field production

**Candidate claim:** A case report presents this as acceptable science: “a stationary charge produces a magnetic field.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: an electric current produces a magnetic field around it. |
| E2 | established science reference | Science brief: a current-carrying wire produces a magnetic field encircling it, and the field strength increases with the current. |
| E3 | established science reference | Science brief: coiling the wire concentrates the field, and adding an iron core strengthens it further, which is how electromagnets work. |
| E4 | established science reference | Science brief: a current-carrying conductor in an external magnetic field experiences a force, which is the basis of the electric motor. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs11-physics-u07::current and magnetic field production, derived from the reviewed correctness source policy/correctness/ma-hs11-physics.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about current and magnetic field production, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about current and magnetic field production, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about current and magnetic field production, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain current and magnetic field production in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for current and magnetic field production. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about current and magnetic field production, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using current and magnetic field production as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about current and magnetic field production? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about current and magnetic field production that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about current and magnetic field production. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about current and magnetic field production.
...
- Apply current and magnetic field production under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect current and magnetic field production to electric and magnetic fields from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs11-physics-u07-l08` · lesson `ma-hs11-physics-u07-l08` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
