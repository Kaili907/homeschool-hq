# Investigation: electric and magnetic fields

**High School Physics (Grade 11)** · Unit 7: Fields, Electromagnetism, and Induction · Day 7 of the unit (course day 79) · about 61–84 minutes

**Today's focus:** electric and magnetic fields
...
- Plan and carry out a safe investigation of electric and magnetic fields, or its stated alternative, and record the learner's own data with its uncertainty.
- Explain electric and magnetic fields using evidence, a model, or a documented process rather than an unsupported answer.
- Apply electric and magnetic fields to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on electric and magnetic fields against the stated success criteria and name the next step.

**Materials:**

- at least 1 m of thin 28-30 AWG enamelled copper wire
- iron nail
- single 1.5 V D-cell or AA with holder
- compass
- strong magnet
- coil of many wire turns
- multimeter set to a voltage range
- paper clips
- tray
...
- **Physical hazard.** Swallowed magnets are a surgical emergency: two or more magnets, or a magnet and any swallowed metal object, attract through the wall of the gut and cut off its blood supply.
  - What stops it: Count the magnets out and back in every session, work over a tray, never bring one near a mouth, and store them closed and labelled out of reach of children and pets. A suspected swallow is an emergency: go at once.
- **Physical hazard.** A wire connected across a battery heats rapidly and can burn skin or start a fire, and a nail is a magnetic core rather than a resistance.
  - What stops it: Use at least 1 m of thin 28-30 AWG enamelled wire so the coil has real resistance; a short or thick wire is a short circuit even with a nail through it. One 1.5 V cell only - NEVER mains, lithium, or button cell.
- **Physical hazard.** A multimeter left on a current range and placed across a battery ruptures its fuse and can arc.
  - What stops it: The multimeter stays on a voltage range for every measurement in this investigation. A current range is never placed across a cell.
- **Physical hazard.** Strong neodymium magnets pinch skin severely and destroy electronics and cards.
  - What stops it: Handle magnets one at a time, keep them well away from phones, laptops, bank cards, and any medical device such as a pacemaker, and store them separated.
...
- Science brief: electric fields exert forces on charges whether or not they are moving; magnetic fields exert forces only on moving charges and on magnetic materials.
- Science brief: a field is a model in which one object modifies the space around it, and a second object responds to the field at its own location.
- Science brief: the electric field direction is defined as the direction of the force on a positive test charge.
- Science brief: magnetic field lines form closed loops; isolated magnetic poles have never been observed.

### Evidence check: electric and magnetic fields

**Candidate claim:** A case report presents this as acceptable science: “a magnetic field exerts a force on a stationary charge.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: electric fields exert forces on charges whether or not they are moving; magnetic fields exert forces only on moving charges and on magnetic materials. |
| E2 | established science reference | Science brief: a field is a model in which one object modifies the space around it, and a second object responds to the field at its own location. |
| E3 | established science reference | Science brief: the electric field direction is defined as the direction of the force on a positive test charge. |
| E4 | established science reference | Science brief: magnetic field lines form closed loops; isolated magnetic poles have never been observed. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs11-physics-u07::electric and magnetic fields, derived from the reviewed correctness source policy/correctness/ma-hs11-physics.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about electric and magnetic fields, and does it support the candidate claim?
...
**My question.** Write the question you are testing about electric and magnetic fields. It has to be a question your evidence could actually answer.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about electric and magnetic fields, then name one check that would catch an error or a weak claim.**
...
**Q1.** Complete the route you chose. For the document/model route, use its printed procedure and input table; for the H4 physical route, use the printed safe order and your own blank record. Report the route, evidence IDs or model rows, conclusion about electric and magnetic fields, uncertainty, and limitation.

>

**Q2.** Explain electric and magnetic fields in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for electric and magnetic fields. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about electric and magnetic fields, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using electric and magnetic fields as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E4 is strongest for evaluating the candidate claim about electric and magnetic fields? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E4, state one conclusion about electric and magnetic fields that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about electric and magnetic fields. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about electric and magnetic fields.
...
- Apply electric and magnetic fields under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect electric and magnetic fields to current and magnetic field production from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Plan and conduct an investigation providing evidence that a current produces a magnetic field and that a changing magnetic field produces a current, and model the energy change involved. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-hs11-physics-u07-l07` · lesson `ma-hs11-physics-u07-l07` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
