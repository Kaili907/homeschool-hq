# Reteach and varied practice: conduction, convection, and radiation

**High School Physics (Grade 11)** · Unit 6: Thermal Energy and the Second Law · Day 8 of the unit (course day 68) · about 55–75 minutes

**Today's focus:** conduction, convection, and radiation
...
- Apply conduction, convection, and radiation to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on conduction, convection, and radiation against the stated success criteria and name the next step.
...
- Science brief: conduction transfers energy through particle interaction, convection through bulk fluid movement, and radiation by electromagnetic waves requiring no medium.
- Science brief: conduction requires matter in contact and is fastest in materials with mobile electrons, which is why metals conduct thermally as well as electrically.
- Science brief: convection requires a fluid free to move, so it does not occur within a solid.
- Science brief: radiation occurs across a vacuum and is how energy reaches Earth from the Sun.

### Evidence check: conduction, convection, and radiation

**Candidate claim:** A case report presents this as acceptable science: “convection occurs within a solid.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: conduction transfers energy through particle interaction, convection through bulk fluid movement, and radiation by electromagnetic waves requiring no medium. |
| E2 | established science reference | Science brief: conduction requires matter in contact and is fastest in materials with mobile electrons, which is why metals conduct thermally as well as electrically. |
| E3 | established science reference | Science brief: convection requires a fluid free to move, so it does not occur within a solid. |
| E4 | established science reference | Science brief: radiation occurs across a vacuum and is how energy reaches Earth from the Sun. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs11-physics-u06::conduction, convection, and radiation, derived from the reviewed correctness source policy/correctness/ma-hs11-physics.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about conduction, convection, and radiation, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about conduction, convection, and radiation, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about conduction, convection, and radiation, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain conduction, convection, and radiation in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for conduction, convection, and radiation. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about conduction, convection, and radiation, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using conduction, convection, and radiation as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about conduction, convection, and radiation? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about conduction, convection, and radiation that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about conduction, convection, and radiation. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about conduction, convection, and radiation.
...
- Apply conduction, convection, and radiation under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect conduction, convection, and radiation to temperature versus thermal energy from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs11-physics-u06-l08` · lesson `ma-hs11-physics-u06-l08` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
