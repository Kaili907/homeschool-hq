# Performance task build: thermal equilibrium

**High School Physics (Grade 11)** · Unit 6: Thermal Energy and the Second Law · Day 9 of the unit (course day 69) · about 61–84 minutes

**Today's focus:** thermal equilibrium
...
- Produce performance-task evidence for thermal equilibrium that a reader could check independently.
- Explain thermal equilibrium using evidence, a model, or a documented process rather than an unsupported answer.
- Apply thermal equilibrium to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on thermal equilibrium against the stated success criteria and name the next step.
...
- Science brief: objects in thermal contact exchange energy until they reach the same temperature; net transfer is then zero.
- Science brief: net thermal energy flows from higher to lower temperature, and the flow stops when the temperatures are equal.
- Science brief: at equilibrium, exchange continues in both directions at equal rates, so equilibrium is dynamic rather than static.
- Science brief: energy is conserved during equilibration: what one body loses, the other and the surroundings gain.

### Evidence check: thermal equilibrium

**Candidate claim:** A case report presents this as acceptable science: “cold flows from the cooler body to the warmer one.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: objects in thermal contact exchange energy until they reach the same temperature; net transfer is then zero. |
| E2 | established science reference | Science brief: net thermal energy flows from higher to lower temperature, and the flow stops when the temperatures are equal. |
| E3 | established science reference | Science brief: at equilibrium, exchange continues in both directions at equal rates, so equilibrium is dynamic rather than static. |
| E4 | established science reference | Science brief: energy is conserved during equilibration: what one body loses, the other and the surroundings gain. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs11-physics-u06::thermal equilibrium, derived from the reviewed correctness source policy/correctness/ma-hs11-physics.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about thermal equilibrium, and does it support the candidate claim?
...
**My question.** Write the question you are testing about thermal equilibrium. It has to be a question your evidence could actually answer.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about thermal equilibrium, then name one check that would catch an error or a weak claim.**
...
**Q1.** Build a checkable contribution to the supplied unit performance task — Plan and conduct an investigation providing evidence that combining components at different temperatures in a closed system produces a more uniform energy distribution. — using the case and E1-E4. Include claim, evidence, reasoning, limitation, and a recorded revision.

>

**Q2.** Explain thermal equilibrium in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for thermal equilibrium. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about thermal equilibrium, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using thermal equilibrium as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E4 is strongest for evaluating the candidate claim about thermal equilibrium? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E4, state one conclusion about thermal equilibrium that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about thermal equilibrium. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about thermal equilibrium.
...
- Apply thermal equilibrium under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect thermal equilibrium to temperature versus thermal energy from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs11-physics-u06-l09` · lesson `ma-hs11-physics-u06-l09` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
