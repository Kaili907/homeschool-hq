# Reteach and varied practice: conservation of momentum

**High School Physics (Grade 11)** · Unit 3: Momentum, Collisions, and Protective Design · Day 8 of the unit (course day 32) · about 55–75 minutes

**Today's focus:** conservation of momentum
...
- Explain conservation of momentum using evidence, a model, or a documented process rather than an unsupported answer.
- Apply conservation of momentum to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on conservation of momentum against the stated success criteria and name the next step.
...
- Science brief: in the absence of a net external force, the total momentum of a system is unchanged by interactions within it.
- Science brief: total momentum before an interaction equals total momentum after it, provided no net external force acts.
- Science brief: momentum conservation holds for every collision type, including those where kinetic energy is not conserved.
- Science brief: defining the system is part of applying the principle: a force is external or internal only with respect to a stated system.

### Evidence check: conservation of momentum

**Candidate claim:** A case report presents this as acceptable science: “momentum is conserved only in elastic collisions.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: in the absence of a net external force, the total momentum of a system is unchanged by interactions within it. |
| E2 | established science reference | Science brief: total momentum before an interaction equals total momentum after it, provided no net external force acts. |
| E3 | established science reference | Science brief: momentum conservation holds for every collision type, including those where kinetic energy is not conserved. |
| E4 | established science reference | Science brief: defining the system is part of applying the principle: a force is external or internal only with respect to a stated system. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs11-physics-u03::conservation of momentum, derived from the reviewed correctness source policy/correctness/ma-hs11-physics.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about conservation of momentum, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about conservation of momentum, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about conservation of momentum, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain conservation of momentum in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for conservation of momentum. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about conservation of momentum, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using conservation of momentum as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about conservation of momentum? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about conservation of momentum that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about conservation of momentum. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about conservation of momentum.
...
- Apply conservation of momentum under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect conservation of momentum to momentum as mass times velocity from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs11-physics-u03-l08` · lesson `ma-hs11-physics-u03-l08` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
