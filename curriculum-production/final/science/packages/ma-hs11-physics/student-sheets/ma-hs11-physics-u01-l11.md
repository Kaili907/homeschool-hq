# Unit assessment: measurement uncertainty in motion

**High School Physics (Grade 11)** · Unit 1: Motion, Measurement, and Quantitative Reasoning · Day 11 of the unit (course day 11) · about 55–75 minutes

**Today's focus:** measurement uncertainty in motion
...
- Demonstrate independent mastery evidence for measurement uncertainty in motion on a fresh task.
- Explain measurement uncertainty in motion using evidence, a model, or a documented process rather than an unsupported answer.
- Apply measurement uncertainty in motion to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on measurement uncertainty in motion against the stated success criteria and name the next step.
...
- Science brief: every timing and distance measurement carries uncertainty, and that uncertainty propagates into any derived velocity or acceleration.
- Science brief: repeated trials estimate random uncertainty but do not reveal systematic error such as a mis-set timing gate.
- Science brief: a reported result states its uncertainty, or a reader cannot judge whether two values differ meaningfully.

### Evidence check: measurement uncertainty in motion

**Candidate claim:** A case report presents this as acceptable science: “two measured values differ when the difference is smaller than the uncertainty.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: every timing and distance measurement carries uncertainty, and that uncertainty propagates into any derived velocity or acceleration. |
| E2 | established science reference | Science brief: repeated trials estimate random uncertainty but do not reveal systematic error such as a mis-set timing gate. |
| E3 | established science reference | Science brief: a reported result states its uncertainty, or a reader cannot judge whether two values differ meaningfully. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs11-physics-u01::measurement uncertainty in motion, derived from the reviewed correctness source policy/correctness/ma-hs11-physics.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about measurement uncertainty in motion, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about measurement uncertainty in motion, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about measurement uncertainty in motion, then name one check that would catch an error or a weak claim.**
...
**Q1.** Without copying a sentence from the brief, evaluate the printed candidate case about measurement uncertainty in motion. Cite E1-E3, write the reasoning in your own words, and correct the case claim so it fits exactly what the record establishes.

>

**Q2.** Explain measurement uncertainty in motion in your own words using at least two specifically named rows from E1-E3. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for measurement uncertainty in motion. Decide whether E1-E3 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about measurement uncertainty in motion, revise its weakest claim with a named row from E1-E3, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using measurement uncertainty in motion as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E3 is strongest for evaluating the candidate claim about measurement uncertainty in motion? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E3, state one conclusion about measurement uncertainty in motion that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about measurement uncertainty in motion. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about measurement uncertainty in motion.
...
- Apply measurement uncertainty in motion under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect measurement uncertainty in motion to position, displacement, and reference frames from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs11-physics-u01-l11` · lesson `ma-hs11-physics-u01-l11` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
