# Synthesis and review: evaluating published claims about radiation

**High School Physics (Grade 11)** · Unit 9: Electromagnetic Radiation, Information, and a Physics Engineering Capstone · Day 10 of the unit (course day 106) · about 55–75 minutes
...
_Package `swp-ma-hs11-physics-u09-l10` · lesson `ma-hs11-physics-u09-l10` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
