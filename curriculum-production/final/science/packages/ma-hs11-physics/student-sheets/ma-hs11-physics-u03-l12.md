# Correction and reflection: engineering a protective device

**High School Physics (Grade 11)** · Unit 3: Momentum, Collisions, and Protective Design · Day 12 of the unit (course day 36) · about 55–75 minutes

**Today's focus:** engineering a protective device
...
- Explain engineering a protective device using evidence, a model, or a documented process rather than an unsupported answer.
- Apply engineering a protective device to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on engineering a protective device against the stated success criteria and name the next step.
...
- Science brief: a protective device works by extending the time or the distance over which momentum changes, thereby reducing peak force.
- Science brief: it can also spread the force over a larger area, reducing pressure, which is a distinct mechanism from reducing the force.
- Science brief: the device is evaluated against measured peak force or deceleration under stated test conditions, not against how sturdy it appears.

### Evidence check: engineering a protective device

**Candidate claim:** A case report presents this as acceptable science: “a protective device removes the momentum change rather than extending the time over which it occurs.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a protective device works by extending the time or the distance over which momentum changes, thereby reducing peak force. |
| E2 | established science reference | Science brief: it can also spread the force over a larger area, reducing pressure, which is a distinct mechanism from reducing the force. |
| E3 | established science reference | Science brief: the device is evaluated against measured peak force or deceleration under stated test conditions, not against how sturdy it appears. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs11-physics-u03::engineering a protective device, derived from the reviewed correctness source policy/correctness/ma-hs11-physics.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about engineering a protective device, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about engineering a protective device, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about engineering a protective device, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain engineering a protective device in your own words using at least two specifically named rows from E1-E3. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for engineering a protective device. Decide whether E1-E3 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about engineering a protective device, revise its weakest claim with a named row from E1-E3, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using engineering a protective device as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about engineering a protective device? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about engineering a protective device that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about engineering a protective device. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about engineering a protective device.
...
- Apply engineering a protective device under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect engineering a protective device to momentum as mass times velocity from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs11-physics-u03-l12` · lesson `ma-hs11-physics-u03-l12` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
