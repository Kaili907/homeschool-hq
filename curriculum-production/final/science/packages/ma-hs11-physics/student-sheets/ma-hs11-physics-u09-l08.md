# Reteach and varied practice: absorption of radiation by matter

**High School Physics (Grade 11)** · Unit 9: Electromagnetic Radiation, Information, and a Physics Engineering Capstone · Day 8 of the unit (course day 104) · about 55–75 minutes

**Today's focus:** absorption of radiation by matter
...
- Explain absorption of radiation by matter using evidence, a model, or a documented process rather than an unsupported answer.
- Apply absorption of radiation by matter to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on absorption of radiation by matter against the stated success criteria and name the next step.
...
- Science brief: whether radiation is absorbed, transmitted, or reflected depends on both the material and the frequency of the radiation.
- Science brief: absorption transfers energy from the radiation to the material, commonly raising its temperature or exciting its electrons.
- Science brief: a material transparent to one part of the spectrum can be opaque to another, which is why glass passes visible light but blocks much ultraviolet.
- Science brief: ionising radiation damages matter by removing electrons from atoms, which non-ionising radiation cannot do however intense it is.

### Evidence check: absorption of radiation by matter

**Candidate claim:** A case report presents this as acceptable science: “a material behaves the same way toward all frequencies of radiation.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: whether radiation is absorbed, transmitted, or reflected depends on both the material and the frequency of the radiation. |
| E2 | established science reference | Science brief: absorption transfers energy from the radiation to the material, commonly raising its temperature or exciting its electrons. |
| E3 | established science reference | Science brief: a material transparent to one part of the spectrum can be opaque to another, which is why glass passes visible light but blocks much ultraviolet. |
| E4 | established science reference | Science brief: ionising radiation damages matter by removing electrons from atoms, which non-ionising radiation cannot do however intense it is. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs11-physics-u09::absorption of radiation by matter, derived from the reviewed correctness source policy/correctness/ma-hs11-physics.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about absorption of radiation by matter, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about absorption of radiation by matter, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about absorption of radiation by matter, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain absorption of radiation by matter in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for absorption of radiation by matter. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about absorption of radiation by matter, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using absorption of radiation by matter as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about absorption of radiation by matter? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about absorption of radiation by matter that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about absorption of radiation by matter. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about absorption of radiation by matter.
...
- Apply absorption of radiation by matter under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect absorption of radiation by matter to the electromagnetic spectrum from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs11-physics-u09-l08` · lesson `ma-hs11-physics-u09-l08` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
