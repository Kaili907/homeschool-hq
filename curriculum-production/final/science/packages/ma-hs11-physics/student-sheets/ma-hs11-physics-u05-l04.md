# Independent application A: energy at macroscopic and particle scales

**High School Physics (Grade 11)** · Unit 5: Energy: Modelling, Accounting, and Conservation · Day 4 of the unit (course day 52) · about 55–75 minutes

**Today's focus:** energy at macroscopic and particle scales
...
- Explain energy at macroscopic and particle scales using evidence, a model, or a documented process rather than an unsupported answer.
- Apply energy at macroscopic and particle scales to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on energy at macroscopic and particle scales against the stated success criteria and name the next step.
...
- Science brief: the thermal energy of an object is the energy associated with the random motion of its particles.
- Science brief: macroscopic kinetic energy is associated with the ordered motion of an object as a whole; thermal energy is associated with the random motion of its particles.
- Science brief: friction and inelastic collisions convert ordered macroscopic energy into random particle energy, which is why they raise temperature.
- Science brief: energy is conserved across the two scales, so an apparent macroscopic loss appears as a particle-scale gain.

### Evidence check: energy at macroscopic and particle scales

**Candidate claim:** A case report presents this as acceptable science: “energy is destroyed by friction rather than converted to thermal energy.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: the thermal energy of an object is the energy associated with the random motion of its particles. |
| E2 | established science reference | Science brief: macroscopic kinetic energy is associated with the ordered motion of an object as a whole; thermal energy is associated with the random motion of its particles. |
| E3 | established science reference | Science brief: friction and inelastic collisions convert ordered macroscopic energy into random particle energy, which is why they raise temperature. |
| E4 | established science reference | Science brief: energy is conserved across the two scales, so an apparent macroscopic loss appears as a particle-scale gain. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs11-physics-u05::energy at macroscopic and particle scales, derived from the reviewed correctness source policy/correctness/ma-hs11-physics.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about energy at macroscopic and particle scales, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about energy at macroscopic and particle scales, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about energy at macroscopic and particle scales, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain energy at macroscopic and particle scales in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for energy at macroscopic and particle scales. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about energy at macroscopic and particle scales, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using energy at macroscopic and particle scales as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about energy at macroscopic and particle scales? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about energy at macroscopic and particle scales that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about energy at macroscopic and particle scales. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about energy at macroscopic and particle scales.
...
- Apply energy at macroscopic and particle scales under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect energy at macroscopic and particle scales to kinetic and potential energy from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs11-physics-u05-l04` · lesson `ma-hs11-physics-u05-l04` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
