# Unit assessment: wave-based technologies

**High School Physics (Grade 11)** · Unit 9: Electromagnetic Radiation, Information, and a Physics Engineering Capstone · Day 11 of the unit (course day 107) · about 55–75 minutes

**Today's focus:** wave-based technologies
...
- Demonstrate independent mastery evidence for wave-based technologies on a fresh task.
- Explain wave-based technologies using evidence, a model, or a documented process rather than an unsupported answer.
- Apply wave-based technologies to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on wave-based technologies against the stated success criteria and name the next step.
...
- Science brief: wave-based technologies work by encoding information onto a wave, transmitting it, and decoding it, and each stage constrains performance.
- Science brief: the choice of frequency band is set by how the wave interacts with the environment: penetration, range, and available bandwidth all depend on it.
- Science brief: every link has limits on range, rate, and reliability set by physics as well as by equipment.

### Evidence check: wave-based technologies

**Candidate claim:** A case report presents this as acceptable science: “a communication technology has no physical limit on range or data rate.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: wave-based technologies work by encoding information onto a wave, transmitting it, and decoding it, and each stage constrains performance. |
| E2 | established science reference | Science brief: the choice of frequency band is set by how the wave interacts with the environment: penetration, range, and available bandwidth all depend on it. |
| E3 | established science reference | Science brief: every link has limits on range, rate, and reliability set by physics as well as by equipment. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs11-physics-u09::wave-based technologies, derived from the reviewed correctness source policy/correctness/ma-hs11-physics.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about wave-based technologies, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about wave-based technologies, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about wave-based technologies, then name one check that would catch an error or a weak claim.**
...
**Q1.** Without copying a sentence from the brief, evaluate the printed candidate case about wave-based technologies. Cite E1-E3, write the reasoning in your own words, and correct the case claim so it fits exactly what the record establishes.

>

**Q2.** Explain wave-based technologies in your own words using at least two specifically named rows from E1-E3. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for wave-based technologies. Decide whether E1-E3 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about wave-based technologies, revise its weakest claim with a named row from E1-E3, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using wave-based technologies as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E3 is strongest for evaluating the candidate claim about wave-based technologies? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E3, state one conclusion about wave-based technologies that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about wave-based technologies. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about wave-based technologies.
...
- Apply wave-based technologies under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect wave-based technologies to the electromagnetic spectrum from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs11-physics-u09-l11` · lesson `ma-hs11-physics-u09-l11` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
