# Guided practice B: energy conversion device design

**High School Physics (Grade 11)** · Unit 9: Electromagnetic Radiation, Information, and a Physics Engineering Capstone · Day 6 of the unit (course day 102) · about 55–75 minutes
...
_Package `swp-ma-hs11-physics-u09-l06` · lesson `ma-hs11-physics-u09-l06` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
