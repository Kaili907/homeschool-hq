# Concept model A: conservation of momentum

**High School Physics (Grade 11)** · Unit 3: Momentum, Collisions, and Protective Design · Day 2 of the unit (course day 26) · about 55–75 minutes
...
_Package `swp-ma-hs11-physics-u03-l02` · lesson `ma-hs11-physics-u03-l02` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
