# Independent application A: uniform acceleration relationships

**High School Physics (Grade 11)** · Unit 1: Motion, Measurement, and Quantitative Reasoning · Day 4 of the unit (course day 4) · about 55–75 minutes

**Today's focus:** uniform acceleration relationships
...
- Explain uniform acceleration relationships using evidence, a model, or a documented process rather than an unsupported answer.
- Apply uniform acceleration relationships to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on uniform acceleration relationships against the stated success criteria and name the next step.
...
- Science brief: the kinematic relationships for uniform acceleration apply only while the acceleration is constant.
- Science brief: for constant acceleration, final velocity, displacement, and time are related by the standard kinematic relationships.
- Science brief: near Earth's surface, an object in free fall with negligible air resistance accelerates downward at approximately nine point eight metres per second squared, independently of its mass.
- Science brief: applying the relationships requires the acceleration to be constant over the whole interval considered.

### Evidence check: uniform acceleration relationships

**Candidate claim:** A case report presents this as acceptable science: “applying the constant-acceleration relationships across an interval where the acceleration changes.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: the kinematic relationships for uniform acceleration apply only while the acceleration is constant. |
| E2 | established science reference | Science brief: for constant acceleration, final velocity, displacement, and time are related by the standard kinematic relationships. |
| E3 | established science reference | Science brief: near Earth's surface, an object in free fall with negligible air resistance accelerates downward at approximately nine point eight metres per second squared, independently of its mass. |
| E4 | established science reference | Science brief: applying the relationships requires the acceleration to be constant over the whole interval considered. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs11-physics-u01::uniform acceleration relationships, derived from the reviewed correctness source policy/correctness/ma-hs11-physics.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about uniform acceleration relationships, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about uniform acceleration relationships, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about uniform acceleration relationships, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain uniform acceleration relationships in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for uniform acceleration relationships. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about uniform acceleration relationships, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using uniform acceleration relationships as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about uniform acceleration relationships? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about uniform acceleration relationships that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about uniform acceleration relationships. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about uniform acceleration relationships.
...
- Apply uniform acceleration relationships under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect uniform acceleration relationships to position, displacement, and reference frames from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs11-physics-u01-l04` · lesson `ma-hs11-physics-u01-l04` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
