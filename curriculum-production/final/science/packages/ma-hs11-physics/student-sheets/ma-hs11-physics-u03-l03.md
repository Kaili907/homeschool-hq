# Guided practice A: impulse and contact time

**High School Physics (Grade 11)** · Unit 3: Momentum, Collisions, and Protective Design · Day 3 of the unit (course day 27) · about 55–75 minutes
...
- Science brief: impulse is force multiplied by the time it acts, and it equals the change in momentum.
- Science brief: for a given change in momentum, extending the contact time reduces the average force.
- Science brief: this is why crumple zones, airbags, helmets, and catching techniques reduce peak force, without reducing the momentum change.
- Science brief: impulse is a vector in the direction of the average force.

### Evidence check: impulse and contact time

**Candidate claim:** A case report presents this as acceptable science: “a protective device reduces the change in momentum rather than the peak force.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: impulse is force multiplied by the time it acts, and it equals the change in momentum. |
| E2 | established science reference | Science brief: for a given change in momentum, extending the contact time reduces the average force. |
| E3 | established science reference | Science brief: this is why crumple zones, airbags, helmets, and catching techniques reduce peak force, without reducing the momentum change. |
| E4 | established science reference | Science brief: impulse is a vector in the direction of the average force. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs11-physics-u03::impulse and contact time, derived from the reviewed correctness source policy/correctness/ma-hs11-physics.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about impulse and contact time, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about impulse and contact time, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**Q1.** Explain impulse and contact time in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for impulse and contact time. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about impulse and contact time, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using impulse and contact time as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about impulse and contact time? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about impulse and contact time that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about impulse and contact time. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
_Package `swp-ma-hs11-physics-u03-l03` · lesson `ma-hs11-physics-u03-l03` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
