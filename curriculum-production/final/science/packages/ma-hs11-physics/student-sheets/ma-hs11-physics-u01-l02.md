# Concept model A: velocity and acceleration

**High School Physics (Grade 11)** · Unit 1: Motion, Measurement, and Quantitative Reasoning · Day 2 of the unit (course day 2) · about 55–75 minutes
...
_Package `swp-ma-hs11-physics-u01-l02` · lesson `ma-hs11-physics-u01-l02` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
