# Launch and diagnostic: kinetic and potential energy

**High School Physics (Grade 11)** · Unit 5: Energy: Modelling, Accounting, and Conservation · Day 1 of the unit (course day 49) · about 55–75 minutes

**Today's focus:** kinetic and potential energy
...
- Explain kinetic and potential energy using evidence, a model, or a documented process rather than an unsupported answer.
- Apply kinetic and potential energy to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on kinetic and potential energy against the stated success criteria and name the next step.
...
- Science brief: kinetic energy depends on mass and on the square of the speed; gravitational potential energy near Earth's surface depends on mass, gravitational field strength, and height above a chosen reference.
- Science brief: doubling an object's speed quadruples its kinetic energy, which is why stopping distance grows so steeply with speed.
- Science brief: potential energy is defined relative to a chosen reference level, and only differences in it are physically meaningful.
- Science brief: potential energy belongs to a system of interacting objects, such as an object and Earth, not to one object alone.

### Evidence check: kinetic and potential energy

**Candidate claim:** A case report presents this as acceptable science: “kinetic energy is proportional to speed rather than to its square.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: kinetic energy depends on mass and on the square of the speed; gravitational potential energy near Earth's surface depends on mass, gravitational field strength, and height above a chosen reference. |
| E2 | established science reference | Science brief: doubling an object's speed quadruples its kinetic energy, which is why stopping distance grows so steeply with speed. |
| E3 | established science reference | Science brief: potential energy is defined relative to a chosen reference level, and only differences in it are physically meaningful. |
| E4 | established science reference | Science brief: potential energy belongs to a system of interacting objects, such as an object and Earth, not to one object alone. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs11-physics-u05::kinetic and potential energy, derived from the reviewed correctness source policy/correctness/ma-hs11-physics.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about kinetic and potential energy, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about kinetic and potential energy, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about kinetic and potential energy, then name one check that would catch an error or a weak claim.**
...
**Q1.** Use the printed case as today's phenomenon for kinetic and potential energy. Record what the candidate claim says, identify the mismatch with E1-E4, and pose a testable question naming what would change and what would be measured or classified.

>

**Q2.** Explain kinetic and potential energy in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for kinetic and potential energy. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about kinetic and potential energy, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using kinetic and potential energy as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E4 is strongest for evaluating the candidate claim about kinetic and potential energy? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E4, state one conclusion about kinetic and potential energy that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about kinetic and potential energy. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about kinetic and potential energy.
...
- Apply kinetic and potential energy under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect kinetic and potential energy to energy as a system-level account from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs11-physics-u05-l01` · lesson `ma-hs11-physics-u05-l01` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
