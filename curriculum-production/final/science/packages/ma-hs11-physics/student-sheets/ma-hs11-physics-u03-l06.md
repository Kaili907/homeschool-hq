# Guided practice B: engineering a protective device

**High School Physics (Grade 11)** · Unit 3: Momentum, Collisions, and Protective Design · Day 6 of the unit (course day 30) · about 55–75 minutes
...
_Package `swp-ma-hs11-physics-u03-l06` · lesson `ma-hs11-physics-u03-l06` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
