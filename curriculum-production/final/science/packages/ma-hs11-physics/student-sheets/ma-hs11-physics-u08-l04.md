# Independent application A: reflection, refraction, and diffraction

**High School Physics (Grade 11)** · Unit 8: Waves and Their Mathematics · Day 4 of the unit (course day 88) · about 55–75 minutes

**Today's focus:** reflection, refraction, and diffraction
...
- Explain reflection, refraction, and diffraction using evidence, a model, or a documented process rather than an unsupported answer.
- Apply reflection, refraction, and diffraction to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on reflection, refraction, and diffraction against the stated success criteria and name the next step.
...
- Science brief: reflection returns a wave from a boundary, refraction is the change of direction on entering a medium where the speed differs, and diffraction is the spreading of a wave past an edge or through a gap.
- Science brief: in reflection from a smooth surface the angle of reflection equals the angle of incidence, both measured from the normal.
- Science brief: refraction occurs because the wave speed changes at the boundary; a wave entering along the normal changes speed without changing direction.
- Science brief: diffraction is most pronounced when the gap or obstacle is comparable in size to the wavelength.

### Evidence check: reflection, refraction, and diffraction

**Candidate claim:** A case report presents this as acceptable science: “refraction occurs because the wave's frequency changes at the boundary.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: reflection returns a wave from a boundary, refraction is the change of direction on entering a medium where the speed differs, and diffraction is the spreading of a wave past an edge or through a gap. |
| E2 | established science reference | Science brief: in reflection from a smooth surface the angle of reflection equals the angle of incidence, both measured from the normal. |
| E3 | established science reference | Science brief: refraction occurs because the wave speed changes at the boundary; a wave entering along the normal changes speed without changing direction. |
| E4 | established science reference | Science brief: diffraction is most pronounced when the gap or obstacle is comparable in size to the wavelength. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs11-physics-u08::reflection, refraction, and diffraction, derived from the reviewed correctness source policy/correctness/ma-hs11-physics.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about reflection, refraction, and diffraction, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about reflection, refraction, and diffraction, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about reflection, refraction, and diffraction, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain reflection, refraction, and diffraction in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for reflection, refraction, and diffraction. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about reflection, refraction, and diffraction, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using reflection, refraction, and diffraction as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about reflection, refraction, and diffraction? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about reflection, refraction, and diffraction that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about reflection, refraction, and diffraction. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about reflection, refraction, and diffraction.
...
- Apply reflection, refraction, and diffraction under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect reflection, refraction, and diffraction to wave properties and terminology from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs11-physics-u08-l04` · lesson `ma-hs11-physics-u08-l04` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
