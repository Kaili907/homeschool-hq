# Synthesis and review: energy at macroscopic and particle scales

**High School Physics (Grade 11)** · Unit 5: Energy: Modelling, Accounting, and Conservation · Day 10 of the unit (course day 58) · about 55–75 minutes
...
_Package `swp-ma-hs11-physics-u05-l10` · lesson `ma-hs11-physics-u05-l10` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
