# Unit assessment: the second law of thermodynamics

**High School Physics (Grade 11)** · Unit 6: Thermal Energy and the Second Law · Day 11 of the unit (course day 71) · about 55–75 minutes

**Today's focus:** the second law of thermodynamics
...
- Demonstrate independent mastery evidence for the second law of thermodynamics on a fresh task.
- Explain the second law of thermodynamics using evidence, a model, or a documented process rather than an unsupported answer.
- Apply the second law of thermodynamics to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on the second law of thermodynamics against the stated success criteria and name the next step.
...
- Science brief: thermal energy does not flow spontaneously from a cooler body to a warmer one, and no cyclic device converts thermal energy entirely into work.
- Science brief: energy spontaneously disperses, so the total disorder of a system and its surroundings does not decrease.
- Science brief: a refrigerator or heat pump moves energy from cooler to warmer only because work is supplied, so the overall dispersal still increases.
- Science brief: this sets an upper limit on the efficiency of any heat engine that is strictly below one hundred per cent.

### Evidence check: the second law of thermodynamics

**Candidate claim:** A case report presents this as acceptable science: “a heat engine can be one hundred per cent efficient.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: thermal energy does not flow spontaneously from a cooler body to a warmer one, and no cyclic device converts thermal energy entirely into work. |
| E2 | established science reference | Science brief: energy spontaneously disperses, so the total disorder of a system and its surroundings does not decrease. |
| E3 | established science reference | Science brief: a refrigerator or heat pump moves energy from cooler to warmer only because work is supplied, so the overall dispersal still increases. |
| E4 | established science reference | Science brief: this sets an upper limit on the efficiency of any heat engine that is strictly below one hundred per cent. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs11-physics-u06::the second law of thermodynamics, derived from the reviewed correctness source policy/correctness/ma-hs11-physics.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about the second law of thermodynamics, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about the second law of thermodynamics, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about the second law of thermodynamics, then name one check that would catch an error or a weak claim.**
...
**Q1.** Without copying a sentence from the brief, evaluate the printed candidate case about the second law of thermodynamics. Cite E1-E4, write the reasoning in your own words, and correct the case claim so it fits exactly what the record establishes.

>

**Q2.** Explain the second law of thermodynamics in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for the second law of thermodynamics. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about the second law of thermodynamics, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using the second law of thermodynamics as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E4 is strongest for evaluating the candidate claim about the second law of thermodynamics? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E4, state one conclusion about the second law of thermodynamics that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about the second law of thermodynamics. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about the second law of thermodynamics.
...
- Apply the second law of thermodynamics under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect the second law of thermodynamics to temperature versus thermal energy from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs11-physics-u06-l11` · lesson `ma-hs11-physics-u06-l11` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
