# Scoring authority — Reteach and varied practice: conduction, convection, and radiation

**High School Physics (Grade 11)** · Unit 6: Thermal Energy and the Second Law · Day 8 · lesson `ma-hs11-physics-u06-l08`
...
_Topic `ma-hs11-physics-u06::conduction, convection, and radiation` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-hs11-physics.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Conduction transfers energy through particle interaction, convection through bulk fluid movement, and radiation by electromagnetic waves requiring no medium.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Conduction requires matter in contact and is fastest in materials with mobile electrons, which is why metals conduct thermally as well as electrically.
- Convection requires a fluid free to move, so it does not occur within a solid.
- Radiation occurs across a vacuum and is how energy reaches Earth from the Sun.
...
- Claiming convection occurs within a solid.
- Claiming thermal radiation requires a medium.
- Claiming an insulator produces cold rather than slowing transfer.

**Grade boundary.** Quantitative transfer coefficients, Stefan-Boltzmann calculations, and emissivity are beyond this course.


## What a complete response contains, question by question

**Q1 — explain with evidence.** _Serves objective 1:_ Explain conduction, convection, and radiation using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q2 — apply new task.** _Serves objective 2:_ Apply conduction, convection, and radiation to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q3 — check revise next step.** _Serves objective 3:_ Check and revise the work on conduction, convection, and radiation against the stated success criteria and name the next step.
...
**Q4 — essential question.** _Serves objective 2:_ Apply conduction, convection, and radiation to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q5 — evidence quality.** _Serves objective 1:_ Explain conduction, convection, and radiation using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q6 — limitation.** _Serves objective 2:_ Apply conduction, convection, and radiation to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q7 — provenance.** _Serves objective 1:_ Explain conduction, convection, and radiation using evidence, a model, or a documented process rather than an unsupported answer.
...
- **prerequisite-gap** — Run the prerequisite reteach route for conduction, convection, and radiation (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for conduction, convection, and radiation (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for conduction, convection, and radiation (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for conduction, convection, and radiation (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for conduction, convection, and radiation (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs11-physics-u06-l08` · built from `hs912-science-h4` at `a86780a`._
