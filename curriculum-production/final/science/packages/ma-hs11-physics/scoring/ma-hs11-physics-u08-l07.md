# Scoring authority — Investigation: wave properties and terminology

**High School Physics (Grade 11)** · Unit 8: Waves and Their Mathematics · Day 7 · lesson `ma-hs11-physics-u08-l07`
...
_Topic `ma-hs11-physics-u08::wave properties and terminology` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-hs11-physics.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- A wave transfers energy without net transport of the medium.
- Amplitude is maximum displacement from equilibrium; wavelength is the distance between matching points on successive cycles; frequency is cycles per second; period is the time for one cycle.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Particles of a medium oscillate about fixed positions while the wave and its energy travel through.
- Frequency and period are reciprocals of one another.
- In a transverse wave the oscillation is perpendicular to the direction of travel; in a longitudinal wave it is along it.
...
- Claiming a wave carries the medium along with it.
- Confusing amplitude with wavelength, or frequency with wave speed.
- Claiming sound is a transverse wave in air.

**Grade boundary.** Wave equation derivation and polarisation are acceptable but not required.
...
**Q1 — investigate.** _Serves objective 1:_ Plan and carry out a safe investigation of wave properties and terminology, or its stated alternative, and record the learner's own data with its uncertainty.
...
**Q2 — explain with evidence.** _Serves objective 2:_ Explain wave properties and terminology using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q3 — apply new task.** _Serves objective 3:_ Apply wave properties and terminology to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q4 — check revise next step.** _Serves objective 4:_ Check and revise the work on wave properties and terminology against the stated success criteria and name the next step.
...
**Q5 — essential question.** _Serves objective 3:_ Apply wave properties and terminology to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q6 — evidence quality.** _Serves objective 2:_ Explain wave properties and terminology using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q7 — limitation.** _Serves objective 1:_ Plan and carry out a safe investigation of wave properties and terminology, or its stated alternative, and record the learner's own data with its uncertainty.
...
**Q8 — provenance.** _Serves objective 1:_ Plan and carry out a safe investigation of wave properties and terminology, or its stated alternative, and record the learner's own data with its uncertainty.
...
- **prerequisite-gap** — Run the prerequisite reteach route for wave properties and terminology (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for wave properties and terminology (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for wave properties and terminology (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for wave properties and terminology (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for wave properties and terminology (evidence type: application, require explanation: True, review timing: same-day).
...
- physical: A stretched spring released under tension snaps back hard and can injure eyes. — mitigation: Everyone wears eye protection whenever the spring is under tension. Two people hold the ends, never stretch beyond about twice the resting length, never let go while stretched, and release slowly together.
- physical: Bright light sources can damage vision. — mitigation: Use a flashlight or LED only. NO LASER of any kind is used in this unit. Never look directly into any light source or point one at another person.
- physical: A snapped or scored CD throws sharp shards. — mitigation: Use an intact CD or a sheet diffraction grating. Never cut, score, or snap a disc.
...
**Disposal and clearing up:** Coil the spring or rope loosely and put it away, empty the water tray down the drain and dry it, and return the CD or grating to its sleeve. Nothing hazardous is produced.
...
_Package `swp-ma-hs11-physics-u08-l07` · built from `hs912-science-h4` at `a86780a`._
