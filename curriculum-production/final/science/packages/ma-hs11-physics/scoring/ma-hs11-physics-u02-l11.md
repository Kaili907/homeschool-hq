# Scoring authority — Unit assessment: friction and normal forces

**High School Physics (Grade 11)** · Unit 2: Forces and Newton's Second Law · Day 11 · lesson `ma-hs11-physics-u02-l11`
...
_Topic `ma-hs11-physics-u02::friction and normal forces` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-hs11-physics.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- The normal force is perpendicular to the contact surface and is not always equal to the object's weight.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Friction acts parallel to the contact surface and opposes relative sliding or the tendency to slide.
- Frictional force depends on the normal force and on the surfaces, and to a good approximation not on the contact area.
- Static friction adjusts up to a maximum to prevent sliding; kinetic friction acts once sliding has begun and is generally smaller.
...
- Claiming the normal force always equals the object's weight, including on an incline or when another vertical force acts.
- Claiming friction depends principally on contact area.
- Claiming friction always opposes motion rather than relative sliding; friction is what propels a walking person forward.

**Grade boundary.** Rolling resistance, lubrication regimes, and surface physics are beyond this course.


## What a complete response contains, question by question

**Q1 — mastery fresh task.** _Serves objective 1:_ Demonstrate independent mastery evidence for friction and normal forces on a fresh task.
...
**Q2 — explain with evidence.** _Serves objective 2:_ Explain friction and normal forces using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q3 — apply new task.** _Serves objective 3:_ Apply friction and normal forces to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q4 — check revise next step.** _Serves objective 4:_ Check and revise the work on friction and normal forces against the stated success criteria and name the next step.
...
**Q5 — essential question.** _Serves objective 3:_ Apply friction and normal forces to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q6 — evidence quality.** _Serves objective 2:_ Explain friction and normal forces using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q7 — limitation.** _Serves objective 3:_ Apply friction and normal forces to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q8 — provenance.** _Serves objective 1:_ Demonstrate independent mastery evidence for friction and normal forces on a fresh task.
...
- **prerequisite-gap** — Run the prerequisite reteach route for friction and normal forces (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for friction and normal forces (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for friction and normal forces (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for friction and normal forces (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for friction and normal forces (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs11-physics-u02-l11` · built from `hs912-science-h4` at `a86780a`._
