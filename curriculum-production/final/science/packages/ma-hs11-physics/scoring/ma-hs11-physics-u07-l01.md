# Scoring authority — Launch and diagnostic: electric and magnetic fields

**High School Physics (Grade 11)** · Unit 7: Fields, Electromagnetism, and Induction · Day 1 · lesson `ma-hs11-physics-u07-l01`
...
_Topic `ma-hs11-physics-u07::electric and magnetic fields` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-hs11-physics.correctness.json`._
...
**Q1 — phenomenon question.** _Serves objective 1:_ Observe the anchoring phenomenon, surface initial thinking about electric and magnetic fields without penalty, and pose a testable question.
...
**Q7 — limitation.** _Serves objective 3:_ Apply electric and magnetic fields to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q8 — provenance.** _Serves objective 1:_ Observe the anchoring phenomenon, surface initial thinking about electric and magnetic fields without penalty, and pose a testable question.
...
_Package `swp-ma-hs11-physics-u07-l01` · built from `hs912-science-h4` at `a86780a`._
