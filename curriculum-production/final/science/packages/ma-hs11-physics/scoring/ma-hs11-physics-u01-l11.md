# Scoring authority — Unit assessment: measurement uncertainty in motion

**High School Physics (Grade 11)** · Unit 1: Motion, Measurement, and Quantitative Reasoning · Day 11 · lesson `ma-hs11-physics-u01-l11`
...
_Topic `ma-hs11-physics-u01::measurement uncertainty in motion` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-hs11-physics.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Every timing and distance measurement carries uncertainty, and that uncertainty propagates into any derived velocity or acceleration.
- Repeated trials estimate random uncertainty but do not reveal systematic error such as a mis-set timing gate.
- A reported result states its uncertainty, or a reader cannot judge whether two values differ meaningfully.

**Also correct.** Accept any of these framings — do not require the wording above:

- Reporting a range, a mean with spread, or an explicit uncertainty are all acceptable at this level.
...
- Claiming two measured values differ when the difference is smaller than the uncertainty.
- Claiming repeated trials remove systematic error.
- Reporting a derived quantity to more significant figures than the input measurements support.

**Grade boundary.** Formal error propagation formulas and statistical hypothesis testing are beyond this course.


## What a complete response contains, question by question

**Q1 — mastery fresh task.** _Serves objective 1:_ Demonstrate independent mastery evidence for measurement uncertainty in motion on a fresh task.
...
**Q2 — explain with evidence.** _Serves objective 2:_ Explain measurement uncertainty in motion using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q3 — apply new task.** _Serves objective 3:_ Apply measurement uncertainty in motion to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q4 — check revise next step.** _Serves objective 4:_ Check and revise the work on measurement uncertainty in motion against the stated success criteria and name the next step.
...
**Q5 — essential question.** _Serves objective 3:_ Apply measurement uncertainty in motion to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q6 — evidence quality.** _Serves objective 2:_ Explain measurement uncertainty in motion using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q7 — limitation.** _Serves objective 3:_ Apply measurement uncertainty in motion to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q8 — provenance.** _Serves objective 1:_ Demonstrate independent mastery evidence for measurement uncertainty in motion on a fresh task.
...
- **prerequisite-gap** — Run the prerequisite reteach route for measurement uncertainty in motion (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for measurement uncertainty in motion (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for measurement uncertainty in motion (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for measurement uncertainty in motion (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for measurement uncertainty in motion (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs11-physics-u01-l11` · built from `hs912-science-h4` at `a86780a`._
