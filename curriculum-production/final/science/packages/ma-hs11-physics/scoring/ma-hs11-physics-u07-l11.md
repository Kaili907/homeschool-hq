# Scoring authority — Unit assessment: energy changes in field interactions

**High School Physics (Grade 11)** · Unit 7: Fields, Electromagnetism, and Induction · Day 11 · lesson `ma-hs11-physics-u07-l11`
...
_Topic `ma-hs11-physics-u07::energy changes in field interactions` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-hs11-physics.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Work is done when a charge or a mass moves through a field along the direction of the force, and energy is transferred as a result.
- Moving a charge or mass against the field force increases the system's potential energy; moving with it decreases it.
- Energy is conserved throughout: a generator supplies electrical energy only because mechanical work is supplied to it.
...
- Claiming a generator or an induction device produces energy.
- Claiming potential energy belongs to the moving object alone rather than to the interacting system.
- Claiming work is done when motion is perpendicular to the field force.

**Grade boundary.** Potential difference formalism and field energy density are acceptable but not required.


## What a complete response contains, question by question

**Q1 — mastery fresh task.** _Serves objective 1:_ Demonstrate independent mastery evidence for energy changes in field interactions on a fresh task.
...
**Q2 — explain with evidence.** _Serves objective 2:_ Explain energy changes in field interactions using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q3 — apply new task.** _Serves objective 3:_ Apply energy changes in field interactions to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q4 — check revise next step.** _Serves objective 4:_ Check and revise the work on energy changes in field interactions against the stated success criteria and name the next step.
...
**Q5 — essential question.** _Serves objective 3:_ Apply energy changes in field interactions to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q6 — evidence quality.** _Serves objective 2:_ Explain energy changes in field interactions using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q7 — limitation.** _Serves objective 3:_ Apply energy changes in field interactions to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q8 — provenance.** _Serves objective 1:_ Demonstrate independent mastery evidence for energy changes in field interactions on a fresh task.
...
- **prerequisite-gap** — Run the prerequisite reteach route for energy changes in field interactions (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for energy changes in field interactions (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for energy changes in field interactions (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for energy changes in field interactions (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for energy changes in field interactions (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs11-physics-u07-l11` · built from `hs912-science-h4` at `a86780a`._
