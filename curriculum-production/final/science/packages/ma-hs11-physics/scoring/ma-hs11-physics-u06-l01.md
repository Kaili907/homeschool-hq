# Scoring authority — Launch and diagnostic: temperature versus thermal energy

**High School Physics (Grade 11)** · Unit 6: Thermal Energy and the Second Law · Day 1 · lesson `ma-hs11-physics-u06-l01`
...
_Topic `ma-hs11-physics-u06::temperature versus thermal energy` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-hs11-physics.correctness.json`._
...
**Q1 — phenomenon question.** _Serves objective 1:_ Observe the anchoring phenomenon, surface initial thinking about temperature versus thermal energy without penalty, and pose a testable question.
...
**Q7 — limitation.** _Serves objective 3:_ Apply temperature versus thermal energy to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q8 — provenance.** _Serves objective 1:_ Observe the anchoring phenomenon, surface initial thinking about temperature versus thermal energy without penalty, and pose a testable question.
...
_Package `swp-ma-hs11-physics-u06-l01` · built from `hs912-science-h4` at `a86780a`._
