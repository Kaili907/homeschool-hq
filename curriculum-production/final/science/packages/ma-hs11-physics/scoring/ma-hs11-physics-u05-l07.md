# Scoring authority — Investigation: kinetic and potential energy

**High School Physics (Grade 11)** · Unit 5: Energy: Modelling, Accounting, and Conservation · Day 7 · lesson `ma-hs11-physics-u05-l07`
...
_Topic `ma-hs11-physics-u05::kinetic and potential energy` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-hs11-physics.correctness.json`._
...
**Q1 — investigate.** _Serves objective 1:_ Plan and carry out a safe investigation of kinetic and potential energy, or its stated alternative, and record the learner's own data with its uncertainty.
...
**Q7 — limitation.** _Serves objective 1:_ Plan and carry out a safe investigation of kinetic and potential energy, or its stated alternative, and record the learner's own data with its uncertainty.
...
**Q8 — provenance.** _Serves objective 1:_ Plan and carry out a safe investigation of kinetic and potential energy, or its stated alternative, and record the learner's own data with its uncertainty.
...
- physical: A swinging pendulum or bouncing ball can strike a person or object. — mitigation: Clear a radius larger than the string length, keep the bob under 200 g, swing at small angles, and keep faces and screens out of the swing plane.
...
**Disposal and clearing up:** Untie and coil the string and put the ball or bob away. Nothing hazardous is produced.
...
_Package `swp-ma-hs11-physics-u05-l07` · built from `hs912-science-h4` at `a86780a`._
