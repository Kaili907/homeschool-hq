# Scoring authority — Guided practice B: building and checking an energy budget

**High School Physics (Grade 11)** · Unit 5: Energy: Modelling, Accounting, and Conservation · Day 6 · lesson `ma-hs11-physics-u05-l06`
...
_Package `swp-ma-hs11-physics-u05-l06` · built from `hs912-science-h4` at `a86780a`._
