# Scoring authority — Launch and diagnostic: momentum as mass times velocity

**High School Physics (Grade 11)** · Unit 3: Momentum, Collisions, and Protective Design · Day 1 · lesson `ma-hs11-physics-u03-l01`
...
_Topic `ma-hs11-physics-u03::momentum as mass times velocity` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-hs11-physics.correctness.json`._
...
**Q1 — phenomenon question.** _Serves objective 1:_ Observe the anchoring phenomenon, surface initial thinking about momentum as mass times velocity without penalty, and pose a testable question.
...
**Q7 — limitation.** _Serves objective 3:_ Apply momentum as mass times velocity to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q8 — provenance.** _Serves objective 1:_ Observe the anchoring phenomenon, surface initial thinking about momentum as mass times velocity without penalty, and pose a testable question.
...
_Package `swp-ma-hs11-physics-u03-l01` · built from `hs912-science-h4` at `a86780a`._
