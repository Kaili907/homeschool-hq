# Scoring authority — Unit assessment: measuring distance and time

**Grade 3 Science** · Unit 2: Forces and Motion · Day 11 · lesson `ma-g3-science-u02-l11`
...
_Topic `ma-g3-science-u02::measuring distance and time` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Distance and time are measured with tools and reported with units; two values can only be compared when they use the same unit.
- Starting and stopping a timer by hand adds error to every trial, which is why several trials are taken.
- A fair comparison of two motions uses the same starting point, the same finish point, and the same measuring method.
...
- Comparing distances recorded in different units without converting them.
- Treating a single hand-timed trial as exact.
- Changing the start or finish point between trials and comparing the results anyway.

**Grade boundary.** Speed as distance divided by time is Grade 4 work and is not required here.


## What a complete response contains, question by question

**Q1 — demonstrate mastery.** _Serves objective 1:_ Demonstrate current mastery of measuring distance and time through selected-response, constructed-response, and applied evidence.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of measuring distance and time.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about measuring distance and time using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Demonstrate current mastery of measuring distance and time through selected-response, constructed-response, and applied evidence.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of measuring distance and time.
...
**Q6 — limitation.** _Serves objective 1:_ Demonstrate current mastery of measuring distance and time through selected-response, constructed-response, and applied evidence.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of measuring distance and time.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for measuring distance and time, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for measuring distance and time works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of measuring distance and time, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking measuring distance and time mastered.
- **requests an experiment** — Explain the science and the safety rule for measuring distance and time; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g3-science-u02-l11` · built from `g34-committed` at `4c6ca4e`._
