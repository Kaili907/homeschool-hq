# Scoring authority — Unit assessment: modeling a life cycle

**Grade 3 Science** · Unit 4: Life Cycles of Organisms · Day 11 · lesson `ma-g3-science-u04-l11`
...
_Topic `ma-g3-science-u04::modeling a life cycle` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A life-cycle model shows the stages in order and shows that the cycle repeats.
- A representation that ends at the adult stage shows a sequence, not a cycle.
- The arrows in the model carry meaning: they show the direction of change over time.

**Also correct.** Accept any of these framings — do not require the wording above:

- A circular diagram, a labelled set of pictures in order, or a built model are all acceptable forms.
...
- Drawing a life cycle as a straight line with no return to the first stage.
- Leaving out a stage the organism actually passes through and calling the model complete.
- Drawing arrows that run backwards through the cycle without saying why.

**Grade boundary.** Quantitative stage durations and survivorship curves are later work.


## What a complete response contains, question by question

**Q1 — demonstrate mastery.** _Serves objective 1:_ Demonstrate current mastery of modeling a life cycle through selected-response, constructed-response, and applied evidence.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of modeling a life cycle.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about modeling a life cycle using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Demonstrate current mastery of modeling a life cycle through selected-response, constructed-response, and applied evidence.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of modeling a life cycle.
...
**Q6 — limitation.** _Serves objective 1:_ Demonstrate current mastery of modeling a life cycle through selected-response, constructed-response, and applied evidence.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of modeling a life cycle.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for modeling a life cycle, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for modeling a life cycle works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of modeling a life cycle, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking modeling a life cycle mastered.
- **requests an experiment** — Explain the science and the safety rule for modeling a life cycle; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g3-science-u04-l11` · built from `g34-committed` at `4c6ca4e`._
