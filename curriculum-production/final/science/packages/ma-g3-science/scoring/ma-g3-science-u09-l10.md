# Scoring authority — Synthesis and review: comparing solutions

**Grade 3 Science** · Unit 9: Capstone: Weather Hazards and Changing Habitats · Day 10 · lesson `ma-g3-science-u09-l10`
...
_Topic `ma-g3-science-u09::comparing solutions` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Solutions are compared against the same criteria and the same constraints.
- A solution can be better on one criterion and worse on another, and the comparison says so.
- The comparison reports what was tested, not what was hoped for.
...
- Declaring a solution best without stating the criteria used.
- Comparing two solutions against different criteria.
- Ignoring a criterion on which the preferred solution does badly.

**Grade boundary.** Weighted decision matrices and formal trade studies are later work.


## What a complete response contains, question by question

**Q1 — connect unit.** _Serves objective 1:_ Connect comparing solutions to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of comparing solutions.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about comparing solutions using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Connect comparing solutions to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of comparing solutions.
...
**Q6 — limitation.** _Serves objective 1:_ Connect comparing solutions to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of comparing solutions.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for comparing solutions, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for comparing solutions works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of comparing solutions, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking comparing solutions mastered.
- **requests an experiment** — Explain the science and the safety rule for comparing solutions; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g3-science-u09-l10` · built from `g34-committed` at `4c6ca4e`._
