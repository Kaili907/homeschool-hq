# Scoring authority — Performance task build: fossil evidence

**Grade 3 Science** · Unit 7: Fossils and Environments Long Ago · Day 9 · lesson `ma-g3-science-u07-l09`
...
_Topic `ma-g3-science-u07::fossil evidence` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Fossils are evidence about which organisms lived in a place and about the conditions there.
- A fossil in a rock layer shows the organism lived when that layer was forming, not when the fossil was found.
- Similar fossils in layers of the same age in different places link those places in time.
...
- Claiming a body fossil shows what the organism did; only trace fossils record behaviour.
- Claiming that finding no fossils of an organism proves it never lived there.
- Dating a fossil by when it was collected rather than by the layer it came from.

**Grade boundary.** Biostratigraphic correlation and continental drift are later work.
...
**Q1 — build product.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies fossil evidence and the unit standards.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of fossil evidence.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about fossil evidence using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies fossil evidence and the unit standards.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of fossil evidence.
...
**Q6 — limitation.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies fossil evidence and the unit standards.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of fossil evidence.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for fossil evidence, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for fossil evidence works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of fossil evidence, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking fossil evidence mastered.
- **requests an experiment** — Explain the science and the safety rule for fossil evidence; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g3-science-u07-l09` · built from `g34-committed` at `4c6ca4e`._
