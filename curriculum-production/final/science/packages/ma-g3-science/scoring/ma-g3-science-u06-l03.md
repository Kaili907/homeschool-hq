# Scoring authority — Guided practice A: habitat needs

**Grade 3 Science** · Unit 6: Living in Groups and Surviving in Habitats · Day 3 · lesson `ma-g3-science-u06-l03`
...
_Topic `ma-g3-science-u06::habitat needs` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._
...
**Q1 — guided practice.** _Serves objective 1:_ Practice habitat needs with prompts, feedback, and gradually reduced support.
...
**Q4 — essential question.** _Serves objective 1:_ Practice habitat needs with prompts, feedback, and gradually reduced support.
...
**Q6 — limitation.** _Serves objective 1:_ Practice habitat needs with prompts, feedback, and gradually reduced support.
...
_Package `swp-ma-g3-science-u06-l03` · built from `g34-committed` at `4c6ca4e`._
