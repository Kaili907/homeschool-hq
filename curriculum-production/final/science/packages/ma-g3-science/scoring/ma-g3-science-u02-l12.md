# Scoring authority — Correction and reflection: friction and surfaces

**Grade 3 Science** · Unit 2: Forces and Motion · Day 12 · lesson `ma-g3-science-u02-l12`
...
_Topic `ma-g3-science-u02::friction and surfaces` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Friction acts only between surfaces that are touching.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Friction is a force between surfaces that are touching, and it opposes sliding.
- Under otherwise identical conditions, a rougher pair of surfaces produces more friction than a smoother pair.
- Friction turns some of the energy of motion into thermal energy, which is why rubbed surfaces warm up.
...
- Claiming friction acts on an object when nothing is touching it.
- Claiming friction is always a problem; friction is what makes walking, gripping, and braking possible.
- Claiming a smoother surface always gives faster motion regardless of the other forces acting.

**Grade boundary.** Coefficients of friction, and the static-versus-kinetic distinction by name, are later work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for friction and surfaces, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of friction and surfaces.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about friction and surfaces using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for friction and surfaces, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of friction and surfaces.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for friction and surfaces, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of friction and surfaces.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for friction and surfaces, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for friction and surfaces works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of friction and surfaces, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking friction and surfaces mastered.
- **requests an experiment** — Explain the science and the safety rule for friction and surfaces; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g3-science-u02-l12` · built from `g34-committed` at `4c6ca4e`._
