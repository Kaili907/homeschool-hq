# Scoring authority — Concept model A: reading rock layers

**Grade 3 Science** · Unit 7: Fossils and Environments Long Ago · Day 2 · lesson `ma-g3-science-u07-l02`
...
**Q1 — model build.** _Serves objective 1:_ Build a clear mental model of reading rock layers through an explicit worked example, demonstration, text, or phenomenon.
...
**Q4 — essential question.** _Serves objective 1:_ Build a clear mental model of reading rock layers through an explicit worked example, demonstration, text, or phenomenon.
...
**Q6 — limitation.** _Serves objective 1:_ Build a clear mental model of reading rock layers through an explicit worked example, demonstration, text, or phenomenon.
...
_Package `swp-ma-g3-science-u07-l02` · built from `g34-committed` at `4c6ca4e`._
