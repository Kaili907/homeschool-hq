# Scoring authority — Investigation or close reading: magnetic attraction and repulsion

**Grade 3 Science** · Unit 3: Magnetic and Electric Interactions · Day 7 · lesson `ma-g3-science-u03-l07`
...
_Topic `ma-g3-science-u03::magnetic attraction and repulsion` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Magnets do not attract every metal. Aluminium and copper are metals and are not attracted.

**Accepted relationships and models.** What this lesson's learning target asserts:

- A magnet exerts a force on some materials without touching them.
- Magnets attract objects containing iron, nickel, or cobalt; they do not attract copper, aluminium, glass, plastic, or wood.
- The magnetic force between a magnet and an object weakens as the distance between them increases.

**Also correct.** Accept any of these framings — do not require the wording above:

- A learner who says 'magnetic materials' rather than naming iron, nickel, and cobalt is correct, provided the examples they give are right.
...
- Claiming magnets attract all metals.
- Claiming a magnet has to touch an object to affect it.
- Claiming the force is the same at every distance.

**Grade boundary.** Magnetic domains, field-strength units, and electromagnets are later work.
...
**Q1 — analyze evidence.** _Serves objective 1:_ Gather and analyze evidence related to magnetic attraction and repulsion, then record a defensible interpretation.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of magnetic attraction and repulsion.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about magnetic attraction and repulsion using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Gather and analyze evidence related to magnetic attraction and repulsion, then record a defensible interpretation.
...
**Q5 — evidence quality.** _Serves objective 1:_ Gather and analyze evidence related to magnetic attraction and repulsion, then record a defensible interpretation.
...
**Q6 — limitation.** _Serves objective 1:_ Gather and analyze evidence related to magnetic attraction and repulsion, then record a defensible interpretation.
...
**Q7 — provenance.** _Serves objective 1:_ Gather and analyze evidence related to magnetic attraction and repulsion, then record a defensible interpretation.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for magnetic attraction and repulsion, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for magnetic attraction and repulsion works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of magnetic attraction and repulsion, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking magnetic attraction and repulsion mastered.
- **requests an experiment** — Explain the science and the safety rule for magnetic attraction and repulsion; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
**Disposal and clearing up:** Put everything back where it came from, wash your hands, and throw away only ordinary household waste. Nothing in this lesson may be poured into a drain unless it is plain water, and nothing is left sealed, warm, connected, or unaccounted for.
...
_Grades 3-5 wording._ The learner's sheet carries a restatement of each prohibition and stop condition at their reading age. Every restatement is stricter than the adult clause it replaces — the fire instruction, for example, is unconditional evacuation with no smothering option. The adult clauses above are the ones in force; read them yourself before the session.
...
_Package `swp-ma-g3-science-u03-l07` · built from `g34-committed` at `4c6ca4e`._
