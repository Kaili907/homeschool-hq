# Scoring authority — Launch and diagnostic: magnetic attraction and repulsion

**Grade 3 Science** · Unit 3: Magnetic and Electric Interactions · Day 1 · lesson `ma-g3-science-u03-l01`
...
_Topic `ma-g3-science-u03::magnetic attraction and repulsion` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._
...
**Q1 — activate prior.** _Serves objective 1:_ Activate prior knowledge about magnetic attraction and repulsion, surface initial thinking without penalty, and establish the unit question.

A complete response records an initial idea that clearly predates instruction and names at least one specific entry in the learner's own record that confirmed or revised it. Score the honesty and the revisiting, never the correctness of the initial idea.
...
**Q4 — essential question.** _Serves objective 1:_ Activate prior knowledge about magnetic attraction and repulsion, surface initial thinking without penalty, and establish the unit question.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of magnetic attraction and repulsion.
...
**Q6 — limitation.** _Serves objective 1:_ Activate prior knowledge about magnetic attraction and repulsion, surface initial thinking without penalty, and establish the unit question.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of magnetic attraction and repulsion.
...
_Package `swp-ma-g3-science-u03-l01` · built from `g34-committed` at `4c6ca4e`._
