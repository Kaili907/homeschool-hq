# Scoring authority — Reteach and varied practice: magnet poles

**Grade 3 Science** · Unit 3: Magnetic and Electric Interactions · Day 8 · lesson `ma-g3-science-u03-l08`
...
_Topic `ma-g3-science-u03::magnet poles` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._
...
- Cutting a magnet in half gives two magnets, each with two poles; a piece with only one pole is never produced.
...
- Claiming like poles attract.
- Claiming a magnet can be cut to give a north-only piece.
- Claiming the north pole of a magnet is stronger than its south pole.

**Grade boundary.** Earth's magnetic field, polarity conventions, and magnetic declination are later work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for magnet poles, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of magnet poles.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about magnet poles using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for magnet poles, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of magnet poles.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for magnet poles, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of magnet poles.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for magnet poles, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for magnet poles works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of magnet poles, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking magnet poles mastered.
- **requests an experiment** — Explain the science and the safety rule for magnet poles; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g3-science-u03-l08` · built from `g34-committed` at `4c6ca4e`._
