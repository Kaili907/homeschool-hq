# Scoring authority — Unit assessment: climates in different regions

**Grade 3 Science** · Unit 8: Weather Patterns and World Climates · Day 11 · lesson `ma-g3-science-u08-l11`
...
_Topic `ma-g3-science-u08::climates in different regions` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._
...
- Climate varies with distance from the equator, height above sea level, and nearness to large bodies of water.
- Two places at the same distance from the equator can have different climates because of those other factors.
...
- Claiming distance from the equator alone determines climate.
- Claiming every place near the equator is a rainforest.
- Claiming a mountain top and the valley below it must share a climate because they are close together.

**Grade boundary.** Ocean currents and prevailing winds as mechanisms, and formal climate classes, are later work.


## What a complete response contains, question by question

**Q1 — demonstrate mastery.** _Serves objective 1:_ Demonstrate current mastery of climates in different regions through selected-response, constructed-response, and applied evidence.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of climates in different regions.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about climates in different regions using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Demonstrate current mastery of climates in different regions through selected-response, constructed-response, and applied evidence.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of climates in different regions.
...
**Q6 — limitation.** _Serves objective 1:_ Demonstrate current mastery of climates in different regions through selected-response, constructed-response, and applied evidence.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of climates in different regions.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for climates in different regions, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for climates in different regions works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of climates in different regions, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking climates in different regions mastered.
- **requests an experiment** — Explain the science and the safety rule for climates in different regions; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g3-science-u08-l11` · built from `g34-committed` at `4c6ca4e`._
