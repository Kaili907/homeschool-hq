# Scoring authority — Unit assessment: fair-testing a design

**Grade 3 Science** · Unit 9: Capstone: Weather Hazards and Changing Habitats · Day 11 · lesson `ma-g3-science-u09-l11`
...
_Topic `ma-g3-science-u09::fair-testing a design` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A design test changes one thing at a time and holds the rest the same, exactly as any fair test does.
- A test that shows a design failing is useful evidence and points to the revision.
- The test has to measure what the criterion states, not whatever is easiest to measure.
...
- Changing the design and the test conditions at the same time and crediting the difference to the design.
- Treating a failed test as a reason to stop rather than as evidence for revision.
- Measuring something other than what the criterion states and reporting it as the criterion.

**Grade boundary.** Statistical comparison of design variants is later work.


## What a complete response contains, question by question

**Q1 — demonstrate mastery.** _Serves objective 1:_ Demonstrate current mastery of fair-testing a design through selected-response, constructed-response, and applied evidence.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of fair-testing a design.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about fair-testing a design using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Demonstrate current mastery of fair-testing a design through selected-response, constructed-response, and applied evidence.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of fair-testing a design.
...
**Q6 — limitation.** _Serves objective 1:_ Demonstrate current mastery of fair-testing a design through selected-response, constructed-response, and applied evidence.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of fair-testing a design.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for fair-testing a design, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for fair-testing a design works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of fair-testing a design, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking fair-testing a design mastered.
- **requests an experiment** — Explain the science and the safety rule for fair-testing a design; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g3-science-u09-l11` · built from `g34-committed` at `4c6ca4e`._
