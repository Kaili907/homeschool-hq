# Scoring authority — Reteach and varied practice: habitat change

**Grade 3 Science** · Unit 9: Capstone: Weather Hazards and Changing Habitats · Day 8 · lesson `ma-g3-science-u09-l08`
...
_Topic `ma-g3-science-u09::habitat change` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- When a habitat changes, some organisms survive there, some move away, and some die.
- Changes can be sudden, such as a flood or fire, or gradual, such as a long drought.
- A change that harms one kind of organism can help another.
...
- Claiming every habitat change harms every organism in it.
- Claiming individual organisms adapt themselves to fit a changed habitat.
- Claiming a habitat that has changed can never support life again.

**Grade boundary.** Population-level change across generations is Grade 8 and High School work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for habitat change, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of habitat change.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about habitat change using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for habitat change, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of habitat change.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for habitat change, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of habitat change.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for habitat change, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for habitat change works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of habitat change, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking habitat change mastered.
- **requests an experiment** — Explain the science and the safety rule for habitat change; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g3-science-u09-l08` · built from `g34-committed` at `4c6ca4e`._
