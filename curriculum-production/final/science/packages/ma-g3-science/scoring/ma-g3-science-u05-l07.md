# Scoring authority — Investigation or close reading: inherited traits

**Grade 3 Science** · Unit 5: Inherited Traits and Variation · Day 7 · lesson `ma-g3-science-u05-l07`
...
_Topic `ma-g3-science-u05::inherited traits` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Organisms inherit many of their traits from their parents.
- Offspring resemble their parents but are not identical to them.
- Inheritance passes information from parent to offspring; it does not pass on what happened to the parent during its life.

**Also correct.** Accept any of these framings — do not require the wording above:

- Saying traits are 'passed down' or 'inherited' are both correct at this grade.
...
- Claiming offspring of two parents are identical copies of one parent.
- Claiming a trait a parent acquired during life, such as a scar or a learned skill, is inherited.
- Claiming every trait an organism has was inherited.

**Grade boundary.** Genes, chromosomes, dominance, and Punnett squares are Grade 8 and High School work.
...
**Q1 — analyze evidence.** _Serves objective 1:_ Gather and analyze evidence related to inherited traits, then record a defensible interpretation.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of inherited traits.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about inherited traits using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Gather and analyze evidence related to inherited traits, then record a defensible interpretation.
...
**Q5 — evidence quality.** _Serves objective 1:_ Gather and analyze evidence related to inherited traits, then record a defensible interpretation.
...
**Q6 — limitation.** _Serves objective 1:_ Gather and analyze evidence related to inherited traits, then record a defensible interpretation.
...
**Q7 — provenance.** _Serves objective 1:_ Gather and analyze evidence related to inherited traits, then record a defensible interpretation.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for inherited traits, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for inherited traits works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of inherited traits, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking inherited traits mastered.
- **requests an experiment** — Explain the science and the safety rule for inherited traits; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g3-science-u05-l07` · built from `g34-committed` at `4c6ca4e`._
