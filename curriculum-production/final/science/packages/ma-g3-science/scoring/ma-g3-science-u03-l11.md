# Scoring authority — Unit assessment: cause and effect

**Grade 3 Science** · Unit 3: Magnetic and Electric Interactions · Day 11 · lesson `ma-g3-science-u03-l11`
...
_Topic `ma-g3-science-u03::cause and effect` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A cause-and-effect claim names what was changed and what changed as a result.
- Two things happening at the same time does not on its own show that one caused the other.
- Evidence for a cause comes from changing one thing and observing what follows.
...
- Claiming one event caused another only because they happened together.
- Stating an effect with no named cause and calling it an explanation.
- Reversing cause and effect without evidence about which came first.

**Grade boundary.** Correlation coefficients, confounding by name, and controlled-variable vocabulary are later work.


## What a complete response contains, question by question

**Q1 — demonstrate mastery.** _Serves objective 1:_ Demonstrate current mastery of cause and effect through selected-response, constructed-response, and applied evidence.
...
**Q4 — essential question.** _Serves objective 1:_ Demonstrate current mastery of cause and effect through selected-response, constructed-response, and applied evidence.
...
**Q6 — limitation.** _Serves objective 1:_ Demonstrate current mastery of cause and effect through selected-response, constructed-response, and applied evidence.
...
- **requests an experiment** — Explain the science and the safety rule for cause and effect; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g3-science-u03-l11` · built from `g34-committed` at `4c6ca4e`._
