# Scoring authority — Unit assessment: measuring and recording data

**Grade 3 Science** · Unit 1: Science and Engineering Practices · Day 11 · lesson `ma-g3-science-u01-l11`
...
_Topic `ma-g3-science-u01::measuring and recording data` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- A measurement is incomplete without its unit.

**Accepted relationships and models.** What this lesson's learning target asserts:

- A measurement has both a number and a unit; the number alone does not say how much.
- The same quantity measured with the same tool by different people should agree closely, and a large disagreement is a signal to check the method.
- Data recorded in a table with labelled columns can be compared; loose notes usually cannot.

**Also correct.** Accept any of these framings — do not require the wording above:

- Metric and customary units are both acceptable, provided one system is used consistently within a comparison.
...
- Recording a bare number with no unit and treating it as a complete measurement.
- Changing a recorded measurement afterwards so it matches a prediction.
- Claiming a longer number is automatically a more accurate measurement.

**Grade boundary.** Significant figures, uncertainty ranges, and error propagation are later work.


## What a complete response contains, question by question

**Q1 — demonstrate mastery.** _Serves objective 1:_ Demonstrate current mastery of measuring and recording data through selected-response, constructed-response, and applied evidence.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of measuring and recording data.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about measuring and recording data using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Demonstrate current mastery of measuring and recording data through selected-response, constructed-response, and applied evidence.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of measuring and recording data.
...
**Q6 — limitation.** _Serves objective 1:_ Demonstrate current mastery of measuring and recording data through selected-response, constructed-response, and applied evidence.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of measuring and recording data.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for measuring and recording data, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for measuring and recording data works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of measuring and recording data, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking measuring and recording data mastered.
- **requests an experiment** — Explain the science and the safety rule for measuring and recording data; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g3-science-u01-l11` · built from `g34-committed` at `4c6ca4e`._
