# Scoring authority — Unit assessment: reading trait data

**Grade 3 Science** · Unit 5: Inherited Traits and Variation · Day 11 · lesson `ma-g3-science-u05-l11`
...
_Topic `ma-g3-science-u05::reading trait data` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Trait data from many individuals can be put in a table or graph to show how common each form of the trait is.
- The shape of the data, where most individuals fall and how spread out they are, is the evidence; no single individual is.
- A graph of trait data shows what was recorded and nothing more.
...
- Drawing a conclusion about the group from one individual's measurement.
- Reading the tallest bar as 'all' rather than 'most'.
- Claiming a trait is absent from a group because it did not appear in a small sample.

**Grade boundary.** Mean, median, spread, and the names of distributions are later work.


## What a complete response contains, question by question

**Q1 — demonstrate mastery.** _Serves objective 1:_ Demonstrate current mastery of reading trait data through selected-response, constructed-response, and applied evidence.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of reading trait data.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about reading trait data using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Demonstrate current mastery of reading trait data through selected-response, constructed-response, and applied evidence.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of reading trait data.
...
**Q6 — limitation.** _Serves objective 1:_ Demonstrate current mastery of reading trait data through selected-response, constructed-response, and applied evidence.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of reading trait data.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for reading trait data, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for reading trait data works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of reading trait data, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking reading trait data mastered.
- **requests an experiment** — Explain the science and the safety rule for reading trait data; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g3-science-u05-l11` · built from `g34-committed` at `4c6ca4e`._
