# Scoring authority — Performance task build: seasonal patterns

**Grade 3 Science** · Unit 8: Weather Patterns and World Climates · Day 9 · lesson `ma-g3-science-u08-l09`
...
_Topic `ma-g3-science-u08::seasonal patterns` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._
...
- At most places, weather varies in a repeating yearly pattern of seasons.
- A seasonal pattern is found by comparing records across several years, not one year.
- The seasons in the Northern and Southern Hemispheres are opposite to each other at the same time of year.
...
- Claiming seasons happen because Earth is closer to the Sun in summer.
- Claiming every year's weather matches the seasonal average exactly.
- Claiming the whole world has summer at the same time.

**Grade boundary.** The tilt of Earth's axis as the mechanism is Grade 5 and Grade 8 work and is not required here; a learner who states it correctly is right.
...
**Q1 — build product.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies seasonal patterns and the unit standards.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of seasonal patterns.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about seasonal patterns using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies seasonal patterns and the unit standards.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of seasonal patterns.
...
**Q6 — limitation.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies seasonal patterns and the unit standards.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of seasonal patterns.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for seasonal patterns, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for seasonal patterns works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of seasonal patterns, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking seasonal patterns mastered.
- **requests an experiment** — Explain the science and the safety rule for seasonal patterns; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g3-science-u08-l09` · built from `g34-committed` at `4c6ca4e`._
