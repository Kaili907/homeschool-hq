# Scoring authority — Correction and reflection: evidence from observation

**Grade 3 Science** · Unit 5: Inherited Traits and Variation · Day 12 · lesson `ma-g3-science-u05-l12`
...
_Topic `ma-g3-science-u05::evidence from observation` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A claim about traits is supported by recorded observations of real organisms, or by published records of them.
- Evidence has to bear on the claim being made; observations of a different trait do not support it.
- The source of an observation is named so that a reader can check it.
...
- Supporting a trait claim with an opinion or a story rather than a recorded observation.
- Offering evidence that does not bear on the claim.
- Presenting an invented observation as a real one.

**Grade boundary.** Sampling design and statistical significance are later work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for evidence from observation, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of evidence from observation.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about evidence from observation using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for evidence from observation, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of evidence from observation.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for evidence from observation, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of evidence from observation.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for evidence from observation, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for evidence from observation works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of evidence from observation, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking evidence from observation mastered.
- **requests an experiment** — Explain the science and the safety rule for evidence from observation; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g3-science-u05-l12` · built from `g34-committed` at `4c6ca4e`._
