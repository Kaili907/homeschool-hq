# Scoring authority — Investigation or close reading: what fossils are

**Grade 3 Science** · Unit 7: Fossils and Environments Long Ago · Day 7 · lesson `ma-g3-science-u07-l07`
...
_Topic `ma-g3-science-u07::what fossils are` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._
...
- A fossil is preserved evidence of an organism that lived in the past: a body part, an impression, or a trace such as a footprint or burrow.
- Most fossils form in sedimentary rock, when remains are buried by sediment before they decay away.
- Only a very small fraction of organisms ever become fossils, so the fossil record is incomplete.

**Also correct.** Accept any of these framings — do not require the wording above:

- Body fossils and trace fossils are both fossils; a learner who names only one kind is not wrong unless they deny the other.
...
- Claiming a fossil is the organism's actual unchanged body.
- Claiming the fossil record contains every organism that ever lived.
- Claiming a rock that merely looks like an organism is a fossil.

**Grade boundary.** Mineral replacement chemistry, taphonomy, and index fossils are later work.
...
**Q1 — analyze evidence.** _Serves objective 1:_ Gather and analyze evidence related to what fossils are, then record a defensible interpretation.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of what fossils are.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about what fossils are using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Gather and analyze evidence related to what fossils are, then record a defensible interpretation.
...
**Q5 — evidence quality.** _Serves objective 1:_ Gather and analyze evidence related to what fossils are, then record a defensible interpretation.
...
**Q6 — limitation.** _Serves objective 1:_ Gather and analyze evidence related to what fossils are, then record a defensible interpretation.
...
**Q7 — provenance.** _Serves objective 1:_ Gather and analyze evidence related to what fossils are, then record a defensible interpretation.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for what fossils are, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for what fossils are works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of what fossils are, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking what fossils are mastered.
- **requests an experiment** — Explain the science and the safety rule for what fossils are; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g3-science-u07-l07` · built from `g34-committed` at `4c6ca4e`._
