# Scoring authority — Synthesis and review: surviving well or less well

**Grade 3 Science** · Unit 6: Living in Groups and Surviving in Habitats · Day 10 · lesson `ma-g3-science-u06-l10`
...
_Topic `ma-g3-science-u06::surviving well or less well` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- In a particular habitat, some variations of a trait help an individual survive and reproduce better than other variations do.
- The same trait can be an advantage in one habitat and a disadvantage in another.
- Surviving well means surviving and reproducing, not being the largest or the strongest.
...
- Calling a trait better without naming the habitat it is better in.
- Claiming an organism develops a trait because it needs it.
- Claiming the strongest individual always survives.

**Grade boundary.** Natural selection as a mechanism acting over generations is Grade 8 and High School work.


## What a complete response contains, question by question

**Q1 — connect unit.** _Serves objective 1:_ Connect surviving well or less well to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of surviving well or less well.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about surviving well or less well using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Connect surviving well or less well to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of surviving well or less well.
...
**Q6 — limitation.** _Serves objective 1:_ Connect surviving well or less well to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of surviving well or less well.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for surviving well or less well, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for surviving well or less well works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of surviving well or less well, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking surviving well or less well mastered.
- **requests an experiment** — Explain the science and the safety rule for surviving well or less well; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g3-science-u06-l10` · built from `g34-committed` at `4c6ca4e`._
