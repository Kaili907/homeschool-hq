# Scoring authority — Unit assessment: constructing an argument

**Grade 3 Science** · Unit 6: Living in Groups and Surviving in Habitats · Day 11 · lesson `ma-g3-science-u06-l11`
...
_Topic `ma-g3-science-u06::constructing an argument` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A scientific argument states a claim, gives evidence, and explains how the evidence supports the claim.
- The reasoning step is what connects evidence to claim; without it the argument is a claim with data sitting beside it.
- An argument is judged on the fit between claim, evidence, and reasoning, not on how strongly it is stated.
...
- Presenting a claim and data with no reasoning linking them.
- Giving reasoning that does not use the evidence presented.
- Treating confident wording as a substitute for evidence.

**Grade boundary.** Counter-argument and rebuttal structure are later work.


## What a complete response contains, question by question

**Q1 — demonstrate mastery.** _Serves objective 1:_ Demonstrate current mastery of constructing an argument through selected-response, constructed-response, and applied evidence.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of constructing an argument.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about constructing an argument using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Demonstrate current mastery of constructing an argument through selected-response, constructed-response, and applied evidence.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of constructing an argument.
...
**Q6 — limitation.** _Serves objective 1:_ Demonstrate current mastery of constructing an argument through selected-response, constructed-response, and applied evidence.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of constructing an argument.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for constructing an argument, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for constructing an argument works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of constructing an argument, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking constructing an argument mastered.
- **requests an experiment** — Explain the science and the safety rule for constructing an argument; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g3-science-u06-l11` · built from `g34-committed` at `4c6ca4e`._
