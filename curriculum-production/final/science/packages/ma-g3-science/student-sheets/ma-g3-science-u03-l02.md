# Concept model A: magnet poles

**Grade 3 Science** · Unit 3: Magnetic and Electric Interactions · Day 2 of the unit (course day 26) · about 40–55 minutes

**Today's focus:** magnet poles
...
- Build a clear mental model of magnet poles through an explicit worked example, demonstration, text, or phenomenon.
- Use subject-appropriate evidence or representation to communicate understanding of magnet poles.
- Check, revise, or improve work about magnet poles using stated success criteria.
...
- Science brief: like poles repel; unlike poles attract.
- Science brief: every magnet has both a north and a south pole.
- Science brief: every magnet has two poles, called north and south.
- Science brief: like poles repel each other and unlike poles attract each other.

### Evidence check: magnet poles

**Candidate claim:** A case report presents this as acceptable science: “like poles attract.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: like poles repel; unlike poles attract. |
| E2 | established science reference | Science brief: every magnet has both a north and a south pole. |
| E3 | established science reference | Science brief: every magnet has two poles, called north and south. |
| E4 | established science reference | Science brief: like poles repel each other and unlike poles attract each other. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u03::magnet poles, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about magnet poles, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about magnet poles, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about magnet poles; then identify one check that would catch an error or weak claim.**
...
**Q1.** Build a labelled model of magnet poles that represents every supplied row in E1-E4. Annotate each model feature with its evidence ID, then show where the candidate claim fails or remains uncertain.

>

**Q2.** Communicate what the supplied record establishes about magnet poles in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about magnet poles against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using magnet poles as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about magnet poles? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about magnet poles that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about magnet poles. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about magnet poles.
...
- Apply magnet poles under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect magnet poles to magnetic attraction and repulsion from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g3-science-u03-l02` · lesson `ma-g3-science-u03-l02` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
