# Guided practice A: insect life cycles

**Grade 3 Science** · Unit 4: Life Cycles of Organisms · Day 3 of the unit (course day 39) · about 40–55 minutes
...
- Practice insect life cycles with prompts, feedback, and gradually reduced support.
...
**The task.** What does evidence E1 through E4 justify about insect life cycles, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**Q1.** First compare E1 with E2 and write a provisional conclusion about insect life cycles. Then add the remaining rows through E4, revise the conclusion, and explain the change.
...
_Package `swp-ma-g3-science-u04-l03` · lesson `ma-g3-science-u04-l03` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
