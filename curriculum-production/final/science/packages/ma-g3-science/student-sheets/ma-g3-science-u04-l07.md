# Investigation or close reading: birth, growth, reproduction, and death

**Grade 3 Science** · Unit 4: Life Cycles of Organisms · Day 7 of the unit (course day 43) · about 40–55 minutes

**Today's focus:** birth, growth, reproduction, and death

**Unit question:** How can understanding life cycles of organisms help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Gather and analyze evidence related to birth, growth, reproduction, and death, then record a defensible interpretation.
- Use subject-appropriate evidence or representation to communicate understanding of birth, growth, reproduction, and death.
- Check, revise, or improve work about birth, growth, reproduction, and death using stated success criteria.
...
- Science brief: all organisms have life cycles that include being born or germinating, growing, reproducing, and dying.
- Science brief: all organisms have life cycles that include being born or germinating, growing, reproducing, and dying.
- Science brief: the particular stages differ between kinds of organism, but the overall birth-growth-reproduction-death pattern is shared.
- Science brief: different kinds of organism take characteristically different lengths of time to complete a life cycle.

### Evidence check: birth, growth, reproduction, and death

**Candidate claim:** A case report presents this as acceptable science: “some organisms never die.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: all organisms have life cycles that include being born or germinating, growing, reproducing, and dying. |
| E2 | established science reference | Science brief: all organisms have life cycles that include being born or germinating, growing, reproducing, and dying. |
| E3 | established science reference | Science brief: the particular stages differ between kinds of organism, but the overall birth-growth-reproduction-death pattern is shared. |
| E4 | established science reference | Science brief: different kinds of organism take characteristically different lengths of time to complete a life cycle. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u04::birth, growth, reproduction, and death, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.

**Supplied unit connections:** birth, growth, reproduction, and death; plant life cycles; insect life cycles; comparing life cycles; modeling a life cycle; diverse but shared patterns

**Supplied unit performance task:** Develop and revise a model that describes the life cycle of a plant and an animal and names the stages they share.

### Bound task

**Question:** What does evidence E1 through E4 justify about birth, growth, reproduction, and death, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about birth, growth, reproduction, and death?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g3-science-u04::birth, growth, reproduction, and death, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u04::birth, growth, reproduction, and death, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about birth, growth, reproduction, and death?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about birth, growth, reproduction, and death; then identify one check that would catch an error or weak claim.**
...
**Q1.** Classify every supplied row E1-E4 as supports, challenges, or does not decide the candidate claim about birth, growth, reproduction, and death. Cite the row and explain each classification.

>

**Q2.** Communicate what the supplied record establishes about birth, growth, reproduction, and death in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about birth, growth, reproduction, and death against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using birth, growth, reproduction, and death as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about birth, growth, reproduction, and death? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about birth, growth, reproduction, and death that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about birth, growth, reproduction, and death. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about birth, growth, reproduction, and death.
...
- Apply birth, growth, reproduction, and death under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect birth, growth, reproduction, and death to plant life cycles from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Develop and revise a model that describes the life cycle of a plant and an animal and names the stages they share. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-g3-science-u04-l07` · lesson `ma-g3-science-u04-l07` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
