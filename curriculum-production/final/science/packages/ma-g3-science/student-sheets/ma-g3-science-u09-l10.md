# Synthesis and review: comparing solutions

**Grade 3 Science** · Unit 9: Capstone: Weather Hazards and Changing Habitats · Day 10 of the unit (course day 106) · about 40–55 minutes
...
- Connect comparing solutions to the unit’s other ideas and select evidence that shows readiness for assessment.
...
- Science brief: solutions are compared against the same criteria and the same constraints.
- Science brief: a solution can be better on one criterion and worse on another, and the comparison says so.
- Science brief: the comparison reports what was tested, not what was hoped for.

### Evidence check: comparing solutions

**Candidate claim:** A case report presents this as acceptable science: “declaring a solution best without stating the criteria used.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: solutions are compared against the same criteria and the same constraints. |
...
| E3 | established science reference | Science brief: the comparison reports what was tested, not what was hoped for. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u09::comparing solutions, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Q1.** The supplied unit connections are: weather-related hazards, habitat change, design criteria and constraints, comparing solutions, fair-testing a design, evidence-based claims. Choose one idea other than comparing solutions, connect it to one row in E1-E3, and explain one way treating the two ideas as identical would be misleading.
...
- Connect comparing solutions to weather-related hazards from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g3-science-u09-l10` · lesson `ma-g3-science-u09-l10` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
