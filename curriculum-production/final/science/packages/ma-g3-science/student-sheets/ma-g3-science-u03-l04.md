# Independent application A: static electric interactions

**Grade 3 Science** · Unit 3: Magnetic and Electric Interactions · Day 4 of the unit (course day 28) · about 40–55 minutes
...
- Apply static electric interactions independently in a new representation, text, situation, or design constraint.
...
**Q1.** Independently evaluate this fully supplied case about static electric interactions: A case report presents this as acceptable science: “rubbing creates charge out of nothing, rather than moving it from one object to the other.” Use at least two rows from E1-E4, correct the claim if needed, and state one limit.
...
_Package `swp-ma-g3-science-u03-l04` · lesson `ma-g3-science-u03-l04` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
