...
**Grade 3 Science** · Unit 1: Science and Engineering Practices · Day 4 of the unit (course day 4) · about 40–55 minutes
...
**Q1.** Independently evaluate this fully supplied case about fair tests: A case report presents this as acceptable science: “calling a test fair when two or more conditions were changed at the same time.” Use at least two rows from E1-E4, correct the claim if needed, and state one limit.
...
_Package `swp-ma-g3-science-u01-l04` · lesson `ma-g3-science-u01-l04` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
