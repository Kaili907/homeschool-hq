# Concept model A: benefits of living in groups

**Grade 3 Science** · Unit 6: Living in Groups and Surviving in Habitats · Day 2 of the unit (course day 62) · about 40–55 minutes
...
- Build a clear mental model of benefits of living in groups through an explicit worked example, demonstration, text, or phenomenon.
...
**Q1.** Build a labelled model of benefits of living in groups that represents every supplied row in E1-E3. Annotate each model feature with its evidence ID, then show where the candidate claim fails or remains uncertain.
...
_Package `swp-ma-g3-science-u06-l02` · lesson `ma-g3-science-u06-l02` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
