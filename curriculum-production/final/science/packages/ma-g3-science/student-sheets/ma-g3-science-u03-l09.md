# Performance task build: forces without contact

**Grade 3 Science** · Unit 3: Magnetic and Electric Interactions · Day 9 of the unit (course day 33) · about 40–55 minutes

**Today's focus:** forces without contact
...
- Create, test, or revise a meaningful product that applies forces without contact and the unit standards.
- Use subject-appropriate evidence or representation to communicate understanding of forces without contact.
- Check, revise, or improve work about forces without contact using stated success criteria.
...
- Science brief: magnetic and electric forces act between objects that are not touching.
- Science brief: gravity also acts without contact.
- Science brief: the strength of a non-contact force depends on the distance between the objects and on properties of the objects themselves.

### Evidence check: forces without contact

**Candidate claim:** A case report presents this as acceptable science: “every force needs contact.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: magnetic and electric forces act between objects that are not touching. |
| E2 | established science reference | Science brief: gravity also acts without contact. |
| E3 | established science reference | Science brief: the strength of a non-contact force depends on the distance between the objects and on properties of the objects themselves. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u03::forces without contact, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about forces without contact, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about forces without contact?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g3-science-u03::forces without contact, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u03::forces without contact, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about forces without contact?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about forces without contact; then identify one check that would catch an error or weak claim.**
...
**Q1.** Create a one-page evidence product for forces without contact using only the supplied case and E1-E3: one claim, at least two cited rows, the reasoning link, one counterpoint, and one revision after checking the success criteria.

>

**Q2.** Communicate what the supplied record establishes about forces without contact in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about forces without contact against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using forces without contact as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about forces without contact? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about forces without contact that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about forces without contact. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about forces without contact.
...
- Apply forces without contact under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect forces without contact to magnetic attraction and repulsion from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g3-science-u03-l09` · lesson `ma-g3-science-u03-l09` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
