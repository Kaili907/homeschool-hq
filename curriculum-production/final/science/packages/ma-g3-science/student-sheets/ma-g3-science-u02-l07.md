# Investigation or close reading: pushes and pulls

**Grade 3 Science** · Unit 2: Forces and Motion · Day 7 of the unit (course day 19) · about 40–55 minutes

**Today's focus:** pushes and pulls

**Unit question:** How can understanding forces and motion help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Gather and analyze evidence related to pushes and pulls, then record a defensible interpretation.
- Use subject-appropriate evidence or representation to communicate understanding of pushes and pulls.
- Check, revise, or improve work about pushes and pulls using stated success criteria.
...
- Science brief: a force is a push or a pull.
- Science brief: a force is a push or a pull on an object, and it comes from an interaction between two objects.
- Science brief: a force has both a strength and a direction.
- Science brief: a force can start motion, stop motion, change speed, or change direction.

### Evidence check: pushes and pulls

**Candidate claim:** A case report presents this as acceptable science: “an object exerts a force on itself, or that a moving object carries a stored force inside it.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a force is a push or a pull. |
| E2 | established science reference | Science brief: a force is a push or a pull on an object, and it comes from an interaction between two objects. |
| E3 | established science reference | Science brief: a force has both a strength and a direction. |
| E4 | established science reference | Science brief: a force can start motion, stop motion, change speed, or change direction. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u02::pushes and pulls, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about pushes and pulls, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about pushes and pulls?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g3-science-u02::pushes and pulls, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u02::pushes and pulls, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about pushes and pulls?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about pushes and pulls; then identify one check that would catch an error or weak claim.**
...
**Q1.** Classify every supplied row E1-E4 as supports, challenges, or does not decide the candidate claim about pushes and pulls. Cite the row and explain each classification.

>

**Q2.** Communicate what the supplied record establishes about pushes and pulls in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about pushes and pulls against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using pushes and pulls as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about pushes and pulls? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about pushes and pulls that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about pushes and pulls. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about pushes and pulls.
...
- Apply pushes and pulls under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect pushes and pulls to balanced and unbalanced forces from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g3-science-u02-l07` · lesson `ma-g3-science-u02-l07` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
