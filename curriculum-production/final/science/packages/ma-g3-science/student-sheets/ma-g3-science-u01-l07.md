...
**Grade 3 Science** · Unit 1: Science and Engineering Practices · Day 7 of the unit (course day 7) · about 40–55 minutes
...
- Science brief: an observation is information taken in directly, through the senses or through a tool such as a hand lens, ruler, or thermometer.
- Science brief: an inference is an explanation of what an observation might mean; the same observation can support more than one inference.
- Science brief: an observation recorded at the time it is made is more reliable than one recalled later, because memory changes.

### Evidence check: careful observations

**Candidate claim:** A case report presents this as acceptable science: “recording an inference as an observation, such as writing 'the plant is thirsty' instead of 'the leaves are drooping'.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: an observation is information taken in directly, through the senses or through a tool such as a hand lens, ruler, or thermometer. |
| E2 | established science reference | Science brief: an inference is an explanation of what an observation might mean; the same observation can support more than one inference. |
| E3 | established science reference | Science brief: an observation recorded at the time it is made is more reliable than one recalled later, because memory changes. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u01::careful observations, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g3-science-u01::careful observations, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u01::careful observations, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
_Package `swp-ma-g3-science-u01-l07` · lesson `ma-g3-science-u01-l07` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
