# Performance task build: patterns in motion

**Grade 3 Science** · Unit 2: Forces and Motion · Day 9 of the unit (course day 21) · about 40–55 minutes

**Today's focus:** patterns in motion

**Unit question:** How can understanding forces and motion help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Create, test, or revise a meaningful product that applies patterns in motion and the unit standards.
- Use subject-appropriate evidence or representation to communicate understanding of patterns in motion.
- Check, revise, or improve work about patterns in motion using stated success criteria.
...
- Science brief: motion that repeats regularly, such as a swing, a spinning wheel, or a ball rolling down the same ramp, can be observed, described, and used to predict what happens next.
- Science brief: a pattern is established by repeated observation; something seen once is not yet a pattern.
- Science brief: a pattern supports a prediction only while the conditions that produced it stay the same.

### Evidence check: patterns in motion

**Candidate claim:** A case report presents this as acceptable science: “calling a single observation a pattern and predicting from it.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: motion that repeats regularly, such as a swing, a spinning wheel, or a ball rolling down the same ramp, can be observed, described, and used to predict what happens next. |
| E2 | established science reference | Science brief: a pattern is established by repeated observation; something seen once is not yet a pattern. |
| E3 | established science reference | Science brief: a pattern supports a prediction only while the conditions that produced it stay the same. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u02::patterns in motion, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.

**Supplied unit connections:** pushes and pulls; balanced and unbalanced forces; patterns in motion; predicting motion; measuring distance and time; friction and surfaces

**Supplied unit performance task:** Plan and carry out an adult-approved investigation of balanced and unbalanced forces, then use a motion pattern to predict what happens next.

### Bound task

**Question:** What does evidence E1 through E3 justify about patterns in motion, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about patterns in motion?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g3-science-u02::patterns in motion, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u02::patterns in motion, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about patterns in motion?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about patterns in motion; then identify one check that would catch an error or weak claim.**
...
**Q1.** Create a one-page evidence product for patterns in motion using only the supplied case and E1-E3: one claim, at least two cited rows, the reasoning link, one counterpoint, and one revision after checking the success criteria.

>

**Q2.** Communicate what the supplied record establishes about patterns in motion in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about patterns in motion against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using patterns in motion as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about patterns in motion? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about patterns in motion that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about patterns in motion. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about patterns in motion.
...
- Apply patterns in motion under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect patterns in motion to pushes and pulls from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Plan and carry out an adult-approved investigation of balanced and unbalanced forces, then use a motion pattern to predict what happens next. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-g3-science-u02-l09` · lesson `ma-g3-science-u02-l09` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
