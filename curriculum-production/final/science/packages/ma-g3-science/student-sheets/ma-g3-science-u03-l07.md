# Investigation or close reading: magnetic attraction and repulsion

**Grade 3 Science** · Unit 3: Magnetic and Electric Interactions · Day 7 of the unit (course day 31) · about 40–55 minutes

**Today's focus:** magnetic attraction and repulsion

**Unit question:** How can understanding magnetic and electric interactions help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Gather and analyze evidence related to magnetic attraction and repulsion, then record a defensible interpretation.
- Use subject-appropriate evidence or representation to communicate understanding of magnetic attraction and repulsion.
- Check, revise, or improve work about magnetic attraction and repulsion using stated success criteria.
...
- Science brief: magnets do not attract every metal. Aluminium and copper are metals and are not attracted.
- Science brief: a magnet exerts a force on some materials without touching them.
- Science brief: magnets attract objects containing iron, nickel, or cobalt; they do not attract copper, aluminium, glass, plastic, or wood.
- Science brief: the magnetic force between a magnet and an object weakens as the distance between them increases.

### Evidence check: magnetic attraction and repulsion

**Candidate claim:** A case report presents this as acceptable science: “magnets attract all metals.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: magnets do not attract every metal. Aluminium and copper are metals and are not attracted. |
| E2 | established science reference | Science brief: a magnet exerts a force on some materials without touching them. |
| E3 | established science reference | Science brief: magnets attract objects containing iron, nickel, or cobalt; they do not attract copper, aluminium, glass, plastic, or wood. |
| E4 | established science reference | Science brief: the magnetic force between a magnet and an object weakens as the distance between them increases. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u03::magnetic attraction and repulsion, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.

**Supplied unit connections:** magnetic attraction and repulsion; magnet poles; forces without contact; static electric interactions; cause and effect; solving a problem with magnets

**Supplied unit performance task:** Investigate magnetic and electric interactions that act at a distance, then define and sketch a simple device that solves a problem using magnets.

### Bound task

**Question:** What does evidence E1 through E4 justify about magnetic attraction and repulsion, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about magnetic attraction and repulsion?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g3-science-u03::magnetic attraction and repulsion, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u03::magnetic attraction and repulsion, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about magnetic attraction and repulsion?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about magnetic attraction and repulsion; then identify one check that would catch an error or weak claim.**
...
**Q1.** Classify every supplied row E1-E4 as supports, challenges, or does not decide the candidate claim about magnetic attraction and repulsion. Cite the row and explain each classification.

>

**Q2.** Communicate what the supplied record establishes about magnetic attraction and repulsion in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about magnetic attraction and repulsion against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using magnetic attraction and repulsion as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about magnetic attraction and repulsion? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about magnetic attraction and repulsion that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about magnetic attraction and repulsion. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about magnetic attraction and repulsion.
...
- Apply magnetic attraction and repulsion under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect magnetic attraction and repulsion to magnet poles from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Investigate magnetic and electric interactions that act at a distance, then define and sketch a simple device that solves a problem using magnets. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-g3-science-u03-l07` · lesson `ma-g3-science-u03-l07` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
