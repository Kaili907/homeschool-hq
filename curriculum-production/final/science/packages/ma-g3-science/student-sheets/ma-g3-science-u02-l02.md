# Concept model A: balanced and unbalanced forces

**Grade 3 Science** · Unit 2: Forces and Motion · Day 2 of the unit (course day 14) · about 40–55 minutes
...
- Build a clear mental model of balanced and unbalanced forces through an explicit worked example, demonstration, text, or phenomenon.
...
**Q1.** Build a labelled model of balanced and unbalanced forces that represents every supplied row in E1-E4. Annotate each model feature with its evidence ID, then show where the candidate claim fails or remains uncertain.
...
_Package `swp-ma-g3-science-u02-l02` · lesson `ma-g3-science-u02-l02` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
