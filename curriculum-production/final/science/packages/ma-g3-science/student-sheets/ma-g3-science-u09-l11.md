# Unit assessment: fair-testing a design

**Grade 3 Science** · Unit 9: Capstone: Weather Hazards and Changing Habitats · Day 11 of the unit (course day 107) · about 40–55 minutes

**Today's focus:** fair-testing a design
...
- Demonstrate current mastery of fair-testing a design through selected-response, constructed-response, and applied evidence.
- Use subject-appropriate evidence or representation to communicate understanding of fair-testing a design.
- Check, revise, or improve work about fair-testing a design using stated success criteria.
...
- Science brief: a design test changes one thing at a time and holds the rest the same, exactly as any fair test does.
- Science brief: a test that shows a design failing is useful evidence and points to the revision.
- Science brief: the test has to measure what the criterion states, not whatever is easiest to measure.

### Evidence check: fair-testing a design

**Candidate claim:** A case report presents this as acceptable science: “changing the design and the test conditions at the same time and crediting the difference to the design.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a design test changes one thing at a time and holds the rest the same, exactly as any fair test does. |
| E2 | established science reference | Science brief: a test that shows a design failing is useful evidence and points to the revision. |
| E3 | established science reference | Science brief: the test has to measure what the criterion states, not whatever is easiest to measure. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u09::fair-testing a design, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about fair-testing a design, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about fair-testing a design, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? Rate confidence in fair-testing a design, cite one piece of evidence from today, and choose: ready to extend, ready to review later, or need a different explanation.**
...
**Q1.** Complete all three parts for fair-testing a design. (1) Select A: supported, B: partly supported, or C: not supported for the candidate claim. (2) Justify the selection with E1-E3. (3) Rewrite the claim so every word is supported by the supplied record.

>

**Q2.** Communicate what the supplied record establishes about fair-testing a design in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about fair-testing a design against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using fair-testing a design as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about fair-testing a design? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about fair-testing a design that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about fair-testing a design. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about fair-testing a design.
...
- Apply fair-testing a design under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect fair-testing a design to weather-related hazards from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g3-science-u09-l11` · lesson `ma-g3-science-u09-l11` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
