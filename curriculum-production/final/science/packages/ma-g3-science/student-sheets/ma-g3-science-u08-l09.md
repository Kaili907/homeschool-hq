# Performance task build: seasonal patterns

**Grade 3 Science** · Unit 8: Weather Patterns and World Climates · Day 9 of the unit (course day 93) · about 40–55 minutes

**Today's focus:** seasonal patterns

**Unit question:** How can understanding weather patterns and world climates help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Create, test, or revise a meaningful product that applies seasonal patterns and the unit standards.
- Use subject-appropriate evidence or representation to communicate understanding of seasonal patterns.
- Check, revise, or improve work about seasonal patterns using stated success criteria.
...
- Science brief: when it is summer in the Northern Hemisphere it is winter in the Southern Hemisphere.
- Science brief: at most places, weather varies in a repeating yearly pattern of seasons.
- Science brief: a seasonal pattern is found by comparing records across several years, not one year.
- Science brief: the seasons in the Northern and Southern Hemispheres are opposite to each other at the same time of year.

### Evidence check: seasonal patterns

**Candidate claim:** A case report presents this as acceptable science: “seasons happen because Earth is closer to the Sun in summer.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: when it is summer in the Northern Hemisphere it is winter in the Southern Hemisphere. |
| E2 | established science reference | Science brief: at most places, weather varies in a repeating yearly pattern of seasons. |
| E3 | established science reference | Science brief: a seasonal pattern is found by comparing records across several years, not one year. |
| E4 | established science reference | Science brief: the seasons in the Northern and Southern Hemispheres are opposite to each other at the same time of year. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u08::seasonal patterns, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.

**Supplied unit connections:** daily weather data; tables and graphs; seasonal patterns; weather compared with climate; climates in different regions; combining information sources

**Supplied unit performance task:** Represent a season of provided weather data in a table and graph, then combine sources to compare climates in two world regions.

### Bound task

**Question:** What does evidence E1 through E4 justify about seasonal patterns, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about seasonal patterns?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g3-science-u08::seasonal patterns, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u08::seasonal patterns, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about seasonal patterns?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about seasonal patterns; then identify one check that would catch an error or weak claim.**
...
**Q1.** Create a one-page evidence product for seasonal patterns using only the supplied case and E1-E4: one claim, at least two cited rows, the reasoning link, one counterpoint, and one revision after checking the success criteria.

>

**Q2.** Communicate what the supplied record establishes about seasonal patterns in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about seasonal patterns against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using seasonal patterns as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about seasonal patterns? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about seasonal patterns that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about seasonal patterns. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about seasonal patterns.
...
- Apply seasonal patterns under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect seasonal patterns to daily weather data from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Represent a season of provided weather data in a table and graph, then combine sources to compare climates in two world regions. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-g3-science-u08-l09` · lesson `ma-g3-science-u08-l09` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
