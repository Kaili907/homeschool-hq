# Investigation or close reading: inherited traits

**Grade 3 Science** · Unit 5: Inherited Traits and Variation · Day 7 of the unit (course day 55) · about 40–55 minutes

**Today's focus:** inherited traits
...
- Gather and analyze evidence related to inherited traits, then record a defensible interpretation.
- Use subject-appropriate evidence or representation to communicate understanding of inherited traits.
- Check, revise, or improve work about inherited traits using stated success criteria.
...
- Science brief: organisms inherit many of their traits from their parents.
- Science brief: offspring resemble their parents but are not identical to them.
- Science brief: inheritance passes information from parent to offspring; it does not pass on what happened to the parent during its life.

### Evidence check: inherited traits

**Candidate claim:** A case report presents this as acceptable science: “offspring of two parents are identical copies of one parent.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: organisms inherit many of their traits from their parents. |
| E2 | established science reference | Science brief: offspring resemble their parents but are not identical to them. |
| E3 | established science reference | Science brief: inheritance passes information from parent to offspring; it does not pass on what happened to the parent during its life. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u05::inherited traits, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.

**Supplied unit connections:** inherited traits; variation within a group; comparing parents and offspring; traits influenced by environment; reading trait data; evidence from observation

**Supplied unit performance task:** Analyze a provided trait data set, then explain with evidence which traits are inherited and which are influenced by the environment.

### Bound task

**Question:** What does evidence E1 through E3 justify about inherited traits, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about inherited traits?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g3-science-u05::inherited traits, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u05::inherited traits, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about inherited traits?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about inherited traits; then identify one check that would catch an error or weak claim.**
...
**Q1.** Classify every supplied row E1-E3 as supports, challenges, or does not decide the candidate claim about inherited traits. Cite the row and explain each classification.

>

**Q2.** Communicate what the supplied record establishes about inherited traits in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about inherited traits against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using inherited traits as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about inherited traits? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about inherited traits that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about inherited traits. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about inherited traits.
...
- Apply inherited traits under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect inherited traits to variation within a group from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g3-science-u05-l07` · lesson `ma-g3-science-u05-l07` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
