# Correction and reflection: combining information sources

**Grade 3 Science** · Unit 8: Weather Patterns and World Climates · Day 12 of the unit (course day 96) · about 40–55 minutes

**Today's focus:** combining information sources
...
- Use error evidence to choose a different representation or strategy for combining information sources, then demonstrate corrected understanding.
- Use subject-appropriate evidence or representation to communicate understanding of combining information sources.
- Check, revise, or improve work about combining information sources using stated success criteria.
...
- Science brief: a conclusion about weather or climate is stronger when it draws on more than one record or source.
- Science brief: each source is named so a reader can check it.
- Science brief: sources that disagree are information in themselves; the disagreement is reported, not hidden.

### Evidence check: combining information sources

**Candidate claim:** A case report presents this as acceptable science: “presenting a combined conclusion with no sources named.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a conclusion about weather or climate is stronger when it draws on more than one record or source. |
| E2 | established science reference | Science brief: each source is named so a reader can check it. |
| E3 | established science reference | Science brief: sources that disagree are information in themselves; the disagreement is reported, not hidden. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u08::combining information sources, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about combining information sources, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about combining information sources, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about combining information sources; then identify one check that would catch an error or weak claim.**
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E3. Name the decisive evidence ID, explain the error about combining information sources, and write a corrected claim.

>

**Q2.** Communicate what the supplied record establishes about combining information sources in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about combining information sources against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using combining information sources as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about combining information sources? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about combining information sources that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about combining information sources. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about combining information sources.
...
- Apply combining information sources under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect combining information sources to daily weather data from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g3-science-u08-l12` · lesson `ma-g3-science-u08-l12` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
