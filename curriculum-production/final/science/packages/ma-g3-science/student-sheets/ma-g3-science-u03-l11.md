# Unit assessment: cause and effect

**Grade 3 Science** · Unit 3: Magnetic and Electric Interactions · Day 11 of the unit (course day 35) · about 40–55 minutes

**Today's focus:** cause and effect
...
- Demonstrate current mastery of cause and effect through selected-response, constructed-response, and applied evidence.
- Use subject-appropriate evidence or representation to communicate understanding of cause and effect.
- Check, revise, or improve work about cause and effect using stated success criteria.
...
- Science brief: a cause-and-effect claim names what was changed and what changed as a result.
- Science brief: two things happening at the same time does not on its own show that one caused the other.
- Science brief: evidence for a cause comes from changing one thing and observing what follows.

### Evidence check: cause and effect

**Candidate claim:** A case report presents this as acceptable science: “one event caused another only because they happened together.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a cause-and-effect claim names what was changed and what changed as a result. |
| E2 | established science reference | Science brief: two things happening at the same time does not on its own show that one caused the other. |
| E3 | established science reference | Science brief: evidence for a cause comes from changing one thing and observing what follows. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u03::cause and effect, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about cause and effect, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about cause and effect, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? Rate confidence in cause and effect, cite one piece of evidence from today, and choose: ready to extend, ready to review later, or need a different explanation.**
...
**Q1.** Complete all three parts for cause and effect. (1) Select A: supported, B: partly supported, or C: not supported for the candidate claim. (2) Justify the selection with E1-E3. (3) Rewrite the claim so every word is supported by the supplied record.

>

**Q2.** Communicate what the supplied record establishes about cause and effect in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about cause and effect against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using cause and effect as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about cause and effect? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about cause and effect that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about cause and effect. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about cause and effect.
...
- Apply cause and effect under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect cause and effect to magnetic attraction and repulsion from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g3-science-u03-l11` · lesson `ma-g3-science-u03-l11` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
