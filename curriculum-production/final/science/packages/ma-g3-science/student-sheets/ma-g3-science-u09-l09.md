# Performance task build: design criteria and constraints

**Grade 3 Science** · Unit 9: Capstone: Weather Hazards and Changing Habitats · Day 9 of the unit (course day 105) · about 40–55 minutes

**Today's focus:** design criteria and constraints

**Unit question:** How can understanding weather hazards and changing habitats help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Create, test, or revise a meaningful product that applies design criteria and constraints and the unit standards.
- Use subject-appropriate evidence or representation to communicate understanding of design criteria and constraints.
- Check, revise, or improve work about design criteria and constraints using stated success criteria.
...
- Science brief: a hazard-reduction design states what it must achieve, which are its criteria, and the limits it must respect, which are its constraints, including safety and cost.
- Science brief: the problem is defined before solutions are generated.
- Science brief: a design that breaks a stated constraint has not solved the problem, however well it meets the criteria.

### Evidence check: design criteria and constraints

**Candidate claim:** A case report presents this as acceptable science: “proposing a solution before stating what it has to achieve.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a hazard-reduction design states what it must achieve, which are its criteria, and the limits it must respect, which are its constraints, including safety and cost. |
| E2 | established science reference | Science brief: the problem is defined before solutions are generated. |
| E3 | established science reference | Science brief: a design that breaks a stated constraint has not solved the problem, however well it meets the criteria. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u09::design criteria and constraints, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.

**Supplied unit connections:** weather-related hazards; habitat change; design criteria and constraints; comparing solutions; fair-testing a design; evidence-based claims

**Supplied unit performance task:** Design, fair-test, and improve a model solution that reduces the impact of a weather hazard or a habitat change, then defend its merit with evidence.

### Bound task

**Question:** What does evidence E1 through E3 justify about design criteria and constraints, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about design criteria and constraints?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g3-science-u09::design criteria and constraints, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u09::design criteria and constraints, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about design criteria and constraints?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about design criteria and constraints; then identify one check that would catch an error or weak claim.**
...
**Q1.** Create a one-page evidence product for design criteria and constraints using only the supplied case and E1-E3: one claim, at least two cited rows, the reasoning link, one counterpoint, and one revision after checking the success criteria.

>

**Q2.** Communicate what the supplied record establishes about design criteria and constraints in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about design criteria and constraints against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using design criteria and constraints as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about design criteria and constraints? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about design criteria and constraints that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about design criteria and constraints. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about design criteria and constraints.
...
- Apply design criteria and constraints under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect design criteria and constraints to weather-related hazards from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Design, fair-test, and improve a model solution that reduces the impact of a weather hazard or a habitat change, then defend its merit with evidence. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-g3-science-u09-l09` · lesson `ma-g3-science-u09-l09` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
