# Reteach and varied practice: balanced and unbalanced forces

**Grade 3 Science** · Unit 2: Forces and Motion · Day 8 of the unit (course day 20) · about 40–55 minutes

**Today's focus:** balanced and unbalanced forces

**Unit question:** How can understanding forces and motion help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Use error evidence to choose a different representation or strategy for balanced and unbalanced forces, then demonstrate corrected understanding.
- Use subject-appropriate evidence or representation to communicate understanding of balanced and unbalanced forces.
- Check, revise, or improve work about balanced and unbalanced forces using stated success criteria.
...
- Science brief: balanced forces do not change an object's motion; unbalanced forces do.
- Science brief: when the forces on an object are balanced, its motion does not change: at rest it stays at rest, and moving it keeps the same speed and direction.
- Science brief: when the forces on an object are unbalanced, its motion changes.
- Science brief: balanced does not mean no forces are acting; it means the forces cancel each other.

### Evidence check: balanced and unbalanced forces

**Candidate claim:** A case report presents this as acceptable science: “an object sitting still has no forces acting on it.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: balanced forces do not change an object's motion; unbalanced forces do. |
| E2 | established science reference | Science brief: when the forces on an object are balanced, its motion does not change: at rest it stays at rest, and moving it keeps the same speed and direction. |
| E3 | established science reference | Science brief: when the forces on an object are unbalanced, its motion changes. |
| E4 | established science reference | Science brief: balanced does not mean no forces are acting; it means the forces cancel each other. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u02::balanced and unbalanced forces, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about balanced and unbalanced forces, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about balanced and unbalanced forces, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about balanced and unbalanced forces; then identify one check that would catch an error or weak claim.**
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E4. Name the decisive evidence ID, explain the error about balanced and unbalanced forces, and write a corrected claim.

>

**Q2.** Communicate what the supplied record establishes about balanced and unbalanced forces in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about balanced and unbalanced forces against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using balanced and unbalanced forces as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about balanced and unbalanced forces? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about balanced and unbalanced forces that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about balanced and unbalanced forces. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about balanced and unbalanced forces.
...
- Apply balanced and unbalanced forces under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect balanced and unbalanced forces to pushes and pulls from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g3-science-u02-l08` · lesson `ma-g3-science-u02-l08` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
