# Performance task build: insect life cycles

**Grade 3 Science** · Unit 4: Life Cycles of Organisms · Day 9 of the unit (course day 45) · about 40–55 minutes

**Today's focus:** insect life cycles
...
- Create, test, or revise a meaningful product that applies insect life cycles and the unit standards.
- Use subject-appropriate evidence or representation to communicate understanding of insect life cycles.
- Check, revise, or improve work about insect life cycles using stated success criteria.
...
- Science brief: complete metamorphosis is egg, larva, pupa, adult.
- Science brief: incomplete metamorphosis is egg, nymph, adult, with no pupal stage.
- Science brief: many insects undergo complete metamorphosis: egg, larva, pupa, adult.
- Science brief: other insects undergo incomplete metamorphosis: egg, nymph, adult, with no pupal stage.

### Evidence check: insect life cycles

**Candidate claim:** A case report presents this as acceptable science: “every insect passes through a pupal stage.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: complete metamorphosis is egg, larva, pupa, adult. |
| E2 | established science reference | Science brief: incomplete metamorphosis is egg, nymph, adult, with no pupal stage. |
| E3 | established science reference | Science brief: many insects undergo complete metamorphosis: egg, larva, pupa, adult. |
| E4 | established science reference | Science brief: other insects undergo incomplete metamorphosis: egg, nymph, adult, with no pupal stage. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u04::insect life cycles, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about insect life cycles, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about insect life cycles?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g3-science-u04::insect life cycles, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u04::insect life cycles, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about insect life cycles?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about insect life cycles; then identify one check that would catch an error or weak claim.**
...
**Q1.** Create a one-page evidence product for insect life cycles using only the supplied case and E1-E4: one claim, at least two cited rows, the reasoning link, one counterpoint, and one revision after checking the success criteria.

>

**Q2.** Communicate what the supplied record establishes about insect life cycles in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about insect life cycles against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using insect life cycles as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about insect life cycles? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about insect life cycles that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about insect life cycles. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about insect life cycles.
...
- Apply insect life cycles under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect insect life cycles to birth, growth, reproduction, and death from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g3-science-u04-l09` · lesson `ma-g3-science-u04-l09` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
