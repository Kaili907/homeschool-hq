# Independent application A: weather compared with climate

**Grade 3 Science** · Unit 8: Weather Patterns and World Climates · Day 4 of the unit (course day 88) · about 40–55 minutes
...
- Apply weather compared with climate independently in a new representation, text, situation, or design constraint.
...
**Q1.** Independently evaluate this fully supplied case about weather compared with climate: A case report presents this as acceptable science: “using a single day's weather as evidence about climate.” Use at least two rows from E1-E4, correct the claim if needed, and state one limit.
...
_Package `swp-ma-g3-science-u08-l04` · lesson `ma-g3-science-u08-l04` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
