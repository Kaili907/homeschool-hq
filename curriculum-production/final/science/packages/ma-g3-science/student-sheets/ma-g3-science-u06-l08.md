# Reteach and varied practice: benefits of living in groups

**Grade 3 Science** · Unit 6: Living in Groups and Surviving in Habitats · Day 8 of the unit (course day 68) · about 40–55 minutes

**Today's focus:** benefits of living in groups
...
- Use error evidence to choose a different representation or strategy for benefits of living in groups, then demonstrate corrected understanding.
- Use subject-appropriate evidence or representation to communicate understanding of benefits of living in groups.
- Check, revise, or improve work about benefits of living in groups using stated success criteria.
...
- Science brief: groups can help members find food, defend against predators, care for young, and cope with harsh conditions.
- Science brief: group living also has costs, such as competition for food inside the group and faster spread of disease.
- Science brief: whether group living helps depends on the environment; it is not an advantage everywhere.

### Evidence check: benefits of living in groups

**Candidate claim:** A case report presents this as acceptable science: “group living has benefits and no costs.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: groups can help members find food, defend against predators, care for young, and cope with harsh conditions. |
| E2 | established science reference | Science brief: group living also has costs, such as competition for food inside the group and faster spread of disease. |
| E3 | established science reference | Science brief: whether group living helps depends on the environment; it is not an advantage everywhere. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u06::benefits of living in groups, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about benefits of living in groups, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about benefits of living in groups, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about benefits of living in groups; then identify one check that would catch an error or weak claim.**
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E3. Name the decisive evidence ID, explain the error about benefits of living in groups, and write a corrected claim.

>

**Q2.** Communicate what the supplied record establishes about benefits of living in groups in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about benefits of living in groups against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using benefits of living in groups as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about benefits of living in groups? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about benefits of living in groups that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about benefits of living in groups. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about benefits of living in groups.
...
- Apply benefits of living in groups under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect benefits of living in groups to animal groups from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g3-science-u06-l08` · lesson `ma-g3-science-u06-l08` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
