# Investigation or close reading: animal groups

**Grade 3 Science** · Unit 6: Living in Groups and Surviving in Habitats · Day 7 of the unit (course day 67) · about 40–55 minutes

**Today's focus:** animal groups
...
- Gather and analyze evidence related to animal groups, then record a defensible interpretation.
- Use subject-appropriate evidence or representation to communicate understanding of animal groups.
- Check, revise, or improve work about animal groups using stated success criteria.
...
- Science brief: some animals live in groups that vary in size and organisation; others live alone for most of their lives.
- Science brief: living in a group is a behaviour, and like other traits it varies between kinds of animal.
- Science brief: a group of animals is many organisms together, not one large organism.

### Evidence check: animal groups

**Candidate claim:** A case report presents this as acceptable science: “all animals of a kind live in groups.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: some animals live in groups that vary in size and organisation; others live alone for most of their lives. |
| E2 | established science reference | Science brief: living in a group is a behaviour, and like other traits it varies between kinds of animal. |
| E3 | established science reference | Science brief: a group of animals is many organisms together, not one large organism. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u06::animal groups, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about animal groups, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about animal groups?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g3-science-u06::animal groups, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u06::animal groups, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about animal groups?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about animal groups; then identify one check that would catch an error or weak claim.**
...
**Q1.** Classify every supplied row E1-E3 as supports, challenges, or does not decide the candidate claim about animal groups. Cite the row and explain each classification.

>

**Q2.** Communicate what the supplied record establishes about animal groups in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about animal groups against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using animal groups as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about animal groups? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about animal groups that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about animal groups. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about animal groups.
...
- Apply animal groups under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect animal groups to benefits of living in groups from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g3-science-u06-l07` · lesson `ma-g3-science-u06-l07` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
