# Synthesis and review: traits influenced by environment

**Grade 3 Science** · Unit 5: Inherited Traits and Variation · Day 10 of the unit (course day 58) · about 40–55 minutes

**Today's focus:** traits influenced by environment
...
- Connect traits influenced by environment to the unit’s other ideas and select evidence that shows readiness for assessment.
- Use subject-appropriate evidence or representation to communicate understanding of traits influenced by environment.
- Check, revise, or improve work about traits influenced by environment using stated success criteria.
...
- Science brief: some traits are affected by the environment: food, water, light, temperature, exercise, and injury.
- Science brief: two organisms with the same inheritance can end up different if they grow in different environments.
- Science brief: an environmental effect on one organism is not passed to its offspring by inheritance.

### Evidence check: traits influenced by environment

**Candidate claim:** A case report presents this as acceptable science: “every difference between two organisms is inherited.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: some traits are affected by the environment: food, water, light, temperature, exercise, and injury. |
| E2 | established science reference | Science brief: two organisms with the same inheritance can end up different if they grow in different environments. |
| E3 | established science reference | Science brief: an environmental effect on one organism is not passed to its offspring by inheritance. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u05::traits influenced by environment, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about traits influenced by environment, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about traits influenced by environment, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about traits influenced by environment; then identify one check that would catch an error or weak claim.**
...
**Q1.** The supplied unit connections are: inherited traits, variation within a group, comparing parents and offspring, traits influenced by environment, reading trait data, evidence from observation. Choose one idea other than traits influenced by environment, connect it to one row in E1-E3, and explain one way treating the two ideas as identical would be misleading.

>

**Q2.** Communicate what the supplied record establishes about traits influenced by environment in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about traits influenced by environment against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using traits influenced by environment as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about traits influenced by environment? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about traits influenced by environment that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about traits influenced by environment. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about traits influenced by environment.
...
- Apply traits influenced by environment under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect traits influenced by environment to inherited traits from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g3-science-u05-l10` · lesson `ma-g3-science-u05-l10` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
