# Independent application A: environments long ago

**Grade 3 Science** · Unit 7: Fossils and Environments Long Ago · Day 4 of the unit (course day 76) · about 40–55 minutes
...
- Apply environments long ago independently in a new representation, text, situation, or design constraint.
...
**Q1.** Independently evaluate this fully supplied case about environments long ago: A case report presents this as acceptable science: “the environment where a fossil is found today must always have been the same.” Use at least two rows from E1-E4, correct the claim if needed, and state one limit.
...
_Package `swp-ma-g3-science-u07-l04` · lesson `ma-g3-science-u07-l04` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
