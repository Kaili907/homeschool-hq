# Launch and diagnostic: birth, growth, reproduction, and death

**Grade 3 Science** · Unit 4: Life Cycles of Organisms · Day 1 of the unit (course day 37) · about 40–55 minutes
...
- Activate prior knowledge about birth, growth, reproduction, and death, surface initial thinking without penalty, and establish the unit question.
...
**The task.** What does evidence E1 through E4 justify about birth, growth, reproduction, and death, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**Q1.** Before rereading the brief, classify the supplied candidate claim about birth, growth, reproduction, and death as supported, partly supported, or not supported. Then read E1-E4, revise the classification, and name the evidence ID that changed or confirmed your thinking.
...
_Package `swp-ma-g3-science-u04-l01` · lesson `ma-g3-science-u04-l01` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
