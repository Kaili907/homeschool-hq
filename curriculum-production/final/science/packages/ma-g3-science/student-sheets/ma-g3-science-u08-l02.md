# Concept model A: tables and graphs

**Grade 3 Science** · Unit 8: Weather Patterns and World Climates · Day 2 of the unit (course day 86) · about 40–55 minutes

**Today's focus:** tables and graphs
...
- Build a clear mental model of tables and graphs through an explicit worked example, demonstration, text, or phenomenon.
- Use subject-appropriate evidence or representation to communicate understanding of tables and graphs.
- Check, revise, or improve work about tables and graphs using stated success criteria.
...
- Science brief: a table organises weather data so values can be compared; a graph shows the pattern in those values.
- Science brief: a graph needs labelled axes with units, or a reader cannot tell what is shown.
- Science brief: a graph shows what was recorded; it does not add information that was never measured.

### Evidence check: tables and graphs

**Candidate claim:** A case report presents this as acceptable science: “reading a trend off a graph with unlabelled axes.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a table organises weather data so values can be compared; a graph shows the pattern in those values. |
| E2 | established science reference | Science brief: a graph needs labelled axes with units, or a reader cannot tell what is shown. |
| E3 | established science reference | Science brief: a graph shows what was recorded; it does not add information that was never measured. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u08::tables and graphs, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about tables and graphs, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about tables and graphs, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about tables and graphs; then identify one check that would catch an error or weak claim.**
...
**Q1.** Build a labelled model of tables and graphs that represents every supplied row in E1-E3. Annotate each model feature with its evidence ID, then show where the candidate claim fails or remains uncertain.

>

**Q2.** Communicate what the supplied record establishes about tables and graphs in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about tables and graphs against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using tables and graphs as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about tables and graphs? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about tables and graphs that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about tables and graphs. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about tables and graphs.
...
- Apply tables and graphs under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect tables and graphs to daily weather data from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g3-science-u08-l02` · lesson `ma-g3-science-u08-l02` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
