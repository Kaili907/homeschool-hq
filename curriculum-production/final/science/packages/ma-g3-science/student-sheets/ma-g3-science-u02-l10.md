# Synthesis and review: predicting motion

**Grade 3 Science** · Unit 2: Forces and Motion · Day 10 of the unit (course day 22) · about 40–55 minutes

**Today's focus:** predicting motion

**Unit question:** How can understanding forces and motion help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Connect predicting motion to the unit’s other ideas and select evidence that shows readiness for assessment.
- Use subject-appropriate evidence or representation to communicate understanding of predicting motion.
- Check, revise, or improve work about predicting motion using stated success criteria.
...
- Science brief: if the pattern of an object's past motion is known and the conditions stay the same, its future motion can be predicted.
- Science brief: a prediction is stated before the observation; a statement made afterwards is an explanation, not a prediction.
- Science brief: a prediction that turns out wrong is evidence, and it is recorded as it was made.

### Evidence check: predicting motion

**Candidate claim:** A case report presents this as acceptable science: “rewriting a prediction after seeing the result.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: if the pattern of an object's past motion is known and the conditions stay the same, its future motion can be predicted. |
| E2 | established science reference | Science brief: a prediction is stated before the observation; a statement made afterwards is an explanation, not a prediction. |
| E3 | established science reference | Science brief: a prediction that turns out wrong is evidence, and it is recorded as it was made. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u02::predicting motion, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about predicting motion, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about predicting motion, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about predicting motion; then identify one check that would catch an error or weak claim.**
...
**Q1.** The supplied unit connections are: pushes and pulls, balanced and unbalanced forces, patterns in motion, predicting motion, measuring distance and time, friction and surfaces. Choose one idea other than predicting motion, connect it to one row in E1-E3, and explain one way treating the two ideas as identical would be misleading.

>

**Q2.** Communicate what the supplied record establishes about predicting motion in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about predicting motion against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using predicting motion as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about predicting motion? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about predicting motion that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about predicting motion. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about predicting motion.
...
- Apply predicting motion under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect predicting motion to pushes and pulls from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g3-science-u02-l10` · lesson `ma-g3-science-u02-l10` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
