...
**Grade 3 Science** · Unit 1: Science and Engineering Practices · Day 12 of the unit (course day 12) · about 40–55 minutes
...
- Science brief: criteria are what a successful solution must do; constraints are the limits it must work within, such as materials, cost, time, or safety.
- Science brief: the problem is defined before solutions are compared, so that every solution is judged against the same criteria.
- Science brief: a solution can meet every criterion and still be rejected because it breaks a constraint.
...
| --- | --- | --- |
| E1 | established science reference | Science brief: criteria are what a successful solution must do; constraints are the limits it must work within, such as materials, cost, time, or safety. |
| E2 | established science reference | Science brief: the problem is defined before solutions are compared, so that every solution is judged against the same criteria. |
| E3 | established science reference | Science brief: a solution can meet every criterion and still be rejected because it breaks a constraint. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u01::criteria and constraints, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
_Package `swp-ma-g3-science-u01-l12` · lesson `ma-g3-science-u01-l12` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
