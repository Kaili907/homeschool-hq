# Independent application A: predicting motion

**Grade 3 Science** · Unit 2: Forces and Motion · Day 4 of the unit (course day 16) · about 40–55 minutes
...
- Apply predicting motion independently in a new representation, text, situation, or design constraint.
...
**Q1.** Independently evaluate this fully supplied case about predicting motion: A case report presents this as acceptable science: “rewriting a prediction after seeing the result.” Use at least two rows from E1-E3, correct the claim if needed, and state one limit.
...
_Package `swp-ma-g3-science-u02-l04` · lesson `ma-g3-science-u02-l04` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
