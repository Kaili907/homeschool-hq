# Performance task build: models and drawings

**Grade 3 Science** · Unit 1: Science and Engineering Practices · Day 9 of the unit (course day 9) · about 40–55 minutes

**Today's focus:** models and drawings
...
- Create, test, or revise a meaningful product that applies models and drawings and the unit standards.
- Use subject-appropriate evidence or representation to communicate understanding of models and drawings.
- Check, revise, or improve work about models and drawings using stated success criteria.
...
- Science brief: a model is a representation used to show or explain how something works: a drawing, diagram, physical build, or acted-out sequence.
- Science brief: every model leaves something out. What it leaves out is a limitation of the model, not a mistake by the learner.
- Science brief: a model is judged by what it explains and predicts about the thing it stands for, not by how attractive it looks.

### Evidence check: models and drawings

**Candidate claim:** A case report presents this as acceptable science: “a model must look exactly like the real thing to be a good model.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a model is a representation used to show or explain how something works: a drawing, diagram, physical build, or acted-out sequence. |
| E2 | established science reference | Science brief: every model leaves something out. What it leaves out is a limitation of the model, not a mistake by the learner. |
| E3 | established science reference | Science brief: a model is judged by what it explains and predicts about the thing it stands for, not by how attractive it looks. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u01::models and drawings, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about models and drawings, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about models and drawings?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g3-science-u01::models and drawings, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u01::models and drawings, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about models and drawings?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about models and drawings; then identify one check that would catch an error or weak claim.**
...
**Q1.** Create a one-page evidence product for models and drawings using only the supplied case and E1-E3: one claim, at least two cited rows, the reasoning link, one counterpoint, and one revision after checking the success criteria.

>

**Q2.** Communicate what the supplied record establishes about models and drawings in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about models and drawings against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using models and drawings as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about models and drawings? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about models and drawings that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about models and drawings. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about models and drawings.
...
- Apply models and drawings under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect models and drawings to careful observations from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g3-science-u01-l09` · lesson `ma-g3-science-u01-l09` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
