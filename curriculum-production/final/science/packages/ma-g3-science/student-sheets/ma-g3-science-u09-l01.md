# Launch and diagnostic: weather-related hazards

**Grade 3 Science** · Unit 9: Capstone: Weather Hazards and Changing Habitats · Day 1 of the unit (course day 97) · about 40–55 minutes
...
- Activate prior knowledge about weather-related hazards, surface initial thinking without penalty, and establish the unit question.
...
**The task.** What does evidence E1 through E3 justify about weather-related hazards, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**Q1.** Before rereading the brief, classify the supplied candidate claim about weather-related hazards as supported, partly supported, or not supported. Then read E1-E3, revise the classification, and name the evidence ID that changed or confirmed your thinking.
...
_Package `swp-ma-g3-science-u09-l01` · lesson `ma-g3-science-u09-l01` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
