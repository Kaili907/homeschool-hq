# Investigation or close reading: what fossils are

**Grade 3 Science** · Unit 7: Fossils and Environments Long Ago · Day 7 of the unit (course day 79) · about 40–55 minutes

**Today's focus:** what fossils are

**Unit question:** How can understanding fossils and environments long ago help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Gather and analyze evidence related to what fossils are, then record a defensible interpretation.
- Use subject-appropriate evidence or representation to communicate understanding of what fossils are.
- Check, revise, or improve work about what fossils are using stated success criteria.
...
- Science brief: a fossil is preserved evidence of an organism that lived in the past.
- Science brief: a fossil is preserved evidence of an organism that lived in the past: a body part, an impression, or a trace such as a footprint or burrow.
- Science brief: most fossils form in sedimentary rock, when remains are buried by sediment before they decay away.
- Science brief: only a very small fraction of organisms ever become fossils, so the fossil record is incomplete.

### Evidence check: what fossils are

**Candidate claim:** A case report presents this as acceptable science: “a fossil is the organism's actual unchanged body.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a fossil is preserved evidence of an organism that lived in the past. |
| E2 | established science reference | Science brief: a fossil is preserved evidence of an organism that lived in the past: a body part, an impression, or a trace such as a footprint or burrow. |
| E3 | established science reference | Science brief: most fossils form in sedimentary rock, when remains are buried by sediment before they decay away. |
| E4 | established science reference | Science brief: only a very small fraction of organisms ever become fossils, so the fossil record is incomplete. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u07::what fossils are, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.

**Supplied unit connections:** what fossils are; reading rock layers; fossil evidence; environments long ago; comparing past and present; variation and advantage

**Supplied unit performance task:** Interpret a provided fossil data set to describe an ancient Michigan-area environment and explain how trait variation can help organisms survive.

### Bound task

**Question:** What does evidence E1 through E4 justify about what fossils are, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about what fossils are?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g3-science-u07::what fossils are, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u07::what fossils are, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about what fossils are?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about what fossils are; then identify one check that would catch an error or weak claim.**
...
**Q1.** Classify every supplied row E1-E4 as supports, challenges, or does not decide the candidate claim about what fossils are. Cite the row and explain each classification.

>

**Q2.** Communicate what the supplied record establishes about what fossils are in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about what fossils are against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using what fossils are as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about what fossils are? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about what fossils are that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about what fossils are. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about what fossils are.
...
- Apply what fossils are under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect what fossils are to reading rock layers from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Interpret a provided fossil data set to describe an ancient Michigan-area environment and explain how trait variation can help organisms survive. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-g3-science-u07-l07` · lesson `ma-g3-science-u07-l07` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
