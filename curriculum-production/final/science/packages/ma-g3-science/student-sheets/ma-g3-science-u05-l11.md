# Unit assessment: reading trait data

**Grade 3 Science** · Unit 5: Inherited Traits and Variation · Day 11 of the unit (course day 59) · about 40–55 minutes

**Today's focus:** reading trait data
...
- Demonstrate current mastery of reading trait data through selected-response, constructed-response, and applied evidence.
- Use subject-appropriate evidence or representation to communicate understanding of reading trait data.
- Check, revise, or improve work about reading trait data using stated success criteria.
...
- Science brief: trait data from many individuals can be put in a table or graph to show how common each form of the trait is.
- Science brief: the shape of the data, where most individuals fall and how spread out they are, is the evidence; no single individual is.
- Science brief: a graph of trait data shows what was recorded and nothing more.

### Evidence check: reading trait data

**Candidate claim:** A case report presents this as acceptable science: “drawing a conclusion about the group from one individual's measurement.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: trait data from many individuals can be put in a table or graph to show how common each form of the trait is. |
| E2 | established science reference | Science brief: the shape of the data, where most individuals fall and how spread out they are, is the evidence; no single individual is. |
| E3 | established science reference | Science brief: a graph of trait data shows what was recorded and nothing more. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u05::reading trait data, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about reading trait data, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about reading trait data, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? Rate confidence in reading trait data, cite one piece of evidence from today, and choose: ready to extend, ready to review later, or need a different explanation.**
...
**Q1.** Complete all three parts for reading trait data. (1) Select A: supported, B: partly supported, or C: not supported for the candidate claim. (2) Justify the selection with E1-E3. (3) Rewrite the claim so every word is supported by the supplied record.

>

**Q2.** Communicate what the supplied record establishes about reading trait data in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about reading trait data against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using reading trait data as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about reading trait data? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about reading trait data that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about reading trait data. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about reading trait data.
...
- Apply reading trait data under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect reading trait data to inherited traits from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g3-science-u05-l11` · lesson `ma-g3-science-u05-l11` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
