# Launch and diagnostic: inherited traits

**Grade 3 Science** · Unit 5: Inherited Traits and Variation · Day 1 of the unit (course day 49) · about 40–55 minutes
...
- Activate prior knowledge about inherited traits, surface initial thinking without penalty, and establish the unit question.
...
**The task.** What does evidence E1 through E3 justify about inherited traits, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**Q1.** Before rereading the brief, classify the supplied candidate claim about inherited traits as supported, partly supported, or not supported. Then read E1-E3, revise the classification, and name the evidence ID that changed or confirmed your thinking.
...
_Package `swp-ma-g3-science-u05-l01` · lesson `ma-g3-science-u05-l01` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
