...
**Grade 3 Science** · Unit 1: Science and Engineering Practices · Day 10 of the unit (course day 10) · about 40–55 minutes
...
- Science brief: in a fair test only one thing is changed on purpose.
- Science brief: in a fair test one thing is changed on purpose and everything else that could affect the result is kept the same.
- Science brief: if more than one thing changes at once, you cannot tell which change caused the result.
- Science brief: repeating a test gives more confidence in the result than a single try does.

### Evidence check: fair tests

**Candidate claim:** A case report presents this as acceptable science: “calling a test fair when two or more conditions were changed at the same time.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: in a fair test only one thing is changed on purpose. |
| E2 | established science reference | Science brief: in a fair test one thing is changed on purpose and everything else that could affect the result is kept the same. |
| E3 | established science reference | Science brief: if more than one thing changes at once, you cannot tell which change caused the result. |
| E4 | established science reference | Science brief: repeating a test gives more confidence in the result than a single try does. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u01::fair tests, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Q1.** The supplied unit connections are: careful observations, testable questions, models and drawings, fair tests, measuring and recording data, criteria and constraints. Choose one idea other than fair tests, connect it to one row in E1-E4, and explain one way treating the two ideas as identical would be misleading.
...
_Package `swp-ma-g3-science-u01-l10` · lesson `ma-g3-science-u01-l10` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
