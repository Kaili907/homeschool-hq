# Synthesis and review: environments long ago

**Grade 3 Science** · Unit 7: Fossils and Environments Long Ago · Day 10 of the unit (course day 82) · about 40–55 minutes

**Today's focus:** environments long ago
...
- Connect environments long ago to the unit’s other ideas and select evidence that shows readiness for assessment.
- Use subject-appropriate evidence or representation to communicate understanding of environments long ago.
- Check, revise, or improve work about environments long ago using stated success criteria.
...
- Science brief: fossils of sea organisms in rock far from any sea are evidence that the area was once under water.
- Science brief: fossils of organisms that live in particular conditions today are evidence that similar conditions existed where those fossils formed.
- Science brief: marine fossils found far inland are evidence that the area was once covered by water.
- Science brief: environments change over long spans of time.

### Evidence check: environments long ago

**Candidate claim:** A case report presents this as acceptable science: “the environment where a fossil is found today must always have been the same.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: fossils of sea organisms in rock far from any sea are evidence that the area was once under water. |
| E2 | established science reference | Science brief: fossils of organisms that live in particular conditions today are evidence that similar conditions existed where those fossils formed. |
| E3 | established science reference | Science brief: marine fossils found far inland are evidence that the area was once covered by water. |
| E4 | established science reference | Science brief: environments change over long spans of time. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u07::environments long ago, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about environments long ago, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about environments long ago, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about environments long ago; then identify one check that would catch an error or weak claim.**
...
**Q1.** The supplied unit connections are: what fossils are, reading rock layers, fossil evidence, environments long ago, comparing past and present, variation and advantage. Choose one idea other than environments long ago, connect it to one row in E1-E4, and explain one way treating the two ideas as identical would be misleading.

>

**Q2.** Communicate what the supplied record establishes about environments long ago in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about environments long ago against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using environments long ago as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about environments long ago? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about environments long ago that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about environments long ago. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about environments long ago.
...
- Apply environments long ago under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect environments long ago to what fossils are from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g3-science-u07-l10` · lesson `ma-g3-science-u07-l10` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
