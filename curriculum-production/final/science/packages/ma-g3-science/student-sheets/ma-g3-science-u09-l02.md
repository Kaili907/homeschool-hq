# Concept model A: habitat change

**Grade 3 Science** · Unit 9: Capstone: Weather Hazards and Changing Habitats · Day 2 of the unit (course day 98) · about 40–55 minutes
...
- Build a clear mental model of habitat change through an explicit worked example, demonstration, text, or phenomenon.
...
**Q1.** Build a labelled model of habitat change that represents every supplied row in E1-E3. Annotate each model feature with its evidence ID, then show where the candidate claim fails or remains uncertain.
...
_Package `swp-ma-g3-science-u09-l02` · lesson `ma-g3-science-u09-l02` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
