# Correction and reflection: variation and advantage

**Grade 3 Science** · Unit 7: Fossils and Environments Long Ago · Day 12 of the unit (course day 84) · about 40–55 minutes

**Today's focus:** variation and advantage
...
- Use error evidence to choose a different representation or strategy for variation and advantage, then demonstrate corrected understanding.
- Use subject-appropriate evidence or representation to communicate understanding of variation and advantage.
- Check, revise, or improve work about variation and advantage using stated success criteria.
...
- Science brief: individuals in a past population varied, just as individuals do today.
- Science brief: a variation that helped individuals survive and reproduce in their environment could become more common in later generations.
- Science brief: which variation counts as an advantage is set by the environment, not by the organism.

### Evidence check: variation and advantage

**Candidate claim:** A case report presents this as acceptable science: “an individual organism changes its own traits to suit its environment.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: individuals in a past population varied, just as individuals do today. |
| E2 | established science reference | Science brief: a variation that helped individuals survive and reproduce in their environment could become more common in later generations. |
| E3 | established science reference | Science brief: which variation counts as an advantage is set by the environment, not by the organism. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u07::variation and advantage, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about variation and advantage, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about variation and advantage, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about variation and advantage; then identify one check that would catch an error or weak claim.**
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E3. Name the decisive evidence ID, explain the error about variation and advantage, and write a corrected claim.

>

**Q2.** Communicate what the supplied record establishes about variation and advantage in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about variation and advantage against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using variation and advantage as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about variation and advantage? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about variation and advantage that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about variation and advantage. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about variation and advantage.
...
- Apply variation and advantage under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect variation and advantage to what fossils are from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g3-science-u07-l12` · lesson `ma-g3-science-u07-l12` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
