# Concept model A: plant life cycles

**Grade 3 Science** · Unit 4: Life Cycles of Organisms · Day 2 of the unit (course day 38) · about 40–55 minutes

**Today's focus:** plant life cycles
...
- Build a clear mental model of plant life cycles through an explicit worked example, demonstration, text, or phenomenon.
- Use subject-appropriate evidence or representation to communicate understanding of plant life cycles.
- Check, revise, or improve work about plant life cycles using stated success criteria.
...
- Science brief: in a flowering plant, pollination and fertilisation must occur before seeds form.
- Science brief: a flowering plant's cycle runs seed, germination, seedling, mature plant with flowers, pollination, then fruit and seed.
- Science brief: seeds form after pollination and fertilisation; a flower that is never pollinated does not produce seed.
- Science brief: a seed contains a young plant and a store of food that supports early growth before the seedling has leaves of its own.

### Evidence check: plant life cycles

**Candidate claim:** A case report presents this as acceptable science: “a flowering plant produces seeds without pollination.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: in a flowering plant, pollination and fertilisation must occur before seeds form. |
| E2 | established science reference | Science brief: a flowering plant's cycle runs seed, germination, seedling, mature plant with flowers, pollination, then fruit and seed. |
| E3 | established science reference | Science brief: seeds form after pollination and fertilisation; a flower that is never pollinated does not produce seed. |
| E4 | established science reference | Science brief: a seed contains a young plant and a store of food that supports early growth before the seedling has leaves of its own. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u04::plant life cycles, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about plant life cycles, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about plant life cycles, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about plant life cycles; then identify one check that would catch an error or weak claim.**
...
**Q1.** Build a labelled model of plant life cycles that represents every supplied row in E1-E4. Annotate each model feature with its evidence ID, then show where the candidate claim fails or remains uncertain.

>

**Q2.** Communicate what the supplied record establishes about plant life cycles in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about plant life cycles against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using plant life cycles as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about plant life cycles? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about plant life cycles that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about plant life cycles. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about plant life cycles.
...
- Apply plant life cycles under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect plant life cycles to birth, growth, reproduction, and death from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g3-science-u04-l02` · lesson `ma-g3-science-u04-l02` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
