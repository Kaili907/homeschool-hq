# Synthesis and review: weather compared with climate

**Grade 3 Science** · Unit 8: Weather Patterns and World Climates · Day 10 of the unit (course day 94) · about 40–55 minutes

**Today's focus:** weather compared with climate
...
- Connect weather compared with climate to the unit’s other ideas and select evidence that shows readiness for assessment.
- Use subject-appropriate evidence or representation to communicate understanding of weather compared with climate.
- Check, revise, or improve work about weather compared with climate using stated success criteria.
...
- Science brief: climate is the long-term pattern of weather at a place, described over many years.
- Science brief: weather is short-term and local; climate is the pattern of weather at a place over many years.
- Science brief: one cold day does not contradict a warm climate, and one hot week is not a change in climate.
- Science brief: climate is described with long-term averages and ranges, not single readings.

### Evidence check: weather compared with climate

**Candidate claim:** A case report presents this as acceptable science: “using a single day's weather as evidence about climate.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: climate is the long-term pattern of weather at a place, described over many years. |
| E2 | established science reference | Science brief: weather is short-term and local; climate is the pattern of weather at a place over many years. |
| E3 | established science reference | Science brief: one cold day does not contradict a warm climate, and one hot week is not a change in climate. |
| E4 | established science reference | Science brief: climate is described with long-term averages and ranges, not single readings. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u08::weather compared with climate, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about weather compared with climate, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about weather compared with climate, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about weather compared with climate; then identify one check that would catch an error or weak claim.**
...
**Q1.** The supplied unit connections are: daily weather data, tables and graphs, seasonal patterns, weather compared with climate, climates in different regions, combining information sources. Choose one idea other than weather compared with climate, connect it to one row in E1-E4, and explain one way treating the two ideas as identical would be misleading.

>

**Q2.** Communicate what the supplied record establishes about weather compared with climate in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about weather compared with climate against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using weather compared with climate as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about weather compared with climate? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about weather compared with climate that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about weather compared with climate. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about weather compared with climate.
...
- Apply weather compared with climate under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect weather compared with climate to daily weather data from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g3-science-u08-l10` · lesson `ma-g3-science-u08-l10` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
