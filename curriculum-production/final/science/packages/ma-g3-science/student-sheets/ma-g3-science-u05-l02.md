# Concept model A: variation within a group

**Grade 3 Science** · Unit 5: Inherited Traits and Variation · Day 2 of the unit (course day 50) · about 40–55 minutes

**Today's focus:** variation within a group
...
- Build a clear mental model of variation within a group through an explicit worked example, demonstration, text, or phenomenon.
- Use subject-appropriate evidence or representation to communicate understanding of variation within a group.
- Check, revise, or improve work about variation within a group using stated success criteria.
...
- Science brief: individuals of the same kind of organism differ from one another, and that difference is called variation.
- Science brief: variation exists even among siblings that share the same two parents.
- Science brief: variation is described by comparing many individuals, not by looking at one.

### Evidence check: variation within a group

**Candidate claim:** A case report presents this as acceptable science: “all members of one kind of organism are the same.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: individuals of the same kind of organism differ from one another, and that difference is called variation. |
| E2 | established science reference | Science brief: variation exists even among siblings that share the same two parents. |
| E3 | established science reference | Science brief: variation is described by comparing many individuals, not by looking at one. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u05::variation within a group, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about variation within a group, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about variation within a group, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about variation within a group; then identify one check that would catch an error or weak claim.**
...
**Q1.** Build a labelled model of variation within a group that represents every supplied row in E1-E3. Annotate each model feature with its evidence ID, then show where the candidate claim fails or remains uncertain.

>

**Q2.** Communicate what the supplied record establishes about variation within a group in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about variation within a group against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using variation within a group as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about variation within a group? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about variation within a group that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about variation within a group. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about variation within a group.
...
- Apply variation within a group under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect variation within a group to inherited traits from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g3-science-u05-l02` · lesson `ma-g3-science-u05-l02` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
