# Investigation or close reading: daily weather data

**Grade 3 Science** · Unit 8: Weather Patterns and World Climates · Day 7 of the unit (course day 91) · about 40–55 minutes

**Today's focus:** daily weather data
...
- Gather and analyze evidence related to daily weather data, then record a defensible interpretation.
- Use subject-appropriate evidence or representation to communicate understanding of daily weather data.
- Check, revise, or improve work about daily weather data using stated success criteria.
...
- Science brief: weather is the state of the atmosphere at a place at a particular time: temperature, precipitation, wind, and cloud.
- Science brief: weather is recorded with instruments, in units, at a stated time and place.
- Science brief: a single day's weather does not describe what a place's weather is usually like.

### Evidence check: daily weather data

**Candidate claim:** A case report presents this as acceptable science: “recording a weather observation with no date, time, or place.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: weather is the state of the atmosphere at a place at a particular time: temperature, precipitation, wind, and cloud. |
| E2 | established science reference | Science brief: weather is recorded with instruments, in units, at a stated time and place. |
| E3 | established science reference | Science brief: a single day's weather does not describe what a place's weather is usually like. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u08::daily weather data, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about daily weather data, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about daily weather data?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g3-science-u08::daily weather data, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u08::daily weather data, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about daily weather data?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about daily weather data; then identify one check that would catch an error or weak claim.**
...
**Q1.** Classify every supplied row E1-E3 as supports, challenges, or does not decide the candidate claim about daily weather data. Cite the row and explain each classification.

>

**Q2.** Communicate what the supplied record establishes about daily weather data in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about daily weather data against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using daily weather data as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about daily weather data? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about daily weather data that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about daily weather data. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about daily weather data.
...
- Apply daily weather data under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect daily weather data to tables and graphs from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g3-science-u08-l07` · lesson `ma-g3-science-u08-l07` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
