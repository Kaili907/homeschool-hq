# Synthesis and review: comparing life cycles

**Grade 3 Science** · Unit 4: Life Cycles of Organisms · Day 10 of the unit (course day 46) · about 40–55 minutes

**Today's focus:** comparing life cycles
...
- Connect comparing life cycles to the unit’s other ideas and select evidence that shows readiness for assessment.
- Use subject-appropriate evidence or representation to communicate understanding of comparing life cycles.
- Check, revise, or improve work about comparing life cycles using stated success criteria.
...
- Science brief: comparing life cycles means matching stages that play the same role, not stages that share a name.
- Science brief: organisms that look very different can share the same overall cycle pattern.
- Science brief: a difference between two life cycles is evidence about the organisms, not a fault in either of them.

### Evidence check: comparing life cycles

**Candidate claim:** A case report presents this as acceptable science: “an organism with a shorter life cycle is less developed or less successful.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: comparing life cycles means matching stages that play the same role, not stages that share a name. |
| E2 | established science reference | Science brief: organisms that look very different can share the same overall cycle pattern. |
| E3 | established science reference | Science brief: a difference between two life cycles is evidence about the organisms, not a fault in either of them. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u04::comparing life cycles, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about comparing life cycles, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about comparing life cycles, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about comparing life cycles; then identify one check that would catch an error or weak claim.**
...
**Q1.** The supplied unit connections are: birth, growth, reproduction, and death, plant life cycles, insect life cycles, comparing life cycles, modeling a life cycle, diverse but shared patterns. Choose one idea other than comparing life cycles, connect it to one row in E1-E3, and explain one way treating the two ideas as identical would be misleading.

>

**Q2.** Communicate what the supplied record establishes about comparing life cycles in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about comparing life cycles against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using comparing life cycles as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about comparing life cycles? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about comparing life cycles that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about comparing life cycles. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about comparing life cycles.
...
- Apply comparing life cycles under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect comparing life cycles to birth, growth, reproduction, and death from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g3-science-u04-l10` · lesson `ma-g3-science-u04-l10` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
