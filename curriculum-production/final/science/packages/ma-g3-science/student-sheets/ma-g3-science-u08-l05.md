# Concept model B: climates in different regions

**Grade 3 Science** · Unit 8: Weather Patterns and World Climates · Day 5 of the unit (course day 89) · about 40–55 minutes
...
- Build a clear mental model of climates in different regions through an explicit worked example, demonstration, text, or phenomenon.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about climates in different regions; then identify one check that would catch an error or weak claim.**
...
**Q1.** Build a labelled model of climates in different regions that represents every supplied row in E1-E3. Annotate each model feature with its evidence ID, then show where the candidate claim fails or remains uncertain.
...
_Package `swp-ma-g3-science-u08-l05` · lesson `ma-g3-science-u08-l05` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
