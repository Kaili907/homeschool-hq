# Unit assessment: comparing past and present

**Grade 3 Science** · Unit 7: Fossils and Environments Long Ago · Day 11 of the unit (course day 83) · about 40–55 minutes

**Today's focus:** comparing past and present
...
- Demonstrate current mastery of comparing past and present through selected-response, constructed-response, and applied evidence.
- Use subject-appropriate evidence or representation to communicate understanding of comparing past and present.
- Check, revise, or improve work about comparing past and present using stated success criteria.
...
- Science brief: extinct means no members of that kind of organism are alive anywhere.
- Science brief: people did not live alongside the large non-bird dinosaurs.
- Science brief: some fossil organisms resemble organisms alive today; others resemble nothing now living.
- Science brief: organisms known only as fossils are extinct: none are alive anywhere.

### Evidence check: comparing past and present

**Candidate claim:** A case report presents this as acceptable science: “treating 'it might still be alive somewhere' as a scientific conclusion about an extinct organism.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: extinct means no members of that kind of organism are alive anywhere. |
| E2 | established science reference | Science brief: people did not live alongside the large non-bird dinosaurs. |
| E3 | established science reference | Science brief: some fossil organisms resemble organisms alive today; others resemble nothing now living. |
| E4 | established science reference | Science brief: organisms known only as fossils are extinct: none are alive anywhere. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u07::comparing past and present, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about comparing past and present, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about comparing past and present, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? Rate confidence in comparing past and present, cite one piece of evidence from today, and choose: ready to extend, ready to review later, or need a different explanation.**
...
**Q1.** Complete all three parts for comparing past and present. (1) Select A: supported, B: partly supported, or C: not supported for the candidate claim. (2) Justify the selection with E1-E4. (3) Rewrite the claim so every word is supported by the supplied record.

>

**Q2.** Communicate what the supplied record establishes about comparing past and present in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about comparing past and present against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using comparing past and present as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about comparing past and present? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about comparing past and present that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about comparing past and present. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about comparing past and present.
...
- Apply comparing past and present under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect comparing past and present to what fossils are from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g3-science-u07-l11` · lesson `ma-g3-science-u07-l11` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
