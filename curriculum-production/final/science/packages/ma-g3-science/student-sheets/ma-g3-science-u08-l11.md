# Unit assessment: climates in different regions

**Grade 3 Science** · Unit 8: Weather Patterns and World Climates · Day 11 of the unit (course day 95) · about 40–55 minutes

**Today's focus:** climates in different regions
...
- Demonstrate current mastery of climates in different regions through selected-response, constructed-response, and applied evidence.
- Use subject-appropriate evidence or representation to communicate understanding of climates in different regions.
- Check, revise, or improve work about climates in different regions using stated success criteria.
...
- Science brief: different regions of the world have different climates.
- Science brief: climate varies with distance from the equator, height above sea level, and nearness to large bodies of water.
- Science brief: two places at the same distance from the equator can have different climates because of those other factors.

### Evidence check: climates in different regions

**Candidate claim:** A case report presents this as acceptable science: “distance from the equator alone determines climate.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: different regions of the world have different climates. |
| E2 | established science reference | Science brief: climate varies with distance from the equator, height above sea level, and nearness to large bodies of water. |
| E3 | established science reference | Science brief: two places at the same distance from the equator can have different climates because of those other factors. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u08::climates in different regions, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about climates in different regions, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about climates in different regions, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? Rate confidence in climates in different regions, cite one piece of evidence from today, and choose: ready to extend, ready to review later, or need a different explanation.**
...
**Q1.** Complete all three parts for climates in different regions. (1) Select A: supported, B: partly supported, or C: not supported for the candidate claim. (2) Justify the selection with E1-E3. (3) Rewrite the claim so every word is supported by the supplied record.

>

**Q2.** Communicate what the supplied record establishes about climates in different regions in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about climates in different regions against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using climates in different regions as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about climates in different regions? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about climates in different regions that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about climates in different regions. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about climates in different regions.
...
- Apply climates in different regions under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect climates in different regions to daily weather data from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g3-science-u08-l11` · lesson `ma-g3-science-u08-l11` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
