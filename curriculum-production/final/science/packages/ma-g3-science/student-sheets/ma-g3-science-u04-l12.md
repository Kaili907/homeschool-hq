# Correction and reflection: diverse but shared patterns

**Grade 3 Science** · Unit 4: Life Cycles of Organisms · Day 12 of the unit (course day 48) · about 40–55 minutes

**Today's focus:** diverse but shared patterns
...
- Use error evidence to choose a different representation or strategy for diverse but shared patterns, then demonstrate corrected understanding.
- Use subject-appropriate evidence or representation to communicate understanding of diverse but shared patterns.
- Check, revise, or improve work about diverse but shared patterns using stated success criteria.
...
- Science brief: organisms are enormously varied, and yet all of them share the broad life-cycle pattern of birth, growth, reproduction, and death.
- Science brief: a pattern shared across many kinds of organism is something to be explained, not a coincidence.
- Science brief: a single organism's cycle is an example of the pattern, not the pattern itself.

### Evidence check: diverse but shared patterns

**Candidate claim:** A case report presents this as acceptable science: “that because organisms look different they share nothing.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: organisms are enormously varied, and yet all of them share the broad life-cycle pattern of birth, growth, reproduction, and death. |
| E2 | established science reference | Science brief: a pattern shared across many kinds of organism is something to be explained, not a coincidence. |
| E3 | established science reference | Science brief: a single organism's cycle is an example of the pattern, not the pattern itself. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u04::diverse but shared patterns, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about diverse but shared patterns, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about diverse but shared patterns, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about diverse but shared patterns; then identify one check that would catch an error or weak claim.**
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E3. Name the decisive evidence ID, explain the error about diverse but shared patterns, and write a corrected claim.

>

**Q2.** Communicate what the supplied record establishes about diverse but shared patterns in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about diverse but shared patterns against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using diverse but shared patterns as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about diverse but shared patterns? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about diverse but shared patterns that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about diverse but shared patterns. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about diverse but shared patterns.
...
- Apply diverse but shared patterns under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect diverse but shared patterns to birth, growth, reproduction, and death from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g3-science-u04-l12` · lesson `ma-g3-science-u04-l12` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
