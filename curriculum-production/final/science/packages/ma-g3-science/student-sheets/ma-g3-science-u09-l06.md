# Guided practice B: evidence-based claims

**Grade 3 Science** · Unit 9: Capstone: Weather Hazards and Changing Habitats · Day 6 of the unit (course day 102) · about 40–55 minutes
...
- Practice evidence-based claims with prompts, feedback, and gradually reduced support.
...
**Q1.** First compare E1 with E2 and write a provisional conclusion about evidence-based claims. Then add the remaining rows through E3, revise the conclusion, and explain the change.
...
_Package `swp-ma-g3-science-u09-l06` · lesson `ma-g3-science-u09-l06` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
