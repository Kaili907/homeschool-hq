...
- Science brief: offspring traits can be compared with parent traits to see which are similar and which differ.
- Science brief: a trait can appear in an offspring that neither parent shows.
- Science brief: resemblance to a parent is evidence of inheritance; it does not establish which parent a particular trait came from.

### Evidence check: comparing parents and offspring

**Candidate claim:** A case report presents this as acceptable science: “a trait must have come from whichever parent the offspring most resembles overall.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: offspring traits can be compared with parent traits to see which are similar and which differ. |
| E2 | established science reference | Science brief: a trait can appear in an offspring that neither parent shows. |
| E3 | established science reference | Science brief: resemblance to a parent is evidence of inheritance; it does not establish which parent a particular trait came from. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u05::comparing parents and offspring, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about comparing parents and offspring, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about comparing parents and offspring, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**Q1.** First compare E1 with E2 and write a provisional conclusion about comparing parents and offspring. Then add the remaining rows through E3, revise the conclusion, and explain the change.

>

**Q2.** Communicate what the supplied record establishes about comparing parents and offspring in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about comparing parents and offspring against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using comparing parents and offspring as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about comparing parents and offspring? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about comparing parents and offspring that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about comparing parents and offspring. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
_Package `swp-ma-g3-science-u05-l03` · lesson `ma-g3-science-u05-l03` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
