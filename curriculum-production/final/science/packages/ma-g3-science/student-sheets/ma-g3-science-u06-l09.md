# Performance task build: habitat needs

**Grade 3 Science** · Unit 6: Living in Groups and Surviving in Habitats · Day 9 of the unit (course day 69) · about 40–55 minutes

**Today's focus:** habitat needs

**Unit question:** How can understanding living in groups and surviving in habitats help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Create, test, or revise a meaningful product that applies habitat needs and the unit standards.
- Use subject-appropriate evidence or representation to communicate understanding of habitat needs.
- Check, revise, or improve work about habitat needs using stated success criteria.
...
- Science brief: every organism needs particular resources and conditions: food or nutrients, water, air or dissolved gases, shelter, and space.
- Science brief: a habitat is a place that supplies those needs; an organism cannot survive where its needs are not met.
- Science brief: different organisms need different things from the same place.

### Evidence check: habitat needs

**Candidate claim:** A case report presents this as acceptable science: “any organism could live anywhere if it tried hard enough.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: every organism needs particular resources and conditions: food or nutrients, water, air or dissolved gases, shelter, and space. |
| E2 | established science reference | Science brief: a habitat is a place that supplies those needs; an organism cannot survive where its needs are not met. |
| E3 | established science reference | Science brief: different organisms need different things from the same place. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u06::habitat needs, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.

**Supplied unit connections:** animal groups; benefits of living in groups; habitat needs; surviving well or less well; constructing an argument; evidence for a survival claim

**Supplied unit performance task:** Construct an evidence-based argument about why some animals form groups and why some organisms survive well in a particular habitat while others do not.

### Bound task

**Question:** What does evidence E1 through E3 justify about habitat needs, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about habitat needs?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g3-science-u06::habitat needs, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u06::habitat needs, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about habitat needs?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about habitat needs; then identify one check that would catch an error or weak claim.**
...
**Q1.** Create a one-page evidence product for habitat needs using only the supplied case and E1-E3: one claim, at least two cited rows, the reasoning link, one counterpoint, and one revision after checking the success criteria.

>

**Q2.** Communicate what the supplied record establishes about habitat needs in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about habitat needs against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using habitat needs as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about habitat needs? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about habitat needs that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about habitat needs. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about habitat needs.
...
- Apply habitat needs under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect habitat needs to animal groups from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Construct an evidence-based argument about why some animals form groups and why some organisms survive well in a particular habitat while others do not. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-g3-science-u06-l09` · lesson `ma-g3-science-u06-l09` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
