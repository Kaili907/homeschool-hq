# Independent application A: traits influenced by environment

**Grade 3 Science** · Unit 5: Inherited Traits and Variation · Day 4 of the unit (course day 52) · about 40–55 minutes
...
- Apply traits influenced by environment independently in a new representation, text, situation, or design constraint.
...
**Q1.** Independently evaluate this fully supplied case about traits influenced by environment: A case report presents this as acceptable science: “every difference between two organisms is inherited.” Use at least two rows from E1-E3, correct the claim if needed, and state one limit.
...
_Package `swp-ma-g3-science-u05-l04` · lesson `ma-g3-science-u05-l04` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
