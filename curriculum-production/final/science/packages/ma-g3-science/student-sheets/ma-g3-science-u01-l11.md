...
**Grade 3 Science** · Unit 1: Science and Engineering Practices · Day 11 of the unit (course day 11) · about 40–55 minutes
...
- Science brief: a measurement has both a number and a unit; the number alone does not say how much.
- Science brief: the same quantity measured with the same tool by different people should agree closely, and a large disagreement is a signal to check the method.
- Science brief: data recorded in a table with labelled columns can be compared; loose notes usually cannot.

### Evidence check: measuring and recording data

**Candidate claim:** A case report presents this as acceptable science: “recording a bare number with no unit and treating it as a complete measurement.”
...
| E2 | established science reference | Science brief: a measurement has both a number and a unit; the number alone does not say how much. |
| E3 | established science reference | Science brief: the same quantity measured with the same tool by different people should agree closely, and a large disagreement is a signal to check the method. |
| E4 | established science reference | Science brief: data recorded in a table with labelled columns can be compared; loose notes usually cannot. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u01::measuring and recording data, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
_Package `swp-ma-g3-science-u01-l11` · lesson `ma-g3-science-u01-l11` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
