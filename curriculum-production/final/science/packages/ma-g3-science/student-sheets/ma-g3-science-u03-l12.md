# Correction and reflection: solving a problem with magnets

**Grade 3 Science** · Unit 3: Magnetic and Electric Interactions · Day 12 of the unit (course day 36) · about 40–55 minutes

**Today's focus:** solving a problem with magnets
...
- Use error evidence to choose a different representation or strategy for solving a problem with magnets, then demonstrate corrected understanding.
- Use subject-appropriate evidence or representation to communicate understanding of solving a problem with magnets.
- Check, revise, or improve work about solving a problem with magnets using stated success criteria.
...
- Science brief: a magnetic solution only works on materials the magnet actually attracts, so the material is part of defining the problem.
- Science brief: a design is tested against its stated criteria and constraints, not against how clever it seems.
- Science brief: a stronger magnet, or a smaller gap, gives the design a larger force to work with.

### Evidence check: solving a problem with magnets

**Candidate claim:** A case report presents this as acceptable science: “proposing a magnetic solution for a material magnets do not attract.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a magnetic solution only works on materials the magnet actually attracts, so the material is part of defining the problem. |
| E2 | established science reference | Science brief: a design is tested against its stated criteria and constraints, not against how clever it seems. |
| E3 | established science reference | Science brief: a stronger magnet, or a smaller gap, gives the design a larger force to work with. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u03::solving a problem with magnets, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about solving a problem with magnets, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about solving a problem with magnets, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about solving a problem with magnets; then identify one check that would catch an error or weak claim.**
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E3. Name the decisive evidence ID, explain the error about solving a problem with magnets, and write a corrected claim.

>

**Q2.** Communicate what the supplied record establishes about solving a problem with magnets in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about solving a problem with magnets against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using solving a problem with magnets as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about solving a problem with magnets? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about solving a problem with magnets that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about solving a problem with magnets. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about solving a problem with magnets.
...
- Apply solving a problem with magnets under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect solving a problem with magnets to magnetic attraction and repulsion from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g3-science-u03-l12` · lesson `ma-g3-science-u03-l12` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
