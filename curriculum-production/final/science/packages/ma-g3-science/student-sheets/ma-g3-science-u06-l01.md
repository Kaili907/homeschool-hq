# Launch and diagnostic: animal groups

**Grade 3 Science** · Unit 6: Living in Groups and Surviving in Habitats · Day 1 of the unit (course day 61) · about 40–55 minutes
...
- Activate prior knowledge about animal groups, surface initial thinking without penalty, and establish the unit question.
...
**The task.** What does evidence E1 through E3 justify about animal groups, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**Q1.** Before rereading the brief, classify the supplied candidate claim about animal groups as supported, partly supported, or not supported. Then read E1-E3, revise the classification, and name the evidence ID that changed or confirmed your thinking.
...
_Package `swp-ma-g3-science-u06-l01` · lesson `ma-g3-science-u06-l01` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
