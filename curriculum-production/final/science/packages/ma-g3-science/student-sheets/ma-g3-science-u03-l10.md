# Synthesis and review: static electric interactions

**Grade 3 Science** · Unit 3: Magnetic and Electric Interactions · Day 10 of the unit (course day 34) · about 40–55 minutes

**Today's focus:** static electric interactions
...
- Connect static electric interactions to the unit’s other ideas and select evidence that shows readiness for assessment.
- Use subject-appropriate evidence or representation to communicate understanding of static electric interactions.
- Check, revise, or improve work about static electric interactions using stated success criteria.
...
- Science brief: opposite charges attract; like charges repel.
- Science brief: rubbing certain materials together transfers electric charge from one to the other, leaving each object charged.
- Science brief: objects with opposite charges attract each other; objects with the same charge repel each other.
- Science brief: a charged object can attract an uncharged object such as paper, hair, or a thin stream of water.

### Evidence check: static electric interactions

**Candidate claim:** A case report presents this as acceptable science: “rubbing creates charge out of nothing, rather than moving it from one object to the other.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: opposite charges attract; like charges repel. |
| E2 | established science reference | Science brief: rubbing certain materials together transfers electric charge from one to the other, leaving each object charged. |
| E3 | established science reference | Science brief: objects with opposite charges attract each other; objects with the same charge repel each other. |
| E4 | established science reference | Science brief: a charged object can attract an uncharged object such as paper, hair, or a thin stream of water. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u03::static electric interactions, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about static electric interactions, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about static electric interactions, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about static electric interactions; then identify one check that would catch an error or weak claim.**
...
**Q1.** The supplied unit connections are: magnetic attraction and repulsion, magnet poles, forces without contact, static electric interactions, cause and effect, solving a problem with magnets. Choose one idea other than static electric interactions, connect it to one row in E1-E4, and explain one way treating the two ideas as identical would be misleading.

>

**Q2.** Communicate what the supplied record establishes about static electric interactions in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about static electric interactions against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using static electric interactions as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about static electric interactions? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about static electric interactions that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about static electric interactions. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about static electric interactions.
...
- Apply static electric interactions under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect static electric interactions to magnetic attraction and repulsion from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g3-science-u03-l10` · lesson `ma-g3-science-u03-l10` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
