# Unit assessment: constructing an argument

**Grade 3 Science** · Unit 6: Living in Groups and Surviving in Habitats · Day 11 of the unit (course day 71) · about 40–55 minutes

**Today's focus:** constructing an argument
...
- Demonstrate current mastery of constructing an argument through selected-response, constructed-response, and applied evidence.
- Use subject-appropriate evidence or representation to communicate understanding of constructing an argument.
- Check, revise, or improve work about constructing an argument using stated success criteria.
...
- Science brief: a scientific argument states a claim, gives evidence, and explains how the evidence supports the claim.
- Science brief: the reasoning step is what connects evidence to claim; without it the argument is a claim with data sitting beside it.
- Science brief: an argument is judged on the fit between claim, evidence, and reasoning, not on how strongly it is stated.

### Evidence check: constructing an argument

**Candidate claim:** A case report presents this as acceptable science: “presenting a claim and data with no reasoning linking them.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a scientific argument states a claim, gives evidence, and explains how the evidence supports the claim. |
| E2 | established science reference | Science brief: the reasoning step is what connects evidence to claim; without it the argument is a claim with data sitting beside it. |
| E3 | established science reference | Science brief: an argument is judged on the fit between claim, evidence, and reasoning, not on how strongly it is stated. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u06::constructing an argument, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about constructing an argument, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about constructing an argument, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? Rate confidence in constructing an argument, cite one piece of evidence from today, and choose: ready to extend, ready to review later, or need a different explanation.**
...
**Q1.** Complete all three parts for constructing an argument. (1) Select A: supported, B: partly supported, or C: not supported for the candidate claim. (2) Justify the selection with E1-E3. (3) Rewrite the claim so every word is supported by the supplied record.

>

**Q2.** Communicate what the supplied record establishes about constructing an argument in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about constructing an argument against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using constructing an argument as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about constructing an argument? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about constructing an argument that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about constructing an argument. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about constructing an argument.
...
- Apply constructing an argument under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect constructing an argument to animal groups from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g3-science-u06-l11` · lesson `ma-g3-science-u06-l11` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
