# Reteach and varied practice: habitat change

**Grade 3 Science** · Unit 9: Capstone: Weather Hazards and Changing Habitats · Day 8 of the unit (course day 104) · about 40–55 minutes

**Today's focus:** habitat change
...
- Use error evidence to choose a different representation or strategy for habitat change, then demonstrate corrected understanding.
- Use subject-appropriate evidence or representation to communicate understanding of habitat change.
- Check, revise, or improve work about habitat change using stated success criteria.
...
- Science brief: when a habitat changes, some organisms survive there, some move away, and some die.
- Science brief: changes can be sudden, such as a flood or fire, or gradual, such as a long drought.
- Science brief: a change that harms one kind of organism can help another.

### Evidence check: habitat change

**Candidate claim:** A case report presents this as acceptable science: “every habitat change harms every organism in it.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: when a habitat changes, some organisms survive there, some move away, and some die. |
| E2 | established science reference | Science brief: changes can be sudden, such as a flood or fire, or gradual, such as a long drought. |
| E3 | established science reference | Science brief: a change that harms one kind of organism can help another. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u09::habitat change, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about habitat change, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about habitat change, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about habitat change; then identify one check that would catch an error or weak claim.**
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E3. Name the decisive evidence ID, explain the error about habitat change, and write a corrected claim.

>

**Q2.** Communicate what the supplied record establishes about habitat change in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about habitat change against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using habitat change as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about habitat change? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about habitat change that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about habitat change. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about habitat change.
...
- Apply habitat change under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect habitat change to weather-related hazards from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g3-science-u09-l08` · lesson `ma-g3-science-u09-l08` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
