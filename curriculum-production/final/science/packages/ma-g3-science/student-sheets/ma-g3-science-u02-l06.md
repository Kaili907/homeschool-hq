# Guided practice B: friction and surfaces

**Grade 3 Science** · Unit 2: Forces and Motion · Day 6 of the unit (course day 18) · about 40–55 minutes
...
- Practice friction and surfaces with prompts, feedback, and gradually reduced support.
...
**Q1.** First compare E1 with E2 and write a provisional conclusion about friction and surfaces. Then add the remaining rows through E4, revise the conclusion, and explain the change.
...
_Package `swp-ma-g3-science-u02-l06` · lesson `ma-g3-science-u02-l06` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
