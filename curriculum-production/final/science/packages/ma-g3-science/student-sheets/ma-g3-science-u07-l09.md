# Performance task build: fossil evidence

**Grade 3 Science** · Unit 7: Fossils and Environments Long Ago · Day 9 of the unit (course day 81) · about 40–55 minutes
...
- Create, test, or revise a meaningful product that applies fossil evidence and the unit standards.
...
- Science brief: fossils are evidence about which organisms lived in a place and about the conditions there.
- Science brief: a fossil in a rock layer shows the organism lived when that layer was forming, not when the fossil was found.
- Science brief: similar fossils in layers of the same age in different places link those places in time.

### Evidence check: fossil evidence

**Candidate claim:** A case report presents this as acceptable science: “a body fossil shows what the organism did; only trace fossils record behaviour.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: fossils are evidence about which organisms lived in a place and about the conditions there. |
| E2 | established science reference | Science brief: a fossil in a rock layer shows the organism lived when that layer was forming, not when the fossil was found. |
| E3 | established science reference | Science brief: similar fossils in layers of the same age in different places link those places in time. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u07::fossil evidence, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about fossil evidence, and does it support the candidate claim?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g3-science-u07::fossil evidence, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u07::fossil evidence, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Q1.** Create a one-page evidence product for fossil evidence using only the supplied case and E1-E3: one claim, at least two cited rows, the reasoning link, one counterpoint, and one revision after checking the success criteria.

>

**Q2.** Communicate what the supplied record establishes about fossil evidence in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about fossil evidence against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using fossil evidence as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about fossil evidence? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about fossil evidence that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about fossil evidence. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- Connect fossil evidence to what fossils are from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g3-science-u07-l09` · lesson `ma-g3-science-u07-l09` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
