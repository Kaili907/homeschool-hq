# Synthesis and review: surviving well or less well

**Grade 3 Science** · Unit 6: Living in Groups and Surviving in Habitats · Day 10 of the unit (course day 70) · about 40–55 minutes

**Today's focus:** surviving well or less well
...
- Connect surviving well or less well to the unit’s other ideas and select evidence that shows readiness for assessment.
- Use subject-appropriate evidence or representation to communicate understanding of surviving well or less well.
- Check, revise, or improve work about surviving well or less well using stated success criteria.
...
- Science brief: in a particular habitat, some variations of a trait help an individual survive and reproduce better than other variations do.
- Science brief: the same trait can be an advantage in one habitat and a disadvantage in another.
- Science brief: surviving well means surviving and reproducing, not being the largest or the strongest.

### Evidence check: surviving well or less well

**Candidate claim:** A case report presents this as acceptable science: “calling a trait better without naming the habitat it is better in.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: in a particular habitat, some variations of a trait help an individual survive and reproduce better than other variations do. |
| E2 | established science reference | Science brief: the same trait can be an advantage in one habitat and a disadvantage in another. |
| E3 | established science reference | Science brief: surviving well means surviving and reproducing, not being the largest or the strongest. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u06::surviving well or less well, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about surviving well or less well, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about surviving well or less well, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about surviving well or less well; then identify one check that would catch an error or weak claim.**
...
**Q1.** The supplied unit connections are: animal groups, benefits of living in groups, habitat needs, surviving well or less well, constructing an argument, evidence for a survival claim. Choose one idea other than surviving well or less well, connect it to one row in E1-E3, and explain one way treating the two ideas as identical would be misleading.

>

**Q2.** Communicate what the supplied record establishes about surviving well or less well in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about surviving well or less well against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using surviving well or less well as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about surviving well or less well? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about surviving well or less well that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about surviving well or less well. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about surviving well or less well.
...
- Apply surviving well or less well under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect surviving well or less well to animal groups from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g3-science-u06-l10` · lesson `ma-g3-science-u06-l10` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
