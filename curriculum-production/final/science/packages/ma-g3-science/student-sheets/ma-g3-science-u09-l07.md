# Investigation or close reading: weather-related hazards

**Grade 3 Science** · Unit 9: Capstone: Weather Hazards and Changing Habitats · Day 7 of the unit (course day 103) · about 40–55 minutes

**Today's focus:** weather-related hazards
...
- Gather and analyze evidence related to weather-related hazards, then record a defensible interpretation.
- Use subject-appropriate evidence or representation to communicate understanding of weather-related hazards.
- Check, revise, or improve work about weather-related hazards using stated success criteria.
...
- Science brief: weather-related hazards include floods, severe thunderstorms, tornadoes, blizzards, drought, and extreme heat and cold.
- Science brief: a hazard is a natural event; it becomes a disaster when it affects people or the things they depend on.
- Science brief: hazards cannot be stopped from happening, but their impacts can be reduced.

### Evidence check: weather-related hazards

**Candidate claim:** A case report presents this as acceptable science: “a weather hazard can be prevented from occurring.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: weather-related hazards include floods, severe thunderstorms, tornadoes, blizzards, drought, and extreme heat and cold. |
| E2 | established science reference | Science brief: a hazard is a natural event; it becomes a disaster when it affects people or the things they depend on. |
| E3 | established science reference | Science brief: hazards cannot be stopped from happening, but their impacts can be reduced. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u09::weather-related hazards, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about weather-related hazards, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about weather-related hazards?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g3-science-u09::weather-related hazards, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u09::weather-related hazards, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about weather-related hazards?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about weather-related hazards; then identify one check that would catch an error or weak claim.**
...
**Q1.** Classify every supplied row E1-E3 as supports, challenges, or does not decide the candidate claim about weather-related hazards. Cite the row and explain each classification.

>

**Q2.** Communicate what the supplied record establishes about weather-related hazards in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about weather-related hazards against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using weather-related hazards as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about weather-related hazards? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about weather-related hazards that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about weather-related hazards. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about weather-related hazards.
...
- Apply weather-related hazards under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect weather-related hazards to habitat change from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g3-science-u09-l07` · lesson `ma-g3-science-u09-l07` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
