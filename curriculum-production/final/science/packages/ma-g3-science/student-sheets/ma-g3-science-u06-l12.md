# Correction and reflection: evidence for a survival claim

**Grade 3 Science** · Unit 6: Living in Groups and Surviving in Habitats · Day 12 of the unit (course day 72) · about 40–55 minutes

**Today's focus:** evidence for a survival claim
...
- Use error evidence to choose a different representation or strategy for evidence for a survival claim, then demonstrate corrected understanding.
- Use subject-appropriate evidence or representation to communicate understanding of evidence for a survival claim.
- Check, revise, or improve work about evidence for a survival claim using stated success criteria.
...
- Science brief: evidence for a survival claim names the habitat, names the trait, and connects the trait to a need in that habitat.
- Science brief: evidence can come from the learner's own observation or from a named published source.
- Science brief: a survival claim covers the habitat the evidence came from, not every habitat.

### Evidence check: evidence for a survival claim

**Candidate claim:** A case report presents this as acceptable science: “supporting a survival claim with a trait that has no stated connection to a need in that habitat.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: evidence for a survival claim names the habitat, names the trait, and connects the trait to a need in that habitat. |
| E2 | established science reference | Science brief: evidence can come from the learner's own observation or from a named published source. |
| E3 | established science reference | Science brief: a survival claim covers the habitat the evidence came from, not every habitat. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u06::evidence for a survival claim, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about evidence for a survival claim, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about evidence for a survival claim, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about evidence for a survival claim; then identify one check that would catch an error or weak claim.**
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E3. Name the decisive evidence ID, explain the error about evidence for a survival claim, and write a corrected claim.

>

**Q2.** Communicate what the supplied record establishes about evidence for a survival claim in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about evidence for a survival claim against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using evidence for a survival claim as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about evidence for a survival claim? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about evidence for a survival claim that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about evidence for a survival claim. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about evidence for a survival claim.
...
- Apply evidence for a survival claim under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect evidence for a survival claim to animal groups from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g3-science-u06-l12` · lesson `ma-g3-science-u06-l12` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
