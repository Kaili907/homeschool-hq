# Reteach and varied practice: magnet poles

**Grade 3 Science** · Unit 3: Magnetic and Electric Interactions · Day 8 of the unit (course day 32) · about 40–55 minutes
...
- Use error evidence to choose a different representation or strategy for magnet poles, then demonstrate corrected understanding.
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E4. Name the decisive evidence ID, explain the error about magnet poles, and write a corrected claim.
...
_Package `swp-ma-g3-science-u03-l08` · lesson `ma-g3-science-u03-l08` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
