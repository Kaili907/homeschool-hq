# Correction and reflection: friction and surfaces

**Grade 3 Science** · Unit 2: Forces and Motion · Day 12 of the unit (course day 24) · about 40–55 minutes

**Today's focus:** friction and surfaces

**Unit question:** How can understanding forces and motion help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Use error evidence to choose a different representation or strategy for friction and surfaces, then demonstrate corrected understanding.
- Use subject-appropriate evidence or representation to communicate understanding of friction and surfaces.
- Check, revise, or improve work about friction and surfaces using stated success criteria.
...
- Science brief: friction acts only between surfaces that are touching.
- Science brief: friction is a force between surfaces that are touching, and it opposes sliding.
- Science brief: under otherwise identical conditions, a rougher pair of surfaces produces more friction than a smoother pair.
- Science brief: friction turns some of the energy of motion into thermal energy, which is why rubbed surfaces warm up.

### Evidence check: friction and surfaces

**Candidate claim:** A case report presents this as acceptable science: “friction acts on an object when nothing is touching it.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: friction acts only between surfaces that are touching. |
| E2 | established science reference | Science brief: friction is a force between surfaces that are touching, and it opposes sliding. |
| E3 | established science reference | Science brief: under otherwise identical conditions, a rougher pair of surfaces produces more friction than a smoother pair. |
| E4 | established science reference | Science brief: friction turns some of the energy of motion into thermal energy, which is why rubbed surfaces warm up. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g3-science-u02::friction and surfaces, derived from the reviewed correctness source policy/correctness/ma-g3-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about friction and surfaces, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about friction and surfaces, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about friction and surfaces; then identify one check that would catch an error or weak claim.**
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E4. Name the decisive evidence ID, explain the error about friction and surfaces, and write a corrected claim.

>

**Q2.** Communicate what the supplied record establishes about friction and surfaces in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about friction and surfaces against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using friction and surfaces as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about friction and surfaces? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about friction and surfaces that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about friction and surfaces. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about friction and surfaces.
...
- Apply friction and surfaces under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect friction and surfaces to pushes and pulls from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g3-science-u02-l12` · lesson `ma-g3-science-u02-l12` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
