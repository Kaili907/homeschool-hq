# Scoring authority — Launch and diagnostic: systems thinking

**Grade 5 Science** · Unit 9: Integrated Science and Engineering Capstone · Day 1 · lesson `ma-g5-science-u09-l01`
...
_Topic `ma-g5-science-u09::systems thinking` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._
...
**Q1 — activate prior.** _Serves objective 1:_ Activate prior knowledge about systems thinking, surface initial thinking without penalty, and establish the unit question.
...
**Q4 — essential question.** _Serves objective 1:_ Activate prior knowledge about systems thinking, surface initial thinking without penalty, and establish the unit question.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of systems thinking.
...
**Q6 — limitation.** _Serves objective 1:_ Activate prior knowledge about systems thinking, surface initial thinking without penalty, and establish the unit question.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of systems thinking.
...
_Package `swp-ma-g5-science-u09-l01` · built from `canonical-1.0.0` at `4056e31`._
