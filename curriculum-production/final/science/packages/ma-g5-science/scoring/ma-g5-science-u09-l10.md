# Scoring authority — Synthesis and review: data communication

**Grade 5 Science** · Unit 9: Integrated Science and Engineering Capstone · Day 10 · lesson `ma-g5-science-u09-l10`
...
_Topic `ma-g5-science-u09::data communication` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A table, graph, or diagram is chosen because it fits the data and the claim, not because it looks impressive.
- Axes are labelled with quantities and units, and the source and date of the data are stated.
- A representation shows what was measured; anything added beyond the data is labelled as such.

**Also correct.** Accept any of these framings — do not require the wording above:

- Bar, line, and scatter forms are each correct for the data they suit; the choice is judged on fit.
...
- Presenting a graph with unlabelled axes and drawing a conclusion from it.
- Extending a line beyond the data and treating the extension as measured.
- Choosing a representation that hides the variation in the data.

**Grade boundary.** Statistical graphics conventions and error bars are later work.


## What a complete response contains, question by question

**Q1 — connect unit.** _Serves objective 1:_ Connect data communication to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of data communication.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about data communication using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Connect data communication to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of data communication.
...
**Q6 — limitation.** _Serves objective 1:_ Connect data communication to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of data communication.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for data communication, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for data communication works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of data communication, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking data communication mastered.
...
_Package `swp-ma-g5-science-u09-l10` · built from `canonical-1.0.0` at `4056e31`._
