# Scoring authority — Reteach and varied practice: cause and effect

**Grade 5 Science** · Unit 9: Integrated Science and Engineering Capstone · Day 8 · lesson `ma-g5-science-u09-l08`
...
_Topic `ma-g5-science-u09::cause and effect` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A causal claim names the change made and the change that followed, and rules out the obvious alternatives.
- Correlation is not causation; things can vary together because a third factor drives both.
- In a system with many interacting parts, one effect can have several contributing causes.
...
- Inferring cause from things happening together.
- Assuming an effect has exactly one cause.
- Reversing cause and effect without evidence about which came first.

**Grade boundary.** Confounding, controlled experimental design vocabulary, and statistics are later work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for cause and effect, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of cause and effect.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about cause and effect using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for cause and effect, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of cause and effect.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for cause and effect, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of cause and effect.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for cause and effect, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for cause and effect works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of cause and effect, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking cause and effect mastered.
...
_Package `swp-ma-g5-science-u09-l08` · built from `canonical-1.0.0` at `4056e31`._
