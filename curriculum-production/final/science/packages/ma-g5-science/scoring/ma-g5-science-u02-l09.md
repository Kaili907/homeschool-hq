# Scoring authority — Performance task build: mass and volume

**Grade 5 Science** · Unit 2: Properties of Matter · Day 9 · lesson `ma-g5-science-u02-l09`
...
_Topic `ma-g5-science-u02::mass and volume` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Mass and volume are different quantities and are measured in different units.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Mass is how much matter an object contains; volume is how much space it takes up.
- Two objects of the same volume can have different masses, and two objects of the same mass can have different volumes.
- Mass is measured with a balance and volume by measuring dimensions or by displacement.

**Also correct.** Accept any of these framings — do not require the wording above:

- Weight and mass are distinguished in later grades; at this grade a learner who uses them interchangeably in everyday contexts is not wrong unless the lesson turns on the distinction.
...
- Claiming a larger object always has more mass.
- Reporting a volume in mass units, or a mass in volume units.
- Claiming mass changes when an object changes shape.

**Grade boundary.** Density as mass divided by volume, and the mass-weight distinction as a graded idea, are Grade 7 and later work.
...
**Q1 — build product.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies mass and volume and the unit standards.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of mass and volume.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about mass and volume using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies mass and volume and the unit standards.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of mass and volume.
...
**Q6 — limitation.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies mass and volume and the unit standards.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of mass and volume.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for mass and volume, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for mass and volume works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of mass and volume, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking mass and volume mastered.
...
_Package `swp-ma-g5-science-u02-l09` · built from `canonical-1.0.0` at `4056e31`._
