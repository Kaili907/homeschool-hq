# Scoring authority — Correction and reflection: regional water patterns

**Grade 5 Science** · Unit 6: Earth Systems and Water · Day 12 · lesson `ma-g5-science-u06-l12`
...
_Topic `ma-g5-science-u06::regional water patterns` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- The amount and timing of water available differ from region to region because of climate, landforms, and the geology beneath.
- Regions with plenty of surface water can still face shortage if the water is polluted, seasonal, or shared between many users.
- A region's water pattern is described over years, not from a single measurement.
...
- Claiming a region near a large lake or river cannot have a water problem.
- Describing a region's water pattern from one season's data.
- Claiming water availability depends on rainfall alone.

**Grade boundary.** Water-budget calculation and drought indices are later work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for regional water patterns, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of regional water patterns.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about regional water patterns using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for regional water patterns, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of regional water patterns.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for regional water patterns, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of regional water patterns.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for regional water patterns, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for regional water patterns works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of regional water patterns, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking regional water patterns mastered.
...
_Package `swp-ma-g5-science-u06-l12` · built from `canonical-1.0.0` at `4056e31`._
