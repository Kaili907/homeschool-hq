# Scoring authority — Correction and reflection: scientific argument

**Grade 5 Science** · Unit 9: Integrated Science and Engineering Capstone · Day 12 · lesson `ma-g5-science-u09-l12`
...
_Topic `ma-g5-science-u09::scientific argument` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A scientific argument connects a claim to evidence by explicit reasoning.
- The strongest opposing case is stated and addressed, rather than left out.
- An argument reaches only as far as its evidence, and it says where that limit falls.
...
- Making a claim broader than the evidence supports.

**Grade boundary.** Formal argumentation schemes and peer review are later work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for scientific argument, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of scientific argument.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about scientific argument using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for scientific argument, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of scientific argument.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for scientific argument, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of scientific argument.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for scientific argument, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for scientific argument works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of scientific argument, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking scientific argument mastered.
...
_Package `swp-ma-g5-science-u09-l12` · built from `canonical-1.0.0` at `4056e31`._
