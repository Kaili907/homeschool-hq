# Scoring authority — Performance task build: energy and matter

**Grade 5 Science** · Unit 9: Integrated Science and Engineering Capstone · Day 9 · lesson `ma-g5-science-u09-l09`
...
_Topic `ma-g5-science-u09::energy and matter` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Matter cycles within a system; energy flows through it and is not recycled.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Matter cycles within and between systems, while energy flows through them in one direction.
- Tracking matter and tracking energy are two different accounts of the same process, and both are needed.
- Neither matter nor energy is created or destroyed within a system; both can only enter, leave, or change form.
...
- Claiming energy cycles the way matter does.
- Claiming matter or energy is created or destroyed inside a system.
- Treating an account of matter as though it also accounted for energy.

**Grade boundary.** Entropy, the second law, and quantitative energy budgets are High School work.
...
**Q1 — build product.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies energy and matter and the unit standards.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of energy and matter.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about energy and matter using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies energy and matter and the unit standards.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of energy and matter.
...
**Q6 — limitation.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies energy and matter and the unit standards.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of energy and matter.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for energy and matter, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for energy and matter works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of energy and matter, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking energy and matter mastered.
...
_Package `swp-ma-g5-science-u09-l09` · built from `canonical-1.0.0` at `4056e31`._
