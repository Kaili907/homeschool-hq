# Scoring authority — Unit assessment: open and closed systems

**Grade 5 Science** · Unit 3: Changes and Conservation of Matter · Day 11 · lesson `ma-g5-science-u03-l11`
...
_Topic `ma-g5-science-u03::open and closed systems` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A closed system does not exchange matter with its surroundings; an open system does.
- Conservation of mass is directly observable in a closed system, and in an open one only if what crosses the boundary is accounted for.
- Defining the boundary of the system is part of the investigation, not a detail.
...
- Treating an open container as a closed system.
- Claiming conservation of mass fails because an open system lost mass.
- Reporting a system without saying where its boundary was drawn.

**Grade boundary.** Isolated systems and energy exchange across boundaries are later work.


## What a complete response contains, question by question

**Q1 — demonstrate mastery.** _Serves objective 1:_ Demonstrate current mastery of open and closed systems through selected-response, constructed-response, and applied evidence.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of open and closed systems.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about open and closed systems using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Demonstrate current mastery of open and closed systems through selected-response, constructed-response, and applied evidence.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of open and closed systems.
...
**Q6 — limitation.** _Serves objective 1:_ Demonstrate current mastery of open and closed systems through selected-response, constructed-response, and applied evidence.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of open and closed systems.
...
- The learner completes the central task about open and closed systems.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for open and closed systems, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for open and closed systems works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of open and closed systems, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking open and closed systems mastered.
...
_Package `swp-ma-g5-science-u03-l11` · built from `canonical-1.0.0` at `4056e31`._
