# Scoring authority — Performance task build: signs of chemical change

**Grade 5 Science** · Unit 3: Changes and Conservation of Matter · Day 9 · lesson `ma-g5-science-u03-l09`
...
_Topic `ma-g5-science-u03::signs of chemical change` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Evidence of a chemical change includes gas production, a temperature change not caused by heating or cooling from outside, a colour change, a precipitate forming, light being given off, and an odour appearing.
...
- Signs that suggest a chemical change include gas bubbles, an unexpected temperature change, colour change, a solid forming from clear liquids, light, and a new smell.
- Any single sign can have another explanation, so several lines of evidence make the conclusion stronger.

**Also correct.** Accept any of these framings — do not require the wording above:

- Chemical change and chemical reaction are the same idea at this grade.
...
- Treating bubbling alone as proof of a chemical change, when boiling and dissolved gas escaping also bubble.
- Claiming a colour change always means a chemical change.
- Claiming a chemical change destroys matter.

**Grade boundary.** Balancing equations, reaction energetics, and reaction rate are Grade 7 and later work.
...
**Q1 — build product.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies signs of chemical change and the unit standards.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of signs of chemical change.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about signs of chemical change using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies signs of chemical change and the unit standards.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of signs of chemical change.
...
**Q6 — limitation.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies signs of chemical change and the unit standards.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of signs of chemical change.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for signs of chemical change, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for signs of chemical change works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of signs of chemical change, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking signs of chemical change mastered.
...
_Package `swp-ma-g5-science-u03-l09` · built from `canonical-1.0.0` at `4056e31`._
