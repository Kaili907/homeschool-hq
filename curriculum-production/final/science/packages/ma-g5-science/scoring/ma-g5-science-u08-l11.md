# Scoring authority — Unit assessment: evidence-based decisions

**Grade 5 Science** · Unit 8: Human Impact and Environmental Decisions · Day 11 · lesson `ma-g5-science-u08-l11`
...
_Topic `ma-g5-science-u08::evidence-based decisions` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A decision is evidence-based when the evidence is named, its source is given, and the reasoning from evidence to decision is shown.
- Evidence can constrain a decision without settling it, because decisions also involve values.
- Evidence that argues against the preferred option is reported, not omitted.
...
- Presenting a decision as evidence-based with no evidence cited.
- Omitting evidence that counts against the chosen option.
- Claiming evidence alone determines what should be done.

**Grade boundary.** Formal decision theory and stakeholder analysis are later work.


## What a complete response contains, question by question

**Q1 — demonstrate mastery.** _Serves objective 1:_ Demonstrate current mastery of evidence-based decisions through selected-response, constructed-response, and applied evidence.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of evidence-based decisions.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about evidence-based decisions using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Demonstrate current mastery of evidence-based decisions through selected-response, constructed-response, and applied evidence.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of evidence-based decisions.
...
**Q6 — limitation.** _Serves objective 1:_ Demonstrate current mastery of evidence-based decisions through selected-response, constructed-response, and applied evidence.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of evidence-based decisions.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for evidence-based decisions, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for evidence-based decisions works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of evidence-based decisions, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking evidence-based decisions mastered.
...
_Package `swp-ma-g5-science-u08-l11` · built from `canonical-1.0.0` at `4056e31`._
