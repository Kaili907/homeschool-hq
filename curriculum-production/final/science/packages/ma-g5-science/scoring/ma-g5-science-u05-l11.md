# Scoring authority — Unit assessment: matter cycling

**Grade 5 Science** · Unit 5: Plants, Ecosystems, and Matter Cycles · Day 11 · lesson `ma-g5-science-u05-l11`
...
_Topic `ma-g5-science-u05::matter cycling` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Matter cycles among organisms and the environment; energy flows through and does not cycle.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Matter cycles repeatedly between organisms and the air, water, and soil around them.
- The same atoms are used over and over by different organisms across time.
- Energy, unlike matter, flows through an ecosystem in one direction and is not recycled.
...
- Claiming new matter is created by organisms as they grow.

**Grade boundary.** Named biogeochemical cycles with reservoirs and fluxes are Grade 7 and High School work.


## What a complete response contains, question by question

**Q1 — demonstrate mastery.** _Serves objective 1:_ Demonstrate current mastery of matter cycling through selected-response, constructed-response, and applied evidence.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of matter cycling.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about matter cycling using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Demonstrate current mastery of matter cycling through selected-response, constructed-response, and applied evidence.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of matter cycling.
...
**Q6 — limitation.** _Serves objective 1:_ Demonstrate current mastery of matter cycling through selected-response, constructed-response, and applied evidence.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of matter cycling.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for matter cycling, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for matter cycling works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of matter cycling, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking matter cycling mastered.
...
_Package `swp-ma-g5-science-u05-l11` · built from `canonical-1.0.0` at `4056e31`._
