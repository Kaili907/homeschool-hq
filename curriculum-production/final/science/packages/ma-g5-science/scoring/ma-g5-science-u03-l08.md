# Scoring authority — Reteach and varied practice: mixing substances

**Grade 5 Science** · Unit 3: Changes and Conservation of Matter · Day 8 · lesson `ma-g5-science-u03-l08`
...
_Topic `ma-g5-science-u03::mixing substances` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Mixing two substances sometimes produces a mixture and sometimes produces new substances.
- Which of the two happened is decided by evidence, not by whether the result looks different.
- When only a mixture forms, the original substances are still there and can in principle be separated.
...
- Concluding a new substance formed only because the appearance changed.
- Claiming any two substances mixed together always react.
- Claiming a mixture cannot be separated once it has been stirred.

**Grade boundary.** Reaction equations, reactants and products by name, and reaction types are Grade 7 and later work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for mixing substances, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of mixing substances.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about mixing substances using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for mixing substances, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of mixing substances.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for mixing substances, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of mixing substances.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for mixing substances, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for mixing substances works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of mixing substances, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking mixing substances mastered.
...
_Package `swp-ma-g5-science-u03-l08` · built from `canonical-1.0.0` at `4056e31`._
