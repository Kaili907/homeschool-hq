# Scoring authority — Unit assessment: mixtures

**Grade 5 Science** · Unit 2: Properties of Matter · Day 11 · lesson `ma-g5-science-u02-l11`
...
_Topic `ma-g5-science-u02::mixtures` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- In a mixture, the substances keep their own properties and can in principle be separated.
...
- Mixtures can be separated by physical means such as filtering, sieving, evaporating, or using a magnet, because the substances have not been changed.
- A substance that has dissolved is still present in the mixture, and evaporating the liquid recovers it.

**Also correct.** Accept any of these framings — do not require the wording above:

- Solutions are mixtures; a learner who calls dissolved sugar in water a mixture or a solution is correct either way.
...
- Claiming dissolving destroys the dissolved substance.
- Claiming a mixture cannot be separated because it looks uniform.
- Claiming any combination of substances is a new substance.

**Grade boundary.** Solubility curves, concentration units, and the compound-versus-mixture distinction in chemical terms are Grade 7 and later work.


## What a complete response contains, question by question

**Q1 — demonstrate mastery.** _Serves objective 1:_ Demonstrate current mastery of mixtures through selected-response, constructed-response, and applied evidence.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of mixtures.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about mixtures using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Demonstrate current mastery of mixtures through selected-response, constructed-response, and applied evidence.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of mixtures.
...
**Q6 — limitation.** _Serves objective 1:_ Demonstrate current mastery of mixtures through selected-response, constructed-response, and applied evidence.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of mixtures.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for mixtures, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for mixtures works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of mixtures, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking mixtures mastered.
...
_Package `swp-ma-g5-science-u02-l11` · built from `canonical-1.0.0` at `4056e31`._
