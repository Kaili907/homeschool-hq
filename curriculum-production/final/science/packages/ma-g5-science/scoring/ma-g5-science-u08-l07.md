# Scoring authority — Investigation or close reading: resource use

**Grade 5 Science** · Unit 8: Human Impact and Environmental Decisions · Day 7 · lesson `ma-g5-science-u08-l07`
...
_Topic `ma-g5-science-u08::resource use` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Renewable resources are replenished on a human timescale; non-renewable resources are not.

**Accepted relationships and models.** What this lesson's learning target asserts:

- People use Earth's resources for energy, food, water, materials, and shelter.
- Renewable resources are replenished on a human timescale; non-renewable resources are used faster than they form.
- A renewable resource can still be exhausted locally if it is used faster than it is replenished.
...
- Claiming renewable resources cannot be depleted.
- Claiming fossil fuels are renewable because they are still forming somewhere.
- Claiming resource use has no environmental effect if the resource is renewable.

**Grade boundary.** Reserve estimation and resource economics are later work.
...
**Q1 — analyze evidence.** _Serves objective 1:_ Gather and analyze evidence related to resource use, then record a defensible interpretation.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of resource use.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about resource use using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Gather and analyze evidence related to resource use, then record a defensible interpretation.
...
**Q5 — evidence quality.** _Serves objective 1:_ Gather and analyze evidence related to resource use, then record a defensible interpretation.
...
**Q6 — limitation.** _Serves objective 1:_ Gather and analyze evidence related to resource use, then record a defensible interpretation.
...
**Q7 — provenance.** _Serves objective 1:_ Gather and analyze evidence related to resource use, then record a defensible interpretation.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for resource use, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for resource use works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of resource use, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking resource use mastered.
...
_Package `swp-ma-g5-science-u08-l07` · built from `canonical-1.0.0` at `4056e31`._
