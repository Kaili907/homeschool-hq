# Scoring authority — Correction and reflection: ecosystem interdependence

**Grade 5 Science** · Unit 5: Plants, Ecosystems, and Matter Cycles · Day 12 · lesson `ma-g5-science-u05-l12`
...
_Topic `ma-g5-science-u05::ecosystem interdependence` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Organisms in an ecosystem depend on one another and on the non-living parts of their environment.
- A change to one part of an ecosystem can affect parts that are not directly connected to it.
- Interdependence means an ecosystem's behaviour cannot be predicted by looking at one organism alone.
...
- Claiming each organism in an ecosystem is independent of the others.
- Claiming the non-living parts of an environment are not part of the ecosystem.
- Predicting the effect of a change by considering only the directly connected organism.

**Grade boundary.** Keystone species, resilience metrics, and quantitative community ecology are later work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for ecosystem interdependence, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of ecosystem interdependence.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about ecosystem interdependence using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for ecosystem interdependence, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of ecosystem interdependence.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for ecosystem interdependence, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of ecosystem interdependence.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for ecosystem interdependence, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for ecosystem interdependence works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of ecosystem interdependence, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking ecosystem interdependence mastered.
...
_Package `swp-ma-g5-science-u05-l12` · built from `canonical-1.0.0` at `4056e31`._
