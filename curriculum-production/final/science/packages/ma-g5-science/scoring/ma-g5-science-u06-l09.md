# Scoring authority — Performance task build: surface water and groundwater

**Grade 5 Science** · Unit 6: Earth Systems and Water · Day 9 · lesson `ma-g5-science-u06-l09`
...
_Topic `ma-g5-science-u06::surface water and groundwater` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Water at the surface collects in streams, rivers, lakes, and wetlands, and water underground fills spaces between soil particles and cracks in rock.
- Surface water and groundwater are connected: water moves between them, so what happens to one affects the other.
- Water moves downhill at the surface and moves through the ground much more slowly than it moves in a river.

**Also correct.** Accept any of these framings — do not require the wording above:

- Describing groundwater as filling pore spaces, or as being held in an aquifer, are both correct.
...
- Claiming groundwater flows in underground rivers everywhere beneath the surface.
- Claiming surface water and groundwater are separate supplies that never mix.
- Claiming pollution at the surface cannot reach groundwater.

**Grade boundary.** Hydraulic conductivity, aquifer modelling, and recharge rates are High School work.
...
**Q1 — build product.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies surface water and groundwater and the unit standards.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of surface water and groundwater.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about surface water and groundwater using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies surface water and groundwater and the unit standards.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of surface water and groundwater.
...
**Q6 — limitation.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies surface water and groundwater and the unit standards.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of surface water and groundwater.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for surface water and groundwater, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for surface water and groundwater works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of surface water and groundwater, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking surface water and groundwater mastered.
...
_Package `swp-ma-g5-science-u06-l09` · built from `canonical-1.0.0` at `4056e31`._
