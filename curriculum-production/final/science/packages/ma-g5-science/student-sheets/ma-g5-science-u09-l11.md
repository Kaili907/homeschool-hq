# Unit assessment: design iteration

**Grade 5 Science** · Unit 9: Integrated Science and Engineering Capstone · Day 11 of the unit (course day 107) · about 45–65 minutes

**Today's focus:** design iteration
...
- Demonstrate current mastery of design iteration through selected-response, constructed-response, and applied evidence.
- Use subject-appropriate evidence or representation to communicate understanding of design iteration.
- Check, revise, or improve work about design iteration using stated success criteria.
...
- Science brief: iteration means testing, using the result to make a specific change, and testing again.
- Science brief: one change at a time lets the effect of that change be identified.
- Science brief: a failed test is the normal and useful input to the next iteration.

### Evidence check: design iteration

**Candidate claim:** A case report presents this as acceptable science: “changing several things between tests and attributing the improvement to one.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: iteration means testing, using the result to make a specific change, and testing again. |
| E2 | established science reference | Science brief: one change at a time lets the effect of that change be identified. |
| E3 | established science reference | Science brief: a failed test is the normal and useful input to the next iteration. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u09::design iteration, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about design iteration, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about design iteration, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? Rate confidence in design iteration, cite one piece of evidence from today, and choose: ready to extend, ready to review later, or need a different explanation.**
...
**Q1.** Complete all three parts for design iteration. (1) Select A: supported, B: partly supported, or C: not supported for the candidate claim. (2) Justify the selection with E1-E3. (3) Rewrite the claim so every word is supported by the supplied record.

>

**Q2.** Communicate what the supplied record establishes about design iteration in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about design iteration against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using design iteration as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about design iteration? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about design iteration that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about design iteration. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about design iteration.
...
- Apply design iteration under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect design iteration to systems thinking from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g5-science-u09-l11` · lesson `ma-g5-science-u09-l11` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
