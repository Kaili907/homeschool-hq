# Reteach and varied practice: air and water as matter sources

**Grade 5 Science** · Unit 5: Plants, Ecosystems, and Matter Cycles · Day 8 of the unit (course day 56) · about 45–65 minutes

**Today's focus:** air and water as matter sources
...
- Use error evidence to choose a different representation or strategy for air and water as matter sources, then demonstrate corrected understanding.
- Use subject-appropriate evidence or representation to communicate understanding of air and water as matter sources.
- Check, revise, or improve work about air and water as matter sources using stated success criteria.
...
- Science brief: most of the material a plant's body is built from comes from air and water, not from soil.
- Science brief: the material that makes up a plant comes chiefly from air and water, not from the soil it grows in.
- Science brief: the carbon in a plant's body comes from carbon dioxide taken in from the air.
- Science brief: soil loses very little mass as a plant growing in it gains a great deal, which is the evidence for this.

### Evidence check: air and water as matter sources

**Candidate claim:** A case report presents this as acceptable science: “a plant's mass comes mainly from the soil.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: most of the material a plant's body is built from comes from air and water, not from soil. |
| E2 | established science reference | Science brief: the material that makes up a plant comes chiefly from air and water, not from the soil it grows in. |
| E3 | established science reference | Science brief: the carbon in a plant's body comes from carbon dioxide taken in from the air. |
| E4 | established science reference | Science brief: soil loses very little mass as a plant growing in it gains a great deal, which is the evidence for this. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u05::air and water as matter sources, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about air and water as matter sources, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about air and water as matter sources, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about air and water as matter sources; then identify one check that would catch an error or weak claim.**
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E4. Name the decisive evidence ID, explain the error about air and water as matter sources, and write a corrected claim.

>

**Q2.** Communicate what the supplied record establishes about air and water as matter sources in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about air and water as matter sources against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using air and water as matter sources as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about air and water as matter sources? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about air and water as matter sources that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about air and water as matter sources. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about air and water as matter sources.
...
- Apply air and water as matter sources under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect air and water as matter sources to plant growth needs from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g5-science-u05-l08` · lesson `ma-g5-science-u05-l08` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
