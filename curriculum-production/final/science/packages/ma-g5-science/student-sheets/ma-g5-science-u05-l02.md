# Concept model A: air and water as matter sources

**Grade 5 Science** · Unit 5: Plants, Ecosystems, and Matter Cycles · Day 2 of the unit (course day 50) · about 45–65 minutes
...
- Build a clear mental model of air and water as matter sources through an explicit worked example, demonstration, text, or phenomenon.
...
**Q1.** Build a labelled model of air and water as matter sources that represents every supplied row in E1-E4. Annotate each model feature with its evidence ID, then show where the candidate claim fails or remains uncertain.
...
_Package `swp-ma-g5-science-u05-l02` · lesson `ma-g5-science-u05-l02` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
