...
**Grade 5 Science** · Unit 1: Science and Engineering Practices · Day 4 of the unit (course day 4) · about 45–65 minutes
...
**Q1.** Independently evaluate this fully supplied case about fair tests: A case report presents this as acceptable science: “calling a test fair when more than one condition changed.” Use at least two rows from E1-E4, correct the claim if needed, and state one limit.
...
_Package `swp-ma-g5-science-u01-l04` · lesson `ma-g5-science-u01-l04` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
