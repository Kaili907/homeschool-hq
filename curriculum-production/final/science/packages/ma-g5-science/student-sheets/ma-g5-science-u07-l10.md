# Synthesis and review: seasonal daylight patterns

**Grade 5 Science** · Unit 7: Patterns in the Sky · Day 10 of the unit (course day 82) · about 45–65 minutes

**Today's focus:** seasonal daylight patterns
...
- Connect seasonal daylight patterns to the unit’s other ideas and select evidence that shows readiness for assessment.
- Use subject-appropriate evidence or representation to communicate understanding of seasonal daylight patterns.
- Check, revise, or improve work about seasonal daylight patterns using stated success criteria.
...
- Science brief: seasons are caused by the tilt of Earth's axis, not by Earth's distance from the Sun.
- Science brief: the length of daylight and the Sun's height in the sky change through the year in a repeating pattern.
- Science brief: these seasonal patterns are caused by the tilt of Earth's axis as Earth orbits the Sun.
- Science brief: because of the tilt, the Northern and Southern Hemispheres have opposite seasons at the same time of year.

### Evidence check: seasonal daylight patterns
...
| --- | --- | --- |
| E1 | established science reference | Science brief: seasons are caused by the tilt of Earth's axis, not by Earth's distance from the Sun. |
| E2 | established science reference | Science brief: the length of daylight and the Sun's height in the sky change through the year in a repeating pattern. |
| E3 | established science reference | Science brief: these seasonal patterns are caused by the tilt of Earth's axis as Earth orbits the Sun. |
| E4 | established science reference | Science brief: because of the tilt, the Northern and Southern Hemispheres have opposite seasons at the same time of year. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u07::seasonal daylight patterns, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about seasonal daylight patterns, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about seasonal daylight patterns, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about seasonal daylight patterns; then identify one check that would catch an error or weak claim.**
...
**Q1.** The supplied unit connections are: star brightness and distance, sun as a star, daily shadow patterns, seasonal daylight patterns, data over time, scale models and limitations. Choose one idea other than seasonal daylight patterns, connect it to one row in E1-E4, and explain one way treating the two ideas as identical would be misleading.

>

**Q2.** Communicate what the supplied record establishes about seasonal daylight patterns in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about seasonal daylight patterns against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using seasonal daylight patterns as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about seasonal daylight patterns? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about seasonal daylight patterns that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about seasonal daylight patterns. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about seasonal daylight patterns.
...
- Apply seasonal daylight patterns under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect seasonal daylight patterns to star brightness and distance from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g5-science-u07-l10` · lesson `ma-g5-science-u07-l10` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
