...
**Grade 5 Science** · Unit 5: Plants, Ecosystems, and Matter Cycles · Day 10 of the unit (course day 58) · about 45–65 minutes
...
- Science brief: a food web shows the feeding relationships in an ecosystem, with arrows pointing from the organism eaten to the organism that eats it.
- Science brief: most organisms appear in more than one chain within a web, which is why a web represents an ecosystem better than a single chain.
- Science brief: changing the number of one organism affects others in the web, sometimes several steps away.

### Evidence check: food webs

**Candidate claim:** A case report presents this as acceptable science: “drawing arrows from predator to prey.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a food web shows the feeding relationships in an ecosystem, with arrows pointing from the organism eaten to the organism that eats it. |
| E2 | established science reference | Science brief: most organisms appear in more than one chain within a web, which is why a web represents an ecosystem better than a single chain. |
| E3 | established science reference | Science brief: changing the number of one organism affects others in the web, sometimes several steps away. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u05::food webs, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.
...
**Q1.** The supplied unit connections are: plant growth needs, air and water as matter sources, producers consumers decomposers, food webs, matter cycling, ecosystem interdependence. Choose one idea other than food webs, connect it to one row in E1-E3, and explain one way treating the two ideas as identical would be misleading.
...
- Connect food webs to plant growth needs from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g5-science-u05-l10` · lesson `ma-g5-science-u05-l10` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
