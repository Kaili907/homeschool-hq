...
**Grade 5 Science** · Unit 5: Plants, Ecosystems, and Matter Cycles · Day 4 of the unit (course day 52) · about 45–65 minutes
...
**Q1.** Independently evaluate this fully supplied case about food webs: A case report presents this as acceptable science: “drawing arrows from predator to prey.” Use at least two rows from E1-E3, correct the claim if needed, and state one limit.
...
_Package `swp-ma-g5-science-u05-l04` · lesson `ma-g5-science-u05-l04` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
