# Performance task build: mass and volume

**Grade 5 Science** · Unit 2: Properties of Matter · Day 9 of the unit (course day 21) · about 45–65 minutes

**Today's focus:** mass and volume
...
- Create, test, or revise a meaningful product that applies mass and volume and the unit standards.
- Use subject-appropriate evidence or representation to communicate understanding of mass and volume.
- Check, revise, or improve work about mass and volume using stated success criteria.
...
- Science brief: mass and volume are different quantities and are measured in different units.
- Science brief: mass is how much matter an object contains; volume is how much space it takes up.
- Science brief: two objects of the same volume can have different masses, and two objects of the same mass can have different volumes.
- Science brief: mass is measured with a balance and volume by measuring dimensions or by displacement.

### Evidence check: mass and volume

**Candidate claim:** A case report presents this as acceptable science: “a larger object always has more mass.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: mass and volume are different quantities and are measured in different units. |
| E2 | established science reference | Science brief: mass is how much matter an object contains; volume is how much space it takes up. |
| E3 | established science reference | Science brief: two objects of the same volume can have different masses, and two objects of the same mass can have different volumes. |
| E4 | established science reference | Science brief: mass is measured with a balance and volume by measuring dimensions or by displacement. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u02::mass and volume, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about mass and volume, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about mass and volume?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g5-science-u02::mass and volume, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u02::mass and volume, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about mass and volume?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about mass and volume; then identify one check that would catch an error or weak claim.**
...
**Q1.** Create a one-page evidence product for mass and volume using only the supplied case and E1-E4: one claim, at least two cited rows, the reasoning link, one counterpoint, and one revision after checking the success criteria.

>

**Q2.** Communicate what the supplied record establishes about mass and volume in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about mass and volume against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using mass and volume as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about mass and volume? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about mass and volume that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about mass and volume. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about mass and volume.
...
- Apply mass and volume under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect mass and volume to particles and matter models from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g5-science-u02-l09` · lesson `ma-g5-science-u02-l09` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
