# Investigation or close reading: geosphere hydrosphere atmosphere biosphere

**Grade 5 Science** · Unit 6: Earth Systems and Water · Day 7 of the unit (course day 67) · about 45–65 minutes

**Today's focus:** geosphere hydrosphere atmosphere biosphere

**Unit question:** How can understanding earth systems and water help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Gather and analyze evidence related to geosphere hydrosphere atmosphere biosphere, then record a defensible interpretation.
- Use subject-appropriate evidence or representation to communicate understanding of geosphere hydrosphere atmosphere biosphere.
- Check, revise, or improve work about geosphere hydrosphere atmosphere biosphere using stated success criteria.
...
- Science brief: earth's major systems are the geosphere, the hydrosphere, the atmosphere, and the biosphere.
- Science brief: earth's major systems are the geosphere, hydrosphere, atmosphere, and biosphere, and they interact continuously.
- Science brief: nearly every Earth process involves more than one of these systems at once.
- Science brief: the four-system division is a model for thinking about Earth, not a set of physically separate compartments.

### Evidence check: geosphere hydrosphere atmosphere biosphere

**Candidate claim:** A case report presents this as acceptable science: “the systems operate independently of one another.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: earth's major systems are the geosphere, the hydrosphere, the atmosphere, and the biosphere. |
| E2 | established science reference | Science brief: earth's major systems are the geosphere, hydrosphere, atmosphere, and biosphere, and they interact continuously. |
| E3 | established science reference | Science brief: nearly every Earth process involves more than one of these systems at once. |
| E4 | established science reference | Science brief: the four-system division is a model for thinking about Earth, not a set of physically separate compartments. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u06::geosphere hydrosphere atmosphere biosphere, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.

**Supplied unit connections:** geosphere hydrosphere atmosphere biosphere; water distribution; surface water and groundwater; system interactions; maps and data; regional water patterns

**Supplied unit performance task:** Develop a local or fictional watershed explanation using maps, data, and an Earth-systems model.

### Bound task

**Question:** What does evidence E1 through E4 justify about geosphere hydrosphere atmosphere biosphere, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about geosphere hydrosphere atmosphere biosphere?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g5-science-u06::geosphere hydrosphere atmosphere biosphere, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u06::geosphere hydrosphere atmosphere biosphere, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about geosphere hydrosphere atmosphere biosphere?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about geosphere hydrosphere atmosphere biosphere; then identify one check that would catch an error or weak claim.**
...
**Q1.** Classify every supplied row E1-E4 as supports, challenges, or does not decide the candidate claim about geosphere hydrosphere atmosphere biosphere. Cite the row and explain each classification.

>

**Q2.** Communicate what the supplied record establishes about geosphere hydrosphere atmosphere biosphere in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about geosphere hydrosphere atmosphere biosphere against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using geosphere hydrosphere atmosphere biosphere as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about geosphere hydrosphere atmosphere biosphere? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about geosphere hydrosphere atmosphere biosphere that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about geosphere hydrosphere atmosphere biosphere. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about geosphere hydrosphere atmosphere biosphere.
...
- Apply geosphere hydrosphere atmosphere biosphere under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect geosphere hydrosphere atmosphere biosphere to water distribution from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Develop a local or fictional watershed explanation using maps, data, and an Earth-systems model. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-g5-science-u06-l07` · lesson `ma-g5-science-u06-l07` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
