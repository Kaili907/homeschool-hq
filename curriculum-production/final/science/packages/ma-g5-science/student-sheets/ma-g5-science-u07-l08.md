# Reteach and varied practice: sun as a star

**Grade 5 Science** · Unit 7: Patterns in the Sky · Day 8 of the unit (course day 80) · about 45–65 minutes
...
- Use error evidence to choose a different representation or strategy for sun as a star, then demonstrate corrected understanding.
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E4. Name the decisive evidence ID, explain the error about sun as a star, and write a corrected claim.
...
_Package `swp-ma-g5-science-u07-l08` · lesson `ma-g5-science-u07-l08` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
