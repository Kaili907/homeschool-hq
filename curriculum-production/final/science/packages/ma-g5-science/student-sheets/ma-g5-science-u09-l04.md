# Independent application A: data communication

**Grade 5 Science** · Unit 9: Integrated Science and Engineering Capstone · Day 4 of the unit (course day 100) · about 45–65 minutes
...
- Apply data communication independently in a new representation, text, situation, or design constraint.
...
**Q1.** Independently evaluate this fully supplied case about data communication: A case report presents this as acceptable science: “presenting a graph with unlabelled axes and drawing a conclusion from it.” Use at least two rows from E1-E3, correct the claim if needed, and state one limit.
...
_Package `swp-ma-g5-science-u09-l04` · lesson `ma-g5-science-u09-l04` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
