# Investigation or close reading: particles and matter models

**Grade 5 Science** · Unit 2: Properties of Matter · Day 7 of the unit (course day 19) · about 45–65 minutes

**Today's focus:** particles and matter models

**Unit question:** How can understanding properties of matter help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Gather and analyze evidence related to particles and matter models, then record a defensible interpretation.
- Use subject-appropriate evidence or representation to communicate understanding of particles and matter models.
- Check, revise, or improve work about particles and matter models using stated success criteria.
...
- Science brief: matter is made of particles too small to be seen.
- Science brief: all matter is made of particles that are far too small to see, even with an ordinary microscope.
- Science brief: because matter is made of particles, a substance can be present even when it cannot be seen, as air is.
- Science brief: the particle model explains why matter that seems to disappear, such as evaporating water or dissolving sugar, has not stopped existing.

### Evidence check: particles and matter models

**Candidate claim:** A case report presents this as acceptable science: “a gas is not matter because it cannot be seen.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: matter is made of particles too small to be seen. |
| E2 | established science reference | Science brief: all matter is made of particles that are far too small to see, even with an ordinary microscope. |
| E3 | established science reference | Science brief: because matter is made of particles, a substance can be present even when it cannot be seen, as air is. |
| E4 | established science reference | Science brief: the particle model explains why matter that seems to disappear, such as evaporating water or dissolving sugar, has not stopped existing. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u02::particles and matter models, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.

**Supplied unit connections:** particles and matter models; observable properties; mass and volume; identifying materials; mixtures; measurement precision

**Supplied unit performance task:** Create an evidence-based material identification guide using safe samples and measured properties.

### Bound task

**Question:** What does evidence E1 through E4 justify about particles and matter models, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about particles and matter models?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g5-science-u02::particles and matter models, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u02::particles and matter models, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about particles and matter models?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about particles and matter models; then identify one check that would catch an error or weak claim.**
...
**Q1.** Classify every supplied row E1-E4 as supports, challenges, or does not decide the candidate claim about particles and matter models. Cite the row and explain each classification.

>

**Q2.** Communicate what the supplied record establishes about particles and matter models in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about particles and matter models against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using particles and matter models as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about particles and matter models? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about particles and matter models that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about particles and matter models. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about particles and matter models.
...
- Apply particles and matter models under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect particles and matter models to observable properties from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Create an evidence-based material identification guide using safe samples and measured properties. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-g5-science-u02-l07` · lesson `ma-g5-science-u02-l07` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
