# Reteach and varied practice: energy in food

**Grade 5 Science** · Unit 4: Energy in Food and Motion · Day 8 of the unit (course day 44) · about 45–65 minutes

**Today's focus:** energy in food
...
- Use error evidence to choose a different representation or strategy for energy in food, then demonstrate corrected understanding.
- Use subject-appropriate evidence or representation to communicate understanding of energy in food.
- Check, revise, or improve work about energy in food using stated success criteria.
...
- Science brief: food provides organisms with both energy and the materials their bodies are built from.
- Science brief: the energy an animal uses for motion, growth, warmth, and repair comes from its food.
- Science brief: food energy that is not used immediately is stored, not destroyed.

### Evidence check: energy in food

**Candidate claim:** A case report presents this as acceptable science: “animals make their own food inside their bodies.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: food provides organisms with both energy and the materials their bodies are built from. |
| E2 | established science reference | Science brief: the energy an animal uses for motion, growth, warmth, and repair comes from its food. |
| E3 | established science reference | Science brief: food energy that is not used immediately is stored, not destroyed. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u04::energy in food, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about energy in food, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about energy in food, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about energy in food; then identify one check that would catch an error or weak claim.**
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E3. Name the decisive evidence ID, explain the error about energy in food, and write a corrected claim.

>

**Q2.** Communicate what the supplied record establishes about energy in food in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about energy in food against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using energy in food as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about energy in food? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about energy in food that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about energy in food. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about energy in food.
...
- Apply energy in food under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect energy in food to energy from the sun from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g5-science-u04-l08` · lesson `ma-g5-science-u04-l08` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
