# Concept model A: observable properties

**Grade 5 Science** · Unit 2: Properties of Matter · Day 2 of the unit (course day 14) · about 45–65 minutes

**Today's focus:** observable properties
...
- Build a clear mental model of observable properties through an explicit worked example, demonstration, text, or phenomenon.
- Use subject-appropriate evidence or representation to communicate understanding of observable properties.
- Check, revise, or improve work about observable properties using stated success criteria.
...
- Science brief: materials can be described by observable properties such as colour, hardness, texture, flexibility, magnetic attraction, conductivity, solubility, and whether they float in water.
- Science brief: some properties do not depend on how much of the material there is, and those are the useful ones for identifying it.
- Science brief: a single property rarely identifies a material; several together do much better.

### Evidence check: observable properties

**Candidate claim:** A case report presents this as acceptable science: “identifying a material from colour alone.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: materials can be described by observable properties such as colour, hardness, texture, flexibility, magnetic attraction, conductivity, solubility, and whether they float in water. |
| E2 | established science reference | Science brief: some properties do not depend on how much of the material there is, and those are the useful ones for identifying it. |
| E3 | established science reference | Science brief: a single property rarely identifies a material; several together do much better. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u02::observable properties, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about observable properties, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about observable properties, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about observable properties; then identify one check that would catch an error or weak claim.**
...
**Q1.** Build a labelled model of observable properties that represents every supplied row in E1-E3. Annotate each model feature with its evidence ID, then show where the candidate claim fails or remains uncertain.

>

**Q2.** Communicate what the supplied record establishes about observable properties in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about observable properties against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using observable properties as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about observable properties? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about observable properties that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about observable properties. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about observable properties.
...
- Apply observable properties under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect observable properties to particles and matter models from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g5-science-u02-l02` · lesson `ma-g5-science-u02-l02` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
