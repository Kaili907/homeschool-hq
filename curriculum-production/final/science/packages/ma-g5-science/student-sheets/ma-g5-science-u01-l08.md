...
- Science brief: a testable question names what will be changed or compared and what will be observed or measured.
- Science brief: a question is testable only if some possible result would count against it.
- Science brief: questions of value or preference are not settled by observation, however carefully they are asked.

### Evidence check: testable questions

**Candidate claim:** A case report presents this as acceptable science: “calling a question testable when no observation could disconfirm it.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a testable question names what will be changed or compared and what will be observed or measured. |
| E2 | established science reference | Science brief: a question is testable only if some possible result would count against it. |
| E3 | established science reference | Science brief: questions of value or preference are not settled by observation, however carefully they are asked. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u01::testable questions, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E3. Name the decisive evidence ID, explain the error about testable questions, and write a corrected claim.
...
_Package `swp-ma-g5-science-u01-l08` · lesson `ma-g5-science-u01-l08` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
