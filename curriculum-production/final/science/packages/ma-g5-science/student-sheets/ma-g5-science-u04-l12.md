# Correction and reflection: cause and effect

**Grade 5 Science** · Unit 4: Energy in Food and Motion · Day 12 of the unit (course day 48) · about 45–65 minutes
...
- Use error evidence to choose a different representation or strategy for cause and effect, then demonstrate corrected understanding.
...
- Science brief: a causal claim names what was changed and what changed as a result.
- Science brief: two things varying together is not sufficient evidence that one causes the other.
- Science brief: evidence for causation comes from changing one factor while holding others constant, and observing what follows.

### Evidence check: cause and effect

**Candidate claim:** A case report presents this as acceptable science: “inferring cause from co-occurrence alone.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a causal claim names what was changed and what changed as a result. |
| E2 | established science reference | Science brief: two things varying together is not sufficient evidence that one causes the other. |
| E3 | established science reference | Science brief: evidence for causation comes from changing one factor while holding others constant, and observing what follows. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u04::cause and effect, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E3. Name the decisive evidence ID, explain the error about cause and effect, and write a corrected claim.
...
- Connect cause and effect to energy from the sun from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g5-science-u04-l12` · lesson `ma-g5-science-u04-l12` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
