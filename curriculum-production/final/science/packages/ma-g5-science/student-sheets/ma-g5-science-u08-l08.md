# Reteach and varied practice: waste and pollution

**Grade 5 Science** · Unit 8: Human Impact and Environmental Decisions · Day 8 of the unit (course day 92) · about 45–65 minutes

**Today's focus:** waste and pollution
...
- Use error evidence to choose a different representation or strategy for waste and pollution, then demonstrate corrected understanding.
- Use subject-appropriate evidence or representation to communicate understanding of waste and pollution.
- Check, revise, or improve work about waste and pollution using stated success criteria.
...
- Science brief: waste and pollutants released into air, water, or land do not disappear; they move through Earth's systems.
- Science brief: a pollutant released in one place can affect a different place, because air and water carry it.
- Science brief: the effect of a pollutant depends on how much there is, how long it lasts, and what it reaches.

### Evidence check: waste and pollution

**Candidate claim:** A case report presents this as acceptable science: “waste disposed of out of sight has left the environment.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: waste and pollutants released into air, water, or land do not disappear; they move through Earth's systems. |
| E2 | established science reference | Science brief: a pollutant released in one place can affect a different place, because air and water carry it. |
| E3 | established science reference | Science brief: the effect of a pollutant depends on how much there is, how long it lasts, and what it reaches. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u08::waste and pollution, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about waste and pollution, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about waste and pollution, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about waste and pollution; then identify one check that would catch an error or weak claim.**
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E3. Name the decisive evidence ID, explain the error about waste and pollution, and write a corrected claim.

>

**Q2.** Communicate what the supplied record establishes about waste and pollution in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about waste and pollution against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using waste and pollution as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about waste and pollution? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about waste and pollution that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about waste and pollution. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about waste and pollution.
...
- Apply waste and pollution under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect waste and pollution to resource use from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g5-science-u08-l08` · lesson `ma-g5-science-u08-l08` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
