# Unit assessment: matter cycling

**Grade 5 Science** · Unit 5: Plants, Ecosystems, and Matter Cycles · Day 11 of the unit (course day 59) · about 45–65 minutes

**Today's focus:** matter cycling
...
- Demonstrate current mastery of matter cycling through selected-response, constructed-response, and applied evidence.
- Use subject-appropriate evidence or representation to communicate understanding of matter cycling.
- Check, revise, or improve work about matter cycling using stated success criteria.
...
- Science brief: matter cycles among organisms and the environment; energy flows through and does not cycle.
- Science brief: matter cycles repeatedly between organisms and the air, water, and soil around them.
- Science brief: the same atoms are used over and over by different organisms across time.
- Science brief: energy, unlike matter, flows through an ecosystem in one direction and is not recycled.

### Evidence check: matter cycling
...
| --- | --- | --- |
| E1 | established science reference | Science brief: matter cycles among organisms and the environment; energy flows through and does not cycle. |
| E2 | established science reference | Science brief: matter cycles repeatedly between organisms and the air, water, and soil around them. |
| E3 | established science reference | Science brief: the same atoms are used over and over by different organisms across time. |
| E4 | established science reference | Science brief: energy, unlike matter, flows through an ecosystem in one direction and is not recycled. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u05::matter cycling, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about matter cycling, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about matter cycling, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? Rate confidence in matter cycling, cite one piece of evidence from today, and choose: ready to extend, ready to review later, or need a different explanation.**
...
**Q1.** Complete all three parts for matter cycling. (1) Select A: supported, B: partly supported, or C: not supported for the candidate claim. (2) Justify the selection with E1-E4. (3) Rewrite the claim so every word is supported by the supplied record.

>

**Q2.** Communicate what the supplied record establishes about matter cycling in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about matter cycling against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using matter cycling as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about matter cycling? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about matter cycling that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about matter cycling. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about matter cycling.
...
- Apply matter cycling under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect matter cycling to plant growth needs from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g5-science-u05-l11` · lesson `ma-g5-science-u05-l11` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
