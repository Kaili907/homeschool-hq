# Guided practice B: measurement precision

**Grade 5 Science** · Unit 2: Properties of Matter · Day 6 of the unit (course day 18) · about 45–65 minutes
...
- Practice measurement precision with prompts, feedback, and gradually reduced support.
...
**Q1.** First compare E1 with E2 and write a provisional conclusion about measurement precision. Then add the remaining rows through E3, revise the conclusion, and explain the change.
...
_Package `swp-ma-g5-science-u02-l06` · lesson `ma-g5-science-u02-l06` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
