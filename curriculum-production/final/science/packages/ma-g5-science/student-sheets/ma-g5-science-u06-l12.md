# Correction and reflection: regional water patterns

**Grade 5 Science** · Unit 6: Earth Systems and Water · Day 12 of the unit (course day 72) · about 45–65 minutes

**Today's focus:** regional water patterns
...
- Use error evidence to choose a different representation or strategy for regional water patterns, then demonstrate corrected understanding.
- Use subject-appropriate evidence or representation to communicate understanding of regional water patterns.
- Check, revise, or improve work about regional water patterns using stated success criteria.
...
- Science brief: the amount and timing of water available differ from region to region because of climate, landforms, and the geology beneath.
- Science brief: regions with plenty of surface water can still face shortage if the water is polluted, seasonal, or shared between many users.
- Science brief: a region's water pattern is described over years, not from a single measurement.

### Evidence check: regional water patterns

**Candidate claim:** A case report presents this as acceptable science: “a region near a large lake or river cannot have a water problem.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: the amount and timing of water available differ from region to region because of climate, landforms, and the geology beneath. |
| E2 | established science reference | Science brief: regions with plenty of surface water can still face shortage if the water is polluted, seasonal, or shared between many users. |
| E3 | established science reference | Science brief: a region's water pattern is described over years, not from a single measurement. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u06::regional water patterns, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about regional water patterns, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about regional water patterns, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about regional water patterns; then identify one check that would catch an error or weak claim.**
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E3. Name the decisive evidence ID, explain the error about regional water patterns, and write a corrected claim.

>

**Q2.** Communicate what the supplied record establishes about regional water patterns in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about regional water patterns against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using regional water patterns as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about regional water patterns? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about regional water patterns that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about regional water patterns. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about regional water patterns.
...
- Apply regional water patterns under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect regional water patterns to geosphere hydrosphere atmosphere biosphere from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g5-science-u06-l12` · lesson `ma-g5-science-u06-l12` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
