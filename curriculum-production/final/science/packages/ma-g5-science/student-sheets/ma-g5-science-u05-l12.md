# Correction and reflection: ecosystem interdependence

**Grade 5 Science** · Unit 5: Plants, Ecosystems, and Matter Cycles · Day 12 of the unit (course day 60) · about 45–65 minutes

**Today's focus:** ecosystem interdependence
...
- Use error evidence to choose a different representation or strategy for ecosystem interdependence, then demonstrate corrected understanding.
- Use subject-appropriate evidence or representation to communicate understanding of ecosystem interdependence.
- Check, revise, or improve work about ecosystem interdependence using stated success criteria.
...
- Science brief: organisms in an ecosystem depend on one another and on the non-living parts of their environment.
- Science brief: a change to one part of an ecosystem can affect parts that are not directly connected to it.
- Science brief: interdependence means an ecosystem's behaviour cannot be predicted by looking at one organism alone.

### Evidence check: ecosystem interdependence

**Candidate claim:** A case report presents this as acceptable science: “each organism in an ecosystem is independent of the others.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: organisms in an ecosystem depend on one another and on the non-living parts of their environment. |
| E2 | established science reference | Science brief: a change to one part of an ecosystem can affect parts that are not directly connected to it. |
| E3 | established science reference | Science brief: interdependence means an ecosystem's behaviour cannot be predicted by looking at one organism alone. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u05::ecosystem interdependence, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about ecosystem interdependence, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about ecosystem interdependence, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about ecosystem interdependence; then identify one check that would catch an error or weak claim.**
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E3. Name the decisive evidence ID, explain the error about ecosystem interdependence, and write a corrected claim.

>

**Q2.** Communicate what the supplied record establishes about ecosystem interdependence in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about ecosystem interdependence against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using ecosystem interdependence as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about ecosystem interdependence? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about ecosystem interdependence that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about ecosystem interdependence. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about ecosystem interdependence.
...
- Apply ecosystem interdependence under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect ecosystem interdependence to plant growth needs from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g5-science-u05-l12` · lesson `ma-g5-science-u05-l12` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
