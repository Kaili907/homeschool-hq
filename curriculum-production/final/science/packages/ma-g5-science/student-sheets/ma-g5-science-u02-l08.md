# Reteach and varied practice: observable properties

**Grade 5 Science** · Unit 2: Properties of Matter · Day 8 of the unit (course day 20) · about 45–65 minutes
...
- Use error evidence to choose a different representation or strategy for observable properties, then demonstrate corrected understanding.
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E3. Name the decisive evidence ID, explain the error about observable properties, and write a corrected claim.
...
_Package `swp-ma-g5-science-u02-l08` · lesson `ma-g5-science-u02-l08` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
