# Synthesis and review: conservation of mass

**Grade 5 Science** · Unit 3: Changes and Conservation of Matter · Day 10 of the unit (course day 34) · about 45–65 minutes

**Today's focus:** conservation of mass
...
- Connect conservation of mass to the unit’s other ideas and select evidence that shows readiness for assessment.
- Use subject-appropriate evidence or representation to communicate understanding of conservation of mass.
- Check, revise, or improve work about conservation of mass using stated success criteria.
...
- Science brief: in any physical or chemical change, the total mass of the substances is the same before and after.
- Science brief: the total mass of matter is the same before and after a change, whether physical or chemical.
- Science brief: mass that appears to be lost has usually left the container as a gas, and mass that appears to be gained has usually entered it from the air.
- Science brief: testing conservation of mass requires a closed system, or an accounting of everything that entered or left.

### Evidence check: conservation of mass

**Candidate claim:** A case report presents this as acceptable science: “mass is destroyed when a substance burns or dissolves.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: in any physical or chemical change, the total mass of the substances is the same before and after. |
| E2 | established science reference | Science brief: the total mass of matter is the same before and after a change, whether physical or chemical. |
| E3 | established science reference | Science brief: mass that appears to be lost has usually left the container as a gas, and mass that appears to be gained has usually entered it from the air. |
| E4 | established science reference | Science brief: testing conservation of mass requires a closed system, or an accounting of everything that entered or left. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u03::conservation of mass, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about conservation of mass, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about conservation of mass, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about conservation of mass; then identify one check that would catch an error or weak claim.**
...
**Q1.** The supplied unit connections are: physical changes, mixing substances, signs of chemical change, conservation of mass, open and closed systems, evidence from measurements. Choose one idea other than conservation of mass, connect it to one row in E1-E4, and explain one way treating the two ideas as identical would be misleading.

>

**Q2.** Communicate what the supplied record establishes about conservation of mass in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about conservation of mass against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using conservation of mass as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about conservation of mass? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about conservation of mass that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about conservation of mass. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about conservation of mass.
...
- Apply conservation of mass under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect conservation of mass to physical changes from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g5-science-u03-l10` · lesson `ma-g5-science-u03-l10` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
