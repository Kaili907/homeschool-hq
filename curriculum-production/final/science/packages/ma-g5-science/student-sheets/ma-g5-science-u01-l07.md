# Investigation or close reading: observable phenomena

**Grade 5 Science** · Unit 1: Science and Engineering Practices · Day 7 of the unit (course day 7) · about 45–65 minutes

**Today's focus:** observable phenomena
...
- Gather and analyze evidence related to observable phenomena, then record a defensible interpretation.
- Use subject-appropriate evidence or representation to communicate understanding of observable phenomena.
- Check, revise, or improve work about observable phenomena using stated success criteria.
...
- Science brief: a phenomenon is something that happens in the world and can be observed; science starts from phenomena rather than from definitions.
- Science brief: an observation reports what happened; an explanation says why, and the two are recorded separately.
- Science brief: a phenomenon worth investigating usually contains something that does not fit what the observer expected.

### Evidence check: observable phenomena

**Candidate claim:** A case report presents this as acceptable science: “recording an explanation in the observation column.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a phenomenon is something that happens in the world and can be observed; science starts from phenomena rather than from definitions. |
| E2 | established science reference | Science brief: an observation reports what happened; an explanation says why, and the two are recorded separately. |
| E3 | established science reference | Science brief: a phenomenon worth investigating usually contains something that does not fit what the observer expected. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u01::observable phenomena, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.

**Supplied unit connections:** observable phenomena; testable questions; models and diagrams; fair tests; measurement and data tables; criteria and constraints

**Supplied unit performance task:** Design, test, and improve a simple solution to a classroom or home problem using safe materials.

### Bound task

**Question:** What does evidence E1 through E3 justify about observable phenomena, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about observable phenomena?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g5-science-u01::observable phenomena, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u01::observable phenomena, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about observable phenomena?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about observable phenomena; then identify one check that would catch an error or weak claim.**
...
**Q1.** Classify every supplied row E1-E3 as supports, challenges, or does not decide the candidate claim about observable phenomena. Cite the row and explain each classification.

>

**Q2.** Communicate what the supplied record establishes about observable phenomena in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about observable phenomena against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using observable phenomena as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about observable phenomena? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about observable phenomena that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about observable phenomena. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about observable phenomena.
...
- Apply observable phenomena under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect observable phenomena to testable questions from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Design, test, and improve a simple solution to a classroom or home problem using safe materials. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-g5-science-u01-l07` · lesson `ma-g5-science-u01-l07` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
