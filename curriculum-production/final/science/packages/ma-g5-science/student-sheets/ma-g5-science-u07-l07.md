# Investigation or close reading: star brightness and distance

**Grade 5 Science** · Unit 7: Patterns in the Sky · Day 7 of the unit (course day 79) · about 45–65 minutes

**Today's focus:** star brightness and distance
...
- Gather and analyze evidence related to star brightness and distance, then record a defensible interpretation.
- Use subject-appropriate evidence or representation to communicate understanding of star brightness and distance.
- Check, revise, or improve work about star brightness and distance using stated success criteria.
...
- Science brief: stars differ in how bright they actually are and in how far away they are, and both affect how bright they look from Earth.
- Science brief: how bright a star looks from Earth depends on how much light it actually gives out and on how far away it is.
- Science brief: a star that looks dim may be very bright but far away; a star that looks bright may be modest but close.
- Science brief: distance cannot be read off apparent brightness alone.

### Evidence check: star brightness and distance

**Candidate claim:** A case report presents this as acceptable science: “the brightest-looking star must be the closest.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: stars differ in how bright they actually are and in how far away they are, and both affect how bright they look from Earth. |
| E2 | established science reference | Science brief: how bright a star looks from Earth depends on how much light it actually gives out and on how far away it is. |
| E3 | established science reference | Science brief: a star that looks dim may be very bright but far away; a star that looks bright may be modest but close. |
| E4 | established science reference | Science brief: distance cannot be read off apparent brightness alone. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u07::star brightness and distance, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about star brightness and distance, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about star brightness and distance?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g5-science-u07::star brightness and distance, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u07::star brightness and distance, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about star brightness and distance?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about star brightness and distance; then identify one check that would catch an error or weak claim.**
...
**Q1.** Classify every supplied row E1-E4 as supports, challenges, or does not decide the candidate claim about star brightness and distance. Cite the row and explain each classification.

>

**Q2.** Communicate what the supplied record establishes about star brightness and distance in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about star brightness and distance against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using star brightness and distance as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about star brightness and distance? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about star brightness and distance that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about star brightness and distance. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about star brightness and distance.
...
- Apply star brightness and distance under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect star brightness and distance to sun as a star from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g5-science-u07-l07` · lesson `ma-g5-science-u07-l07` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
