# Guided practice A: surface water and groundwater

**Grade 5 Science** · Unit 6: Earth Systems and Water · Day 3 of the unit (course day 63) · about 45–65 minutes
...
- Practice surface water and groundwater with prompts, feedback, and gradually reduced support.
...
**The task.** What does evidence E1 through E3 justify about surface water and groundwater, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**Q1.** First compare E1 with E2 and write a provisional conclusion about surface water and groundwater. Then add the remaining rows through E3, revise the conclusion, and explain the change.
...
_Package `swp-ma-g5-science-u06-l03` · lesson `ma-g5-science-u06-l03` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
