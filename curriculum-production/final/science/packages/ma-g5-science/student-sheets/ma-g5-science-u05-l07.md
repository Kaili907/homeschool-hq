# Investigation or close reading: plant growth needs

**Grade 5 Science** · Unit 5: Plants, Ecosystems, and Matter Cycles · Day 7 of the unit (course day 55) · about 45–65 minutes

**Today's focus:** plant growth needs
...
- Gather and analyze evidence related to plant growth needs, then record a defensible interpretation.
- Use subject-appropriate evidence or representation to communicate understanding of plant growth needs.
- Check, revise, or improve work about plant growth needs using stated success criteria.
...
- Science brief: plants need light, water, air, and a suitable temperature to grow; soil supplies minerals and support, not food.
- Science brief: plants need light, water, air, and suitable temperature in order to grow.
- Science brief: soil provides water, dissolved minerals, and physical support; it does not supply the plant's food.
- Science brief: removing any one of a plant's needs limits its growth, however plentiful the others are.

### Evidence check: plant growth needs

**Candidate claim:** A case report presents this as acceptable science: “plants take in food from the soil.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: plants need light, water, air, and a suitable temperature to grow; soil supplies minerals and support, not food. |
| E2 | established science reference | Science brief: plants need light, water, air, and suitable temperature in order to grow. |
| E3 | established science reference | Science brief: soil provides water, dissolved minerals, and physical support; it does not supply the plant's food. |
| E4 | established science reference | Science brief: removing any one of a plant's needs limits its growth, however plentiful the others are. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u05::plant growth needs, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about plant growth needs, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about plant growth needs?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g5-science-u05::plant growth needs, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u05::plant growth needs, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about plant growth needs?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about plant growth needs; then identify one check that would catch an error or weak claim.**
...
**Q1.** Classify every supplied row E1-E4 as supports, challenges, or does not decide the candidate claim about plant growth needs. Cite the row and explain each classification.

>

**Q2.** Communicate what the supplied record establishes about plant growth needs in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about plant growth needs against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using plant growth needs as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about plant growth needs? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about plant growth needs that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about plant growth needs. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about plant growth needs.
...
- Apply plant growth needs under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect plant growth needs to air and water as matter sources from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g5-science-u05-l07` · lesson `ma-g5-science-u05-l07` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
