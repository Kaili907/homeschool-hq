# Concept model A: water distribution

**Grade 5 Science** · Unit 6: Earth Systems and Water · Day 2 of the unit (course day 62) · about 45–65 minutes
...
- Build a clear mental model of water distribution through an explicit worked example, demonstration, text, or phenomenon.
...
**Q1.** Build a labelled model of water distribution that represents every supplied row in E1-E4. Annotate each model feature with its evidence ID, then show where the candidate claim fails or remains uncertain.
...
_Package `swp-ma-g5-science-u06-l02` · lesson `ma-g5-science-u06-l02` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
