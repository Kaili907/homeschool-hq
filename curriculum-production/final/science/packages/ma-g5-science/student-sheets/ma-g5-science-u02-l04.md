# Independent application A: identifying materials

**Grade 5 Science** · Unit 2: Properties of Matter · Day 4 of the unit (course day 16) · about 45–65 minutes
...
- Apply identifying materials independently in a new representation, text, situation, or design constraint.
...
**Q1.** Independently evaluate this fully supplied case about identifying materials: A case report presents this as acceptable science: “declaring an identification certain on the strength of one property.” Use at least two rows from E1-E3, correct the claim if needed, and state one limit.
...
_Package `swp-ma-g5-science-u02-l04` · lesson `ma-g5-science-u02-l04` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
