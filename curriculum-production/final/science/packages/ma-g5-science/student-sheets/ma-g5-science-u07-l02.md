# Concept model A: sun as a star

**Grade 5 Science** · Unit 7: Patterns in the Sky · Day 2 of the unit (course day 74) · about 45–65 minutes

**Today's focus:** sun as a star
...
- Build a clear mental model of sun as a star through an explicit worked example, demonstration, text, or phenomenon.
- Use subject-appropriate evidence or representation to communicate understanding of sun as a star.
- Check, revise, or improve work about sun as a star using stated success criteria.
...
- Science brief: the Sun is a star, and it appears larger and brighter than other stars because it is far closer to Earth.
- Science brief: the Sun is an ordinary star; it looks different from the others only because it is enormously closer.
- Science brief: other stars are suns too, at distances so great that they appear as points of light.
- Science brief: the Sun's apparent size and brightness are consequences of its distance, not of it being a different kind of object.

### Evidence check: sun as a star

**Candidate claim:** A case report presents this as acceptable science: “the Sun is not a star.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: the Sun is a star, and it appears larger and brighter than other stars because it is far closer to Earth. |
| E2 | established science reference | Science brief: the Sun is an ordinary star; it looks different from the others only because it is enormously closer. |
| E3 | established science reference | Science brief: other stars are suns too, at distances so great that they appear as points of light. |
| E4 | established science reference | Science brief: the Sun's apparent size and brightness are consequences of its distance, not of it being a different kind of object. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u07::sun as a star, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about sun as a star, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about sun as a star, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about sun as a star; then identify one check that would catch an error or weak claim.**
...
**Q1.** Build a labelled model of sun as a star that represents every supplied row in E1-E4. Annotate each model feature with its evidence ID, then show where the candidate claim fails or remains uncertain.

>

**Q2.** Communicate what the supplied record establishes about sun as a star in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about sun as a star against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using sun as a star as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about sun as a star? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about sun as a star that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about sun as a star. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about sun as a star.
...
- Apply sun as a star under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect sun as a star to star brightness and distance from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g5-science-u07-l02` · lesson `ma-g5-science-u07-l02` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
