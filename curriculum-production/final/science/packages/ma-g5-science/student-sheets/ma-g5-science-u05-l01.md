# Launch and diagnostic: plant growth needs

**Grade 5 Science** · Unit 5: Plants, Ecosystems, and Matter Cycles · Day 1 of the unit (course day 49) · about 45–65 minutes
...
- Activate prior knowledge about plant growth needs, surface initial thinking without penalty, and establish the unit question.
...
**The task.** What does evidence E1 through E4 justify about plant growth needs, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**Q1.** Before rereading the brief, classify the supplied candidate claim about plant growth needs as supported, partly supported, or not supported. Then read E1-E4, revise the classification, and name the evidence ID that changed or confirmed your thinking.
...
_Package `swp-ma-g5-science-u05-l01` · lesson `ma-g5-science-u05-l01` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
