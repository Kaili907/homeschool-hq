# Independent application A: seasonal daylight patterns

**Grade 5 Science** · Unit 7: Patterns in the Sky · Day 4 of the unit (course day 76) · about 45–65 minutes
...
- Apply seasonal daylight patterns independently in a new representation, text, situation, or design constraint.
...
**Q1.** Independently evaluate this fully supplied case about seasonal daylight patterns: A case report presents this as acceptable science: “seasons happen because Earth is closer to the Sun in summer.” Use at least two rows from E1-E4, correct the claim if needed, and state one limit.
...
_Package `swp-ma-g5-science-u07-l04` · lesson `ma-g5-science-u07-l04` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
