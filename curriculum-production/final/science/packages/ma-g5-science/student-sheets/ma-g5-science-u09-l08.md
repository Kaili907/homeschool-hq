# Reteach and varied practice: cause and effect

**Grade 5 Science** · Unit 9: Integrated Science and Engineering Capstone · Day 8 of the unit (course day 104) · about 45–65 minutes
...
- Science brief: a causal claim names the change made and the change that followed, and rules out the obvious alternatives.
- Science brief: correlation is not causation; things can vary together because a third factor drives both.
- Science brief: in a system with many interacting parts, one effect can have several contributing causes.

### Evidence check: cause and effect

**Candidate claim:** A case report presents this as acceptable science: “inferring cause from things happening together.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a causal claim names the change made and the change that followed, and rules out the obvious alternatives. |
| E2 | established science reference | Science brief: correlation is not causation; things can vary together because a third factor drives both. |
| E3 | established science reference | Science brief: in a system with many interacting parts, one effect can have several contributing causes. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u09::cause and effect, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.
...
- Connect cause and effect to systems thinking from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g5-science-u09-l08` · lesson `ma-g5-science-u09-l08` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
