# Reteach and varied practice: water distribution

**Grade 5 Science** · Unit 6: Earth Systems and Water · Day 8 of the unit (course day 68) · about 45–65 minutes

**Today's focus:** water distribution
...
- Use error evidence to choose a different representation or strategy for water distribution, then demonstrate corrected understanding.
- Use subject-appropriate evidence or representation to communicate understanding of water distribution.
- Check, revise, or improve work about water distribution using stated success criteria.
...
- Science brief: about 97 per cent of Earth's water is salt water in the ocean.
- Science brief: of the small fresh-water fraction, most is frozen in glaciers and ice caps, and only a small part is liquid fresh water available at the surface or underground.
- Science brief: almost all of Earth's water is salt water in the ocean; fresh water is a small fraction of the total.
- Science brief: most fresh water is frozen in glaciers and ice sheets rather than available as liquid.

### Evidence check: water distribution

**Candidate claim:** A case report presents this as acceptable science: “most of Earth's water is fresh.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: about 97 per cent of Earth's water is salt water in the ocean. |
| E2 | established science reference | Science brief: of the small fresh-water fraction, most is frozen in glaciers and ice caps, and only a small part is liquid fresh water available at the surface or underground. |
| E3 | established science reference | Science brief: almost all of Earth's water is salt water in the ocean; fresh water is a small fraction of the total. |
| E4 | established science reference | Science brief: most fresh water is frozen in glaciers and ice sheets rather than available as liquid. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u06::water distribution, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about water distribution, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about water distribution, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about water distribution; then identify one check that would catch an error or weak claim.**
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E4. Name the decisive evidence ID, explain the error about water distribution, and write a corrected claim.

>

**Q2.** Communicate what the supplied record establishes about water distribution in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about water distribution against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using water distribution as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about water distribution? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about water distribution that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about water distribution. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about water distribution.
...
- Apply water distribution under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect water distribution to geosphere hydrosphere atmosphere biosphere from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g5-science-u06-l08` · lesson `ma-g5-science-u06-l08` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
