# Investigation or close reading: systems thinking

**Grade 5 Science** · Unit 9: Integrated Science and Engineering Capstone · Day 7 of the unit (course day 103) · about 45–65 minutes

**Today's focus:** systems thinking
...
- Gather and analyze evidence related to systems thinking, then record a defensible interpretation.
- Use subject-appropriate evidence or representation to communicate understanding of systems thinking.
- Check, revise, or improve work about systems thinking using stated success criteria.
...
- Science brief: a system is defined by its boundary, its parts, and the flows of matter and energy across that boundary.
- Science brief: a system's behaviour comes from the interactions between its parts, not from any one part alone.
- Science brief: changing where the boundary is drawn changes what counts as inside the system and what counts as an input.

### Evidence check: systems thinking

**Candidate claim:** A case report presents this as acceptable science: “describing a system without stating its boundary.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a system is defined by its boundary, its parts, and the flows of matter and energy across that boundary. |
| E2 | established science reference | Science brief: a system's behaviour comes from the interactions between its parts, not from any one part alone. |
| E3 | established science reference | Science brief: changing where the boundary is drawn changes what counts as inside the system and what counts as an input. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u09::systems thinking, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about systems thinking, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about systems thinking?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g5-science-u09::systems thinking, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u09::systems thinking, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about systems thinking?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about systems thinking; then identify one check that would catch an error or weak claim.**
...
**Q1.** Classify every supplied row E1-E3 as supports, challenges, or does not decide the candidate claim about systems thinking. Cite the row and explain each classification.

>

**Q2.** Communicate what the supplied record establishes about systems thinking in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about systems thinking against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using systems thinking as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about systems thinking? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about systems thinking that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about systems thinking. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about systems thinking.
...
- Apply systems thinking under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect systems thinking to cause and effect from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g5-science-u09-l07` · lesson `ma-g5-science-u09-l07` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
