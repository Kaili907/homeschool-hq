# Performance task build: daily shadow patterns

**Grade 5 Science** · Unit 7: Patterns in the Sky · Day 9 of the unit (course day 81) · about 45–65 minutes

**Today's focus:** daily shadow patterns

**Unit question:** How can understanding patterns in the sky help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Create, test, or revise a meaningful product that applies daily shadow patterns and the unit standards.
- Use subject-appropriate evidence or representation to communicate understanding of daily shadow patterns.
- Check, revise, or improve work about daily shadow patterns using stated success criteria.
...
- Science brief: day and night are caused by Earth rotating on its axis, not by the Sun moving around Earth.
- Science brief: earth's rotation on its axis causes the daily cycle of day and night and the apparent movement of the Sun across the sky.
- Science brief: a shadow is longest when the Sun is lowest in the sky and shortest when it is highest, so shadows change in a repeating daily pattern.
- Science brief: a shadow points away from the light source, so shadow direction changes through the day as the Sun's apparent position changes.

### Evidence check: daily shadow patterns

**Candidate claim:** A case report presents this as acceptable science: “the Sun orbits Earth each day.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: day and night are caused by Earth rotating on its axis, not by the Sun moving around Earth. |
| E2 | established science reference | Science brief: earth's rotation on its axis causes the daily cycle of day and night and the apparent movement of the Sun across the sky. |
| E3 | established science reference | Science brief: a shadow is longest when the Sun is lowest in the sky and shortest when it is highest, so shadows change in a repeating daily pattern. |
| E4 | established science reference | Science brief: a shadow points away from the light source, so shadow direction changes through the day as the Sun's apparent position changes. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u07::daily shadow patterns, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.

**Supplied unit connections:** star brightness and distance; sun as a star; daily shadow patterns; seasonal daylight patterns; data over time; scale models and limitations

**Supplied unit performance task:** Create a sky-pattern observation report using safe indirect observations and provided data.

### Bound task

**Question:** What does evidence E1 through E4 justify about daily shadow patterns, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about daily shadow patterns?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g5-science-u07::daily shadow patterns, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u07::daily shadow patterns, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about daily shadow patterns?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about daily shadow patterns; then identify one check that would catch an error or weak claim.**
...
**Q1.** Create a one-page evidence product for daily shadow patterns using only the supplied case and E1-E4: one claim, at least two cited rows, the reasoning link, one counterpoint, and one revision after checking the success criteria.

>

**Q2.** Communicate what the supplied record establishes about daily shadow patterns in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about daily shadow patterns against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using daily shadow patterns as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about daily shadow patterns? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about daily shadow patterns that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about daily shadow patterns. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about daily shadow patterns.
...
- Apply daily shadow patterns under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect daily shadow patterns to star brightness and distance from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Create a sky-pattern observation report using safe indirect observations and provided data. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-g5-science-u07-l09` · lesson `ma-g5-science-u07-l09` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
