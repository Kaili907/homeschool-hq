# Concept model A: mixing substances

**Grade 5 Science** · Unit 3: Changes and Conservation of Matter · Day 2 of the unit (course day 26) · about 45–65 minutes

**Today's focus:** mixing substances
...
- Build a clear mental model of mixing substances through an explicit worked example, demonstration, text, or phenomenon.
- Use subject-appropriate evidence or representation to communicate understanding of mixing substances.
- Check, revise, or improve work about mixing substances using stated success criteria.
...
- Science brief: mixing two substances sometimes produces a mixture and sometimes produces new substances.
- Science brief: which of the two happened is decided by evidence, not by whether the result looks different.
- Science brief: when only a mixture forms, the original substances are still there and can in principle be separated.

### Evidence check: mixing substances

**Candidate claim:** A case report presents this as acceptable science: “concluding a new substance formed only because the appearance changed.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: mixing two substances sometimes produces a mixture and sometimes produces new substances. |
| E2 | established science reference | Science brief: which of the two happened is decided by evidence, not by whether the result looks different. |
| E3 | established science reference | Science brief: when only a mixture forms, the original substances are still there and can in principle be separated. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u03::mixing substances, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about mixing substances, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about mixing substances, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about mixing substances; then identify one check that would catch an error or weak claim.**
...
**Q1.** Build a labelled model of mixing substances that represents every supplied row in E1-E3. Annotate each model feature with its evidence ID, then show where the candidate claim fails or remains uncertain.

>

**Q2.** Communicate what the supplied record establishes about mixing substances in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about mixing substances against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using mixing substances as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about mixing substances? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about mixing substances that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about mixing substances. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about mixing substances.
...
- Apply mixing substances under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect mixing substances to physical changes from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g5-science-u03-l02` · lesson `ma-g5-science-u03-l02` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
