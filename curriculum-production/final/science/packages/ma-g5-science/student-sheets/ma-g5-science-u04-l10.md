# Synthesis and review: gravity

**Grade 5 Science** · Unit 4: Energy in Food and Motion · Day 10 of the unit (course day 46) · about 45–65 minutes

**Today's focus:** gravity
...
- Connect gravity to the unit’s other ideas and select evidence that shows readiness for assessment.
- Use subject-appropriate evidence or representation to communicate understanding of gravity.
- Check, revise, or improve work about gravity using stated success criteria.
...
- Science brief: the gravitational force Earth exerts on objects is directed toward Earth's centre, which is what 'down' means.
- Science brief: earth pulls objects toward its centre; that pull is what is called gravity, and it is why unsupported objects fall.
- Science brief: the direction called 'down' is toward Earth's centre, and it is different at different places on the globe.
- Science brief: gravity acts on an object whether it is moving or at rest, and whether or not it is touching anything.

### Evidence check: gravity

**Candidate claim:** A case report presents this as acceptable science: “gravity acts only on falling objects and not on ones sitting still.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: the gravitational force Earth exerts on objects is directed toward Earth's centre, which is what 'down' means. |
| E2 | established science reference | Science brief: earth pulls objects toward its centre; that pull is what is called gravity, and it is why unsupported objects fall. |
| E3 | established science reference | Science brief: the direction called 'down' is toward Earth's centre, and it is different at different places on the globe. |
| E4 | established science reference | Science brief: gravity acts on an object whether it is moving or at rest, and whether or not it is touching anything. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u04::gravity, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about gravity, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about gravity, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about gravity; then identify one check that would catch an error or weak claim.**
...
**Q1.** The supplied unit connections are: energy from the sun, energy in food, food webs and energy transfer, gravity, motion observations, cause and effect. Choose one idea other than gravity, connect it to one row in E1-E4, and explain one way treating the two ideas as identical would be misleading.

>

**Q2.** Communicate what the supplied record establishes about gravity in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about gravity against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using gravity as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about gravity? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about gravity that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about gravity. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about gravity.
...
- Apply gravity under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect gravity to energy from the sun from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g5-science-u04-l10` · lesson `ma-g5-science-u04-l10` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
