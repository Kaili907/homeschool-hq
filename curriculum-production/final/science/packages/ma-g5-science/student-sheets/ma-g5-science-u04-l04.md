# Independent application A: gravity

**Grade 5 Science** · Unit 4: Energy in Food and Motion · Day 4 of the unit (course day 40) · about 45–65 minutes
...
- Apply gravity independently in a new representation, text, situation, or design constraint.
...
**Q1.** Independently evaluate this fully supplied case about gravity: A case report presents this as acceptable science: “gravity acts only on falling objects and not on ones sitting still.” Use at least two rows from E1-E4, correct the claim if needed, and state one limit.
...
_Package `swp-ma-g5-science-u04-l04` · lesson `ma-g5-science-u04-l04` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
