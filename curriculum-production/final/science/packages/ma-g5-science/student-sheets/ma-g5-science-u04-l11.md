# Unit assessment: motion observations

**Grade 5 Science** · Unit 4: Energy in Food and Motion · Day 11 of the unit (course day 47) · about 45–65 minutes

**Today's focus:** motion observations
...
- Demonstrate current mastery of motion observations through selected-response, constructed-response, and applied evidence.
- Use subject-appropriate evidence or representation to communicate understanding of motion observations.
- Check, revise, or improve work about motion observations using stated success criteria.
...
- Science brief: motion is described relative to something else, so the reference point is stated.
- Science brief: observing motion means recording position at stated times, not only whether something moved.
- Science brief: patterns in recorded motion support predictions about motion under the same conditions.

### Evidence check: motion observations

**Candidate claim:** A case report presents this as acceptable science: “describing motion with no reference point stated.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: motion is described relative to something else, so the reference point is stated. |
| E2 | established science reference | Science brief: observing motion means recording position at stated times, not only whether something moved. |
| E3 | established science reference | Science brief: patterns in recorded motion support predictions about motion under the same conditions. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u04::motion observations, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about motion observations, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about motion observations, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? Rate confidence in motion observations, cite one piece of evidence from today, and choose: ready to extend, ready to review later, or need a different explanation.**
...
**Q1.** Complete all three parts for motion observations. (1) Select A: supported, B: partly supported, or C: not supported for the candidate claim. (2) Justify the selection with E1-E3. (3) Rewrite the claim so every word is supported by the supplied record.

>

**Q2.** Communicate what the supplied record establishes about motion observations in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about motion observations against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using motion observations as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about motion observations? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about motion observations that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about motion observations. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about motion observations.
...
- Apply motion observations under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect motion observations to energy from the sun from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g5-science-u04-l11` · lesson `ma-g5-science-u04-l11` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
