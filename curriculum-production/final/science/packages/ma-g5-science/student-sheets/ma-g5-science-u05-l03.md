# Guided practice A: producers consumers decomposers

**Grade 5 Science** · Unit 5: Plants, Ecosystems, and Matter Cycles · Day 3 of the unit (course day 51) · about 45–65 minutes
...
- Practice producers consumers decomposers with prompts, feedback, and gradually reduced support.
...
**The task.** What does evidence E1 through E4 justify about producers consumers decomposers, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**Q1.** First compare E1 with E2 and write a provisional conclusion about producers consumers decomposers. Then add the remaining rows through E4, revise the conclusion, and explain the change.
...
_Package `swp-ma-g5-science-u05-l03` · lesson `ma-g5-science-u05-l03` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
