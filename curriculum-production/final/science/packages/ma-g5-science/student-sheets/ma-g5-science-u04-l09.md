# Performance task build: food webs and energy transfer

**Grade 5 Science** · Unit 4: Energy in Food and Motion · Day 9 of the unit (course day 45) · about 45–65 minutes

**Today's focus:** food webs and energy transfer

**Unit question:** How can understanding energy in food and motion help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Create, test, or revise a meaningful product that applies food webs and energy transfer and the unit standards.
- Use subject-appropriate evidence or representation to communicate understanding of food webs and energy transfer.
- Check, revise, or improve work about food webs and energy transfer using stated success criteria.
...
- Science brief: energy moves through a food web in one direction, from producers to consumers to decomposers.
- Science brief: energy enters an ecosystem through producers and passes to consumers when they eat.
- Science brief: at every transfer most of the energy is released to the surroundings, mainly as warmth, so less is available at each successive level.
- Science brief: arrows in a food web point in the direction the energy and matter travel, that is, from the organism eaten to the organism eating it.

### Evidence check: food webs and energy transfer

**Candidate claim:** A case report presents this as acceptable science: “drawing food-web arrows pointing from the eater to the eaten.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: energy moves through a food web in one direction, from producers to consumers to decomposers. |
| E2 | established science reference | Science brief: energy enters an ecosystem through producers and passes to consumers when they eat. |
| E3 | established science reference | Science brief: at every transfer most of the energy is released to the surroundings, mainly as warmth, so less is available at each successive level. |
| E4 | established science reference | Science brief: arrows in a food web point in the direction the energy and matter travel, that is, from the organism eaten to the organism eating it. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u04::food webs and energy transfer, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.

**Supplied unit connections:** energy from the sun; energy in food; food webs and energy transfer; gravity; motion observations; cause and effect

**Supplied unit performance task:** Create a model tracing energy from sunlight through organisms and connect it to observable motion or work.

### Bound task

**Question:** What does evidence E1 through E4 justify about food webs and energy transfer, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about food webs and energy transfer?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g5-science-u04::food webs and energy transfer, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u04::food webs and energy transfer, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about food webs and energy transfer?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about food webs and energy transfer; then identify one check that would catch an error or weak claim.**
...
**Q1.** Create a one-page evidence product for food webs and energy transfer using only the supplied case and E1-E4: one claim, at least two cited rows, the reasoning link, one counterpoint, and one revision after checking the success criteria.

>

**Q2.** Communicate what the supplied record establishes about food webs and energy transfer in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about food webs and energy transfer against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using food webs and energy transfer as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about food webs and energy transfer? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about food webs and energy transfer that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about food webs and energy transfer. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about food webs and energy transfer.
...
- Apply food webs and energy transfer under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect food webs and energy transfer to energy from the sun from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Create a model tracing energy from sunlight through organisms and connect it to observable motion or work. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-g5-science-u04-l09` · lesson `ma-g5-science-u04-l09` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
