# Performance task build: signs of chemical change

**Grade 5 Science** · Unit 3: Changes and Conservation of Matter · Day 9 of the unit (course day 33) · about 45–65 minutes

**Today's focus:** signs of chemical change

**Unit question:** How can understanding changes and conservation of matter help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Create, test, or revise a meaningful product that applies signs of chemical change and the unit standards.
- Use subject-appropriate evidence or representation to communicate understanding of signs of chemical change.
- Check, revise, or improve work about signs of chemical change using stated success criteria.
...
- Science brief: evidence of a chemical change includes gas production, a temperature change not caused by heating or cooling from outside, a colour change, a precipitate forming, light being given off, and an odour appearing.
- Science brief: a chemical change produces one or more new substances with different properties.
- Science brief: signs that suggest a chemical change include gas bubbles, an unexpected temperature change, colour change, a solid forming from clear liquids, light, and a new smell.
- Science brief: any single sign can have another explanation, so several lines of evidence make the conclusion stronger.

### Evidence check: signs of chemical change

**Candidate claim:** A case report presents this as acceptable science: “treating bubbling alone as proof of a chemical change, when boiling and dissolved gas escaping also bubble.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: evidence of a chemical change includes gas production, a temperature change not caused by heating or cooling from outside, a colour change, a precipitate forming, light being given off, and an odour appearing. |
| E2 | established science reference | Science brief: a chemical change produces one or more new substances with different properties. |
| E3 | established science reference | Science brief: signs that suggest a chemical change include gas bubbles, an unexpected temperature change, colour change, a solid forming from clear liquids, light, and a new smell. |
| E4 | established science reference | Science brief: any single sign can have another explanation, so several lines of evidence make the conclusion stronger. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u03::signs of chemical change, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about signs of chemical change, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about signs of chemical change?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g5-science-u03::signs of chemical change, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u03::signs of chemical change, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about signs of chemical change?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about signs of chemical change; then identify one check that would catch an error or weak claim.**
...
**Q1.** Create a one-page evidence product for signs of chemical change using only the supplied case and E1-E4: one claim, at least two cited rows, the reasoning link, one counterpoint, and one revision after checking the success criteria.

>

**Q2.** Communicate what the supplied record establishes about signs of chemical change in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about signs of chemical change against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using signs of chemical change as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about signs of chemical change? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about signs of chemical change that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about signs of chemical change. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about signs of chemical change.
...
- Apply signs of chemical change under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect signs of chemical change to physical changes from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Conduct safe change-of-matter investigations and defend whether matter was conserved. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-g5-science-u03-l09` · lesson `ma-g5-science-u03-l09` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
