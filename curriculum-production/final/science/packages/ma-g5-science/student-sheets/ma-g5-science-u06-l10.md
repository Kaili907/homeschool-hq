# Synthesis and review: system interactions

**Grade 5 Science** · Unit 6: Earth Systems and Water · Day 10 of the unit (course day 70) · about 45–65 minutes
...
- Connect system interactions to the unit’s other ideas and select evidence that shows readiness for assessment.
...
- Science brief: an interaction between Earth's systems is described by naming both systems and what passes between them.
- Science brief: one event usually involves several interactions at once, such as a storm moving water from atmosphere to geosphere and biosphere.
- Science brief: interactions can change a system enough to change how it interacts next, which is why Earth systems do not stay in a fixed state.

### Evidence check: system interactions

**Candidate claim:** A case report presents this as acceptable science: “naming an interaction without saying what moves between the systems.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: an interaction between Earth's systems is described by naming both systems and what passes between them. |
| E2 | established science reference | Science brief: one event usually involves several interactions at once, such as a storm moving water from atmosphere to geosphere and biosphere. |
| E3 | established science reference | Science brief: interactions can change a system enough to change how it interacts next, which is why Earth systems do not stay in a fixed state. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u06::system interactions, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.
...
**The task.** What does evidence E1 through E3 justify about system interactions, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**Q1.** The supplied unit connections are: geosphere hydrosphere atmosphere biosphere, water distribution, surface water and groundwater, system interactions, maps and data, regional water patterns. Choose one idea other than system interactions, connect it to one row in E1-E3, and explain one way treating the two ideas as identical would be misleading.
...
- Connect system interactions to geosphere hydrosphere atmosphere biosphere from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g5-science-u06-l10` · lesson `ma-g5-science-u06-l10` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
