# Correction and reflection: evidence from measurements

**Grade 5 Science** · Unit 3: Changes and Conservation of Matter · Day 12 of the unit (course day 36) · about 45–65 minutes

**Today's focus:** evidence from measurements
...
- Use error evidence to choose a different representation or strategy for evidence from measurements, then demonstrate corrected understanding.
- Use subject-appropriate evidence or representation to communicate understanding of evidence from measurements.
- Check, revise, or improve work about evidence from measurements using stated success criteria.
...
- Science brief: a claim about a change is supported by measurements taken before and after under the same conditions.
- Science brief: a difference smaller than the measuring tool can resolve is not evidence of a change.
- Science brief: every reported value states its unit and how it was obtained.

### Evidence check: evidence from measurements

**Candidate claim:** A case report presents this as acceptable science: “a change from a difference smaller than the tool can resolve.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a claim about a change is supported by measurements taken before and after under the same conditions. |
| E2 | established science reference | Science brief: a difference smaller than the measuring tool can resolve is not evidence of a change. |
| E3 | established science reference | Science brief: every reported value states its unit and how it was obtained. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u03::evidence from measurements, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about evidence from measurements, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about evidence from measurements, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about evidence from measurements; then identify one check that would catch an error or weak claim.**
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E3. Name the decisive evidence ID, explain the error about evidence from measurements, and write a corrected claim.

>

**Q2.** Communicate what the supplied record establishes about evidence from measurements in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about evidence from measurements against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using evidence from measurements as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about evidence from measurements? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about evidence from measurements that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about evidence from measurements. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about evidence from measurements.
...
- Apply evidence from measurements under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect evidence from measurements to physical changes from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g5-science-u03-l12` · lesson `ma-g5-science-u03-l12` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
