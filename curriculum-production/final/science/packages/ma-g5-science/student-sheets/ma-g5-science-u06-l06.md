# Guided practice B: regional water patterns

**Grade 5 Science** · Unit 6: Earth Systems and Water · Day 6 of the unit (course day 66) · about 45–65 minutes
...
- Practice regional water patterns with prompts, feedback, and gradually reduced support.
...
**Q1.** First compare E1 with E2 and write a provisional conclusion about regional water patterns. Then add the remaining rows through E3, revise the conclusion, and explain the change.
...
_Package `swp-ma-g5-science-u06-l06` · lesson `ma-g5-science-u06-l06` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
