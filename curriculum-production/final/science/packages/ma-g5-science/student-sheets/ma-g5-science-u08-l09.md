# Performance task build: conservation strategies

**Grade 5 Science** · Unit 8: Human Impact and Environmental Decisions · Day 9 of the unit (course day 93) · about 45–65 minutes

**Today's focus:** conservation strategies

**Unit question:** How can understanding human impact and environmental decisions help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Create, test, or revise a meaningful product that applies conservation strategies and the unit standards.
- Use subject-appropriate evidence or representation to communicate understanding of conservation strategies.
- Check, revise, or improve work about conservation strategies using stated success criteria.
...
- Science brief: conservation strategies reduce use, reuse materials, recycle them, or protect a resource from damage.
- Science brief: a strategy's effect is judged by evidence of what changed, not by how popular or well-intentioned it is.
- Science brief: reducing use generally has a larger effect than recycling the same material, because recycling itself takes energy and materials.

### Evidence check: conservation strategies

**Candidate claim:** A case report presents this as acceptable science: “recycling makes unlimited use sustainable.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: conservation strategies reduce use, reuse materials, recycle them, or protect a resource from damage. |
| E2 | established science reference | Science brief: a strategy's effect is judged by evidence of what changed, not by how popular or well-intentioned it is. |
| E3 | established science reference | Science brief: reducing use generally has a larger effect than recycling the same material, because recycling itself takes energy and materials. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u08::conservation strategies, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.

**Supplied unit connections:** resource use; waste and pollution; conservation strategies; community tradeoffs; evidence-based decisions; solution criteria

**Supplied unit performance task:** Propose and test a realistic action that protects an Earth resource without shaming individual households.

### Bound task

**Question:** What does evidence E1 through E3 justify about conservation strategies, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about conservation strategies?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g5-science-u08::conservation strategies, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u08::conservation strategies, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about conservation strategies?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about conservation strategies; then identify one check that would catch an error or weak claim.**
...
**Q1.** Create a one-page evidence product for conservation strategies using only the supplied case and E1-E3: one claim, at least two cited rows, the reasoning link, one counterpoint, and one revision after checking the success criteria.

>

**Q2.** Communicate what the supplied record establishes about conservation strategies in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about conservation strategies against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using conservation strategies as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about conservation strategies? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about conservation strategies that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about conservation strategies. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about conservation strategies.
...
- Apply conservation strategies under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect conservation strategies to resource use from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Propose and test a realistic action that protects an Earth resource without shaming individual households. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-g5-science-u08-l09` · lesson `ma-g5-science-u08-l09` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
