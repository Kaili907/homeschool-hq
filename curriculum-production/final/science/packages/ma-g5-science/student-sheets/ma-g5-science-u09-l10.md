# Synthesis and review: data communication

**Grade 5 Science** · Unit 9: Integrated Science and Engineering Capstone · Day 10 of the unit (course day 106) · about 45–65 minutes

**Today's focus:** data communication
...
- Connect data communication to the unit’s other ideas and select evidence that shows readiness for assessment.
- Use subject-appropriate evidence or representation to communicate understanding of data communication.
- Check, revise, or improve work about data communication using stated success criteria.
...
- Science brief: a table, graph, or diagram is chosen because it fits the data and the claim, not because it looks impressive.
- Science brief: axes are labelled with quantities and units, and the source and date of the data are stated.
- Science brief: a representation shows what was measured; anything added beyond the data is labelled as such.

### Evidence check: data communication

**Candidate claim:** A case report presents this as acceptable science: “presenting a graph with unlabelled axes and drawing a conclusion from it.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a table, graph, or diagram is chosen because it fits the data and the claim, not because it looks impressive. |
| E2 | established science reference | Science brief: axes are labelled with quantities and units, and the source and date of the data are stated. |
| E3 | established science reference | Science brief: a representation shows what was measured; anything added beyond the data is labelled as such. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u09::data communication, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about data communication, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about data communication, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about data communication; then identify one check that would catch an error or weak claim.**
...
**Q1.** The supplied unit connections are: systems thinking, cause and effect, energy and matter, data communication, design iteration, scientific argument. Choose one idea other than data communication, connect it to one row in E1-E3, and explain one way treating the two ideas as identical would be misleading.

>

**Q2.** Communicate what the supplied record establishes about data communication in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about data communication against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using data communication as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about data communication? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about data communication that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about data communication. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about data communication.
...
- Apply data communication under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect data communication to systems thinking from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g5-science-u09-l10` · lesson `ma-g5-science-u09-l10` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
