...
**Grade 5 Science** · Unit 1: Science and Engineering Practices · Day 9 of the unit (course day 9) · about 45–65 minutes
...
- Science brief: a model represents a system in order to explain or predict its behaviour.
- Science brief: every model simplifies; the simplification is a stated limitation, not a defect to conceal.
- Science brief: a model is tested by whether its predictions match observation, not by how detailed it looks.

### Evidence check: models and diagrams

**Candidate claim:** A case report presents this as acceptable science: “a model must resemble the real thing to be useful.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a model represents a system in order to explain or predict its behaviour. |
| E2 | established science reference | Science brief: every model simplifies; the simplification is a stated limitation, not a defect to conceal. |
| E3 | established science reference | Science brief: a model is tested by whether its predictions match observation, not by how detailed it looks. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u01::models and diagrams, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g5-science-u01::models and diagrams, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u01::models and diagrams, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.
...
- Connect models and diagrams to observable phenomena from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g5-science-u01-l09` · lesson `ma-g5-science-u01-l09` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
