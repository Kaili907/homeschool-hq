# Independent application A: system interactions

**Grade 5 Science** · Unit 6: Earth Systems and Water · Day 4 of the unit (course day 64) · about 45–65 minutes
...
- Apply system interactions independently in a new representation, text, situation, or design constraint.
...
**Q1.** Independently evaluate this fully supplied case about system interactions: A case report presents this as acceptable science: “naming an interaction without saying what moves between the systems.” Use at least two rows from E1-E3, correct the claim if needed, and state one limit.
...
_Package `swp-ma-g5-science-u06-l04` · lesson `ma-g5-science-u06-l04` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
