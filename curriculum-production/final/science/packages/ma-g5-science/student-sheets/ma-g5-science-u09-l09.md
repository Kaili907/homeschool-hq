# Performance task build: energy and matter

**Grade 5 Science** · Unit 9: Integrated Science and Engineering Capstone · Day 9 of the unit (course day 105) · about 45–65 minutes

**Today's focus:** energy and matter

**Unit question:** How can understanding integrated science and engineering capstone help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Create, test, or revise a meaningful product that applies energy and matter and the unit standards.
- Use subject-appropriate evidence or representation to communicate understanding of energy and matter.
- Check, revise, or improve work about energy and matter using stated success criteria.
...
- Science brief: matter cycles within a system; energy flows through it and is not recycled.
- Science brief: matter cycles within and between systems, while energy flows through them in one direction.
- Science brief: tracking matter and tracking energy are two different accounts of the same process, and both are needed.
- Science brief: neither matter nor energy is created or destroyed within a system; both can only enter, leave, or change form.

### Evidence check: energy and matter

**Candidate claim:** A case report presents this as acceptable science: “energy cycles the way matter does.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: matter cycles within a system; energy flows through it and is not recycled. |
| E2 | established science reference | Science brief: matter cycles within and between systems, while energy flows through them in one direction. |
| E3 | established science reference | Science brief: tracking matter and tracking energy are two different accounts of the same process, and both are needed. |
| E4 | established science reference | Science brief: neither matter nor energy is created or destroyed within a system; both can only enter, leave, or change form. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u09::energy and matter, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.

**Supplied unit connections:** systems thinking; cause and effect; energy and matter; data communication; design iteration; scientific argument

**Supplied unit performance task:** Investigate a local or simulated system, then present a model, evidence-based explanation, and tested improvement.

### Bound task

**Question:** What does evidence E1 through E4 justify about energy and matter, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about energy and matter?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g5-science-u09::energy and matter, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u09::energy and matter, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about energy and matter?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about energy and matter; then identify one check that would catch an error or weak claim.**
...
**Q1.** Create a one-page evidence product for energy and matter using only the supplied case and E1-E4: one claim, at least two cited rows, the reasoning link, one counterpoint, and one revision after checking the success criteria.

>

**Q2.** Communicate what the supplied record establishes about energy and matter in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about energy and matter against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using energy and matter as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about energy and matter? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about energy and matter that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about energy and matter. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about energy and matter.
...
- Apply energy and matter under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect energy and matter to systems thinking from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Investigate a local or simulated system, then present a model, evidence-based explanation, and tested improvement. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-g5-science-u09-l09` · lesson `ma-g5-science-u09-l09` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
