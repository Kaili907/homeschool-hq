# Independent application A: conservation of mass

**Grade 5 Science** · Unit 3: Changes and Conservation of Matter · Day 4 of the unit (course day 28) · about 45–65 minutes
...
- Apply conservation of mass independently in a new representation, text, situation, or design constraint.
...
**Q1.** Independently evaluate this fully supplied case about conservation of mass: A case report presents this as acceptable science: “mass is destroyed when a substance burns or dissolves.” Use at least two rows from E1-E4, correct the claim if needed, and state one limit.
...
_Package `swp-ma-g5-science-u03-l04` · lesson `ma-g5-science-u03-l04` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
