# Performance task build: producers consumers decomposers

**Grade 5 Science** · Unit 5: Plants, Ecosystems, and Matter Cycles · Day 9 of the unit (course day 57) · about 45–65 minutes

**Today's focus:** producers consumers decomposers

**Unit question:** How can understanding plants, ecosystems, and matter cycles help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Create, test, or revise a meaningful product that applies producers consumers decomposers and the unit standards.
- Use subject-appropriate evidence or representation to communicate understanding of producers consumers decomposers.
- Check, revise, or improve work about producers consumers decomposers using stated success criteria.
...
- Science brief: producers make their own food; consumers eat other organisms; decomposers break down dead material and wastes.
- Science brief: producers make their own food, usually using light; consumers get food by eating other organisms; decomposers break down dead organisms and wastes.
- Science brief: decomposers return matter from dead organisms to the soil, water, and air, where producers can use it again.
- Science brief: without decomposers, matter would stay locked in dead material and the cycle would stop.

### Evidence check: producers consumers decomposers

**Candidate claim:** A case report presents this as acceptable science: “classifying a plant as a consumer because it takes in water and minerals.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: producers make their own food; consumers eat other organisms; decomposers break down dead material and wastes. |
| E2 | established science reference | Science brief: producers make their own food, usually using light; consumers get food by eating other organisms; decomposers break down dead organisms and wastes. |
| E3 | established science reference | Science brief: decomposers return matter from dead organisms to the soil, water, and air, where producers can use it again. |
| E4 | established science reference | Science brief: without decomposers, matter would stay locked in dead material and the cycle would stop. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u05::producers consumers decomposers, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.

**Supplied unit connections:** plant growth needs; air and water as matter sources; producers consumers decomposers; food webs; matter cycling; ecosystem interdependence

**Supplied unit performance task:** Build and revise an ecosystem model that tracks matter and energy and explains a change.

### Bound task

**Question:** What does evidence E1 through E4 justify about producers consumers decomposers, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about producers consumers decomposers?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g5-science-u05::producers consumers decomposers, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u05::producers consumers decomposers, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about producers consumers decomposers?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about producers consumers decomposers; then identify one check that would catch an error or weak claim.**
...
**Q1.** Create a one-page evidence product for producers consumers decomposers using only the supplied case and E1-E4: one claim, at least two cited rows, the reasoning link, one counterpoint, and one revision after checking the success criteria.

>

**Q2.** Communicate what the supplied record establishes about producers consumers decomposers in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about producers consumers decomposers against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using producers consumers decomposers as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about producers consumers decomposers? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about producers consumers decomposers that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about producers consumers decomposers. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about producers consumers decomposers.
...
- Apply producers consumers decomposers under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect producers consumers decomposers to plant growth needs from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Build and revise an ecosystem model that tracks matter and energy and explains a change. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-g5-science-u05-l09` · lesson `ma-g5-science-u05-l09` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
