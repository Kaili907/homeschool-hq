# Correction and reflection: scientific argument

**Grade 5 Science** · Unit 9: Integrated Science and Engineering Capstone · Day 12 of the unit (course day 108) · about 45–65 minutes

**Today's focus:** scientific argument
...
- Use error evidence to choose a different representation or strategy for scientific argument, then demonstrate corrected understanding.
- Use subject-appropriate evidence or representation to communicate understanding of scientific argument.
- Check, revise, or improve work about scientific argument using stated success criteria.
...
- Science brief: a scientific argument connects a claim to evidence by explicit reasoning.
- Science brief: the strongest opposing case is stated and addressed, rather than left out.
- Science brief: an argument reaches only as far as its evidence, and it says where that limit falls.

### Evidence check: scientific argument
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a scientific argument connects a claim to evidence by explicit reasoning. |
| E2 | established science reference | Science brief: the strongest opposing case is stated and addressed, rather than left out. |
| E3 | established science reference | Science brief: an argument reaches only as far as its evidence, and it says where that limit falls. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u09::scientific argument, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about scientific argument, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about scientific argument, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about scientific argument; then identify one check that would catch an error or weak claim.**
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E3. Name the decisive evidence ID, explain the error about scientific argument, and write a corrected claim.

>

**Q2.** Communicate what the supplied record establishes about scientific argument in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about scientific argument against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using scientific argument as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about scientific argument? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about scientific argument that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about scientific argument. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about scientific argument.
...
- Apply scientific argument under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect scientific argument to systems thinking from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g5-science-u09-l12` · lesson `ma-g5-science-u09-l12` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
