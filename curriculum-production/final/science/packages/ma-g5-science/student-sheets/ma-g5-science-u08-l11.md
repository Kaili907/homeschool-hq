# Unit assessment: evidence-based decisions

**Grade 5 Science** · Unit 8: Human Impact and Environmental Decisions · Day 11 of the unit (course day 95) · about 45–65 minutes

**Today's focus:** evidence-based decisions
...
- Demonstrate current mastery of evidence-based decisions through selected-response, constructed-response, and applied evidence.
- Use subject-appropriate evidence or representation to communicate understanding of evidence-based decisions.
- Check, revise, or improve work about evidence-based decisions using stated success criteria.
...
- Science brief: a decision is evidence-based when the evidence is named, its source is given, and the reasoning from evidence to decision is shown.
- Science brief: evidence can constrain a decision without settling it, because decisions also involve values.
- Science brief: evidence that argues against the preferred option is reported, not omitted.

### Evidence check: evidence-based decisions

**Candidate claim:** A case report presents this as acceptable science: “presenting a decision as evidence-based with no evidence cited.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a decision is evidence-based when the evidence is named, its source is given, and the reasoning from evidence to decision is shown. |
| E2 | established science reference | Science brief: evidence can constrain a decision without settling it, because decisions also involve values. |
| E3 | established science reference | Science brief: evidence that argues against the preferred option is reported, not omitted. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u08::evidence-based decisions, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about evidence-based decisions, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about evidence-based decisions, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? Rate confidence in evidence-based decisions, cite one piece of evidence from today, and choose: ready to extend, ready to review later, or need a different explanation.**
...
**Q1.** Complete all three parts for evidence-based decisions. (1) Select A: supported, B: partly supported, or C: not supported for the candidate claim. (2) Justify the selection with E1-E3. (3) Rewrite the claim so every word is supported by the supplied record.

>

**Q2.** Communicate what the supplied record establishes about evidence-based decisions in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about evidence-based decisions against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using evidence-based decisions as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about evidence-based decisions? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about evidence-based decisions that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about evidence-based decisions. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about evidence-based decisions.
...
- Apply evidence-based decisions under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect evidence-based decisions to resource use from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g5-science-u08-l11` · lesson `ma-g5-science-u08-l11` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
