# Investigation or close reading: energy from the sun

**Grade 5 Science** · Unit 4: Energy in Food and Motion · Day 7 of the unit (course day 43) · about 45–65 minutes

**Today's focus:** energy from the sun
...
- Gather and analyze evidence related to energy from the sun, then record a defensible interpretation.
- Use subject-appropriate evidence or representation to communicate understanding of energy from the sun.
- Check, revise, or improve work about energy from the sun using stated success criteria.
...
- Science brief: the energy in almost all food can be traced back to energy from the Sun.
- Science brief: plants capture energy from sunlight and use it to make their own food.
- Science brief: the energy in the food animals eat can be traced back to the Sun through the plants at the base of the food chain.
- Science brief: the Sun is the source of the energy that drives most processes at Earth's surface, including weather and the water cycle.

### Evidence check: energy from the sun

**Candidate claim:** A case report presents this as acceptable science: “plants take in food from the soil rather than making it.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: the energy in almost all food can be traced back to energy from the Sun. |
| E2 | established science reference | Science brief: plants capture energy from sunlight and use it to make their own food. |
| E3 | established science reference | Science brief: the energy in the food animals eat can be traced back to the Sun through the plants at the base of the food chain. |
| E4 | established science reference | Science brief: the Sun is the source of the energy that drives most processes at Earth's surface, including weather and the water cycle. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u04::energy from the sun, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about energy from the sun, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about energy from the sun?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g5-science-u04::energy from the sun, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u04::energy from the sun, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about energy from the sun?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about energy from the sun; then identify one check that would catch an error or weak claim.**
...
**Q1.** Classify every supplied row E1-E4 as supports, challenges, or does not decide the candidate claim about energy from the sun. Cite the row and explain each classification.

>

**Q2.** Communicate what the supplied record establishes about energy from the sun in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about energy from the sun against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using energy from the sun as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about energy from the sun? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about energy from the sun that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about energy from the sun. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about energy from the sun.
...
- Apply energy from the sun under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect energy from the sun to energy in food from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g5-science-u04-l07` · lesson `ma-g5-science-u04-l07` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
