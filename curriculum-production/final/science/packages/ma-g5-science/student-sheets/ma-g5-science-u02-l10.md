# Synthesis and review: identifying materials

**Grade 5 Science** · Unit 2: Properties of Matter · Day 10 of the unit (course day 22) · about 45–65 minutes

**Today's focus:** identifying materials
...
- Connect identifying materials to the unit’s other ideas and select evidence that shows readiness for assessment.
- Use subject-appropriate evidence or representation to communicate understanding of identifying materials.
- Check, revise, or improve work about identifying materials using stated success criteria.
...
- Science brief: a material is identified by testing several properties and comparing the results with known materials.
- Science brief: the more properties that match, the stronger the identification.
- Science brief: an identification is a conclusion supported by evidence, and it can be revised if a further test disagrees.

### Evidence check: identifying materials

**Candidate claim:** A case report presents this as acceptable science: “declaring an identification certain on the strength of one property.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a material is identified by testing several properties and comparing the results with known materials. |
| E2 | established science reference | Science brief: the more properties that match, the stronger the identification. |
| E3 | established science reference | Science brief: an identification is a conclusion supported by evidence, and it can be revised if a further test disagrees. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u02::identifying materials, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about identifying materials, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about identifying materials, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about identifying materials; then identify one check that would catch an error or weak claim.**
...
**Q1.** The supplied unit connections are: particles and matter models, observable properties, mass and volume, identifying materials, mixtures, measurement precision. Choose one idea other than identifying materials, connect it to one row in E1-E3, and explain one way treating the two ideas as identical would be misleading.

>

**Q2.** Communicate what the supplied record establishes about identifying materials in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about identifying materials against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using identifying materials as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about identifying materials? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about identifying materials that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about identifying materials. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about identifying materials.
...
- Apply identifying materials under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect identifying materials to particles and matter models from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g5-science-u02-l10` · lesson `ma-g5-science-u02-l10` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
