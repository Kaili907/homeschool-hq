# Guided practice A: daily shadow patterns

**Grade 5 Science** · Unit 7: Patterns in the Sky · Day 3 of the unit (course day 75) · about 45–65 minutes
...
- Practice daily shadow patterns with prompts, feedback, and gradually reduced support.
...
**The task.** What does evidence E1 through E4 justify about daily shadow patterns, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**Q1.** First compare E1 with E2 and write a provisional conclusion about daily shadow patterns. Then add the remaining rows through E4, revise the conclusion, and explain the change.
...
_Package `swp-ma-g5-science-u07-l03` · lesson `ma-g5-science-u07-l03` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
