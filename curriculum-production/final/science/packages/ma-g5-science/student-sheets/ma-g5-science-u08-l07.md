# Investigation or close reading: resource use

**Grade 5 Science** · Unit 8: Human Impact and Environmental Decisions · Day 7 of the unit (course day 91) · about 45–65 minutes

**Today's focus:** resource use
...
- Gather and analyze evidence related to resource use, then record a defensible interpretation.
- Use subject-appropriate evidence or representation to communicate understanding of resource use.
- Check, revise, or improve work about resource use using stated success criteria.
...
- Science brief: renewable resources are replenished on a human timescale; non-renewable resources are not.
- Science brief: people use Earth's resources for energy, food, water, materials, and shelter.
- Science brief: renewable resources are replenished on a human timescale; non-renewable resources are used faster than they form.
- Science brief: a renewable resource can still be exhausted locally if it is used faster than it is replenished.

### Evidence check: resource use

**Candidate claim:** A case report presents this as acceptable science: “renewable resources cannot be depleted.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: renewable resources are replenished on a human timescale; non-renewable resources are not. |
| E2 | established science reference | Science brief: people use Earth's resources for energy, food, water, materials, and shelter. |
| E3 | established science reference | Science brief: renewable resources are replenished on a human timescale; non-renewable resources are used faster than they form. |
| E4 | established science reference | Science brief: a renewable resource can still be exhausted locally if it is used faster than it is replenished. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u08::resource use, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about resource use, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about resource use?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g5-science-u08::resource use, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u08::resource use, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about resource use?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about resource use; then identify one check that would catch an error or weak claim.**
...
**Q1.** Classify every supplied row E1-E4 as supports, challenges, or does not decide the candidate claim about resource use. Cite the row and explain each classification.

>

**Q2.** Communicate what the supplied record establishes about resource use in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about resource use against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using resource use as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about resource use? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about resource use that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about resource use. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about resource use.
...
- Apply resource use under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect resource use to waste and pollution from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g5-science-u08-l07` · lesson `ma-g5-science-u08-l07` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
