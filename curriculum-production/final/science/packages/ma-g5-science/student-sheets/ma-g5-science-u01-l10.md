...
**Grade 5 Science** · Unit 1: Science and Engineering Practices · Day 10 of the unit (course day 10) · about 45–65 minutes
...
- Science brief: a fair test changes one variable and holds the others constant.
- Science brief: a fair test changes one thing on purpose and holds constant everything else that could affect the result.
- Science brief: if two conditions change together, the result cannot be attributed to either.
- Science brief: repeating trials shows whether a result is reproducible; a single trial cannot.

### Evidence check: fair tests

**Candidate claim:** A case report presents this as acceptable science: “calling a test fair when more than one condition changed.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a fair test changes one variable and holds the others constant. |
| E2 | established science reference | Science brief: a fair test changes one thing on purpose and holds constant everything else that could affect the result. |
| E3 | established science reference | Science brief: if two conditions change together, the result cannot be attributed to either. |
| E4 | established science reference | Science brief: repeating trials shows whether a result is reproducible; a single trial cannot. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u01::fair tests, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.
...
**Q1.** The supplied unit connections are: observable phenomena, testable questions, models and diagrams, fair tests, measurement and data tables, criteria and constraints. Choose one idea other than fair tests, connect it to one row in E1-E4, and explain one way treating the two ideas as identical would be misleading.
...
- Connect fair tests to observable phenomena from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g5-science-u01-l10` · lesson `ma-g5-science-u01-l10` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
