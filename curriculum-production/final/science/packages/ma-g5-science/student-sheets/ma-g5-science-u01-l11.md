# Unit assessment: measurement and data tables

**Grade 5 Science** · Unit 1: Science and Engineering Practices · Day 11 of the unit (course day 11) · about 45–65 minutes

**Today's focus:** measurement and data tables
...
- Demonstrate current mastery of measurement and data tables through selected-response, constructed-response, and applied evidence.
- Use subject-appropriate evidence or representation to communicate understanding of measurement and data tables.
- Check, revise, or improve work about measurement and data tables using stated success criteria.
...
- Science brief: a measurement has a number and a unit, and comparisons require the same unit.
- Science brief: a data table with labelled columns, units in the headings, and one row per trial can be read by someone who was not present.
- Science brief: repeated measurements of the same quantity vary a little; that variation is information about the method.

### Evidence check: measurement and data tables

**Candidate claim:** A case report presents this as acceptable science: “recording values with no units.”
...
| E2 | established science reference | Science brief: a measurement has a number and a unit, and comparisons require the same unit. |
| E3 | established science reference | Science brief: a data table with labelled columns, units in the headings, and one row per trial can be read by someone who was not present. |
| E4 | established science reference | Science brief: repeated measurements of the same quantity vary a little; that variation is information about the method. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g5-science-u01::measurement and data tables, derived from the reviewed correctness source policy/correctness/ma-g5-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about measurement and data tables, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about measurement and data tables, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? Rate confidence in measurement and data tables, cite one piece of evidence from today, and choose: ready to extend, ready to review later, or need a different explanation.**
...
**Q1.** Complete all three parts for measurement and data tables. (1) Select A: supported, B: partly supported, or C: not supported for the candidate claim. (2) Justify the selection with E1-E4. (3) Rewrite the claim so every word is supported by the supplied record.

>

**Q2.** Communicate what the supplied record establishes about measurement and data tables in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about measurement and data tables against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using measurement and data tables as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about measurement and data tables? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about measurement and data tables that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about measurement and data tables. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about measurement and data tables.
...
- Apply measurement and data tables under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect measurement and data tables to observable phenomena from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g5-science-u01-l11` · lesson `ma-g5-science-u01-l11` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
