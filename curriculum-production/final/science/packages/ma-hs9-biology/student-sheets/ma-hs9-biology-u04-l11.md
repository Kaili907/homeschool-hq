# Unit assessment: regulation across organ systems

**High School Biology (Grade 9)** · Unit 4: Homeostasis and Feedback Mechanisms · Day 11 of the unit (course day 47) · about 55–75 minutes

**Today's focus:** regulation across organ systems
...
- Demonstrate independent mastery evidence for regulation across organ systems on a fresh task.
- Explain regulation across organ systems using evidence, a model, or a documented process rather than an unsupported answer.
- Apply regulation across organ systems to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on regulation across organ systems against the stated success criteria and name the next step.
...
- Science brief: regulating one variable usually involves several organ systems acting together, coordinated by nervous and endocrine signals.
- Science brief: nervous signalling is fast and short-lived; endocrine signalling is slower and more sustained, and the two are used for different regulatory jobs.
- Science brief: because systems are coupled, correcting one variable can disturb another.

### Evidence check: regulation across organ systems

**Candidate claim:** A case report presents this as acceptable science: “a single organ regulates a variable without involving others.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: regulating one variable usually involves several organ systems acting together, coordinated by nervous and endocrine signals. |
| E2 | established science reference | Science brief: nervous signalling is fast and short-lived; endocrine signalling is slower and more sustained, and the two are used for different regulatory jobs. |
| E3 | established science reference | Science brief: because systems are coupled, correcting one variable can disturb another. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs9-biology-u04::regulation across organ systems, derived from the reviewed correctness source policy/correctness/ma-hs9-biology.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about regulation across organ systems, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about regulation across organ systems, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about regulation across organ systems, then name one check that would catch an error or a weak claim.**
...
**Q1.** Without copying a sentence from the brief, evaluate the printed candidate case about regulation across organ systems. Cite E1-E3, write the reasoning in your own words, and correct the case claim so it fits exactly what the record establishes.

>

**Q2.** Explain regulation across organ systems in your own words using at least two specifically named rows from E1-E3. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for regulation across organ systems. Decide whether E1-E3 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about regulation across organ systems, revise its weakest claim with a named row from E1-E3, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using regulation across organ systems as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E3 is strongest for evaluating the candidate claim about regulation across organ systems? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E3, state one conclusion about regulation across organ systems that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about regulation across organ systems. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about regulation across organ systems.
...
- Apply regulation across organ systems under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect regulation across organ systems to setpoints and tolerance ranges from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs9-biology-u04-l11` · lesson `ma-hs9-biology-u04-l11` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
