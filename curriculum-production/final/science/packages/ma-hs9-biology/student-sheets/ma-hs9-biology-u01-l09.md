# Performance task build: carbon and macromolecule structure

**High School Biology (Grade 9)** · Unit 1: Scientific Practice, Measurement, and the Molecules of Life · Day 9 of the unit (course day 9) · about 61–84 minutes

**Today's focus:** carbon and macromolecule structure
...
- Produce performance-task evidence for carbon and macromolecule structure that a reader could check independently.
...
- Apply carbon and macromolecule structure to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on carbon and macromolecule structure against the stated success criteria and name the next step.

**Materials:**

- apple or potato slices
- lemon juice
...
- **Chemical hazard.** 3% hydrogen peroxide irritates eyes and can bleach fabric and skin on contact.
  - What stops it: Use the household 3% strength only, keep it in its original bottle, wear eye protection, work over a washable surface, and rinse any splash with water for 15 minutes.
- **Chemical hazard.** Hydrogen peroxide and lemon juice must never be combined; together they make peracetic acid, which is corrosive and irritating to the airway.
  - What stops it: The lemon-juice route and the peroxide route run in separate labelled cups. They are never poured together, never poured into a shared waste cup, and never combined to see what happens.
- **Chemical hazard.** Catalase and peroxide foam vigorously and release oxygen.
  - What stops it: No lid, cap, film, or cover ever goes on a peroxide container. Use a wide open cup on a tray with plenty of headroom.
- **Physical hazard.** Slicing produce with a kitchen knife risks cuts.
  - What stops it: An adult does all cutting, or the learner uses pre-cut produce; no knife work is required by the lesson.
...
**Clearing up.** Pour the peroxide and the lemon-juice cups down the drain SEPARATELY, each with the cold tap running, and never into a shared waste cup. Wash the cups, compost or bin the produce, and wash hands. Nothing is ever capped or sealed, and nothing is kept or reused.
...
- Science brief: carbon forms four covalent bonds, which is why it builds the large, varied molecules life depends on.
- Science brief: the four major classes of biological macromolecule are carbohydrates, lipids, proteins, and nucleic acids.
- Science brief: carbon's capacity to form four stable covalent bonds, including with other carbon atoms, allows chains, branches, and rings, and therefore enormous molecular variety.
- Science brief: carbohydrates, proteins, and nucleic acids are polymers built from repeating monomers; lipids are not polymers in the same sense.

### Evidence check: carbon and macromolecule structure

**Candidate claim:** A case report presents this as acceptable science: “carbon forms a number of covalent bonds other than four in these molecules.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: carbon forms four covalent bonds, which is why it builds the large, varied molecules life depends on. |
| E2 | established science reference | Science brief: the four major classes of biological macromolecule are carbohydrates, lipids, proteins, and nucleic acids. |
| E3 | established science reference | Science brief: carbon's capacity to form four stable covalent bonds, including with other carbon atoms, allows chains, branches, and rings, and therefore enormous molecular variety. |
| E4 | established science reference | Science brief: carbohydrates, proteins, and nucleic acids are polymers built from repeating monomers; lipids are not polymers in the same sense. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs9-biology-u01::carbon and macromolecule structure, derived from the reviewed correctness source policy/correctness/ma-hs9-biology.correctness.json.

**Supplied unit connections:** biological scale and measurement; uncertainty and repeated trials; carbon and macromolecule structure; structure-function relationships; enzymes and reaction conditions; argument from evidence in biology

**Supplied unit performance task:** Plan and run a controlled investigation of one factor affecting an enzyme or browning reaction, then defend the conclusion with your own data, stated uncertainty, and named limitations.

### Bound task

**Question:** What does evidence E1 through E4 justify about carbon and macromolecule structure, and does it support the candidate claim?
...
**Model/source rule:** For pH 7, product units are a piecewise classroom model that rise from 12 at 10 °C to 38 at 35 °C; changing pH from 7 to 4 multiplies the 35 °C output by 9/38.
...
3. Graph modelled product against temperature for A-C, compare C with D, and separate what this model shows from what an experiment would still have to test.
...
**Pinned H4 alternative statement (lineage evidence):** Run the browning comparison with no chemicals at all: compare apple slices in air, under water, and wrapped, timing colour change against a printed colour scale. This needs only produce, water, and a timer and meets the same target.
...
**My question.** Write the question you are testing about carbon and macromolecule structure. It has to be a question your evidence could actually answer.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about carbon and macromolecule structure, then name one check that would catch an error or a weak claim.**
...
**Q1.** Build a checkable contribution to the supplied unit performance task — Plan and run a controlled investigation of one factor affecting an enzyme or browning reaction, then defend the conclusion with your own data, stated uncertainty, and named limitations. — using the case and E1-E4. Include claim, evidence, reasoning, limitation, and a recorded revision.

>

**Q2.** Explain carbon and macromolecule structure in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for carbon and macromolecule structure. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about carbon and macromolecule structure, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using carbon and macromolecule structure as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E4 is strongest for evaluating the candidate claim about carbon and macromolecule structure? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E4, state one conclusion about carbon and macromolecule structure that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about carbon and macromolecule structure. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about carbon and macromolecule structure.
...
- Apply carbon and macromolecule structure under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect carbon and macromolecule structure to biological scale and measurement from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Plan and run a controlled investigation of one factor affecting an enzyme or browning reaction, then defend the conclusion with your own data, stated uncertainty, and named limitations. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-hs9-biology-u01-l09` · lesson `ma-hs9-biology-u01-l09` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
