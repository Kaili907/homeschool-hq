# Reteach and varied practice: negative feedback loops

**High School Biology (Grade 9)** · Unit 4: Homeostasis and Feedback Mechanisms · Day 8 of the unit (course day 44) · about 55–75 minutes

**Today's focus:** negative feedback loops
...
- Explain negative feedback loops using evidence, a model, or a documented process rather than an unsupported answer.
- Apply negative feedback loops to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on negative feedback loops against the stated success criteria and name the next step.
...
- Science brief: negative feedback opposes the change that triggered it and returns the variable toward its setpoint.
- Science brief: a negative feedback loop requires a sensor that detects the change, a control centre that compares it with the setpoint, and an effector that acts to reverse it.
- Science brief: because the response opposes the deviation, the system is stabilised around the setpoint.
- Science brief: most physiological regulation, including of body temperature, blood glucose, and water balance, is negative feedback.

### Evidence check: negative feedback loops

**Candidate claim:** A case report presents this as acceptable science: “describing a loop as negative feedback when the response amplifies the original change.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: negative feedback opposes the change that triggered it and returns the variable toward its setpoint. |
| E2 | established science reference | Science brief: a negative feedback loop requires a sensor that detects the change, a control centre that compares it with the setpoint, and an effector that acts to reverse it. |
| E3 | established science reference | Science brief: because the response opposes the deviation, the system is stabilised around the setpoint. |
| E4 | established science reference | Science brief: most physiological regulation, including of body temperature, blood glucose, and water balance, is negative feedback. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs9-biology-u04::negative feedback loops, derived from the reviewed correctness source policy/correctness/ma-hs9-biology.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about negative feedback loops, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about negative feedback loops, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about negative feedback loops, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain negative feedback loops in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for negative feedback loops. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about negative feedback loops, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using negative feedback loops as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about negative feedback loops? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about negative feedback loops that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about negative feedback loops. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about negative feedback loops.
...
- Apply negative feedback loops under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect negative feedback loops to setpoints and tolerance ranges from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs9-biology-u04-l08` · lesson `ma-hs9-biology-u04-l08` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
