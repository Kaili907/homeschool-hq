# Unit assessment: ecosystem resilience and disturbance

**High School Biology (Grade 9)** · Unit 7: Population Dynamics, Carrying Capacity, and Biodiversity · Day 11 of the unit (course day 83) · about 55–75 minutes

**Today's focus:** ecosystem resilience and disturbance
...
- Demonstrate independent mastery evidence for ecosystem resilience and disturbance on a fresh task.
...
- Apply ecosystem resilience and disturbance to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on ecosystem resilience and disturbance against the stated success criteria and name the next step.
...
- Science brief: disturbance is a normal component of ecosystem dynamics, and many communities depend on it.
- Science brief: resilience is the capacity to recover ecosystem function after disturbance, and it generally rises with biodiversity.
- Science brief: severe or repeated disturbance can shift an ecosystem into a different state that does not return on its own.

### Evidence check: ecosystem resilience and disturbance

**Candidate claim:** A case report presents this as acceptable science: “all disturbance damages ecosystems.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: disturbance is a normal component of ecosystem dynamics, and many communities depend on it. |
| E2 | established science reference | Science brief: resilience is the capacity to recover ecosystem function after disturbance, and it generally rises with biodiversity. |
| E3 | established science reference | Science brief: severe or repeated disturbance can shift an ecosystem into a different state that does not return on its own. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs9-biology-u07::ecosystem resilience and disturbance, derived from the reviewed correctness source policy/correctness/ma-hs9-biology.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about ecosystem resilience and disturbance, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about ecosystem resilience and disturbance, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about ecosystem resilience and disturbance, then name one check that would catch an error or a weak claim.**
...
**Q1.** Without copying a sentence from the brief, evaluate the printed candidate case about ecosystem resilience and disturbance. Cite E1-E3, write the reasoning in your own words, and correct the case claim so it fits exactly what the record establishes.

>

**Q2.** Explain ecosystem resilience and disturbance in your own words using at least two specifically named rows from E1-E3. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for ecosystem resilience and disturbance. Decide whether E1-E3 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about ecosystem resilience and disturbance, revise its weakest claim with a named row from E1-E3, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using ecosystem resilience and disturbance as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E3 is strongest for evaluating the candidate claim about ecosystem resilience and disturbance? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E3, state one conclusion about ecosystem resilience and disturbance that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about ecosystem resilience and disturbance. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about ecosystem resilience and disturbance.
...
- Apply ecosystem resilience and disturbance under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect ecosystem resilience and disturbance to exponential and logistic growth from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs9-biology-u07-l11` · lesson `ma-hs9-biology-u07-l11` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
