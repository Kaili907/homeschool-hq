# Unit assessment: polygenic and environmental effects

**High School Biology (Grade 9)** · Unit 8: Inheritance and Variation of Traits · Day 11 of the unit (course day 95) · about 55–75 minutes

**Today's focus:** polygenic and environmental effects
...
- Demonstrate independent mastery evidence for polygenic and environmental effects on a fresh task.
- Explain polygenic and environmental effects using evidence, a model, or a documented process rather than an unsupported answer.
- Apply polygenic and environmental effects to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on polygenic and environmental effects against the stated success criteria and name the next step.
...
- Science brief: many traits are influenced by multiple genes and by the environment, and these show continuous rather than discrete variation.
- Science brief: a polygenic trait is influenced by several genes, each contributing part of the effect, which produces a continuous range of phenotypes.
- Science brief: the environment modifies the expression of many traits, so genotype does not determine phenotype on its own.
- Science brief: simple dominant-recessive models apply to a minority of traits and mislead when applied to polygenic ones.

### Evidence check: polygenic and environmental effects

**Candidate claim:** A case report presents this as acceptable science: “modelling a continuously varying trait such as height as a single gene with two alleles and presenting the result as established.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: many traits are influenced by multiple genes and by the environment, and these show continuous rather than discrete variation. |
| E2 | established science reference | Science brief: a polygenic trait is influenced by several genes, each contributing part of the effect, which produces a continuous range of phenotypes. |
| E3 | established science reference | Science brief: the environment modifies the expression of many traits, so genotype does not determine phenotype on its own. |
| E4 | established science reference | Science brief: simple dominant-recessive models apply to a minority of traits and mislead when applied to polygenic ones. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs9-biology-u08::polygenic and environmental effects, derived from the reviewed correctness source policy/correctness/ma-hs9-biology.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about polygenic and environmental effects, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about polygenic and environmental effects, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about polygenic and environmental effects, then name one check that would catch an error or a weak claim.**
...
**Q1.** Without copying a sentence from the brief, evaluate the printed candidate case about polygenic and environmental effects. Cite E1-E4, write the reasoning in your own words, and correct the case claim so it fits exactly what the record establishes.

>

**Q2.** Explain polygenic and environmental effects in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for polygenic and environmental effects. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about polygenic and environmental effects, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using polygenic and environmental effects as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E4 is strongest for evaluating the candidate claim about polygenic and environmental effects? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E4, state one conclusion about polygenic and environmental effects that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about polygenic and environmental effects. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about polygenic and environmental effects.
...
- Apply polygenic and environmental effects under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect polygenic and environmental effects to chromosomes and gene loci from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs9-biology-u08-l11` · lesson `ma-hs9-biology-u08-l11` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
