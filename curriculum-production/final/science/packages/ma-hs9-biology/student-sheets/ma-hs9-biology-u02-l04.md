# Independent application A: translation and the genetic code

**High School Biology (Grade 9)** · Unit 2: DNA, Proteins, and the Information Flow of the Cell · Day 4 of the unit (course day 16) · about 55–75 minutes

**Today's focus:** translation and the genetic code
...
- Explain translation and the genetic code using evidence, a model, or a documented process rather than an unsupported answer.
- Apply translation and the genetic code to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on translation and the genetic code against the stated success criteria and name the next step.
...
- Science brief: the genetic code is read in three-nucleotide codons, and it is redundant: most amino acids are specified by more than one codon.
- Science brief: proteins are built from twenty standard amino acids.
- Science brief: ribosomes read messenger RNA in codons of three nucleotides and assemble the corresponding amino acids into a chain.
- Science brief: transfer RNA molecules match codons to amino acids, which is how the nucleotide sequence is converted into an amino acid sequence.

### Evidence check: translation and the genetic code

**Candidate claim:** A case report presents this as acceptable science: “one nucleotide, or two, specifies one amino acid.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: the genetic code is read in three-nucleotide codons, and it is redundant: most amino acids are specified by more than one codon. |
| E2 | established science reference | Science brief: proteins are built from twenty standard amino acids. |
| E3 | established science reference | Science brief: ribosomes read messenger RNA in codons of three nucleotides and assemble the corresponding amino acids into a chain. |
| E4 | established science reference | Science brief: transfer RNA molecules match codons to amino acids, which is how the nucleotide sequence is converted into an amino acid sequence. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs9-biology-u02::translation and the genetic code, derived from the reviewed correctness source policy/correctness/ma-hs9-biology.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about translation and the genetic code, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about translation and the genetic code, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about translation and the genetic code, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain translation and the genetic code in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for translation and the genetic code. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about translation and the genetic code, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using translation and the genetic code as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about translation and the genetic code? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about translation and the genetic code that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about translation and the genetic code. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about translation and the genetic code.
...
- Apply translation and the genetic code under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect translation and the genetic code to DNA structure and base pairing from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs9-biology-u02-l04` · lesson `ma-hs9-biology-u02-l04` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
