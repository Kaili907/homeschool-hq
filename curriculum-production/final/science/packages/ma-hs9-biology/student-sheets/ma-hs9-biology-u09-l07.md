# Investigation: multiple lines of evidence for common ancestry

**High School Biology (Grade 9)** · Unit 9: Natural Selection, Evolution, and Biodiversity Engineering · Day 7 of the unit (course day 103) · about 61–84 minutes

**Today's focus:** multiple lines of evidence for common ancestry
...
- Explain multiple lines of evidence for common ancestry using evidence, a model, or a documented process rather than an unsupported answer.
- Apply multiple lines of evidence for common ancestry to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on multiple lines of evidence for common ancestry against the stated success criteria and name the next step.

**Materials:**

- two or three colours of dried beans or paper dots
- patterned cloth or paper background
- timer
- graph paper
- published conservation case study
...
- **Physical hazard.** Timed grabbing games can knock over nearby objects.
  - What stops it: Clear the work surface first and keep the play area away from edges and breakables.
- **Emotional hazard.** Extinction and habitat loss can be genuinely upsetting.
  - What stops it: Frame the unit around designed responses and documented recoveries; the learner may pause or choose a different case at any point.
...
**Clearing up.** Beans, paper dots, and cloth go back into a labelled container out of reach of young children; beans used as counters are never eaten. Case-study printouts are filed or recycled. No location is recorded and nothing is uploaded.
...
- Science brief: evidence for common ancestry comes from the fossil record, comparative anatomy, embryology, biogeography, and molecular sequence comparison.
- Science brief: independent lines of evidence converging on the same pattern of relationship is what makes common ancestry a robust conclusion.
- Science brief: shared DNA and protein sequences among species match the pattern inferred from anatomy and fossils.
- Science brief: shared underlying structure used for different functions indicates common ancestry; similar function achieved by different structures does not.

### Evidence check: multiple lines of evidence for common ancestry

**Candidate claim:** A case report presents this as acceptable science: “treating similarity of function as evidence of close relationship.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: evidence for common ancestry comes from the fossil record, comparative anatomy, embryology, biogeography, and molecular sequence comparison. |
| E2 | established science reference | Science brief: independent lines of evidence converging on the same pattern of relationship is what makes common ancestry a robust conclusion. |
| E3 | established science reference | Science brief: shared DNA and protein sequences among species match the pattern inferred from anatomy and fossils. |
| E4 | established science reference | Science brief: shared underlying structure used for different functions indicates common ancestry; similar function achieved by different structures does not. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs9-biology-u09::multiple lines of evidence for common ancestry, derived from the reviewed correctness source policy/correctness/ma-hs9-biology.correctness.json.

**Supplied unit connections:** multiple lines of evidence for common ancestry; the four factors driving natural selection; statistics of advantageous traits; adaptation of populations; environmental change and extinction; engineering solutions for biodiversity

**Supplied unit performance task:** Complete a biodiversity engineering capstone: define criteria and constraints for a real conservation problem, model a solution, test it by simulation, evaluate trade-offs, and defend the revision history.

### Bound task

**Question:** What does evidence E1 through E4 justify about multiple lines of evidence for common ancestry, and does it support the candidate claim?
...
**Model/source rule:** Counts come from a deterministic survival-reproduction simulation in which the matching trait has survival weight 1.2 and the other 0.8; each generation is rescaled to 100.
...
3. Graph trait frequency, connect changes to the environment state, and explain why the model supports selection on populations rather than individuals changing because they need to.
...
**Pinned H4 alternative statement (lineage evidence):** Run the selection simulation entirely on paper with dice determining survival probability by trait, then analyse a published conservation case study. No materials beyond paper and one die.
...
**My question.** Write the question you are testing about multiple lines of evidence for common ancestry. It has to be a question your evidence could actually answer.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about multiple lines of evidence for common ancestry, then name one check that would catch an error or a weak claim.**
...
**Q1.** Complete the route you chose. For the document/model route, use its printed procedure and input table; for the H4 physical route, use the printed safe order and your own blank record. Report the route, evidence IDs or model rows, conclusion about multiple lines of evidence for common ancestry, uncertainty, and limitation.

>

**Q2.** Explain multiple lines of evidence for common ancestry in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for multiple lines of evidence for common ancestry. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about multiple lines of evidence for common ancestry, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using multiple lines of evidence for common ancestry as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E4 is strongest for evaluating the candidate claim about multiple lines of evidence for common ancestry? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E4, state one conclusion about multiple lines of evidence for common ancestry that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about multiple lines of evidence for common ancestry. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about multiple lines of evidence for common ancestry.
...
- Apply multiple lines of evidence for common ancestry under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect multiple lines of evidence for common ancestry to the four factors driving natural selection from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Complete a biodiversity engineering capstone: define criteria and constraints for a real conservation problem, model a solution, test it by simulation, evaluate trade-offs, and defend the revision history. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-hs9-biology-u09-l07` · lesson `ma-hs9-biology-u09-l07` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
