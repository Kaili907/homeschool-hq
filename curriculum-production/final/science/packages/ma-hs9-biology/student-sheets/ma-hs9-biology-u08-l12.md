# Correction and reflection: distribution of expressed traits

**High School Biology (Grade 9)** · Unit 8: Inheritance and Variation of Traits · Day 12 of the unit (course day 96) · about 55–75 minutes

**Today's focus:** distribution of expressed traits
...
- Explain distribution of expressed traits using evidence, a model, or a documented process rather than an unsupported answer.
- Apply distribution of expressed traits to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on distribution of expressed traits against the stated success criteria and name the next step.
...
- Science brief: traits influenced by many genes and by the environment are distributed continuously in a population, often clustering around a central value.
- Science brief: the distribution is a property of the population, and no individual measurement characterises it.
- Science brief: comparing distributions requires comparable measurement methods and sample sizes.

### Evidence check: distribution of expressed traits

**Candidate claim:** A case report presents this as acceptable science: “drawing a conclusion about a population's trait distribution from one individual.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: traits influenced by many genes and by the environment are distributed continuously in a population, often clustering around a central value. |
| E2 | established science reference | Science brief: the distribution is a property of the population, and no individual measurement characterises it. |
| E3 | established science reference | Science brief: comparing distributions requires comparable measurement methods and sample sizes. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs9-biology-u08::distribution of expressed traits, derived from the reviewed correctness source policy/correctness/ma-hs9-biology.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about distribution of expressed traits, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about distribution of expressed traits, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about distribution of expressed traits, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain distribution of expressed traits in your own words using at least two specifically named rows from E1-E3. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for distribution of expressed traits. Decide whether E1-E3 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about distribution of expressed traits, revise its weakest claim with a named row from E1-E3, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using distribution of expressed traits as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about distribution of expressed traits? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about distribution of expressed traits that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about distribution of expressed traits. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about distribution of expressed traits.
...
- Apply distribution of expressed traits under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect distribution of expressed traits to chromosomes and gene loci from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs9-biology-u08-l12` · lesson `ma-hs9-biology-u08-l12` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
