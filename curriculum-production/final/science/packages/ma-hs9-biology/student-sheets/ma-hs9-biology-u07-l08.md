# Reteach and varied practice: carrying capacity and limiting factors

**High School Biology (Grade 9)** · Unit 7: Population Dynamics, Carrying Capacity, and Biodiversity · Day 8 of the unit (course day 80) · about 55–75 minutes

**Today's focus:** carrying capacity and limiting factors
...
- Explain carrying capacity and limiting factors using evidence, a model, or a documented process rather than an unsupported answer.
- Apply carrying capacity and limiting factors to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on carrying capacity and limiting factors against the stated success criteria and name the next step.
...
- Science brief: carrying capacity is the population size an environment can sustain given its limiting resources, and it changes when those resources change.
- Science brief: the limiting factor is the resource in shortest supply relative to demand; increasing any other resource does not raise the population.
- Science brief: density-dependent factors such as competition, disease, and predation intensify as population rises; density-independent factors such as weather do not.
- Science brief: carrying capacity is a property of the environment and the population together, and it is not fixed.

### Evidence check: carrying capacity and limiting factors

**Candidate claim:** A case report presents this as acceptable science: “treating carrying capacity as a permanent fixed number for a place.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: carrying capacity is the population size an environment can sustain given its limiting resources, and it changes when those resources change. |
| E2 | established science reference | Science brief: the limiting factor is the resource in shortest supply relative to demand; increasing any other resource does not raise the population. |
| E3 | established science reference | Science brief: density-dependent factors such as competition, disease, and predation intensify as population rises; density-independent factors such as weather do not. |
| E4 | established science reference | Science brief: carrying capacity is a property of the environment and the population together, and it is not fixed. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs9-biology-u07::carrying capacity and limiting factors, derived from the reviewed correctness source policy/correctness/ma-hs9-biology.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about carrying capacity and limiting factors, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about carrying capacity and limiting factors, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about carrying capacity and limiting factors, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain carrying capacity and limiting factors in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for carrying capacity and limiting factors. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about carrying capacity and limiting factors, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using carrying capacity and limiting factors as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about carrying capacity and limiting factors? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about carrying capacity and limiting factors that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about carrying capacity and limiting factors. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about carrying capacity and limiting factors.
...
- Apply carrying capacity and limiting factors under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect carrying capacity and limiting factors to exponential and logistic growth from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs9-biology-u07-l08` · lesson `ma-hs9-biology-u07-l08` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
