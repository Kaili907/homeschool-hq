# Investigation: exponential and logistic growth

**High School Biology (Grade 9)** · Unit 7: Population Dynamics, Carrying Capacity, and Biodiversity · Day 7 of the unit (course day 79) · about 61–84 minutes

**Today's focus:** exponential and logistic growth
...
- Explain exponential and logistic growth using evidence, a model, or a documented process rather than an unsupported answer.
- Apply exponential and logistic growth to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on exponential and logistic growth against the stated success criteria and name the next step.

**Materials:**

- published population dataset
- spreadsheet or graph paper
- calculator
- notebook
- dried beans or counters (physical sampling model)
- a shallow tray to count the beans in
...
- **Privacy hazard.** Online dataset searching can expose the learner to tracking or to accounts.
  - What stops it: An adult supplies the dataset file or the exact source; no account creation, sign-in, or purchase is required.
- **Physical hazard.** Small counters are a choking hazard around young children, and dried beans used as counters are no longer food - raw kidney beans in particular are toxic if eaten.
  - What stops it: Keep counters away from younger siblings, count them back into a labelled container at the end, and never return beans used as counters to food storage or eat them.
...
**Clearing up.** Beans and counters go back into a labelled container stored out of reach of young children. Beans used as counters are never eaten and never returned to food storage. Dataset files stay on the adult's device; nothing is uploaded.
...
- Science brief: exponential growth has no limiting factor and cannot be sustained; logistic growth slows as the population approaches carrying capacity.
- Science brief: a population grows exponentially when resources are effectively unlimited, with growth rate proportional to population size.
- Science brief: as resources become limiting, per-individual growth rate declines and the curve levels off near the carrying capacity.
- Science brief: no real population grows exponentially indefinitely, because no environment supplies unlimited resources.

### Evidence check: exponential and logistic growth

**Candidate claim:** A case report presents this as acceptable science: “a population can sustain exponential growth indefinitely.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: exponential growth has no limiting factor and cannot be sustained; logistic growth slows as the population approaches carrying capacity. |
| E2 | established science reference | Science brief: a population grows exponentially when resources are effectively unlimited, with growth rate proportional to population size. |
| E3 | established science reference | Science brief: as resources become limiting, per-individual growth rate declines and the curve levels off near the carrying capacity. |
| E4 | established science reference | Science brief: no real population grows exponentially indefinitely, because no environment supplies unlimited resources. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs9-biology-u07::exponential and logistic growth, derived from the reviewed correctness source policy/correctness/ma-hs9-biology.correctness.json.

**Supplied unit connections:** exponential and logistic growth; carrying capacity and limiting factors; interspecific interactions; biodiversity measurement; ecosystem resilience and disturbance; group behaviour and survival

**Supplied unit performance task:** Use mathematical and computational representations of real population data to explain and revise a claim about carrying capacity, biodiversity, or the survival value of group behaviour.

### Bound task

**Question:** What does evidence E1 through E4 justify about exponential and logistic growth, and does it support the candidate claim?
...
**Model/source rule:** X is rounded 1.5-fold growth. Y follows rounded logistic growth N(next)=N+0.5N(1-N/75).
...
3. Graph both populations, identify which rule is exponential and which is density-limited, and use differences between successive values as evidence.
...
**Pinned H4 alternative statement (lineage evidence):** Run a mark-and-recapture sampling model with two colours of dried beans in a bag to estimate an unknown population, then compare the estimate to the true count. Kitchen materials and arithmetic only.
...
**My question.** Write the question you are testing about exponential and logistic growth. It has to be a question your evidence could actually answer.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about exponential and logistic growth, then name one check that would catch an error or a weak claim.**
...
**Q1.** Complete the route you chose. For the document/model route, use its printed procedure and input table; for the H4 physical route, use the printed safe order and your own blank record. Report the route, evidence IDs or model rows, conclusion about exponential and logistic growth, uncertainty, and limitation.

>

**Q2.** Explain exponential and logistic growth in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for exponential and logistic growth. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about exponential and logistic growth, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using exponential and logistic growth as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E4 is strongest for evaluating the candidate claim about exponential and logistic growth? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E4, state one conclusion about exponential and logistic growth that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about exponential and logistic growth. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about exponential and logistic growth.
...
- Apply exponential and logistic growth under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect exponential and logistic growth to carrying capacity and limiting factors from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Use mathematical and computational representations of real population data to explain and revise a claim about carrying capacity, biodiversity, or the survival value of group behaviour. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-hs9-biology-u07-l07` · lesson `ma-hs9-biology-u07-l07` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
