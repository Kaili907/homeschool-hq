# Launch and diagnostic: cell theory and cell types

**High School Biology (Grade 9)** · Unit 3: Cells, Hierarchical Organization, and Cellular Division · Day 1 of the unit (course day 25) · about 55–75 minutes
...
- Observe the anchoring phenomenon, surface initial thinking about cell theory and cell types without penalty, and pose a testable question.
...
- Science brief: all living organisms are made of cells, the cell is the basic unit of life, and all cells come from pre-existing cells.
- Science brief: prokaryotic cells have no nucleus or membrane-bound organelles; eukaryotic cells have both.
- Science brief: cell theory holds that organisms are composed of cells, that the cell is the basic unit of structure and function, and that cells arise only from existing cells.
- Science brief: prokaryotic cells lack a nucleus and membrane-bound organelles; eukaryotic cells have a nucleus and a range of organelles.

### Evidence check: cell theory and cell types

**Candidate claim:** A case report presents this as acceptable science: “prokaryotic cells have no DNA or no ribosomes.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: all living organisms are made of cells, the cell is the basic unit of life, and all cells come from pre-existing cells. |
| E2 | established science reference | Science brief: prokaryotic cells have no nucleus or membrane-bound organelles; eukaryotic cells have both. |
| E3 | established science reference | Science brief: cell theory holds that organisms are composed of cells, that the cell is the basic unit of structure and function, and that cells arise only from existing cells. |
| E4 | established science reference | Science brief: prokaryotic cells lack a nucleus and membrane-bound organelles; eukaryotic cells have a nucleus and a range of organelles. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs9-biology-u03::cell theory and cell types, derived from the reviewed correctness source policy/correctness/ma-hs9-biology.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about cell theory and cell types, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about cell theory and cell types, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**Q1.** Use the printed case as today's phenomenon for cell theory and cell types. Record what the candidate claim says, identify the mismatch with E1-E4, and pose a testable question naming what would change and what would be measured or classified.

>

**Q2.** Explain cell theory and cell types in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for cell theory and cell types. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about cell theory and cell types, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using cell theory and cell types as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E4 is strongest for evaluating the candidate claim about cell theory and cell types? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E4, state one conclusion about cell theory and cell types that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about cell theory and cell types. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
_Package `swp-ma-hs9-biology-u03-l01` · lesson `ma-hs9-biology-u03-l01` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
