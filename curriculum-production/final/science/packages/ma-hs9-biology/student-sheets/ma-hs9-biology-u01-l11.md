# Unit assessment: enzymes and reaction conditions

**High School Biology (Grade 9)** · Unit 1: Scientific Practice, Measurement, and the Molecules of Life · Day 11 of the unit (course day 11) · about 55–75 minutes

**Today's focus:** enzymes and reaction conditions
...
- Demonstrate independent mastery evidence for enzymes and reaction conditions on a fresh task.
- Explain enzymes and reaction conditions using evidence, a model, or a documented process rather than an unsupported answer.
- Apply enzymes and reaction conditions to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on enzymes and reaction conditions against the stated success criteria and name the next step.
...
- Science brief: an enzyme lowers the activation energy of a reaction and is not consumed by it.
- Science brief: enzymes do not change whether a reaction is energetically favourable; they change how fast it proceeds.
- Science brief: an enzyme is a biological catalyst: it lowers activation energy, speeds the reaction, and emerges unchanged.
- Science brief: enzyme activity depends on temperature and pH, rising to an optimum and falling away as the enzyme's shape is disrupted.

### Evidence check: enzymes and reaction conditions

**Candidate claim:** A case report presents this as acceptable science: “an enzyme is used up in the reaction it catalyses.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: an enzyme lowers the activation energy of a reaction and is not consumed by it. |
| E2 | established science reference | Science brief: enzymes do not change whether a reaction is energetically favourable; they change how fast it proceeds. |
| E3 | established science reference | Science brief: an enzyme is a biological catalyst: it lowers activation energy, speeds the reaction, and emerges unchanged. |
| E4 | established science reference | Science brief: enzyme activity depends on temperature and pH, rising to an optimum and falling away as the enzyme's shape is disrupted. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs9-biology-u01::enzymes and reaction conditions, derived from the reviewed correctness source policy/correctness/ma-hs9-biology.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about enzymes and reaction conditions, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about enzymes and reaction conditions, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about enzymes and reaction conditions, then name one check that would catch an error or a weak claim.**
...
**Q1.** Without copying a sentence from the brief, evaluate the printed candidate case about enzymes and reaction conditions. Cite E1-E4, write the reasoning in your own words, and correct the case claim so it fits exactly what the record establishes.

>

**Q2.** Explain enzymes and reaction conditions in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for enzymes and reaction conditions. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about enzymes and reaction conditions, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using enzymes and reaction conditions as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E4 is strongest for evaluating the candidate claim about enzymes and reaction conditions? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E4, state one conclusion about enzymes and reaction conditions that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about enzymes and reaction conditions. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about enzymes and reaction conditions.
...
- Apply enzymes and reaction conditions under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect enzymes and reaction conditions to biological scale and measurement from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs9-biology-u01-l11` · lesson `ma-hs9-biology-u01-l11` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
