# Independent application A: aerobic and anaerobic pathways

**High School Biology (Grade 9)** · Unit 5: Photosynthesis, Cellular Respiration, and Energy in Living Systems · Day 4 of the unit (course day 52) · about 55–75 minutes

**Today's focus:** aerobic and anaerobic pathways
...
- Explain aerobic and anaerobic pathways using evidence, a model, or a documented process rather than an unsupported answer.
- Apply aerobic and anaerobic pathways to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on aerobic and anaerobic pathways against the stated success criteria and name the next step.
...
- Science brief: anaerobic pathways yield far less ATP per glucose molecule than aerobic respiration.
- Science brief: when oxygen is unavailable, cells use anaerobic pathways such as lactic acid fermentation or alcoholic fermentation.
- Science brief: fermentation regenerates the molecules glycolysis needs to continue, which is why it allows ATP production to keep going.
- Science brief: the far lower ATP yield is why anaerobic activity cannot be sustained for long at high demand.

### Evidence check: aerobic and anaerobic pathways

**Candidate claim:** A case report presents this as acceptable science: “fermentation produces more ATP than aerobic respiration.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: anaerobic pathways yield far less ATP per glucose molecule than aerobic respiration. |
| E2 | established science reference | Science brief: when oxygen is unavailable, cells use anaerobic pathways such as lactic acid fermentation or alcoholic fermentation. |
| E3 | established science reference | Science brief: fermentation regenerates the molecules glycolysis needs to continue, which is why it allows ATP production to keep going. |
| E4 | established science reference | Science brief: the far lower ATP yield is why anaerobic activity cannot be sustained for long at high demand. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs9-biology-u05::aerobic and anaerobic pathways, derived from the reviewed correctness source policy/correctness/ma-hs9-biology.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about aerobic and anaerobic pathways, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about aerobic and anaerobic pathways, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about aerobic and anaerobic pathways, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain aerobic and anaerobic pathways in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for aerobic and anaerobic pathways. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about aerobic and anaerobic pathways, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using aerobic and anaerobic pathways as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about aerobic and anaerobic pathways? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about aerobic and anaerobic pathways that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about aerobic and anaerobic pathways. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about aerobic and anaerobic pathways.
...
- Apply aerobic and anaerobic pathways under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect aerobic and anaerobic pathways to light energy capture from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs9-biology-u05-l04` · lesson `ma-hs9-biology-u05-l04` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
