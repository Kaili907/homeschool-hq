# Guided practice B: group behaviour and survival

**High School Biology (Grade 9)** · Unit 7: Population Dynamics, Carrying Capacity, and Biodiversity · Day 6 of the unit (course day 78) · about 55–75 minutes
...
_Package `swp-ma-hs9-biology-u07-l06` · lesson `ma-hs9-biology-u07-l06` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
