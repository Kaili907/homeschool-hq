# Correction and reflection: group behaviour and survival

**High School Biology (Grade 9)** · Unit 7: Population Dynamics, Carrying Capacity, and Biodiversity · Day 12 of the unit (course day 84) · about 55–75 minutes

**Today's focus:** group behaviour and survival
...
- Explain group behaviour and survival using evidence, a model, or a documented process rather than an unsupported answer.
- Apply group behaviour and survival to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on group behaviour and survival against the stated success criteria and name the next step.
...
- Science brief: group behaviours such as flocking, herding, cooperative hunting, and colonial nesting can increase individual survival and reproductive success.
- Science brief: group living also imposes costs, including competition within the group and faster transmission of disease and parasites.
- Science brief: whether group behaviour is favoured depends on the balance of those costs and benefits in the specific environment.

### Evidence check: group behaviour and survival

**Candidate claim:** A case report presents this as acceptable science: “group behaviour evolves for the good of the species irrespective of effects on individuals.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: group behaviours such as flocking, herding, cooperative hunting, and colonial nesting can increase individual survival and reproductive success. |
| E2 | established science reference | Science brief: group living also imposes costs, including competition within the group and faster transmission of disease and parasites. |
| E3 | established science reference | Science brief: whether group behaviour is favoured depends on the balance of those costs and benefits in the specific environment. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs9-biology-u07::group behaviour and survival, derived from the reviewed correctness source policy/correctness/ma-hs9-biology.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about group behaviour and survival, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about group behaviour and survival, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about group behaviour and survival, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain group behaviour and survival in your own words using at least two specifically named rows from E1-E3. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for group behaviour and survival. Decide whether E1-E3 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about group behaviour and survival, revise its weakest claim with a named row from E1-E3, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using group behaviour and survival as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about group behaviour and survival? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about group behaviour and survival that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about group behaviour and survival. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about group behaviour and survival.
...
- Apply group behaviour and survival under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect group behaviour and survival to exponential and logistic growth from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs9-biology-u07-l12` · lesson `ma-hs9-biology-u07-l12` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
