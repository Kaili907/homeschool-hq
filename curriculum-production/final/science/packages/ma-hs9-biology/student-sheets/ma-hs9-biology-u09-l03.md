# Guided practice A: statistics of advantageous traits

**High School Biology (Grade 9)** · Unit 9: Natural Selection, Evolution, and Biodiversity Engineering · Day 3 of the unit (course day 99) · about 55–75 minutes
...
- Science brief: selection is detected as a change in the distribution of a trait in a population over generations.
- Science brief: a shift in a distribution is evidence about the population, not about any individual within it.
- Science brief: the strength of the evidence depends on sample size, on measurement method, and on the number of generations observed.

### Evidence check: statistics of advantageous traits

**Candidate claim:** A case report presents this as acceptable science: “inferring selection from a change in one individual.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: selection is detected as a change in the distribution of a trait in a population over generations. |
| E2 | established science reference | Science brief: a shift in a distribution is evidence about the population, not about any individual within it. |
| E3 | established science reference | Science brief: the strength of the evidence depends on sample size, on measurement method, and on the number of generations observed. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs9-biology-u09::statistics of advantageous traits, derived from the reviewed correctness source policy/correctness/ma-hs9-biology.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about statistics of advantageous traits, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about statistics of advantageous traits, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**Q1.** Explain statistics of advantageous traits in your own words using at least two specifically named rows from E1-E3. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for statistics of advantageous traits. Decide whether E1-E3 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about statistics of advantageous traits, revise its weakest claim with a named row from E1-E3, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using statistics of advantageous traits as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about statistics of advantageous traits? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about statistics of advantageous traits that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about statistics of advantageous traits. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
_Package `swp-ma-hs9-biology-u09-l03` · lesson `ma-hs9-biology-u09-l03` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
