# Correction and reflection: engineering solutions for biodiversity

**High School Biology (Grade 9)** · Unit 9: Natural Selection, Evolution, and Biodiversity Engineering · Day 12 of the unit (course day 108) · about 55–75 minutes

**Today's focus:** engineering solutions for biodiversity
...
- Explain engineering solutions for biodiversity using evidence, a model, or a documented process rather than an unsupported answer.
- Apply engineering solutions for biodiversity to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on engineering solutions for biodiversity against the stated success criteria and name the next step.
...
- Science brief: interventions to protect biodiversity are evaluated against stated criteria and against evidence of effect, not against intent.
- Science brief: because ecosystems are connected, an intervention has effects beyond its target, sometimes delayed or distant.
- Science brief: monitoring after the intervention is what converts an expected effect into an observed one.

### Evidence check: engineering solutions for biodiversity

**Candidate claim:** A case report presents this as acceptable science: “an intervention affects only its intended target.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: interventions to protect biodiversity are evaluated against stated criteria and against evidence of effect, not against intent. |
| E2 | established science reference | Science brief: because ecosystems are connected, an intervention has effects beyond its target, sometimes delayed or distant. |
| E3 | established science reference | Science brief: monitoring after the intervention is what converts an expected effect into an observed one. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs9-biology-u09::engineering solutions for biodiversity, derived from the reviewed correctness source policy/correctness/ma-hs9-biology.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about engineering solutions for biodiversity, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about engineering solutions for biodiversity, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about engineering solutions for biodiversity, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain engineering solutions for biodiversity in your own words using at least two specifically named rows from E1-E3. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for engineering solutions for biodiversity. Decide whether E1-E3 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about engineering solutions for biodiversity, revise its weakest claim with a named row from E1-E3, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using engineering solutions for biodiversity as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about engineering solutions for biodiversity? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about engineering solutions for biodiversity that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about engineering solutions for biodiversity. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about engineering solutions for biodiversity.
...
- Apply engineering solutions for biodiversity under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect engineering solutions for biodiversity to multiple lines of evidence for common ancestry from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs9-biology-u09-l12` · lesson `ma-hs9-biology-u09-l12` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
