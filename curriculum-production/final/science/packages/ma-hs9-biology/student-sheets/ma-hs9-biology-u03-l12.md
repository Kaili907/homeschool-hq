# Correction and reflection: scale and surface-area-to-volume

**High School Biology (Grade 9)** · Unit 3: Cells, Hierarchical Organization, and Cellular Division · Day 12 of the unit (course day 36) · about 55–75 minutes

**Today's focus:** scale and surface-area-to-volume
...
- Explain scale and surface-area-to-volume using evidence, a model, or a documented process rather than an unsupported answer.
- Apply scale and surface-area-to-volume to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on scale and surface-area-to-volume against the stated success criteria and name the next step.
...
- Science brief: as an object grows with its shape unchanged, its volume increases faster than its surface area, so the surface-area-to-volume ratio falls.
- Science brief: exchange with the environment happens across the surface, while demand scales with volume, so cells are limited in the size they can reach.
- Science brief: multicellular organisms overcome the limit with many small cells and with structures such as folds, villi, and branching that increase surface area.
- Science brief: the ratio explains why cells divide rather than simply growing larger.

### Evidence check: scale and surface-area-to-volume

**Candidate claim:** A case report presents this as acceptable science: “surface area and volume increase in the same proportion as an object grows.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: as an object grows with its shape unchanged, its volume increases faster than its surface area, so the surface-area-to-volume ratio falls. |
| E2 | established science reference | Science brief: exchange with the environment happens across the surface, while demand scales with volume, so cells are limited in the size they can reach. |
| E3 | established science reference | Science brief: multicellular organisms overcome the limit with many small cells and with structures such as folds, villi, and branching that increase surface area. |
| E4 | established science reference | Science brief: the ratio explains why cells divide rather than simply growing larger. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs9-biology-u03::scale and surface-area-to-volume, derived from the reviewed correctness source policy/correctness/ma-hs9-biology.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about scale and surface-area-to-volume, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about scale and surface-area-to-volume, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about scale and surface-area-to-volume, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain scale and surface-area-to-volume in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for scale and surface-area-to-volume. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about scale and surface-area-to-volume, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using scale and surface-area-to-volume as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about scale and surface-area-to-volume? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about scale and surface-area-to-volume that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about scale and surface-area-to-volume. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about scale and surface-area-to-volume.
...
- Apply scale and surface-area-to-volume under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect scale and surface-area-to-volume to cell theory and cell types from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs9-biology-u03-l12` · lesson `ma-hs9-biology-u03-l12` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
