# Independent application A: nitrogen and nutrient cycling

**High School Biology (Grade 9)** · Unit 6: Ecosystems: Matter Cycling and Energy Flow · Day 4 of the unit (course day 64) · about 55–75 minutes

**Today's focus:** nitrogen and nutrient cycling
...
- Explain nitrogen and nutrient cycling using evidence, a model, or a documented process rather than an unsupported answer.
- Apply nitrogen and nutrient cycling to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on nitrogen and nutrient cycling against the stated success criteria and name the next step.
...
- Science brief: atmospheric nitrogen gas cannot be used directly by plants or animals; it must first be fixed into usable compounds.
- Science brief: nitrogen-fixing bacteria, and industrial processes, convert atmospheric nitrogen into forms plants can take up.
- Science brief: nitrogen moves from soil to plants to consumers and back through excretion and decomposition.
- Science brief: adding excess nutrients to water bodies stimulates growth that, on decomposing, depletes dissolved oxygen.

### Evidence check: nitrogen and nutrient cycling

**Candidate claim:** A case report presents this as acceptable science: “plants take nitrogen directly from the air.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: atmospheric nitrogen gas cannot be used directly by plants or animals; it must first be fixed into usable compounds. |
| E2 | established science reference | Science brief: nitrogen-fixing bacteria, and industrial processes, convert atmospheric nitrogen into forms plants can take up. |
| E3 | established science reference | Science brief: nitrogen moves from soil to plants to consumers and back through excretion and decomposition. |
| E4 | established science reference | Science brief: adding excess nutrients to water bodies stimulates growth that, on decomposing, depletes dissolved oxygen. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs9-biology-u06::nitrogen and nutrient cycling, derived from the reviewed correctness source policy/correctness/ma-hs9-biology.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about nitrogen and nutrient cycling, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about nitrogen and nutrient cycling, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about nitrogen and nutrient cycling, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain nitrogen and nutrient cycling in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for nitrogen and nutrient cycling. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about nitrogen and nutrient cycling, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using nitrogen and nutrient cycling as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about nitrogen and nutrient cycling? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about nitrogen and nutrient cycling that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about nitrogen and nutrient cycling. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about nitrogen and nutrient cycling.
...
- Apply nitrogen and nutrient cycling under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect nitrogen and nutrient cycling to trophic levels and energy transfer from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs9-biology-u06-l04` · lesson `ma-hs9-biology-u06-l04` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
