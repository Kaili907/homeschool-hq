# Reteach and varied practice: the four factors driving natural selection

**High School Biology (Grade 9)** · Unit 9: Natural Selection, Evolution, and Biodiversity Engineering · Day 8 of the unit (course day 104) · about 55–75 minutes

**Today's focus:** the four factors driving natural selection
...
- Explain the four factors driving natural selection using evidence, a model, or a documented process rather than an unsupported answer.
- Apply the four factors driving natural selection to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on the four factors driving natural selection against the stated success criteria and name the next step.
...
- Science brief: natural selection requires: more offspring produced than can survive; heritable variation among individuals; competition for limited resources; and differential survival and reproduction of individuals with particular heritable traits.
- Science brief: all four conditions are necessary; if any is absent, natural selection does not operate.
- Science brief: selection acts on phenotypes, and the effect is heritable only to the extent that the variation is genetic.
- Science brief: the outcome is a change in the frequency of heritable traits in the population across generations.

### Evidence check: the four factors driving natural selection

**Candidate claim:** A case report presents this as acceptable science: “individual organisms evolve or adapt themselves during their lifetimes.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: natural selection requires: more offspring produced than can survive; heritable variation among individuals; competition for limited resources; and differential survival and reproduction of individuals with particular heritable traits. |
| E2 | established science reference | Science brief: all four conditions are necessary; if any is absent, natural selection does not operate. |
| E3 | established science reference | Science brief: selection acts on phenotypes, and the effect is heritable only to the extent that the variation is genetic. |
| E4 | established science reference | Science brief: the outcome is a change in the frequency of heritable traits in the population across generations. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs9-biology-u09::the four factors driving natural selection, derived from the reviewed correctness source policy/correctness/ma-hs9-biology.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about the four factors driving natural selection, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about the four factors driving natural selection, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about the four factors driving natural selection, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain the four factors driving natural selection in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for the four factors driving natural selection. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about the four factors driving natural selection, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using the four factors driving natural selection as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about the four factors driving natural selection? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about the four factors driving natural selection that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about the four factors driving natural selection. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about the four factors driving natural selection.
...
- Apply the four factors driving natural selection under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect the four factors driving natural selection to multiple lines of evidence for common ancestry from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs9-biology-u09-l08` · lesson `ma-hs9-biology-u09-l08` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
