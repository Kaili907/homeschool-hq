# Correction and reflection: argument from evidence in biology

**High School Biology (Grade 9)** · Unit 1: Scientific Practice, Measurement, and the Molecules of Life · Day 12 of the unit (course day 12) · about 55–75 minutes

**Today's focus:** argument from evidence in biology
...
- Explain argument from evidence in biology using evidence, a model, or a documented process rather than an unsupported answer.
- Apply argument from evidence in biology to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on argument from evidence in biology against the stated success criteria and name the next step.
...
- Science brief: a biological argument links a claim to evidence through explicit reasoning about mechanism or pattern.
- Science brief: biological systems are variable, so an argument states how much of the observed pattern the evidence actually establishes.
- Science brief: the strongest alternative explanation is stated and addressed rather than omitted.

### Evidence check: argument from evidence in biology

**Candidate claim:** A case report presents this as acceptable science: “inferring a causal mechanism from a correlation with no further evidence.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a biological argument links a claim to evidence through explicit reasoning about mechanism or pattern. |
| E2 | established science reference | Science brief: biological systems are variable, so an argument states how much of the observed pattern the evidence actually establishes. |
| E3 | established science reference | Science brief: the strongest alternative explanation is stated and addressed rather than omitted. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs9-biology-u01::argument from evidence in biology, derived from the reviewed correctness source policy/correctness/ma-hs9-biology.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about argument from evidence in biology, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about argument from evidence in biology, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about argument from evidence in biology, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain argument from evidence in biology in your own words using at least two specifically named rows from E1-E3. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for argument from evidence in biology. Decide whether E1-E3 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about argument from evidence in biology, revise its weakest claim with a named row from E1-E3, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using argument from evidence in biology as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about argument from evidence in biology? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about argument from evidence in biology that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about argument from evidence in biology. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about argument from evidence in biology.
...
- Apply argument from evidence in biology under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect argument from evidence in biology to biological scale and measurement from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs9-biology-u01-l12` · lesson `ma-hs9-biology-u01-l12` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
