# Correction and reflection: mutation and its consequences

**High School Biology (Grade 9)** · Unit 2: DNA, Proteins, and the Information Flow of the Cell · Day 12 of the unit (course day 24) · about 55–75 minutes

**Today's focus:** mutation and its consequences
...
- Apply mutation and its consequences to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on mutation and its consequences against the stated success criteria and name the next step.
...
- Science brief: a mutation is a change in DNA sequence; its effect may be harmful, beneficial, or neutral, and depends on where it occurs and what it changes.
- Science brief: mutations arise from replication errors and from chemical and radiation damage, and most are repaired.
- Science brief: a substitution may change no amino acid, change one, or introduce a stop; an insertion or deletion that is not a multiple of three shifts the reading frame and usually has a larger effect.
- Science brief: only mutations in the germ line are inherited; somatic mutations affect the individual alone.

### Evidence check: mutation and its consequences

**Candidate claim:** A case report presents this as acceptable science: “all mutations are harmful.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a mutation is a change in DNA sequence; its effect may be harmful, beneficial, or neutral, and depends on where it occurs and what it changes. |
| E2 | established science reference | Science brief: mutations arise from replication errors and from chemical and radiation damage, and most are repaired. |
| E3 | established science reference | Science brief: a substitution may change no amino acid, change one, or introduce a stop; an insertion or deletion that is not a multiple of three shifts the reading frame and usually has a larger effect. |
| E4 | established science reference | Science brief: only mutations in the germ line are inherited; somatic mutations affect the individual alone. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs9-biology-u02::mutation and its consequences, derived from the reviewed correctness source policy/correctness/ma-hs9-biology.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about mutation and its consequences, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about mutation and its consequences, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about mutation and its consequences, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain mutation and its consequences in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for mutation and its consequences. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about mutation and its consequences, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using mutation and its consequences as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about mutation and its consequences? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about mutation and its consequences that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about mutation and its consequences. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about mutation and its consequences.
...
- Apply mutation and its consequences under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect mutation and its consequences to DNA structure and base pairing from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs9-biology-u02-l12` · lesson `ma-hs9-biology-u02-l12` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
