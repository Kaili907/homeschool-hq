# Independent application A: adaptation of populations

**High School Biology (Grade 9)** · Unit 9: Natural Selection, Evolution, and Biodiversity Engineering · Day 4 of the unit (course day 100) · about 55–75 minutes

**Today's focus:** adaptation of populations
...
- Apply adaptation of populations to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on adaptation of populations against the stated success criteria and name the next step.
...
- Science brief: adaptation is a population-level outcome across generations, not a change an individual makes during its life.
- Science brief: an adaptation is a heritable trait that has become common in a population because it improved survival and reproduction in that environment.
- Science brief: a trait that is adaptive in one environment can be neutral or harmful in another, so adaptation is always relative to conditions.
- Science brief: not every trait is an adaptation; some persist through chance, through linkage to other traits, or as by-products.

### Evidence check: adaptation of populations

**Candidate claim:** A case report presents this as acceptable science: “describing an individual organism as adapting to its environment during its lifetime as an evolutionary process.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: adaptation is a population-level outcome across generations, not a change an individual makes during its life. |
| E2 | established science reference | Science brief: an adaptation is a heritable trait that has become common in a population because it improved survival and reproduction in that environment. |
| E3 | established science reference | Science brief: a trait that is adaptive in one environment can be neutral or harmful in another, so adaptation is always relative to conditions. |
| E4 | established science reference | Science brief: not every trait is an adaptation; some persist through chance, through linkage to other traits, or as by-products. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs9-biology-u09::adaptation of populations, derived from the reviewed correctness source policy/correctness/ma-hs9-biology.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about adaptation of populations, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about adaptation of populations, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about adaptation of populations, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain adaptation of populations in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for adaptation of populations. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about adaptation of populations, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using adaptation of populations as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about adaptation of populations? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about adaptation of populations that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about adaptation of populations. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about adaptation of populations.
...
- Apply adaptation of populations under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect adaptation of populations to multiple lines of evidence for common ancestry from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs9-biology-u09-l04` · lesson `ma-hs9-biology-u09-l04` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
