# Unit assessment: differentiation and stem cells

**High School Biology (Grade 9)** · Unit 3: Cells, Hierarchical Organization, and Cellular Division · Day 11 of the unit (course day 35) · about 55–75 minutes

**Today's focus:** differentiation and stem cells
...
- Explain differentiation and stem cells using evidence, a model, or a documented process rather than an unsupported answer.
- Apply differentiation and stem cells to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on differentiation and stem cells against the stated success criteria and name the next step.
...
- Science brief: differentiated cells in one organism generally contain the same genome; they differ in which genes are expressed.
- Science brief: differentiation is the process by which cells become specialised, and it results from differences in gene expression rather than differences in the genes present.
- Science brief: stem cells retain the capacity to divide and to give rise to specialised cell types.
- Science brief: because the genome is retained, differentiation is about regulation, not about loss of genetic information.

### Evidence check: differentiation and stem cells

**Candidate claim:** A case report presents this as acceptable science: “differentiated cells have lost the genes they do not use.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: differentiated cells in one organism generally contain the same genome; they differ in which genes are expressed. |
| E2 | established science reference | Science brief: differentiation is the process by which cells become specialised, and it results from differences in gene expression rather than differences in the genes present. |
| E3 | established science reference | Science brief: stem cells retain the capacity to divide and to give rise to specialised cell types. |
| E4 | established science reference | Science brief: because the genome is retained, differentiation is about regulation, not about loss of genetic information. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs9-biology-u03::differentiation and stem cells, derived from the reviewed correctness source policy/correctness/ma-hs9-biology.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about differentiation and stem cells, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about differentiation and stem cells, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about differentiation and stem cells, then name one check that would catch an error or a weak claim.**
...
**Q1.** Without copying a sentence from the brief, evaluate the printed candidate case about differentiation and stem cells. Cite E1-E4, write the reasoning in your own words, and correct the case claim so it fits exactly what the record establishes.

>

**Q2.** Explain differentiation and stem cells in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for differentiation and stem cells. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about differentiation and stem cells, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using differentiation and stem cells as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E4 is strongest for evaluating the candidate claim about differentiation and stem cells? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E4, state one conclusion about differentiation and stem cells that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about differentiation and stem cells. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about differentiation and stem cells.
...
- Apply differentiation and stem cells under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect differentiation and stem cells to cell theory and cell types from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs9-biology-u03-l11` · lesson `ma-hs9-biology-u03-l11` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
