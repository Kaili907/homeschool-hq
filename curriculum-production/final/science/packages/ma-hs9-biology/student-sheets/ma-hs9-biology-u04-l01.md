# Launch and diagnostic: setpoints and tolerance ranges

**High School Biology (Grade 9)** · Unit 4: Homeostasis and Feedback Mechanisms · Day 1 of the unit (course day 37) · about 55–75 minutes
...
- Science brief: homeostasis maintains internal conditions within a tolerance range, not at a single unchanging value.
- Science brief: a regulated variable has a setpoint and a range within which the organism functions.
- Science brief: values fluctuate within the range continuously; regulation acts when a departure is detected, so variation is expected.
- Science brief: different variables have different ranges, and exceeding a range has consequences specific to that variable.

### Evidence check: setpoints and tolerance ranges

**Candidate claim:** A case report presents this as acceptable science: “a homeostatically regulated variable is held perfectly constant.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: homeostasis maintains internal conditions within a tolerance range, not at a single unchanging value. |
| E2 | established science reference | Science brief: a regulated variable has a setpoint and a range within which the organism functions. |
| E3 | established science reference | Science brief: values fluctuate within the range continuously; regulation acts when a departure is detected, so variation is expected. |
| E4 | established science reference | Science brief: different variables have different ranges, and exceeding a range has consequences specific to that variable. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs9-biology-u04::setpoints and tolerance ranges, derived from the reviewed correctness source policy/correctness/ma-hs9-biology.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about setpoints and tolerance ranges, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about setpoints and tolerance ranges, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**Q1.** Use the printed case as today's phenomenon for setpoints and tolerance ranges. Record what the candidate claim says, identify the mismatch with E1-E4, and pose a testable question naming what would change and what would be measured or classified.

>

**Q2.** Explain setpoints and tolerance ranges in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for setpoints and tolerance ranges. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about setpoints and tolerance ranges, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using setpoints and tolerance ranges as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E4 is strongest for evaluating the candidate claim about setpoints and tolerance ranges? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E4, state one conclusion about setpoints and tolerance ranges that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about setpoints and tolerance ranges. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
_Package `swp-ma-hs9-biology-u04-l01` · lesson `ma-hs9-biology-u04-l01` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
