# Reteach and varied practice: meiosis and recombination

**High School Biology (Grade 9)** · Unit 8: Inheritance and Variation of Traits · Day 8 of the unit (course day 92) · about 55–75 minutes

**Today's focus:** meiosis and recombination
...
- Explain meiosis and recombination using evidence, a model, or a documented process rather than an unsupported answer.
- Apply meiosis and recombination to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on meiosis and recombination against the stated success criteria and name the next step.
...
- Science brief: meiosis halves the chromosome number and produces four genetically distinct haploid cells from one diploid cell.
- Science brief: meiosis involves two divisions after a single round of DNA replication, which is why the chromosome number is halved.
- Science brief: crossing over between homologous chromosomes, and the independent assortment of homologous pairs, produce genetically distinct gametes.
- Science brief: fertilisation restores the diploid number and adds a further source of combination.

### Evidence check: meiosis and recombination

**Candidate claim:** A case report presents this as acceptable science: “meiosis produces two genetically identical daughter cells.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: meiosis halves the chromosome number and produces four genetically distinct haploid cells from one diploid cell. |
| E2 | established science reference | Science brief: meiosis involves two divisions after a single round of DNA replication, which is why the chromosome number is halved. |
| E3 | established science reference | Science brief: crossing over between homologous chromosomes, and the independent assortment of homologous pairs, produce genetically distinct gametes. |
| E4 | established science reference | Science brief: fertilisation restores the diploid number and adds a further source of combination. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs9-biology-u08::meiosis and recombination, derived from the reviewed correctness source policy/correctness/ma-hs9-biology.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about meiosis and recombination, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about meiosis and recombination, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about meiosis and recombination, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain meiosis and recombination in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for meiosis and recombination. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about meiosis and recombination, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using meiosis and recombination as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about meiosis and recombination? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about meiosis and recombination that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about meiosis and recombination. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about meiosis and recombination.
...
- Apply meiosis and recombination under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect meiosis and recombination to chromosomes and gene loci from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs9-biology-u08-l08` · lesson `ma-hs9-biology-u08-l08` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
