# Concept model A: organelles as interacting subsystems

**High School Biology (Grade 9)** · Unit 3: Cells, Hierarchical Organization, and Cellular Division · Day 2 of the unit (course day 26) · about 55–75 minutes
...
_Package `swp-ma-hs9-biology-u03-l02` · lesson `ma-hs9-biology-u03-l02` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
