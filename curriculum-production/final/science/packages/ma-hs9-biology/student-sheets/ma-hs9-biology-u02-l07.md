# Investigation: DNA structure and base pairing

**High School Biology (Grade 9)** · Unit 2: DNA, Proteins, and the Information Flow of the Cell · Day 7 of the unit (course day 19) · about 61–84 minutes

**Today's focus:** DNA structure and base pairing
...
- Plan and carry out a safe investigation of DNA structure and base pairing, or its stated alternative, and record the learner's own data with its uncertainty.
- Explain DNA structure and base pairing using evidence, a model, or a documented process rather than an unsupported answer.
- Apply DNA structure and base pairing to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on DNA structure and base pairing against the stated success criteria and name the next step.
...
- cold rubbing alcohol (isopropyl)
- clear cup
- a tray to work over
- resealable bag
...
- **Chemical hazard.** Isopropyl alcohol is flammable, its vapour is heavier than air and pools at bench level, and it is harmful if swallowed or splashed in eyes.
  - What stops it: An adult sweeps the room for every ignition source before the bottle is opened, pours no more than 60 mL, and returns the bottle to a closed cupboard at once. Eye protection on; nothing is tasted. See the safe order.
- **Physical hazard.** Glass containers can break and cut.
  - What stops it: Use plastic or unbreakable cups only.
...
**Clearing up.** Pour the alcohol-and-fruit mixture down the drain with the cold tap running for 30 seconds, then wash and dry the cup. Ventilate the room for ten minutes before any appliance, charger, or battery is used at that surface. Never seal the mixture in a bag, bottle, or any closed container.
...
- Science brief: in DNA, adenine pairs with thymine and guanine pairs with cytosine.
- Science brief: dNA is a double helix of two antiparallel strands with a sugar-phosphate backbone on the outside and paired bases on the inside.
- Science brief: dNA is composed of nucleotides, each a deoxyribose sugar, a phosphate group, and one of four nitrogenous bases.
- Science brief: the two strands are held together by hydrogen bonds between complementary bases: adenine with thymine, guanine with cytosine.

### Evidence check: DNA structure and base pairing

**Candidate claim:** A case report presents this as acceptable science: “pairing adenine with guanine, or cytosine with thymine.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: in DNA, adenine pairs with thymine and guanine pairs with cytosine. |
| E2 | established science reference | Science brief: dNA is a double helix of two antiparallel strands with a sugar-phosphate backbone on the outside and paired bases on the inside. |
| E3 | established science reference | Science brief: dNA is composed of nucleotides, each a deoxyribose sugar, a phosphate group, and one of four nitrogenous bases. |
| E4 | established science reference | Science brief: the two strands are held together by hydrogen bonds between complementary bases: adenine with thymine, guanine with cytosine. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs9-biology-u02::DNA structure and base pairing, derived from the reviewed correctness source policy/correctness/ma-hs9-biology.correctness.json.

**Supplied unit connections:** DNA structure and base pairing; replication as information copying; transcription; translation and the genetic code; protein folding and function; mutation and its consequences

**Supplied unit performance task:** Build a physical or drawn model tracing one gene from DNA sequence to folded protein to observable function, and state precisely what your model cannot show.

### Bound task

**Question:** What does evidence E1 through E4 justify about DNA structure and base pairing, and does it support the candidate claim?
...
| --- | --- |
| DNA template | TAC GGA CTT ACT |
| mRNA pairing | A-U, T-A, C-G, G-C |
| AUG | Met/start |
| CCU | Pro |
| GAA | Glu |
| UGA | Stop |

**Model/source rule:** Apply the supplied complementary-pairing rules, read mRNA from left to right in triplets, and use only the four-entry codon key shown.
...
3. Transcribe the template, translate it with the supplied key, draw the resulting amino-acid chain, and explain how one changed DNA base could change or preserve the chain.
...
**Pinned H4 alternative statement (lineage evidence):** Skip extraction entirely: use a printed codon table and a supplied DNA sequence to transcribe and translate by hand, then build the protein from paper or beads. This needs only paper and meets the sequence-to-function target.
...
**My question.** Write the question you are testing about DNA structure and base pairing. It has to be a question your evidence could actually answer.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about DNA structure and base pairing, then name one check that would catch an error or a weak claim.**
...
**Q1.** Complete the route you chose. For the document/model route, use its printed procedure and input table; for the H4 physical route, use the printed safe order and your own blank record. Report the route, evidence IDs or model rows, conclusion about DNA structure and base pairing, uncertainty, and limitation.

>

**Q2.** Explain DNA structure and base pairing in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for DNA structure and base pairing. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about DNA structure and base pairing, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using DNA structure and base pairing as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E4 is strongest for evaluating the candidate claim about DNA structure and base pairing? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E4, state one conclusion about DNA structure and base pairing that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about DNA structure and base pairing. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about DNA structure and base pairing.
...
- Apply DNA structure and base pairing under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect DNA structure and base pairing to replication as information copying from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Build a physical or drawn model tracing one gene from DNA sequence to folded protein to observable function, and state precisely what your model cannot show. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-hs9-biology-u02-l07` · lesson `ma-hs9-biology-u02-l07` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
