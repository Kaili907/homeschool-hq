# Launch and diagnostic: biological scale and measurement

**High School Biology (Grade 9)** · Unit 1: Scientific Practice, Measurement, and the Molecules of Life · Day 1 of the unit (course day 1) · about 55–75 minutes
...
- Science brief: typical bacterial cells are on the order of micrometres; typical eukaryotic cells are tens of micrometres; molecules such as proteins are on the order of nanometres.
- Science brief: biological structures span many orders of magnitude, and the appropriate unit and instrument change with the scale being studied.
- Science brief: the scale of a structure constrains what can be observed about it: light microscopy resolves cells and large organelles, not individual proteins.
- Science brief: a measurement is meaningful only with its unit and the method that produced it.

### Evidence check: biological scale and measurement

**Candidate claim:** A case report presents this as acceptable science: “individual protein molecules can be resolved with a light microscope.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: typical bacterial cells are on the order of micrometres; typical eukaryotic cells are tens of micrometres; molecules such as proteins are on the order of nanometres. |
| E2 | established science reference | Science brief: biological structures span many orders of magnitude, and the appropriate unit and instrument change with the scale being studied. |
| E3 | established science reference | Science brief: the scale of a structure constrains what can be observed about it: light microscopy resolves cells and large organelles, not individual proteins. |
| E4 | established science reference | Science brief: a measurement is meaningful only with its unit and the method that produced it. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs9-biology-u01::biological scale and measurement, derived from the reviewed correctness source policy/correctness/ma-hs9-biology.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about biological scale and measurement, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about biological scale and measurement, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**Q1.** Use the printed case as today's phenomenon for biological scale and measurement. Record what the candidate claim says, identify the mismatch with E1-E4, and pose a testable question naming what would change and what would be measured or classified.

>

**Q2.** Explain biological scale and measurement in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for biological scale and measurement. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about biological scale and measurement, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using biological scale and measurement as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E4 is strongest for evaluating the candidate claim about biological scale and measurement? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E4, state one conclusion about biological scale and measurement that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about biological scale and measurement. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
_Package `swp-ma-hs9-biology-u01-l01` · lesson `ma-hs9-biology-u01-l01` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
