# Correction and reflection: quantitative ecosystem models

**High School Biology (Grade 9)** · Unit 6: Ecosystems: Matter Cycling and Energy Flow · Day 12 of the unit (course day 72) · about 55–75 minutes

**Today's focus:** quantitative ecosystem models
...
- Explain quantitative ecosystem models using evidence, a model, or a documented process rather than an unsupported answer.
- Apply quantitative ecosystem models to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on quantitative ecosystem models against the stated success criteria and name the next step.
...
- Science brief: a quantitative ecosystem model represents stocks and flows of matter or energy and must balance.
- Science brief: model outputs are conditional on the assumptions and parameter values used, and those are stated.
- Science brief: a model is evaluated against measured data, and disagreement is information about the assumptions.

### Evidence check: quantitative ecosystem models
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a quantitative ecosystem model represents stocks and flows of matter or energy and must balance. |
| E2 | established science reference | Science brief: model outputs are conditional on the assumptions and parameter values used, and those are stated. |
| E3 | established science reference | Science brief: a model is evaluated against measured data, and disagreement is information about the assumptions. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs9-biology-u06::quantitative ecosystem models, derived from the reviewed correctness source policy/correctness/ma-hs9-biology.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about quantitative ecosystem models, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about quantitative ecosystem models, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about quantitative ecosystem models, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain quantitative ecosystem models in your own words using at least two specifically named rows from E1-E3. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for quantitative ecosystem models. Decide whether E1-E3 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about quantitative ecosystem models, revise its weakest claim with a named row from E1-E3, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using quantitative ecosystem models as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about quantitative ecosystem models? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about quantitative ecosystem models that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about quantitative ecosystem models. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about quantitative ecosystem models.
...
- Apply quantitative ecosystem models under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect quantitative ecosystem models to trophic levels and energy transfer from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs9-biology-u06-l12` · lesson `ma-hs9-biology-u06-l12` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
