# Guided practice B: distribution of expressed traits

**High School Biology (Grade 9)** · Unit 8: Inheritance and Variation of Traits · Day 6 of the unit (course day 90) · about 55–75 minutes
...
_Package `swp-ma-hs9-biology-u08-l06` · lesson `ma-hs9-biology-u08-l06` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
