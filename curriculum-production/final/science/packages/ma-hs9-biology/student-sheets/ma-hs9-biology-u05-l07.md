# Investigation: light energy capture

**High School Biology (Grade 9)** · Unit 5: Photosynthesis, Cellular Respiration, and Energy in Living Systems · Day 7 of the unit (course day 55) · about 61–84 minutes

**Today's focus:** light energy capture
...
- Plan and carry out a safe investigation of light energy capture, or its stated alternative, and record the learner's own data with its uncertainty.
- Explain light energy capture using evidence, a model, or a documented process rather than an unsupported answer.
- Apply light energy capture to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on light energy capture against the stated success criteria and name the next step.

**Materials:**

- fresh spinach or elodea
- baking soda
- water
- clear cups
- lamp or window light
- needleless blunt-tip syringe (optional leaf-disk route)
- thermometer
- yeast, sugar, water below 40 degrees Celsius, balloon (respiration route)
- timer
...
- **Chemical hazard.** Baking soda solution irritates eyes.
  - What stops it: Wear eye protection and rinse any splash with water.
- **Physical hazard.** A lamp close to a water container gets hot and mixes electricity with water.
  - What stops it: Use an LED lamp only - never incandescent or halogen, which crack a cup and can ignite paper at this distance. Keep it at least 30 cm away, never above the water, and plug it in away from any spill zone; an adult positions the lamp.
- **Physical hazard.** Warm water scalds, and hot tap water kills the yeast anyway.
  - What stops it: An adult mixes the yeast water and confirms with the thermometer that it reads below 40 degrees Celsius. Temperature is judged with the thermometer, never with a hand.
- **Physical hazard.** A syringe with a needle, or a blocked tip under vacuum, injures or sprays.
  - What stops it: Use a needleless blunt-tip syringe only. No needle of any kind is used in this course.
...
**Clearing up.** Pour the baking-soda and yeast mixtures down the drain with the tap running, compost or bin the leaf material, wash the containers with soap, and wash hands. Leave any yeast container open until fizzing stops before it is binned. Nothing is sealed, kept, or stored.
...
- Science brief: chlorophyll absorbs light most strongly in the blue and red regions and reflects green, which is why plants appear green.
- Science brief: pigments absorb particular wavelengths of light and transfer that energy into the photosynthetic process.
- Science brief: light absorbed is used; light reflected or transmitted is not, which is why leaf colour indicates which wavelengths are least used.
- Science brief: the light-dependent reactions occur in the thylakoid membranes of the chloroplast.

### Evidence check: light energy capture

**Candidate claim:** A case report presents this as acceptable science: “chlorophyll absorbs green light most strongly.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: chlorophyll absorbs light most strongly in the blue and red regions and reflects green, which is why plants appear green. |
| E2 | established science reference | Science brief: pigments absorb particular wavelengths of light and transfer that energy into the photosynthetic process. |
| E3 | established science reference | Science brief: light absorbed is used; light reflected or transmitted is not, which is why leaf colour indicates which wavelengths are least used. |
| E4 | established science reference | Science brief: the light-dependent reactions occur in the thylakoid membranes of the chloroplast. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs9-biology-u05::light energy capture, derived from the reviewed correctness source policy/correctness/ma-hs9-biology.correctness.json.

**Supplied unit connections:** light energy capture; photosynthesis as matter and energy transformation; cellular respiration; aerobic and anaerobic pathways; conservation of matter in metabolism; energy accounting in organisms

**Supplied unit performance task:** Construct and revise an evidence-based explanation of how matter and energy move through photosynthesis and respiration, using your own data plus a published dataset.

### Bound task

**Question:** What does evidence E1 through E4 justify about light energy capture, and does it support the candidate claim?
...
**Model/source rule:** At relative CO₂ 1.0, rate = 20L/(100+L). The final row applies a 0.60 CO₂ limitation factor.
...
3. Graph rate against light, calculate the gain from each light increase, and use the last two rows to distinguish light limitation from carbon-dioxide limitation.
...
**Pinned H4 alternative statement (lineage evidence):** Run the yeast-and-sugar respiration comparison with a loosely fitted balloon and no lamp at all, or analyse a published photosynthesis-rate dataset against light intensity. Both meet the matter-and-energy target with kitchen materials or paper only.
...
**My question.** Write the question you are testing about light energy capture. It has to be a question your evidence could actually answer.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about light energy capture, then name one check that would catch an error or a weak claim.**
...
**Q1.** Complete the route you chose. For the document/model route, use its printed procedure and input table; for the H4 physical route, use the printed safe order and your own blank record. Report the route, evidence IDs or model rows, conclusion about light energy capture, uncertainty, and limitation.

>

**Q2.** Explain light energy capture in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for light energy capture. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about light energy capture, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using light energy capture as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E4 is strongest for evaluating the candidate claim about light energy capture? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E4, state one conclusion about light energy capture that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about light energy capture. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about light energy capture.
...
- Apply light energy capture under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect light energy capture to photosynthesis as matter and energy transformation from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Construct and revise an evidence-based explanation of how matter and energy move through photosynthesis and respiration, using your own data plus a published dataset. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-hs9-biology-u05-l07` · lesson `ma-hs9-biology-u05-l07` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
