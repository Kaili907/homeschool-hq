# Unit assessment: protein folding and function

**High School Biology (Grade 9)** · Unit 2: DNA, Proteins, and the Information Flow of the Cell · Day 11 of the unit (course day 23) · about 55–75 minutes

**Today's focus:** protein folding and function
...
- Demonstrate independent mastery evidence for protein folding and function on a fresh task.
- Explain protein folding and function using evidence, a model, or a documented process rather than an unsupported answer.
- Apply protein folding and function to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on protein folding and function against the stated success criteria and name the next step.
...
- Science brief: a protein's amino acid sequence, together with its cellular environment, determines the three-dimensional structure it folds into, and that structure determines its function.
- Science brief: the order of amino acids determines how the chain folds, because the side chains interact with each other and with water.
- Science brief: a protein that loses its folded shape loses its function, which is what denaturation by heat or extreme pH does.
- Science brief: because structure follows from sequence, a change in the sequence can change or abolish the function.

### Evidence check: protein folding and function

**Candidate claim:** A case report presents this as acceptable science: “a protein's function is determined by its amino acid composition regardless of order.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a protein's amino acid sequence, together with its cellular environment, determines the three-dimensional structure it folds into, and that structure determines its function. |
| E2 | established science reference | Science brief: the order of amino acids determines how the chain folds, because the side chains interact with each other and with water. |
| E3 | established science reference | Science brief: a protein that loses its folded shape loses its function, which is what denaturation by heat or extreme pH does. |
| E4 | established science reference | Science brief: because structure follows from sequence, a change in the sequence can change or abolish the function. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs9-biology-u02::protein folding and function, derived from the reviewed correctness source policy/correctness/ma-hs9-biology.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about protein folding and function, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about protein folding and function, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about protein folding and function, then name one check that would catch an error or a weak claim.**
...
**Q1.** Without copying a sentence from the brief, evaluate the printed candidate case about protein folding and function. Cite E1-E4, write the reasoning in your own words, and correct the case claim so it fits exactly what the record establishes.

>

**Q2.** Explain protein folding and function in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for protein folding and function. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about protein folding and function, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using protein folding and function as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E4 is strongest for evaluating the candidate claim about protein folding and function? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E4, state one conclusion about protein folding and function that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about protein folding and function. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about protein folding and function.
...
- Apply protein folding and function under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect protein folding and function to DNA structure and base pairing from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs9-biology-u02-l11` · lesson `ma-hs9-biology-u02-l11` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
