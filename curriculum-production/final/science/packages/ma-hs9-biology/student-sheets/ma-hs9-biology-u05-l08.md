# Reteach and varied practice: photosynthesis as matter and energy transformation

**High School Biology (Grade 9)** · Unit 5: Photosynthesis, Cellular Respiration, and Energy in Living Systems · Day 8 of the unit (course day 56) · about 55–75 minutes

**Today's focus:** photosynthesis as matter and energy transformation
...
- Explain photosynthesis as matter and energy transformation using evidence, a model, or a documented process rather than an unsupported answer.
- Apply photosynthesis as matter and energy transformation to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on photosynthesis as matter and energy transformation against the stated success criteria and name the next step.
...
- Science brief: photosynthesis uses carbon dioxide and water, with light energy, to produce glucose and oxygen.
- Science brief: the oxygen released by photosynthesis comes from water, not from carbon dioxide.
- Science brief: photosynthesis converts light energy into chemical energy stored in the bonds of sugar.
- Science brief: the carbon in the sugar comes from atmospheric carbon dioxide, which is the origin of most of a plant's mass.

### Evidence check: photosynthesis as matter and energy transformation

**Candidate claim:** A case report presents this as acceptable science: “the oxygen released comes from carbon dioxide.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: photosynthesis uses carbon dioxide and water, with light energy, to produce glucose and oxygen. |
| E2 | established science reference | Science brief: the oxygen released by photosynthesis comes from water, not from carbon dioxide. |
| E3 | established science reference | Science brief: photosynthesis converts light energy into chemical energy stored in the bonds of sugar. |
| E4 | established science reference | Science brief: the carbon in the sugar comes from atmospheric carbon dioxide, which is the origin of most of a plant's mass. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs9-biology-u05::photosynthesis as matter and energy transformation, derived from the reviewed correctness source policy/correctness/ma-hs9-biology.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about photosynthesis as matter and energy transformation, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about photosynthesis as matter and energy transformation, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about photosynthesis as matter and energy transformation, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain photosynthesis as matter and energy transformation in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for photosynthesis as matter and energy transformation. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about photosynthesis as matter and energy transformation, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using photosynthesis as matter and energy transformation as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about photosynthesis as matter and energy transformation? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about photosynthesis as matter and energy transformation that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about photosynthesis as matter and energy transformation. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about photosynthesis as matter and energy transformation.
...
- Apply photosynthesis as matter and energy transformation under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect photosynthesis as matter and energy transformation to light energy capture from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs9-biology-u05-l08` · lesson `ma-hs9-biology-u05-l08` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
