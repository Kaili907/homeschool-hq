# Reteach and varied practice: organelles as interacting subsystems

**High School Biology (Grade 9)** · Unit 3: Cells, Hierarchical Organization, and Cellular Division · Day 8 of the unit (course day 32) · about 55–75 minutes

**Today's focus:** organelles as interacting subsystems
...
- Apply organelles as interacting subsystems to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on organelles as interacting subsystems against the stated success criteria and name the next step.
...
- Science brief: the nucleus holds the genetic material, ribosomes assemble proteins, mitochondria carry out most ATP production, and chloroplasts carry out photosynthesis in plant cells.
- Science brief: organelles are specialised compartments whose functions depend on one another, so the cell operates as an integrated system.
- Science brief: membranes create separate chemical environments, which is what allows incompatible processes to run in the same cell at once.
- Science brief: a product of one organelle is frequently the input of another, so disrupting one disrupts others.

### Evidence check: organelles as interacting subsystems

**Candidate claim:** A case report presents this as acceptable science: “plant cells have chloroplasts instead of mitochondria; plant cells have both.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: the nucleus holds the genetic material, ribosomes assemble proteins, mitochondria carry out most ATP production, and chloroplasts carry out photosynthesis in plant cells. |
| E2 | established science reference | Science brief: organelles are specialised compartments whose functions depend on one another, so the cell operates as an integrated system. |
| E3 | established science reference | Science brief: membranes create separate chemical environments, which is what allows incompatible processes to run in the same cell at once. |
| E4 | established science reference | Science brief: a product of one organelle is frequently the input of another, so disrupting one disrupts others. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs9-biology-u03::organelles as interacting subsystems, derived from the reviewed correctness source policy/correctness/ma-hs9-biology.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about organelles as interacting subsystems, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about organelles as interacting subsystems, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about organelles as interacting subsystems, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain organelles as interacting subsystems in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for organelles as interacting subsystems. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about organelles as interacting subsystems, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using organelles as interacting subsystems as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about organelles as interacting subsystems? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about organelles as interacting subsystems that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about organelles as interacting subsystems. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about organelles as interacting subsystems.
...
- Apply organelles as interacting subsystems under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect organelles as interacting subsystems to cell theory and cell types from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs9-biology-u03-l08` · lesson `ma-hs9-biology-u03-l08` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
