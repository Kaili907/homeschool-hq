# Performance task build: sources of genetic variation

**High School Biology (Grade 9)** · Unit 8: Inheritance and Variation of Traits · Day 9 of the unit (course day 93) · about 61–84 minutes

**Today's focus:** sources of genetic variation
...
- Produce performance-task evidence for sources of genetic variation that a reader could check independently.
- Explain sources of genetic variation using evidence, a model, or a documented process rather than an unsupported answer.
- Apply sources of genetic variation to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on sources of genetic variation against the stated success criteria and name the next step.

**Materials:**

- dried beans, seeds, or leaves from one plant species (30+ specimens)
- ruler
- graph paper
- coins or dice for probability modelling
- gloves
- notebook
...
- **Physical hazard.** Collecting leaves without identifying the plant risks irritant sap, poison ivy, oak or sumac, and pesticide residue.
  - What stops it: Collect only from a plant an adult has identified as safe. Never from a plant with milky sap, never poison ivy, oak, or sumac, and never from a plant or verge that has been treated with pesticide. Wear gloves and wash hands afterwards.
- **Physical hazard.** Small counters and dried beans are a choking hazard around young children and are no longer food.
  - What stops it: Keep counters away from younger siblings, count them back into a labelled container, and never return them to food storage or eat them.
- **Privacy hazard.** Family trait or pedigree work can expose genetic and health information about relatives who never consented.
  - What stops it: This unit uses NON-HUMAN specimens and fictional pedigrees only. The learner is never asked to record family traits, family medical history, ancestry, or any relative's data.
- **Emotional hazard.** Heredity topics can touch on disability, adoption, or family history painfully.
  - What stops it: All examples are fictional or non-human; the learner may decline any example without penalty and no personal disclosure is ever requested.
...
**Clearing up.** Return leaves and seeds to the garden or compost, put beans back in their labelled container out of reach of young children, and wash hands. Beans used as counters are never eaten. No specimen and no family information is stored.
...
- Science brief: the sources of heritable variation are mutation, recombination during meiosis, independent assortment, and the random combination of gametes at fertilisation.
- Science brief: mutation is the ultimate source of new alleles; the other mechanisms rearrange existing alleles into new combinations.
- Science brief: sexual reproduction generates far more genetic variety among offspring than asexual reproduction does.
- Science brief: variation is present in a population before selection acts on it.

### Evidence check: sources of genetic variation

**Candidate claim:** A case report presents this as acceptable science: “recombination creates new alleles.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: the sources of heritable variation are mutation, recombination during meiosis, independent assortment, and the random combination of gametes at fertilisation. |
| E2 | established science reference | Science brief: mutation is the ultimate source of new alleles; the other mechanisms rearrange existing alleles into new combinations. |
| E3 | established science reference | Science brief: sexual reproduction generates far more genetic variety among offspring than asexual reproduction does. |
| E4 | established science reference | Science brief: variation is present in a population before selection acts on it. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs9-biology-u08::sources of genetic variation, derived from the reviewed correctness source policy/correctness/ma-hs9-biology.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about sources of genetic variation, and does it support the candidate claim?
...
**My question.** Write the question you are testing about sources of genetic variation. It has to be a question your evidence could actually answer.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about sources of genetic variation, then name one check that would catch an error or a weak claim.**
...
**Q1.** Build a checkable contribution to the supplied unit performance task — Make and defend an evidence-based claim about the source of a heritable variation, using statistics and probability, and state where a simple inheritance model stops working. — using the case and E1-E4. Include claim, evidence, reasoning, limitation, and a recorded revision.

>

**Q2.** Explain sources of genetic variation in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for sources of genetic variation. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about sources of genetic variation, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using sources of genetic variation as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E4 is strongest for evaluating the candidate claim about sources of genetic variation? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E4, state one conclusion about sources of genetic variation that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about sources of genetic variation. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about sources of genetic variation.
...
- Apply sources of genetic variation under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect sources of genetic variation to chromosomes and gene loci from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Make and defend an evidence-based claim about the source of a heritable variation, using statistics and probability, and state where a simple inheritance model stops working. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-hs9-biology-u08-l09` · lesson `ma-hs9-biology-u08-l09` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
