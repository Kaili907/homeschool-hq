# Unit assessment: environmental change and extinction

**High School Biology (Grade 9)** · Unit 9: Natural Selection, Evolution, and Biodiversity Engineering · Day 11 of the unit (course day 107) · about 55–75 minutes

**Today's focus:** environmental change and extinction
...
- Demonstrate independent mastery evidence for environmental change and extinction on a fresh task.
- Explain environmental change and extinction using evidence, a model, or a documented process rather than an unsupported answer.
- Apply environmental change and extinction to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on environmental change and extinction against the stated success criteria and name the next step.
...
- Science brief: when the environment changes, populations may shift in trait frequency, migrate, or become extinct, and which occurs depends on existing variation and the rate of change.
- Science brief: rapid change is more likely to cause extinction than gradual change, because there is less opportunity for trait frequencies to shift.
- Science brief: extinction is the normal fate of most species over geological time, and the fossil record documents this.

### Evidence check: environmental change and extinction

**Candidate claim:** A case report presents this as acceptable science: “a population will always evolve in time to survive an environmental change.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: when the environment changes, populations may shift in trait frequency, migrate, or become extinct, and which occurs depends on existing variation and the rate of change. |
| E2 | established science reference | Science brief: rapid change is more likely to cause extinction than gradual change, because there is less opportunity for trait frequencies to shift. |
| E3 | established science reference | Science brief: extinction is the normal fate of most species over geological time, and the fossil record documents this. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs9-biology-u09::environmental change and extinction, derived from the reviewed correctness source policy/correctness/ma-hs9-biology.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about environmental change and extinction, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about environmental change and extinction, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about environmental change and extinction, then name one check that would catch an error or a weak claim.**
...
**Q1.** Without copying a sentence from the brief, evaluate the printed candidate case about environmental change and extinction. Cite E1-E3, write the reasoning in your own words, and correct the case claim so it fits exactly what the record establishes.

>

**Q2.** Explain environmental change and extinction in your own words using at least two specifically named rows from E1-E3. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for environmental change and extinction. Decide whether E1-E3 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about environmental change and extinction, revise its weakest claim with a named row from E1-E3, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using environmental change and extinction as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E3 is strongest for evaluating the candidate claim about environmental change and extinction? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E3, state one conclusion about environmental change and extinction that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about environmental change and extinction. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about environmental change and extinction.
...
- Apply environmental change and extinction under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect environmental change and extinction to multiple lines of evidence for common ancestry from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs9-biology-u09-l11` · lesson `ma-hs9-biology-u09-l11` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
