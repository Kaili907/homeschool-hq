# Performance task build: cellular respiration

**High School Biology (Grade 9)** · Unit 5: Photosynthesis, Cellular Respiration, and Energy in Living Systems · Day 9 of the unit (course day 57) · about 61–84 minutes

**Today's focus:** cellular respiration
...
- Produce performance-task evidence for cellular respiration that a reader could check independently.
- Explain cellular respiration using evidence, a model, or a documented process rather than an unsupported answer.
- Apply cellular respiration to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on cellular respiration against the stated success criteria and name the next step.
...
- Science brief: aerobic cellular respiration uses glucose and oxygen and produces carbon dioxide, water, and ATP.
- Science brief: cellular respiration occurs in all living cells, including plant cells.
- Science brief: cellular respiration releases energy stored in glucose and captures it in ATP, the cell's usable energy currency.
- Science brief: glycolysis occurs in the cytoplasm; the remaining aerobic stages occur in the mitochondria.

### Evidence check: cellular respiration

**Candidate claim:** A case report presents this as acceptable science: “plants carry out photosynthesis instead of respiration.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: aerobic cellular respiration uses glucose and oxygen and produces carbon dioxide, water, and ATP. |
| E2 | established science reference | Science brief: cellular respiration occurs in all living cells, including plant cells. |
| E3 | established science reference | Science brief: cellular respiration releases energy stored in glucose and captures it in ATP, the cell's usable energy currency. |
| E4 | established science reference | Science brief: glycolysis occurs in the cytoplasm; the remaining aerobic stages occur in the mitochondria. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs9-biology-u05::cellular respiration, derived from the reviewed correctness source policy/correctness/ma-hs9-biology.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about cellular respiration, and does it support the candidate claim?
...
**My question.** Write the question you are testing about cellular respiration. It has to be a question your evidence could actually answer.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about cellular respiration, then name one check that would catch an error or a weak claim.**
...
**Q1.** Build a checkable contribution to the supplied unit performance task — Construct and revise an evidence-based explanation of how matter and energy move through photosynthesis and respiration, using your own data plus a published dataset. — using the case and E1-E4. Include claim, evidence, reasoning, limitation, and a recorded revision.

>

**Q2.** Explain cellular respiration in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for cellular respiration. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about cellular respiration, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using cellular respiration as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E4 is strongest for evaluating the candidate claim about cellular respiration? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E4, state one conclusion about cellular respiration that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about cellular respiration. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- Apply cellular respiration under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect cellular respiration to light energy capture from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs9-biology-u05-l09` · lesson `ma-hs9-biology-u05-l09` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
