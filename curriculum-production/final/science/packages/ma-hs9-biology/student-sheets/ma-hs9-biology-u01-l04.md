# Independent application A: structure-function relationships

**High School Biology (Grade 9)** · Unit 1: Scientific Practice, Measurement, and the Molecules of Life · Day 4 of the unit (course day 4) · about 55–75 minutes

**Today's focus:** structure-function relationships
...
- Explain structure-function relationships using evidence, a model, or a documented process rather than an unsupported answer.
- Apply structure-function relationships to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on structure-function relationships against the stated success criteria and name the next step.
...
- Science brief: the three-dimensional shape and chemical properties of a biological molecule determine what it can interact with and therefore what it does.
- Science brief: changing the structure changes the function, which is why a small change in shape can abolish activity entirely.
- Science brief: the relationship runs from structure to function; a molecule does not acquire a structure because a function is needed.

### Evidence check: structure-function relationships

**Candidate claim:** A case report presents this as acceptable science: “a molecule changes its structure in order to perform a function it is required to perform.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: the three-dimensional shape and chemical properties of a biological molecule determine what it can interact with and therefore what it does. |
| E2 | established science reference | Science brief: changing the structure changes the function, which is why a small change in shape can abolish activity entirely. |
| E3 | established science reference | Science brief: the relationship runs from structure to function; a molecule does not acquire a structure because a function is needed. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs9-biology-u01::structure-function relationships, derived from the reviewed correctness source policy/correctness/ma-hs9-biology.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about structure-function relationships, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about structure-function relationships, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about structure-function relationships, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain structure-function relationships in your own words using at least two specifically named rows from E1-E3. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for structure-function relationships. Decide whether E1-E3 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about structure-function relationships, revise its weakest claim with a named row from E1-E3, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using structure-function relationships as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about structure-function relationships? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about structure-function relationships that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about structure-function relationships. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about structure-function relationships.
...
- Apply structure-function relationships under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect structure-function relationships to biological scale and measurement from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs9-biology-u01-l04` · lesson `ma-hs9-biology-u01-l04` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
