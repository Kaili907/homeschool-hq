# Reteach and varied practice: food webs and matter flow

**High School Biology (Grade 9)** · Unit 6: Ecosystems: Matter Cycling and Energy Flow · Day 8 of the unit (course day 68) · about 55–75 minutes

**Today's focus:** food webs and matter flow
...
- Explain food webs and matter flow using evidence, a model, or a documented process rather than an unsupported answer.
- Apply food webs and matter flow to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on food webs and matter flow against the stated success criteria and name the next step.
...
- Science brief: food web arrows point from the organism consumed to the consumer, showing the direction matter and energy move.
- Science brief: matter cycles within the ecosystem; the atoms in a consumer were previously in its food and will later be elsewhere.
- Science brief: because organisms occupy multiple positions in a web, effects of a change propagate beyond the direct link.

### Evidence check: food webs and matter flow

**Candidate claim:** A case report presents this as acceptable science: “drawing food-web arrows from consumer to consumed.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: food web arrows point from the organism consumed to the consumer, showing the direction matter and energy move. |
| E2 | established science reference | Science brief: matter cycles within the ecosystem; the atoms in a consumer were previously in its food and will later be elsewhere. |
| E3 | established science reference | Science brief: because organisms occupy multiple positions in a web, effects of a change propagate beyond the direct link. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs9-biology-u06::food webs and matter flow, derived from the reviewed correctness source policy/correctness/ma-hs9-biology.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about food webs and matter flow, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about food webs and matter flow, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about food webs and matter flow, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain food webs and matter flow in your own words using at least two specifically named rows from E1-E3. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for food webs and matter flow. Decide whether E1-E3 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about food webs and matter flow, revise its weakest claim with a named row from E1-E3, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using food webs and matter flow as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about food webs and matter flow? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about food webs and matter flow that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about food webs and matter flow. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about food webs and matter flow.
...
- Apply food webs and matter flow under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect food webs and matter flow to trophic levels and energy transfer from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs9-biology-u06-l08` · lesson `ma-hs9-biology-u06-l08` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
