# Unit assessment: decomposition

**High School Biology (Grade 9)** · Unit 6: Ecosystems: Matter Cycling and Energy Flow · Day 11 of the unit (course day 71) · about 55–75 minutes

**Today's focus:** decomposition
...
- Demonstrate independent mastery evidence for decomposition on a fresh task.
- Explain decomposition using evidence, a model, or a documented process rather than an unsupported answer.
- Apply decomposition to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on decomposition against the stated success criteria and name the next step.
...
- Science brief: decomposers break down dead organisms and waste, returning elements to soil, water, and air in forms producers can use.
- Science brief: decomposition rate depends on temperature, moisture, oxygen availability, and the material itself.
- Science brief: without decomposition, matter would remain locked in dead material and nutrient cycling would halt.

### Evidence check: decomposition

**Candidate claim:** A case report presents this as acceptable science: “dead material disappears without any organism acting on it.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: decomposers break down dead organisms and waste, returning elements to soil, water, and air in forms producers can use. |
| E2 | established science reference | Science brief: decomposition rate depends on temperature, moisture, oxygen availability, and the material itself. |
| E3 | established science reference | Science brief: without decomposition, matter would remain locked in dead material and nutrient cycling would halt. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs9-biology-u06::decomposition, derived from the reviewed correctness source policy/correctness/ma-hs9-biology.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about decomposition, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about decomposition, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about decomposition, then name one check that would catch an error or a weak claim.**
...
**Q1.** Without copying a sentence from the brief, evaluate the printed candidate case about decomposition. Cite E1-E3, write the reasoning in your own words, and correct the case claim so it fits exactly what the record establishes.

>

**Q2.** Explain decomposition in your own words using at least two specifically named rows from E1-E3. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for decomposition. Decide whether E1-E3 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about decomposition, revise its weakest claim with a named row from E1-E3, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using decomposition as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E3 is strongest for evaluating the candidate claim about decomposition? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E3, state one conclusion about decomposition that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about decomposition. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about decomposition.
...
- Apply decomposition under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect decomposition to trophic levels and energy transfer from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs9-biology-u06-l11` · lesson `ma-hs9-biology-u06-l11` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
