# Performance task build: transcription

**High School Biology (Grade 9)** · Unit 2: DNA, Proteins, and the Information Flow of the Cell · Day 9 of the unit (course day 21) · about 61–84 minutes

**Today's focus:** transcription
...
- Produce performance-task evidence for transcription that a reader could check independently.
- Explain transcription using evidence, a model, or a documented process rather than an unsupported answer.
- Apply transcription to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on transcription against the stated success criteria and name the next step.
...
- Science brief: transcription copies a DNA sequence into RNA; RNA contains uracil in place of thymine and ribose in place of deoxyribose.
- Science brief: in eukaryotes transcription occurs in the nucleus and translation occurs at ribosomes in the cytoplasm.
- Science brief: transcription produces a single-stranded RNA copy complementary to one DNA strand.
- Science brief: only part of the genome is transcribed in any given cell at any given time, which is why cells with identical DNA differ.

### Evidence check: transcription

**Candidate claim:** A case report presents this as acceptable science: “rNA contains thymine.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: transcription copies a DNA sequence into RNA; RNA contains uracil in place of thymine and ribose in place of deoxyribose. |
| E2 | established science reference | Science brief: in eukaryotes transcription occurs in the nucleus and translation occurs at ribosomes in the cytoplasm. |
| E3 | established science reference | Science brief: transcription produces a single-stranded RNA copy complementary to one DNA strand. |
| E4 | established science reference | Science brief: only part of the genome is transcribed in any given cell at any given time, which is why cells with identical DNA differ. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs9-biology-u02::transcription, derived from the reviewed correctness source policy/correctness/ma-hs9-biology.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about transcription, and does it support the candidate claim?
...
**My question.** Write the question you are testing about transcription. It has to be a question your evidence could actually answer.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about transcription, then name one check that would catch an error or a weak claim.**
...
**Q1.** Build a checkable contribution to the supplied unit performance task — Build a physical or drawn model tracing one gene from DNA sequence to folded protein to observable function, and state precisely what your model cannot show. — using the case and E1-E4. Include claim, evidence, reasoning, limitation, and a recorded revision.

>

**Q2.** Explain transcription in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for transcription. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about transcription, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using transcription as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E4 is strongest for evaluating the candidate claim about transcription? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E4, state one conclusion about transcription that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about transcription. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about transcription.
...
- Apply transcription under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect transcription to DNA structure and base pairing from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs9-biology-u02-l09` · lesson `ma-hs9-biology-u02-l09` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
