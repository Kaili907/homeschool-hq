# Guided practice A: interspecific interactions

**High School Biology (Grade 9)** · Unit 7: Population Dynamics, Carrying Capacity, and Biodiversity · Day 3 of the unit (course day 75) · about 55–75 minutes
...
- Science brief: in mutualism both species benefit; in commensalism one benefits and the other is essentially unaffected; in parasitism and predation one benefits at the other's expense; in competition both are harmed.
- Science brief: interactions are classified by the effect on each participant, not by intent or by how the relationship appears.
- Science brief: interspecific competition occurs where species use the same limiting resource, and it can shift the resources each species uses.
- Science brief: predator and prey populations influence one another, typically with a delay between the change in one and the response of the other.

### Evidence check: interspecific interactions

**Candidate claim:** A case report presents this as acceptable science: “classifying a relationship as mutualism when only one participant benefits.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: in mutualism both species benefit; in commensalism one benefits and the other is essentially unaffected; in parasitism and predation one benefits at the other's expense; in competition both are harmed. |
| E2 | established science reference | Science brief: interactions are classified by the effect on each participant, not by intent or by how the relationship appears. |
| E3 | established science reference | Science brief: interspecific competition occurs where species use the same limiting resource, and it can shift the resources each species uses. |
| E4 | established science reference | Science brief: predator and prey populations influence one another, typically with a delay between the change in one and the response of the other. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs9-biology-u07::interspecific interactions, derived from the reviewed correctness source policy/correctness/ma-hs9-biology.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about interspecific interactions, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about interspecific interactions, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**Q1.** Explain interspecific interactions in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for interspecific interactions. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about interspecific interactions, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using interspecific interactions as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about interspecific interactions? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about interspecific interactions that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about interspecific interactions. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
_Package `swp-ma-hs9-biology-u07-l03` · lesson `ma-hs9-biology-u07-l03` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
