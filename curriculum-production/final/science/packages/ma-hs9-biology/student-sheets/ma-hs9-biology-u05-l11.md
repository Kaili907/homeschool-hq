# Unit assessment: conservation of matter in metabolism

**High School Biology (Grade 9)** · Unit 5: Photosynthesis, Cellular Respiration, and Energy in Living Systems · Day 11 of the unit (course day 59) · about 55–75 minutes

**Today's focus:** conservation of matter in metabolism
...
- Demonstrate independent mastery evidence for conservation of matter in metabolism on a fresh task.
- Explain conservation of matter in metabolism using evidence, a model, or a documented process rather than an unsupported answer.
- Apply conservation of matter in metabolism to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on conservation of matter in metabolism against the stated success criteria and name the next step.
...
- Science brief: atoms are conserved through every metabolic process; they are rearranged, never created or destroyed.
- Science brief: the atoms in an organism's body came from the food, water, and gases it took in.
- Science brief: tracing an element through metabolism means following where its atoms go, and every atom is accounted for.
- Science brief: mass lost by an organism leaves as matter, principally as exhaled carbon dioxide and as water, not as energy.

### Evidence check: conservation of matter in metabolism

**Candidate claim:** A case report presents this as acceptable science: “atoms are consumed or destroyed during metabolism.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: atoms are conserved through every metabolic process; they are rearranged, never created or destroyed. |
| E2 | established science reference | Science brief: the atoms in an organism's body came from the food, water, and gases it took in. |
| E3 | established science reference | Science brief: tracing an element through metabolism means following where its atoms go, and every atom is accounted for. |
| E4 | established science reference | Science brief: mass lost by an organism leaves as matter, principally as exhaled carbon dioxide and as water, not as energy. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs9-biology-u05::conservation of matter in metabolism, derived from the reviewed correctness source policy/correctness/ma-hs9-biology.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about conservation of matter in metabolism, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about conservation of matter in metabolism, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about conservation of matter in metabolism, then name one check that would catch an error or a weak claim.**
...
**Q1.** Without copying a sentence from the brief, evaluate the printed candidate case about conservation of matter in metabolism. Cite E1-E4, write the reasoning in your own words, and correct the case claim so it fits exactly what the record establishes.

>

**Q2.** Explain conservation of matter in metabolism in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for conservation of matter in metabolism. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about conservation of matter in metabolism, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using conservation of matter in metabolism as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E4 is strongest for evaluating the candidate claim about conservation of matter in metabolism? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E4, state one conclusion about conservation of matter in metabolism that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about conservation of matter in metabolism. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about conservation of matter in metabolism.
...
- Apply conservation of matter in metabolism under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect conservation of matter in metabolism to light energy capture from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs9-biology-u05-l11` · lesson `ma-hs9-biology-u05-l11` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
