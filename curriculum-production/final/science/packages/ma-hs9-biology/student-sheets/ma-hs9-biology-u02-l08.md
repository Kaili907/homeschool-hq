# Reteach and varied practice: replication as information copying

**High School Biology (Grade 9)** · Unit 2: DNA, Proteins, and the Information Flow of the Cell · Day 8 of the unit (course day 20) · about 55–75 minutes

**Today's focus:** replication as information copying
...
- Explain replication as information copying using evidence, a model, or a documented process rather than an unsupported answer.
- Apply replication as information copying to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on replication as information copying against the stated success criteria and name the next step.
...
- Science brief: dNA replication is semiconservative: each new double helix contains one original strand and one newly made strand.
- Science brief: the double helix separates and each original strand acts as a template for a new complementary strand.
- Science brief: because replication is semiconservative, every daughter molecule retains one parental strand.
- Science brief: copying is highly accurate but not perfect, and uncorrected errors become mutations.

### Evidence check: replication as information copying

**Candidate claim:** A case report presents this as acceptable science: “replication is conservative, with the original helix intact and a wholly new one produced.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: dNA replication is semiconservative: each new double helix contains one original strand and one newly made strand. |
| E2 | established science reference | Science brief: the double helix separates and each original strand acts as a template for a new complementary strand. |
| E3 | established science reference | Science brief: because replication is semiconservative, every daughter molecule retains one parental strand. |
| E4 | established science reference | Science brief: copying is highly accurate but not perfect, and uncorrected errors become mutations. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs9-biology-u02::replication as information copying, derived from the reviewed correctness source policy/correctness/ma-hs9-biology.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about replication as information copying, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about replication as information copying, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about replication as information copying, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain replication as information copying in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for replication as information copying. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about replication as information copying, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using replication as information copying as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about replication as information copying? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about replication as information copying that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about replication as information copying. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about replication as information copying.
...
- Apply replication as information copying under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect replication as information copying to DNA structure and base pairing from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs9-biology-u02-l08` · lesson `ma-hs9-biology-u02-l08` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
