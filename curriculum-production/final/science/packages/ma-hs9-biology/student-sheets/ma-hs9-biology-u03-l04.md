# Independent application A: the cell cycle and mitosis

**High School Biology (Grade 9)** · Unit 3: Cells, Hierarchical Organization, and Cellular Division · Day 4 of the unit (course day 28) · about 55–75 minutes

**Today's focus:** the cell cycle and mitosis
...
- Explain the cell cycle and mitosis using evidence, a model, or a documented process rather than an unsupported answer.
- Apply the cell cycle and mitosis to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on the cell cycle and mitosis against the stated success criteria and name the next step.
...
- Science brief: mitosis produces two daughter cells genetically identical to the parent cell and to each other.
- Science brief: dNA is replicated during interphase, before mitosis begins.
- Science brief: the cell cycle consists of interphase, during which the cell grows and replicates its DNA, followed by division.
- Science brief: mitosis distributes one complete copy of the replicated chromosomes to each daughter cell, so chromosome number is maintained.

### Evidence check: the cell cycle and mitosis

**Candidate claim:** A case report presents this as acceptable science: “mitosis halves the chromosome number.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: mitosis produces two daughter cells genetically identical to the parent cell and to each other. |
| E2 | established science reference | Science brief: dNA is replicated during interphase, before mitosis begins. |
| E3 | established science reference | Science brief: the cell cycle consists of interphase, during which the cell grows and replicates its DNA, followed by division. |
| E4 | established science reference | Science brief: mitosis distributes one complete copy of the replicated chromosomes to each daughter cell, so chromosome number is maintained. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs9-biology-u03::the cell cycle and mitosis, derived from the reviewed correctness source policy/correctness/ma-hs9-biology.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about the cell cycle and mitosis, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about the cell cycle and mitosis, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about the cell cycle and mitosis, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain the cell cycle and mitosis in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for the cell cycle and mitosis. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about the cell cycle and mitosis, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using the cell cycle and mitosis as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about the cell cycle and mitosis? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about the cell cycle and mitosis that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about the cell cycle and mitosis. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about the cell cycle and mitosis.
...
- Apply the cell cycle and mitosis under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect the cell cycle and mitosis to cell theory and cell types from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs9-biology-u03-l04` · lesson `ma-hs9-biology-u03-l04` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
