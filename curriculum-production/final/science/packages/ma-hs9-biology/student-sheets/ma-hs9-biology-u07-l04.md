# Independent application A: biodiversity measurement

**High School Biology (Grade 9)** · Unit 7: Population Dynamics, Carrying Capacity, and Biodiversity · Day 4 of the unit (course day 76) · about 55–75 minutes

**Today's focus:** biodiversity measurement
...
- Explain biodiversity measurement using evidence, a model, or a documented process rather than an unsupported answer.
- Apply biodiversity measurement to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on biodiversity measurement against the stated success criteria and name the next step.
...
- Science brief: biodiversity measures include the number of species present and how evenly individuals are distributed among them.
- Science brief: a measurement depends on the area sampled, the effort spent, and the method used, so figures are comparable only when those match.
- Science brief: genetic diversity within species and diversity of ecosystems are also components of biodiversity.

### Evidence check: biodiversity measurement

**Candidate claim:** A case report presents this as acceptable science: “comparing biodiversity figures from different sampling areas or methods as though they were equivalent.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: biodiversity measures include the number of species present and how evenly individuals are distributed among them. |
| E2 | established science reference | Science brief: a measurement depends on the area sampled, the effort spent, and the method used, so figures are comparable only when those match. |
| E3 | established science reference | Science brief: genetic diversity within species and diversity of ecosystems are also components of biodiversity. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs9-biology-u07::biodiversity measurement, derived from the reviewed correctness source policy/correctness/ma-hs9-biology.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about biodiversity measurement, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about biodiversity measurement, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about biodiversity measurement, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain biodiversity measurement in your own words using at least two specifically named rows from E1-E3. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for biodiversity measurement. Decide whether E1-E3 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about biodiversity measurement, revise its weakest claim with a named row from E1-E3, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using biodiversity measurement as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about biodiversity measurement? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about biodiversity measurement that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about biodiversity measurement. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about biodiversity measurement.
...
- Apply biodiversity measurement under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect biodiversity measurement to exponential and logistic growth from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs9-biology-u07-l04` · lesson `ma-hs9-biology-u07-l04` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
