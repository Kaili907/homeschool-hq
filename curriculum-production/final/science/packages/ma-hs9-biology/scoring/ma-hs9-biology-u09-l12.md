# Scoring authority — Correction and reflection: engineering solutions for biodiversity

**High School Biology (Grade 9)** · Unit 9: Natural Selection, Evolution, and Biodiversity Engineering · Day 12 · lesson `ma-hs9-biology-u09-l12`
...
_Topic `ma-hs9-biology-u09::engineering solutions for biodiversity` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs9-biology.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Interventions to protect biodiversity are evaluated against stated criteria and against evidence of effect, not against intent.
- Because ecosystems are connected, an intervention has effects beyond its target, sometimes delayed or distant.
- Monitoring after the intervention is what converts an expected effect into an observed one.
...
- Claiming an intervention affects only its intended target.
- Declaring an intervention successful without post-intervention monitoring.
- Presenting a conservation option as having benefits with no costs or trade-offs.

**Grade boundary.** Conservation policy, environmental impact assessment procedure, and economic valuation are beyond this course.
...
**Q1 — explain with evidence.** _Serves objective 1:_ Explain engineering solutions for biodiversity using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q2 — apply new task.** _Serves objective 2:_ Apply engineering solutions for biodiversity to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q3 — check revise next step.** _Serves objective 3:_ Check and revise the work on engineering solutions for biodiversity against the stated success criteria and name the next step.
...
**Q4 — essential question.** _Serves objective 2:_ Apply engineering solutions for biodiversity to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q5 — evidence quality.** _Serves objective 1:_ Explain engineering solutions for biodiversity using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q6 — limitation.** _Serves objective 2:_ Apply engineering solutions for biodiversity to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q7 — provenance.** _Serves objective 1:_ Explain engineering solutions for biodiversity using evidence, a model, or a documented process rather than an unsupported answer.
...
- **prerequisite-gap** — Run the prerequisite reteach route for engineering solutions for biodiversity (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for engineering solutions for biodiversity (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for engineering solutions for biodiversity (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for engineering solutions for biodiversity (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for engineering solutions for biodiversity (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs9-biology-u09-l12` · built from `hs912-science-h4` at `a86780a`._
