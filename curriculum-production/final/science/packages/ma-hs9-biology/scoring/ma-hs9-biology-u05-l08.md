# Scoring authority — Reteach and varied practice: photosynthesis as matter and energy transformation

**High School Biology (Grade 9)** · Unit 5: Photosynthesis, Cellular Respiration, and Energy in Living Systems · Day 8 · lesson `ma-hs9-biology-u05-l08`
...
_Topic `ma-hs9-biology-u05::photosynthesis as matter and energy transformation` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs9-biology.correctness.json`._
...
- The oxygen released by photosynthesis comes from water, not from carbon dioxide.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Photosynthesis converts light energy into chemical energy stored in the bonds of sugar.
- The carbon in the sugar comes from atmospheric carbon dioxide, which is the origin of most of a plant's mass.
- Photosynthesis is both an energy transformation and a matter transformation, and a complete account addresses both.

**Also correct.** Accept any of these framings — do not require the wording above:

- Writing the overall equation in words or in symbols, and naming the light-dependent reactions and the Calvin cycle, are all acceptable.
...
- Claiming the oxygen released comes from carbon dioxide.
- Claiming a plant's mass comes principally from the soil.
- Claiming photosynthesis creates energy rather than converting it.

**Grade boundary.** Calvin cycle intermediates, RuBisCO kinetics, and photorespiration are beyond this course.
...
**Q1 — explain with evidence.** _Serves objective 1:_ Explain photosynthesis as matter and energy transformation using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q2 — apply new task.** _Serves objective 2:_ Apply photosynthesis as matter and energy transformation to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q3 — check revise next step.** _Serves objective 3:_ Check and revise the work on photosynthesis as matter and energy transformation against the stated success criteria and name the next step.
...
**Q4 — essential question.** _Serves objective 2:_ Apply photosynthesis as matter and energy transformation to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q5 — evidence quality.** _Serves objective 1:_ Explain photosynthesis as matter and energy transformation using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q6 — limitation.** _Serves objective 2:_ Apply photosynthesis as matter and energy transformation to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q7 — provenance.** _Serves objective 1:_ Explain photosynthesis as matter and energy transformation using evidence, a model, or a documented process rather than an unsupported answer.
...
- **prerequisite-gap** — Run the prerequisite reteach route for photosynthesis as matter and energy transformation (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for photosynthesis as matter and energy transformation (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for photosynthesis as matter and energy transformation (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for photosynthesis as matter and energy transformation (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for photosynthesis as matter and energy transformation (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs9-biology-u05-l08` · built from `hs912-science-h4` at `a86780a`._
