# Scoring authority — Unit assessment: differentiation and stem cells

**High School Biology (Grade 9)** · Unit 3: Cells, Hierarchical Organization, and Cellular Division · Day 11 · lesson `ma-hs9-biology-u03-l11`
...
_Topic `ma-hs9-biology-u03::differentiation and stem cells` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs9-biology.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Differentiated cells in one organism generally contain the same genome; they differ in which genes are expressed.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Differentiation is the process by which cells become specialised, and it results from differences in gene expression rather than differences in the genes present.
- Stem cells retain the capacity to divide and to give rise to specialised cell types.
- Because the genome is retained, differentiation is about regulation, not about loss of genetic information.
...
- Claiming differentiated cells have lost the genes they do not use.
- Claiming every cell in the body expresses the same genes.
- Claiming differentiation is driven by the cell choosing what the organism needs.

**Grade boundary.** Reprogramming methods, epigenetic mechanisms in detail, and stem-cell therapeutics are beyond this course.
...
**Q1 — mastery fresh task.** _Serves objective 1:_ Demonstrate independent mastery evidence for differentiation and stem cells on a fresh task.
...
**Q2 — explain with evidence.** _Serves objective 2:_ Explain differentiation and stem cells using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q3 — apply new task.** _Serves objective 3:_ Apply differentiation and stem cells to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q4 — check revise next step.** _Serves objective 4:_ Check and revise the work on differentiation and stem cells against the stated success criteria and name the next step.
...
**Q5 — essential question.** _Serves objective 3:_ Apply differentiation and stem cells to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q6 — evidence quality.** _Serves objective 2:_ Explain differentiation and stem cells using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q7 — limitation.** _Serves objective 3:_ Apply differentiation and stem cells to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q8 — provenance.** _Serves objective 1:_ Demonstrate independent mastery evidence for differentiation and stem cells on a fresh task.
...
- **prerequisite-gap** — Run the prerequisite reteach route for differentiation and stem cells (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for differentiation and stem cells (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for differentiation and stem cells (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for differentiation and stem cells (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for differentiation and stem cells (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs9-biology-u03-l11` · built from `hs912-science-h4` at `a86780a`._
