# Scoring authority — Launch and diagnostic: chromosomes and gene loci

**High School Biology (Grade 9)** · Unit 8: Inheritance and Variation of Traits · Day 1 · lesson `ma-hs9-biology-u08-l01`
...
_Topic `ma-hs9-biology-u08::chromosomes and gene loci` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-hs9-biology.correctness.json`._
...
**Q1 — phenomenon question.** _Serves objective 1:_ Observe the anchoring phenomenon, surface initial thinking about chromosomes and gene loci without penalty, and pose a testable question.
...
**Q7 — limitation.** _Serves objective 3:_ Apply chromosomes and gene loci to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q8 — provenance.** _Serves objective 1:_ Observe the anchoring phenomenon, surface initial thinking about chromosomes and gene loci without penalty, and pose a testable question.
...
_Package `swp-ma-hs9-biology-u08-l01` · built from `hs912-science-h4` at `a86780a`._
