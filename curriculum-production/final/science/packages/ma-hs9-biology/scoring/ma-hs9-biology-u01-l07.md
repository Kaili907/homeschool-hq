# Scoring authority — Investigation: biological scale and measurement

**High School Biology (Grade 9)** · Unit 1: Scientific Practice, Measurement, and the Molecules of Life · Day 7 · lesson `ma-hs9-biology-u01-l07`
...
_Topic `ma-hs9-biology-u01::biological scale and measurement` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-hs9-biology.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Typical bacterial cells are on the order of micrometres; typical eukaryotic cells are tens of micrometres; molecules such as proteins are on the order of nanometres.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Biological structures span many orders of magnitude, and the appropriate unit and instrument change with the scale being studied.
- The scale of a structure constrains what can be observed about it: light microscopy resolves cells and large organelles, not individual proteins.
- A measurement is meaningful only with its unit and the method that produced it.

**Also correct.** Accept any of these framings — do not require the wording above:

- Scientific notation, SI prefixes, and explicit unit conversions are all acceptable ways to express biological scale.
...
- Claiming individual protein molecules can be resolved with a light microscope.
- Reporting a biological measurement with no unit, or with a unit off by orders of magnitude for the structure named.
- Claiming a cell and an organelle are of comparable size.

**Grade boundary.** Electron microscopy theory, super-resolution methods, and instrument physics are beyond this course.
...
**Q1 — investigate.** _Serves objective 1:_ Plan and carry out a safe investigation of biological scale and measurement, or its stated alternative, and record the learner's own data with its uncertainty.
...
**Q2 — explain with evidence.** _Serves objective 2:_ Explain biological scale and measurement using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q3 — apply new task.** _Serves objective 3:_ Apply biological scale and measurement to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q4 — check revise next step.** _Serves objective 4:_ Check and revise the work on biological scale and measurement against the stated success criteria and name the next step.
...
**Q5 — essential question.** _Serves objective 3:_ Apply biological scale and measurement to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q6 — evidence quality.** _Serves objective 2:_ Explain biological scale and measurement using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q7 — limitation.** _Serves objective 1:_ Plan and carry out a safe investigation of biological scale and measurement, or its stated alternative, and record the learner's own data with its uncertainty.
...
**Q8 — provenance.** _Serves objective 1:_ Plan and carry out a safe investigation of biological scale and measurement, or its stated alternative, and record the learner's own data with its uncertainty.
...
- **prerequisite-gap** — Run the prerequisite reteach route for biological scale and measurement (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for biological scale and measurement (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for biological scale and measurement (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for biological scale and measurement (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for biological scale and measurement (evidence type: application, require explanation: True, review timing: same-day).
...
- chemical: 3% hydrogen peroxide irritates eyes and can bleach fabric and skin on contact. — mitigation: Use the household 3% strength only, keep it in its original bottle, wear eye protection, work over a washable surface, and rinse any splash with water for 15 minutes.
- chemical: Hydrogen peroxide and lemon juice must never be combined; together they make peracetic acid, which is corrosive and irritating to the airway. — mitigation: The lemon-juice route and the peroxide route run in separate labelled cups. They are never poured together, never poured into a shared waste cup, and never combined to see what happens.
- chemical: Catalase and peroxide foam vigorously and release oxygen. — mitigation: No lid, cap, film, or cover ever goes on a peroxide container. Use a wide open cup on a tray with plenty of headroom.
- physical: Slicing produce with a kitchen knife risks cuts. — mitigation: An adult does all cutting, or the learner uses pre-cut produce; no knife work is required by the lesson.
...
**Disposal and clearing up:** Pour the peroxide and the lemon-juice cups down the drain SEPARATELY, each with the cold tap running, and never into a shared waste cup. Wash the cups, compost or bin the produce, and wash hands. Nothing is ever capped or sealed, and nothing is kept or reused.
...
_Package `swp-ma-hs9-biology-u01-l07` · built from `hs912-science-h4` at `a86780a`._
