# Scoring authority — Reteach and varied practice: food webs and matter flow

**High School Biology (Grade 9)** · Unit 6: Ecosystems: Matter Cycling and Energy Flow · Day 8 · lesson `ma-hs9-biology-u06-l08`
...
_Topic `ma-hs9-biology-u06::food webs and matter flow` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs9-biology.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Food web arrows point from the organism consumed to the consumer, showing the direction matter and energy move.
- Matter cycles within the ecosystem; the atoms in a consumer were previously in its food and will later be elsewhere.
- Because organisms occupy multiple positions in a web, effects of a change propagate beyond the direct link.
...
- Drawing food-web arrows from consumer to consumed.
- Claiming matter is used up and lost from the ecosystem.
- Claiming removing a species affects only the species directly linked to it.

**Grade boundary.** Network analysis metrics and quantitative food-web modelling are beyond this course.
...
**Q1 — explain with evidence.** _Serves objective 1:_ Explain food webs and matter flow using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q2 — apply new task.** _Serves objective 2:_ Apply food webs and matter flow to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q3 — check revise next step.** _Serves objective 3:_ Check and revise the work on food webs and matter flow against the stated success criteria and name the next step.
...
**Q4 — essential question.** _Serves objective 2:_ Apply food webs and matter flow to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q5 — evidence quality.** _Serves objective 1:_ Explain food webs and matter flow using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q6 — limitation.** _Serves objective 2:_ Apply food webs and matter flow to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q7 — provenance.** _Serves objective 1:_ Explain food webs and matter flow using evidence, a model, or a documented process rather than an unsupported answer.
...
- **prerequisite-gap** — Run the prerequisite reteach route for food webs and matter flow (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for food webs and matter flow (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for food webs and matter flow (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for food webs and matter flow (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for food webs and matter flow (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs9-biology-u06-l08` · built from `hs912-science-h4` at `a86780a`._
