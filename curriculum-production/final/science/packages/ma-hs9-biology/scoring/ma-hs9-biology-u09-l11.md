# Scoring authority — Unit assessment: environmental change and extinction

**High School Biology (Grade 9)** · Unit 9: Natural Selection, Evolution, and Biodiversity Engineering · Day 11 · lesson `ma-hs9-biology-u09-l11`
...
_Topic `ma-hs9-biology-u09::environmental change and extinction` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs9-biology.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- When the environment changes, populations may shift in trait frequency, migrate, or become extinct, and which occurs depends on existing variation and the rate of change.
- Rapid change is more likely to cause extinction than gradual change, because there is less opportunity for trait frequencies to shift.
- Extinction is the normal fate of most species over geological time, and the fossil record documents this.
...
- Claiming a population will always evolve in time to survive an environmental change.
- Claiming extinction indicates a defect in the organisms rather than a mismatch with changed conditions.
- Claiming populations can evolve traits for which no variation exists.

**Grade boundary.** Extinction rate estimation and mass extinction mechanisms in detail are beyond this course.
...
**Q1 — mastery fresh task.** _Serves objective 1:_ Demonstrate independent mastery evidence for environmental change and extinction on a fresh task.
...
**Q2 — explain with evidence.** _Serves objective 2:_ Explain environmental change and extinction using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q3 — apply new task.** _Serves objective 3:_ Apply environmental change and extinction to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q4 — check revise next step.** _Serves objective 4:_ Check and revise the work on environmental change and extinction against the stated success criteria and name the next step.
...
**Q5 — essential question.** _Serves objective 3:_ Apply environmental change and extinction to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q6 — evidence quality.** _Serves objective 2:_ Explain environmental change and extinction using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q7 — limitation.** _Serves objective 3:_ Apply environmental change and extinction to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q8 — provenance.** _Serves objective 1:_ Demonstrate independent mastery evidence for environmental change and extinction on a fresh task.
...
- **prerequisite-gap** — Run the prerequisite reteach route for environmental change and extinction (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for environmental change and extinction (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for environmental change and extinction (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for environmental change and extinction (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for environmental change and extinction (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs9-biology-u09-l11` · built from `hs912-science-h4` at `a86780a`._
