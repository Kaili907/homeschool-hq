# Scoring authority — Investigation: DNA structure and base pairing

**High School Biology (Grade 9)** · Unit 2: DNA, Proteins, and the Information Flow of the Cell · Day 7 · lesson `ma-hs9-biology-u02-l07`
...
_Topic `ma-hs9-biology-u02::DNA structure and base pairing` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs9-biology.correctness.json`._
...
- DNA is a double helix of two antiparallel strands with a sugar-phosphate backbone on the outside and paired bases on the inside.

**Accepted relationships and models.** What this lesson's learning target asserts:

- DNA is composed of nucleotides, each a deoxyribose sugar, a phosphate group, and one of four nitrogenous bases.
- The two strands are held together by hydrogen bonds between complementary bases: adenine with thymine, guanine with cytosine.
- Because the pairing is complementary, each strand specifies the sequence of the other, which is what makes accurate copying possible.

**Also correct.** Accept any of these framings — do not require the wording above:

- Writing the pairing as A-T and G-C, or spelling out the base names, are equally correct.
...
- Pairing adenine with guanine, or cytosine with thymine.
- Claiming the bases form the backbone and the sugars and phosphates lie in the interior.
- Claiming the two strands run in the same direction.

**Grade boundary.** Base-stacking energetics, DNA topology, and chromatin structure in detail are beyond this course.
...
> Learner's own observation of the extracted material, plus a published codon table. No yield figure is fabricated.
...
**Q1 — investigate.** _Serves objective 1:_ Plan and carry out a safe investigation of DNA structure and base pairing, or its stated alternative, and record the learner's own data with its uncertainty.
...
**Q2 — explain with evidence.** _Serves objective 2:_ Explain DNA structure and base pairing using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q3 — apply new task.** _Serves objective 3:_ Apply DNA structure and base pairing to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q4 — check revise next step.** _Serves objective 4:_ Check and revise the work on DNA structure and base pairing against the stated success criteria and name the next step.
...
**Q5 — essential question.** _Serves objective 3:_ Apply DNA structure and base pairing to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q6 — evidence quality.** _Serves objective 2:_ Explain DNA structure and base pairing using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q7 — limitation.** _Serves objective 1:_ Plan and carry out a safe investigation of DNA structure and base pairing, or its stated alternative, and record the learner's own data with its uncertainty.
...
**Q8 — provenance.** _Serves objective 1:_ Plan and carry out a safe investigation of DNA structure and base pairing, or its stated alternative, and record the learner's own data with its uncertainty.
...
- **prerequisite-gap** — Run the prerequisite reteach route for DNA structure and base pairing (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for DNA structure and base pairing (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for DNA structure and base pairing (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for DNA structure and base pairing (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for DNA structure and base pairing (evidence type: application, require explanation: True, review timing: same-day).
...
- chemical: Isopropyl alcohol is flammable, its vapour is heavier than air and pools at bench level, and it is harmful if swallowed or splashed in eyes. — mitigation: An adult sweeps the room for every ignition source before the bottle is opened, pours no more than 60 mL, and returns the bottle to a closed cupboard at once. Eye protection on; nothing is tasted. See the safe order.
- physical: Glass containers can break and cut. — mitigation: Use plastic or unbreakable cups only.
...
**Disposal and clearing up:** Pour the alcohol-and-fruit mixture down the drain with the cold tap running for 30 seconds, then wash and dry the cup. Ventilate the room for ten minutes before any appliance, charger, or battery is used at that surface. Never seal the mixture in a bag, bottle, or any closed container.
...
_Package `swp-ma-hs9-biology-u02-l07` · built from `hs912-science-h4` at `a86780a`._
