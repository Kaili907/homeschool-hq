# Scoring authority — Guided practice A: interspecific interactions

**High School Biology (Grade 9)** · Unit 7: Population Dynamics, Carrying Capacity, and Biodiversity · Day 3 · lesson `ma-hs9-biology-u07-l03`
...
_Topic `ma-hs9-biology-u07::interspecific interactions` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs9-biology.correctness.json`._
...
**Q1 — explain with evidence.** _Serves objective 1:_ Explain interspecific interactions using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q2 — apply new task.** _Serves objective 2:_ Apply interspecific interactions to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q3 — check revise next step.** _Serves objective 3:_ Check and revise the work on interspecific interactions against the stated success criteria and name the next step.
...
**Q4 — essential question.** _Serves objective 2:_ Apply interspecific interactions to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q5 — evidence quality.** _Serves objective 1:_ Explain interspecific interactions using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q6 — limitation.** _Serves objective 2:_ Apply interspecific interactions to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q7 — provenance.** _Serves objective 1:_ Explain interspecific interactions using evidence, a model, or a documented process rather than an unsupported answer.
...
_Package `swp-ma-hs9-biology-u07-l03` · built from `hs912-science-h4` at `a86780a`._
