# Scoring authority — Correction and reflection: argument from evidence in biology

**High School Biology (Grade 9)** · Unit 1: Scientific Practice, Measurement, and the Molecules of Life · Day 12 · lesson `ma-hs9-biology-u01-l12`
...
_Topic `ma-hs9-biology-u01::argument from evidence in biology` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-hs9-biology.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A biological argument links a claim to evidence through explicit reasoning about mechanism or pattern.
- Biological systems are variable, so an argument states how much of the observed pattern the evidence actually establishes.
- The strongest alternative explanation is stated and addressed rather than omitted.
...
- Inferring a causal mechanism from a correlation with no further evidence.
- Generalising from a single organism or a single trial to a population.
- Omitting evidence or an alternative explanation that weakens the claim.

**Grade boundary.** Formal experimental design theory and meta-analysis are beyond this course.


## What a complete response contains, question by question

**Q1 — explain with evidence.** _Serves objective 1:_ Explain argument from evidence in biology using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q2 — apply new task.** _Serves objective 2:_ Apply argument from evidence in biology to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q3 — check revise next step.** _Serves objective 3:_ Check and revise the work on argument from evidence in biology against the stated success criteria and name the next step.
...
**Q4 — essential question.** _Serves objective 2:_ Apply argument from evidence in biology to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q5 — evidence quality.** _Serves objective 1:_ Explain argument from evidence in biology using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q6 — limitation.** _Serves objective 2:_ Apply argument from evidence in biology to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q7 — provenance.** _Serves objective 1:_ Explain argument from evidence in biology using evidence, a model, or a documented process rather than an unsupported answer.
...
- **prerequisite-gap** — Run the prerequisite reteach route for argument from evidence in biology (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for argument from evidence in biology (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for argument from evidence in biology (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for argument from evidence in biology (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for argument from evidence in biology (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs9-biology-u01-l12` · built from `hs912-science-h4` at `a86780a`._
