# Scoring authority — Unit assessment: conservation of matter in metabolism

**High School Biology (Grade 9)** · Unit 5: Photosynthesis, Cellular Respiration, and Energy in Living Systems · Day 11 · lesson `ma-hs9-biology-u05-l11`
...
_Topic `ma-hs9-biology-u05::conservation of matter in metabolism` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs9-biology.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Atoms are conserved through every metabolic process; they are rearranged, never created or destroyed.

**Accepted relationships and models.** What this lesson's learning target asserts:

- The atoms in an organism's body came from the food, water, and gases it took in.
- Tracing an element through metabolism means following where its atoms go, and every atom is accounted for.
- Mass lost by an organism leaves as matter, principally as exhaled carbon dioxide and as water, not as energy.
...
- Claiming atoms are consumed or destroyed during metabolism.
- Claiming body mass lost is converted into energy and thereby ceases to be matter.
- Claiming an organism builds tissue from matter that did not enter it.

**Grade boundary.** Isotope tracer methodology and metabolic flux analysis are beyond this course.
...
**Q1 — mastery fresh task.** _Serves objective 1:_ Demonstrate independent mastery evidence for conservation of matter in metabolism on a fresh task.
...
**Q2 — explain with evidence.** _Serves objective 2:_ Explain conservation of matter in metabolism using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q3 — apply new task.** _Serves objective 3:_ Apply conservation of matter in metabolism to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q4 — check revise next step.** _Serves objective 4:_ Check and revise the work on conservation of matter in metabolism against the stated success criteria and name the next step.
...
**Q5 — essential question.** _Serves objective 3:_ Apply conservation of matter in metabolism to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q6 — evidence quality.** _Serves objective 2:_ Explain conservation of matter in metabolism using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q7 — limitation.** _Serves objective 3:_ Apply conservation of matter in metabolism to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q8 — provenance.** _Serves objective 1:_ Demonstrate independent mastery evidence for conservation of matter in metabolism on a fresh task.
...
- **prerequisite-gap** — Run the prerequisite reteach route for conservation of matter in metabolism (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for conservation of matter in metabolism (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for conservation of matter in metabolism (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for conservation of matter in metabolism (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for conservation of matter in metabolism (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs9-biology-u05-l11` · built from `hs912-science-h4` at `a86780a`._
