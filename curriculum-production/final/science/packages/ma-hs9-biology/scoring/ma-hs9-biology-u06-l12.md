# Scoring authority — Correction and reflection: quantitative ecosystem models

**High School Biology (Grade 9)** · Unit 6: Ecosystems: Matter Cycling and Energy Flow · Day 12 · lesson `ma-hs9-biology-u06-l12`
...
_Topic `ma-hs9-biology-u06::quantitative ecosystem models` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs9-biology.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A quantitative ecosystem model represents stocks and flows of matter or energy and must balance.
- Model outputs are conditional on the assumptions and parameter values used, and those are stated.
- A model is evaluated against measured data, and disagreement is information about the assumptions.
...
- Building a matter or energy model whose inputs and outputs do not balance.

**Grade boundary.** Sensitivity analysis and formal model validation methods are beyond this course.
...
**Q1 — explain with evidence.** _Serves objective 1:_ Explain quantitative ecosystem models using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q2 — apply new task.** _Serves objective 2:_ Apply quantitative ecosystem models to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q3 — check revise next step.** _Serves objective 3:_ Check and revise the work on quantitative ecosystem models against the stated success criteria and name the next step.
...
**Q4 — essential question.** _Serves objective 2:_ Apply quantitative ecosystem models to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q5 — evidence quality.** _Serves objective 1:_ Explain quantitative ecosystem models using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q6 — limitation.** _Serves objective 2:_ Apply quantitative ecosystem models to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q7 — provenance.** _Serves objective 1:_ Explain quantitative ecosystem models using evidence, a model, or a documented process rather than an unsupported answer.
...
- **prerequisite-gap** — Run the prerequisite reteach route for quantitative ecosystem models (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for quantitative ecosystem models (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for quantitative ecosystem models (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for quantitative ecosystem models (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for quantitative ecosystem models (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs9-biology-u06-l12` · built from `hs912-science-h4` at `a86780a`._
