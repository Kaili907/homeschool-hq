# Scoring authority — Correction and reflection: energy accounting in organisms

**High School Biology (Grade 9)** · Unit 5: Photosynthesis, Cellular Respiration, and Energy in Living Systems · Day 12 · lesson `ma-hs9-biology-u05-l12`
...
_Topic `ma-hs9-biology-u05::energy accounting in organisms` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs9-biology.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Energy taken in is used for maintenance, growth, movement, and reproduction, with a substantial fraction released to the surroundings as thermal energy.
- Energy is conserved: an account balances intake against use, storage, and loss.
- Because energy is degraded to thermal energy at every transfer, organisms need a continuous supply.
...
- Claiming all energy taken in is available for growth.
- Claiming energy, like matter, is recycled within the organism.

**Grade boundary.** Calorimetry, metabolic rate measurement, and quantitative energy budgets are beyond this course.
...
**Q1 — explain with evidence.** _Serves objective 1:_ Explain energy accounting in organisms using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q2 — apply new task.** _Serves objective 2:_ Apply energy accounting in organisms to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q3 — check revise next step.** _Serves objective 3:_ Check and revise the work on energy accounting in organisms against the stated success criteria and name the next step.
...
**Q4 — essential question.** _Serves objective 2:_ Apply energy accounting in organisms to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q5 — evidence quality.** _Serves objective 1:_ Explain energy accounting in organisms using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q6 — limitation.** _Serves objective 2:_ Apply energy accounting in organisms to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q7 — provenance.** _Serves objective 1:_ Explain energy accounting in organisms using evidence, a model, or a documented process rather than an unsupported answer.
...
- **prerequisite-gap** — Run the prerequisite reteach route for energy accounting in organisms (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for energy accounting in organisms (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for energy accounting in organisms (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for energy accounting in organisms (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for energy accounting in organisms (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs9-biology-u05-l12` · built from `hs912-science-h4` at `a86780a`._
