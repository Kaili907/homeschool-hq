# Scoring authority — Unit assessment: regulation across organ systems

**High School Biology (Grade 9)** · Unit 4: Homeostasis and Feedback Mechanisms · Day 11 · lesson `ma-hs9-biology-u04-l11`
...
_Topic `ma-hs9-biology-u04::regulation across organ systems` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs9-biology.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Regulating one variable usually involves several organ systems acting together, coordinated by nervous and endocrine signals.
- Nervous signalling is fast and short-lived; endocrine signalling is slower and more sustained, and the two are used for different regulatory jobs.
- Because systems are coupled, correcting one variable can disturb another.
...
- Claiming a single organ regulates a variable without involving others.
- Claiming nervous and endocrine signalling operate on the same timescale.
- Claiming correcting one regulated variable never affects any other.

**Grade boundary.** Specific hormone axes in detail and integrative physiology modelling are beyond this course.
...
**Q1 — mastery fresh task.** _Serves objective 1:_ Demonstrate independent mastery evidence for regulation across organ systems on a fresh task.
...
**Q2 — explain with evidence.** _Serves objective 2:_ Explain regulation across organ systems using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q3 — apply new task.** _Serves objective 3:_ Apply regulation across organ systems to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q4 — check revise next step.** _Serves objective 4:_ Check and revise the work on regulation across organ systems against the stated success criteria and name the next step.
...
**Q5 — essential question.** _Serves objective 3:_ Apply regulation across organ systems to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q6 — evidence quality.** _Serves objective 2:_ Explain regulation across organ systems using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q7 — limitation.** _Serves objective 3:_ Apply regulation across organ systems to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q8 — provenance.** _Serves objective 1:_ Demonstrate independent mastery evidence for regulation across organ systems on a fresh task.
...
- **prerequisite-gap** — Run the prerequisite reteach route for regulation across organ systems (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for regulation across organ systems (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for regulation across organ systems (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for regulation across organ systems (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for regulation across organ systems (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs9-biology-u04-l11` · built from `hs912-science-h4` at `a86780a`._
