# Scoring authority — Performance task build: carbon and macromolecule structure

**High School Biology (Grade 9)** · Unit 1: Scientific Practice, Measurement, and the Molecules of Life · Day 9 · lesson `ma-hs9-biology-u01-l09`
...
_Topic `ma-hs9-biology-u01::carbon and macromolecule structure` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-hs9-biology.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Carbon forms four covalent bonds, which is why it builds the large, varied molecules life depends on.
- The four major classes of biological macromolecule are carbohydrates, lipids, proteins, and nucleic acids.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Carbon's capacity to form four stable covalent bonds, including with other carbon atoms, allows chains, branches, and rings, and therefore enormous molecular variety.
- Carbohydrates, proteins, and nucleic acids are polymers built from repeating monomers; lipids are not polymers in the same sense.
- Monomers are joined by removing water and separated by adding it.

**Also correct.** Accept any of these framings — do not require the wording above:

- Naming the joining and splitting reactions dehydration synthesis and hydrolysis, or describing them as removing and adding water, are equally correct.
...
- Claiming carbon forms a number of covalent bonds other than four in these molecules.
- Claiming lipids are polymers of a repeating monomer in the way proteins and nucleic acids are.
- Claiming monomers are joined by adding water and separated by removing it.

**Grade boundary.** Detailed organic reaction mechanisms and stereochemistry are Chemistry course work.
...
**Q1 — performance evidence.** _Serves objective 1:_ Produce performance-task evidence for carbon and macromolecule structure that a reader could check independently.
...
**Q2 — explain with evidence.** _Serves objective 2:_ Explain carbon and macromolecule structure using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q3 — apply new task.** _Serves objective 3:_ Apply carbon and macromolecule structure to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q4 — check revise next step.** _Serves objective 4:_ Check and revise the work on carbon and macromolecule structure against the stated success criteria and name the next step.
...
**Q5 — essential question.** _Serves objective 3:_ Apply carbon and macromolecule structure to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q6 — evidence quality.** _Serves objective 2:_ Explain carbon and macromolecule structure using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q7 — limitation.** _Serves objective 3:_ Apply carbon and macromolecule structure to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q8 — provenance.** _Serves objective 1:_ Produce performance-task evidence for carbon and macromolecule structure that a reader could check independently.
...
- **prerequisite-gap** — Run the prerequisite reteach route for carbon and macromolecule structure (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for carbon and macromolecule structure (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for carbon and macromolecule structure (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for carbon and macromolecule structure (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for carbon and macromolecule structure (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs9-biology-u01-l09` · built from `hs912-science-h4` at `a86780a`._
