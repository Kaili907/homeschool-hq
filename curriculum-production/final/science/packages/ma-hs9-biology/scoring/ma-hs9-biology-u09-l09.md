# Scoring authority — Performance task build: statistics of advantageous traits

**High School Biology (Grade 9)** · Unit 9: Natural Selection, Evolution, and Biodiversity Engineering · Day 9 · lesson `ma-hs9-biology-u09-l09`
...
_Topic `ma-hs9-biology-u09::statistics of advantageous traits` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs9-biology.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Selection is detected as a change in the distribution of a trait in a population over generations.
- A shift in a distribution is evidence about the population, not about any individual within it.
- The strength of the evidence depends on sample size, on measurement method, and on the number of generations observed.

**Also correct.** Accept any of these framings — do not require the wording above:

- Directional, stabilising, and disruptive selection are correct names for the distributional patterns; describing the shift without the labels is equally acceptable.
...
- Inferring selection from a change in one individual.
- Claiming a shift in a trait distribution is necessarily due to selection, without considering other causes.
- Reporting a distributional change with no reference to sample size or generations.

**Grade boundary.** Selection coefficients and formal statistical inference are beyond this course.
...
**Q1 — performance evidence.** _Serves objective 1:_ Produce performance-task evidence for statistics of advantageous traits that a reader could check independently.
...
**Q2 — explain with evidence.** _Serves objective 2:_ Explain statistics of advantageous traits using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q3 — apply new task.** _Serves objective 3:_ Apply statistics of advantageous traits to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q4 — check revise next step.** _Serves objective 4:_ Check and revise the work on statistics of advantageous traits against the stated success criteria and name the next step.
...
**Q5 — essential question.** _Serves objective 3:_ Apply statistics of advantageous traits to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q6 — evidence quality.** _Serves objective 2:_ Explain statistics of advantageous traits using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q7 — limitation.** _Serves objective 3:_ Apply statistics of advantageous traits to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q8 — provenance.** _Serves objective 1:_ Produce performance-task evidence for statistics of advantageous traits that a reader could check independently.
...
- **prerequisite-gap** — Run the prerequisite reteach route for statistics of advantageous traits (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for statistics of advantageous traits (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for statistics of advantageous traits (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for statistics of advantageous traits (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for statistics of advantageous traits (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs9-biology-u09-l09` · built from `hs912-science-h4` at `a86780a`._
