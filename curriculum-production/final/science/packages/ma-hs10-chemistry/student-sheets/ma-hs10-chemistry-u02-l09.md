# Performance task build: valence electrons

**High School Chemistry (Grade 10)** · Unit 2: Atomic Structure and the Periodic Table as a Model · Day 9 of the unit (course day 21) · about 61–84 minutes

**Today's focus:** valence electrons
...
- Produce performance-task evidence for valence electrons that a reader could check independently.
- Explain valence electrons using evidence, a model, or a documented process rather than an unsupported answer.
- Apply valence electrons to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on valence electrons against the stated success criteria and name the next step.

**Materials:**

- published periodic-trend dataset
- published emission-spectrum reference images
- graph paper or spreadsheet
- calculator
- card tube and craft knife (adult-cut viewing slit)
- a CD, DVD, or sheet diffraction grating
- tape for the learner to assemble the tube
...
- **Physical hazard.** Looking into a bright light source, or at the sun, damages vision permanently.
  - What stops it: View household lamps only, from at least an arm's length, never the sun and never a laser. No optical device is ever pointed at the sun or at another person. This prohibition is not disableable.
- **Physical hazard.** Cutting the viewing slit in the card tube uses a sharp blade.
  - What stops it: An adult cuts the slit; the learner assembles and tapes only. No cutting tool is required of the learner.
...
**Clearing up.** Recycle the card tube, return the CD or grating to its sleeve, and file or recycle the printed spectra. No flame, fuel, heat source, or chemical is used anywhere in this investigation, so there is nothing hazardous to dispose of.
...
- Science brief: valence electrons are the electrons in the outermost energy level, and they are the electrons involved in bonding.
- Science brief: the number of valence electrons largely determines an element's chemical behaviour, which is why elements in the same main group behave similarly.
- Science brief: atoms tend toward outer-electron arrangements resembling those of the noble gases, by transferring, sharing, or delocalising electrons.
- Science brief: for main-group elements the valence electron count follows from the group: groups 1 and 2 have one and two, and groups 13 to 18 have the group number minus ten, with helium the exception at two.

### Evidence check: valence electrons

**Candidate claim:** A case report presents this as acceptable science: “counting all of an atom's electrons as valence electrons.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: valence electrons are the electrons in the outermost energy level, and they are the electrons involved in bonding. |
| E2 | established science reference | Science brief: the number of valence electrons largely determines an element's chemical behaviour, which is why elements in the same main group behave similarly. |
| E3 | established science reference | Science brief: atoms tend toward outer-electron arrangements resembling those of the noble gases, by transferring, sharing, or delocalising electrons. |
| E4 | established science reference | Science brief: for main-group elements the valence electron count follows from the group: groups 1 and 2 have one and two, and groups 13 to 18 have the group number minus ten, with helium the exception at two. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs10-chemistry-u02::valence electrons, derived from the reviewed correctness source policy/correctness/ma-hs10-chemistry.correctness.json.

**Supplied unit connections:** subatomic structure and isotopes; electron arrangement and energy levels; valence electrons; periodic trends in atomic radius and ionization; reactivity patterns by group; the periodic table as a predictive model

**Supplied unit performance task:** Use the periodic table as a model to predict relative properties of unfamiliar elements from outer-electron patterns, then check your predictions against published data and account for every miss.

### Bound task

**Question:** What does evidence E1 through E4 justify about valence electrons, and does it support the candidate claim?
...
| Q | 4 | 112 | 900 | 468, 527 |
| R | 5 | 85 | 801 | 412, 448 |
| S | 11 | 186 | 496 | 589, 590 |

**Model/source rule:** Values are a simplified instructional table patterned on periodic relationships; element letters are masked so identification must use the supplied evidence rather than recall.
...
3. Graph radius and ionization energy against atomic number, describe the within-period pattern and the reset, then match an unknown spectrum containing 589 and 590 nm.
...
**My question.** Write the question you are testing about valence electrons. It has to be a question your evidence could actually answer.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about valence electrons, then name one check that would catch an error or a weak claim.**
...
**Q1.** Build a checkable contribution to the supplied unit performance task — Use the periodic table as a model to predict relative properties of unfamiliar elements from outer-electron patterns, then check your predictions against published data and account for every miss. — using the case and E1-E4. Include claim, evidence, reasoning, limitation, and a recorded revision.

>

**Q2.** Explain valence electrons in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for valence electrons. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about valence electrons, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using valence electrons as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E4 is strongest for evaluating the candidate claim about valence electrons? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E4, state one conclusion about valence electrons that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about valence electrons. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about valence electrons.
...
- Apply valence electrons under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect valence electrons to subatomic structure and isotopes from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Use the periodic table as a model to predict relative properties of unfamiliar elements from outer-electron patterns, then check your predictions against published data and account for every miss. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-hs10-chemistry-u02-l09` · lesson `ma-hs10-chemistry-u02-l09` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
