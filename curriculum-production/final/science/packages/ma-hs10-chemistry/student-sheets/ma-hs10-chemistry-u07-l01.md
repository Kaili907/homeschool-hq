# Launch and diagnostic: collision model of reactions

**High School Chemistry (Grade 10)** · Unit 7: Reaction Rates and the Conditions That Change Them · Day 1 of the unit (course day 73) · about 55–75 minutes
...
- Observe the anchoring phenomenon, surface initial thinking about collision model of reactions without penalty, and pose a testable question.
...
- Science brief: for a reaction to occur, particles must collide with sufficient energy and in a suitable orientation.
- Science brief: reaction rate depends on how often effective collisions occur, where effective means both energetic enough and correctly oriented.
- Science brief: activation energy is the minimum energy a collision must have to lead to reaction.
- Science brief: anything that raises the frequency or the effectiveness of collisions raises the rate.

### Evidence check: collision model of reactions

**Candidate claim:** A case report presents this as acceptable science: “every collision between reactant particles produces a reaction.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: for a reaction to occur, particles must collide with sufficient energy and in a suitable orientation. |
| E2 | established science reference | Science brief: reaction rate depends on how often effective collisions occur, where effective means both energetic enough and correctly oriented. |
| E3 | established science reference | Science brief: activation energy is the minimum energy a collision must have to lead to reaction. |
| E4 | established science reference | Science brief: anything that raises the frequency or the effectiveness of collisions raises the rate. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs10-chemistry-u07::collision model of reactions, derived from the reviewed correctness source policy/correctness/ma-hs10-chemistry.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about collision model of reactions, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about collision model of reactions, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**Q1.** Use the printed case as today's phenomenon for collision model of reactions. Record what the candidate claim says, identify the mismatch with E1-E4, and pose a testable question naming what would change and what would be measured or classified.

>

**Q2.** Explain collision model of reactions in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for collision model of reactions. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about collision model of reactions, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using collision model of reactions as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E4 is strongest for evaluating the candidate claim about collision model of reactions? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E4, state one conclusion about collision model of reactions that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about collision model of reactions. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
_Package `swp-ma-hs10-chemistry-u07-l01` · lesson `ma-hs10-chemistry-u07-l01` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
