# Reteach and varied practice: measurement, precision, and significant figures

**High School Chemistry (Grade 10)** · Unit 1: Matter, Measurement, and Laboratory Practice · Day 8 of the unit (course day 8) · about 55–75 minutes

**Today's focus:** measurement, precision, and significant figures
...
- Explain measurement, precision, and significant figures using evidence, a model, or a documented process rather than an unsupported answer.
- Apply measurement, precision, and significant figures to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on measurement, precision, and significant figures against the stated success criteria and name the next step.
...
- Science brief: the number of significant figures reported must reflect the precision of the instrument used.
- Science brief: a measurement is recorded to the smallest division of the instrument plus one estimated digit.
- Science brief: precision describes how closely repeated measurements agree; accuracy describes how close they are to the accepted value, and the two are independent.
- Science brief: calculations cannot create precision: a result is reported to no more significant figures than the least precise input allows.

### Evidence check: measurement, precision, and significant figures

**Candidate claim:** A case report presents this as acceptable science: “reporting a calculated result to more significant figures than the measurements support.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: the number of significant figures reported must reflect the precision of the instrument used. |
| E2 | established science reference | Science brief: a measurement is recorded to the smallest division of the instrument plus one estimated digit. |
| E3 | established science reference | Science brief: precision describes how closely repeated measurements agree; accuracy describes how close they are to the accepted value, and the two are independent. |
| E4 | established science reference | Science brief: calculations cannot create precision: a result is reported to no more significant figures than the least precise input allows. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs10-chemistry-u01::measurement, precision, and significant figures, derived from the reviewed correctness source policy/correctness/ma-hs10-chemistry.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about measurement, precision, and significant figures, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about measurement, precision, and significant figures, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about measurement, precision, and significant figures, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain measurement, precision, and significant figures in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for measurement, precision, and significant figures. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about measurement, precision, and significant figures, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using measurement, precision, and significant figures as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about measurement, precision, and significant figures? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about measurement, precision, and significant figures that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about measurement, precision, and significant figures. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about measurement, precision, and significant figures.
...
- Apply measurement, precision, and significant figures under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect measurement, precision, and significant figures to physical and chemical properties from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs10-chemistry-u01-l08` · lesson `ma-hs10-chemistry-u01-l08` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
