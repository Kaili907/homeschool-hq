# Investigation: subatomic structure and isotopes

**High School Chemistry (Grade 10)** · Unit 2: Atomic Structure and the Periodic Table as a Model · Day 7 of the unit (course day 19) · about 61–84 minutes

**Today's focus:** subatomic structure and isotopes
...
- Explain subatomic structure and isotopes using evidence, a model, or a documented process rather than an unsupported answer.
- Apply subatomic structure and isotopes to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on subatomic structure and isotopes against the stated success criteria and name the next step.
...
- Science brief: the number of protons in the nucleus defines the element.
- Science brief: isotopes of an element have the same number of protons and different numbers of neutrons.
- Science brief: an atom has protons and neutrons in the nucleus and electrons outside it; protons are positive, electrons negative, neutrons uncharged.
- Science brief: changing the neutron number gives a different isotope of the same element; changing the proton number gives a different element.

### Evidence check: subatomic structure and isotopes

**Candidate claim:** A case report presents this as acceptable science: “isotopes of an element differ in proton number.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: the number of protons in the nucleus defines the element. |
| E2 | established science reference | Science brief: isotopes of an element have the same number of protons and different numbers of neutrons. |
| E3 | established science reference | Science brief: an atom has protons and neutrons in the nucleus and electrons outside it; protons are positive, electrons negative, neutrons uncharged. |
| E4 | established science reference | Science brief: changing the neutron number gives a different isotope of the same element; changing the proton number gives a different element. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs10-chemistry-u02::subatomic structure and isotopes, derived from the reviewed correctness source policy/correctness/ma-hs10-chemistry.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about subatomic structure and isotopes, and does it support the candidate claim?
...
**My question.** Write the question you are testing about subatomic structure and isotopes. It has to be a question your evidence could actually answer.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about subatomic structure and isotopes, then name one check that would catch an error or a weak claim.**
...
**Q1.** Complete the route you chose. For the document/model route, use its printed procedure and input table; for the H4 physical route, use the printed safe order and your own blank record. Report the route, evidence IDs or model rows, conclusion about subatomic structure and isotopes, uncertainty, and limitation.

>

**Q2.** Explain subatomic structure and isotopes in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for subatomic structure and isotopes. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about subatomic structure and isotopes, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using subatomic structure and isotopes as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E4 is strongest for evaluating the candidate claim about subatomic structure and isotopes? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E4, state one conclusion about subatomic structure and isotopes that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about subatomic structure and isotopes. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about subatomic structure and isotopes.
...
- Apply subatomic structure and isotopes under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect subatomic structure and isotopes to electron arrangement and energy levels from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs10-chemistry-u02-l07` · lesson `ma-hs10-chemistry-u02-l07` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
