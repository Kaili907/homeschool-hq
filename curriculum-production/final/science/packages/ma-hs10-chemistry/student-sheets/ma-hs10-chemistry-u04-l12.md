# Correction and reflection: writing and revising explanations

**High School Chemistry (Grade 10)** · Unit 4: Chemical Reactions and Electron Rearrangement · Day 12 of the unit (course day 48) · about 55–75 minutes

**Today's focus:** writing and revising explanations
...
- Explain writing and revising explanations using evidence, a model, or a documented process rather than an unsupported answer.
- Apply writing and revising explanations to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on writing and revising explanations against the stated success criteria and name the next step.
...
- Science brief: a chemical explanation connects observation to particle-level behaviour by explicit reasoning.
- Science brief: revising an explanation means saying what evidence prompted the change and what the earlier version got wrong.
- Science brief: an explanation that accounts for the confirming evidence but not the disconfirming evidence is incomplete.

### Evidence check: writing and revising explanations

**Candidate claim:** A case report presents this as acceptable science: “revising an explanation to fit new evidence without saying what the earlier version failed to account for.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a chemical explanation connects observation to particle-level behaviour by explicit reasoning. |
| E2 | established science reference | Science brief: revising an explanation means saying what evidence prompted the change and what the earlier version got wrong. |
| E3 | established science reference | Science brief: an explanation that accounts for the confirming evidence but not the disconfirming evidence is incomplete. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs10-chemistry-u04::writing and revising explanations, derived from the reviewed correctness source policy/correctness/ma-hs10-chemistry.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about writing and revising explanations, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about writing and revising explanations, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about writing and revising explanations, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain writing and revising explanations in your own words using at least two specifically named rows from E1-E3. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for writing and revising explanations. Decide whether E1-E3 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about writing and revising explanations, revise its weakest claim with a named row from E1-E3, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using writing and revising explanations as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about writing and revising explanations? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about writing and revising explanations that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about writing and revising explanations. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about writing and revising explanations.
...
- Apply writing and revising explanations under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect writing and revising explanations to evidence of chemical change from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs10-chemistry-u04-l12` · lesson `ma-hs10-chemistry-u04-l12` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
