# Reteach and varied practice: reaction types and patterns

**High School Chemistry (Grade 10)** · Unit 4: Chemical Reactions and Electron Rearrangement · Day 8 of the unit (course day 44) · about 55–75 minutes

**Today's focus:** reaction types and patterns
...
- Explain reaction types and patterns using evidence, a model, or a documented process rather than an unsupported answer.
- Apply reaction types and patterns to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on reaction types and patterns against the stated success criteria and name the next step.
...
- Science brief: common reaction patterns include synthesis, decomposition, single replacement, double replacement, and combustion.
- Science brief: classifying a reaction by pattern supports predicting its products, because each pattern has a characteristic rearrangement.
- Science brief: the classification describes what happens to the atoms, not why the reaction is favourable.
- Science brief: some reactions fit more than one pattern, and some fit none; the categories are a useful model rather than an exhaustive partition.

### Evidence check: reaction types and patterns

**Candidate claim:** A case report presents this as acceptable science: “predicting products by pattern while producing an equation in which atoms are not conserved.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: common reaction patterns include synthesis, decomposition, single replacement, double replacement, and combustion. |
| E2 | established science reference | Science brief: classifying a reaction by pattern supports predicting its products, because each pattern has a characteristic rearrangement. |
| E3 | established science reference | Science brief: the classification describes what happens to the atoms, not why the reaction is favourable. |
| E4 | established science reference | Science brief: some reactions fit more than one pattern, and some fit none; the categories are a useful model rather than an exhaustive partition. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs10-chemistry-u04::reaction types and patterns, derived from the reviewed correctness source policy/correctness/ma-hs10-chemistry.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about reaction types and patterns, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about reaction types and patterns, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about reaction types and patterns, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain reaction types and patterns in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for reaction types and patterns. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about reaction types and patterns, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using reaction types and patterns as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about reaction types and patterns? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about reaction types and patterns that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about reaction types and patterns. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about reaction types and patterns.
...
- Apply reaction types and patterns under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect reaction types and patterns to evidence of chemical change from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs10-chemistry-u04-l08` · lesson `ma-hs10-chemistry-u04-l08` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
