# Unit assessment: mass-energy and nuclear energy scale

**High School Chemistry (Grade 10)** · Unit 9: The Nucleus, Nuclear Energy, and a Chemistry Engineering Capstone · Day 11 of the unit (course day 107) · about 55–75 minutes

**Today's focus:** mass-energy and nuclear energy scale
...
- Demonstrate independent mastery evidence for mass-energy and nuclear energy scale on a fresh task.
- Explain mass-energy and nuclear energy scale using evidence, a model, or a documented process rather than an unsupported answer.
- Apply mass-energy and nuclear energy scale to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on mass-energy and nuclear energy scale against the stated success criteria and name the next step.
...
- Science brief: in nuclear reactions a small amount of mass is converted to energy, following the mass-energy relationship, which is why nuclear energy release is millions of times larger per event than chemical energy release.
- Science brief: the energy released in a nuclear reaction corresponds to the mass difference between the initial and final nuclei.
- Science brief: chemical reactions rearrange electrons and involve mass changes far too small to measure; nuclear reactions do not.
- Science brief: this difference in scale is why a small mass of nuclear fuel yields energy comparable to a very large mass of chemical fuel.

### Evidence check: mass-energy and nuclear energy scale

**Candidate claim:** A case report presents this as acceptable science: “mass is conserved exactly in nuclear reactions in the same way it is in chemical ones.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: in nuclear reactions a small amount of mass is converted to energy, following the mass-energy relationship, which is why nuclear energy release is millions of times larger per event than chemical energy release. |
| E2 | established science reference | Science brief: the energy released in a nuclear reaction corresponds to the mass difference between the initial and final nuclei. |
| E3 | established science reference | Science brief: chemical reactions rearrange electrons and involve mass changes far too small to measure; nuclear reactions do not. |
| E4 | established science reference | Science brief: this difference in scale is why a small mass of nuclear fuel yields energy comparable to a very large mass of chemical fuel. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs10-chemistry-u09::mass-energy and nuclear energy scale, derived from the reviewed correctness source policy/correctness/ma-hs10-chemistry.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about mass-energy and nuclear energy scale, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about mass-energy and nuclear energy scale, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about mass-energy and nuclear energy scale, then name one check that would catch an error or a weak claim.**
...
**Q1.** Without copying a sentence from the brief, evaluate the printed candidate case about mass-energy and nuclear energy scale. Cite E1-E4, write the reasoning in your own words, and correct the case claim so it fits exactly what the record establishes.

>

**Q2.** Explain mass-energy and nuclear energy scale in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for mass-energy and nuclear energy scale. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about mass-energy and nuclear energy scale, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using mass-energy and nuclear energy scale as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E4 is strongest for evaluating the candidate claim about mass-energy and nuclear energy scale? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E4, state one conclusion about mass-energy and nuclear energy scale that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about mass-energy and nuclear energy scale. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about mass-energy and nuclear energy scale.
...
- Apply mass-energy and nuclear energy scale under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect mass-energy and nuclear energy scale to nuclear composition and isotopes from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs10-chemistry-u09-l11` · lesson `ma-hs10-chemistry-u09-l11` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
