# Concept model A: dynamic equilibrium

**High School Chemistry (Grade 10)** · Unit 8: Equilibrium and the Design of Chemical Systems · Day 2 of the unit (course day 86) · about 55–75 minutes
...
_Package `swp-ma-hs10-chemistry-u08-l02` · lesson `ma-hs10-chemistry-u08-l02` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
