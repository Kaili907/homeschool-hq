# Performance task build: concentration and reaction rate

**High School Chemistry (Grade 10)** · Unit 7: Reaction Rates and the Conditions That Change Them · Day 9 of the unit (course day 81) · about 61–84 minutes

**Today's focus:** concentration and reaction rate
...
- Produce performance-task evidence for concentration and reaction rate that a reader could check independently.
- Explain concentration and reaction rate using evidence, a model, or a documented process rather than an unsupported answer.
- Apply concentration and reaction rate to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on concentration and reaction rate against the stated success criteria and name the next step.

**Materials:**

- effervescent tablets or baking soda
- vinegar at several dilutions
...
- **Chemical hazard.** A glow stick holds an internal glass ampoule, irritant esters, and hydrogen peroxide.
  - What stops it: Bend to activate; never cut, bite, open, or mouth a glow stick. If one splits, nobody touches it: rinse any contact 15 minutes and an adult bags and bins it. This prohibition is not disableable.
- **Chemical hazard.** Vinegar and effervescent tablets irritate eyes.
  - What stops it: Wear eye protection, work over a tray, and rinse splashes with water.
- **Physical hazard.** Warm water can scald and glass can break with thermal shock.
  - What stops it: An adult pours every warm sample and confirms with the thermometer that it reads below 50 degrees Celsius. Use plastic or unbreakable cups only.
...
- Science brief: increasing the concentration of a reactant generally increases the reaction rate.
- Science brief: higher concentration means more reactant particles in a given volume, so collisions between them are more frequent.
- Science brief: concentration affects collision frequency but not the energy of individual collisions.
- Science brief: for gases, increasing pressure by reducing volume has the same effect as increasing concentration.

### Evidence check: concentration and reaction rate

**Candidate claim:** A case report presents this as acceptable science: “higher concentration increases the energy of each collision.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: increasing the concentration of a reactant generally increases the reaction rate. |
| E2 | established science reference | Science brief: higher concentration means more reactant particles in a given volume, so collisions between them are more frequent. |
| E3 | established science reference | Science brief: concentration affects collision frequency but not the energy of individual collisions. |
| E4 | established science reference | Science brief: for gases, increasing pressure by reducing volume has the same effect as increasing concentration. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs10-chemistry-u07::concentration and reaction rate, derived from the reviewed correctness source policy/correctness/ma-hs10-chemistry.correctness.json.

**Supplied unit connections:** collision model of reactions; temperature and reaction rate; concentration and reaction rate; surface area and mixing; catalysts; explaining rate with scientific principles

**Supplied unit performance task:** Apply the collision model and your own rate data to explain how temperature and concentration change reaction rate, and identify the variable your design failed to control.

### Bound task

**Question:** What does evidence E1 through E4 justify about concentration and reaction rate, and does it support the candidate claim?
...
**Model/source rule:** Base time is 120 s; each +10 °C or doubling of surface factor halves time, while halving concentration doubles it.
...
3. Compare matched pairs to isolate one variable, convert time to relative rate 1/time, and explain the patterns with collision frequency and effective collisions.
...
**Pinned H4 alternative statement (lineage evidence):** Vary only surface area and concentration at room temperature - whole versus crushed tablet, full-strength versus diluted vinegar - eliminating all heating. Or analyse a published rate-versus-temperature dataset. Kitchen materials or paper.
...
**My question.** Write the question you are testing about concentration and reaction rate. It has to be a question your evidence could actually answer.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about concentration and reaction rate, then name one check that would catch an error or a weak claim.**
...
**Q1.** Build a checkable contribution to the supplied unit performance task — Apply the collision model and your own rate data to explain how temperature and concentration change reaction rate, and identify the variable your design failed to control. — using the case and E1-E4. Include claim, evidence, reasoning, limitation, and a recorded revision.

>

**Q2.** Explain concentration and reaction rate in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for concentration and reaction rate. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about concentration and reaction rate, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using concentration and reaction rate as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E4 is strongest for evaluating the candidate claim about concentration and reaction rate? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E4, state one conclusion about concentration and reaction rate that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about concentration and reaction rate. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about concentration and reaction rate.
...
- Apply concentration and reaction rate under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect concentration and reaction rate to collision model of reactions from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Apply the collision model and your own rate data to explain how temperature and concentration change reaction rate, and identify the variable your design failed to control. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-hs10-chemistry-u07-l09` · lesson `ma-hs10-chemistry-u07-l09` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
