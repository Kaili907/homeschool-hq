# Investigation: evidence of chemical change

**High School Chemistry (Grade 10)** · Unit 4: Chemical Reactions and Electron Rearrangement · Day 7 of the unit (course day 43) · about 61–84 minutes

**Today's focus:** evidence of chemical change
...
- Plan and carry out a safe investigation of evidence of chemical change, or its stated alternative, and record the learner's own data with its uncertainty.
- Explain evidence of chemical change using evidence, a model, or a documented process rather than an unsupported answer.
- Apply evidence of chemical change to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on evidence of chemical change against the stated success criteria and name the next step.
...
- baking soda
- red cabbage
- warm water below 50 degrees Celsius, poured by an adult
- thermometer
- clear cups
- a wide OPEN metal or ceramic dish for the oxidation run
- a scale used with a disposable tray under the sample, never the sample directly
- a separate tray to work over, not the disposable weighing tray
- gloves
...
- **Chemical hazard.** Steel wool in vinegar is an iron-and-acid reaction that slowly releases hydrogen, which is flammable in air across a wide range of concentrations.
  - What stops it: The oxidation run is NEVER put in a bag, jar, or any container with a lid. It stays in a wide open dish in a ventilated room, with no flame, hob, pilot light, heater, battery, charger, or static source anywhere near it.
- **Chemical hazard.** Vinegar is a mild acid that stings eyes and open cuts.
  - What stops it: Wear eye protection and gloves, cover any cut with a waterproof dressing, work over a tray, and rinse splashes with water for 15 minutes.
- **Chemical hazard.** Combining household chemicals other than those listed can generate toxic gas.
  - What stops it: Use ONLY vinegar, baking soda, and cabbage indicator. Never add bleach, ammonia, drain cleaner, or any cleaning product. This prohibition is not disableable.
- **Physical hazard.** Warm water scalds, and household hot taps commonly deliver water above 55 degrees Celsius.
  - What stops it: Cabbage indicator is extracted with water an adult has poured and checked at below 50 degrees Celsius. Hot tap water is never used directly, and temperature is judged with the thermometer, never with a hand.
- **Physical hazard.** Steel wool fibres cut skin, and damp finely divided steel wool self-heats as it oxidises.
  - What stops it: Wear gloves. Keep steel wool away from every battery and heat source, and never let it touch a 9V battery from an earlier unit. Warm or damp steel wool is never bagged, boxed, or binned - see the disposal steps.
...
**Clearing up.** NOTHING FROM THIS INVESTIGATION IS EVER SEALED. Leave the steel wool spread out in its open dish, well away from anything combustible, until it is completely cold and dry - normally overnight. Then rinse it under running water until the water runs clear, squeeze it out, and put it into the OUTDOOR waste bin still wet and cold, loose, never bagged and never with paper or a battery. If the dish is warm at any point, stop, leave the room ventilated, and wait. Pour the vinegar, baking-soda, and cabbage solutions down the drain with the tap running. Bin the disposable weighing tray; it never returns to food use.
...
- Science brief: a chemical change produces substances with different properties from the starting materials.
- Science brief: indicators include gas evolution, unexplained temperature change, colour change, precipitate formation, light emission, and odour, each of which has non-chemical explanations too.
- Science brief: the strongest evidence is a measured change in an identifying property before and after.

### Evidence check: evidence of chemical change

**Candidate claim:** A case report presents this as acceptable science: “treating bubbling alone as proof of reaction, when boiling and dissolved gas release also produce bubbles.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a chemical change produces substances with different properties from the starting materials. |
| E2 | established science reference | Science brief: indicators include gas evolution, unexplained temperature change, colour change, precipitate formation, light emission, and odour, each of which has non-chemical explanations too. |
| E3 | established science reference | Science brief: the strongest evidence is a measured change in an identifying property before and after. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs10-chemistry-u04::evidence of chemical change, derived from the reviewed correctness source policy/correctness/ma-hs10-chemistry.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about evidence of chemical change, and does it support the candidate claim?
...
**My question.** Write the question you are testing about evidence of chemical change. It has to be a question your evidence could actually answer.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about evidence of chemical change, then name one check that would catch an error or a weak claim.**
...
**Q1.** Complete the route you chose. For the document/model route, use its printed procedure and input table; for the H4 physical route, use the printed safe order and your own blank record. Report the route, evidence IDs or model rows, conclusion about evidence of chemical change, uncertainty, and limitation.

>

**Q2.** Explain evidence of chemical change in your own words using at least two specifically named rows from E1-E3. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for evidence of chemical change. Decide whether E1-E3 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about evidence of chemical change, revise its weakest claim with a named row from E1-E3, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using evidence of chemical change as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E3 is strongest for evaluating the candidate claim about evidence of chemical change? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E3, state one conclusion about evidence of chemical change that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about evidence of chemical change. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- Apply evidence of chemical change under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect evidence of chemical change to reaction types and patterns from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Construct and revise an explanation for the outcome of a reaction you ran, grounded in outer-electron states and periodic trends rather than memorised rules. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-hs10-chemistry-u04-l07` · lesson `ma-hs10-chemistry-u04-l07` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
