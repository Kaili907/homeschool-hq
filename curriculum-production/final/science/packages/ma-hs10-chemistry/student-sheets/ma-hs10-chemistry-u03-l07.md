# Investigation: ionic, covalent, and metallic bonding

**High School Chemistry (Grade 10)** · Unit 3: Bonding, Structure, and the Properties of Designed Materials · Day 7 of the unit (course day 31) · about 61–84 minutes

**Today's focus:** ionic, covalent, and metallic bonding
...
- Plan and carry out a safe investigation of ionic, covalent, and metallic bonding, or its stated alternative, and record the learner's own data with its uncertainty.
- Explain ionic, covalent, and metallic bonding using evidence, a model, or a documented process rather than an unsupported answer.
- Apply ionic, covalent, and metallic bonding to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on ionic, covalent, and metallic bonding against the stated success criteria and name the next step.
...
- warm water below 50 degrees Celsius
- a tray to work over and wipe down at the end of Stage A
- tape for the battery terminals
- published melting-point and conductivity tables
...
Read this before you touch any material. If anything here does not match what is in front of you, stop and ask the supervising adult.

**Who has to be with you.** An adult must be beside you, watching, for the whole activity. Do not start without them.

**Protective equipment.** Eye protection: required.

### What could go wrong, and what stops it

- **Chemical hazard.** Rubbing alcohol is flammable, its vapour is heavier than air and pools at bench level, and it is harmful if swallowed.
  - What stops it: STAGE A runs with no battery, charger, flame, hob, pilot light, heater, or lamp anywhere in the room. An adult dispenses no more than 30 mL per cup, caps the bottle, and removes it from the room at once. Nothing is ever tasted.
- **Chemical hazard.** The poured alcohol samples - not just the bottle - are the ignition risk, and a shorting battery is an ignition source.
  - What stops it: STAGE A ends when every POURED SAMPLE is down the drain, the cups washed and dried, and the room ventilated ten minutes - not when the bottle is capped. Only then may a battery enter, and STAGE B runs on a different surface.
- **Chemical hazard.** Passing current through salt water is electrolysis: it produces hydrogen at one lead and chlorine gas at the other.
  - What stops it: Each conductivity test is a touch of one to two seconds. Leads are never left standing in a solution. If bubbles form at a lead, disconnect at once, ventilate, and move to the published table.
- **Physical hazard.** Battery testing risks a short circuit that heats the leads.
  - What stops it: Use one 9V battery only - NEVER mains electricity, never a lithium or button cell. Keep the LED in the circuit at all times, tape the terminals before and after use, keep leads apart between tests, and let an adult make every connection.
- **Physical hazard.** Warm water can scald.
  - What stops it: An adult pours every warm sample and confirms with the thermometer that it reads below 50 degrees Celsius. Temperature is judged with the thermometer, never with a hand.
...
**Clearing up.** Alcohol samples go down the drain with the cold tap running at THE END OF STAGE A, before any battery appears; the cups are washed, dried, and put away. Salt, sugar, and oil solutions go down the drain with the tap running after Stage B. Disconnect the battery, tape its terminals, store it away from steel wool and loose metal, and wipe the surface. Nothing from this investigation is ever sealed, capped, or stored while wet. Alcohol and a battery are never left out together at any point.
...
- Content is academic; no personal, family, health, or location disclosure is requested.
...
- Science brief: ionic bonding involves the transfer of electrons from one atom to another, producing oppositely charged ions held together by electrostatic attraction.
- Science brief: covalent bonding involves the sharing of electron pairs between atoms.
- Science brief: metallic bonding involves positive metal ions in a shared, delocalised sea of electrons.
- Science brief: ionic bonds typically form between a metal and a non-metal, where the difference in attraction for electrons is large enough for transfer.

### Evidence check: ionic, covalent, and metallic bonding

**Candidate claim:** A case report presents this as acceptable science: “ionic bonds form when atoms share electrons, equally or otherwise.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: ionic bonding involves the transfer of electrons from one atom to another, producing oppositely charged ions held together by electrostatic attraction. |
| E2 | established science reference | Science brief: covalent bonding involves the sharing of electron pairs between atoms. |
| E3 | established science reference | Science brief: metallic bonding involves positive metal ions in a shared, delocalised sea of electrons. |
| E4 | established science reference | Science brief: ionic bonds typically form between a metal and a non-metal, where the difference in attraction for electrons is large enough for transfer. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs10-chemistry-u03::ionic, covalent, and metallic bonding, derived from the reviewed correctness source policy/correctness/ma-hs10-chemistry.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about ionic, covalent, and metallic bonding, and does it support the candidate claim?
...
| --- | --- | --- | --- | --- |
| M | dissolves | low | high | high |
| N | dissolves | low | low | low |
| O | does not mix | low | not applicable | low |
| P | does not dissolve | high | not applicable | high |

**Model/source rule:** The four masked materials instantiate idealized ionic, molecular-polar, molecular-nonpolar, and metallic property patterns.
...
3. Classify each material's most likely bonding type, cite at least two independent properties for each classification, and identify one limitation of inferring structure from bulk properties.
...
**Pinned H4 alternative statement (lineage evidence):** Compare only salt, sugar, and oil in water at room temperature - solubility and mixing behaviour alone - and take every melting-point and conductivity figure from the published tables. No battery, no alcohol, no heat, and therefore no ignition risk at all. This is the path to choose if the two stages cannot be separated in time and space exactly as written.
...
**My question.** Write the question you are testing about ionic, covalent, and metallic bonding. It has to be a question your evidence could actually answer.
...
| Trial | What I did (the exact step) | What I measured or observed | Unit | How sure I am / uncertainty | Anything unexpected |
| --- | --- | --- | --- | --- | --- |
|   |   |   |   |   |   |
|   |   |   |   |   |   |
|   |   |   |   |   |   |
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about ionic, covalent, and metallic bonding, then name one check that would catch an error or a weak claim.**
...
**Q1.** Complete the route you chose. For the document/model route, use its printed procedure and input table; for the H4 physical route, use the printed safe order and your own blank record. Report the route, evidence IDs or model rows, conclusion about ionic, covalent, and metallic bonding, uncertainty, and limitation.

>

**Q2.** Explain ionic, covalent, and metallic bonding in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for ionic, covalent, and metallic bonding. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about ionic, covalent, and metallic bonding, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using ionic, covalent, and metallic bonding as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E4 is strongest for evaluating the candidate claim about ionic, covalent, and metallic bonding? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E4, state one conclusion about ionic, covalent, and metallic bonding that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about ionic, covalent, and metallic bonding. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about ionic, covalent, and metallic bonding.
...
- Apply ionic, covalent, and metallic bonding under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect ionic, covalent, and metallic bonding to intermolecular forces from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Plan and conduct an investigation comparing bulk properties of several substances to infer the relative strength of forces between their particles, then communicate why molecular-level structure matters for one designed material. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-hs10-chemistry-u03-l07` · lesson `ma-hs10-chemistry-u03-l07` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
