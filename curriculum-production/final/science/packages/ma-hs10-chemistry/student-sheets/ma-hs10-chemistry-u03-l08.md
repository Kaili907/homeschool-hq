# Reteach and varied practice: intermolecular forces

**High School Chemistry (Grade 10)** · Unit 3: Bonding, Structure, and the Properties of Designed Materials · Day 8 of the unit (course day 32) · about 55–75 minutes

**Today's focus:** intermolecular forces
...
- Explain intermolecular forces using evidence, a model, or a documented process rather than an unsupported answer.
- Apply intermolecular forces to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on intermolecular forces against the stated success criteria and name the next step.
...
- Science brief: intermolecular forces are attractions between molecules and are much weaker than the covalent bonds within a molecule.
- Science brief: intermolecular attractions include dispersion forces, which act between all molecules, dipole-dipole attractions between polar molecules, and hydrogen bonding where hydrogen is bonded to nitrogen, oxygen, or fluorine.
- Science brief: boiling a molecular substance overcomes the forces between molecules, not the bonds within them.
- Science brief: stronger intermolecular forces raise boiling point, raise viscosity, and lower vapour pressure.

### Evidence check: intermolecular forces

**Candidate claim:** A case report presents this as acceptable science: “boiling water breaks the covalent bonds within water molecules.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: intermolecular forces are attractions between molecules and are much weaker than the covalent bonds within a molecule. |
| E2 | established science reference | Science brief: intermolecular attractions include dispersion forces, which act between all molecules, dipole-dipole attractions between polar molecules, and hydrogen bonding where hydrogen is bonded to nitrogen, oxygen, or fluorine. |
| E3 | established science reference | Science brief: boiling a molecular substance overcomes the forces between molecules, not the bonds within them. |
| E4 | established science reference | Science brief: stronger intermolecular forces raise boiling point, raise viscosity, and lower vapour pressure. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs10-chemistry-u03::intermolecular forces, derived from the reviewed correctness source policy/correctness/ma-hs10-chemistry.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about intermolecular forces, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about intermolecular forces, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about intermolecular forces, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain intermolecular forces in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for intermolecular forces. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about intermolecular forces, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using intermolecular forces as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about intermolecular forces? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about intermolecular forces that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about intermolecular forces. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about intermolecular forces.
...
- Apply intermolecular forces under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect intermolecular forces to ionic, covalent, and metallic bonding from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs10-chemistry-u03-l08` · lesson `ma-hs10-chemistry-u03-l08` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
