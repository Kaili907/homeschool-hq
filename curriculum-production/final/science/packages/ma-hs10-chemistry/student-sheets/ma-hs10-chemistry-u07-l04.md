# Independent application A: surface area and mixing

**High School Chemistry (Grade 10)** · Unit 7: Reaction Rates and the Conditions That Change Them · Day 4 of the unit (course day 76) · about 55–75 minutes

**Today's focus:** surface area and mixing
...
- Explain surface area and mixing using evidence, a model, or a documented process rather than an unsupported answer.
- Apply surface area and mixing to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on surface area and mixing against the stated success criteria and name the next step.
...
- Science brief: increasing the surface area of a solid reactant increases the reaction rate.
- Science brief: a reaction involving a solid occurs at its surface, so subdividing the solid exposes more particles to collision.
- Science brief: mixing brings reactants into contact and prevents local depletion, which is why stirring can raise the rate in solution.
- Science brief: surface area and mixing affect how often reactant particles meet, not the energy of the collisions.

### Evidence check: surface area and mixing

**Candidate claim:** A case report presents this as acceptable science: “the mass of a solid, rather than its exposed surface area, sets the rate for a surface reaction.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: increasing the surface area of a solid reactant increases the reaction rate. |
| E2 | established science reference | Science brief: a reaction involving a solid occurs at its surface, so subdividing the solid exposes more particles to collision. |
| E3 | established science reference | Science brief: mixing brings reactants into contact and prevents local depletion, which is why stirring can raise the rate in solution. |
| E4 | established science reference | Science brief: surface area and mixing affect how often reactant particles meet, not the energy of the collisions. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs10-chemistry-u07::surface area and mixing, derived from the reviewed correctness source policy/correctness/ma-hs10-chemistry.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about surface area and mixing, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about surface area and mixing, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about surface area and mixing, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain surface area and mixing in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for surface area and mixing. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about surface area and mixing, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using surface area and mixing as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about surface area and mixing? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about surface area and mixing that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about surface area and mixing. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about surface area and mixing.
...
- Apply surface area and mixing under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect surface area and mixing to collision model of reactions from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs10-chemistry-u07-l04` · lesson `ma-hs10-chemistry-u07-l04` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
