# Investigation: conservation of atoms and mass

**High School Chemistry (Grade 10)** · Unit 5: Conservation of Mass and Quantitative Reasoning in Reactions · Day 7 of the unit (course day 55) · about 61–84 minutes

**Today's focus:** conservation of atoms and mass
...
- Plan and carry out a safe investigation of conservation of atoms and mass, or its stated alternative, and record the learner's own data with its uncertainty.
- Explain conservation of atoms and mass using evidence, a model, or a documented process rather than an unsupported answer.
- Apply conservation of atoms and mass to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on conservation of atoms and mass against the stated success criteria and name the next step.
...
- clear cups
- kitchen scale reading to 1 g or better
- tray
- notebook
...
- **Chemical hazard.** Vinegar stings eyes, and the reaction produces carbon dioxide.
  - What stops it: Wear eye protection and work in a ventilated room. At the quantities fixed below the carbon dioxide is harmless; the quantities are what keep it that way, so they are part of the procedure and not a suggestion.
- **Physical hazard.** A closed bag holding a gas-producing reaction can burst and spray liquid.
  - What stops it: The closed trial is SEALED COMPLETELY - a part-sealed bag is not a closed system - and is made safe by volume: half a teaspoon of baking soda and 20 mL of vinegar in a one-litre bag. Flat on a tray, pointed away, never held.
...
- Science brief: the number of atoms of each element is identical before and after a chemical reaction, so mass is conserved.
- Science brief: atoms are neither created nor destroyed in chemical reactions; they are rearranged among substances.
- Science brief: conservation of atoms is the reason chemical equations must balance and the reason mass calculations work.
- Science brief: an apparent mass change in an open system means matter crossed the system boundary, most often as a gas.

### Evidence check: conservation of atoms and mass

**Candidate claim:** A case report presents this as acceptable science: “mass is lost during combustion without accounting for oxygen consumed and gases released.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: the number of atoms of each element is identical before and after a chemical reaction, so mass is conserved. |
| E2 | established science reference | Science brief: atoms are neither created nor destroyed in chemical reactions; they are rearranged among substances. |
| E3 | established science reference | Science brief: conservation of atoms is the reason chemical equations must balance and the reason mass calculations work. |
| E4 | established science reference | Science brief: an apparent mass change in an open system means matter crossed the system boundary, most often as a gas. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs10-chemistry-u05::conservation of atoms and mass, derived from the reviewed correctness source policy/correctness/ma-hs10-chemistry.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about conservation of atoms and mass, and does it support the candidate claim?
...
| --- | --- | --- | --- | --- |
| Open A | 12.4 | 8.0 | 19.35 | no |
| Open B | 12.4 | 8.0 | 19.29 | no |
| Closed A | 12.4 | 10.5 | 22.88 | yes |
| Closed B | 12.4 | 10.5 | 22.91 | yes |

**Model/source rule:** The closed-system model conserves 22.90 g with ±0.02 g scale deviation; the open model releases simulated gas mass plus the same scale deviation.
...
3. Compute each before-after difference, estimate gas mass for the open trials, and explain why system boundary—not disappearance of atoms—changes the measured total.
...
**Pinned H4 alternative statement (lineage evidence):** Do the mass accounting from a supplied table of published open- and closed-system masses, balancing the equation and computing expected gas mass by hand. Paper and calculator only.
...
**My question.** Write the question you are testing about conservation of atoms and mass. It has to be a question your evidence could actually answer.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about conservation of atoms and mass, then name one check that would catch an error or a weak claim.**
...
**Q1.** Complete the route you chose. For the document/model route, use its printed procedure and input table; for the H4 physical route, use the printed safe order and your own blank record. Report the route, evidence IDs or model rows, conclusion about conservation of atoms and mass, uncertainty, and limitation.

>

**Q2.** Explain conservation of atoms and mass in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for conservation of atoms and mass. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about conservation of atoms and mass, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using conservation of atoms and mass as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E4 is strongest for evaluating the candidate claim about conservation of atoms and mass? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E4, state one conclusion about conservation of atoms and mass that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about conservation of atoms and mass. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about conservation of atoms and mass.
...
- Apply conservation of atoms and mass under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect conservation of atoms and mass to balancing equations as bookkeeping from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Use your own mass measurements from open and closed systems to support the claim that atoms and mass are conserved, and explain the open-system loss quantitatively. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-hs10-chemistry-u05-l07` · lesson `ma-hs10-chemistry-u05-l07` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
