# Reteach and varied practice: exothermic and endothermic processes

**High School Chemistry (Grade 10)** · Unit 6: Energy in Chemical Systems · Day 8 of the unit (course day 68) · about 55–75 minutes

**Today's focus:** exothermic and endothermic processes
...
- Explain exothermic and endothermic processes using evidence, a model, or a documented process rather than an unsupported answer.
- Apply exothermic and endothermic processes to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on exothermic and endothermic processes against the stated success criteria and name the next step.
...
- Science brief: an exothermic process releases energy to the surroundings; an endothermic process absorbs energy from them.
- Science brief: in an exothermic reaction the products are lower in chemical energy than the reactants, and the difference is released to the surroundings.
- Science brief: in an endothermic reaction the products are higher in chemical energy, and the difference is absorbed from the surroundings.
- Science brief: the surroundings warming or cooling is the evidence; the reaction system itself is what is being classified.

### Evidence check: exothermic and endothermic processes

**Candidate claim:** A case report presents this as acceptable science: “an endothermic reaction produces cold rather than absorbing energy.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: an exothermic process releases energy to the surroundings; an endothermic process absorbs energy from them. |
| E2 | established science reference | Science brief: in an exothermic reaction the products are lower in chemical energy than the reactants, and the difference is released to the surroundings. |
| E3 | established science reference | Science brief: in an endothermic reaction the products are higher in chemical energy, and the difference is absorbed from the surroundings. |
| E4 | established science reference | Science brief: the surroundings warming or cooling is the evidence; the reaction system itself is what is being classified. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs10-chemistry-u06::exothermic and endothermic processes, derived from the reviewed correctness source policy/correctness/ma-hs10-chemistry.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about exothermic and endothermic processes, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about exothermic and endothermic processes, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about exothermic and endothermic processes, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain exothermic and endothermic processes in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for exothermic and endothermic processes. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about exothermic and endothermic processes, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using exothermic and endothermic processes as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about exothermic and endothermic processes? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about exothermic and endothermic processes that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about exothermic and endothermic processes. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about exothermic and endothermic processes.
...
- Apply exothermic and endothermic processes under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect exothermic and endothermic processes to bond breaking and bond making from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs10-chemistry-u06-l08` · lesson `ma-hs10-chemistry-u06-l08` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
