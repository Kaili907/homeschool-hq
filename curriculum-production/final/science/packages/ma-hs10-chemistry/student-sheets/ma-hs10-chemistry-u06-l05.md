# Concept model B: computational energy models

**High School Chemistry (Grade 10)** · Unit 6: Energy in Chemical Systems · Day 5 of the unit (course day 65) · about 55–75 minutes
...
_Package `swp-ma-hs10-chemistry-u06-l05` · lesson `ma-hs10-chemistry-u06-l05` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
