# Concept model A: measurement, precision, and significant figures

**High School Chemistry (Grade 10)** · Unit 1: Matter, Measurement, and Laboratory Practice · Day 2 of the unit (course day 2) · about 55–75 minutes
...
_Package `swp-ma-hs10-chemistry-u01-l02` · lesson `ma-hs10-chemistry-u01-l02` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
