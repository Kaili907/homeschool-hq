# Performance task build: the mole as a counting unit

**High School Chemistry (Grade 10)** · Unit 5: Conservation of Mass and Quantitative Reasoning in Reactions · Day 9 of the unit (course day 57) · about 61–84 minutes

**Today's focus:** the mole as a counting unit
...
- Produce performance-task evidence for the mole as a counting unit that a reader could check independently.
- Explain the mole as a counting unit using evidence, a model, or a documented process rather than an unsupported answer.
- Apply the mole as a counting unit to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on the mole as a counting unit against the stated success criteria and name the next step.
...
- Science brief: one mole contains Avogadro's number of particles, approximately 6.022 times ten to the twenty-third.
- Science brief: the mole is a counting unit for particles, in the same way that a dozen is, chosen so that molar mass in grams matches atomic and formula mass.
- Science brief: a mole of any substance contains the same number of particles, but moles of different substances have different masses.
- Science brief: the particle counted must be specified, since a mole of oxygen atoms and a mole of oxygen molecules are different quantities.

### Evidence check: the mole as a counting unit

**Candidate claim:** A case report presents this as acceptable science: “a mole is a unit of mass.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: one mole contains Avogadro's number of particles, approximately 6.022 times ten to the twenty-third. |
| E2 | established science reference | Science brief: the mole is a counting unit for particles, in the same way that a dozen is, chosen so that molar mass in grams matches atomic and formula mass. |
| E3 | established science reference | Science brief: a mole of any substance contains the same number of particles, but moles of different substances have different masses. |
| E4 | established science reference | Science brief: the particle counted must be specified, since a mole of oxygen atoms and a mole of oxygen molecules are different quantities. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs10-chemistry-u05::the mole as a counting unit, derived from the reviewed correctness source policy/correctness/ma-hs10-chemistry.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about the mole as a counting unit, and does it support the candidate claim?
...
**My question.** Write the question you are testing about the mole as a counting unit. It has to be a question your evidence could actually answer.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about the mole as a counting unit, then name one check that would catch an error or a weak claim.**
...
**Q1.** Build a checkable contribution to the supplied unit performance task — Use your own mass measurements from open and closed systems to support the claim that atoms and mass are conserved, and explain the open-system loss quantitatively. — using the case and E1-E4. Include claim, evidence, reasoning, limitation, and a recorded revision.

>

**Q2.** Explain the mole as a counting unit in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for the mole as a counting unit. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about the mole as a counting unit, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using the mole as a counting unit as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E4 is strongest for evaluating the candidate claim about the mole as a counting unit? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E4, state one conclusion about the mole as a counting unit that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about the mole as a counting unit. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about the mole as a counting unit.
...
- Apply the mole as a counting unit under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect the mole as a counting unit to conservation of atoms and mass from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs10-chemistry-u05-l09` · lesson `ma-hs10-chemistry-u05-l09` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
