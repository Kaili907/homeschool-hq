# Independent application A: molar mass and formula mass

**High School Chemistry (Grade 10)** · Unit 5: Conservation of Mass and Quantitative Reasoning in Reactions · Day 4 of the unit (course day 52) · about 55–75 minutes

**Today's focus:** molar mass and formula mass
...
- Explain molar mass and formula mass using evidence, a model, or a documented process rather than an unsupported answer.
- Apply molar mass and formula mass to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on molar mass and formula mass against the stated success criteria and name the next step.
...
- Science brief: the molar mass of a substance in grams per mole is numerically equal to its formula or molecular mass in atomic mass units.
- Science brief: molar mass is calculated by summing the molar masses of the atoms in the formula, each multiplied by its subscript.
- Science brief: molar mass converts between mass, which is measurable, and moles, which is what stoichiometry needs.
- Science brief: the molar mass of an element as listed on the periodic table is a weighted average across its natural isotopes.

### Evidence check: molar mass and formula mass

**Candidate claim:** A case report presents this as acceptable science: “summing atomic masses without applying the subscripts in the formula.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: the molar mass of a substance in grams per mole is numerically equal to its formula or molecular mass in atomic mass units. |
| E2 | established science reference | Science brief: molar mass is calculated by summing the molar masses of the atoms in the formula, each multiplied by its subscript. |
| E3 | established science reference | Science brief: molar mass converts between mass, which is measurable, and moles, which is what stoichiometry needs. |
| E4 | established science reference | Science brief: the molar mass of an element as listed on the periodic table is a weighted average across its natural isotopes. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs10-chemistry-u05::molar mass and formula mass, derived from the reviewed correctness source policy/correctness/ma-hs10-chemistry.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about molar mass and formula mass, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about molar mass and formula mass, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about molar mass and formula mass, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain molar mass and formula mass in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for molar mass and formula mass. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about molar mass and formula mass, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using molar mass and formula mass as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about molar mass and formula mass? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about molar mass and formula mass that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about molar mass and formula mass. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about molar mass and formula mass.
...
- Apply molar mass and formula mass under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect molar mass and formula mass to conservation of atoms and mass from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs10-chemistry-u05-l04` · lesson `ma-hs10-chemistry-u05-l04` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
