# Independent application A: density and derived quantities

**High School Chemistry (Grade 10)** · Unit 1: Matter, Measurement, and Laboratory Practice · Day 4 of the unit (course day 4) · about 55–75 minutes

**Today's focus:** density and derived quantities
...
- Apply density and derived quantities to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on density and derived quantities against the stated success criteria and name the next step.
...
- Science brief: density is mass divided by volume, and it is an intensive property: it does not change with the size of the sample.
- Science brief: density is a derived quantity, calculated from two measurements, so its uncertainty depends on both.
- Science brief: because density is intensive, a small piece and a large piece of the same pure substance have the same density.
- Science brief: density varies with temperature, because volume does, so a density value is quoted with the temperature it applies at.

### Evidence check: density and derived quantities

**Candidate claim:** A case report presents this as acceptable science: “a larger sample of the same substance has a greater density.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: density is mass divided by volume, and it is an intensive property: it does not change with the size of the sample. |
| E2 | established science reference | Science brief: density is a derived quantity, calculated from two measurements, so its uncertainty depends on both. |
| E3 | established science reference | Science brief: because density is intensive, a small piece and a large piece of the same pure substance have the same density. |
| E4 | established science reference | Science brief: density varies with temperature, because volume does, so a density value is quoted with the temperature it applies at. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs10-chemistry-u01::density and derived quantities, derived from the reviewed correctness source policy/correctness/ma-hs10-chemistry.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about density and derived quantities, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about density and derived quantities, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about density and derived quantities, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain density and derived quantities in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for density and derived quantities. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about density and derived quantities, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using density and derived quantities as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about density and derived quantities? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about density and derived quantities that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about density and derived quantities. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about density and derived quantities.
...
- Apply density and derived quantities under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect density and derived quantities to physical and chemical properties from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs10-chemistry-u01-l04` · lesson `ma-hs10-chemistry-u01-l04` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
