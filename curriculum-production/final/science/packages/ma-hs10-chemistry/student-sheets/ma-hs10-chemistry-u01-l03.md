# Guided practice A: uncertainty and repeated trials

**High School Chemistry (Grade 10)** · Unit 1: Matter, Measurement, and Laboratory Practice · Day 3 of the unit (course day 3) · about 55–75 minutes
...
_Package `swp-ma-hs10-chemistry-u01-l03` · lesson `ma-hs10-chemistry-u01-l03` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
