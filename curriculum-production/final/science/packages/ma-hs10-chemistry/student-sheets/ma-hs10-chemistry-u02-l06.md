# Guided practice B: the periodic table as a predictive model

**High School Chemistry (Grade 10)** · Unit 2: Atomic Structure and the Periodic Table as a Model · Day 6 of the unit (course day 18) · about 55–75 minutes
...
_Package `swp-ma-hs10-chemistry-u02-l06` · lesson `ma-hs10-chemistry-u02-l06` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
