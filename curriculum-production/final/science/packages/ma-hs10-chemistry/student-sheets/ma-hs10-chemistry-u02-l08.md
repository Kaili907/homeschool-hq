# Reteach and varied practice: electron arrangement and energy levels

**High School Chemistry (Grade 10)** · Unit 2: Atomic Structure and the Periodic Table as a Model · Day 8 of the unit (course day 20) · about 55–75 minutes

**Today's focus:** electron arrangement and energy levels
...
- Explain electron arrangement and energy levels using evidence, a model, or a documented process rather than an unsupported answer.
- Apply electron arrangement and energy levels to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on electron arrangement and energy levels against the stated success criteria and name the next step.
...
- Science brief: electrons occupy discrete energy levels; they do not have arbitrary intermediate energies.
- Science brief: electrons occupy energy levels around the nucleus, with lower levels filled before higher ones in the ground state.
- Science brief: an electron moves between levels only by absorbing or emitting exactly the energy difference between them, which is why atomic spectra consist of discrete lines.
- Science brief: the arrangement of electrons, particularly in the outermost level, determines how an atom bonds.

### Evidence check: electron arrangement and energy levels

**Candidate claim:** A case report presents this as acceptable science: “electrons orbit the nucleus in fixed planetary paths at any energy.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: electrons occupy discrete energy levels; they do not have arbitrary intermediate energies. |
| E2 | established science reference | Science brief: electrons occupy energy levels around the nucleus, with lower levels filled before higher ones in the ground state. |
| E3 | established science reference | Science brief: an electron moves between levels only by absorbing or emitting exactly the energy difference between them, which is why atomic spectra consist of discrete lines. |
| E4 | established science reference | Science brief: the arrangement of electrons, particularly in the outermost level, determines how an atom bonds. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs10-chemistry-u02::electron arrangement and energy levels, derived from the reviewed correctness source policy/correctness/ma-hs10-chemistry.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about electron arrangement and energy levels, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about electron arrangement and energy levels, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about electron arrangement and energy levels, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain electron arrangement and energy levels in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for electron arrangement and energy levels. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about electron arrangement and energy levels, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using electron arrangement and energy levels as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about electron arrangement and energy levels? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about electron arrangement and energy levels that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about electron arrangement and energy levels. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about electron arrangement and energy levels.
...
- Apply electron arrangement and energy levels under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect electron arrangement and energy levels to subatomic structure and isotopes from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs10-chemistry-u02-l08` · lesson `ma-hs10-chemistry-u02-l08` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
