# Launch and diagnostic: nuclear composition and isotopes

**High School Chemistry (Grade 10)** · Unit 9: The Nucleus, Nuclear Energy, and a Chemistry Engineering Capstone · Day 1 of the unit (course day 97) · about 55–75 minutes
...
- Observe the anchoring phenomenon, surface initial thinking about nuclear composition and isotopes without penalty, and pose a testable question.
...
**The task.** What does evidence E1 through E4 justify about nuclear composition and isotopes, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**Q1.** Use the printed case as today's phenomenon for nuclear composition and isotopes. Record what the candidate claim says, identify the mismatch with E1-E4, and pose a testable question naming what would change and what would be measured or classified.
...
_Package `swp-ma-hs10-chemistry-u09-l01` · lesson `ma-hs10-chemistry-u09-l01` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
