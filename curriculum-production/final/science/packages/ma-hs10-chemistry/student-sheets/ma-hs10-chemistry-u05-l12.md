# Correction and reflection: mathematical representations of reactions

**High School Chemistry (Grade 10)** · Unit 5: Conservation of Mass and Quantitative Reasoning in Reactions · Day 12 of the unit (course day 60) · about 55–75 minutes

**Today's focus:** mathematical representations of reactions
...
- Explain mathematical representations of reactions using evidence, a model, or a documented process rather than an unsupported answer.
- Apply mathematical representations of reactions to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on mathematical representations of reactions against the stated success criteria and name the next step.
...
- Science brief: a balanced equation is a mathematical statement about relative numbers of particles, and mole ratios are read directly from its coefficients.
- Science brief: mass, moles, and particle count are related through molar mass and Avogadro's number, and calculations move between them in a stated order.
- Science brief: a calculated result carries the units and the precision of the measurements it came from.

### Evidence check: mathematical representations of reactions

**Candidate claim:** A case report presents this as acceptable science: “reading mole ratios from an unbalanced equation.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a balanced equation is a mathematical statement about relative numbers of particles, and mole ratios are read directly from its coefficients. |
| E2 | established science reference | Science brief: mass, moles, and particle count are related through molar mass and Avogadro's number, and calculations move between them in a stated order. |
| E3 | established science reference | Science brief: a calculated result carries the units and the precision of the measurements it came from. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs10-chemistry-u05::mathematical representations of reactions, derived from the reviewed correctness source policy/correctness/ma-hs10-chemistry.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about mathematical representations of reactions, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about mathematical representations of reactions, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about mathematical representations of reactions, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain mathematical representations of reactions in your own words using at least two specifically named rows from E1-E3. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for mathematical representations of reactions. Decide whether E1-E3 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about mathematical representations of reactions, revise its weakest claim with a named row from E1-E3, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using mathematical representations of reactions as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about mathematical representations of reactions? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about mathematical representations of reactions that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about mathematical representations of reactions. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about mathematical representations of reactions.
...
- Apply mathematical representations of reactions under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect mathematical representations of reactions to conservation of atoms and mass from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs10-chemistry-u05-l12` · lesson `ma-hs10-chemistry-u05-l12` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
