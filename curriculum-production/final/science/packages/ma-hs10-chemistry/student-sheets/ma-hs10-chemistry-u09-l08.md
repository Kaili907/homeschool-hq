# Reteach and varied practice: radioactive decay and half-life

**High School Chemistry (Grade 10)** · Unit 9: The Nucleus, Nuclear Energy, and a Chemistry Engineering Capstone · Day 8 of the unit (course day 104) · about 55–75 minutes

**Today's focus:** radioactive decay and half-life
...
- Explain radioactive decay and half-life using evidence, a model, or a documented process rather than an unsupported answer.
- Apply radioactive decay and half-life to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on radioactive decay and half-life against the stated success criteria and name the next step.
...
- Science brief: half-life is the time for half of the nuclei in a sample to decay, and it is unaffected by temperature, pressure, or chemical combination.
- Science brief: alpha decay reduces the atomic number by two and the mass number by four; beta-minus decay increases the atomic number by one and leaves the mass number unchanged.
- Science brief: radioactive decay is a nuclear process, so it changes the element, unlike chemical reactions.
- Science brief: decay of an individual nucleus is random, while the behaviour of a large sample follows a predictable exponential pattern.

### Evidence check: radioactive decay and half-life

**Candidate claim:** A case report presents this as acceptable science: “half-life can be changed by heating, cooling, or chemically combining the substance.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: half-life is the time for half of the nuclei in a sample to decay, and it is unaffected by temperature, pressure, or chemical combination. |
| E2 | established science reference | Science brief: alpha decay reduces the atomic number by two and the mass number by four; beta-minus decay increases the atomic number by one and leaves the mass number unchanged. |
| E3 | established science reference | Science brief: radioactive decay is a nuclear process, so it changes the element, unlike chemical reactions. |
| E4 | established science reference | Science brief: decay of an individual nucleus is random, while the behaviour of a large sample follows a predictable exponential pattern. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs10-chemistry-u09::radioactive decay and half-life, derived from the reviewed correctness source policy/correctness/ma-hs10-chemistry.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about radioactive decay and half-life, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about radioactive decay and half-life, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about radioactive decay and half-life, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain radioactive decay and half-life in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for radioactive decay and half-life. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about radioactive decay and half-life, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using radioactive decay and half-life as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about radioactive decay and half-life? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about radioactive decay and half-life that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about radioactive decay and half-life. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about radioactive decay and half-life.
...
- Apply radioactive decay and half-life under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect radioactive decay and half-life to nuclear composition and isotopes from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs10-chemistry-u09-l08` · lesson `ma-hs10-chemistry-u09-l08` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
