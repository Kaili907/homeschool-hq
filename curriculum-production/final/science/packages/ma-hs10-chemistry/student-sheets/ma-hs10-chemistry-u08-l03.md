# Guided practice A: stress and system response

**High School Chemistry (Grade 10)** · Unit 8: Equilibrium and the Design of Chemical Systems · Day 3 of the unit (course day 87) · about 55–75 minutes
...
- Science brief: a system at equilibrium responds to a change in conditions by shifting in the direction that partially counteracts that change.
- Science brief: changing concentration, pressure, or temperature disturbs the balance of forward and reverse rates, and the system shifts until they are equal again.
- Science brief: the shift partially offsets the change; it does not restore the original conditions.
- Science brief: temperature is the only one of these changes that alters the equilibrium position by changing the balance of the reaction's own energetics rather than by changing amounts.

### Evidence check: stress and system response

**Candidate claim:** A case report presents this as acceptable science: “the system returns exactly to its original conditions after a disturbance.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a system at equilibrium responds to a change in conditions by shifting in the direction that partially counteracts that change. |
| E2 | established science reference | Science brief: changing concentration, pressure, or temperature disturbs the balance of forward and reverse rates, and the system shifts until they are equal again. |
| E3 | established science reference | Science brief: the shift partially offsets the change; it does not restore the original conditions. |
| E4 | established science reference | Science brief: temperature is the only one of these changes that alters the equilibrium position by changing the balance of the reaction's own energetics rather than by changing amounts. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs10-chemistry-u08::stress and system response, derived from the reviewed correctness source policy/correctness/ma-hs10-chemistry.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about stress and system response, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about stress and system response, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**Q1.** Explain stress and system response in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for stress and system response. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about stress and system response, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using stress and system response as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about stress and system response? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about stress and system response that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about stress and system response. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
_Package `swp-ma-hs10-chemistry-u08-l03` · lesson `ma-hs10-chemistry-u08-l03` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
