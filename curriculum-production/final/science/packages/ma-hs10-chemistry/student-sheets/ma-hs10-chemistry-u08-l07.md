# Investigation: reversible reactions

**High School Chemistry (Grade 10)** · Unit 8: Equilibrium and the Design of Chemical Systems · Day 7 of the unit (course day 91) · about 61–84 minutes

**Today's focus:** reversible reactions
...
- Plan and carry out a safe investigation of reversible reactions, or its stated alternative, and record the learner's own data with its uncertainty.
- Explain reversible reactions using evidence, a model, or a documented process rather than an unsupported answer.
- Apply reversible reactions to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on reversible reactions against the stated success criteria and name the next step.
...
- a tray to work over
- thermometer
- a cool water bath and a warm water bath below 50 degrees Celsius, poured by an adult
- notebook
...
- **Chemical hazard.** Acidic and basic solutions sting eyes and irritate skin.
  - What stops it: Wear eye protection, work over a tray, use small volumes with droppers, and rinse any splash with water for 15 minutes.
- **Chemical hazard.** Household chemical mixing beyond the listed materials can produce toxic gas.
  - What stops it: Use ONLY cabbage indicator, vinegar, baking soda, and carbonated water. Never introduce a cleaning product. This prohibition is not disableable.
- **Physical hazard.** A sealed carbonated bottle is a pressure vessel, and warming or shaking it turns the cap into a projectile.
  - What stops it: A carbonated bottle is never warmed above 40 degrees Celsius, never shaken while closed, and is always opened slowly with the cap pointed away from every face.
- **Physical hazard.** Warm water can scald.
  - What stops it: An adult pours the warm bath and confirms with the thermometer that it reads below 50 degrees Celsius. Temperature is judged with the thermometer, never with a hand.
...
**Clearing up.** Pour all indicator, vinegar, baking-soda, and carbonated solutions down the drain with the tap running, rinse the cups and droppers, and wipe the tray. Open and empty any carbonated bottle before recycling it. No solution is stored or reused.
...
- Science brief: a reversible reaction proceeds in both directions, and reactants are never completely converted to products in a closed system.
- Science brief: in a reversible reaction the products re-form the reactants as well as the reverse, so both are present at all times.
- Science brief: the double arrow notation states that both directions occur under the same conditions.
- Science brief: reversibility is a property of the reaction under the stated conditions, not a claim that it can be undone by any means.

### Evidence check: reversible reactions

**Candidate claim:** A case report presents this as acceptable science: “a reversible reaction goes to completion in a closed system.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a reversible reaction proceeds in both directions, and reactants are never completely converted to products in a closed system. |
| E2 | established science reference | Science brief: in a reversible reaction the products re-form the reactants as well as the reverse, so both are present at all times. |
| E3 | established science reference | Science brief: the double arrow notation states that both directions occur under the same conditions. |
| E4 | established science reference | Science brief: reversibility is a property of the reaction under the stated conditions, not a claim that it can be undone by any means. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs10-chemistry-u08::reversible reactions, derived from the reviewed correctness source policy/correctness/ma-hs10-chemistry.correctness.json.

**Supplied unit connections:** reversible reactions; dynamic equilibrium; stress and system response; shifting equilibrium by changing conditions; yield and industrial trade-offs; refining a chemical system design

**Supplied unit performance task:** Refine the design of a chemical system by specifying a condition change that would increase product at equilibrium, and defend the change with evidence and stated trade-offs.

### Bound task

**Question:** What does evidence E1 through E4 justify about reversible reactions, and does it support the candidate claim?
...
| 1 | none | 60 | 40 | 100 |
| 2 | none | 55 | 45 | 100 |
| 3 | add 20 A | 75 | 45 | 120 |
| 4 | re-equilibrate | 66 | 54 | 120 |
| 5 | re-equilibrate | 62 | 58 | 120 |

**Model/source rule:** At each equilibrium step, 20% of A converts to B and 30% of B converts to A, rounded to whole particles; step 3 adds A before conversion resumes.
...
3. Calculate forward and reverse changes at two steps, identify dynamic equilibrium, and explain the response to added A without claiming that either reaction stops.
...
**Pinned H4 alternative statement (lineage evidence):** Observe the carbon-dioxide equilibrium in carbonated water alone - sealed versus open, cool versus warm - with no indicator chemistry, or reason from a published equilibrium dataset. Kitchen materials or paper.
...
**My question.** Write the question you are testing about reversible reactions. It has to be a question your evidence could actually answer.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about reversible reactions, then name one check that would catch an error or a weak claim.**
...
**Q1.** Complete the route you chose. For the document/model route, use its printed procedure and input table; for the H4 physical route, use the printed safe order and your own blank record. Report the route, evidence IDs or model rows, conclusion about reversible reactions, uncertainty, and limitation.

>

**Q2.** Explain reversible reactions in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for reversible reactions. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about reversible reactions, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using reversible reactions as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E4 is strongest for evaluating the candidate claim about reversible reactions? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E4, state one conclusion about reversible reactions that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about reversible reactions. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about reversible reactions.
...
- Apply reversible reactions under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect reversible reactions to dynamic equilibrium from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Refine the design of a chemical system by specifying a condition change that would increase product at equilibrium, and defend the change with evidence and stated trade-offs. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-hs10-chemistry-u08-l07` · lesson `ma-hs10-chemistry-u08-l07` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
