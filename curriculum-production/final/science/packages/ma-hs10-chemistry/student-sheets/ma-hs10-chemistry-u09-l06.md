# Guided practice B: criteria, constraints, and trade-offs in chemical engineering

**High School Chemistry (Grade 10)** · Unit 9: The Nucleus, Nuclear Energy, and a Chemistry Engineering Capstone · Day 6 of the unit (course day 102) · about 55–75 minutes
...
3. Sort all evidence as supports, challenges, or does not decide, and justify every placement.
...
_Package `swp-ma-hs10-chemistry-u09-l06` · lesson `ma-hs10-chemistry-u09-l06` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
