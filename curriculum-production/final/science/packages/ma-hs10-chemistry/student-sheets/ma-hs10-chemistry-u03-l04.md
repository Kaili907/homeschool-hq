# Independent application A: conductivity, melting point, and solubility

**High School Chemistry (Grade 10)** · Unit 3: Bonding, Structure, and the Properties of Designed Materials · Day 4 of the unit (course day 28) · about 55–75 minutes

**Today's focus:** conductivity, melting point, and solubility
...
- Explain conductivity, melting point, and solubility using evidence, a model, or a documented process rather than an unsupported answer.
- Apply conductivity, melting point, and solubility to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on conductivity, melting point, and solubility against the stated success criteria and name the next step.
...
- Science brief: ionic compounds do not conduct as solids but do when molten or dissolved, because the ions become free to move.
- Science brief: metals conduct in the solid state because their electrons are delocalised.
- Science brief: electrical conduction requires charged particles free to move: delocalised electrons in metals, mobile ions in molten or dissolved ionic compounds.
- Science brief: melting point reflects the energy needed to overcome the forces holding particles in the solid structure.

### Evidence check: conductivity, melting point, and solubility

**Candidate claim:** A case report presents this as acceptable science: “solid ionic compounds conduct electricity.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: ionic compounds do not conduct as solids but do when molten or dissolved, because the ions become free to move. |
| E2 | established science reference | Science brief: metals conduct in the solid state because their electrons are delocalised. |
| E3 | established science reference | Science brief: electrical conduction requires charged particles free to move: delocalised electrons in metals, mobile ions in molten or dissolved ionic compounds. |
| E4 | established science reference | Science brief: melting point reflects the energy needed to overcome the forces holding particles in the solid structure. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs10-chemistry-u03::conductivity, melting point, and solubility, derived from the reviewed correctness source policy/correctness/ma-hs10-chemistry.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about conductivity, melting point, and solubility, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about conductivity, melting point, and solubility, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about conductivity, melting point, and solubility, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain conductivity, melting point, and solubility in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for conductivity, melting point, and solubility. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about conductivity, melting point, and solubility, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using conductivity, melting point, and solubility as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about conductivity, melting point, and solubility? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about conductivity, melting point, and solubility that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about conductivity, melting point, and solubility. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about conductivity, melting point, and solubility.
...
- Apply conductivity, melting point, and solubility under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect conductivity, melting point, and solubility to ionic, covalent, and metallic bonding from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs10-chemistry-u03-l04` · lesson `ma-hs10-chemistry-u03-l04` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
