# Concept model A: reaction types and patterns

**High School Chemistry (Grade 10)** · Unit 4: Chemical Reactions and Electron Rearrangement · Day 2 of the unit (course day 38) · about 55–75 minutes
...
_Package `swp-ma-hs10-chemistry-u04-l02` · lesson `ma-hs10-chemistry-u04-l02` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
