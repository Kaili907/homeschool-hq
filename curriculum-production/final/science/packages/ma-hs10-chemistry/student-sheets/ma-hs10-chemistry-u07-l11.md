# Unit assessment: catalysts

**High School Chemistry (Grade 10)** · Unit 7: Reaction Rates and the Conditions That Change Them · Day 11 of the unit (course day 83) · about 55–75 minutes

**Today's focus:** catalysts
...
- Explain catalysts using evidence, a model, or a documented process rather than an unsupported answer.
- Apply catalysts to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on catalysts against the stated success criteria and name the next step.
...
- Science brief: a catalyst increases reaction rate by providing a pathway with lower activation energy, and it is not consumed by the reaction.
- Science brief: a catalyst lowers the activation energy, so a larger fraction of collisions is effective at any given temperature.
- Science brief: a catalyst does not change the overall energy change of the reaction or the position of equilibrium; it speeds the forward and reverse directions equally.
- Science brief: enzymes are biological catalysts and follow the same principles.

### Evidence check: catalysts

**Candidate claim:** A case report presents this as acceptable science: “a catalyst is consumed by the reaction it catalyses.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a catalyst increases reaction rate by providing a pathway with lower activation energy, and it is not consumed by the reaction. |
| E2 | established science reference | Science brief: a catalyst lowers the activation energy, so a larger fraction of collisions is effective at any given temperature. |
| E3 | established science reference | Science brief: a catalyst does not change the overall energy change of the reaction or the position of equilibrium; it speeds the forward and reverse directions equally. |
| E4 | established science reference | Science brief: enzymes are biological catalysts and follow the same principles. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs10-chemistry-u07::catalysts, derived from the reviewed correctness source policy/correctness/ma-hs10-chemistry.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about catalysts, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about catalysts, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about catalysts, then name one check that would catch an error or a weak claim.**
...
**Q1.** Without copying a sentence from the brief, evaluate the printed candidate case about catalysts. Cite E1-E4, write the reasoning in your own words, and correct the case claim so it fits exactly what the record establishes.

>

**Q2.** Explain catalysts in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for catalysts. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about catalysts, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using catalysts as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E4 is strongest for evaluating the candidate claim about catalysts? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E4, state one conclusion about catalysts that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about catalysts. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about catalysts.
...
- Apply catalysts under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect catalysts to collision model of reactions from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs10-chemistry-u07-l11` · lesson `ma-hs10-chemistry-u07-l11` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
