# Independent application A: shifting equilibrium by changing conditions

**High School Chemistry (Grade 10)** · Unit 8: Equilibrium and the Design of Chemical Systems · Day 4 of the unit (course day 88) · about 55–75 minutes

**Today's focus:** shifting equilibrium by changing conditions
...
- Explain shifting equilibrium by changing conditions using evidence, a model, or a documented process rather than an unsupported answer.
- Apply shifting equilibrium by changing conditions to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on shifting equilibrium by changing conditions against the stated success criteria and name the next step.
...
- Science brief: increasing the concentration of a reactant shifts the equilibrium toward products; increasing pressure on a gas-phase equilibrium shifts it toward the side with fewer gas particles.
- Science brief: adding a substance shifts the system away from that substance; removing one shifts it toward that substance.
- Science brief: for gas-phase equilibria, raising pressure by reducing volume favours the side with fewer moles of gas.
- Science brief: raising temperature favours the endothermic direction; lowering it favours the exothermic direction.

### Evidence check: shifting equilibrium by changing conditions

**Candidate claim:** A case report presents this as acceptable science: “raising temperature always increases product yield regardless of the reaction's energetics.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: increasing the concentration of a reactant shifts the equilibrium toward products; increasing pressure on a gas-phase equilibrium shifts it toward the side with fewer gas particles. |
| E2 | established science reference | Science brief: adding a substance shifts the system away from that substance; removing one shifts it toward that substance. |
| E3 | established science reference | Science brief: for gas-phase equilibria, raising pressure by reducing volume favours the side with fewer moles of gas. |
| E4 | established science reference | Science brief: raising temperature favours the endothermic direction; lowering it favours the exothermic direction. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs10-chemistry-u08::shifting equilibrium by changing conditions, derived from the reviewed correctness source policy/correctness/ma-hs10-chemistry.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about shifting equilibrium by changing conditions, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about shifting equilibrium by changing conditions, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about shifting equilibrium by changing conditions, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain shifting equilibrium by changing conditions in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for shifting equilibrium by changing conditions. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about shifting equilibrium by changing conditions, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using shifting equilibrium by changing conditions as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about shifting equilibrium by changing conditions? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about shifting equilibrium by changing conditions that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about shifting equilibrium by changing conditions. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about shifting equilibrium by changing conditions.
...
- Apply shifting equilibrium by changing conditions under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect shifting equilibrium by changing conditions to reversible reactions from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs10-chemistry-u08-l04` · lesson `ma-hs10-chemistry-u08-l04` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
