# Independent application A: oxidation and reduction basics

**High School Chemistry (Grade 10)** · Unit 4: Chemical Reactions and Electron Rearrangement · Day 4 of the unit (course day 40) · about 55–75 minutes

**Today's focus:** oxidation and reduction basics
...
- Explain oxidation and reduction basics using evidence, a model, or a documented process rather than an unsupported answer.
- Apply oxidation and reduction basics to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on oxidation and reduction basics against the stated success criteria and name the next step.
...
- Science brief: oxidation is loss of electrons; reduction is gain of electrons.
- Science brief: oxidation and reduction always occur together: electrons lost by one species are gained by another.
- Science brief: in a redox reaction, the species oxidised is the reducing agent and the species reduced is the oxidising agent.
- Science brief: because electrons are conserved, the electrons lost in the oxidation equal the electrons gained in the reduction.

### Evidence check: oxidation and reduction basics

**Candidate claim:** A case report presents this as acceptable science: “oxidation is gain of electrons or reduction is loss of electrons.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: oxidation is loss of electrons; reduction is gain of electrons. |
| E2 | established science reference | Science brief: oxidation and reduction always occur together: electrons lost by one species are gained by another. |
| E3 | established science reference | Science brief: in a redox reaction, the species oxidised is the reducing agent and the species reduced is the oxidising agent. |
| E4 | established science reference | Science brief: because electrons are conserved, the electrons lost in the oxidation equal the electrons gained in the reduction. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs10-chemistry-u04::oxidation and reduction basics, derived from the reviewed correctness source policy/correctness/ma-hs10-chemistry.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about oxidation and reduction basics, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about oxidation and reduction basics, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about oxidation and reduction basics, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain oxidation and reduction basics in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for oxidation and reduction basics. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about oxidation and reduction basics, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using oxidation and reduction basics as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about oxidation and reduction basics? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about oxidation and reduction basics that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about oxidation and reduction basics. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about oxidation and reduction basics.
...
- Apply oxidation and reduction basics under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect oxidation and reduction basics to evidence of chemical change from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs10-chemistry-u04-l04` · lesson `ma-hs10-chemistry-u04-l04` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
