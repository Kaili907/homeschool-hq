# Unit assessment: yield and industrial trade-offs

**High School Chemistry (Grade 10)** · Unit 8: Equilibrium and the Design of Chemical Systems · Day 11 of the unit (course day 95) · about 55–75 minutes

**Today's focus:** yield and industrial trade-offs
...
- Demonstrate independent mastery evidence for yield and industrial trade-offs on a fresh task.
- Explain yield and industrial trade-offs using evidence, a model, or a documented process rather than an unsupported answer.
- Apply yield and industrial trade-offs to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on yield and industrial trade-offs against the stated success criteria and name the next step.
...
- Science brief: industrial conditions balance equilibrium yield against reaction rate, energy cost, equipment limits, and safety.
- Science brief: conditions that maximise yield often reduce rate, and the chosen compromise is not the maximum of either.
- Science brief: recycling unreacted material raises overall conversion without changing the equilibrium position.

### Evidence check: yield and industrial trade-offs

**Candidate claim:** A case report presents this as acceptable science: “industrial conditions are chosen to maximise equilibrium yield alone.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: industrial conditions balance equilibrium yield against reaction rate, energy cost, equipment limits, and safety. |
| E2 | established science reference | Science brief: conditions that maximise yield often reduce rate, and the chosen compromise is not the maximum of either. |
| E3 | established science reference | Science brief: recycling unreacted material raises overall conversion without changing the equilibrium position. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs10-chemistry-u08::yield and industrial trade-offs, derived from the reviewed correctness source policy/correctness/ma-hs10-chemistry.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about yield and industrial trade-offs, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about yield and industrial trade-offs, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about yield and industrial trade-offs, then name one check that would catch an error or a weak claim.**
...
**Q1.** Without copying a sentence from the brief, evaluate the printed candidate case about yield and industrial trade-offs. Cite E1-E3, write the reasoning in your own words, and correct the case claim so it fits exactly what the record establishes.

>

**Q2.** Explain yield and industrial trade-offs in your own words using at least two specifically named rows from E1-E3. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for yield and industrial trade-offs. Decide whether E1-E3 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about yield and industrial trade-offs, revise its weakest claim with a named row from E1-E3, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using yield and industrial trade-offs as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E3 is strongest for evaluating the candidate claim about yield and industrial trade-offs? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E3, state one conclusion about yield and industrial trade-offs that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about yield and industrial trade-offs. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about yield and industrial trade-offs.
...
- Apply yield and industrial trade-offs under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect yield and industrial trade-offs to reversible reactions from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs10-chemistry-u08-l11` · lesson `ma-hs10-chemistry-u08-l11` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
