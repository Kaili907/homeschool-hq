# Correction and reflection: chemical safety and hazard reading

**High School Chemistry (Grade 10)** · Unit 1: Matter, Measurement, and Laboratory Practice · Day 12 of the unit (course day 12) · about 55–75 minutes

**Today's focus:** chemical safety and hazard reading
...
- Explain chemical safety and hazard reading using evidence, a model, or a documented process rather than an unsupported answer.
- Apply chemical safety and hazard reading to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on chemical safety and hazard reading against the stated success criteria and name the next step.
...
- Science brief: a safety data sheet states hazards, handling, storage, first aid, and disposal for a specific substance.
- Science brief: hazard information is specific to the substance and to its concentration and form; a dilute solution and a concentrated one are not interchangeable.
- Science brief: hazard pictograms and hazard statements identify the type of hazard; the handling instructions state what to do about it.
- Science brief: reading hazard information happens before the substance is handled, not after something goes wrong.

### Evidence check: chemical safety and hazard reading

**Candidate claim:** A case report presents this as acceptable science: “a household or naturally occurring substance is safe by virtue of being household or natural.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a safety data sheet states hazards, handling, storage, first aid, and disposal for a specific substance. |
| E2 | established science reference | Science brief: hazard information is specific to the substance and to its concentration and form; a dilute solution and a concentrated one are not interchangeable. |
| E3 | established science reference | Science brief: hazard pictograms and hazard statements identify the type of hazard; the handling instructions state what to do about it. |
| E4 | established science reference | Science brief: reading hazard information happens before the substance is handled, not after something goes wrong. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs10-chemistry-u01::chemical safety and hazard reading, derived from the reviewed correctness source policy/correctness/ma-hs10-chemistry.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about chemical safety and hazard reading, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about chemical safety and hazard reading, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about chemical safety and hazard reading, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain chemical safety and hazard reading in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for chemical safety and hazard reading. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about chemical safety and hazard reading, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using chemical safety and hazard reading as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about chemical safety and hazard reading? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about chemical safety and hazard reading that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about chemical safety and hazard reading. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about chemical safety and hazard reading.
...
- Apply chemical safety and hazard reading under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect chemical safety and hazard reading to physical and chemical properties from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs10-chemistry-u01-l12` · lesson `ma-hs10-chemistry-u01-l12` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
