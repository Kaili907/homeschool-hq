# Correction and reflection: communicating technical information

**High School Chemistry (Grade 10)** · Unit 3: Bonding, Structure, and the Properties of Designed Materials · Day 12 of the unit (course day 36) · about 55–75 minutes

**Today's focus:** communicating technical information
...
- Explain communicating technical information using evidence, a model, or a documented process rather than an unsupported answer.
- Apply communicating technical information to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on communicating technical information against the stated success criteria and name the next step.
...
- Science brief: a technical explanation states the claim, the evidence, and the particle-level reasoning that connects them.
- Science brief: chemical notation, diagrams, and prose each carry different information, and the choice is made for what needs to be shown.
- Science brief: an explanation states the limits of the evidence rather than presenting an inference as a measurement.

### Evidence check: communicating technical information

**Candidate claim:** A case report presents this as acceptable science: “presenting an inferred structure as though it had been directly observed.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a technical explanation states the claim, the evidence, and the particle-level reasoning that connects them. |
| E2 | established science reference | Science brief: chemical notation, diagrams, and prose each carry different information, and the choice is made for what needs to be shown. |
| E3 | established science reference | Science brief: an explanation states the limits of the evidence rather than presenting an inference as a measurement. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs10-chemistry-u03::communicating technical information, derived from the reviewed correctness source policy/correctness/ma-hs10-chemistry.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about communicating technical information, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about communicating technical information, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about communicating technical information, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain communicating technical information in your own words using at least two specifically named rows from E1-E3. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for communicating technical information. Decide whether E1-E3 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about communicating technical information, revise its weakest claim with a named row from E1-E3, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using communicating technical information as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about communicating technical information? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about communicating technical information that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about communicating technical information. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about communicating technical information.
...
- Apply communicating technical information under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect communicating technical information to ionic, covalent, and metallic bonding from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs10-chemistry-u03-l12` · lesson `ma-hs10-chemistry-u03-l12` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
