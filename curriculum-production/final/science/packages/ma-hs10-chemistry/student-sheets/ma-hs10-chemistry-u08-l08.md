# Reteach and varied practice: dynamic equilibrium

**High School Chemistry (Grade 10)** · Unit 8: Equilibrium and the Design of Chemical Systems · Day 8 of the unit (course day 92) · about 55–75 minutes

**Today's focus:** dynamic equilibrium
...
- Explain dynamic equilibrium using evidence, a model, or a documented process rather than an unsupported answer.
- Apply dynamic equilibrium to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on dynamic equilibrium against the stated success criteria and name the next step.
...
- Science brief: at equilibrium the forward and reverse reaction rates are equal, so concentrations remain constant while both reactions continue.
- Science brief: equilibrium is dynamic: both reactions continue at equal rates, and the system is not static.
- Science brief: equal rates do not mean equal concentrations; the concentrations at equilibrium depend on the reaction.
- Science brief: equilibrium is reached only in a closed system, since an open one loses products or reactants.

### Evidence check: dynamic equilibrium

**Candidate claim:** A case report presents this as acceptable science: “reactions stop at equilibrium.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: at equilibrium the forward and reverse reaction rates are equal, so concentrations remain constant while both reactions continue. |
| E2 | established science reference | Science brief: equilibrium is dynamic: both reactions continue at equal rates, and the system is not static. |
| E3 | established science reference | Science brief: equal rates do not mean equal concentrations; the concentrations at equilibrium depend on the reaction. |
| E4 | established science reference | Science brief: equilibrium is reached only in a closed system, since an open one loses products or reactants. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs10-chemistry-u08::dynamic equilibrium, derived from the reviewed correctness source policy/correctness/ma-hs10-chemistry.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about dynamic equilibrium, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about dynamic equilibrium, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about dynamic equilibrium, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain dynamic equilibrium in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for dynamic equilibrium. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about dynamic equilibrium, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using dynamic equilibrium as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about dynamic equilibrium? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about dynamic equilibrium that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about dynamic equilibrium. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about dynamic equilibrium.
...
- Apply dynamic equilibrium under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect dynamic equilibrium to reversible reactions from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs10-chemistry-u08-l08` · lesson `ma-hs10-chemistry-u08-l08` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
