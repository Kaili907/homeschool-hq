# Guided practice A: fission

**High School Chemistry (Grade 10)** · Unit 9: The Nucleus, Nuclear Energy, and a Chemistry Engineering Capstone · Day 3 of the unit (course day 99) · about 55–75 minutes
...
- Science brief: fission is the splitting of a heavy nucleus into lighter nuclei, releasing energy and typically neutrons.
- Science brief: fission of a heavy nucleus releases energy because the products are more tightly bound per nucleon than the original nucleus.
- Science brief: released neutrons can induce further fissions, which is the basis of a chain reaction.
- Science brief: control of a fission reactor works by controlling the number of neutrons available to induce further fission.

### Evidence check: fission

**Candidate claim:** A case report presents this as acceptable science: “fission is the combining of nuclei.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: fission is the splitting of a heavy nucleus into lighter nuclei, releasing energy and typically neutrons. |
| E2 | established science reference | Science brief: fission of a heavy nucleus releases energy because the products are more tightly bound per nucleon than the original nucleus. |
| E3 | established science reference | Science brief: released neutrons can induce further fissions, which is the basis of a chain reaction. |
| E4 | established science reference | Science brief: control of a fission reactor works by controlling the number of neutrons available to induce further fission. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs10-chemistry-u09::fission, derived from the reviewed correctness source policy/correctness/ma-hs10-chemistry.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about fission, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about fission, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**Q1.** Explain fission in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for fission. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about fission, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using fission as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about fission? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about fission that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about fission. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
_Package `swp-ma-hs10-chemistry-u09-l03` · lesson `ma-hs10-chemistry-u09-l03` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
