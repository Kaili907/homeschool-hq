# Reteach and varied practice: temperature and reaction rate

**High School Chemistry (Grade 10)** · Unit 7: Reaction Rates and the Conditions That Change Them · Day 8 of the unit (course day 80) · about 55–75 minutes

**Today's focus:** temperature and reaction rate
...
- Explain temperature and reaction rate using evidence, a model, or a documented process rather than an unsupported answer.
- Apply temperature and reaction rate to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on temperature and reaction rate against the stated success criteria and name the next step.
...
- Science brief: raising the temperature increases reaction rate.
- Science brief: higher temperature increases the average kinetic energy of particles, so collisions are both more frequent and more often energetic enough to react.
- Science brief: the increase in the fraction of sufficiently energetic collisions is the larger of the two effects.
- Science brief: temperature affects rate; it does not change whether a reaction is exothermic or endothermic.

### Evidence check: temperature and reaction rate

**Candidate claim:** A case report presents this as acceptable science: “higher temperature works only by making collisions more frequent.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: raising the temperature increases reaction rate. |
| E2 | established science reference | Science brief: higher temperature increases the average kinetic energy of particles, so collisions are both more frequent and more often energetic enough to react. |
| E3 | established science reference | Science brief: the increase in the fraction of sufficiently energetic collisions is the larger of the two effects. |
| E4 | established science reference | Science brief: temperature affects rate; it does not change whether a reaction is exothermic or endothermic. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs10-chemistry-u07::temperature and reaction rate, derived from the reviewed correctness source policy/correctness/ma-hs10-chemistry.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about temperature and reaction rate, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about temperature and reaction rate, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about temperature and reaction rate, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain temperature and reaction rate in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for temperature and reaction rate. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about temperature and reaction rate, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using temperature and reaction rate as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about temperature and reaction rate? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about temperature and reaction rate that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about temperature and reaction rate. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about temperature and reaction rate.
...
- Apply temperature and reaction rate under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect temperature and reaction rate to collision model of reactions from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs10-chemistry-u07-l08` · lesson `ma-hs10-chemistry-u07-l08` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
