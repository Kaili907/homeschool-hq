# Guided practice B: refining a chemical system design

**High School Chemistry (Grade 10)** · Unit 8: Equilibrium and the Design of Chemical Systems · Day 6 of the unit (course day 90) · about 55–75 minutes
...
_Package `swp-ma-hs10-chemistry-u08-l06` · lesson `ma-hs10-chemistry-u08-l06` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
