# Guided practice B: explaining rate with scientific principles

**High School Chemistry (Grade 10)** · Unit 7: Reaction Rates and the Conditions That Change Them · Day 6 of the unit (course day 78) · about 55–75 minutes
...
_Package `swp-ma-hs10-chemistry-u07-l06` · lesson `ma-hs10-chemistry-u07-l06` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
