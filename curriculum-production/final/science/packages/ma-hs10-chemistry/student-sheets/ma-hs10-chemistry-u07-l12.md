# Correction and reflection: explaining rate with scientific principles

**High School Chemistry (Grade 10)** · Unit 7: Reaction Rates and the Conditions That Change Them · Day 12 of the unit (course day 84) · about 55–75 minutes

**Today's focus:** explaining rate with scientific principles
...
- Explain explaining rate with scientific principles using evidence, a model, or a documented process rather than an unsupported answer.
- Apply explaining rate with scientific principles to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on explaining rate with scientific principles against the stated success criteria and name the next step.
...
- Science brief: a rate explanation identifies which factor was changed and connects it to collision frequency, collision energy, or activation energy.
- Science brief: naming the factor is description; connecting it to the collision model is explanation.
- Science brief: an explanation is tested by whether it also predicts what happens when the factor is changed the other way.

### Evidence check: explaining rate with scientific principles

**Candidate claim:** A case report presents this as acceptable science: “attributing a rate change to a factor without identifying the mechanism it acts through.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a rate explanation identifies which factor was changed and connects it to collision frequency, collision energy, or activation energy. |
| E2 | established science reference | Science brief: naming the factor is description; connecting it to the collision model is explanation. |
| E3 | established science reference | Science brief: an explanation is tested by whether it also predicts what happens when the factor is changed the other way. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs10-chemistry-u07::explaining rate with scientific principles, derived from the reviewed correctness source policy/correctness/ma-hs10-chemistry.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about explaining rate with scientific principles, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about explaining rate with scientific principles, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about explaining rate with scientific principles, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain explaining rate with scientific principles in your own words using at least two specifically named rows from E1-E3. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for explaining rate with scientific principles. Decide whether E1-E3 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about explaining rate with scientific principles, revise its weakest claim with a named row from E1-E3, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using explaining rate with scientific principles as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about explaining rate with scientific principles? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about explaining rate with scientific principles that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about explaining rate with scientific principles. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about explaining rate with scientific principles.
...
- Apply explaining rate with scientific principles under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect explaining rate with scientific principles to collision model of reactions from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs10-chemistry-u07-l12` · lesson `ma-hs10-chemistry-u07-l12` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
