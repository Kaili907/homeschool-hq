# Scoring authority — Investigation: reversible reactions

**High School Chemistry (Grade 10)** · Unit 8: Equilibrium and the Design of Chemical Systems · Day 7 · lesson `ma-hs10-chemistry-u08-l07`
...
_Topic `ma-hs10-chemistry-u08::reversible reactions` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-hs10-chemistry.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- A reversible reaction proceeds in both directions, and reactants are never completely converted to products in a closed system.

**Accepted relationships and models.** What this lesson's learning target asserts:

- In a reversible reaction the products re-form the reactants as well as the reverse, so both are present at all times.
- The double arrow notation states that both directions occur under the same conditions.
- Reversibility is a property of the reaction under the stated conditions, not a claim that it can be undone by any means.
...
- Claiming a reversible reaction goes to completion in a closed system.
- Claiming the reverse reaction begins only after the forward reaction has finished.
- Claiming reversibility means the reaction produces no net change ever.

**Grade boundary.** Equilibrium constant expressions and quantitative equilibrium calculation are beyond this course.
...
**Q1 — investigate.** _Serves objective 1:_ Plan and carry out a safe investigation of reversible reactions, or its stated alternative, and record the learner's own data with its uncertainty.
...
**Q2 — explain with evidence.** _Serves objective 2:_ Explain reversible reactions using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q3 — apply new task.** _Serves objective 3:_ Apply reversible reactions to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q4 — check revise next step.** _Serves objective 4:_ Check and revise the work on reversible reactions against the stated success criteria and name the next step.
...
**Q5 — essential question.** _Serves objective 3:_ Apply reversible reactions to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q6 — evidence quality.** _Serves objective 2:_ Explain reversible reactions using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q7 — limitation.** _Serves objective 1:_ Plan and carry out a safe investigation of reversible reactions, or its stated alternative, and record the learner's own data with its uncertainty.
...
**Q8 — provenance.** _Serves objective 1:_ Plan and carry out a safe investigation of reversible reactions, or its stated alternative, and record the learner's own data with its uncertainty.
...
- **prerequisite-gap** — Run the prerequisite reteach route for reversible reactions (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for reversible reactions (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for reversible reactions (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for reversible reactions (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for reversible reactions (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs10-chemistry-u08-l07` · built from `hs912-science-h4` at `a86780a`._
