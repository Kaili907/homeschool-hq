# Scoring authority — Investigation: ionic, covalent, and metallic bonding

**High School Chemistry (Grade 10)** · Unit 3: Bonding, Structure, and the Properties of Designed Materials · Day 7 · lesson `ma-hs10-chemistry-u03-l07`
...
_Topic `ma-hs10-chemistry-u03::ionic, covalent, and metallic bonding` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs10-chemistry.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Ionic bonding involves the transfer of electrons from one atom to another, producing oppositely charged ions held together by electrostatic attraction.
- Covalent bonding involves the sharing of electron pairs between atoms.
- Metallic bonding involves positive metal ions in a shared, delocalised sea of electrons.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Ionic bonds typically form between a metal and a non-metal, where the difference in attraction for electrons is large enough for transfer.
- Covalent bonds typically form between non-metals, and the sharing is equal only when the two atoms attract electrons equally; otherwise the bond is polar.
- Metallic bonding leaves electrons free to move through the structure, which is what makes metals conduct and deform without shattering.

**Also correct.** Accept any of these framings — do not require the wording above:

- Describing bond character as a continuum from pure covalent through polar covalent to ionic is more accurate than three discrete boxes, and is fully acceptable.
...
- Claiming ionic bonds form when atoms share electrons, equally or otherwise.
- Claiming covalent bonds form by the transfer of electrons.
- Claiming all covalent bonds share electrons equally, or that polar covalent bonds are ionic.

**Grade boundary.** Molecular orbital theory, formal electronegativity cutoffs, and band theory are beyond this course.
...
> Learner's own solubility and conductivity observations plus published melting-point tables. Rankings are inferred by the learner from what they observe.
...
**Q1 — investigate.** _Serves objective 1:_ Plan and carry out a safe investigation of ionic, covalent, and metallic bonding, or its stated alternative, and record the learner's own data with its uncertainty.
...
**Q2 — explain with evidence.** _Serves objective 2:_ Explain ionic, covalent, and metallic bonding using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q3 — apply new task.** _Serves objective 3:_ Apply ionic, covalent, and metallic bonding to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q4 — check revise next step.** _Serves objective 4:_ Check and revise the work on ionic, covalent, and metallic bonding against the stated success criteria and name the next step.
...
**Q5 — essential question.** _Serves objective 3:_ Apply ionic, covalent, and metallic bonding to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q6 — evidence quality.** _Serves objective 2:_ Explain ionic, covalent, and metallic bonding using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q7 — limitation.** _Serves objective 1:_ Plan and carry out a safe investigation of ionic, covalent, and metallic bonding, or its stated alternative, and record the learner's own data with its uncertainty.
...
**Q8 — provenance.** _Serves objective 1:_ Plan and carry out a safe investigation of ionic, covalent, and metallic bonding, or its stated alternative, and record the learner's own data with its uncertainty.
...
- **prerequisite-gap** — Run the prerequisite reteach route for ionic, covalent, and metallic bonding (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for ionic, covalent, and metallic bonding (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for ionic, covalent, and metallic bonding (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for ionic, covalent, and metallic bonding (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for ionic, covalent, and metallic bonding (evidence type: application, require explanation: True, review timing: same-day).
...
- chemical: Rubbing alcohol is flammable, its vapour is heavier than air and pools at bench level, and it is harmful if swallowed. — mitigation: STAGE A runs with no battery, charger, flame, hob, pilot light, heater, or lamp anywhere in the room. An adult dispenses no more than 30 mL per cup, caps the bottle, and removes it from the room at once. Nothing is ever tasted.
- chemical: The poured alcohol samples - not just the bottle - are the ignition risk, and a shorting battery is an ignition source. — mitigation: STAGE A ends when every POURED SAMPLE is down the drain, the cups washed and dried, and the room ventilated ten minutes - not when the bottle is capped. Only then may a battery enter, and STAGE B runs on a different surface.
- chemical: Passing current through salt water is electrolysis: it produces hydrogen at one lead and chlorine gas at the other. — mitigation: Each conductivity test is a touch of one to two seconds. Leads are never left standing in a solution. If bubbles form at a lead, disconnect at once, ventilate, and move to the published table.
- physical: Battery testing risks a short circuit that heats the leads. — mitigation: Use one 9V battery only - NEVER mains electricity, never a lithium or button cell. Keep the LED in the circuit at all times, tape the terminals before and after use, keep leads apart between tests, and let an adult make every connection.
- physical: Warm water can scald. — mitigation: An adult pours every warm sample and confirms with the thermometer that it reads below 50 degrees Celsius. Temperature is judged with the thermometer, never with a hand.
...
**Disposal and clearing up:** Alcohol samples go down the drain with the cold tap running at THE END OF STAGE A, before any battery appears; the cups are washed, dried, and put away. Salt, sugar, and oil solutions go down the drain with the tap running after Stage B. Disconnect the battery, tape its terminals, store it away from steel wool and loose metal, and wipe the surface. Nothing from this investigation is ever sealed, capped, or stored while wet. Alcohol and a battery are never left out together at any point.
...
_Package `swp-ma-hs10-chemistry-u03-l07` · built from `hs912-science-h4` at `a86780a`._
