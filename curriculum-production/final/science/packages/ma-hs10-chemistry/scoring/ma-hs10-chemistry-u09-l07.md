# Scoring authority — Investigation: nuclear composition and isotopes

**High School Chemistry (Grade 10)** · Unit 9: The Nucleus, Nuclear Energy, and a Chemistry Engineering Capstone · Day 7 · lesson `ma-hs10-chemistry-u09-l07`
...
_Topic `ma-hs10-chemistry-u09::nuclear composition and isotopes` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs10-chemistry.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- The atomic number is the number of protons and identifies the element; the mass number is the total number of protons and neutrons.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Isotopes of an element share the proton number and differ in neutron number, and therefore in mass number.
- Isotopes of an element have essentially identical chemical behaviour, because chemistry depends on electrons, while their nuclear stability can differ greatly.
- The mass listed on the periodic table is a weighted average over an element's naturally occurring isotopes.
...
- Claiming isotopes of an element differ chemically in a substantial way.
- Claiming the mass number is the mass in grams.
- Claiming an element's isotopes have different proton numbers.

**Grade boundary.** Nuclear shell models and binding energy per nucleon curves are acceptable to reference but not required.
...
> Learner's own coin- or dice-decay trials plotted against the exponential model, plus published decay and materials data. No radiation measurement is taken.
...
**Q1 — investigate.** _Serves objective 1:_ Plan and carry out a safe investigation of nuclear composition and isotopes, or its stated alternative, and record the learner's own data with its uncertainty.
...
**Q2 — explain with evidence.** _Serves objective 2:_ Explain nuclear composition and isotopes using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q3 — apply new task.** _Serves objective 3:_ Apply nuclear composition and isotopes to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q4 — check revise next step.** _Serves objective 4:_ Check and revise the work on nuclear composition and isotopes against the stated success criteria and name the next step.
...
**Q5 — essential question.** _Serves objective 3:_ Apply nuclear composition and isotopes to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q6 — evidence quality.** _Serves objective 2:_ Explain nuclear composition and isotopes using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q7 — limitation.** _Serves objective 1:_ Plan and carry out a safe investigation of nuclear composition and isotopes, or its stated alternative, and record the learner's own data with its uncertainty.
...
**Q8 — provenance.** _Serves objective 1:_ Plan and carry out a safe investigation of nuclear composition and isotopes, or its stated alternative, and record the learner's own data with its uncertainty.
...
- **prerequisite-gap** — Run the prerequisite reteach route for nuclear composition and isotopes (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for nuclear composition and isotopes (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for nuclear composition and isotopes (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for nuclear composition and isotopes (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for nuclear composition and isotopes (evidence type: application, require explanation: True, review timing: same-day).
...
- physical: A domestic smoke detector contains a sealed radioactive source and is safe only while it stays intact. — mitigation: A smoke detector is never opened, dismantled, or taken apart, and its source is never removed or handled. A working smoke alarm is a safety device and stays installed and intact. This prohibition is not disableable.
- physical: Large numbers of small counters spread and can be a choking hazard. — mitigation: Work in a shallow tray, keep counters away from young children, and count them back at the end.
- emotional: Nuclear topics can raise anxiety about weapons or accidents. — mitigation: Content stays on decay physics, energy scale, and engineering trade-offs; the learner may pause or redirect to the materials strand at any point.
...
**Disposal and clearing up:** Counters go back into a labelled container stored out of reach of young children. No radioactive source is used or acquired at any point and no smoke detector is opened, so there is nothing hazardous to dispose of.
...
_Package `swp-ma-hs10-chemistry-u09-l07` · built from `hs912-science-h4` at `a86780a`._
