# Scoring authority — Launch and diagnostic: subatomic structure and isotopes

**High School Chemistry (Grade 10)** · Unit 2: Atomic Structure and the Periodic Table as a Model · Day 1 · lesson `ma-hs10-chemistry-u02-l01`
...
_Topic `ma-hs10-chemistry-u02::subatomic structure and isotopes` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs10-chemistry.correctness.json`._
...
**Q1 — phenomenon question.** _Serves objective 1:_ Observe the anchoring phenomenon, surface initial thinking about subatomic structure and isotopes without penalty, and pose a testable question.
...
**Q7 — limitation.** _Serves objective 3:_ Apply subatomic structure and isotopes to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q8 — provenance.** _Serves objective 1:_ Observe the anchoring phenomenon, surface initial thinking about subatomic structure and isotopes without penalty, and pose a testable question.
...
_Package `swp-ma-hs10-chemistry-u02-l01` · built from `hs912-science-h4` at `a86780a`._
