# Scoring authority — Launch and diagnostic: collision model of reactions

**High School Chemistry (Grade 10)** · Unit 7: Reaction Rates and the Conditions That Change Them · Day 1 · lesson `ma-hs10-chemistry-u07-l01`
...
_Topic `ma-hs10-chemistry-u07::collision model of reactions` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-hs10-chemistry.correctness.json`._
...
**Q1 — phenomenon question.** _Serves objective 1:_ Observe the anchoring phenomenon, surface initial thinking about collision model of reactions without penalty, and pose a testable question.
...
**Q7 — limitation.** _Serves objective 3:_ Apply collision model of reactions to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q8 — provenance.** _Serves objective 1:_ Observe the anchoring phenomenon, surface initial thinking about collision model of reactions without penalty, and pose a testable question.
...
_Package `swp-ma-hs10-chemistry-u07-l01` · built from `hs912-science-h4` at `a86780a`._
