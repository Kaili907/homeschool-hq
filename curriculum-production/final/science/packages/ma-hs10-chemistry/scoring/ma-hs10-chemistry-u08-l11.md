# Scoring authority — Unit assessment: yield and industrial trade-offs

**High School Chemistry (Grade 10)** · Unit 8: Equilibrium and the Design of Chemical Systems · Day 11 · lesson `ma-hs10-chemistry-u08-l11`
...
_Topic `ma-hs10-chemistry-u08::yield and industrial trade-offs` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-hs10-chemistry.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Industrial conditions balance equilibrium yield against reaction rate, energy cost, equipment limits, and safety.
- Conditions that maximise yield often reduce rate, and the chosen compromise is not the maximum of either.
- Recycling unreacted material raises overall conversion without changing the equilibrium position.
...
- Claiming industrial conditions are chosen to maximise equilibrium yield alone.
- Claiming a catalyst is used to increase the yield rather than the rate.
- Presenting a set of conditions as optimal with no criteria or constraints stated.

**Grade boundary.** Process engineering economics and reactor design are beyond this course.


## What a complete response contains, question by question

**Q1 — mastery fresh task.** _Serves objective 1:_ Demonstrate independent mastery evidence for yield and industrial trade-offs on a fresh task.
...
**Q2 — explain with evidence.** _Serves objective 2:_ Explain yield and industrial trade-offs using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q3 — apply new task.** _Serves objective 3:_ Apply yield and industrial trade-offs to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q4 — check revise next step.** _Serves objective 4:_ Check and revise the work on yield and industrial trade-offs against the stated success criteria and name the next step.
...
**Q5 — essential question.** _Serves objective 3:_ Apply yield and industrial trade-offs to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q6 — evidence quality.** _Serves objective 2:_ Explain yield and industrial trade-offs using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q7 — limitation.** _Serves objective 3:_ Apply yield and industrial trade-offs to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q8 — provenance.** _Serves objective 1:_ Demonstrate independent mastery evidence for yield and industrial trade-offs on a fresh task.
...
- **prerequisite-gap** — Run the prerequisite reteach route for yield and industrial trade-offs (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for yield and industrial trade-offs (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for yield and industrial trade-offs (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for yield and industrial trade-offs (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for yield and industrial trade-offs (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs10-chemistry-u08-l11` · built from `hs912-science-h4` at `a86780a`._
