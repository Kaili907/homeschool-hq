# Scoring authority — Correction and reflection: communicating technical information

**High School Chemistry (Grade 10)** · Unit 3: Bonding, Structure, and the Properties of Designed Materials · Day 12 · lesson `ma-hs10-chemistry-u03-l12`
...
_Topic `ma-hs10-chemistry-u03::communicating technical information` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs10-chemistry.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A technical explanation states the claim, the evidence, and the particle-level reasoning that connects them.
- Chemical notation, diagrams, and prose each carry different information, and the choice is made for what needs to be shown.
- An explanation states the limits of the evidence rather than presenting an inference as a measurement.
...
- Presenting an inferred structure as though it had been directly observed.
- Using chemical notation that does not match the substance being described.
- Stating a conclusion with more certainty than the evidence supports.

**Grade boundary.** Formal technical writing standards and publication conventions are beyond this course.
...
**Q1 — explain with evidence.** _Serves objective 1:_ Explain communicating technical information using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q2 — apply new task.** _Serves objective 2:_ Apply communicating technical information to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q3 — check revise next step.** _Serves objective 3:_ Check and revise the work on communicating technical information against the stated success criteria and name the next step.
...
**Q4 — essential question.** _Serves objective 2:_ Apply communicating technical information to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q5 — evidence quality.** _Serves objective 1:_ Explain communicating technical information using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q6 — limitation.** _Serves objective 2:_ Apply communicating technical information to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q7 — provenance.** _Serves objective 1:_ Explain communicating technical information using evidence, a model, or a documented process rather than an unsupported answer.
...
- **prerequisite-gap** — Run the prerequisite reteach route for communicating technical information (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for communicating technical information (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for communicating technical information (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for communicating technical information (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for communicating technical information (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs10-chemistry-u03-l12` · built from `hs912-science-h4` at `a86780a`._
