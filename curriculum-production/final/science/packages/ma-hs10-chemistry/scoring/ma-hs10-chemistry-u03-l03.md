# Scoring authority — Guided practice A: bulk properties as evidence of particle forces

**High School Chemistry (Grade 10)** · Unit 3: Bonding, Structure, and the Properties of Designed Materials · Day 3 · lesson `ma-hs10-chemistry-u03-l03`
...
_Topic `ma-hs10-chemistry-u03::bulk properties as evidence of particle forces` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs10-chemistry.correctness.json`._
...
**Q1 — explain with evidence.** _Serves objective 1:_ Explain bulk properties as evidence of particle forces using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q2 — apply new task.** _Serves objective 2:_ Apply bulk properties as evidence of particle forces to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q3 — check revise next step.** _Serves objective 3:_ Check and revise the work on bulk properties as evidence of particle forces against the stated success criteria and name the next step.
...
**Q4 — essential question.** _Serves objective 2:_ Apply bulk properties as evidence of particle forces to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q5 — evidence quality.** _Serves objective 1:_ Explain bulk properties as evidence of particle forces using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q6 — limitation.** _Serves objective 2:_ Apply bulk properties as evidence of particle forces to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q7 — provenance.** _Serves objective 1:_ Explain bulk properties as evidence of particle forces using evidence, a model, or a documented process rather than an unsupported answer.
...
_Package `swp-ma-hs10-chemistry-u03-l03` · built from `hs912-science-h4` at `a86780a`._
