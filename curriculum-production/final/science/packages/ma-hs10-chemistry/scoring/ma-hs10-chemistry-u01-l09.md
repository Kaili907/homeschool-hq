# Scoring authority — Performance task build: uncertainty and repeated trials

**High School Chemistry (Grade 10)** · Unit 1: Matter, Measurement, and Laboratory Practice · Day 9 · lesson `ma-hs10-chemistry-u01-l09`
...
_Topic `ma-hs10-chemistry-u01::uncertainty and repeated trials` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs10-chemistry.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Repeated trials estimate random uncertainty; they do not detect or remove systematic error.
- A systematic error shifts every trial in the same direction, so tightly agreeing results can still all be wrong.
- A reported result states the number of trials and the spread among them, or a reader cannot judge it.

**Also correct.** Accept any of these framings — do not require the wording above:

- Describing the two error types as random and systematic, or as scatter and bias, are equivalent.
...
- Claiming repeated trials eliminate systematic error.
- Discarding an outlying trial without recording that it was discarded and why.
- Reporting a mean with no indication of spread or number of trials.

**Grade boundary.** Standard deviation, confidence intervals, and outlier tests are beyond this course.
...
**Q1 — performance evidence.** _Serves objective 1:_ Produce performance-task evidence for uncertainty and repeated trials that a reader could check independently.
...
**Q2 — explain with evidence.** _Serves objective 2:_ Explain uncertainty and repeated trials using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q3 — apply new task.** _Serves objective 3:_ Apply uncertainty and repeated trials to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q4 — check revise next step.** _Serves objective 4:_ Check and revise the work on uncertainty and repeated trials against the stated success criteria and name the next step.
...
**Q5 — essential question.** _Serves objective 3:_ Apply uncertainty and repeated trials to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q6 — evidence quality.** _Serves objective 2:_ Explain uncertainty and repeated trials using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q7 — limitation.** _Serves objective 3:_ Apply uncertainty and repeated trials to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q8 — provenance.** _Serves objective 1:_ Produce performance-task evidence for uncertainty and repeated trials that a reader could check independently.
...
- **prerequisite-gap** — Run the prerequisite reteach route for uncertainty and repeated trials (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for uncertainty and repeated trials (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for uncertainty and repeated trials (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for uncertainty and repeated trials (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for uncertainty and repeated trials (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs10-chemistry-u01-l09` · built from `hs912-science-h4` at `a86780a`._
