# Scoring authority — Investigation: subatomic structure and isotopes

**High School Chemistry (Grade 10)** · Unit 2: Atomic Structure and the Periodic Table as a Model · Day 7 · lesson `ma-hs10-chemistry-u02-l07`
...
_Topic `ma-hs10-chemistry-u02::subatomic structure and isotopes` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs10-chemistry.correctness.json`._
...
- An atom has protons and neutrons in the nucleus and electrons outside it; protons are positive, electrons negative, neutrons uncharged.
- Changing the neutron number gives a different isotope of the same element; changing the proton number gives a different element.
- Nearly all of an atom's mass is in the nucleus, while nearly all of its volume is the region occupied by electrons.

**Also correct.** Accept any of these framings — do not require the wording above:

- Isotope notation by mass number, or by name and mass number, are equally correct.
...
- Claiming isotopes of an element differ in proton number.
- Claiming an atom's identity is set by its electron count.
- Claiming the mass of an atom is distributed evenly through its volume.

**Grade boundary.** Nuclear binding energy calculations and quantum mechanical atomic models are beyond this course.
...
> Published periodic-property data and published emission-spectrum images the family retrieves, plus the learner's own sketches, graphs, and predictions. No identification is stated before observation.
...
**Q1 — investigate.** _Serves objective 1:_ Plan and carry out a safe investigation of subatomic structure and isotopes, or its stated alternative, and record the learner's own data with its uncertainty.
...
**Q2 — explain with evidence.** _Serves objective 2:_ Explain subatomic structure and isotopes using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q3 — apply new task.** _Serves objective 3:_ Apply subatomic structure and isotopes to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q4 — check revise next step.** _Serves objective 4:_ Check and revise the work on subatomic structure and isotopes against the stated success criteria and name the next step.
...
**Q5 — essential question.** _Serves objective 3:_ Apply subatomic structure and isotopes to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q6 — evidence quality.** _Serves objective 2:_ Explain subatomic structure and isotopes using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q7 — limitation.** _Serves objective 1:_ Plan and carry out a safe investigation of subatomic structure and isotopes, or its stated alternative, and record the learner's own data with its uncertainty.
...
**Q8 — provenance.** _Serves objective 1:_ Plan and carry out a safe investigation of subatomic structure and isotopes, or its stated alternative, and record the learner's own data with its uncertainty.
...
- **prerequisite-gap** — Run the prerequisite reteach route for subatomic structure and isotopes (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for subatomic structure and isotopes (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for subatomic structure and isotopes (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for subatomic structure and isotopes (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for subatomic structure and isotopes (evidence type: application, require explanation: True, review timing: same-day).
...
- physical: Looking into a bright light source, or at the sun, damages vision permanently. — mitigation: View household lamps only, from at least an arm's length, never the sun and never a laser. No optical device is ever pointed at the sun or at another person. This prohibition is not disableable.
- physical: Cutting the viewing slit in the card tube uses a sharp blade. — mitigation: An adult cuts the slit; the learner assembles and tapes only. No cutting tool is required of the learner.
...
**Disposal and clearing up:** Recycle the card tube, return the CD or grating to its sleeve, and file or recycle the printed spectra. No flame, fuel, heat source, or chemical is used anywhere in this investigation, so there is nothing hazardous to dispose of.
...
_Package `swp-ma-hs10-chemistry-u02-l07` · built from `hs912-science-h4` at `a86780a`._
