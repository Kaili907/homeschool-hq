# Scoring authority — Reteach and varied practice: electron arrangement and energy levels

**High School Chemistry (Grade 10)** · Unit 2: Atomic Structure and the Periodic Table as a Model · Day 8 · lesson `ma-hs10-chemistry-u02-l08`
...
_Topic `ma-hs10-chemistry-u02::electron arrangement and energy levels` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs10-chemistry.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Electrons occupy discrete energy levels; they do not have arbitrary intermediate energies.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Electrons occupy energy levels around the nucleus, with lower levels filled before higher ones in the ground state.
- An electron moves between levels only by absorbing or emitting exactly the energy difference between them, which is why atomic spectra consist of discrete lines.
- The arrangement of electrons, particularly in the outermost level, determines how an atom bonds.

**Also correct.** Accept any of these framings — do not require the wording above:

- Shell diagrams, electron configuration notation, and orbital descriptions are all acceptable representations at this level.
...
- Claiming electrons orbit the nucleus in fixed planetary paths at any energy.
- Claiming an electron can absorb any amount of energy to move between levels.
- Claiming inner electrons determine an atom's ordinary chemical bonding.

**Grade boundary.** Quantum numbers, orbital shapes in detail, and spectroscopic term symbols are beyond this course.
...
**Q1 — explain with evidence.** _Serves objective 1:_ Explain electron arrangement and energy levels using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q2 — apply new task.** _Serves objective 2:_ Apply electron arrangement and energy levels to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q3 — check revise next step.** _Serves objective 3:_ Check and revise the work on electron arrangement and energy levels against the stated success criteria and name the next step.
...
**Q4 — essential question.** _Serves objective 2:_ Apply electron arrangement and energy levels to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q5 — evidence quality.** _Serves objective 1:_ Explain electron arrangement and energy levels using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q6 — limitation.** _Serves objective 2:_ Apply electron arrangement and energy levels to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q7 — provenance.** _Serves objective 1:_ Explain electron arrangement and energy levels using evidence, a model, or a documented process rather than an unsupported answer.
...
- **prerequisite-gap** — Run the prerequisite reteach route for electron arrangement and energy levels (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for electron arrangement and energy levels (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for electron arrangement and energy levels (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for electron arrangement and energy levels (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for electron arrangement and energy levels (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs10-chemistry-u02-l08` · built from `hs912-science-h4` at `a86780a`._
