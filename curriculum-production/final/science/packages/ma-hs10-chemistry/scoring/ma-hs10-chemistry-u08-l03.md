# Scoring authority — Guided practice A: stress and system response

**High School Chemistry (Grade 10)** · Unit 8: Equilibrium and the Design of Chemical Systems · Day 3 · lesson `ma-hs10-chemistry-u08-l03`
...
_Topic `ma-hs10-chemistry-u08::stress and system response` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-hs10-chemistry.correctness.json`._
...
**Q1 — explain with evidence.** _Serves objective 1:_ Explain stress and system response using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q2 — apply new task.** _Serves objective 2:_ Apply stress and system response to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q3 — check revise next step.** _Serves objective 3:_ Check and revise the work on stress and system response against the stated success criteria and name the next step.
...
**Q4 — essential question.** _Serves objective 2:_ Apply stress and system response to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q5 — evidence quality.** _Serves objective 1:_ Explain stress and system response using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q6 — limitation.** _Serves objective 2:_ Apply stress and system response to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q7 — provenance.** _Serves objective 1:_ Explain stress and system response using evidence, a model, or a documented process rather than an unsupported answer.
...
_Package `swp-ma-hs10-chemistry-u08-l03` · built from `hs912-science-h4` at `a86780a`._
