# Scoring authority — Independent application A: conductivity, melting point, and solubility

**High School Chemistry (Grade 10)** · Unit 3: Bonding, Structure, and the Properties of Designed Materials · Day 4 · lesson `ma-hs10-chemistry-u03-l04`
...
_Topic `ma-hs10-chemistry-u03::conductivity, melting point, and solubility` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs10-chemistry.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Ionic compounds do not conduct as solids but do when molten or dissolved, because the ions become free to move.
- Metals conduct in the solid state because their electrons are delocalised.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Electrical conduction requires charged particles free to move: delocalised electrons in metals, mobile ions in molten or dissolved ionic compounds.
- Melting point reflects the energy needed to overcome the forces holding particles in the solid structure.
- Solubility reflects whether the attractions formed with the solvent compensate for the attractions broken in the solute and the solvent.

**Also correct.** Accept any of these framings — do not require the wording above:

- The heuristic that like dissolves like is acceptable, provided it is explained in terms of the attractions involved.
...
- Claiming solid ionic compounds conduct electricity.
- Claiming a substance that dissolves must therefore conduct.
- Claiming molecular covalent substances conduct because they contain electrons.

**Grade boundary.** Conductivity measurement theory, solubility product constants, and lattice enthalpy cycles are beyond this course.
...
**Q1 — explain with evidence.** _Serves objective 1:_ Explain conductivity, melting point, and solubility using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q2 — apply new task.** _Serves objective 2:_ Apply conductivity, melting point, and solubility to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q3 — check revise next step.** _Serves objective 3:_ Check and revise the work on conductivity, melting point, and solubility against the stated success criteria and name the next step.
...
**Q4 — essential question.** _Serves objective 2:_ Apply conductivity, melting point, and solubility to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q5 — evidence quality.** _Serves objective 1:_ Explain conductivity, melting point, and solubility using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q6 — limitation.** _Serves objective 2:_ Apply conductivity, melting point, and solubility to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q7 — provenance.** _Serves objective 1:_ Explain conductivity, melting point, and solubility using evidence, a model, or a documented process rather than an unsupported answer.
...
- **prerequisite-gap** — Run the prerequisite reteach route for conductivity, melting point, and solubility (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for conductivity, melting point, and solubility (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for conductivity, melting point, and solubility (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for conductivity, melting point, and solubility (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for conductivity, melting point, and solubility (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs10-chemistry-u03-l04` · built from `hs912-science-h4` at `a86780a`._
