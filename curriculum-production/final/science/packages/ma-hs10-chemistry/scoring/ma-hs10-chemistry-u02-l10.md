# Scoring authority — Synthesis and review: periodic trends in atomic radius and ionization

**High School Chemistry (Grade 10)** · Unit 2: Atomic Structure and the Periodic Table as a Model · Day 10 · lesson `ma-hs10-chemistry-u02-l10`
...
_Package `swp-ma-hs10-chemistry-u02-l10` · built from `hs912-science-h4` at `a86780a`._
