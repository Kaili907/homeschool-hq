# Scoring authority — Unit assessment: mass-energy and nuclear energy scale

**High School Chemistry (Grade 10)** · Unit 9: The Nucleus, Nuclear Energy, and a Chemistry Engineering Capstone · Day 11 · lesson `ma-hs10-chemistry-u09-l11`
...
_Topic `ma-hs10-chemistry-u09::mass-energy and nuclear energy scale` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs10-chemistry.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- In nuclear reactions a small amount of mass is converted to energy, following the mass-energy relationship, which is why nuclear energy release is millions of times larger per event than chemical energy release.

**Accepted relationships and models.** What this lesson's learning target asserts:

- The energy released in a nuclear reaction corresponds to the mass difference between the initial and final nuclei.
- Chemical reactions rearrange electrons and involve mass changes far too small to measure; nuclear reactions do not.
- This difference in scale is why a small mass of nuclear fuel yields energy comparable to a very large mass of chemical fuel.
...
- Claiming mass is conserved exactly in nuclear reactions in the same way it is in chemical ones.
- Claiming chemical and nuclear energy releases are of comparable magnitude per reaction.
- Claiming nuclear energy comes from breaking bonds between atoms.

**Grade boundary.** Relativistic mechanics and binding energy computation are beyond this course.
...
**Q1 — mastery fresh task.** _Serves objective 1:_ Demonstrate independent mastery evidence for mass-energy and nuclear energy scale on a fresh task.
...
**Q2 — explain with evidence.** _Serves objective 2:_ Explain mass-energy and nuclear energy scale using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q3 — apply new task.** _Serves objective 3:_ Apply mass-energy and nuclear energy scale to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q4 — check revise next step.** _Serves objective 4:_ Check and revise the work on mass-energy and nuclear energy scale against the stated success criteria and name the next step.
...
**Q5 — essential question.** _Serves objective 3:_ Apply mass-energy and nuclear energy scale to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q6 — evidence quality.** _Serves objective 2:_ Explain mass-energy and nuclear energy scale using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q7 — limitation.** _Serves objective 3:_ Apply mass-energy and nuclear energy scale to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q8 — provenance.** _Serves objective 1:_ Demonstrate independent mastery evidence for mass-energy and nuclear energy scale on a fresh task.
...
- **prerequisite-gap** — Run the prerequisite reteach route for mass-energy and nuclear energy scale (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for mass-energy and nuclear energy scale (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for mass-energy and nuclear energy scale (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for mass-energy and nuclear energy scale (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for mass-energy and nuclear energy scale (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs10-chemistry-u09-l11` · built from `hs912-science-h4` at `a86780a`._
