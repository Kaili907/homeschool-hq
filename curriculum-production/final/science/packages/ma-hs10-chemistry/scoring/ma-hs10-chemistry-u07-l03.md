# Scoring authority — Guided practice A: concentration and reaction rate

**High School Chemistry (Grade 10)** · Unit 7: Reaction Rates and the Conditions That Change Them · Day 3 · lesson `ma-hs10-chemistry-u07-l03`
...
_Topic `ma-hs10-chemistry-u07::concentration and reaction rate` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-hs10-chemistry.correctness.json`._
...
**Q1 — explain with evidence.** _Serves objective 1:_ Explain concentration and reaction rate using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q2 — apply new task.** _Serves objective 2:_ Apply concentration and reaction rate to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q3 — check revise next step.** _Serves objective 3:_ Check and revise the work on concentration and reaction rate against the stated success criteria and name the next step.
...
**Q4 — essential question.** _Serves objective 2:_ Apply concentration and reaction rate to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q5 — evidence quality.** _Serves objective 1:_ Explain concentration and reaction rate using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q6 — limitation.** _Serves objective 2:_ Apply concentration and reaction rate to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q7 — provenance.** _Serves objective 1:_ Explain concentration and reaction rate using evidence, a model, or a documented process rather than an unsupported answer.
...
_Package `swp-ma-hs10-chemistry-u07-l03` · built from `hs912-science-h4` at `a86780a`._
