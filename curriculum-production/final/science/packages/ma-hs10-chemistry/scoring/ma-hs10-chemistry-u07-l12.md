# Scoring authority — Correction and reflection: explaining rate with scientific principles

**High School Chemistry (Grade 10)** · Unit 7: Reaction Rates and the Conditions That Change Them · Day 12 · lesson `ma-hs10-chemistry-u07-l12`
...
_Topic `ma-hs10-chemistry-u07::explaining rate with scientific principles` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-hs10-chemistry.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A rate explanation identifies which factor was changed and connects it to collision frequency, collision energy, or activation energy.
- Naming the factor is description; connecting it to the collision model is explanation.
- An explanation is tested by whether it also predicts what happens when the factor is changed the other way.
...
- Attributing a rate change to a factor without identifying the mechanism it acts through.
- Attributing a rate increase to lowered activation energy when the factor changed was temperature or concentration.
- Claiming a factor speeds a reaction because it makes the reaction more favourable energetically.

**Grade boundary.** Quantitative kinetics and mechanism determination are beyond this course.


## What a complete response contains, question by question

**Q1 — explain with evidence.** _Serves objective 1:_ Explain explaining rate with scientific principles using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q2 — apply new task.** _Serves objective 2:_ Apply explaining rate with scientific principles to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q3 — check revise next step.** _Serves objective 3:_ Check and revise the work on explaining rate with scientific principles against the stated success criteria and name the next step.
...
**Q4 — essential question.** _Serves objective 2:_ Apply explaining rate with scientific principles to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q5 — evidence quality.** _Serves objective 1:_ Explain explaining rate with scientific principles using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q6 — limitation.** _Serves objective 2:_ Apply explaining rate with scientific principles to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q7 — provenance.** _Serves objective 1:_ Explain explaining rate with scientific principles using evidence, a model, or a documented process rather than an unsupported answer.
...
- **prerequisite-gap** — Run the prerequisite reteach route for explaining rate with scientific principles (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for explaining rate with scientific principles (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for explaining rate with scientific principles (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for explaining rate with scientific principles (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for explaining rate with scientific principles (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs10-chemistry-u07-l12` · built from `hs912-science-h4` at `a86780a`._
