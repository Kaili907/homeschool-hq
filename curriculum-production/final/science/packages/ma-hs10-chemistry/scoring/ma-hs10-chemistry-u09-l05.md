# Scoring authority — Concept model B: mass-energy and nuclear energy scale

**High School Chemistry (Grade 10)** · Unit 9: The Nucleus, Nuclear Energy, and a Chemistry Engineering Capstone · Day 5 · lesson `ma-hs10-chemistry-u09-l05`
...
**Q1 — explain with evidence.** _Serves objective 1:_ Explain mass-energy and nuclear energy scale using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q2 — apply new task.** _Serves objective 2:_ Apply mass-energy and nuclear energy scale to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q3 — check revise next step.** _Serves objective 3:_ Check and revise the work on mass-energy and nuclear energy scale against the stated success criteria and name the next step.
...
**Q4 — essential question.** _Serves objective 2:_ Apply mass-energy and nuclear energy scale to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q5 — evidence quality.** _Serves objective 1:_ Explain mass-energy and nuclear energy scale using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q6 — limitation.** _Serves objective 2:_ Apply mass-energy and nuclear energy scale to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q7 — provenance.** _Serves objective 1:_ Explain mass-energy and nuclear energy scale using evidence, a model, or a documented process rather than an unsupported answer.
...
_Package `swp-ma-hs10-chemistry-u09-l05` · built from `hs912-science-h4` at `a86780a`._
