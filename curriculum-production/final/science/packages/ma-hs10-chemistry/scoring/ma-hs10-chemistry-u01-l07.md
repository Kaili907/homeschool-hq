# Scoring authority — Investigation: physical and chemical properties

**High School Chemistry (Grade 10)** · Unit 1: Matter, Measurement, and Laboratory Practice · Day 7 · lesson `ma-hs10-chemistry-u01-l07`
...
_Topic `ma-hs10-chemistry-u01::physical and chemical properties` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs10-chemistry.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- A physical property can be measured without changing the substance's identity; a chemical property describes how it changes into a different substance.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Physical properties include colour, state, melting and boiling point, density, hardness, and solubility; chemical properties include flammability, reactivity with acid, and resistance to corrosion.
- Intensive properties do not depend on the amount of sample and can therefore identify a substance; extensive properties such as mass and volume cannot.
- Observing a chemical property necessarily changes the sample, which is why chemical tests are destructive.

**Also correct.** Accept any of these framings — do not require the wording above:

- Intensive and extensive, or amount-independent and amount-dependent, are equivalent framings.
...
- Using mass or volume as an identifying property of a substance.
- Claiming flammability can be assessed without any change occurring.
- Claiming a change of state produces a chemically different substance.

**Grade boundary.** Spectroscopic identification and thermodynamic property tables are beyond this course.
...
> Learner's own repeated mass and volume trials. Accepted reference densities are looked up for comparison only, after the learner reports their own value.
...
**Q1 — investigate.** _Serves objective 1:_ Plan and carry out a safe investigation of physical and chemical properties, or its stated alternative, and record the learner's own data with its uncertainty.
...
**Q2 — explain with evidence.** _Serves objective 2:_ Explain physical and chemical properties using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q3 — apply new task.** _Serves objective 3:_ Apply physical and chemical properties to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q4 — check revise next step.** _Serves objective 4:_ Check and revise the work on physical and chemical properties against the stated success criteria and name the next step.
...
**Q5 — essential question.** _Serves objective 3:_ Apply physical and chemical properties to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q6 — evidence quality.** _Serves objective 2:_ Explain physical and chemical properties using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q7 — limitation.** _Serves objective 1:_ Plan and carry out a safe investigation of physical and chemical properties, or its stated alternative, and record the learner's own data with its uncertainty.
...
**Q8 — provenance.** _Serves objective 1:_ Plan and carry out a safe investigation of physical and chemical properties, or its stated alternative, and record the learner's own data with its uncertainty.
...
- **prerequisite-gap** — Run the prerequisite reteach route for physical and chemical properties (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for physical and chemical properties (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for physical and chemical properties (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for physical and chemical properties (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for physical and chemical properties (evidence type: application, require explanation: True, review timing: same-day).
...
- physical: Spilled water makes floors slippery and can reach electrical outlets. — mitigation: Work over a tray on a low surface away from outlets, and wipe spills immediately.
- chemical: Household substances must never be combined experimentally. — mitigation: This unit uses water, salt, and sugar only. Never mix cleaning products; bleach with ammonia or acid releases toxic gas. This prohibition is not disableable.
- physical: An unknown solid chosen for the density measurement can be hazardous in itself. — mitigation: An adult approves every solid. Never use a battery, a magnet, a medicine, a sealed pouch, or anything carrying a printed hazard symbol.
...
**Disposal and clearing up:** Pour salt and sugar solutions down the drain with the tap running, dry the scale and the surface, and return solids to their labelled containers. Nothing is combined with anything not on the materials list.
...
_Package `swp-ma-hs10-chemistry-u01-l07` · built from `hs912-science-h4` at `a86780a`._
