# Scoring authority — Independent application A: surface area and mixing

**High School Chemistry (Grade 10)** · Unit 7: Reaction Rates and the Conditions That Change Them · Day 4 · lesson `ma-hs10-chemistry-u07-l04`
...
_Topic `ma-hs10-chemistry-u07::surface area and mixing` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-hs10-chemistry.correctness.json`._
...
- A reaction involving a solid occurs at its surface, so subdividing the solid exposes more particles to collision.
- Mixing brings reactants into contact and prevents local depletion, which is why stirring can raise the rate in solution.
- Surface area and mixing affect how often reactant particles meet, not the energy of the collisions.
...
- Claiming the mass of a solid, rather than its exposed surface area, sets the rate for a surface reaction.
- Claiming subdividing a solid changes its chemical properties.
- Claiming stirring changes the activation energy.

**Grade boundary.** Diffusion-limited kinetics and surface chemistry are beyond this course.


## What a complete response contains, question by question

**Q1 — explain with evidence.** _Serves objective 1:_ Explain surface area and mixing using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q2 — apply new task.** _Serves objective 2:_ Apply surface area and mixing to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q3 — check revise next step.** _Serves objective 3:_ Check and revise the work on surface area and mixing against the stated success criteria and name the next step.
...
**Q4 — essential question.** _Serves objective 2:_ Apply surface area and mixing to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q5 — evidence quality.** _Serves objective 1:_ Explain surface area and mixing using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q6 — limitation.** _Serves objective 2:_ Apply surface area and mixing to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q7 — provenance.** _Serves objective 1:_ Explain surface area and mixing using evidence, a model, or a documented process rather than an unsupported answer.
...
- **prerequisite-gap** — Run the prerequisite reteach route for surface area and mixing (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for surface area and mixing (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for surface area and mixing (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for surface area and mixing (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for surface area and mixing (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs10-chemistry-u07-l04` · built from `hs912-science-h4` at `a86780a`._
