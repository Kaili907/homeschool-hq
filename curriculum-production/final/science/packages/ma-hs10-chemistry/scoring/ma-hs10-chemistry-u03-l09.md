# Scoring authority — Performance task build: bulk properties as evidence of particle forces

**High School Chemistry (Grade 10)** · Unit 3: Bonding, Structure, and the Properties of Designed Materials · Day 9 · lesson `ma-hs10-chemistry-u03-l09`
...
_Topic `ma-hs10-chemistry-u03::bulk properties as evidence of particle forces` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs10-chemistry.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Bulk properties such as melting point, hardness, and volatility are evidence about the type and strength of the forces between particles.
- Substances with strong three-dimensional networks of bonds, whether ionic or covalent network, have high melting points; molecular substances generally have low ones.
- Reasoning runs from measured bulk property to inferred particle-level structure, and the inference is checked against other properties.
...
- Inferring bonding type from a single bulk property and stating it as established.
- Claiming a high melting point on its own establishes ionic bonding, when covalent network solids also have high melting points.
- Attributing a bulk property such as ductility to an individual particle.

**Grade boundary.** Crystallography and lattice energy calculations are beyond this course.
...
**Q1 — performance evidence.** _Serves objective 1:_ Produce performance-task evidence for bulk properties as evidence of particle forces that a reader could check independently.
...
**Q2 — explain with evidence.** _Serves objective 2:_ Explain bulk properties as evidence of particle forces using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q3 — apply new task.** _Serves objective 3:_ Apply bulk properties as evidence of particle forces to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q4 — check revise next step.** _Serves objective 4:_ Check and revise the work on bulk properties as evidence of particle forces against the stated success criteria and name the next step.
...
**Q5 — essential question.** _Serves objective 3:_ Apply bulk properties as evidence of particle forces to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q6 — evidence quality.** _Serves objective 2:_ Explain bulk properties as evidence of particle forces using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q7 — limitation.** _Serves objective 3:_ Apply bulk properties as evidence of particle forces to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q8 — provenance.** _Serves objective 1:_ Produce performance-task evidence for bulk properties as evidence of particle forces that a reader could check independently.
...
- **prerequisite-gap** — Run the prerequisite reteach route for bulk properties as evidence of particle forces (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for bulk properties as evidence of particle forces (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for bulk properties as evidence of particle forces (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for bulk properties as evidence of particle forces (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for bulk properties as evidence of particle forces (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs10-chemistry-u03-l09` · built from `hs912-science-h4` at `a86780a`._
