# Scoring authority — Performance task build: embryological evidence

**Grade 8 Science** · Unit 4: Natural Selection and Adaptation · Day 9 · lesson `ma-g8-science-u04-l09`
...
_Topic `ma-g8-science-u04::embryological evidence` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Embryos of different vertebrate species pass through stages that resemble one another more than the adults do.
- Those shared developmental patterns are evidence of shared ancestry.
- Embryological similarity is one line of evidence among several, and it is strongest when it agrees with the anatomical and fossil evidence.
...
- Claiming an embryo passes through the adult forms of its ancestors.
- Treating embryological similarity as proof on its own without the other lines of evidence.
- Claiming embryos of different species are indistinguishable.

**Grade boundary.** Developmental genetics and evolutionary developmental biology are High School work.
...
**Q1 — build product.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies embryological evidence and the unit standards.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of embryological evidence.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about embryological evidence using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies embryological evidence and the unit standards.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of embryological evidence.
...
**Q6 — limitation.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies embryological evidence and the unit standards.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of embryological evidence.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for embryological evidence, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for embryological evidence works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of embryological evidence, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking embryological evidence mastered.
...
_Package `swp-ma-g8-science-u04-l09` · built from `canonical-1.0.0` at `4056e31`._
