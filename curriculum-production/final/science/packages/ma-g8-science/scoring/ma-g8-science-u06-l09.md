# Scoring authority — Performance task build: gravity and orbital motion

**Grade 8 Science** · Unit 6: Earth, Moon, Sun, and the Solar System · Day 9 · lesson `ma-g8-science-u06-l09`
...
_Topic `ma-g8-science-u06::gravity and orbital motion` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Gravity is the force that holds objects in orbit; an orbiting object is continuously falling toward the body it orbits.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Gravitational attraction between the Sun and the planets, and between planets and their moons, keeps them in orbit.
- An orbiting object is accelerating toward the body it orbits while also moving sideways fast enough that it keeps missing it.
- Orbital motion depends on the mass of the central body and on the orbital distance.
...
- Claiming astronauts in orbit are weightless because gravity is absent there.
- Claiming an orbiting object is not accelerating because its speed is steady.
- Claiming a force pushes orbiting objects outward from the centre.

**Grade boundary.** Kepler's laws quantitatively and orbital energy are High School work.
...
**Q1 — build product.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies gravity and orbital motion and the unit standards.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of gravity and orbital motion.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about gravity and orbital motion using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies gravity and orbital motion and the unit standards.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of gravity and orbital motion.
...
**Q6 — limitation.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies gravity and orbital motion and the unit standards.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of gravity and orbital motion.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for gravity and orbital motion, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for gravity and orbital motion works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of gravity and orbital motion, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking gravity and orbital motion mastered.
...
_Package `swp-ma-g8-science-u06-l09` · built from `canonical-1.0.0` at `4056e31`._
