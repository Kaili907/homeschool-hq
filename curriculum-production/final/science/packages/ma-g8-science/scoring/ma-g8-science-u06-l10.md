# Scoring authority — Synthesis and review: solar-system scale

**Grade 8 Science** · Unit 6: Earth, Moon, Sun, and the Solar System · Day 10 · lesson `ma-g8-science-u06-l10`
...
_Topic `ma-g8-science-u06::solar-system scale` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Distances between objects in the solar system are vastly larger than the objects themselves.

**Accepted relationships and models.** What this lesson's learning target asserts:

- The solar system is mostly empty space: the distances between planets dwarf the planets' sizes.
- No ordinary diagram shows both sizes and distances to the same scale, which is why textbook diagrams distort one of them.
- Scale matters for what is physically possible, so a model that distorts it can produce wrong conclusions.

**Also correct.** Accept any of these framings — do not require the wording above:

- Astronomical units, kilometres, and light-travel time are all acceptable ways to express these distances.
...
- Reading planetary distances or sizes off a classroom diagram as though it were to scale.
- Claiming the planets are close enough together to be seen from one another as discs.
- Presenting a scale model without saying which quantity it distorts.

**Grade boundary.** Parallax measurement and stellar distance scales are High School work.


## What a complete response contains, question by question

**Q1 — connect unit.** _Serves objective 1:_ Connect solar-system scale to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of solar-system scale.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about solar-system scale using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Connect solar-system scale to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of solar-system scale.
...
**Q6 — limitation.** _Serves objective 1:_ Connect solar-system scale to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of solar-system scale.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for solar-system scale, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for solar-system scale works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of solar-system scale, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking solar-system scale mastered.
...
_Package `swp-ma-g8-science-u06-l10` · built from `canonical-1.0.0` at `4056e31`._
