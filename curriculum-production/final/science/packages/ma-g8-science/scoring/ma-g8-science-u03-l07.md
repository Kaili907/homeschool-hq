# Scoring authority — Investigation or close reading: sexual and asexual reproduction

**Grade 8 Science** · Unit 3: Growth, Reproduction, and Heredity · Day 7 · lesson `ma-g8-science-u03-l07`
...
_Topic `ma-g8-science-u03::sexual and asexual reproduction` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Asexual reproduction produces offspring genetically identical to the single parent; sexual reproduction produces offspring with a combination of genetic material from two parents.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Asexual reproduction involves one parent and produces genetically identical offspring apart from mutation.
- Sexual reproduction involves two parents, each contributing genetic material, so offspring differ from both parents and from each other.
- Sexual reproduction generates variation within a population; asexual reproduction generates far less.

**Also correct.** Accept any of these framings — do not require the wording above:

- Naming the mechanisms as mitosis and meiosis is correct but not required at this grade.
...
- Claiming asexual offspring differ genetically from the parent as a normal outcome.
- Claiming sexual reproduction produces offspring identical to one parent.
- Claiming only animals reproduce sexually or only simple organisms reproduce asexually.

**Grade boundary.** Meiosis in detail, crossing over, and reproductive strategy theory are High School work.
...
**Q1 — analyze evidence.** _Serves objective 1:_ Gather and analyze evidence related to sexual and asexual reproduction, then record a defensible interpretation.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of sexual and asexual reproduction.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about sexual and asexual reproduction using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Gather and analyze evidence related to sexual and asexual reproduction, then record a defensible interpretation.
...
**Q5 — evidence quality.** _Serves objective 1:_ Gather and analyze evidence related to sexual and asexual reproduction, then record a defensible interpretation.
...
**Q6 — limitation.** _Serves objective 1:_ Gather and analyze evidence related to sexual and asexual reproduction, then record a defensible interpretation.
...
**Q7 — provenance.** _Serves objective 1:_ Gather and analyze evidence related to sexual and asexual reproduction, then record a defensible interpretation.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for sexual and asexual reproduction, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for sexual and asexual reproduction works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of sexual and asexual reproduction, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking sexual and asexual reproduction mastered.
...
_Package `swp-ma-g8-science-u03-l07` · built from `canonical-1.0.0` at `4056e31`._
