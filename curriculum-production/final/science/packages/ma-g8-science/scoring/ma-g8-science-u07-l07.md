# Scoring authority — Investigation or close reading: resource distribution

**Grade 8 Science** · Unit 7: Resources, Climate, and Human Systems · Day 7 · lesson `ma-g8-science-u07-l07`
...
_Topic `ma-g8-science-u07::resource distribution` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Mineral, energy, water, and soil resources are distributed unevenly because of the geological and biological processes that formed them.
- Where a resource is found is a consequence of past Earth processes, not of present-day political boundaries.
- Uneven distribution shapes where people settle, what they trade, and where conflicts over resources arise.
...
- Claiming resources are distributed evenly or at random.
- Claiming resource location can be explained without reference to geological history.
- Claiming a resource that is abundant globally is therefore available locally.

**Grade boundary.** Ore genesis and reserve economics are High School work.
...
**Q1 — analyze evidence.** _Serves objective 1:_ Gather and analyze evidence related to resource distribution, then record a defensible interpretation.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of resource distribution.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about resource distribution using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Gather and analyze evidence related to resource distribution, then record a defensible interpretation.
...
**Q5 — evidence quality.** _Serves objective 1:_ Gather and analyze evidence related to resource distribution, then record a defensible interpretation.
...
**Q6 — limitation.** _Serves objective 1:_ Gather and analyze evidence related to resource distribution, then record a defensible interpretation.
...
**Q7 — provenance.** _Serves objective 1:_ Gather and analyze evidence related to resource distribution, then record a defensible interpretation.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for resource distribution, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for resource distribution works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of resource distribution, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking resource distribution mastered.
...
_Package `swp-ma-g8-science-u07-l07` · built from `canonical-1.0.0` at `4056e31`._
