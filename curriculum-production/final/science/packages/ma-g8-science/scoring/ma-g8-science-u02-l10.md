# Scoring authority — Synthesis and review: digital versus analog signals

**Grade 8 Science** · Unit 2: Waves and Information Transfer · Day 10 · lesson `ma-g8-science-u02-l10`
...
_Topic `ma-g8-science-u02::digital versus analog signals` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- A digital signal encodes information as discrete values; an analog signal varies continuously.

**Accepted relationships and models.** What this lesson's learning target asserts:

- An analog signal varies continuously and any noise added to it becomes part of the signal.
- A digital signal takes discrete values, so small amounts of noise can be removed by restoring each value to the nearest allowed one.
- That is why digital signals can be copied and transmitted many times with far less degradation than analog ones.

**Also correct.** Accept any of these framings — do not require the wording above:

- Describing digital encoding as binary, or as discrete levels, are both correct.
...
- Claiming digital signals are immune to all noise and loss.
- Claiming digital means the information itself is not physical.
- Claiming an analog signal can be restored to its original form after noise is added, as a digital one can.

**Grade boundary.** Sampling theory, bit depth, and error-correcting codes are High School work.


## What a complete response contains, question by question

**Q1 — connect unit.** _Serves objective 1:_ Connect digital versus analog signals to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of digital versus analog signals.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about digital versus analog signals using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Connect digital versus analog signals to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of digital versus analog signals.
...
**Q6 — limitation.** _Serves objective 1:_ Connect digital versus analog signals to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of digital versus analog signals.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for digital versus analog signals, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for digital versus analog signals works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of digital versus analog signals, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking digital versus analog signals mastered.
...
_Package `swp-ma-g8-science-u02-l10` · built from `canonical-1.0.0` at `4056e31`._
