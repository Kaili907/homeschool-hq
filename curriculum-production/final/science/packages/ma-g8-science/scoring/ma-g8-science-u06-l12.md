# Scoring authority — Correction and reflection: model misconceptions

**Grade 8 Science** · Unit 6: Earth, Moon, Sun, and the Solar System · Day 12 · lesson `ma-g8-science-u06-l12`
...
_Topic `ma-g8-science-u06::model misconceptions` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Common astronomy models introduce distortions of scale, of orbit shape, and of viewing angle, and each can produce a specific wrong conclusion.
- Identifying what a model distorts is part of using it correctly.
- A misconception is corrected by evidence and by a better model, not by asserting the right answer alone.
...
- Claiming Earth's orbit is strongly elliptical because diagrams draw it that way; it is very nearly circular.
- Claiming the Moon does not rotate because the same face always points toward Earth.
- Treating a model's simplification as a fact about the real system.

**Grade boundary.** Orbital eccentricity values and tidal locking mechanics are High School work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for model misconceptions, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of model misconceptions.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about model misconceptions using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for model misconceptions, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of model misconceptions.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for model misconceptions, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of model misconceptions.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for model misconceptions, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for model misconceptions works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of model misconceptions, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking model misconceptions mastered.
...
_Package `swp-ma-g8-science-u06-l12` · built from `canonical-1.0.0` at `4056e31`._
