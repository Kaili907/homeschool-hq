# Scoring authority — Guided practice A: gravity and orbital motion

**Grade 8 Science** · Unit 6: Earth, Moon, Sun, and the Solar System · Day 3 · lesson `ma-g8-science-u06-l03`
...
_Topic `ma-g8-science-u06::gravity and orbital motion` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._
...
**Q1 — guided practice.** _Serves objective 1:_ Practice gravity and orbital motion with prompts, feedback, and gradually reduced support.
...
**Q4 — essential question.** _Serves objective 1:_ Practice gravity and orbital motion with prompts, feedback, and gradually reduced support.
...
**Q6 — limitation.** _Serves objective 1:_ Practice gravity and orbital motion with prompts, feedback, and gradually reduced support.
...
_Package `swp-ma-g8-science-u06-l03` · built from `canonical-1.0.0` at `4056e31`._
