# Scoring authority — Performance task build: population and consumption

**Grade 8 Science** · Unit 7: Resources, Climate, and Human Systems · Day 9 · lesson `ma-g8-science-u07-l09`
...
_Topic `ma-g8-science-u07::population and consumption` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Total human impact depends on population size, on consumption per person, and on the technologies used.
- Per-person consumption varies greatly between regions, so population size alone does not determine impact.
- Changes in any of the three factors change the total, and they can act in opposite directions.
...
- Attributing environmental impact to population size alone.
- Claiming consumption per person is roughly equal worldwide.
- Claiming technological improvement always reduces total impact.

**Grade boundary.** Demographic transition theory and formal impact identities are High School work.
...
**Q1 — build product.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies population and consumption and the unit standards.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of population and consumption.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about population and consumption using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies population and consumption and the unit standards.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of population and consumption.
...
**Q6 — limitation.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies population and consumption and the unit standards.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of population and consumption.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for population and consumption, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for population and consumption works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of population and consumption, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking population and consumption mastered.
...
_Package `swp-ma-g8-science-u07-l09` · built from `canonical-1.0.0` at `4056e31`._
