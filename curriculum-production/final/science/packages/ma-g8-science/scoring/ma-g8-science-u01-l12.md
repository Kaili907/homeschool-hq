# Scoring authority — Correction and reflection: electric and magnetic fields

**Grade 8 Science** · Unit 1: Forces, Motion, and Interactions · Day 12 · lesson `ma-g8-science-u01-l12`
...
_Topic `ma-g8-science-u01::electric and magnetic fields` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Electric and magnetic forces act at a distance, and both can attract or repel.

**Accepted relationships and models.** What this lesson's learning target asserts:

- A field is a model for how one object exerts a force on another without contact, with strength depending on distance and on properties of the objects.
- Electric forces act between charges and magnetic forces between magnets and moving charges; both attract or repel depending on orientation or sign.
- Electric currents produce magnetic fields, which is why electromagnets work and why electricity and magnetism are treated as one subject.

**Also correct.** Accept any of these framings — do not require the wording above:

- Field lines and force arrows are both acceptable representations; neither is required.
...
- Claiming magnetic and electric forces are the same force acting on the same property.
- Claiming field lines are physically present in space rather than a representation.
- Claiming gravity, like electric force, can repel.

**Grade boundary.** Coulomb's law, field strength units, and Maxwell's relationships are High School work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for electric and magnetic fields, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of electric and magnetic fields.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about electric and magnetic fields using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for electric and magnetic fields, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of electric and magnetic fields.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for electric and magnetic fields, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of electric and magnetic fields.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for electric and magnetic fields, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for electric and magnetic fields works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of electric and magnetic fields, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking electric and magnetic fields mastered.
...
_Package `swp-ma-g8-science-u01-l12` · built from `canonical-1.0.0` at `4056e31`._
