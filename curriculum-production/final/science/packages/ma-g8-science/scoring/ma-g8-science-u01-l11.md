# Scoring authority — Unit assessment: gravitational interactions

**Grade 8 Science** · Unit 1: Forces, Motion, and Interactions · Day 11 · lesson `ma-g8-science-u01-l11`
...
_Topic `ma-g8-science-u01::gravitational interactions` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Gravitational attraction acts between any two masses, increases with their masses, and decreases as the distance between them increases.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Every mass attracts every other mass; the force increases with either mass and decreases as the separation increases.
- Gravity is always attractive, never repulsive.
- Gravitational forces are noticeable in everyday life only when at least one of the objects is astronomically massive.
...
- Claiming there is no gravity in space, or that orbiting astronauts float because gravity has stopped.
- Claiming gravity can repel as well as attract.
- Claiming gravity acts only on objects touching a planet's surface.

**Grade boundary.** The inverse-square law stated quantitatively and orbital mechanics are High School work.


## What a complete response contains, question by question

**Q1 — demonstrate mastery.** _Serves objective 1:_ Demonstrate current mastery of gravitational interactions through selected-response, constructed-response, and applied evidence.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of gravitational interactions.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about gravitational interactions using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Demonstrate current mastery of gravitational interactions through selected-response, constructed-response, and applied evidence.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of gravitational interactions.
...
**Q6 — limitation.** _Serves objective 1:_ Demonstrate current mastery of gravitational interactions through selected-response, constructed-response, and applied evidence.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of gravitational interactions.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for gravitational interactions, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for gravitational interactions works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of gravitational interactions, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking gravitational interactions mastered.
...
_Package `swp-ma-g8-science-u01-l11` · built from `canonical-1.0.0` at `4056e31`._
