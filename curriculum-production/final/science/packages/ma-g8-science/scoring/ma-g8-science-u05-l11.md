# Scoring authority — Unit assessment: surface processes

**Grade 8 Science** · Unit 5: Earth History and Geologic Processes · Day 11 · lesson `ma-g8-science-u05-l11`
...
_Topic `ma-g8-science-u05::surface processes` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Weathering breaks rock down in place; erosion transports the material; deposition lays it down elsewhere.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Weathering, erosion, transport, and deposition together reshape Earth's surface continuously.
- The rate depends on climate, slope, rock type, and vegetation cover, so it varies enormously between places.
- Surface processes generally act to wear down elevated regions while tectonic processes build them up.
...
- Using weathering and erosion as interchangeable terms.
- Claiming surface processes act at the same rate everywhere.
- Claiming landscapes only change during rare catastrophic events.

**Grade boundary.** Quantitative denudation rates and landscape-evolution modelling are High School work.


## What a complete response contains, question by question

**Q1 — demonstrate mastery.** _Serves objective 1:_ Demonstrate current mastery of surface processes through selected-response, constructed-response, and applied evidence.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of surface processes.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about surface processes using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Demonstrate current mastery of surface processes through selected-response, constructed-response, and applied evidence.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of surface processes.
...
**Q6 — limitation.** _Serves objective 1:_ Demonstrate current mastery of surface processes through selected-response, constructed-response, and applied evidence.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of surface processes.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for surface processes, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for surface processes works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of surface processes, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking surface processes mastered.
...
_Package `swp-ma-g8-science-u05-l11` · built from `canonical-1.0.0` at `4056e31`._
