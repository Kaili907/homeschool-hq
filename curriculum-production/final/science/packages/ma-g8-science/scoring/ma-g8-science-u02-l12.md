# Scoring authority — Correction and reflection: model limitations

**Grade 8 Science** · Unit 2: Waves and Information Transfer · Day 12 · lesson `ma-g8-science-u02-l12`
...
_Topic `ma-g8-science-u02::model limitations` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A wave model represents some behaviours well and others not at all, and which those are depends on the model.
- Choosing a model means choosing which behaviours matter for the question being asked.
- A model's failure at the edge of its range is information about the range, not proof that the model is worthless.
...
- Treating a model's representational features as physical facts, such as claiming a transverse-wave drawing shows how sound moves.
- Claiming a model that fails in one regime is therefore wrong everywhere.
- Using a model beyond its stated range without saying so.

**Grade boundary.** Formal model validation and computational modelling are later work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for model limitations, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of model limitations.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about model limitations using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for model limitations, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of model limitations.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for model limitations, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of model limitations.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for model limitations, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for model limitations works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of model limitations, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking model limitations mastered.
...
_Package `swp-ma-g8-science-u02-l12` · built from `canonical-1.0.0` at `4056e31`._
