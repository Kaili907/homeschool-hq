# Scoring authority — Reteach and varied practice: force and mass

**Grade 8 Science** · Unit 1: Forces, Motion, and Interactions · Day 8 · lesson `ma-g8-science-u01-l08`
...
_Topic `ma-g8-science-u01::force and mass` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- For the same net force, a larger mass has a smaller change in motion.

**Accepted relationships and models.** What this lesson's learning target asserts:

- For a given net force, the change in an object's motion decreases as its mass increases.
- For a given mass, a larger net force produces a larger change in motion.
- Mass is a measure of how much matter an object contains and does not change with location; weight is the gravitational force on it and does.

**Also correct.** Accept any of these framings — do not require the wording above:

- Describing mass as resistance to change in motion, or as amount of matter, are both acceptable here.
...
- Claiming an object's mass changes when it is taken to the Moon.
- Claiming force alone determines the change in motion regardless of mass.

**Grade boundary.** Quantitative acceleration calculations and inertial mass versus gravitational mass are High School work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for force and mass, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of force and mass.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about force and mass using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for force and mass, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of force and mass.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for force and mass, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of force and mass.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for force and mass, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for force and mass works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of force and mass, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking force and mass mastered.
...
_Package `swp-ma-g8-science-u01-l08` · built from `canonical-1.0.0` at `4056e31`._
