# Scoring authority — Reteach and varied practice: reflection absorption and transmission

**Grade 8 Science** · Unit 2: Waves and Information Transfer · Day 8 · lesson `ma-g8-science-u02-l08`
...
_Topic `ma-g8-science-u02::reflection absorption and transmission` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- When a wave meets a boundary it is reflected, absorbed, transmitted, or some combination of the three.

**Accepted relationships and models.** What this lesson's learning target asserts:

- At a boundary, wave energy is divided between reflection, absorption, and transmission, and the division depends on both materials and on the wave.
- Absorbed wave energy is transferred to the material, usually raising its temperature.
- The same material can reflect one kind of wave and transmit another, which is why glass is transparent to visible light but not to all radiation.
...
- Claiming a material either reflects or transmits, with no possibility of both.
- Claiming absorbed wave energy disappears.
- Claiming a material behaves the same way toward every kind of wave.

**Grade boundary.** Refraction geometry, refractive index, and interference are High School work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for reflection absorption and transmission, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of reflection absorption and transmission.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about reflection absorption and transmission using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for reflection absorption and transmission, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of reflection absorption and transmission.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for reflection absorption and transmission, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of reflection absorption and transmission.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for reflection absorption and transmission, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for reflection absorption and transmission works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of reflection absorption and transmission, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking reflection absorption and transmission mastered.
...
_Package `swp-ma-g8-science-u02-l08` · built from `canonical-1.0.0` at `4056e31`._
