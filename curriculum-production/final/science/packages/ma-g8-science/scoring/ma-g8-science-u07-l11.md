# Scoring authority — Unit assessment: mitigation adaptation and tradeoffs

**Grade 8 Science** · Unit 7: Resources, Climate, and Human Systems · Day 11 · lesson `ma-g8-science-u07-l11`
...
_Topic `ma-g8-science-u07::mitigation adaptation and tradeoffs` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Mitigation reduces the cause; adaptation reduces the harm from effects that occur anyway.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Mitigation and adaptation address different parts of the problem, and both are needed because some change is already committed.
- Every option has costs, benefits, and side effects, and these fall differently on different groups.
- Delay is itself a choice, because the cause continues to operate while a decision is postponed.
...
- Using mitigation and adaptation interchangeably.
- Presenting an option as having benefits and no costs.
- Claiming adaptation makes addressing the cause unnecessary.

**Grade boundary.** Policy instrument design and integrated assessment modelling are High School work.


## What a complete response contains, question by question

**Q1 — demonstrate mastery.** _Serves objective 1:_ Demonstrate current mastery of mitigation adaptation and tradeoffs through selected-response, constructed-response, and applied evidence.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of mitigation adaptation and tradeoffs.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about mitigation adaptation and tradeoffs using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Demonstrate current mastery of mitigation adaptation and tradeoffs through selected-response, constructed-response, and applied evidence.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of mitigation adaptation and tradeoffs.
...
**Q6 — limitation.** _Serves objective 1:_ Demonstrate current mastery of mitigation adaptation and tradeoffs through selected-response, constructed-response, and applied evidence.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of mitigation adaptation and tradeoffs.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for mitigation adaptation and tradeoffs, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for mitigation adaptation and tradeoffs works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of mitigation adaptation and tradeoffs, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking mitigation adaptation and tradeoffs mastered.
...
_Package `swp-ma-g8-science-u07-l11` · built from `canonical-1.0.0` at `4056e31`._
