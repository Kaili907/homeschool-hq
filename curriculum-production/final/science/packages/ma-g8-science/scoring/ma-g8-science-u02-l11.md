# Scoring authority — Unit assessment: communication technologies

**Grade 8 Science** · Unit 2: Waves and Information Transfer · Day 11 · lesson `ma-g8-science-u02-l11`
...
_Topic `ma-g8-science-u02::communication technologies` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Communication technologies encode information into a wave or a signal, transmit it, and decode it at the other end.
- Every link has limits on range, rate, and reliability, set by the physics of the carrier and by the equipment.
- The information is carried by the pattern, so the same message can be sent by very different physical means.
...
- Claiming a technology transmits information with no physical carrier.
- Claiming a communication link has no limits on range or rate.
- Claiming the meaning of a message is a property of the wave itself rather than of the agreed encoding.

**Grade boundary.** Modulation schemes, bandwidth calculation, and network protocols are later work.


## What a complete response contains, question by question

**Q1 — demonstrate mastery.** _Serves objective 1:_ Demonstrate current mastery of communication technologies through selected-response, constructed-response, and applied evidence.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of communication technologies.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about communication technologies using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Demonstrate current mastery of communication technologies through selected-response, constructed-response, and applied evidence.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of communication technologies.
...
**Q6 — limitation.** _Serves objective 1:_ Demonstrate current mastery of communication technologies through selected-response, constructed-response, and applied evidence.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of communication technologies.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for communication technologies, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for communication technologies works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of communication technologies, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking communication technologies mastered.
...
_Package `swp-ma-g8-science-u02-l11` · built from `canonical-1.0.0` at `4056e31`._
