# Scoring authority — Guided practice A: population and consumption

**Grade 8 Science** · Unit 7: Resources, Climate, and Human Systems · Day 3 · lesson `ma-g8-science-u07-l03`
...
_Topic `ma-g8-science-u07::population and consumption` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._
...
**Q1 — guided practice.** _Serves objective 1:_ Practice population and consumption with prompts, feedback, and gradually reduced support.
...
**Q4 — essential question.** _Serves objective 1:_ Practice population and consumption with prompts, feedback, and gradually reduced support.
...
**Q6 — limitation.** _Serves objective 1:_ Practice population and consumption with prompts, feedback, and gradually reduced support.
...
_Package `swp-ma-g8-science-u07-l03` · built from `canonical-1.0.0` at `4056e31`._
