# Scoring authority — Unit assessment: natural selection

**Grade 8 Science** · Unit 4: Natural Selection and Adaptation · Day 11 · lesson `ma-g8-science-u04-l11`
...
_Topic `ma-g8-science-u04::natural selection` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Natural selection requires heritable variation, competition for limited resources, differences in survival and reproduction, and inheritance of the advantageous variation.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Individuals with heritable traits that suit their environment tend to survive and reproduce more than those without them.
- Because the traits are heritable, they become more common in the population over generations.
- Natural selection acts on populations across generations; individual organisms do not evolve during their lifetimes.

**Also correct.** Accept any of these framings — do not require the wording above:

- Describing the outcome as differential survival and reproduction, or as differences in reproductive success, are both correct.
...
- Claiming an individual organism evolves or adapts itself during its lifetime.
- Claiming organisms develop traits because they need them.
- Claiming natural selection has a goal or is working toward a more advanced organism.

**Grade boundary.** Hardy-Weinberg reasoning, genetic drift, and speciation mechanisms are High School work.


## What a complete response contains, question by question

**Q1 — demonstrate mastery.** _Serves objective 1:_ Demonstrate current mastery of natural selection through selected-response, constructed-response, and applied evidence.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of natural selection.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about natural selection using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Demonstrate current mastery of natural selection through selected-response, constructed-response, and applied evidence.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of natural selection.
...
**Q6 — limitation.** _Serves objective 1:_ Demonstrate current mastery of natural selection through selected-response, constructed-response, and applied evidence.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of natural selection.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for natural selection, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for natural selection works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of natural selection, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking natural selection mastered.
...
_Package `swp-ma-g8-science-u04-l11` · built from `canonical-1.0.0` at `4056e31`._
