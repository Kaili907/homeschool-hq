# Scoring authority — Performance task build: plate tectonics

**Grade 8 Science** · Unit 5: Earth History and Geologic Processes · Day 9 · lesson `ma-g8-science-u05-l09`
...
_Topic `ma-g8-science-u05::plate tectonics` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Earth's lithosphere is broken into plates that move relative to one another, driven by motion in the mantle beneath.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Earth's outer shell is divided into plates that move slowly relative to one another over the mantle.
- Most earthquakes, volcanoes, and mountain belts occur at plate boundaries, which is why those features are distributed in bands rather than evenly.
- Evidence for plate motion includes matching coastlines and fossils across oceans, seafloor age patterns, and directly measured plate movement.

**Also correct.** Accept any of these framings — do not require the wording above:

- Describing the driving mechanism as mantle convection, or as a combination including slab pull and ridge push, are both acceptable at this grade.
...
- Claiming the continents float on liquid rock beneath them; the mantle is solid rock that flows very slowly.
- Claiming plates move at rates people could observe directly without instruments.
- Claiming earthquakes and volcanoes are distributed evenly over Earth's surface.

**Grade boundary.** Quantitative plate kinematics and mantle dynamics are High School work.
...
**Q1 — build product.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies plate tectonics and the unit standards.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of plate tectonics.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about plate tectonics using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies plate tectonics and the unit standards.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of plate tectonics.
...
**Q6 — limitation.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies plate tectonics and the unit standards.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of plate tectonics.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for plate tectonics, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for plate tectonics works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of plate tectonics, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking plate tectonics mastered.
...
_Package `swp-ma-g8-science-u05-l09` · built from `canonical-1.0.0` at `4056e31`._
