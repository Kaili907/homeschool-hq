# Scoring authority — Synthesis and review: cycling of Earth materials

**Grade 8 Science** · Unit 5: Earth History and Geologic Processes · Day 10 · lesson `ma-g8-science-u05-l10`
...
_Topic `ma-g8-science-u05::cycling of Earth materials` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Rock is cycled among igneous, sedimentary, and metamorphic forms; any rock type can become any other.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Rock material is recycled: melting and cooling, weathering and deposition, and heat and pressure convert rock between igneous, sedimentary, and metamorphic forms.
- There is no fixed order to the cycle; any rock type can become any other given the right conditions.
- The cycle is driven by energy from Earth's interior and from the Sun, together with gravity.
...
- Claiming the rock cycle runs in a single fixed sequence.
- Claiming sedimentary rock can only form from igneous rock.
- Claiming rock material is created or destroyed in the cycle.

**Grade boundary.** Mineralogy, metamorphic facies, and igneous petrology are High School work.


## What a complete response contains, question by question

**Q1 — connect unit.** _Serves objective 1:_ Connect cycling of Earth materials to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of cycling of Earth materials.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about cycling of Earth materials using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Connect cycling of Earth materials to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of cycling of Earth materials.
...
**Q6 — limitation.** _Serves objective 1:_ Connect cycling of Earth materials to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of cycling of Earth materials.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for cycling of Earth materials, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for cycling of Earth materials works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of cycling of Earth materials, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking cycling of Earth materials mastered.
...
_Package `swp-ma-g8-science-u05-l10` · built from `canonical-1.0.0` at `4056e31`._
