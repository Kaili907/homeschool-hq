# Scoring authority — Reteach and varied practice: lunar phases and eclipses

**Grade 8 Science** · Unit 6: Earth, Moon, Sun, and the Solar System · Day 8 · lesson `ma-g8-science-u06-l08`
...
_Topic `ma-g8-science-u06::lunar phases and eclipses` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Lunar phases are caused by the changing relative positions of the Sun, Earth, and Moon, not by Earth's shadow falling on the Moon.
- A lunar eclipse occurs when Earth's shadow falls on the Moon; a solar eclipse occurs when the Moon passes between the Sun and Earth.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Half the Moon is always lit by the Sun; the phase is how much of that lit half is visible from Earth as the Moon orbits.
- The phase cycle repeats about every month as the Moon completes an orbit relative to the Sun.
- Eclipses are not monthly because the Moon's orbit is tilted relative to Earth's orbit, so the three bodies line up only occasionally.
...
- Claiming lunar phases are caused by Earth's shadow on the Moon.
- Claiming an eclipse of one kind or another should occur every month.
- Claiming part of the Moon is permanently unlit by the Sun; the far side is not the dark side.

**Grade boundary.** Orbital inclination geometry and eclipse prediction are High School work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for lunar phases and eclipses, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of lunar phases and eclipses.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about lunar phases and eclipses using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for lunar phases and eclipses, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of lunar phases and eclipses.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for lunar phases and eclipses, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of lunar phases and eclipses.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for lunar phases and eclipses, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for lunar phases and eclipses works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of lunar phases and eclipses, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking lunar phases and eclipses mastered.
...
_Package `swp-ma-g8-science-u06-l08` · built from `canonical-1.0.0` at `4056e31`._
