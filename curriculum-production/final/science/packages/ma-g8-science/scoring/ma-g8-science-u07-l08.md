# Scoring authority — Reteach and varied practice: geoscience processes

**Grade 8 Science** · Unit 7: Resources, Climate, and Human Systems · Day 8 · lesson `ma-g8-science-u07-l08`
...
_Topic `ma-g8-science-u07::geoscience processes` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Geoscience processes shape where hazards occur, where resources form, and where land is suitable for particular uses.
- These processes operate on timescales from seconds to millions of years, and the timescale determines what human action can affect.
- Understanding the process is what makes prediction and planning possible.
...
- Claiming geoscience processes can be halted by human action.
- Treating a slow process as irrelevant because it is not visible within a human lifetime.
- Claiming hazard locations are unrelated to underlying geological processes.

**Grade boundary.** Quantitative process modelling is High School work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for geoscience processes, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of geoscience processes.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about geoscience processes using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for geoscience processes, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of geoscience processes.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for geoscience processes, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of geoscience processes.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for geoscience processes, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for geoscience processes works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of geoscience processes, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking geoscience processes mastered.
...
_Package `swp-ma-g8-science-u07-l08` · built from `canonical-1.0.0` at `4056e31`._
