# Independent application A: inheritance models

**Grade 8 Science** · Unit 3: Growth, Reproduction, and Heredity · Day 4 of the unit (course day 28) · about 45–65 minutes
...
- Apply inheritance models independently in a new representation, text, situation, or design constraint.
...
**Q1.** Independently evaluate this fully supplied case about inheritance models: A case report presents this as acceptable science: “reading a model's proportion as a guarantee about an individual offspring.” Use at least two rows from E1-E3, correct the claim if needed, and state one limit.
...
_Package `swp-ma-g8-science-u03-l04` · lesson `ma-g8-science-u03-l04` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
