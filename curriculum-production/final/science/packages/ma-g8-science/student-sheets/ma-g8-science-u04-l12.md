# Correction and reflection: population change over generations

**Grade 8 Science** · Unit 4: Natural Selection and Adaptation · Day 12 of the unit (course day 48) · about 45–65 minutes

**Today's focus:** population change over generations
...
- Use error evidence to choose a different representation or strategy for population change over generations, then demonstrate corrected understanding.
- Use subject-appropriate evidence or representation to communicate understanding of population change over generations.
- Check, revise, or improve work about population change over generations using stated success criteria.
...
- Science brief: evolution is a change in the traits of a population across generations, measured in the population and not in individuals.
- Science brief: the rate of change depends on how strong the selection is, how much heritable variation exists, and how quickly generations turn over.
- Science brief: a trait that is advantageous in one environment can become disadvantageous when the environment changes.

### Evidence check: population change over generations

**Candidate claim:** A case report presents this as acceptable science: “describing evolution as change within an individual organism.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: evolution is a change in the traits of a population across generations, measured in the population and not in individuals. |
| E2 | established science reference | Science brief: the rate of change depends on how strong the selection is, how much heritable variation exists, and how quickly generations turn over. |
| E3 | established science reference | Science brief: a trait that is advantageous in one environment can become disadvantageous when the environment changes. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u04::population change over generations, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about population change over generations, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about population change over generations, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about population change over generations; then identify one check that would catch an error or weak claim.**
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E3. Name the decisive evidence ID, explain the error about population change over generations, and write a corrected claim.

>

**Q2.** Communicate what the supplied record establishes about population change over generations in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about population change over generations against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using population change over generations as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about population change over generations? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about population change over generations that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about population change over generations. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about population change over generations.
...
- Apply population change over generations under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect population change over generations to fossil evidence from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g8-science-u04-l12` · lesson `ma-g8-science-u04-l12` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
