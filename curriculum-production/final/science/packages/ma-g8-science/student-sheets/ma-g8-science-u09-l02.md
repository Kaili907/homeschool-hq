# Concept model A: criteria constraints and stakeholders

**Grade 8 Science** · Unit 9: Engineering and Scientific Argument Capstone · Day 2 of the unit (course day 98) · about 45–65 minutes
...
- Build a clear mental model of criteria constraints and stakeholders through an explicit worked example, demonstration, text, or phenomenon.
...
**Q1.** Build a labelled model of criteria constraints and stakeholders that represents every supplied row in E1-E3. Annotate each model feature with its evidence ID, then show where the candidate claim fails or remains uncertain.
...
_Package `swp-ma-g8-science-u09-l02` · lesson `ma-g8-science-u09-l02` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
