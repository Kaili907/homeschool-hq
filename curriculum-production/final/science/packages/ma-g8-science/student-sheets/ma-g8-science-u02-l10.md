# Synthesis and review: digital versus analog signals

**Grade 8 Science** · Unit 2: Waves and Information Transfer · Day 10 of the unit (course day 22) · about 45–65 minutes

**Today's focus:** digital versus analog signals
...
- Connect digital versus analog signals to the unit’s other ideas and select evidence that shows readiness for assessment.
- Use subject-appropriate evidence or representation to communicate understanding of digital versus analog signals.
- Check, revise, or improve work about digital versus analog signals using stated success criteria.
...
- Science brief: a digital signal encodes information as discrete values; an analog signal varies continuously.
- Science brief: an analog signal varies continuously and any noise added to it becomes part of the signal.
- Science brief: a digital signal takes discrete values, so small amounts of noise can be removed by restoring each value to the nearest allowed one.
- Science brief: that is why digital signals can be copied and transmitted many times with far less degradation than analog ones.

### Evidence check: digital versus analog signals

**Candidate claim:** A case report presents this as acceptable science: “digital signals are immune to all noise and loss.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a digital signal encodes information as discrete values; an analog signal varies continuously. |
| E2 | established science reference | Science brief: an analog signal varies continuously and any noise added to it becomes part of the signal. |
| E3 | established science reference | Science brief: a digital signal takes discrete values, so small amounts of noise can be removed by restoring each value to the nearest allowed one. |
| E4 | established science reference | Science brief: that is why digital signals can be copied and transmitted many times with far less degradation than analog ones. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u02::digital versus analog signals, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about digital versus analog signals, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about digital versus analog signals, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about digital versus analog signals; then identify one check that would catch an error or weak claim.**
...
**Q1.** The supplied unit connections are: wave amplitude wavelength and energy, reflection absorption and transmission, light and sound models, digital versus analog signals, communication technologies, model limitations. Choose one idea other than digital versus analog signals, connect it to one row in E1-E4, and explain one way treating the two ideas as identical would be misleading.

>

**Q2.** Communicate what the supplied record establishes about digital versus analog signals in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about digital versus analog signals against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using digital versus analog signals as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about digital versus analog signals? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about digital versus analog signals that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about digital versus analog signals. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about digital versus analog signals.
...
- Apply digital versus analog signals under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect digital versus analog signals to wave amplitude wavelength and energy from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g8-science-u02-l10` · lesson `ma-g8-science-u02-l10` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
