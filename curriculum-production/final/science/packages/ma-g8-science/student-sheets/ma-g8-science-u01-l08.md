# Reteach and varied practice: force and mass

**Grade 8 Science** · Unit 1: Forces, Motion, and Interactions · Day 8 of the unit (course day 8) · about 45–65 minutes

**Today's focus:** force and mass
...
- Use error evidence to choose a different representation or strategy for force and mass, then demonstrate corrected understanding.
- Use subject-appropriate evidence or representation to communicate understanding of force and mass.
- Check, revise, or improve work about force and mass using stated success criteria.
...
- Science brief: for the same net force, a larger mass has a smaller change in motion.
- Science brief: for a given net force, the change in an object's motion decreases as its mass increases.
- Science brief: for a given mass, a larger net force produces a larger change in motion.
- Science brief: mass is a measure of how much matter an object contains and does not change with location; weight is the gravitational force on it and does.

### Evidence check: force and mass

**Candidate claim:** A case report presents this as acceptable science: “treating mass and weight as the same quantity.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: for the same net force, a larger mass has a smaller change in motion. |
| E2 | established science reference | Science brief: for a given net force, the change in an object's motion decreases as its mass increases. |
| E3 | established science reference | Science brief: for a given mass, a larger net force produces a larger change in motion. |
| E4 | established science reference | Science brief: mass is a measure of how much matter an object contains and does not change with location; weight is the gravitational force on it and does. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u01::force and mass, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about force and mass, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about force and mass, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about force and mass; then identify one check that would catch an error or weak claim.**
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E4. Name the decisive evidence ID, explain the error about force and mass, and write a corrected claim.

>

**Q2.** Communicate what the supplied record establishes about force and mass in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about force and mass against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using force and mass as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about force and mass? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about force and mass that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about force and mass. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about force and mass.
...
- Apply force and mass under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect force and mass to Newton’s laws at middle-school level from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g8-science-u01-l08` · lesson `ma-g8-science-u01-l08` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
