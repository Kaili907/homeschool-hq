# Guided practice B: competing design criteria

**Grade 8 Science** · Unit 8: Applied Biology and Ecosystem Design · Day 6 of the unit (course day 90) · about 45–65 minutes
...
- Practice competing design criteria with prompts, feedback, and gradually reduced support.
...
**Q1.** First compare E1 with E2 and write a provisional conclusion about competing design criteria. Then add the remaining rows through E3, revise the conclusion, and explain the change.
...
_Package `swp-ma-g8-science-u08-l06` · lesson `ma-g8-science-u08-l06` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
