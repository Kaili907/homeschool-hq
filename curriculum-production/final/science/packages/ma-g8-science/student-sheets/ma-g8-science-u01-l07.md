# Investigation or close reading: Newton’s laws at middle-school level

**Grade 8 Science** · Unit 1: Forces, Motion, and Interactions · Day 7 of the unit (course day 7) · about 45–65 minutes

**Today's focus:** Newton’s laws at middle-school level

**Unit question:** How can understanding forces, motion, and interactions help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Gather and analyze evidence related to Newton’s laws at middle-school level, then record a defensible interpretation.
- Use subject-appropriate evidence or representation to communicate understanding of Newton’s laws at middle-school level.
- Check, revise, or improve work about Newton’s laws at middle-school level using stated success criteria.
...
- Science brief: an object's motion changes only when a net force acts on it.
- Science brief: forces come in pairs: when object A pushes on object B, B pushes back on A with equal strength in the opposite direction.
- Science brief: an object at rest stays at rest, and an object in motion keeps the same speed and direction, unless a net force acts on it.
- Science brief: a net force changes an object's motion, and for a given force a more massive object changes motion less.

### Evidence check: Newton’s laws at middle-school level

**Candidate claim:** A case report presents this as acceptable science: “a force is needed to keep an object moving at constant velocity.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: an object's motion changes only when a net force acts on it. |
| E2 | established science reference | Science brief: forces come in pairs: when object A pushes on object B, B pushes back on A with equal strength in the opposite direction. |
| E3 | established science reference | Science brief: an object at rest stays at rest, and an object in motion keeps the same speed and direction, unless a net force acts on it. |
| E4 | established science reference | Science brief: a net force changes an object's motion, and for a given force a more massive object changes motion less. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u01::Newton’s laws at middle-school level, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.

**Supplied unit connections:** Newton’s laws at middle-school level; force and mass; motion graphs; collisions; gravitational interactions; electric and magnetic fields

**Supplied unit performance task:** Design and test a motion or collision system and explain outcomes with force models and data.

### Bound task

**Question:** What does evidence E1 through E4 justify about Newton’s laws at middle-school level, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about Newton’s laws at middle-school level?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g8-science-u01::Newton’s laws at middle-school level, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u01::Newton’s laws at middle-school level, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about Newton’s laws at middle-school level?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about Newton’s laws at middle-school level; then identify one check that would catch an error or weak claim.**
...
**Q1.** Classify every supplied row E1-E4 as supports, challenges, or does not decide the candidate claim about Newton’s laws at middle-school level. Cite the row and explain each classification.

>

**Q2.** Communicate what the supplied record establishes about Newton’s laws at middle-school level in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about Newton’s laws at middle-school level against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using Newton’s laws at middle-school level as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about Newton’s laws at middle-school level? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about Newton’s laws at middle-school level that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about Newton’s laws at middle-school level. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about Newton’s laws at middle-school level.
...
- Apply Newton’s laws at middle-school level under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect Newton’s laws at middle-school level to force and mass from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Design and test a motion or collision system and explain outcomes with force models and data. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-g8-science-u01-l07` · lesson `ma-g8-science-u01-l07` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
