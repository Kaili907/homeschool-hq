# Unit assessment: technology and space data

**Grade 8 Science** · Unit 6: Earth, Moon, Sun, and the Solar System · Day 11 of the unit (course day 71) · about 45–65 minutes

**Today's focus:** technology and space data
...
- Demonstrate current mastery of technology and space data through selected-response, constructed-response, and applied evidence.
- Use subject-appropriate evidence or representation to communicate understanding of technology and space data.
- Check, revise, or improve work about technology and space data using stated success criteria.
...
- Science brief: almost everything known about distant objects comes from the radiation they emit or reflect, collected by telescopes and spacecraft instruments.
- Science brief: improvements in instruments have repeatedly changed what is known, because the data available sets the limits on the conclusions.
- Science brief: every instrument has limits of resolution, sensitivity, and wavelength range, and those limits belong in the interpretation.

### Evidence check: technology and space data

**Candidate claim:** A case report presents this as acceptable science: “treating a processed or false-colour astronomical image as a direct visual view.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: almost everything known about distant objects comes from the radiation they emit or reflect, collected by telescopes and spacecraft instruments. |
| E2 | established science reference | Science brief: improvements in instruments have repeatedly changed what is known, because the data available sets the limits on the conclusions. |
| E3 | established science reference | Science brief: every instrument has limits of resolution, sensitivity, and wavelength range, and those limits belong in the interpretation. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u06::technology and space data, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about technology and space data, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about technology and space data, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? Rate confidence in technology and space data, cite one piece of evidence from today, and choose: ready to extend, ready to review later, or need a different explanation.**
...
**Q1.** Complete all three parts for technology and space data. (1) Select A: supported, B: partly supported, or C: not supported for the candidate claim. (2) Justify the selection with E1-E3. (3) Rewrite the claim so every word is supported by the supplied record.

>

**Q2.** Communicate what the supplied record establishes about technology and space data in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about technology and space data against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using technology and space data as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about technology and space data? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about technology and space data that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about technology and space data. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about technology and space data.
...
- Apply technology and space data under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect technology and space data to seasons from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g8-science-u06-l11` · lesson `ma-g8-science-u06-l11` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
