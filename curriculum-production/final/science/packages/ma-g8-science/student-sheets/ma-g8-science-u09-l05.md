# Concept model B: optimization

**Grade 8 Science** · Unit 9: Engineering and Scientific Argument Capstone · Day 5 of the unit (course day 101) · about 45–65 minutes
...
- Build a clear mental model of optimization through an explicit worked example, demonstration, text, or phenomenon.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about optimization; then identify one check that would catch an error or weak claim.**
...
**Q1.** Build a labelled model of optimization that represents every supplied row in E1-E3. Annotate each model feature with its evidence ID, then show where the candidate claim fails or remains uncertain.
...
_Package `swp-ma-g8-science-u09-l05` · lesson `ma-g8-science-u09-l05` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
