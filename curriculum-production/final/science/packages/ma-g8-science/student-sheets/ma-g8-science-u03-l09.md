# Performance task build: mutations

**Grade 8 Science** · Unit 3: Growth, Reproduction, and Heredity · Day 9 of the unit (course day 33) · about 45–65 minutes

**Today's focus:** mutations
...
- Create, test, or revise a meaningful product that applies mutations and the unit standards.
- Use subject-appropriate evidence or representation to communicate understanding of mutations.
- Check, revise, or improve work about mutations using stated success criteria.
...
- Science brief: a mutation is a change in the DNA sequence, and it may be harmful, beneficial, or have no noticeable effect.
- Science brief: mutations are changes to the genetic material and can arise from copying errors or from environmental agents.
- Science brief: a mutation's effect depends on where it occurs and what it changes; most have no noticeable effect on the organism.
- Science brief: only mutations in cells that produce offspring can be inherited.

### Evidence check: mutations
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a mutation is a change in the DNA sequence, and it may be harmful, beneficial, or have no noticeable effect. |
| E2 | established science reference | Science brief: mutations are changes to the genetic material and can arise from copying errors or from environmental agents. |
| E3 | established science reference | Science brief: a mutation's effect depends on where it occurs and what it changes; most have no noticeable effect on the organism. |
| E4 | established science reference | Science brief: only mutations in cells that produce offspring can be inherited. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u03::mutations, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about mutations, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about mutations?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g8-science-u03::mutations, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u03::mutations, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about mutations?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about mutations; then identify one check that would catch an error or weak claim.**
...
**Q1.** Create a one-page evidence product for mutations using only the supplied case and E1-E4: one claim, at least two cited rows, the reasoning link, one counterpoint, and one revision after checking the success criteria.

>

**Q2.** Communicate what the supplied record establishes about mutations in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about mutations against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using mutations as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about mutations? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about mutations that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about mutations. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about mutations.
...
- Apply mutations under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect mutations to sexual and asexual reproduction from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g8-science-u03-l09` · lesson `ma-g8-science-u03-l09` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
