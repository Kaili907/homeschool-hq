# Unit assessment: environment and trait expression

**Grade 8 Science** · Unit 3: Growth, Reproduction, and Heredity · Day 11 of the unit (course day 35) · about 45–65 minutes

**Today's focus:** environment and trait expression
...
- Demonstrate current mastery of environment and trait expression through selected-response, constructed-response, and applied evidence.
- Use subject-appropriate evidence or representation to communicate understanding of environment and trait expression.
- Check, revise, or improve work about environment and trait expression using stated success criteria.
...
- Science brief: many traits result from both genetic instructions and environmental conditions.
- Science brief: two organisms with the same genetic instructions can differ if they develop in different environments.
- Science brief: an environmentally caused change in an individual is not passed on through the genetic material.

### Evidence check: environment and trait expression

**Candidate claim:** A case report presents this as acceptable science: “every trait is determined by genes alone.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: many traits result from both genetic instructions and environmental conditions. |
| E2 | established science reference | Science brief: two organisms with the same genetic instructions can differ if they develop in different environments. |
| E3 | established science reference | Science brief: an environmentally caused change in an individual is not passed on through the genetic material. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u03::environment and trait expression, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about environment and trait expression, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about environment and trait expression, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? Rate confidence in environment and trait expression, cite one piece of evidence from today, and choose: ready to extend, ready to review later, or need a different explanation.**
...
**Q1.** Complete all three parts for environment and trait expression. (1) Select A: supported, B: partly supported, or C: not supported for the candidate claim. (2) Justify the selection with E1-E3. (3) Rewrite the claim so every word is supported by the supplied record.

>

**Q2.** Communicate what the supplied record establishes about environment and trait expression in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about environment and trait expression against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using environment and trait expression as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about environment and trait expression? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about environment and trait expression that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about environment and trait expression. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about environment and trait expression.
...
- Apply environment and trait expression under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect environment and trait expression to sexual and asexual reproduction from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g8-science-u03-l11` · lesson `ma-g8-science-u03-l11` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
