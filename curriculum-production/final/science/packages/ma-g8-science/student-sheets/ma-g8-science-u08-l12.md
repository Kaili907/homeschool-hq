# Correction and reflection: competing design criteria

**Grade 8 Science** · Unit 8: Applied Biology and Ecosystem Design · Day 12 of the unit (course day 96) · about 45–65 minutes

**Today's focus:** competing design criteria
...
- Use error evidence to choose a different representation or strategy for competing design criteria, then demonstrate corrected understanding.
- Use subject-appropriate evidence or representation to communicate understanding of competing design criteria.
- Check, revise, or improve work about competing design criteria using stated success criteria.
...
- Science brief: ecosystem design problems involve criteria that pull against one another, such as yield, cost, biodiversity, and resilience.
- Science brief: improving one criterion usually costs something on another, and the choice of which to favour is a decision, not a measurement.
- Science brief: every option is evaluated against the same criteria, including the option of doing nothing.

### Evidence check: competing design criteria

**Candidate claim:** A case report presents this as acceptable science: “presenting a solution that is best on every criterion at once with no trade-off.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: ecosystem design problems involve criteria that pull against one another, such as yield, cost, biodiversity, and resilience. |
| E2 | established science reference | Science brief: improving one criterion usually costs something on another, and the choice of which to favour is a decision, not a measurement. |
| E3 | established science reference | Science brief: every option is evaluated against the same criteria, including the option of doing nothing. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u08::competing design criteria, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about competing design criteria, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about competing design criteria, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about competing design criteria; then identify one check that would catch an error or weak claim.**
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E3. Name the decisive evidence ID, explain the error about competing design criteria, and write a corrected claim.

>

**Q2.** Communicate what the supplied record establishes about competing design criteria in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about competing design criteria against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using competing design criteria as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about competing design criteria? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about competing design criteria that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about competing design criteria. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about competing design criteria.
...
- Apply competing design criteria under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect competing design criteria to biodiversity from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g8-science-u08-l12` · lesson `ma-g8-science-u08-l12` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
