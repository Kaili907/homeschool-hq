# Guided practice B: scientific argument and communication

**Grade 8 Science** · Unit 9: Engineering and Scientific Argument Capstone · Day 6 of the unit (course day 102) · about 45–65 minutes
...
- Practice scientific argument and communication with prompts, feedback, and gradually reduced support.
...
**Q1.** First compare E1 with E2 and write a provisional conclusion about scientific argument and communication. Then add the remaining rows through E3, revise the conclusion, and explain the change.
...
_Package `swp-ma-g8-science-u09-l06` · lesson `ma-g8-science-u09-l06` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
