# Independent application A: cycling of Earth materials

**Grade 8 Science** · Unit 5: Earth History and Geologic Processes · Day 4 of the unit (course day 52) · about 45–65 minutes
...
- Apply cycling of Earth materials independently in a new representation, text, situation, or design constraint.
...
**Q1.** Independently evaluate this fully supplied case about cycling of Earth materials: A case report presents this as acceptable science: “the rock cycle runs in a single fixed sequence.” Use at least two rows from E1-E4, correct the claim if needed, and state one limit.
...
_Package `swp-ma-g8-science-u05-l04` · lesson `ma-g8-science-u05-l04` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
