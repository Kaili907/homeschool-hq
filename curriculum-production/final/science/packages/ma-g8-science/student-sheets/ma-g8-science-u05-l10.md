# Synthesis and review: cycling of Earth materials

**Grade 8 Science** · Unit 5: Earth History and Geologic Processes · Day 10 of the unit (course day 58) · about 45–65 minutes

**Today's focus:** cycling of Earth materials
...
- Connect cycling of Earth materials to the unit’s other ideas and select evidence that shows readiness for assessment.
- Use subject-appropriate evidence or representation to communicate understanding of cycling of Earth materials.
- Check, revise, or improve work about cycling of Earth materials using stated success criteria.
...
- Science brief: rock is cycled among igneous, sedimentary, and metamorphic forms; any rock type can become any other.
- Science brief: rock material is recycled: melting and cooling, weathering and deposition, and heat and pressure convert rock between igneous, sedimentary, and metamorphic forms.
- Science brief: there is no fixed order to the cycle; any rock type can become any other given the right conditions.
- Science brief: the cycle is driven by energy from Earth's interior and from the Sun, together with gravity.

### Evidence check: cycling of Earth materials

**Candidate claim:** A case report presents this as acceptable science: “the rock cycle runs in a single fixed sequence.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: rock is cycled among igneous, sedimentary, and metamorphic forms; any rock type can become any other. |
| E2 | established science reference | Science brief: rock material is recycled: melting and cooling, weathering and deposition, and heat and pressure convert rock between igneous, sedimentary, and metamorphic forms. |
| E3 | established science reference | Science brief: there is no fixed order to the cycle; any rock type can become any other given the right conditions. |
| E4 | established science reference | Science brief: the cycle is driven by energy from Earth's interior and from the Sun, together with gravity. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u05::cycling of Earth materials, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about cycling of Earth materials, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about cycling of Earth materials, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about cycling of Earth materials; then identify one check that would catch an error or weak claim.**
...
**Q1.** The supplied unit connections are: geologic time, rock strata and fossils, plate tectonics, cycling of Earth materials, surface processes, evidence for past change. Choose one idea other than cycling of Earth materials, connect it to one row in E1-E4, and explain one way treating the two ideas as identical would be misleading.

>

**Q2.** Communicate what the supplied record establishes about cycling of Earth materials in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about cycling of Earth materials against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using cycling of Earth materials as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about cycling of Earth materials? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about cycling of Earth materials that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about cycling of Earth materials. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about cycling of Earth materials.
...
- Apply cycling of Earth materials under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect cycling of Earth materials to geologic time from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g8-science-u05-l10` · lesson `ma-g8-science-u05-l10` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
