# Performance task build: data-driven comparison

**Grade 8 Science** · Unit 9: Engineering and Scientific Argument Capstone · Day 9 of the unit (course day 105) · about 45–65 minutes

**Today's focus:** data-driven comparison

**Unit question:** How can understanding engineering and scientific argument capstone help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Create, test, or revise a meaningful product that applies data-driven comparison and the unit standards.
- Use subject-appropriate evidence or representation to communicate understanding of data-driven comparison.
- Check, revise, or improve work about data-driven comparison using stated success criteria.
...
- Science brief: comparing solutions requires the same measurements under the same conditions for each option.
- Science brief: a difference smaller than the variation between repeated trials is not evidence that one option is better.
- Science brief: the comparison reports every criterion evaluated, including those where the preferred option performs badly.

### Evidence check: data-driven comparison

**Candidate claim:** A case report presents this as acceptable science: “comparing options tested under different conditions.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: comparing solutions requires the same measurements under the same conditions for each option. |
| E2 | established science reference | Science brief: a difference smaller than the variation between repeated trials is not evidence that one option is better. |
| E3 | established science reference | Science brief: the comparison reports every criterion evaluated, including those where the preferred option performs badly. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u09::data-driven comparison, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.

**Supplied unit connections:** problem definition; criteria constraints and stakeholders; data-driven comparison; iterative modeling; optimization; scientific argument and communication

**Supplied unit performance task:** Complete an engineering or research capstone tied to forces, waves, life science, Earth science, or environmental systems.

### Bound task

**Question:** What does evidence E1 through E3 justify about data-driven comparison, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about data-driven comparison?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g8-science-u09::data-driven comparison, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u09::data-driven comparison, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about data-driven comparison?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about data-driven comparison; then identify one check that would catch an error or weak claim.**
...
**Q1.** Create a one-page evidence product for data-driven comparison using only the supplied case and E1-E3: one claim, at least two cited rows, the reasoning link, one counterpoint, and one revision after checking the success criteria.

>

**Q2.** Communicate what the supplied record establishes about data-driven comparison in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about data-driven comparison against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using data-driven comparison as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about data-driven comparison? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about data-driven comparison that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about data-driven comparison. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about data-driven comparison.
...
- Apply data-driven comparison under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect data-driven comparison to problem definition from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Complete an engineering or research capstone tied to forces, waves, life science, Earth science, or environmental systems. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-g8-science-u09-l09` · lesson `ma-g8-science-u09-l09` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
