# Unit assessment: surface processes

**Grade 8 Science** · Unit 5: Earth History and Geologic Processes · Day 11 of the unit (course day 59) · about 45–65 minutes

**Today's focus:** surface processes
...
- Demonstrate current mastery of surface processes through selected-response, constructed-response, and applied evidence.
- Use subject-appropriate evidence or representation to communicate understanding of surface processes.
- Check, revise, or improve work about surface processes using stated success criteria.
...
- Science brief: weathering breaks rock down in place; erosion transports the material; deposition lays it down elsewhere.
- Science brief: weathering, erosion, transport, and deposition together reshape Earth's surface continuously.
- Science brief: the rate depends on climate, slope, rock type, and vegetation cover, so it varies enormously between places.
- Science brief: surface processes generally act to wear down elevated regions while tectonic processes build them up.

### Evidence check: surface processes

**Candidate claim:** A case report presents this as acceptable science: “using weathering and erosion as interchangeable terms.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: weathering breaks rock down in place; erosion transports the material; deposition lays it down elsewhere. |
| E2 | established science reference | Science brief: weathering, erosion, transport, and deposition together reshape Earth's surface continuously. |
| E3 | established science reference | Science brief: the rate depends on climate, slope, rock type, and vegetation cover, so it varies enormously between places. |
| E4 | established science reference | Science brief: surface processes generally act to wear down elevated regions while tectonic processes build them up. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u05::surface processes, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about surface processes, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about surface processes, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? Rate confidence in surface processes, cite one piece of evidence from today, and choose: ready to extend, ready to review later, or need a different explanation.**
...
**Q1.** Complete all three parts for surface processes. (1) Select A: supported, B: partly supported, or C: not supported for the candidate claim. (2) Justify the selection with E1-E4. (3) Rewrite the claim so every word is supported by the supplied record.

>

**Q2.** Communicate what the supplied record establishes about surface processes in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about surface processes against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using surface processes as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about surface processes? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about surface processes that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about surface processes. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about surface processes.
...
- Apply surface processes under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect surface processes to geologic time from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g8-science-u05-l11` · lesson `ma-g8-science-u05-l11` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
