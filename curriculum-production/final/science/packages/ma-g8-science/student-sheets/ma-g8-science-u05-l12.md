# Correction and reflection: evidence for past change

**Grade 8 Science** · Unit 5: Earth History and Geologic Processes · Day 12 of the unit (course day 60) · about 45–65 minutes

**Today's focus:** evidence for past change
...
- Use error evidence to choose a different representation or strategy for evidence for past change, then demonstrate corrected understanding.
- Use subject-appropriate evidence or representation to communicate understanding of evidence for past change.
- Check, revise, or improve work about evidence for past change using stated success criteria.
...
- Science brief: conclusions about Earth's past rest on several independent lines of evidence agreeing: rock type, structure, fossils, and dating.
- Science brief: present-day processes are used to interpret past ones, because the same physical and chemical processes operated then.
- Science brief: a conclusion about the past is provisional and is revised when new evidence requires it.

### Evidence check: evidence for past change

**Candidate claim:** A case report presents this as acceptable science: “drawing a conclusion about the past from one line of evidence and presenting it as settled.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: conclusions about Earth's past rest on several independent lines of evidence agreeing: rock type, structure, fossils, and dating. |
| E2 | established science reference | Science brief: present-day processes are used to interpret past ones, because the same physical and chemical processes operated then. |
| E3 | established science reference | Science brief: a conclusion about the past is provisional and is revised when new evidence requires it. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u05::evidence for past change, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about evidence for past change, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about evidence for past change, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about evidence for past change; then identify one check that would catch an error or weak claim.**
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E3. Name the decisive evidence ID, explain the error about evidence for past change, and write a corrected claim.

>

**Q2.** Communicate what the supplied record establishes about evidence for past change in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about evidence for past change against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using evidence for past change as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about evidence for past change? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about evidence for past change that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about evidence for past change. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about evidence for past change.
...
- Apply evidence for past change under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect evidence for past change to geologic time from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g8-science-u05-l12` · lesson `ma-g8-science-u05-l12` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
