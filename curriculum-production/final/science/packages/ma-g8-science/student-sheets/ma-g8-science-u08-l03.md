# Guided practice A: disturbance and resilience

**Grade 8 Science** · Unit 8: Applied Biology and Ecosystem Design · Day 3 of the unit (course day 87) · about 45–65 minutes
...
- Practice disturbance and resilience with prompts, feedback, and gradually reduced support.
...
**The task.** What does evidence E1 through E3 justify about disturbance and resilience, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**Q1.** First compare E1 with E2 and write a provisional conclusion about disturbance and resilience. Then add the remaining rows through E3, revise the conclusion, and explain the change.
...
_Package `swp-ma-g8-science-u08-l03` · lesson `ma-g8-science-u08-l03` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
