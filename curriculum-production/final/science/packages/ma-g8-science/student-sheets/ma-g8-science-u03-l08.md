# Reteach and varied practice: genes chromosomes and traits

**Grade 8 Science** · Unit 3: Growth, Reproduction, and Heredity · Day 8 of the unit (course day 32) · about 45–65 minutes

**Today's focus:** genes chromosomes and traits
...
- Use error evidence to choose a different representation or strategy for genes chromosomes and traits, then demonstrate corrected understanding.
- Use subject-appropriate evidence or representation to communicate understanding of genes chromosomes and traits.
- Check, revise, or improve work about genes chromosomes and traits using stated success criteria.
...
- Science brief: genes are segments of DNA located on chromosomes, and they carry the instructions for proteins that affect traits.
- Science brief: chromosomes carry genes, and genes are lengths of DNA that code for proteins.
- Science brief: proteins carry out and regulate the processes that produce an organism's traits, which is why a change in a gene can change a trait.
- Science brief: offspring receive one set of chromosomes from each parent in sexual reproduction, which is why they show a combination of parental traits.

### Evidence check: genes chromosomes and traits

**Candidate claim:** A case report presents this as acceptable science: “a gene is a trait rather than an instruction that influences one.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: genes are segments of DNA located on chromosomes, and they carry the instructions for proteins that affect traits. |
| E2 | established science reference | Science brief: chromosomes carry genes, and genes are lengths of DNA that code for proteins. |
| E3 | established science reference | Science brief: proteins carry out and regulate the processes that produce an organism's traits, which is why a change in a gene can change a trait. |
| E4 | established science reference | Science brief: offspring receive one set of chromosomes from each parent in sexual reproduction, which is why they show a combination of parental traits. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u03::genes chromosomes and traits, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about genes chromosomes and traits, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about genes chromosomes and traits, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about genes chromosomes and traits; then identify one check that would catch an error or weak claim.**
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E4. Name the decisive evidence ID, explain the error about genes chromosomes and traits, and write a corrected claim.

>

**Q2.** Communicate what the supplied record establishes about genes chromosomes and traits in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about genes chromosomes and traits against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using genes chromosomes and traits as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about genes chromosomes and traits? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about genes chromosomes and traits that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about genes chromosomes and traits. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about genes chromosomes and traits.
...
- Apply genes chromosomes and traits under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect genes chromosomes and traits to sexual and asexual reproduction from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g8-science-u03-l08` · lesson `ma-g8-science-u03-l08` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
