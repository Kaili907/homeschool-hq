# Investigation or close reading: seasons

**Grade 8 Science** · Unit 6: Earth, Moon, Sun, and the Solar System · Day 7 of the unit (course day 67) · about 45–65 minutes

**Today's focus:** seasons
...
- Gather and analyze evidence related to seasons, then record a defensible interpretation.
- Use subject-appropriate evidence or representation to communicate understanding of seasons.
- Check, revise, or improve work about seasons using stated success criteria.
...
- Science brief: seasons are caused by the tilt of Earth's rotation axis relative to its orbit, not by changes in Earth's distance from the Sun.
- Science brief: earth's axis is tilted relative to its orbital plane and keeps the same orientation in space as Earth orbits the Sun.
- Science brief: because of the tilt, each hemisphere receives sunlight at a more direct angle and for longer each day during its summer.
- Science brief: the two hemispheres therefore have opposite seasons at the same time of year.

### Evidence check: seasons

**Candidate claim:** A case report presents this as acceptable science: “seasons are caused by Earth being closer to the Sun in summer.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: seasons are caused by the tilt of Earth's rotation axis relative to its orbit, not by changes in Earth's distance from the Sun. |
| E2 | established science reference | Science brief: earth's axis is tilted relative to its orbital plane and keeps the same orientation in space as Earth orbits the Sun. |
| E3 | established science reference | Science brief: because of the tilt, each hemisphere receives sunlight at a more direct angle and for longer each day during its summer. |
| E4 | established science reference | Science brief: the two hemispheres therefore have opposite seasons at the same time of year. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u06::seasons, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about seasons, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about seasons?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g8-science-u06::seasons, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u06::seasons, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about seasons?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about seasons; then identify one check that would catch an error or weak claim.**
...
**Q1.** Classify every supplied row E1-E4 as supports, challenges, or does not decide the candidate claim about seasons. Cite the row and explain each classification.

>

**Q2.** Communicate what the supplied record establishes about seasons in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about seasons against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using seasons as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about seasons? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about seasons that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about seasons. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about seasons.
...
- Apply seasons under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect seasons to lunar phases and eclipses from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g8-science-u06-l07` · lesson `ma-g8-science-u06-l07` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
