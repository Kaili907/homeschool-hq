# Concept model A: rock strata and fossils

**Grade 8 Science** · Unit 5: Earth History and Geologic Processes · Day 2 of the unit (course day 50) · about 45–65 minutes

**Today's focus:** rock strata and fossils
...
- Build a clear mental model of rock strata and fossils through an explicit worked example, demonstration, text, or phenomenon.
- Use subject-appropriate evidence or representation to communicate understanding of rock strata and fossils.
- Check, revise, or improve work about rock strata and fossils using stated success criteria.
...
- Science brief: in undisturbed sequences, lower strata are older than the strata above them.
- Science brief: sedimentary strata are deposited in order, so in an undisturbed sequence lower means older.
- Science brief: fossils within strata date the strata relative to one another, and matching fossil assemblages allow strata in different places to be correlated.
- Science brief: strata can be tilted, folded, faulted, or eroded, so the sequence has to be interpreted, not simply read off.

### Evidence check: rock strata and fossils

**Candidate claim:** A case report presents this as acceptable science: “applying the lower-is-older rule to a visibly overturned sequence without accounting for it.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: in undisturbed sequences, lower strata are older than the strata above them. |
| E2 | established science reference | Science brief: sedimentary strata are deposited in order, so in an undisturbed sequence lower means older. |
| E3 | established science reference | Science brief: fossils within strata date the strata relative to one another, and matching fossil assemblages allow strata in different places to be correlated. |
| E4 | established science reference | Science brief: strata can be tilted, folded, faulted, or eroded, so the sequence has to be interpreted, not simply read off. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u05::rock strata and fossils, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about rock strata and fossils, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about rock strata and fossils, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about rock strata and fossils; then identify one check that would catch an error or weak claim.**
...
**Q1.** Build a labelled model of rock strata and fossils that represents every supplied row in E1-E4. Annotate each model feature with its evidence ID, then show where the candidate claim fails or remains uncertain.

>

**Q2.** Communicate what the supplied record establishes about rock strata and fossils in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about rock strata and fossils against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using rock strata and fossils as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about rock strata and fossils? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about rock strata and fossils that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about rock strata and fossils. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about rock strata and fossils.
...
- Apply rock strata and fossils under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect rock strata and fossils to geologic time from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g8-science-u05-l02` · lesson `ma-g8-science-u05-l02` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
