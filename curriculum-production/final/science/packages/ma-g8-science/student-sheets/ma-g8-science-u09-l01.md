# Launch and diagnostic: problem definition

**Grade 8 Science** · Unit 9: Engineering and Scientific Argument Capstone · Day 1 of the unit (course day 97) · about 45–65 minutes
...
- Activate prior knowledge about problem definition, surface initial thinking without penalty, and establish the unit question.
...
**The task.** What does evidence E1 through E3 justify about problem definition, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**Q1.** Before rereading the brief, classify the supplied candidate claim about problem definition as supported, partly supported, or not supported. Then read E1-E3, revise the classification, and name the evidence ID that changed or confirmed your thinking.
...
_Package `swp-ma-g8-science-u09-l01` · lesson `ma-g8-science-u09-l01` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
