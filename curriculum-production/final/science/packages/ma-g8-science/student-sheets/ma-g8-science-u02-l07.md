# Investigation or close reading: wave amplitude wavelength and energy

**Grade 8 Science** · Unit 2: Waves and Information Transfer · Day 7 of the unit (course day 19) · about 45–65 minutes

**Today's focus:** wave amplitude wavelength and energy

**Unit question:** How can understanding waves and information transfer help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Gather and analyze evidence related to wave amplitude wavelength and energy, then record a defensible interpretation.
- Use subject-appropriate evidence or representation to communicate understanding of wave amplitude wavelength and energy.
- Check, revise, or improve work about wave amplitude wavelength and energy using stated success criteria.
...
**Protective equipment.** Wear eye protection and hand protection for any hands-on step. If you do not have them, run the alternative path instead; it needs no protective equipment and earns the same credit.
...
- Science brief: a wave's amplitude determines the energy it carries; wavelength is the distance between matching points on successive waves.
- Science brief: amplitude is the maximum displacement from the resting position, and a larger amplitude wave carries more energy.
- Science brief: wavelength is the distance from a point on one wave to the matching point on the next, and frequency is the number of waves passing a point each second.
- Science brief: in a given medium, wavelength and frequency vary together so that their product, the wave speed, stays the same.

### Evidence check: wave amplitude wavelength and energy

**Candidate claim:** A case report presents this as acceptable science: “amplitude determines the pitch of a sound or the colour of light.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a wave's amplitude determines the energy it carries; wavelength is the distance between matching points on successive waves. |
| E2 | established science reference | Science brief: amplitude is the maximum displacement from the resting position, and a larger amplitude wave carries more energy. |
| E3 | established science reference | Science brief: wavelength is the distance from a point on one wave to the matching point on the next, and frequency is the number of waves passing a point each second. |
| E4 | established science reference | Science brief: in a given medium, wavelength and frequency vary together so that their product, the wave speed, stays the same. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u02::wave amplitude wavelength and energy, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.

**Supplied unit connections:** wave amplitude wavelength and energy; reflection absorption and transmission; light and sound models; digital versus analog signals; communication technologies; model limitations

**Supplied unit performance task:** Build or analyze a communication system and evaluate how wave properties affect information transfer.

### Bound task

**Question:** What does evidence E1 through E4 justify about wave amplitude wavelength and energy, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about wave amplitude wavelength and energy?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g8-science-u02::wave amplitude wavelength and energy, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u02::wave amplitude wavelength and energy, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about wave amplitude wavelength and energy?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about wave amplitude wavelength and energy; then identify one check that would catch an error or weak claim.**
...
**Q1.** Classify every supplied row E1-E4 as supports, challenges, or does not decide the candidate claim about wave amplitude wavelength and energy. Cite the row and explain each classification.

>

**Q2.** Communicate what the supplied record establishes about wave amplitude wavelength and energy in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about wave amplitude wavelength and energy against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using wave amplitude wavelength and energy as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about wave amplitude wavelength and energy? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about wave amplitude wavelength and energy that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about wave amplitude wavelength and energy. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about wave amplitude wavelength and energy.
...
- Apply wave amplitude wavelength and energy under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect wave amplitude wavelength and energy to reflection absorption and transmission from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Build or analyze a communication system and evaluate how wave properties affect information transfer. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-g8-science-u02-l07` · lesson `ma-g8-science-u02-l07` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
