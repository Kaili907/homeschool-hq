# Unit assessment: natural selection

**Grade 8 Science** · Unit 4: Natural Selection and Adaptation · Day 11 of the unit (course day 47) · about 45–65 minutes
...
- Demonstrate current mastery of natural selection through selected-response, constructed-response, and applied evidence.
- Use subject-appropriate evidence or representation to communicate understanding of natural selection.
- Check, revise, or improve work about natural selection using stated success criteria.
...
- Science brief: natural selection requires heritable variation, competition for limited resources, differences in survival and reproduction, and inheritance of the advantageous variation.
- Science brief: individuals with heritable traits that suit their environment tend to survive and reproduce more than those without them.
- Science brief: because the traits are heritable, they become more common in the population over generations.
- Science brief: natural selection acts on populations across generations; individual organisms do not evolve during their lifetimes.

### Evidence check: natural selection

**Candidate claim:** A case report presents this as acceptable science: “an individual organism evolves or adapts itself during its lifetime.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: natural selection requires heritable variation, competition for limited resources, differences in survival and reproduction, and inheritance of the advantageous variation. |
| E2 | established science reference | Science brief: individuals with heritable traits that suit their environment tend to survive and reproduce more than those without them. |
| E3 | established science reference | Science brief: because the traits are heritable, they become more common in the population over generations. |
| E4 | established science reference | Science brief: natural selection acts on populations across generations; individual organisms do not evolve during their lifetimes. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u04::natural selection, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about natural selection, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about natural selection, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? Rate confidence in natural selection, cite one piece of evidence from today, and choose: ready to extend, ready to review later, or need a different explanation.**
...
**Q1.** Complete all three parts for natural selection. (1) Select A: supported, B: partly supported, or C: not supported for the candidate claim. (2) Justify the selection with E1-E4. (3) Rewrite the claim so every word is supported by the supplied record.

>

**Q2.** Communicate what the supplied record establishes about natural selection in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about natural selection against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using natural selection as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about natural selection? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about natural selection that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about natural selection. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about natural selection.
...
- Apply natural selection under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect natural selection to fossil evidence from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g8-science-u04-l11` · lesson `ma-g8-science-u04-l11` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
