# Concept model A: anatomical similarities

**Grade 8 Science** · Unit 4: Natural Selection and Adaptation · Day 2 of the unit (course day 38) · about 45–65 minutes

**Today's focus:** anatomical similarities
...
- Build a clear mental model of anatomical similarities through an explicit worked example, demonstration, text, or phenomenon.
- Use subject-appropriate evidence or representation to communicate understanding of anatomical similarities.
- Check, revise, or improve work about anatomical similarities using stated success criteria.
...
- Science brief: different species can share the same underlying body structures, such as the bone pattern in the limbs of mammals, birds, and reptiles.
- Science brief: shared underlying structure used for different purposes is evidence of common ancestry rather than of shared function.
- Science brief: similar function achieved with quite different structures, such as insect and bird wings, is evidence of separate origins.

### Evidence check: anatomical similarities

**Candidate claim:** A case report presents this as acceptable science: “treating any resemblance between two organisms as evidence of close relationship.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: different species can share the same underlying body structures, such as the bone pattern in the limbs of mammals, birds, and reptiles. |
| E2 | established science reference | Science brief: shared underlying structure used for different purposes is evidence of common ancestry rather than of shared function. |
| E3 | established science reference | Science brief: similar function achieved with quite different structures, such as insect and bird wings, is evidence of separate origins. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u04::anatomical similarities, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about anatomical similarities, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about anatomical similarities, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about anatomical similarities; then identify one check that would catch an error or weak claim.**
...
**Q1.** Build a labelled model of anatomical similarities that represents every supplied row in E1-E3. Annotate each model feature with its evidence ID, then show where the candidate claim fails or remains uncertain.

>

**Q2.** Communicate what the supplied record establishes about anatomical similarities in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about anatomical similarities against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using anatomical similarities as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about anatomical similarities? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about anatomical similarities that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about anatomical similarities. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about anatomical similarities.
...
- Apply anatomical similarities under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect anatomical similarities to fossil evidence from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g8-science-u04-l02` · lesson `ma-g8-science-u04-l02` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
