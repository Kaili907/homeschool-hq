# Performance task build: population and consumption

**Grade 8 Science** · Unit 7: Resources, Climate, and Human Systems · Day 9 of the unit (course day 81) · about 45–65 minutes

**Today's focus:** population and consumption

**Unit question:** How can understanding resources, climate, and human systems help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Create, test, or revise a meaningful product that applies population and consumption and the unit standards.
- Use subject-appropriate evidence or representation to communicate understanding of population and consumption.
- Check, revise, or improve work about population and consumption using stated success criteria.
...
- Science brief: total human impact depends on population size, on consumption per person, and on the technologies used.
- Science brief: per-person consumption varies greatly between regions, so population size alone does not determine impact.
- Science brief: changes in any of the three factors change the total, and they can act in opposite directions.

### Evidence check: population and consumption

**Candidate claim:** A case report presents this as acceptable science: “attributing environmental impact to population size alone.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: total human impact depends on population size, on consumption per person, and on the technologies used. |
| E2 | established science reference | Science brief: per-person consumption varies greatly between regions, so population size alone does not determine impact. |
| E3 | established science reference | Science brief: changes in any of the three factors change the total, and they can act in opposite directions. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u07::population and consumption, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.

**Supplied unit connections:** resource distribution; geoscience processes; population and consumption; climate evidence; mitigation adaptation and tradeoffs; environmental justice foundations

**Supplied unit performance task:** Evaluate a resource or climate-response decision using science, uncertainty, costs, benefits, and affected communities.

### Bound task

**Question:** What does evidence E1 through E3 justify about population and consumption, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about population and consumption?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g8-science-u07::population and consumption, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u07::population and consumption, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about population and consumption?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about population and consumption; then identify one check that would catch an error or weak claim.**
...
**Q1.** Create a one-page evidence product for population and consumption using only the supplied case and E1-E3: one claim, at least two cited rows, the reasoning link, one counterpoint, and one revision after checking the success criteria.

>

**Q2.** Communicate what the supplied record establishes about population and consumption in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about population and consumption against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using population and consumption as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about population and consumption? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about population and consumption that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about population and consumption. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about population and consumption.
...
- Apply population and consumption under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect population and consumption to resource distribution from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Evaluate a resource or climate-response decision using science, uncertainty, costs, benefits, and affected communities. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-g8-science-u07-l09` · lesson `ma-g8-science-u07-l09` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
