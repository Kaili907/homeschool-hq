# Independent application A: solar-system scale

**Grade 8 Science** · Unit 6: Earth, Moon, Sun, and the Solar System · Day 4 of the unit (course day 64) · about 45–65 minutes
...
- Apply solar-system scale independently in a new representation, text, situation, or design constraint.
...
**Q1.** Independently evaluate this fully supplied case about solar-system scale: A case report presents this as acceptable science: “reading planetary distances or sizes off a classroom diagram as though it were to scale.” Use at least two rows from E1-E4, correct the claim if needed, and state one limit.
...
_Package `swp-ma-g8-science-u06-l04` · lesson `ma-g8-science-u06-l04` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
