# Reteach and varied practice: lunar phases and eclipses

**Grade 8 Science** · Unit 6: Earth, Moon, Sun, and the Solar System · Day 8 of the unit (course day 68) · about 45–65 minutes

**Today's focus:** lunar phases and eclipses
...
- Use error evidence to choose a different representation or strategy for lunar phases and eclipses, then demonstrate corrected understanding.
- Use subject-appropriate evidence or representation to communicate understanding of lunar phases and eclipses.
- Check, revise, or improve work about lunar phases and eclipses using stated success criteria.
...
- Science brief: lunar phases are caused by the changing relative positions of the Sun, Earth, and Moon, not by Earth's shadow falling on the Moon.
- Science brief: a lunar eclipse occurs when Earth's shadow falls on the Moon; a solar eclipse occurs when the Moon passes between the Sun and Earth.
- Science brief: half the Moon is always lit by the Sun; the phase is how much of that lit half is visible from Earth as the Moon orbits.
- Science brief: the phase cycle repeats about every month as the Moon completes an orbit relative to the Sun.

### Evidence check: lunar phases and eclipses

**Candidate claim:** A case report presents this as acceptable science: “lunar phases are caused by Earth's shadow on the Moon.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: lunar phases are caused by the changing relative positions of the Sun, Earth, and Moon, not by Earth's shadow falling on the Moon. |
| E2 | established science reference | Science brief: a lunar eclipse occurs when Earth's shadow falls on the Moon; a solar eclipse occurs when the Moon passes between the Sun and Earth. |
| E3 | established science reference | Science brief: half the Moon is always lit by the Sun; the phase is how much of that lit half is visible from Earth as the Moon orbits. |
| E4 | established science reference | Science brief: the phase cycle repeats about every month as the Moon completes an orbit relative to the Sun. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u06::lunar phases and eclipses, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about lunar phases and eclipses, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about lunar phases and eclipses, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about lunar phases and eclipses; then identify one check that would catch an error or weak claim.**
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E4. Name the decisive evidence ID, explain the error about lunar phases and eclipses, and write a corrected claim.

>

**Q2.** Communicate what the supplied record establishes about lunar phases and eclipses in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about lunar phases and eclipses against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using lunar phases and eclipses as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about lunar phases and eclipses? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about lunar phases and eclipses that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about lunar phases and eclipses. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about lunar phases and eclipses.
...
- Apply lunar phases and eclipses under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect lunar phases and eclipses to seasons from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g8-science-u06-l08` · lesson `ma-g8-science-u06-l08` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
