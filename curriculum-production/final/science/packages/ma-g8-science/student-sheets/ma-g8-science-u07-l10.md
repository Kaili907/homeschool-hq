# Synthesis and review: climate evidence

**Grade 8 Science** · Unit 7: Resources, Climate, and Human Systems · Day 10 of the unit (course day 82) · about 45–65 minutes

**Today's focus:** climate evidence
...
- Connect climate evidence to the unit’s other ideas and select evidence that shows readiness for assessment.
- Use subject-appropriate evidence or representation to communicate understanding of climate evidence.
- Check, revise, or improve work about climate evidence using stated success criteria.
...
- Science brief: global average surface temperature has risen since the late nineteenth century, and the rise is principally caused by greenhouse gases released by human activity, above all carbon dioxide from burning fossil fuels.
- Science brief: multiple independent records agree: surface and ocean temperatures, sea level, ice-sheet and glacier mass, and the timing of seasonal biological events.
- Science brief: ice cores and other archives extend the record far beyond instruments and show that current carbon dioxide levels are far outside the range of recent geological history.
- Science brief: the natural greenhouse effect is necessary for life; the concern is the additional warming from gases added by human activity.

### Evidence check: climate evidence

**Candidate claim:** A case report presents this as acceptable science: “citing a single cold season or year as evidence against long-term warming.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: global average surface temperature has risen since the late nineteenth century, and the rise is principally caused by greenhouse gases released by human activity, above all carbon dioxide from burning fossil fuels. |
| E2 | established science reference | Science brief: multiple independent records agree: surface and ocean temperatures, sea level, ice-sheet and glacier mass, and the timing of seasonal biological events. |
| E3 | established science reference | Science brief: ice cores and other archives extend the record far beyond instruments and show that current carbon dioxide levels are far outside the range of recent geological history. |
| E4 | established science reference | Science brief: the natural greenhouse effect is necessary for life; the concern is the additional warming from gases added by human activity. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u07::climate evidence, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about climate evidence, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about climate evidence, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about climate evidence; then identify one check that would catch an error or weak claim.**
...
**Q1.** The supplied unit connections are: resource distribution, geoscience processes, population and consumption, climate evidence, mitigation adaptation and tradeoffs, environmental justice foundations. Choose one idea other than climate evidence, connect it to one row in E1-E4, and explain one way treating the two ideas as identical would be misleading.

>

**Q2.** Communicate what the supplied record establishes about climate evidence in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about climate evidence against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using climate evidence as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about climate evidence? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about climate evidence that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about climate evidence. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about climate evidence.
...
- Apply climate evidence under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect climate evidence to resource distribution from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g8-science-u07-l10` · lesson `ma-g8-science-u07-l10` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
