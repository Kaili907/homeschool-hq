# Performance task build: embryological evidence

**Grade 8 Science** · Unit 4: Natural Selection and Adaptation · Day 9 of the unit (course day 45) · about 45–65 minutes

**Today's focus:** embryological evidence
...
- Create, test, or revise a meaningful product that applies embryological evidence and the unit standards.
- Use subject-appropriate evidence or representation to communicate understanding of embryological evidence.
- Check, revise, or improve work about embryological evidence using stated success criteria.
...
- Science brief: embryos of different vertebrate species pass through stages that resemble one another more than the adults do.
- Science brief: those shared developmental patterns are evidence of shared ancestry.
- Science brief: embryological similarity is one line of evidence among several, and it is strongest when it agrees with the anatomical and fossil evidence.

### Evidence check: embryological evidence

**Candidate claim:** A case report presents this as acceptable science: “an embryo passes through the adult forms of its ancestors.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: embryos of different vertebrate species pass through stages that resemble one another more than the adults do. |
| E2 | established science reference | Science brief: those shared developmental patterns are evidence of shared ancestry. |
| E3 | established science reference | Science brief: embryological similarity is one line of evidence among several, and it is strongest when it agrees with the anatomical and fossil evidence. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u04::embryological evidence, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about embryological evidence, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about embryological evidence?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g8-science-u04::embryological evidence, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u04::embryological evidence, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about embryological evidence?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about embryological evidence; then identify one check that would catch an error or weak claim.**
...
**Q1.** Create a one-page evidence product for embryological evidence using only the supplied case and E1-E3: one claim, at least two cited rows, the reasoning link, one counterpoint, and one revision after checking the success criteria.

>

**Q2.** Communicate what the supplied record establishes about embryological evidence in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about embryological evidence against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using embryological evidence as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about embryological evidence? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about embryological evidence that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about embryological evidence. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about embryological evidence.
...
- Apply embryological evidence under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect embryological evidence to fossil evidence from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g8-science-u04-l09` · lesson `ma-g8-science-u04-l09` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
