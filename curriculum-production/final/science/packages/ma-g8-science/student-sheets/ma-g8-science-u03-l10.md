# Synthesis and review: inheritance models

**Grade 8 Science** · Unit 3: Growth, Reproduction, and Heredity · Day 10 of the unit (course day 34) · about 45–65 minutes

**Today's focus:** inheritance models
...
- Connect inheritance models to the unit’s other ideas and select evidence that shows readiness for assessment.
- Use subject-appropriate evidence or representation to communicate understanding of inheritance models.
- Check, revise, or improve work about inheritance models using stated success criteria.
...
- Science brief: an inheritance model represents how versions of a gene from two parents can combine in offspring.
- Science brief: a model such as a Punnett square gives the proportions expected over many offspring, not what any individual offspring will be.
- Science brief: the model assumes the simple case of one gene with two versions, which many real traits do not follow.

### Evidence check: inheritance models

**Candidate claim:** A case report presents this as acceptable science: “reading a model's proportion as a guarantee about an individual offspring.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: an inheritance model represents how versions of a gene from two parents can combine in offspring. |
| E2 | established science reference | Science brief: a model such as a Punnett square gives the proportions expected over many offspring, not what any individual offspring will be. |
| E3 | established science reference | Science brief: the model assumes the simple case of one gene with two versions, which many real traits do not follow. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u03::inheritance models, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about inheritance models, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about inheritance models, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about inheritance models; then identify one check that would catch an error or weak claim.**
...
**Q1.** The supplied unit connections are: sexual and asexual reproduction, genes chromosomes and traits, mutations, inheritance models, environment and trait expression, probability and model limits. Choose one idea other than inheritance models, connect it to one row in E1-E3, and explain one way treating the two ideas as identical would be misleading.

>

**Q2.** Communicate what the supplied record establishes about inheritance models in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about inheritance models against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using inheritance models as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about inheritance models? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about inheritance models that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about inheritance models. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about inheritance models.
...
- Apply inheritance models under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect inheritance models to sexual and asexual reproduction from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g8-science-u03-l10` · lesson `ma-g8-science-u03-l10` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
