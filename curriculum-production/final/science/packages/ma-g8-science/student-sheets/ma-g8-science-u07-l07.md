# Investigation or close reading: resource distribution

**Grade 8 Science** · Unit 7: Resources, Climate, and Human Systems · Day 7 of the unit (course day 79) · about 45–65 minutes

**Today's focus:** resource distribution
...
- Gather and analyze evidence related to resource distribution, then record a defensible interpretation.
- Use subject-appropriate evidence or representation to communicate understanding of resource distribution.
- Check, revise, or improve work about resource distribution using stated success criteria.
...
- Science brief: mineral, energy, water, and soil resources are distributed unevenly because of the geological and biological processes that formed them.
- Science brief: where a resource is found is a consequence of past Earth processes, not of present-day political boundaries.
- Science brief: uneven distribution shapes where people settle, what they trade, and where conflicts over resources arise.

### Evidence check: resource distribution

**Candidate claim:** A case report presents this as acceptable science: “resources are distributed evenly or at random.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: mineral, energy, water, and soil resources are distributed unevenly because of the geological and biological processes that formed them. |
| E2 | established science reference | Science brief: where a resource is found is a consequence of past Earth processes, not of present-day political boundaries. |
| E3 | established science reference | Science brief: uneven distribution shapes where people settle, what they trade, and where conflicts over resources arise. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u07::resource distribution, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about resource distribution, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about resource distribution?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g8-science-u07::resource distribution, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u07::resource distribution, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about resource distribution?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about resource distribution; then identify one check that would catch an error or weak claim.**
...
**Q1.** Classify every supplied row E1-E3 as supports, challenges, or does not decide the candidate claim about resource distribution. Cite the row and explain each classification.

>

**Q2.** Communicate what the supplied record establishes about resource distribution in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about resource distribution against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using resource distribution as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about resource distribution? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about resource distribution that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about resource distribution. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about resource distribution.
...
- Apply resource distribution under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect resource distribution to geoscience processes from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g8-science-u07-l07` · lesson `ma-g8-science-u07-l07` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
