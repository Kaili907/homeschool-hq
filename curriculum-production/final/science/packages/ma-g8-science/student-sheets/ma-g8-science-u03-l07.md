# Investigation or close reading: sexual and asexual reproduction

**Grade 8 Science** · Unit 3: Growth, Reproduction, and Heredity · Day 7 of the unit (course day 31) · about 45–65 minutes

**Today's focus:** sexual and asexual reproduction

**Unit question:** How can understanding growth, reproduction, and heredity help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Gather and analyze evidence related to sexual and asexual reproduction, then record a defensible interpretation.
- Use subject-appropriate evidence or representation to communicate understanding of sexual and asexual reproduction.
- Check, revise, or improve work about sexual and asexual reproduction using stated success criteria.
...
- Science brief: asexual reproduction produces offspring genetically identical to the single parent; sexual reproduction produces offspring with a combination of genetic material from two parents.
- Science brief: asexual reproduction involves one parent and produces genetically identical offspring apart from mutation.
- Science brief: sexual reproduction involves two parents, each contributing genetic material, so offspring differ from both parents and from each other.
- Science brief: sexual reproduction generates variation within a population; asexual reproduction generates far less.

### Evidence check: sexual and asexual reproduction

**Candidate claim:** A case report presents this as acceptable science: “asexual offspring differ genetically from the parent as a normal outcome.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: asexual reproduction produces offspring genetically identical to the single parent; sexual reproduction produces offspring with a combination of genetic material from two parents. |
| E2 | established science reference | Science brief: asexual reproduction involves one parent and produces genetically identical offspring apart from mutation. |
| E3 | established science reference | Science brief: sexual reproduction involves two parents, each contributing genetic material, so offspring differ from both parents and from each other. |
| E4 | established science reference | Science brief: sexual reproduction generates variation within a population; asexual reproduction generates far less. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u03::sexual and asexual reproduction, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.

**Supplied unit connections:** sexual and asexual reproduction; genes chromosomes and traits; mutations; inheritance models; environment and trait expression; probability and model limits

**Supplied unit performance task:** Develop an inheritance model using fictional organisms and explain what the model can and cannot predict.

### Bound task

**Question:** What does evidence E1 through E4 justify about sexual and asexual reproduction, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about sexual and asexual reproduction?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g8-science-u03::sexual and asexual reproduction, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u03::sexual and asexual reproduction, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about sexual and asexual reproduction?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about sexual and asexual reproduction; then identify one check that would catch an error or weak claim.**
...
**Q1.** Classify every supplied row E1-E4 as supports, challenges, or does not decide the candidate claim about sexual and asexual reproduction. Cite the row and explain each classification.

>

**Q2.** Communicate what the supplied record establishes about sexual and asexual reproduction in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about sexual and asexual reproduction against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using sexual and asexual reproduction as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about sexual and asexual reproduction? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about sexual and asexual reproduction that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about sexual and asexual reproduction. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about sexual and asexual reproduction.
...
- Apply sexual and asexual reproduction under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect sexual and asexual reproduction to genes chromosomes and traits from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Develop an inheritance model using fictional organisms and explain what the model can and cannot predict. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-g8-science-u03-l07` · lesson `ma-g8-science-u03-l07` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
