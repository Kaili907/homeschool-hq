# Independent application A: climate evidence

**Grade 8 Science** · Unit 7: Resources, Climate, and Human Systems · Day 4 of the unit (course day 76) · about 45–65 minutes
...
- Apply climate evidence independently in a new representation, text, situation, or design constraint.
...
**Q1.** Independently evaluate this fully supplied case about climate evidence: A case report presents this as acceptable science: “citing a single cold season or year as evidence against long-term warming.” Use at least two rows from E1-E4, correct the claim if needed, and state one limit.
...
_Package `swp-ma-g8-science-u07-l04` · lesson `ma-g8-science-u07-l04` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
