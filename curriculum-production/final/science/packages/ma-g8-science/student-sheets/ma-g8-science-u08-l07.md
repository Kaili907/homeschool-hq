# Investigation or close reading: biodiversity

**Grade 8 Science** · Unit 8: Applied Biology and Ecosystem Design · Day 7 of the unit (course day 91) · about 45–65 minutes

**Today's focus:** biodiversity
...
- Gather and analyze evidence related to biodiversity, then record a defensible interpretation.
- Use subject-appropriate evidence or representation to communicate understanding of biodiversity.
- Check, revise, or improve work about biodiversity using stated success criteria.
...
- Science brief: biodiversity includes the variety of species, the genetic variety within species, and the variety of ecosystems.
- Science brief: greater genetic variety within a population generally makes it better able to withstand disease and environmental change.
- Science brief: biodiversity is measured by counting and comparing, so the measurement method and the area covered determine what the number means.

### Evidence check: biodiversity

**Candidate claim:** A case report presents this as acceptable science: “treating biodiversity as species count alone.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: biodiversity includes the variety of species, the genetic variety within species, and the variety of ecosystems. |
| E2 | established science reference | Science brief: greater genetic variety within a population generally makes it better able to withstand disease and environmental change. |
| E3 | established science reference | Science brief: biodiversity is measured by counting and comparing, so the measurement method and the area covered determine what the number means. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u08::biodiversity, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about biodiversity, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about biodiversity?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g8-science-u08::biodiversity, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u08::biodiversity, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about biodiversity?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about biodiversity; then identify one check that would catch an error or weak claim.**
...
**Q1.** Classify every supplied row E1-E3 as supports, challenges, or does not decide the candidate claim about biodiversity. Cite the row and explain each classification.

>

**Q2.** Communicate what the supplied record establishes about biodiversity in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about biodiversity against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using biodiversity as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about biodiversity? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about biodiversity that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about biodiversity. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about biodiversity.
...
- Apply biodiversity under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect biodiversity to ecosystem services from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g8-science-u08-l07` · lesson `ma-g8-science-u08-l07` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
