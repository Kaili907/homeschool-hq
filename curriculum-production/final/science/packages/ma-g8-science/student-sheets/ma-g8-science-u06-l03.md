# Guided practice A: gravity and orbital motion

**Grade 8 Science** · Unit 6: Earth, Moon, Sun, and the Solar System · Day 3 of the unit (course day 63) · about 45–65 minutes
...
- Practice gravity and orbital motion with prompts, feedback, and gradually reduced support.
...
**The task.** What does evidence E1 through E4 justify about gravity and orbital motion, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**Q1.** First compare E1 with E2 and write a provisional conclusion about gravity and orbital motion. Then add the remaining rows through E4, revise the conclusion, and explain the change.
...
_Package `swp-ma-g8-science-u06-l03` · lesson `ma-g8-science-u06-l03` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
