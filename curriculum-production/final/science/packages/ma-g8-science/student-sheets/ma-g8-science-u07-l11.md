# Unit assessment: mitigation adaptation and tradeoffs

**Grade 8 Science** · Unit 7: Resources, Climate, and Human Systems · Day 11 of the unit (course day 83) · about 45–65 minutes

**Today's focus:** mitigation adaptation and tradeoffs
...
- Demonstrate current mastery of mitigation adaptation and tradeoffs through selected-response, constructed-response, and applied evidence.
- Use subject-appropriate evidence or representation to communicate understanding of mitigation adaptation and tradeoffs.
- Check, revise, or improve work about mitigation adaptation and tradeoffs using stated success criteria.
...
- Science brief: mitigation reduces the cause; adaptation reduces the harm from effects that occur anyway.
- Science brief: mitigation and adaptation address different parts of the problem, and both are needed because some change is already committed.
- Science brief: every option has costs, benefits, and side effects, and these fall differently on different groups.
- Science brief: delay is itself a choice, because the cause continues to operate while a decision is postponed.

### Evidence check: mitigation adaptation and tradeoffs

**Candidate claim:** A case report presents this as acceptable science: “using mitigation and adaptation interchangeably.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: mitigation reduces the cause; adaptation reduces the harm from effects that occur anyway. |
| E2 | established science reference | Science brief: mitigation and adaptation address different parts of the problem, and both are needed because some change is already committed. |
| E3 | established science reference | Science brief: every option has costs, benefits, and side effects, and these fall differently on different groups. |
| E4 | established science reference | Science brief: delay is itself a choice, because the cause continues to operate while a decision is postponed. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u07::mitigation adaptation and tradeoffs, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about mitigation adaptation and tradeoffs, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about mitigation adaptation and tradeoffs, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? Rate confidence in mitigation adaptation and tradeoffs, cite one piece of evidence from today, and choose: ready to extend, ready to review later, or need a different explanation.**
...
**Q1.** Complete all three parts for mitigation adaptation and tradeoffs. (1) Select A: supported, B: partly supported, or C: not supported for the candidate claim. (2) Justify the selection with E1-E4. (3) Rewrite the claim so every word is supported by the supplied record.

>

**Q2.** Communicate what the supplied record establishes about mitigation adaptation and tradeoffs in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about mitigation adaptation and tradeoffs against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using mitigation adaptation and tradeoffs as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about mitigation adaptation and tradeoffs? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about mitigation adaptation and tradeoffs that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about mitigation adaptation and tradeoffs. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about mitigation adaptation and tradeoffs.
...
- Apply mitigation adaptation and tradeoffs under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect mitigation adaptation and tradeoffs to resource distribution from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g8-science-u07-l11` · lesson `ma-g8-science-u07-l11` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
