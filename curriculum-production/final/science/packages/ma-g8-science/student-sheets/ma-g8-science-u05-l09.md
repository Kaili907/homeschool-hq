# Performance task build: plate tectonics

**Grade 8 Science** · Unit 5: Earth History and Geologic Processes · Day 9 of the unit (course day 57) · about 45–65 minutes

**Today's focus:** plate tectonics

**Unit question:** How can understanding earth history and geologic processes help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Create, test, or revise a meaningful product that applies plate tectonics and the unit standards.
- Use subject-appropriate evidence or representation to communicate understanding of plate tectonics.
- Check, revise, or improve work about plate tectonics using stated success criteria.
...
- Science brief: earth's lithosphere is broken into plates that move relative to one another, driven by motion in the mantle beneath.
- Science brief: earth's outer shell is divided into plates that move slowly relative to one another over the mantle.
- Science brief: most earthquakes, volcanoes, and mountain belts occur at plate boundaries, which is why those features are distributed in bands rather than evenly.
- Science brief: evidence for plate motion includes matching coastlines and fossils across oceans, seafloor age patterns, and directly measured plate movement.

### Evidence check: plate tectonics

**Candidate claim:** A case report presents this as acceptable science: “the continents float on liquid rock beneath them; the mantle is solid rock that flows very slowly.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: earth's lithosphere is broken into plates that move relative to one another, driven by motion in the mantle beneath. |
| E2 | established science reference | Science brief: earth's outer shell is divided into plates that move slowly relative to one another over the mantle. |
| E3 | established science reference | Science brief: most earthquakes, volcanoes, and mountain belts occur at plate boundaries, which is why those features are distributed in bands rather than evenly. |
| E4 | established science reference | Science brief: evidence for plate motion includes matching coastlines and fossils across oceans, seafloor age patterns, and directly measured plate movement. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u05::plate tectonics, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.

**Supplied unit connections:** geologic time; rock strata and fossils; plate tectonics; cycling of Earth materials; surface processes; evidence for past change

**Supplied unit performance task:** Construct a regional geologic-history explanation from maps, cross-sections, rocks, and fossil data.

### Bound task

**Question:** What does evidence E1 through E4 justify about plate tectonics, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about plate tectonics?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g8-science-u05::plate tectonics, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u05::plate tectonics, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about plate tectonics?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about plate tectonics; then identify one check that would catch an error or weak claim.**
...
**Q1.** Create a one-page evidence product for plate tectonics using only the supplied case and E1-E4: one claim, at least two cited rows, the reasoning link, one counterpoint, and one revision after checking the success criteria.

>

**Q2.** Communicate what the supplied record establishes about plate tectonics in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about plate tectonics against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using plate tectonics as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about plate tectonics? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about plate tectonics that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about plate tectonics. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about plate tectonics.
...
- Apply plate tectonics under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect plate tectonics to geologic time from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Construct a regional geologic-history explanation from maps, cross-sections, rocks, and fossil data. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-g8-science-u05-l09` · lesson `ma-g8-science-u05-l09` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
