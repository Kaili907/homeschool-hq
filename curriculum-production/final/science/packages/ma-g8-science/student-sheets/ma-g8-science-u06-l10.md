# Synthesis and review: solar-system scale

**Grade 8 Science** · Unit 6: Earth, Moon, Sun, and the Solar System · Day 10 of the unit (course day 70) · about 45–65 minutes

**Today's focus:** solar-system scale
...
- Connect solar-system scale to the unit’s other ideas and select evidence that shows readiness for assessment.
- Use subject-appropriate evidence or representation to communicate understanding of solar-system scale.
- Check, revise, or improve work about solar-system scale using stated success criteria.
...
- Science brief: distances between objects in the solar system are vastly larger than the objects themselves.
- Science brief: the solar system is mostly empty space: the distances between planets dwarf the planets' sizes.
- Science brief: no ordinary diagram shows both sizes and distances to the same scale, which is why textbook diagrams distort one of them.
- Science brief: scale matters for what is physically possible, so a model that distorts it can produce wrong conclusions.

### Evidence check: solar-system scale

**Candidate claim:** A case report presents this as acceptable science: “reading planetary distances or sizes off a classroom diagram as though it were to scale.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: distances between objects in the solar system are vastly larger than the objects themselves. |
| E2 | established science reference | Science brief: the solar system is mostly empty space: the distances between planets dwarf the planets' sizes. |
| E3 | established science reference | Science brief: no ordinary diagram shows both sizes and distances to the same scale, which is why textbook diagrams distort one of them. |
| E4 | established science reference | Science brief: scale matters for what is physically possible, so a model that distorts it can produce wrong conclusions. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u06::solar-system scale, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about solar-system scale, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about solar-system scale, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about solar-system scale; then identify one check that would catch an error or weak claim.**
...
**Q1.** The supplied unit connections are: seasons, lunar phases and eclipses, gravity and orbital motion, solar-system scale, technology and space data, model misconceptions. Choose one idea other than solar-system scale, connect it to one row in E1-E4, and explain one way treating the two ideas as identical would be misleading.

>

**Q2.** Communicate what the supplied record establishes about solar-system scale in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about solar-system scale against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using solar-system scale as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about solar-system scale? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about solar-system scale that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about solar-system scale. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about solar-system scale.
...
- Apply solar-system scale under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect solar-system scale to seasons from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g8-science-u06-l10` · lesson `ma-g8-science-u06-l10` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
