# Correction and reflection: model limitations

**Grade 8 Science** · Unit 2: Waves and Information Transfer · Day 12 of the unit (course day 24) · about 45–65 minutes

**Today's focus:** model limitations
...
- Use error evidence to choose a different representation or strategy for model limitations, then demonstrate corrected understanding.
- Use subject-appropriate evidence or representation to communicate understanding of model limitations.
- Check, revise, or improve work about model limitations using stated success criteria.
...
- Science brief: a wave model represents some behaviours well and others not at all, and which those are depends on the model.
- Science brief: choosing a model means choosing which behaviours matter for the question being asked.
- Science brief: a model's failure at the edge of its range is information about the range, not proof that the model is worthless.

### Evidence check: model limitations

**Candidate claim:** A case report presents this as acceptable science: “treating a model's representational features as physical facts, such as claiming a transverse-wave drawing shows how sound moves.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a wave model represents some behaviours well and others not at all, and which those are depends on the model. |
| E2 | established science reference | Science brief: choosing a model means choosing which behaviours matter for the question being asked. |
| E3 | established science reference | Science brief: a model's failure at the edge of its range is information about the range, not proof that the model is worthless. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u02::model limitations, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about model limitations, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about model limitations, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about model limitations; then identify one check that would catch an error or weak claim.**
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E3. Name the decisive evidence ID, explain the error about model limitations, and write a corrected claim.

>

**Q2.** Communicate what the supplied record establishes about model limitations in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about model limitations against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using model limitations as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about model limitations? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about model limitations that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about model limitations. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about model limitations.
...
- Apply model limitations under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect model limitations to wave amplitude wavelength and energy from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g8-science-u02-l12` · lesson `ma-g8-science-u02-l12` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
