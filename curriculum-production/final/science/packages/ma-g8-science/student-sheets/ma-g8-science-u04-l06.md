# Guided practice B: population change over generations

**Grade 8 Science** · Unit 4: Natural Selection and Adaptation · Day 6 of the unit (course day 42) · about 45–65 minutes
...
- Practice population change over generations with prompts, feedback, and gradually reduced support.
...
**Q1.** First compare E1 with E2 and write a provisional conclusion about population change over generations. Then add the remaining rows through E3, revise the conclusion, and explain the change.
...
_Package `swp-ma-g8-science-u04-l06` · lesson `ma-g8-science-u04-l06` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
