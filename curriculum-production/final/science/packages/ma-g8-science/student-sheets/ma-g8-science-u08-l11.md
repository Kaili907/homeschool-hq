# Unit assessment: solution impacts

**Grade 8 Science** · Unit 8: Applied Biology and Ecosystem Design · Day 11 of the unit (course day 95) · about 45–65 minutes

**Today's focus:** solution impacts
...
- Demonstrate current mastery of solution impacts through selected-response, constructed-response, and applied evidence.
- Use subject-appropriate evidence or representation to communicate understanding of solution impacts.
- Check, revise, or improve work about solution impacts using stated success criteria.
...
- Science brief: an intervention in an ecosystem has effects beyond its target, because the parts of an ecosystem are connected.
- Science brief: effects can appear at a distance in space or after a delay in time, so an immediate local check is not sufficient evidence.
- Science brief: monitoring after the intervention is what turns an expected effect into an observed one.

### Evidence check: solution impacts
...
| --- | --- | --- |
| E1 | established science reference | Science brief: an intervention in an ecosystem has effects beyond its target, because the parts of an ecosystem are connected. |
| E2 | established science reference | Science brief: effects can appear at a distance in space or after a delay in time, so an immediate local check is not sufficient evidence. |
| E3 | established science reference | Science brief: monitoring after the intervention is what turns an expected effect into an observed one. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u08::solution impacts, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about solution impacts, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about solution impacts, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? Rate confidence in solution impacts, cite one piece of evidence from today, and choose: ready to extend, ready to review later, or need a different explanation.**
...
**Q1.** Complete all three parts for solution impacts. (1) Select A: supported, B: partly supported, or C: not supported for the candidate claim. (2) Justify the selection with E1-E3. (3) Rewrite the claim so every word is supported by the supplied record.

>

**Q2.** Communicate what the supplied record establishes about solution impacts in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about solution impacts against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using solution impacts as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about solution impacts? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about solution impacts that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about solution impacts. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about solution impacts.
...
- Apply solution impacts under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect solution impacts to biodiversity from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g8-science-u08-l11` · lesson `ma-g8-science-u08-l11` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
