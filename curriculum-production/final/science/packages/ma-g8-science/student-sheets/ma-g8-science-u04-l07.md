# Investigation or close reading: fossil evidence

**Grade 8 Science** · Unit 4: Natural Selection and Adaptation · Day 7 of the unit (course day 43) · about 45–65 minutes

**Today's focus:** fossil evidence

**Unit question:** How can understanding natural selection and adaptation help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Gather and analyze evidence related to fossil evidence, then record a defensible interpretation.
- Use subject-appropriate evidence or representation to communicate understanding of fossil evidence.
- Check, revise, or improve work about fossil evidence using stated success criteria.
...
- Science brief: the fossil record shows that the kinds of organisms on Earth have changed over time and that many are now extinct.
- Science brief: fossils in successive rock layers show that the organisms living on Earth have changed over long spans of time.
- Science brief: the order in which groups appear in the record is consistent worldwide, which is why the record is evidence about history rather than local accident.
- Science brief: the fossil record is incomplete because fossilisation is rare, so absence of a fossil is weak evidence of absence of the organism.

### Evidence check: fossil evidence

**Candidate claim:** A case report presents this as acceptable science: “the fossil record contains every organism that has lived.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: the fossil record shows that the kinds of organisms on Earth have changed over time and that many are now extinct. |
| E2 | established science reference | Science brief: fossils in successive rock layers show that the organisms living on Earth have changed over long spans of time. |
| E3 | established science reference | Science brief: the order in which groups appear in the record is consistent worldwide, which is why the record is evidence about history rather than local accident. |
| E4 | established science reference | Science brief: the fossil record is incomplete because fossilisation is rare, so absence of a fossil is weak evidence of absence of the organism. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u04::fossil evidence, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about fossil evidence, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about fossil evidence?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g8-science-u04::fossil evidence, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u04::fossil evidence, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about fossil evidence?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about fossil evidence; then identify one check that would catch an error or weak claim.**
...
**Q1.** Classify every supplied row E1-E4 as supports, challenges, or does not decide the candidate claim about fossil evidence. Cite the row and explain each classification.

>

**Q2.** Communicate what the supplied record establishes about fossil evidence in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about fossil evidence against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using fossil evidence as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about fossil evidence? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about fossil evidence that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about fossil evidence. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about fossil evidence.
...
- Apply fossil evidence under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect fossil evidence to anatomical similarities from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Use multiple evidence types to explain a population change without implying that individuals evolve on demand. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-g8-science-u04-l07` · lesson `ma-g8-science-u04-l07` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
