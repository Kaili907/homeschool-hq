# Correction and reflection: scientific argument and communication

**Grade 8 Science** · Unit 9: Engineering and Scientific Argument Capstone · Day 12 of the unit (course day 108) · about 45–65 minutes

**Today's focus:** scientific argument and communication
...
- Use error evidence to choose a different representation or strategy for scientific argument and communication, then demonstrate corrected understanding.
- Use subject-appropriate evidence or representation to communicate understanding of scientific argument and communication.
- Check, revise, or improve work about scientific argument and communication using stated success criteria.
...
- Science brief: a scientific argument states a claim, presents evidence, and gives explicit reasoning linking the two.
- Science brief: the strongest opposing evidence or interpretation is presented and addressed rather than omitted.
- Science brief: the argument reaches only as far as the evidence, and it says where that limit falls.

### Evidence check: scientific argument and communication

**Candidate claim:** A case report presents this as acceptable science: “presenting claim and evidence with no reasoning between them.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a scientific argument states a claim, presents evidence, and gives explicit reasoning linking the two. |
| E2 | established science reference | Science brief: the strongest opposing evidence or interpretation is presented and addressed rather than omitted. |
| E3 | established science reference | Science brief: the argument reaches only as far as the evidence, and it says where that limit falls. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u09::scientific argument and communication, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about scientific argument and communication, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about scientific argument and communication, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about scientific argument and communication; then identify one check that would catch an error or weak claim.**
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E3. Name the decisive evidence ID, explain the error about scientific argument and communication, and write a corrected claim.

>

**Q2.** Communicate what the supplied record establishes about scientific argument and communication in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about scientific argument and communication against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using scientific argument and communication as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about scientific argument and communication? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about scientific argument and communication that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about scientific argument and communication. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about scientific argument and communication.
...
- Apply scientific argument and communication under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect scientific argument and communication to problem definition from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g8-science-u09-l12` · lesson `ma-g8-science-u09-l12` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
