# Unit assessment: communication technologies

**Grade 8 Science** · Unit 2: Waves and Information Transfer · Day 11 of the unit (course day 23) · about 45–65 minutes

**Today's focus:** communication technologies
...
- Demonstrate current mastery of communication technologies through selected-response, constructed-response, and applied evidence.
- Use subject-appropriate evidence or representation to communicate understanding of communication technologies.
- Check, revise, or improve work about communication technologies using stated success criteria.
...
- Science brief: communication technologies encode information into a wave or a signal, transmit it, and decode it at the other end.
- Science brief: every link has limits on range, rate, and reliability, set by the physics of the carrier and by the equipment.
- Science brief: the information is carried by the pattern, so the same message can be sent by very different physical means.

### Evidence check: communication technologies

**Candidate claim:** A case report presents this as acceptable science: “a technology transmits information with no physical carrier.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: communication technologies encode information into a wave or a signal, transmit it, and decode it at the other end. |
| E2 | established science reference | Science brief: every link has limits on range, rate, and reliability, set by the physics of the carrier and by the equipment. |
| E3 | established science reference | Science brief: the information is carried by the pattern, so the same message can be sent by very different physical means. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u02::communication technologies, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about communication technologies, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about communication technologies, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? Rate confidence in communication technologies, cite one piece of evidence from today, and choose: ready to extend, ready to review later, or need a different explanation.**
...
**Q1.** Complete all three parts for communication technologies. (1) Select A: supported, B: partly supported, or C: not supported for the candidate claim. (2) Justify the selection with E1-E3. (3) Rewrite the claim so every word is supported by the supplied record.

>

**Q2.** Communicate what the supplied record establishes about communication technologies in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about communication technologies against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using communication technologies as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about communication technologies? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about communication technologies that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about communication technologies. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about communication technologies.
...
- Apply communication technologies under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect communication technologies to wave amplitude wavelength and energy from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g8-science-u02-l11` · lesson `ma-g8-science-u02-l11` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
