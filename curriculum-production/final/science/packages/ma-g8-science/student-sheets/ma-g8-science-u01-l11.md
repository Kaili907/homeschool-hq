# Unit assessment: gravitational interactions

**Grade 8 Science** · Unit 1: Forces, Motion, and Interactions · Day 11 of the unit (course day 11) · about 45–65 minutes

**Today's focus:** gravitational interactions
...
- Demonstrate current mastery of gravitational interactions through selected-response, constructed-response, and applied evidence.
- Use subject-appropriate evidence or representation to communicate understanding of gravitational interactions.
- Check, revise, or improve work about gravitational interactions using stated success criteria.
...
- Science brief: gravitational attraction acts between any two masses, increases with their masses, and decreases as the distance between them increases.
- Science brief: every mass attracts every other mass; the force increases with either mass and decreases as the separation increases.
- Science brief: gravity is always attractive, never repulsive.
- Science brief: gravitational forces are noticeable in everyday life only when at least one of the objects is astronomically massive.

### Evidence check: gravitational interactions

**Candidate claim:** A case report presents this as acceptable science: “there is no gravity in space, or that orbiting astronauts float because gravity has stopped.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: gravitational attraction acts between any two masses, increases with their masses, and decreases as the distance between them increases. |
| E2 | established science reference | Science brief: every mass attracts every other mass; the force increases with either mass and decreases as the separation increases. |
| E3 | established science reference | Science brief: gravity is always attractive, never repulsive. |
| E4 | established science reference | Science brief: gravitational forces are noticeable in everyday life only when at least one of the objects is astronomically massive. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u01::gravitational interactions, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about gravitational interactions, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about gravitational interactions, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? Rate confidence in gravitational interactions, cite one piece of evidence from today, and choose: ready to extend, ready to review later, or need a different explanation.**
...
**Q1.** Complete all three parts for gravitational interactions. (1) Select A: supported, B: partly supported, or C: not supported for the candidate claim. (2) Justify the selection with E1-E4. (3) Rewrite the claim so every word is supported by the supplied record.

>

**Q2.** Communicate what the supplied record establishes about gravitational interactions in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about gravitational interactions against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using gravitational interactions as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about gravitational interactions? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about gravitational interactions that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about gravitational interactions. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about gravitational interactions.
...
- Apply gravitational interactions under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect gravitational interactions to Newton’s laws at middle-school level from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g8-science-u01-l11` · lesson `ma-g8-science-u01-l11` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
