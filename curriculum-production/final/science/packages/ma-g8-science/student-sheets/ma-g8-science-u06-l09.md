# Performance task build: gravity and orbital motion

**Grade 8 Science** · Unit 6: Earth, Moon, Sun, and the Solar System · Day 9 of the unit (course day 69) · about 45–65 minutes

**Today's focus:** gravity and orbital motion

**Unit question:** How can understanding earth, moon, sun, and the solar system help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Create, test, or revise a meaningful product that applies gravity and orbital motion and the unit standards.
- Use subject-appropriate evidence or representation to communicate understanding of gravity and orbital motion.
- Check, revise, or improve work about gravity and orbital motion using stated success criteria.
...
- Science brief: gravity is the force that holds objects in orbit; an orbiting object is continuously falling toward the body it orbits.
- Science brief: gravitational attraction between the Sun and the planets, and between planets and their moons, keeps them in orbit.
- Science brief: an orbiting object is accelerating toward the body it orbits while also moving sideways fast enough that it keeps missing it.
- Science brief: orbital motion depends on the mass of the central body and on the orbital distance.

### Evidence check: gravity and orbital motion

**Candidate claim:** A case report presents this as acceptable science: “astronauts in orbit are weightless because gravity is absent there.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: gravity is the force that holds objects in orbit; an orbiting object is continuously falling toward the body it orbits. |
| E2 | established science reference | Science brief: gravitational attraction between the Sun and the planets, and between planets and their moons, keeps them in orbit. |
| E3 | established science reference | Science brief: an orbiting object is accelerating toward the body it orbits while also moving sideways fast enough that it keeps missing it. |
| E4 | established science reference | Science brief: orbital motion depends on the mass of the central body and on the orbital distance. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u06::gravity and orbital motion, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.

**Supplied unit connections:** seasons; lunar phases and eclipses; gravity and orbital motion; solar-system scale; technology and space data; model misconceptions

**Supplied unit performance task:** Create and critique scale and motion models for an Earth-space phenomenon.

### Bound task

**Question:** What does evidence E1 through E4 justify about gravity and orbital motion, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about gravity and orbital motion?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g8-science-u06::gravity and orbital motion, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u06::gravity and orbital motion, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about gravity and orbital motion?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about gravity and orbital motion; then identify one check that would catch an error or weak claim.**
...
**Q1.** Create a one-page evidence product for gravity and orbital motion using only the supplied case and E1-E4: one claim, at least two cited rows, the reasoning link, one counterpoint, and one revision after checking the success criteria.

>

**Q2.** Communicate what the supplied record establishes about gravity and orbital motion in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about gravity and orbital motion against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using gravity and orbital motion as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about gravity and orbital motion? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about gravity and orbital motion that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about gravity and orbital motion. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about gravity and orbital motion.
...
- Apply gravity and orbital motion under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect gravity and orbital motion to seasons from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Create and critique scale and motion models for an Earth-space phenomenon. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-g8-science-u06-l09` · lesson `ma-g8-science-u06-l09` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
