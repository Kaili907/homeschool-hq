# Independent application A: iterative modeling

**Grade 8 Science** · Unit 9: Engineering and Scientific Argument Capstone · Day 4 of the unit (course day 100) · about 45–65 minutes
...
- Apply iterative modeling independently in a new representation, text, situation, or design constraint.
...
**Q1.** Independently evaluate this fully supplied case about iterative modeling: A case report presents this as acceptable science: “reporting only the successful final iteration.” Use at least two rows from E1-E3, correct the claim if needed, and state one limit.
...
_Package `swp-ma-g8-science-u09-l04` · lesson `ma-g8-science-u09-l04` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
