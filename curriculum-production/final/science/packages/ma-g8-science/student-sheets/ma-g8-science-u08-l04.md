...
**Q1.** Independently evaluate this fully supplied case about artificial selection: A case report presents this as acceptable science: “artificial selection creates the desired variation rather than selecting from existing variation.” Use at least two rows from E1-E4, correct the claim if needed, and state one limit.
...
_Package `swp-ma-g8-science-u08-l04` · lesson `ma-g8-science-u08-l04` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
