...
**Q1.** The supplied unit connections are: fossil evidence, anatomical similarities, embryological evidence, variation, natural selection, population change over generations. Choose one idea other than variation, connect it to one row in E1-E4, and explain one way treating the two ideas as identical would be misleading.
...
_Package `swp-ma-g8-science-u04-l10` · lesson `ma-g8-science-u04-l10` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
