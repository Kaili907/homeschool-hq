# Reteach and varied practice: geoscience processes

**Grade 8 Science** · Unit 7: Resources, Climate, and Human Systems · Day 8 of the unit (course day 80) · about 45–65 minutes

**Today's focus:** geoscience processes
...
- Use error evidence to choose a different representation or strategy for geoscience processes, then demonstrate corrected understanding.
- Use subject-appropriate evidence or representation to communicate understanding of geoscience processes.
- Check, revise, or improve work about geoscience processes using stated success criteria.
...
- Science brief: geoscience processes shape where hazards occur, where resources form, and where land is suitable for particular uses.
- Science brief: these processes operate on timescales from seconds to millions of years, and the timescale determines what human action can affect.
- Science brief: understanding the process is what makes prediction and planning possible.

### Evidence check: geoscience processes

**Candidate claim:** A case report presents this as acceptable science: “geoscience processes can be halted by human action.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: geoscience processes shape where hazards occur, where resources form, and where land is suitable for particular uses. |
| E2 | established science reference | Science brief: these processes operate on timescales from seconds to millions of years, and the timescale determines what human action can affect. |
| E3 | established science reference | Science brief: understanding the process is what makes prediction and planning possible. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u07::geoscience processes, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about geoscience processes, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about geoscience processes, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about geoscience processes; then identify one check that would catch an error or weak claim.**
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E3. Name the decisive evidence ID, explain the error about geoscience processes, and write a corrected claim.

>

**Q2.** Communicate what the supplied record establishes about geoscience processes in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about geoscience processes against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using geoscience processes as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about geoscience processes? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about geoscience processes that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about geoscience processes. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about geoscience processes.
...
- Apply geoscience processes under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect geoscience processes to resource distribution from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g8-science-u07-l08` · lesson `ma-g8-science-u07-l08` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
