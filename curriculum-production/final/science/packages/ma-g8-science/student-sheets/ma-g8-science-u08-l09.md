# Performance task build: disturbance and resilience

**Grade 8 Science** · Unit 8: Applied Biology and Ecosystem Design · Day 9 of the unit (course day 93) · about 45–65 minutes

**Today's focus:** disturbance and resilience

**Unit question:** How can understanding applied biology and ecosystem design help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Create, test, or revise a meaningful product that applies disturbance and resilience and the unit standards.
- Use subject-appropriate evidence or representation to communicate understanding of disturbance and resilience.
- Check, revise, or improve work about disturbance and resilience using stated success criteria.
...
- Science brief: disturbances such as fire, flood, storm, and disease are normal parts of ecosystem dynamics.
- Science brief: resilience is an ecosystem's capacity to recover its function after disturbance, and it depends on what survives and on the severity of the disturbance.
- Science brief: repeated or severe disturbance can push an ecosystem into a different state that does not return on its own.

### Evidence check: disturbance and resilience

**Candidate claim:** A case report presents this as acceptable science: “all disturbance is damaging; many communities depend on periodic disturbance.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: disturbances such as fire, flood, storm, and disease are normal parts of ecosystem dynamics. |
| E2 | established science reference | Science brief: resilience is an ecosystem's capacity to recover its function after disturbance, and it depends on what survives and on the severity of the disturbance. |
| E3 | established science reference | Science brief: repeated or severe disturbance can push an ecosystem into a different state that does not return on its own. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u08::disturbance and resilience, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about disturbance and resilience, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about disturbance and resilience?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g8-science-u08::disturbance and resilience, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u08::disturbance and resilience, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about disturbance and resilience?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about disturbance and resilience; then identify one check that would catch an error or weak claim.**
...
**Q1.** Create a one-page evidence product for disturbance and resilience using only the supplied case and E1-E3: one claim, at least two cited rows, the reasoning link, one counterpoint, and one revision after checking the success criteria.

>

**Q2.** Communicate what the supplied record establishes about disturbance and resilience in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about disturbance and resilience against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using disturbance and resilience as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about disturbance and resilience? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about disturbance and resilience that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about disturbance and resilience. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about disturbance and resilience.
...
- Apply disturbance and resilience under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect disturbance and resilience to biodiversity from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Compare and improve solutions for biodiversity, food systems, habitat, or restoration using an impact matrix. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-g8-science-u08-l09` · lesson `ma-g8-science-u08-l09` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
