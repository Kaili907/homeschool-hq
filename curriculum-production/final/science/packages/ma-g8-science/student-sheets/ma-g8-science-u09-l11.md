# Unit assessment: optimization

**Grade 8 Science** · Unit 9: Engineering and Scientific Argument Capstone · Day 11 of the unit (course day 107) · about 45–65 minutes
...
- Demonstrate current mastery of optimization through selected-response, constructed-response, and applied evidence.
- Use subject-appropriate evidence or representation to communicate understanding of optimization.
- Check, revise, or improve work about optimization using stated success criteria.
...
- Science brief: optimisation improves performance against stated criteria within stated constraints; it does not improve everything at once.
- Science brief: an optimum depends on the criteria and their relative importance, so different priorities give different optima.
- Science brief: a solution optimised past a constraint is not a solution.

### Evidence check: optimization

**Candidate claim:** A case report presents this as acceptable science: “a design was optimised on every criterion simultaneously.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: optimisation improves performance against stated criteria within stated constraints; it does not improve everything at once. |
| E2 | established science reference | Science brief: an optimum depends on the criteria and their relative importance, so different priorities give different optima. |
| E3 | established science reference | Science brief: a solution optimised past a constraint is not a solution. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u09::optimization, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about optimization, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about optimization, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? Rate confidence in optimization, cite one piece of evidence from today, and choose: ready to extend, ready to review later, or need a different explanation.**
...
**Q1.** Complete all three parts for optimization. (1) Select A: supported, B: partly supported, or C: not supported for the candidate claim. (2) Justify the selection with E1-E3. (3) Rewrite the claim so every word is supported by the supplied record.

>

**Q2.** Communicate what the supplied record establishes about optimization in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about optimization against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using optimization as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about optimization? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about optimization that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about optimization. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about optimization.
...
- Apply optimization under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect optimization to problem definition from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g8-science-u09-l11` · lesson `ma-g8-science-u09-l11` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
