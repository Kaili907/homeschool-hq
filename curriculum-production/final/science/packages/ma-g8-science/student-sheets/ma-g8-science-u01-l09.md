# Performance task build: motion graphs

**Grade 8 Science** · Unit 1: Forces, Motion, and Interactions · Day 9 of the unit (course day 9) · about 45–65 minutes

**Today's focus:** motion graphs
...
- Create, test, or revise a meaningful product that applies motion graphs and the unit standards.
- Use subject-appropriate evidence or representation to communicate understanding of motion graphs.
- Check, revise, or improve work about motion graphs using stated success criteria.
...
- Science brief: on a distance-time graph the slope represents speed; a horizontal line means the object is not moving.
- Science brief: on a distance-time graph, a steeper slope means a greater speed and a flat line means no motion.
- Science brief: a straight line on a distance-time graph means constant speed; a curve means the speed is changing.
- Science brief: a graph shows only what was measured; the axes and their units determine what can be read from it.

### Evidence check: motion graphs

**Candidate claim:** A case report presents this as acceptable science: “reading a distance-time graph as though it showed the path the object travelled through space.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: on a distance-time graph the slope represents speed; a horizontal line means the object is not moving. |
| E2 | established science reference | Science brief: on a distance-time graph, a steeper slope means a greater speed and a flat line means no motion. |
| E3 | established science reference | Science brief: a straight line on a distance-time graph means constant speed; a curve means the speed is changing. |
| E4 | established science reference | Science brief: a graph shows only what was measured; the axes and their units determine what can be read from it. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u01::motion graphs, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about motion graphs, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about motion graphs?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g8-science-u01::motion graphs, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u01::motion graphs, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about motion graphs?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about motion graphs; then identify one check that would catch an error or weak claim.**
...
**Q1.** Create a one-page evidence product for motion graphs using only the supplied case and E1-E4: one claim, at least two cited rows, the reasoning link, one counterpoint, and one revision after checking the success criteria.

>

**Q2.** Communicate what the supplied record establishes about motion graphs in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about motion graphs against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using motion graphs as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about motion graphs? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about motion graphs that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about motion graphs. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about motion graphs.
...
- Apply motion graphs under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect motion graphs to Newton’s laws at middle-school level from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g8-science-u01-l09` · lesson `ma-g8-science-u01-l09` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
