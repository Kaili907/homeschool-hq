# Guided practice B: evidence for past change

**Grade 8 Science** · Unit 5: Earth History and Geologic Processes · Day 6 of the unit (course day 54) · about 45–65 minutes
...
- Practice evidence for past change with prompts, feedback, and gradually reduced support.
...
**Q1.** First compare E1 with E2 and write a provisional conclusion about evidence for past change. Then add the remaining rows through E3, revise the conclusion, and explain the change.
...
_Package `swp-ma-g8-science-u05-l06` · lesson `ma-g8-science-u05-l06` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
