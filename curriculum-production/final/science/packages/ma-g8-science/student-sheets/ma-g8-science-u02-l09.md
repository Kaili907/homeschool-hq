# Performance task build: light and sound models

**Grade 8 Science** · Unit 2: Waves and Information Transfer · Day 9 of the unit (course day 21) · about 45–65 minutes

**Today's focus:** light and sound models
...
- Create, test, or revise a meaningful product that applies light and sound models and the unit standards.
- Use subject-appropriate evidence or representation to communicate understanding of light and sound models.
- Check, revise, or improve work about light and sound models using stated success criteria.
...
- Science brief: sound requires a medium; light does not.
- Science brief: sound is a mechanical wave: it is a vibration passing through matter and cannot travel through a vacuum.
- Science brief: light is an electromagnetic wave and travels through a vacuum, which is how sunlight reaches Earth.
- Science brief: both carry energy and both reflect, absorb, and transmit at boundaries, which is why the wave model is useful for each.

### Evidence check: light and sound models

**Candidate claim:** A case report presents this as acceptable science: “sound travels through space.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: sound requires a medium; light does not. |
| E2 | established science reference | Science brief: sound is a mechanical wave: it is a vibration passing through matter and cannot travel through a vacuum. |
| E3 | established science reference | Science brief: light is an electromagnetic wave and travels through a vacuum, which is how sunlight reaches Earth. |
| E4 | established science reference | Science brief: both carry energy and both reflect, absorb, and transmit at boundaries, which is why the wave model is useful for each. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u02::light and sound models, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about light and sound models, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about light and sound models?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g8-science-u02::light and sound models, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u02::light and sound models, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about light and sound models?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about light and sound models; then identify one check that would catch an error or weak claim.**
...
**Q1.** Create a one-page evidence product for light and sound models using only the supplied case and E1-E4: one claim, at least two cited rows, the reasoning link, one counterpoint, and one revision after checking the success criteria.

>

**Q2.** Communicate what the supplied record establishes about light and sound models in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about light and sound models against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using light and sound models as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about light and sound models? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about light and sound models that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about light and sound models. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about light and sound models.
...
- Apply light and sound models under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect light and sound models to wave amplitude wavelength and energy from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g8-science-u02-l09` · lesson `ma-g8-science-u02-l09` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
