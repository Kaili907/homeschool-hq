# Correction and reflection: environmental justice foundations

**Grade 8 Science** · Unit 7: Resources, Climate, and Human Systems · Day 12 of the unit (course day 84) · about 45–65 minutes

**Today's focus:** environmental justice foundations
...
- Use error evidence to choose a different representation or strategy for environmental justice foundations, then demonstrate corrected understanding.
- Use subject-appropriate evidence or representation to communicate understanding of environmental justice foundations.
- Check, revise, or improve work about environmental justice foundations using stated success criteria.
...
- Science brief: environmental burdens and benefits are not distributed evenly across communities, and the pattern is documented rather than assumed.
- Science brief: who is exposed, who decides, and who benefits are separate questions, and a full account addresses all three.
- Science brief: evidence about distribution comes from data on exposure, health, and access, not from assertion.

### Evidence check: environmental justice foundations

**Candidate claim:** A case report presents this as acceptable science: “environmental burdens fall equally on all communities.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: environmental burdens and benefits are not distributed evenly across communities, and the pattern is documented rather than assumed. |
| E2 | established science reference | Science brief: who is exposed, who decides, and who benefits are separate questions, and a full account addresses all three. |
| E3 | established science reference | Science brief: evidence about distribution comes from data on exposure, health, and access, not from assertion. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u07::environmental justice foundations, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about environmental justice foundations, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about environmental justice foundations, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about environmental justice foundations; then identify one check that would catch an error or weak claim.**
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E3. Name the decisive evidence ID, explain the error about environmental justice foundations, and write a corrected claim.

>

**Q2.** Communicate what the supplied record establishes about environmental justice foundations in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about environmental justice foundations against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using environmental justice foundations as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about environmental justice foundations? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about environmental justice foundations that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about environmental justice foundations. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about environmental justice foundations.
...
- Apply environmental justice foundations under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect environmental justice foundations to resource distribution from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g8-science-u07-l12` · lesson `ma-g8-science-u07-l12` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
