# Guided practice B: electric and magnetic fields

**Grade 8 Science** · Unit 1: Forces, Motion, and Interactions · Day 6 of the unit (course day 6) · about 45–65 minutes
...
- Practice electric and magnetic fields with prompts, feedback, and gradually reduced support.
...
**Q1.** First compare E1 with E2 and write a provisional conclusion about electric and magnetic fields. Then add the remaining rows through E4, revise the conclusion, and explain the change.
...
_Package `swp-ma-g8-science-u01-l06` · lesson `ma-g8-science-u01-l06` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
