# Reteach and varied practice: rock strata and fossils

**Grade 8 Science** · Unit 5: Earth History and Geologic Processes · Day 8 of the unit (course day 56) · about 45–65 minutes
...
- Use error evidence to choose a different representation or strategy for rock strata and fossils, then demonstrate corrected understanding.
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E4. Name the decisive evidence ID, explain the error about rock strata and fossils, and write a corrected claim.
...
_Package `swp-ma-g8-science-u05-l08` · lesson `ma-g8-science-u05-l08` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
