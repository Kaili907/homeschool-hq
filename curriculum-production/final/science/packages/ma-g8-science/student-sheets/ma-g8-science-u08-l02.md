# Concept model A: ecosystem services

**Grade 8 Science** · Unit 8: Applied Biology and Ecosystem Design · Day 2 of the unit (course day 86) · about 45–65 minutes
...
- Build a clear mental model of ecosystem services through an explicit worked example, demonstration, text, or phenomenon.
...
**Q1.** Build a labelled model of ecosystem services that represents every supplied row in E1-E3. Annotate each model feature with its evidence ID, then show where the candidate claim fails or remains uncertain.
...
_Package `swp-ma-g8-science-u08-l02` · lesson `ma-g8-science-u08-l02` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
