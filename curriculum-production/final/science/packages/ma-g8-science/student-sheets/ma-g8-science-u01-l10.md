# Synthesis and review: collisions

**Grade 8 Science** · Unit 1: Forces, Motion, and Interactions · Day 10 of the unit (course day 10) · about 45–65 minutes

**Today's focus:** collisions
...
- Connect collisions to the unit’s other ideas and select evidence that shows readiness for assessment.
- Use subject-appropriate evidence or representation to communicate understanding of collisions.
- Check, revise, or improve work about collisions using stated success criteria.
...
- Science brief: in a collision the objects exert equal and opposite forces on each other for the same length of time.
- Science brief: energy is transferred during a collision, and some is always transferred to sound, warming, and deformation.
- Science brief: extending the time over which a collision force acts reduces the peak force, which is the principle behind crumple zones, helmets, and airbags.

### Evidence check: collisions

**Candidate claim:** A case report presents this as acceptable science: “the heavier object in a collision exerts the larger force.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: in a collision the objects exert equal and opposite forces on each other for the same length of time. |
| E2 | established science reference | Science brief: energy is transferred during a collision, and some is always transferred to sound, warming, and deformation. |
| E3 | established science reference | Science brief: extending the time over which a collision force acts reduces the peak force, which is the principle behind crumple zones, helmets, and airbags. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u01::collisions, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about collisions, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about collisions, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about collisions; then identify one check that would catch an error or weak claim.**
...
**Q1.** The supplied unit connections are: Newton’s laws at middle-school level, force and mass, motion graphs, collisions, gravitational interactions, electric and magnetic fields. Choose one idea other than collisions, connect it to one row in E1-E3, and explain one way treating the two ideas as identical would be misleading.

>

**Q2.** Communicate what the supplied record establishes about collisions in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about collisions against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using collisions as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about collisions? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about collisions that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about collisions. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about collisions.
...
- Apply collisions under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect collisions to Newton’s laws at middle-school level from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g8-science-u01-l10` · lesson `ma-g8-science-u01-l10` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
