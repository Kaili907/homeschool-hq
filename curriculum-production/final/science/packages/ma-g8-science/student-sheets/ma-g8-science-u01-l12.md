# Correction and reflection: electric and magnetic fields

**Grade 8 Science** · Unit 1: Forces, Motion, and Interactions · Day 12 of the unit (course day 12) · about 45–65 minutes
...
- Use error evidence to choose a different representation or strategy for electric and magnetic fields, then demonstrate corrected understanding.
- Use subject-appropriate evidence or representation to communicate understanding of electric and magnetic fields.
- Check, revise, or improve work about electric and magnetic fields using stated success criteria.
...
- Science brief: electric and magnetic forces act at a distance, and both can attract or repel.
- Science brief: a field is a model for how one object exerts a force on another without contact, with strength depending on distance and on properties of the objects.
- Science brief: electric forces act between charges and magnetic forces between magnets and moving charges; both attract or repel depending on orientation or sign.
- Science brief: electric currents produce magnetic fields, which is why electromagnets work and why electricity and magnetism are treated as one subject.

### Evidence check: electric and magnetic fields

**Candidate claim:** A case report presents this as acceptable science: “magnetic and electric forces are the same force acting on the same property.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: electric and magnetic forces act at a distance, and both can attract or repel. |
| E2 | established science reference | Science brief: a field is a model for how one object exerts a force on another without contact, with strength depending on distance and on properties of the objects. |
| E3 | established science reference | Science brief: electric forces act between charges and magnetic forces between magnets and moving charges; both attract or repel depending on orientation or sign. |
| E4 | established science reference | Science brief: electric currents produce magnetic fields, which is why electromagnets work and why electricity and magnetism are treated as one subject. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u01::electric and magnetic fields, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about electric and magnetic fields; then identify one check that would catch an error or weak claim.**
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E4. Name the decisive evidence ID, explain the error about electric and magnetic fields, and write a corrected claim.

>

**Q2.** Communicate what the supplied record establishes about electric and magnetic fields in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about electric and magnetic fields against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using electric and magnetic fields as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about electric and magnetic fields? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about electric and magnetic fields that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about electric and magnetic fields. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- Apply electric and magnetic fields under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect electric and magnetic fields to Newton’s laws at middle-school level from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g8-science-u01-l12` · lesson `ma-g8-science-u01-l12` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
