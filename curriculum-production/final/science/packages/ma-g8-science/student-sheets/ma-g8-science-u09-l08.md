# Reteach and varied practice: criteria constraints and stakeholders

**Grade 8 Science** · Unit 9: Engineering and Scientific Argument Capstone · Day 8 of the unit (course day 104) · about 45–65 minutes

**Today's focus:** criteria constraints and stakeholders
...
- Use error evidence to choose a different representation or strategy for criteria constraints and stakeholders, then demonstrate corrected understanding.
- Use subject-appropriate evidence or representation to communicate understanding of criteria constraints and stakeholders.
- Check, revise, or improve work about criteria constraints and stakeholders using stated success criteria.
...
- Science brief: criteria say what a solution must achieve; constraints say what limits it must respect; stakeholders are those affected by either.
- Science brief: different stakeholders often value the criteria differently, and that disagreement is part of the problem rather than noise.
- Science brief: safety and legal constraints are not traded against performance.

### Evidence check: criteria constraints and stakeholders

**Candidate claim:** A case report presents this as acceptable science: “treating criteria and constraints as interchangeable.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: criteria say what a solution must achieve; constraints say what limits it must respect; stakeholders are those affected by either. |
| E2 | established science reference | Science brief: different stakeholders often value the criteria differently, and that disagreement is part of the problem rather than noise. |
| E3 | established science reference | Science brief: safety and legal constraints are not traded against performance. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u09::criteria constraints and stakeholders, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about criteria constraints and stakeholders, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about criteria constraints and stakeholders, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about criteria constraints and stakeholders; then identify one check that would catch an error or weak claim.**
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E3. Name the decisive evidence ID, explain the error about criteria constraints and stakeholders, and write a corrected claim.

>

**Q2.** Communicate what the supplied record establishes about criteria constraints and stakeholders in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about criteria constraints and stakeholders against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using criteria constraints and stakeholders as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about criteria constraints and stakeholders? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about criteria constraints and stakeholders that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about criteria constraints and stakeholders. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about criteria constraints and stakeholders.
...
- Apply criteria constraints and stakeholders under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect criteria constraints and stakeholders to problem definition from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g8-science-u09-l08` · lesson `ma-g8-science-u09-l08` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
