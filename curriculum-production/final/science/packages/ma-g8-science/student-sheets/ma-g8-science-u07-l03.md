# Guided practice A: population and consumption

**Grade 8 Science** · Unit 7: Resources, Climate, and Human Systems · Day 3 of the unit (course day 75) · about 45–65 minutes
...
- Practice population and consumption with prompts, feedback, and gradually reduced support.
...
**Q1.** First compare E1 with E2 and write a provisional conclusion about population and consumption. Then add the remaining rows through E3, revise the conclusion, and explain the change.
...
_Package `swp-ma-g8-science-u07-l03` · lesson `ma-g8-science-u07-l03` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
