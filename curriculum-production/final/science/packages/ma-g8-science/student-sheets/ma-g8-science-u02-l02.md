# Concept model A: reflection absorption and transmission

**Grade 8 Science** · Unit 2: Waves and Information Transfer · Day 2 of the unit (course day 14) · about 45–65 minutes

**Today's focus:** reflection absorption and transmission
...
- Build a clear mental model of reflection absorption and transmission through an explicit worked example, demonstration, text, or phenomenon.
- Use subject-appropriate evidence or representation to communicate understanding of reflection absorption and transmission.
- Check, revise, or improve work about reflection absorption and transmission using stated success criteria.
...
- Science brief: when a wave meets a boundary it is reflected, absorbed, transmitted, or some combination of the three.
- Science brief: at a boundary, wave energy is divided between reflection, absorption, and transmission, and the division depends on both materials and on the wave.
- Science brief: absorbed wave energy is transferred to the material, usually raising its temperature.
- Science brief: the same material can reflect one kind of wave and transmit another, which is why glass is transparent to visible light but not to all radiation.

### Evidence check: reflection absorption and transmission

**Candidate claim:** A case report presents this as acceptable science: “a material either reflects or transmits, with no possibility of both.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: when a wave meets a boundary it is reflected, absorbed, transmitted, or some combination of the three. |
| E2 | established science reference | Science brief: at a boundary, wave energy is divided between reflection, absorption, and transmission, and the division depends on both materials and on the wave. |
| E3 | established science reference | Science brief: absorbed wave energy is transferred to the material, usually raising its temperature. |
| E4 | established science reference | Science brief: the same material can reflect one kind of wave and transmit another, which is why glass is transparent to visible light but not to all radiation. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g8-science-u02::reflection absorption and transmission, derived from the reviewed correctness source policy/correctness/ma-g8-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about reflection absorption and transmission, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about reflection absorption and transmission, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about reflection absorption and transmission; then identify one check that would catch an error or weak claim.**
...
**Q1.** Build a labelled model of reflection absorption and transmission that represents every supplied row in E1-E4. Annotate each model feature with its evidence ID, then show where the candidate claim fails or remains uncertain.

>

**Q2.** Communicate what the supplied record establishes about reflection absorption and transmission in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about reflection absorption and transmission against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using reflection absorption and transmission as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about reflection absorption and transmission? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about reflection absorption and transmission that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about reflection absorption and transmission. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about reflection absorption and transmission.
...
- Apply reflection absorption and transmission under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect reflection absorption and transmission to wave amplitude wavelength and energy from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g8-science-u02-l02` · lesson `ma-g8-science-u02-l02` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
