# Concept model A: fuels and the environment

**Grade 4 Science** · Unit 9: Capstone: Energy Resources and Michigan Hazards · Day 2 of the unit (course day 98) · about 40–55 minutes
...
- Build a clear mental model of fuels and the environment through an explicit worked example, demonstration, text, or phenomenon.
...
**Q1.** Build a labelled model of fuels and the environment that represents every supplied row in E1-E4. Annotate each model feature with its evidence ID, then show where the candidate claim fails or remains uncertain.
...
_Package `swp-ma-g4-science-u09-l02` · lesson `ma-g4-science-u09-l02` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
