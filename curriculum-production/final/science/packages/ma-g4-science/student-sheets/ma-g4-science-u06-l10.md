# Synthesis and review: senses and information

**Grade 4 Science** · Unit 6: Light, Vision, and the Senses · Day 10 of the unit (course day 70) · about 40–55 minutes

**Today's focus:** senses and information
...
- Connect senses and information to the unit’s other ideas and select evidence that shows readiness for assessment.
- Use subject-appropriate evidence or representation to communicate understanding of senses and information.
- Check, revise, or improve work about senses and information using stated success criteria.
...
- Science brief: animals take in information about their surroundings through sense receptors: eyes, ears, skin, nose, and tongue.
- Science brief: each kind of receptor responds to a particular kind of input, such as light, sound, pressure, or chemicals.
- Science brief: the information is sent from the receptor to the brain as signals.

### Evidence check: senses and information

**Candidate claim:** A case report presents this as acceptable science: “one receptor responds equally to every kind of input.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: animals take in information about their surroundings through sense receptors: eyes, ears, skin, nose, and tongue. |
| E2 | established science reference | Science brief: each kind of receptor responds to a particular kind of input, such as light, sound, pressure, or chemicals. |
| E3 | established science reference | Science brief: the information is sent from the receptor to the brain as signals. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u06::senses and information, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about senses and information, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about senses and information, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about senses and information; then identify one check that would catch an error or weak claim.**
...
**Q1.** The supplied unit connections are: light reflection, how we see, modeling light paths, senses and information, the brain and response, modeling information processing. Choose one idea other than senses and information, connect it to one row in E1-E3, and explain one way treating the two ideas as identical would be misleading.

>

**Q2.** Communicate what the supplied record establishes about senses and information in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about senses and information against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using senses and information as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about senses and information? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about senses and information that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about senses and information. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about senses and information.
...
- Apply senses and information under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect senses and information to light reflection from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g4-science-u06-l10` · lesson `ma-g4-science-u06-l10` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
