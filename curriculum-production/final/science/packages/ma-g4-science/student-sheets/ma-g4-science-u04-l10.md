# Synthesis and review: building a device

**Grade 4 Science** · Unit 4: Designing an Energy Converter · Day 10 of the unit (course day 46) · about 40–55 minutes

**Today's focus:** building a device
...
- Connect building a device to the unit’s other ideas and select evidence that shows readiness for assessment.
- Use subject-appropriate evidence or representation to communicate understanding of building a device.
- Check, revise, or improve work about building a device using stated success criteria.
...
- Science brief: a build follows the design, and any departure from the design is recorded as it happens.
- Science brief: the device that is tested is the device that was built, not the one that was drawn.
- Science brief: a build that cannot be described well enough for someone else to repeat it cannot be evaluated properly.

### Evidence check: building a device

**Candidate claim:** A case report presents this as acceptable science: “reporting the intended design rather than what was actually built.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a build follows the design, and any departure from the design is recorded as it happens. |
| E2 | established science reference | Science brief: the device that is tested is the device that was built, not the one that was drawn. |
| E3 | established science reference | Science brief: a build that cannot be described well enough for someone else to repeat it cannot be evaluated properly. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u04::building a device, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about building a device, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about building a device, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about building a device; then identify one check that would catch an error or weak claim.**
...
**Q1.** The supplied unit connections are: energy conversion, design criteria, generating solutions, building a device, testing and refining, comparing designs. Choose one idea other than building a device, connect it to one row in E1-E3, and explain one way treating the two ideas as identical would be misleading.

>

**Q2.** Communicate what the supplied record establishes about building a device in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about building a device against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using building a device as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about building a device? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about building a device that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about building a device. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about building a device.
...
- Apply building a device under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect building a device to energy conversion from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g4-science-u04-l10` · lesson `ma-g4-science-u04-l10` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
