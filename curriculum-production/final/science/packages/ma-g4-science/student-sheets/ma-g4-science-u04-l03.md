# Guided practice A: generating solutions

**Grade 4 Science** · Unit 4: Designing an Energy Converter · Day 3 of the unit (course day 39) · about 40–55 minutes
...
- Practice generating solutions with prompts, feedback, and gradually reduced support.
...
**The task.** What does evidence E1 through E3 justify about generating solutions, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**Q1.** First compare E1 with E2 and write a provisional conclusion about generating solutions. Then add the remaining rows through E3, revise the conclusion, and explain the change.
...
_Package `swp-ma-g4-science-u04-l03` · lesson `ma-g4-science-u04-l03` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
