# Reteach and varied practice: how we see

**Grade 4 Science** · Unit 6: Light, Vision, and the Senses · Day 8 of the unit (course day 68) · about 40–55 minutes
...
- Use error evidence to choose a different representation or strategy for how we see, then demonstrate corrected understanding.
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E4. Name the decisive evidence ID, explain the error about how we see, and write a corrected claim.
...
_Package `swp-ma-g4-science-u06-l08` · lesson `ma-g4-science-u06-l08` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
