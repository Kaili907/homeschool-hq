# Investigation or close reading: rock layers

**Grade 4 Science** · Unit 8: Earth's Changing Landscape · Day 7 of the unit (course day 91) · about 40–55 minutes

**Today's focus:** rock layers
...
- Gather and analyze evidence related to rock layers, then record a defensible interpretation.
- Use subject-appropriate evidence or representation to communicate understanding of rock layers.
- Check, revise, or improve work about rock layers using stated success criteria.
...
- Science brief: in undisturbed sedimentary layers, a lower layer formed before the layer above it.
- Science brief: sedimentary rock forms as sediment settles in layers, with newer material on top.
- Science brief: in an undisturbed sequence, deeper means older.
- Science brief: layers can be tilted, folded, faulted, or eroded after they form, so a sequence has to be checked for disturbance before the rule is applied.

### Evidence check: rock layers

**Candidate claim:** A case report presents this as acceptable science: “the topmost layer is the oldest.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: in undisturbed sedimentary layers, a lower layer formed before the layer above it. |
| E2 | established science reference | Science brief: sedimentary rock forms as sediment settles in layers, with newer material on top. |
| E3 | established science reference | Science brief: in an undisturbed sequence, deeper means older. |
| E4 | established science reference | Science brief: layers can be tilted, folded, faulted, or eroded after they form, so a sequence has to be checked for disturbance before the rule is applied. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u08::rock layers, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about rock layers, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about rock layers?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g4-science-u08::rock layers, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u08::rock layers, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about rock layers?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about rock layers; then identify one check that would catch an error or weak claim.**
...
**Q1.** Classify every supplied row E1-E4 as supports, challenges, or does not decide the candidate claim about rock layers. Cite the row and explain each classification.

>

**Q2.** Communicate what the supplied record establishes about rock layers in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about rock layers against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using rock layers as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about rock layers? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about rock layers that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about rock layers. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about rock layers.
...
- Apply rock layers under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect rock layers to fossils in rock layers from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g4-science-u08-l07` · lesson `ma-g4-science-u08-l07` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
