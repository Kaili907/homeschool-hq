# Performance task build: natural Earth processes

**Grade 4 Science** · Unit 9: Capstone: Energy Resources and Michigan Hazards · Day 9 of the unit (course day 105) · about 40–55 minutes

**Today's focus:** natural Earth processes
...
- Create, test, or revise a meaningful product that applies natural Earth processes and the unit standards.
- Use subject-appropriate evidence or representation to communicate understanding of natural Earth processes.
- Check, revise, or improve work about natural Earth processes using stated success criteria.
...
- Science brief: natural Earth processes such as floods, storms, erosion, and, elsewhere, earthquakes and volcanic eruptions, happen whether or not people are present.
- Science brief: these processes become hazards when they affect people and what they depend on.
- Science brief: where and when many of these processes occur follows patterns that can be studied and used for planning.

### Evidence check: natural Earth processes

**Candidate claim:** A case report presents this as acceptable science: “natural Earth processes can be stopped from happening.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: natural Earth processes such as floods, storms, erosion, and, elsewhere, earthquakes and volcanic eruptions, happen whether or not people are present. |
| E2 | established science reference | Science brief: these processes become hazards when they affect people and what they depend on. |
| E3 | established science reference | Science brief: where and when many of these processes occur follows patterns that can be studied and used for planning. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u09::natural Earth processes, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about natural Earth processes, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about natural Earth processes?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g4-science-u09::natural Earth processes, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u09::natural Earth processes, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about natural Earth processes?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about natural Earth processes; then identify one check that would catch an error or weak claim.**
...
**Q1.** Create a one-page evidence product for natural Earth processes using only the supplied case and E1-E3: one claim, at least two cited rows, the reasoning link, one counterpoint, and one revision after checking the success criteria.

>

**Q2.** Communicate what the supplied record establishes about natural Earth processes in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about natural Earth processes against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using natural Earth processes as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about natural Earth processes? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about natural Earth processes that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about natural Earth processes. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about natural Earth processes.
...
- Apply natural Earth processes under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect natural Earth processes to energy from natural resources from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g4-science-u09-l09` · lesson `ma-g4-science-u09-l09` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
