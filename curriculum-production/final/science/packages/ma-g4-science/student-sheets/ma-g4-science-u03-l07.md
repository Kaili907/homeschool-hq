# Investigation or close reading: sound energy

**Grade 4 Science** · Unit 3: Energy Transfer · Day 7 of the unit (course day 31) · about 40–55 minutes

**Today's focus:** sound energy

**Unit question:** How can understanding energy transfer help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Gather and analyze evidence related to sound energy, then record a defensible interpretation.
- Use subject-appropriate evidence or representation to communicate understanding of sound energy.
- Check, revise, or improve work about sound energy using stated success criteria.
...
- Science brief: sound is produced by vibrating matter and needs matter to travel through.
- Science brief: sound is produced when matter vibrates, and the vibration passes through the material around it.
- Science brief: sound travels through solids, liquids, and gases; it cannot travel through empty space.
- Science brief: a larger vibration carries more energy and is heard as a louder sound.

### Evidence check: sound energy

**Candidate claim:** A case report presents this as acceptable science: “sound travels through a vacuum.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: sound is produced by vibrating matter and needs matter to travel through. |
| E2 | established science reference | Science brief: sound is produced when matter vibrates, and the vibration passes through the material around it. |
| E3 | established science reference | Science brief: sound travels through solids, liquids, and gases; it cannot travel through empty space. |
| E4 | established science reference | Science brief: a larger vibration carries more energy and is heard as a louder sound. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u03::sound energy, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about sound energy, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about sound energy?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g4-science-u03::sound energy, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u03::sound energy, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about sound energy?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about sound energy; then identify one check that would catch an error or weak claim.**
...
**Q1.** Classify every supplied row E1-E4 as supports, challenges, or does not decide the candidate claim about sound energy. Cite the row and explain each classification.

>

**Q2.** Communicate what the supplied record establishes about sound energy in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about sound energy against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using sound energy as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about sound energy? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about sound energy that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about sound energy. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about sound energy.
...
- Apply sound energy under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect sound energy to light energy from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g4-science-u03-l07` · lesson `ma-g4-science-u03-l07` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
