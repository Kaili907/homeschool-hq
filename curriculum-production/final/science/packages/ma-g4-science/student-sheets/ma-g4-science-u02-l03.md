# Guided practice A: evidence and explanation

**Grade 4 Science** · Unit 2: Energy and Speed · Day 3 of the unit (course day 15) · about 40–55 minutes
...
- Practice evidence and explanation with prompts, feedback, and gradually reduced support.
...
**The task.** What does evidence E1 through E3 justify about evidence and explanation, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**Q1.** First compare E1 with E2 and write a provisional conclusion about evidence and explanation. Then add the remaining rows through E3, revise the conclusion, and explain the change.
...
_Package `swp-ma-g4-science-u02-l03` · lesson `ma-g4-science-u02-l03` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
