# Concept model A: fossils in rock layers

**Grade 4 Science** · Unit 8: Earth's Changing Landscape · Day 2 of the unit (course day 86) · about 40–55 minutes

**Today's focus:** fossils in rock layers
...
- Build a clear mental model of fossils in rock layers through an explicit worked example, demonstration, text, or phenomenon.
- Use subject-appropriate evidence or representation to communicate understanding of fossils in rock layers.
- Check, revise, or improve work about fossils in rock layers using stated success criteria.
...
- Science brief: fossils in rock layers are evidence of the organisms that lived when those layers were forming.
- Science brief: different layers often contain different fossils, which is evidence that the living things in a place changed over time.
- Science brief: fossils of organisms that lived in water, found in layers now far from water, are evidence that the environment there has changed.

### Evidence check: fossils in rock layers

**Candidate claim:** A case report presents this as acceptable science: “dating a fossil by when it was collected rather than by the layer it came from.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: fossils in rock layers are evidence of the organisms that lived when those layers were forming. |
| E2 | established science reference | Science brief: different layers often contain different fossils, which is evidence that the living things in a place changed over time. |
| E3 | established science reference | Science brief: fossils of organisms that lived in water, found in layers now far from water, are evidence that the environment there has changed. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u08::fossils in rock layers, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about fossils in rock layers, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about fossils in rock layers, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about fossils in rock layers; then identify one check that would catch an error or weak claim.**
...
**Q1.** Build a labelled model of fossils in rock layers that represents every supplied row in E1-E3. Annotate each model feature with its evidence ID, then show where the candidate claim fails or remains uncertain.

>

**Q2.** Communicate what the supplied record establishes about fossils in rock layers in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about fossils in rock layers against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using fossils in rock layers as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about fossils in rock layers? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about fossils in rock layers that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about fossils in rock layers. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about fossils in rock layers.
...
- Apply fossils in rock layers under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect fossils in rock layers to rock layers from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g4-science-u08-l02` · lesson `ma-g4-science-u08-l02` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
