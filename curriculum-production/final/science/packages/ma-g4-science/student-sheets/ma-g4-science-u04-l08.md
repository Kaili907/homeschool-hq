# Reteach and varied practice: design criteria

**Grade 4 Science** · Unit 4: Designing an Energy Converter · Day 8 of the unit (course day 44) · about 40–55 minutes
...
- Use error evidence to choose a different representation or strategy for design criteria, then demonstrate corrected understanding.
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E3. Name the decisive evidence ID, explain the error about design criteria, and write a corrected claim.
...
_Package `swp-ma-g4-science-u04-l08` · lesson `ma-g4-science-u04-l08` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
