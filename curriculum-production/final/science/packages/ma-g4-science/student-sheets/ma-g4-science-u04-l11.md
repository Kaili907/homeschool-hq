# Unit assessment: testing and refining

**Grade 4 Science** · Unit 4: Designing an Energy Converter · Day 11 of the unit (course day 47) · about 40–55 minutes

**Today's focus:** testing and refining
...
- Demonstrate current mastery of testing and refining through selected-response, constructed-response, and applied evidence.
- Use subject-appropriate evidence or representation to communicate understanding of testing and refining.
- Check, revise, or improve work about testing and refining using stated success criteria.
...
- Science brief: a test changes one thing at a time so an improvement can be attributed to a particular change.
- Science brief: a failed test is evidence about the design and is the normal route to a better one.
- Science brief: refinement is judged against the original criteria, not against how much effort the change took.

### Evidence check: testing and refining

**Candidate claim:** A case report presents this as acceptable science: “changing several things between tests and crediting the improvement to one of them.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a test changes one thing at a time so an improvement can be attributed to a particular change. |
| E2 | established science reference | Science brief: a failed test is evidence about the design and is the normal route to a better one. |
| E3 | established science reference | Science brief: refinement is judged against the original criteria, not against how much effort the change took. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u04::testing and refining, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about testing and refining, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about testing and refining, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? Rate confidence in testing and refining, cite one piece of evidence from today, and choose: ready to extend, ready to review later, or need a different explanation.**
...
**Q1.** Complete all three parts for testing and refining. (1) Select A: supported, B: partly supported, or C: not supported for the candidate claim. (2) Justify the selection with E1-E3. (3) Rewrite the claim so every word is supported by the supplied record.

>

**Q2.** Communicate what the supplied record establishes about testing and refining in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about testing and refining against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using testing and refining as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about testing and refining? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about testing and refining that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about testing and refining. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about testing and refining.
...
- Apply testing and refining under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect testing and refining to energy conversion from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g4-science-u04-l11` · lesson `ma-g4-science-u04-l11` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
