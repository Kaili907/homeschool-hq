# Synthesis and review: rate of erosion

**Grade 4 Science** · Unit 8: Earth's Changing Landscape · Day 10 of the unit (course day 94) · about 40–55 minutes

**Today's focus:** rate of erosion
...
- Connect rate of erosion to the unit’s other ideas and select evidence that shows readiness for assessment.
- Use subject-appropriate evidence or representation to communicate understanding of rate of erosion.
- Check, revise, or improve work about rate of erosion using stated success criteria.
...
- Science brief: the rate of erosion depends on the slope, the amount and speed of moving water or wind, the material, and whether plants hold it in place.
- Science brief: faster-moving water carries more material and larger pieces than slower-moving water.
- Science brief: plant roots slow erosion by holding soil together, which is why removing vegetation increases it.

### Evidence check: rate of erosion

**Candidate claim:** A case report presents this as acceptable science: “erosion happens at the same rate everywhere regardless of slope or cover.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: the rate of erosion depends on the slope, the amount and speed of moving water or wind, the material, and whether plants hold it in place. |
| E2 | established science reference | Science brief: faster-moving water carries more material and larger pieces than slower-moving water. |
| E3 | established science reference | Science brief: plant roots slow erosion by holding soil together, which is why removing vegetation increases it. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u08::rate of erosion, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about rate of erosion, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about rate of erosion, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about rate of erosion; then identify one check that would catch an error or weak claim.**
...
**Q1.** The supplied unit connections are: rock layers, fossils in rock layers, weathering, rate of erosion, maps of Earth's features, Michigan's geological change. Choose one idea other than rate of erosion, connect it to one row in E1-E3, and explain one way treating the two ideas as identical would be misleading.

>

**Q2.** Communicate what the supplied record establishes about rate of erosion in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about rate of erosion against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using rate of erosion as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about rate of erosion? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about rate of erosion that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about rate of erosion. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about rate of erosion.
...
- Apply rate of erosion under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect rate of erosion to rock layers from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g4-science-u08-l10` · lesson `ma-g4-science-u08-l10` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
