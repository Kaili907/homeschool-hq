# Investigation or close reading: energy conversion

**Grade 4 Science** · Unit 4: Designing an Energy Converter · Day 7 of the unit (course day 43) · about 40–55 minutes

**Today's focus:** energy conversion

**Unit question:** How can understanding designing an energy converter help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Gather and analyze evidence related to energy conversion, then record a defensible interpretation.
- Use subject-appropriate evidence or representation to communicate understanding of energy conversion.
- Check, revise, or improve work about energy conversion using stated success criteria.
...
- Science brief: energy is not created or destroyed by a device; it is converted from one form to another.
- Science brief: a device converts energy from one form to another, such as electrical to light, or motion to sound.
- Science brief: no device converts all the energy it receives into the form that is wanted; some always ends up warming the surroundings.
- Science brief: the energy a device delivers comes from a source, never from the device itself.

### Evidence check: energy conversion

**Candidate claim:** A case report presents this as acceptable science: “a device creates energy.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: energy is not created or destroyed by a device; it is converted from one form to another. |
| E2 | established science reference | Science brief: a device converts energy from one form to another, such as electrical to light, or motion to sound. |
| E3 | established science reference | Science brief: no device converts all the energy it receives into the form that is wanted; some always ends up warming the surroundings. |
| E4 | established science reference | Science brief: the energy a device delivers comes from a source, never from the device itself. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u04::energy conversion, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.

**Supplied unit connections:** energy conversion; design criteria; generating solutions; building a device; testing and refining; comparing designs

**Supplied unit performance task:** Design, test, and refine a safe device that converts energy from one form to another, then compare it against a second design.

### Bound task

**Question:** What does evidence E1 through E4 justify about energy conversion, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about energy conversion?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g4-science-u04::energy conversion, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u04::energy conversion, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about energy conversion?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about energy conversion; then identify one check that would catch an error or weak claim.**
...
**Q1.** Classify every supplied row E1-E4 as supports, challenges, or does not decide the candidate claim about energy conversion. Cite the row and explain each classification.

>

**Q2.** Communicate what the supplied record establishes about energy conversion in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about energy conversion against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using energy conversion as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about energy conversion? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about energy conversion that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about energy conversion. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about energy conversion.
...
- Apply energy conversion under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect energy conversion to design criteria from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Design, test, and refine a safe device that converts energy from one form to another, then compare it against a second design. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-g4-science-u04-l07` · lesson `ma-g4-science-u04-l07` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
