# Correction and reflection: comparing communication solutions

**Grade 4 Science** · Unit 5: Waves and Information · Day 12 of the unit (course day 60) · about 40–55 minutes

**Today's focus:** comparing communication solutions
...
- Use error evidence to choose a different representation or strategy for comparing communication solutions, then demonstrate corrected understanding.
- Use subject-appropriate evidence or representation to communicate understanding of comparing communication solutions.
- Check, revise, or improve work about comparing communication solutions using stated success criteria.
...
- Science brief: communication solutions are compared on how reliably, how far, and how quickly they carry the message, and on what they cost or require.
- Science brief: a solution that works well in one setting can fail in another, so the setting is part of the comparison.
- Science brief: the comparison uses the same criteria for every option.

### Evidence check: comparing communication solutions

**Candidate claim:** A case report presents this as acceptable science: “declaring one method best without naming the criteria or the setting.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: communication solutions are compared on how reliably, how far, and how quickly they carry the message, and on what they cost or require. |
| E2 | established science reference | Science brief: a solution that works well in one setting can fail in another, so the setting is part of the comparison. |
| E3 | established science reference | Science brief: the comparison uses the same criteria for every option. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u05::comparing communication solutions, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about comparing communication solutions, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about comparing communication solutions, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about comparing communication solutions; then identify one check that would catch an error or weak claim.**
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E3. Name the decisive evidence ID, explain the error about comparing communication solutions, and write a corrected claim.

>

**Q2.** Communicate what the supplied record establishes about comparing communication solutions in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about comparing communication solutions against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using comparing communication solutions as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about comparing communication solutions? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about comparing communication solutions that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about comparing communication solutions. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about comparing communication solutions.
...
- Apply comparing communication solutions under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect comparing communication solutions to wave patterns from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g4-science-u05-l12` · lesson `ma-g4-science-u05-l12` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
