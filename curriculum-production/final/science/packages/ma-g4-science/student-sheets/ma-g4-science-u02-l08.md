# Reteach and varied practice: speed and energy

**Grade 4 Science** · Unit 2: Energy and Speed · Day 8 of the unit (course day 20) · about 40–55 minutes
...
- Use error evidence to choose a different representation or strategy for speed and energy, then demonstrate corrected understanding.
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E3. Name the decisive evidence ID, explain the error about speed and energy, and write a corrected claim.
...
_Package `swp-ma-g4-science-u02-l08` · lesson `ma-g4-science-u02-l08` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
