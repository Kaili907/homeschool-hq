# Guided practice B: comparing designs

**Grade 4 Science** · Unit 4: Designing an Energy Converter · Day 6 of the unit (course day 42) · about 40–55 minutes
...
- Practice comparing designs with prompts, feedback, and gradually reduced support.
...
**Q1.** First compare E1 with E2 and write a provisional conclusion about comparing designs. Then add the remaining rows through E3, revise the conclusion, and explain the change.
...
_Package `swp-ma-g4-science-u04-l06` · lesson `ma-g4-science-u04-l06` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
