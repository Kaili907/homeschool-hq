# Performance task build: evidence and explanation

**Grade 4 Science** · Unit 2: Energy and Speed · Day 9 of the unit (course day 21) · about 40–55 minutes

**Today's focus:** evidence and explanation

**Unit question:** How can understanding energy and speed help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Create, test, or revise a meaningful product that applies evidence and explanation and the unit standards.
- Use subject-appropriate evidence or representation to communicate understanding of evidence and explanation.
- Check, revise, or improve work about evidence and explanation using stated success criteria.
...
- Science brief: an explanation says how or why something happens; evidence is the recorded observation or measurement that supports it.
- Science brief: an explanation is only as strong as the evidence tied to it.
- Science brief: evidence that does not bear on the claim does not support it, however carefully it was collected.

### Evidence check: evidence and explanation

**Candidate claim:** A case report presents this as acceptable science: “presenting a claim with no evidence and calling it an explanation.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: an explanation says how or why something happens; evidence is the recorded observation or measurement that supports it. |
| E2 | established science reference | Science brief: an explanation is only as strong as the evidence tied to it. |
| E3 | established science reference | Science brief: evidence that does not bear on the claim does not support it, however carefully it was collected. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u02::evidence and explanation, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.

**Supplied unit connections:** energy of motion; speed and energy; evidence and explanation; collisions; predicting outcomes; asking scientific questions

**Supplied unit performance task:** Use evidence from an adult-approved motion investigation to explain how speed relates to energy, then predict and check what changes when objects collide.

### Bound task

**Question:** What does evidence E1 through E3 justify about evidence and explanation, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about evidence and explanation?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g4-science-u02::evidence and explanation, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u02::evidence and explanation, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about evidence and explanation?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about evidence and explanation; then identify one check that would catch an error or weak claim.**
...
**Q1.** Create a one-page evidence product for evidence and explanation using only the supplied case and E1-E3: one claim, at least two cited rows, the reasoning link, one counterpoint, and one revision after checking the success criteria.

>

**Q2.** Communicate what the supplied record establishes about evidence and explanation in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about evidence and explanation against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using evidence and explanation as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about evidence and explanation? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about evidence and explanation that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about evidence and explanation. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about evidence and explanation.
...
- Apply evidence and explanation under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect evidence and explanation to energy of motion from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Use evidence from an adult-approved motion investigation to explain how speed relates to energy, then predict and check what changes when objects collide. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-g4-science-u02-l09` · lesson `ma-g4-science-u02-l09` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
