# Correction and reflection: criteria and constraints

**Grade 4 Science** · Unit 1: Science and Engineering Practices · Day 12 of the unit (course day 12) · about 40–55 minutes

**Today's focus:** criteria and constraints
...
- Use error evidence to choose a different representation or strategy for criteria and constraints, then demonstrate corrected understanding.
- Use subject-appropriate evidence or representation to communicate understanding of criteria and constraints.
- Check, revise, or improve work about criteria and constraints using stated success criteria.
...
- Science brief: criteria are what a successful solution has to achieve; constraints are the limits it has to work within, including materials, cost, time, and safety.
- Science brief: criteria and constraints are stated before solutions are generated, so every solution is judged the same way.
- Science brief: a solution that breaks a constraint has not solved the problem, however well it meets the criteria.

### Evidence check: criteria and constraints

**Candidate claim:** A case report presents this as acceptable science: “treating criteria and constraints as the same thing.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: criteria are what a successful solution has to achieve; constraints are the limits it has to work within, including materials, cost, time, and safety. |
| E2 | established science reference | Science brief: criteria and constraints are stated before solutions are generated, so every solution is judged the same way. |
| E3 | established science reference | Science brief: a solution that breaks a constraint has not solved the problem, however well it meets the criteria. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u01::criteria and constraints, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about criteria and constraints, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about criteria and constraints, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about criteria and constraints; then identify one check that would catch an error or weak claim.**
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E3. Name the decisive evidence ID, explain the error about criteria and constraints, and write a corrected claim.

>

**Q2.** Communicate what the supplied record establishes about criteria and constraints in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about criteria and constraints against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using criteria and constraints as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about criteria and constraints? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about criteria and constraints that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about criteria and constraints. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about criteria and constraints.
...
- Apply criteria and constraints under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect criteria and constraints to careful observations from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g4-science-u01-l12` · lesson `ma-g4-science-u01-l12` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
