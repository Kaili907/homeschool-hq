# Correction and reflection: tracing energy paths

**Grade 4 Science** · Unit 3: Energy Transfer · Day 12 of the unit (course day 36) · about 40–55 minutes

**Today's focus:** tracing energy paths

**Unit question:** How can understanding energy transfer help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Use error evidence to choose a different representation or strategy for tracing energy paths, then demonstrate corrected understanding.
- Use subject-appropriate evidence or representation to communicate understanding of tracing energy paths.
- Check, revise, or improve work about tracing energy paths using stated success criteria.
...
- Science brief: energy can be traced from a source, through transfers, to where it ends up.
- Science brief: at every step some energy is transferred to the surroundings, usually as warming, and that step belongs in the trace.
- Science brief: a complete trace names the source, each transfer, and the final form.

### Evidence check: tracing energy paths

**Candidate claim:** A case report presents this as acceptable science: “showing energy appearing partway along the path with no source.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: energy can be traced from a source, through transfers, to where it ends up. |
| E2 | established science reference | Science brief: at every step some energy is transferred to the surroundings, usually as warming, and that step belongs in the trace. |
| E3 | established science reference | Science brief: a complete trace names the source, each transfer, and the final form. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u03::tracing energy paths, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about tracing energy paths, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about tracing energy paths, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about tracing energy paths; then identify one check that would catch an error or weak claim.**
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E3. Name the decisive evidence ID, explain the error about tracing energy paths, and write a corrected claim.

>

**Q2.** Communicate what the supplied record establishes about tracing energy paths in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about tracing energy paths against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using tracing energy paths as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about tracing energy paths? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about tracing energy paths that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about tracing energy paths. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about tracing energy paths.
...
- Apply tracing energy paths under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect tracing energy paths to sound energy from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g4-science-u03-l12` · lesson `ma-g4-science-u03-l12` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
