# Guided practice B: modeling information processing

**Grade 4 Science** · Unit 6: Light, Vision, and the Senses · Day 6 of the unit (course day 66) · about 40–55 minutes
...
- Practice modeling information processing with prompts, feedback, and gradually reduced support.
...
**Q1.** First compare E1 with E2 and write a provisional conclusion about modeling information processing. Then add the remaining rows through E3, revise the conclusion, and explain the change.
...
_Package `swp-ma-g4-science-u06-l06` · lesson `ma-g4-science-u06-l06` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
