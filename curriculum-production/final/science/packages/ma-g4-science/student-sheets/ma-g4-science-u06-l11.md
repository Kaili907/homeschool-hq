# Unit assessment: the brain and response

**Grade 4 Science** · Unit 6: Light, Vision, and the Senses · Day 11 of the unit (course day 71) · about 40–55 minutes

**Today's focus:** the brain and response
...
- Demonstrate current mastery of the brain and response through selected-response, constructed-response, and applied evidence.
- Use subject-appropriate evidence or representation to communicate understanding of the brain and response.
- Check, revise, or improve work about the brain and response using stated success criteria.
...
- Science brief: information from the senses is processed in the brain, which is what leads to a response.
- Science brief: a response can be immediate action, or storing the information as memory for later.
- Science brief: different animals respond differently to the same information, because their bodies and behaviours differ.

### Evidence check: the brain and response

**Candidate claim:** A case report presents this as acceptable science: “the response happens in the sense organ with no processing.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: information from the senses is processed in the brain, which is what leads to a response. |
| E2 | established science reference | Science brief: a response can be immediate action, or storing the information as memory for later. |
| E3 | established science reference | Science brief: different animals respond differently to the same information, because their bodies and behaviours differ. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u06::the brain and response, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about the brain and response, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about the brain and response, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? Rate confidence in the brain and response, cite one piece of evidence from today, and choose: ready to extend, ready to review later, or need a different explanation.**
...
**Q1.** Complete all three parts for the brain and response. (1) Select A: supported, B: partly supported, or C: not supported for the candidate claim. (2) Justify the selection with E1-E3. (3) Rewrite the claim so every word is supported by the supplied record.

>

**Q2.** Communicate what the supplied record establishes about the brain and response in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about the brain and response against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using the brain and response as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about the brain and response? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about the brain and response that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about the brain and response. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about the brain and response.
...
- Apply the brain and response under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect the brain and response to light reflection from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g4-science-u06-l11` · lesson `ma-g4-science-u06-l11` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
