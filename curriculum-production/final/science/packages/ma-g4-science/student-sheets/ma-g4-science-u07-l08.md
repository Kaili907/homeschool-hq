# Reteach and varied practice: internal structures

**Grade 4 Science** · Unit 7: Structures That Support Survival · Day 8 of the unit (course day 80) · about 40–55 minutes

**Today's focus:** internal structures
...
- Use error evidence to choose a different representation or strategy for internal structures, then demonstrate corrected understanding.
- Use subject-appropriate evidence or representation to communicate understanding of internal structures.
- Check, revise, or improve work about internal structures using stated success criteria.
...
- Science brief: internal structures such as bones, hearts, lungs, stomachs, roots, and stems support survival, growth, behaviour, and reproduction.
- Science brief: internal and external structures work together; neither functions alone.
- Science brief: an internal structure's function can be inferred from where it is and what it connects to, and then checked against evidence.

### Evidence check: internal structures

**Candidate claim:** A case report presents this as acceptable science: “internal structures matter only to animals and not to plants.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: internal structures such as bones, hearts, lungs, stomachs, roots, and stems support survival, growth, behaviour, and reproduction. |
| E2 | established science reference | Science brief: internal and external structures work together; neither functions alone. |
| E3 | established science reference | Science brief: an internal structure's function can be inferred from where it is and what it connects to, and then checked against evidence. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u07::internal structures, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about internal structures, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about internal structures, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about internal structures; then identify one check that would catch an error or weak claim.**
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E3. Name the decisive evidence ID, explain the error about internal structures, and write a corrected claim.

>

**Q2.** Communicate what the supplied record establishes about internal structures in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about internal structures against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using internal structures as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about internal structures? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about internal structures that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about internal structures. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about internal structures.
...
- Apply internal structures under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect internal structures to external structures from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g4-science-u07-l08` · lesson `ma-g4-science-u07-l08` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
