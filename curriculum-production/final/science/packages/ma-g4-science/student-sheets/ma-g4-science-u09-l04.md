# Independent application A: reducing hazard impacts

**Grade 4 Science** · Unit 9: Capstone: Energy Resources and Michigan Hazards · Day 4 of the unit (course day 100) · about 40–55 minutes
...
- Apply reducing hazard impacts independently in a new representation, text, situation, or design constraint.
...
**Q1.** Independently evaluate this fully supplied case about reducing hazard impacts: A case report presents this as acceptable science: “a design prevents the natural event itself.” Use at least two rows from E1-E3, correct the claim if needed, and state one limit.
...
_Package `swp-ma-g4-science-u09-l04` · lesson `ma-g4-science-u09-l04` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
