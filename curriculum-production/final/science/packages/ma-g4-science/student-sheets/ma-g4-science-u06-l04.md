# Independent application A: senses and information

**Grade 4 Science** · Unit 6: Light, Vision, and the Senses · Day 4 of the unit (course day 64) · about 40–55 minutes
...
- Apply senses and information independently in a new representation, text, situation, or design constraint.
...
**Q1.** Independently evaluate this fully supplied case about senses and information: A case report presents this as acceptable science: “one receptor responds equally to every kind of input.” Use at least two rows from E1-E3, correct the claim if needed, and state one limit.
...
_Package `swp-ma-g4-science-u06-l04` · lesson `ma-g4-science-u06-l04` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
