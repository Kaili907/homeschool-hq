# Unit assessment: predicting outcomes

**Grade 4 Science** · Unit 2: Energy and Speed · Day 11 of the unit (course day 23) · about 40–55 minutes

**Today's focus:** predicting outcomes

**Unit question:** How can understanding energy and speed help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Demonstrate current mastery of predicting outcomes through selected-response, constructed-response, and applied evidence.
- Use subject-appropriate evidence or representation to communicate understanding of predicting outcomes.
- Check, revise, or improve work about predicting outcomes using stated success criteria.
...
- Science brief: a prediction about a collision or a motion is based on a pattern established by earlier observation.
- Science brief: a prediction is stated before the test; a statement made afterwards is an explanation.
- Science brief: a prediction that turns out wrong is useful evidence and is recorded exactly as it was made.

### Evidence check: predicting outcomes

**Candidate claim:** A case report presents this as acceptable science: “changing a recorded prediction after seeing the result.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a prediction about a collision or a motion is based on a pattern established by earlier observation. |
| E2 | established science reference | Science brief: a prediction is stated before the test; a statement made afterwards is an explanation. |
| E3 | established science reference | Science brief: a prediction that turns out wrong is useful evidence and is recorded exactly as it was made. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u02::predicting outcomes, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about predicting outcomes, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about predicting outcomes, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? Rate confidence in predicting outcomes, cite one piece of evidence from today, and choose: ready to extend, ready to review later, or need a different explanation.**
...
**Q1.** Complete all three parts for predicting outcomes. (1) Select A: supported, B: partly supported, or C: not supported for the candidate claim. (2) Justify the selection with E1-E3. (3) Rewrite the claim so every word is supported by the supplied record.

>

**Q2.** Communicate what the supplied record establishes about predicting outcomes in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about predicting outcomes against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using predicting outcomes as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about predicting outcomes? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about predicting outcomes that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about predicting outcomes. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about predicting outcomes.
...
- Apply predicting outcomes under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect predicting outcomes to energy of motion from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g4-science-u02-l11` · lesson `ma-g4-science-u02-l11` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
