# Unit assessment: maps of Earth's features

**Grade 4 Science** · Unit 8: Earth's Changing Landscape · Day 11 of the unit (course day 95) · about 40–55 minutes

**Today's focus:** maps of Earth's features
...
- Demonstrate current mastery of maps of Earth's features through selected-response, constructed-response, and applied evidence.
- Use subject-appropriate evidence or representation to communicate understanding of maps of Earth's features.
- Check, revise, or improve work about maps of Earth's features using stated success criteria.
...
- Science brief: maps show where Earth's features are, and patterns in those locations are evidence about the processes that made them.
- Science brief: a map needs a key and a scale, or its symbols and distances cannot be read.
- Science brief: features such as mountains, volcanoes, and earthquakes are not spread evenly over Earth; they cluster in patterns.

### Evidence check: maps of Earth's features

**Candidate claim:** A case report presents this as acceptable science: “reading distances off a map with no scale.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: maps show where Earth's features are, and patterns in those locations are evidence about the processes that made them. |
| E2 | established science reference | Science brief: a map needs a key and a scale, or its symbols and distances cannot be read. |
| E3 | established science reference | Science brief: features such as mountains, volcanoes, and earthquakes are not spread evenly over Earth; they cluster in patterns. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u08::maps of Earth's features, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about maps of Earth's features, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about maps of Earth's features, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? Rate confidence in maps of Earth's features, cite one piece of evidence from today, and choose: ready to extend, ready to review later, or need a different explanation.**
...
**Q1.** Complete all three parts for maps of Earth's features. (1) Select A: supported, B: partly supported, or C: not supported for the candidate claim. (2) Justify the selection with E1-E3. (3) Rewrite the claim so every word is supported by the supplied record.

>

**Q2.** Communicate what the supplied record establishes about maps of Earth's features in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about maps of Earth's features against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using maps of Earth's features as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about maps of Earth's features? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about maps of Earth's features that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about maps of Earth's features. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about maps of Earth's features.
...
- Apply maps of Earth's features under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect maps of Earth's features to rock layers from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g4-science-u08-l11` · lesson `ma-g4-science-u08-l11` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
