# Synthesis and review: waves and motion

**Grade 4 Science** · Unit 5: Waves and Information · Day 10 of the unit (course day 58) · about 40–55 minutes

**Today's focus:** waves and motion
...
- Connect waves and motion to the unit’s other ideas and select evidence that shows readiness for assessment.
- Use subject-appropriate evidence or representation to communicate understanding of waves and motion.
- Check, revise, or improve work about waves and motion using stated success criteria.
...
- Science brief: a wave can make an object in its path move, because it transfers energy to that object.
- Science brief: an object floating on water bobs up and down as waves pass; it is not carried along by them.
- Science brief: a wave with more energy makes a larger motion in the object it reaches.

### Evidence check: waves and motion

**Candidate claim:** A case report presents this as acceptable science: “a floating object is carried forward by each passing wave.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a wave can make an object in its path move, because it transfers energy to that object. |
| E2 | established science reference | Science brief: an object floating on water bobs up and down as waves pass; it is not carried along by them. |
| E3 | established science reference | Science brief: a wave with more energy makes a larger motion in the object it reaches. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u05::waves and motion, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about waves and motion, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about waves and motion, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about waves and motion; then identify one check that would catch an error or weak claim.**
...
**Q1.** The supplied unit connections are: wave patterns, amplitude, wavelength, waves and motion, patterns that carry information, comparing communication solutions. Choose one idea other than waves and motion, connect it to one row in E1-E3, and explain one way treating the two ideas as identical would be misleading.

>

**Q2.** Communicate what the supplied record establishes about waves and motion in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about waves and motion against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using waves and motion as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about waves and motion? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about waves and motion that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about waves and motion. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about waves and motion.
...
- Apply waves and motion under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect waves and motion to wave patterns from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g4-science-u05-l10` · lesson `ma-g4-science-u05-l10` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
