# Correction and reflection: evidence-based arguments

**Grade 4 Science** · Unit 7: Structures That Support Survival · Day 12 of the unit (course day 84) · about 40–55 minutes

**Today's focus:** evidence-based arguments
...
- Use error evidence to choose a different representation or strategy for evidence-based arguments, then demonstrate corrected understanding.
- Use subject-appropriate evidence or representation to communicate understanding of evidence-based arguments.
- Check, revise, or improve work about evidence-based arguments using stated success criteria.
...
- Science brief: an argument about structure and function states a claim, cites observed evidence, and explains how the evidence supports the claim.
- Science brief: evidence for a function comes from observing the structure being used, or from its position, shape, and connections.
- Science brief: an argument covers only what the evidence reaches, and says where it stops.

### Evidence check: evidence-based arguments

**Candidate claim:** A case report presents this as acceptable science: “asserting a function with no evidence and no reasoning.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: an argument about structure and function states a claim, cites observed evidence, and explains how the evidence supports the claim. |
| E2 | established science reference | Science brief: evidence for a function comes from observing the structure being used, or from its position, shape, and connections. |
| E3 | established science reference | Science brief: an argument covers only what the evidence reaches, and says where it stops. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u07::evidence-based arguments, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about evidence-based arguments, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about evidence-based arguments, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about evidence-based arguments; then identify one check that would catch an error or weak claim.**
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E3. Name the decisive evidence ID, explain the error about evidence-based arguments, and write a corrected claim.

>

**Q2.** Communicate what the supplied record establishes about evidence-based arguments in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about evidence-based arguments against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using evidence-based arguments as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about evidence-based arguments? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about evidence-based arguments that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about evidence-based arguments. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about evidence-based arguments.
...
- Apply evidence-based arguments under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect evidence-based arguments to external structures from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g4-science-u07-l12` · lesson `ma-g4-science-u07-l12` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
