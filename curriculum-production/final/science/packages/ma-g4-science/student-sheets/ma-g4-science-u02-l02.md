# Concept model A: speed and energy

**Grade 4 Science** · Unit 2: Energy and Speed · Day 2 of the unit (course day 14) · about 40–55 minutes

**Today's focus:** speed and energy

**Unit question:** How can understanding energy and speed help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Build a clear mental model of speed and energy through an explicit worked example, demonstration, text, or phenomenon.
- Use subject-appropriate evidence or representation to communicate understanding of speed and energy.
- Check, revise, or improve work about speed and energy using stated success criteria.
...
- Science brief: speed describes how far an object travels in a given time.
- Science brief: increasing an object's speed increases its energy of motion.
- Science brief: energy has to be transferred to an object to speed it up, and away from it to slow it down.

### Evidence check: speed and energy

**Candidate claim:** A case report presents this as acceptable science: “an object speeds up or slows down without any energy transfer.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: speed describes how far an object travels in a given time. |
| E2 | established science reference | Science brief: increasing an object's speed increases its energy of motion. |
| E3 | established science reference | Science brief: energy has to be transferred to an object to speed it up, and away from it to slow it down. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u02::speed and energy, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about speed and energy, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about speed and energy, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about speed and energy; then identify one check that would catch an error or weak claim.**
...
**Q1.** Build a labelled model of speed and energy that represents every supplied row in E1-E3. Annotate each model feature with its evidence ID, then show where the candidate claim fails or remains uncertain.

>

**Q2.** Communicate what the supplied record establishes about speed and energy in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about speed and energy against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using speed and energy as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about speed and energy? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about speed and energy that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about speed and energy. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about speed and energy.
...
- Apply speed and energy under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect speed and energy to energy of motion from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g4-science-u02-l02` · lesson `ma-g4-science-u02-l02` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
