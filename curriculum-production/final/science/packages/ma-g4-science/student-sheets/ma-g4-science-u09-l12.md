# Correction and reflection: Michigan's people and places

**Grade 4 Science** · Unit 9: Capstone: Energy Resources and Michigan Hazards · Day 12 of the unit (course day 108) · about 40–55 minutes

**Today's focus:** Michigan's people and places
...
- Use error evidence to choose a different representation or strategy for Michigan's people and places, then demonstrate corrected understanding.
- Use subject-appropriate evidence or representation to communicate understanding of Michigan's people and places.
- Check, revise, or improve work about Michigan's people and places using stated success criteria.
...
- Science brief: where people in Michigan live and work is shaped by the Great Lakes, by farmland and forests, and by mineral and energy resources.
- Science brief: michigan's main weather-related hazards include severe thunderstorms, tornadoes, winter and lake-effect snow storms, flooding, and shoreline erosion.
- Science brief: decisions about resources and hazards affect different communities differently, so who is affected is part of the evidence.

### Evidence check: Michigan's people and places

**Candidate claim:** A case report presents this as acceptable science: “michigan faces significant volcanic or major earthquake hazard.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: where people in Michigan live and work is shaped by the Great Lakes, by farmland and forests, and by mineral and energy resources. |
| E2 | established science reference | Science brief: michigan's main weather-related hazards include severe thunderstorms, tornadoes, winter and lake-effect snow storms, flooding, and shoreline erosion. |
| E3 | established science reference | Science brief: decisions about resources and hazards affect different communities differently, so who is affected is part of the evidence. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u09::Michigan's people and places, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about Michigan's people and places, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about Michigan's people and places, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about Michigan's people and places; then identify one check that would catch an error or weak claim.**
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E3. Name the decisive evidence ID, explain the error about Michigan's people and places, and write a corrected claim.

>

**Q2.** Communicate what the supplied record establishes about Michigan's people and places in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about Michigan's people and places against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using Michigan's people and places as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about Michigan's people and places? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about Michigan's people and places that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about Michigan's people and places. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about Michigan's people and places.
...
- Apply Michigan's people and places under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect Michigan's people and places to energy from natural resources from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g4-science-u09-l12` · lesson `ma-g4-science-u09-l12` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
