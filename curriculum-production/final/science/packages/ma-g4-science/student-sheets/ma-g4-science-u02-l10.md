...
**Grade 4 Science** · Unit 2: Energy and Speed · Day 10 of the unit (course day 22) · about 40–55 minutes
...
- Science brief: in a collision, energy is transferred between the colliding objects and into sound, heat, and deformation.
- Science brief: when objects collide, energy is transferred from one object to the other.
- Science brief: some of the energy in a collision is transferred to sound, to warming, and to changing the shape of the objects.
- Science brief: a faster collision transfers more energy, which is why faster collisions do more damage.

### Evidence check: collisions

**Candidate claim:** A case report presents this as acceptable science: “energy disappears in a collision.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: in a collision, energy is transferred between the colliding objects and into sound, heat, and deformation. |
| E2 | established science reference | Science brief: when objects collide, energy is transferred from one object to the other. |
| E3 | established science reference | Science brief: some of the energy in a collision is transferred to sound, to warming, and to changing the shape of the objects. |
| E4 | established science reference | Science brief: a faster collision transfers more energy, which is why faster collisions do more damage. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u02::collisions, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about collisions, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about collisions, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**Q1.** The supplied unit connections are: energy of motion, speed and energy, evidence and explanation, collisions, predicting outcomes, asking scientific questions. Choose one idea other than collisions, connect it to one row in E1-E4, and explain one way treating the two ideas as identical would be misleading.

>

**Q2.** Communicate what the supplied record establishes about collisions in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about collisions against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using collisions as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about collisions? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about collisions that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about collisions. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- Connect collisions to energy of motion from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g4-science-u02-l10` · lesson `ma-g4-science-u02-l10` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
