# Unit assessment: observing transfer

**Grade 4 Science** · Unit 3: Energy Transfer · Day 11 of the unit (course day 35) · about 40–55 minutes

**Today's focus:** observing transfer

**Unit question:** How can understanding energy transfer help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Demonstrate current mastery of observing transfer through selected-response, constructed-response, and applied evidence.
- Use subject-appropriate evidence or representation to communicate understanding of observing transfer.
- Check, revise, or improve work about observing transfer using stated success criteria.
...
- Science brief: energy transfer is observed through its effects: something moves, warms, lights up, makes sound, or changes shape.
- Science brief: observing an effect is evidence that energy was transferred, not a direct sight of the energy itself.
- Science brief: the same transfer can often be detected by more than one effect, and agreement between them strengthens the evidence.

### Evidence check: observing transfer

**Candidate claim:** A case report presents this as acceptable science: “energy itself was seen or held.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: energy transfer is observed through its effects: something moves, warms, lights up, makes sound, or changes shape. |
| E2 | established science reference | Science brief: observing an effect is evidence that energy was transferred, not a direct sight of the energy itself. |
| E3 | established science reference | Science brief: the same transfer can often be detected by more than one effect, and agreement between them strengthens the evidence. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u03::observing transfer, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about observing transfer, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about observing transfer, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? Rate confidence in observing transfer, cite one piece of evidence from today, and choose: ready to extend, ready to review later, or need a different explanation.**
...
**Q1.** Complete all three parts for observing transfer. (1) Select A: supported, B: partly supported, or C: not supported for the candidate claim. (2) Justify the selection with E1-E3. (3) Rewrite the claim so every word is supported by the supplied record.

>

**Q2.** Communicate what the supplied record establishes about observing transfer in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about observing transfer against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using observing transfer as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about observing transfer? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about observing transfer that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about observing transfer. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about observing transfer.
...
- Apply observing transfer under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect observing transfer to sound energy from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g4-science-u03-l11` · lesson `ma-g4-science-u03-l11` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
