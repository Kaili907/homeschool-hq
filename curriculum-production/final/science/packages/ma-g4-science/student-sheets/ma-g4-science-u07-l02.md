# Concept model A: internal structures

**Grade 4 Science** · Unit 7: Structures That Support Survival · Day 2 of the unit (course day 74) · about 40–55 minutes
...
- Build a clear mental model of internal structures through an explicit worked example, demonstration, text, or phenomenon.
...
**Q1.** Build a labelled model of internal structures that represents every supplied row in E1-E3. Annotate each model feature with its evidence ID, then show where the candidate claim fails or remains uncertain.
...
_Package `swp-ma-g4-science-u07-l02` · lesson `ma-g4-science-u07-l02` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
