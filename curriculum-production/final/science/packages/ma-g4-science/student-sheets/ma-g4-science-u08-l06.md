# Guided practice B: Michigan's geological change

**Grade 4 Science** · Unit 8: Earth's Changing Landscape · Day 6 of the unit (course day 90) · about 40–55 minutes
...
- Practice Michigan's geological change with prompts, feedback, and gradually reduced support.
...
**Q1.** First compare E1 with E2 and write a provisional conclusion about Michigan's geological change. Then add the remaining rows through E4, revise the conclusion, and explain the change.
...
_Package `swp-ma-g4-science-u08-l06` · lesson `ma-g4-science-u08-l06` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
