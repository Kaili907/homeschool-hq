# Investigation or close reading: careful observations

**Grade 4 Science** · Unit 1: Science and Engineering Practices · Day 7 of the unit (course day 7) · about 40–55 minutes

**Today's focus:** careful observations
...
- Gather and analyze evidence related to careful observations, then record a defensible interpretation.
- Use subject-appropriate evidence or representation to communicate understanding of careful observations.
- Check, revise, or improve work about careful observations using stated success criteria.
...
- Science brief: an observation is information taken in directly, through the senses or through an instrument.
- Science brief: an inference goes beyond the observation to say what it might mean, and the same observation can support more than one inference.
- Science brief: observations recorded as they are made are more trustworthy than ones written up from memory afterwards.

### Evidence check: careful observations

**Candidate claim:** A case report presents this as acceptable science: “recording an inference as an observation, such as 'the circuit is broken' instead of 'the bulb did not light'.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: an observation is information taken in directly, through the senses or through an instrument. |
| E2 | established science reference | Science brief: an inference goes beyond the observation to say what it might mean, and the same observation can support more than one inference. |
| E3 | established science reference | Science brief: observations recorded as they are made are more trustworthy than ones written up from memory afterwards. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u01::careful observations, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.

**Supplied unit connections:** careful observations; testable questions; models and diagrams; fair tests; measuring and recording data; criteria and constraints

**Supplied unit performance task:** Define a simple design problem with criteria and constraints, generate two possible solutions, and plan a fair test that controls variables.

### Bound task

**Question:** What does evidence E1 through E3 justify about careful observations, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about careful observations?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g4-science-u01::careful observations, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u01::careful observations, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about careful observations?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about careful observations; then identify one check that would catch an error or weak claim.**
...
**Q1.** Classify every supplied row E1-E3 as supports, challenges, or does not decide the candidate claim about careful observations. Cite the row and explain each classification.

>

**Q2.** Communicate what the supplied record establishes about careful observations in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about careful observations against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using careful observations as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about careful observations? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about careful observations that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about careful observations. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about careful observations.
...
- Apply careful observations under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect careful observations to testable questions from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Define a simple design problem with criteria and constraints, generate two possible solutions, and plan a fair test that controls variables. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-g4-science-u01-l07` · lesson `ma-g4-science-u01-l07` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
