# Unit assessment: patterns that carry information

**Grade 4 Science** · Unit 5: Waves and Information · Day 11 of the unit (course day 59) · about 40–55 minutes

**Today's focus:** patterns that carry information
...
- Demonstrate current mastery of patterns that carry information through selected-response, constructed-response, and applied evidence.
- Use subject-appropriate evidence or representation to communicate understanding of patterns that carry information.
- Check, revise, or improve work about patterns that carry information using stated success criteria.
...
- Science brief: patterns can be used to send information: a code of light flashes, sounds, or marks stands for something the sender and receiver agree on.
- Science brief: information is carried by the pattern, not by the material; the same message can be sent as light, sound, or writing.
- Science brief: a receiver can only recover the message if it knows the code the sender used.

### Evidence check: patterns that carry information

**Candidate claim:** A case report presents this as acceptable science: “information travels without any physical carrier.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: patterns can be used to send information: a code of light flashes, sounds, or marks stands for something the sender and receiver agree on. |
| E2 | established science reference | Science brief: information is carried by the pattern, not by the material; the same message can be sent as light, sound, or writing. |
| E3 | established science reference | Science brief: a receiver can only recover the message if it knows the code the sender used. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u05::patterns that carry information, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about patterns that carry information, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about patterns that carry information, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? Rate confidence in patterns that carry information, cite one piece of evidence from today, and choose: ready to extend, ready to review later, or need a different explanation.**
...
**Q1.** Complete all three parts for patterns that carry information. (1) Select A: supported, B: partly supported, or C: not supported for the candidate claim. (2) Justify the selection with E1-E3. (3) Rewrite the claim so every word is supported by the supplied record.

>

**Q2.** Communicate what the supplied record establishes about patterns that carry information in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about patterns that carry information against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using patterns that carry information as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about patterns that carry information? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about patterns that carry information that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about patterns that carry information. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about patterns that carry information.
...
- Apply patterns that carry information under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect patterns that carry information to wave patterns from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g4-science-u05-l11` · lesson `ma-g4-science-u05-l11` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
