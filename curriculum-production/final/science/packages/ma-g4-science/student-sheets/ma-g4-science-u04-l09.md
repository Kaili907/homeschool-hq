# Performance task build: generating solutions

**Grade 4 Science** · Unit 4: Designing an Energy Converter · Day 9 of the unit (course day 45) · about 40–55 minutes

**Today's focus:** generating solutions
...
- Create, test, or revise a meaningful product that applies generating solutions and the unit standards.
- Use subject-appropriate evidence or representation to communicate understanding of generating solutions.
- Check, revise, or improve work about generating solutions using stated success criteria.
...
- Science brief: more than one design can meet the same criteria, and generating several before choosing gives a better chance of a good one.
- Science brief: comparing alternatives is only meaningful when they are judged against the same criteria.
- Science brief: an idea that fails a constraint is eliminated at this stage, not tested and then rejected.

### Evidence check: generating solutions

**Candidate claim:** A case report presents this as acceptable science: “committing to the first idea and calling the comparison done.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: more than one design can meet the same criteria, and generating several before choosing gives a better chance of a good one. |
| E2 | established science reference | Science brief: comparing alternatives is only meaningful when they are judged against the same criteria. |
| E3 | established science reference | Science brief: an idea that fails a constraint is eliminated at this stage, not tested and then rejected. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u04::generating solutions, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about generating solutions, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about generating solutions?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g4-science-u04::generating solutions, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u04::generating solutions, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about generating solutions?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about generating solutions; then identify one check that would catch an error or weak claim.**
...
**Q1.** Create a one-page evidence product for generating solutions using only the supplied case and E1-E3: one claim, at least two cited rows, the reasoning link, one counterpoint, and one revision after checking the success criteria.

>

**Q2.** Communicate what the supplied record establishes about generating solutions in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about generating solutions against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using generating solutions as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about generating solutions? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about generating solutions that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about generating solutions. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about generating solutions.
...
- Apply generating solutions under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect generating solutions to energy conversion from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g4-science-u04-l09` · lesson `ma-g4-science-u04-l09` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
