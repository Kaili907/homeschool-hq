...
**Grade 4 Science** · Unit 2: Energy and Speed · Day 4 of the unit (course day 16) · about 40–55 minutes
...
**Q1.** Independently evaluate this fully supplied case about collisions: A case report presents this as acceptable science: “energy disappears in a collision.” Use at least two rows from E1-E4, correct the claim if needed, and state one limit.
...
_Package `swp-ma-g4-science-u02-l04` · lesson `ma-g4-science-u02-l04` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
