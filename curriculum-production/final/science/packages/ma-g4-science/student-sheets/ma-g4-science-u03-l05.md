# Concept model B: observing transfer

**Grade 4 Science** · Unit 3: Energy Transfer · Day 5 of the unit (course day 29) · about 40–55 minutes
...
- Build a clear mental model of observing transfer through an explicit worked example, demonstration, text, or phenomenon.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about observing transfer; then identify one check that would catch an error or weak claim.**
...
**Q1.** Build a labelled model of observing transfer that represents every supplied row in E1-E3. Annotate each model feature with its evidence ID, then show where the candidate claim fails or remains uncertain.
...
_Package `swp-ma-g4-science-u03-l05` · lesson `ma-g4-science-u03-l05` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
