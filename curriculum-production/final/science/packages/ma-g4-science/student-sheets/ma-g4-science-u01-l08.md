...
- Science brief: a testable question can be answered by making observations or by doing something and seeing what happens.
- Science brief: a testable question names what will be changed or examined and what will be observed or measured.
- Science brief: a question that no possible observation could settle is not testable, however interesting it is.

### Evidence check: testable questions

**Candidate claim:** A case report presents this as acceptable science: “calling a question testable when no observation could answer it.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a testable question can be answered by making observations or by doing something and seeing what happens. |
| E2 | established science reference | Science brief: a testable question names what will be changed or examined and what will be observed or measured. |
| E3 | established science reference | Science brief: a question that no possible observation could settle is not testable, however interesting it is. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u01::testable questions, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
_Package `swp-ma-g4-science-u01-l08` · lesson `ma-g4-science-u01-l08` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
