# Unit assessment: measuring and recording data

**Grade 4 Science** · Unit 1: Science and Engineering Practices · Day 11 of the unit (course day 11) · about 40–55 minutes

**Today's focus:** measuring and recording data
...
- Demonstrate current mastery of measuring and recording data through selected-response, constructed-response, and applied evidence.
- Use subject-appropriate evidence or representation to communicate understanding of measuring and recording data.
- Check, revise, or improve work about measuring and recording data using stated success criteria.
...
- Science brief: a measurement is incomplete without its unit.
- Science brief: a measurement has a number and a unit, and both are needed for it to mean anything.
- Science brief: repeated measurements of the same quantity usually differ a little; that spread is information about the method, not a mistake to hide.
- Science brief: a labelled table lets values be compared; scattered notes usually do not.

### Evidence check: measuring and recording data

**Candidate claim:** A case report presents this as acceptable science: “recording a number with no unit and calling the measurement complete.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a measurement is incomplete without its unit. |
| E2 | established science reference | Science brief: a measurement has a number and a unit, and both are needed for it to mean anything. |
| E3 | established science reference | Science brief: repeated measurements of the same quantity usually differ a little; that spread is information about the method, not a mistake to hide. |
| E4 | established science reference | Science brief: a labelled table lets values be compared; scattered notes usually do not. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u01::measuring and recording data, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about measuring and recording data, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about measuring and recording data, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? Rate confidence in measuring and recording data, cite one piece of evidence from today, and choose: ready to extend, ready to review later, or need a different explanation.**
...
**Q1.** Complete all three parts for measuring and recording data. (1) Select A: supported, B: partly supported, or C: not supported for the candidate claim. (2) Justify the selection with E1-E4. (3) Rewrite the claim so every word is supported by the supplied record.

>

**Q2.** Communicate what the supplied record establishes about measuring and recording data in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about measuring and recording data against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using measuring and recording data as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about measuring and recording data? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about measuring and recording data that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about measuring and recording data. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about measuring and recording data.
...
- Apply measuring and recording data under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect measuring and recording data to careful observations from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g4-science-u01-l11` · lesson `ma-g4-science-u01-l11` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
