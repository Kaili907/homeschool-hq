# Investigation or close reading: energy from natural resources

**Grade 4 Science** · Unit 9: Capstone: Energy Resources and Michigan Hazards · Day 7 of the unit (course day 103) · about 40–55 minutes

**Today's focus:** energy from natural resources

**Unit question:** How can understanding energy resources and Michigan hazards help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Gather and analyze evidence related to energy from natural resources, then record a defensible interpretation.
- Use subject-appropriate evidence or representation to communicate understanding of energy from natural resources.
- Check, revise, or improve work about energy from natural resources using stated success criteria.
...
- Science brief: renewable resources are replenished on a human timescale; fossil fuels are not.
- Science brief: the energy people use comes from natural resources: sunlight, wind, moving water, biomass, fossil fuels, and nuclear fuels.
- Science brief: renewable resources are replaced on a human timescale; fossil fuels form over many millions of years and are not.
- Science brief: every energy resource has to be found, extracted or captured, converted, and delivered, and each of those steps has costs and effects.

### Evidence check: energy from natural resources

**Candidate claim:** A case report presents this as acceptable science: “any energy resource has no environmental effect at all.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: renewable resources are replenished on a human timescale; fossil fuels are not. |
| E2 | established science reference | Science brief: the energy people use comes from natural resources: sunlight, wind, moving water, biomass, fossil fuels, and nuclear fuels. |
| E3 | established science reference | Science brief: renewable resources are replaced on a human timescale; fossil fuels form over many millions of years and are not. |
| E4 | established science reference | Science brief: every energy resource has to be found, extracted or captured, converted, and delivered, and each of those steps has costs and effects. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u09::energy from natural resources, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.

**Supplied unit connections:** energy from natural resources; fuels and the environment; natural Earth processes; reducing hazard impacts; comparing solutions; Michigan's people and places

**Supplied unit performance task:** Obtain and combine information about energy and fuels, then generate, fair-test, and compare solutions that reduce the impact of a natural Earth process on Michigan's people and places.

### Bound task

**Question:** What does evidence E1 through E4 justify about energy from natural resources, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about energy from natural resources?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g4-science-u09::energy from natural resources, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u09::energy from natural resources, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about energy from natural resources?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about energy from natural resources; then identify one check that would catch an error or weak claim.**
...
**Q1.** Classify every supplied row E1-E4 as supports, challenges, or does not decide the candidate claim about energy from natural resources. Cite the row and explain each classification.

>

**Q2.** Communicate what the supplied record establishes about energy from natural resources in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about energy from natural resources against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using energy from natural resources as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about energy from natural resources? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about energy from natural resources that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about energy from natural resources. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about energy from natural resources.
...
- Apply energy from natural resources under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect energy from natural resources to fuels and the environment from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Obtain and combine information about energy and fuels, then generate, fair-test, and compare solutions that reduce the impact of a natural Earth process on Michigan's people and places. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-g4-science-u09-l07` · lesson `ma-g4-science-u09-l07` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
