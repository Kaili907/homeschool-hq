# Synthesis and review: electric currents

**Grade 4 Science** · Unit 3: Energy Transfer · Day 10 of the unit (course day 34) · about 40–55 minutes

**Today's focus:** electric currents

**Unit question:** How can understanding energy transfer help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Connect electric currents to the unit’s other ideas and select evidence that shows readiness for assessment.
- Use subject-appropriate evidence or representation to communicate understanding of electric currents.
- Check, revise, or improve work about electric currents using stated success criteria.
...
- Science brief: an electric current needs a complete, unbroken loop from one terminal of the source back to the other.
- Science brief: energy can be transferred from place to place by electric currents.
- Science brief: a current flows only in a complete circuit; a break anywhere stops it everywhere in that loop.
- Science brief: a device in a circuit converts the energy delivered to it into another form, such as light, sound, motion, or warmth.

### Evidence check: electric currents

**Candidate claim:** A case report presents this as acceptable science: “a bulb lights with a wire on only one terminal of the battery.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: an electric current needs a complete, unbroken loop from one terminal of the source back to the other. |
| E2 | established science reference | Science brief: energy can be transferred from place to place by electric currents. |
| E3 | established science reference | Science brief: a current flows only in a complete circuit; a break anywhere stops it everywhere in that loop. |
| E4 | established science reference | Science brief: a device in a circuit converts the energy delivered to it into another form, such as light, sound, motion, or warmth. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u03::electric currents, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about electric currents, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about electric currents, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about electric currents; then identify one check that would catch an error or weak claim.**
...
**Q1.** The supplied unit connections are: sound energy, light energy, heat transfer, electric currents, observing transfer, tracing energy paths. Choose one idea other than electric currents, connect it to one row in E1-E4, and explain one way treating the two ideas as identical would be misleading.

>

**Q2.** Communicate what the supplied record establishes about electric currents in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about electric currents against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using electric currents as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about electric currents? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about electric currents that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about electric currents. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about electric currents.
...
- Apply electric currents under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect electric currents to sound energy from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g4-science-u03-l10` · lesson `ma-g4-science-u03-l10` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
