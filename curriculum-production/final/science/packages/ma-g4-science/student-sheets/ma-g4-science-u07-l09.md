# Performance task build: structure and function

**Grade 4 Science** · Unit 7: Structures That Support Survival · Day 9 of the unit (course day 81) · about 40–55 minutes

**Today's focus:** structure and function
...
- Create, test, or revise a meaningful product that applies structure and function and the unit standards.
- Use subject-appropriate evidence or representation to communicate understanding of structure and function.
- Check, revise, or improve work about structure and function using stated success criteria.
...
- Science brief: a structure's shape and material relate to what it does; this is the structure-function relationship.
- Science brief: changing the structure changes what it can do.
- Science brief: similar functions in different organisms are often carried out by structures that are built differently.

### Evidence check: structure and function

**Candidate claim:** A case report presents this as acceptable science: “structure and function are unrelated.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a structure's shape and material relate to what it does; this is the structure-function relationship. |
| E2 | established science reference | Science brief: changing the structure changes what it can do. |
| E3 | established science reference | Science brief: similar functions in different organisms are often carried out by structures that are built differently. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u07::structure and function, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about structure and function, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about structure and function?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g4-science-u07::structure and function, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u07::structure and function, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about structure and function?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about structure and function; then identify one check that would catch an error or weak claim.**
...
**Q1.** Create a one-page evidence product for structure and function using only the supplied case and E1-E3: one claim, at least two cited rows, the reasoning link, one counterpoint, and one revision after checking the success criteria.

>

**Q2.** Communicate what the supplied record establishes about structure and function in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about structure and function against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using structure and function as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about structure and function? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about structure and function that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about structure and function. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about structure and function.
...
- Apply structure and function under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect structure and function to external structures from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g4-science-u07-l09` · lesson `ma-g4-science-u07-l09` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
