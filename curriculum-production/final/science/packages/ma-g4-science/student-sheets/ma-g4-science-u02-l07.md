# Investigation or close reading: energy of motion

**Grade 4 Science** · Unit 2: Energy and Speed · Day 7 of the unit (course day 19) · about 40–55 minutes

**Today's focus:** energy of motion

**Unit question:** How can understanding energy and speed help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Gather and analyze evidence related to energy of motion, then record a defensible interpretation.
- Use subject-appropriate evidence or representation to communicate understanding of energy of motion.
- Check, revise, or improve work about energy of motion using stated success criteria.
...
- Science brief: a moving object has energy of motion; a faster-moving object of the same mass has more of it.
- Science brief: any moving object has energy because of its motion.
- Science brief: for objects of the same mass, the faster one has more energy of motion.
- Science brief: for objects moving at the same speed, the more massive one has more energy of motion.

### Evidence check: energy of motion

**Candidate claim:** A case report presents this as acceptable science: “a moving object has no energy until it hits something.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a moving object has energy of motion; a faster-moving object of the same mass has more of it. |
| E2 | established science reference | Science brief: any moving object has energy because of its motion. |
| E3 | established science reference | Science brief: for objects of the same mass, the faster one has more energy of motion. |
| E4 | established science reference | Science brief: for objects moving at the same speed, the more massive one has more energy of motion. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u02::energy of motion, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about energy of motion, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about energy of motion?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g4-science-u02::energy of motion, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u02::energy of motion, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about energy of motion?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about energy of motion; then identify one check that would catch an error or weak claim.**
...
**Q1.** Classify every supplied row E1-E4 as supports, challenges, or does not decide the candidate claim about energy of motion. Cite the row and explain each classification.

>

**Q2.** Communicate what the supplied record establishes about energy of motion in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about energy of motion against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using energy of motion as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about energy of motion? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about energy of motion that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about energy of motion. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about energy of motion.
...
- Apply energy of motion under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect energy of motion to speed and energy from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g4-science-u02-l07` · lesson `ma-g4-science-u02-l07` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
