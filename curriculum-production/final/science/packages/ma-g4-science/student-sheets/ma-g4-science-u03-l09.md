# Performance task build: heat transfer

**Grade 4 Science** · Unit 3: Energy Transfer · Day 9 of the unit (course day 33) · about 40–55 minutes

**Today's focus:** heat transfer

**Unit question:** How can understanding energy transfer help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Create, test, or revise a meaningful product that applies heat transfer and the unit standards.
- Use subject-appropriate evidence or representation to communicate understanding of heat transfer.
- Check, revise, or improve work about heat transfer using stated success criteria.
...
- Science brief: energy moves from the warmer object to the cooler one, never the other way on its own.
- Science brief: when two objects at different temperatures touch, energy moves from the warmer one to the cooler one.
- Science brief: transfer continues until the two objects reach the same temperature.
- Science brief: some materials transfer energy quickly and others slowly, which is what makes insulators useful.

### Evidence check: heat transfer

**Candidate claim:** A case report presents this as acceptable science: “cold moves into a warm object; only energy moves, and it moves from warmer to cooler.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: energy moves from the warmer object to the cooler one, never the other way on its own. |
| E2 | established science reference | Science brief: when two objects at different temperatures touch, energy moves from the warmer one to the cooler one. |
| E3 | established science reference | Science brief: transfer continues until the two objects reach the same temperature. |
| E4 | established science reference | Science brief: some materials transfer energy quickly and others slowly, which is what makes insulators useful. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u03::heat transfer, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about heat transfer, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about heat transfer?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g4-science-u03::heat transfer, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u03::heat transfer, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about heat transfer?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about heat transfer; then identify one check that would catch an error or weak claim.**
...
**Q1.** Create a one-page evidence product for heat transfer using only the supplied case and E1-E4: one claim, at least two cited rows, the reasoning link, one counterpoint, and one revision after checking the success criteria.

>

**Q2.** Communicate what the supplied record establishes about heat transfer in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about heat transfer against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using heat transfer as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about heat transfer? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about heat transfer that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about heat transfer. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about heat transfer.
...
- Apply heat transfer under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect heat transfer to sound energy from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Make observations that provide evidence energy moves from place to place by sound, light, heat, and simple battery-powered electric currents. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-g4-science-u03-l09` · lesson `ma-g4-science-u03-l09` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
