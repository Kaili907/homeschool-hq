# Investigation or close reading: light reflection

**Grade 4 Science** · Unit 6: Light, Vision, and the Senses · Day 7 of the unit (course day 67) · about 40–55 minutes

**Today's focus:** light reflection

**Unit question:** How can understanding light, vision, and the senses help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Gather and analyze evidence related to light reflection, then record a defensible interpretation.
- Use subject-appropriate evidence or representation to communicate understanding of light reflection.
- Check, revise, or improve work about light reflection using stated success criteria.
...
- Science brief: an object is seen when light reflected from it enters the eye.
- Science brief: light bounces off surfaces, and that bouncing is reflection.
- Science brief: a smooth surface reflects light in a regular way and gives an image; a rough surface scatters it in many directions and does not.
- Science brief: an object that gives out no light of its own is seen only because light from a source reflects off it.

### Evidence check: light reflection

**Candidate claim:** A case report presents this as acceptable science: “the eye sends out light to see objects.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: an object is seen when light reflected from it enters the eye. |
| E2 | established science reference | Science brief: light bounces off surfaces, and that bouncing is reflection. |
| E3 | established science reference | Science brief: a smooth surface reflects light in a regular way and gives an image; a rough surface scatters it in many directions and does not. |
| E4 | established science reference | Science brief: an object that gives out no light of its own is seen only because light from a source reflects off it. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u06::light reflection, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.

**Supplied unit connections:** light reflection; how we see; modeling light paths; senses and information; the brain and response; modeling information processing

**Supplied unit performance task:** Develop a model showing that light reflects from objects into the eye, and a second model tracing how an animal senses, processes, and responds to information.

### Bound task

**Question:** What does evidence E1 through E4 justify about light reflection, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about light reflection?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g4-science-u06::light reflection, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u06::light reflection, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about light reflection?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about light reflection; then identify one check that would catch an error or weak claim.**
...
**Q1.** Classify every supplied row E1-E4 as supports, challenges, or does not decide the candidate claim about light reflection. Cite the row and explain each classification.

>

**Q2.** Communicate what the supplied record establishes about light reflection in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about light reflection against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using light reflection as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about light reflection? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about light reflection that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about light reflection. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about light reflection.
...
- Apply light reflection under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect light reflection to how we see from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Develop a model showing that light reflects from objects into the eye, and a second model tracing how an animal senses, processes, and responds to information. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-g4-science-u06-l07` · lesson `ma-g4-science-u06-l07` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
