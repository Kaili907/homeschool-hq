# Correction and reflection: asking scientific questions

**Grade 4 Science** · Unit 2: Energy and Speed · Day 12 of the unit (course day 24) · about 40–55 minutes

**Today's focus:** asking scientific questions

**Unit question:** How can understanding energy and speed help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Use error evidence to choose a different representation or strategy for asking scientific questions, then demonstrate corrected understanding.
- Use subject-appropriate evidence or representation to communicate understanding of asking scientific questions.
- Check, revise, or improve work about asking scientific questions using stated success criteria.
...
- Science brief: a scientific question about energy names what would be changed and what would be observed or measured.
- Science brief: good questions often come from something that does not fit an existing explanation.
- Science brief: a question that cannot be answered by any observation is not a scientific question, whatever else it is.

### Evidence check: asking scientific questions

**Candidate claim:** A case report presents this as acceptable science: “framing a preference or a value judgement as a scientific question.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a scientific question about energy names what would be changed and what would be observed or measured. |
| E2 | established science reference | Science brief: good questions often come from something that does not fit an existing explanation. |
| E3 | established science reference | Science brief: a question that cannot be answered by any observation is not a scientific question, whatever else it is. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u02::asking scientific questions, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about asking scientific questions, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about asking scientific questions, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about asking scientific questions; then identify one check that would catch an error or weak claim.**
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E3. Name the decisive evidence ID, explain the error about asking scientific questions, and write a corrected claim.

>

**Q2.** Communicate what the supplied record establishes about asking scientific questions in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about asking scientific questions against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using asking scientific questions as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about asking scientific questions? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about asking scientific questions that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about asking scientific questions. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about asking scientific questions.
...
- Apply asking scientific questions under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect asking scientific questions to energy of motion from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g4-science-u02-l12` · lesson `ma-g4-science-u02-l12` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
