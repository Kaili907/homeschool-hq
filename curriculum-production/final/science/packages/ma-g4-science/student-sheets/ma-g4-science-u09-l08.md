# Reteach and varied practice: fuels and the environment

**Grade 4 Science** · Unit 9: Capstone: Energy Resources and Michigan Hazards · Day 8 of the unit (course day 104) · about 40–55 minutes

**Today's focus:** fuels and the environment
...
- Use error evidence to choose a different representation or strategy for fuels and the environment, then demonstrate corrected understanding.
- Use subject-appropriate evidence or representation to communicate understanding of fuels and the environment.
- Check, revise, or improve work about fuels and the environment using stated success criteria.
...
- Science brief: burning fossil fuels releases carbon dioxide into the atmosphere.
- Science brief: burning fossil fuels releases carbon dioxide and other substances into the air.
- Science brief: extracting, transporting, and burning fuels affects land, water, and air, and those effects differ between fuels.
- Science brief: reducing the amount of fuel used reduces the effects, which is why efficiency and conservation matter.

### Evidence check: fuels and the environment

**Candidate claim:** A case report presents this as acceptable science: “burning fuel produces no waste products because the flame looks clean.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: burning fossil fuels releases carbon dioxide into the atmosphere. |
| E2 | established science reference | Science brief: burning fossil fuels releases carbon dioxide and other substances into the air. |
| E3 | established science reference | Science brief: extracting, transporting, and burning fuels affects land, water, and air, and those effects differ between fuels. |
| E4 | established science reference | Science brief: reducing the amount of fuel used reduces the effects, which is why efficiency and conservation matter. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u09::fuels and the environment, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about fuels and the environment, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about fuels and the environment, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about fuels and the environment; then identify one check that would catch an error or weak claim.**
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E4. Name the decisive evidence ID, explain the error about fuels and the environment, and write a corrected claim.

>

**Q2.** Communicate what the supplied record establishes about fuels and the environment in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about fuels and the environment against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using fuels and the environment as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about fuels and the environment? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about fuels and the environment that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about fuels and the environment. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about fuels and the environment.
...
- Apply fuels and the environment under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect fuels and the environment to energy from natural resources from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g4-science-u09-l08` · lesson `ma-g4-science-u09-l08` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
