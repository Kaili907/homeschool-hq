# Synthesis and review: reducing hazard impacts

**Grade 4 Science** · Unit 9: Capstone: Energy Resources and Michigan Hazards · Day 10 of the unit (course day 106) · about 40–55 minutes

**Today's focus:** reducing hazard impacts
...
- Connect reducing hazard impacts to the unit’s other ideas and select evidence that shows readiness for assessment.
- Use subject-appropriate evidence or representation to communicate understanding of reducing hazard impacts.
- Check, revise, or improve work about reducing hazard impacts using stated success criteria.
...
- Science brief: the impact of a natural hazard can be reduced by design, by warning systems, and by where and how people build.
- Science brief: reducing impact is not the same as preventing the event; the event still happens.
- Science brief: every mitigation has costs and limits, and a solution that works for one hazard may not work for another.

### Evidence check: reducing hazard impacts

**Candidate claim:** A case report presents this as acceptable science: “a design prevents the natural event itself.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: the impact of a natural hazard can be reduced by design, by warning systems, and by where and how people build. |
| E2 | established science reference | Science brief: reducing impact is not the same as preventing the event; the event still happens. |
| E3 | established science reference | Science brief: every mitigation has costs and limits, and a solution that works for one hazard may not work for another. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u09::reducing hazard impacts, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about reducing hazard impacts, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about reducing hazard impacts, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about reducing hazard impacts; then identify one check that would catch an error or weak claim.**
...
**Q1.** The supplied unit connections are: energy from natural resources, fuels and the environment, natural Earth processes, reducing hazard impacts, comparing solutions, Michigan's people and places. Choose one idea other than reducing hazard impacts, connect it to one row in E1-E3, and explain one way treating the two ideas as identical would be misleading.

>

**Q2.** Communicate what the supplied record establishes about reducing hazard impacts in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about reducing hazard impacts against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using reducing hazard impacts as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about reducing hazard impacts? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about reducing hazard impacts that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about reducing hazard impacts. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about reducing hazard impacts.
...
- Apply reducing hazard impacts under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect reducing hazard impacts to energy from natural resources from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g4-science-u09-l10` · lesson `ma-g4-science-u09-l10` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
