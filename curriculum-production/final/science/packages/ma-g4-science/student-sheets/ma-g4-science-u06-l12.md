# Correction and reflection: modeling information processing

**Grade 4 Science** · Unit 6: Light, Vision, and the Senses · Day 12 of the unit (course day 72) · about 40–55 minutes

**Today's focus:** modeling information processing
...
- Use error evidence to choose a different representation or strategy for modeling information processing, then demonstrate corrected understanding.
- Use subject-appropriate evidence or representation to communicate understanding of modeling information processing.
- Check, revise, or improve work about modeling information processing using stated success criteria.
...
- Science brief: a model of information processing shows input, processing, and response as distinct stages.
- Science brief: the model shows the direction of flow, from receptor to brain to response.
- Science brief: a model that omits the processing stage cannot explain why responses differ between animals or situations.

### Evidence check: modeling information processing

**Candidate claim:** A case report presents this as acceptable science: “drawing a model that runs from response back to input as the normal direction.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a model of information processing shows input, processing, and response as distinct stages. |
| E2 | established science reference | Science brief: the model shows the direction of flow, from receptor to brain to response. |
| E3 | established science reference | Science brief: a model that omits the processing stage cannot explain why responses differ between animals or situations. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u06::modeling information processing, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about modeling information processing, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about modeling information processing, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about modeling information processing; then identify one check that would catch an error or weak claim.**
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E3. Name the decisive evidence ID, explain the error about modeling information processing, and write a corrected claim.

>

**Q2.** Communicate what the supplied record establishes about modeling information processing in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about modeling information processing against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using modeling information processing as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about modeling information processing? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about modeling information processing that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about modeling information processing. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about modeling information processing.
...
- Apply modeling information processing under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect modeling information processing to light reflection from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g4-science-u06-l12` · lesson `ma-g4-science-u06-l12` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
