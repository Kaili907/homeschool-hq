# Investigation or close reading: wave patterns

**Grade 4 Science** · Unit 5: Waves and Information · Day 7 of the unit (course day 55) · about 40–55 minutes

**Today's focus:** wave patterns

**Unit question:** How can understanding waves and information help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Gather and analyze evidence related to wave patterns, then record a defensible interpretation.
- Use subject-appropriate evidence or representation to communicate understanding of wave patterns.
- Check, revise, or improve work about wave patterns using stated success criteria.
...
- Science brief: a wave transfers energy from place to place without transporting the material it travels through.
- Science brief: waves are regular repeating patterns of motion that transfer energy from one place to another.
- Science brief: the material a wave travels through moves back and forth about its resting position; it is not carried along with the wave.
- Science brief: waves can be described by their amplitude and their wavelength.

### Evidence check: wave patterns

**Candidate claim:** A case report presents this as acceptable science: “a wave carries the water or the rope along with it.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a wave transfers energy from place to place without transporting the material it travels through. |
| E2 | established science reference | Science brief: waves are regular repeating patterns of motion that transfer energy from one place to another. |
| E3 | established science reference | Science brief: the material a wave travels through moves back and forth about its resting position; it is not carried along with the wave. |
| E4 | established science reference | Science brief: waves can be described by their amplitude and their wavelength. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u05::wave patterns, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.

**Supplied unit connections:** wave patterns; amplitude; wavelength; waves and motion; patterns that carry information; comparing communication solutions

**Supplied unit performance task:** Develop a wave model showing amplitude and wavelength, then generate and compare two solutions that use patterns to send information.

### Bound task

**Question:** What does evidence E1 through E4 justify about wave patterns, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about wave patterns?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g4-science-u05::wave patterns, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u05::wave patterns, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about wave patterns?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about wave patterns; then identify one check that would catch an error or weak claim.**
...
**Q1.** Classify every supplied row E1-E4 as supports, challenges, or does not decide the candidate claim about wave patterns. Cite the row and explain each classification.

>

**Q2.** Communicate what the supplied record establishes about wave patterns in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about wave patterns against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using wave patterns as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about wave patterns? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about wave patterns that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about wave patterns. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about wave patterns.
...
- Apply wave patterns under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect wave patterns to amplitude from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Develop a wave model showing amplitude and wavelength, then generate and compare two solutions that use patterns to send information. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-g4-science-u05-l07` · lesson `ma-g4-science-u05-l07` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
