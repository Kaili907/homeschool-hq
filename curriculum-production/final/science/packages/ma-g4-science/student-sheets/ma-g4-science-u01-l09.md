# Performance task build: models and diagrams

**Grade 4 Science** · Unit 1: Science and Engineering Practices · Day 9 of the unit (course day 9) · about 40–55 minutes

**Today's focus:** models and diagrams
...
- Create, test, or revise a meaningful product that applies models and diagrams and the unit standards.
- Use subject-appropriate evidence or representation to communicate understanding of models and diagrams.
- Check, revise, or improve work about models and diagrams using stated success criteria.
...
- Science brief: a model or diagram represents something in order to explain or predict how it behaves.
- Science brief: every model simplifies, and what it leaves out is a limitation to be stated rather than hidden.
- Science brief: a diagram's labels and arrows carry meaning; an unlabelled diagram does not communicate a model.

### Evidence check: models and diagrams

**Candidate claim:** A case report presents this as acceptable science: “a model has to look like the real thing to be good.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a model or diagram represents something in order to explain or predict how it behaves. |
| E2 | established science reference | Science brief: every model simplifies, and what it leaves out is a limitation to be stated rather than hidden. |
| E3 | established science reference | Science brief: a diagram's labels and arrows carry meaning; an unlabelled diagram does not communicate a model. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u01::models and diagrams, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about models and diagrams, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about models and diagrams?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g4-science-u01::models and diagrams, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u01::models and diagrams, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about models and diagrams?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about models and diagrams; then identify one check that would catch an error or weak claim.**
...
**Q1.** Create a one-page evidence product for models and diagrams using only the supplied case and E1-E3: one claim, at least two cited rows, the reasoning link, one counterpoint, and one revision after checking the success criteria.

>

**Q2.** Communicate what the supplied record establishes about models and diagrams in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about models and diagrams against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using models and diagrams as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about models and diagrams? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about models and diagrams that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about models and diagrams. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about models and diagrams.
...
- Apply models and diagrams under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect models and diagrams to careful observations from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g4-science-u01-l09` · lesson `ma-g4-science-u01-l09` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
