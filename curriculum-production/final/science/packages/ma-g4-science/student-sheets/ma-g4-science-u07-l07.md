# Investigation or close reading: external structures

**Grade 4 Science** · Unit 7: Structures That Support Survival · Day 7 of the unit (course day 79) · about 40–55 minutes

**Today's focus:** external structures

**Unit question:** How can understanding structures that support survival help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Gather and analyze evidence related to external structures, then record a defensible interpretation.
- Use subject-appropriate evidence or representation to communicate understanding of external structures.
- Check, revise, or improve work about external structures using stated success criteria.
...
- Science brief: plants and animals have external structures, such as leaves, thorns, fur, claws, shells, and scales, that support survival, growth, behaviour, and reproduction.
- Science brief: a structure supports survival by doing something specific: protecting, capturing, moving, sensing, or attracting.
- Science brief: the same kind of structure can serve different functions in different organisms.

### Evidence check: external structures

**Candidate claim:** A case report presents this as acceptable science: “a structure exists because the organism wanted or needed it.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: plants and animals have external structures, such as leaves, thorns, fur, claws, shells, and scales, that support survival, growth, behaviour, and reproduction. |
| E2 | established science reference | Science brief: a structure supports survival by doing something specific: protecting, capturing, moving, sensing, or attracting. |
| E3 | established science reference | Science brief: the same kind of structure can serve different functions in different organisms. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u07::external structures, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.

**Supplied unit connections:** external structures; internal structures; structure and function; plant structures; animal structures; evidence-based arguments

**Supplied unit performance task:** Construct an evidence-based argument that specific internal and external structures support survival, growth, behavior, and reproduction.

### Bound task

**Question:** What does evidence E1 through E3 justify about external structures, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about external structures?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g4-science-u07::external structures, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u07::external structures, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about external structures?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about external structures; then identify one check that would catch an error or weak claim.**
...
**Q1.** Classify every supplied row E1-E3 as supports, challenges, or does not decide the candidate claim about external structures. Cite the row and explain each classification.

>

**Q2.** Communicate what the supplied record establishes about external structures in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about external structures against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using external structures as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about external structures? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about external structures that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about external structures. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about external structures.
...
- Apply external structures under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect external structures to internal structures from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Construct an evidence-based argument that specific internal and external structures support survival, growth, behavior, and reproduction. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-g4-science-u07-l07` · lesson `ma-g4-science-u07-l07` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
