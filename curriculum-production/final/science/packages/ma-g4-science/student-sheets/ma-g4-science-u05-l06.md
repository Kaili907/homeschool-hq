# Guided practice B: comparing communication solutions

**Grade 4 Science** · Unit 5: Waves and Information · Day 6 of the unit (course day 54) · about 40–55 minutes
...
- Practice comparing communication solutions with prompts, feedback, and gradually reduced support.
...
**Q1.** First compare E1 with E2 and write a provisional conclusion about comparing communication solutions. Then add the remaining rows through E3, revise the conclusion, and explain the change.
...
_Package `swp-ma-g4-science-u05-l06` · lesson `ma-g4-science-u05-l06` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
