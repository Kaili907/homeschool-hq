# Synthesis and review: plant structures

**Grade 4 Science** · Unit 7: Structures That Support Survival · Day 10 of the unit (course day 82) · about 40–55 minutes

**Today's focus:** plant structures
...
- Connect plant structures to the unit’s other ideas and select evidence that shows readiness for assessment.
- Use subject-appropriate evidence or representation to communicate understanding of plant structures.
- Check, revise, or improve work about plant structures using stated success criteria.
...
- Science brief: roots take in water and dissolved minerals; leaves are where the plant makes its food.
- Science brief: roots anchor the plant and take in water and dissolved minerals from the soil.
- Science brief: stems support the plant and carry water and food between roots and leaves.
- Science brief: leaves are where the plant makes its own food, using light.

### Evidence check: plant structures

**Candidate claim:** A case report presents this as acceptable science: “plants take in ready-made food from the soil.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: roots take in water and dissolved minerals; leaves are where the plant makes its food. |
| E2 | established science reference | Science brief: roots anchor the plant and take in water and dissolved minerals from the soil. |
| E3 | established science reference | Science brief: stems support the plant and carry water and food between roots and leaves. |
| E4 | established science reference | Science brief: leaves are where the plant makes its own food, using light. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u07::plant structures, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about plant structures, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about plant structures, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about plant structures; then identify one check that would catch an error or weak claim.**
...
**Q1.** The supplied unit connections are: external structures, internal structures, structure and function, plant structures, animal structures, evidence-based arguments. Choose one idea other than plant structures, connect it to one row in E1-E4, and explain one way treating the two ideas as identical would be misleading.

>

**Q2.** Communicate what the supplied record establishes about plant structures in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about plant structures against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using plant structures as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about plant structures? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about plant structures that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about plant structures. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about plant structures.
...
- Apply plant structures under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect plant structures to external structures from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g4-science-u07-l10` · lesson `ma-g4-science-u07-l10` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
