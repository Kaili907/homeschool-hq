# Concept model A: amplitude

**Grade 4 Science** · Unit 5: Waves and Information · Day 2 of the unit (course day 50) · about 40–55 minutes

**Today's focus:** amplitude
...
- Build a clear mental model of amplitude through an explicit worked example, demonstration, text, or phenomenon.
- Use subject-appropriate evidence or representation to communicate understanding of amplitude.
- Check, revise, or improve work about amplitude using stated success criteria.
...
- Science brief: amplitude is the height of a wave from its resting position, and a larger amplitude carries more energy.
- Science brief: amplitude is measured from the resting position to the crest, not from trough to crest.
- Science brief: a wave with larger amplitude carries more energy than an otherwise identical wave with smaller amplitude.
- Science brief: in sound, larger amplitude is heard as louder; in water, larger amplitude is a taller wave.

### Evidence check: amplitude

**Candidate claim:** A case report presents this as acceptable science: “confusing amplitude with wavelength.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: amplitude is the height of a wave from its resting position, and a larger amplitude carries more energy. |
| E2 | established science reference | Science brief: amplitude is measured from the resting position to the crest, not from trough to crest. |
| E3 | established science reference | Science brief: a wave with larger amplitude carries more energy than an otherwise identical wave with smaller amplitude. |
| E4 | established science reference | Science brief: in sound, larger amplitude is heard as louder; in water, larger amplitude is a taller wave. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u05::amplitude, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about amplitude, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about amplitude, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about amplitude; then identify one check that would catch an error or weak claim.**
...
**Q1.** Build a labelled model of amplitude that represents every supplied row in E1-E4. Annotate each model feature with its evidence ID, then show where the candidate claim fails or remains uncertain.

>

**Q2.** Communicate what the supplied record establishes about amplitude in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about amplitude against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using amplitude as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about amplitude? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about amplitude that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about amplitude. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about amplitude.
...
- Apply amplitude under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect amplitude to wave patterns from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g4-science-u05-l02` · lesson `ma-g4-science-u05-l02` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
