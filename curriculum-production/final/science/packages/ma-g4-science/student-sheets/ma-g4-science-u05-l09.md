# Performance task build: wavelength

**Grade 4 Science** · Unit 5: Waves and Information · Day 9 of the unit (course day 57) · about 40–55 minutes

**Today's focus:** wavelength
...
- Create, test, or revise a meaningful product that applies wavelength and the unit standards.
- Use subject-appropriate evidence or representation to communicate understanding of wavelength.
- Check, revise, or improve work about wavelength using stated success criteria.
...
- Science brief: wavelength is the distance from one point on a wave to the matching point on the next wave, such as crest to crest.
- Science brief: wavelength is the distance from a point on one wave to the matching point on the next.
- Science brief: wavelength and amplitude are independent: changing one does not force the other to change.
- Science brief: wavelength is a distance and is reported with a length unit.

### Evidence check: wavelength

**Candidate claim:** A case report presents this as acceptable science: “confusing wavelength with amplitude.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: wavelength is the distance from one point on a wave to the matching point on the next wave, such as crest to crest. |
| E2 | established science reference | Science brief: wavelength is the distance from a point on one wave to the matching point on the next. |
| E3 | established science reference | Science brief: wavelength and amplitude are independent: changing one does not force the other to change. |
| E4 | established science reference | Science brief: wavelength is a distance and is reported with a length unit. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u05::wavelength, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about wavelength, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about wavelength?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g4-science-u05::wavelength, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u05::wavelength, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about wavelength?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about wavelength; then identify one check that would catch an error or weak claim.**
...
**Q1.** Create a one-page evidence product for wavelength using only the supplied case and E1-E4: one claim, at least two cited rows, the reasoning link, one counterpoint, and one revision after checking the success criteria.

>

**Q2.** Communicate what the supplied record establishes about wavelength in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about wavelength against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using wavelength as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about wavelength? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about wavelength that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about wavelength. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about wavelength.
...
- Apply wavelength under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect wavelength to wave patterns from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g4-science-u05-l09` · lesson `ma-g4-science-u05-l09` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
