# Performance task build: weathering

**Grade 4 Science** · Unit 8: Earth's Changing Landscape · Day 9 of the unit (course day 93) · about 40–55 minutes

**Today's focus:** weathering

**Unit question:** How can understanding Earth's changing landscape help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Create, test, or revise a meaningful product that applies weathering and the unit standards.
- Use subject-appropriate evidence or representation to communicate understanding of weathering.
- Check, revise, or improve work about weathering using stated success criteria.
...
- Science brief: weathering breaks rock down in place; erosion moves the pieces away.
- Science brief: weathering breaks rock into smaller pieces where it sits, by water, ice, wind, temperature change, plants, and chemical action.
- Science brief: water freezing in a crack expands and widens the crack, which is why freeze-thaw is a powerful weathering process in Michigan.
- Science brief: weathering and erosion are different processes: weathering breaks material down, erosion carries it away.

### Evidence check: weathering

**Candidate claim:** A case report presents this as acceptable science: “using weathering and erosion as though they meant the same thing.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: weathering breaks rock down in place; erosion moves the pieces away. |
| E2 | established science reference | Science brief: weathering breaks rock into smaller pieces where it sits, by water, ice, wind, temperature change, plants, and chemical action. |
| E3 | established science reference | Science brief: water freezing in a crack expands and widens the crack, which is why freeze-thaw is a powerful weathering process in Michigan. |
| E4 | established science reference | Science brief: weathering and erosion are different processes: weathering breaks material down, erosion carries it away. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u08::weathering, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.

**Supplied unit connections:** rock layers; fossils in rock layers; weathering; rate of erosion; maps of Earth's features; Michigan's geological change

**Supplied unit performance task:** Use rock-layer and fossil patterns plus map data to explain landscape change over time, including possible explanations for Michigan's geological changes.

### Bound task

**Question:** What does evidence E1 through E4 justify about weathering, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about weathering?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g4-science-u08::weathering, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g4-science-u08::weathering, derived from the reviewed correctness source policy/correctness/ma-g4-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about weathering?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about weathering; then identify one check that would catch an error or weak claim.**
...
**Q1.** Create a one-page evidence product for weathering using only the supplied case and E1-E4: one claim, at least two cited rows, the reasoning link, one counterpoint, and one revision after checking the success criteria.

>

**Q2.** Communicate what the supplied record establishes about weathering in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about weathering against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using weathering as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about weathering? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about weathering that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about weathering. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about weathering.
...
- Apply weathering under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect weathering to rock layers from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Use rock-layer and fossil patterns plus map data to explain landscape change over time, including possible explanations for Michigan's geological changes. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-g4-science-u08-l09` · lesson `ma-g4-science-u08-l09` · built from `g34-committed` at `4c6ca4e`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
