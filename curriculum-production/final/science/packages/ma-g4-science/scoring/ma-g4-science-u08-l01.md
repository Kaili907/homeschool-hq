# Scoring authority — Launch and diagnostic: rock layers

**Grade 4 Science** · Unit 8: Earth's Changing Landscape · Day 1 · lesson `ma-g4-science-u08-l01`
...
_Topic `ma-g4-science-u08::rock layers` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._
...
**Q1 — activate prior.** _Serves objective 1:_ Activate prior knowledge about rock layers, surface initial thinking without penalty, and establish the unit question.
...
**Q4 — essential question.** _Serves objective 1:_ Activate prior knowledge about rock layers, surface initial thinking without penalty, and establish the unit question.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of rock layers.
...
**Q6 — limitation.** _Serves objective 1:_ Activate prior knowledge about rock layers, surface initial thinking without penalty, and establish the unit question.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of rock layers.
...
_Package `swp-ma-g4-science-u08-l01` · built from `g34-committed` at `4c6ca4e`._
