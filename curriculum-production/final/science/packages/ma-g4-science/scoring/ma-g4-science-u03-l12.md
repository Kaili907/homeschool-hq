# Scoring authority — Correction and reflection: tracing energy paths

**Grade 4 Science** · Unit 3: Energy Transfer · Day 12 · lesson `ma-g4-science-u03-l12`
...
_Topic `ma-g4-science-u03::tracing energy paths` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Energy can be traced from a source, through transfers, to where it ends up.
- At every step some energy is transferred to the surroundings, usually as warming, and that step belongs in the trace.
- A complete trace names the source, each transfer, and the final form.

**Also correct.** Accept any of these framings — do not require the wording above:

- An arrow diagram, a labelled sequence, or a written account are all valid ways to show the path.
...
- Showing energy appearing partway along the path with no source.
- Showing energy vanishing at the end of the path rather than being transferred to the surroundings.
- Claiming a device creates the energy it delivers.

**Grade boundary.** Quantitative energy accounting and named efficiency figures are later work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for tracing energy paths, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of tracing energy paths.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about tracing energy paths using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for tracing energy paths, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of tracing energy paths.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for tracing energy paths, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of tracing energy paths.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for tracing energy paths, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for tracing energy paths works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of tracing energy paths, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking tracing energy paths mastered.
- **requests an experiment** — Explain the science and the safety rule for tracing energy paths; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g4-science-u03-l12` · built from `g34-committed` at `4c6ca4e`._
