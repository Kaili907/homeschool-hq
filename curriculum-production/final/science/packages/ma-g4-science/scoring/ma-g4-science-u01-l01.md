...
**Grade 4 Science** · Unit 1: Science and Engineering Practices · Day 1 · lesson `ma-g4-science-u01-l01`
...
_Topic `ma-g4-science-u01::careful observations` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._
...
_Package `swp-ma-g4-science-u01-l01` · built from `g34-committed` at `4c6ca4e`._
