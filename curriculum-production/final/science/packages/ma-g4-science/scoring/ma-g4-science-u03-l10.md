# Scoring authority — Synthesis and review: electric currents

**Grade 4 Science** · Unit 3: Energy Transfer · Day 10 · lesson `ma-g4-science-u03-l10`
...
_Topic `ma-g4-science-u03::electric currents` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- An electric current needs a complete, unbroken loop from one terminal of the source back to the other.
...
- A current flows only in a complete circuit; a break anywhere stops it everywhere in that loop.
- A device in a circuit converts the energy delivered to it into another form, such as light, sound, motion, or warmth.

**Also correct.** Accept any of these framings — do not require the wording above:

- Describing the circuit as a loop, a path, or a closed circuit are all correct.
...
- Claiming a bulb lights with a wire on only one terminal of the battery.
- Claiming a battery stores current rather than storing energy.
- Claiming current is used up as it goes round the circuit so less returns to the battery.

**Grade boundary.** Voltage, resistance, series and parallel analysis, and Ohm's law are later work.


## What a complete response contains, question by question

**Q1 — connect unit.** _Serves objective 1:_ Connect electric currents to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of electric currents.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about electric currents using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Connect electric currents to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of electric currents.
...
**Q6 — limitation.** _Serves objective 1:_ Connect electric currents to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of electric currents.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for electric currents, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for electric currents works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of electric currents, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking electric currents mastered.
- **requests an experiment** — Explain the science and the safety rule for electric currents; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g4-science-u03-l10` · built from `g34-committed` at `4c6ca4e`._
