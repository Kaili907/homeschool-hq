# Scoring authority — Unit assessment: comparing solutions

**Grade 4 Science** · Unit 9: Capstone: Energy Resources and Michigan Hazards · Day 11 · lesson `ma-g4-science-u09-l11`
...
_Topic `ma-g4-science-u09::comparing solutions` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Solutions are compared against the same criteria and constraints, including cost, safety, and who is affected.
- A solution can be better on one criterion and worse on another, and the comparison says so.
- The comparison is based on tested evidence, not on preference.
...
- Naming a best solution with no criteria stated.
- Comparing solutions evaluated under different conditions.
- Leaving out a criterion the preferred solution fails.
...
**Q1 — demonstrate mastery.** _Serves objective 1:_ Demonstrate current mastery of comparing solutions through selected-response, constructed-response, and applied evidence.
...
**Q4 — essential question.** _Serves objective 1:_ Demonstrate current mastery of comparing solutions through selected-response, constructed-response, and applied evidence.
...
**Q6 — limitation.** _Serves objective 1:_ Demonstrate current mastery of comparing solutions through selected-response, constructed-response, and applied evidence.
...
_Package `swp-ma-g4-science-u09-l11` · built from `g34-committed` at `4c6ca4e`._
