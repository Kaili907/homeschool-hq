# Scoring authority — Reteach and varied practice: light energy

**Grade 4 Science** · Unit 3: Energy Transfer · Day 8 · lesson `ma-g4-science-u03-l08`
...
_Topic `ma-g4-science-u03::light energy` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Light travels from a source, and it travels in straight lines until something changes its path.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Light carries energy away from a source such as the Sun, a flame, or a lamp.
- Light travels in straight lines until it is reflected, absorbed, or bent by a material.
- Light that is absorbed by a material transfers energy to it, which is why dark surfaces in sunlight warm up.

**Also correct.** Accept any of these framings — do not require the wording above:

- Describing light as rays or as beams are both acceptable representations at this grade.
...
- Claiming light comes out of the eye to make objects visible.
- Claiming light bends around ordinary opaque objects so you can see behind them.
- Claiming a mirror creates light rather than reflecting it.

**Grade boundary.** The wave and particle models of light, the speed of light, and the electromagnetic spectrum are later work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for light energy, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of light energy.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about light energy using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for light energy, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of light energy.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for light energy, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of light energy.
...
- The learner completes the central task about light energy.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for light energy, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for light energy works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of light energy, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking light energy mastered.
- **requests an experiment** — Explain the science and the safety rule for light energy; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g4-science-u03-l08` · built from `g34-committed` at `4c6ca4e`._
