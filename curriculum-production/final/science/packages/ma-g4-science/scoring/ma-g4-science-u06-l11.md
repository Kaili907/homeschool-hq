# Scoring authority — Unit assessment: the brain and response

**Grade 4 Science** · Unit 6: Light, Vision, and the Senses · Day 11 · lesson `ma-g4-science-u06-l11`
...
_Topic `ma-g4-science-u06::the brain and response` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Information from the senses is processed in the brain, which is what leads to a response.
- A response can be immediate action, or storing the information as memory for later.
- Different animals respond differently to the same information, because their bodies and behaviours differ.
...
- Claiming the response happens in the sense organ with no processing.
- Claiming memory is stored in the sense organ.
- Claiming every animal must respond identically to the same input.

**Grade boundary.** Named brain regions, reflex arcs, and neurotransmission are later work.


## What a complete response contains, question by question

**Q1 — demonstrate mastery.** _Serves objective 1:_ Demonstrate current mastery of the brain and response through selected-response, constructed-response, and applied evidence.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of the brain and response.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about the brain and response using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Demonstrate current mastery of the brain and response through selected-response, constructed-response, and applied evidence.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of the brain and response.
...
**Q6 — limitation.** _Serves objective 1:_ Demonstrate current mastery of the brain and response through selected-response, constructed-response, and applied evidence.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of the brain and response.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for the brain and response, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for the brain and response works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of the brain and response, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking the brain and response mastered.
- **requests an experiment** — Explain the science and the safety rule for the brain and response; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g4-science-u06-l11` · built from `g34-committed` at `4c6ca4e`._
