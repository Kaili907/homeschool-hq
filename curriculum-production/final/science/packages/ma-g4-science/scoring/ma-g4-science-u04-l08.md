# Scoring authority — Reteach and varied practice: design criteria

**Grade 4 Science** · Unit 4: Designing an Energy Converter · Day 8 · lesson `ma-g4-science-u04-l08`
...
_Topic `ma-g4-science-u04::design criteria` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Design criteria state what the converter has to achieve, in terms that can actually be checked.
- A criterion that cannot be tested cannot be used to judge the design.
- Safety limits are constraints, and they are not traded away for better performance.
...
- Writing a criterion so vague that no test could settle whether it was met.
- Treating a safety limit as negotiable.
- Judging the design against criteria written after the test.

**Grade boundary.** Formal requirements specification and engineering standards are later work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for design criteria, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of design criteria.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about design criteria using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for design criteria, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of design criteria.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for design criteria, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of design criteria.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for design criteria, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for design criteria works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of design criteria, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking design criteria mastered.
- **requests an experiment** — Explain the science and the safety rule for design criteria; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g4-science-u04-l08` · built from `g34-committed` at `4c6ca4e`._
