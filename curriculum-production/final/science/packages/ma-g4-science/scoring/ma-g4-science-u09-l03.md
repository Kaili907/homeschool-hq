# Scoring authority — Guided practice A: natural Earth processes

**Grade 4 Science** · Unit 9: Capstone: Energy Resources and Michigan Hazards · Day 3 · lesson `ma-g4-science-u09-l03`
...
_Topic `ma-g4-science-u09::natural Earth processes` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._
...
**Q1 — guided practice.** _Serves objective 1:_ Practice natural Earth processes with prompts, feedback, and gradually reduced support.
...
**Q4 — essential question.** _Serves objective 1:_ Practice natural Earth processes with prompts, feedback, and gradually reduced support.
...
**Q6 — limitation.** _Serves objective 1:_ Practice natural Earth processes with prompts, feedback, and gradually reduced support.
...
_Package `swp-ma-g4-science-u09-l03` · built from `g34-committed` at `4c6ca4e`._
