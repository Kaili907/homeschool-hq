# Scoring authority — Concept model B: comparing solutions

**Grade 4 Science** · Unit 9: Capstone: Energy Resources and Michigan Hazards · Day 5 · lesson `ma-g4-science-u09-l05`
...
**Q1 — model build.** _Serves objective 1:_ Build a clear mental model of comparing solutions through an explicit worked example, demonstration, text, or phenomenon.
...
**Q4 — essential question.** _Serves objective 1:_ Build a clear mental model of comparing solutions through an explicit worked example, demonstration, text, or phenomenon.
...
**Q6 — limitation.** _Serves objective 1:_ Build a clear mental model of comparing solutions through an explicit worked example, demonstration, text, or phenomenon.
...
_Package `swp-ma-g4-science-u09-l05` · built from `g34-committed` at `4c6ca4e`._
