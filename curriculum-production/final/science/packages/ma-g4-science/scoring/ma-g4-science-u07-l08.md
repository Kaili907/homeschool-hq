# Scoring authority — Reteach and varied practice: internal structures

**Grade 4 Science** · Unit 7: Structures That Support Survival · Day 8 · lesson `ma-g4-science-u07-l08`
...
_Topic `ma-g4-science-u07::internal structures` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Internal structures such as bones, hearts, lungs, stomachs, roots, and stems support survival, growth, behaviour, and reproduction.
- Internal and external structures work together; neither functions alone.
- An internal structure's function can be inferred from where it is and what it connects to, and then checked against evidence.
...
- Claiming internal structures matter only to animals and not to plants.
- Claiming a structure has a function without any evidence for it.
- Claiming internal structures work independently of the rest of the organism.

**Grade boundary.** Cells, tissues, and organ systems as a hierarchy are Grade 7 and High School work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for internal structures, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of internal structures.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about internal structures using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for internal structures, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of internal structures.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for internal structures, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of internal structures.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for internal structures, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for internal structures works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of internal structures, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking internal structures mastered.
- **requests an experiment** — Explain the science and the safety rule for internal structures; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g4-science-u07-l08` · built from `g34-committed` at `4c6ca4e`._
