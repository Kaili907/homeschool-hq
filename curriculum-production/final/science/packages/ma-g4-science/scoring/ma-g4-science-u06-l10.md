# Scoring authority — Synthesis and review: senses and information

**Grade 4 Science** · Unit 6: Light, Vision, and the Senses · Day 10 · lesson `ma-g4-science-u06-l10`
...
_Topic `ma-g4-science-u06::senses and information` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Animals take in information about their surroundings through sense receptors: eyes, ears, skin, nose, and tongue.
- Each kind of receptor responds to a particular kind of input, such as light, sound, pressure, or chemicals.
- The information is sent from the receptor to the brain as signals.

**Also correct.** Accept any of these framings — do not require the wording above:

- Naming the sense organ or the kind of input it responds to are both acceptable ways to answer here.
...
- Claiming one receptor responds equally to every kind of input.
- Claiming the sense organ decides what to do without the brain.
- Claiming an animal responds to information it has no receptor for.

**Grade boundary.** Neurons, synapses, and signal transduction are Grade 7 and High School work.


## What a complete response contains, question by question

**Q1 — connect unit.** _Serves objective 1:_ Connect senses and information to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of senses and information.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about senses and information using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Connect senses and information to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of senses and information.
...
**Q6 — limitation.** _Serves objective 1:_ Connect senses and information to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of senses and information.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for senses and information, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for senses and information works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of senses and information, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking senses and information mastered.
- **requests an experiment** — Explain the science and the safety rule for senses and information; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g4-science-u06-l10` · built from `g34-committed` at `4c6ca4e`._
