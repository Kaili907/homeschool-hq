# Scoring authority — Unit assessment: patterns that carry information

**Grade 4 Science** · Unit 5: Waves and Information · Day 11 · lesson `ma-g4-science-u05-l11`
...
_Topic `ma-g4-science-u05::patterns that carry information` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Patterns can be used to send information: a code of light flashes, sounds, or marks stands for something the sender and receiver agree on.
- Information is carried by the pattern, not by the material; the same message can be sent as light, sound, or writing.
- A receiver can only recover the message if it knows the code the sender used.

**Also correct.** Accept any of these framings — do not require the wording above:

- Morse code, flag signals, drumbeats, and binary patterns are all correct examples.
...
- Claiming a pattern carries meaning on its own, without an agreed code.
- Claiming a message cannot be converted from one carrier to another.

**Grade boundary.** Digital versus analog encoding, bandwidth, and error correction are Grade 8 and High School work.


## What a complete response contains, question by question

**Q1 — demonstrate mastery.** _Serves objective 1:_ Demonstrate current mastery of patterns that carry information through selected-response, constructed-response, and applied evidence.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of patterns that carry information.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about patterns that carry information using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Demonstrate current mastery of patterns that carry information through selected-response, constructed-response, and applied evidence.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of patterns that carry information.
...
**Q6 — limitation.** _Serves objective 1:_ Demonstrate current mastery of patterns that carry information through selected-response, constructed-response, and applied evidence.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of patterns that carry information.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for patterns that carry information, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for patterns that carry information works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of patterns that carry information, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking patterns that carry information mastered.
- **requests an experiment** — Explain the science and the safety rule for patterns that carry information; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g4-science-u05-l11` · built from `g34-committed` at `4c6ca4e`._
