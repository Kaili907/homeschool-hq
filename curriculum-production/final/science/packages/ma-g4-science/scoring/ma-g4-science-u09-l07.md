# Scoring authority — Investigation or close reading: energy from natural resources

**Grade 4 Science** · Unit 9: Capstone: Energy Resources and Michigan Hazards · Day 7 · lesson `ma-g4-science-u09-l07`
...
_Topic `ma-g4-science-u09::energy from natural resources` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Renewable resources are replenished on a human timescale; fossil fuels are not.

**Accepted relationships and models.** What this lesson's learning target asserts:

- The energy people use comes from natural resources: sunlight, wind, moving water, biomass, fossil fuels, and nuclear fuels.
- Renewable resources are replaced on a human timescale; fossil fuels form over many millions of years and are not.
- Every energy resource has to be found, extracted or captured, converted, and delivered, and each of those steps has costs and effects.
...
- Claiming any energy resource has no environmental effect at all.
- Claiming fossil fuels are renewable because they are still forming.
- Claiming energy is created at a power plant rather than converted there.

**Grade boundary.** Quantitative energy budgets, capacity factors, and life-cycle analysis are later work.
...
**Q1 — analyze evidence.** _Serves objective 1:_ Gather and analyze evidence related to energy from natural resources, then record a defensible interpretation.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of energy from natural resources.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about energy from natural resources using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Gather and analyze evidence related to energy from natural resources, then record a defensible interpretation.
...
**Q5 — evidence quality.** _Serves objective 1:_ Gather and analyze evidence related to energy from natural resources, then record a defensible interpretation.
...
**Q6 — limitation.** _Serves objective 1:_ Gather and analyze evidence related to energy from natural resources, then record a defensible interpretation.
...
**Q7 — provenance.** _Serves objective 1:_ Gather and analyze evidence related to energy from natural resources, then record a defensible interpretation.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for energy from natural resources, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for energy from natural resources works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of energy from natural resources, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking energy from natural resources mastered.
- **requests an experiment** — Explain the science and the safety rule for energy from natural resources; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g4-science-u09-l07` · built from `g34-committed` at `4c6ca4e`._
