# Scoring authority — Performance task build: generating solutions

**Grade 4 Science** · Unit 4: Designing an Energy Converter · Day 9 · lesson `ma-g4-science-u04-l09`
...
_Topic `ma-g4-science-u04::generating solutions` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- More than one design can meet the same criteria, and generating several before choosing gives a better chance of a good one.
- Comparing alternatives is only meaningful when they are judged against the same criteria.
- An idea that fails a constraint is eliminated at this stage, not tested and then rejected.
...
- Committing to the first idea and calling the comparison done.
- Comparing two designs against different criteria.
- Keeping a design that breaks a stated constraint because it performs well otherwise.

**Grade boundary.** Structured ideation methods and decision matrices are later work.
...
**Q1 — build product.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies generating solutions and the unit standards.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of generating solutions.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about generating solutions using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies generating solutions and the unit standards.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of generating solutions.
...
**Q6 — limitation.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies generating solutions and the unit standards.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of generating solutions.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for generating solutions, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for generating solutions works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of generating solutions, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking generating solutions mastered.
- **requests an experiment** — Explain the science and the safety rule for generating solutions; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g4-science-u04-l09` · built from `g34-committed` at `4c6ca4e`._
