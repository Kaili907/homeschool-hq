# Scoring authority — Correction and reflection: evidence-based arguments

**Grade 4 Science** · Unit 7: Structures That Support Survival · Day 12 · lesson `ma-g4-science-u07-l12`
...
_Topic `ma-g4-science-u07::evidence-based arguments` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- An argument about structure and function states a claim, cites observed evidence, and explains how the evidence supports the claim.
- Evidence for a function comes from observing the structure being used, or from its position, shape, and connections.
- An argument covers only what the evidence reaches, and says where it stops.
...
- Asserting a function with no evidence and no reasoning.
- Using evidence about one organism to make a claim about all organisms.
- Treating a plausible story as evidence.

**Grade boundary.** Counter-argument structure and formal rebuttal are later work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for evidence-based arguments, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of evidence-based arguments.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about evidence-based arguments using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for evidence-based arguments, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of evidence-based arguments.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for evidence-based arguments, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of evidence-based arguments.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for evidence-based arguments, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for evidence-based arguments works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of evidence-based arguments, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking evidence-based arguments mastered.
- **requests an experiment** — Explain the science and the safety rule for evidence-based arguments; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g4-science-u07-l12` · built from `g34-committed` at `4c6ca4e`._
