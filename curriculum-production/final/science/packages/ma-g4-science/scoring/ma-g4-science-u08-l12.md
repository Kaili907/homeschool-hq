# Scoring authority — Correction and reflection: Michigan's geological change

**Grade 4 Science** · Unit 8: Earth's Changing Landscape · Day 12 · lesson `ma-g4-science-u08-l12`
...
_Topic `ma-g4-science-u08::Michigan's geological change` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- The Great Lakes basins were shaped by continental glaciers during the most recent ice age.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Michigan's landscape was shaped by continental ice sheets that advanced and retreated repeatedly, carving basins and leaving behind sand, gravel, and boulders.
- Much of Michigan's bedrock is sedimentary rock formed in ancient shallow seas, which is why marine fossils such as corals are found there.
- Michigan's shorelines and dunes are still being changed today by waves, currents, wind, and ice.

**Also correct.** Accept any of these framings — do not require the wording above:

- Saying glaciers, ice sheets, or continental ice all correctly name the agent that shaped the Great Lakes basins.
...
- Claiming the Great Lakes were formed by volcanic eruptions or by meteorite impact.
- Claiming Michigan's landscape has not changed since the ice retreated.
- Claiming fossil corals in Michigan rock mean corals live there in the lakes now.

**Grade boundary.** Glacial stratigraphy, isostatic rebound, and the Michigan Basin's formation history are later work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for Michigan's geological change, then demonstrate corrected understanding.

A complete response diagnoses what the error assumed and why the assumption looked reasonable, then shows a different representation or strategy that makes that error structurally impossible rather than merely avoided once. Correcting the answer without naming the assumption is incomplete.

**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of Michigan's geological change.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about Michigan's geological change using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for Michigan's geological change, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of Michigan's geological change.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for Michigan's geological change, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of Michigan's geological change.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for Michigan's geological change, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for Michigan's geological change works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of Michigan's geological change, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking Michigan's geological change mastered.
- **requests an experiment** — Explain the science and the safety rule for Michigan's geological change; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g4-science-u08-l12` · built from `g34-committed` at `4c6ca4e`._
