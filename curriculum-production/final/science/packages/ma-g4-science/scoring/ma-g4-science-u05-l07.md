# Scoring authority — Investigation or close reading: wave patterns

**Grade 4 Science** · Unit 5: Waves and Information · Day 7 · lesson `ma-g4-science-u05-l07`
...
_Topic `ma-g4-science-u05::wave patterns` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- A wave transfers energy from place to place without transporting the material it travels through.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Waves are regular repeating patterns of motion that transfer energy from one place to another.
- The material a wave travels through moves back and forth about its resting position; it is not carried along with the wave.
- Waves can be described by their amplitude and their wavelength.

**Also correct.** Accept any of these framings — do not require the wording above:

- Describing a wave by a diagram, by a demonstration with a rope or spring, or in words are all acceptable.
...
- Claiming a wave carries the water or the rope along with it.
- Claiming a wave transfers matter rather than energy.
- Claiming a single pulse with no repetition shows a wavelength.

**Grade boundary.** The frequency-wavelength-speed relationship, and wave equations, are Grade 8 and High School work.
...
**Q1 — analyze evidence.** _Serves objective 1:_ Gather and analyze evidence related to wave patterns, then record a defensible interpretation.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of wave patterns.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about wave patterns using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Gather and analyze evidence related to wave patterns, then record a defensible interpretation.
...
**Q5 — evidence quality.** _Serves objective 1:_ Gather and analyze evidence related to wave patterns, then record a defensible interpretation.
...
**Q6 — limitation.** _Serves objective 1:_ Gather and analyze evidence related to wave patterns, then record a defensible interpretation.
...
**Q7 — provenance.** _Serves objective 1:_ Gather and analyze evidence related to wave patterns, then record a defensible interpretation.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for wave patterns, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for wave patterns works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of wave patterns, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking wave patterns mastered.
- **requests an experiment** — Explain the science and the safety rule for wave patterns; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g4-science-u05-l07` · built from `g34-committed` at `4c6ca4e`._
