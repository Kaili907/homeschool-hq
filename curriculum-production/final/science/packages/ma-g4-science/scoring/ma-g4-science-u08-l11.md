# Scoring authority — Unit assessment: maps of Earth's features

**Grade 4 Science** · Unit 8: Earth's Changing Landscape · Day 11 · lesson `ma-g4-science-u08-l11`
...
_Topic `ma-g4-science-u08::maps of Earth's features` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Maps show where Earth's features are, and patterns in those locations are evidence about the processes that made them.
- A map needs a key and a scale, or its symbols and distances cannot be read.
- Features such as mountains, volcanoes, and earthquakes are not spread evenly over Earth; they cluster in patterns.

**Also correct.** Accept any of these framings — do not require the wording above:

- Topographic maps, relief maps, and thematic maps are all legitimate map types here.
...
- Reading distances off a map with no scale.
- Claiming Earth's major features are spread evenly across the surface.
- Treating a map symbol as the feature itself rather than as a representation of it.

**Grade boundary.** Plate tectonics as the explanation for the patterns is Grade 8 and High School work.


## What a complete response contains, question by question

**Q1 — demonstrate mastery.** _Serves objective 1:_ Demonstrate current mastery of maps of Earth's features through selected-response, constructed-response, and applied evidence.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of maps of Earth's features.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about maps of Earth's features using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Demonstrate current mastery of maps of Earth's features through selected-response, constructed-response, and applied evidence.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of maps of Earth's features.
...
**Q6 — limitation.** _Serves objective 1:_ Demonstrate current mastery of maps of Earth's features through selected-response, constructed-response, and applied evidence.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of maps of Earth's features.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for maps of Earth's features, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for maps of Earth's features works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of maps of Earth's features, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking maps of Earth's features mastered.
- **requests an experiment** — Explain the science and the safety rule for maps of Earth's features; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g4-science-u08-l11` · built from `g34-committed` at `4c6ca4e`._
