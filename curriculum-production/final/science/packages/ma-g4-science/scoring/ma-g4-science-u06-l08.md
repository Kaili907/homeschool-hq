# Scoring authority — Reteach and varied practice: how we see

**Grade 4 Science** · Unit 6: Light, Vision, and the Senses · Day 8 · lesson `ma-g4-science-u06-l08`
...
_Topic `ma-g4-science-u06::how we see` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Seeing requires light travelling from a source, reflecting off the object, and entering the eye.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Light from a source reflects off an object, enters the eye, and is detected there.
- The eye detects the light; the brain interprets the signal as an image.
- Without light entering the eye, nothing is seen, however close or large the object is.
...
- Claiming vision works by the eye reaching out to the object.
- Claiming an object is visible in a completely dark room once the eyes adjust.
- Claiming the eye forms the perception without the brain.

**Grade boundary.** Lens optics, the retina and its cell types, and colour vision mechanisms are later work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for how we see, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of how we see.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about how we see using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for how we see, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of how we see.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for how we see, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of how we see.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for how we see, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for how we see works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of how we see, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking how we see mastered.
- **requests an experiment** — Explain the science and the safety rule for how we see; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g4-science-u06-l08` · built from `g34-committed` at `4c6ca4e`._
