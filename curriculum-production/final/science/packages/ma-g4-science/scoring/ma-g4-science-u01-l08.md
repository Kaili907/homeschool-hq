...
**Grade 4 Science** · Unit 1: Science and Engineering Practices · Day 8 · lesson `ma-g4-science-u01-l08`
...
_Topic `ma-g4-science-u01::testable questions` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A testable question can be answered by making observations or by doing something and seeing what happens.
- A testable question names what will be changed or examined and what will be observed or measured.
- A question that no possible observation could settle is not testable, however interesting it is.

**Also correct.** Accept any of these framings — do not require the wording above:

- Comparison questions, cause questions, and 'what happens if' questions are all testable forms.
...
- Calling a question testable when no observation could answer it.
- Claiming a question has to start with 'why' to count as scientific.
- Confusing a question that is looked up in a source with one the learner tested.

**Grade boundary.** Naming independent and dependent variables formally, and writing hypotheses in if-then form, are later work.
...
_Package `swp-ma-g4-science-u01-l08` · built from `g34-committed` at `4c6ca4e`._
