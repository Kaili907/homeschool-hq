# Scoring authority — Investigation or close reading: external structures

**Grade 4 Science** · Unit 7: Structures That Support Survival · Day 7 · lesson `ma-g4-science-u07-l07`
...
_Topic `ma-g4-science-u07::external structures` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Plants and animals have external structures, such as leaves, thorns, fur, claws, shells, and scales, that support survival, growth, behaviour, and reproduction.
- A structure supports survival by doing something specific: protecting, capturing, moving, sensing, or attracting.
- The same kind of structure can serve different functions in different organisms.
...
- Claiming a structure exists because the organism wanted or needed it.
- Naming a structure without saying what it does for the organism.
- Claiming every external structure has exactly one function.

**Grade boundary.** Evolutionary explanation of how structures arose is Grade 8 and High School work.
...
**Q1 — analyze evidence.** _Serves objective 1:_ Gather and analyze evidence related to external structures, then record a defensible interpretation.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of external structures.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about external structures using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Gather and analyze evidence related to external structures, then record a defensible interpretation.
...
**Q5 — evidence quality.** _Serves objective 1:_ Gather and analyze evidence related to external structures, then record a defensible interpretation.
...
**Q6 — limitation.** _Serves objective 1:_ Gather and analyze evidence related to external structures, then record a defensible interpretation.
...
**Q7 — provenance.** _Serves objective 1:_ Gather and analyze evidence related to external structures, then record a defensible interpretation.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for external structures, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for external structures works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of external structures, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking external structures mastered.
- **requests an experiment** — Explain the science and the safety rule for external structures; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g4-science-u07-l07` · built from `g34-committed` at `4c6ca4e`._
