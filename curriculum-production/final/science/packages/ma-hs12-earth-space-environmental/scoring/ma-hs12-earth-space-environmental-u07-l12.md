# Scoring authority — Correction and reflection: evidence-based forecasting

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 7: Climate, Energy Flow, and the Carbon Cycle · Day 12 · lesson `ma-hs12-earth-space-environmental-u07-l12`
...
_Topic `ma-hs12-earth-space-environmental-u07::evidence-based forecasting` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs12-earth-space-environmental.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A forecast states what is projected, under what assumptions, over what period, and with what uncertainty.
- A forecast is evaluated over many predictions against what actually occurred, not by a single instance.
- Distinguishing a projection conditional on a scenario from an unconditional prediction is essential to evaluating either.
...
- Judging a probabilistic forecast wrong on the basis of one outcome.
- Presenting a scenario-conditional projection as an unconditional prediction.
- Reporting a forecast with no stated period, assumptions, or uncertainty.

**Grade boundary.** Forecast verification statistics and skill scores are beyond this course.
...
**Q1 — explain with evidence.** _Serves objective 1:_ Explain evidence-based forecasting using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q2 — apply new task.** _Serves objective 2:_ Apply evidence-based forecasting to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q3 — check revise next step.** _Serves objective 3:_ Check and revise the work on evidence-based forecasting against the stated success criteria and name the next step.
...
**Q4 — essential question.** _Serves objective 2:_ Apply evidence-based forecasting to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q5 — evidence quality.** _Serves objective 1:_ Explain evidence-based forecasting using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q6 — limitation.** _Serves objective 2:_ Apply evidence-based forecasting to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q7 — provenance.** _Serves objective 1:_ Explain evidence-based forecasting using evidence, a model, or a documented process rather than an unsupported answer.
...
- **prerequisite-gap** — Run the prerequisite reteach route for evidence-based forecasting (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for evidence-based forecasting (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for evidence-based forecasting (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for evidence-based forecasting (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for evidence-based forecasting (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs12-earth-space-environmental-u07-l12` · built from `hs912-science-h4` at `a86780a`._
