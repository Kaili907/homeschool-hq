# Scoring authority — Launch and diagnostic: the Great Oxidation Event and atmospheric change

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 8: Coevolution of Earth and Life, Resources, and Natural Hazards · Day 1 · lesson `ma-hs12-earth-space-environmental-u08-l01`
...
- Named data-source resource: `res-ma-hs12-earth-space-environmental-data-sources` (scope: course).
...
**Q1 — phenomenon question.** _Serves objective 1:_ Observe the anchoring phenomenon, surface initial thinking about the Great Oxidation Event and atmospheric change without penalty, and pose a testable question.
...
**Q7 — limitation.** _Serves objective 3:_ Apply the Great Oxidation Event and atmospheric change to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q8 — provenance.** _Serves objective 1:_ Observe the anchoring phenomenon, surface initial thinking about the Great Oxidation Event and atmospheric change without penalty, and pose a testable question.
...
_Package `swp-ma-hs12-earth-space-environmental-u08-l01` · built from `hs912-science-h4` at `a86780a`._
