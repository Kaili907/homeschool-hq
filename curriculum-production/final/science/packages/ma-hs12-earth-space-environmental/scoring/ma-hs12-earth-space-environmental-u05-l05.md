# Scoring authority — Concept model B: radiometric dating and Earth's age

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 5: Plate Tectonics and the History of Earth · Day 5 · lesson `ma-hs12-earth-space-environmental-u05-l05`
...
**Q1 — explain with evidence.** _Serves objective 1:_ Explain radiometric dating and Earth's age using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q2 — apply new task.** _Serves objective 2:_ Apply radiometric dating and Earth's age to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q3 — check revise next step.** _Serves objective 3:_ Check and revise the work on radiometric dating and Earth's age against the stated success criteria and name the next step.
...
**Q4 — essential question.** _Serves objective 2:_ Apply radiometric dating and Earth's age to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q5 — evidence quality.** _Serves objective 1:_ Explain radiometric dating and Earth's age using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q6 — limitation.** _Serves objective 2:_ Apply radiometric dating and Earth's age to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q7 — provenance.** _Serves objective 1:_ Explain radiometric dating and Earth's age using evidence, a model, or a documented process rather than an unsupported answer.
...
_Package `swp-ma-hs12-earth-space-environmental-u05-l05` · built from `hs912-science-h4` at `a86780a`._
