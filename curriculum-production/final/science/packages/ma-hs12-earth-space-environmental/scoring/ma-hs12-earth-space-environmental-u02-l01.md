# Scoring authority — Launch and diagnostic: nuclear fusion in stellar cores

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 2: The Sun, Stars, and the Origin of the Elements · Day 1 · lesson `ma-hs12-earth-space-environmental-u02-l01`
...
**Q1 — phenomenon question.** _Serves objective 1:_ Observe the anchoring phenomenon, surface initial thinking about nuclear fusion in stellar cores without penalty, and pose a testable question.
...
**Q7 — limitation.** _Serves objective 3:_ Apply nuclear fusion in stellar cores to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q8 — provenance.** _Serves objective 1:_ Observe the anchoring phenomenon, surface initial thinking about nuclear fusion in stellar cores without penalty, and pose a testable question.
...
_Package `swp-ma-hs12-earth-space-environmental-u02-l01` · built from `hs912-science-h4` at `a86780a`._
