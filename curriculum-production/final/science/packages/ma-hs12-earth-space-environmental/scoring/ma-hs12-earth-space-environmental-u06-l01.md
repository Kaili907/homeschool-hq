# Scoring authority — Launch and diagnostic: weathering and erosion

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 6: Surface Processes, Water, and Earth System Feedbacks · Day 1 · lesson `ma-hs12-earth-space-environmental-u06-l01`
...
_Topic `ma-hs12-earth-space-environmental-u06::weathering and erosion` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs12-earth-space-environmental.correctness.json`._
...
**Q1 — phenomenon question.** _Serves objective 1:_ Observe the anchoring phenomenon, surface initial thinking about weathering and erosion without penalty, and pose a testable question.
...
**Q7 — limitation.** _Serves objective 3:_ Apply weathering and erosion to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q8 — provenance.** _Serves objective 1:_ Observe the anchoring phenomenon, surface initial thinking about weathering and erosion without penalty, and pose a testable question.
...
_Package `swp-ma-hs12-earth-space-environmental-u06-l01` · built from `hs912-science-h4` at `a86780a`._
