...
**Disposal and clearing up:** Dataset and model files stay on the adult's device; nothing is uploaded and no account is created. File or recycle printed output. Nothing hazardous is produced.
...
_Package `swp-ma-hs12-earth-space-environmental-u09-l07` · built from `hs912-science-h4` at `a86780a`._
