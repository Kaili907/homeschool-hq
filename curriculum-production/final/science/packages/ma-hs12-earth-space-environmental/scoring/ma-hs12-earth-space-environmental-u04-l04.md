# Scoring authority — Independent application A: elliptical orbits and orbital energy

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 4: Orbital Motion and the Solar System · Day 4 · lesson `ma-hs12-earth-space-environmental-u04-l04`
...
_Topic `ma-hs12-earth-space-environmental-u04::elliptical orbits and orbital energy` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs12-earth-space-environmental.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- In an elliptical orbit, kinetic and gravitational potential energy exchange while the total remains constant in the absence of other forces.

**Accepted relationships and models.** What this lesson's learning target asserts:

- A body speeds up as it approaches the central body, converting potential energy into kinetic, and slows as it recedes.
- Total orbital energy is conserved for an isolated two-body system, so an orbit does not decay without an external influence such as atmospheric drag.
- Most planetary orbits in the solar system are close to circular; textbook diagrams exaggerate their ellipticity.
...
- Claiming Earth's orbit is strongly elliptical, and using that to explain the seasons.
- Claiming an orbiting body loses energy continuously in the absence of drag or another external force.
- Claiming kinetic energy is greatest at the point farthest from the central body.

**Grade boundary.** Vis-viva equation and orbital element formalism are beyond this course.
...
**Q1 — explain with evidence.** _Serves objective 1:_ Explain elliptical orbits and orbital energy using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q2 — apply new task.** _Serves objective 2:_ Apply elliptical orbits and orbital energy to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q3 — check revise next step.** _Serves objective 3:_ Check and revise the work on elliptical orbits and orbital energy against the stated success criteria and name the next step.
...
**Q4 — essential question.** _Serves objective 2:_ Apply elliptical orbits and orbital energy to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q5 — evidence quality.** _Serves objective 1:_ Explain elliptical orbits and orbital energy using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q6 — limitation.** _Serves objective 2:_ Apply elliptical orbits and orbital energy to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q7 — provenance.** _Serves objective 1:_ Explain elliptical orbits and orbital energy using evidence, a model, or a documented process rather than an unsupported answer.
...
- **prerequisite-gap** — Run the prerequisite reteach route for elliptical orbits and orbital energy (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for elliptical orbits and orbital energy (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for elliptical orbits and orbital energy (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for elliptical orbits and orbital energy (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for elliptical orbits and orbital energy (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs12-earth-space-environmental-u04-l04` · built from `hs912-science-h4` at `a86780a`._
