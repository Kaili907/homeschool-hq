# Scoring authority — Reteach and varied practice: coevolution of the geosphere and biosphere

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 8: Coevolution of Earth and Life, Resources, and Natural Hazards · Day 8 · lesson `ma-hs12-earth-space-environmental-u08-l08`
...
_Topic `ma-hs12-earth-space-environmental-u08::coevolution of the geosphere and biosphere` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs12-earth-space-environmental.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Life has altered Earth's atmosphere, oceans, soils, and rocks, and those changes have in turn shaped the evolution of life.
- Many rock types, including limestone, coal, and banded iron formations, exist because of biological activity.
- The influence runs in both directions, which is why the systems are described as coevolving rather than one acting on the other.
...
- Claiming life adapted to Earth's conditions without altering them.
- Claiming Earth's physical systems developed independently of the biosphere.
- Claiming biologically produced rocks are chemically indistinguishable in origin from purely inorganic ones.

**Grade boundary.** Earth system modelling of coevolution is beyond this course.
...
**Q1 — explain with evidence.** _Serves objective 1:_ Explain coevolution of the geosphere and biosphere using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q2 — apply new task.** _Serves objective 2:_ Apply coevolution of the geosphere and biosphere to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q3 — check revise next step.** _Serves objective 3:_ Check and revise the work on coevolution of the geosphere and biosphere against the stated success criteria and name the next step.
...
**Q4 — essential question.** _Serves objective 2:_ Apply coevolution of the geosphere and biosphere to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q5 — evidence quality.** _Serves objective 1:_ Explain coevolution of the geosphere and biosphere using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q6 — limitation.** _Serves objective 2:_ Apply coevolution of the geosphere and biosphere to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q7 — provenance.** _Serves objective 1:_ Explain coevolution of the geosphere and biosphere using evidence, a model, or a documented process rather than an unsupported answer.
...
- **prerequisite-gap** — Run the prerequisite reteach route for coevolution of the geosphere and biosphere (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for coevolution of the geosphere and biosphere (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for coevolution of the geosphere and biosphere (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for coevolution of the geosphere and biosphere (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for coevolution of the geosphere and biosphere (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs12-earth-space-environmental-u08-l08` · built from `hs912-science-h4` at `a86780a`._
