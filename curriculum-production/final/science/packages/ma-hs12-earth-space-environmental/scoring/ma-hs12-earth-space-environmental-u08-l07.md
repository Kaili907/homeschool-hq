# Scoring authority — Investigation: the Great Oxidation Event and atmospheric change

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 8: Coevolution of Earth and Life, Resources, and Natural Hazards · Day 7 · lesson `ma-hs12-earth-space-environmental-u08-l07`
...
_Topic `ma-hs12-earth-space-environmental-u08::the Great Oxidation Event and atmospheric change` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs12-earth-space-environmental.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Earth's early atmosphere contained essentially no free oxygen; atmospheric oxygen accumulated from about 2.4 billion years ago, produced by photosynthesising organisms.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Oxygen-producing photosynthesis by cyanobacteria released oxygen that was first consumed by dissolved iron and other reduced material before accumulating in the atmosphere.
- Banded iron formations in the rock record are evidence of that early oxygen being taken up by dissolved iron.
- The rise of oxygen transformed surface chemistry and made aerobic metabolism, and eventually complex life, possible.
...
- Claiming Earth's atmosphere has always contained free oxygen at roughly present levels.
- Claiming atmospheric oxygen was produced by geological outgassing rather than by photosynthesis.
- Claiming oxygen accumulated immediately once photosynthesis began.

**Grade boundary.** Isotopic evidence methodology and detailed Precambrian chronology are beyond this course.
...
> Published atmospheric, geologic, resource, and hazard data. The argument and its evidence weighting are the learner's own.
...
**Q1 — investigate.** _Serves objective 1:_ Plan and carry out a safe investigation of the Great Oxidation Event and atmospheric change, or its stated alternative, and record the learner's own data with its uncertainty.
...
**Q2 — explain with evidence.** _Serves objective 2:_ Explain the Great Oxidation Event and atmospheric change using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q3 — apply new task.** _Serves objective 3:_ Apply the Great Oxidation Event and atmospheric change to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q4 — check revise next step.** _Serves objective 4:_ Check and revise the work on the Great Oxidation Event and atmospheric change against the stated success criteria and name the next step.
...
**Q5 — essential question.** _Serves objective 3:_ Apply the Great Oxidation Event and atmospheric change to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q6 — evidence quality.** _Serves objective 2:_ Explain the Great Oxidation Event and atmospheric change using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q7 — limitation.** _Serves objective 1:_ Plan and carry out a safe investigation of the Great Oxidation Event and atmospheric change, or its stated alternative, and record the learner's own data with its uncertainty.
...
**Q8 — provenance.** _Serves objective 1:_ Plan and carry out a safe investigation of the Great Oxidation Event and atmospheric change, or its stated alternative, and record the learner's own data with its uncertainty.
...
- The learner completes the central task about the Great Oxidation Event and atmospheric change.
...
- **prerequisite-gap** — Run the prerequisite reteach route for the Great Oxidation Event and atmospheric change (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for the Great Oxidation Event and atmospheric change (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for the Great Oxidation Event and atmospheric change (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for the Great Oxidation Event and atmospheric change (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for the Great Oxidation Event and atmospheric change (evidence type: application, require explanation: True, review timing: same-day).
...
- privacy: Mapping local hazards and resources can disclose where the family lives. — mitigation: Analyse a region at county scale or larger, or a region the family does not live in. Never record a home address or precise location.
- emotional: Natural hazard content can be frightening, especially after a local event. — mitigation: Keep the framing on preparation, mitigation, and documented responses; the learner may choose a different region at any point.
...
**Disposal and clearing up:** File or recycle the printed maps and notes. No location data is stored, uploaded, or shared. Nothing hazardous is produced.
...
Use a supplied printed regional case study rather than searching sources, and complete the argument on paper. No online work required.

---

_Package `swp-ma-hs12-earth-space-environmental-u08-l07` · built from `hs912-science-h4` at `a86780a`._
