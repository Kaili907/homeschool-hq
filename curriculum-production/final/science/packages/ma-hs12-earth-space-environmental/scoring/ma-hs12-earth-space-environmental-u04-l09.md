# Scoring authority — Performance task build: orbital period and radius

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 4: Orbital Motion and the Solar System · Day 9 · lesson `ma-hs12-earth-space-environmental-u04-l09`
...
_Topic `ma-hs12-earth-space-environmental-u04::orbital period and radius` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs12-earth-space-environmental.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- A body in a larger orbit around the same central mass has a longer period and a lower orbital speed.

**Accepted relationships and models.** What this lesson's learning target asserts:

- The period-radius relationship means a satellite raised to a higher orbit takes longer to complete each circuit.
- Orbital speed decreases with increasing orbital radius, even though the total orbital energy increases.
- Because the relationship depends on the central mass, measuring a satellite's period and orbital radius determines that mass.
...
- Claiming a satellite in a higher orbit moves faster because it has more energy.
- Claiming orbital period depends on the mass of the orbiting body.
- Claiming period is proportional to radius rather than following the square-cube relationship.

**Grade boundary.** Orbital transfer manoeuvres and delta-v calculation are beyond this course.
...
**Q1 — performance evidence.** _Serves objective 1:_ Produce performance-task evidence for orbital period and radius that a reader could check independently.
...
**Q2 — explain with evidence.** _Serves objective 2:_ Explain orbital period and radius using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q3 — apply new task.** _Serves objective 3:_ Apply orbital period and radius to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q4 — check revise next step.** _Serves objective 4:_ Check and revise the work on orbital period and radius against the stated success criteria and name the next step.
...
**Q5 — essential question.** _Serves objective 3:_ Apply orbital period and radius to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q6 — evidence quality.** _Serves objective 2:_ Explain orbital period and radius using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q7 — limitation.** _Serves objective 3:_ Apply orbital period and radius to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q8 — provenance.** _Serves objective 1:_ Produce performance-task evidence for orbital period and radius that a reader could check independently.
...
- **prerequisite-gap** — Run the prerequisite reteach route for orbital period and radius (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for orbital period and radius (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for orbital period and radius (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for orbital period and radius (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for orbital period and radius (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs12-earth-space-environmental-u04-l09` · built from `hs912-science-h4` at `a86780a`._
