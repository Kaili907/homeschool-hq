# Scoring authority — Independent application A: continental and oceanic crust formation

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 5: Plate Tectonics and the History of Earth · Day 4 · lesson `ma-hs12-earth-space-environmental-u05-l04`
...
_Topic `ma-hs12-earth-space-environmental-u05::continental and oceanic crust formation` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs12-earth-space-environmental.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Oceanic crust is denser and thinner than continental crust, which is why oceanic crust subducts beneath continental crust.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Oceanic crust forms at spreading ridges from mantle-derived magma and is returned to the mantle at subduction zones.
- Continental crust is less dense, so it resists subduction and can survive for billions of years.
- Subduction generates magma that rises to build volcanic arcs and adds to continental crust over time.
...
- Claiming continental crust subducts beneath oceanic crust.
- Claiming oceanic and continental crust have the same composition and density.
- Claiming continental crust is continuously recycled at the same rate as oceanic crust.

**Grade boundary.** Igneous petrogenesis and crustal growth modelling are beyond this course.
...
**Q1 — explain with evidence.** _Serves objective 1:_ Explain continental and oceanic crust formation using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q2 — apply new task.** _Serves objective 2:_ Apply continental and oceanic crust formation to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q3 — check revise next step.** _Serves objective 3:_ Check and revise the work on continental and oceanic crust formation against the stated success criteria and name the next step.
...
**Q4 — essential question.** _Serves objective 2:_ Apply continental and oceanic crust formation to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q5 — evidence quality.** _Serves objective 1:_ Explain continental and oceanic crust formation using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q6 — limitation.** _Serves objective 2:_ Apply continental and oceanic crust formation to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q7 — provenance.** _Serves objective 1:_ Explain continental and oceanic crust formation using evidence, a model, or a documented process rather than an unsupported answer.
...
- **prerequisite-gap** — Run the prerequisite reteach route for continental and oceanic crust formation (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for continental and oceanic crust formation (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for continental and oceanic crust formation (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for continental and oceanic crust formation (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for continental and oceanic crust formation (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs12-earth-space-environmental-u05-l04` · built from `hs912-science-h4` at `a86780a`._
