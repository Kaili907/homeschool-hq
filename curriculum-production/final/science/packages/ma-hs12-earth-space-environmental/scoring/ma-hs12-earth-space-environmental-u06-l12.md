# Scoring authority — Correction and reflection: investigating water and Earth materials

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 6: Surface Processes, Water, and Earth System Feedbacks · Day 12 · lesson `ma-hs12-earth-space-environmental-u06-l12`
...
_Topic `ma-hs12-earth-space-environmental-u06::investigating water and Earth materials` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs12-earth-space-environmental.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- An investigation of water or earth materials states its sampling location, time, method, and the property measured, since all four affect the result.
- Natural variability means a single sample characterises that sample, not the system it came from.
- Measurements are compared against published values only where the method and conditions are comparable.
...
- Characterising a water body or a formation from a single sample.
- Comparing a measurement against a published value obtained by a different method without saying so.
- Reporting a field measurement without location, time, and method.

**Grade boundary.** Analytical laboratory methods and quality assurance protocols are beyond this course.
...
**Q1 — explain with evidence.** _Serves objective 1:_ Explain investigating water and Earth materials using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q2 — apply new task.** _Serves objective 2:_ Apply investigating water and Earth materials to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q3 — check revise next step.** _Serves objective 3:_ Check and revise the work on investigating water and Earth materials against the stated success criteria and name the next step.
...
**Q4 — essential question.** _Serves objective 2:_ Apply investigating water and Earth materials to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q5 — evidence quality.** _Serves objective 1:_ Explain investigating water and Earth materials using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q6 — limitation.** _Serves objective 2:_ Apply investigating water and Earth materials to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q7 — provenance.** _Serves objective 1:_ Explain investigating water and Earth materials using evidence, a model, or a documented process rather than an unsupported answer.
...
- **prerequisite-gap** — Run the prerequisite reteach route for investigating water and Earth materials (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for investigating water and Earth materials (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for investigating water and Earth materials (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for investigating water and Earth materials (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for investigating water and Earth materials (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs12-earth-space-environmental-u06-l12` · built from `hs912-science-h4` at `a86780a`._
