# Scoring authority — Investigation: systems and system models

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 1: Earth and Space Systems, Scale, and Data Practice · Day 7 · lesson `ma-hs12-earth-space-environmental-u01-l07`
...
_Topic `ma-hs12-earth-space-environmental-u01::systems and system models` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs12-earth-space-environmental.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A system is defined by its boundary, its components, and the flows of matter and energy across that boundary.
- System behaviour arises from the interactions between components, so it cannot be predicted from any component alone.
- Where the boundary is drawn determines what counts as internal behaviour and what counts as an input or output.

**Also correct.** Accept any of these framings — do not require the wording above:

- Box-and-arrow diagrams, stock-and-flow diagrams, and written system descriptions are all acceptable model forms.
...
- Describing a system with no boundary stated.
- Explaining a whole-system behaviour from one component in isolation.
- Claiming a system model captures the real system completely.

**Grade boundary.** Formal systems dynamics mathematics is beyond this course.
...
**Q1 — investigate.** _Serves objective 1:_ Plan and carry out a safe investigation of systems and system models, or its stated alternative, and record the learner's own data with its uncertainty.
...
**Q2 — explain with evidence.** _Serves objective 2:_ Explain systems and system models using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q3 — apply new task.** _Serves objective 3:_ Apply systems and system models to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q4 — check revise next step.** _Serves objective 4:_ Check and revise the work on systems and system models against the stated success criteria and name the next step.
...
**Q5 — essential question.** _Serves objective 3:_ Apply systems and system models to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q6 — evidence quality.** _Serves objective 2:_ Explain systems and system models using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q7 — limitation.** _Serves objective 1:_ Plan and carry out a safe investigation of systems and system models, or its stated alternative, and record the learner's own data with its uncertainty.
...
**Q8 — provenance.** _Serves objective 1:_ Plan and carry out a safe investigation of systems and system models, or its stated alternative, and record the learner's own data with its uncertainty.
...
- The learner completes the central task about systems and system models.
...
- **prerequisite-gap** — Run the prerequisite reteach route for systems and system models (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for systems and system models (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for systems and system models (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for systems and system models (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for systems and system models (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs12-earth-space-environmental-u01-l07` · built from `hs912-science-h4` at `a86780a`._
