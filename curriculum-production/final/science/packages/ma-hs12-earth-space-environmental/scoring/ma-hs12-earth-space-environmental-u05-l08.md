# Scoring authority — Reteach and varied practice: seafloor age and magnetic striping

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 5: Plate Tectonics and the History of Earth · Day 8 · lesson `ma-hs12-earth-space-environmental-u05-l08`
...
_Topic `ma-hs12-earth-space-environmental-u05::seafloor age and magnetic striping` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs12-earth-space-environmental.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Oceanic crust is youngest at mid-ocean ridges and progressively older away from them, symmetrically on both sides.
- The oceanic crust is far younger than the continental crust, because it is continually created and destroyed.

**Accepted relationships and models.** What this lesson's learning target asserts:

- New oceanic crust forms at ridges and records the direction of Earth's magnetic field as it cools.
- Because Earth's magnetic field has reversed many times, the seafloor carries symmetric bands of alternating magnetisation on either side of a ridge.
- The symmetry of the pattern is direct evidence of seafloor spreading.
...
- Claiming the seafloor is oldest at the ridges.
- Claiming the magnetic stripes record variations in rock type rather than reversals of Earth's field.
- Claiming oceanic and continental crust are of comparable age.

**Grade boundary.** Magnetostratigraphic dating methodology and geodynamo theory are beyond this course.
...
**Q1 — explain with evidence.** _Serves objective 1:_ Explain seafloor age and magnetic striping using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q2 — apply new task.** _Serves objective 2:_ Apply seafloor age and magnetic striping to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q3 — check revise next step.** _Serves objective 3:_ Check and revise the work on seafloor age and magnetic striping against the stated success criteria and name the next step.
...
**Q4 — essential question.** _Serves objective 2:_ Apply seafloor age and magnetic striping to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q5 — evidence quality.** _Serves objective 1:_ Explain seafloor age and magnetic striping using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q6 — limitation.** _Serves objective 2:_ Apply seafloor age and magnetic striping to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q7 — provenance.** _Serves objective 1:_ Explain seafloor age and magnetic striping using evidence, a model, or a documented process rather than an unsupported answer.
...
- **prerequisite-gap** — Run the prerequisite reteach route for seafloor age and magnetic striping (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for seafloor age and magnetic striping (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for seafloor age and magnetic striping (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for seafloor age and magnetic striping (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for seafloor age and magnetic striping (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs12-earth-space-environmental-u05-l08` · built from `hs912-science-h4` at `a86780a`._
