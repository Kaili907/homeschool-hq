# Scoring authority — Unit assessment: radiometric dating and Earth's age

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 5: Plate Tectonics and the History of Earth · Day 11 · lesson `ma-hs12-earth-space-environmental-u05-l11`
...
_Topic `ma-hs12-earth-space-environmental-u05::radiometric dating and Earth's age` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs12-earth-space-environmental.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Earth is about 4.5 billion years old, determined principally from radiometric dating of meteorites and the oldest terrestrial minerals.
- The half-life of a radioactive isotope is unaffected by temperature, pressure, or chemical combination.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Radiometric dating measures the ratio of a parent isotope to its decay product and converts it to elapsed time using the known half-life.
- The method requires a closed system since formation, which is why samples are tested for disturbance and why multiple isotope systems are cross-checked.
- Different isotope pairs suit different age ranges, and agreement between independent systems is what makes an age robust.

**Also correct.** Accept any of these framings — do not require the wording above:

- Approximate statements such as 'about four and a half billion years' are correct; the precise figure is not required.
...
- Claiming decay rates vary with environmental conditions in a way that undermines dating.
- Claiming radiometric dating gives an age for a rock without any assumption about the system being closed.
- Claiming carbon dating is used to date rocks billions of years old.

**Grade boundary.** Isochron construction and closure temperature theory are beyond this course.
...
**Q1 — mastery fresh task.** _Serves objective 1:_ Demonstrate independent mastery evidence for radiometric dating and Earth's age on a fresh task.
...
**Q2 — explain with evidence.** _Serves objective 2:_ Explain radiometric dating and Earth's age using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q3 — apply new task.** _Serves objective 3:_ Apply radiometric dating and Earth's age to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q4 — check revise next step.** _Serves objective 4:_ Check and revise the work on radiometric dating and Earth's age against the stated success criteria and name the next step.
...
**Q5 — essential question.** _Serves objective 3:_ Apply radiometric dating and Earth's age to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q6 — evidence quality.** _Serves objective 2:_ Explain radiometric dating and Earth's age using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q7 — limitation.** _Serves objective 3:_ Apply radiometric dating and Earth's age to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q8 — provenance.** _Serves objective 1:_ Demonstrate independent mastery evidence for radiometric dating and Earth's age on a fresh task.
...
- **prerequisite-gap** — Run the prerequisite reteach route for radiometric dating and Earth's age (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for radiometric dating and Earth's age (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for radiometric dating and Earth's age (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for radiometric dating and Earth's age (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for radiometric dating and Earth's age (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs12-earth-space-environmental-u05-l11` · built from `hs912-science-h4` at `a86780a`._
