# Scoring authority — Independent application A: uncertainty in geoscience data

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 1: Earth and Space Systems, Scale, and Data Practice · Day 4 · lesson `ma-hs12-earth-space-environmental-u01-l04`
...
_Topic `ma-hs12-earth-space-environmental-u01::uncertainty in geoscience data` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs12-earth-space-environmental.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Geoscience data carries uncertainty from measurement, from sampling in space and time, and from the models used to interpret it.
- Uncertainty is a quantified statement about how well something is known; it is not an admission that nothing is known.
- A conclusion is stated with the uncertainty attached, so that a reader can judge what it supports.

**Also correct.** Accept any of these framings — do not require the wording above:

- Ranges, error bars, and stated confidence language are all acceptable ways to express uncertainty at this level.
...
- Treating a stated uncertainty as grounds for dismissing a well-supported conclusion.
- Reporting a geoscience result with no indication of uncertainty or sampling limits.
- Claiming two values differ when the difference is within the stated uncertainty.

**Grade boundary.** Formal statistical inference and Bayesian methods are beyond this course.
...
**Q1 — explain with evidence.** _Serves objective 1:_ Explain uncertainty in geoscience data using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q2 — apply new task.** _Serves objective 2:_ Apply uncertainty in geoscience data to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q3 — check revise next step.** _Serves objective 3:_ Check and revise the work on uncertainty in geoscience data against the stated success criteria and name the next step.
...
**Q4 — essential question.** _Serves objective 2:_ Apply uncertainty in geoscience data to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q5 — evidence quality.** _Serves objective 1:_ Explain uncertainty in geoscience data using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q6 — limitation.** _Serves objective 2:_ Apply uncertainty in geoscience data to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q7 — provenance.** _Serves objective 1:_ Explain uncertainty in geoscience data using evidence, a model, or a documented process rather than an unsupported answer.
...
- **prerequisite-gap** — Run the prerequisite reteach route for uncertainty in geoscience data (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for uncertainty in geoscience data (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for uncertainty in geoscience data (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for uncertainty in geoscience data (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for uncertainty in geoscience data (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs12-earth-space-environmental-u01-l04` · built from `hs912-science-h4` at `a86780a`._
