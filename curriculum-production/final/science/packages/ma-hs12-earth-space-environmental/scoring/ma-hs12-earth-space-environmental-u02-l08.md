# Scoring authority — Reteach and varied practice: the sun's energy budget and lifespan

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 2: The Sun, Stars, and the Origin of the Elements · Day 8 · lesson `ma-hs12-earth-space-environmental-u02-l08`
...
_Topic `ma-hs12-earth-space-environmental-u02::the sun's energy budget and lifespan` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs12-earth-space-environmental.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- The Sun is roughly 4.6 billion years old and is about halfway through its main-sequence lifetime.
- The Sun will end as a white dwarf, not as a supernova.

**Accepted relationships and models.** What this lesson's learning target asserts:

- The Sun's energy output is set by the rate of fusion in its core, which is regulated by the balance between gravity and pressure.
- Essentially all the energy driving Earth's surface processes, weather, and life originates from the Sun, with geothermal and tidal energy as small additional contributions.
- A star's lifetime depends on its mass: more massive stars burn far more quickly and live far shorter lives.

**Also correct.** Accept any of these framings — do not require the wording above:

- Approximate ages and lifetimes such as 'about four and a half billion years' are correct; exact figures are not required.
...
- Claiming the Sun will explode as a supernova.
- Claiming more massive stars live longer because they have more fuel.
- Claiming the Sun's energy comes from a source other than nuclear fusion.

**Grade boundary.** Solar interior modelling and helioseismology are beyond this course.
...
**Q1 — explain with evidence.** _Serves objective 1:_ Explain the sun's energy budget and lifespan using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q2 — apply new task.** _Serves objective 2:_ Apply the sun's energy budget and lifespan to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q3 — check revise next step.** _Serves objective 3:_ Check and revise the work on the sun's energy budget and lifespan against the stated success criteria and name the next step.
...
**Q4 — essential question.** _Serves objective 2:_ Apply the sun's energy budget and lifespan to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q5 — evidence quality.** _Serves objective 1:_ Explain the sun's energy budget and lifespan using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q6 — limitation.** _Serves objective 2:_ Apply the sun's energy budget and lifespan to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q7 — provenance.** _Serves objective 1:_ Explain the sun's energy budget and lifespan using evidence, a model, or a documented process rather than an unsupported answer.
...
- **prerequisite-gap** — Run the prerequisite reteach route for the sun's energy budget and lifespan (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for the sun's energy budget and lifespan (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for the sun's energy budget and lifespan (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for the sun's energy budget and lifespan (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for the sun's energy budget and lifespan (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs12-earth-space-environmental-u02-l08` · built from `hs912-science-h4` at `a86780a`._
