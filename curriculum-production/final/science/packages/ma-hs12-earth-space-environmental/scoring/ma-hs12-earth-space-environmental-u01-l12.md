# Scoring authority — Correction and reflection: distinguishing correlation and causation

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 1: Earth and Space Systems, Scale, and Data Practice · Day 12 · lesson `ma-hs12-earth-space-environmental-u01-l12`
...
- Two variables can correlate because one causes the other, because a third factor drives both, or by coincidence in a limited sample.
- Establishing causation requires a mechanism, evidence that cause precedes effect, and where possible a controlled comparison.
- In Earth science, controlled experiments are often impossible, so causal claims rest on mechanism plus multiple independent lines of evidence.
...
- Rejecting a well-supported causal claim on the grounds that the evidence is correlational, when mechanism and multiple lines of evidence are present.
- Asserting a mechanism with no evidence and treating that as having established causation.

**Grade boundary.** Formal causal inference frameworks are beyond this course.
...
**Q1 — explain with evidence.** _Serves objective 1:_ Explain distinguishing correlation and causation using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q2 — apply new task.** _Serves objective 2:_ Apply distinguishing correlation and causation to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q3 — check revise next step.** _Serves objective 3:_ Check and revise the work on distinguishing correlation and causation against the stated success criteria and name the next step.
...
**Q4 — essential question.** _Serves objective 2:_ Apply distinguishing correlation and causation to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q5 — evidence quality.** _Serves objective 1:_ Explain distinguishing correlation and causation using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q6 — limitation.** _Serves objective 2:_ Apply distinguishing correlation and causation to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q7 — provenance.** _Serves objective 1:_ Explain distinguishing correlation and causation using evidence, a model, or a documented process rather than an unsupported answer.
...
- **prerequisite-gap** — Run the prerequisite reteach route for distinguishing correlation and causation (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for distinguishing correlation and causation (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for distinguishing correlation and causation (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for distinguishing correlation and causation (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for distinguishing correlation and causation (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs12-earth-space-environmental-u01-l12` · built from `hs912-science-h4` at `a86780a`._
