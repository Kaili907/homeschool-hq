# Scoring authority — Concept model A: the greenhouse effect

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 7: Climate, Energy Flow, and the Carbon Cycle · Day 2 · lesson `ma-hs12-earth-space-environmental-u07-l02`
...
_Package `swp-ma-hs12-earth-space-environmental-u07-l02` · built from `hs912-science-h4` at `a86780a`._
