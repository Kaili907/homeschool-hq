# Scoring authority — Investigation: energy flow into and out of Earth systems

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 7: Climate, Energy Flow, and the Carbon Cycle · Day 7 · lesson `ma-hs12-earth-space-environmental-u07-l07`
...
_Topic `ma-hs12-earth-space-environmental-u07::energy flow into and out of Earth systems` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs12-earth-space-environmental.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Earth's climate is set by the balance between incoming solar radiation and outgoing infrared radiation.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Incoming solar energy is absorbed, reflected, or scattered, and the reflective fraction is the albedo.
- Earth radiates energy back to space as infrared, and long-term temperature is set by the balance between incoming and outgoing.
- Anything that changes absorbed solar energy or outgoing infrared changes the balance and therefore the temperature.
...
- Claiming Earth's surface temperature is set by incoming solar radiation alone with no role for outgoing radiation.
- Claiming Earth's internal heat is a major contributor to surface temperature.
- Claiming a change in albedo has no effect on the energy balance.

**Grade boundary.** Radiative transfer calculation and quantitative energy budget partitioning are beyond this course.
...
> Published climate records, carbon flux estimates, and model outputs the family retrieves, plus the learner's own container temperature series. Forecasts are the learner's own, with stated uncertainty.
...
**Q1 — investigate.** _Serves objective 1:_ Plan and carry out a safe investigation of energy flow into and out of Earth systems, or its stated alternative, and record the learner's own data with its uncertainty.
...
**Q2 — explain with evidence.** _Serves objective 2:_ Explain energy flow into and out of Earth systems using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q3 — apply new task.** _Serves objective 3:_ Apply energy flow into and out of Earth systems to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q4 — check revise next step.** _Serves objective 4:_ Check and revise the work on energy flow into and out of Earth systems against the stated success criteria and name the next step.
...
**Q5 — essential question.** _Serves objective 3:_ Apply energy flow into and out of Earth systems to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q6 — evidence quality.** _Serves objective 2:_ Explain energy flow into and out of Earth systems using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q7 — limitation.** _Serves objective 1:_ Plan and carry out a safe investigation of energy flow into and out of Earth systems, or its stated alternative, and record the learner's own data with its uncertainty.
...
**Q8 — provenance.** _Serves objective 1:_ Plan and carry out a safe investigation of energy flow into and out of Earth systems, or its stated alternative, and record the learner's own data with its uncertainty.
...
- **prerequisite-gap** — Run the prerequisite reteach route for energy flow into and out of Earth systems (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for energy flow into and out of Earth systems (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for energy flow into and out of Earth systems (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for energy flow into and out of Earth systems (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for energy flow into and out of Earth systems (evidence type: application, require explanation: True, review timing: same-day).
...
- physical: A lamp used as a light source gets hot and must stay away from water. — mitigation: Use an LED lamp only - never incandescent or halogen. Keep it at least 30 cm from containers, never above water, and let an adult position it. Allow it to cool before moving.
- emotional: Climate content can produce genuine anxiety about the future. — mitigation: Pair every impact with documented response options and human agency, keep the framing on evidence and design, and let the learner pause or redirect at any time.
...
**Disposal and clearing up:** Once the lamp is off and cool, pour the water down the drain and dry the containers, then unplug the lamp and put it away. Nothing hazardous is produced.
...
_Package `swp-ma-hs12-earth-space-environmental-u07-l07` · built from `hs912-science-h4` at `a86780a`._
