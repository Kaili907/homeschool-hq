# Scoring authority — Reteach and varied practice: motion of distant galaxies

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 3: Cosmology and the Evidence for the Big Bang · Day 8 · lesson `ma-hs12-earth-space-environmental-u03-l08`
...
_Topic `ma-hs12-earth-space-environmental-u03::motion of distant galaxies` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs12-earth-space-environmental.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Almost all distant galaxies show redshift, indicating that the universe is expanding.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Observers in any galaxy would see the same pattern of recession, because the expansion has no centre within the universe.
- Nearby galaxies can show blueshift, because local gravitational motion can exceed the expansion at short distances.
- The expansion carries galaxies apart; galaxies are not flying outward through pre-existing space from an explosion site.
...
- Claiming the universe has a centre from which galaxies are receding.
- Claiming the Big Bang was an explosion at a point in existing space.
- Claiming every galaxy without exception shows redshift.

**Grade boundary.** Peculiar velocity corrections and large-scale structure dynamics are beyond this course.
...
**Q1 — explain with evidence.** _Serves objective 1:_ Explain motion of distant galaxies using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q2 — apply new task.** _Serves objective 2:_ Apply motion of distant galaxies to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q3 — check revise next step.** _Serves objective 3:_ Check and revise the work on motion of distant galaxies against the stated success criteria and name the next step.
...
**Q4 — essential question.** _Serves objective 2:_ Apply motion of distant galaxies to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q5 — evidence quality.** _Serves objective 1:_ Explain motion of distant galaxies using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q6 — limitation.** _Serves objective 2:_ Apply motion of distant galaxies to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q7 — provenance.** _Serves objective 1:_ Explain motion of distant galaxies using evidence, a model, or a documented process rather than an unsupported answer.
...
- The learner completes the central task about motion of distant galaxies.
...
- **prerequisite-gap** — Run the prerequisite reteach route for motion of distant galaxies (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for motion of distant galaxies (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for motion of distant galaxies (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for motion of distant galaxies (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for motion of distant galaxies (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs12-earth-space-environmental-u03-l08` · built from `hs912-science-h4` at `a86780a`._
