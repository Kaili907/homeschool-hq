# Correction and reflection: reconstructing geologic history

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 5: Plate Tectonics and the History of Earth · Day 12 of the unit (course day 60) · about 55–75 minutes

**Today's focus:** reconstructing geologic history
...
- Explain reconstructing geologic history using evidence, a model, or a documented process rather than an unsupported answer.
- Apply reconstructing geologic history to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on reconstructing geologic history against the stated success criteria and name the next step.
...
- Science brief: a geologic history is reconstructed by combining relative dating of structures with absolute ages and with evidence about depositional environment.
- Science brief: cross-cutting relationships, inclusions, and unconformities each constrain the sequence of events.
- Science brief: a reconstruction states which parts are well constrained and which rest on fewer lines of evidence.

### Evidence check: reconstructing geologic history

**Candidate claim:** A case report presents this as acceptable science: “applying superposition to a sequence with evidence of overturning without accounting for it.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a geologic history is reconstructed by combining relative dating of structures with absolute ages and with evidence about depositional environment. |
| E2 | established science reference | Science brief: cross-cutting relationships, inclusions, and unconformities each constrain the sequence of events. |
| E3 | established science reference | Science brief: a reconstruction states which parts are well constrained and which rest on fewer lines of evidence. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs12-earth-space-environmental-u05::reconstructing geologic history, derived from the reviewed correctness source policy/correctness/ma-hs12-earth-space-environmental.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about reconstructing geologic history, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about reconstructing geologic history, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about reconstructing geologic history, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain reconstructing geologic history in your own words using at least two specifically named rows from E1-E3. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for reconstructing geologic history. Decide whether E1-E3 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about reconstructing geologic history, revise its weakest claim with a named row from E1-E3, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using reconstructing geologic history as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about reconstructing geologic history? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about reconstructing geologic history that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about reconstructing geologic history. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about reconstructing geologic history.
...
- Apply reconstructing geologic history under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect reconstructing geologic history to evidence for plate motion from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs12-earth-space-environmental-u05-l12` · lesson `ma-hs12-earth-space-environmental-u05-l12` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
