# Correction and reflection: constructing arguments from geologic and biological evidence

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 8: Coevolution of Earth and Life, Resources, and Natural Hazards · Day 12 of the unit (course day 96) · about 55–75 minutes

**Today's focus:** constructing arguments from geologic and biological evidence
...
- Explain constructing arguments from geologic and biological evidence using evidence, a model, or a documented process rather than an unsupported answer.
- Apply constructing arguments from geologic and biological evidence to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on constructing arguments from geologic and biological evidence against the stated success criteria and name the next step.
...
- Science brief: an argument about Earth history links a claim to specific geologic and biological evidence through explicit reasoning about process.
- Science brief: because controlled experiments on Earth history are impossible, arguments rest on multiple independent lines of evidence converging.
- Science brief: an argument states which parts of the claim the evidence establishes and which remain open.

### Evidence check: constructing arguments from geologic and biological evidence

**Candidate claim:** A case report presents this as acceptable science: “presenting a single line of evidence as establishing a claim about Earth history.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: an argument about Earth history links a claim to specific geologic and biological evidence through explicit reasoning about process. |
| E2 | established science reference | Science brief: because controlled experiments on Earth history are impossible, arguments rest on multiple independent lines of evidence converging. |
| E3 | established science reference | Science brief: an argument states which parts of the claim the evidence establishes and which remain open. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs12-earth-space-environmental-u08::constructing arguments from geologic and biological evidence, derived from the reviewed correctness source policy/correctness/ma-hs12-earth-space-environmental.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about constructing arguments from geologic and biological evidence, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about constructing arguments from geologic and biological evidence, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about constructing arguments from geologic and biological evidence, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain constructing arguments from geologic and biological evidence in your own words using at least two specifically named rows from E1-E3. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for constructing arguments from geologic and biological evidence. Decide whether E1-E3 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about constructing arguments from geologic and biological evidence, revise its weakest claim with a named row from E1-E3, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using constructing arguments from geologic and biological evidence as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about constructing arguments from geologic and biological evidence? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about constructing arguments from geologic and biological evidence that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about constructing arguments from geologic and biological evidence. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about constructing arguments from geologic and biological evidence.
...
- Apply constructing arguments from geologic and biological evidence under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect constructing arguments from geologic and biological evidence to the Great Oxidation Event and atmospheric change from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Construct an evidence-based argument about the coevolution of Earth's systems and life, and explain how resource distribution, hazards, and climate change have driven human activity. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-hs12-earth-space-environmental-u08-l12` · lesson `ma-hs12-earth-space-environmental-u08-l12` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
