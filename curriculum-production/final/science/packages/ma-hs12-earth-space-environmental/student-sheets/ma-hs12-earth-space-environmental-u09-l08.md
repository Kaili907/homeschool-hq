# Reteach and varied practice: cost-benefit analysis of energy and mineral resources

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 9: Sustainability Engineering and the Grade 12 Capstone · Day 8 of the unit (course day 104) · about 55–75 minutes

**Today's focus:** cost-benefit analysis of energy and mineral resources
...
- Apply cost-benefit analysis of energy and mineral resources to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on cost-benefit analysis of energy and mineral resources against the stated success criteria and name the next step.
...
- Science brief: a full comparison of resource options accounts for the whole life cycle: extraction, processing, transport, use, and end of life.
- Science brief: every energy and mineral option has environmental and social costs; the comparison is between different sets of costs, not between costly and costless options.
- Science brief: costs and benefits fall on different groups and over different timescales, and a comparison that omits that is incomplete.

### Evidence check: cost-benefit analysis of energy and mineral resources

**Candidate claim:** A case report presents this as acceptable science: “presenting any energy or mineral option as having no environmental cost.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a full comparison of resource options accounts for the whole life cycle: extraction, processing, transport, use, and end of life. |
| E2 | established science reference | Science brief: every energy and mineral option has environmental and social costs; the comparison is between different sets of costs, not between costly and costless options. |
| E3 | established science reference | Science brief: costs and benefits fall on different groups and over different timescales, and a comparison that omits that is incomplete. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs12-earth-space-environmental-u09::cost-benefit analysis of energy and mineral resources, derived from the reviewed correctness source policy/correctness/ma-hs12-earth-space-environmental.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about cost-benefit analysis of energy and mineral resources, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about cost-benefit analysis of energy and mineral resources, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about cost-benefit analysis of energy and mineral resources, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain cost-benefit analysis of energy and mineral resources in your own words using at least two specifically named rows from E1-E3. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for cost-benefit analysis of energy and mineral resources. Decide whether E1-E3 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about cost-benefit analysis of energy and mineral resources, revise its weakest claim with a named row from E1-E3, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using cost-benefit analysis of energy and mineral resources as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about cost-benefit analysis of energy and mineral resources? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about cost-benefit analysis of energy and mineral resources that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about cost-benefit analysis of energy and mineral resources. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about cost-benefit analysis of energy and mineral resources.
...
- Apply cost-benefit analysis of energy and mineral resources under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect cost-benefit analysis of energy and mineral resources to criteria, constraints, and prioritisation from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs12-earth-space-environmental-u09-l08` · lesson `ma-hs12-earth-space-environmental-u09-l08` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
