# Unit assessment: sustainability and human population

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 9: Sustainability Engineering and the Grade 12 Capstone · Day 11 of the unit (course day 107) · about 55–75 minutes

**Today's focus:** sustainability and human population
...
- Demonstrate independent mastery evidence for sustainability and human population on a fresh task.
- Explain sustainability and human population using evidence, a model, or a documented process rather than an unsupported answer.
- Apply sustainability and human population to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on sustainability and human population against the stated success criteria and name the next step.
...
- Science brief: total resource demand depends on population size, on consumption per person, and on the technologies used, and all three vary greatly between regions.
- Science brief: sustainability requires that renewable resources be used no faster than they are replenished and that waste be produced no faster than it can be absorbed.
- Science brief: human population growth rate has been declining globally for decades, while total population continues to rise.

### Evidence check: sustainability and human population

**Candidate claim:** A case report presents this as acceptable science: “attributing resource pressure to population size alone, ignoring consumption and technology.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: total resource demand depends on population size, on consumption per person, and on the technologies used, and all three vary greatly between regions. |
| E2 | established science reference | Science brief: sustainability requires that renewable resources be used no faster than they are replenished and that waste be produced no faster than it can be absorbed. |
| E3 | established science reference | Science brief: human population growth rate has been declining globally for decades, while total population continues to rise. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs12-earth-space-environmental-u09::sustainability and human population, derived from the reviewed correctness source policy/correctness/ma-hs12-earth-space-environmental.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about sustainability and human population, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about sustainability and human population, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about sustainability and human population, then name one check that would catch an error or a weak claim.**
...
**Q1.** Without copying a sentence from the brief, evaluate the printed candidate case about sustainability and human population. Cite E1-E3, write the reasoning in your own words, and correct the case claim so it fits exactly what the record establishes.

>

**Q2.** Explain sustainability and human population in your own words using at least two specifically named rows from E1-E3. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for sustainability and human population. Decide whether E1-E3 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about sustainability and human population, revise its weakest claim with a named row from E1-E3, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using sustainability and human population as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E3 is strongest for evaluating the candidate claim about sustainability and human population? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E3, state one conclusion about sustainability and human population that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about sustainability and human population. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about sustainability and human population.
...
- Apply sustainability and human population under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect sustainability and human population to criteria, constraints, and prioritisation from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs12-earth-space-environmental-u09-l11` · lesson `ma-hs12-earth-space-environmental-u09-l11` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
