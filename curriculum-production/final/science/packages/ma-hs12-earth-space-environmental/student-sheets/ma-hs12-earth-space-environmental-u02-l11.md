# Unit assessment: spectra as compositional evidence

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 2: The Sun, Stars, and the Origin of the Elements · Day 11 of the unit (course day 23) · about 55–75 minutes

**Today's focus:** spectra as compositional evidence
...
- Demonstrate independent mastery evidence for spectra as compositional evidence on a fresh task.
- Explain spectra as compositional evidence using evidence, a model, or a documented process rather than an unsupported answer.
- Apply spectra as compositional evidence to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on spectra as compositional evidence against the stated success criteria and name the next step.
...
- Science brief: each element produces a characteristic pattern of spectral lines, which is how the composition of distant objects is determined.
- Science brief: emission lines appear where atoms release specific energies; absorption lines appear where atoms remove those same energies from light passing through.
- Science brief: because the line pattern is characteristic of the element, a spectrum identifies which elements are present without any sample being collected.
- Science brief: line positions also carry information about motion, through Doppler shift, and about conditions such as temperature and pressure.

### Evidence check: spectra as compositional evidence

**Candidate claim:** A case report presents this as acceptable science: “spectral line patterns are the same for different elements.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: each element produces a characteristic pattern of spectral lines, which is how the composition of distant objects is determined. |
| E2 | established science reference | Science brief: emission lines appear where atoms release specific energies; absorption lines appear where atoms remove those same energies from light passing through. |
| E3 | established science reference | Science brief: because the line pattern is characteristic of the element, a spectrum identifies which elements are present without any sample being collected. |
| E4 | established science reference | Science brief: line positions also carry information about motion, through Doppler shift, and about conditions such as temperature and pressure. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs12-earth-space-environmental-u02::spectra as compositional evidence, derived from the reviewed correctness source policy/correctness/ma-hs12-earth-space-environmental.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about spectra as compositional evidence, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about spectra as compositional evidence, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about spectra as compositional evidence, then name one check that would catch an error or a weak claim.**
...
**Q1.** Without copying a sentence from the brief, evaluate the printed candidate case about spectra as compositional evidence. Cite E1-E4, write the reasoning in your own words, and correct the case claim so it fits exactly what the record establishes.

>

**Q2.** Explain spectra as compositional evidence in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for spectra as compositional evidence. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about spectra as compositional evidence, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using spectra as compositional evidence as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E4 is strongest for evaluating the candidate claim about spectra as compositional evidence? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E4, state one conclusion about spectra as compositional evidence that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about spectra as compositional evidence. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about spectra as compositional evidence.
...
- Apply spectra as compositional evidence under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect spectra as compositional evidence to nuclear fusion in stellar cores from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs12-earth-space-environmental-u02-l11` · lesson `ma-hs12-earth-space-environmental-u02-l11` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
