...
**The task.** What does evidence E1 through E3 justify about systems and system models, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**Q1.** Use the printed case as today's phenomenon for systems and system models. Record what the candidate claim says, identify the mismatch with E1-E3, and pose a testable question naming what would change and what would be measured or classified.
...
_Package `swp-ma-hs12-earth-space-environmental-u01-l01` · lesson `ma-hs12-earth-space-environmental-u01-l01` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
