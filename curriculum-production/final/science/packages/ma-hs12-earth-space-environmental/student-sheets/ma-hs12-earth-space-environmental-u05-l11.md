# Unit assessment: radiometric dating and Earth's age

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 5: Plate Tectonics and the History of Earth · Day 11 of the unit (course day 59) · about 55–75 minutes

**Today's focus:** radiometric dating and Earth's age
...
- Explain radiometric dating and Earth's age using evidence, a model, or a documented process rather than an unsupported answer.
- Apply radiometric dating and Earth's age to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on radiometric dating and Earth's age against the stated success criteria and name the next step.
...
- Science brief: earth is about 4.5 billion years old, determined principally from radiometric dating of meteorites and the oldest terrestrial minerals.
- Science brief: the half-life of a radioactive isotope is unaffected by temperature, pressure, or chemical combination.
- Science brief: radiometric dating measures the ratio of a parent isotope to its decay product and converts it to elapsed time using the known half-life.
- Science brief: the method requires a closed system since formation, which is why samples are tested for disturbance and why multiple isotope systems are cross-checked.

### Evidence check: radiometric dating and Earth's age

**Candidate claim:** A case report presents this as acceptable science: “decay rates vary with environmental conditions in a way that undermines dating.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: earth is about 4.5 billion years old, determined principally from radiometric dating of meteorites and the oldest terrestrial minerals. |
| E2 | established science reference | Science brief: the half-life of a radioactive isotope is unaffected by temperature, pressure, or chemical combination. |
| E3 | established science reference | Science brief: radiometric dating measures the ratio of a parent isotope to its decay product and converts it to elapsed time using the known half-life. |
| E4 | established science reference | Science brief: the method requires a closed system since formation, which is why samples are tested for disturbance and why multiple isotope systems are cross-checked. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs12-earth-space-environmental-u05::radiometric dating and Earth's age, derived from the reviewed correctness source policy/correctness/ma-hs12-earth-space-environmental.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about radiometric dating and Earth's age, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about radiometric dating and Earth's age, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about radiometric dating and Earth's age, then name one check that would catch an error or a weak claim.**
...
**Q1.** Without copying a sentence from the brief, evaluate the printed candidate case about radiometric dating and Earth's age. Cite E1-E4, write the reasoning in your own words, and correct the case claim so it fits exactly what the record establishes.

>

**Q2.** Explain radiometric dating and Earth's age in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for radiometric dating and Earth's age. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about radiometric dating and Earth's age, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using radiometric dating and Earth's age as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E4 is strongest for evaluating the candidate claim about radiometric dating and Earth's age? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E4, state one conclusion about radiometric dating and Earth's age that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about radiometric dating and Earth's age. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about radiometric dating and Earth's age.
...
- Apply radiometric dating and Earth's age under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect radiometric dating and Earth's age to evidence for plate motion from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs12-earth-space-environmental-u05-l11` · lesson `ma-hs12-earth-space-environmental-u05-l11` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
