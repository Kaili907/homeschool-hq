...
**Pinned H4 alternative statement (lineage evidence):** Use a supplied printed regional case study rather than searching sources, and complete the argument on paper. No online work required.
...
_Package `swp-ma-hs12-earth-space-environmental-u08-l07` · lesson `ma-hs12-earth-space-environmental-u08-l07` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
