# Reteach and varied practice: the special properties of water

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 6: Surface Processes, Water, and Earth System Feedbacks · Day 8 of the unit (course day 68) · about 55–75 minutes

**Today's focus:** the special properties of water
...
- Explain the special properties of water using evidence, a model, or a documented process rather than an unsupported answer.
- Apply the special properties of water to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on the special properties of water against the stated success criteria and name the next step.
...
- Science brief: water expands on freezing, so ice is less dense than liquid water and floats.
- Science brief: water has an unusually high specific heat capacity and a high heat of vaporisation.
- Science brief: water's polarity and its hydrogen bonding account for its high specific heat, high heat of vaporisation, high surface tension, and its capacity to dissolve many substances.
- Science brief: ice floating means lakes freeze from the top down, insulating the water beneath and allowing aquatic life to survive winter.

### Evidence check: the special properties of water

**Candidate claim:** A case report presents this as acceptable science: “ice is denser than liquid water.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: water expands on freezing, so ice is less dense than liquid water and floats. |
| E2 | established science reference | Science brief: water has an unusually high specific heat capacity and a high heat of vaporisation. |
| E3 | established science reference | Science brief: water's polarity and its hydrogen bonding account for its high specific heat, high heat of vaporisation, high surface tension, and its capacity to dissolve many substances. |
| E4 | established science reference | Science brief: ice floating means lakes freeze from the top down, insulating the water beneath and allowing aquatic life to survive winter. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs12-earth-space-environmental-u06::the special properties of water, derived from the reviewed correctness source policy/correctness/ma-hs12-earth-space-environmental.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about the special properties of water, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about the special properties of water, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about the special properties of water, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain the special properties of water in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for the special properties of water. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about the special properties of water, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using the special properties of water as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about the special properties of water? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about the special properties of water that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about the special properties of water. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about the special properties of water.
...
- Apply the special properties of water under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect the special properties of water to weathering and erosion from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs12-earth-space-environmental-u06-l08` · lesson `ma-hs12-earth-space-environmental-u06-l08` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
