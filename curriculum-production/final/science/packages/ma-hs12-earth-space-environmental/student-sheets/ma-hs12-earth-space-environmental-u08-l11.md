# Unit assessment: resource availability and human settlement

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 8: Coevolution of Earth and Life, Resources, and Natural Hazards · Day 11 of the unit (course day 95) · about 55–75 minutes

**Today's focus:** resource availability and human settlement
...
- Demonstrate independent mastery evidence for resource availability and human settlement on a fresh task.
- Explain resource availability and human settlement using evidence, a model, or a documented process rather than an unsupported answer.
- Apply resource availability and human settlement to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on resource availability and human settlement against the stated success criteria and name the next step.
...
- Science brief: where people settle has been shaped by access to water, arable soil, energy, materials, and transport routes.
- Science brief: settlement in hazard-prone locations often reflects the resources that make those locations valuable, such as fertile volcanic soils and river floodplains.
- Science brief: resource availability changes over time through depletion, technology, and climate, and settlement patterns respond with a lag.

### Evidence check: resource availability and human settlement

**Candidate claim:** A case report presents this as acceptable science: “settlement patterns are unrelated to the physical distribution of resources.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: where people settle has been shaped by access to water, arable soil, energy, materials, and transport routes. |
| E2 | established science reference | Science brief: settlement in hazard-prone locations often reflects the resources that make those locations valuable, such as fertile volcanic soils and river floodplains. |
| E3 | established science reference | Science brief: resource availability changes over time through depletion, technology, and climate, and settlement patterns respond with a lag. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs12-earth-space-environmental-u08::resource availability and human settlement, derived from the reviewed correctness source policy/correctness/ma-hs12-earth-space-environmental.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about resource availability and human settlement, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about resource availability and human settlement, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about resource availability and human settlement, then name one check that would catch an error or a weak claim.**
...
**Q1.** Without copying a sentence from the brief, evaluate the printed candidate case about resource availability and human settlement. Cite E1-E3, write the reasoning in your own words, and correct the case claim so it fits exactly what the record establishes.

>

**Q2.** Explain resource availability and human settlement in your own words using at least two specifically named rows from E1-E3. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for resource availability and human settlement. Decide whether E1-E3 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about resource availability and human settlement, revise its weakest claim with a named row from E1-E3, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using resource availability and human settlement as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E3 is strongest for evaluating the candidate claim about resource availability and human settlement? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E3, state one conclusion about resource availability and human settlement that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about resource availability and human settlement. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about resource availability and human settlement.
...
- Apply resource availability and human settlement under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect resource availability and human settlement to the Great Oxidation Event and atmospheric change from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs12-earth-space-environmental-u08-l11` · lesson `ma-hs12-earth-space-environmental-u08-l11` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
