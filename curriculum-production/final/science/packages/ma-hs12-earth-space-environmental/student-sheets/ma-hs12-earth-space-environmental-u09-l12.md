# Correction and reflection: defending a design under uncertainty

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 9: Sustainability Engineering and the Grade 12 Capstone · Day 12 of the unit (course day 108) · about 55–75 minutes

**Today's focus:** defending a design under uncertainty
...
- Explain defending a design under uncertainty using evidence, a model, or a documented process rather than an unsupported answer.
- Apply defending a design under uncertainty to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on defending a design under uncertainty against the stated success criteria and name the next step.
...
- Science brief: defending a design means stating the evidence, the assumptions, the uncertainty, and what result would change the recommendation.
- Science brief: uncertainty is a reason to state the range of outcomes and to build in adaptability, not a reason to withhold a recommendation.
- Science brief: the strongest objection is addressed directly rather than omitted.

### Evidence check: defending a design under uncertainty

**Candidate claim:** A case report presents this as acceptable science: “presenting a recommendation with no acknowledgement of its uncertainties.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: defending a design means stating the evidence, the assumptions, the uncertainty, and what result would change the recommendation. |
| E2 | established science reference | Science brief: uncertainty is a reason to state the range of outcomes and to build in adaptability, not a reason to withhold a recommendation. |
| E3 | established science reference | Science brief: the strongest objection is addressed directly rather than omitted. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs12-earth-space-environmental-u09::defending a design under uncertainty, derived from the reviewed correctness source policy/correctness/ma-hs12-earth-space-environmental.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about defending a design under uncertainty, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about defending a design under uncertainty, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about defending a design under uncertainty, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain defending a design under uncertainty in your own words using at least two specifically named rows from E1-E3. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for defending a design under uncertainty. Decide whether E1-E3 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about defending a design under uncertainty, revise its weakest claim with a named row from E1-E3, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using defending a design under uncertainty as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about defending a design under uncertainty? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about defending a design under uncertainty that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about defending a design under uncertainty. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about defending a design under uncertainty.
...
- Apply defending a design under uncertainty under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect defending a design under uncertainty to criteria, constraints, and prioritisation from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs12-earth-space-environmental-u09-l12` · lesson `ma-hs12-earth-space-environmental-u09-l12` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
