# Correction and reflection: evidence-based forecasting

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 7: Climate, Energy Flow, and the Carbon Cycle · Day 12 of the unit (course day 84) · about 55–75 minutes

**Today's focus:** evidence-based forecasting
...
- Explain evidence-based forecasting using evidence, a model, or a documented process rather than an unsupported answer.
- Apply evidence-based forecasting to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on evidence-based forecasting against the stated success criteria and name the next step.
...
- Science brief: a forecast states what is projected, under what assumptions, over what period, and with what uncertainty.
- Science brief: a forecast is evaluated over many predictions against what actually occurred, not by a single instance.
- Science brief: distinguishing a projection conditional on a scenario from an unconditional prediction is essential to evaluating either.

### Evidence check: evidence-based forecasting

**Candidate claim:** A case report presents this as acceptable science: “judging a probabilistic forecast wrong on the basis of one outcome.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a forecast states what is projected, under what assumptions, over what period, and with what uncertainty. |
| E2 | established science reference | Science brief: a forecast is evaluated over many predictions against what actually occurred, not by a single instance. |
| E3 | established science reference | Science brief: distinguishing a projection conditional on a scenario from an unconditional prediction is essential to evaluating either. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs12-earth-space-environmental-u07::evidence-based forecasting, derived from the reviewed correctness source policy/correctness/ma-hs12-earth-space-environmental.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about evidence-based forecasting, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about evidence-based forecasting, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about evidence-based forecasting, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain evidence-based forecasting in your own words using at least two specifically named rows from E1-E3. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for evidence-based forecasting. Decide whether E1-E3 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about evidence-based forecasting, revise its weakest claim with a named row from E1-E3, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using evidence-based forecasting as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about evidence-based forecasting? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about evidence-based forecasting that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about evidence-based forecasting. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about evidence-based forecasting.
...
- Apply evidence-based forecasting under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect evidence-based forecasting to energy flow into and out of Earth systems from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs12-earth-space-environmental-u07-l12` · lesson `ma-hs12-earth-space-environmental-u07-l12` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
