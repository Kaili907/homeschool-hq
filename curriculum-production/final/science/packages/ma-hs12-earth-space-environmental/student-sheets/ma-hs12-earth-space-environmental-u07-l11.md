# Unit assessment: climate models and their uncertainty

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 7: Climate, Energy Flow, and the Carbon Cycle · Day 11 of the unit (course day 83) · about 55–75 minutes

**Today's focus:** climate models and their uncertainty
...
- Demonstrate independent mastery evidence for climate models and their uncertainty on a fresh task.
- Explain climate models and their uncertainty using evidence, a model, or a documented process rather than an unsupported answer.
- Apply climate models and their uncertainty to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on climate models and their uncertainty against the stated success criteria and name the next step.
...
- Science brief: climate models are built from physical laws and are tested against past and present observations before being used for projection.
- Science brief: projections are given as ranges under stated scenarios, because future emissions are a choice and the physics carries its own uncertainty.
- Science brief: model uncertainty is quantified; it is not a statement that the projections carry no information.

### Evidence check: climate models and their uncertainty

**Candidate claim:** A case report presents this as acceptable science: “treating a projection range as evidence that models are uninformative.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: climate models are built from physical laws and are tested against past and present observations before being used for projection. |
| E2 | established science reference | Science brief: projections are given as ranges under stated scenarios, because future emissions are a choice and the physics carries its own uncertainty. |
| E3 | established science reference | Science brief: model uncertainty is quantified; it is not a statement that the projections carry no information. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs12-earth-space-environmental-u07::climate models and their uncertainty, derived from the reviewed correctness source policy/correctness/ma-hs12-earth-space-environmental.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about climate models and their uncertainty, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about climate models and their uncertainty, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about climate models and their uncertainty, then name one check that would catch an error or a weak claim.**
...
**Q1.** Without copying a sentence from the brief, evaluate the printed candidate case about climate models and their uncertainty. Cite E1-E3, write the reasoning in your own words, and correct the case claim so it fits exactly what the record establishes.

>

**Q2.** Explain climate models and their uncertainty in your own words using at least two specifically named rows from E1-E3. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for climate models and their uncertainty. Decide whether E1-E3 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about climate models and their uncertainty, revise its weakest claim with a named row from E1-E3, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using climate models and their uncertainty as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E3 is strongest for evaluating the candidate claim about climate models and their uncertainty? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E3, state one conclusion about climate models and their uncertainty that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about climate models and their uncertainty. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about climate models and their uncertainty.
...
- Apply climate models and their uncertainty under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect climate models and their uncertainty to energy flow into and out of Earth systems from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs12-earth-space-environmental-u07-l11` · lesson `ma-hs12-earth-space-environmental-u07-l11` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
