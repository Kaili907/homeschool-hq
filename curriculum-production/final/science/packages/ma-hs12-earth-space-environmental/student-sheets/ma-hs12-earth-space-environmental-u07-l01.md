# Launch and diagnostic: energy flow into and out of Earth systems

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 7: Climate, Energy Flow, and the Carbon Cycle · Day 1 of the unit (course day 73) · about 55–75 minutes
...
- Observe the anchoring phenomenon, surface initial thinking about energy flow into and out of Earth systems without penalty, and pose a testable question.
...
**The task.** What does evidence E1 through E4 justify about energy flow into and out of Earth systems, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**Q1.** Use the printed case as today's phenomenon for energy flow into and out of Earth systems. Record what the candidate claim says, identify the mismatch with E1-E4, and pose a testable question naming what would change and what would be measured or classified.
...
_Package `swp-ma-hs12-earth-space-environmental-u07-l01` · lesson `ma-hs12-earth-space-environmental-u07-l01` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
