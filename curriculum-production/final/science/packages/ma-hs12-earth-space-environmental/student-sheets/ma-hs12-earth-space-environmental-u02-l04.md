# Independent application A: nucleosynthesis and element formation

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 2: The Sun, Stars, and the Origin of the Elements · Day 4 of the unit (course day 16) · about 55–75 minutes

**Today's focus:** nucleosynthesis and element formation
...
- Explain nucleosynthesis and element formation using evidence, a model, or a documented process rather than an unsupported answer.
- Apply nucleosynthesis and element formation to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on nucleosynthesis and element formation against the stated success criteria and name the next step.
...
- Science brief: hydrogen and helium formed in the early universe; elements up to iron are produced by fusion in stars; most elements heavier than iron are produced by neutron capture in evolved stars and in explosive events.
- Science brief: fusion releases energy up to iron, and beyond iron fusion consumes rather than releases energy, which is why stellar fusion does not build the heaviest elements.
- Science brief: heavier elements are dispersed into space by stellar winds and supernovae, enriching the material from which later stars and planets form.
- Science brief: the atoms in Earth and in living things were produced in earlier generations of stars.

### Evidence check: nucleosynthesis and element formation

**Candidate claim:** A case report presents this as acceptable science: “all elements were produced in the Big Bang.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: hydrogen and helium formed in the early universe; elements up to iron are produced by fusion in stars; most elements heavier than iron are produced by neutron capture in evolved stars and in explosive events. |
| E2 | established science reference | Science brief: fusion releases energy up to iron, and beyond iron fusion consumes rather than releases energy, which is why stellar fusion does not build the heaviest elements. |
| E3 | established science reference | Science brief: heavier elements are dispersed into space by stellar winds and supernovae, enriching the material from which later stars and planets form. |
| E4 | established science reference | Science brief: the atoms in Earth and in living things were produced in earlier generations of stars. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs12-earth-space-environmental-u02::nucleosynthesis and element formation, derived from the reviewed correctness source policy/correctness/ma-hs12-earth-space-environmental.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about nucleosynthesis and element formation, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about nucleosynthesis and element formation, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about nucleosynthesis and element formation, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain nucleosynthesis and element formation in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for nucleosynthesis and element formation. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about nucleosynthesis and element formation, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using nucleosynthesis and element formation as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about nucleosynthesis and element formation? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about nucleosynthesis and element formation that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about nucleosynthesis and element formation. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about nucleosynthesis and element formation.
...
- Apply nucleosynthesis and element formation under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect nucleosynthesis and element formation to nuclear fusion in stellar cores from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs12-earth-space-environmental-u02-l04` · lesson `ma-hs12-earth-space-environmental-u02-l04` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
