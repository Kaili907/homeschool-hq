# Unit assessment: human alteration of surface processes

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 6: Surface Processes, Water, and Earth System Feedbacks · Day 11 of the unit (course day 71) · about 55–75 minutes

**Today's focus:** human alteration of surface processes
...
- Demonstrate independent mastery evidence for human alteration of surface processes on a fresh task.
- Explain human alteration of surface processes using evidence, a model, or a documented process rather than an unsupported answer.
- Apply human alteration of surface processes to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on human alteration of surface processes against the stated success criteria and name the next step.
...
- Science brief: land clearing, agriculture, construction, damming, and channel modification change rates of erosion, deposition, infiltration, and runoff.
- Science brief: altering one part of a surface system changes others, often downstream or after a delay.
- Science brief: human activity now moves more sediment and earth material annually than many natural processes do.

### Evidence check: human alteration of surface processes

**Candidate claim:** A case report presents this as acceptable science: “a local land-use change has only local effects.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: land clearing, agriculture, construction, damming, and channel modification change rates of erosion, deposition, infiltration, and runoff. |
| E2 | established science reference | Science brief: altering one part of a surface system changes others, often downstream or after a delay. |
| E3 | established science reference | Science brief: human activity now moves more sediment and earth material annually than many natural processes do. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs12-earth-space-environmental-u06::human alteration of surface processes, derived from the reviewed correctness source policy/correctness/ma-hs12-earth-space-environmental.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about human alteration of surface processes, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about human alteration of surface processes, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about human alteration of surface processes, then name one check that would catch an error or a weak claim.**
...
**Q1.** Without copying a sentence from the brief, evaluate the printed candidate case about human alteration of surface processes. Cite E1-E3, write the reasoning in your own words, and correct the case claim so it fits exactly what the record establishes.

>

**Q2.** Explain human alteration of surface processes in your own words using at least two specifically named rows from E1-E3. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for human alteration of surface processes. Decide whether E1-E3 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about human alteration of surface processes, revise its weakest claim with a named row from E1-E3, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using human alteration of surface processes as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E3 is strongest for evaluating the candidate claim about human alteration of surface processes? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E3, state one conclusion about human alteration of surface processes that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about human alteration of surface processes. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about human alteration of surface processes.
...
- Apply human alteration of surface processes under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect human alteration of surface processes to weathering and erosion from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs12-earth-space-environmental-u06-l11` · lesson `ma-hs12-earth-space-environmental-u06-l11` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
