# Reteach and varied practice: the sun's energy budget and lifespan

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 2: The Sun, Stars, and the Origin of the Elements · Day 8 of the unit (course day 20) · about 55–75 minutes

**Today's focus:** the sun's energy budget and lifespan
...
- Apply the sun's energy budget and lifespan to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on the sun's energy budget and lifespan against the stated success criteria and name the next step.
...
- Science brief: the Sun is roughly 4.6 billion years old and is about halfway through its main-sequence lifetime.
- Science brief: the Sun will end as a white dwarf, not as a supernova.
- Science brief: the Sun's energy output is set by the rate of fusion in its core, which is regulated by the balance between gravity and pressure.
- Science brief: essentially all the energy driving Earth's surface processes, weather, and life originates from the Sun, with geothermal and tidal energy as small additional contributions.

### Evidence check: the sun's energy budget and lifespan

**Candidate claim:** A case report presents this as acceptable science: “the Sun will explode as a supernova.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: the Sun is roughly 4.6 billion years old and is about halfway through its main-sequence lifetime. |
| E2 | established science reference | Science brief: the Sun will end as a white dwarf, not as a supernova. |
| E3 | established science reference | Science brief: the Sun's energy output is set by the rate of fusion in its core, which is regulated by the balance between gravity and pressure. |
| E4 | established science reference | Science brief: essentially all the energy driving Earth's surface processes, weather, and life originates from the Sun, with geothermal and tidal energy as small additional contributions. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs12-earth-space-environmental-u02::the sun's energy budget and lifespan, derived from the reviewed correctness source policy/correctness/ma-hs12-earth-space-environmental.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about the sun's energy budget and lifespan, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about the sun's energy budget and lifespan, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about the sun's energy budget and lifespan, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain the sun's energy budget and lifespan in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for the sun's energy budget and lifespan. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about the sun's energy budget and lifespan, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using the sun's energy budget and lifespan as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about the sun's energy budget and lifespan? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about the sun's energy budget and lifespan that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about the sun's energy budget and lifespan. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about the sun's energy budget and lifespan.
...
- Apply the sun's energy budget and lifespan under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect the sun's energy budget and lifespan to nuclear fusion in stellar cores from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs12-earth-space-environmental-u02-l08` · lesson `ma-hs12-earth-space-environmental-u02-l08` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
