# Investigation: energy flow into and out of Earth systems

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 7: Climate, Energy Flow, and the Carbon Cycle · Day 7 of the unit (course day 79) · about 61–84 minutes

**Today's focus:** energy flow into and out of Earth systems
...
- Plan and carry out a safe investigation of energy flow into and out of Earth systems, or its stated alternative, and record the learner's own data with its uncertainty.
- Explain energy flow into and out of Earth systems using evidence, a model, or a documented process rather than an unsupported answer.
- Apply energy flow into and out of Earth systems to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on energy flow into and out of Earth systems against the stated success criteria and name the next step.
...
- clear covering
- lamp or sunlight
- published climate and carbon flux datasets
...
- **Physical hazard.** A lamp used as a light source gets hot and must stay away from water.
  - What stops it: Use an LED lamp only - never incandescent or halogen. Keep it at least 30 cm from containers, never above water, and let an adult position it. Allow it to cool before moving.
- **Emotional hazard.** Climate content can produce genuine anxiety about the future.
  - What stops it: Pair every impact with documented response options and human agency, keep the framing on evidence and design, and let the learner pause or redirect at any time.
...
**Clearing up.** Once the lamp is off and cool, pour the water down the drain and dry the containers, then unplug the lamp and put it away. Nothing hazardous is produced.
...
- Science brief: earth's climate is set by the balance between incoming solar radiation and outgoing infrared radiation.
- Science brief: incoming solar energy is absorbed, reflected, or scattered, and the reflective fraction is the albedo.
- Science brief: earth radiates energy back to space as infrared, and long-term temperature is set by the balance between incoming and outgoing.
- Science brief: anything that changes absorbed solar energy or outgoing infrared changes the balance and therefore the temperature.

### Evidence check: energy flow into and out of Earth systems

**Candidate claim:** A case report presents this as acceptable science: “earth's surface temperature is set by incoming solar radiation alone with no role for outgoing radiation.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: earth's climate is set by the balance between incoming solar radiation and outgoing infrared radiation. |
| E2 | established science reference | Science brief: incoming solar energy is absorbed, reflected, or scattered, and the reflective fraction is the albedo. |
| E3 | established science reference | Science brief: earth radiates energy back to space as infrared, and long-term temperature is set by the balance between incoming and outgoing. |
| E4 | established science reference | Science brief: anything that changes absorbed solar energy or outgoing infrared changes the balance and therefore the temperature. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs12-earth-space-environmental-u07::energy flow into and out of Earth systems, derived from the reviewed correctness source policy/correctness/ma-hs12-earth-space-environmental.correctness.json.

**Supplied unit connections:** energy flow into and out of Earth systems; the greenhouse effect; the global carbon cycle; climate versus weather; climate models and their uncertainty; evidence-based forecasting

**Supplied unit performance task:** Use a model of Earth's energy flows and a quantitative carbon-cycle model to make an evidence-based forecast of climate change, with the forecast's uncertainty stated explicitly.

### Bound task

**Question:** What does evidence E1 through E4 justify about energy flow into and out of Earth systems, and does it support the candidate claim?
...
| --- | --- | --- | --- | --- | --- |
| A | 340 | 100 | calculate | 240 | calculate |
| B | 340 | 110 | calculate | 230 | calculate |
| C | 340 | 90 | calculate | 245 | calculate |
| D | 350 | 100 | calculate | 240 | calculate |

**Model/source rule:** Absorbed=incoming-reflected; net=absorbed-outgoing. Positive net adds energy to the modeled system and negative net removes it.
...
3. Complete the table, compare albedo and outgoing-energy changes, and state why the sign of net energy is not itself a forecast of exact future temperature.
...
**Pinned H4 alternative statement (lineage evidence):** Run the energy-balance comparison in sunlight rather than under a lamp, or skip the physical model entirely and build the energy budget and carbon-cycle quantification from published flux data. Paper and calculator only.
...
**My question.** Write the question you are testing about energy flow into and out of Earth systems. It has to be a question your evidence could actually answer.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about energy flow into and out of Earth systems, then name one check that would catch an error or a weak claim.**
...
**Q1.** Complete the route you chose. For the document/model route, use its printed procedure and input table; for the H4 physical route, use the printed safe order and your own blank record. Report the route, evidence IDs or model rows, conclusion about energy flow into and out of Earth systems, uncertainty, and limitation.

>

**Q2.** Explain energy flow into and out of Earth systems in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for energy flow into and out of Earth systems. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about energy flow into and out of Earth systems, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using energy flow into and out of Earth systems as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E4 is strongest for evaluating the candidate claim about energy flow into and out of Earth systems? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E4, state one conclusion about energy flow into and out of Earth systems that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about energy flow into and out of Earth systems. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about energy flow into and out of Earth systems.
...
- Apply energy flow into and out of Earth systems under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect energy flow into and out of Earth systems to the greenhouse effect from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Use a model of Earth's energy flows and a quantitative carbon-cycle model to make an evidence-based forecast of climate change, with the forecast's uncertainty stated explicitly. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-hs12-earth-space-environmental-u07-l07` · lesson `ma-hs12-earth-space-environmental-u07-l07` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
