# Independent application A: natural hazards and their causes

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 8: Coevolution of Earth and Life, Resources, and Natural Hazards · Day 4 of the unit (course day 88) · about 55–75 minutes

**Today's focus:** natural hazards and their causes
...
- Explain natural hazards and their causes using evidence, a model, or a documented process rather than an unsupported answer.
- Apply natural hazards and their causes to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on natural hazards and their causes against the stated success criteria and name the next step.
...
- Science brief: earthquakes and volcanoes occur predominantly at plate boundaries, and their global distribution follows those boundaries.
- Science brief: each hazard has a physical cause, and understanding the cause is what makes the hazard mappable and, in some cases, forecastable.
- Science brief: hazard forecasting is generally probabilistic: the likelihood over a period can be estimated where the timing of a specific event cannot.
- Science brief: a hazard becomes a disaster through exposure and vulnerability, so risk depends on people and infrastructure as well as on the physical event.

### Evidence check: natural hazards and their causes

**Candidate claim:** A case report presents this as acceptable science: “individual earthquakes can be predicted for a specific day and place with current science.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: earthquakes and volcanoes occur predominantly at plate boundaries, and their global distribution follows those boundaries. |
| E2 | established science reference | Science brief: each hazard has a physical cause, and understanding the cause is what makes the hazard mappable and, in some cases, forecastable. |
| E3 | established science reference | Science brief: hazard forecasting is generally probabilistic: the likelihood over a period can be estimated where the timing of a specific event cannot. |
| E4 | established science reference | Science brief: a hazard becomes a disaster through exposure and vulnerability, so risk depends on people and infrastructure as well as on the physical event. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs12-earth-space-environmental-u08::natural hazards and their causes, derived from the reviewed correctness source policy/correctness/ma-hs12-earth-space-environmental.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about natural hazards and their causes, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about natural hazards and their causes, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about natural hazards and their causes, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain natural hazards and their causes in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for natural hazards and their causes. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about natural hazards and their causes, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using natural hazards and their causes as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about natural hazards and their causes? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about natural hazards and their causes that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about natural hazards and their causes. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about natural hazards and their causes.
...
- Apply natural hazards and their causes under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect natural hazards and their causes to the Great Oxidation Event and atmospheric change from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs12-earth-space-environmental-u08-l04` · lesson `ma-hs12-earth-space-environmental-u08-l04` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
