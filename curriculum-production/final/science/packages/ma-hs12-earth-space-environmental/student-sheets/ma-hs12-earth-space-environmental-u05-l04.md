# Independent application A: continental and oceanic crust formation

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 5: Plate Tectonics and the History of Earth · Day 4 of the unit (course day 52) · about 55–75 minutes

**Today's focus:** continental and oceanic crust formation
...
- Apply continental and oceanic crust formation to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on continental and oceanic crust formation against the stated success criteria and name the next step.
...
- Science brief: oceanic crust is denser and thinner than continental crust, which is why oceanic crust subducts beneath continental crust.
- Science brief: oceanic crust forms at spreading ridges from mantle-derived magma and is returned to the mantle at subduction zones.
- Science brief: continental crust is less dense, so it resists subduction and can survive for billions of years.
- Science brief: subduction generates magma that rises to build volcanic arcs and adds to continental crust over time.

### Evidence check: continental and oceanic crust formation

**Candidate claim:** A case report presents this as acceptable science: “continental crust subducts beneath oceanic crust.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: oceanic crust is denser and thinner than continental crust, which is why oceanic crust subducts beneath continental crust. |
| E2 | established science reference | Science brief: oceanic crust forms at spreading ridges from mantle-derived magma and is returned to the mantle at subduction zones. |
| E3 | established science reference | Science brief: continental crust is less dense, so it resists subduction and can survive for billions of years. |
| E4 | established science reference | Science brief: subduction generates magma that rises to build volcanic arcs and adds to continental crust over time. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs12-earth-space-environmental-u05::continental and oceanic crust formation, derived from the reviewed correctness source policy/correctness/ma-hs12-earth-space-environmental.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about continental and oceanic crust formation, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about continental and oceanic crust formation, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about continental and oceanic crust formation, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain continental and oceanic crust formation in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for continental and oceanic crust formation. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about continental and oceanic crust formation, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using continental and oceanic crust formation as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about continental and oceanic crust formation? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about continental and oceanic crust formation that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about continental and oceanic crust formation. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about continental and oceanic crust formation.
...
- Apply continental and oceanic crust formation under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect continental and oceanic crust formation to evidence for plate motion from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs12-earth-space-environmental-u05-l04` · lesson `ma-hs12-earth-space-environmental-u05-l04` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
