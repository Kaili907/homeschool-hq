# Guided practice B: solar system architecture

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 4: Orbital Motion and the Solar System · Day 6 of the unit (course day 42) · about 55–75 minutes
...
_Package `swp-ma-hs12-earth-space-environmental-u04-l06` · lesson `ma-hs12-earth-space-environmental-u04-l06` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
