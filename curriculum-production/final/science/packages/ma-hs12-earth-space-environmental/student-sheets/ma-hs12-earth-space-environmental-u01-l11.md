# Unit assessment: reading and building graphs honestly

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 1: Earth and Space Systems, Scale, and Data Practice · Day 11 of the unit (course day 11) · about 55–75 minutes

**Today's focus:** reading and building graphs honestly
...
- Demonstrate independent mastery evidence for reading and building graphs honestly on a fresh task.
- Explain reading and building graphs honestly using evidence, a model, or a documented process rather than an unsupported answer.
- Apply reading and building graphs honestly to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on reading and building graphs honestly against the stated success criteria and name the next step.
...
- Science brief: axis range, scale type, and baseline choice change how a graph reads without changing the underlying data.
- Science brief: a graph states its data source, its date, and its units, or the reader cannot check it.
- Science brief: extrapolation beyond the data is labelled as such, because the data does not support it.

### Evidence check: reading and building graphs honestly

**Candidate claim:** A case report presents this as acceptable science: “presenting an extrapolation as though it were measured data.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: axis range, scale type, and baseline choice change how a graph reads without changing the underlying data. |
| E2 | established science reference | Science brief: a graph states its data source, its date, and its units, or the reader cannot check it. |
| E3 | established science reference | Science brief: extrapolation beyond the data is labelled as such, because the data does not support it. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs12-earth-space-environmental-u01::reading and building graphs honestly, derived from the reviewed correctness source policy/correctness/ma-hs12-earth-space-environmental.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about reading and building graphs honestly, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about reading and building graphs honestly, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about reading and building graphs honestly, then name one check that would catch an error or a weak claim.**
...
**Q1.** Without copying a sentence from the brief, evaluate the printed candidate case about reading and building graphs honestly. Cite E1-E3, write the reasoning in your own words, and correct the case claim so it fits exactly what the record establishes.

>

**Q2.** Explain reading and building graphs honestly in your own words using at least two specifically named rows from E1-E3. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for reading and building graphs honestly. Decide whether E1-E3 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about reading and building graphs honestly, revise its weakest claim with a named row from E1-E3, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using reading and building graphs honestly as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E3 is strongest for evaluating the candidate claim about reading and building graphs honestly? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E3, state one conclusion about reading and building graphs honestly that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about reading and building graphs honestly. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about reading and building graphs honestly.
...
- Apply reading and building graphs honestly under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect reading and building graphs honestly to systems and system models from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs12-earth-space-environmental-u01-l11` · lesson `ma-hs12-earth-space-environmental-u01-l11` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
