# Guided practice A: convection in Earth's interior

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 5: Plate Tectonics and the History of Earth · Day 3 of the unit (course day 51) · about 55–75 minutes
...
- Science brief: earth's mantle is solid rock that deforms and flows very slowly; it is not a liquid layer.
- Science brief: heat from Earth's interior, from residual formation heat and radioactive decay, drives slow convective flow in the mantle.
- Science brief: mantle flow, together with the pull of dense subducting slabs and the push at ridges, drives plate motion.
- Science brief: the mantle behaves as a solid on short timescales and flows on geological ones, which is why seismic shear waves pass through it.

### Evidence check: convection in Earth's interior

**Candidate claim:** A case report presents this as acceptable science: “the plates float on a layer of liquid magma.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: earth's mantle is solid rock that deforms and flows very slowly; it is not a liquid layer. |
| E2 | established science reference | Science brief: heat from Earth's interior, from residual formation heat and radioactive decay, drives slow convective flow in the mantle. |
| E3 | established science reference | Science brief: mantle flow, together with the pull of dense subducting slabs and the push at ridges, drives plate motion. |
| E4 | established science reference | Science brief: the mantle behaves as a solid on short timescales and flows on geological ones, which is why seismic shear waves pass through it. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs12-earth-space-environmental-u05::convection in Earth's interior, derived from the reviewed correctness source policy/correctness/ma-hs12-earth-space-environmental.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about convection in Earth's interior, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about convection in Earth's interior, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**Q1.** Explain convection in Earth's interior in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for convection in Earth's interior. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about convection in Earth's interior, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using convection in Earth's interior as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about convection in Earth's interior? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about convection in Earth's interior that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about convection in Earth's interior. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
_Package `swp-ma-hs12-earth-space-environmental-u05-l03` · lesson `ma-hs12-earth-space-environmental-u05-l03` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
