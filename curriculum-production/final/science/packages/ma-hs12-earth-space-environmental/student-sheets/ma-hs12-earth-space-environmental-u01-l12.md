# Correction and reflection: distinguishing correlation and causation

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 1: Earth and Space Systems, Scale, and Data Practice · Day 12 of the unit (course day 12) · about 55–75 minutes

**Today's focus:** distinguishing correlation and causation
...
- Explain distinguishing correlation and causation using evidence, a model, or a documented process rather than an unsupported answer.
- Apply distinguishing correlation and causation to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on distinguishing correlation and causation against the stated success criteria and name the next step.
...
- Science brief: correlation between two variables does not establish that one causes the other.
- Science brief: two variables can correlate because one causes the other, because a third factor drives both, or by coincidence in a limited sample.
- Science brief: establishing causation requires a mechanism, evidence that cause precedes effect, and where possible a controlled comparison.
- Science brief: in Earth science, controlled experiments are often impossible, so causal claims rest on mechanism plus multiple independent lines of evidence.

### Evidence check: distinguishing correlation and causation

**Candidate claim:** A case report presents this as acceptable science: “inferring causation from correlation alone.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: correlation between two variables does not establish that one causes the other. |
| E2 | established science reference | Science brief: two variables can correlate because one causes the other, because a third factor drives both, or by coincidence in a limited sample. |
| E3 | established science reference | Science brief: establishing causation requires a mechanism, evidence that cause precedes effect, and where possible a controlled comparison. |
| E4 | established science reference | Science brief: in Earth science, controlled experiments are often impossible, so causal claims rest on mechanism plus multiple independent lines of evidence. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs12-earth-space-environmental-u01::distinguishing correlation and causation, derived from the reviewed correctness source policy/correctness/ma-hs12-earth-space-environmental.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about distinguishing correlation and causation, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about distinguishing correlation and causation, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about distinguishing correlation and causation, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain distinguishing correlation and causation in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for distinguishing correlation and causation. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about distinguishing correlation and causation, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using distinguishing correlation and causation as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about distinguishing correlation and causation? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about distinguishing correlation and causation that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about distinguishing correlation and causation. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about distinguishing correlation and causation.
...
- Apply distinguishing correlation and causation under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect distinguishing correlation and causation to systems and system models from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs12-earth-space-environmental-u01-l12` · lesson `ma-hs12-earth-space-environmental-u01-l12` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
