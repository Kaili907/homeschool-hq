# Correction and reflection: solar system architecture

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 4: Orbital Motion and the Solar System · Day 12 of the unit (course day 48) · about 55–75 minutes

**Today's focus:** solar system architecture
...
- Explain solar system architecture using evidence, a model, or a documented process rather than an unsupported answer.
- Apply solar system architecture to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on solar system architecture against the stated success criteria and name the next step.
...
- Science brief: the inner planets are small and rocky; the outer planets are large and gas- or ice-rich, and this pattern reflects conditions in the forming solar nebula.
- Science brief: the solar system formed from a rotating disc of gas and dust, which is why the planets orbit in nearly the same plane and direction.
- Science brief: temperature in the disc decreased with distance from the young Sun, so volatile materials could condense only in the outer regions.
- Science brief: asteroids, comets, and Kuiper belt objects are remnants of that formation process and carry evidence about it.

### Evidence check: solar system architecture

**Candidate claim:** A case report presents this as acceptable science: “the planets formed independently and were later captured by the Sun.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: the inner planets are small and rocky; the outer planets are large and gas- or ice-rich, and this pattern reflects conditions in the forming solar nebula. |
| E2 | established science reference | Science brief: the solar system formed from a rotating disc of gas and dust, which is why the planets orbit in nearly the same plane and direction. |
| E3 | established science reference | Science brief: temperature in the disc decreased with distance from the young Sun, so volatile materials could condense only in the outer regions. |
| E4 | established science reference | Science brief: asteroids, comets, and Kuiper belt objects are remnants of that formation process and carry evidence about it. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs12-earth-space-environmental-u04::solar system architecture, derived from the reviewed correctness source policy/correctness/ma-hs12-earth-space-environmental.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about solar system architecture, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about solar system architecture, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about solar system architecture, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain solar system architecture in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for solar system architecture. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about solar system architecture, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using solar system architecture as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about solar system architecture? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about solar system architecture that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about solar system architecture. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about solar system architecture.
...
- Apply solar system architecture under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect solar system architecture to gravitational orbits from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs12-earth-space-environmental-u04-l12` · lesson `ma-hs12-earth-space-environmental-u04-l12` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
