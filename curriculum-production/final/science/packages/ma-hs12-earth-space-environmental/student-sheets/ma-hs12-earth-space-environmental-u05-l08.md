# Reteach and varied practice: seafloor age and magnetic striping

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 5: Plate Tectonics and the History of Earth · Day 8 of the unit (course day 56) · about 55–75 minutes

**Today's focus:** seafloor age and magnetic striping
...
- Explain seafloor age and magnetic striping using evidence, a model, or a documented process rather than an unsupported answer.
- Apply seafloor age and magnetic striping to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on seafloor age and magnetic striping against the stated success criteria and name the next step.
...
- Science brief: oceanic crust is youngest at mid-ocean ridges and progressively older away from them, symmetrically on both sides.
- Science brief: the oceanic crust is far younger than the continental crust, because it is continually created and destroyed.
- Science brief: new oceanic crust forms at ridges and records the direction of Earth's magnetic field as it cools.
- Science brief: because Earth's magnetic field has reversed many times, the seafloor carries symmetric bands of alternating magnetisation on either side of a ridge.

### Evidence check: seafloor age and magnetic striping

**Candidate claim:** A case report presents this as acceptable science: “the seafloor is oldest at the ridges.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: oceanic crust is youngest at mid-ocean ridges and progressively older away from them, symmetrically on both sides. |
| E2 | established science reference | Science brief: the oceanic crust is far younger than the continental crust, because it is continually created and destroyed. |
| E3 | established science reference | Science brief: new oceanic crust forms at ridges and records the direction of Earth's magnetic field as it cools. |
| E4 | established science reference | Science brief: because Earth's magnetic field has reversed many times, the seafloor carries symmetric bands of alternating magnetisation on either side of a ridge. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs12-earth-space-environmental-u05::seafloor age and magnetic striping, derived from the reviewed correctness source policy/correctness/ma-hs12-earth-space-environmental.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about seafloor age and magnetic striping, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about seafloor age and magnetic striping, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about seafloor age and magnetic striping, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain seafloor age and magnetic striping in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for seafloor age and magnetic striping. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about seafloor age and magnetic striping, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using seafloor age and magnetic striping as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about seafloor age and magnetic striping? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about seafloor age and magnetic striping that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about seafloor age and magnetic striping. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about seafloor age and magnetic striping.
...
- Apply seafloor age and magnetic striping under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect seafloor age and magnetic striping to evidence for plate motion from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs12-earth-space-environmental-u05-l08` · lesson `ma-hs12-earth-space-environmental-u05-l08` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
