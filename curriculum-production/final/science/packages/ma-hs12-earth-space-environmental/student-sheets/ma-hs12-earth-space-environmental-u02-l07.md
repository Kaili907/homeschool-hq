# Investigation: nuclear fusion in stellar cores

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 2: The Sun, Stars, and the Origin of the Elements · Day 7 of the unit (course day 19) · about 61–84 minutes

**Today's focus:** nuclear fusion in stellar cores
...
- Explain nuclear fusion in stellar cores using evidence, a model, or a documented process rather than an unsupported answer.
- Apply nuclear fusion in stellar cores to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on nuclear fusion in stellar cores against the stated success criteria and name the next step.

**Materials:**

- thermometer
- dark container of water
- timer
- measuring cup
- CD or diffraction grating
- published stellar spectra
- notebook
...
- **Physical hazard.** Looking at the sun causes permanent eye damage.
  - What stops it: NEVER look at the sun directly, through any lens, grating, CD, camera, or filter. All solar work is done by measuring warming water in shade-versus-sun, with the learner's back to the sun.
- **Physical hazard.** Working outdoors in sun risks heat and sunburn, and a sealed dark container left in full sun pressurises.
  - What stops it: Leave the water container OPEN - never capped or sealed - in the sun. Limit exposure to 30 minutes at a time, wear a hat and sunscreen, keep drinking water available, and work in the cooler part of the day.
...
**Clearing up.** Pour the water down the drain and dry the container, and return the CD or grating to its sleeve. Nothing hazardous is produced, and no image of the sun is captured by any means.
...
- Science brief: stars release energy by fusing lighter nuclei into heavier ones, principally hydrogen into helium during the main sequence.
- Science brief: fusion requires the extreme temperature and pressure found in stellar cores, because positively charged nuclei repel one another.
- Science brief: the energy released corresponds to the small mass difference between the reactants and the products.
- Science brief: the outward pressure from fusion balances the inward pull of gravity, which is what keeps a main-sequence star stable.

### Evidence check: nuclear fusion in stellar cores

**Candidate claim:** A case report presents this as acceptable science: “stars are powered by chemical combustion.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: stars release energy by fusing lighter nuclei into heavier ones, principally hydrogen into helium during the main sequence. |
| E2 | established science reference | Science brief: fusion requires the extreme temperature and pressure found in stellar cores, because positively charged nuclei repel one another. |
| E3 | established science reference | Science brief: the energy released corresponds to the small mass difference between the reactants and the products. |
| E4 | established science reference | Science brief: the outward pressure from fusion balances the inward pull of gravity, which is what keeps a main-sequence star stable. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs12-earth-space-environmental-u02::nuclear fusion in stellar cores, derived from the reviewed correctness source policy/correctness/ma-hs12-earth-space-environmental.correctness.json.

**Supplied unit connections:** nuclear fusion in stellar cores; the sun's energy budget and lifespan; stellar life cycles; nucleosynthesis and element formation; spectra as compositional evidence; communicating stellar science

**Supplied unit performance task:** Develop an evidence-based model of the sun's life span and energy source, and communicate how stars across their life cycle produce the elements in ordinary matter.

### Bound task

**Question:** What does evidence E1 through E4 justify about nuclear fusion in stellar cores, and does it support the candidate claim?
...
| B | 1.0 | 1.0 | 1.0 | 1.0 |
| C | 2.0 | 11.3 | 1.4 | 0.18 |
| D | 4.0 | 128.0 | 2.0 | 0.03 |

**Model/source rule:** Instructional scaling: luminosity=M^3.5 and lifetime=M/luminosity; core-temperature index=square root of mass.
...
3. Verify the model outputs, graph luminosity against mass on log axes, and explain why greater fuel supply does not give a massive star a longer main-sequence lifetime in this model.
...
**Pinned H4 alternative statement (lineage evidence):** Skip all outdoor solar work: compute the sun's power output and lifetime from published solar-constant and mass data, and identify elements from published stellar spectra images. Paper and calculator only. This is the DEFAULT path.
...
**My question.** Write the question you are testing about nuclear fusion in stellar cores. It has to be a question your evidence could actually answer.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about nuclear fusion in stellar cores, then name one check that would catch an error or a weak claim.**
...
**Q1.** Complete the route you chose. For the document/model route, use its printed procedure and input table; for the H4 physical route, use the printed safe order and your own blank record. Report the route, evidence IDs or model rows, conclusion about nuclear fusion in stellar cores, uncertainty, and limitation.

>

**Q2.** Explain nuclear fusion in stellar cores in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for nuclear fusion in stellar cores. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about nuclear fusion in stellar cores, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using nuclear fusion in stellar cores as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E4 is strongest for evaluating the candidate claim about nuclear fusion in stellar cores? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E4, state one conclusion about nuclear fusion in stellar cores that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about nuclear fusion in stellar cores. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about nuclear fusion in stellar cores.
...
- Apply nuclear fusion in stellar cores under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect nuclear fusion in stellar cores to the sun's energy budget and lifespan from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Develop an evidence-based model of the sun's life span and energy source, and communicate how stars across their life cycle produce the elements in ordinary matter. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-hs12-earth-space-environmental-u02-l07` · lesson `ma-hs12-earth-space-environmental-u02-l07` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
