# Performance task build: surface water and groundwater systems

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 6: Surface Processes, Water, and Earth System Feedbacks · Day 9 of the unit (course day 69) · about 61–84 minutes

**Today's focus:** surface water and groundwater systems
...
- Produce performance-task evidence for surface water and groundwater systems that a reader could check independently.
- Explain surface water and groundwater systems using evidence, a model, or a documented process rather than an unsupported answer.
- Apply surface water and groundwater systems to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on surface water and groundwater systems against the stated success criteria and name the next step.
...
- water
- a measuring cup kept for non-food use
- a large tray kept for non-food use to work over indoors
- a strainer kept for non-food use for pouring runoff into an outdoor drain
- timer
- ice
- thermometer
- gloves
- published watershed dataset
- notebook
...
- **Physical hazard.** Soil and outdoor materials carry bacteria and sharp fragments.
  - What stops it: Cover any cut or graze with a waterproof dressing before handling soil, wear gloves, keep hands away from the face, wash thoroughly afterwards, and never use soil from an area treated with pesticide or near a roadway.
- **Physical hazard.** Soil on kitchen equipment contaminates everything used with it afterwards.
  - What stops it: The trays, cups, and measuring container are labelled for this investigation and never return to food use. Nothing from this investigation is washed in a kitchen sink.
- **Physical hazard.** Water and soil together make surfaces slippery, and soil runoff blocks indoor drain traps.
  - What stops it: Work outdoors or over a large tray, clean spills immediately, and pour all runoff outdoors onto ground or through a strainer into an outdoor drain - never down a kitchen or bathroom sink.
- **Privacy hazard.** Photographing or logging a field site can reveal where the family lives.
  - What stops it: Record substrate type, slope, and conditions only. No address, GPS coordinate, or identifiable landmark is recorded, and no photograph is required.
...
**Clearing up.** Return the soil, sand, and gravel outdoors. Pour all muddy runoff outdoors onto ground, or through a strainer into an outdoor drain - NEVER down a kitchen or bathroom sink, where it blocks the trap. The trays, cups, measuring container, and gloves are washed outdoors, stay out of the kitchen, and never return to food use.
...
- Science brief: groundwater occupies pore spaces and fractures in rock and sediment; it does not generally flow in open underground rivers.
- Science brief: surface water and groundwater are connected: streams gain from or lose to groundwater depending on the water table.
- Science brief: groundwater moves far more slowly than surface water, so contamination is slow to appear and slow to clear.
- Science brief: extraction faster than recharge lowers the water table and can cause land subsidence and saltwater intrusion.

### Evidence check: surface water and groundwater systems

**Candidate claim:** A case report presents this as acceptable science: “groundwater flows in underground rivers throughout the subsurface.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: groundwater occupies pore spaces and fractures in rock and sediment; it does not generally flow in open underground rivers. |
| E2 | established science reference | Science brief: surface water and groundwater are connected: streams gain from or lose to groundwater depending on the water table. |
| E3 | established science reference | Science brief: groundwater moves far more slowly than surface water, so contamination is slow to appear and slow to clear. |
| E4 | established science reference | Science brief: extraction faster than recharge lowers the water table and can cause land subsidence and saltwater intrusion. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs12-earth-space-environmental-u06::surface water and groundwater systems, derived from the reviewed correctness source policy/correctness/ma-hs12-earth-space-environmental.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about surface water and groundwater systems, and does it support the candidate claim?
...
**My question.** Write the question you are testing about surface water and groundwater systems. It has to be a question your evidence could actually answer.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about surface water and groundwater systems, then name one check that would catch an error or a weak claim.**
...
**Q1.** Build a checkable contribution to the supplied unit performance task — Plan and conduct an investigation of water's properties and their effects on Earth materials, then analyse geoscience data to claim that one surface change creates feedbacks in other systems. — using the case and E1-E4. Include claim, evidence, reasoning, limitation, and a recorded revision.

>

**Q2.** Explain surface water and groundwater systems in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for surface water and groundwater systems. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about surface water and groundwater systems, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using surface water and groundwater systems as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E4 is strongest for evaluating the candidate claim about surface water and groundwater systems? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E4, state one conclusion about surface water and groundwater systems that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about surface water and groundwater systems. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about surface water and groundwater systems.
...
- Apply surface water and groundwater systems under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect surface water and groundwater systems to weathering and erosion from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Plan and conduct an investigation of water's properties and their effects on Earth materials, then analyse geoscience data to claim that one surface change creates feedbacks in other systems. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-hs12-earth-space-environmental-u06-l09` · lesson `ma-hs12-earth-space-environmental-u06-l09` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
