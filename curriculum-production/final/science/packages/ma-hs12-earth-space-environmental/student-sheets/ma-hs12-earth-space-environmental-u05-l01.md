# Launch and diagnostic: evidence for plate motion

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 5: Plate Tectonics and the History of Earth · Day 1 of the unit (course day 49) · about 55–75 minutes
...
**The task.** What does evidence E1 through E4 justify about evidence for plate motion, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**Q1.** Use the printed case as today's phenomenon for evidence for plate motion. Record what the candidate claim says, identify the mismatch with E1-E4, and pose a testable question naming what would change and what would be measured or classified.
...
_Package `swp-ma-hs12-earth-space-environmental-u05-l01` · lesson `ma-hs12-earth-space-environmental-u05-l01` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
