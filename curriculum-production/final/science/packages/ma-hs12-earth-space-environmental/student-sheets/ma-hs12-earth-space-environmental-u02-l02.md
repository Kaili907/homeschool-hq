# Concept model A: the sun's energy budget and lifespan

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 2: The Sun, Stars, and the Origin of the Elements · Day 2 of the unit (course day 14) · about 55–75 minutes
...
_Package `swp-ma-hs12-earth-space-environmental-u02-l02` · lesson `ma-hs12-earth-space-environmental-u02-l02` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
