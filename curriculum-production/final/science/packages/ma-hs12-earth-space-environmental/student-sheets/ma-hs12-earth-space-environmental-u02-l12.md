# Correction and reflection: communicating stellar science

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 2: The Sun, Stars, and the Origin of the Elements · Day 12 of the unit (course day 24) · about 55–75 minutes

**Today's focus:** communicating stellar science
...
- Explain communicating stellar science using evidence, a model, or a documented process rather than an unsupported answer.
- Apply communicating stellar science to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on communicating stellar science against the stated success criteria and name the next step.
...
- Science brief: communicating astronomical results means distinguishing what was measured, what was inferred from a model, and how confident the conclusion is.
- Science brief: astronomical images are frequently processed and colour-mapped, and a communication says so rather than presenting them as direct views.
- Science brief: scale statements need explicit units and comparisons, because astronomical magnitudes are outside everyday experience.

### Evidence check: communicating stellar science

**Candidate claim:** A case report presents this as acceptable science: “presenting a false-colour or composite astronomical image as a direct visual observation.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: communicating astronomical results means distinguishing what was measured, what was inferred from a model, and how confident the conclusion is. |
| E2 | established science reference | Science brief: astronomical images are frequently processed and colour-mapped, and a communication says so rather than presenting them as direct views. |
| E3 | established science reference | Science brief: scale statements need explicit units and comparisons, because astronomical magnitudes are outside everyday experience. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs12-earth-space-environmental-u02::communicating stellar science, derived from the reviewed correctness source policy/correctness/ma-hs12-earth-space-environmental.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about communicating stellar science, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about communicating stellar science, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about communicating stellar science, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain communicating stellar science in your own words using at least two specifically named rows from E1-E3. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for communicating stellar science. Decide whether E1-E3 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about communicating stellar science, revise its weakest claim with a named row from E1-E3, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using communicating stellar science as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about communicating stellar science? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about communicating stellar science that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about communicating stellar science. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about communicating stellar science.
...
- Apply communicating stellar science under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect communicating stellar science to nuclear fusion in stellar cores from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs12-earth-space-environmental-u02-l12` · lesson `ma-hs12-earth-space-environmental-u02-l12` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
