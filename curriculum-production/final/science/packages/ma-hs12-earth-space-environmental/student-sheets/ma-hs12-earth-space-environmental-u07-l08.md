# Reteach and varied practice: the greenhouse effect

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 7: Climate, Energy Flow, and the Carbon Cycle · Day 8 of the unit (course day 80) · about 55–75 minutes

**Today's focus:** the greenhouse effect
...
- Explain the greenhouse effect using evidence, a model, or a documented process rather than an unsupported answer.
- Apply the greenhouse effect to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on the greenhouse effect against the stated success criteria and name the next step.
...
- Science brief: greenhouse gases are largely transparent to incoming sunlight and absorb outgoing infrared radiation, re-emitting some of it back toward the surface.
- Science brief: the natural greenhouse effect keeps Earth's surface far warmer than it would otherwise be and is necessary for life as it exists.
- Science brief: water vapour, carbon dioxide, methane, and nitrous oxide absorb infrared radiation because of how their molecules vibrate.
- Science brief: adding greenhouse gases reduces outgoing infrared for a given surface temperature, so the surface warms until balance is restored.

### Evidence check: the greenhouse effect

**Candidate claim:** A case report presents this as acceptable science: “greenhouse gases work by trapping heat like the glass of a greenhouse, which warms mainly by suppressing convection.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: greenhouse gases are largely transparent to incoming sunlight and absorb outgoing infrared radiation, re-emitting some of it back toward the surface. |
| E2 | established science reference | Science brief: the natural greenhouse effect keeps Earth's surface far warmer than it would otherwise be and is necessary for life as it exists. |
| E3 | established science reference | Science brief: water vapour, carbon dioxide, methane, and nitrous oxide absorb infrared radiation because of how their molecules vibrate. |
| E4 | established science reference | Science brief: adding greenhouse gases reduces outgoing infrared for a given surface temperature, so the surface warms until balance is restored. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs12-earth-space-environmental-u07::the greenhouse effect, derived from the reviewed correctness source policy/correctness/ma-hs12-earth-space-environmental.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about the greenhouse effect, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about the greenhouse effect, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about the greenhouse effect, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain the greenhouse effect in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for the greenhouse effect. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about the greenhouse effect, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using the greenhouse effect as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about the greenhouse effect? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about the greenhouse effect that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about the greenhouse effect. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about the greenhouse effect.
...
- Apply the greenhouse effect under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect the greenhouse effect to energy flow into and out of Earth systems from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs12-earth-space-environmental-u07-l08` · lesson `ma-hs12-earth-space-environmental-u07-l08` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
