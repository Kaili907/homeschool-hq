# Unit assessment: composition of matter in the universe

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 3: Cosmology and the Evidence for the Big Bang · Day 11 of the unit (course day 35) · about 55–75 minutes

**Today's focus:** composition of matter in the universe
...
- Demonstrate independent mastery evidence for composition of matter in the universe on a fresh task.
- Explain composition of matter in the universe using evidence, a model, or a documented process rather than an unsupported answer.
- Apply composition of matter in the universe to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on composition of matter in the universe against the stated success criteria and name the next step.
...
- Science brief: ordinary matter in the universe is overwhelmingly hydrogen and helium, in a ratio close to three to one by mass.
- Science brief: the observed hydrogen and helium proportions match what a hot early universe predicts, which is an independent line of evidence for the model.
- Science brief: all elements heavier than helium together make up only a small fraction of ordinary matter.
- Science brief: ordinary matter itself accounts for a minority of the universe's total mass and energy content, with dark matter and dark energy making up the rest.

### Evidence check: composition of matter in the universe

**Candidate claim:** A case report presents this as acceptable science: “heavy elements make up a large fraction of the universe's ordinary matter.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: ordinary matter in the universe is overwhelmingly hydrogen and helium, in a ratio close to three to one by mass. |
| E2 | established science reference | Science brief: the observed hydrogen and helium proportions match what a hot early universe predicts, which is an independent line of evidence for the model. |
| E3 | established science reference | Science brief: all elements heavier than helium together make up only a small fraction of ordinary matter. |
| E4 | established science reference | Science brief: ordinary matter itself accounts for a minority of the universe's total mass and energy content, with dark matter and dark energy making up the rest. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs12-earth-space-environmental-u03::composition of matter in the universe, derived from the reviewed correctness source policy/correctness/ma-hs12-earth-space-environmental.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about composition of matter in the universe, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about composition of matter in the universe, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about composition of matter in the universe, then name one check that would catch an error or a weak claim.**
...
**Q1.** Without copying a sentence from the brief, evaluate the printed candidate case about composition of matter in the universe. Cite E1-E4, write the reasoning in your own words, and correct the case claim so it fits exactly what the record establishes.

>

**Q2.** Explain composition of matter in the universe in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for composition of matter in the universe. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about composition of matter in the universe, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using composition of matter in the universe as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E4 is strongest for evaluating the candidate claim about composition of matter in the universe? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E4, state one conclusion about composition of matter in the universe that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about composition of matter in the universe. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about composition of matter in the universe.
...
- Apply composition of matter in the universe under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect composition of matter in the universe to light spectra and redshift from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs12-earth-space-environmental-u03-l11` · lesson `ma-hs12-earth-space-environmental-u03-l11` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
