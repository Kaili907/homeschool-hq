# Independent application A: refining technological solutions

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 9: Sustainability Engineering and the Grade 12 Capstone · Day 4 of the unit (course day 100) · about 55–75 minutes

**Today's focus:** refining technological solutions
...
- Explain refining technological solutions using evidence, a model, or a documented process rather than an unsupported answer.
- Apply refining technological solutions to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on refining technological solutions against the stated success criteria and name the next step.
...
- Science brief: refinement proceeds by testing against criteria, identifying a specific shortfall, and making a change aimed at it.
- Science brief: changing one thing at a time keeps the effect of each change identifiable.
- Science brief: unintended consequences are looked for deliberately, because a solution that shifts a problem elsewhere has not solved it.

### Evidence check: refining technological solutions

**Candidate claim:** A case report presents this as acceptable science: “changing several features at once and attributing the improvement to one.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: refinement proceeds by testing against criteria, identifying a specific shortfall, and making a change aimed at it. |
| E2 | established science reference | Science brief: changing one thing at a time keeps the effect of each change identifiable. |
| E3 | established science reference | Science brief: unintended consequences are looked for deliberately, because a solution that shifts a problem elsewhere has not solved it. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs12-earth-space-environmental-u09::refining technological solutions, derived from the reviewed correctness source policy/correctness/ma-hs12-earth-space-environmental.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about refining technological solutions, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about refining technological solutions, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about refining technological solutions, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain refining technological solutions in your own words using at least two specifically named rows from E1-E3. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for refining technological solutions. Decide whether E1-E3 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about refining technological solutions, revise its weakest claim with a named row from E1-E3, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using refining technological solutions as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about refining technological solutions? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about refining technological solutions that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about refining technological solutions. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about refining technological solutions.
...
- Apply refining technological solutions under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect refining technological solutions to criteria, constraints, and prioritisation from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs12-earth-space-environmental-u09-l04` · lesson `ma-hs12-earth-space-environmental-u09-l04` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
