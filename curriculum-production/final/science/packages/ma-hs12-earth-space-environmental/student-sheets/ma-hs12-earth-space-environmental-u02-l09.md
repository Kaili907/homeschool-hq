# Performance task build: stellar life cycles

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 2: The Sun, Stars, and the Origin of the Elements · Day 9 of the unit (course day 21) · about 61–84 minutes

**Today's focus:** stellar life cycles
...
- Produce performance-task evidence for stellar life cycles that a reader could check independently.
- Explain stellar life cycles using evidence, a model, or a documented process rather than an unsupported answer.
- Apply stellar life cycles to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on stellar life cycles against the stated success criteria and name the next step.
...
- Science brief: a star's mass determines its life cycle and its end state: white dwarf for low and intermediate masses, neutron star or black hole for high masses.
- Science brief: stars form from collapsing clouds of gas and dust, spend most of their lives fusing hydrogen on the main sequence, and then evolve as their core fuel is exhausted.
- Science brief: low and intermediate mass stars expand to red giants, shed their outer layers, and leave a white dwarf.
- Science brief: high-mass stars end in supernova explosions, leaving a neutron star or a black hole.

### Evidence check: stellar life cycles

**Candidate claim:** A case report presents this as acceptable science: “all stars end their lives as supernovae.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a star's mass determines its life cycle and its end state: white dwarf for low and intermediate masses, neutron star or black hole for high masses. |
| E2 | established science reference | Science brief: stars form from collapsing clouds of gas and dust, spend most of their lives fusing hydrogen on the main sequence, and then evolve as their core fuel is exhausted. |
| E3 | established science reference | Science brief: low and intermediate mass stars expand to red giants, shed their outer layers, and leave a white dwarf. |
| E4 | established science reference | Science brief: high-mass stars end in supernova explosions, leaving a neutron star or a black hole. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs12-earth-space-environmental-u02::stellar life cycles, derived from the reviewed correctness source policy/correctness/ma-hs12-earth-space-environmental.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about stellar life cycles, and does it support the candidate claim?
...
**My question.** Write the question you are testing about stellar life cycles. It has to be a question your evidence could actually answer.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about stellar life cycles, then name one check that would catch an error or a weak claim.**
...
**Q1.** Build a checkable contribution to the supplied unit performance task — Develop an evidence-based model of the sun's life span and energy source, and communicate how stars across their life cycle produce the elements in ordinary matter. — using the case and E1-E4. Include claim, evidence, reasoning, limitation, and a recorded revision.

>

**Q2.** Explain stellar life cycles in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for stellar life cycles. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about stellar life cycles, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using stellar life cycles as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E4 is strongest for evaluating the candidate claim about stellar life cycles? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E4, state one conclusion about stellar life cycles that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about stellar life cycles. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about stellar life cycles.
...
- Apply stellar life cycles under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect stellar life cycles to nuclear fusion in stellar cores from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs12-earth-space-environmental-u02-l09` · lesson `ma-hs12-earth-space-environmental-u02-l09` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
