# Reteach and varied practice: coevolution of the geosphere and biosphere

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 8: Coevolution of Earth and Life, Resources, and Natural Hazards · Day 8 of the unit (course day 92) · about 55–75 minutes

**Today's focus:** coevolution of the geosphere and biosphere
...
- Explain coevolution of the geosphere and biosphere using evidence, a model, or a documented process rather than an unsupported answer.
- Apply coevolution of the geosphere and biosphere to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on coevolution of the geosphere and biosphere against the stated success criteria and name the next step.
...
- Science brief: life has altered Earth's atmosphere, oceans, soils, and rocks, and those changes have in turn shaped the evolution of life.
- Science brief: many rock types, including limestone, coal, and banded iron formations, exist because of biological activity.
- Science brief: the influence runs in both directions, which is why the systems are described as coevolving rather than one acting on the other.

### Evidence check: coevolution of the geosphere and biosphere

**Candidate claim:** A case report presents this as acceptable science: “life adapted to Earth's conditions without altering them.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: life has altered Earth's atmosphere, oceans, soils, and rocks, and those changes have in turn shaped the evolution of life. |
| E2 | established science reference | Science brief: many rock types, including limestone, coal, and banded iron formations, exist because of biological activity. |
| E3 | established science reference | Science brief: the influence runs in both directions, which is why the systems are described as coevolving rather than one acting on the other. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs12-earth-space-environmental-u08::coevolution of the geosphere and biosphere, derived from the reviewed correctness source policy/correctness/ma-hs12-earth-space-environmental.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about coevolution of the geosphere and biosphere, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about coevolution of the geosphere and biosphere, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about coevolution of the geosphere and biosphere, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain coevolution of the geosphere and biosphere in your own words using at least two specifically named rows from E1-E3. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for coevolution of the geosphere and biosphere. Decide whether E1-E3 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about coevolution of the geosphere and biosphere, revise its weakest claim with a named row from E1-E3, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using coevolution of the geosphere and biosphere as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about coevolution of the geosphere and biosphere? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about coevolution of the geosphere and biosphere that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about coevolution of the geosphere and biosphere. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about coevolution of the geosphere and biosphere.
...
- Apply coevolution of the geosphere and biosphere under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect coevolution of the geosphere and biosphere to the Great Oxidation Event and atmospheric change from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs12-earth-space-environmental-u08-l08` · lesson `ma-hs12-earth-space-environmental-u08-l08` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
