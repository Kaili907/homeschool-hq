# Performance task build: orbital period and radius

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 4: Orbital Motion and the Solar System · Day 9 of the unit (course day 45) · about 61–84 minutes

**Today's focus:** orbital period and radius
...
- Produce performance-task evidence for orbital period and radius that a reader could check independently.
- Explain orbital period and radius using evidence, a model, or a documented process rather than an unsupported answer.
- Apply orbital period and radius to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on orbital period and radius against the stated success criteria and name the next step.

**Materials:**

- published orbital dataset for planets or moons
- spreadsheet or graph paper
- calculator
- string, pins, and cardboard for ellipse construction
- notebook
...
- **Physical hazard.** Pins used to draw ellipses can prick or be stepped on.
  - What stops it: Push pins into a cardboard backing on a table, count them out and back in, and keep them away from young children and off the floor.
...
**Clearing up.** Pins go back into a closed labelled container, counted, and stored out of reach of young children. Recycle the cardboard. Nothing hazardous is produced.
...
- Science brief: a body in a larger orbit around the same central mass has a longer period and a lower orbital speed.
- Science brief: the period-radius relationship means a satellite raised to a higher orbit takes longer to complete each circuit.
- Science brief: orbital speed decreases with increasing orbital radius, even though the total orbital energy increases.
- Science brief: because the relationship depends on the central mass, measuring a satellite's period and orbital radius determines that mass.

### Evidence check: orbital period and radius

**Candidate claim:** A case report presents this as acceptable science: “a satellite in a higher orbit moves faster because it has more energy.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a body in a larger orbit around the same central mass has a longer period and a lower orbital speed. |
| E2 | established science reference | Science brief: the period-radius relationship means a satellite raised to a higher orbit takes longer to complete each circuit. |
| E3 | established science reference | Science brief: orbital speed decreases with increasing orbital radius, even though the total orbital energy increases. |
| E4 | established science reference | Science brief: because the relationship depends on the central mass, measuring a satellite's period and orbital radius determines that mass. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs12-earth-space-environmental-u04::orbital period and radius, derived from the reviewed correctness source policy/correctness/ma-hs12-earth-space-environmental.correctness.json.

**Supplied unit connections:** gravitational orbits; Kepler's relationships; orbital period and radius; elliptical orbits and orbital energy; computational prediction of orbits; solar system architecture

**Supplied unit performance task:** Use mathematical or computational representations to predict the motion of orbiting bodies, and test your predictions against published orbital data.

### Bound task

**Question:** What does evidence E1 through E4 justify about orbital period and radius, and does it support the candidate claim?
...
**Model/source rule:** Weathering score=(rainfall index × temperature index)/rock resistance.
...
3. Verify scores, isolate each variable with matched comparisons, and explain why this index is a model rather than a direct rate in physical units.
...
**Pinned H4 alternative statement (lineage evidence):** Construct ellipses with a compass and ruler rather than pins and string, and complete all orbital prediction arithmetically from the published dataset. Paper only.
...
**My question.** Write the question you are testing about orbital period and radius. It has to be a question your evidence could actually answer.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about orbital period and radius, then name one check that would catch an error or a weak claim.**
...
**Q1.** Build a checkable contribution to the supplied unit performance task — Use mathematical or computational representations to predict the motion of orbiting bodies, and test your predictions against published orbital data. — using the case and E1-E4. Include claim, evidence, reasoning, limitation, and a recorded revision.

>

**Q2.** Explain orbital period and radius in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for orbital period and radius. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about orbital period and radius, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using orbital period and radius as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E4 is strongest for evaluating the candidate claim about orbital period and radius? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E4, state one conclusion about orbital period and radius that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about orbital period and radius. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about orbital period and radius.
...
- Apply orbital period and radius under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect orbital period and radius to gravitational orbits from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Use mathematical or computational representations to predict the motion of orbiting bodies, and test your predictions against published orbital data. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-hs12-earth-space-environmental-u04-l09` · lesson `ma-hs12-earth-space-environmental-u04-l09` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
