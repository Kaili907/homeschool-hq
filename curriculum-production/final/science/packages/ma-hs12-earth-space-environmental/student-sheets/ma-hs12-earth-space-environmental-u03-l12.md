# Correction and reflection: constructing an explanation from multiple evidence lines

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 3: Cosmology and the Evidence for the Big Bang · Day 12 of the unit (course day 36) · about 55–75 minutes

**Today's focus:** constructing an explanation from multiple evidence lines
...
- Explain constructing an explanation from multiple evidence lines using evidence, a model, or a documented process rather than an unsupported answer.
- Apply constructing an explanation from multiple evidence lines to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on constructing an explanation from multiple evidence lines against the stated success criteria and name the next step.
...
- Science brief: the strength of the Big Bang model rests on several independent lines agreeing: galaxy redshifts, the microwave background, and the light-element abundances.
- Science brief: independent lines of evidence converging carries far more weight than any single line, because they fail in different ways.
- Science brief: an explanation states which observations it accounts for and which it does not.

### Evidence check: constructing an explanation from multiple evidence lines

**Candidate claim:** A case report presents this as acceptable science: “presenting one line of evidence as establishing the model on its own.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: the strength of the Big Bang model rests on several independent lines agreeing: galaxy redshifts, the microwave background, and the light-element abundances. |
| E2 | established science reference | Science brief: independent lines of evidence converging carries far more weight than any single line, because they fail in different ways. |
| E3 | established science reference | Science brief: an explanation states which observations it accounts for and which it does not. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs12-earth-space-environmental-u03::constructing an explanation from multiple evidence lines, derived from the reviewed correctness source policy/correctness/ma-hs12-earth-space-environmental.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about constructing an explanation from multiple evidence lines, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about constructing an explanation from multiple evidence lines, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about constructing an explanation from multiple evidence lines, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain constructing an explanation from multiple evidence lines in your own words using at least two specifically named rows from E1-E3. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for constructing an explanation from multiple evidence lines. Decide whether E1-E3 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about constructing an explanation from multiple evidence lines, revise its weakest claim with a named row from E1-E3, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using constructing an explanation from multiple evidence lines as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about constructing an explanation from multiple evidence lines? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about constructing an explanation from multiple evidence lines that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about constructing an explanation from multiple evidence lines. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about constructing an explanation from multiple evidence lines.
...
- Apply constructing an explanation from multiple evidence lines under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect constructing an explanation from multiple evidence lines to light spectra and redshift from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs12-earth-space-environmental-u03-l12` · lesson `ma-hs12-earth-space-environmental-u03-l12` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
