# Investigation: evidence for plate motion

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 5: Plate Tectonics and the History of Earth · Day 7 of the unit (course day 55) · about 61–84 minutes

**Today's focus:** evidence for plate motion
...
- Plan and carry out a safe investigation of evidence for plate motion, or its stated alternative, and record the learner's own data with its uncertainty.
- Explain evidence for plate motion using evidence, a model, or a documented process rather than an unsupported answer.
- Apply evidence for plate motion to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on evidence for plate motion against the stated success criteria and name the next step.

**Materials:**

- published seafloor age and crustal age datasets
- coloured pencils
- graph paper
- clear plastic or heatproof container
- thermometer
...
- stiff card, thick paper, and tape for an adult to wrap a cracked container before binning
- notebook
...
- **Physical hazard.** Warm water used for the convection model can scald, and glass can crack from thermal shock.
  - What stops it: Keep water below 50 degrees Celsius, use a plastic or heatproof container, and let an adult pour.
- **Physical hazard.** Food colouring stains surfaces and clothing.
  - What stops it: Work over a tray with old clothing or an apron.
...
**Clearing up.** Pour the cooled coloured water down the drain with the tap running and rinse the container; wipe the tray and any stained surface immediately. A cracked container is wrapped in thick paper and tape before binning, never put in loose.
...
- Science brief: plate motion is directly measured today by satellite geodesy, at rates of centimetres per year.
- Science brief: evidence includes matching coastlines and rock sequences across oceans, matching fossil distributions, seafloor age patterns, earthquake and volcano distributions, and direct measurement.
- Science brief: the distribution of earthquakes and volcanoes in narrow bands marks plate boundaries.
- Science brief: no single line of evidence established plate tectonics; the convergence of many did.

### Evidence check: evidence for plate motion

**Candidate claim:** A case report presents this as acceptable science: “continents plough through oceanic crust rather than moving as parts of plates.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: plate motion is directly measured today by satellite geodesy, at rates of centimetres per year. |
| E2 | established science reference | Science brief: evidence includes matching coastlines and rock sequences across oceans, matching fossil distributions, seafloor age patterns, earthquake and volcano distributions, and direct measurement. |
| E3 | established science reference | Science brief: the distribution of earthquakes and volcanoes in narrow bands marks plate boundaries. |
| E4 | established science reference | Science brief: no single line of evidence established plate tectonics; the convergence of many did. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs12-earth-space-environmental-u05::evidence for plate motion, derived from the reviewed correctness source policy/correctness/ma-hs12-earth-space-environmental.correctness.json.

**Supplied unit connections:** evidence for plate motion; seafloor age and magnetic striping; convection in Earth's interior; continental and oceanic crust formation; radiometric dating and Earth's age; reconstructing geologic history

**Supplied unit performance task:** Evaluate multiple lines of evidence for past and current crustal movement, and construct an account of Earth's formation and early history from ancient materials and planetary surfaces.

### Bound task

**Question:** What does evidence E1 through E4 justify about evidence for plate motion, and does it support the candidate claim?
...
**Model/source rule:** A deterministic pore-flow simulation assigns larger connected pore spaces more five-minute flow; turbidity is a separate 1-5 model index.
...
3. Calculate retained water, rank permeability, and use both flow and turbidity to evaluate a claim about groundwater filtration without assuming faster flow always means cleaner water.
...
**Pinned H4 alternative statement (lineage evidence):** Do the convection strand from a published thermal-convection diagram sequence and complete the seafloor age mapping with coloured pencils on a printed map. No water, paper only.
...
**My question.** Write the question you are testing about evidence for plate motion. It has to be a question your evidence could actually answer.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about evidence for plate motion, then name one check that would catch an error or a weak claim.**
...
**Q1.** Complete the route you chose. For the document/model route, use its printed procedure and input table; for the H4 physical route, use the printed safe order and your own blank record. Report the route, evidence IDs or model rows, conclusion about evidence for plate motion, uncertainty, and limitation.

>

**Q2.** Explain evidence for plate motion in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for evidence for plate motion. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about evidence for plate motion, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using evidence for plate motion as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E4 is strongest for evaluating the candidate claim about evidence for plate motion? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E4, state one conclusion about evidence for plate motion that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about evidence for plate motion. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about evidence for plate motion.
...
- Apply evidence for plate motion under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect evidence for plate motion to seafloor age and magnetic striping from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Evaluate multiple lines of evidence for past and current crustal movement, and construct an account of Earth's formation and early history from ancient materials and planetary surfaces. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-hs12-earth-space-environmental-u05-l07` · lesson `ma-hs12-earth-space-environmental-u05-l07` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
