# Performance task build: proxy data and indirect evidence

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 1: Earth and Space Systems, Scale, and Data Practice · Day 9 of the unit (course day 9) · about 61–84 minutes

**Today's focus:** proxy data and indirect evidence
...
- Produce performance-task evidence for proxy data and indirect evidence that a reader could check independently.
- Explain proxy data and indirect evidence using evidence, a model, or a documented process rather than an unsupported answer.
- Apply proxy data and indirect evidence to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on proxy data and indirect evidence against the stated success criteria and name the next step.

**Materials:**

- published geoscience dataset
...
- **Online hazard.** Locating datasets online can expose the learner to tracking or account prompts.
  - What stops it: An adult supplies the dataset file or exact source. No account creation, sign-in, or purchase is required.
- **Physical hazard.** Building a large scale model outdoors involves walking measured distances.
  - What stops it: Stay on the property or in a park away from roads and water, with an adult aware of the route.
...
**Clearing up.** Collect the string and markers and leave the site as it was found. Dataset files stay on the adult's device; nothing is uploaded and no location is stored. Nothing hazardous is produced.
...
- Science brief: a proxy is a measurable quantity that stands in for a quantity that cannot be measured directly, and it requires a calibrated relationship between the two.
- Science brief: ice cores, tree rings, sediment layers, corals, and isotope ratios are proxies for past conditions.
- Science brief: a proxy carries the uncertainty of the calibration as well as of the measurement itself.
- Science brief: independent proxies agreeing is what makes a reconstruction robust; a single proxy carries much weaker support.

### Evidence check: proxy data and indirect evidence

**Candidate claim:** A case report presents this as acceptable science: “treating a proxy measurement as a direct measurement of the quantity it stands for.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a proxy is a measurable quantity that stands in for a quantity that cannot be measured directly, and it requires a calibrated relationship between the two. |
| E2 | established science reference | Science brief: ice cores, tree rings, sediment layers, corals, and isotope ratios are proxies for past conditions. |
| E3 | established science reference | Science brief: a proxy carries the uncertainty of the calibration as well as of the measurement itself. |
| E4 | established science reference | Science brief: independent proxies agreeing is what makes a reconstruction robust; a single proxy carries much weaker support. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs12-earth-space-environmental-u01::proxy data and indirect evidence, derived from the reviewed correctness source policy/correctness/ma-hs12-earth-space-environmental.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about proxy data and indirect evidence, and does it support the candidate claim?
...
**My question.** Write the question you are testing about proxy data and indirect evidence. It has to be a question your evidence could actually answer.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about proxy data and indirect evidence, then name one check that would catch an error or a weak claim.**
...
**Q1.** Build a checkable contribution to the supplied unit performance task — Take one published geoscience or astronomical dataset, build an honest representation of it, and document every choice that could mislead a reader. — using the case and E1-E4. Include claim, evidence, reasoning, limitation, and a recorded revision.

>

**Q2.** Explain proxy data and indirect evidence in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for proxy data and indirect evidence. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about proxy data and indirect evidence, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using proxy data and indirect evidence as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E4 is strongest for evaluating the candidate claim about proxy data and indirect evidence? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E4, state one conclusion about proxy data and indirect evidence that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about proxy data and indirect evidence. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about proxy data and indirect evidence.
...
- Apply proxy data and indirect evidence under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect proxy data and indirect evidence to systems and system models from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Take one published geoscience or astronomical dataset, build an honest representation of it, and document every choice that could mislead a reader. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-hs12-earth-space-environmental-u01-l09` · lesson `ma-hs12-earth-space-environmental-u01-l09` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
