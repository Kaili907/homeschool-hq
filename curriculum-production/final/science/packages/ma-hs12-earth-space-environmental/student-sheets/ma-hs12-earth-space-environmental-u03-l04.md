# Independent application A: cosmic microwave background

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 3: Cosmology and the Evidence for the Big Bang · Day 4 of the unit (course day 28) · about 55–75 minutes

**Today's focus:** cosmic microwave background
...
- Explain cosmic microwave background using evidence, a model, or a documented process rather than an unsupported answer.
- Apply cosmic microwave background to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on cosmic microwave background against the stated success criteria and name the next step.
...
- Science brief: the cosmic microwave background is faint radiation reaching Earth from every direction, with a spectrum matching a body at about 2.7 kelvin.
- Science brief: the background radiation is light released when the early universe first became transparent, stretched to microwave wavelengths by the expansion since.
- Science brief: its near-uniformity across the sky, with small measured variations, is a strong constraint on models of the early universe.
- Science brief: it was predicted before it was detected, which is why its discovery was decisive evidence.

### Evidence check: cosmic microwave background

**Candidate claim:** A case report presents this as acceptable science: “the background radiation comes from a particular direction or source in the sky.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: the cosmic microwave background is faint radiation reaching Earth from every direction, with a spectrum matching a body at about 2.7 kelvin. |
| E2 | established science reference | Science brief: the background radiation is light released when the early universe first became transparent, stretched to microwave wavelengths by the expansion since. |
| E3 | established science reference | Science brief: its near-uniformity across the sky, with small measured variations, is a strong constraint on models of the early universe. |
| E4 | established science reference | Science brief: it was predicted before it was detected, which is why its discovery was decisive evidence. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs12-earth-space-environmental-u03::cosmic microwave background, derived from the reviewed correctness source policy/correctness/ma-hs12-earth-space-environmental.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about cosmic microwave background, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about cosmic microwave background, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about cosmic microwave background, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain cosmic microwave background in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for cosmic microwave background. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about cosmic microwave background, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using cosmic microwave background as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about cosmic microwave background? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about cosmic microwave background that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about cosmic microwave background. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about cosmic microwave background.
...
- Apply cosmic microwave background under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect cosmic microwave background to light spectra and redshift from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs12-earth-space-environmental-u03-l04` · lesson `ma-hs12-earth-space-environmental-u03-l04` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
