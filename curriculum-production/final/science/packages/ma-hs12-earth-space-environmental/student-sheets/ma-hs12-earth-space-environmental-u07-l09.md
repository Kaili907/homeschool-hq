# Performance task build: the global carbon cycle

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 7: Climate, Energy Flow, and the Carbon Cycle · Day 9 of the unit (course day 81) · about 61–84 minutes

**Today's focus:** the global carbon cycle
...
- Produce performance-task evidence for the global carbon cycle that a reader could check independently.
- Explain the global carbon cycle using evidence, a model, or a documented process rather than an unsupported answer.
- Apply the global carbon cycle to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on the global carbon cycle against the stated success criteria and name the next step.
...
- Science brief: burning fossil fuels transfers carbon from a long-term geological reservoir into the atmosphere far faster than natural processes return it.
- Science brief: carbon moves between atmosphere, ocean, land biosphere, soils, and rock, on timescales ranging from years to millions of years.
- Science brief: the ocean has absorbed a large fraction of the carbon dioxide added by human activity, which has also made surface waters more acidic.
- Science brief: a carbon budget accounts for all sources and sinks; the atmospheric increase is the difference between what is added and what is taken up.

### Evidence check: the global carbon cycle

**Candidate claim:** A case report presents this as acceptable science: “carbon added to the atmosphere is removed on a timescale of a few years.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: burning fossil fuels transfers carbon from a long-term geological reservoir into the atmosphere far faster than natural processes return it. |
| E2 | established science reference | Science brief: carbon moves between atmosphere, ocean, land biosphere, soils, and rock, on timescales ranging from years to millions of years. |
| E3 | established science reference | Science brief: the ocean has absorbed a large fraction of the carbon dioxide added by human activity, which has also made surface waters more acidic. |
| E4 | established science reference | Science brief: a carbon budget accounts for all sources and sinks; the atmospheric increase is the difference between what is added and what is taken up. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs12-earth-space-environmental-u07::the global carbon cycle, derived from the reviewed correctness source policy/correctness/ma-hs12-earth-space-environmental.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about the global carbon cycle, and does it support the candidate claim?
...
**My question.** Write the question you are testing about the global carbon cycle. It has to be a question your evidence could actually answer.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about the global carbon cycle, then name one check that would catch an error or a weak claim.**
...
**Q1.** Build a checkable contribution to the supplied unit performance task — Use a model of Earth's energy flows and a quantitative carbon-cycle model to make an evidence-based forecast of climate change, with the forecast's uncertainty stated explicitly. — using the case and E1-E4. Include claim, evidence, reasoning, limitation, and a recorded revision.

>

**Q2.** Explain the global carbon cycle in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for the global carbon cycle. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about the global carbon cycle, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using the global carbon cycle as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E4 is strongest for evaluating the candidate claim about the global carbon cycle? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E4, state one conclusion about the global carbon cycle that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about the global carbon cycle. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about the global carbon cycle.
...
- Apply the global carbon cycle under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect the global carbon cycle to energy flow into and out of Earth systems from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs12-earth-space-environmental-u07-l09` · lesson `ma-hs12-earth-space-environmental-u07-l09` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
