# Correction and reflection: investigating water and Earth materials

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 6: Surface Processes, Water, and Earth System Feedbacks · Day 12 of the unit (course day 72) · about 55–75 minutes

**Today's focus:** investigating water and Earth materials
...
- Explain investigating water and Earth materials using evidence, a model, or a documented process rather than an unsupported answer.
- Apply investigating water and Earth materials to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on investigating water and Earth materials against the stated success criteria and name the next step.
...
- Science brief: an investigation of water or earth materials states its sampling location, time, method, and the property measured, since all four affect the result.
- Science brief: natural variability means a single sample characterises that sample, not the system it came from.
- Science brief: measurements are compared against published values only where the method and conditions are comparable.

### Evidence check: investigating water and Earth materials

**Candidate claim:** A case report presents this as acceptable science: “characterising a water body or a formation from a single sample.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: an investigation of water or earth materials states its sampling location, time, method, and the property measured, since all four affect the result. |
| E2 | established science reference | Science brief: natural variability means a single sample characterises that sample, not the system it came from. |
| E3 | established science reference | Science brief: measurements are compared against published values only where the method and conditions are comparable. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs12-earth-space-environmental-u06::investigating water and Earth materials, derived from the reviewed correctness source policy/correctness/ma-hs12-earth-space-environmental.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about investigating water and Earth materials, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about investigating water and Earth materials, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about investigating water and Earth materials, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain investigating water and Earth materials in your own words using at least two specifically named rows from E1-E3. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for investigating water and Earth materials. Decide whether E1-E3 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about investigating water and Earth materials, revise its weakest claim with a named row from E1-E3, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using investigating water and Earth materials as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about investigating water and Earth materials? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about investigating water and Earth materials that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about investigating water and Earth materials. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about investigating water and Earth materials.
...
- Apply investigating water and Earth materials under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect investigating water and Earth materials to weathering and erosion from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs12-earth-space-environmental-u06-l12` · lesson `ma-hs12-earth-space-environmental-u06-l12` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
