# Concept model A: the greenhouse effect

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 7: Climate, Energy Flow, and the Carbon Cycle · Day 2 of the unit (course day 74) · about 55–75 minutes
...
_Package `swp-ma-hs12-earth-space-environmental-u07-l02` · lesson `ma-hs12-earth-space-environmental-u07-l02` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
