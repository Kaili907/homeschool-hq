# Independent application A: feedbacks between Earth systems

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 6: Surface Processes, Water, and Earth System Feedbacks · Day 4 of the unit (course day 64) · about 55–75 minutes

**Today's focus:** feedbacks between Earth systems
...
- Apply feedbacks between Earth systems to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on feedbacks between Earth systems against the stated success criteria and name the next step.
...
- Science brief: a positive feedback amplifies an initial change; a negative feedback damps it.
- Science brief: ice-albedo feedback is positive: warming melts reflective ice, exposing darker surfaces that absorb more energy and warm further.
- Science brief: silicate weathering is a negative feedback on long timescales: warming speeds weathering, which removes carbon dioxide and cools.
- Science brief: feedbacks determine whether a perturbation is amplified or damped, and identifying their sign is central to predicting system behaviour.

### Evidence check: feedbacks between Earth systems

**Candidate claim:** A case report presents this as acceptable science: “equating positive feedback with a beneficial outcome and negative feedback with a harmful one.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a positive feedback amplifies an initial change; a negative feedback damps it. |
| E2 | established science reference | Science brief: ice-albedo feedback is positive: warming melts reflective ice, exposing darker surfaces that absorb more energy and warm further. |
| E3 | established science reference | Science brief: silicate weathering is a negative feedback on long timescales: warming speeds weathering, which removes carbon dioxide and cools. |
| E4 | established science reference | Science brief: feedbacks determine whether a perturbation is amplified or damped, and identifying their sign is central to predicting system behaviour. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs12-earth-space-environmental-u06::feedbacks between Earth systems, derived from the reviewed correctness source policy/correctness/ma-hs12-earth-space-environmental.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about feedbacks between Earth systems, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about feedbacks between Earth systems, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about feedbacks between Earth systems, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain feedbacks between Earth systems in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for feedbacks between Earth systems. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about feedbacks between Earth systems, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using feedbacks between Earth systems as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about feedbacks between Earth systems? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about feedbacks between Earth systems that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about feedbacks between Earth systems. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about feedbacks between Earth systems.
...
- Apply feedbacks between Earth systems under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect feedbacks between Earth systems to weathering and erosion from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs12-earth-space-environmental-u06-l04` · lesson `ma-hs12-earth-space-environmental-u06-l04` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
