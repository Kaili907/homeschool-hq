# Independent application A: uncertainty in geoscience data

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 1: Earth and Space Systems, Scale, and Data Practice · Day 4 of the unit (course day 4) · about 55–75 minutes

**Today's focus:** uncertainty in geoscience data
...
- Explain uncertainty in geoscience data using evidence, a model, or a documented process rather than an unsupported answer.
- Apply uncertainty in geoscience data to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on uncertainty in geoscience data against the stated success criteria and name the next step.
...
- Science brief: geoscience data carries uncertainty from measurement, from sampling in space and time, and from the models used to interpret it.
- Science brief: uncertainty is a quantified statement about how well something is known; it is not an admission that nothing is known.
- Science brief: a conclusion is stated with the uncertainty attached, so that a reader can judge what it supports.

### Evidence check: uncertainty in geoscience data

**Candidate claim:** A case report presents this as acceptable science: “treating a stated uncertainty as grounds for dismissing a well-supported conclusion.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: geoscience data carries uncertainty from measurement, from sampling in space and time, and from the models used to interpret it. |
| E2 | established science reference | Science brief: uncertainty is a quantified statement about how well something is known; it is not an admission that nothing is known. |
| E3 | established science reference | Science brief: a conclusion is stated with the uncertainty attached, so that a reader can judge what it supports. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs12-earth-space-environmental-u01::uncertainty in geoscience data, derived from the reviewed correctness source policy/correctness/ma-hs12-earth-space-environmental.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about uncertainty in geoscience data, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about uncertainty in geoscience data, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about uncertainty in geoscience data, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain uncertainty in geoscience data in your own words using at least two specifically named rows from E1-E3. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for uncertainty in geoscience data. Decide whether E1-E3 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about uncertainty in geoscience data, revise its weakest claim with a named row from E1-E3, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using uncertainty in geoscience data as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about uncertainty in geoscience data? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about uncertainty in geoscience data that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about uncertainty in geoscience data. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about uncertainty in geoscience data.
...
- Apply uncertainty in geoscience data under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect uncertainty in geoscience data to systems and system models from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs12-earth-space-environmental-u01-l04` · lesson `ma-hs12-earth-space-environmental-u01-l04` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
