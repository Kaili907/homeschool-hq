# Investigation: light spectra and redshift

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 3: Cosmology and the Evidence for the Big Bang · Day 7 of the unit (course day 31) · about 61–84 minutes

**Today's focus:** light spectra and redshift

**Unit question:** What observations force the conclusion that the universe has a history?

**Anchoring phenomenon: Nearly every distant galaxy's light is shifted toward red, and the farther away it is, the more shifted it is.**

**What you are aiming at:**

- Plan and carry out a safe investigation of light spectra and redshift, or its stated alternative, and record the learner's own data with its uncertainty.
- Explain light spectra and redshift using evidence, a model, or a documented process rather than an unsupported answer.
- Apply light spectra and redshift to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on light spectra and redshift against the stated success criteria and name the next step.

**Materials:**

- balloon and marker, or elastic band and ruler
- published galaxy redshift and distance dataset
...
- **Physical hazard.** Balloons pop and are a choking hazard for young children.
  - What stops it: Keep fragments away from young children; anyone with a latex allergy uses the elastic-band model.
- **Emotional hazard.** Cosmological scale and deep time can be unsettling for some learners.
  - What stops it: Pace the content, keep the focus on evidence and reasoning, and allow the learner to pause at any point.
...
**Clearing up.** Put whole balloons and every fragment straight into the bin - fragments are a choking hazard for young children. Recycle the paper. Nothing hazardous is produced.
...
- Science brief: redshift is a shift of spectral lines toward longer wavelengths; blueshift is a shift toward shorter wavelengths.
- Science brief: redshift is identified by the whole characteristic line pattern of an element being displaced, which is what distinguishes it from an object simply being red.
- Science brief: cosmological redshift arises because space itself has expanded while the light was in transit, stretching its wavelength.
- Science brief: measuring the shift of known line patterns is how the recession of distant galaxies is determined.

### Evidence check: light spectra and redshift

**Candidate claim:** A case report presents this as acceptable science: “a red-looking star is redshifted for that reason.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: redshift is a shift of spectral lines toward longer wavelengths; blueshift is a shift toward shorter wavelengths. |
| E2 | established science reference | Science brief: redshift is identified by the whole characteristic line pattern of an element being displaced, which is what distinguishes it from an object simply being red. |
| E3 | established science reference | Science brief: cosmological redshift arises because space itself has expanded while the light was in transit, stretching its wavelength. |
| E4 | established science reference | Science brief: measuring the shift of known line patterns is how the recession of distant galaxies is determined. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs12-earth-space-environmental-u03::light spectra and redshift, derived from the reviewed correctness source policy/correctness/ma-hs12-earth-space-environmental.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about light spectra and redshift, and does it support the candidate claim?
...
**My question.** Write the question you are testing about light spectra and redshift. It has to be a question your evidence could actually answer.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about light spectra and redshift, then name one check that would catch an error or a weak claim.**
...
**Q1.** Complete the route you chose. For the document/model route, use its printed procedure and input table; for the H4 physical route, use the printed safe order and your own blank record. Report the route, evidence IDs or model rows, conclusion about light spectra and redshift, uncertainty, and limitation.

>

**Q2.** Explain light spectra and redshift in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for light spectra and redshift. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about light spectra and redshift, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using light spectra and redshift as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E4 is strongest for evaluating the candidate claim about light spectra and redshift? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E4, state one conclusion about light spectra and redshift that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about light spectra and redshift. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about light spectra and redshift.
...
- Apply light spectra and redshift under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect light spectra and redshift to motion of distant galaxies from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Construct an explanation of the Big Bang theory from astronomical evidence, weighing how each independent line of evidence constrains the model. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-hs12-earth-space-environmental-u03-l07` · lesson `ma-hs12-earth-space-environmental-u03-l07` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
