# Launch and diagnostic: gravitational orbits

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 4: Orbital Motion and the Solar System · Day 1 of the unit (course day 37) · about 55–75 minutes

**Today's focus:** gravitational orbits
...
- Observe the anchoring phenomenon, surface initial thinking about gravitational orbits without penalty, and pose a testable question.
- Explain gravitational orbits using evidence, a model, or a documented process rather than an unsupported answer.
- Apply gravitational orbits to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on gravitational orbits against the stated success criteria and name the next step.
...
- Science brief: gravity provides the force that keeps a body in orbit, and an orbiting body is continuously accelerating toward the body it orbits.
- Science brief: an orbit is the result of a body's sideways motion combined with continuous gravitational acceleration toward the central body.
- Science brief: an orbiting object has weight; it appears weightless because it and everything with it are in free fall together.
- Science brief: the two bodies attract each other equally and both orbit their common centre of mass, which lies inside the more massive body when the mass difference is large.

### Evidence check: gravitational orbits

**Candidate claim:** A case report presents this as acceptable science: “there is no gravity where satellites orbit.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: gravity provides the force that keeps a body in orbit, and an orbiting body is continuously accelerating toward the body it orbits. |
| E2 | established science reference | Science brief: an orbit is the result of a body's sideways motion combined with continuous gravitational acceleration toward the central body. |
| E3 | established science reference | Science brief: an orbiting object has weight; it appears weightless because it and everything with it are in free fall together. |
| E4 | established science reference | Science brief: the two bodies attract each other equally and both orbit their common centre of mass, which lies inside the more massive body when the mass difference is large. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs12-earth-space-environmental-u04::gravitational orbits, derived from the reviewed correctness source policy/correctness/ma-hs12-earth-space-environmental.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about gravitational orbits, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about gravitational orbits, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about gravitational orbits, then name one check that would catch an error or a weak claim.**
...
**Q1.** Use the printed case as today's phenomenon for gravitational orbits. Record what the candidate claim says, identify the mismatch with E1-E4, and pose a testable question naming what would change and what would be measured or classified.

>

**Q2.** Explain gravitational orbits in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q3.** Treat the printed candidate claim as the fresh case for gravitational orbits. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q4.** Check the conclusion about gravitational orbits, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q5.** Answer the printed unit question using gravitational orbits as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q6.** Which one row in E1-E4 is strongest for evaluating the candidate claim about gravitational orbits? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q7.** Using the supplied case and E1-E4, state one conclusion about gravitational orbits that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q8.** Audit the inputs used in your response about gravitational orbits. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about gravitational orbits.
...
- Apply gravitational orbits under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect gravitational orbits to Kepler's relationships from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs12-earth-space-environmental-u04-l01` · lesson `ma-hs12-earth-space-environmental-u04-l01` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
