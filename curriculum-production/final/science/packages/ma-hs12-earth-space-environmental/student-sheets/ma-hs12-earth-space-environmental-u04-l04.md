# Independent application A: elliptical orbits and orbital energy

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 4: Orbital Motion and the Solar System · Day 4 of the unit (course day 40) · about 55–75 minutes

**Today's focus:** elliptical orbits and orbital energy
...
- Explain elliptical orbits and orbital energy using evidence, a model, or a documented process rather than an unsupported answer.
- Apply elliptical orbits and orbital energy to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on elliptical orbits and orbital energy against the stated success criteria and name the next step.
...
- Science brief: in an elliptical orbit, kinetic and gravitational potential energy exchange while the total remains constant in the absence of other forces.
- Science brief: a body speeds up as it approaches the central body, converting potential energy into kinetic, and slows as it recedes.
- Science brief: total orbital energy is conserved for an isolated two-body system, so an orbit does not decay without an external influence such as atmospheric drag.
- Science brief: most planetary orbits in the solar system are close to circular; textbook diagrams exaggerate their ellipticity.

### Evidence check: elliptical orbits and orbital energy

**Candidate claim:** A case report presents this as acceptable science: “earth's orbit is strongly elliptical, and using that to explain the seasons.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: in an elliptical orbit, kinetic and gravitational potential energy exchange while the total remains constant in the absence of other forces. |
| E2 | established science reference | Science brief: a body speeds up as it approaches the central body, converting potential energy into kinetic, and slows as it recedes. |
| E3 | established science reference | Science brief: total orbital energy is conserved for an isolated two-body system, so an orbit does not decay without an external influence such as atmospheric drag. |
| E4 | established science reference | Science brief: most planetary orbits in the solar system are close to circular; textbook diagrams exaggerate their ellipticity. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs12-earth-space-environmental-u04::elliptical orbits and orbital energy, derived from the reviewed correctness source policy/correctness/ma-hs12-earth-space-environmental.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about elliptical orbits and orbital energy, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about elliptical orbits and orbital energy, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about elliptical orbits and orbital energy, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain elliptical orbits and orbital energy in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for elliptical orbits and orbital energy. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about elliptical orbits and orbital energy, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using elliptical orbits and orbital energy as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about elliptical orbits and orbital energy? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about elliptical orbits and orbital energy that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about elliptical orbits and orbital energy. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about elliptical orbits and orbital energy.
...
- Apply elliptical orbits and orbital energy under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect elliptical orbits and orbital energy to gravitational orbits from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs12-earth-space-environmental-u04-l04` · lesson `ma-hs12-earth-space-environmental-u04-l04` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
