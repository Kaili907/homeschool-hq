# Reteach and varied practice: Kepler's relationships

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 4: Orbital Motion and the Solar System · Day 8 of the unit (course day 44) · about 55–75 minutes

**Today's focus:** Kepler's relationships
...
- Apply Kepler's relationships to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on Kepler's relationships against the stated success criteria and name the next step.
...
- Science brief: planetary orbits are ellipses with the Sun at one focus.
- Science brief: the square of the orbital period is proportional to the cube of the semi-major axis.
- Science brief: a planet moves faster when nearer the Sun and slower when farther away, sweeping equal areas in equal times.
- Science brief: the period-radius relationship holds for any set of bodies orbiting the same central mass, which is why it applies to moons and satellites too.

### Evidence check: Kepler's relationships

**Candidate claim:** A case report presents this as acceptable science: “the Sun sits at the centre of a planet's elliptical orbit rather than at a focus.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: planetary orbits are ellipses with the Sun at one focus. |
| E2 | established science reference | Science brief: the square of the orbital period is proportional to the cube of the semi-major axis. |
| E3 | established science reference | Science brief: a planet moves faster when nearer the Sun and slower when farther away, sweeping equal areas in equal times. |
| E4 | established science reference | Science brief: the period-radius relationship holds for any set of bodies orbiting the same central mass, which is why it applies to moons and satellites too. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-hs12-earth-space-environmental-u04::Kepler's relationships, derived from the reviewed correctness source policy/correctness/ma-hs12-earth-space-environmental.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about Kepler's relationships, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about Kepler's relationships, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about Kepler's relationships, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain Kepler's relationships in your own words using at least two specifically named rows from E1-E4. Then explain why the candidate claim does or does not follow.

>

**Q2.** Treat the printed candidate claim as the fresh case for Kepler's relationships. Decide whether E1-E4 supports it, show the evidence-to-conclusion reasoning, and write a more defensible replacement claim if it does not.

>

**Q3.** Check the conclusion about Kepler's relationships, revise its weakest claim with a named row from E1-E4, and name the next observation or model input that would resolve the remaining limitation.

>

**Q4.** Answer the printed unit question using Kepler's relationships as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about Kepler's relationships? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about Kepler's relationships that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about Kepler's relationships. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about Kepler's relationships.
...
- Apply Kepler's relationships under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect Kepler's relationships to gravitational orbits from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs12-earth-space-environmental-u04-l08` · lesson `ma-hs12-earth-space-environmental-u04-l08` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
