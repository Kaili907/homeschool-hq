# Guided practice B: distinguishing correlation and causation

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 1: Earth and Space Systems, Scale, and Data Practice · Day 6 of the unit (course day 6) · about 55–75 minutes
...
_Package `swp-ma-hs12-earth-space-environmental-u01-l06` · lesson `ma-hs12-earth-space-environmental-u01-l06` · built from `hs912-science-h4` at `a86780a`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
