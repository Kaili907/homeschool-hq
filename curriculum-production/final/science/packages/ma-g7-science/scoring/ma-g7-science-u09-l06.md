# Scoring authority — Guided practice B: communicating tradeoffs

**Grade 7 Science** · Unit 9: Engineering Design Capstone · Day 6 · lesson `ma-g7-science-u09-l06`
...
**Q1 — guided practice.** _Serves objective 1:_ Practice communicating tradeoffs with prompts, feedback, and gradually reduced support.
...
**Q4 — essential question.** _Serves objective 1:_ Practice communicating tradeoffs with prompts, feedback, and gradually reduced support.
...
**Q6 — limitation.** _Serves objective 1:_ Practice communicating tradeoffs with prompts, feedback, and gradually reduced support.
...
_Package `swp-ma-g7-science-u09-l06` · built from `canonical-1.0.0` at `4056e31`._
