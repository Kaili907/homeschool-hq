# Scoring authority — Investigation or close reading: water cycle driven by energy and gravity

**Grade 7 Science** · Unit 7: Weather, Climate, and Earth Systems · Day 7 · lesson `ma-g7-science-u07-l07`
...
_Topic `ma-g7-science-u07::water cycle driven by energy and gravity` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- The water cycle is driven by energy from the Sun and by gravity.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Energy from the Sun drives evaporation and transpiration, moving water from surface to atmosphere.
- Gravity drives precipitation, runoff, and the downward movement of water through the ground.
- Water changes state during the cycle but the total amount of water on Earth stays essentially the same.

**Also correct.** Accept any of these framings — do not require the wording above:

- Including transpiration, sublimation, and infiltration among the processes is correct; naming every process is not required.
...
- Claiming the water cycle creates or destroys water.
- Claiming clouds form because water becomes lighter than air rather than by condensation on particles.
- Claiming the cycle runs without any energy input.

**Grade boundary.** Quantitative water budgets and residence times are High School work.
...
**Q1 — analyze evidence.** _Serves objective 1:_ Gather and analyze evidence related to water cycle driven by energy and gravity, then record a defensible interpretation.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of water cycle driven by energy and gravity.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about water cycle driven by energy and gravity using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Gather and analyze evidence related to water cycle driven by energy and gravity, then record a defensible interpretation.
...
**Q5 — evidence quality.** _Serves objective 1:_ Gather and analyze evidence related to water cycle driven by energy and gravity, then record a defensible interpretation.
...
**Q6 — limitation.** _Serves objective 1:_ Gather and analyze evidence related to water cycle driven by energy and gravity, then record a defensible interpretation.
...
**Q7 — provenance.** _Serves objective 1:_ Gather and analyze evidence related to water cycle driven by energy and gravity, then record a defensible interpretation.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for water cycle driven by energy and gravity, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for water cycle driven by energy and gravity works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of water cycle driven by energy and gravity, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking water cycle driven by energy and gravity mastered.
...
_Package `swp-ma-g7-science-u07-l07` · built from `canonical-1.0.0` at `4056e31`._
