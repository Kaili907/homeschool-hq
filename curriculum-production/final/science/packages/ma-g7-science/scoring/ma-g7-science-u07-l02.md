# Scoring authority — Concept model A: air masses and weather

**Grade 7 Science** · Unit 7: Weather, Climate, and Earth Systems · Day 2 · lesson `ma-g7-science-u07-l02`
...
**Q1 — model build.** _Serves objective 1:_ Build a clear mental model of air masses and weather through an explicit worked example, demonstration, text, or phenomenon.
...
**Q4 — essential question.** _Serves objective 1:_ Build a clear mental model of air masses and weather through an explicit worked example, demonstration, text, or phenomenon.
...
**Q6 — limitation.** _Serves objective 1:_ Build a clear mental model of air masses and weather through an explicit worked example, demonstration, text, or phenomenon.
...
_Package `swp-ma-g7-science-u07-l02` · built from `canonical-1.0.0` at `4056e31`._
