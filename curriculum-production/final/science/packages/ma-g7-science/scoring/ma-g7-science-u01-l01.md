# Scoring authority — Launch and diagnostic: atomic and molecular models

**Grade 7 Science** · Unit 1: Matter, Particles, and Properties · Day 1 · lesson `ma-g7-science-u01-l01`
...
_Topic `ma-g7-science-u01::atomic and molecular models` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._
...
**Q1 — activate prior.** _Serves objective 1:_ Activate prior knowledge about atomic and molecular models, surface initial thinking without penalty, and establish the unit question.
...
**Q4 — essential question.** _Serves objective 1:_ Activate prior knowledge about atomic and molecular models, surface initial thinking without penalty, and establish the unit question.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of atomic and molecular models.
...
**Q6 — limitation.** _Serves objective 1:_ Activate prior knowledge about atomic and molecular models, surface initial thinking without penalty, and establish the unit question.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of atomic and molecular models.
...
_Package `swp-ma-g7-science-u01-l01` · built from `canonical-1.0.0` at `4056e31`._
