# Scoring authority — Launch and diagnostic: cell theory

**Grade 7 Science** · Unit 4: Cells and Organism Organization · Day 1 · lesson `ma-g7-science-u04-l01`
...
_Topic `ma-g7-science-u04::cell theory` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._
...
**Q1 — activate prior.** _Serves objective 1:_ Activate prior knowledge about cell theory, surface initial thinking without penalty, and establish the unit question.
...
**Q4 — essential question.** _Serves objective 1:_ Activate prior knowledge about cell theory, surface initial thinking without penalty, and establish the unit question.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of cell theory.
...
**Q6 — limitation.** _Serves objective 1:_ Activate prior knowledge about cell theory, surface initial thinking without penalty, and establish the unit question.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of cell theory.
...
_Package `swp-ma-g7-science-u04-l01` · built from `canonical-1.0.0` at `4056e31`._
