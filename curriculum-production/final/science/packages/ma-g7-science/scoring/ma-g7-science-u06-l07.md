# Scoring authority — Investigation or close reading: resource availability

**Grade 7 Science** · Unit 6: Ecosystem Interactions and Dynamics · Day 7 · lesson `ma-g7-science-u06-l07`
...
_Topic `ma-g7-science-u06::resource availability` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- The number of organisms an ecosystem supports is limited by the resources available: food, water, space, shelter, light, and nutrients.
- When a resource becomes scarce, populations that depend on it decline or move.
- The limiting resource is the one in shortest supply relative to need, and increasing any other does not remove the limit.

**Also correct.** Accept any of these framings — do not require the wording above:

- Naming the idea a limiting factor is correct but not required at this grade.
...
- Claiming a population can grow indefinitely if food alone is plentiful.
- Claiming resources are unlimited in a large ecosystem.
- Claiming increasing a non-limiting resource increases the population.

**Grade boundary.** Logistic growth equations and quantitative carrying capacity are High School work.
...
**Q1 — analyze evidence.** _Serves objective 1:_ Gather and analyze evidence related to resource availability, then record a defensible interpretation.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of resource availability.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about resource availability using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Gather and analyze evidence related to resource availability, then record a defensible interpretation.
...
**Q5 — evidence quality.** _Serves objective 1:_ Gather and analyze evidence related to resource availability, then record a defensible interpretation.
...
**Q6 — limitation.** _Serves objective 1:_ Gather and analyze evidence related to resource availability, then record a defensible interpretation.
...
**Q7 — provenance.** _Serves objective 1:_ Gather and analyze evidence related to resource availability, then record a defensible interpretation.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for resource availability, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for resource availability works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of resource availability, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking resource availability mastered.
...
_Package `swp-ma-g7-science-u06-l07` · built from `canonical-1.0.0` at `4056e31`._
