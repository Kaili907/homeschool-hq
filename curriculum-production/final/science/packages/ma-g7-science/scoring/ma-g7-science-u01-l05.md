# Scoring authority — Concept model B: model limitations

**Grade 7 Science** · Unit 1: Matter, Particles, and Properties · Day 5 · lesson `ma-g7-science-u01-l05`
...
**Q1 — model build.** _Serves objective 1:_ Build a clear mental model of model limitations through an explicit worked example, demonstration, text, or phenomenon.
...
**Q4 — essential question.** _Serves objective 1:_ Build a clear mental model of model limitations through an explicit worked example, demonstration, text, or phenomenon.
...
**Q6 — limitation.** _Serves objective 1:_ Build a clear mental model of model limitations through an explicit worked example, demonstration, text, or phenomenon.
...
_Package `swp-ma-g7-science-u01-l05` · built from `canonical-1.0.0` at `4056e31`._
