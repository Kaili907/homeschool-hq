# Scoring authority — Investigation or close reading: cell theory

**Grade 7 Science** · Unit 4: Cells and Organism Organization · Day 7 · lesson `ma-g7-science-u04-l07`
...
_Topic `ma-g7-science-u04::cell theory` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- All living things are made of one or more cells, the cell is the basic unit of structure and function, and all cells come from pre-existing cells.

**Accepted relationships and models.** What this lesson's learning target asserts:

- All living organisms are composed of one or more cells.
- The cell is the basic unit of structure and function in living things.
- All cells arise from pre-existing cells; cells do not form spontaneously from non-living material.
...
- Claiming some living organisms are not made of cells.
- Claiming cells form spontaneously from non-living matter.
- Claiming viruses are cells.

**Grade boundary.** Cell-cycle detail, prokaryote-eukaryote molecular differences, and endosymbiosis are High School work.
...
**Q1 — analyze evidence.** _Serves objective 1:_ Gather and analyze evidence related to cell theory, then record a defensible interpretation.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of cell theory.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about cell theory using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Gather and analyze evidence related to cell theory, then record a defensible interpretation.
...
**Q5 — evidence quality.** _Serves objective 1:_ Gather and analyze evidence related to cell theory, then record a defensible interpretation.
...
**Q6 — limitation.** _Serves objective 1:_ Gather and analyze evidence related to cell theory, then record a defensible interpretation.
...
**Q7 — provenance.** _Serves objective 1:_ Gather and analyze evidence related to cell theory, then record a defensible interpretation.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for cell theory, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for cell theory works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of cell theory, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking cell theory mastered.
...
_Package `swp-ma-g7-science-u04-l07` · built from `canonical-1.0.0` at `4056e31`._
