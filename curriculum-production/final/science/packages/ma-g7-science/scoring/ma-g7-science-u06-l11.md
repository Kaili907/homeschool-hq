# Scoring authority — Unit assessment: matter and energy flow

**Grade 7 Science** · Unit 6: Ecosystem Interactions and Dynamics · Day 11 · lesson `ma-g7-science-u06-l11`
...
_Topic `ma-g7-science-u06::matter and energy flow` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Matter cycles within an ecosystem; energy flows through it and is not recycled.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Energy enters most ecosystems as sunlight, is captured by producers, and passes to consumers, with most released to the surroundings at each transfer.
- Matter cycles: atoms pass between organisms and the environment repeatedly and are not used up.
- Because most energy is lost at each transfer, ecosystems support far less biomass at higher feeding levels.
...
- Claiming all the energy at one feeding level passes to the next.
- Claiming matter is destroyed when an organism dies.

**Grade boundary.** Specific trophic efficiency percentages and quantitative energy pyramids are High School work.


## What a complete response contains, question by question

**Q1 — demonstrate mastery.** _Serves objective 1:_ Demonstrate current mastery of matter and energy flow through selected-response, constructed-response, and applied evidence.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of matter and energy flow.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about matter and energy flow using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Demonstrate current mastery of matter and energy flow through selected-response, constructed-response, and applied evidence.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of matter and energy flow.
...
**Q6 — limitation.** _Serves objective 1:_ Demonstrate current mastery of matter and energy flow through selected-response, constructed-response, and applied evidence.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of matter and energy flow.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for matter and energy flow, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for matter and energy flow works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of matter and energy flow, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking matter and energy flow mastered.
...
_Package `swp-ma-g7-science-u06-l11` · built from `canonical-1.0.0` at `4056e31`._
