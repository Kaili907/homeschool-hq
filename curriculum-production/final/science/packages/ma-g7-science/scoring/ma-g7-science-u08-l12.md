# Scoring authority — Correction and reflection: mitigation and adaptation

**Grade 7 Science** · Unit 8: Natural Hazards and Human Impacts · Day 12 · lesson `ma-g7-science-u08-l12`
...
_Topic `ma-g7-science-u08::mitigation and adaptation` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Mitigation reduces the cause of a problem; adaptation reduces the harm from effects that occur anyway.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Mitigation acts on the cause, such as reducing emissions; adaptation acts on the consequences, such as changing where and how people build.
- Both are needed, because some change is already committed and further change can still be limited.
- Every option has costs, and who pays them and who benefits are part of the evaluation.
...
- Using mitigation and adaptation as though they meant the same thing.
- Claiming adaptation removes the need to address the cause.
- Presenting an option as having benefits with no costs.

**Grade boundary.** Policy instruments and cost-benefit modelling are High School work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for mitigation and adaptation, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of mitigation and adaptation.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about mitigation and adaptation using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for mitigation and adaptation, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of mitigation and adaptation.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for mitigation and adaptation, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of mitigation and adaptation.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for mitigation and adaptation, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for mitigation and adaptation works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of mitigation and adaptation, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking mitigation and adaptation mastered.
...
_Package `swp-ma-g7-science-u08-l12` · built from `canonical-1.0.0` at `4056e31`._
