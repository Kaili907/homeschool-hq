...
**Grade 7 Science** · Unit 3: Thermal Energy and Energy Transfer · Day 8 · lesson `ma-g7-science-u03-l08`
...
_Topic `ma-g7-science-u03::conduction convection and radiation` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Conduction transfers energy through direct particle contact, convection through the bulk movement of a fluid, and radiation by electromagnetic waves requiring no medium.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Conduction transfers energy through collisions between neighbouring particles, so it needs matter in contact.
- Convection transfers energy by the bulk movement of a heated fluid, so it happens in liquids and gases, not in solids.
- Radiation transfers energy as electromagnetic waves and is the only mechanism that works across a vacuum.
...
- Claiming radiation requires a medium to travel through.
- Claiming energy from the Sun reaches Earth mainly by conduction or convection.

**Grade boundary.** Quantitative transfer equations and emissivity are High School work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for conduction convection and radiation, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of conduction convection and radiation.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about conduction convection and radiation using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for conduction convection and radiation, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of conduction convection and radiation.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for conduction convection and radiation, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of conduction convection and radiation.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for conduction convection and radiation, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for conduction convection and radiation works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of conduction convection and radiation, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking conduction convection and radiation mastered.
...
_Package `swp-ma-g7-science-u03-l08` · built from `canonical-1.0.0` at `4056e31`._
