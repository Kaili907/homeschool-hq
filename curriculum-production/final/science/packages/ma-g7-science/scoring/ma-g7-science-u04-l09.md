# Scoring authority — Performance task build: unicellular and multicellular organisms

**Grade 7 Science** · Unit 4: Cells and Organism Organization · Day 9 · lesson `ma-g7-science-u04-l09`
...
_Topic `ma-g7-science-u04::unicellular and multicellular organisms` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._
...
- In a multicellular organism, cells are specialised, and groups of them carry out different functions for the whole organism.
- Being unicellular is not a lesser condition; unicellular organisms are complete, successful organisms.
...
- Claiming unicellular organisms cannot carry out all the functions of life.
- Claiming a colony of identical cells is the same as a multicellular organism with specialised cells.
- Claiming multicellular organisms are more advanced in a way that makes unicellular ones incomplete.

**Grade boundary.** Differentiation mechanisms and stem-cell biology are High School work.
...
**Q1 — build product.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies unicellular and multicellular organisms and the unit standards.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of unicellular and multicellular organisms.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about unicellular and multicellular organisms using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies unicellular and multicellular organisms and the unit standards.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of unicellular and multicellular organisms.
...
**Q6 — limitation.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies unicellular and multicellular organisms and the unit standards.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of unicellular and multicellular organisms.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for unicellular and multicellular organisms, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for unicellular and multicellular organisms works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of unicellular and multicellular organisms, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking unicellular and multicellular organisms mastered.
...
_Package `swp-ma-g7-science-u04-l09` · built from `canonical-1.0.0` at `4056e31`._
