# Scoring authority — Reteach and varied practice: nervous system signaling

**Grade 7 Science** · Unit 5: Body Systems, Senses, and Responses · Day 8 · lesson `ma-g7-science-u05-l08`
...
_Topic `ma-g7-science-u05::nervous system signaling` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Nerve cells carry information as electrical and chemical signals.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Sensory receptors detect a stimulus and send signals along nerve cells toward the brain and spinal cord.
- Signals are processed in the brain or spinal cord, and signals are then sent out to muscles or glands to produce a response.
- Signalling is fast compared with chemical messengers carried in the blood, which is why the nervous system handles rapid responses.

**Also correct.** Accept any of these framings — do not require the wording above:

- Describing the pathway as receptor, processing, response, or as stimulus, integration, effector, are both correct.
...
- Claiming nerve signals travel as a fluid pushed along the nerve.
- Claiming a response occurs without any processing anywhere.
- Reversing the direction, with signals travelling from muscles to receptors as the normal pathway.

**Grade boundary.** Action potentials, synaptic transmission, and neurotransmitters are High School work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for nervous system signaling, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of nervous system signaling.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about nervous system signaling using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for nervous system signaling, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of nervous system signaling.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for nervous system signaling, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of nervous system signaling.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for nervous system signaling, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for nervous system signaling works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of nervous system signaling, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking nervous system signaling mastered.
...
_Package `swp-ma-g7-science-u05-l08` · built from `canonical-1.0.0` at `4056e31`._
