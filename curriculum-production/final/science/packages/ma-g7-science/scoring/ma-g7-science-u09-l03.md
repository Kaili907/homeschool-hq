# Scoring authority — Guided practice A: test data

**Grade 7 Science** · Unit 9: Engineering Design Capstone · Day 3 · lesson `ma-g7-science-u09-l03`
...
_Topic `ma-g7-science-u09::test data` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._
...
**Q1 — guided practice.** _Serves objective 1:_ Practice test data with prompts, feedback, and gradually reduced support.
...
**Q4 — essential question.** _Serves objective 1:_ Practice test data with prompts, feedback, and gradually reduced support.
...
**Q6 — limitation.** _Serves objective 1:_ Practice test data with prompts, feedback, and gradually reduced support.
...
_Package `swp-ma-g7-science-u09-l03` · built from `canonical-1.0.0` at `4056e31`._
