# Scoring authority — Launch and diagnostic: resource availability

**Grade 7 Science** · Unit 6: Ecosystem Interactions and Dynamics · Day 1 · lesson `ma-g7-science-u06-l01`
...
_Topic `ma-g7-science-u06::resource availability` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._
...
**Q1 — activate prior.** _Serves objective 1:_ Activate prior knowledge about resource availability, surface initial thinking without penalty, and establish the unit question.
...
**Q4 — essential question.** _Serves objective 1:_ Activate prior knowledge about resource availability, surface initial thinking without penalty, and establish the unit question.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of resource availability.
...
**Q6 — limitation.** _Serves objective 1:_ Activate prior knowledge about resource availability, surface initial thinking without penalty, and establish the unit question.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of resource availability.
...
_Package `swp-ma-g7-science-u06-l01` · built from `canonical-1.0.0` at `4056e31`._
