# Scoring authority — Performance task build: physical and chemical properties

**Grade 7 Science** · Unit 1: Matter, Particles, and Properties · Day 9 · lesson `ma-g7-science-u01-l09`
...
_Topic `ma-g7-science-u01::physical and chemical properties` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A physical property can be observed without changing the substance into a different substance; a chemical property describes how it changes into one.
- Characteristic properties such as melting point, boiling point, density, and solubility do not depend on how much of the substance there is, so they can identify it.
- Identification is stronger when several characteristic properties agree.

**Also correct.** Accept any of these framings — do not require the wording above:

- Intensive and extensive, or characteristic and non-characteristic, are both acceptable ways to make the amount-independence distinction.
...
- Treating mass or volume as a property that identifies a substance.
- Claiming flammability or reactivity can be observed without any change occurring.
- Identifying a substance from a single property and stating it as certain.

**Grade boundary.** Quantitative density calculation is acceptable but not required; spectroscopic identification is High School work.
...
**Q1 — build product.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies physical and chemical properties and the unit standards.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of physical and chemical properties.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about physical and chemical properties using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies physical and chemical properties and the unit standards.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of physical and chemical properties.
...
**Q6 — limitation.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies physical and chemical properties and the unit standards.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of physical and chemical properties.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for physical and chemical properties, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for physical and chemical properties works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of physical and chemical properties, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking physical and chemical properties mastered.
...
_Package `swp-ma-g7-science-u01-l09` · built from `canonical-1.0.0` at `4056e31`._
