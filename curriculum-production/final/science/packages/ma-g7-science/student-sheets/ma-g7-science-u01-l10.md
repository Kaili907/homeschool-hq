# Synthesis and review: synthetic materials

**Grade 7 Science** · Unit 1: Matter, Particles, and Properties · Day 10 of the unit (course day 10) · about 45–65 minutes

**Today's focus:** synthetic materials
...
- Connect synthetic materials to the unit’s other ideas and select evidence that shows readiness for assessment.
- Use subject-appropriate evidence or representation to communicate understanding of synthetic materials.
- Check, revise, or improve work about synthetic materials using stated success criteria.
...
- Science brief: synthetic materials are made by processing natural resources so that new substances with new properties are produced.
- Science brief: the properties of a synthetic material come from its composition and structure, which is why they can be designed for a purpose.
- Science brief: every synthetic material carries costs as well as benefits, in resources used, energy required, and what happens at the end of its life.

### Evidence check: synthetic materials

**Candidate claim:** A case report presents this as acceptable science: “synthetic materials are not made from natural resources.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: synthetic materials are made by processing natural resources so that new substances with new properties are produced. |
| E2 | established science reference | Science brief: the properties of a synthetic material come from its composition and structure, which is why they can be designed for a purpose. |
| E3 | established science reference | Science brief: every synthetic material carries costs as well as benefits, in resources used, energy required, and what happens at the end of its life. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u01::synthetic materials, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about synthetic materials, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about synthetic materials, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about synthetic materials; then identify one check that would catch an error or weak claim.**
...
**Q1.** The supplied unit connections are: atomic and molecular models, pure substances and mixtures, physical and chemical properties, synthetic materials, model limitations, evidence from properties. Choose one idea other than synthetic materials, connect it to one row in E1-E3, and explain one way treating the two ideas as identical would be misleading.

>

**Q2.** Communicate what the supplied record establishes about synthetic materials in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about synthetic materials against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using synthetic materials as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about synthetic materials? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about synthetic materials that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about synthetic materials. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about synthetic materials.
...
- Apply synthetic materials under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect synthetic materials to atomic and molecular models from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g7-science-u01-l10` · lesson `ma-g7-science-u01-l10` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
