# Reteach and varied practice: pure substances and mixtures

**Grade 7 Science** · Unit 1: Matter, Particles, and Properties · Day 8 of the unit (course day 8) · about 45–65 minutes

**Today's focus:** pure substances and mixtures
...
- Use error evidence to choose a different representation or strategy for pure substances and mixtures, then demonstrate corrected understanding.
- Use subject-appropriate evidence or representation to communicate understanding of pure substances and mixtures.
- Check, revise, or improve work about pure substances and mixtures using stated success criteria.
...
- Science brief: a pure substance has a fixed composition; a mixture does not.
- Science brief: a pure substance, whether an element or a compound, has a fixed composition and a characteristic set of properties.
- Science brief: a mixture contains two or more substances in no fixed ratio, and each keeps its own properties.
- Science brief: mixtures are separated by physical means; the components of a compound are separated only by chemical change.

### Evidence check: pure substances and mixtures

**Candidate claim:** A case report presents this as acceptable science: “classifying a compound as a mixture because it contains more than one element.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a pure substance has a fixed composition; a mixture does not. |
| E2 | established science reference | Science brief: a pure substance, whether an element or a compound, has a fixed composition and a characteristic set of properties. |
| E3 | established science reference | Science brief: a mixture contains two or more substances in no fixed ratio, and each keeps its own properties. |
| E4 | established science reference | Science brief: mixtures are separated by physical means; the components of a compound are separated only by chemical change. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u01::pure substances and mixtures, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about pure substances and mixtures, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about pure substances and mixtures, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about pure substances and mixtures; then identify one check that would catch an error or weak claim.**
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E4. Name the decisive evidence ID, explain the error about pure substances and mixtures, and write a corrected claim.

>

**Q2.** Communicate what the supplied record establishes about pure substances and mixtures in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about pure substances and mixtures against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using pure substances and mixtures as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about pure substances and mixtures? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about pure substances and mixtures that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about pure substances and mixtures. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about pure substances and mixtures.
...
- Apply pure substances and mixtures under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect pure substances and mixtures to atomic and molecular models from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g7-science-u01-l08` · lesson `ma-g7-science-u01-l08` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
