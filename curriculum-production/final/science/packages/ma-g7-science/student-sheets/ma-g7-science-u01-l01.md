# Launch and diagnostic: atomic and molecular models

**Grade 7 Science** · Unit 1: Matter, Particles, and Properties · Day 1 of the unit (course day 1) · about 45–65 minutes
...
- Activate prior knowledge about atomic and molecular models, surface initial thinking without penalty, and establish the unit question.
...
**The task.** What does evidence E1 through E4 justify about atomic and molecular models, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**Q1.** Before rereading the brief, classify the supplied candidate claim about atomic and molecular models as supported, partly supported, or not supported. Then read E1-E4, revise the classification, and name the evidence ID that changed or confirmed your thinking.
...
_Package `swp-ma-g7-science-u01-l01` · lesson `ma-g7-science-u01-l01` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
