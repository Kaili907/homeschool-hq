# Independent application A: mass material and temperature change

**Grade 7 Science** · Unit 3: Thermal Energy and Energy Transfer · Day 4 of the unit (course day 28) · about 45–65 minutes
...
- Apply mass material and temperature change independently in a new representation, text, situation, or design constraint.
...
**Q1.** Independently evaluate this fully supplied case about mass material and temperature change: A case report presents this as acceptable science: “equal energy input produces equal temperature change regardless of mass.” Use at least two rows from E1-E3, correct the claim if needed, and state one limit.
...
_Package `swp-ma-g7-science-u03-l04` · lesson `ma-g7-science-u03-l04` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
