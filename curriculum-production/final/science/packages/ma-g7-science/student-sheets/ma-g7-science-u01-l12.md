# Correction and reflection: evidence from properties

**Grade 7 Science** · Unit 1: Matter, Particles, and Properties · Day 12 of the unit (course day 12) · about 45–65 minutes

**Today's focus:** evidence from properties
...
- Use error evidence to choose a different representation or strategy for evidence from properties, then demonstrate corrected understanding.
- Use subject-appropriate evidence or representation to communicate understanding of evidence from properties.
- Check, revise, or improve work about evidence from properties using stated success criteria.
...
- Science brief: measured properties are the evidence for a claim about what a substance is.
- Science brief: the strength of the evidence depends on how characteristic the property is and how well it was measured.
- Science brief: a property measurement that disagrees with the identification is reported and explained, not dropped.

### Evidence check: evidence from properties

**Candidate claim:** A case report presents this as acceptable science: “an identification is confirmed while omitting a measurement that disagrees.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: measured properties are the evidence for a claim about what a substance is. |
| E2 | established science reference | Science brief: the strength of the evidence depends on how characteristic the property is and how well it was measured. |
| E3 | established science reference | Science brief: a property measurement that disagrees with the identification is reported and explained, not dropped. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u01::evidence from properties, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about evidence from properties, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about evidence from properties, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about evidence from properties; then identify one check that would catch an error or weak claim.**
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E3. Name the decisive evidence ID, explain the error about evidence from properties, and write a corrected claim.

>

**Q2.** Communicate what the supplied record establishes about evidence from properties in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about evidence from properties against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using evidence from properties as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about evidence from properties? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about evidence from properties that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about evidence from properties. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about evidence from properties.
...
- Apply evidence from properties under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect evidence from properties to atomic and molecular models from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g7-science-u01-l12` · lesson `ma-g7-science-u01-l12` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
