...
**Grade 7 Science** · Unit 3: Thermal Energy and Energy Transfer · Day 8 of the unit (course day 32) · about 45–65 minutes
...
- Use error evidence to choose a different representation or strategy for conduction convection and radiation, then demonstrate corrected understanding.
- Use subject-appropriate evidence or representation to communicate understanding of conduction convection and radiation.
- Check, revise, or improve work about conduction convection and radiation using stated success criteria.
...
- Science brief: conduction transfers energy through direct particle contact, convection through the bulk movement of a fluid, and radiation by electromagnetic waves requiring no medium.
- Science brief: conduction transfers energy through collisions between neighbouring particles, so it needs matter in contact.
- Science brief: convection transfers energy by the bulk movement of a heated fluid, so it happens in liquids and gases, not in solids.
- Science brief: radiation transfers energy as electromagnetic waves and is the only mechanism that works across a vacuum.
...
| --- | --- | --- |
| E1 | established science reference | Science brief: conduction transfers energy through direct particle contact, convection through the bulk movement of a fluid, and radiation by electromagnetic waves requiring no medium. |
| E2 | established science reference | Science brief: conduction transfers energy through collisions between neighbouring particles, so it needs matter in contact. |
| E3 | established science reference | Science brief: convection transfers energy by the bulk movement of a heated fluid, so it happens in liquids and gases, not in solids. |
| E4 | established science reference | Science brief: radiation transfers energy as electromagnetic waves and is the only mechanism that works across a vacuum. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u03::conduction convection and radiation, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about conduction convection and radiation; then identify one check that would catch an error or weak claim.**
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E4. Name the decisive evidence ID, explain the error about conduction convection and radiation, and write a corrected claim.

>

**Q2.** Communicate what the supplied record establishes about conduction convection and radiation in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about conduction convection and radiation against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.
...
- Apply conduction convection and radiation under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect conduction convection and radiation to temperature and particle motion from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g7-science-u03-l08` · lesson `ma-g7-science-u03-l08` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
