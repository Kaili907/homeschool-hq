# Independent application A: stimulus and response

**Grade 7 Science** · Unit 5: Body Systems, Senses, and Responses · Day 4 of the unit (course day 52) · about 45–65 minutes
...
- Apply stimulus and response independently in a new representation, text, situation, or design constraint.
...
**Q1.** Independently evaluate this fully supplied case about stimulus and response: A case report presents this as acceptable science: “every response to a stimulus is identical regardless of context.” Use at least two rows from E1-E3, correct the claim if needed, and state one limit.
...
_Package `swp-ma-g7-science-u05-l04` · lesson `ma-g7-science-u05-l04` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
