# Unit assessment: climate evidence

**Grade 7 Science** · Unit 8: Natural Hazards and Human Impacts · Day 11 of the unit (course day 95) · about 45–65 minutes
...
- Demonstrate current mastery of climate evidence through selected-response, constructed-response, and applied evidence.
...
- Science brief: global average surface temperature has risen since the late nineteenth century, and the increase in atmospheric carbon dioxide from burning fossil fuels is the principal cause.
- Science brief: evidence for climate change comes from many independent lines: instrument records, ice cores, sea level, glacier extent, and the timing of biological events.
- Science brief: independent lines of evidence agreeing is what makes the conclusion robust; no single record carries it alone.
- Science brief: climate change is a change in long-term patterns, so it is established from decades of record, not from individual seasons.

### Evidence check: climate evidence

**Candidate claim:** A case report presents this as acceptable science: “citing one cold season as evidence against long-term warming.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: global average surface temperature has risen since the late nineteenth century, and the increase in atmospheric carbon dioxide from burning fossil fuels is the principal cause. |
| E2 | established science reference | Science brief: evidence for climate change comes from many independent lines: instrument records, ice cores, sea level, glacier extent, and the timing of biological events. |
| E3 | established science reference | Science brief: independent lines of evidence agreeing is what makes the conclusion robust; no single record carries it alone. |
| E4 | established science reference | Science brief: climate change is a change in long-term patterns, so it is established from decades of record, not from individual seasons. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u08::climate evidence, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
**What did you check, what did you change, and what is your next step? Rate confidence in climate evidence, cite one piece of evidence from today, and choose: ready to extend, ready to review later, or need a different explanation.**
...
**Q1.** Complete all three parts for climate evidence. (1) Select A: supported, B: partly supported, or C: not supported for the candidate claim. (2) Justify the selection with E1-E4. (3) Rewrite the claim so every word is supported by the supplied record.
...
- Connect climate evidence to hazard mapping from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g7-science-u08-l11` · lesson `ma-g7-science-u08-l11` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
