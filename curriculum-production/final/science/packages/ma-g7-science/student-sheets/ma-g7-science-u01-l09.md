# Performance task build: physical and chemical properties

**Grade 7 Science** · Unit 1: Matter, Particles, and Properties · Day 9 of the unit (course day 9) · about 45–65 minutes
...
- Create, test, or revise a meaningful product that applies physical and chemical properties and the unit standards.
- Use subject-appropriate evidence or representation to communicate understanding of physical and chemical properties.
- Check, revise, or improve work about physical and chemical properties using stated success criteria.
...
- Science brief: a physical property can be observed without changing the substance into a different substance; a chemical property describes how it changes into one.
- Science brief: characteristic properties such as melting point, boiling point, density, and solubility do not depend on how much of the substance there is, so they can identify it.
- Science brief: identification is stronger when several characteristic properties agree.

### Evidence check: physical and chemical properties

**Candidate claim:** A case report presents this as acceptable science: “treating mass or volume as a property that identifies a substance.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a physical property can be observed without changing the substance into a different substance; a chemical property describes how it changes into one. |
| E2 | established science reference | Science brief: characteristic properties such as melting point, boiling point, density, and solubility do not depend on how much of the substance there is, so they can identify it. |
| E3 | established science reference | Science brief: identification is stronger when several characteristic properties agree. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u01::physical and chemical properties, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about physical and chemical properties, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about physical and chemical properties?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g7-science-u01::physical and chemical properties, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u01::physical and chemical properties, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about physical and chemical properties?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about physical and chemical properties; then identify one check that would catch an error or weak claim.**
...
**Q1.** Create a one-page evidence product for physical and chemical properties using only the supplied case and E1-E3: one claim, at least two cited rows, the reasoning link, one counterpoint, and one revision after checking the success criteria.

>

**Q2.** Communicate what the supplied record establishes about physical and chemical properties in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about physical and chemical properties against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using physical and chemical properties as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about physical and chemical properties? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about physical and chemical properties that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about physical and chemical properties. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- Apply physical and chemical properties under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect physical and chemical properties to atomic and molecular models from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g7-science-u01-l09` · lesson `ma-g7-science-u01-l09` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
