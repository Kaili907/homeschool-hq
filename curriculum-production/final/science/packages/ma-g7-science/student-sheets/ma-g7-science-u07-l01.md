# Launch and diagnostic: water cycle driven by energy and gravity

**Grade 7 Science** · Unit 7: Weather, Climate, and Earth Systems · Day 1 of the unit (course day 73) · about 45–65 minutes
...
- Activate prior knowledge about water cycle driven by energy and gravity, surface initial thinking without penalty, and establish the unit question.
...
**The task.** What does evidence E1 through E4 justify about water cycle driven by energy and gravity, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**Q1.** Before rereading the brief, classify the supplied candidate claim about water cycle driven by energy and gravity as supported, partly supported, or not supported. Then read E1-E4, revise the classification, and name the evidence ID that changed or confirmed your thinking.
...
_Package `swp-ma-g7-science-u07-l01` · lesson `ma-g7-science-u07-l01` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
