...
**Grade 7 Science** · Unit 9: Engineering Design Capstone · Day 4 of the unit (course day 100) · about 45–65 minutes
...
**Q1.** Independently evaluate this fully supplied case about iterative modeling: A case report presents this as acceptable science: “revising a model to fit data without saying what the disagreement showed.” Use at least two rows from E1-E3, correct the claim if needed, and state one limit.
...
_Package `swp-ma-g7-science-u09-l04` · lesson `ma-g7-science-u09-l04` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
