# Investigation or close reading: defining criteria and constraints

**Grade 7 Science** · Unit 9: Engineering Design Capstone · Day 7 of the unit (course day 103) · about 45–65 minutes

**Today's focus:** defining criteria and constraints

**Unit question:** How can understanding engineering design capstone help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Gather and analyze evidence related to defining criteria and constraints, then record a defensible interpretation.
- Use subject-appropriate evidence or representation to communicate understanding of defining criteria and constraints.
- Check, revise, or improve work about defining criteria and constraints using stated success criteria.
...
- Science brief: a well-defined problem states criteria that can be measured and constraints that can be checked.
- Science brief: the definition comes before solution generation, so that all candidates are judged the same way.
- Science brief: constraints include safety, cost, time, materials, and law, and none of them is traded away for performance.

### Evidence check: defining criteria and constraints

**Candidate claim:** A case report presents this as acceptable science: “writing a criterion that no test could evaluate.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a well-defined problem states criteria that can be measured and constraints that can be checked. |
| E2 | established science reference | Science brief: the definition comes before solution generation, so that all candidates are judged the same way. |
| E3 | established science reference | Science brief: constraints include safety, cost, time, materials, and law, and none of them is traded away for performance. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u09::defining criteria and constraints, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.

**Supplied unit connections:** defining criteria and constraints; evaluating competing solutions; test data; iterative modeling; optimization; communicating tradeoffs

**Supplied unit performance task:** Design, test, analyze, and improve a solution connected to energy, ecosystems, weather, or community safety.

### Bound task

**Question:** What does evidence E1 through E3 justify about defining criteria and constraints, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about defining criteria and constraints?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g7-science-u09::defining criteria and constraints, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u09::defining criteria and constraints, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about defining criteria and constraints?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about defining criteria and constraints; then identify one check that would catch an error or weak claim.**
...
**Q1.** Classify every supplied row E1-E3 as supports, challenges, or does not decide the candidate claim about defining criteria and constraints. Cite the row and explain each classification.

>

**Q2.** Communicate what the supplied record establishes about defining criteria and constraints in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about defining criteria and constraints against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using defining criteria and constraints as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about defining criteria and constraints? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about defining criteria and constraints that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about defining criteria and constraints. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about defining criteria and constraints.
...
- Apply defining criteria and constraints under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect defining criteria and constraints to evaluating competing solutions from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Design, test, analyze, and improve a solution connected to energy, ecosystems, weather, or community safety. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-g7-science-u09-l07` · lesson `ma-g7-science-u09-l07` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
