# Synthesis and review: tissues organs and systems

**Grade 7 Science** · Unit 4: Cells and Organism Organization · Day 10 of the unit (course day 46) · about 45–65 minutes

**Today's focus:** tissues organs and systems
...
- Connect tissues organs and systems to the unit’s other ideas and select evidence that shows readiness for assessment.
- Use subject-appropriate evidence or representation to communicate understanding of tissues organs and systems.
- Check, revise, or improve work about tissues organs and systems using stated success criteria.
...
- Science brief: the levels of organisation run cells, tissues, organs, organ systems, organism.
- Science brief: similar specialised cells form tissues, tissues form organs, organs form organ systems, and systems together form the organism.
- Science brief: each level does something the level below cannot do on its own; the organisation is what produces the capability.
- Science brief: a failure at one level affects the levels above it.

### Evidence check: tissues organs and systems
...
| --- | --- | --- |
| E1 | established science reference | Science brief: the levels of organisation run cells, tissues, organs, organ systems, organism. |
| E2 | established science reference | Science brief: similar specialised cells form tissues, tissues form organs, organs form organ systems, and systems together form the organism. |
| E3 | established science reference | Science brief: each level does something the level below cannot do on its own; the organisation is what produces the capability. |
| E4 | established science reference | Science brief: a failure at one level affects the levels above it. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u04::tissues organs and systems, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about tissues organs and systems, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about tissues organs and systems, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about tissues organs and systems; then identify one check that would catch an error or weak claim.**
...
**Q1.** The supplied unit connections are: cell theory, cell structures and functions, unicellular and multicellular organisms, tissues organs and systems, microscope image interpretation, structure and function. Choose one idea other than tissues organs and systems, connect it to one row in E1-E4, and explain one way treating the two ideas as identical would be misleading.

>

**Q2.** Communicate what the supplied record establishes about tissues organs and systems in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about tissues organs and systems against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using tissues organs and systems as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about tissues organs and systems? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about tissues organs and systems that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about tissues organs and systems. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about tissues organs and systems.
...
- Apply tissues organs and systems under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect tissues organs and systems to cell theory from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g7-science-u04-l10` · lesson `ma-g7-science-u04-l10` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
