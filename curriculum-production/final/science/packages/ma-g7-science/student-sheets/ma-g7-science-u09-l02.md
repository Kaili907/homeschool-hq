# Concept model A: evaluating competing solutions

**Grade 7 Science** · Unit 9: Engineering Design Capstone · Day 2 of the unit (course day 98) · about 45–65 minutes
...
- Build a clear mental model of evaluating competing solutions through an explicit worked example, demonstration, text, or phenomenon.
...
**Q1.** Build a labelled model of evaluating competing solutions that represents every supplied row in E1-E3. Annotate each model feature with its evidence ID, then show where the candidate claim fails or remains uncertain.
...
_Package `swp-ma-g7-science-u09-l02` · lesson `ma-g7-science-u09-l02` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
