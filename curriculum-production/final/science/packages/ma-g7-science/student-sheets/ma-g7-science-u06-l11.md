# Unit assessment: matter and energy flow

**Grade 7 Science** · Unit 6: Ecosystem Interactions and Dynamics · Day 11 of the unit (course day 71) · about 45–65 minutes

**Today's focus:** matter and energy flow
...
- Demonstrate current mastery of matter and energy flow through selected-response, constructed-response, and applied evidence.
- Use subject-appropriate evidence or representation to communicate understanding of matter and energy flow.
- Check, revise, or improve work about matter and energy flow using stated success criteria.
...
- Science brief: matter cycles within an ecosystem; energy flows through it and is not recycled.
- Science brief: energy enters most ecosystems as sunlight, is captured by producers, and passes to consumers, with most released to the surroundings at each transfer.
- Science brief: matter cycles: atoms pass between organisms and the environment repeatedly and are not used up.
- Science brief: because most energy is lost at each transfer, ecosystems support far less biomass at higher feeding levels.

### Evidence check: matter and energy flow
...
| --- | --- | --- |
| E1 | established science reference | Science brief: matter cycles within an ecosystem; energy flows through it and is not recycled. |
| E2 | established science reference | Science brief: energy enters most ecosystems as sunlight, is captured by producers, and passes to consumers, with most released to the surroundings at each transfer. |
| E3 | established science reference | Science brief: matter cycles: atoms pass between organisms and the environment repeatedly and are not used up. |
| E4 | established science reference | Science brief: because most energy is lost at each transfer, ecosystems support far less biomass at higher feeding levels. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u06::matter and energy flow, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about matter and energy flow, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about matter and energy flow, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? Rate confidence in matter and energy flow, cite one piece of evidence from today, and choose: ready to extend, ready to review later, or need a different explanation.**
...
**Q1.** Complete all three parts for matter and energy flow. (1) Select A: supported, B: partly supported, or C: not supported for the candidate claim. (2) Justify the selection with E1-E4. (3) Rewrite the claim so every word is supported by the supplied record.

>

**Q2.** Communicate what the supplied record establishes about matter and energy flow in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about matter and energy flow against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using matter and energy flow as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about matter and energy flow? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about matter and energy flow that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about matter and energy flow. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about matter and energy flow.
...
- Apply matter and energy flow under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect matter and energy flow to resource availability from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g7-science-u06-l11` · lesson `ma-g7-science-u06-l11` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
