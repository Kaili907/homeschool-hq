# Investigation or close reading: signs of reaction

**Grade 7 Science** · Unit 2: Chemical Reactions and Conservation · Day 7 of the unit (course day 19) · about 45–65 minutes

**Today's focus:** signs of reaction
...
- Gather and analyze evidence related to signs of reaction, then record a defensible interpretation.
- Use subject-appropriate evidence or representation to communicate understanding of signs of reaction.
- Check, revise, or improve work about signs of reaction using stated success criteria.
...
- Science brief: a chemical reaction produces one or more substances with properties different from the starting substances.
- Science brief: signs that suggest a reaction include gas production, a temperature change not caused by external heating or cooling, a colour change, a precipitate, light, and a new odour.
- Science brief: each sign has non-chemical explanations too, so a conclusion rests on several lines of evidence together.

### Evidence check: signs of reaction

**Candidate claim:** A case report presents this as acceptable science: “treating bubbling alone as proof of reaction when boiling or escaping dissolved gas explains it.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a chemical reaction produces one or more substances with properties different from the starting substances. |
| E2 | established science reference | Science brief: signs that suggest a reaction include gas production, a temperature change not caused by external heating or cooling, a colour change, a precipitate, light, and a new odour. |
| E3 | established science reference | Science brief: each sign has non-chemical explanations too, so a conclusion rests on several lines of evidence together. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u02::signs of reaction, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about signs of reaction, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about signs of reaction?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g7-science-u02::signs of reaction, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u02::signs of reaction, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about signs of reaction?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about signs of reaction; then identify one check that would catch an error or weak claim.**
...
**Q1.** Classify every supplied row E1-E3 as supports, challenges, or does not decide the candidate claim about signs of reaction. Cite the row and explain each classification.

>

**Q2.** Communicate what the supplied record establishes about signs of reaction in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about signs of reaction against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using signs of reaction as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about signs of reaction? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about signs of reaction that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about signs of reaction. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about signs of reaction.
...
- Apply signs of reaction under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect signs of reaction to reactants and products from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g7-science-u02-l07` · lesson `ma-g7-science-u02-l07` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
