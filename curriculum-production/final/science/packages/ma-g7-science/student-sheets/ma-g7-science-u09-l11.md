...
**Grade 7 Science** · Unit 9: Engineering Design Capstone · Day 11 of the unit (course day 107) · about 45–65 minutes
...
- Science brief: optimising means improving performance against the criteria within the constraints, not improving everything at once.
- Science brief: improving one criterion often worsens another, so optimisation involves choosing which trade-off to accept.
- Science brief: an optimum is relative to the criteria chosen; different criteria give a different optimum.
...
| --- | --- | --- |
| E1 | established science reference | Science brief: optimising means improving performance against the criteria within the constraints, not improving everything at once. |
| E2 | established science reference | Science brief: improving one criterion often worsens another, so optimisation involves choosing which trade-off to accept. |
| E3 | established science reference | Science brief: an optimum is relative to the criteria chosen; different criteria give a different optimum. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u09::optimization, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
- Connect optimization to defining criteria and constraints from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g7-science-u09-l11` · lesson `ma-g7-science-u09-l11` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
