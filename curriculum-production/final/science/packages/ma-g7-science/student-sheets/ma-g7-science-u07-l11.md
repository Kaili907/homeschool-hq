# Unit assessment: weather maps

**Grade 7 Science** · Unit 7: Weather, Climate, and Earth Systems · Day 11 of the unit (course day 83) · about 45–65 minutes

**Today's focus:** weather maps
...
- Demonstrate current mastery of weather maps through selected-response, constructed-response, and applied evidence.
- Use subject-appropriate evidence or representation to communicate understanding of weather maps.
- Check, revise, or improve work about weather maps using stated success criteria.
...
- Science brief: weather maps show measured conditions and analysed features such as fronts, pressure centres, and precipitation, each with its own symbol.
- Science brief: a map is a snapshot with a stated time; reading a forecast from it requires knowing how the features move.
- Science brief: air moves from higher pressure toward lower pressure, which is why pressure patterns indicate wind.

### Evidence check: weather maps

**Candidate claim:** A case report presents this as acceptable science: “reading a weather map with no time stamp as showing current conditions.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: weather maps show measured conditions and analysed features such as fronts, pressure centres, and precipitation, each with its own symbol. |
| E2 | established science reference | Science brief: a map is a snapshot with a stated time; reading a forecast from it requires knowing how the features move. |
| E3 | established science reference | Science brief: air moves from higher pressure toward lower pressure, which is why pressure patterns indicate wind. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u07::weather maps, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about weather maps, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about weather maps, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? Rate confidence in weather maps, cite one piece of evidence from today, and choose: ready to extend, ready to review later, or need a different explanation.**
...
**Q1.** Complete all three parts for weather maps. (1) Select A: supported, B: partly supported, or C: not supported for the candidate claim. (2) Justify the selection with E1-E3. (3) Rewrite the claim so every word is supported by the supplied record.

>

**Q2.** Communicate what the supplied record establishes about weather maps in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about weather maps against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using weather maps as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about weather maps? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about weather maps that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about weather maps. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about weather maps.
...
- Apply weather maps under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect weather maps to water cycle driven by energy and gravity from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g7-science-u07-l11` · lesson `ma-g7-science-u07-l11` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
