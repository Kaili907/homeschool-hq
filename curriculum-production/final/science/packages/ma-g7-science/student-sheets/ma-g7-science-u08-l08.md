# Reteach and varied practice: risk and vulnerability

**Grade 7 Science** · Unit 8: Natural Hazards and Human Impacts · Day 8 of the unit (course day 92) · about 45–65 minutes

**Today's focus:** risk and vulnerability
...
- Use error evidence to choose a different representation or strategy for risk and vulnerability, then demonstrate corrected understanding.
- Use subject-appropriate evidence or representation to communicate understanding of risk and vulnerability.
- Check, revise, or improve work about risk and vulnerability using stated success criteria.
...
- Science brief: risk depends on the hazard, on what is exposed to it, and on how vulnerable that exposure is.
- Science brief: two communities facing the same hazard can face very different risk, because exposure and vulnerability differ.
- Science brief: reducing risk can act on exposure or on vulnerability, since the hazard itself cannot be prevented.

### Evidence check: risk and vulnerability

**Candidate claim:** A case report presents this as acceptable science: “treating risk and hazard as the same thing.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: risk depends on the hazard, on what is exposed to it, and on how vulnerable that exposure is. |
| E2 | established science reference | Science brief: two communities facing the same hazard can face very different risk, because exposure and vulnerability differ. |
| E3 | established science reference | Science brief: reducing risk can act on exposure or on vulnerability, since the hazard itself cannot be prevented. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u08::risk and vulnerability, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about risk and vulnerability, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about risk and vulnerability, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about risk and vulnerability; then identify one check that would catch an error or weak claim.**
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E3. Name the decisive evidence ID, explain the error about risk and vulnerability, and write a corrected claim.

>

**Q2.** Communicate what the supplied record establishes about risk and vulnerability in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about risk and vulnerability against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using risk and vulnerability as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about risk and vulnerability? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about risk and vulnerability that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about risk and vulnerability. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about risk and vulnerability.
...
- Apply risk and vulnerability under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect risk and vulnerability to hazard mapping from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g7-science-u08-l08` · lesson `ma-g7-science-u08-l08` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
