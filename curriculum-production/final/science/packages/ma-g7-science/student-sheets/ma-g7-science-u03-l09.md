# Performance task build: energy transfer

**Grade 7 Science** · Unit 3: Thermal Energy and Energy Transfer · Day 9 of the unit (course day 33) · about 45–65 minutes

**Today's focus:** energy transfer
...
- Create, test, or revise a meaningful product that applies energy transfer and the unit standards.
- Use subject-appropriate evidence or representation to communicate understanding of energy transfer.
- Check, revise, or improve work about energy transfer using stated success criteria.
...
- Science brief: thermal energy is transferred spontaneously from the higher-temperature object to the lower-temperature one.
- Science brief: when objects at different temperatures interact, energy is transferred from the warmer to the cooler until they reach the same temperature.
- Science brief: the transfer is one-directional on its own; energy does not move spontaneously from cooler to warmer.
- Science brief: total energy is conserved during the transfer: what one object loses, the other and the surroundings gain.

### Evidence check: energy transfer

**Candidate claim:** A case report presents this as acceptable science: “cold flows from the cooler object into the warmer one.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: thermal energy is transferred spontaneously from the higher-temperature object to the lower-temperature one. |
| E2 | established science reference | Science brief: when objects at different temperatures interact, energy is transferred from the warmer to the cooler until they reach the same temperature. |
| E3 | established science reference | Science brief: the transfer is one-directional on its own; energy does not move spontaneously from cooler to warmer. |
| E4 | established science reference | Science brief: total energy is conserved during the transfer: what one object loses, the other and the surroundings gain. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u03::energy transfer, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about energy transfer, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about energy transfer?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g7-science-u03::energy transfer, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u03::energy transfer, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about energy transfer?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about energy transfer; then identify one check that would catch an error or weak claim.**
...
**Q1.** Create a one-page evidence product for energy transfer using only the supplied case and E1-E4: one claim, at least two cited rows, the reasoning link, one counterpoint, and one revision after checking the success criteria.

>

**Q2.** Communicate what the supplied record establishes about energy transfer in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about energy transfer against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using energy transfer as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about energy transfer? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about energy transfer that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about energy transfer. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about energy transfer.
...
- Apply energy transfer under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect energy transfer to temperature and particle motion from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g7-science-u03-l09` · lesson `ma-g7-science-u03-l09` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
