# Concept model B: climate evidence

**Grade 7 Science** · Unit 8: Natural Hazards and Human Impacts · Day 5 of the unit (course day 89) · about 45–65 minutes
...
- Build a clear mental model of climate evidence through an explicit worked example, demonstration, text, or phenomenon.
...
**Q1.** Build a labelled model of climate evidence that represents every supplied row in E1-E4. Annotate each model feature with its evidence ID, then show where the candidate claim fails or remains uncertain.
...
_Package `swp-ma-g7-science-u08-l05` · lesson `ma-g7-science-u08-l05` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
