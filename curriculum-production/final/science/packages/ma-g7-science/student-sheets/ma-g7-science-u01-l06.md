# Guided practice B: evidence from properties

**Grade 7 Science** · Unit 1: Matter, Particles, and Properties · Day 6 of the unit (course day 6) · about 45–65 minutes
...
- Practice evidence from properties with prompts, feedback, and gradually reduced support.
...
**Q1.** First compare E1 with E2 and write a provisional conclusion about evidence from properties. Then add the remaining rows through E3, revise the conclusion, and explain the change.
...
_Package `swp-ma-g7-science-u01-l06` · lesson `ma-g7-science-u01-l06` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
