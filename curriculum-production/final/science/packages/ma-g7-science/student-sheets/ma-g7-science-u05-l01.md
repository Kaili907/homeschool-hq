# Launch and diagnostic: system interactions

**Grade 7 Science** · Unit 5: Body Systems, Senses, and Responses · Day 1 of the unit (course day 49) · about 45–65 minutes
...
- Activate prior knowledge about system interactions, surface initial thinking without penalty, and establish the unit question.
...
**Q1.** Before rereading the brief, classify the supplied candidate claim about system interactions as supported, partly supported, or not supported. Then read E1-E3, revise the classification, and name the evidence ID that changed or confirmed your thinking.
...
_Package `swp-ma-g7-science-u05-l01` · lesson `ma-g7-science-u05-l01` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
