# Concept model A: air masses and weather

**Grade 7 Science** · Unit 7: Weather, Climate, and Earth Systems · Day 2 of the unit (course day 74) · about 45–65 minutes

**Today's focus:** air masses and weather
...
- Build a clear mental model of air masses and weather through an explicit worked example, demonstration, text, or phenomenon.
- Use subject-appropriate evidence or representation to communicate understanding of air masses and weather.
- Check, revise, or improve work about air masses and weather using stated success criteria.
...
- Science brief: weather changes occur at the boundaries between air masses of different temperature and humidity.
- Science brief: an air mass takes on the temperature and humidity of the region it forms over.
- Science brief: where air masses of different properties meet, the warmer, less dense air is forced upward, it cools, water vapour condenses, and clouds and precipitation form.
- Science brief: the kind of weather depends on the properties of the air masses involved and on how they meet.

### Evidence check: air masses and weather

**Candidate claim:** A case report presents this as acceptable science: “warm air sinks below cold air.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: weather changes occur at the boundaries between air masses of different temperature and humidity. |
| E2 | established science reference | Science brief: an air mass takes on the temperature and humidity of the region it forms over. |
| E3 | established science reference | Science brief: where air masses of different properties meet, the warmer, less dense air is forced upward, it cools, water vapour condenses, and clouds and precipitation form. |
| E4 | established science reference | Science brief: the kind of weather depends on the properties of the air masses involved and on how they meet. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u07::air masses and weather, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about air masses and weather, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about air masses and weather, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about air masses and weather; then identify one check that would catch an error or weak claim.**
...
**Q1.** Build a labelled model of air masses and weather that represents every supplied row in E1-E4. Annotate each model feature with its evidence ID, then show where the candidate claim fails or remains uncertain.

>

**Q2.** Communicate what the supplied record establishes about air masses and weather in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about air masses and weather against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using air masses and weather as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about air masses and weather? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about air masses and weather that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about air masses and weather. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about air masses and weather.
...
- Apply air masses and weather under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect air masses and weather to water cycle driven by energy and gravity from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g7-science-u07-l02` · lesson `ma-g7-science-u07-l02` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
