# Synthesis and review: thermal changes

**Grade 7 Science** · Unit 2: Chemical Reactions and Conservation · Day 10 of the unit (course day 22) · about 45–65 minutes

**Today's focus:** thermal changes
...
- Connect thermal changes to the unit’s other ideas and select evidence that shows readiness for assessment.
- Use subject-appropriate evidence or representation to communicate understanding of thermal changes.
- Check, revise, or improve work about thermal changes using stated success criteria.
...
- Science brief: an exothermic process releases energy to its surroundings; an endothermic process absorbs energy from them.
- Science brief: some reactions release energy to the surroundings and some absorb energy from them.
- Science brief: a container that becomes warmer indicates energy released by the reaction inside it; one that becomes cooler indicates energy absorbed.
- Science brief: energy released or absorbed is transferred, not created or destroyed.

### Evidence check: thermal changes

**Candidate claim:** A case report presents this as acceptable science: “an endothermic reaction creates cold rather than absorbing energy.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: an exothermic process releases energy to its surroundings; an endothermic process absorbs energy from them. |
| E2 | established science reference | Science brief: some reactions release energy to the surroundings and some absorb energy from them. |
| E3 | established science reference | Science brief: a container that becomes warmer indicates energy released by the reaction inside it; one that becomes cooler indicates energy absorbed. |
| E4 | established science reference | Science brief: energy released or absorbed is transferred, not created or destroyed. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u02::thermal changes, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about thermal changes, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about thermal changes, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about thermal changes; then identify one check that would catch an error or weak claim.**
...
**Q1.** The supplied unit connections are: signs of reaction, reactants and products, conservation of atoms, thermal changes, reaction evidence, designing a heat-transfer device. Choose one idea other than thermal changes, connect it to one row in E1-E4, and explain one way treating the two ideas as identical would be misleading.

>

**Q2.** Communicate what the supplied record establishes about thermal changes in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about thermal changes against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using thermal changes as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about thermal changes? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about thermal changes that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about thermal changes. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about thermal changes.
...
- Apply thermal changes under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect thermal changes to signs of reaction from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g7-science-u02-l10` · lesson `ma-g7-science-u02-l10` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
