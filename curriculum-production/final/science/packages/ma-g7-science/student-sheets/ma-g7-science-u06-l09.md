# Performance task build: mutualism

**Grade 7 Science** · Unit 6: Ecosystem Interactions and Dynamics · Day 9 of the unit (course day 69) · about 45–65 minutes

**Today's focus:** mutualism

**Unit question:** How can understanding ecosystem interactions and dynamics help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Create, test, or revise a meaningful product that applies mutualism and the unit standards.
- Use subject-appropriate evidence or representation to communicate understanding of mutualism.
- Check, revise, or improve work about mutualism using stated success criteria.
...
- Science brief: in mutualism both species benefit; in commensalism one benefits and the other is largely unaffected; in parasitism one benefits at the other's expense.
- Science brief: in a mutualistic relationship both species gain something, such as food, protection, or transport.
- Science brief: mutualism is not cooperation by intention; each species is acting in ways that happen to benefit the other.
- Science brief: mutualism, commensalism, and parasitism are distinguished by who benefits and who is harmed.

### Evidence check: mutualism

**Candidate claim:** A case report presents this as acceptable science: “classifying a relationship as mutualism when only one species benefits.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: in mutualism both species benefit; in commensalism one benefits and the other is largely unaffected; in parasitism one benefits at the other's expense. |
| E2 | established science reference | Science brief: in a mutualistic relationship both species gain something, such as food, protection, or transport. |
| E3 | established science reference | Science brief: mutualism is not cooperation by intention; each species is acting in ways that happen to benefit the other. |
| E4 | established science reference | Science brief: mutualism, commensalism, and parasitism are distinguished by who benefits and who is harmed. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u06::mutualism, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.

**Supplied unit connections:** resource availability; competition and predation; mutualism; food webs; matter and energy flow; ecosystem change

**Supplied unit performance task:** Use a dataset to explain an ecosystem change and predict effects across a food web.

### Bound task

**Question:** What does evidence E1 through E4 justify about mutualism, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about mutualism?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g7-science-u06::mutualism, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u06::mutualism, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about mutualism?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about mutualism; then identify one check that would catch an error or weak claim.**
...
**Q1.** Create a one-page evidence product for mutualism using only the supplied case and E1-E4: one claim, at least two cited rows, the reasoning link, one counterpoint, and one revision after checking the success criteria.

>

**Q2.** Communicate what the supplied record establishes about mutualism in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about mutualism against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using mutualism as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about mutualism? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about mutualism that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about mutualism. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about mutualism.
...
- Apply mutualism under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect mutualism to resource availability from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Use a dataset to explain an ecosystem change and predict effects across a food web. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-g7-science-u06-l09` · lesson `ma-g7-science-u06-l09` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
