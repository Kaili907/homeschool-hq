# Investigation or close reading: hazard mapping

**Grade 7 Science** · Unit 8: Natural Hazards and Human Impacts · Day 7 of the unit (course day 91) · about 45–65 minutes

**Today's focus:** hazard mapping

**Unit question:** How can understanding natural hazards and human impacts help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Gather and analyze evidence related to hazard mapping, then record a defensible interpretation.
- Use subject-appropriate evidence or representation to communicate understanding of hazard mapping.
- Check, revise, or improve work about hazard mapping using stated success criteria.
...
- Science brief: natural hazards occur in patterns tied to geology, geography, and climate, so where they are likely can be mapped.
- Science brief: a hazard map shows likelihood and, usually, severity; it does not predict a particular event on a particular day.
- Science brief: maps are built from historical records and physical understanding, and both have limits that belong in the reading.

### Evidence check: hazard mapping

**Candidate claim:** A case report presents this as acceptable science: “reading a hazard map as a prediction of when an event will occur.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: natural hazards occur in patterns tied to geology, geography, and climate, so where they are likely can be mapped. |
| E2 | established science reference | Science brief: a hazard map shows likelihood and, usually, severity; it does not predict a particular event on a particular day. |
| E3 | established science reference | Science brief: maps are built from historical records and physical understanding, and both have limits that belong in the reading. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u08::hazard mapping, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.

**Supplied unit connections:** hazard mapping; risk and vulnerability; resource use; population and consumption; climate evidence; mitigation and adaptation

**Supplied unit performance task:** Develop an evidence-based community resilience proposal with tradeoffs and equity considerations.

### Bound task

**Question:** What does evidence E1 through E3 justify about hazard mapping, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about hazard mapping?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g7-science-u08::hazard mapping, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u08::hazard mapping, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about hazard mapping?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about hazard mapping; then identify one check that would catch an error or weak claim.**
...
**Q1.** Classify every supplied row E1-E3 as supports, challenges, or does not decide the candidate claim about hazard mapping. Cite the row and explain each classification.

>

**Q2.** Communicate what the supplied record establishes about hazard mapping in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about hazard mapping against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using hazard mapping as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about hazard mapping? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about hazard mapping that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about hazard mapping. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about hazard mapping.
...
- Apply hazard mapping under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect hazard mapping to risk and vulnerability from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Develop an evidence-based community resilience proposal with tradeoffs and equity considerations. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-g7-science-u08-l07` · lesson `ma-g7-science-u08-l07` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
