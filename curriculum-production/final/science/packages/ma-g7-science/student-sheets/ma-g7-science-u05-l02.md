# Concept model A: nervous system signaling

**Grade 7 Science** · Unit 5: Body Systems, Senses, and Responses · Day 2 of the unit (course day 50) · about 45–65 minutes

**Today's focus:** nervous system signaling
...
- Build a clear mental model of nervous system signaling through an explicit worked example, demonstration, text, or phenomenon.
- Use subject-appropriate evidence or representation to communicate understanding of nervous system signaling.
- Check, revise, or improve work about nervous system signaling using stated success criteria.
...
- Science brief: nerve cells carry information as electrical and chemical signals.
- Science brief: sensory receptors detect a stimulus and send signals along nerve cells toward the brain and spinal cord.
- Science brief: signals are processed in the brain or spinal cord, and signals are then sent out to muscles or glands to produce a response.
- Science brief: signalling is fast compared with chemical messengers carried in the blood, which is why the nervous system handles rapid responses.

### Evidence check: nervous system signaling

**Candidate claim:** A case report presents this as acceptable science: “nerve signals travel as a fluid pushed along the nerve.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: nerve cells carry information as electrical and chemical signals. |
| E2 | established science reference | Science brief: sensory receptors detect a stimulus and send signals along nerve cells toward the brain and spinal cord. |
| E3 | established science reference | Science brief: signals are processed in the brain or spinal cord, and signals are then sent out to muscles or glands to produce a response. |
| E4 | established science reference | Science brief: signalling is fast compared with chemical messengers carried in the blood, which is why the nervous system handles rapid responses. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u05::nervous system signaling, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about nervous system signaling, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about nervous system signaling, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about nervous system signaling; then identify one check that would catch an error or weak claim.**
...
**Q1.** Build a labelled model of nervous system signaling that represents every supplied row in E1-E4. Annotate each model feature with its evidence ID, then show where the candidate claim fails or remains uncertain.

>

**Q2.** Communicate what the supplied record establishes about nervous system signaling in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about nervous system signaling against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using nervous system signaling as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about nervous system signaling? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about nervous system signaling that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about nervous system signaling. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about nervous system signaling.
...
- Apply nervous system signaling under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect nervous system signaling to system interactions from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g7-science-u05-l02` · lesson `ma-g7-science-u05-l02` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
