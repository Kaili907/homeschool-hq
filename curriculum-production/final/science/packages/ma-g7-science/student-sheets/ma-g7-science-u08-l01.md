# Launch and diagnostic: hazard mapping

**Grade 7 Science** · Unit 8: Natural Hazards and Human Impacts · Day 1 of the unit (course day 85) · about 45–65 minutes
...
- Activate prior knowledge about hazard mapping, surface initial thinking without penalty, and establish the unit question.
...
**The task.** What does evidence E1 through E3 justify about hazard mapping, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**Q1.** Before rereading the brief, classify the supplied candidate claim about hazard mapping as supported, partly supported, or not supported. Then read E1-E3, revise the classification, and name the evidence ID that changed or confirmed your thinking.
...
_Package `swp-ma-g7-science-u08-l01` · lesson `ma-g7-science-u08-l01` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
