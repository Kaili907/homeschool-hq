# Performance task build: resource use

**Grade 7 Science** · Unit 8: Natural Hazards and Human Impacts · Day 9 of the unit (course day 93) · about 45–65 minutes
...
- Create, test, or revise a meaningful product that applies resource use and the unit standards.
...
- Science brief: resources are distributed unevenly because of the geological and biological processes that formed them.
- Science brief: extracting and using a resource changes the environment where it is taken and where it is used.
- Science brief: a renewable resource is only sustainable if the rate of use stays below the rate of replenishment.
...
| --- | --- | --- |
| E1 | established science reference | Science brief: resources are distributed unevenly because of the geological and biological processes that formed them. |
| E2 | established science reference | Science brief: extracting and using a resource changes the environment where it is taken and where it is used. |
| E3 | established science reference | Science brief: a renewable resource is only sustainable if the rate of use stays below the rate of replenishment. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u08::resource use, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about resource use, and does it support the candidate claim?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g7-science-u08::resource use, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u08::resource use, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
**Q1.** Create a one-page evidence product for resource use using only the supplied case and E1-E3: one claim, at least two cited rows, the reasoning link, one counterpoint, and one revision after checking the success criteria.

>

**Q2.** Communicate what the supplied record establishes about resource use in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about resource use against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using resource use as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about resource use? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about resource use that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about resource use. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- Connect resource use to hazard mapping from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g7-science-u08-l09` · lesson `ma-g7-science-u08-l09` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
