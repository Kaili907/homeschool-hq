# Investigation or close reading: temperature and particle motion

**Grade 7 Science** · Unit 3: Thermal Energy and Energy Transfer · Day 7 of the unit (course day 31) · about 45–65 minutes

**Today's focus:** temperature and particle motion

**Unit question:** How can understanding thermal energy and energy transfer help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Gather and analyze evidence related to temperature and particle motion, then record a defensible interpretation.
- Use subject-appropriate evidence or representation to communicate understanding of temperature and particle motion.
- Check, revise, or improve work about temperature and particle motion using stated success criteria.
...
- Science brief: temperature is a measure of the average kinetic energy of the particles in a sample.
- Science brief: the particles in any sample of matter are in constant motion, and temperature measures the average kinetic energy of that motion.
- Science brief: temperature and total thermal energy are different: a large cool object can contain more thermal energy than a small hot one.
- Science brief: adding energy to a sample generally raises its temperature, except during a change of state, when it changes the arrangement of particles instead.

### Evidence check: temperature and particle motion

**Candidate claim:** A case report presents this as acceptable science: “temperature and thermal energy are the same quantity.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: temperature is a measure of the average kinetic energy of the particles in a sample. |
| E2 | established science reference | Science brief: the particles in any sample of matter are in constant motion, and temperature measures the average kinetic energy of that motion. |
| E3 | established science reference | Science brief: temperature and total thermal energy are different: a large cool object can contain more thermal energy than a small hot one. |
| E4 | established science reference | Science brief: adding energy to a sample generally raises its temperature, except during a change of state, when it changes the arrangement of particles instead. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u03::temperature and particle motion, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.

**Supplied unit connections:** temperature and particle motion; conduction convection and radiation; energy transfer; mass material and temperature change; potential and kinetic energy; device efficiency

**Supplied unit performance task:** Test insulating or thermal-control designs and explain results using particle and energy models.

### Bound task

**Question:** What does evidence E1 through E4 justify about temperature and particle motion, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about temperature and particle motion?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g7-science-u03::temperature and particle motion, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u03::temperature and particle motion, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about temperature and particle motion?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about temperature and particle motion; then identify one check that would catch an error or weak claim.**
...
**Q1.** Classify every supplied row E1-E4 as supports, challenges, or does not decide the candidate claim about temperature and particle motion. Cite the row and explain each classification.

>

**Q2.** Communicate what the supplied record establishes about temperature and particle motion in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about temperature and particle motion against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using temperature and particle motion as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about temperature and particle motion? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about temperature and particle motion that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about temperature and particle motion. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about temperature and particle motion.
...
- Apply temperature and particle motion under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect temperature and particle motion to conduction convection and radiation from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Test insulating or thermal-control designs and explain results using particle and energy models. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-g7-science-u03-l07` · lesson `ma-g7-science-u03-l07` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
