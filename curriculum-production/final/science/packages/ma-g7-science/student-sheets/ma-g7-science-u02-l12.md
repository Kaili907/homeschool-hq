# Correction and reflection: designing a heat-transfer device

**Grade 7 Science** · Unit 2: Chemical Reactions and Conservation · Day 12 of the unit (course day 24) · about 45–65 minutes

**Today's focus:** designing a heat-transfer device
...
- Use error evidence to choose a different representation or strategy for designing a heat-transfer device, then demonstrate corrected understanding.
- Use subject-appropriate evidence or representation to communicate understanding of designing a heat-transfer device.
- Check, revise, or improve work about designing a heat-transfer device using stated success criteria.
...
- Science brief: a device that releases or absorbs thermal energy works by controlling the rate of transfer between a source and its surroundings.
- Science brief: insulating materials slow transfer; they do not produce warmth or cold.
- Science brief: the device is judged against measurable criteria, such as how far the temperature changed and how long the effect lasted.

### Evidence check: designing a heat-transfer device

**Candidate claim:** A case report presents this as acceptable science: “an insulator generates warmth or cold.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a device that releases or absorbs thermal energy works by controlling the rate of transfer between a source and its surroundings. |
| E2 | established science reference | Science brief: insulating materials slow transfer; they do not produce warmth or cold. |
| E3 | established science reference | Science brief: the device is judged against measurable criteria, such as how far the temperature changed and how long the effect lasted. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u02::designing a heat-transfer device, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about designing a heat-transfer device, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about designing a heat-transfer device, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about designing a heat-transfer device; then identify one check that would catch an error or weak claim.**
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E3. Name the decisive evidence ID, explain the error about designing a heat-transfer device, and write a corrected claim.

>

**Q2.** Communicate what the supplied record establishes about designing a heat-transfer device in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about designing a heat-transfer device against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using designing a heat-transfer device as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about designing a heat-transfer device? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about designing a heat-transfer device that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about designing a heat-transfer device. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about designing a heat-transfer device.
...
- Apply designing a heat-transfer device under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect designing a heat-transfer device to signs of reaction from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g7-science-u02-l12` · lesson `ma-g7-science-u02-l12` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
