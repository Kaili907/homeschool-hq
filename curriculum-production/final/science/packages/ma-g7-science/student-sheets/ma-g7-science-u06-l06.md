# Guided practice B: ecosystem change

**Grade 7 Science** · Unit 6: Ecosystem Interactions and Dynamics · Day 6 of the unit (course day 66) · about 45–65 minutes
...
- Practice ecosystem change with prompts, feedback, and gradually reduced support.
...
**Q1.** First compare E1 with E2 and write a provisional conclusion about ecosystem change. Then add the remaining rows through E3, revise the conclusion, and explain the change.
...
_Package `swp-ma-g7-science-u06-l06` · lesson `ma-g7-science-u06-l06` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
