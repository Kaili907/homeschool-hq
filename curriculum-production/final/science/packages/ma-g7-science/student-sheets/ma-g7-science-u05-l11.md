# Unit assessment: homeostasis concept

**Grade 7 Science** · Unit 5: Body Systems, Senses, and Responses · Day 11 of the unit (course day 59) · about 45–65 minutes

**Today's focus:** homeostasis concept
...
- Demonstrate current mastery of homeostasis concept through selected-response, constructed-response, and applied evidence.
- Use subject-appropriate evidence or representation to communicate understanding of homeostasis concept.
- Check, revise, or improve work about homeostasis concept using stated success criteria.
...
- Science brief: homeostasis is the maintenance of internal conditions within a range, not at a single fixed value.
- Science brief: organisms maintain internal conditions such as temperature, water balance, and blood sugar within a workable range.
- Science brief: maintenance requires detecting a departure from the range and acting to reverse it, which is a feedback process.
- Science brief: internal conditions fluctuate within the range; homeostasis is regulation, not constancy.

### Evidence check: homeostasis concept

**Candidate claim:** A case report presents this as acceptable science: “internal conditions are held perfectly constant.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: homeostasis is the maintenance of internal conditions within a range, not at a single fixed value. |
| E2 | established science reference | Science brief: organisms maintain internal conditions such as temperature, water balance, and blood sugar within a workable range. |
| E3 | established science reference | Science brief: maintenance requires detecting a departure from the range and acting to reverse it, which is a feedback process. |
| E4 | established science reference | Science brief: internal conditions fluctuate within the range; homeostasis is regulation, not constancy. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u05::homeostasis concept, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about homeostasis concept, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about homeostasis concept, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? Rate confidence in homeostasis concept, cite one piece of evidence from today, and choose: ready to extend, ready to review later, or need a different explanation.**
...
**Q1.** Complete all three parts for homeostasis concept. (1) Select A: supported, B: partly supported, or C: not supported for the candidate claim. (2) Justify the selection with E1-E4. (3) Rewrite the claim so every word is supported by the supplied record.

>

**Q2.** Communicate what the supplied record establishes about homeostasis concept in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about homeostasis concept against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using homeostasis concept as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about homeostasis concept? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about homeostasis concept that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about homeostasis concept. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about homeostasis concept.
...
- Apply homeostasis concept under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect homeostasis concept to system interactions from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g7-science-u05-l11` · lesson `ma-g7-science-u05-l11` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
