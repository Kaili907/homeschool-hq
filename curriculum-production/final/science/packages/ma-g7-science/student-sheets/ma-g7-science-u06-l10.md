# Synthesis and review: food webs

**Grade 7 Science** · Unit 6: Ecosystem Interactions and Dynamics · Day 10 of the unit (course day 70) · about 45–65 minutes

**Today's focus:** food webs
...
- Connect food webs to the unit’s other ideas and select evidence that shows readiness for assessment.
- Use subject-appropriate evidence or representation to communicate understanding of food webs.
- Check, revise, or improve work about food webs using stated success criteria.
...
- Science brief: a food web shows feeding relationships, with arrows running from the organism that is eaten to the organism that eats it.
- Science brief: because organisms appear in several chains, a change to one population can affect populations several links away.
- Science brief: producers form the base of every web, and decomposers act on organisms at every level.

### Evidence check: food webs

**Candidate claim:** A case report presents this as acceptable science: “drawing food-web arrows from predator to prey.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a food web shows feeding relationships, with arrows running from the organism that is eaten to the organism that eats it. |
| E2 | established science reference | Science brief: because organisms appear in several chains, a change to one population can affect populations several links away. |
| E3 | established science reference | Science brief: producers form the base of every web, and decomposers act on organisms at every level. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u06::food webs, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about food webs, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about food webs, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about food webs; then identify one check that would catch an error or weak claim.**
...
**Q1.** The supplied unit connections are: resource availability, competition and predation, mutualism, food webs, matter and energy flow, ecosystem change. Choose one idea other than food webs, connect it to one row in E1-E3, and explain one way treating the two ideas as identical would be misleading.

>

**Q2.** Communicate what the supplied record establishes about food webs in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about food webs against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using food webs as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about food webs? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about food webs that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about food webs. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about food webs.
...
- Apply food webs under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect food webs to resource availability from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g7-science-u06-l10` · lesson `ma-g7-science-u06-l10` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
