# Unit assessment: microscope image interpretation

**Grade 7 Science** · Unit 4: Cells and Organism Organization · Day 11 of the unit (course day 47) · about 45–65 minutes

**Today's focus:** microscope image interpretation
...
- Demonstrate current mastery of microscope image interpretation through selected-response, constructed-response, and applied evidence.
- Use subject-appropriate evidence or representation to communicate understanding of microscope image interpretation.
- Check, revise, or improve work about microscope image interpretation using stated success criteria.
...
- Science brief: a microscope image is a two-dimensional view of a thin slice or a thin sample, so what is seen depends on how the sample was prepared.
- Science brief: magnification and the scale bar are needed before any size can be read from an image.
- Science brief: stains and preparation can introduce features that are artefacts rather than parts of the living cell.

### Evidence check: microscope image interpretation

**Candidate claim:** A case report presents this as acceptable science: “reading a size off a micrograph with no scale or magnification given.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a microscope image is a two-dimensional view of a thin slice or a thin sample, so what is seen depends on how the sample was prepared. |
| E2 | established science reference | Science brief: magnification and the scale bar are needed before any size can be read from an image. |
| E3 | established science reference | Science brief: stains and preparation can introduce features that are artefacts rather than parts of the living cell. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u04::microscope image interpretation, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about microscope image interpretation, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about microscope image interpretation, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? Rate confidence in microscope image interpretation, cite one piece of evidence from today, and choose: ready to extend, ready to review later, or need a different explanation.**
...
**Q1.** Complete all three parts for microscope image interpretation. (1) Select A: supported, B: partly supported, or C: not supported for the candidate claim. (2) Justify the selection with E1-E3. (3) Rewrite the claim so every word is supported by the supplied record.

>

**Q2.** Communicate what the supplied record establishes about microscope image interpretation in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about microscope image interpretation against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using microscope image interpretation as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about microscope image interpretation? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about microscope image interpretation that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about microscope image interpretation. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about microscope image interpretation.
...
- Apply microscope image interpretation under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect microscope image interpretation to cell theory from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g7-science-u04-l11` · lesson `ma-g7-science-u04-l11` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
