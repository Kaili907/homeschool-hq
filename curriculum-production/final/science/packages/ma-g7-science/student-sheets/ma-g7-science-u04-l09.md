# Performance task build: unicellular and multicellular organisms

**Grade 7 Science** · Unit 4: Cells and Organism Organization · Day 9 of the unit (course day 45) · about 45–65 minutes

**Today's focus:** unicellular and multicellular organisms

**Unit question:** How can understanding cells and organism organization help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Create, test, or revise a meaningful product that applies unicellular and multicellular organisms and the unit standards.
- Use subject-appropriate evidence or representation to communicate understanding of unicellular and multicellular organisms.
- Check, revise, or improve work about unicellular and multicellular organisms using stated success criteria.
...
- Science brief: a unicellular organism carries out all life functions within a single cell.
- Science brief: in a multicellular organism, cells are specialised, and groups of them carry out different functions for the whole organism.
- Science brief: being unicellular is not a lesser condition; unicellular organisms are complete, successful organisms.

### Evidence check: unicellular and multicellular organisms

**Candidate claim:** A case report presents this as acceptable science: “unicellular organisms cannot carry out all the functions of life.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a unicellular organism carries out all life functions within a single cell. |
| E2 | established science reference | Science brief: in a multicellular organism, cells are specialised, and groups of them carry out different functions for the whole organism. |
| E3 | established science reference | Science brief: being unicellular is not a lesser condition; unicellular organisms are complete, successful organisms. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u04::unicellular and multicellular organisms, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.

**Supplied unit connections:** cell theory; cell structures and functions; unicellular and multicellular organisms; tissues organs and systems; microscope image interpretation; structure and function

**Supplied unit performance task:** Create a multiscale model linking cell structures to organism-level functions.

### Bound task

**Question:** What does evidence E1 through E3 justify about unicellular and multicellular organisms, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about unicellular and multicellular organisms?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g7-science-u04::unicellular and multicellular organisms, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u04::unicellular and multicellular organisms, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about unicellular and multicellular organisms?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about unicellular and multicellular organisms; then identify one check that would catch an error or weak claim.**
...
**Q1.** Create a one-page evidence product for unicellular and multicellular organisms using only the supplied case and E1-E3: one claim, at least two cited rows, the reasoning link, one counterpoint, and one revision after checking the success criteria.

>

**Q2.** Communicate what the supplied record establishes about unicellular and multicellular organisms in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about unicellular and multicellular organisms against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using unicellular and multicellular organisms as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about unicellular and multicellular organisms? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about unicellular and multicellular organisms that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about unicellular and multicellular organisms. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about unicellular and multicellular organisms.
...
- Apply unicellular and multicellular organisms under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect unicellular and multicellular organisms to cell theory from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Create a multiscale model linking cell structures to organism-level functions. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-g7-science-u04-l09` · lesson `ma-g7-science-u04-l09` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
