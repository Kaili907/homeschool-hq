# Independent application A: thermal changes

**Grade 7 Science** · Unit 2: Chemical Reactions and Conservation · Day 4 of the unit (course day 16) · about 45–65 minutes
...
- Apply thermal changes independently in a new representation, text, situation, or design constraint.
...
**Q1.** Independently evaluate this fully supplied case about thermal changes: A case report presents this as acceptable science: “an endothermic reaction creates cold rather than absorbing energy.” Use at least two rows from E1-E4, correct the claim if needed, and state one limit.
...
_Package `swp-ma-g7-science-u02-l04` · lesson `ma-g7-science-u02-l04` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
