# Reteach and varied practice: competition and predation

**Grade 7 Science** · Unit 6: Ecosystem Interactions and Dynamics · Day 8 of the unit (course day 68) · about 45–65 minutes

**Today's focus:** competition and predation
...
- Use error evidence to choose a different representation or strategy for competition and predation, then demonstrate corrected understanding.
- Use subject-appropriate evidence or representation to communicate understanding of competition and predation.
- Check, revise, or improve work about competition and predation using stated success criteria.
...
- Science brief: competition occurs when organisms use the same limited resource, whether they are of the same species or different ones.
- Science brief: predation transfers matter and energy from prey to predator and affects the population sizes of both.
- Science brief: predator and prey populations influence each other, so a change in one produces a change in the other, usually after a delay.

### Evidence check: competition and predation

**Candidate claim:** A case report presents this as acceptable science: “competition only occurs between different species.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: competition occurs when organisms use the same limited resource, whether they are of the same species or different ones. |
| E2 | established science reference | Science brief: predation transfers matter and energy from prey to predator and affects the population sizes of both. |
| E3 | established science reference | Science brief: predator and prey populations influence each other, so a change in one produces a change in the other, usually after a delay. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u06::competition and predation, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about competition and predation, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about competition and predation, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about competition and predation; then identify one check that would catch an error or weak claim.**
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E3. Name the decisive evidence ID, explain the error about competition and predation, and write a corrected claim.

>

**Q2.** Communicate what the supplied record establishes about competition and predation in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about competition and predation against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using competition and predation as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about competition and predation? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about competition and predation that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about competition and predation. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about competition and predation.
...
- Apply competition and predation under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect competition and predation to resource availability from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g7-science-u06-l08` · lesson `ma-g7-science-u06-l08` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
