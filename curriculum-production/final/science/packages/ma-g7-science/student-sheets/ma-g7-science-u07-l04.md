# Independent application A: regional climates

**Grade 7 Science** · Unit 7: Weather, Climate, and Earth Systems · Day 4 of the unit (course day 76) · about 45–65 minutes
...
- Apply regional climates independently in a new representation, text, situation, or design constraint.
...
**Q1.** Independently evaluate this fully supplied case about regional climates: A case report presents this as acceptable science: “latitude alone determines climate.” Use at least two rows from E1-E3, correct the claim if needed, and state one limit.
...
_Package `swp-ma-g7-science-u07-l04` · lesson `ma-g7-science-u07-l04` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
