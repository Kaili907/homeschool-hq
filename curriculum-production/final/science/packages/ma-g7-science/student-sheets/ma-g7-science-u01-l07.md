# Investigation or close reading: atomic and molecular models

**Grade 7 Science** · Unit 1: Matter, Particles, and Properties · Day 7 of the unit (course day 7) · about 45–65 minutes

**Today's focus:** atomic and molecular models

**Unit question:** How can understanding matter, particles, and properties help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Gather and analyze evidence related to atomic and molecular models, then record a defensible interpretation.
- Use subject-appropriate evidence or representation to communicate understanding of atomic and molecular models.
- Check, revise, or improve work about atomic and molecular models using stated success criteria.
...
- Science brief: atoms are the particles that make up elements; molecules are groups of atoms bonded together.
- Science brief: all matter is made of atoms, and atoms of a given element are alike in the properties that define that element.
- Science brief: a molecule is two or more atoms held together by chemical bonds; a compound contains atoms of more than one element in a fixed ratio.
- Science brief: substances differ because their atoms differ, or because the same atoms are arranged and bonded differently.

### Evidence check: atomic and molecular models

**Candidate claim:** A case report presents this as acceptable science: “atoms of a compound take on the bulk properties of the compound, such as a single water molecule being wet.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: atoms are the particles that make up elements; molecules are groups of atoms bonded together. |
| E2 | established science reference | Science brief: all matter is made of atoms, and atoms of a given element are alike in the properties that define that element. |
| E3 | established science reference | Science brief: a molecule is two or more atoms held together by chemical bonds; a compound contains atoms of more than one element in a fixed ratio. |
| E4 | established science reference | Science brief: substances differ because their atoms differ, or because the same atoms are arranged and bonded differently. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u01::atomic and molecular models, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.

**Supplied unit connections:** atomic and molecular models; pure substances and mixtures; physical and chemical properties; synthetic materials; model limitations; evidence from properties

**Supplied unit performance task:** Develop and defend particle-level models for several materials and transformations.

### Bound task

**Question:** What does evidence E1 through E4 justify about atomic and molecular models, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about atomic and molecular models?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g7-science-u01::atomic and molecular models, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u01::atomic and molecular models, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about atomic and molecular models?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about atomic and molecular models; then identify one check that would catch an error or weak claim.**
...
**Q1.** Classify every supplied row E1-E4 as supports, challenges, or does not decide the candidate claim about atomic and molecular models. Cite the row and explain each classification.

>

**Q2.** Communicate what the supplied record establishes about atomic and molecular models in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about atomic and molecular models against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using atomic and molecular models as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about atomic and molecular models? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about atomic and molecular models that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about atomic and molecular models. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about atomic and molecular models.
...
- Apply atomic and molecular models under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect atomic and molecular models to pure substances and mixtures from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Develop and defend particle-level models for several materials and transformations. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-g7-science-u01-l07` · lesson `ma-g7-science-u01-l07` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
