# Performance task build: sensory receptors

**Grade 7 Science** · Unit 5: Body Systems, Senses, and Responses · Day 9 of the unit (course day 57) · about 45–65 minutes

**Today's focus:** sensory receptors

**Unit question:** How can understanding body systems, senses, and responses help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Create, test, or revise a meaningful product that applies sensory receptors and the unit standards.
- Use subject-appropriate evidence or representation to communicate understanding of sensory receptors.
- Check, revise, or improve work about sensory receptors using stated success criteria.
...
- Science brief: each type of sensory receptor responds to a particular kind of stimulus, such as light, sound, pressure, temperature, or chemicals.
- Science brief: an organism can only respond to stimuli it has receptors for, which is why different animals sense different things.
- Science brief: receptors convert the stimulus into a signal the nervous system can carry; they do not send the stimulus itself.

### Evidence check: sensory receptors

**Candidate claim:** A case report presents this as acceptable science: “one receptor type responds equally to every stimulus.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: each type of sensory receptor responds to a particular kind of stimulus, such as light, sound, pressure, temperature, or chemicals. |
| E2 | established science reference | Science brief: an organism can only respond to stimuli it has receptors for, which is why different animals sense different things. |
| E3 | established science reference | Science brief: receptors convert the stimulus into a signal the nervous system can carry; they do not send the stimulus itself. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u05::sensory receptors, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.

**Supplied unit connections:** system interactions; nervous system signaling; sensory receptors; stimulus and response; homeostasis concept; modeling body-system coordination

**Supplied unit performance task:** Analyze a fictional stimulus-response scenario and revise a body-systems model without diagnosing individuals.

### Bound task

**Question:** What does evidence E1 through E3 justify about sensory receptors, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about sensory receptors?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g7-science-u05::sensory receptors, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u05::sensory receptors, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about sensory receptors?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about sensory receptors; then identify one check that would catch an error or weak claim.**
...
**Q1.** Create a one-page evidence product for sensory receptors using only the supplied case and E1-E3: one claim, at least two cited rows, the reasoning link, one counterpoint, and one revision after checking the success criteria.

>

**Q2.** Communicate what the supplied record establishes about sensory receptors in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about sensory receptors against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using sensory receptors as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about sensory receptors? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about sensory receptors that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about sensory receptors. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about sensory receptors.
...
- Apply sensory receptors under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect sensory receptors to system interactions from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Analyze a fictional stimulus-response scenario and revise a body-systems model without diagnosing individuals. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-g7-science-u05-l09` · lesson `ma-g7-science-u05-l09` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
