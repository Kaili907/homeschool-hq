# Concept model A: cell structures and functions

**Grade 7 Science** · Unit 4: Cells and Organism Organization · Day 2 of the unit (course day 38) · about 45–65 minutes

**Today's focus:** cell structures and functions
...
- Build a clear mental model of cell structures and functions through an explicit worked example, demonstration, text, or phenomenon.
- Use subject-appropriate evidence or representation to communicate understanding of cell structures and functions.
- Check, revise, or improve work about cell structures and functions using stated success criteria.
...
- Science brief: the nucleus contains the cell's genetic material; the cell membrane controls what enters and leaves; chloroplasts are found in plant cells and not in animal cells.
- Science brief: each cell part carries out a particular function, and the parts work together as a system.
- Science brief: the cell membrane controls what enters and leaves the cell; the nucleus holds the genetic material in cells that have one.
- Science brief: plant cells have a cell wall and chloroplasts that animal cells lack; both have a membrane, cytoplasm, and, in eukaryotes, a nucleus.

### Evidence check: cell structures and functions

**Candidate claim:** A case report presents this as acceptable science: “animal cells contain chloroplasts or a cell wall.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: the nucleus contains the cell's genetic material; the cell membrane controls what enters and leaves; chloroplasts are found in plant cells and not in animal cells. |
| E2 | established science reference | Science brief: each cell part carries out a particular function, and the parts work together as a system. |
| E3 | established science reference | Science brief: the cell membrane controls what enters and leaves the cell; the nucleus holds the genetic material in cells that have one. |
| E4 | established science reference | Science brief: plant cells have a cell wall and chloroplasts that animal cells lack; both have a membrane, cytoplasm, and, in eukaryotes, a nucleus. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u04::cell structures and functions, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about cell structures and functions, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about cell structures and functions, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about cell structures and functions; then identify one check that would catch an error or weak claim.**
...
**Q1.** Build a labelled model of cell structures and functions that represents every supplied row in E1-E4. Annotate each model feature with its evidence ID, then show where the candidate claim fails or remains uncertain.

>

**Q2.** Communicate what the supplied record establishes about cell structures and functions in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about cell structures and functions against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using cell structures and functions as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about cell structures and functions? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about cell structures and functions that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about cell structures and functions. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about cell structures and functions.
...
- Apply cell structures and functions under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect cell structures and functions to cell theory from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g7-science-u04-l02` · lesson `ma-g7-science-u04-l02` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
