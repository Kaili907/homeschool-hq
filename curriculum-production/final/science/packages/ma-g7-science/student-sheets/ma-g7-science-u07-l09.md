# Performance task build: ocean and atmospheric circulation

**Grade 7 Science** · Unit 7: Weather, Climate, and Earth Systems · Day 9 of the unit (course day 81) · about 45–65 minutes

**Today's focus:** ocean and atmospheric circulation

**Unit question:** How can understanding weather, climate, and earth systems help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Create, test, or revise a meaningful product that applies ocean and atmospheric circulation and the unit standards.
- Use subject-appropriate evidence or representation to communicate understanding of ocean and atmospheric circulation.
- Check, revise, or improve work about ocean and atmospheric circulation using stated success criteria.
...
- Science brief: global circulation exists because the equator receives more solar energy per unit area than the poles.
- Science brief: uneven heating of Earth's surface, with more energy per unit area near the equator, drives large-scale circulation in the atmosphere and ocean.
- Science brief: circulation moves energy from lower to higher latitudes, which is why the poles are not colder and the tropics not hotter than they are.
- Science brief: ocean currents and prevailing winds strongly influence the climate of the coasts they reach.

### Evidence check: ocean and atmospheric circulation

**Candidate claim:** A case report presents this as acceptable science: “the equator is warmer because it is closer to the Sun.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: global circulation exists because the equator receives more solar energy per unit area than the poles. |
| E2 | established science reference | Science brief: uneven heating of Earth's surface, with more energy per unit area near the equator, drives large-scale circulation in the atmosphere and ocean. |
| E3 | established science reference | Science brief: circulation moves energy from lower to higher latitudes, which is why the poles are not colder and the tropics not hotter than they are. |
| E4 | established science reference | Science brief: ocean currents and prevailing winds strongly influence the climate of the coasts they reach. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u07::ocean and atmospheric circulation, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.

**Supplied unit connections:** water cycle driven by energy and gravity; air masses and weather; ocean and atmospheric circulation; regional climates; weather maps; model uncertainty

**Supplied unit performance task:** Produce and evaluate a short-range weather explanation and a climate-pattern model using provided data.

### Bound task

**Question:** What does evidence E1 through E4 justify about ocean and atmospheric circulation, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about ocean and atmospheric circulation?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g7-science-u07::ocean and atmospheric circulation, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u07::ocean and atmospheric circulation, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about ocean and atmospheric circulation?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about ocean and atmospheric circulation; then identify one check that would catch an error or weak claim.**
...
**Q1.** Create a one-page evidence product for ocean and atmospheric circulation using only the supplied case and E1-E4: one claim, at least two cited rows, the reasoning link, one counterpoint, and one revision after checking the success criteria.

>

**Q2.** Communicate what the supplied record establishes about ocean and atmospheric circulation in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about ocean and atmospheric circulation against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using ocean and atmospheric circulation as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about ocean and atmospheric circulation? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about ocean and atmospheric circulation that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about ocean and atmospheric circulation. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about ocean and atmospheric circulation.
...
- Apply ocean and atmospheric circulation under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect ocean and atmospheric circulation to water cycle driven by energy and gravity from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Produce and evaluate a short-range weather explanation and a climate-pattern model using provided data. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-g7-science-u07-l09` · lesson `ma-g7-science-u07-l09` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
