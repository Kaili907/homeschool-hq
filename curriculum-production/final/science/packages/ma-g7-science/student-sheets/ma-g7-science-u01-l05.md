# Concept model B: model limitations

**Grade 7 Science** · Unit 1: Matter, Particles, and Properties · Day 5 of the unit (course day 5) · about 45–65 minutes
...
- Build a clear mental model of model limitations through an explicit worked example, demonstration, text, or phenomenon.
...
**Q1.** Build a labelled model of model limitations that represents every supplied row in E1-E3. Annotate each model feature with its evidence ID, then show where the candidate claim fails or remains uncertain.
...
_Package `swp-ma-g7-science-u01-l05` · lesson `ma-g7-science-u01-l05` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
