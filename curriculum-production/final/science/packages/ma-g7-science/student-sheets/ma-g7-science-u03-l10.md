# Synthesis and review: mass material and temperature change

**Grade 7 Science** · Unit 3: Thermal Energy and Energy Transfer · Day 10 of the unit (course day 34) · about 45–65 minutes

**Today's focus:** mass material and temperature change
...
- Connect mass material and temperature change to the unit’s other ideas and select evidence that shows readiness for assessment.
- Use subject-appropriate evidence or representation to communicate understanding of mass material and temperature change.
- Check, revise, or improve work about mass material and temperature change using stated success criteria.
...
- Science brief: for the same energy input, a larger mass of the same material changes temperature less than a smaller mass.
- Science brief: different materials require different amounts of energy to change the temperature of the same mass by the same amount.
- Science brief: comparing materials fairly requires the same mass, the same energy input, and the same starting temperature.

### Evidence check: mass material and temperature change

**Candidate claim:** A case report presents this as acceptable science: “equal energy input produces equal temperature change regardless of mass.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: for the same energy input, a larger mass of the same material changes temperature less than a smaller mass. |
| E2 | established science reference | Science brief: different materials require different amounts of energy to change the temperature of the same mass by the same amount. |
| E3 | established science reference | Science brief: comparing materials fairly requires the same mass, the same energy input, and the same starting temperature. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u03::mass material and temperature change, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about mass material and temperature change, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about mass material and temperature change, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about mass material and temperature change; then identify one check that would catch an error or weak claim.**
...
**Q1.** The supplied unit connections are: temperature and particle motion, conduction convection and radiation, energy transfer, mass material and temperature change, potential and kinetic energy, device efficiency. Choose one idea other than mass material and temperature change, connect it to one row in E1-E3, and explain one way treating the two ideas as identical would be misleading.

>

**Q2.** Communicate what the supplied record establishes about mass material and temperature change in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about mass material and temperature change against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using mass material and temperature change as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about mass material and temperature change? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about mass material and temperature change that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about mass material and temperature change. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about mass material and temperature change.
...
- Apply mass material and temperature change under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect mass material and temperature change to temperature and particle motion from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g7-science-u03-l10` · lesson `ma-g7-science-u03-l10` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
