# Guided practice A: ocean and atmospheric circulation

**Grade 7 Science** · Unit 7: Weather, Climate, and Earth Systems · Day 3 of the unit (course day 75) · about 45–65 minutes
...
- Practice ocean and atmospheric circulation with prompts, feedback, and gradually reduced support.
...
**The task.** What does evidence E1 through E4 justify about ocean and atmospheric circulation, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**Q1.** First compare E1 with E2 and write a provisional conclusion about ocean and atmospheric circulation. Then add the remaining rows through E4, revise the conclusion, and explain the change.
...
_Package `swp-ma-g7-science-u07-l03` · lesson `ma-g7-science-u07-l03` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
