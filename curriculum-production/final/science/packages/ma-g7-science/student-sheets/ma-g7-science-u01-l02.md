# Concept model A: pure substances and mixtures

**Grade 7 Science** · Unit 1: Matter, Particles, and Properties · Day 2 of the unit (course day 2) · about 45–65 minutes
...
- Build a clear mental model of pure substances and mixtures through an explicit worked example, demonstration, text, or phenomenon.
...
**Q1.** Build a labelled model of pure substances and mixtures that represents every supplied row in E1-E4. Annotate each model feature with its evidence ID, then show where the candidate claim fails or remains uncertain.
...
_Package `swp-ma-g7-science-u01-l02` · lesson `ma-g7-science-u01-l02` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
