# Correction and reflection: modeling body-system coordination

**Grade 7 Science** · Unit 5: Body Systems, Senses, and Responses · Day 12 of the unit (course day 60) · about 45–65 minutes

**Today's focus:** modeling body-system coordination
...
- Use error evidence to choose a different representation or strategy for modeling body-system coordination, then demonstrate corrected understanding.
- Use subject-appropriate evidence or representation to communicate understanding of modeling body-system coordination.
- Check, revise, or improve work about modeling body-system coordination using stated success criteria.
...
- Science brief: a model of coordination shows the systems involved, what passes between them, and in which direction.
- Science brief: the model has to include the detection step and the response step, or it cannot explain regulation.
- Science brief: a model is judged on whether it explains the coordination, not on how many parts it includes.

### Evidence check: modeling body-system coordination

**Candidate claim:** A case report presents this as acceptable science: “building a coordination model with no feedback path from response back to condition.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a model of coordination shows the systems involved, what passes between them, and in which direction. |
| E2 | established science reference | Science brief: the model has to include the detection step and the response step, or it cannot explain regulation. |
| E3 | established science reference | Science brief: a model is judged on whether it explains the coordination, not on how many parts it includes. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u05::modeling body-system coordination, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about modeling body-system coordination, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about modeling body-system coordination, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about modeling body-system coordination; then identify one check that would catch an error or weak claim.**
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E3. Name the decisive evidence ID, explain the error about modeling body-system coordination, and write a corrected claim.

>

**Q2.** Communicate what the supplied record establishes about modeling body-system coordination in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about modeling body-system coordination against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using modeling body-system coordination as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about modeling body-system coordination? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about modeling body-system coordination that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about modeling body-system coordination. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about modeling body-system coordination.
...
- Apply modeling body-system coordination under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect modeling body-system coordination to system interactions from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g7-science-u05-l12` · lesson `ma-g7-science-u05-l12` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
