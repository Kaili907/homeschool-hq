# Investigation or close reading: water cycle driven by energy and gravity

**Grade 7 Science** · Unit 7: Weather, Climate, and Earth Systems · Day 7 of the unit (course day 79) · about 45–65 minutes

**Today's focus:** water cycle driven by energy and gravity
...
- Gather and analyze evidence related to water cycle driven by energy and gravity, then record a defensible interpretation.
- Use subject-appropriate evidence or representation to communicate understanding of water cycle driven by energy and gravity.
- Check, revise, or improve work about water cycle driven by energy and gravity using stated success criteria.
...
- Science brief: the water cycle is driven by energy from the Sun and by gravity.
- Science brief: energy from the Sun drives evaporation and transpiration, moving water from surface to atmosphere.
- Science brief: gravity drives precipitation, runoff, and the downward movement of water through the ground.
- Science brief: water changes state during the cycle but the total amount of water on Earth stays essentially the same.

### Evidence check: water cycle driven by energy and gravity

**Candidate claim:** A case report presents this as acceptable science: “the water cycle creates or destroys water.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: the water cycle is driven by energy from the Sun and by gravity. |
| E2 | established science reference | Science brief: energy from the Sun drives evaporation and transpiration, moving water from surface to atmosphere. |
| E3 | established science reference | Science brief: gravity drives precipitation, runoff, and the downward movement of water through the ground. |
| E4 | established science reference | Science brief: water changes state during the cycle but the total amount of water on Earth stays essentially the same. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u07::water cycle driven by energy and gravity, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about water cycle driven by energy and gravity, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about water cycle driven by energy and gravity?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g7-science-u07::water cycle driven by energy and gravity, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u07::water cycle driven by energy and gravity, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about water cycle driven by energy and gravity?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about water cycle driven by energy and gravity; then identify one check that would catch an error or weak claim.**
...
**Q1.** Classify every supplied row E1-E4 as supports, challenges, or does not decide the candidate claim about water cycle driven by energy and gravity. Cite the row and explain each classification.

>

**Q2.** Communicate what the supplied record establishes about water cycle driven by energy and gravity in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about water cycle driven by energy and gravity against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using water cycle driven by energy and gravity as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about water cycle driven by energy and gravity? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about water cycle driven by energy and gravity that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about water cycle driven by energy and gravity. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about water cycle driven by energy and gravity.
...
- Apply water cycle driven by energy and gravity under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect water cycle driven by energy and gravity to air masses and weather from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g7-science-u07-l07` · lesson `ma-g7-science-u07-l07` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
