# Concept model A: competition and predation

**Grade 7 Science** · Unit 6: Ecosystem Interactions and Dynamics · Day 2 of the unit (course day 62) · about 45–65 minutes
...
- Build a clear mental model of competition and predation through an explicit worked example, demonstration, text, or phenomenon.
...
**Q1.** Build a labelled model of competition and predation that represents every supplied row in E1-E3. Annotate each model feature with its evidence ID, then show where the candidate claim fails or remains uncertain.
...
_Package `swp-ma-g7-science-u06-l02` · lesson `ma-g7-science-u06-l02` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
