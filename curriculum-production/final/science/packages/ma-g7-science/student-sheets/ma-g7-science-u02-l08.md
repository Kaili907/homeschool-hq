# Reteach and varied practice: reactants and products

**Grade 7 Science** · Unit 2: Chemical Reactions and Conservation · Day 8 of the unit (course day 20) · about 45–65 minutes
...
- Use error evidence to choose a different representation or strategy for reactants and products, then demonstrate corrected understanding.
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E4. Name the decisive evidence ID, explain the error about reactants and products, and write a corrected claim.
...
_Package `swp-ma-g7-science-u02-l08` · lesson `ma-g7-science-u02-l08` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
