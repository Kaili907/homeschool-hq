# Investigation or close reading: resource availability

**Grade 7 Science** · Unit 6: Ecosystem Interactions and Dynamics · Day 7 of the unit (course day 67) · about 45–65 minutes

**Today's focus:** resource availability
...
- Gather and analyze evidence related to resource availability, then record a defensible interpretation.
- Use subject-appropriate evidence or representation to communicate understanding of resource availability.
- Check, revise, or improve work about resource availability using stated success criteria.
...
- Science brief: the number of organisms an ecosystem supports is limited by the resources available: food, water, space, shelter, light, and nutrients.
- Science brief: when a resource becomes scarce, populations that depend on it decline or move.
- Science brief: the limiting resource is the one in shortest supply relative to need, and increasing any other does not remove the limit.

### Evidence check: resource availability

**Candidate claim:** A case report presents this as acceptable science: “a population can grow indefinitely if food alone is plentiful.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: the number of organisms an ecosystem supports is limited by the resources available: food, water, space, shelter, light, and nutrients. |
| E2 | established science reference | Science brief: when a resource becomes scarce, populations that depend on it decline or move. |
| E3 | established science reference | Science brief: the limiting resource is the one in shortest supply relative to need, and increasing any other does not remove the limit. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u06::resource availability, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about resource availability, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about resource availability?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g7-science-u06::resource availability, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u06::resource availability, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about resource availability?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about resource availability; then identify one check that would catch an error or weak claim.**
...
**Q1.** Classify every supplied row E1-E3 as supports, challenges, or does not decide the candidate claim about resource availability. Cite the row and explain each classification.

>

**Q2.** Communicate what the supplied record establishes about resource availability in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about resource availability against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using resource availability as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about resource availability? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about resource availability that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about resource availability. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about resource availability.
...
- Apply resource availability under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect resource availability to competition and predation from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g7-science-u06-l07` · lesson `ma-g7-science-u06-l07` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
