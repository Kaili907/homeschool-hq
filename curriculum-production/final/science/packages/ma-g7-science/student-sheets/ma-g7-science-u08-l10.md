# Synthesis and review: population and consumption

**Grade 7 Science** · Unit 8: Natural Hazards and Human Impacts · Day 10 of the unit (course day 94) · about 45–65 minutes
...
- Connect population and consumption to the unit’s other ideas and select evidence that shows readiness for assessment.
...
- Science brief: total impact depends on both the number of people and how much each consumes, so neither alone explains it.
- Science brief: per-person consumption differs greatly between regions, so equal populations can have very different impacts.
- Science brief: technology can change impact per person in either direction.
...
| --- | --- | --- |
| E1 | established science reference | Science brief: total impact depends on both the number of people and how much each consumes, so neither alone explains it. |
| E2 | established science reference | Science brief: per-person consumption differs greatly between regions, so equal populations can have very different impacts. |
| E3 | established science reference | Science brief: technology can change impact per person in either direction. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u08::population and consumption, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
**The task.** What does evidence E1 through E3 justify about population and consumption, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**Q1.** The supplied unit connections are: hazard mapping, risk and vulnerability, resource use, population and consumption, climate evidence, mitigation and adaptation. Choose one idea other than population and consumption, connect it to one row in E1-E3, and explain one way treating the two ideas as identical would be misleading.
...
- Connect population and consumption to hazard mapping from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g7-science-u08-l10` · lesson `ma-g7-science-u08-l10` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
