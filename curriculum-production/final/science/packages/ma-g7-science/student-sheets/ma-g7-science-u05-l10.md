# Synthesis and review: stimulus and response

**Grade 7 Science** · Unit 5: Body Systems, Senses, and Responses · Day 10 of the unit (course day 58) · about 45–65 minutes

**Today's focus:** stimulus and response
...
- Connect stimulus and response to the unit’s other ideas and select evidence that shows readiness for assessment.
- Use subject-appropriate evidence or representation to communicate understanding of stimulus and response.
- Check, revise, or improve work about stimulus and response using stated success criteria.
...
- Science brief: a response follows a stimulus through a pathway of detection, processing, and action.
- Science brief: the same stimulus can produce different responses in different circumstances, because processing takes context into account.
- Science brief: some responses are immediate and involuntary; others involve deliberate processing and take longer.

### Evidence check: stimulus and response

**Candidate claim:** A case report presents this as acceptable science: “every response to a stimulus is identical regardless of context.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a response follows a stimulus through a pathway of detection, processing, and action. |
| E2 | established science reference | Science brief: the same stimulus can produce different responses in different circumstances, because processing takes context into account. |
| E3 | established science reference | Science brief: some responses are immediate and involuntary; others involve deliberate processing and take longer. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u05::stimulus and response, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about stimulus and response, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about stimulus and response, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about stimulus and response; then identify one check that would catch an error or weak claim.**
...
**Q1.** The supplied unit connections are: system interactions, nervous system signaling, sensory receptors, stimulus and response, homeostasis concept, modeling body-system coordination. Choose one idea other than stimulus and response, connect it to one row in E1-E3, and explain one way treating the two ideas as identical would be misleading.

>

**Q2.** Communicate what the supplied record establishes about stimulus and response in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about stimulus and response against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using stimulus and response as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about stimulus and response? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about stimulus and response that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about stimulus and response. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about stimulus and response.
...
- Apply stimulus and response under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect stimulus and response to system interactions from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g7-science-u05-l10` · lesson `ma-g7-science-u05-l10` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
