# Guided practice B: model uncertainty

**Grade 7 Science** · Unit 7: Weather, Climate, and Earth Systems · Day 6 of the unit (course day 78) · about 45–65 minutes
...
- Practice model uncertainty with prompts, feedback, and gradually reduced support.
...
**Q1.** First compare E1 with E2 and write a provisional conclusion about model uncertainty. Then add the remaining rows through E3, revise the conclusion, and explain the change.
...
_Package `swp-ma-g7-science-u07-l06` · lesson `ma-g7-science-u07-l06` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
