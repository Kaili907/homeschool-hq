# Performance task build: conservation of atoms

**Grade 7 Science** · Unit 2: Chemical Reactions and Conservation · Day 9 of the unit (course day 21) · about 45–65 minutes

**Today's focus:** conservation of atoms

**Unit question:** How can understanding chemical reactions and conservation help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Create, test, or revise a meaningful product that applies conservation of atoms and the unit standards.
- Use subject-appropriate evidence or representation to communicate understanding of conservation of atoms.
- Check, revise, or improve work about conservation of atoms using stated success criteria.
...
- Science brief: the number of atoms of each element is the same before and after a chemical reaction, so the total mass is unchanged.
- Science brief: atoms are neither created nor destroyed in a chemical reaction; they are rearranged.
- Science brief: because the atoms are conserved, the total mass of the system is the same before and after.
- Science brief: an apparent mass change in an open container means matter crossed the boundary, most often as a gas.

### Evidence check: conservation of atoms

**Candidate claim:** A case report presents this as acceptable science: “mass is lost when a substance burns, without accounting for gases released or oxygen consumed.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: the number of atoms of each element is the same before and after a chemical reaction, so the total mass is unchanged. |
| E2 | established science reference | Science brief: atoms are neither created nor destroyed in a chemical reaction; they are rearranged. |
| E3 | established science reference | Science brief: because the atoms are conserved, the total mass of the system is the same before and after. |
| E4 | established science reference | Science brief: an apparent mass change in an open container means matter crossed the boundary, most often as a gas. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u02::conservation of atoms, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.

**Supplied unit connections:** signs of reaction; reactants and products; conservation of atoms; thermal changes; reaction evidence; designing a heat-transfer device

**Supplied unit performance task:** Conduct safe reaction analyses and design a device that manages thermal energy under clear constraints.

### Bound task

**Question:** What does evidence E1 through E4 justify about conservation of atoms, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about conservation of atoms?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g7-science-u02::conservation of atoms, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u02::conservation of atoms, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about conservation of atoms?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about conservation of atoms; then identify one check that would catch an error or weak claim.**
...
**Q1.** Create a one-page evidence product for conservation of atoms using only the supplied case and E1-E4: one claim, at least two cited rows, the reasoning link, one counterpoint, and one revision after checking the success criteria.

>

**Q2.** Communicate what the supplied record establishes about conservation of atoms in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about conservation of atoms against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using conservation of atoms as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about conservation of atoms? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about conservation of atoms that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about conservation of atoms. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about conservation of atoms.
...
- Apply conservation of atoms under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect conservation of atoms to signs of reaction from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
- Take the unit's performance task — Conduct safe reaction analyses and design a device that manages thermal energy under clear constraints. — and write the one measurement or piece of evidence that would most change its outcome, then say why.
...
_Package `swp-ma-g7-science-u02-l09` · lesson `ma-g7-science-u02-l09` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
