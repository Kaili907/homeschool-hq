# Unit assessment: potential and kinetic energy

**Grade 7 Science** · Unit 3: Thermal Energy and Energy Transfer · Day 11 of the unit (course day 35) · about 45–65 minutes

**Today's focus:** potential and kinetic energy
...
- Demonstrate current mastery of potential and kinetic energy through selected-response, constructed-response, and applied evidence.
- Use subject-appropriate evidence or representation to communicate understanding of potential and kinetic energy.
- Check, revise, or improve work about potential and kinetic energy using stated success criteria.
...
- Science brief: kinetic energy is energy of motion; potential energy is energy stored by position or configuration.
- Science brief: kinetic energy depends on an object's mass and speed; potential energy depends on position or arrangement relative to something else.
- Science brief: energy converts between kinetic and potential forms while the total stays the same, apart from what is transferred out of the system.
- Science brief: potential energy is a property of a system, such as an object and Earth together, not of the object alone.

### Evidence check: potential and kinetic energy

**Candidate claim:** A case report presents this as acceptable science: “energy is destroyed when a moving object comes to rest, rather than transferred out.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: kinetic energy is energy of motion; potential energy is energy stored by position or configuration. |
| E2 | established science reference | Science brief: kinetic energy depends on an object's mass and speed; potential energy depends on position or arrangement relative to something else. |
| E3 | established science reference | Science brief: energy converts between kinetic and potential forms while the total stays the same, apart from what is transferred out of the system. |
| E4 | established science reference | Science brief: potential energy is a property of a system, such as an object and Earth together, not of the object alone. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u03::potential and kinetic energy, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about potential and kinetic energy, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about potential and kinetic energy, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? Rate confidence in potential and kinetic energy, cite one piece of evidence from today, and choose: ready to extend, ready to review later, or need a different explanation.**
...
**Q1.** Complete all three parts for potential and kinetic energy. (1) Select A: supported, B: partly supported, or C: not supported for the candidate claim. (2) Justify the selection with E1-E4. (3) Rewrite the claim so every word is supported by the supplied record.

>

**Q2.** Communicate what the supplied record establishes about potential and kinetic energy in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about potential and kinetic energy against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using potential and kinetic energy as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about potential and kinetic energy? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about potential and kinetic energy that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about potential and kinetic energy. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about potential and kinetic energy.
...
- Apply potential and kinetic energy under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect potential and kinetic energy to temperature and particle motion from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g7-science-u03-l11` · lesson `ma-g7-science-u03-l11` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
