# Investigation or close reading: system interactions

**Grade 7 Science** · Unit 5: Body Systems, Senses, and Responses · Day 7 of the unit (course day 55) · about 45–65 minutes

**Today's focus:** system interactions
...
- Gather and analyze evidence related to system interactions, then record a defensible interpretation.
- Use subject-appropriate evidence or representation to communicate understanding of system interactions.
- Check, revise, or improve work about system interactions using stated success criteria.
...
- Science brief: body systems interact: the digestive, circulatory, respiratory, excretory, nervous, and musculoskeletal systems each depend on the others.
- Science brief: a substance taken in by one system is distributed by another and used or removed by a third.
- Science brief: because the systems are coupled, a change in one produces changes in others.

### Evidence check: system interactions

**Candidate claim:** A case report presents this as acceptable science: “each body system works independently.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: body systems interact: the digestive, circulatory, respiratory, excretory, nervous, and musculoskeletal systems each depend on the others. |
| E2 | established science reference | Science brief: a substance taken in by one system is distributed by another and used or removed by a third. |
| E3 | established science reference | Science brief: because the systems are coupled, a change in one produces changes in others. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u05::system interactions, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about system interactions, and does it support the candidate claim?
...
**Investigation question:** How well does the supplied evidence support the case claim about system interactions?
...
**Model/source rule:** Manuel Academy Science learner brief for topic ma-g7-science-u05::system interactions, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.

**Provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u05::system interactions, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
**Evidence question.** How well does the supplied evidence support the case claim about system interactions?
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about system interactions; then identify one check that would catch an error or weak claim.**
...
**Q1.** Classify every supplied row E1-E3 as supports, challenges, or does not decide the candidate claim about system interactions. Cite the row and explain each classification.

>

**Q2.** Communicate what the supplied record establishes about system interactions in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about system interactions against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using system interactions as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about system interactions? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about system interactions that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about system interactions. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about system interactions.
...
- Apply system interactions under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect system interactions to nervous system signaling from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g7-science-u05-l07` · lesson `ma-g7-science-u05-l07` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
