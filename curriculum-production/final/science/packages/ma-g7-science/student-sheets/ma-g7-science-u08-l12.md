# Correction and reflection: mitigation and adaptation

**Grade 7 Science** · Unit 8: Natural Hazards and Human Impacts · Day 12 of the unit (course day 96) · about 45–65 minutes

**Today's focus:** mitigation and adaptation
...
- Use error evidence to choose a different representation or strategy for mitigation and adaptation, then demonstrate corrected understanding.
- Use subject-appropriate evidence or representation to communicate understanding of mitigation and adaptation.
- Check, revise, or improve work about mitigation and adaptation using stated success criteria.
...
- Science brief: mitigation reduces the cause of a problem; adaptation reduces the harm from effects that occur anyway.
- Science brief: mitigation acts on the cause, such as reducing emissions; adaptation acts on the consequences, such as changing where and how people build.
- Science brief: both are needed, because some change is already committed and further change can still be limited.
- Science brief: every option has costs, and who pays them and who benefits are part of the evaluation.

### Evidence check: mitigation and adaptation

**Candidate claim:** A case report presents this as acceptable science: “using mitigation and adaptation as though they meant the same thing.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: mitigation reduces the cause of a problem; adaptation reduces the harm from effects that occur anyway. |
| E2 | established science reference | Science brief: mitigation acts on the cause, such as reducing emissions; adaptation acts on the consequences, such as changing where and how people build. |
| E3 | established science reference | Science brief: both are needed, because some change is already committed and further change can still be limited. |
| E4 | established science reference | Science brief: every option has costs, and who pays them and who benefits are part of the evaluation. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u08::mitigation and adaptation, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about mitigation and adaptation, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about mitigation and adaptation, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about mitigation and adaptation; then identify one check that would catch an error or weak claim.**
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E4. Name the decisive evidence ID, explain the error about mitigation and adaptation, and write a corrected claim.

>

**Q2.** Communicate what the supplied record establishes about mitigation and adaptation in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about mitigation and adaptation against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using mitigation and adaptation as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about mitigation and adaptation? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about mitigation and adaptation that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about mitigation and adaptation. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about mitigation and adaptation.
...
- Apply mitigation and adaptation under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect mitigation and adaptation to hazard mapping from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g7-science-u08-l12` · lesson `ma-g7-science-u08-l12` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
