# Concept model A: reactants and products

**Grade 7 Science** · Unit 2: Chemical Reactions and Conservation · Day 2 of the unit (course day 14) · about 45–65 minutes

**Today's focus:** reactants and products
...
- Build a clear mental model of reactants and products through an explicit worked example, demonstration, text, or phenomenon.
- Use subject-appropriate evidence or representation to communicate understanding of reactants and products.
- Check, revise, or improve work about reactants and products using stated success criteria.
...
- Science brief: reactants are the starting substances; products are the substances formed.
- Science brief: reactants are the substances present before a reaction; products are the substances present after it.
- Science brief: the atoms in the products are the same atoms that were in the reactants, rearranged into new combinations.
- Science brief: the products have their own properties, which is what distinguishes a reaction from a mixture.

### Evidence check: reactants and products

**Candidate claim:** A case report presents this as acceptable science: “new atoms are made during a chemical reaction.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: reactants are the starting substances; products are the substances formed. |
| E2 | established science reference | Science brief: reactants are the substances present before a reaction; products are the substances present after it. |
| E3 | established science reference | Science brief: the atoms in the products are the same atoms that were in the reactants, rearranged into new combinations. |
| E4 | established science reference | Science brief: the products have their own properties, which is what distinguishes a reaction from a mixture. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u02::reactants and products, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about reactants and products, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about reactants and products, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about reactants and products; then identify one check that would catch an error or weak claim.**
...
**Q1.** Build a labelled model of reactants and products that represents every supplied row in E1-E4. Annotate each model feature with its evidence ID, then show where the candidate claim fails or remains uncertain.

>

**Q2.** Communicate what the supplied record establishes about reactants and products in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about reactants and products against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using reactants and products as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about reactants and products? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about reactants and products that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about reactants and products. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about reactants and products.
...
- Apply reactants and products under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect reactants and products to signs of reaction from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g7-science-u02-l02` · lesson `ma-g7-science-u02-l02` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
