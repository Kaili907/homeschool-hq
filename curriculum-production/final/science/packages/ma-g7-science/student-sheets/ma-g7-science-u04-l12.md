# Correction and reflection: structure and function

**Grade 7 Science** · Unit 4: Cells and Organism Organization · Day 12 of the unit (course day 48) · about 45–65 minutes
...
- Use error evidence to choose a different representation or strategy for structure and function, then demonstrate corrected understanding.
...
- Science brief: a cell's shape and contents relate to what it does, which is why nerve, muscle, and root-hair cells look so different.
- Science brief: specialisation trades generality for capability: a specialised cell does one job well and depends on others for the rest.
- Science brief: inferring function from structure is a hypothesis that must then be checked against evidence.

### Evidence check: structure and function

**Candidate claim:** A case report presents this as acceptable science: “a cell developed a structure because the organism needed it.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a cell's shape and contents relate to what it does, which is why nerve, muscle, and root-hair cells look so different. |
| E2 | established science reference | Science brief: specialisation trades generality for capability: a specialised cell does one job well and depends on others for the rest. |
| E3 | established science reference | Science brief: inferring function from structure is a hypothesis that must then be checked against evidence. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u04::structure and function, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
**The task.** What does evidence E1 through E3 justify about structure and function, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E3. Name the decisive evidence ID, explain the error about structure and function, and write a corrected claim.
...
- Connect structure and function to cell theory from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g7-science-u04-l12` · lesson `ma-g7-science-u04-l12` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
