# Correction and reflection: device efficiency

**Grade 7 Science** · Unit 3: Thermal Energy and Energy Transfer · Day 12 of the unit (course day 36) · about 45–65 minutes

**Today's focus:** device efficiency
...
- Use error evidence to choose a different representation or strategy for device efficiency, then demonstrate corrected understanding.
- Use subject-appropriate evidence or representation to communicate understanding of device efficiency.
- Check, revise, or improve work about device efficiency using stated success criteria.
...
- Science brief: no device converts all of its energy input into the useful output.
- Science brief: a device's useful output is always less than its energy input, because some energy is transferred to the surroundings, usually as warming.
- Science brief: improving efficiency means reducing the unwanted transfers, not eliminating them.
- Science brief: efficiency claims are judged against measurements of input and useful output, not against the design intent.

### Evidence check: device efficiency

**Candidate claim:** A case report presents this as acceptable science: “a device is or could be one hundred per cent efficient.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: no device converts all of its energy input into the useful output. |
| E2 | established science reference | Science brief: a device's useful output is always less than its energy input, because some energy is transferred to the surroundings, usually as warming. |
| E3 | established science reference | Science brief: improving efficiency means reducing the unwanted transfers, not eliminating them. |
| E4 | established science reference | Science brief: efficiency claims are judged against measurements of input and useful output, not against the design intent. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u03::device efficiency, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
**Question:** What does evidence E1 through E4 justify about device efficiency, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E4 justify about device efficiency, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about device efficiency; then identify one check that would catch an error or weak claim.**
...
**Q1.** Locate the exact phrase in the candidate claim that conflicts with E1-E4. Name the decisive evidence ID, explain the error about device efficiency, and write a corrected claim.

>

**Q2.** Communicate what the supplied record establishes about device efficiency in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E4 and mark where the representation stops being supported.

>

**Q3.** Check your response about device efficiency against each success criterion. Revise one sentence by adding or changing a citation to E1-E4; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using device efficiency as the example. Cite one row from E1-E4, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E4 is strongest for evaluating the candidate claim about device efficiency? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E4, state one conclusion about device efficiency that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about device efficiency. Label E1-E4 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about device efficiency.
...
- Apply device efficiency under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect device efficiency to temperature and particle motion from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g7-science-u03-l12` · lesson `ma-g7-science-u03-l12` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
