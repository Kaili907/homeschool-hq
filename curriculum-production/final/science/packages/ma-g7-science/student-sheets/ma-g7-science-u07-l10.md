# Synthesis and review: regional climates

**Grade 7 Science** · Unit 7: Weather, Climate, and Earth Systems · Day 10 of the unit (course day 82) · about 45–65 minutes

**Today's focus:** regional climates
...
- Connect regional climates to the unit’s other ideas and select evidence that shows readiness for assessment.
- Use subject-appropriate evidence or representation to communicate understanding of regional climates.
- Check, revise, or improve work about regional climates using stated success criteria.
...
- Science brief: a region's climate depends on latitude, elevation, distance from large water bodies, ocean currents, prevailing winds, and nearby mountains.
- Science brief: two regions at the same latitude can have very different climates because of these other factors.
- Science brief: climate is described by long-term averages and ranges, over decades rather than seasons.

### Evidence check: regional climates

**Candidate claim:** A case report presents this as acceptable science: “latitude alone determines climate.”
...
| --- | --- | --- |
| E1 | established science reference | Science brief: a region's climate depends on latitude, elevation, distance from large water bodies, ocean currents, prevailing winds, and nearby mountains. |
| E2 | established science reference | Science brief: two regions at the same latitude can have very different climates because of these other factors. |
| E3 | established science reference | Science brief: climate is described by long-term averages and ranges, over decades rather than seasons. |

**Input provenance:** Manuel Academy Science learner brief for topic ma-g7-science-u07::regional climates, derived from the reviewed correctness source policy/correctness/ma-g7-science.correctness.json.
...
**Question:** What does evidence E1 through E3 justify about regional climates, and does it support the candidate claim?
...
**The task.** What does evidence E1 through E3 justify about regional climates, and does it support the candidate claim? Follow the five bound steps printed above and cite the supplied evidence IDs.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about regional climates; then identify one check that would catch an error or weak claim.**
...
**Q1.** The supplied unit connections are: water cycle driven by energy and gravity, air masses and weather, ocean and atmospheric circulation, regional climates, weather maps, model uncertainty. Choose one idea other than regional climates, connect it to one row in E1-E3, and explain one way treating the two ideas as identical would be misleading.

>

**Q2.** Communicate what the supplied record establishes about regional climates in a labelled diagram, table, or paragraph. Include citations to at least two rows from E1-E3 and mark where the representation stops being supported.

>

**Q3.** Check your response about regional climates against each success criterion. Revise one sentence by adding or changing a citation to E1-E3; state exactly what the revision fixes.

>

**Q4.** Answer the printed unit question using regional climates as the example. Cite one row from E1-E3, connect it to the answer, and state what the supplied record cannot decide.

>

**Q5.** Which one row in E1-E3 is strongest for evaluating the candidate claim about regional climates? Name the row, explain why it is more direct than another supplied row, and name one input that would strengthen it.

>

**Q6.** Using the supplied case and E1-E3, state one conclusion about regional climates that the record supports and one question it cannot answer. Name the different observation, measurement, or model input the unanswered question would require.

>

**Q7.** Audit the inputs used in your response about regional climates. Label E1-E3 as SUPPLIED reference information with the provenance printed below the table; label any model value as MODEL OUTPUT and any value you calculate as CALCULATED.
...
- The learner completes the central task about regional climates.
...
- Apply regional climates under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect regional climates to water cycle driven by energy and gravity from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g7-science-u07-l10` · lesson `ma-g7-science-u07-l10` · built from `canonical-1.0.0` at `4056e31`. Supplied reference and model inputs are labelled; physical-investigation observations and expected results are never supplied before collection._
