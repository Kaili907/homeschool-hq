...
build is reproducible regardless of where the source branches move next.
  ...
  high school 9-12     mac/hs912-science-h4 @ a86780a (H4 source-consistency fix)

H4 supersedes H3 and H2 for High School. The superseded commits and failed base
candidate are recorded only so validators can prove the build read none of them.
"""
...
HS_H4_COMMIT = "a86780a315b5a6ba4f134f35b7033f35707b0e52"
HS_SUPERSEDED_H3_COMMIT = "e7551b959112fcd9e6868d614799028cf22acf5d"
HS_SUPERSEDED_H2_COMMIT = "265ea3a75740ccbeea0dfa02c723514779def052"
HS_FAILED_BASE_COMMIT = "f58f7f1eec0a0f93801df4978c00511ec98cc95e"

INPUT_COMMITS: tuple[dict[str, str], ...] = (
    {
        "name": "mac/hs912-science-h4",
        "commit": HS_H4_COMMIT,
        "role": "required High School H4 curriculum source",
    },
    {
        "name": "mac/science-correctness-r2",
        "commit": "4b375ee41a2ad534ddf3cef3bd1c97d6347b2ad7",
        "role": "accepted lesson-level scientific correctness authority",
    },
    {
        "name": "mac/science-production-r1",
        "commit": "fefae93c480abb62750df24472c8f82ca4e16602",
        "role": "accepted Science production renderer and safety baseline",
    },
    {
        "name": "mac/science-production-final-h3",
        "commit": "d61f277559e10c8a8a698f6ceaf6f3300d386968",
        "role": "prior final-production findings and reconciliation baseline",
    },
    {
        "name": "mac/g34-science-social-r1",
        "commit": G34_COMMIT,
        "role": "reviewed Grade 3/4 Science source",
    },
    {
        "name": "canonical Grade 5/7/8 Science release 1.0.0",
        "commit": CANONICAL_COMMIT,
        "role": "immutable Grade 5/7/8 Science source",
    },
    {
        "name": "mac/curriculum-production-gate-h3",
        "commit": "49b3c4b86cc7764627bd4cfbd752222849831abf",
        "role": "Production Gate H3 implementation and target branch base",
    },
)
