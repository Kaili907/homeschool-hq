...
/**
 * Emits the whole Grade 3/4 mathematics student-work corpus and validates it
 * in the same pass. Writing and checking together means a package can never
 * be published without having been checked.
 */
