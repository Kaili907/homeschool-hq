...
OUT_ROOT = REPO_ROOT / "curriculum-production" / "student-work" / "science"
...
def build_alternatives(
    ...
    if course["family"] == "hs":
        ...
        if data_bearing and (is_pointer or not lesson_alternative) and unit_alternative:
            ...
            alternative_source = "hs912-science-h2 unit lab-alternative"
            is_pointer = False
        else:
            alternative_text = lesson_alternative or unit_alternative
            alternative_source = (
                "hs912-science-h2 lesson lab-alternative"
                if lesson_alternative
                else "hs912-science-h2 unit lab-alternative"
            )
...
def main() -> int:
    ...
    manifest = {
        ...
        "high_school_safety_lineage": {
            ...
            "note": "No blob from the failed base candidate is read by this build.",
        },
        "invariants": [
