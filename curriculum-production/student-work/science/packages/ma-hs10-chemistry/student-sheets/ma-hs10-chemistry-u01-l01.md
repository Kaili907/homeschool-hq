...
**The task.** The learner completes a new application of physical and chemical properties independently and records both the result and the reasoning, evidence, process, or design choice that produced it.
...
**The hands-on day in this unit, and its equal-credit alternative:** Day 7 investigation: Density determination with repeated trials and stated uncertainty | No-special-equipment alternative: Determine density from a supplied set of published mass and volume measurements, computing uncertainty by hand. Paper and calculator only.
...
**Q1.** Record two specific observations of the anchoring phenomenon for physical and chemical properties and one thing that does not yet fit your explanation. Turn that mismatch into a testable question: state what you would change, what you would measure, and what result would count against your own current thinking.
...
_Package `swp-ma-hs10-chemistry-u01-l01` · lesson `ma-hs10-chemistry-u01-l01` · built from `hs912-science-h2` at `265ea3a`. No observation, measurement, or expected result is supplied anywhere in this sheet._
