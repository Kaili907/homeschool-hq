...
**The task.** The learner completes a new application of oxidation and reduction basics independently and records both the result and the reasoning, evidence, process, or design choice that produced it.
...
**Q1.** Explain oxidation and reduction basics in your own words and tie each claim to a specific item in your record: a measurement, a feature of your model, a documented step, or a named source. A claim with no evidence behind it is incomplete regardless of whether it is correct.

> 

**Q2.** Apply oxidation and reduction basics to a case in Chemical Reactions and Electron Rearrangement you have not worked before. Show the reasoning that produced your result, not only the result, and name the single step where that reasoning is most likely to break down.

> 

**Q3.** Check your work on oxidation and reduction basics against each stated success criterion in turn and name the one you meet least well. Revise it, then state your next step concretely enough that someone else could carry it out: what you would do, and what result would tell you it worked.

> 

**Q4.** Answer the unit's essential question in two or three sentences, using oxidation and reduction basics as your worked example and citing one piece of your own evidence: What is actually happening to electrons when one substance turns into another?

> 

**Q5.** Which single piece of evidence in your record most strongly supports your conclusion about oxidation and reduction basics? State what makes it strong — precision, repetition, independence, or directness — and name one specific change that would strengthen it further.

> 

**Q6.** Name one thing your work on oxidation and reduction basics cannot show, however carefully it was carried out, and explain what a different design or data source would have to do to answer it. State the limitation as a property of the method, not as an apology.
...
_Package `swp-ma-hs10-chemistry-u04-l04` · lesson `ma-hs10-chemistry-u04-l04` · built from `hs912-science-h2` at `265ea3a`. No observation, measurement, or expected result is supplied anywhere in this sheet._
