...
**The task.** The learner completes a new application of nuclear composition and isotopes independently and records both the result and the reasoning, evidence, process, or design choice that produced it.
...
**The hands-on day in this unit, and its equal-credit alternative:** Day 7 investigation: Half-life modelling and a materials trade-off analysis | No-special-equipment alternative: Model half-life with a single die and tally marks on paper instead of 100 coins, then complete the trade-off analysis from published materials data. Paper only.
...
**Q1.** Record two specific observations of the anchoring phenomenon for nuclear composition and isotopes and one thing that does not yet fit your explanation. Turn that mismatch into a testable question: state what you would change, what you would measure, and what result would count against your own current thinking.
...
_Package `swp-ma-hs10-chemistry-u09-l01` · lesson `ma-hs10-chemistry-u09-l01` · built from `hs912-science-h2` at `265ea3a`. No observation, measurement, or expected result is supplied anywhere in this sheet._
