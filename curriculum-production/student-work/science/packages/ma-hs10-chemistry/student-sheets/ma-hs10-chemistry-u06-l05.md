...
**Q2.** Apply computational energy models to a case in Energy in Chemical Systems you have not worked before. Show the reasoning that produced your result, not only the result, and name the single step where that reasoning is most likely to break down.
...
**Q4.** Answer the unit's essential question in two or three sentences, using computational energy models as your worked example and citing one piece of your own evidence: Why do some reactions warm their surroundings and others chill them, when both are just rearranging bonds?
...
_Package `swp-ma-hs10-chemistry-u06-l05` · lesson `ma-hs10-chemistry-u06-l05` · built from `hs912-science-h2` at `265ea3a`. No observation, measurement, or expected result is supplied anywhere in this sheet._
