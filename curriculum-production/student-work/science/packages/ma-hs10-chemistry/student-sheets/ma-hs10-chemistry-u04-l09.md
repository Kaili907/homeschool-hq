# Performance task build: outermost electron states in reactions

**High School Chemistry (Grade 10)** · Unit 4: Chemical Reactions and Electron Rearrangement · Day 9 of the unit (course day 45) · about 61–84 minutes

**Today's focus:** outermost electron states in reactions
...
- Explain outermost electron states in reactions using evidence, a model, or a documented process rather than an unsupported answer.
- Apply outermost electron states in reactions to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on outermost electron states in reactions against the stated success criteria and name the next step.
...
**My question.** Write the question you are testing about outermost electron states in reactions. It has to be a question your evidence could actually answer.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about outermost electron states in reactions, then name one check that would catch an error or a weak claim.**
...
- The learner completes the central task about outermost electron states in reactions.
...
- Apply outermost electron states in reactions under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect outermost electron states in reactions to evidence of chemical change from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs10-chemistry-u04-l09` · lesson `ma-hs10-chemistry-u04-l09` · built from `hs912-science-h2` at `265ea3a`. No observation, measurement, or expected result is supplied anywhere in this sheet._
