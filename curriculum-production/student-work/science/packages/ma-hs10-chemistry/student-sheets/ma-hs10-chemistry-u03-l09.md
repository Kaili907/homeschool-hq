# Performance task build: bulk properties as evidence of particle forces

**High School Chemistry (Grade 10)** · Unit 3: Bonding, Structure, and the Properties of Designed Materials · Day 9 of the unit (course day 33) · about 61–84 minutes

**Today's focus:** bulk properties as evidence of particle forces
...
- Explain bulk properties as evidence of particle forces using evidence, a model, or a documented process rather than an unsupported answer.
- Apply bulk properties as evidence of particle forces to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on bulk properties as evidence of particle forces against the stated success criteria and name the next step.
...
**My question.** Write the question you are testing about bulk properties as evidence of particle forces. It has to be a question your evidence could actually answer.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about bulk properties as evidence of particle forces, then name one check that would catch an error or a weak claim.**
...
**Q1.** Assemble performance-task evidence for bulk properties as evidence of particle forces that an independent reader could check without asking you a single question: the claim, the data behind it with its provenance, the reasoning between them, and the limitations. Anything a reader would have to take on trust is a gap in the evidence, not a detail.

> 

**Q2.** Explain bulk properties as evidence of particle forces in your own words and tie each claim to a specific item in your record: a measurement, a feature of your model, a documented step, or a named source. A claim with no evidence behind it is incomplete regardless of whether it is correct.

> 

**Q3.** Apply bulk properties as evidence of particle forces to a case in Bonding, Structure, and the Properties of Designed Materials you have not worked before. Show the reasoning that produced your result, not only the result, and name the single step where that reasoning is most likely to break down.
...
**Q5.** Answer the unit's essential question in two or three sentences, using bulk properties as evidence of particle forces as your worked example and citing one piece of your own evidence: How does what happens between particles explain what a material does in your hand?

> 

**Q6.** Which single piece of evidence in your record most strongly supports your conclusion about bulk properties as evidence of particle forces? State what makes it strong — precision, repetition, independence, or directness — and name one specific change that would strengthen it further.

> 

**Q7.** Name one thing your work on bulk properties as evidence of particle forces cannot show, however carefully it was carried out, and explain what a different design or data source would have to do to answer it. State the limitation as a property of the method, not as an apology.
...
- The learner completes the central task about bulk properties as evidence of particle forces.
...
- Apply bulk properties as evidence of particle forces under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect bulk properties as evidence of particle forces to ionic, covalent, and metallic bonding from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs10-chemistry-u03-l09` · lesson `ma-hs10-chemistry-u03-l09` · built from `hs912-science-h2` at `265ea3a`. No observation, measurement, or expected result is supplied anywhere in this sheet._
