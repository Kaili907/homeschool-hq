# Reteach and varied practice: balancing equations as bookkeeping

**High School Chemistry (Grade 10)** · Unit 5: Conservation of Mass and Quantitative Reasoning in Reactions · Day 8 of the unit (course day 56) · about 55–75 minutes

**Today's focus:** balancing equations as bookkeeping
...
- Apply balancing equations as bookkeeping to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on balancing equations as bookkeeping against the stated success criteria and name the next step.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about balancing equations as bookkeeping, then name one check that would catch an error or a weak claim.**
...
- Apply balancing equations as bookkeeping under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect balancing equations as bookkeeping to conservation of atoms and mass from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs10-chemistry-u05-l08` · lesson `ma-hs10-chemistry-u05-l08` · built from `hs912-science-h2` at `265ea3a`. No observation, measurement, or expected result is supplied anywhere in this sheet._
