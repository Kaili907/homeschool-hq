...
**Q1.** Produce independent mastery evidence for computational energy models on a task you have not seen, with no worked example available. Show the reasoning, not only the result — mastery is the reasoning surviving an unfamiliar surface, and an unexplained correct answer does not evidence it.
...
**Q3.** Apply computational energy models to a case in Energy in Chemical Systems you have not worked before. Show the reasoning that produced your result, not only the result, and name the single step where that reasoning is most likely to break down.
...
**Q5.** Answer the unit's essential question in two or three sentences, using computational energy models as your worked example and citing one piece of your own evidence: Why do some reactions warm their surroundings and others chill them, when both are just rearranging bonds?
...
_Package `swp-ma-hs10-chemistry-u06-l11` · lesson `ma-hs10-chemistry-u06-l11` · built from `hs912-science-h2` at `265ea3a`. No observation, measurement, or expected result is supplied anywhere in this sheet._
