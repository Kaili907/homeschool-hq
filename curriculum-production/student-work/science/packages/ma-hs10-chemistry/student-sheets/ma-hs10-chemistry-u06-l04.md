# Independent application A: thermal energy transfer and equilibration

**High School Chemistry (Grade 10)** · Unit 6: Energy in Chemical Systems · Day 4 of the unit (course day 64) · about 55–75 minutes

**Today's focus:** thermal energy transfer and equilibration
...
- Explain thermal energy transfer and equilibration using evidence, a model, or a documented process rather than an unsupported answer.
- Apply thermal energy transfer and equilibration to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on thermal energy transfer and equilibration against the stated success criteria and name the next step.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about thermal energy transfer and equilibration, then name one check that would catch an error or a weak claim.**
...
- Apply thermal energy transfer and equilibration under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect thermal energy transfer and equilibration to bond breaking and bond making from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs10-chemistry-u06-l04` · lesson `ma-hs10-chemistry-u06-l04` · built from `hs912-science-h2` at `265ea3a`. No observation, measurement, or expected result is supplied anywhere in this sheet._
