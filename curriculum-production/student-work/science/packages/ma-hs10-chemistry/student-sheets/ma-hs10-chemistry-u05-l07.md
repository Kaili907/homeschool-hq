...
Do the mass accounting from a supplied table of published open- and closed-system masses, balancing the equation and computing expected gas mass by hand. Paper and calculator only.
...
**Q1.** Describe the investigation you actually ran on conservation of atoms and mass — or the alternative path, which is scored the same: the question, the variable you changed, the variables you held constant, what you measured, your uncertainty, and how many trials you completed. Report only values you measured or calculated yourself, or took from a source you name on the provenance line and mark SUPPLIED.

> 

**Q2.** Explain conservation of atoms and mass in your own words and tie each claim to a specific item in your record: a measurement, a feature of your model, a documented step, or a named source. A claim with no evidence behind it is incomplete regardless of whether it is correct.

> 

**Q3.** Apply conservation of atoms and mass to a case in Conservation of Mass and Quantitative Reasoning in Reactions you have not worked before. Show the reasoning that produced your result, not only the result, and name the single step where that reasoning is most likely to break down.

> 

**Q4.** Check your work on conservation of atoms and mass against each stated success criterion in turn and name the one you meet least well. Revise it, then state your next step concretely enough that someone else could carry it out: what you would do, and what result would tell you it worked.

> 

**Q5.** Answer the unit's essential question in two or three sentences, using conservation of atoms and mass as your worked example and citing one piece of your own evidence: If atoms are never created or destroyed, why does a reaction so often look like mass disappeared?

> 

**Q6.** Which single piece of evidence in your record most strongly supports your conclusion about conservation of atoms and mass? State what makes it strong — precision, repetition, independence, or directness — and name one specific change that would strengthen it further.

> 

**Q7.** Name one thing your work on conservation of atoms and mass cannot show, however carefully it was carried out, and explain what a different design or data source would have to do to answer it. State the limitation as a property of the method, not as an apology.
...
_Package `swp-ma-hs10-chemistry-u05-l07` · lesson `ma-hs10-chemistry-u05-l07` · built from `hs912-science-h2` at `265ea3a`. No observation, measurement, or expected result is supplied anywhere in this sheet._
