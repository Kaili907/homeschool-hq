...
Vary only surface area and concentration at room temperature - whole versus crushed tablet, full-strength versus diluted vinegar - eliminating all heating. Or analyse a published rate-versus-temperature dataset. Kitchen materials or paper.
...
**What this lesson's data is, according to the curriculum:** Learner-timed reaction completions across their own conditions. Rate relationships are inferred from the learner's plotted data.
...
**Q1.** Assemble performance-task evidence for concentration and reaction rate that an independent reader could check without asking you a single question: the claim, the data behind it with its provenance, the reasoning between them, and the limitations. Anything a reader would have to take on trust is a gap in the evidence, not a detail.

> 

**Q2.** Explain concentration and reaction rate in your own words and tie each claim to a specific item in your record: a measurement, a feature of your model, a documented step, or a named source. A claim with no evidence behind it is incomplete regardless of whether it is correct.

> 

**Q3.** Apply concentration and reaction rate to a case in Reaction Rates and the Conditions That Change Them you have not worked before. Show the reasoning that produced your result, not only the result, and name the single step where that reasoning is most likely to break down.

> 

**Q4.** Check your work on concentration and reaction rate against each stated success criterion in turn and name the one you meet least well. Revise it, then state your next step concretely enough that someone else could carry it out: what you would do, and what result would tell you it worked.

> 

**Q5.** Answer the unit's essential question in two or three sentences, using concentration and reaction rate as your worked example and citing one piece of your own evidence: What has to be true at the particle level for a reaction to go faster?

> 

**Q6.** Which single piece of evidence in your record most strongly supports your conclusion about concentration and reaction rate? State what makes it strong — precision, repetition, independence, or directness — and name one specific change that would strengthen it further.

> 

**Q7.** Name one thing your work on concentration and reaction rate cannot show, however carefully it was carried out, and explain what a different design or data source would have to do to answer it. State the limitation as a property of the method, not as an apology.
...
_Package `swp-ma-hs10-chemistry-u07-l09` · lesson `ma-hs10-chemistry-u07-l09` · built from `hs912-science-h2` at `265ea3a`. No observation, measurement, or expected result is supplied anywhere in this sheet._
