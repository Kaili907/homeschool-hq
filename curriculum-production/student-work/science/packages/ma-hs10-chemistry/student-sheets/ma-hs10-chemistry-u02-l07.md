...
Skip the spectroscope build entirely: identify elements from published emission-spectrum images alone, and graph atomic radius, ionization energy, and electronegativity across periods and down groups from published data. Paper and calculator only. Both paths meet the same target.
...
**What this lesson's data is, according to the curriculum:** Published periodic-property data and published emission-spectrum images the family retrieves, plus the learner's own sketches, graphs, and predictions. No identification is stated before observation.
...
**Q1.** Describe the investigation you actually ran on subatomic structure and isotopes — or the alternative path, which is scored the same: the question, the variable you changed, the variables you held constant, what you measured, your uncertainty, and how many trials you completed. Report only values you measured or calculated yourself, or took from a source you name on the provenance line and mark SUPPLIED.

> 

**Q2.** Explain subatomic structure and isotopes in your own words and tie each claim to a specific item in your record: a measurement, a feature of your model, a documented step, or a named source. A claim with no evidence behind it is incomplete regardless of whether it is correct.

> 

**Q3.** Apply subatomic structure and isotopes to a case in Atomic Structure and the Periodic Table as a Model you have not worked before. Show the reasoning that produced your result, not only the result, and name the single step where that reasoning is most likely to break down.

> 

**Q4.** Check your work on subatomic structure and isotopes against each stated success criterion in turn and name the one you meet least well. Revise it, then state your next step concretely enough that someone else could carry it out: what you would do, and what result would tell you it worked.

> 

**Q5.** Answer the unit's essential question in two or three sentences, using subatomic structure and isotopes as your worked example and citing one piece of your own evidence: Why does the periodic table predict how an element will behave before anyone tests it?

> 

**Q6.** Which single piece of evidence in your record most strongly supports your conclusion about subatomic structure and isotopes? State what makes it strong — precision, repetition, independence, or directness — and name one specific change that would strengthen it further.

> 

**Q7.** Name one thing your work on subatomic structure and isotopes cannot show, however carefully it was carried out, and explain what a different design or data source would have to do to answer it. State the limitation as a property of the method, not as an apology.
...
_Package `swp-ma-hs10-chemistry-u02-l07` · lesson `ma-hs10-chemistry-u02-l07` · built from `hs912-science-h2` at `265ea3a`. No observation, measurement, or expected result is supplied anywhere in this sheet._
