# Performance task build: stress and system response

**High School Chemistry (Grade 10)** · Unit 8: Equilibrium and the Design of Chemical Systems · Day 9 of the unit (course day 93) · about 61–84 minutes

**Today's focus:** stress and system response

**Unit question:** How can a reaction be running hard in both directions and still look like nothing is happening?

**What you are aiming at:**

- Produce performance-task evidence for stress and system response that a reader could check independently.
- Explain stress and system response using evidence, a model, or a documented process rather than an unsupported answer.
- Apply stress and system response to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on stress and system response against the stated success criteria and name the next step.
...
**My question.** Write the question you are testing about stress and system response. It has to be a question your evidence could actually answer.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about stress and system response, then name one check that would catch an error or a weak claim.**
...
Observe the carbon-dioxide equilibrium in carbonated water alone - sealed versus open, cool versus warm - with no indicator chemistry, or reason from a published equilibrium dataset. Kitchen materials or paper.
...
**What this lesson's data is, according to the curriculum:** Learner's own colour and effervescence observations across conditions. Direction of shift is concluded by the learner from what they see.
...
**Q1.** Assemble performance-task evidence for stress and system response that an independent reader could check without asking you a single question: the claim, the data behind it with its provenance, the reasoning between them, and the limitations. Anything a reader would have to take on trust is a gap in the evidence, not a detail.

> 

**Q2.** Explain stress and system response in your own words and tie each claim to a specific item in your record: a measurement, a feature of your model, a documented step, or a named source. A claim with no evidence behind it is incomplete regardless of whether it is correct.

> 

**Q3.** Apply stress and system response to a case in Equilibrium and the Design of Chemical Systems you have not worked before. Show the reasoning that produced your result, not only the result, and name the single step where that reasoning is most likely to break down.

> 

**Q4.** Check your work on stress and system response against each stated success criterion in turn and name the one you meet least well. Revise it, then state your next step concretely enough that someone else could carry it out: what you would do, and what result would tell you it worked.

> 

**Q5.** Answer the unit's essential question in two or three sentences, using stress and system response as your worked example and citing one piece of your own evidence: How can a reaction be running hard in both directions and still look like nothing is happening?

> 

**Q6.** Which single piece of evidence in your record most strongly supports your conclusion about stress and system response? State what makes it strong — precision, repetition, independence, or directness — and name one specific change that would strengthen it further.

> 

**Q7.** Name one thing your work on stress and system response cannot show, however carefully it was carried out, and explain what a different design or data source would have to do to answer it. State the limitation as a property of the method, not as an apology.
...
- The learner completes the central task about stress and system response.
...
- Apply stress and system response under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect stress and system response to reversible reactions from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs10-chemistry-u08-l09` · lesson `ma-hs10-chemistry-u08-l09` · built from `hs912-science-h2` at `265ea3a`. No observation, measurement, or expected result is supplied anywhere in this sheet._
