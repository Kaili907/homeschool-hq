...
**The task.** The learner completes a new application of collision model of reactions independently and records both the result and the reasoning, evidence, process, or design choice that produced it.
...
**The hands-on day in this unit, and its equal-credit alternative:** Day 7 investigation: Rate of an effervescent or enzymatic reaction under varied conditions | No-special-equipment alternative: Vary only surface area and concentration at room temperature - whole versus crushed tablet, full-strength versus diluted vinegar - eliminating all heating. Or analyse a published rate-versus-temperature dataset. Kitchen materials or paper.
...
**Q1.** Record two specific observations of the anchoring phenomenon for collision model of reactions and one thing that does not yet fit your explanation. Turn that mismatch into a testable question: state what you would change, what you would measure, and what result would count against your own current thinking.
...
_Package `swp-ma-hs10-chemistry-u07-l01` · lesson `ma-hs10-chemistry-u07-l01` · built from `hs912-science-h2` at `265ea3a`. No observation, measurement, or expected result is supplied anywhere in this sheet._
