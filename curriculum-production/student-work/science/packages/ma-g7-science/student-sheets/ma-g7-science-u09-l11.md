...
**Q4.** Answer the unit's essential question in two or three sentences, using optimization as your worked example and citing one piece of your own evidence: How can understanding engineering design capstone help us explain, decide, create, or solve something that matters?
...
_Package `swp-ma-g7-science-u09-l11` · lesson `ma-g7-science-u09-l11` · built from `canonical-1.0.0` at `4056e31`. No observation, measurement, or expected result is supplied anywhere in this sheet._
