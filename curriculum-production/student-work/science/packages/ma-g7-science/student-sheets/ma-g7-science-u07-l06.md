...
**Q1.** Work the practice items on model uncertainty, using the supported steps for the first and none for the last. Then compare the two: name the step you had to reconstruct without the prompt, and say what you now know you do not yet have automatic.
...
_Package `swp-ma-g7-science-u07-l06` · lesson `ma-g7-science-u07-l06` · built from `canonical-1.0.0` at `4056e31`. No observation, measurement, or expected result is supplied anywhere in this sheet._
