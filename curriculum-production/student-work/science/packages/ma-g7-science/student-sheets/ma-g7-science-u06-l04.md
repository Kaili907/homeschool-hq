...
**The task.** Learner completes a new application of food webs and records both the result and the reasoning, evidence, process, or design choice that produced it.
...
**Q1.** Work independently, without a template: apply food webs in a different representation, context, or design constraint from the one you practised in. State what carried over unchanged and what you had to adapt, because the adaptation is the evidence of understanding.

> 

**Q2.** Present your findings on food webs in the representation the task calls for — a labelled model, a data display, a written explanation, or a documented process — and justify why that representation carries the evidence better than a bare statement would.

> 

**Q3.** Identify one place where you checked or revised your work on food webs. State what you changed, what prompted you to notice it, and why the revision is an improvement against the stated success criteria rather than merely a difference.

> 

**Q4.** Answer the unit's essential question in two or three sentences, using food webs as your worked example and citing one piece of your own evidence: How can understanding ecosystem interactions and dynamics help us explain, decide, create, or solve something that matters?

> 

**Q5.** Which single piece of evidence in your record most strongly supports your conclusion about food webs? State what makes it strong — precision, repetition, independence, or directness — and name one specific change that would strengthen it further.

> 

**Q6.** Name one thing your work on food webs cannot show, however carefully it was carried out, and explain what a different design or data source would have to do to answer it. State the limitation as a property of the method, not as an apology.
...
_Package `swp-ma-g7-science-u06-l04` · lesson `ma-g7-science-u06-l04` · built from `canonical-1.0.0` at `4056e31`. No observation, measurement, or expected result is supplied anywhere in this sheet._
