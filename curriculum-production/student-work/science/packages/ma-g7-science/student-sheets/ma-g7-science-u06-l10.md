...
**Q1.** Connect food webs to the other ideas in Ecosystem Interactions and Dynamics: state one principle that holds across them and one case where treating them as the same would mislead you. Then select the single piece of your own work that best evidences readiness for assessment, and justify the selection against the success criteria.
...
_Package `swp-ma-g7-science-u06-l10` · lesson `ma-g7-science-u06-l10` · built from `canonical-1.0.0` at `4056e31`. No observation, measurement, or expected result is supplied anywhere in this sheet._
