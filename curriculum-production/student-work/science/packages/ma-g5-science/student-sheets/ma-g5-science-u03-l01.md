# Launch and diagnostic: physical changes

**Grade 5 Science** · Unit 3: Changes and Conservation of Matter · Day 1 of the unit (course day 25) · about 45–65 minutes

**Today's focus:** physical changes
...
- Activate prior knowledge about physical changes, surface initial thinking without penalty, and establish the unit question.
- Use subject-appropriate evidence or representation to communicate understanding of physical changes.
- Check, revise, or improve work about physical changes using stated success criteria.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about physical changes; then identify one check that would catch an error or weak claim.**
...
**Q1.** Before anyone taught you anything today, what did you already think about physical changes? Write that down first. Then mark one place in your record that changed your mind and one that showed you were right. A first idea is never marked wrong.
...
- Apply physical changes under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect physical changes to mixing substances from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g5-science-u03-l01` · lesson `ma-g5-science-u03-l01` · built from `canonical-1.0.0` at `4056e31`. No observation, measurement, or expected result is supplied anywhere in this sheet._
