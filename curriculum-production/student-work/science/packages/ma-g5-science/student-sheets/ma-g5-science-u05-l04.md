...
**Q1.** Do this one on your own, with no help and no example to copy: use food webs in a new situation, a new drawing, or under a new rule about what you are allowed to use. Write down what you did and why it worked.
...
_Package `swp-ma-g5-science-u05-l04` · lesson `ma-g5-science-u05-l04` · built from `canonical-1.0.0` at `4056e31`. No observation, measurement, or expected result is supplied anywhere in this sheet._
