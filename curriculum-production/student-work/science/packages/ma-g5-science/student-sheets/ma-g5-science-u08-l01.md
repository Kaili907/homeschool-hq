...
**Q1.** Before anyone taught you anything today, what did you already think about resource use? Write that down first. Then mark one place in your record that changed your mind and one that showed you were right. A first idea is never marked wrong.
...
_Package `swp-ma-g5-science-u08-l01` · lesson `ma-g5-science-u08-l01` · built from `canonical-1.0.0` at `4056e31`. No observation, measurement, or expected result is supplied anywhere in this sheet._
