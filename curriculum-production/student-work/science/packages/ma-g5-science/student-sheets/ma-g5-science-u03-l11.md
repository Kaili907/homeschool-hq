# Unit assessment: open and closed systems

**Grade 5 Science** · Unit 3: Changes and Conservation of Matter · Day 11 of the unit (course day 35) · about 45–65 minutes

**Today's focus:** open and closed systems
...
- Demonstrate current mastery of open and closed systems through selected-response, constructed-response, and applied evidence.
- Use subject-appropriate evidence or representation to communicate understanding of open and closed systems.
- Check, revise, or improve work about open and closed systems using stated success criteria.
...
**The task.** Complete the unit assessment evidence for open and closed systems independently. Supports may preserve access but may not supply the answer, interpretation, or final product.
...
**What did you check, what did you change, and what is your next step? Rate confidence in open and closed systems, cite one piece of evidence from today, and choose: ready to extend, ready to review later, or need a different explanation.**
...
**Q1.** Show what you know about open and closed systems three ways: pick the right answer from choices, write an answer in your own words, and use it on a real task. If the three disagree, say which one you trust and why.
...
- Apply open and closed systems under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect open and closed systems to physical changes from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g5-science-u03-l11` · lesson `ma-g5-science-u03-l11` · built from `canonical-1.0.0` at `4056e31`. No observation, measurement, or expected result is supplied anywhere in this sheet._
