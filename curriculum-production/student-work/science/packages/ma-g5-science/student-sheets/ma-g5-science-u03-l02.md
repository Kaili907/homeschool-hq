...
**Q1.** Draw or write a model that shows how mixing substances works. Label the parts. Then say which part of the worked example or demonstration you got each label from, and name one thing your model leaves out on purpose.
...
_Package `swp-ma-g5-science-u03-l02` · lesson `ma-g5-science-u03-l02` · built from `canonical-1.0.0` at `4056e31`. No observation, measurement, or expected result is supplied anywhere in this sheet._
