...
**Q1.** Work the practice items on signs of chemical change. On the first one you may use the steps in front of you. On the last one, cover the steps and do it from memory. Then say what was different about doing it without help.
...
_Package `swp-ma-g5-science-u03-l03` · lesson `ma-g5-science-u03-l03` · built from `canonical-1.0.0` at `4056e31`. No observation, measurement, or expected result is supplied anywhere in this sheet._
