# Concept model B: open and closed systems

**Grade 5 Science** · Unit 3: Changes and Conservation of Matter · Day 5 of the unit (course day 29) · about 45–65 minutes
...
- Build a clear mental model of open and closed systems through an explicit worked example, demonstration, text, or phenomenon.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about open and closed systems; then identify one check that would catch an error or weak claim.**
