...
**The task.** Learner completes a new application of design iteration and records both the result and the reasoning, evidence, process, or design choice that produced it.
...
**Q1.** Draw or write a model that shows how design iteration works. Label the parts. Then say which part of the worked example or demonstration you got each label from, and name one thing your model leaves out on purpose.
...
_Package `swp-ma-g5-science-u09-l05` · lesson `ma-g5-science-u09-l05` · built from `canonical-1.0.0` at `4056e31`. No observation, measurement, or expected result is supplied anywhere in this sheet._
