# Unit assessment: collision analysis from data

**High School Physics (Grade 11)** · Unit 3: Momentum, Collisions, and Protective Design · Day 11 of the unit (course day 35) · about 55–75 minutes
...
- Demonstrate independent mastery evidence for collision analysis from data on a fresh task.
...
_Package `swp-ma-hs11-physics-u03-l11` · lesson `ma-hs11-physics-u03-l11` · built from `hs912-science-h2` at `265ea3a`. No observation, measurement, or expected result is supplied anywhere in this sheet._
