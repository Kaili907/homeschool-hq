# Concept model B: collision analysis from data

**High School Physics (Grade 11)** · Unit 3: Momentum, Collisions, and Protective Design · Day 5 of the unit (course day 29) · about 55–75 minutes

**Today's focus:** collision analysis from data

**Unit question:** What is conserved in a collision, and how do we use that to keep people safe?

**What you are aiming at:**

- Explain collision analysis from data using evidence, a model, or a documented process rather than an unsupported answer.
- Apply collision analysis from data to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on collision analysis from data against the stated success criteria and name the next step.
...
**The task.** The learner completes a new application of collision analysis from data independently and records both the result and the reasoning, evidence, process, or design choice that produced it.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about collision analysis from data, then name one check that would catch an error or a weak claim.**
...
**Q1.** Explain collision analysis from data in your own words and tie each claim to a specific item in your record: a measurement, a feature of your model, a documented step, or a named source. A claim with no evidence behind it is incomplete regardless of whether it is correct.

> 

**Q2.** Apply collision analysis from data to a case in Momentum, Collisions, and Protective Design you have not worked before. Show the reasoning that produced your result, not only the result, and name the single step where that reasoning is most likely to break down.

> 

**Q3.** Check your work on collision analysis from data against each stated success criterion in turn and name the one you meet least well. Revise it, then state your next step concretely enough that someone else could carry it out: what you would do, and what result would tell you it worked.

> 

**Q4.** Answer the unit's essential question in two or three sentences, using collision analysis from data as your worked example and citing one piece of your own evidence: What is conserved in a collision, and how do we use that to keep people safe?

> 

**Q5.** Which single piece of evidence in your record most strongly supports your conclusion about collision analysis from data? State what makes it strong — precision, repetition, independence, or directness — and name one specific change that would strengthen it further.

> 

**Q6.** Name one thing your work on collision analysis from data cannot show, however carefully it was carried out, and explain what a different design or data source would have to do to answer it. State the limitation as a property of the method, not as an apology.
...
- The learner completes the central task about collision analysis from data.
...
- Apply collision analysis from data under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect collision analysis from data to momentum as mass times velocity from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs11-physics-u03-l05` · lesson `ma-hs11-physics-u03-l05` · built from `hs912-science-h2` at `265ea3a`. No observation, measurement, or expected result is supplied anywhere in this sheet._
