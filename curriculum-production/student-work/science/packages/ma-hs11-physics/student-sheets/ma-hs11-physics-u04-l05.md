...
**The task.** The learner completes a new application of field lines as representations independently and records both the result and the reasoning, evidence, process, or design choice that produced it.
...
**Q1.** Explain field lines as representations in your own words and tie each claim to a specific item in your record: a measurement, a feature of your model, a documented step, or a named source. A claim with no evidence behind it is incomplete regardless of whether it is correct.

> 

**Q2.** Apply field lines as representations to a case in Gravitation and Electrostatic Forces you have not worked before. Show the reasoning that produced your result, not only the result, and name the single step where that reasoning is most likely to break down.

> 

**Q3.** Check your work on field lines as representations against each stated success criterion in turn and name the one you meet least well. Revise it, then state your next step concretely enough that someone else could carry it out: what you would do, and what result would tell you it worked.

> 

**Q4.** Answer the unit's essential question in two or three sentences, using field lines as representations as your worked example and citing one piece of your own evidence: Why do gravity and the electric force follow the same mathematical shape while behaving so differently?

> 

**Q5.** Which single piece of evidence in your record most strongly supports your conclusion about field lines as representations? State what makes it strong — precision, repetition, independence, or directness — and name one specific change that would strengthen it further.

> 

**Q6.** Name one thing your work on field lines as representations cannot show, however carefully it was carried out, and explain what a different design or data source would have to do to answer it. State the limitation as a property of the method, not as an apology.
...
_Package `swp-ma-hs11-physics-u04-l05` · lesson `ma-hs11-physics-u04-l05` · built from `hs912-science-h2` at `265ea3a`. No observation, measurement, or expected result is supplied anywhere in this sheet._
