# Performance task build: electromagnetic induction

**High School Physics (Grade 11)** · Unit 7: Fields, Electromagnetism, and Induction · Day 9 of the unit (course day 81) · about 61–84 minutes

**Today's focus:** electromagnetic induction
...
- Explain electromagnetic induction using evidence, a model, or a documented process rather than an unsupported answer.
- Apply electromagnetic induction to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on electromagnetic induction against the stated success criteria and name the next step.
...
**My question.** Write the question you are testing about electromagnetic induction. It has to be a question your evidence could actually answer.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about electromagnetic induction, then name one check that would catch an error or a weak claim.**
...
- Apply electromagnetic induction under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect electromagnetic induction to electric and magnetic fields from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs11-physics-u07-l09` · lesson `ma-hs11-physics-u07-l09` · built from `hs912-science-h2` at `265ea3a`. No observation, measurement, or expected result is supplied anywhere in this sheet._
