...
**The task.** The learner completes a new application of position, displacement, and reference frames independently and records both the result and the reasoning, evidence, process, or design choice that produced it.
...
**The hands-on day in this unit, and its equal-credit alternative:** Day 7 investigation: Timing accelerated motion on a ramp | No-special-equipment alternative: Analyse a published motion dataset or a frame-numbered motion diagram supplied on paper, extracting velocity and acceleration by hand. No ramp, no timing, paper only.
...
**Q1.** Record two specific observations of the anchoring phenomenon for position, displacement, and reference frames and one thing that does not yet fit your explanation. Turn that mismatch into a testable question: state what you would change, what you would measure, and what result would count against your own current thinking.
...
_Package `swp-ma-hs11-physics-u01-l01` · lesson `ma-hs11-physics-u01-l01` · built from `hs912-science-h2` at `265ea3a`. No observation, measurement, or expected result is supplied anywhere in this sheet._
