...
**The task.** The learner completes a new application of kinetic and potential energy independently and records both the result and the reasoning, evidence, process, or design choice that produced it.
...
_Package `swp-ma-hs11-physics-u05-l01` · lesson `ma-hs11-physics-u05-l01` · built from `hs912-science-h2` at `265ea3a`. No observation, measurement, or expected result is supplied anywhere in this sheet._
