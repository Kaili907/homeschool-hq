...
**High School Physics (Grade 11)** · Unit 5: Energy: Modelling, Accounting, and Conservation · Day 7 of the unit (course day 55) · about 61–84 minutes
...
- Plan and carry out a safe investigation of kinetic and potential energy, or its stated alternative, and record the learner's own data with its uncertainty.
...
**My question.** Write the question you are testing about kinetic and potential energy. It has to be a question your evidence could actually answer.
...
**Q1.** Describe the investigation you actually ran on kinetic and potential energy — or the alternative path, which is scored the same: the question, the variable you changed, the variables you held constant, what you measured, your uncertainty, and how many trials you completed. Report only values you measured or calculated yourself, or took from a source you name on the provenance line and mark SUPPLIED.

> 

**Q2.** Explain kinetic and potential energy in your own words and tie each claim to a specific item in your record: a measurement, a feature of your model, a documented step, or a named source. A claim with no evidence behind it is incomplete regardless of whether it is correct.

> 

**Q3.** Apply kinetic and potential energy to a case in Energy: Modelling, Accounting, and Conservation you have not worked before. Show the reasoning that produced your result, not only the result, and name the single step where that reasoning is most likely to break down.

> 

**Q4.** Check your work on kinetic and potential energy against each stated success criterion in turn and name the one you meet least well. Revise it, then state your next step concretely enough that someone else could carry it out: what you would do, and what result would tell you it worked.

> 

**Q5.** Answer the unit's essential question in two or three sentences, using kinetic and potential energy as your worked example and citing one piece of your own evidence: If energy is always conserved, why does everything eventually stop?

> 

**Q6.** Which single piece of evidence in your record most strongly supports your conclusion about kinetic and potential energy? State what makes it strong — precision, repetition, independence, or directness — and name one specific change that would strengthen it further.

> 

**Q7.** Name one thing your work on kinetic and potential energy cannot show, however carefully it was carried out, and explain what a different design or data source would have to do to answer it. State the limitation as a property of the method, not as an apology.
...
_Package `swp-ma-hs11-physics-u05-l07` · lesson `ma-hs11-physics-u05-l07` · built from `hs912-science-h2` at `265ea3a`. No observation, measurement, or expected result is supplied anywhere in this sheet._
