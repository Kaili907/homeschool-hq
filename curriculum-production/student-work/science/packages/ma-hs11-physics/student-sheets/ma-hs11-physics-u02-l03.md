...
**The task.** The learner completes a new application of Newton's second law as a mathematical relationship independently and records both the result and the reasoning, evidence, process, or design choice that produced it.
...
**The hands-on day in this unit, and its equal-credit alternative:** Day 7 investigation: Varying mass and force on a rolling cart | No-special-equipment alternative: Use a published force-mass-acceleration dataset and a supplied set of free-body diagrams; derive the relationship graphically. Paper and calculator only.
...
**Q1.** Explain Newton's second law as a mathematical relationship in your own words and tie each claim to a specific item in your record: a measurement, a feature of your model, a documented step, or a named source. A claim with no evidence behind it is incomplete regardless of whether it is correct.

> 

**Q2.** Apply Newton's second law as a mathematical relationship to a case in Forces and Newton's Second Law you have not worked before. Show the reasoning that produced your result, not only the result, and name the single step where that reasoning is most likely to break down.
...
**Q4.** Answer the unit's essential question in two or three sentences, using Newton's second law as a mathematical relationship as your worked example and citing one piece of your own evidence: What exactly is the relationship among net force, mass, and acceleration - and how would you know?

> 

**Q5.** Which single piece of evidence in your record most strongly supports your conclusion about Newton's second law as a mathematical relationship? State what makes it strong — precision, repetition, independence, or directness — and name one specific change that would strengthen it further.

> 

**Q6.** Name one thing your work on Newton's second law as a mathematical relationship cannot show, however carefully it was carried out, and explain what a different design or data source would have to do to answer it. State the limitation as a property of the method, not as an apology.
...
_Package `swp-ma-hs11-physics-u02-l03` · lesson `ma-hs11-physics-u02-l03` · built from `hs912-science-h2` at `265ea3a`. No observation, measurement, or expected result is supplied anywhere in this sheet._
