# Investigation: free-body diagrams

**High School Physics (Grade 11)** · Unit 2: Forces and Newton's Second Law · Day 7 of the unit (course day 19) · about 61–84 minutes

**Today's focus:** free-body diagrams

**Unit question:** What exactly is the relationship among net force, mass, and acceleration - and how would you know?

**What you are aiming at:**

- Plan and carry out a safe investigation of free-body diagrams, or its stated alternative, and record the learner's own data with its uncertainty.
- Explain free-body diagrams using evidence, a model, or a documented process rather than an unsupported answer.
- Apply free-body diagrams to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on free-body diagrams against the stated success criteria and name the next step.
...
**My question.** Write the question you are testing about free-body diagrams. It has to be a question your evidence could actually answer.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about free-body diagrams, then name one check that would catch an error or a weak claim.**
...
- Apply free-body diagrams under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect free-body diagrams to net force from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs11-physics-u02-l07` · lesson `ma-hs11-physics-u02-l07` · built from `hs912-science-h2` at `265ea3a`. No observation, measurement, or expected result is supplied anywhere in this sheet._
