...
**The task.** The learner completes a new application of evaluating published claims about radiation independently and records both the result and the reasoning, evidence, process, or design choice that produced it.
...
**The hands-on day in this unit, and its equal-credit alternative:** Day 7 investigation: Signal transmission, shielding, and an energy-conversion device build | No-special-equipment alternative: Run the shielding test with a radio and household materials only - no build - and complete the capstone as a documented paper design with a modelled energy budget rather than a physical device.
...
**Q1.** Explain evaluating published claims about radiation in your own words and tie each claim to a specific item in your record: a measurement, a feature of your model, a documented step, or a named source. A claim with no evidence behind it is incomplete regardless of whether it is correct.

> 

**Q2.** Apply evaluating published claims about radiation to a case in Electromagnetic Radiation, Information, and a Physics Engineering Capstone you have not worked before. Show the reasoning that produced your result, not only the result, and name the single step where that reasoning is most likely to break down.

> 

**Q3.** Check your work on evaluating published claims about radiation against each stated success criterion in turn and name the one you meet least well. Revise it, then state your next step concretely enough that someone else could carry it out: what you would do, and what result would tell you it worked.

> 

**Q4.** Answer the unit's essential question in two or three sentences, using evaluating published claims about radiation as your worked example and citing one piece of your own evidence: How do we send information reliably using something we cannot see?

> 

**Q5.** Which single piece of evidence in your record most strongly supports your conclusion about evaluating published claims about radiation? State what makes it strong — precision, repetition, independence, or directness — and name one specific change that would strengthen it further.

> 

**Q6.** Name one thing your work on evaluating published claims about radiation cannot show, however carefully it was carried out, and explain what a different design or data source would have to do to answer it. State the limitation as a property of the method, not as an apology.
...
_Package `swp-ma-hs11-physics-u09-l04` · lesson `ma-hs11-physics-u09-l04` · built from `hs912-science-h2` at `265ea3a`. No observation, measurement, or expected result is supplied anywhere in this sheet._
