# Performance task build: inverse-square relationships

**High School Physics (Grade 11)** · Unit 4: Gravitation and Electrostatic Forces · Day 9 of the unit (course day 45) · about 61–84 minutes
...
- Produce performance-task evidence for inverse-square relationships that a reader could check independently.
...
**My question.** Write the question you are testing about inverse-square relationships. It has to be a question your evidence could actually answer.
...
_Package `swp-ma-hs11-physics-u04-l09` · lesson `ma-hs11-physics-u04-l09` · built from `hs912-science-h2` at `265ea3a`. No observation, measurement, or expected result is supplied anywhere in this sheet._
