...
Analyse a published motion dataset or a frame-numbered motion diagram supplied on paper, extracting velocity and acceleration by hand. No ramp, no timing, paper only.
...
**What this lesson's data is, according to the curriculum:** Learner's own repeated timing trials over measured distances. Acceleration is computed from the learner's data, never supplied.
...
**Q1.** Describe the investigation you actually ran on position, displacement, and reference frames — or the alternative path, which is scored the same: the question, the variable you changed, the variables you held constant, what you measured, your uncertainty, and how many trials you completed. Report only values you measured or calculated yourself, or took from a source you name on the provenance line and mark SUPPLIED.

> 

**Q2.** Explain position, displacement, and reference frames in your own words and tie each claim to a specific item in your record: a measurement, a feature of your model, a documented step, or a named source. A claim with no evidence behind it is incomplete regardless of whether it is correct.

> 

**Q3.** Apply position, displacement, and reference frames to a case in Motion, Measurement, and Quantitative Reasoning you have not worked before. Show the reasoning that produced your result, not only the result, and name the single step where that reasoning is most likely to break down.

> 

**Q4.** Check your work on position, displacement, and reference frames against each stated success criterion in turn and name the one you meet least well. Revise it, then state your next step concretely enough that someone else could carry it out: what you would do, and what result would tell you it worked.

> 

**Q5.** Answer the unit's essential question in two or three sentences, using position, displacement, and reference frames as your worked example and citing one piece of your own evidence: How do we describe motion precisely enough that someone else can check us?

> 

**Q6.** Which single piece of evidence in your record most strongly supports your conclusion about position, displacement, and reference frames? State what makes it strong — precision, repetition, independence, or directness — and name one specific change that would strengthen it further.

> 

**Q7.** Name one thing your work on position, displacement, and reference frames cannot show, however carefully it was carried out, and explain what a different design or data source would have to do to answer it. State the limitation as a property of the method, not as an apology.
...
_Package `swp-ma-hs11-physics-u01-l07` · lesson `ma-hs11-physics-u01-l07` · built from `hs912-science-h2` at `265ea3a`. No observation, measurement, or expected result is supplied anywhere in this sheet._
