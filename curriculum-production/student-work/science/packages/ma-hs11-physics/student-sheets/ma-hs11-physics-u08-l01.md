...
**The task.** The learner completes a new application of wave properties and terminology independently and records both the result and the reasoning, evidence, process, or design choice that produced it.
...
**Q1.** Record two specific observations of the anchoring phenomenon for wave properties and terminology and one thing that does not yet fit your explanation. Turn that mismatch into a testable question: state what you would change, what you would measure, and what result would count against your own current thinking.
...
_Package `swp-ma-hs11-physics-u08-l01` · lesson `ma-hs11-physics-u08-l01` · built from `hs912-science-h2` at `265ea3a`. No observation, measurement, or expected result is supplied anywhere in this sheet._
