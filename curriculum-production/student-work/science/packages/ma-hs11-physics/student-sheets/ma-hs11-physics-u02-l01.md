# Launch and diagnostic: free-body diagrams

**High School Physics (Grade 11)** · Unit 2: Forces and Newton's Second Law · Day 1 of the unit (course day 13) · about 55–75 minutes
...
- Observe the anchoring phenomenon, surface initial thinking about free-body diagrams without penalty, and pose a testable question.
...
**The task.** The learner completes a new application of free-body diagrams independently and records both the result and the reasoning, evidence, process, or design choice that produced it.
...
**Q1.** Record two specific observations of the anchoring phenomenon for free-body diagrams and one thing that does not yet fit your explanation. Turn that mismatch into a testable question: state what you would change, what you would measure, and what result would count against your own current thinking.
...
_Package `swp-ma-hs11-physics-u02-l01` · lesson `ma-hs11-physics-u02-l01` · built from `hs912-science-h2` at `265ea3a`. No observation, measurement, or expected result is supplied anywhere in this sheet._
