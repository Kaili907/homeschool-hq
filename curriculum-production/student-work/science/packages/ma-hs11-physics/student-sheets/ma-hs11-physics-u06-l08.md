...
**The task.** The learner completes a new application of conduction, convection, and radiation independently and records both the result and the reasoning, evidence, process, or design choice that produced it.
...
**Q1.** Explain conduction, convection, and radiation in your own words and tie each claim to a specific item in your record: a measurement, a feature of your model, a documented step, or a named source. A claim with no evidence behind it is incomplete regardless of whether it is correct.

> 

**Q2.** Apply conduction, convection, and radiation to a case in Thermal Energy and the Second Law you have not worked before. Show the reasoning that produced your result, not only the result, and name the single step where that reasoning is most likely to break down.

> 

**Q3.** Check your work on conduction, convection, and radiation against each stated success criterion in turn and name the one you meet least well. Revise it, then state your next step concretely enough that someone else could carry it out: what you would do, and what result would tell you it worked.

> 

**Q4.** Answer the unit's essential question in two or three sentences, using conduction, convection, and radiation as your worked example and citing one piece of your own evidence: Why does energy spread out on its own, and never gather itself back up?

> 

**Q5.** Which single piece of evidence in your record most strongly supports your conclusion about conduction, convection, and radiation? State what makes it strong — precision, repetition, independence, or directness — and name one specific change that would strengthen it further.

> 

**Q6.** Name one thing your work on conduction, convection, and radiation cannot show, however carefully it was carried out, and explain what a different design or data source would have to do to answer it. State the limitation as a property of the method, not as an apology.
...
_Package `swp-ma-hs11-physics-u06-l08` · lesson `ma-hs11-physics-u06-l08` · built from `hs912-science-h2` at `265ea3a`. No observation, measurement, or expected result is supplied anywhere in this sheet._
