...
**Q1.** Do this one on your own, with no help and no example to copy: use waves and motion in a new situation, a new drawing, or under a new rule about what you are allowed to use. Write down what you did and why it worked.
...
_Package `swp-ma-g4-science-u05-l04` · lesson `ma-g4-science-u05-l04` · built from `g34-committed` at `4c6ca4e`. No observation, measurement, or expected result is supplied anywhere in this sheet._
