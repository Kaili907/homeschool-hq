# Concept model A: light energy

**Grade 4 Science** · Unit 3: Energy Transfer · Day 2 of the unit (course day 26) · about 40–55 minutes

**Today's focus:** light energy

**Unit question:** How can understanding energy transfer help us explain, decide, create, or solve something that matters?

**What you are aiming at:**

- Build a clear mental model of light energy through an explicit worked example, demonstration, text, or phenomenon.
- Use subject-appropriate evidence or representation to communicate understanding of light energy.
- Check, revise, or improve work about light energy using stated success criteria.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about light energy; then identify one check that would catch an error or weak claim.**
...
**Q1.** Draw or write a model that shows how light energy works. Label the parts. Then say which part of the worked example or demonstration you got each label from, and name one thing your model leaves out on purpose.
...
- Apply light energy under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect light energy to sound energy from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g4-science-u03-l02` · lesson `ma-g4-science-u03-l02` · built from `g34-committed` at `4c6ca4e`. No observation, measurement, or expected result is supplied anywhere in this sheet._
