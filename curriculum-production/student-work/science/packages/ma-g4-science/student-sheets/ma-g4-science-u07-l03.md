...
**Q1.** Work the practice items on structure and function. On the first one you may use the steps in front of you. On the last one, cover the steps and do it from memory. Then say what was different about doing it without help.
...
_Package `swp-ma-g4-science-u07-l03` · lesson `ma-g4-science-u07-l03` · built from `g34-committed` at `4c6ca4e`. No observation, measurement, or expected result is supplied anywhere in this sheet._
