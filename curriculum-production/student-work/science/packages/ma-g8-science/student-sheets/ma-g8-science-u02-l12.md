...
**The task.** Learner completes a new application of model limitations and records both the result and the reasoning, evidence, process, or design choice that produced it.
...
**Q4.** Answer the unit's essential question in two or three sentences, using model limitations as your worked example and citing one piece of your own evidence: How can understanding waves and information transfer help us explain, decide, create, or solve something that matters?
...
_Package `swp-ma-g8-science-u02-l12` · lesson `ma-g8-science-u02-l12` · built from `canonical-1.0.0` at `4056e31`. No observation, measurement, or expected result is supplied anywhere in this sheet._
