# Independent application A: artificial selection

**Grade 8 Science** · Unit 8: Applied Biology and Ecosystem Design · Day 4 of the unit (course day 88) · about 45–65 minutes

**Today's focus:** artificial selection
...
- Apply artificial selection independently in a new representation, text, situation, or design constraint.
- Use subject-appropriate evidence or representation to communicate understanding of artificial selection.
- Check, revise, or improve work about artificial selection using stated success criteria.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about artificial selection; then identify one check that would catch an error or weak claim.**
...
**Q1.** Work independently, without a template: apply artificial selection in a different representation, context, or design constraint from the one you practised in. State what carried over unchanged and what you had to adapt, because the adaptation is the evidence of understanding.
...
- Apply artificial selection under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect artificial selection to biodiversity from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g8-science-u08-l04` · lesson `ma-g8-science-u08-l04` · built from `canonical-1.0.0` at `4056e31`. No observation, measurement, or expected result is supplied anywhere in this sheet._
