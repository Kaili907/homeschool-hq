...
**The task.** Learner completes a new application of ecosystem services and records both the result and the reasoning, evidence, process, or design choice that produced it.
...
**Q1.** Take a specific error in your earlier work on ecosystem services and diagnose it: what the error assumed, and why that assumption seemed reasonable. Then choose a different representation or strategy, redo the work, and show that the new approach makes the original error impossible rather than merely avoided this time.

> 

**Q2.** Present your findings on ecosystem services in the representation the task calls for — a labelled model, a data display, a written explanation, or a documented process — and justify why that representation carries the evidence better than a bare statement would.

> 

**Q3.** Identify one place where you checked or revised your work on ecosystem services. State what you changed, what prompted you to notice it, and why the revision is an improvement against the stated success criteria rather than merely a difference.

> 

**Q4.** Answer the unit's essential question in two or three sentences, using ecosystem services as your worked example and citing one piece of your own evidence: How can understanding applied biology and ecosystem design help us explain, decide, create, or solve something that matters?

> 

**Q5.** Which single piece of evidence in your record most strongly supports your conclusion about ecosystem services? State what makes it strong — precision, repetition, independence, or directness — and name one specific change that would strengthen it further.

> 

**Q6.** Name one thing your work on ecosystem services cannot show, however carefully it was carried out, and explain what a different design or data source would have to do to answer it. State the limitation as a property of the method, not as an apology.
...
_Package `swp-ma-g8-science-u08-l08` · lesson `ma-g8-science-u08-l08` · built from `canonical-1.0.0` at `4056e31`. No observation, measurement, or expected result is supplied anywhere in this sheet._
