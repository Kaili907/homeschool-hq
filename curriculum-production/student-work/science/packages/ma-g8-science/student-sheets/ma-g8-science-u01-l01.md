...
**Q1.** State what you already believed about Newton’s laws at middle-school level before today's instruction, then point to one entry in your own record that revised that belief and one that confirmed it. An initial idea is scored for being stated honestly and revisited, never for correctness.
...
_Package `swp-ma-g8-science-u01-l01` · lesson `ma-g8-science-u01-l01` · built from `canonical-1.0.0` at `4056e31`. No observation, measurement, or expected result is supplied anywhere in this sheet._
