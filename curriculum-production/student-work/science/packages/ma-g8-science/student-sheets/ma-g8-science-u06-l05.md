...
**The task.** Learner completes a new application of technology and space data and records both the result and the reasoning, evidence, process, or design choice that produced it.
...
_Package `swp-ma-g8-science-u06-l05` · lesson `ma-g8-science-u06-l05` · built from `canonical-1.0.0` at `4056e31`. No observation, measurement, or expected result is supplied anywhere in this sheet._
