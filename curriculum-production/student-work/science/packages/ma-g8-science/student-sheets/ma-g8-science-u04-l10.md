# Synthesis and review: variation

**Grade 8 Science** · Unit 4: Natural Selection and Adaptation · Day 10 of the unit (course day 46) · about 45–65 minutes

**Today's focus:** variation
...
- Connect variation to the unit’s other ideas and select evidence that shows readiness for assessment.
- Use subject-appropriate evidence or representation to communicate understanding of variation.
- Check, revise, or improve work about variation using stated success criteria.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about variation; then identify one check that would catch an error or weak claim.**
...
**Q1.** Connect variation to the other ideas in Natural Selection and Adaptation: state one principle that holds across them and one case where treating them as the same would mislead you. Then select the single piece of your own work that best evidences readiness for assessment, and justify the selection against the success criteria.
...
- Apply variation under a new constraint, compare two approaches or perspectives, or teach the idea with an original example without completing another learner’s graded work.
- Connect variation to fossil evidence from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-g8-science-u04-l10` · lesson `ma-g8-science-u04-l10` · built from `canonical-1.0.0` at `4056e31`. No observation, measurement, or expected result is supplied anywhere in this sheet._
