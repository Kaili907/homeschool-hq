...
**Q1.** Produce independent mastery evidence for computational prediction of orbits on a task you have not seen, with no worked example available. Show the reasoning, not only the result — mastery is the reasoning surviving an unfamiliar surface, and an unexplained correct answer does not evidence it.

> 

**Q2.** Explain computational prediction of orbits in your own words and tie each claim to a specific item in your record: a measurement, a feature of your model, a documented step, or a named source. A claim with no evidence behind it is incomplete regardless of whether it is correct.

> 

**Q3.** Apply computational prediction of orbits to a case in Orbital Motion and the Solar System you have not worked before. Show the reasoning that produced your result, not only the result, and name the single step where that reasoning is most likely to break down.

> 

**Q4.** Check your work on computational prediction of orbits against each stated success criterion in turn and name the one you meet least well. Revise it, then state your next step concretely enough that someone else could carry it out: what you would do, and what result would tell you it worked.

> 

**Q5.** Answer the unit's essential question in two or three sentences, using computational prediction of orbits as your worked example and citing one piece of your own evidence: Why do orbits keep their shape, and what would it take to change one?

> 

**Q6.** Which single piece of evidence in your record most strongly supports your conclusion about computational prediction of orbits? State what makes it strong — precision, repetition, independence, or directness — and name one specific change that would strengthen it further.

> 

**Q7.** Name one thing your work on computational prediction of orbits cannot show, however carefully it was carried out, and explain what a different design or data source would have to do to answer it. State the limitation as a property of the method, not as an apology.
...
_Package `swp-ma-hs12-earth-space-environmental-u04-l11` · lesson `ma-hs12-earth-space-environmental-u04-l11` · built from `hs912-science-h2` at `265ea3a`. No observation, measurement, or expected result is supplied anywhere in this sheet._
