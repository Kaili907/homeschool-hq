# Launch and diagnostic: systems and system models

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 1: Earth and Space Systems, Scale, and Data Practice · Day 1 of the unit (course day 1) · about 55–75 minutes
...
- Observe the anchoring phenomenon, surface initial thinking about systems and system models without penalty, and pose a testable question.
...
**The task.** The learner completes a new application of systems and system models independently and records both the result and the reasoning, evidence, process, or design choice that produced it.
...
**Q1.** Record two specific observations of the anchoring phenomenon for systems and system models and one thing that does not yet fit your explanation. Turn that mismatch into a testable question: state what you would change, what you would measure, and what result would count against your own current thinking.
...
_Package `swp-ma-hs12-earth-space-environmental-u01-l01` · lesson `ma-hs12-earth-space-environmental-u01-l01` · built from `hs912-science-h2` at `265ea3a`. No observation, measurement, or expected result is supplied anywhere in this sheet._
