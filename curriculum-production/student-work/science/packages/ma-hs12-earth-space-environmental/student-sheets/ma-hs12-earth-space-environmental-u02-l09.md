...
Skip all outdoor solar work: compute the sun's power output and lifetime from published solar-constant and mass data, and identify elements from published stellar spectra images. Paper and calculator only. This is the DEFAULT path.
...
**What this lesson's data is, according to the curriculum:** Published solar constant, solar mass, and stellar spectra, plus the learner's own warming measurements if the outdoor route is used. Fusion rates are computed by the learner.
...
**Q1.** Assemble performance-task evidence for stellar life cycles that an independent reader could check without asking you a single question: the claim, the data behind it with its provenance, the reasoning between them, and the limitations. Anything a reader would have to take on trust is a gap in the evidence, not a detail.

> 

**Q2.** Explain stellar life cycles in your own words and tie each claim to a specific item in your record: a measurement, a feature of your model, a documented step, or a named source. A claim with no evidence behind it is incomplete regardless of whether it is correct.

> 

**Q3.** Apply stellar life cycles to a case in The Sun, Stars, and the Origin of the Elements you have not worked before. Show the reasoning that produced your result, not only the result, and name the single step where that reasoning is most likely to break down.

> 

**Q4.** Check your work on stellar life cycles against each stated success criterion in turn and name the one you meet least well. Revise it, then state your next step concretely enough that someone else could carry it out: what you would do, and what result would tell you it worked.

> 

**Q5.** Answer the unit's essential question in two or three sentences, using stellar life cycles as your worked example and citing one piece of your own evidence: Where did the atoms in your body actually come from?

> 

**Q6.** Which single piece of evidence in your record most strongly supports your conclusion about stellar life cycles? State what makes it strong — precision, repetition, independence, or directness — and name one specific change that would strengthen it further.

> 

**Q7.** Name one thing your work on stellar life cycles cannot show, however carefully it was carried out, and explain what a different design or data source would have to do to answer it. State the limitation as a property of the method, not as an apology.
...
_Package `swp-ma-hs12-earth-space-environmental-u02-l09` · lesson `ma-hs12-earth-space-environmental-u02-l09` · built from `hs912-science-h2` at `265ea3a`. No observation, measurement, or expected result is supplied anywhere in this sheet._
