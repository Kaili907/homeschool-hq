...
**The task.** The learner completes a new application of criteria, constraints, and prioritisation independently and records both the result and the reasoning, evidence, process, or design choice that produced it.
...
**The hands-on day in this unit, and its equal-credit alternative:** Day 7 investigation: Computational simulation of a coupled resource and sustainability system | No-special-equipment alternative: Build the simulation as an iterated spreadsheet or as a hand-computed table over time steps on paper. No programming environment and no downloads required.
...
**Q1.** Record two specific observations of the anchoring phenomenon for criteria, constraints, and prioritisation and one thing that does not yet fit your explanation. Turn that mismatch into a testable question: state what you would change, what you would measure, and what result would count against your own current thinking.
...
_Package `swp-ma-hs12-earth-space-environmental-u09-l01` · lesson `ma-hs12-earth-space-environmental-u09-l01` · built from `hs912-science-h2` at `265ea3a`. No observation, measurement, or expected result is supplied anywhere in this sheet._
