# Reteach and varied practice: motion of distant galaxies

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 3: Cosmology and the Evidence for the Big Bang · Day 8 of the unit (course day 32) · about 55–75 minutes

**Today's focus:** motion of distant galaxies

**Unit question:** What observations force the conclusion that the universe has a history?

**What you are aiming at:**

- Explain motion of distant galaxies using evidence, a model, or a documented process rather than an unsupported answer.
- Apply motion of distant galaxies to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on motion of distant galaxies against the stated success criteria and name the next step.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about motion of distant galaxies, then name one check that would catch an error or a weak claim.**
...
- Apply motion of distant galaxies under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect motion of distant galaxies to light spectra and redshift from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs12-earth-space-environmental-u03-l08` · lesson `ma-hs12-earth-space-environmental-u03-l08` · built from `hs912-science-h2` at `265ea3a`. No observation, measurement, or expected result is supplied anywhere in this sheet._
