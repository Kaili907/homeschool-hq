...
**Q1.** Produce independent mastery evidence for climate models and their uncertainty on a task you have not seen, with no worked example available. Show the reasoning, not only the result — mastery is the reasoning surviving an unfamiliar surface, and an unexplained correct answer does not evidence it.

> 

**Q2.** Explain climate models and their uncertainty in your own words and tie each claim to a specific item in your record: a measurement, a feature of your model, a documented step, or a named source. A claim with no evidence behind it is incomplete regardless of whether it is correct.

> 

**Q3.** Apply climate models and their uncertainty to a case in Climate, Energy Flow, and the Carbon Cycle you have not worked before. Show the reasoning that produced your result, not only the result, and name the single step where that reasoning is most likely to break down.

> 

**Q4.** Check your work on climate models and their uncertainty against each stated success criterion in turn and name the one you meet least well. Revise it, then state your next step concretely enough that someone else could carry it out: what you would do, and what result would tell you it worked.

> 

**Q5.** Answer the unit's essential question in two or three sentences, using climate models and their uncertainty as your worked example and citing one piece of your own evidence: What determines Earth's temperature, and how confident can a forecast honestly be?

> 

**Q6.** Which single piece of evidence in your record most strongly supports your conclusion about climate models and their uncertainty? State what makes it strong — precision, repetition, independence, or directness — and name one specific change that would strengthen it further.

> 

**Q7.** Name one thing your work on climate models and their uncertainty cannot show, however carefully it was carried out, and explain what a different design or data source would have to do to answer it. State the limitation as a property of the method, not as an apology.
...
_Package `swp-ma-hs12-earth-space-environmental-u07-l11` · lesson `ma-hs12-earth-space-environmental-u07-l11` · built from `hs912-science-h2` at `265ea3a`. No observation, measurement, or expected result is supplied anywhere in this sheet._
