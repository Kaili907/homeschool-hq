...
**The task.** The learner completes a new application of energy flow into and out of Earth systems independently and records both the result and the reasoning, evidence, process, or design choice that produced it.
...
**The hands-on day in this unit, and its equal-credit alternative:** Day 7 investigation: Energy balance modelling and carbon cycle quantification | No-special-equipment alternative: Run the energy-balance comparison in sunlight rather than under a lamp, or skip the physical model entirely and build the energy budget and carbon-cycle quantification from published flux data. Paper and calculator only.
...
**Q1.** Record two specific observations of the anchoring phenomenon for energy flow into and out of Earth systems and one thing that does not yet fit your explanation. Turn that mismatch into a testable question: state what you would change, what you would measure, and what result would count against your own current thinking.
...
_Package `swp-ma-hs12-earth-space-environmental-u07-l01` · lesson `ma-hs12-earth-space-environmental-u07-l01` · built from `hs912-science-h2` at `265ea3a`. No observation, measurement, or expected result is supplied anywhere in this sheet._
