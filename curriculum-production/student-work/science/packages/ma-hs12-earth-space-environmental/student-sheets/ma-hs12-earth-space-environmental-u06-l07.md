# Investigation: weathering and erosion

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 6: Surface Processes, Water, and Earth System Feedbacks · Day 7 of the unit (course day 67) · about 61–84 minutes

**Today's focus:** weathering and erosion
...
- Explain weathering and erosion using evidence, a model, or a documented process rather than an unsupported answer.
- Apply weathering and erosion to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on weathering and erosion against the stated success criteria and name the next step.
...
**My question.** Write the question you are testing about weathering and erosion. It has to be a question your evidence could actually answer.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about weathering and erosion, then name one check that would catch an error or a weak claim.**
...
- The learner completes the central task about weathering and erosion.
...
- Apply weathering and erosion under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect weathering and erosion to the special properties of water from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs12-earth-space-environmental-u06-l07` · lesson `ma-hs12-earth-space-environmental-u06-l07` · built from `hs912-science-h2` at `265ea3a`. No observation, measurement, or expected result is supplied anywhere in this sheet._
