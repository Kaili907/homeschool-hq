# Investigation: the Great Oxidation Event and atmospheric change

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 8: Coevolution of Earth and Life, Resources, and Natural Hazards · Day 7 of the unit (course day 91) · about 61–84 minutes

**Today's focus:** the Great Oxidation Event and atmospheric change

**Unit question:** How have Earth and life reshaped each other, and how does that history set where people can live?

**What you are aiming at:**

- Plan and carry out a safe investigation of the Great Oxidation Event and atmospheric change, or its stated alternative, and record the learner's own data with its uncertainty.
- Explain the Great Oxidation Event and atmospheric change using evidence, a model, or a documented process rather than an unsupported answer.
- Apply the Great Oxidation Event and atmospheric change to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on the Great Oxidation Event and atmospheric change against the stated success criteria and name the next step.

**Materials:**

- published atmospheric composition and banded-iron-formation data
- published hazard and resource maps
- graph paper
- notebook
...
- **Privacy hazard.** Mapping local hazards and resources can disclose where the family lives.
  - What stops it: Analyse a region at county scale or larger, or a region the family does not live in. Never record a home address or precise location.
- **Emotional hazard.** Natural hazard content can be frightening, especially after a local event.
  - What stops it: Keep the framing on preparation, mitigation, and documented responses; the learner may choose a different region at any point.
...
**Clearing up.** File or recycle the printed maps and notes. No location data is stored, uploaded, or shared. Nothing hazardous is produced.
...
**My question.** Write the question you are testing about the Great Oxidation Event and atmospheric change. It has to be a question your evidence could actually answer.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about the Great Oxidation Event and atmospheric change, then name one check that would catch an error or a weak claim.**
...
- Apply the Great Oxidation Event and atmospheric change under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect the Great Oxidation Event and atmospheric change to coevolution of the geosphere and biosphere from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs12-earth-space-environmental-u08-l07` · lesson `ma-hs12-earth-space-environmental-u08-l07` · built from `hs912-science-h2` at `265ea3a`. No observation, measurement, or expected result is supplied anywhere in this sheet._
