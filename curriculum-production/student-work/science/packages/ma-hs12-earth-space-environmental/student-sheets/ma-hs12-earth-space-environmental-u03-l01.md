...
**The task.** The learner completes a new application of light spectra and redshift independently and records both the result and the reasoning, evidence, process, or design choice that produced it.
...
_Package `swp-ma-hs12-earth-space-environmental-u03-l01` · lesson `ma-hs12-earth-space-environmental-u03-l01` · built from `hs912-science-h2` at `265ea3a`. No observation, measurement, or expected result is supplied anywhere in this sheet._
