...
**The hands-on day in this unit, and its equal-credit alternative:** Day 7 investigation: Erosion, infiltration, and water property testing | No-special-equipment alternative: Compare infiltration through sand, gravel, and packed soil in three cups on a tray indoors, or work entirely from a published watershed dataset. Kitchen materials or paper.
...
**Q1.** Produce independent mastery evidence for human alteration of surface processes on a task you have not seen, with no worked example available. Show the reasoning, not only the result — mastery is the reasoning surviving an unfamiliar surface, and an unexplained correct answer does not evidence it.

> 

**Q2.** Explain human alteration of surface processes in your own words and tie each claim to a specific item in your record: a measurement, a feature of your model, a documented step, or a named source. A claim with no evidence behind it is incomplete regardless of whether it is correct.

> 

**Q3.** Apply human alteration of surface processes to a case in Surface Processes, Water, and Earth System Feedbacks you have not worked before. Show the reasoning that produced your result, not only the result, and name the single step where that reasoning is most likely to break down.

> 

**Q4.** Check your work on human alteration of surface processes against each stated success criterion in turn and name the one you meet least well. Revise it, then state your next step concretely enough that someone else could carry it out: what you would do, and what result would tell you it worked.

> 

**Q5.** Answer the unit's essential question in two or three sentences, using human alteration of surface processes as your worked example and citing one piece of your own evidence: How does one change to Earth's surface end up changing systems far away from it?

> 

**Q6.** Which single piece of evidence in your record most strongly supports your conclusion about human alteration of surface processes? State what makes it strong — precision, repetition, independence, or directness — and name one specific change that would strengthen it further.

> 

**Q7.** Name one thing your work on human alteration of surface processes cannot show, however carefully it was carried out, and explain what a different design or data source would have to do to answer it. State the limitation as a property of the method, not as an apology.
...
_Package `swp-ma-hs12-earth-space-environmental-u06-l11` · lesson `ma-hs12-earth-space-environmental-u06-l11` · built from `hs912-science-h2` at `265ea3a`. No observation, measurement, or expected result is supplied anywhere in this sheet._
