# Scoring authority — Launch and diagnostic: criteria, constraints, and prioritisation

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 9: Sustainability Engineering and the Grade 12 Capstone · Day 1 · lesson `ma-hs12-earth-space-environmental-u09-l01`
...
**Q1 — phenomenon question.** _Serves objective 1:_ Observe the anchoring phenomenon, surface initial thinking about criteria, constraints, and prioritisation without penalty, and pose a testable question.
...
**Q7 — limitation.** _Serves objective 3:_ Apply criteria, constraints, and prioritisation to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q8 — provenance.** _Serves objective 1:_ Observe the anchoring phenomenon, surface initial thinking about criteria, constraints, and prioritisation without penalty, and pose a testable question.
...
_Package `swp-ma-hs12-earth-space-environmental-u09-l01` · built from `hs912-science-h2` at `265ea3a`._
