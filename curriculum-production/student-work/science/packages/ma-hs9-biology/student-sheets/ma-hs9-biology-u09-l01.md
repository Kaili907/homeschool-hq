...
**The task.** The learner completes a new application of multiple lines of evidence for common ancestry independently and records both the result and the reasoning, evidence, process, or design choice that produced it.
...
**The hands-on day in this unit, and its equal-credit alternative:** Day 7 investigation: Selection simulation and a conservation design test | No-special-equipment alternative: Run the selection simulation entirely on paper with dice determining survival probability by trait, then analyse a published conservation case study. No materials beyond paper and one die.
...
**Q1.** Record two specific observations of the anchoring phenomenon for multiple lines of evidence for common ancestry and one thing that does not yet fit your explanation. Turn that mismatch into a testable question: state what you would change, what you would measure, and what result would count against your own current thinking.
...
_Package `swp-ma-hs9-biology-u09-l01` · lesson `ma-hs9-biology-u09-l01` · built from `hs912-science-h2` at `265ea3a`. No observation, measurement, or expected result is supplied anywhere in this sheet._
