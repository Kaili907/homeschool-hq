# Investigation: setpoints and tolerance ranges

**High School Biology (Grade 9)** · Unit 4: Homeostasis and Feedback Mechanisms · Day 7 of the unit (course day 43) · about 61–84 minutes

**Today's focus:** setpoints and tolerance ranges

**Unit question:** How do living systems hold conditions steady while the world around them keeps changing?

**What you are aiming at:**

- Plan and carry out a safe investigation of setpoints and tolerance ranges, or its stated alternative, and record the learner's own data with its uncertainty.
- Explain setpoints and tolerance ranges using evidence, a model, or a documented process rather than an unsupported answer.
- Apply setpoints and tolerance ranges to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on setpoints and tolerance ranges against the stated success criteria and name the next step.
...
**My question.** Write the question you are testing about setpoints and tolerance ranges. It has to be a question your evidence could actually answer.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about setpoints and tolerance ranges, then name one check that would catch an error or a weak claim.**
...
Use a published, openly licensed physiological dataset - for example thermoregulation in a non-human animal - and model the feedback loop from that data. Needs only the dataset and paper.
...
**What this lesson's data is, according to the curriculum:** Learner-collected plant or thermal-model measurements, or a published non-human dataset. NO LEARNER BODY OR HEALTH MEASUREMENT IS REQUESTED ANYWHERE IN THIS UNIT.
...
**Q1.** Describe the investigation you actually ran on setpoints and tolerance ranges — or the alternative path, which is scored the same: the question, the variable you changed, the variables you held constant, what you measured, your uncertainty, and how many trials you completed. Report only values you measured or calculated yourself, or took from a source you name on the provenance line and mark SUPPLIED.

> 

**Q2.** Explain setpoints and tolerance ranges in your own words and tie each claim to a specific item in your record: a measurement, a feature of your model, a documented step, or a named source. A claim with no evidence behind it is incomplete regardless of whether it is correct.

> 

**Q3.** Apply setpoints and tolerance ranges to a case in Homeostasis and Feedback Mechanisms you have not worked before. Show the reasoning that produced your result, not only the result, and name the single step where that reasoning is most likely to break down.

> 

**Q4.** Check your work on setpoints and tolerance ranges against each stated success criterion in turn and name the one you meet least well. Revise it, then state your next step concretely enough that someone else could carry it out: what you would do, and what result would tell you it worked.

> 

**Q5.** Answer the unit's essential question in two or three sentences, using setpoints and tolerance ranges as your worked example and citing one piece of your own evidence: How do living systems hold conditions steady while the world around them keeps changing?

> 

**Q6.** Which single piece of evidence in your record most strongly supports your conclusion about setpoints and tolerance ranges? State what makes it strong — precision, repetition, independence, or directness — and name one specific change that would strengthen it further.

> 

**Q7.** Name one thing your work on setpoints and tolerance ranges cannot show, however carefully it was carried out, and explain what a different design or data source would have to do to answer it. State the limitation as a property of the method, not as an apology.
...
- The learner completes the central task about setpoints and tolerance ranges.
...
- Apply setpoints and tolerance ranges under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect setpoints and tolerance ranges to negative feedback loops from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs9-biology-u04-l07` · lesson `ma-hs9-biology-u04-l07` · built from `hs912-science-h2` at `265ea3a`. No observation, measurement, or expected result is supplied anywhere in this sheet._
