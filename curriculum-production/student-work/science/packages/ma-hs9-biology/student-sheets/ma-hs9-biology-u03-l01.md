...
**The task.** The learner completes a new application of cell theory and cell types independently and records both the result and the reasoning, evidence, process, or design choice that produced it.
...
**The hands-on day in this unit, and its equal-credit alternative:** Day 7 investigation: Surface-area-to-volume modelling and observation of dividing cells | No-special-equipment alternative: Do the whole unit with no microscope and no cutting: use published, openly licensed onion-root-tip micrographs to count cells in each mitotic phase, and model surface-area-to-volume with hand-rolled clay cubes measured with a ruler.
...
**Q1.** Record two specific observations of the anchoring phenomenon for cell theory and cell types and one thing that does not yet fit your explanation. Turn that mismatch into a testable question: state what you would change, what you would measure, and what result would count against your own current thinking.
...
_Package `swp-ma-hs9-biology-u03-l01` · lesson `ma-hs9-biology-u03-l01` · built from `hs912-science-h2` at `265ea3a`. No observation, measurement, or expected result is supplied anywhere in this sheet._
