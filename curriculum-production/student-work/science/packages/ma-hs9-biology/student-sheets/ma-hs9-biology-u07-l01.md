...
**The task.** The learner completes a new application of exponential and logistic growth independently and records both the result and the reasoning, evidence, process, or design choice that produced it.
...
**The hands-on day in this unit, and its equal-credit alternative:** Day 7 investigation: Modelling population growth from a published long-term dataset | No-special-equipment alternative: Run a mark-and-recapture sampling model with two colours of dried beans in a bag to estimate an unknown population, then compare the estimate to the true count. Kitchen materials and arithmetic only.
...
**Q1.** Record two specific observations of the anchoring phenomenon for exponential and logistic growth and one thing that does not yet fit your explanation. Turn that mismatch into a testable question: state what you would change, what you would measure, and what result would count against your own current thinking.
...
_Package `swp-ma-hs9-biology-u07-l01` · lesson `ma-hs9-biology-u07-l01` · built from `hs912-science-h2` at `265ea3a`. No observation, measurement, or expected result is supplied anywhere in this sheet._
