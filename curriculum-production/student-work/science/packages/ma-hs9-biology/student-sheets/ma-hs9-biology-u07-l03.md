...
**The task.** The learner completes a new application of interspecific interactions independently and records both the result and the reasoning, evidence, process, or design choice that produced it.
...
**Q1.** Explain interspecific interactions in your own words and tie each claim to a specific item in your record: a measurement, a feature of your model, a documented step, or a named source. A claim with no evidence behind it is incomplete regardless of whether it is correct.

> 

**Q2.** Apply interspecific interactions to a case in Population Dynamics, Carrying Capacity, and Biodiversity you have not worked before. Show the reasoning that produced your result, not only the result, and name the single step where that reasoning is most likely to break down.

> 

**Q3.** Check your work on interspecific interactions against each stated success criterion in turn and name the one you meet least well. Revise it, then state your next step concretely enough that someone else could carry it out: what you would do, and what result would tell you it worked.

> 

**Q4.** Answer the unit's essential question in two or three sentences, using interspecific interactions as your worked example and citing one piece of your own evidence: What actually sets the ceiling on a population, and what makes an ecosystem resilient when conditions change?

> 

**Q5.** Which single piece of evidence in your record most strongly supports your conclusion about interspecific interactions? State what makes it strong — precision, repetition, independence, or directness — and name one specific change that would strengthen it further.

> 

**Q6.** Name one thing your work on interspecific interactions cannot show, however carefully it was carried out, and explain what a different design or data source would have to do to answer it. State the limitation as a property of the method, not as an apology.
...
_Package `swp-ma-hs9-biology-u07-l03` · lesson `ma-hs9-biology-u07-l03` · built from `hs912-science-h2` at `265ea3a`. No observation, measurement, or expected result is supplied anywhere in this sheet._
