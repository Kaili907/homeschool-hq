# Independent application A: probability and Punnett models

**High School Biology (Grade 9)** · Unit 8: Inheritance and Variation of Traits · Day 4 of the unit (course day 88) · about 55–75 minutes

**Today's focus:** probability and Punnett models

**Unit question:** Where does heritable variation come from, and what can probability actually predict about it?

**What you are aiming at:**

- Explain probability and Punnett models using evidence, a model, or a documented process rather than an unsupported answer.
- Apply probability and Punnett models to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on probability and Punnett models against the stated success criteria and name the next step.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about probability and Punnett models, then name one check that would catch an error or a weak claim.**
...
- Apply probability and Punnett models under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect probability and Punnett models to chromosomes and gene loci from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs9-biology-u08-l04` · lesson `ma-hs9-biology-u08-l04` · built from `hs912-science-h2` at `265ea3a`. No observation, measurement, or expected result is supplied anywhere in this sheet._
