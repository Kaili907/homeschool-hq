# Investigation: trophic levels and energy transfer

**High School Biology (Grade 9)** · Unit 6: Ecosystems: Matter Cycling and Energy Flow · Day 7 of the unit (course day 67) · about 61–84 minutes

**Today's focus:** trophic levels and energy transfer

**Unit question:** Why does so little of the energy entering an ecosystem reach its top consumers?

**What you are aiming at:**

- Plan and carry out a safe investigation of trophic levels and energy transfer, or its stated alternative, and record the learner's own data with its uncertainty.
- Explain trophic levels and energy transfer using evidence, a model, or a documented process rather than an unsupported answer.
- Apply trophic levels and energy transfer to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on trophic levels and energy transfer against the stated success criteria and name the next step.
...
**My question.** Write the question you are testing about trophic levels and energy transfer. It has to be a question your evidence could actually answer.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about trophic levels and energy transfer, then name one check that would catch an error or a weak claim.**
...
Skip the decomposition setup: build the energy budget and carbon flow entirely from a published, openly licensed ecosystem dataset and a species list, using arithmetic and a drawn web. Paper only.
...
**What this lesson's data is, according to the curriculum:** Learner-collected mass-loss measurements where run, plus a published ecosystem energy dataset. Trophic efficiency is derived from data, never asserted.

**Where to find the published data:** see `res-ma-hs9-biology-data-sources` in the course resource list. The family retrieves it; no third-party content is copied into this package.
...
**Q1.** Describe the investigation you actually ran on trophic levels and energy transfer — or the alternative path, which is scored the same: the question, the variable you changed, the variables you held constant, what you measured, your uncertainty, and how many trials you completed. Report only values you measured or calculated yourself, or took from a source you name on the provenance line and mark SUPPLIED.

> 

**Q2.** Explain trophic levels and energy transfer in your own words and tie each claim to a specific item in your record: a measurement, a feature of your model, a documented step, or a named source. A claim with no evidence behind it is incomplete regardless of whether it is correct.

> 

**Q3.** Apply trophic levels and energy transfer to a case in Ecosystems: Matter Cycling and Energy Flow you have not worked before. Show the reasoning that produced your result, not only the result, and name the single step where that reasoning is most likely to break down.

> 

**Q4.** Check your work on trophic levels and energy transfer against each stated success criterion in turn and name the one you meet least well. Revise it, then state your next step concretely enough that someone else could carry it out: what you would do, and what result would tell you it worked.

> 

**Q5.** Answer the unit's essential question in two or three sentences, using trophic levels and energy transfer as your worked example and citing one piece of your own evidence: Why does so little of the energy entering an ecosystem reach its top consumers?

> 

**Q6.** Which single piece of evidence in your record most strongly supports your conclusion about trophic levels and energy transfer? State what makes it strong — precision, repetition, independence, or directness — and name one specific change that would strengthen it further.

> 

**Q7.** Name one thing your work on trophic levels and energy transfer cannot show, however carefully it was carried out, and explain what a different design or data source would have to do to answer it. State the limitation as a property of the method, not as an apology.
...
- The learner completes the central task about trophic levels and energy transfer.
...
- Apply trophic levels and energy transfer under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect trophic levels and energy transfer to food webs and matter flow from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs9-biology-u06-l07` · lesson `ma-hs9-biology-u06-l07` · built from `hs912-science-h2` at `265ea3a`. No observation, measurement, or expected result is supplied anywhere in this sheet._
