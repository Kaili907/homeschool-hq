# Investigation: chromosomes and gene loci

**High School Biology (Grade 9)** · Unit 8: Inheritance and Variation of Traits · Day 7 of the unit (course day 91) · about 61–84 minutes

**Today's focus:** chromosomes and gene loci

**Unit question:** Where does heritable variation come from, and what can probability actually predict about it?

**What you are aiming at:**

- Plan and carry out a safe investigation of chromosomes and gene loci, or its stated alternative, and record the learner's own data with its uncertainty.
- Explain chromosomes and gene loci using evidence, a model, or a documented process rather than an unsupported answer.
- Apply chromosomes and gene loci to a task the learner has not seen before, showing the reasoning that produced the result.
- Check and revise the work on chromosomes and gene loci against the stated success criteria and name the next step.
...
**My question.** Write the question you are testing about chromosomes and gene loci. It has to be a question your evidence could actually answer.
...
**What did you check, what did you change, and what is your next step? In one concise response, show or explain the most important idea about chromosomes and gene loci, then name one check that would catch an error or a weak claim.**
...
- The learner completes the central task about chromosomes and gene loci.
...
- Apply chromosomes and gene loci under a new constraint, compare two approaches or two sources, or teach the idea with an original example. Extension never means completing another learner's graded work.
- Connect chromosomes and gene loci to meiosis and recombination from this unit: state one thing that must be true of both, and one case where treating them the same would mislead you.
...
_Package `swp-ma-hs9-biology-u08-l07` · lesson `ma-hs9-biology-u08-l07` · built from `hs912-science-h2` at `265ea3a`. No observation, measurement, or expected result is supplied anywhere in this sheet._
