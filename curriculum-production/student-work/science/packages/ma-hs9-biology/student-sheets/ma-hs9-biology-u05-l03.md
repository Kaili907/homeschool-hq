...
**The task.** The learner completes a new application of cellular respiration independently and records both the result and the reasoning, evidence, process, or design choice that produced it.
...
**Q1.** Explain cellular respiration in your own words and tie each claim to a specific item in your record: a measurement, a feature of your model, a documented step, or a named source. A claim with no evidence behind it is incomplete regardless of whether it is correct.

> 

**Q2.** Apply cellular respiration to a case in Photosynthesis, Cellular Respiration, and Energy in Living Systems you have not worked before. Show the reasoning that produced your result, not only the result, and name the single step where that reasoning is most likely to break down.

> 

**Q3.** Check your work on cellular respiration against each stated success criterion in turn and name the one you meet least well. Revise it, then state your next step concretely enough that someone else could carry it out: what you would do, and what result would tell you it worked.

> 

**Q4.** Answer the unit's essential question in two or three sentences, using cellular respiration as your worked example and citing one piece of your own evidence: Where does the matter in a tree come from, and where does the energy in your food actually go?

> 

**Q5.** Which single piece of evidence in your record most strongly supports your conclusion about cellular respiration? State what makes it strong — precision, repetition, independence, or directness — and name one specific change that would strengthen it further.

> 

**Q6.** Name one thing your work on cellular respiration cannot show, however carefully it was carried out, and explain what a different design or data source would have to do to answer it. State the limitation as a property of the method, not as an apology.
...
_Package `swp-ma-hs9-biology-u05-l03` · lesson `ma-hs9-biology-u05-l03` · built from `hs912-science-h2` at `265ea3a`. No observation, measurement, or expected result is supplied anywhere in this sheet._
