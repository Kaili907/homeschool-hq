...
**The task.** The learner completes a new application of trophic levels and energy transfer independently and records both the result and the reasoning, evidence, process, or design choice that produced it.
...
**The hands-on day in this unit, and its equal-credit alternative:** Day 7 investigation: Decomposition rates and a quantified local food web | No-special-equipment alternative: Skip the decomposition setup: build the energy budget and carbon flow entirely from a published, openly licensed ecosystem dataset and a species list, using arithmetic and a drawn web. Paper only.
...
_Package `swp-ma-hs9-biology-u06-l01` · lesson `ma-hs9-biology-u06-l01` · built from `hs912-science-h2` at `265ea3a`. No observation, measurement, or expected result is supplied anywhere in this sheet._
