...
**Q1.** Before anyone taught you anything today, what did you already think about birth, growth, reproduction, and death? Write that down first. Then mark one place in your record that changed your mind and one that showed you were right. A first idea is never marked wrong.
...
_Package `swp-ma-g3-science-u04-l01` · lesson `ma-g3-science-u04-l01` · built from `g34-committed` at `4c6ca4e`. No observation, measurement, or expected result is supplied anywhere in this sheet._
