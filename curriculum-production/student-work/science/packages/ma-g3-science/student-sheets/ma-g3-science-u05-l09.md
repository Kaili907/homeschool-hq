# Performance task build: comparing parents and offspring

**Grade 3 Science** · Unit 5: Inherited Traits and Variation · Day 9 of the unit (course day 57) · about 40–55 minutes
...
- Create, test, or revise a meaningful product that applies comparing parents and offspring and the unit standards.
...
**My question.** Write the question you are testing about comparing parents and offspring. It has to be a question your evidence could actually answer.
...
**Q1.** Build, test, and improve something that uses comparing parents and offspring. Write what it has to do, test it, then change one thing to make it better and test again. Record both tests, including the one that went badly.
...
_Package `swp-ma-g3-science-u05-l09` · lesson `ma-g3-science-u05-l09` · built from `g34-committed` at `4c6ca4e`. No observation, measurement, or expected result is supplied anywhere in this sheet._
