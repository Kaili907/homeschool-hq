...
**The task.** Complete the unit assessment evidence for cause and effect independently. Supports may preserve access but may not supply the answer, interpretation, or final product.
...
**Q1.** Show what you know about cause and effect three ways: pick the right answer from choices, write an answer in your own words, and use it on a real task. If the three disagree, say which one you trust and why.
...
**Q4.** Answer the big question for this unit in two or three sentences, using cause and effect as your example: How can understanding magnetic and electric interactions help us explain, decide, create, or solve something that matters?
...
_Package `swp-ma-g3-science-u03-l11` · lesson `ma-g3-science-u03-l11` · built from `g34-committed` at `4c6ca4e`. No observation, measurement, or expected result is supplied anywhere in this sheet._
