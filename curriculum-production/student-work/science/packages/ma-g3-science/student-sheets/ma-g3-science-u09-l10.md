...
**Q1.** Connect comparing solutions to the other big ideas in Capstone: Weather Hazards and Changing Habitats. Say what they have in common, then pick the one piece of your work that best shows you are ready for the unit test and say why that one.
...
**Q4.** Answer the big question for this unit in two or three sentences, using comparing solutions as your example: How can understanding weather hazards and changing habitats help us explain, decide, create, or solve something that matters?
...
_Package `swp-ma-g3-science-u09-l10` · lesson `ma-g3-science-u09-l10` · built from `g34-committed` at `4c6ca4e`. No observation, measurement, or expected result is supplied anywhere in this sheet._
