...
**The task.** Learner completes a new application of models and drawings and records both the result and the reasoning, evidence, process, or design choice that produced it.
...
**My question.** Write the question you are testing about models and drawings. It has to be a question your evidence could actually answer.
...
**Q1.** Build, test, and improve something that uses models and drawings. Write what it has to do, test it, then change one thing to make it better and test again. Record both tests, including the one that went badly.

> 

**Q2.** Show what you found about models and drawings in the clearest way for this task — a labelled drawing, a table, a written explanation, or the steps you followed. Then say why you picked that way instead of just writing one sentence.

> 

**Q3.** Find one place where you checked your work about models and drawings and changed something. Write what you changed, what made you notice it, and why the new version is better — not just different.

> 

**Q4.** Answer the big question for this unit in two or three sentences, using models and drawings as your example: How can understanding science and engineering practices help us explain, decide, create, or solve something that matters?

> 

**Q5.** Which one piece of evidence in your record best supports what you decided about models and drawings? Say what makes it good evidence, and name one thing that would make it even stronger.

> 

**Q6.** Name one thing your work on models and drawings cannot tell you, even if you did everything carefully. Then say what someone would have to do differently to find that out.
...
_Package `swp-ma-g3-science-u01-l09` · lesson `ma-g3-science-u01-l09` · built from `g34-committed` at `4c6ca4e`. No observation, measurement, or expected result is supplied anywhere in this sheet._
