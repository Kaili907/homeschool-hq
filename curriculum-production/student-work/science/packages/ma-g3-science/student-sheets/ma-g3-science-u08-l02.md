...
**Q1.** Draw or write a model that shows how tables and graphs works. Label the parts. Then say which part of the worked example or demonstration you got each label from, and name one thing your model leaves out on purpose.
...
_Package `swp-ma-g3-science-u08-l02` · lesson `ma-g3-science-u08-l02` · built from `g34-committed` at `4c6ca4e`. No observation, measurement, or expected result is supplied anywhere in this sheet._
