...
- `hs-safety-from-h2-only` — Every High School safety brief carries the H2 safety-review text, and no lesson falls back to the failed base candidate.
- `hs-base-candidate-defects-absent` — None of the defects the H2 fix removed — flame demonstration, water on a fire, uncapped hot water, sealing a reacting mixture — reappears in any student sheet.
...
- `prohibitions-on-every-sheet` — All ten non-disableable prohibitions appear on every student sheet, in the wording for that grade band.
...
- `chemical-hazard-needs-direct-adult` — Any lesson declaring a chemical hazard declares direct-adult supervision, as the H2 framework requires.
