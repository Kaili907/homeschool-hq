/**
 * Emits the shipped grade 12 corpus from the authored specs.
 *
...
export const GATE_METADATA_PATH = 'gate/gate-metadata.json'
...
write(GATE_METADATA_PATH, buildGateMetadata(ALL_SPECS))

process.stdout.write(`emitted ${n} task sheets, ${n} scoring records, and gate scoring-mode metadata for ${n} lessons\n`)
