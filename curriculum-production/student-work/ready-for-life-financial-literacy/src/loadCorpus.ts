...
/**
 * Loads every authored package/scoring pair in this branch's corpus. Throws
 * if a package has no matching scoring record, since a task sheet with no
 * scoring authority is not production material.
 */
