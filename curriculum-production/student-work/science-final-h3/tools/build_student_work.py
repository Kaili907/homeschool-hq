...
OUT_ROOT = REPO_ROOT / "curriculum-production" / "student-work" / "science-final-h3"
...
def build_alternatives(
    ...
    if course["family"] == "hs":
        ...
        if data_bearing and (is_pointer or not lesson_alternative) and unit_alternative:
            ...
            alternative_source = "hs912-science-h3 unit lab-alternative"
            is_pointer = False
        else:
            alternative_text = lesson_alternative or unit_alternative
            alternative_source = (
                "hs912-science-h3 lesson lab-alternative"
                if lesson_alternative
                else "hs912-science-h3 unit lab-alternative"
            )
...
def main() -> int:
    ...
    resources = reader.read_json("hs912-science-h3", HS_H3_COMMIT, HS_RESOURCES_PATH)
    ...
    manifest = {
        ...
        "high_school_safety_lineage": {
            ...
            "supersedes": HS_SUPERSEDED_H2_COMMIT,
            "rejected_base_candidate": HS_FAILED_BASE_COMMIT,
            "note": (
                "High School student sheets are derived from H3. No blob from the "
                "superseded H2 fix or the failed base candidate is read by this build."
            ),
        },
        "invariants": [
            ...
            "High School safety content comes from the H3 package only; H2 is superseded.",
