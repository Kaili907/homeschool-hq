...
build is reproducible regardless of where the source branches move next.
  ...
  high school 9-12     mac/hs912-science-h3 @ e7551b9 (H3 learner-use safety fix)

H3 supersedes H2 for High School. Both the failed base candidate (f58f7f1) and
the superseded H2 fix (265ea3a) are recorded here only so the validator can
prove the build read neither. No High School blob is read at H2 any more.
"""
...
HS_H3_COMMIT = "e7551b959112fcd9e6868d614799028cf22acf5d"
