# Scoring authority — Concept model A: anatomical similarities

**Grade 8 Science** · Unit 4: Natural Selection and Adaptation · Day 2 · lesson `ma-g8-science-u04-l02`
...
**Q1 — model build.** _Serves objective 1:_ Build a clear mental model of anatomical similarities through an explicit worked example, demonstration, text, or phenomenon.
...
**Q4 — essential question.** _Serves objective 1:_ Build a clear mental model of anatomical similarities through an explicit worked example, demonstration, text, or phenomenon.
...
**Q6 — limitation.** _Serves objective 1:_ Build a clear mental model of anatomical similarities through an explicit worked example, demonstration, text, or phenomenon.
...
_Package `swp-ma-g8-science-u04-l02` · built from `canonical-1.0.0` at `4056e31`._
