# Scoring authority — Correction and reflection: competing design criteria

**Grade 8 Science** · Unit 8: Applied Biology and Ecosystem Design · Day 12 · lesson `ma-g8-science-u08-l12`
...
_Topic `ma-g8-science-u08::competing design criteria` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Ecosystem design problems involve criteria that pull against one another, such as yield, cost, biodiversity, and resilience.
- Improving one criterion usually costs something on another, and the choice of which to favour is a decision, not a measurement.
- Every option is evaluated against the same criteria, including the option of doing nothing.
...
- Presenting a solution that is best on every criterion at once with no trade-off.
- Omitting the do-nothing option from the comparison without saying why.
- Changing the criteria after evaluation to favour a preferred option.

**Grade boundary.** Multi-criteria decision analysis is High School work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for competing design criteria, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of competing design criteria.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about competing design criteria using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for competing design criteria, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of competing design criteria.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for competing design criteria, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of competing design criteria.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for competing design criteria, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for competing design criteria works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of competing design criteria, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking competing design criteria mastered.
...
_Package `swp-ma-g8-science-u08-l12` · built from `canonical-1.0.0` at `4056e31`._
