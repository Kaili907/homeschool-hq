# Scoring authority — Reteach and varied practice: anatomical similarities

**Grade 8 Science** · Unit 4: Natural Selection and Adaptation · Day 8 · lesson `ma-g8-science-u04-l08`
...
_Topic `ma-g8-science-u04::anatomical similarities` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Different species can share the same underlying body structures, such as the bone pattern in the limbs of mammals, birds, and reptiles.
- Shared underlying structure used for different purposes is evidence of common ancestry rather than of shared function.
- Similar function achieved with quite different structures, such as insect and bird wings, is evidence of separate origins.

**Also correct.** Accept any of these framings — do not require the wording above:

- Naming these patterns homologous and analogous structures is correct but not required at this grade.
...
- Treating any resemblance between two organisms as evidence of close relationship.
- Claiming structures used for the same purpose must share an origin.
- Claiming a structure changed within one organism's lifetime to suit a new purpose.

**Grade boundary.** Phylogenetic tree construction and molecular homology are High School work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for anatomical similarities, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of anatomical similarities.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about anatomical similarities using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for anatomical similarities, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of anatomical similarities.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for anatomical similarities, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of anatomical similarities.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for anatomical similarities, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for anatomical similarities works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of anatomical similarities, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking anatomical similarities mastered.
...
_Package `swp-ma-g8-science-u04-l08` · built from `canonical-1.0.0` at `4056e31`._
