# Scoring authority — Unit assessment: technology and space data

**Grade 8 Science** · Unit 6: Earth, Moon, Sun, and the Solar System · Day 11 · lesson `ma-g8-science-u06-l11`
...
_Topic `ma-g8-science-u06::technology and space data` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Almost everything known about distant objects comes from the radiation they emit or reflect, collected by telescopes and spacecraft instruments.
- Improvements in instruments have repeatedly changed what is known, because the data available sets the limits on the conclusions.
- Every instrument has limits of resolution, sensitivity, and wavelength range, and those limits belong in the interpretation.
...
- Treating a processed or false-colour astronomical image as a direct visual view.
- Claiming an instrument's failure to detect something proves it is not there.
- Claiming space data requires no interpretation.

**Grade boundary.** Detector physics and spectroscopic analysis are High School work.


## What a complete response contains, question by question

**Q1 — demonstrate mastery.** _Serves objective 1:_ Demonstrate current mastery of technology and space data through selected-response, constructed-response, and applied evidence.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of technology and space data.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about technology and space data using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Demonstrate current mastery of technology and space data through selected-response, constructed-response, and applied evidence.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of technology and space data.
...
**Q6 — limitation.** _Serves objective 1:_ Demonstrate current mastery of technology and space data through selected-response, constructed-response, and applied evidence.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of technology and space data.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for technology and space data, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for technology and space data works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of technology and space data, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking technology and space data mastered.
...
_Package `swp-ma-g8-science-u06-l11` · built from `canonical-1.0.0` at `4056e31`._
