# Scoring authority — Synthesis and review: artificial selection

**Grade 8 Science** · Unit 8: Applied Biology and Ecosystem Design · Day 10 · lesson `ma-g8-science-u08-l10`
...
_Topic `ma-g8-science-u08::artificial selection` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- In artificial selection humans choose which individuals reproduce; in natural selection the environment determines differential reproductive success.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Artificial selection works on the same heritable variation that natural selection acts on; only the selecting agent differs.
- Selecting strongly for one trait often carries other traits with it and can reduce genetic variety in the population.
- The speed of change under artificial selection shows how quickly heritable traits in a population can shift.

**Also correct.** Accept any of these framings — do not require the wording above:

- Selective breeding and artificial selection are the same idea.
...
- Claiming artificial selection creates the desired variation rather than selecting from existing variation.
- Claiming artificial selection has no unintended effects on other traits or on genetic variety.
- Confusing artificial selection with direct genetic modification.

**Grade boundary.** Quantitative genetics, breeding values, and genetic engineering techniques are High School work.


## What a complete response contains, question by question

**Q1 — connect unit.** _Serves objective 1:_ Connect artificial selection to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of artificial selection.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about artificial selection using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Connect artificial selection to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of artificial selection.
...
**Q6 — limitation.** _Serves objective 1:_ Connect artificial selection to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of artificial selection.
...
- The learner completes the central task about artificial selection.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for artificial selection, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for artificial selection works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of artificial selection, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking artificial selection mastered.
...
_Package `swp-ma-g8-science-u08-l10` · built from `canonical-1.0.0` at `4056e31`._
