# Scoring authority — Launch and diagnostic: fossil evidence

**Grade 8 Science** · Unit 4: Natural Selection and Adaptation · Day 1 · lesson `ma-g8-science-u04-l01`
...
_Topic `ma-g8-science-u04::fossil evidence` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._
...
**Q1 — activate prior.** _Serves objective 1:_ Activate prior knowledge about fossil evidence, surface initial thinking without penalty, and establish the unit question.
...
**Q4 — essential question.** _Serves objective 1:_ Activate prior knowledge about fossil evidence, surface initial thinking without penalty, and establish the unit question.
...
**Q6 — limitation.** _Serves objective 1:_ Activate prior knowledge about fossil evidence, surface initial thinking without penalty, and establish the unit question.
...
_Package `swp-ma-g8-science-u04-l01` · built from `canonical-1.0.0` at `4056e31`._
