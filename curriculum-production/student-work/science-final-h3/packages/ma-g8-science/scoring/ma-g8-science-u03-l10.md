# Scoring authority — Synthesis and review: inheritance models

**Grade 8 Science** · Unit 3: Growth, Reproduction, and Heredity · Day 10 · lesson `ma-g8-science-u03-l10`
...
_Topic `ma-g8-science-u03::inheritance models` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- An inheritance model represents how versions of a gene from two parents can combine in offspring.
- A model such as a Punnett square gives the proportions expected over many offspring, not what any individual offspring will be.
- The model assumes the simple case of one gene with two versions, which many real traits do not follow.

**Also correct.** Accept any of these framings — do not require the wording above:

- Punnett squares, probability trees, and pedigree diagrams are all acceptable models here.
...
- Reading a model's proportion as a guarantee about an individual offspring.
- Claiming every trait follows a simple two-version pattern.
- Claiming a model's prediction is disproved because one small family did not match it.

**Grade boundary.** Linkage, incomplete dominance and codominance by name, and chi-squared testing are High School work.


## What a complete response contains, question by question

**Q1 — connect unit.** _Serves objective 1:_ Connect inheritance models to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of inheritance models.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about inheritance models using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Connect inheritance models to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of inheritance models.
...
**Q6 — limitation.** _Serves objective 1:_ Connect inheritance models to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of inheritance models.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for inheritance models, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for inheritance models works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of inheritance models, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking inheritance models mastered.
...
_Package `swp-ma-g8-science-u03-l10` · built from `canonical-1.0.0` at `4056e31`._
