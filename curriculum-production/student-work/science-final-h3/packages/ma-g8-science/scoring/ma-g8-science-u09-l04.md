# Scoring authority — Independent application A: iterative modeling

**Grade 8 Science** · Unit 9: Engineering and Scientific Argument Capstone · Day 4 · lesson `ma-g8-science-u09-l04`
...
**Q1 — apply independent.** _Serves objective 1:_ Apply iterative modeling independently in a new representation, text, situation, or design constraint.
...
**Q4 — essential question.** _Serves objective 1:_ Apply iterative modeling independently in a new representation, text, situation, or design constraint.
...
**Q6 — limitation.** _Serves objective 1:_ Apply iterative modeling independently in a new representation, text, situation, or design constraint.
...
_Package `swp-ma-g8-science-u09-l04` · built from `canonical-1.0.0` at `4056e31`._
