# Scoring authority — Synthesis and review: climate evidence

**Grade 8 Science** · Unit 7: Resources, Climate, and Human Systems · Day 10 · lesson `ma-g8-science-u07-l10`
...
_Topic `ma-g8-science-u07::climate evidence` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Global average surface temperature has risen since the late nineteenth century, and the rise is principally caused by greenhouse gases released by human activity, above all carbon dioxide from burning fossil fuels.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Multiple independent records agree: surface and ocean temperatures, sea level, ice-sheet and glacier mass, and the timing of seasonal biological events.
- Ice cores and other archives extend the record far beyond instruments and show that current carbon dioxide levels are far outside the range of recent geological history.
- The natural greenhouse effect is necessary for life; the concern is the additional warming from gases added by human activity.

**Also correct.** Accept any of these framings — do not require the wording above:

- Attributing the cause to greenhouse gases from human activity, or specifically to carbon dioxide from fossil fuel burning, are both correct.
...
- Citing a single cold season or year as evidence against long-term warming.
- Claiming the cause of the observed warming is unknown or unestablished.
- Confusing the natural greenhouse effect with the enhanced effect from added greenhouse gases.

**Grade boundary.** Radiative forcing calculations, climate sensitivity, and formal attribution methods are High School work.


## What a complete response contains, question by question

**Q1 — connect unit.** _Serves objective 1:_ Connect climate evidence to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of climate evidence.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about climate evidence using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Connect climate evidence to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of climate evidence.
...
**Q6 — limitation.** _Serves objective 1:_ Connect climate evidence to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of climate evidence.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for climate evidence, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for climate evidence works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of climate evidence, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking climate evidence mastered.
...
_Package `swp-ma-g8-science-u07-l10` · built from `canonical-1.0.0` at `4056e31`._
