# Scoring authority — Performance task build: disturbance and resilience

**Grade 8 Science** · Unit 8: Applied Biology and Ecosystem Design · Day 9 · lesson `ma-g8-science-u08-l09`
...
_Topic `ma-g8-science-u08::disturbance and resilience` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Disturbances such as fire, flood, storm, and disease are normal parts of ecosystem dynamics.
- Resilience is an ecosystem's capacity to recover its function after disturbance, and it depends on what survives and on the severity of the disturbance.
- Repeated or severe disturbance can push an ecosystem into a different state that does not return on its own.
...
- Claiming all disturbance is damaging; many communities depend on periodic disturbance.
- Claiming an ecosystem always returns to its previous state.
- Claiming resilience means an ecosystem is unaffected by disturbance.

**Grade boundary.** Alternative stable states and resilience metrics are High School work.
...
**Q1 — build product.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies disturbance and resilience and the unit standards.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of disturbance and resilience.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about disturbance and resilience using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies disturbance and resilience and the unit standards.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of disturbance and resilience.
...
**Q6 — limitation.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies disturbance and resilience and the unit standards.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of disturbance and resilience.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for disturbance and resilience, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for disturbance and resilience works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of disturbance and resilience, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking disturbance and resilience mastered.
...
_Package `swp-ma-g8-science-u08-l09` · built from `canonical-1.0.0` at `4056e31`._
