# Scoring authority — Correction and reflection: probability and model limits

**Grade 8 Science** · Unit 3: Growth, Reproduction, and Heredity · Day 12 · lesson `ma-g8-science-u03-l12`
...
_Topic `ma-g8-science-u03::probability and model limits` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Inheritance predictions are probabilities: they describe expected proportions across many offspring.
- Small samples depart from expected proportions by chance, and that departure is not evidence against the model.
- A probability model is tested against large numbers of outcomes, not against individual cases.
...
- Treating a three-to-one expectation as a promise about four offspring.
- Claiming a model is wrong because a small sample did not match it.
- Claiming earlier offspring change the probability for later ones in independent events.

**Grade boundary.** Formal statistical testing and confidence intervals are High School work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for probability and model limits, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of probability and model limits.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about probability and model limits using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for probability and model limits, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of probability and model limits.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for probability and model limits, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of probability and model limits.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for probability and model limits, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for probability and model limits works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of probability and model limits, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking probability and model limits mastered.
...
_Package `swp-ma-g8-science-u03-l12` · built from `canonical-1.0.0` at `4056e31`._
