# Scoring authority — Reteach and varied practice: rock strata and fossils

**Grade 8 Science** · Unit 5: Earth History and Geologic Processes · Day 8 · lesson `ma-g8-science-u05-l08`
...
_Topic `ma-g8-science-u05::rock strata and fossils` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- In undisturbed sequences, lower strata are older than the strata above them.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Sedimentary strata are deposited in order, so in an undisturbed sequence lower means older.
- Fossils within strata date the strata relative to one another, and matching fossil assemblages allow strata in different places to be correlated.
- Strata can be tilted, folded, faulted, or eroded, so the sequence has to be interpreted, not simply read off.

**Also correct.** Accept any of these framings — do not require the wording above:

- Naming superposition and faunal succession is correct but not required.
...
- Applying the lower-is-older rule to a visibly overturned sequence without accounting for it.
- Claiming strata order gives an age in years directly.
- Claiming a gap in the record means no time passed there.

**Grade boundary.** Formal stratigraphic nomenclature and sequence stratigraphy are High School work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for rock strata and fossils, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of rock strata and fossils.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about rock strata and fossils using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for rock strata and fossils, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of rock strata and fossils.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for rock strata and fossils, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of rock strata and fossils.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for rock strata and fossils, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for rock strata and fossils works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of rock strata and fossils, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking rock strata and fossils mastered.
...
_Package `swp-ma-g8-science-u05-l08` · built from `canonical-1.0.0` at `4056e31`._
