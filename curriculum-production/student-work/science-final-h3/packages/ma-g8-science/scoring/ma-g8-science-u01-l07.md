# Scoring authority — Investigation or close reading: Newton’s laws at middle-school level

**Grade 8 Science** · Unit 1: Forces, Motion, and Interactions · Day 7 · lesson `ma-g8-science-u01-l07`
...
_Topic `ma-g8-science-u01::Newton’s laws at middle-school level` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- An object's motion changes only when a net force acts on it.
- Forces come in pairs: when object A pushes on object B, B pushes back on A with equal strength in the opposite direction.

**Accepted relationships and models.** What this lesson's learning target asserts:

- An object at rest stays at rest, and an object in motion keeps the same speed and direction, unless a net force acts on it.
- A net force changes an object's motion, and for a given force a more massive object changes motion less.
- Forces always act in pairs between two objects, equal in size and opposite in direction, and the two forces act on different objects.

**Also correct.** Accept any of these framings — do not require the wording above:

- Naming the laws by number, or describing them in plain terms, are both correct; the numbering is not required.
...
- Claiming a force is needed to keep an object moving at constant velocity.
- Claiming the two forces of an interaction pair act on the same object and therefore cancel.
- Claiming a heavier object always pushes harder than a lighter one it collides with.

**Grade boundary.** Vector decomposition, quantitative F equals ma problems, and frames of reference are High School work; correct use of them is not an error.
...
**Q1 — analyze evidence.** _Serves objective 1:_ Gather and analyze evidence related to Newton’s laws at middle-school level, then record a defensible interpretation.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of Newton’s laws at middle-school level.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about Newton’s laws at middle-school level using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Gather and analyze evidence related to Newton’s laws at middle-school level, then record a defensible interpretation.
...
**Q5 — evidence quality.** _Serves objective 1:_ Gather and analyze evidence related to Newton’s laws at middle-school level, then record a defensible interpretation.
...
**Q6 — limitation.** _Serves objective 1:_ Gather and analyze evidence related to Newton’s laws at middle-school level, then record a defensible interpretation.
...
**Q7 — provenance.** _Serves objective 1:_ Gather and analyze evidence related to Newton’s laws at middle-school level, then record a defensible interpretation.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for Newton’s laws at middle-school level, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for Newton’s laws at middle-school level works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of Newton’s laws at middle-school level, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking Newton’s laws at middle-school level mastered.
...
_Package `swp-ma-g8-science-u01-l07` · built from `canonical-1.0.0` at `4056e31`._
