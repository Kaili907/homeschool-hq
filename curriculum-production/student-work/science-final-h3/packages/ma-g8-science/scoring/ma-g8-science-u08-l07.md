# Scoring authority — Investigation or close reading: biodiversity

**Grade 8 Science** · Unit 8: Applied Biology and Ecosystem Design · Day 7 · lesson `ma-g8-science-u08-l07`
...
_Topic `ma-g8-science-u08::biodiversity` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Biodiversity includes the variety of species, the genetic variety within species, and the variety of ecosystems.
- Greater genetic variety within a population generally makes it better able to withstand disease and environmental change.
- Biodiversity is measured by counting and comparing, so the measurement method and the area covered determine what the number means.

**Also correct.** Accept any of these framings — do not require the wording above:

- Species richness and species diversity are both legitimate measures; they are not the same measure.
...
- Treating biodiversity as species count alone.
- Comparing biodiversity figures measured over different areas or by different methods as though they were equivalent.
- Claiming genetic variety within a species has no bearing on its resilience.

**Grade boundary.** Diversity indices and rarefaction are High School work.
...
**Q1 — analyze evidence.** _Serves objective 1:_ Gather and analyze evidence related to biodiversity, then record a defensible interpretation.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of biodiversity.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about biodiversity using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Gather and analyze evidence related to biodiversity, then record a defensible interpretation.
...
**Q5 — evidence quality.** _Serves objective 1:_ Gather and analyze evidence related to biodiversity, then record a defensible interpretation.
...
**Q6 — limitation.** _Serves objective 1:_ Gather and analyze evidence related to biodiversity, then record a defensible interpretation.
...
**Q7 — provenance.** _Serves objective 1:_ Gather and analyze evidence related to biodiversity, then record a defensible interpretation.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for biodiversity, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for biodiversity works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of biodiversity, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking biodiversity mastered.
...
_Package `swp-ma-g8-science-u08-l07` · built from `canonical-1.0.0` at `4056e31`._
