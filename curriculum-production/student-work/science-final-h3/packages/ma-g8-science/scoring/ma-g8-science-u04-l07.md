# Scoring authority — Investigation or close reading: fossil evidence

**Grade 8 Science** · Unit 4: Natural Selection and Adaptation · Day 7 · lesson `ma-g8-science-u04-l07`
...
_Topic `ma-g8-science-u04::fossil evidence` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- The fossil record shows that the kinds of organisms on Earth have changed over time and that many are now extinct.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Fossils in successive rock layers show that the organisms living on Earth have changed over long spans of time.
- The order in which groups appear in the record is consistent worldwide, which is why the record is evidence about history rather than local accident.
- The fossil record is incomplete because fossilisation is rare, so absence of a fossil is weak evidence of absence of the organism.
...
- Claiming the fossil record contains every organism that has lived.
- Claiming all fossils formed at the same time.
- Claiming an organism turned into another kind of organism during its own lifetime.

**Grade boundary.** Cladistics, transitional-form analysis, and taphonomy are High School work.
...
**Q1 — analyze evidence.** _Serves objective 1:_ Gather and analyze evidence related to fossil evidence, then record a defensible interpretation.
...
**Q4 — essential question.** _Serves objective 1:_ Gather and analyze evidence related to fossil evidence, then record a defensible interpretation.
...
**Q5 — evidence quality.** _Serves objective 1:_ Gather and analyze evidence related to fossil evidence, then record a defensible interpretation.
...
**Q6 — limitation.** _Serves objective 1:_ Gather and analyze evidence related to fossil evidence, then record a defensible interpretation.
...
**Q7 — provenance.** _Serves objective 1:_ Gather and analyze evidence related to fossil evidence, then record a defensible interpretation.
...
_Package `swp-ma-g8-science-u04-l07` · built from `canonical-1.0.0` at `4056e31`._
