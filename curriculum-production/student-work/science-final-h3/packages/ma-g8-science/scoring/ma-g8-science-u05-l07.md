# Scoring authority — Investigation or close reading: geologic time

**Grade 8 Science** · Unit 5: Earth History and Geologic Processes · Day 7 · lesson `ma-g8-science-u05-l07`
...
_Topic `ma-g8-science-u05::geologic time` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._
...
- Earth's history spans billions of years, and most of it took place before organisms with hard parts existed.
- Geologic time is divided into named intervals whose boundaries are marked by major changes in the rock and fossil record.
- Relative dating orders events; radiometric dating supplies ages in years, and the two are used together.

**Also correct.** Accept any of these framings — do not require the wording above:

- Approximate statements such as 'about four and a half billion years' are correct; an exact figure is not required.
...
- Claiming Earth is thousands rather than billions of years old.
- Claiming humans have existed for a substantial fraction of Earth's history.
- Claiming relative dating gives ages in years.

**Grade boundary.** Isotope decay equations and calibration of the geologic timescale are High School work.
...
**Q1 — analyze evidence.** _Serves objective 1:_ Gather and analyze evidence related to geologic time, then record a defensible interpretation.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of geologic time.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about geologic time using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Gather and analyze evidence related to geologic time, then record a defensible interpretation.
...
**Q5 — evidence quality.** _Serves objective 1:_ Gather and analyze evidence related to geologic time, then record a defensible interpretation.
...
**Q6 — limitation.** _Serves objective 1:_ Gather and analyze evidence related to geologic time, then record a defensible interpretation.
...
**Q7 — provenance.** _Serves objective 1:_ Gather and analyze evidence related to geologic time, then record a defensible interpretation.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for geologic time, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for geologic time works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of geologic time, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking geologic time mastered.
...
_Package `swp-ma-g8-science-u05-l07` · built from `canonical-1.0.0` at `4056e31`._
