# Scoring authority — Investigation or close reading: wave amplitude wavelength and energy

**Grade 8 Science** · Unit 2: Waves and Information Transfer · Day 7 · lesson `ma-g8-science-u02-l07`
...
**Q1 — analyze evidence.** _Serves objective 1:_ Gather and analyze evidence related to wave amplitude wavelength and energy, then record a defensible interpretation.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of wave amplitude wavelength and energy.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about wave amplitude wavelength and energy using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Gather and analyze evidence related to wave amplitude wavelength and energy, then record a defensible interpretation.
...
**Q5 — evidence quality.** _Serves objective 1:_ Gather and analyze evidence related to wave amplitude wavelength and energy, then record a defensible interpretation.
...
**Q6 — limitation.** _Serves objective 1:_ Gather and analyze evidence related to wave amplitude wavelength and energy, then record a defensible interpretation.
...
**Q7 — provenance.** _Serves objective 1:_ Gather and analyze evidence related to wave amplitude wavelength and energy, then record a defensible interpretation.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for wave amplitude wavelength and energy, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for wave amplitude wavelength and energy works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of wave amplitude wavelength and energy, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking wave amplitude wavelength and energy mastered.
...
_Package `swp-ma-g8-science-u02-l07` · built from `canonical-1.0.0` at `4056e31`._
