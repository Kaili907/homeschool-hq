# Scoring authority — Reteach and varied practice: criteria constraints and stakeholders

**Grade 8 Science** · Unit 9: Engineering and Scientific Argument Capstone · Day 8 · lesson `ma-g8-science-u09-l08`
...
_Topic `ma-g8-science-u09::criteria constraints and stakeholders` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Criteria say what a solution must achieve; constraints say what limits it must respect; stakeholders are those affected by either.
- Different stakeholders often value the criteria differently, and that disagreement is part of the problem rather than noise.
- Safety and legal constraints are not traded against performance.
...
- Assuming all stakeholders share the same priorities.
- Trading away a safety constraint for better performance.

**Grade boundary.** Formal stakeholder analysis methods are later work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for criteria constraints and stakeholders, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of criteria constraints and stakeholders.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about criteria constraints and stakeholders using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for criteria constraints and stakeholders, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of criteria constraints and stakeholders.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for criteria constraints and stakeholders, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of criteria constraints and stakeholders.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for criteria constraints and stakeholders, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for criteria constraints and stakeholders works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of criteria constraints and stakeholders, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking criteria constraints and stakeholders mastered.
...
_Package `swp-ma-g8-science-u09-l08` · built from `canonical-1.0.0` at `4056e31`._
