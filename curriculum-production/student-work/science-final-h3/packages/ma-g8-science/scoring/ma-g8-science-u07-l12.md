# Scoring authority — Correction and reflection: environmental justice foundations

**Grade 8 Science** · Unit 7: Resources, Climate, and Human Systems · Day 12 · lesson `ma-g8-science-u07-l12`
...
_Topic `ma-g8-science-u07::environmental justice foundations` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Environmental burdens and benefits are not distributed evenly across communities, and the pattern is documented rather than assumed.
- Who is exposed, who decides, and who benefits are separate questions, and a full account addresses all three.
- Evidence about distribution comes from data on exposure, health, and access, not from assertion.
...
- Claiming environmental burdens fall equally on all communities.
- Treating who is affected as outside the scope of the scientific evidence.
- Making a distributional claim with no data behind it.

**Grade boundary.** Policy analysis and formal equity frameworks are High School work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for environmental justice foundations, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of environmental justice foundations.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about environmental justice foundations using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for environmental justice foundations, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of environmental justice foundations.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for environmental justice foundations, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of environmental justice foundations.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for environmental justice foundations, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for environmental justice foundations works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of environmental justice foundations, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking environmental justice foundations mastered.
...
_Package `swp-ma-g8-science-u07-l12` · built from `canonical-1.0.0` at `4056e31`._
