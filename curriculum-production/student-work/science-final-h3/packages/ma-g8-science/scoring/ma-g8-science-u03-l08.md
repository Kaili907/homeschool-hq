# Scoring authority — Reteach and varied practice: genes chromosomes and traits

**Grade 8 Science** · Unit 3: Growth, Reproduction, and Heredity · Day 8 · lesson `ma-g8-science-u03-l08`
...
_Topic `ma-g8-science-u03::genes chromosomes and traits` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Genes are segments of DNA located on chromosomes, and they carry the instructions for proteins that affect traits.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Chromosomes carry genes, and genes are lengths of DNA that code for proteins.
- Proteins carry out and regulate the processes that produce an organism's traits, which is why a change in a gene can change a trait.
- Offspring receive one set of chromosomes from each parent in sexual reproduction, which is why they show a combination of parental traits.

**Also correct.** Accept any of these framings — do not require the wording above:

- Describing genes as instructions or as coding for proteins are both acceptable at this grade.
...
- Claiming a gene is a trait rather than an instruction that influences one.
- Claiming every trait is controlled by exactly one gene.
- Claiming chromosomes are made of protein rather than of DNA and protein.

**Grade boundary.** Transcription and translation in detail, and gene regulation, are High School work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for genes chromosomes and traits, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of genes chromosomes and traits.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about genes chromosomes and traits using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for genes chromosomes and traits, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of genes chromosomes and traits.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for genes chromosomes and traits, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of genes chromosomes and traits.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for genes chromosomes and traits, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for genes chromosomes and traits works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of genes chromosomes and traits, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking genes chromosomes and traits mastered.
...
_Package `swp-ma-g8-science-u03-l08` · built from `canonical-1.0.0` at `4056e31`._
