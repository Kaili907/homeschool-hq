# Scoring authority — Guided practice B: model limitations

**Grade 8 Science** · Unit 2: Waves and Information Transfer · Day 6 · lesson `ma-g8-science-u02-l06`
...
**Q1 — guided practice.** _Serves objective 1:_ Practice model limitations with prompts, feedback, and gradually reduced support.
...
**Q4 — essential question.** _Serves objective 1:_ Practice model limitations with prompts, feedback, and gradually reduced support.
...
**Q6 — limitation.** _Serves objective 1:_ Practice model limitations with prompts, feedback, and gradually reduced support.
...
_Package `swp-ma-g8-science-u02-l06` · built from `canonical-1.0.0` at `4056e31`._
