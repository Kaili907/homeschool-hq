...
**Grade 8 Science** · Unit 9: Engineering and Scientific Argument Capstone · Day 11 · lesson `ma-g8-science-u09-l11`
...
_Topic `ma-g8-science-u09::optimization` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Optimisation improves performance against stated criteria within stated constraints; it does not improve everything at once.
- An optimum depends on the criteria and their relative importance, so different priorities give different optima.
- A solution optimised past a constraint is not a solution.
...
- Reporting an optimum with no statement of the criteria it optimises.
- Violating a constraint in pursuit of a better criterion score.

**Grade boundary.** Mathematical optimisation techniques are later work.
...
_Package `swp-ma-g8-science-u09-l11` · built from `canonical-1.0.0` at `4056e31`._
