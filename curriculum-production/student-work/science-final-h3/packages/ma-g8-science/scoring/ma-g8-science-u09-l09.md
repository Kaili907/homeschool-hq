# Scoring authority — Performance task build: data-driven comparison

**Grade 8 Science** · Unit 9: Engineering and Scientific Argument Capstone · Day 9 · lesson `ma-g8-science-u09-l09`
...
_Topic `ma-g8-science-u09::data-driven comparison` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Comparing solutions requires the same measurements under the same conditions for each option.
- A difference smaller than the variation between repeated trials is not evidence that one option is better.
- The comparison reports every criterion evaluated, including those where the preferred option performs badly.
...
- Comparing options tested under different conditions.
- Claiming a difference is real when it is smaller than the trial-to-trial variation.
- Omitting a criterion where the preferred option performed poorly.

**Grade boundary.** Statistical significance testing is High School work.
...
**Q1 — build product.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies data-driven comparison and the unit standards.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of data-driven comparison.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about data-driven comparison using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies data-driven comparison and the unit standards.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of data-driven comparison.
...
**Q6 — limitation.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies data-driven comparison and the unit standards.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of data-driven comparison.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for data-driven comparison, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for data-driven comparison works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of data-driven comparison, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking data-driven comparison mastered.
...
_Package `swp-ma-g8-science-u09-l09` · built from `canonical-1.0.0` at `4056e31`._
