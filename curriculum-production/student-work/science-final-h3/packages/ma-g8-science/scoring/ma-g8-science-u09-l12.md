# Scoring authority — Correction and reflection: scientific argument and communication

**Grade 8 Science** · Unit 9: Engineering and Scientific Argument Capstone · Day 12 · lesson `ma-g8-science-u09-l12`
...
_Topic `ma-g8-science-u09::scientific argument and communication` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A scientific argument states a claim, presents evidence, and gives explicit reasoning linking the two.
- The strongest opposing evidence or interpretation is presented and addressed rather than omitted.
- The argument reaches only as far as the evidence, and it says where that limit falls.

**Also correct.** Accept any of these framings — do not require the wording above:

- Claim-evidence-reasoning structure, and a written argument that carries the same three elements without the labels, are equally acceptable.
...
- Presenting claim and evidence with no reasoning between them.
- Omitting evidence that counts against the claim.
- Stating a conclusion more strongly than the evidence supports.

**Grade boundary.** Formal argumentation theory and peer review process are later work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for scientific argument and communication, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of scientific argument and communication.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about scientific argument and communication using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for scientific argument and communication, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of scientific argument and communication.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for scientific argument and communication, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of scientific argument and communication.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for scientific argument and communication, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for scientific argument and communication works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of scientific argument and communication, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking scientific argument and communication mastered.
...
_Package `swp-ma-g8-science-u09-l12` · built from `canonical-1.0.0` at `4056e31`._
