# Scoring authority — Performance task build: mutations

**Grade 8 Science** · Unit 3: Growth, Reproduction, and Heredity · Day 9 · lesson `ma-g8-science-u03-l09`
...
_Topic `ma-g8-science-u03::mutations` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- A mutation is a change in the DNA sequence, and it may be harmful, beneficial, or have no noticeable effect.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Mutations are changes to the genetic material and can arise from copying errors or from environmental agents.
- A mutation's effect depends on where it occurs and what it changes; most have no noticeable effect on the organism.
- Only mutations in cells that produce offspring can be inherited.
...
- Claiming mutations occur because an organism needs a particular change.
- Claiming a mutation in a body cell will be passed to the organism's offspring.

**Grade boundary.** Mutation types by name, repair mechanisms, and mutation rates are High School work.
...
**Q1 — build product.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies mutations and the unit standards.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of mutations.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about mutations using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies mutations and the unit standards.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of mutations.
...
**Q6 — limitation.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies mutations and the unit standards.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of mutations.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for mutations, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for mutations works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of mutations, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking mutations mastered.
...
_Package `swp-ma-g8-science-u03-l09` · built from `canonical-1.0.0` at `4056e31`._
