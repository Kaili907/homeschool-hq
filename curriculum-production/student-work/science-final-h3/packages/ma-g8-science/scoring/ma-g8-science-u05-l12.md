# Scoring authority — Correction and reflection: evidence for past change

**Grade 8 Science** · Unit 5: Earth History and Geologic Processes · Day 12 · lesson `ma-g8-science-u05-l12`
...
_Topic `ma-g8-science-u05::evidence for past change` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Conclusions about Earth's past rest on several independent lines of evidence agreeing: rock type, structure, fossils, and dating.
- Present-day processes are used to interpret past ones, because the same physical and chemical processes operated then.
- A conclusion about the past is provisional and is revised when new evidence requires it.

**Also correct.** Accept any of these framings — do not require the wording above:

- Naming the assumption uniformitarianism is correct but not required.
...
- Drawing a conclusion about the past from one line of evidence and presenting it as settled.
- Claiming past processes must have been different in kind from those observed today, without evidence.
- Treating a well-supported reconstruction as unrevisable.

**Grade boundary.** Formal palaeoenvironmental proxy analysis is High School work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for evidence for past change, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of evidence for past change.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about evidence for past change using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for evidence for past change, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of evidence for past change.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for evidence for past change, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of evidence for past change.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for evidence for past change, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for evidence for past change works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of evidence for past change, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking evidence for past change mastered.
...
_Package `swp-ma-g8-science-u05-l12` · built from `canonical-1.0.0` at `4056e31`._
