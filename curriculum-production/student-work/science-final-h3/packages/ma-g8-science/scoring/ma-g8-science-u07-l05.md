# Scoring authority — Concept model B: mitigation adaptation and tradeoffs

**Grade 8 Science** · Unit 7: Resources, Climate, and Human Systems · Day 5 · lesson `ma-g8-science-u07-l05`
...
**Q1 — model build.** _Serves objective 1:_ Build a clear mental model of mitigation adaptation and tradeoffs through an explicit worked example, demonstration, text, or phenomenon.
...
**Q4 — essential question.** _Serves objective 1:_ Build a clear mental model of mitigation adaptation and tradeoffs through an explicit worked example, demonstration, text, or phenomenon.
...
**Q6 — limitation.** _Serves objective 1:_ Build a clear mental model of mitigation adaptation and tradeoffs through an explicit worked example, demonstration, text, or phenomenon.
...
_Package `swp-ma-g8-science-u07-l05` · built from `canonical-1.0.0` at `4056e31`._
