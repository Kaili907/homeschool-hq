# Scoring authority — Concept model A: lunar phases and eclipses

**Grade 8 Science** · Unit 6: Earth, Moon, Sun, and the Solar System · Day 2 · lesson `ma-g8-science-u06-l02`
...
**Q1 — model build.** _Serves objective 1:_ Build a clear mental model of lunar phases and eclipses through an explicit worked example, demonstration, text, or phenomenon.
...
**Q4 — essential question.** _Serves objective 1:_ Build a clear mental model of lunar phases and eclipses through an explicit worked example, demonstration, text, or phenomenon.
...
**Q6 — limitation.** _Serves objective 1:_ Build a clear mental model of lunar phases and eclipses through an explicit worked example, demonstration, text, or phenomenon.
...
_Package `swp-ma-g8-science-u06-l02` · built from `canonical-1.0.0` at `4056e31`._
