# Scoring authority — Concept model B: communication technologies

**Grade 8 Science** · Unit 2: Waves and Information Transfer · Day 5 · lesson `ma-g8-science-u02-l05`
...
**Q1 — model build.** _Serves objective 1:_ Build a clear mental model of communication technologies through an explicit worked example, demonstration, text, or phenomenon.
...
**Q4 — essential question.** _Serves objective 1:_ Build a clear mental model of communication technologies through an explicit worked example, demonstration, text, or phenomenon.
...
**Q6 — limitation.** _Serves objective 1:_ Build a clear mental model of communication technologies through an explicit worked example, demonstration, text, or phenomenon.
...
_Package `swp-ma-g8-science-u02-l05` · built from `canonical-1.0.0` at `4056e31`._
