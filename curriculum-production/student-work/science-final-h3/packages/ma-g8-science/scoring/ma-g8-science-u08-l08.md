# Scoring authority — Reteach and varied practice: ecosystem services

**Grade 8 Science** · Unit 8: Applied Biology and Ecosystem Design · Day 8 · lesson `ma-g8-science-u08-l08`
...
_Topic `ma-g8-science-u08::ecosystem services` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Ecosystems supply people with services such as pollination, water filtration, flood control, soil formation, and climate regulation.
- These services depend on the organisms and processes present, so losing them can remove the service.
- A service can often be replaced by engineering only at far greater cost, and sometimes not at all.
...
- Claiming ecosystem services are free in the sense of requiring nothing to sustain them.
- Claiming every ecosystem service can be replaced by technology.
- Claiming a service continues unchanged after the organisms providing it are removed.

**Grade boundary.** Valuation methods and natural capital accounting are High School work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for ecosystem services, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of ecosystem services.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about ecosystem services using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for ecosystem services, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of ecosystem services.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for ecosystem services, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of ecosystem services.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for ecosystem services, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for ecosystem services works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of ecosystem services, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking ecosystem services mastered.
...
_Package `swp-ma-g8-science-u08-l08` · built from `canonical-1.0.0` at `4056e31`._
