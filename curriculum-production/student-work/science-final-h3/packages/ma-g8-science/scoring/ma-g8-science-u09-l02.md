# Scoring authority — Concept model A: criteria constraints and stakeholders

**Grade 8 Science** · Unit 9: Engineering and Scientific Argument Capstone · Day 2 · lesson `ma-g8-science-u09-l02`
...
**Q1 — model build.** _Serves objective 1:_ Build a clear mental model of criteria constraints and stakeholders through an explicit worked example, demonstration, text, or phenomenon.
...
**Q4 — essential question.** _Serves objective 1:_ Build a clear mental model of criteria constraints and stakeholders through an explicit worked example, demonstration, text, or phenomenon.
...
**Q6 — limitation.** _Serves objective 1:_ Build a clear mental model of criteria constraints and stakeholders through an explicit worked example, demonstration, text, or phenomenon.
...
_Package `swp-ma-g8-science-u09-l02` · built from `canonical-1.0.0` at `4056e31`._
