# Scoring authority — Launch and diagnostic: geologic time

**Grade 8 Science** · Unit 5: Earth History and Geologic Processes · Day 1 · lesson `ma-g8-science-u05-l01`
...
_Topic `ma-g8-science-u05::geologic time` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._
...
**Q1 — activate prior.** _Serves objective 1:_ Activate prior knowledge about geologic time, surface initial thinking without penalty, and establish the unit question.
...
**Q4 — essential question.** _Serves objective 1:_ Activate prior knowledge about geologic time, surface initial thinking without penalty, and establish the unit question.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of geologic time.
...
**Q6 — limitation.** _Serves objective 1:_ Activate prior knowledge about geologic time, surface initial thinking without penalty, and establish the unit question.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of geologic time.
...
_Package `swp-ma-g8-science-u05-l01` · built from `canonical-1.0.0` at `4056e31`._
