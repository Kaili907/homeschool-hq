# Scoring authority — Investigation or close reading: problem definition

**Grade 8 Science** · Unit 9: Engineering and Scientific Argument Capstone · Day 7 · lesson `ma-g8-science-u09-l07`
...
_Topic `ma-g8-science-u09::problem definition` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A well-defined problem states what needs to change, for whom, and how success would be recognised.
- Defining the problem precedes generating solutions, so that solutions are not smuggled into the definition.
- A problem statement that names a solution has already foreclosed the design work.
...
- Writing a problem statement that names the intended solution.
- Defining success in terms nothing could measure.
- Omitting who is affected from the problem definition.
...
**Q1 — analyze evidence.** _Serves objective 1:_ Gather and analyze evidence related to problem definition, then record a defensible interpretation.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of problem definition.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about problem definition using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Gather and analyze evidence related to problem definition, then record a defensible interpretation.
...
**Q5 — evidence quality.** _Serves objective 1:_ Gather and analyze evidence related to problem definition, then record a defensible interpretation.
...
**Q6 — limitation.** _Serves objective 1:_ Gather and analyze evidence related to problem definition, then record a defensible interpretation.
...
**Q7 — provenance.** _Serves objective 1:_ Gather and analyze evidence related to problem definition, then record a defensible interpretation.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for problem definition, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for problem definition works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of problem definition, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking problem definition mastered.
...
_Package `swp-ma-g8-science-u09-l07` · built from `canonical-1.0.0` at `4056e31`._
