# Scoring authority — Synthesis and review: variation

**Grade 8 Science** · Unit 4: Natural Selection and Adaptation · Day 10 · lesson `ma-g8-science-u04-l10`
...
_Topic `ma-g8-science-u04::variation` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Variation among individuals in a population arises from mutation and, in sexually reproducing species, from the recombination of parental genetic material.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Individuals in a population differ in heritable traits, and that variation exists before any environmental pressure acts.
- Variation arises from mutation and, in sexual reproduction, from new combinations of parental genes.
- Without heritable variation there is nothing for natural selection to act on.
...
- Claiming variation arises in response to what the population needs.
- Claiming all members of a species are essentially identical.
- Claiming variation appears only after the environment changes.

**Grade boundary.** Population genetics and allele frequency calculation are High School work.


## What a complete response contains, question by question

**Q1 — connect unit.** _Serves objective 1:_ Connect variation to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of variation.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about variation using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Connect variation to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of variation.
...
**Q6 — limitation.** _Serves objective 1:_ Connect variation to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of variation.
...
- The learner completes the central task about variation.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for variation, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for variation works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of variation, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking variation mastered.
...
_Package `swp-ma-g8-science-u04-l10` · built from `canonical-1.0.0` at `4056e31`._
