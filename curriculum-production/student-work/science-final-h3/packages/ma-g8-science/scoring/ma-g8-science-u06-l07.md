# Scoring authority — Investigation or close reading: seasons

**Grade 8 Science** · Unit 6: Earth, Moon, Sun, and the Solar System · Day 7 · lesson `ma-g8-science-u06-l07`
...
_Topic `ma-g8-science-u06::seasons` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Seasons are caused by the tilt of Earth's rotation axis relative to its orbit, not by changes in Earth's distance from the Sun.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Earth's axis is tilted relative to its orbital plane and keeps the same orientation in space as Earth orbits the Sun.
- Because of the tilt, each hemisphere receives sunlight at a more direct angle and for longer each day during its summer.
- The two hemispheres therefore have opposite seasons at the same time of year.

**Also correct.** Accept any of these framings — do not require the wording above:

- Explaining the effect through the angle of incoming sunlight, through day length, or through both, are all correct; both effects operate.
...
- Claiming seasons are caused by Earth being closer to the Sun in summer.
- Claiming Earth's axis tilts back and forth through the year.
- Claiming both hemispheres experience summer at the same time.

**Grade boundary.** Solar declination calculations, insolation formulas, and Milankovitch cycles are High School work.
...
**Q1 — analyze evidence.** _Serves objective 1:_ Gather and analyze evidence related to seasons, then record a defensible interpretation.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of seasons.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about seasons using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Gather and analyze evidence related to seasons, then record a defensible interpretation.
...
**Q5 — evidence quality.** _Serves objective 1:_ Gather and analyze evidence related to seasons, then record a defensible interpretation.
...
**Q6 — limitation.** _Serves objective 1:_ Gather and analyze evidence related to seasons, then record a defensible interpretation.
...
**Q7 — provenance.** _Serves objective 1:_ Gather and analyze evidence related to seasons, then record a defensible interpretation.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for seasons, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for seasons works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of seasons, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking seasons mastered.
...
_Package `swp-ma-g8-science-u06-l07` · built from `canonical-1.0.0` at `4056e31`._
