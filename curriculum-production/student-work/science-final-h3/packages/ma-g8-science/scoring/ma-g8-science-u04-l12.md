# Scoring authority — Correction and reflection: population change over generations

**Grade 8 Science** · Unit 4: Natural Selection and Adaptation · Day 12 · lesson `ma-g8-science-u04-l12`
...
_Topic `ma-g8-science-u04::population change over generations` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Evolution is a change in the traits of a population across generations, measured in the population and not in individuals.
- The rate of change depends on how strong the selection is, how much heritable variation exists, and how quickly generations turn over.
- A trait that is advantageous in one environment can become disadvantageous when the environment changes.
...
- Describing evolution as change within an individual organism.
- Claiming evolution always produces more complex organisms.
- Claiming a population changes instantly in response to a new environment.

**Grade boundary.** Quantitative evolutionary rates and phylogenetic dating are High School work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for population change over generations, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of population change over generations.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about population change over generations using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for population change over generations, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of population change over generations.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for population change over generations, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of population change over generations.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for population change over generations, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for population change over generations works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of population change over generations, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking population change over generations mastered.
...
_Package `swp-ma-g8-science-u04-l12` · built from `canonical-1.0.0` at `4056e31`._
