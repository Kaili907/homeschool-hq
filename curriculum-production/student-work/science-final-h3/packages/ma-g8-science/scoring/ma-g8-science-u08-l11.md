# Scoring authority — Unit assessment: solution impacts

**Grade 8 Science** · Unit 8: Applied Biology and Ecosystem Design · Day 11 · lesson `ma-g8-science-u08-l11`
...
_Topic `ma-g8-science-u08::solution impacts` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- An intervention in an ecosystem has effects beyond its target, because the parts of an ecosystem are connected.
- Effects can appear at a distance in space or after a delay in time, so an immediate local check is not sufficient evidence.
- Monitoring after the intervention is what turns an expected effect into an observed one.
...
- Declaring an intervention successful from an immediate local observation alone.
- Proposing an intervention with no plan to check its effects.

**Grade boundary.** Environmental impact assessment procedure is High School work.


## What a complete response contains, question by question

**Q1 — demonstrate mastery.** _Serves objective 1:_ Demonstrate current mastery of solution impacts through selected-response, constructed-response, and applied evidence.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of solution impacts.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about solution impacts using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Demonstrate current mastery of solution impacts through selected-response, constructed-response, and applied evidence.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of solution impacts.
...
**Q6 — limitation.** _Serves objective 1:_ Demonstrate current mastery of solution impacts through selected-response, constructed-response, and applied evidence.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of solution impacts.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for solution impacts, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for solution impacts works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of solution impacts, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking solution impacts mastered.
...
_Package `swp-ma-g8-science-u08-l11` · built from `canonical-1.0.0` at `4056e31`._
