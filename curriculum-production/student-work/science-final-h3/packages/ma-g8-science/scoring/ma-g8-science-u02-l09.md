# Scoring authority — Performance task build: light and sound models

**Grade 8 Science** · Unit 2: Waves and Information Transfer · Day 9 · lesson `ma-g8-science-u02-l09`
...
_Topic `ma-g8-science-u02::light and sound models` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._
...
- Sound is a mechanical wave: it is a vibration passing through matter and cannot travel through a vacuum.
- Light is an electromagnetic wave and travels through a vacuum, which is how sunlight reaches Earth.
- Both carry energy and both reflect, absorb, and transmit at boundaries, which is why the wave model is useful for each.

**Also correct.** Accept any of these framings — do not require the wording above:

- Describing light as a wave, or noting that it also has particle-like behaviour, are both acceptable; the wave model is what is required here.
...
- Claiming sound travels through space.
- Claiming light needs a medium to travel through.
- Claiming sound and light travel at the same speed.

**Grade boundary.** Wave-particle duality, photons, and the electromagnetic spectrum in detail are High School work.
...
**Q1 — build product.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies light and sound models and the unit standards.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of light and sound models.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about light and sound models using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies light and sound models and the unit standards.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of light and sound models.
...
**Q6 — limitation.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies light and sound models and the unit standards.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of light and sound models.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for light and sound models, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for light and sound models works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of light and sound models, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking light and sound models mastered.
...
_Package `swp-ma-g8-science-u02-l09` · built from `canonical-1.0.0` at `4056e31`._
