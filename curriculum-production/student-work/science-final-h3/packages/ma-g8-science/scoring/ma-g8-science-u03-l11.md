# Scoring authority — Unit assessment: environment and trait expression

**Grade 8 Science** · Unit 3: Growth, Reproduction, and Heredity · Day 11 · lesson `ma-g8-science-u03-l11`
...
_Topic `ma-g8-science-u03::environment and trait expression` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g8-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Many traits result from both genetic instructions and environmental conditions.
- Two organisms with the same genetic instructions can differ if they develop in different environments.
- An environmentally caused change in an individual is not passed on through the genetic material.
...
- Claiming every trait is determined by genes alone.
- Claiming a change caused by the environment during an organism's life is inherited by its offspring.
- Claiming the environment has no role in any trait.

**Grade boundary.** Epigenetics and heritability statistics are High School work.


## What a complete response contains, question by question

**Q1 — demonstrate mastery.** _Serves objective 1:_ Demonstrate current mastery of environment and trait expression through selected-response, constructed-response, and applied evidence.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of environment and trait expression.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about environment and trait expression using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Demonstrate current mastery of environment and trait expression through selected-response, constructed-response, and applied evidence.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of environment and trait expression.
...
**Q6 — limitation.** _Serves objective 1:_ Demonstrate current mastery of environment and trait expression through selected-response, constructed-response, and applied evidence.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of environment and trait expression.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for environment and trait expression, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for environment and trait expression works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of environment and trait expression, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking environment and trait expression mastered.
...
_Package `swp-ma-g8-science-u03-l11` · built from `canonical-1.0.0` at `4056e31`._
