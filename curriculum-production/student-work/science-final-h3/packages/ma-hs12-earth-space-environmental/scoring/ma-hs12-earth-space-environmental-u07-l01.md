# Scoring authority — Launch and diagnostic: energy flow into and out of Earth systems

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 7: Climate, Energy Flow, and the Carbon Cycle · Day 1 · lesson `ma-hs12-earth-space-environmental-u07-l01`
...
**Q1 — phenomenon question.** _Serves objective 1:_ Observe the anchoring phenomenon, surface initial thinking about energy flow into and out of Earth systems without penalty, and pose a testable question.
...
**Q7 — limitation.** _Serves objective 3:_ Apply energy flow into and out of Earth systems to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q8 — provenance.** _Serves objective 1:_ Observe the anchoring phenomenon, surface initial thinking about energy flow into and out of Earth systems without penalty, and pose a testable question.
...
_Package `swp-ma-hs12-earth-space-environmental-u07-l01` · built from `hs912-science-h3` at `e7551b9`._
