# Scoring authority — Unit assessment: composition of matter in the universe

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 3: Cosmology and the Evidence for the Big Bang · Day 11 · lesson `ma-hs12-earth-space-environmental-u03-l11`
...
_Topic `ma-hs12-earth-space-environmental-u03::composition of matter in the universe` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs12-earth-space-environmental.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Ordinary matter in the universe is overwhelmingly hydrogen and helium, in a ratio close to three to one by mass.

**Accepted relationships and models.** What this lesson's learning target asserts:

- The observed hydrogen and helium proportions match what a hot early universe predicts, which is an independent line of evidence for the model.
- All elements heavier than helium together make up only a small fraction of ordinary matter.
- Ordinary matter itself accounts for a minority of the universe's total mass and energy content, with dark matter and dark energy making up the rest.

**Also correct.** Accept any of these framings — do not require the wording above:

- Approximate proportions such as 'about three quarters hydrogen' are correct; exact figures are not required.
...
- Claiming heavy elements make up a large fraction of the universe's ordinary matter.
- Claiming the elemental proportions were produced entirely in stars.
- Claiming ordinary matter accounts for most of the universe's mass and energy.

**Grade boundary.** Big Bang nucleosynthesis calculations and dark matter detection methods are beyond this course.
...
**Q1 — mastery fresh task.** _Serves objective 1:_ Demonstrate independent mastery evidence for composition of matter in the universe on a fresh task.
...
**Q2 — explain with evidence.** _Serves objective 2:_ Explain composition of matter in the universe using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q3 — apply new task.** _Serves objective 3:_ Apply composition of matter in the universe to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q4 — check revise next step.** _Serves objective 4:_ Check and revise the work on composition of matter in the universe against the stated success criteria and name the next step.
...
**Q5 — essential question.** _Serves objective 3:_ Apply composition of matter in the universe to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q6 — evidence quality.** _Serves objective 2:_ Explain composition of matter in the universe using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q7 — limitation.** _Serves objective 3:_ Apply composition of matter in the universe to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q8 — provenance.** _Serves objective 1:_ Demonstrate independent mastery evidence for composition of matter in the universe on a fresh task.
...
- **prerequisite-gap** — Run the prerequisite reteach route for composition of matter in the universe (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for composition of matter in the universe (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for composition of matter in the universe (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for composition of matter in the universe (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for composition of matter in the universe (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs12-earth-space-environmental-u03-l11` · built from `hs912-science-h3` at `e7551b9`._
