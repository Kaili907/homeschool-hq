# Scoring authority — Unit assessment: human alteration of surface processes

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 6: Surface Processes, Water, and Earth System Feedbacks · Day 11 · lesson `ma-hs12-earth-space-environmental-u06-l11`
...
_Topic `ma-hs12-earth-space-environmental-u06::human alteration of surface processes` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs12-earth-space-environmental.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Land clearing, agriculture, construction, damming, and channel modification change rates of erosion, deposition, infiltration, and runoff.
- Altering one part of a surface system changes others, often downstream or after a delay.
- Human activity now moves more sediment and earth material annually than many natural processes do.
...
- Claiming a local land-use change has only local effects.
- Claiming human effects on surface processes are negligible compared with natural ones.
- Claiming an engineered channel or dam removes flood risk rather than altering it.

**Grade boundary.** Sediment budget quantification and hydrological modelling are beyond this course.
...
**Q1 — mastery fresh task.** _Serves objective 1:_ Demonstrate independent mastery evidence for human alteration of surface processes on a fresh task.
...
**Q2 — explain with evidence.** _Serves objective 2:_ Explain human alteration of surface processes using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q3 — apply new task.** _Serves objective 3:_ Apply human alteration of surface processes to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q4 — check revise next step.** _Serves objective 4:_ Check and revise the work on human alteration of surface processes against the stated success criteria and name the next step.
...
**Q5 — essential question.** _Serves objective 3:_ Apply human alteration of surface processes to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q6 — evidence quality.** _Serves objective 2:_ Explain human alteration of surface processes using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q7 — limitation.** _Serves objective 3:_ Apply human alteration of surface processes to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q8 — provenance.** _Serves objective 1:_ Demonstrate independent mastery evidence for human alteration of surface processes on a fresh task.
...
- **prerequisite-gap** — Run the prerequisite reteach route for human alteration of surface processes (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for human alteration of surface processes (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for human alteration of surface processes (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for human alteration of surface processes (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for human alteration of surface processes (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs12-earth-space-environmental-u06-l11` · built from `hs912-science-h3` at `e7551b9`._
