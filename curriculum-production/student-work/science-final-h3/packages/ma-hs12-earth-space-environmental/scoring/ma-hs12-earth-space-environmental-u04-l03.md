# Scoring authority — Guided practice A: orbital period and radius

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 4: Orbital Motion and the Solar System · Day 3 · lesson `ma-hs12-earth-space-environmental-u04-l03`
...
_Topic `ma-hs12-earth-space-environmental-u04::orbital period and radius` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs12-earth-space-environmental.correctness.json`._
...
**Q1 — explain with evidence.** _Serves objective 1:_ Explain orbital period and radius using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q2 — apply new task.** _Serves objective 2:_ Apply orbital period and radius to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q3 — check revise next step.** _Serves objective 3:_ Check and revise the work on orbital period and radius against the stated success criteria and name the next step.
...
**Q4 — essential question.** _Serves objective 2:_ Apply orbital period and radius to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q5 — evidence quality.** _Serves objective 1:_ Explain orbital period and radius using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q6 — limitation.** _Serves objective 2:_ Apply orbital period and radius to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q7 — provenance.** _Serves objective 1:_ Explain orbital period and radius using evidence, a model, or a documented process rather than an unsupported answer.
...
_Package `swp-ma-hs12-earth-space-environmental-u04-l03` · built from `hs912-science-h3` at `e7551b9`._
