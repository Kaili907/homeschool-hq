# Scoring authority — Reteach and varied practice: the special properties of water

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 6: Surface Processes, Water, and Earth System Feedbacks · Day 8 · lesson `ma-hs12-earth-space-environmental-u06-l08`
...
_Topic `ma-hs12-earth-space-environmental-u06::the special properties of water` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs12-earth-space-environmental.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Water expands on freezing, so ice is less dense than liquid water and floats.
- Water has an unusually high specific heat capacity and a high heat of vaporisation.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Water's polarity and its hydrogen bonding account for its high specific heat, high heat of vaporisation, high surface tension, and its capacity to dissolve many substances.
- Ice floating means lakes freeze from the top down, insulating the water beneath and allowing aquatic life to survive winter.
- Water's high specific heat moderates the climate near large water bodies and makes the ocean a large thermal reservoir.
...
- Claiming water's anomalous properties arise from something other than its polarity and hydrogen bonding.
- Claiming water dissolves all substances equally well.

**Grade boundary.** Quantitative thermodynamic properties and solvation modelling are beyond this course.
...
**Q1 — explain with evidence.** _Serves objective 1:_ Explain the special properties of water using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q2 — apply new task.** _Serves objective 2:_ Apply the special properties of water to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q3 — check revise next step.** _Serves objective 3:_ Check and revise the work on the special properties of water against the stated success criteria and name the next step.
...
**Q4 — essential question.** _Serves objective 2:_ Apply the special properties of water to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q5 — evidence quality.** _Serves objective 1:_ Explain the special properties of water using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q6 — limitation.** _Serves objective 2:_ Apply the special properties of water to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q7 — provenance.** _Serves objective 1:_ Explain the special properties of water using evidence, a model, or a documented process rather than an unsupported answer.
...
- **prerequisite-gap** — Run the prerequisite reteach route for the special properties of water (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for the special properties of water (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for the special properties of water (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for the special properties of water (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for the special properties of water (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs12-earth-space-environmental-u06-l08` · built from `hs912-science-h3` at `e7551b9`._
