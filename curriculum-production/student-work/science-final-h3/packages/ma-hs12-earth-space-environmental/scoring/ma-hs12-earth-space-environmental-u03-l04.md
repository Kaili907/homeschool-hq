# Scoring authority — Independent application A: cosmic microwave background

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 3: Cosmology and the Evidence for the Big Bang · Day 4 · lesson `ma-hs12-earth-space-environmental-u03-l04`
...
_Topic `ma-hs12-earth-space-environmental-u03::cosmic microwave background` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs12-earth-space-environmental.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- The cosmic microwave background is faint radiation reaching Earth from every direction, with a spectrum matching a body at about 2.7 kelvin.

**Accepted relationships and models.** What this lesson's learning target asserts:

- The background radiation is light released when the early universe first became transparent, stretched to microwave wavelengths by the expansion since.
- Its near-uniformity across the sky, with small measured variations, is a strong constraint on models of the early universe.
- It was predicted before it was detected, which is why its discovery was decisive evidence.
...
- Claiming the background radiation comes from a particular direction or source in the sky.
- Claiming the background is perfectly uniform with no variations; the small variations are themselves key evidence.
- Claiming the background is light currently emitted by distant galaxies.

**Grade boundary.** Power spectrum analysis and cosmological parameter fitting are beyond this course.
...
**Q1 — explain with evidence.** _Serves objective 1:_ Explain cosmic microwave background using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q2 — apply new task.** _Serves objective 2:_ Apply cosmic microwave background to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q3 — check revise next step.** _Serves objective 3:_ Check and revise the work on cosmic microwave background against the stated success criteria and name the next step.
...
**Q4 — essential question.** _Serves objective 2:_ Apply cosmic microwave background to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q5 — evidence quality.** _Serves objective 1:_ Explain cosmic microwave background using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q6 — limitation.** _Serves objective 2:_ Apply cosmic microwave background to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q7 — provenance.** _Serves objective 1:_ Explain cosmic microwave background using evidence, a model, or a documented process rather than an unsupported answer.
...
- **prerequisite-gap** — Run the prerequisite reteach route for cosmic microwave background (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for cosmic microwave background (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for cosmic microwave background (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for cosmic microwave background (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for cosmic microwave background (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs12-earth-space-environmental-u03-l04` · built from `hs912-science-h3` at `e7551b9`._
