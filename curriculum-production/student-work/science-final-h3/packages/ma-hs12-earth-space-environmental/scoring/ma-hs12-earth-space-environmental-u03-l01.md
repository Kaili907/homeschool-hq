# Scoring authority — Launch and diagnostic: light spectra and redshift

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 3: Cosmology and the Evidence for the Big Bang · Day 1 · lesson `ma-hs12-earth-space-environmental-u03-l01`
...
_Topic `ma-hs12-earth-space-environmental-u03::light spectra and redshift` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs12-earth-space-environmental.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Redshift is a shift of spectral lines toward longer wavelengths; blueshift is a shift toward shorter wavelengths.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Redshift is identified by the whole characteristic line pattern of an element being displaced, which is what distinguishes it from an object simply being red.
- Cosmological redshift arises because space itself has expanded while the light was in transit, stretching its wavelength.
- Measuring the shift of known line patterns is how the recession of distant galaxies is determined.

**Also correct.** Accept any of these framings — do not require the wording above:

- Describing cosmological redshift as expansion of space, and the Doppler analogy as an approximation for nearby objects, are both acceptable.
...
- Claiming a red-looking star is redshifted for that reason.
- Claiming cosmological redshift means galaxies are moving through space away from a central point.
- Claiming redshift shortens wavelengths.

**Grade boundary.** Relativistic Doppler formulas and scale-factor cosmology are beyond this course.
...
> Published galaxy redshift and distance measurements the family retrieves. The learner fits the relationship themselves; no expansion rate is supplied.


## What a complete response contains, question by question

**Q1 — phenomenon question.** _Serves objective 1:_ Observe the anchoring phenomenon, surface initial thinking about light spectra and redshift without penalty, and pose a testable question.
...
**Q2 — explain with evidence.** _Serves objective 2:_ Explain light spectra and redshift using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q3 — apply new task.** _Serves objective 3:_ Apply light spectra and redshift to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q4 — check revise next step.** _Serves objective 4:_ Check and revise the work on light spectra and redshift against the stated success criteria and name the next step.
...
**Q5 — essential question.** _Serves objective 3:_ Apply light spectra and redshift to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q6 — evidence quality.** _Serves objective 2:_ Explain light spectra and redshift using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q7 — limitation.** _Serves objective 3:_ Apply light spectra and redshift to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q8 — provenance.** _Serves objective 1:_ Observe the anchoring phenomenon, surface initial thinking about light spectra and redshift without penalty, and pose a testable question.
...
- **prerequisite-gap** — Run the prerequisite reteach route for light spectra and redshift (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for light spectra and redshift (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for light spectra and redshift (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for light spectra and redshift (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for light spectra and redshift (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs12-earth-space-environmental-u03-l01` · built from `hs912-science-h3` at `e7551b9`._
