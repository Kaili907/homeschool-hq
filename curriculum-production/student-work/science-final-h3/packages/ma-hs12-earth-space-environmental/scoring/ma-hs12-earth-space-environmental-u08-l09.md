# Scoring authority — Performance task build: distribution of natural resources

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 8: Coevolution of Earth and Life, Resources, and Natural Hazards · Day 9 · lesson `ma-hs12-earth-space-environmental-u08-l09`
...
_Topic `ma-hs12-earth-space-environmental-u08::distribution of natural resources` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs12-earth-space-environmental.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Mineral, energy, water, and soil resources are distributed unevenly because of the specific geological and biological processes that concentrated them.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Ore deposits form where particular processes concentrated an element far above its average crustal abundance.
- Fossil fuels formed where organic material accumulated, was buried, and was heated within a particular range of conditions.
- A resource is economically usable only where concentration, accessibility, and extraction cost permit, so the physical presence of an element is not sufficient.
...
- Claiming resource distribution is random or a matter of chance.
- Claiming an element's presence in the crust makes it available as a resource.
- Claiming resource distribution follows political boundaries.

**Grade boundary.** Ore genesis models and reserve estimation methodology are beyond this course.
...
**Q1 — performance evidence.** _Serves objective 1:_ Produce performance-task evidence for distribution of natural resources that a reader could check independently.
...
**Q2 — explain with evidence.** _Serves objective 2:_ Explain distribution of natural resources using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q3 — apply new task.** _Serves objective 3:_ Apply distribution of natural resources to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q4 — check revise next step.** _Serves objective 4:_ Check and revise the work on distribution of natural resources against the stated success criteria and name the next step.
...
**Q5 — essential question.** _Serves objective 3:_ Apply distribution of natural resources to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q6 — evidence quality.** _Serves objective 2:_ Explain distribution of natural resources using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q7 — limitation.** _Serves objective 3:_ Apply distribution of natural resources to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q8 — provenance.** _Serves objective 1:_ Produce performance-task evidence for distribution of natural resources that a reader could check independently.
...
- **prerequisite-gap** — Run the prerequisite reteach route for distribution of natural resources (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for distribution of natural resources (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for distribution of natural resources (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for distribution of natural resources (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for distribution of natural resources (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs12-earth-space-environmental-u08-l09` · built from `hs912-science-h3` at `e7551b9`._
