# Scoring authority — Correction and reflection: constructing arguments from geologic and biological evidence

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 8: Coevolution of Earth and Life, Resources, and Natural Hazards · Day 12 · lesson `ma-hs12-earth-space-environmental-u08-l12`
...
_Topic `ma-hs12-earth-space-environmental-u08::constructing arguments from geologic and biological evidence` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs12-earth-space-environmental.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- An argument about Earth history links a claim to specific geologic and biological evidence through explicit reasoning about process.
- Because controlled experiments on Earth history are impossible, arguments rest on multiple independent lines of evidence converging.
- An argument states which parts of the claim the evidence establishes and which remain open.
...
- Presenting a single line of evidence as establishing a claim about Earth history.
- Omitting evidence that does not fit the proposed reconstruction.
- Treating the impossibility of controlled experiment as grounds for treating any reconstruction as equally supported.

**Grade boundary.** Formal historical-science methodology is beyond this course.
...
**Q1 — explain with evidence.** _Serves objective 1:_ Explain constructing arguments from geologic and biological evidence using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q2 — apply new task.** _Serves objective 2:_ Apply constructing arguments from geologic and biological evidence to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q3 — check revise next step.** _Serves objective 3:_ Check and revise the work on constructing arguments from geologic and biological evidence against the stated success criteria and name the next step.
...
**Q4 — essential question.** _Serves objective 2:_ Apply constructing arguments from geologic and biological evidence to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q5 — evidence quality.** _Serves objective 1:_ Explain constructing arguments from geologic and biological evidence using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q6 — limitation.** _Serves objective 2:_ Apply constructing arguments from geologic and biological evidence to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q7 — provenance.** _Serves objective 1:_ Explain constructing arguments from geologic and biological evidence using evidence, a model, or a documented process rather than an unsupported answer.
...
- **prerequisite-gap** — Run the prerequisite reteach route for constructing arguments from geologic and biological evidence (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for constructing arguments from geologic and biological evidence (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for constructing arguments from geologic and biological evidence (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for constructing arguments from geologic and biological evidence (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for constructing arguments from geologic and biological evidence (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs12-earth-space-environmental-u08-l12` · built from `hs912-science-h3` at `e7551b9`._
