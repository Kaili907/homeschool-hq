# Scoring authority — Independent application A: nucleosynthesis and element formation

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 2: The Sun, Stars, and the Origin of the Elements · Day 4 · lesson `ma-hs12-earth-space-environmental-u02-l04`
...
_Topic `ma-hs12-earth-space-environmental-u02::nucleosynthesis and element formation` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs12-earth-space-environmental.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Hydrogen and helium formed in the early universe; elements up to iron are produced by fusion in stars; most elements heavier than iron are produced by neutron capture in evolved stars and in explosive events.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Fusion releases energy up to iron, and beyond iron fusion consumes rather than releases energy, which is why stellar fusion does not build the heaviest elements.
- Heavier elements are dispersed into space by stellar winds and supernovae, enriching the material from which later stars and planets form.
- The atoms in Earth and in living things were produced in earlier generations of stars.

**Also correct.** Accept any of these framings — do not require the wording above:

- Naming the s-process and r-process, or describing neutron capture in general terms, are equally correct.
...
- Claiming all elements were produced in the Big Bang.
- Claiming stellar core fusion produces elements heavier than iron by releasing energy.
- Claiming heavy elements formed on Earth rather than being inherited from earlier stars.

**Grade boundary.** Nuclear reaction network modelling and isotopic yield calculations are beyond this course.
...
**Q1 — explain with evidence.** _Serves objective 1:_ Explain nucleosynthesis and element formation using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q2 — apply new task.** _Serves objective 2:_ Apply nucleosynthesis and element formation to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q3 — check revise next step.** _Serves objective 3:_ Check and revise the work on nucleosynthesis and element formation against the stated success criteria and name the next step.
...
**Q4 — essential question.** _Serves objective 2:_ Apply nucleosynthesis and element formation to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q5 — evidence quality.** _Serves objective 1:_ Explain nucleosynthesis and element formation using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q6 — limitation.** _Serves objective 2:_ Apply nucleosynthesis and element formation to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q7 — provenance.** _Serves objective 1:_ Explain nucleosynthesis and element formation using evidence, a model, or a documented process rather than an unsupported answer.
...
- **prerequisite-gap** — Run the prerequisite reteach route for nucleosynthesis and element formation (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for nucleosynthesis and element formation (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for nucleosynthesis and element formation (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for nucleosynthesis and element formation (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for nucleosynthesis and element formation (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs12-earth-space-environmental-u02-l04` · built from `hs912-science-h3` at `e7551b9`._
