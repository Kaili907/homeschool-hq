# Scoring authority — Guided practice A: distribution of natural resources

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 8: Coevolution of Earth and Life, Resources, and Natural Hazards · Day 3 · lesson `ma-hs12-earth-space-environmental-u08-l03`
...
**Q1 — explain with evidence.** _Serves objective 1:_ Explain distribution of natural resources using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q2 — apply new task.** _Serves objective 2:_ Apply distribution of natural resources to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q3 — check revise next step.** _Serves objective 3:_ Check and revise the work on distribution of natural resources against the stated success criteria and name the next step.
...
**Q4 — essential question.** _Serves objective 2:_ Apply distribution of natural resources to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q5 — evidence quality.** _Serves objective 1:_ Explain distribution of natural resources using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q6 — limitation.** _Serves objective 2:_ Apply distribution of natural resources to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q7 — provenance.** _Serves objective 1:_ Explain distribution of natural resources using evidence, a model, or a documented process rather than an unsupported answer.
...
_Package `swp-ma-hs12-earth-space-environmental-u08-l03` · built from `hs912-science-h3` at `e7551b9`._
