# Scoring authority — Investigation: weathering and erosion

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 6: Surface Processes, Water, and Earth System Feedbacks · Day 7 · lesson `ma-hs12-earth-space-environmental-u06-l07`
...
_Topic `ma-hs12-earth-space-environmental-u06::weathering and erosion` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs12-earth-space-environmental.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Weathering breaks rock down in place; erosion transports the products; deposition lays them down elsewhere.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Physical weathering fragments rock without changing its composition; chemical weathering alters the minerals themselves.
- Rates depend on climate, rock type, slope, and vegetation cover, so they vary greatly between settings.
- Chemical weathering of silicate rock consumes atmospheric carbon dioxide, linking surface processes to the long-term carbon cycle.

**Also correct.** Accept any of these framings — do not require the wording above:

- Physical and mechanical weathering are the same category.
...
- Claiming chemical weathering rates are independent of climate.
- Claiming weathering rates are uniform across all rock types and settings.

**Grade boundary.** Quantitative weathering flux calculation is beyond this course.
...
**Q1 — investigate.** _Serves objective 1:_ Plan and carry out a safe investigation of weathering and erosion, or its stated alternative, and record the learner's own data with its uncertainty.
...
**Q2 — explain with evidence.** _Serves objective 2:_ Explain weathering and erosion using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q3 — apply new task.** _Serves objective 3:_ Apply weathering and erosion to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q4 — check revise next step.** _Serves objective 4:_ Check and revise the work on weathering and erosion against the stated success criteria and name the next step.
...
**Q5 — essential question.** _Serves objective 3:_ Apply weathering and erosion to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q6 — evidence quality.** _Serves objective 2:_ Explain weathering and erosion using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q7 — limitation.** _Serves objective 1:_ Plan and carry out a safe investigation of weathering and erosion, or its stated alternative, and record the learner's own data with its uncertainty.
...
**Q8 — provenance.** _Serves objective 1:_ Plan and carry out a safe investigation of weathering and erosion, or its stated alternative, and record the learner's own data with its uncertainty.
...
- **prerequisite-gap** — Run the prerequisite reteach route for weathering and erosion (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for weathering and erosion (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for weathering and erosion (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for weathering and erosion (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for weathering and erosion (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs12-earth-space-environmental-u06-l07` · built from `hs912-science-h3` at `e7551b9`._
