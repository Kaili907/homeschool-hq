# Scoring authority — Performance task build: surface water and groundwater systems

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 6: Surface Processes, Water, and Earth System Feedbacks · Day 9 · lesson `ma-hs12-earth-space-environmental-u06-l09`
...
_Topic `ma-hs12-earth-space-environmental-u06::surface water and groundwater systems` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs12-earth-space-environmental.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Groundwater occupies pore spaces and fractures in rock and sediment; it does not generally flow in open underground rivers.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Surface water and groundwater are connected: streams gain from or lose to groundwater depending on the water table.
- Groundwater moves far more slowly than surface water, so contamination is slow to appear and slow to clear.
- Extraction faster than recharge lowers the water table and can cause land subsidence and saltwater intrusion.
...
- Claiming groundwater flows in underground rivers throughout the subsurface.
- Claiming surface water and groundwater are independent supplies.
- Claiming an aquifer refills as quickly as it is pumped.

**Grade boundary.** Darcy's law calculation and aquifer modelling are beyond this course.
...
**Q1 — performance evidence.** _Serves objective 1:_ Produce performance-task evidence for surface water and groundwater systems that a reader could check independently.
...
**Q2 — explain with evidence.** _Serves objective 2:_ Explain surface water and groundwater systems using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q3 — apply new task.** _Serves objective 3:_ Apply surface water and groundwater systems to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q4 — check revise next step.** _Serves objective 4:_ Check and revise the work on surface water and groundwater systems against the stated success criteria and name the next step.
...
**Q5 — essential question.** _Serves objective 3:_ Apply surface water and groundwater systems to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q6 — evidence quality.** _Serves objective 2:_ Explain surface water and groundwater systems using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q7 — limitation.** _Serves objective 3:_ Apply surface water and groundwater systems to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q8 — provenance.** _Serves objective 1:_ Produce performance-task evidence for surface water and groundwater systems that a reader could check independently.
...
- **prerequisite-gap** — Run the prerequisite reteach route for surface water and groundwater systems (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for surface water and groundwater systems (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for surface water and groundwater systems (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for surface water and groundwater systems (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for surface water and groundwater systems (evidence type: application, require explanation: True, review timing: same-day).
...
- physical: Soil and outdoor materials carry bacteria and sharp fragments. — mitigation: Cover any cut or graze with a waterproof dressing before handling soil, wear gloves, keep hands away from the face, wash thoroughly afterwards, and never use soil from an area treated with pesticide or near a roadway.
- physical: Soil on kitchen equipment contaminates everything used with it afterwards. — mitigation: The trays, cups, and measuring container are labelled for this investigation and never return to food use. Nothing from this investigation is washed in a kitchen sink.
- physical: Water and soil together make surfaces slippery, and soil runoff blocks indoor drain traps. — mitigation: Work outdoors or over a large tray, clean spills immediately, and pour all runoff outdoors onto ground or through a strainer into an outdoor drain - never down a kitchen or bathroom sink.
- privacy: Photographing or logging a field site can reveal where the family lives. — mitigation: Record substrate type, slope, and conditions only. No address, GPS coordinate, or identifiable landmark is recorded, and no photograph is required.
...
_Package `swp-ma-hs12-earth-space-environmental-u06-l09` · built from `hs912-science-h3` at `e7551b9`._
