# Scoring authority — Guided practice A: proxy data and indirect evidence

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 1: Earth and Space Systems, Scale, and Data Practice · Day 3 · lesson `ma-hs12-earth-space-environmental-u01-l03`
...
**Q1 — explain with evidence.** _Serves objective 1:_ Explain proxy data and indirect evidence using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q2 — apply new task.** _Serves objective 2:_ Apply proxy data and indirect evidence to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q3 — check revise next step.** _Serves objective 3:_ Check and revise the work on proxy data and indirect evidence against the stated success criteria and name the next step.
...
**Q4 — essential question.** _Serves objective 2:_ Apply proxy data and indirect evidence to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q5 — evidence quality.** _Serves objective 1:_ Explain proxy data and indirect evidence using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q6 — limitation.** _Serves objective 2:_ Apply proxy data and indirect evidence to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q7 — provenance.** _Serves objective 1:_ Explain proxy data and indirect evidence using evidence, a model, or a documented process rather than an unsupported answer.
...
_Package `swp-ma-hs12-earth-space-environmental-u01-l03` · built from `hs912-science-h3` at `e7551b9`._
