# Scoring authority — Unit assessment: reading and building graphs honestly

**High School Earth, Space, and Environmental Science (Grade 12)** · Unit 1: Earth and Space Systems, Scale, and Data Practice · Day 11 · lesson `ma-hs12-earth-space-environmental-u01-l11`
...
_Topic `ma-hs12-earth-space-environmental-u01::reading and building graphs honestly` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs12-earth-space-environmental.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Axis range, scale type, and baseline choice change how a graph reads without changing the underlying data.
- A graph states its data source, its date, and its units, or the reader cannot check it.
- Extrapolation beyond the data is labelled as such, because the data does not support it.

**Also correct.** Accept any of these framings — do not require the wording above:

- Linear and logarithmic scales are both legitimate; the choice is disclosed and justified by what needs to be shown.
...
- Presenting an extrapolation as though it were measured data.
- Choosing an axis range or baseline that conceals or exaggerates the effect being discussed, without disclosure.
- Drawing a conclusion from a graph with no source, units, or date given.

**Grade boundary.** Formal data visualisation theory is beyond this course.
...
**Q1 — mastery fresh task.** _Serves objective 1:_ Demonstrate independent mastery evidence for reading and building graphs honestly on a fresh task.
...
**Q2 — explain with evidence.** _Serves objective 2:_ Explain reading and building graphs honestly using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q3 — apply new task.** _Serves objective 3:_ Apply reading and building graphs honestly to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q4 — check revise next step.** _Serves objective 4:_ Check and revise the work on reading and building graphs honestly against the stated success criteria and name the next step.
...
**Q5 — essential question.** _Serves objective 3:_ Apply reading and building graphs honestly to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q6 — evidence quality.** _Serves objective 2:_ Explain reading and building graphs honestly using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q7 — limitation.** _Serves objective 3:_ Apply reading and building graphs honestly to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q8 — provenance.** _Serves objective 1:_ Demonstrate independent mastery evidence for reading and building graphs honestly on a fresh task.
...
- **prerequisite-gap** — Run the prerequisite reteach route for reading and building graphs honestly (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for reading and building graphs honestly (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for reading and building graphs honestly (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for reading and building graphs honestly (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for reading and building graphs honestly (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs12-earth-space-environmental-u01-l11` · built from `hs912-science-h3` at `e7551b9`._
