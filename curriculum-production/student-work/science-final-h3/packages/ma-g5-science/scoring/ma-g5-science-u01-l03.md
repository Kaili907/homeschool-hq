...
**Grade 5 Science** · Unit 1: Science and Engineering Practices · Day 3 · lesson `ma-g5-science-u01-l03`
...
_Topic `ma-g5-science-u01::models and diagrams` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._
...
_Package `swp-ma-g5-science-u01-l03` · built from `canonical-1.0.0` at `4056e31`._
