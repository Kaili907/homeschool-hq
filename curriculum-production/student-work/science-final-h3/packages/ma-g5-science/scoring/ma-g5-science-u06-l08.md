# Scoring authority — Reteach and varied practice: water distribution

**Grade 5 Science** · Unit 6: Earth Systems and Water · Day 8 · lesson `ma-g5-science-u06-l08`
...
_Topic `ma-g5-science-u06::water distribution` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- About 97 per cent of Earth's water is salt water in the ocean.
- Of the small fresh-water fraction, most is frozen in glaciers and ice caps, and only a small part is liquid fresh water available at the surface or underground.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Almost all of Earth's water is salt water in the ocean; fresh water is a small fraction of the total.
- Most fresh water is frozen in glaciers and ice sheets rather than available as liquid.
- Liquid fresh water is unevenly distributed across Earth, which is why availability differs so much between regions.

**Also correct.** Accept any of these framings — do not require the wording above:

- Approximate figures such as 'about 97 per cent' or 'nearly all' are both acceptable; exact percentages are not required.
...
- Claiming most of Earth's water is fresh.
- Claiming most fresh water is in lakes and rivers.
- Claiming fresh water is evenly available everywhere on Earth.

**Grade boundary.** Reservoir residence times and quantitative water budgets are High School work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for water distribution, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of water distribution.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about water distribution using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for water distribution, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of water distribution.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for water distribution, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of water distribution.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for water distribution, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for water distribution works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of water distribution, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking water distribution mastered.
...
_Package `swp-ma-g5-science-u06-l08` · built from `canonical-1.0.0` at `4056e31`._
