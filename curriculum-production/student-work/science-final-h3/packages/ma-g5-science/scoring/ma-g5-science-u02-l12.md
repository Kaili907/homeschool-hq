# Scoring authority — Correction and reflection: measurement precision

**Grade 5 Science** · Unit 2: Properties of Matter · Day 12 · lesson `ma-g5-science-u02-l12`
...
_Topic `ma-g5-science-u02::measurement precision` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A measuring tool can only resolve differences down to its smallest division; smaller differences than that are not measured, they are guessed.
- Repeating a measurement and getting similar values shows the method is reproducible.
- Precision is about how closely repeated measurements agree; being close together is not the same as being right.
...
- Reporting a measurement to more places than the tool can resolve.
- Claiming precise measurements must be accurate.
- Discarding a value that disagrees, without recording that it was discarded and why.

**Grade boundary.** Significant figures, standard deviation, and formal uncertainty are Grade 7 and later work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for measurement precision, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of measurement precision.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about measurement precision using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for measurement precision, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of measurement precision.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for measurement precision, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of measurement precision.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for measurement precision, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for measurement precision works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of measurement precision, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking measurement precision mastered.
...
_Package `swp-ma-g5-science-u02-l12` · built from `canonical-1.0.0` at `4056e31`._
