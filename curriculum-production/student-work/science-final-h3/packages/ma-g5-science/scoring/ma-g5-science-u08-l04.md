# Scoring authority — Independent application A: community tradeoffs

**Grade 5 Science** · Unit 8: Human Impact and Environmental Decisions · Day 4 · lesson `ma-g5-science-u08-l04`
...
**Q1 — apply independent.** _Serves objective 1:_ Apply community tradeoffs independently in a new representation, text, situation, or design constraint.
...
**Q4 — essential question.** _Serves objective 1:_ Apply community tradeoffs independently in a new representation, text, situation, or design constraint.
...
**Q6 — limitation.** _Serves objective 1:_ Apply community tradeoffs independently in a new representation, text, situation, or design constraint.
...
_Package `swp-ma-g5-science-u08-l04` · built from `canonical-1.0.0` at `4056e31`._
