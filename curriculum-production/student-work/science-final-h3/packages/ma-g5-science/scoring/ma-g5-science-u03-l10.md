# Scoring authority — Synthesis and review: conservation of mass

**Grade 5 Science** · Unit 3: Changes and Conservation of Matter · Day 10 · lesson `ma-g5-science-u03-l10`
...
_Topic `ma-g5-science-u03::conservation of mass` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- In any physical or chemical change, the total mass of the substances is the same before and after.

**Accepted relationships and models.** What this lesson's learning target asserts:

- The total mass of matter is the same before and after a change, whether physical or chemical.
- Mass that appears to be lost has usually left the container as a gas, and mass that appears to be gained has usually entered it from the air.
- Testing conservation of mass requires a closed system, or an accounting of everything that entered or left.

**Also correct.** Accept any of these framings — do not require the wording above:

- Saying matter is conserved, or that atoms are neither created nor destroyed, are both correct.
...
- Claiming mass is destroyed when a substance burns or dissolves.
- Claiming mass is created when a solid forms from two solutions.
- Concluding mass was not conserved from an open-container measurement without accounting for what entered or left.

**Grade boundary.** Stoichiometry, the mole, and mass-energy equivalence are High School work.


## What a complete response contains, question by question

**Q1 — connect unit.** _Serves objective 1:_ Connect conservation of mass to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of conservation of mass.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about conservation of mass using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Connect conservation of mass to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of conservation of mass.
...
**Q6 — limitation.** _Serves objective 1:_ Connect conservation of mass to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of conservation of mass.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for conservation of mass, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for conservation of mass works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of conservation of mass, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking conservation of mass mastered.
...
_Package `swp-ma-g5-science-u03-l10` · built from `canonical-1.0.0` at `4056e31`._
