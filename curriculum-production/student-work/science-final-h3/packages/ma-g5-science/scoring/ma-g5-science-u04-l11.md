# Scoring authority — Unit assessment: motion observations

**Grade 5 Science** · Unit 4: Energy in Food and Motion · Day 11 · lesson `ma-g5-science-u04-l11`
...
_Topic `ma-g5-science-u04::motion observations` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Motion is described relative to something else, so the reference point is stated.
- Observing motion means recording position at stated times, not only whether something moved.
- Patterns in recorded motion support predictions about motion under the same conditions.
...
- Describing motion with no reference point stated.
- Reporting that an object moved without saying over what time or distance.
- Predicting motion for conditions the observations never covered.

**Grade boundary.** Velocity as a vector, acceleration, and motion graphs are Grade 8 and High School work.


## What a complete response contains, question by question

**Q1 — demonstrate mastery.** _Serves objective 1:_ Demonstrate current mastery of motion observations through selected-response, constructed-response, and applied evidence.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of motion observations.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about motion observations using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Demonstrate current mastery of motion observations through selected-response, constructed-response, and applied evidence.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of motion observations.
...
**Q6 — limitation.** _Serves objective 1:_ Demonstrate current mastery of motion observations through selected-response, constructed-response, and applied evidence.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of motion observations.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for motion observations, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for motion observations works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of motion observations, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking motion observations mastered.
...
_Package `swp-ma-g5-science-u04-l11` · built from `canonical-1.0.0` at `4056e31`._
