# Scoring authority — Investigation or close reading: physical changes

**Grade 5 Science** · Unit 3: Changes and Conservation of Matter · Day 7 · lesson `ma-g5-science-u03-l07`
...
_Topic `ma-g5-science-u03::physical changes` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._
...
- A physical change alters the form, state, or appearance of a substance without producing a new substance.
- Melting, freezing, boiling, evaporating, dissolving, breaking, and bending are physical changes.
- The total mass does not change during a physical change, even when the material seems to disappear.
...
- Claiming that melting or boiling turns a substance into a different substance.
- Claiming mass is lost when a liquid evaporates from an open container, rather than that the vapour has left the container.
- Claiming a change is physical because it can be reversed and chemical because it cannot; reversibility is a clue, not the definition.

**Grade boundary.** Phase-change energy, latent heat, and particle-level state diagrams are Grade 7 and later work.
...
**Q1 — analyze evidence.** _Serves objective 1:_ Gather and analyze evidence related to physical changes, then record a defensible interpretation.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of physical changes.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about physical changes using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Gather and analyze evidence related to physical changes, then record a defensible interpretation.
...
**Q5 — evidence quality.** _Serves objective 1:_ Gather and analyze evidence related to physical changes, then record a defensible interpretation.
...
**Q6 — limitation.** _Serves objective 1:_ Gather and analyze evidence related to physical changes, then record a defensible interpretation.
...
**Q7 — provenance.** _Serves objective 1:_ Gather and analyze evidence related to physical changes, then record a defensible interpretation.
...
- The learner completes the central task about physical changes.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for physical changes, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for physical changes works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of physical changes, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking physical changes mastered.
...
_Package `swp-ma-g5-science-u03-l07` · built from `canonical-1.0.0` at `4056e31`._
