# Scoring authority — Investigation or close reading: observable phenomena

**Grade 5 Science** · Unit 1: Science and Engineering Practices · Day 7 · lesson `ma-g5-science-u01-l07`
...
_Topic `ma-g5-science-u01::observable phenomena` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A phenomenon is something that happens in the world and can be observed; science starts from phenomena rather than from definitions.
- An observation reports what happened; an explanation says why, and the two are recorded separately.
- A phenomenon worth investigating usually contains something that does not fit what the observer expected.

**Also correct.** Accept any of these framings — do not require the wording above:

- Qualitative and quantitative observations are both observations; neither is required to be present.
...
- Recording an explanation in the observation column.
- Treating a personal opinion about a phenomenon as data.
- Claiming a phenomenon must be unusual or dramatic to be worth investigating.

**Grade boundary.** Formal uncertainty analysis and instrument calibration are later grades.
...
**Q1 — analyze evidence.** _Serves objective 1:_ Gather and analyze evidence related to observable phenomena, then record a defensible interpretation.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of observable phenomena.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about observable phenomena using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Gather and analyze evidence related to observable phenomena, then record a defensible interpretation.
...
**Q5 — evidence quality.** _Serves objective 1:_ Gather and analyze evidence related to observable phenomena, then record a defensible interpretation.
...
**Q6 — limitation.** _Serves objective 1:_ Gather and analyze evidence related to observable phenomena, then record a defensible interpretation.
...
**Q7 — provenance.** _Serves objective 1:_ Gather and analyze evidence related to observable phenomena, then record a defensible interpretation.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for observable phenomena, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for observable phenomena works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of observable phenomena, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking observable phenomena mastered.
...
_Package `swp-ma-g5-science-u01-l07` · built from `canonical-1.0.0` at `4056e31`._
