# Scoring authority — Synthesis and review: community tradeoffs

**Grade 5 Science** · Unit 8: Human Impact and Environmental Decisions · Day 10 · lesson `ma-g5-science-u08-l10`
...
_Topic `ma-g5-science-u08::community tradeoffs` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Environmental decisions involve trade-offs: a benefit for one group or one goal often comes with a cost to another.
- Who bears the cost and who receives the benefit are part of the evidence, not a separate question.
- A decision that ignores a trade-off has not removed it.
...
- Presenting a solution as having benefits and no costs.
- Claiming everyone in a community is affected equally by a decision.
- Treating a trade-off as settled by preference rather than by evidence about effects.

**Grade boundary.** Formal cost-benefit analysis and policy frameworks are later work.


## What a complete response contains, question by question

**Q1 — connect unit.** _Serves objective 1:_ Connect community tradeoffs to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of community tradeoffs.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about community tradeoffs using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Connect community tradeoffs to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of community tradeoffs.
...
**Q6 — limitation.** _Serves objective 1:_ Connect community tradeoffs to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of community tradeoffs.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for community tradeoffs, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for community tradeoffs works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of community tradeoffs, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking community tradeoffs mastered.
...
_Package `swp-ma-g5-science-u08-l10` · built from `canonical-1.0.0` at `4056e31`._
