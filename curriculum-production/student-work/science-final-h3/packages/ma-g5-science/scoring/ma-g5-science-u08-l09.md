# Scoring authority — Performance task build: conservation strategies

**Grade 5 Science** · Unit 8: Human Impact and Environmental Decisions · Day 9 · lesson `ma-g5-science-u08-l09`
...
_Topic `ma-g5-science-u08::conservation strategies` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Conservation strategies reduce use, reuse materials, recycle them, or protect a resource from damage.
- A strategy's effect is judged by evidence of what changed, not by how popular or well-intentioned it is.
- Reducing use generally has a larger effect than recycling the same material, because recycling itself takes energy and materials.
...
- Claiming recycling makes unlimited use sustainable.
- Claiming a strategy works without any evidence of its effect.
- Claiming a strategy that works in one setting must work everywhere.

**Grade boundary.** Life-cycle assessment and quantitative footprint accounting are later work.
...
**Q1 — build product.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies conservation strategies and the unit standards.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of conservation strategies.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about conservation strategies using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies conservation strategies and the unit standards.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of conservation strategies.
...
**Q6 — limitation.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies conservation strategies and the unit standards.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of conservation strategies.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for conservation strategies, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for conservation strategies works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of conservation strategies, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking conservation strategies mastered.
...
_Package `swp-ma-g5-science-u08-l09` · built from `canonical-1.0.0` at `4056e31`._
