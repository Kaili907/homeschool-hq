# Scoring authority — Unit assessment: data over time

**Grade 5 Science** · Unit 7: Patterns in the Sky · Day 11 · lesson `ma-g5-science-u07-l11`
...
_Topic `ma-g5-science-u07::data over time` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Patterns in the sky are found by recording observations over days, months, or a year, not from single observations.
- The record states the date, time, and place of each observation, because all three affect what is seen.
- A pattern found over one period supports predictions only for conditions the record actually covered.
...
- Claiming a yearly pattern from a few days of observation.
- Recording sky observations without date, time, and location.
- Extending a pattern to a season or a latitude the record never covered.

**Grade boundary.** Time-series analysis and formal periodicity tests are later work.


## What a complete response contains, question by question

**Q1 — demonstrate mastery.** _Serves objective 1:_ Demonstrate current mastery of data over time through selected-response, constructed-response, and applied evidence.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of data over time.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about data over time using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Demonstrate current mastery of data over time through selected-response, constructed-response, and applied evidence.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of data over time.
...
**Q6 — limitation.** _Serves objective 1:_ Demonstrate current mastery of data over time through selected-response, constructed-response, and applied evidence.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of data over time.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for data over time, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for data over time works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of data over time, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking data over time mastered.
...
_Package `swp-ma-g5-science-u07-l11` · built from `canonical-1.0.0` at `4056e31`._
