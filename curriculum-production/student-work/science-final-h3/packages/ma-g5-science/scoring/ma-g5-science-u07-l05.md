# Scoring authority — Concept model B: data over time

**Grade 5 Science** · Unit 7: Patterns in the Sky · Day 5 · lesson `ma-g5-science-u07-l05`
...
**Q1 — model build.** _Serves objective 1:_ Build a clear mental model of data over time through an explicit worked example, demonstration, text, or phenomenon.
...
**Q4 — essential question.** _Serves objective 1:_ Build a clear mental model of data over time through an explicit worked example, demonstration, text, or phenomenon.
...
**Q6 — limitation.** _Serves objective 1:_ Build a clear mental model of data over time through an explicit worked example, demonstration, text, or phenomenon.
...
_Package `swp-ma-g5-science-u07-l05` · built from `canonical-1.0.0` at `4056e31`._
