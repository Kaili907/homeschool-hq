# Scoring authority — Synthesis and review: system interactions

**Grade 5 Science** · Unit 6: Earth Systems and Water · Day 10 · lesson `ma-g5-science-u06-l10`
...
_Topic `ma-g5-science-u06::system interactions` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- An interaction between Earth's systems is described by naming both systems and what passes between them.
- One event usually involves several interactions at once, such as a storm moving water from atmosphere to geosphere and biosphere.
- Interactions can change a system enough to change how it interacts next, which is why Earth systems do not stay in a fixed state.
...
- Naming an interaction without saying what moves between the systems.
- Claiming an interaction goes only one way when it goes both.
- Claiming a change in one system leaves all the others unaffected.

**Grade boundary.** Named feedback loops and quantitative coupling are High School work.


## What a complete response contains, question by question

**Q1 — connect unit.** _Serves objective 1:_ Connect system interactions to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of system interactions.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about system interactions using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Connect system interactions to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of system interactions.
...
**Q6 — limitation.** _Serves objective 1:_ Connect system interactions to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of system interactions.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for system interactions, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for system interactions works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of system interactions, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking system interactions mastered.
...
_Package `swp-ma-g5-science-u06-l10` · built from `canonical-1.0.0` at `4056e31`._
