# Scoring authority — Synthesis and review: gravity

**Grade 5 Science** · Unit 4: Energy in Food and Motion · Day 10 · lesson `ma-g5-science-u04-l10`
...
_Topic `ma-g5-science-u04::gravity` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- The gravitational force Earth exerts on objects is directed toward Earth's centre, which is what 'down' means.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Earth pulls objects toward its centre; that pull is what is called gravity, and it is why unsupported objects fall.
- The direction called 'down' is toward Earth's centre, and it is different at different places on the globe.
- Gravity acts on an object whether it is moving or at rest, and whether or not it is touching anything.
...
- Claiming gravity acts only on falling objects and not on ones sitting still.
- Claiming there is no gravity in space, or that astronauts float because gravity has stopped.
- Claiming heavier objects always fall noticeably faster than lighter ones through air, without reference to air resistance.

**Grade boundary.** Newton's law of gravitation, weight as a calculated force, and orbital mechanics are Grade 8 and High School work.


## What a complete response contains, question by question

**Q1 — connect unit.** _Serves objective 1:_ Connect gravity to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of gravity.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about gravity using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Connect gravity to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of gravity.
...
**Q6 — limitation.** _Serves objective 1:_ Connect gravity to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of gravity.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for gravity, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for gravity works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of gravity, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking gravity mastered.
...
_Package `swp-ma-g5-science-u04-l10` · built from `canonical-1.0.0` at `4056e31`._
