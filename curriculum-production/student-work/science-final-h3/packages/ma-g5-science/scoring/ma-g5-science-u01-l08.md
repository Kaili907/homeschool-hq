...
**Grade 5 Science** · Unit 1: Science and Engineering Practices · Day 8 · lesson `ma-g5-science-u01-l08`
...
_Topic `ma-g5-science-u01::testable questions` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A testable question names what will be changed or compared and what will be observed or measured.
- A question is testable only if some possible result would count against it.
- Questions of value or preference are not settled by observation, however carefully they are asked.

**Also correct.** Accept any of these framings — do not require the wording above:

- Comparison, cause, and 'what happens if' forms are all testable question types.
...
- Calling a question testable when no observation could disconfirm it.
- Framing a preference as a testable question.
- Claiming a question must begin with 'why' to be scientific.

**Grade boundary.** Formal hypothesis statements and named variables are later work.
...
_Package `swp-ma-g5-science-u01-l08` · built from `canonical-1.0.0` at `4056e31`._
