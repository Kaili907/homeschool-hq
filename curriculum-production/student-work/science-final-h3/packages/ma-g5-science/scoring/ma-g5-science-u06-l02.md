# Scoring authority — Concept model A: water distribution

**Grade 5 Science** · Unit 6: Earth Systems and Water · Day 2 · lesson `ma-g5-science-u06-l02`
...
**Q1 — model build.** _Serves objective 1:_ Build a clear mental model of water distribution through an explicit worked example, demonstration, text, or phenomenon.
...
**Q4 — essential question.** _Serves objective 1:_ Build a clear mental model of water distribution through an explicit worked example, demonstration, text, or phenomenon.
...
**Q6 — limitation.** _Serves objective 1:_ Build a clear mental model of water distribution through an explicit worked example, demonstration, text, or phenomenon.
...
_Package `swp-ma-g5-science-u06-l02` · built from `canonical-1.0.0` at `4056e31`._
