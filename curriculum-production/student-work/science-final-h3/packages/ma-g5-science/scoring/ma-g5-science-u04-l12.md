# Scoring authority — Correction and reflection: cause and effect

**Grade 5 Science** · Unit 4: Energy in Food and Motion · Day 12 · lesson `ma-g5-science-u04-l12`
...
_Topic `ma-g5-science-u04::cause and effect` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A causal claim names what was changed and what changed as a result.
- Two things varying together is not sufficient evidence that one causes the other.
- Evidence for causation comes from changing one factor while holding others constant, and observing what follows.
...
- Inferring cause from co-occurrence alone.
- Reversing cause and effect with no evidence about order.
- Naming an effect with no proposed cause and calling it an explanation.

**Grade boundary.** Confounding variables by name and correlation coefficients are later work.
...
_Package `swp-ma-g5-science-u04-l12` · built from `canonical-1.0.0` at `4056e31`._
