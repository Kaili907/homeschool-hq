# Scoring authority — Investigation or close reading: star brightness and distance

**Grade 5 Science** · Unit 7: Patterns in the Sky · Day 7 · lesson `ma-g5-science-u07-l07`
...
_Topic `ma-g5-science-u07::star brightness and distance` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Stars differ in how bright they actually are and in how far away they are, and both affect how bright they look from Earth.

**Accepted relationships and models.** What this lesson's learning target asserts:

- How bright a star looks from Earth depends on how much light it actually gives out and on how far away it is.
- A star that looks dim may be very bright but far away; a star that looks bright may be modest but close.
- Distance cannot be read off apparent brightness alone.

**Also correct.** Accept any of these framings — do not require the wording above:

- Apparent and actual brightness, or apparent and absolute brightness, are both acceptable namings.
...
- Claiming the brightest-looking star must be the closest.
- Claiming all stars give out the same amount of light.
- Claiming a star's apparent brightness alone establishes its distance.

**Grade boundary.** The inverse-square law, magnitude scales, and parallax measurement are High School work.
...
**Q1 — analyze evidence.** _Serves objective 1:_ Gather and analyze evidence related to star brightness and distance, then record a defensible interpretation.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of star brightness and distance.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about star brightness and distance using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Gather and analyze evidence related to star brightness and distance, then record a defensible interpretation.
...
**Q5 — evidence quality.** _Serves objective 1:_ Gather and analyze evidence related to star brightness and distance, then record a defensible interpretation.
...
**Q6 — limitation.** _Serves objective 1:_ Gather and analyze evidence related to star brightness and distance, then record a defensible interpretation.
...
**Q7 — provenance.** _Serves objective 1:_ Gather and analyze evidence related to star brightness and distance, then record a defensible interpretation.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for star brightness and distance, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for star brightness and distance works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of star brightness and distance, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking star brightness and distance mastered.
...
_Package `swp-ma-g5-science-u07-l07` · built from `canonical-1.0.0` at `4056e31`._
