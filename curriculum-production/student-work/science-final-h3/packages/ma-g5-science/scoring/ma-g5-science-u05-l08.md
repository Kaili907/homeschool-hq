# Scoring authority — Reteach and varied practice: air and water as matter sources

**Grade 5 Science** · Unit 5: Plants, Ecosystems, and Matter Cycles · Day 8 · lesson `ma-g5-science-u05-l08`
...
_Topic `ma-g5-science-u05::air and water as matter sources` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Most of the material a plant's body is built from comes from air and water, not from soil.

**Accepted relationships and models.** What this lesson's learning target asserts:

- The material that makes up a plant comes chiefly from air and water, not from the soil it grows in.
- The carbon in a plant's body comes from carbon dioxide taken in from the air.
- Soil loses very little mass as a plant growing in it gains a great deal, which is the evidence for this.

**Also correct.** Accept any of these framings — do not require the wording above:

- Saying the plant's mass comes from air and water, or that carbon comes from carbon dioxide and hydrogen and oxygen from water, are both correct.
...
- Claiming a plant's mass comes mainly from the soil.
- Claiming a plant gains mass from fertiliser as its principal building material.
- Claiming air contributes nothing to a plant's body because it cannot be seen.

**Grade boundary.** The full photosynthesis equation and carbon fixation chemistry are High School work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for air and water as matter sources, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of air and water as matter sources.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about air and water as matter sources using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for air and water as matter sources, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of air and water as matter sources.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for air and water as matter sources, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of air and water as matter sources.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for air and water as matter sources, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for air and water as matter sources works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of air and water as matter sources, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking air and water as matter sources mastered.
...
_Package `swp-ma-g5-science-u05-l08` · built from `canonical-1.0.0` at `4056e31`._
