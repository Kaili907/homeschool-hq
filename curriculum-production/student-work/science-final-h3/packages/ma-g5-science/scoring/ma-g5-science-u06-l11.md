# Scoring authority — Unit assessment: maps and data

**Grade 5 Science** · Unit 6: Earth Systems and Water · Day 11 · lesson `ma-g5-science-u06-l11`
...
_Topic `ma-g5-science-u06::maps and data` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Maps and data tables show where Earth's water, land, and features are, and patterns in them are evidence about processes.
- A map needs a key, a scale, and a stated source before its patterns can be relied on.
- Data shown on a map is still data: it has a date, a source, and limits on what it covers.
...
- Reading distances or quantities from a map with no scale or key.
- Treating an undated map as showing current conditions.
- Claiming a pattern on a map explains itself without any proposed process.

**Grade boundary.** Projection distortion and geographic information systems are later work.


## What a complete response contains, question by question

**Q1 — demonstrate mastery.** _Serves objective 1:_ Demonstrate current mastery of maps and data through selected-response, constructed-response, and applied evidence.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of maps and data.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about maps and data using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Demonstrate current mastery of maps and data through selected-response, constructed-response, and applied evidence.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of maps and data.
...
**Q6 — limitation.** _Serves objective 1:_ Demonstrate current mastery of maps and data through selected-response, constructed-response, and applied evidence.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of maps and data.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for maps and data, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for maps and data works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of maps and data, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking maps and data mastered.
...
_Package `swp-ma-g5-science-u06-l11` · built from `canonical-1.0.0` at `4056e31`._
