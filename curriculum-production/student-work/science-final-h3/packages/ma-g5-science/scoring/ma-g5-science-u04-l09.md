# Scoring authority — Performance task build: food webs and energy transfer

**Grade 5 Science** · Unit 4: Energy in Food and Motion · Day 9 · lesson `ma-g5-science-u04-l09`
...
_Topic `ma-g5-science-u04::food webs and energy transfer` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Energy moves through a food web in one direction, from producers to consumers to decomposers.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Energy enters an ecosystem through producers and passes to consumers when they eat.
- At every transfer most of the energy is released to the surroundings, mainly as warmth, so less is available at each successive level.
- Arrows in a food web point in the direction the energy and matter travel, that is, from the organism eaten to the organism eating it.

**Also correct.** Accept any of these framings — do not require the wording above:

- Food chain and food web are both correct representations; a web shows more of the connections.
...
- Drawing food-web arrows pointing from the eater to the eaten.
- Claiming energy cycles round a food web the way matter does.
- Claiming all the energy at one level passes to the next.

**Grade boundary.** Quantitative trophic efficiency figures and energy pyramids with numbers are Grade 7 and High School work.
...
**Q1 — build product.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies food webs and energy transfer and the unit standards.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of food webs and energy transfer.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about food webs and energy transfer using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies food webs and energy transfer and the unit standards.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of food webs and energy transfer.
...
**Q6 — limitation.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies food webs and energy transfer and the unit standards.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of food webs and energy transfer.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for food webs and energy transfer, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for food webs and energy transfer works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of food webs and energy transfer, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking food webs and energy transfer mastered.
...
_Package `swp-ma-g5-science-u04-l09` · built from `canonical-1.0.0` at `4056e31`._
