# Scoring authority — Investigation or close reading: systems thinking

**Grade 5 Science** · Unit 9: Integrated Science and Engineering Capstone · Day 7 · lesson `ma-g5-science-u09-l07`
...
_Topic `ma-g5-science-u09::systems thinking` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A system is defined by its boundary, its parts, and the flows of matter and energy across that boundary.
- A system's behaviour comes from the interactions between its parts, not from any one part alone.
- Changing where the boundary is drawn changes what counts as inside the system and what counts as an input.
...
- Describing a system without stating its boundary.
- Explaining a system's behaviour from one part in isolation.
- Claiming a system model captures everything about the real system.

**Grade boundary.** Quantitative system dynamics and feedback modelling are High School work.
...
**Q1 — analyze evidence.** _Serves objective 1:_ Gather and analyze evidence related to systems thinking, then record a defensible interpretation.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of systems thinking.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about systems thinking using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Gather and analyze evidence related to systems thinking, then record a defensible interpretation.
...
**Q5 — evidence quality.** _Serves objective 1:_ Gather and analyze evidence related to systems thinking, then record a defensible interpretation.
...
**Q6 — limitation.** _Serves objective 1:_ Gather and analyze evidence related to systems thinking, then record a defensible interpretation.
...
**Q7 — provenance.** _Serves objective 1:_ Gather and analyze evidence related to systems thinking, then record a defensible interpretation.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for systems thinking, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for systems thinking works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of systems thinking, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking systems thinking mastered.
...
_Package `swp-ma-g5-science-u09-l07` · built from `canonical-1.0.0` at `4056e31`._
