# Scoring authority — Investigation or close reading: energy from the sun

**Grade 5 Science** · Unit 4: Energy in Food and Motion · Day 7 · lesson `ma-g5-science-u04-l07`
...
_Topic `ma-g5-science-u04::energy from the sun` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- The energy in almost all food can be traced back to energy from the Sun.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Plants capture energy from sunlight and use it to make their own food.
- The energy in the food animals eat can be traced back to the Sun through the plants at the base of the food chain.
- The Sun is the source of the energy that drives most processes at Earth's surface, including weather and the water cycle.

**Also correct.** Accept any of these framings — do not require the wording above:

- Saying plants make food using light energy, or that they carry out photosynthesis, are both correct here.
...
- Claiming plants take in food from the soil rather than making it.
- Claiming animals get their energy directly from sunlight.
- Claiming energy is created inside an organism.

**Grade boundary.** The chemistry of photosynthesis and ATP are Grade 7 and High School work.
...
**Q1 — analyze evidence.** _Serves objective 1:_ Gather and analyze evidence related to energy from the sun, then record a defensible interpretation.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of energy from the sun.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about energy from the sun using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Gather and analyze evidence related to energy from the sun, then record a defensible interpretation.
...
**Q5 — evidence quality.** _Serves objective 1:_ Gather and analyze evidence related to energy from the sun, then record a defensible interpretation.
...
**Q6 — limitation.** _Serves objective 1:_ Gather and analyze evidence related to energy from the sun, then record a defensible interpretation.
...
**Q7 — provenance.** _Serves objective 1:_ Gather and analyze evidence related to energy from the sun, then record a defensible interpretation.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for energy from the sun, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for energy from the sun works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of energy from the sun, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking energy from the sun mastered.
...
_Package `swp-ma-g5-science-u04-l07` · built from `canonical-1.0.0` at `4056e31`._
