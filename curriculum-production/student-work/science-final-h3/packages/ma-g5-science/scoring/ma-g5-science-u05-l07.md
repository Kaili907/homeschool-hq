# Scoring authority — Investigation or close reading: plant growth needs

**Grade 5 Science** · Unit 5: Plants, Ecosystems, and Matter Cycles · Day 7 · lesson `ma-g5-science-u05-l07`
...
_Topic `ma-g5-science-u05::plant growth needs` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Plants need light, water, air, and a suitable temperature to grow; soil supplies minerals and support, not food.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Plants need light, water, air, and suitable temperature in order to grow.
- Soil provides water, dissolved minerals, and physical support; it does not supply the plant's food.
- Removing any one of a plant's needs limits its growth, however plentiful the others are.

**Also correct.** Accept any of these framings — do not require the wording above:

- Saying plants need carbon dioxide, or that they need air, are both correct at this grade.
...
- Claiming plants take in food from the soil.
- Claiming soil is the main source of the material a plant's body is built from.
- Claiming a plant can grow indefinitely with water alone.

**Grade boundary.** The photosynthesis equation and mineral nutrition detail are Grade 7 and High School work.
...
**Q1 — analyze evidence.** _Serves objective 1:_ Gather and analyze evidence related to plant growth needs, then record a defensible interpretation.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of plant growth needs.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about plant growth needs using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Gather and analyze evidence related to plant growth needs, then record a defensible interpretation.
...
**Q5 — evidence quality.** _Serves objective 1:_ Gather and analyze evidence related to plant growth needs, then record a defensible interpretation.
...
**Q6 — limitation.** _Serves objective 1:_ Gather and analyze evidence related to plant growth needs, then record a defensible interpretation.
...
**Q7 — provenance.** _Serves objective 1:_ Gather and analyze evidence related to plant growth needs, then record a defensible interpretation.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for plant growth needs, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for plant growth needs works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of plant growth needs, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking plant growth needs mastered.
...
_Package `swp-ma-g5-science-u05-l07` · built from `canonical-1.0.0` at `4056e31`._
