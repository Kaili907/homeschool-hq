# Scoring authority — Concept model B: motion observations

**Grade 5 Science** · Unit 4: Energy in Food and Motion · Day 5 · lesson `ma-g5-science-u04-l05`
...
**Q1 — model build.** _Serves objective 1:_ Build a clear mental model of motion observations through an explicit worked example, demonstration, text, or phenomenon.
...
**Q4 — essential question.** _Serves objective 1:_ Build a clear mental model of motion observations through an explicit worked example, demonstration, text, or phenomenon.
...
**Q6 — limitation.** _Serves objective 1:_ Build a clear mental model of motion observations through an explicit worked example, demonstration, text, or phenomenon.
...
_Package `swp-ma-g5-science-u04-l05` · built from `canonical-1.0.0` at `4056e31`._
