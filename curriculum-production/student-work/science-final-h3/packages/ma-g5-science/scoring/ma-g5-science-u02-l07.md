# Scoring authority — Investigation or close reading: particles and matter models

**Grade 5 Science** · Unit 2: Properties of Matter · Day 7 · lesson `ma-g5-science-u02-l07`
...
_Topic `ma-g5-science-u02::particles and matter models` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._
...
- All matter is made of particles that are far too small to see, even with an ordinary microscope.
- Because matter is made of particles, a substance can be present even when it cannot be seen, as air is.
- The particle model explains why matter that seems to disappear, such as evaporating water or dissolving sugar, has not stopped existing.

**Also correct.** Accept any of these framings — do not require the wording above:

- Calling them particles, or atoms and molecules, are both acceptable at this grade; the source's own wording is not required.
...
- Claiming a gas is not matter because it cannot be seen.
- Claiming dissolved or evaporated material has ceased to exist.
- Claiming particles can be seen directly with a hand lens or school microscope.

**Grade boundary.** Atomic structure, the periodic table, and molecular formulas are Grade 7 and later work.
...
**Q1 — analyze evidence.** _Serves objective 1:_ Gather and analyze evidence related to particles and matter models, then record a defensible interpretation.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of particles and matter models.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about particles and matter models using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Gather and analyze evidence related to particles and matter models, then record a defensible interpretation.
...
**Q5 — evidence quality.** _Serves objective 1:_ Gather and analyze evidence related to particles and matter models, then record a defensible interpretation.
...
**Q6 — limitation.** _Serves objective 1:_ Gather and analyze evidence related to particles and matter models, then record a defensible interpretation.
...
**Q7 — provenance.** _Serves objective 1:_ Gather and analyze evidence related to particles and matter models, then record a defensible interpretation.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for particles and matter models, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for particles and matter models works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of particles and matter models, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking particles and matter models mastered.
...
_Package `swp-ma-g5-science-u02-l07` · built from `canonical-1.0.0` at `4056e31`._
