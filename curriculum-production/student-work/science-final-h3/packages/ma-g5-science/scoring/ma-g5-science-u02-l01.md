# Scoring authority — Launch and diagnostic: particles and matter models

**Grade 5 Science** · Unit 2: Properties of Matter · Day 1 · lesson `ma-g5-science-u02-l01`
...
_Topic `ma-g5-science-u02::particles and matter models` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._
...
**Q1 — activate prior.** _Serves objective 1:_ Activate prior knowledge about particles and matter models, surface initial thinking without penalty, and establish the unit question.
...
**Q4 — essential question.** _Serves objective 1:_ Activate prior knowledge about particles and matter models, surface initial thinking without penalty, and establish the unit question.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of particles and matter models.
...
**Q6 — limitation.** _Serves objective 1:_ Activate prior knowledge about particles and matter models, surface initial thinking without penalty, and establish the unit question.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of particles and matter models.
...
_Package `swp-ma-g5-science-u02-l01` · built from `canonical-1.0.0` at `4056e31`._
