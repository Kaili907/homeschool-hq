# Scoring authority — Correction and reflection: solution criteria

**Grade 5 Science** · Unit 8: Human Impact and Environmental Decisions · Day 12 · lesson `ma-g5-science-u08-l12`
...
_Topic `ma-g5-science-u08::solution criteria` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Criteria for an environmental solution state what it must achieve in terms that can be checked with evidence.
- Constraints include cost, time, available materials, safety, and law.
- Criteria are set before options are compared, and every option is judged against the same set.
...
- Writing a criterion that no evidence could ever check.
- Comparing options against different criteria.
- Changing the criteria after the comparison so a preferred option wins.

**Grade boundary.** Weighted scoring and formal requirements analysis are later work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for solution criteria, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of solution criteria.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about solution criteria using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for solution criteria, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of solution criteria.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for solution criteria, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of solution criteria.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for solution criteria, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for solution criteria works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of solution criteria, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking solution criteria mastered.
...
_Package `swp-ma-g5-science-u08-l12` · built from `canonical-1.0.0` at `4056e31`._
