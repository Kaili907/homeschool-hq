# Scoring authority — Reteach and varied practice: observable properties

**Grade 5 Science** · Unit 2: Properties of Matter · Day 8 · lesson `ma-g5-science-u02-l08`
...
_Topic `ma-g5-science-u02::observable properties` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Materials can be described by observable properties such as colour, hardness, texture, flexibility, magnetic attraction, conductivity, solubility, and whether they float in water.
- Some properties do not depend on how much of the material there is, and those are the useful ones for identifying it.
- A single property rarely identifies a material; several together do much better.
...
- Identifying a material from colour alone.
- Treating the amount of a sample as a property of the material.
- Claiming two materials must be the same because they share one property.

**Grade boundary.** The intensive-extensive distinction by name, and density as a calculated quantity, are Grade 7 and later work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for observable properties, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of observable properties.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about observable properties using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for observable properties, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of observable properties.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for observable properties, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of observable properties.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for observable properties, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for observable properties works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of observable properties, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking observable properties mastered.
...
_Package `swp-ma-g5-science-u02-l08` · built from `canonical-1.0.0` at `4056e31`._
