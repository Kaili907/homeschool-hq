# Scoring authority — Synthesis and review: food webs

**Grade 5 Science** · Unit 5: Plants, Ecosystems, and Matter Cycles · Day 10 · lesson `ma-g5-science-u05-l10`
...
_Topic `ma-g5-science-u05::food webs` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A food web shows the feeding relationships in an ecosystem, with arrows pointing from the organism eaten to the organism that eats it.
- Most organisms appear in more than one chain within a web, which is why a web represents an ecosystem better than a single chain.
- Changing the number of one organism affects others in the web, sometimes several steps away.
...
- Drawing arrows from predator to prey.
- Claiming removing one organism affects only the one directly above it.
- Claiming a food web shows energy returning from consumers to producers.

**Grade boundary.** Quantitative population modelling and trophic cascades by name are later work.


## What a complete response contains, question by question

**Q1 — connect unit.** _Serves objective 1:_ Connect food webs to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of food webs.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about food webs using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Connect food webs to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of food webs.
...
**Q6 — limitation.** _Serves objective 1:_ Connect food webs to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of food webs.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for food webs, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for food webs works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of food webs, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking food webs mastered.
...
_Package `swp-ma-g5-science-u05-l10` · built from `canonical-1.0.0` at `4056e31`._
