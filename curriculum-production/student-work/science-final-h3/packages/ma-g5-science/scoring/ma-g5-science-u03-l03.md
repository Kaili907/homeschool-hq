# Scoring authority — Guided practice A: signs of chemical change

**Grade 5 Science** · Unit 3: Changes and Conservation of Matter · Day 3 · lesson `ma-g5-science-u03-l03`
...
_Topic `ma-g5-science-u03::signs of chemical change` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._
...
**Q1 — guided practice.** _Serves objective 1:_ Practice signs of chemical change with prompts, feedback, and gradually reduced support.
...
**Q4 — essential question.** _Serves objective 1:_ Practice signs of chemical change with prompts, feedback, and gradually reduced support.
...
**Q6 — limitation.** _Serves objective 1:_ Practice signs of chemical change with prompts, feedback, and gradually reduced support.
...
_Package `swp-ma-g5-science-u03-l03` · built from `canonical-1.0.0` at `4056e31`._
