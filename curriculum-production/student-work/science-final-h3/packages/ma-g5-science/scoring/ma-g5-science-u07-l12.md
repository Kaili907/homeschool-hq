# Scoring authority — Correction and reflection: scale models and limitations

**Grade 5 Science** · Unit 7: Patterns in the Sky · Day 12 · lesson `ma-g5-science-u07-l12`
...
_Topic `ma-g5-science-u07::scale models and limitations` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A scale model of the sky or the solar system cannot usually keep both sizes and distances to the same scale, because the distances are so much larger.
- The model's limitation is stated alongside it, so nobody reads the wrong lesson from it.
- A model is useful for the relationships it does represent, even when it distorts others.
...
- Reading planet sizes or distances off a classroom model as though they were to scale.
- Claiming a model that distorts scale is simply wrong rather than limited.
- Presenting a scale model without stating what it does not represent.

**Grade boundary.** Astronomical units, light years, and logarithmic scaling are Grade 8 and High School work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for scale models and limitations, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of scale models and limitations.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about scale models and limitations using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for scale models and limitations, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of scale models and limitations.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for scale models and limitations, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of scale models and limitations.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for scale models and limitations, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for scale models and limitations works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of scale models and limitations, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking scale models and limitations mastered.
...
_Package `swp-ma-g5-science-u07-l12` · built from `canonical-1.0.0` at `4056e31`._
