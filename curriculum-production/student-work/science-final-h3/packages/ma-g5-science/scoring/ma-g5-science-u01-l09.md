...
**Grade 5 Science** · Unit 1: Science and Engineering Practices · Day 9 · lesson `ma-g5-science-u01-l09`
...
_Topic `ma-g5-science-u01::models and diagrams` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A model represents a system in order to explain or predict its behaviour.
- Every model simplifies; the simplification is a stated limitation, not a defect to conceal.
- A model is tested by whether its predictions match observation, not by how detailed it looks.

**Also correct.** Accept any of these framings — do not require the wording above:

- Diagrams, physical builds, flow charts, and written descriptions are all legitimate models here.
...
- Claiming a model must resemble the real thing to be useful.
- Claiming a model has no limitations.
- Judging a model on presentation rather than on what it predicts or explains.

**Grade boundary.** Mathematical and computational models are Grade 7 and later work.
...
_Package `swp-ma-g5-science-u01-l09` · built from `canonical-1.0.0` at `4056e31`._
