# Scoring authority — Investigation or close reading: geosphere hydrosphere atmosphere biosphere

**Grade 5 Science** · Unit 6: Earth Systems and Water · Day 7 · lesson `ma-g5-science-u06-l07`
...
_Topic `ma-g5-science-u06::geosphere hydrosphere atmosphere biosphere` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Earth's major systems are the geosphere, the hydrosphere, the atmosphere, and the biosphere.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Earth's major systems are the geosphere, hydrosphere, atmosphere, and biosphere, and they interact continuously.
- Nearly every Earth process involves more than one of these systems at once.
- The four-system division is a model for thinking about Earth, not a set of physically separate compartments.

**Also correct.** Accept any of these framings — do not require the wording above:

- Including the cryosphere as part of the hydrosphere, or naming it separately, are both acceptable.
...
- Claiming the systems operate independently of one another.
- Placing living things outside Earth's systems.
- Claiming the boundaries between the systems are sharp physical divisions.

**Grade boundary.** Quantitative system fluxes and feedback analysis are High School work.
...
**Q1 — analyze evidence.** _Serves objective 1:_ Gather and analyze evidence related to geosphere hydrosphere atmosphere biosphere, then record a defensible interpretation.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of geosphere hydrosphere atmosphere biosphere.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about geosphere hydrosphere atmosphere biosphere using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Gather and analyze evidence related to geosphere hydrosphere atmosphere biosphere, then record a defensible interpretation.
...
**Q5 — evidence quality.** _Serves objective 1:_ Gather and analyze evidence related to geosphere hydrosphere atmosphere biosphere, then record a defensible interpretation.
...
**Q6 — limitation.** _Serves objective 1:_ Gather and analyze evidence related to geosphere hydrosphere atmosphere biosphere, then record a defensible interpretation.
...
**Q7 — provenance.** _Serves objective 1:_ Gather and analyze evidence related to geosphere hydrosphere atmosphere biosphere, then record a defensible interpretation.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for geosphere hydrosphere atmosphere biosphere, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for geosphere hydrosphere atmosphere biosphere works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of geosphere hydrosphere atmosphere biosphere, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking geosphere hydrosphere atmosphere biosphere mastered.
...
_Package `swp-ma-g5-science-u06-l07` · built from `canonical-1.0.0` at `4056e31`._
