# Scoring authority — Unit assessment: design iteration

**Grade 5 Science** · Unit 9: Integrated Science and Engineering Capstone · Day 11 · lesson `ma-g5-science-u09-l11`
...
_Topic `ma-g5-science-u09::design iteration` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Iteration means testing, using the result to make a specific change, and testing again.
- One change at a time lets the effect of that change be identified.
- A failed test is the normal and useful input to the next iteration.
...
- Changing several things between tests and attributing the improvement to one.
- Declaring a design improved without retesting against the criteria.
- Treating a failed test as a reason to abandon rather than as evidence.

**Grade boundary.** Design of experiments and statistical optimisation are later work.


## What a complete response contains, question by question

**Q1 — demonstrate mastery.** _Serves objective 1:_ Demonstrate current mastery of design iteration through selected-response, constructed-response, and applied evidence.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of design iteration.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about design iteration using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Demonstrate current mastery of design iteration through selected-response, constructed-response, and applied evidence.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of design iteration.
...
**Q6 — limitation.** _Serves objective 1:_ Demonstrate current mastery of design iteration through selected-response, constructed-response, and applied evidence.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of design iteration.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for design iteration, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for design iteration works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of design iteration, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking design iteration mastered.
...
_Package `swp-ma-g5-science-u09-l11` · built from `canonical-1.0.0` at `4056e31`._
