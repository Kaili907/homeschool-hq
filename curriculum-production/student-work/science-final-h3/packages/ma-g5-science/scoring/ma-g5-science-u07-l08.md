# Scoring authority — Reteach and varied practice: sun as a star

**Grade 5 Science** · Unit 7: Patterns in the Sky · Day 8 · lesson `ma-g5-science-u07-l08`
...
_Topic `ma-g5-science-u07::sun as a star` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- The Sun is a star, and it appears larger and brighter than other stars because it is far closer to Earth.

**Accepted relationships and models.** What this lesson's learning target asserts:

- The Sun is an ordinary star; it looks different from the others only because it is enormously closer.
- Other stars are suns too, at distances so great that they appear as points of light.
- The Sun's apparent size and brightness are consequences of its distance, not of it being a different kind of object.
...
- Claiming the Sun is not a star.
- Claiming the Sun is the largest or brightest star that exists.
- Claiming other stars are small because they look small.

**Grade boundary.** Stellar classification, fusion, and stellar life cycles are High School work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for sun as a star, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of sun as a star.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about sun as a star using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for sun as a star, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of sun as a star.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for sun as a star, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of sun as a star.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for sun as a star, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for sun as a star works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of sun as a star, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking sun as a star mastered.
...
_Package `swp-ma-g5-science-u07-l08` · built from `canonical-1.0.0` at `4056e31`._
