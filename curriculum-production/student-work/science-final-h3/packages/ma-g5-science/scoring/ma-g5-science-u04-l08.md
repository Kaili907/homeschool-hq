# Scoring authority — Reteach and varied practice: energy in food

**Grade 5 Science** · Unit 4: Energy in Food and Motion · Day 8 · lesson `ma-g5-science-u04-l08`
...
_Topic `ma-g5-science-u04::energy in food` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Food provides organisms with both energy and the materials their bodies are built from.
- The energy an animal uses for motion, growth, warmth, and repair comes from its food.
- Food energy that is not used immediately is stored, not destroyed.
...
- Claiming animals make their own food inside their bodies.
- Claiming food supplies energy but not the materials for growth.
- Claiming unused food energy simply disappears.

**Grade boundary.** Cellular respiration as a chemical process, and calorie accounting, are Grade 7 and High School work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for energy in food, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of energy in food.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about energy in food using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for energy in food, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of energy in food.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for energy in food, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of energy in food.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for energy in food, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for energy in food works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of energy in food, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking energy in food mastered.
...
_Package `swp-ma-g5-science-u04-l08` · built from `canonical-1.0.0` at `4056e31`._
