# Scoring authority — Correction and reflection: evidence from measurements

**Grade 5 Science** · Unit 3: Changes and Conservation of Matter · Day 12 · lesson `ma-g5-science-u03-l12`
...
_Topic `ma-g5-science-u03::evidence from measurements` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A claim about a change is supported by measurements taken before and after under the same conditions.
- A difference smaller than the measuring tool can resolve is not evidence of a change.
- Every reported value states its unit and how it was obtained.
...
- Claiming a change from a difference smaller than the tool can resolve.
- Comparing before and after measurements taken with different tools or methods, without saying so.
- Reporting a measurement without a unit.

**Grade boundary.** Uncertainty propagation and statistical tests are later work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for evidence from measurements, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of evidence from measurements.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about evidence from measurements using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for evidence from measurements, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of evidence from measurements.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for evidence from measurements, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of evidence from measurements.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for evidence from measurements, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for evidence from measurements works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of evidence from measurements, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking evidence from measurements mastered.
...
_Package `swp-ma-g5-science-u03-l12` · built from `canonical-1.0.0` at `4056e31`._
