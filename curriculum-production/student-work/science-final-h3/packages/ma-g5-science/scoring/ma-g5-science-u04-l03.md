# Scoring authority — Guided practice A: food webs and energy transfer

**Grade 5 Science** · Unit 4: Energy in Food and Motion · Day 3 · lesson `ma-g5-science-u04-l03`
...
_Topic `ma-g5-science-u04::food webs and energy transfer` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._
...
**Q1 — guided practice.** _Serves objective 1:_ Practice food webs and energy transfer with prompts, feedback, and gradually reduced support.
...
**Q4 — essential question.** _Serves objective 1:_ Practice food webs and energy transfer with prompts, feedback, and gradually reduced support.
...
**Q6 — limitation.** _Serves objective 1:_ Practice food webs and energy transfer with prompts, feedback, and gradually reduced support.
...
_Package `swp-ma-g5-science-u04-l03` · built from `canonical-1.0.0` at `4056e31`._
