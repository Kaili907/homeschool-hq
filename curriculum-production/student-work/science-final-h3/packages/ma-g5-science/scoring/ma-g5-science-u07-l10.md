# Scoring authority — Synthesis and review: seasonal daylight patterns

**Grade 5 Science** · Unit 7: Patterns in the Sky · Day 10 · lesson `ma-g5-science-u07-l10`
...
_Topic `ma-g5-science-u07::seasonal daylight patterns` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._
...
- The length of daylight and the Sun's height in the sky change through the year in a repeating pattern.
- These seasonal patterns are caused by the tilt of Earth's axis as Earth orbits the Sun.
- Because of the tilt, the Northern and Southern Hemispheres have opposite seasons at the same time of year.

**Also correct.** Accept any of these framings — do not require the wording above:

- Explaining the tilt effect as a change in the directness of sunlight, or as a change in day length, are both correct and usually both apply.
...
- Claiming both hemispheres have summer at the same time.
- Claiming the tilt of Earth's axis changes direction through the year.

**Grade boundary.** Solstice and equinox geometry in quantitative terms, and axial precession, are later work.


## What a complete response contains, question by question

**Q1 — connect unit.** _Serves objective 1:_ Connect seasonal daylight patterns to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of seasonal daylight patterns.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about seasonal daylight patterns using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Connect seasonal daylight patterns to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of seasonal daylight patterns.
...
**Q6 — limitation.** _Serves objective 1:_ Connect seasonal daylight patterns to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of seasonal daylight patterns.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for seasonal daylight patterns, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for seasonal daylight patterns works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of seasonal daylight patterns, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking seasonal daylight patterns mastered.
...
_Package `swp-ma-g5-science-u07-l10` · built from `canonical-1.0.0` at `4056e31`._
