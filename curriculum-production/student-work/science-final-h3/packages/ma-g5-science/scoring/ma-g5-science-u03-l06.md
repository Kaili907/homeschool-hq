# Scoring authority — Guided practice B: evidence from measurements

**Grade 5 Science** · Unit 3: Changes and Conservation of Matter · Day 6 · lesson `ma-g5-science-u03-l06`
...
**Q1 — guided practice.** _Serves objective 1:_ Practice evidence from measurements with prompts, feedback, and gradually reduced support.
...
**Q4 — essential question.** _Serves objective 1:_ Practice evidence from measurements with prompts, feedback, and gradually reduced support.
...
**Q6 — limitation.** _Serves objective 1:_ Practice evidence from measurements with prompts, feedback, and gradually reduced support.
...
_Package `swp-ma-g5-science-u03-l06` · built from `canonical-1.0.0` at `4056e31`._
