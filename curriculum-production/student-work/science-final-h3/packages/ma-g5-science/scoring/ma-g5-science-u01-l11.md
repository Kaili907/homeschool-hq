# Scoring authority — Unit assessment: measurement and data tables

**Grade 5 Science** · Unit 1: Science and Engineering Practices · Day 11 · lesson `ma-g5-science-u01-l11`
...
_Topic `ma-g5-science-u01::measurement and data tables` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._
...
- A measurement has a number and a unit, and comparisons require the same unit.
- A data table with labelled columns, units in the headings, and one row per trial can be read by someone who was not present.
- Repeated measurements of the same quantity vary a little; that variation is information about the method.

**Also correct.** Accept any of these framings — do not require the wording above:

- Metric or customary units are both acceptable if used consistently within a comparison.
...
- Recording values with no units.
- Adjusting a recorded value so it fits the expected pattern.
- Claiming that more decimal places always means a more accurate measurement.

**Grade boundary.** Significant figures and formal uncertainty ranges are Grade 7 and later work.


## What a complete response contains, question by question

**Q1 — demonstrate mastery.** _Serves objective 1:_ Demonstrate current mastery of measurement and data tables through selected-response, constructed-response, and applied evidence.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of measurement and data tables.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about measurement and data tables using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Demonstrate current mastery of measurement and data tables through selected-response, constructed-response, and applied evidence.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of measurement and data tables.
...
**Q6 — limitation.** _Serves objective 1:_ Demonstrate current mastery of measurement and data tables through selected-response, constructed-response, and applied evidence.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of measurement and data tables.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for measurement and data tables, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for measurement and data tables works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of measurement and data tables, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking measurement and data tables mastered.
...
_Package `swp-ma-g5-science-u01-l11` · built from `canonical-1.0.0` at `4056e31`._
