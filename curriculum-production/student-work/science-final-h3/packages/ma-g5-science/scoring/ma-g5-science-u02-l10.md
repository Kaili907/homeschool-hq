# Scoring authority — Synthesis and review: identifying materials

**Grade 5 Science** · Unit 2: Properties of Matter · Day 10 · lesson `ma-g5-science-u02-l10`
...
_Topic `ma-g5-science-u02::identifying materials` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A material is identified by testing several properties and comparing the results with known materials.
- The more properties that match, the stronger the identification.
- An identification is a conclusion supported by evidence, and it can be revised if a further test disagrees.
...
- Declaring an identification certain on the strength of one property.
- Ignoring a test result that disagrees with the preferred identification.
- Claiming an unknown must be one of the samples offered when none of the properties match.

**Grade boundary.** Chemical tests, flame tests, and analytical identification are later work.


## What a complete response contains, question by question

**Q1 — connect unit.** _Serves objective 1:_ Connect identifying materials to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of identifying materials.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about identifying materials using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Connect identifying materials to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of identifying materials.
...
**Q6 — limitation.** _Serves objective 1:_ Connect identifying materials to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of identifying materials.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for identifying materials, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for identifying materials works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of identifying materials, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking identifying materials mastered.
...
_Package `swp-ma-g5-science-u02-l10` · built from `canonical-1.0.0` at `4056e31`._
