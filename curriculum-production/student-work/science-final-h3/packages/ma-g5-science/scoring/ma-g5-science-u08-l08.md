# Scoring authority — Reteach and varied practice: waste and pollution

**Grade 5 Science** · Unit 8: Human Impact and Environmental Decisions · Day 8 · lesson `ma-g5-science-u08-l08`
...
_Topic `ma-g5-science-u08::waste and pollution` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g5-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Waste and pollutants released into air, water, or land do not disappear; they move through Earth's systems.
- A pollutant released in one place can affect a different place, because air and water carry it.
- The effect of a pollutant depends on how much there is, how long it lasts, and what it reaches.
...
- Claiming waste disposed of out of sight has left the environment.
- Claiming pollution affects only the place it was released.
- Claiming any detectable amount of a substance is necessarily harmful, or that a small amount never is, without reference to the amount and the exposure.

**Grade boundary.** Toxicology, dose-response, and pollutant transport modelling are later work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for waste and pollution, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of waste and pollution.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about waste and pollution using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for waste and pollution, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of waste and pollution.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for waste and pollution, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of waste and pollution.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for waste and pollution, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for waste and pollution works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of waste and pollution, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking waste and pollution mastered.
...
_Package `swp-ma-g5-science-u08-l08` · built from `canonical-1.0.0` at `4056e31`._
