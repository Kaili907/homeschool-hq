# Scoring authority — Unit assessment: catalysts

**High School Chemistry (Grade 10)** · Unit 7: Reaction Rates and the Conditions That Change Them · Day 11 · lesson `ma-hs10-chemistry-u07-l11`
...
_Topic `ma-hs10-chemistry-u07::catalysts` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-hs10-chemistry.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- A catalyst increases reaction rate by providing a pathway with lower activation energy, and it is not consumed by the reaction.

**Accepted relationships and models.** What this lesson's learning target asserts:

- A catalyst lowers the activation energy, so a larger fraction of collisions is effective at any given temperature.
- A catalyst does not change the overall energy change of the reaction or the position of equilibrium; it speeds the forward and reverse directions equally.
- Enzymes are biological catalysts and follow the same principles.
...
- Claiming a catalyst is consumed by the reaction it catalyses.
- Claiming a catalyst increases the yield or shifts the equilibrium position.
- Claiming a catalyst supplies the activation energy rather than lowering it.

**Grade boundary.** Catalytic mechanisms, turnover number, and heterogeneous catalysis theory are beyond this course.


## What a complete response contains, question by question

**Q1 — mastery fresh task.** _Serves objective 1:_ Demonstrate independent mastery evidence for catalysts on a fresh task.
...
**Q2 — explain with evidence.** _Serves objective 2:_ Explain catalysts using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q3 — apply new task.** _Serves objective 3:_ Apply catalysts to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q4 — check revise next step.** _Serves objective 4:_ Check and revise the work on catalysts against the stated success criteria and name the next step.
...
**Q5 — essential question.** _Serves objective 3:_ Apply catalysts to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q6 — evidence quality.** _Serves objective 2:_ Explain catalysts using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q7 — limitation.** _Serves objective 3:_ Apply catalysts to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q8 — provenance.** _Serves objective 1:_ Demonstrate independent mastery evidence for catalysts on a fresh task.
...
- **prerequisite-gap** — Run the prerequisite reteach route for catalysts (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for catalysts (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for catalysts (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for catalysts (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for catalysts (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs10-chemistry-u07-l11` · built from `hs912-science-h3` at `e7551b9`._
