# Scoring authority — Launch and diagnostic: evidence of chemical change

**High School Chemistry (Grade 10)** · Unit 4: Chemical Reactions and Electron Rearrangement · Day 1 · lesson `ma-hs10-chemistry-u04-l01`
...
_Topic `ma-hs10-chemistry-u04::evidence of chemical change` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs10-chemistry.correctness.json`._
...
**Q1 — phenomenon question.** _Serves objective 1:_ Observe the anchoring phenomenon, surface initial thinking about evidence of chemical change without penalty, and pose a testable question.
...
**Q7 — limitation.** _Serves objective 3:_ Apply evidence of chemical change to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q8 — provenance.** _Serves objective 1:_ Observe the anchoring phenomenon, surface initial thinking about evidence of chemical change without penalty, and pose a testable question.
...
_Package `swp-ma-hs10-chemistry-u04-l01` · built from `hs912-science-h3` at `e7551b9`._
