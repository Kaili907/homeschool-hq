# Scoring authority — Reteach and varied practice: temperature and reaction rate

**High School Chemistry (Grade 10)** · Unit 7: Reaction Rates and the Conditions That Change Them · Day 8 · lesson `ma-hs10-chemistry-u07-l08`
...
_Topic `ma-hs10-chemistry-u07::temperature and reaction rate` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-hs10-chemistry.correctness.json`._
...
- Higher temperature increases the average kinetic energy of particles, so collisions are both more frequent and more often energetic enough to react.
- The increase in the fraction of sufficiently energetic collisions is the larger of the two effects.
- Temperature affects rate; it does not change whether a reaction is exothermic or endothermic.
...
- Claiming higher temperature works only by making collisions more frequent.
- Claiming raising the temperature changes a reaction from endothermic to exothermic.
- Claiming temperature has no effect on the rate of an exothermic reaction.

**Grade boundary.** Arrhenius plots and quantitative temperature coefficients are beyond this course.


## What a complete response contains, question by question

**Q1 — explain with evidence.** _Serves objective 1:_ Explain temperature and reaction rate using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q2 — apply new task.** _Serves objective 2:_ Apply temperature and reaction rate to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q3 — check revise next step.** _Serves objective 3:_ Check and revise the work on temperature and reaction rate against the stated success criteria and name the next step.
...
**Q4 — essential question.** _Serves objective 2:_ Apply temperature and reaction rate to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q5 — evidence quality.** _Serves objective 1:_ Explain temperature and reaction rate using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q6 — limitation.** _Serves objective 2:_ Apply temperature and reaction rate to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q7 — provenance.** _Serves objective 1:_ Explain temperature and reaction rate using evidence, a model, or a documented process rather than an unsupported answer.
...
- **prerequisite-gap** — Run the prerequisite reteach route for temperature and reaction rate (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for temperature and reaction rate (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for temperature and reaction rate (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for temperature and reaction rate (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for temperature and reaction rate (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs10-chemistry-u07-l08` · built from `hs912-science-h3` at `e7551b9`._
