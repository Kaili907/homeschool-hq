# Scoring authority — Launch and diagnostic: ionic, covalent, and metallic bonding

**High School Chemistry (Grade 10)** · Unit 3: Bonding, Structure, and the Properties of Designed Materials · Day 1 · lesson `ma-hs10-chemistry-u03-l01`
...
_Topic `ma-hs10-chemistry-u03::ionic, covalent, and metallic bonding` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs10-chemistry.correctness.json`._
...
- Named data-source resource: `res-ma-hs10-chemistry-data-sources` (scope: course).
...
**Q1 — phenomenon question.** _Serves objective 1:_ Observe the anchoring phenomenon, surface initial thinking about ionic, covalent, and metallic bonding without penalty, and pose a testable question.
...
**Q7 — limitation.** _Serves objective 3:_ Apply ionic, covalent, and metallic bonding to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q8 — provenance.** _Serves objective 1:_ Observe the anchoring phenomenon, surface initial thinking about ionic, covalent, and metallic bonding without penalty, and pose a testable question.
...
**Mastery rule:** Do not mark mastery from one answer. This course requires independent evidence on at least 2 occasions across at least 2 distinct dates, using explanation, application, retrieval, with transfer to a novel context.
...
- physical: Desk-based work only; no chemicals, heat, electricity, or tools are used in this lesson. — mitigation: Materials are notebook, writing tool, and printed or on-screen text. Any hands-on extension defers to the unit investigation's safety review.
...
**Disposal and clearing up:** Nothing in this lesson produces waste beyond ordinary paper. File or recycle it.
...
_Package `swp-ma-hs10-chemistry-u03-l01` · built from `hs912-science-h3` at `e7551b9`._
