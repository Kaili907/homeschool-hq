# Scoring authority — Performance task build: outermost electron states in reactions

**High School Chemistry (Grade 10)** · Unit 4: Chemical Reactions and Electron Rearrangement · Day 9 · lesson `ma-hs10-chemistry-u04-l09`
...
_Topic `ma-hs10-chemistry-u04::outermost electron states in reactions` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs10-chemistry.correctness.json`._
...
**Q1 — performance evidence.** _Serves objective 1:_ Produce performance-task evidence for outermost electron states in reactions that a reader could check independently.
...
**Q2 — explain with evidence.** _Serves objective 2:_ Explain outermost electron states in reactions using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q3 — apply new task.** _Serves objective 3:_ Apply outermost electron states in reactions to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q4 — check revise next step.** _Serves objective 4:_ Check and revise the work on outermost electron states in reactions against the stated success criteria and name the next step.
...
**Q5 — essential question.** _Serves objective 3:_ Apply outermost electron states in reactions to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q6 — evidence quality.** _Serves objective 2:_ Explain outermost electron states in reactions using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q7 — limitation.** _Serves objective 3:_ Apply outermost electron states in reactions to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q8 — provenance.** _Serves objective 1:_ Produce performance-task evidence for outermost electron states in reactions that a reader could check independently.
...
_Package `swp-ma-hs10-chemistry-u04-l09` · built from `hs912-science-h3` at `e7551b9`._
