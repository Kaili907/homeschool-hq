# Scoring authority — Correction and reflection: criteria, constraints, and trade-offs in chemical engineering

**High School Chemistry (Grade 10)** · Unit 9: The Nucleus, Nuclear Energy, and a Chemistry Engineering Capstone · Day 12 · lesson `ma-hs10-chemistry-u09-l12`
...
_Topic `ma-hs10-chemistry-u09::criteria, constraints, and trade-offs in chemical engineering` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs10-chemistry.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A chemical engineering design is evaluated against stated criteria such as yield, rate, cost, and energy demand, within constraints of safety, waste, and regulation.
- Improving one criterion usually costs something on another, and the design states which trade-off was accepted and why.
- Waste streams and end-of-life handling are part of the design, not a consequence to be addressed afterwards.
...
- Presenting a design as optimal on every criterion simultaneously.
- Omitting waste or safety from the evaluation.
- Declaring a design successful with no criteria stated to judge it against.

**Grade boundary.** Process economics, regulatory compliance procedure, and formal life-cycle assessment are beyond this course.
...
**Q1 — explain with evidence.** _Serves objective 1:_ Explain criteria, constraints, and trade-offs in chemical engineering using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q2 — apply new task.** _Serves objective 2:_ Apply criteria, constraints, and trade-offs in chemical engineering to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q3 — check revise next step.** _Serves objective 3:_ Check and revise the work on criteria, constraints, and trade-offs in chemical engineering against the stated success criteria and name the next step.
...
**Q4 — essential question.** _Serves objective 2:_ Apply criteria, constraints, and trade-offs in chemical engineering to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q5 — evidence quality.** _Serves objective 1:_ Explain criteria, constraints, and trade-offs in chemical engineering using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q6 — limitation.** _Serves objective 2:_ Apply criteria, constraints, and trade-offs in chemical engineering to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q7 — provenance.** _Serves objective 1:_ Explain criteria, constraints, and trade-offs in chemical engineering using evidence, a model, or a documented process rather than an unsupported answer.
...
- **prerequisite-gap** — Run the prerequisite reteach route for criteria, constraints, and trade-offs in chemical engineering (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for criteria, constraints, and trade-offs in chemical engineering (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for criteria, constraints, and trade-offs in chemical engineering (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for criteria, constraints, and trade-offs in chemical engineering (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for criteria, constraints, and trade-offs in chemical engineering (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs10-chemistry-u09-l12` · built from `hs912-science-h3` at `e7551b9`._
