...
- physical: Solutions can become hot enough to burn. — mitigation: Use an insulated cup on a tray, stir with the thermometer rather than a finger, judge temperature only from the thermometer, and stop if the solution exceeds 50 degrees Celsius.
...
- Set the insulated cup on a tray and record the starting temperature before anything is added.
...
_Package `swp-ma-hs10-chemistry-u06-l07` · built from `hs912-science-h3` at `e7551b9`._
