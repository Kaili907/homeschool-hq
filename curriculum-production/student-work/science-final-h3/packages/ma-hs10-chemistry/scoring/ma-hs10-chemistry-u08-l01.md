# Scoring authority — Launch and diagnostic: reversible reactions

**High School Chemistry (Grade 10)** · Unit 8: Equilibrium and the Design of Chemical Systems · Day 1 · lesson `ma-hs10-chemistry-u08-l01`
...
_Topic `ma-hs10-chemistry-u08::reversible reactions` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-hs10-chemistry.correctness.json`._
...
**Q1 — phenomenon question.** _Serves objective 1:_ Observe the anchoring phenomenon, surface initial thinking about reversible reactions without penalty, and pose a testable question.
...
**Q7 — limitation.** _Serves objective 3:_ Apply reversible reactions to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q8 — provenance.** _Serves objective 1:_ Observe the anchoring phenomenon, surface initial thinking about reversible reactions without penalty, and pose a testable question.
...
_Package `swp-ma-hs10-chemistry-u08-l01` · built from `hs912-science-h3` at `e7551b9`._
