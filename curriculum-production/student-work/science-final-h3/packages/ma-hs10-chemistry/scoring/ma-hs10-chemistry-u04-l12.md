# Scoring authority — Correction and reflection: writing and revising explanations

**High School Chemistry (Grade 10)** · Unit 4: Chemical Reactions and Electron Rearrangement · Day 12 · lesson `ma-hs10-chemistry-u04-l12`
...
_Topic `ma-hs10-chemistry-u04::writing and revising explanations` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs10-chemistry.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A chemical explanation connects observation to particle-level behaviour by explicit reasoning.
- Revising an explanation means saying what evidence prompted the change and what the earlier version got wrong.
- An explanation that accounts for the confirming evidence but not the disconfirming evidence is incomplete.
...
- Revising an explanation to fit new evidence without saying what the earlier version failed to account for.
- Presenting an explanation that ignores an observation that contradicts it.
- Describing what was observed and calling it an explanation.

**Grade boundary.** Philosophy of scientific explanation and formal model selection are beyond this course.
...
**Q1 — explain with evidence.** _Serves objective 1:_ Explain writing and revising explanations using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q2 — apply new task.** _Serves objective 2:_ Apply writing and revising explanations to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q3 — check revise next step.** _Serves objective 3:_ Check and revise the work on writing and revising explanations against the stated success criteria and name the next step.
...
**Q4 — essential question.** _Serves objective 2:_ Apply writing and revising explanations to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q5 — evidence quality.** _Serves objective 1:_ Explain writing and revising explanations using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q6 — limitation.** _Serves objective 2:_ Apply writing and revising explanations to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q7 — provenance.** _Serves objective 1:_ Explain writing and revising explanations using evidence, a model, or a documented process rather than an unsupported answer.
...
- **prerequisite-gap** — Run the prerequisite reteach route for writing and revising explanations (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for writing and revising explanations (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for writing and revising explanations (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for writing and revising explanations (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for writing and revising explanations (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs10-chemistry-u04-l12` · built from `hs912-science-h3` at `e7551b9`._
