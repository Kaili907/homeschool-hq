# Scoring authority — Guided practice B: the periodic table as a predictive model

**High School Chemistry (Grade 10)** · Unit 2: Atomic Structure and the Periodic Table as a Model · Day 6 · lesson `ma-hs10-chemistry-u02-l06`
...
_Package `swp-ma-hs10-chemistry-u02-l06` · built from `hs912-science-h3` at `e7551b9`._
