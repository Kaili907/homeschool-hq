# Scoring authority — Independent application A: molar mass and formula mass

**High School Chemistry (Grade 10)** · Unit 5: Conservation of Mass and Quantitative Reasoning in Reactions · Day 4 · lesson `ma-hs10-chemistry-u05-l04`
...
_Topic `ma-hs10-chemistry-u05::molar mass and formula mass` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-hs10-chemistry.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- The molar mass of a substance in grams per mole is numerically equal to its formula or molecular mass in atomic mass units.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Molar mass is calculated by summing the molar masses of the atoms in the formula, each multiplied by its subscript.
- Molar mass converts between mass, which is measurable, and moles, which is what stoichiometry needs.
- The molar mass of an element as listed on the periodic table is a weighted average across its natural isotopes.
...
- Summing atomic masses without applying the subscripts in the formula.
- Claiming the periodic table mass is the mass of a single specified isotope.
- Reporting a molar mass without units, or with units other than mass per mole.

**Grade boundary.** Mass spectrometry and precise isotopic abundance determination are beyond this course.


## What a complete response contains, question by question

**Q1 — explain with evidence.** _Serves objective 1:_ Explain molar mass and formula mass using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q2 — apply new task.** _Serves objective 2:_ Apply molar mass and formula mass to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q3 — check revise next step.** _Serves objective 3:_ Check and revise the work on molar mass and formula mass against the stated success criteria and name the next step.
...
**Q4 — essential question.** _Serves objective 2:_ Apply molar mass and formula mass to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q5 — evidence quality.** _Serves objective 1:_ Explain molar mass and formula mass using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q6 — limitation.** _Serves objective 2:_ Apply molar mass and formula mass to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q7 — provenance.** _Serves objective 1:_ Explain molar mass and formula mass using evidence, a model, or a documented process rather than an unsupported answer.
...
- **prerequisite-gap** — Run the prerequisite reteach route for molar mass and formula mass (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for molar mass and formula mass (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for molar mass and formula mass (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for molar mass and formula mass (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for molar mass and formula mass (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs10-chemistry-u05-l04` · built from `hs912-science-h3` at `e7551b9`._
