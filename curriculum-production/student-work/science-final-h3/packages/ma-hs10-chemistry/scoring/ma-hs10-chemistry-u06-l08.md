# Scoring authority — Reteach and varied practice: exothermic and endothermic processes

**High School Chemistry (Grade 10)** · Unit 6: Energy in Chemical Systems · Day 8 · lesson `ma-hs10-chemistry-u06-l08`
...
_Topic `ma-hs10-chemistry-u06::exothermic and endothermic processes` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs10-chemistry.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- An exothermic process releases energy to the surroundings; an endothermic process absorbs energy from them.

**Accepted relationships and models.** What this lesson's learning target asserts:

- In an exothermic reaction the products are lower in chemical energy than the reactants, and the difference is released to the surroundings.
- In an endothermic reaction the products are higher in chemical energy, and the difference is absorbed from the surroundings.
- The surroundings warming or cooling is the evidence; the reaction system itself is what is being classified.

**Also correct.** Accept any of these framings — do not require the wording above:

- Energy diagrams, enthalpy sign conventions, and plain descriptions of energy released or absorbed are all correct.
...
- Claiming an endothermic reaction produces cold rather than absorbing energy.
- Claiming an exothermic reaction creates energy.
- Confusing the reaction being exothermic with the reaction being fast or spontaneous.

**Grade boundary.** Gibbs free energy and spontaneity criteria are beyond this course.
...
**Q1 — explain with evidence.** _Serves objective 1:_ Explain exothermic and endothermic processes using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q2 — apply new task.** _Serves objective 2:_ Apply exothermic and endothermic processes to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q3 — check revise next step.** _Serves objective 3:_ Check and revise the work on exothermic and endothermic processes against the stated success criteria and name the next step.
...
**Q4 — essential question.** _Serves objective 2:_ Apply exothermic and endothermic processes to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q5 — evidence quality.** _Serves objective 1:_ Explain exothermic and endothermic processes using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q6 — limitation.** _Serves objective 2:_ Apply exothermic and endothermic processes to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q7 — provenance.** _Serves objective 1:_ Explain exothermic and endothermic processes using evidence, a model, or a documented process rather than an unsupported answer.
...
- **prerequisite-gap** — Run the prerequisite reteach route for exothermic and endothermic processes (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for exothermic and endothermic processes (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for exothermic and endothermic processes (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for exothermic and endothermic processes (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for exothermic and endothermic processes (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs10-chemistry-u06-l08` · built from `hs912-science-h3` at `e7551b9`._
