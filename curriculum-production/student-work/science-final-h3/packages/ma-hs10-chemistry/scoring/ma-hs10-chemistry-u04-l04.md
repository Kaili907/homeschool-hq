# Scoring authority — Independent application A: oxidation and reduction basics

**High School Chemistry (Grade 10)** · Unit 4: Chemical Reactions and Electron Rearrangement · Day 4 · lesson `ma-hs10-chemistry-u04-l04`
...
_Topic `ma-hs10-chemistry-u04::oxidation and reduction basics` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs10-chemistry.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Oxidation is loss of electrons; reduction is gain of electrons.
- Oxidation and reduction always occur together: electrons lost by one species are gained by another.

**Accepted relationships and models.** What this lesson's learning target asserts:

- In a redox reaction, the species oxidised is the reducing agent and the species reduced is the oxidising agent.
- Because electrons are conserved, the electrons lost in the oxidation equal the electrons gained in the reduction.
- Combustion, corrosion, and electrochemical cells are all redox processes.

**Also correct.** Accept any of these framings — do not require the wording above:

- The mnemonics for loss and gain of electrons, and descriptions in terms of oxidation number changes, are equally correct.
...
- Claiming oxidation is gain of electrons or reduction is loss of electrons.
- Claiming oxidation can occur without a corresponding reduction.
- Claiming oxidation requires the presence of oxygen.

**Grade boundary.** Standard electrode potentials, Nernst equation, and balancing redox in acidic or basic solution are beyond this course.
...
**Q1 — explain with evidence.** _Serves objective 1:_ Explain oxidation and reduction basics using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q2 — apply new task.** _Serves objective 2:_ Apply oxidation and reduction basics to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q3 — check revise next step.** _Serves objective 3:_ Check and revise the work on oxidation and reduction basics against the stated success criteria and name the next step.
...
**Q4 — essential question.** _Serves objective 2:_ Apply oxidation and reduction basics to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q5 — evidence quality.** _Serves objective 1:_ Explain oxidation and reduction basics using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q6 — limitation.** _Serves objective 2:_ Apply oxidation and reduction basics to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q7 — provenance.** _Serves objective 1:_ Explain oxidation and reduction basics using evidence, a model, or a documented process rather than an unsupported answer.
...
- **prerequisite-gap** — Run the prerequisite reteach route for oxidation and reduction basics (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for oxidation and reduction basics (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for oxidation and reduction basics (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for oxidation and reduction basics (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for oxidation and reduction basics (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs10-chemistry-u04-l04` · built from `hs912-science-h3` at `e7551b9`._
