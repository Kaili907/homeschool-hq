# Scoring authority — Concept model B: yield and industrial trade-offs

**High School Chemistry (Grade 10)** · Unit 8: Equilibrium and the Design of Chemical Systems · Day 5 · lesson `ma-hs10-chemistry-u08-l05`
...
**Q1 — explain with evidence.** _Serves objective 1:_ Explain yield and industrial trade-offs using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q2 — apply new task.** _Serves objective 2:_ Apply yield and industrial trade-offs to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q3 — check revise next step.** _Serves objective 3:_ Check and revise the work on yield and industrial trade-offs against the stated success criteria and name the next step.
...
**Q4 — essential question.** _Serves objective 2:_ Apply yield and industrial trade-offs to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q5 — evidence quality.** _Serves objective 1:_ Explain yield and industrial trade-offs using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q6 — limitation.** _Serves objective 2:_ Apply yield and industrial trade-offs to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q7 — provenance.** _Serves objective 1:_ Explain yield and industrial trade-offs using evidence, a model, or a documented process rather than an unsupported answer.
...
_Package `swp-ma-hs10-chemistry-u08-l05` · built from `hs912-science-h3` at `e7551b9`._
