# Scoring authority — Investigation: conservation of atoms and mass

**High School Chemistry (Grade 10)** · Unit 5: Conservation of Mass and Quantitative Reasoning in Reactions · Day 7 · lesson `ma-hs10-chemistry-u05-l07`
...
_Topic `ma-hs10-chemistry-u05::conservation of atoms and mass` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-hs10-chemistry.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- The number of atoms of each element is identical before and after a chemical reaction, so mass is conserved.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Atoms are neither created nor destroyed in chemical reactions; they are rearranged among substances.
- Conservation of atoms is the reason chemical equations must balance and the reason mass calculations work.
- An apparent mass change in an open system means matter crossed the system boundary, most often as a gas.
...
- Claiming mass is lost during combustion without accounting for oxygen consumed and gases released.
- Claiming atoms are created or destroyed in a chemical reaction.
- Concluding that mass is not conserved from an open-container measurement.

**Grade boundary.** Mass-energy equivalence, which does apply to nuclear reactions, is unit 9 work.
...
**Q1 — investigate.** _Serves objective 1:_ Plan and carry out a safe investigation of conservation of atoms and mass, or its stated alternative, and record the learner's own data with its uncertainty.
...
**Q2 — explain with evidence.** _Serves objective 2:_ Explain conservation of atoms and mass using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q3 — apply new task.** _Serves objective 3:_ Apply conservation of atoms and mass to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q4 — check revise next step.** _Serves objective 4:_ Check and revise the work on conservation of atoms and mass against the stated success criteria and name the next step.
...
**Q5 — essential question.** _Serves objective 3:_ Apply conservation of atoms and mass to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q6 — evidence quality.** _Serves objective 2:_ Explain conservation of atoms and mass using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q7 — limitation.** _Serves objective 1:_ Plan and carry out a safe investigation of conservation of atoms and mass, or its stated alternative, and record the learner's own data with its uncertainty.
...
**Q8 — provenance.** _Serves objective 1:_ Plan and carry out a safe investigation of conservation of atoms and mass, or its stated alternative, and record the learner's own data with its uncertainty.
...
- **prerequisite-gap** — Run the prerequisite reteach route for conservation of atoms and mass (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for conservation of atoms and mass (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for conservation of atoms and mass (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for conservation of atoms and mass (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for conservation of atoms and mass (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs10-chemistry-u05-l07` · built from `hs912-science-h3` at `e7551b9`._
