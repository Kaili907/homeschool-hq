...
- disposable cups for the calcium chloride route - one standing inside a second for insulation - binned after a single use; no mug, tumbler, flask, bottle, or drinking cup ever holds calcium chloride
...
- **Physical hazard.** Solutions can become hot enough to burn.
  - What stops it: Use an insulated cup on a tray, stir with the thermometer rather than a finger, judge temperature only from the thermometer, and stop if the solution exceeds 50 degrees Celsius.
...
_Package `swp-ma-hs10-chemistry-u06-l07` · lesson `ma-hs10-chemistry-u06-l07` · built from `hs912-science-h3` at `e7551b9`. No observation, measurement, or expected result is supplied anywhere in this sheet._
