# Scoring authority — Launch and diagnostic: exponential and logistic growth

**High School Biology (Grade 9)** · Unit 7: Population Dynamics, Carrying Capacity, and Biodiversity · Day 1 · lesson `ma-hs9-biology-u07-l01`
...
_Topic `ma-hs9-biology-u07::exponential and logistic growth` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs9-biology.correctness.json`._
...
**Q1 — phenomenon question.** _Serves objective 1:_ Observe the anchoring phenomenon, surface initial thinking about exponential and logistic growth without penalty, and pose a testable question.
...
**Q7 — limitation.** _Serves objective 3:_ Apply exponential and logistic growth to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q8 — provenance.** _Serves objective 1:_ Observe the anchoring phenomenon, surface initial thinking about exponential and logistic growth without penalty, and pose a testable question.
...
_Package `swp-ma-hs9-biology-u07-l01` · built from `hs912-science-h3` at `e7551b9`._
