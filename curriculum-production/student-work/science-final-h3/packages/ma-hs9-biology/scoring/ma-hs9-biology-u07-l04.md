# Scoring authority — Independent application A: biodiversity measurement

**High School Biology (Grade 9)** · Unit 7: Population Dynamics, Carrying Capacity, and Biodiversity · Day 4 · lesson `ma-hs9-biology-u07-l04`
...
_Topic `ma-hs9-biology-u07::biodiversity measurement` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs9-biology.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Biodiversity measures include the number of species present and how evenly individuals are distributed among them.
- A measurement depends on the area sampled, the effort spent, and the method used, so figures are comparable only when those match.
- Genetic diversity within species and diversity of ecosystems are also components of biodiversity.

**Also correct.** Accept any of these framings — do not require the wording above:

- Species richness and species evenness are distinct measures, and either or both may be reported.
...
- Comparing biodiversity figures from different sampling areas or methods as though they were equivalent.
- Treating species richness as the whole of biodiversity.
- Claiming an unsampled species is absent.

**Grade boundary.** Diversity indices, rarefaction curves, and estimator statistics are beyond this course.
...
**Q1 — explain with evidence.** _Serves objective 1:_ Explain biodiversity measurement using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q2 — apply new task.** _Serves objective 2:_ Apply biodiversity measurement to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q3 — check revise next step.** _Serves objective 3:_ Check and revise the work on biodiversity measurement against the stated success criteria and name the next step.
...
**Q4 — essential question.** _Serves objective 2:_ Apply biodiversity measurement to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q5 — evidence quality.** _Serves objective 1:_ Explain biodiversity measurement using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q6 — limitation.** _Serves objective 2:_ Apply biodiversity measurement to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q7 — provenance.** _Serves objective 1:_ Explain biodiversity measurement using evidence, a model, or a documented process rather than an unsupported answer.
...
- **prerequisite-gap** — Run the prerequisite reteach route for biodiversity measurement (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for biodiversity measurement (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for biodiversity measurement (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for biodiversity measurement (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for biodiversity measurement (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs9-biology-u07-l04` · built from `hs912-science-h3` at `e7551b9`._
