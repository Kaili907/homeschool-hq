# Scoring authority — Launch and diagnostic: setpoints and tolerance ranges

**High School Biology (Grade 9)** · Unit 4: Homeostasis and Feedback Mechanisms · Day 1 · lesson `ma-hs9-biology-u04-l01`
...
_Topic `ma-hs9-biology-u04::setpoints and tolerance ranges` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs9-biology.correctness.json`._
...
**Q1 — phenomenon question.** _Serves objective 1:_ Observe the anchoring phenomenon, surface initial thinking about setpoints and tolerance ranges without penalty, and pose a testable question.
...
**Q7 — limitation.** _Serves objective 3:_ Apply setpoints and tolerance ranges to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q8 — provenance.** _Serves objective 1:_ Observe the anchoring phenomenon, surface initial thinking about setpoints and tolerance ranges without penalty, and pose a testable question.
...
_Package `swp-ma-hs9-biology-u04-l01` · built from `hs912-science-h3` at `e7551b9`._
