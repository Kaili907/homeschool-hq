# Scoring authority — Concept model B: polygenic and environmental effects

**High School Biology (Grade 9)** · Unit 8: Inheritance and Variation of Traits · Day 5 · lesson `ma-hs9-biology-u08-l05`
...
**Q1 — explain with evidence.** _Serves objective 1:_ Explain polygenic and environmental effects using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q2 — apply new task.** _Serves objective 2:_ Apply polygenic and environmental effects to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q3 — check revise next step.** _Serves objective 3:_ Check and revise the work on polygenic and environmental effects against the stated success criteria and name the next step.
...
**Q4 — essential question.** _Serves objective 2:_ Apply polygenic and environmental effects to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q5 — evidence quality.** _Serves objective 1:_ Explain polygenic and environmental effects using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q6 — limitation.** _Serves objective 2:_ Apply polygenic and environmental effects to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q7 — provenance.** _Serves objective 1:_ Explain polygenic and environmental effects using evidence, a model, or a documented process rather than an unsupported answer.
...
_Package `swp-ma-hs9-biology-u08-l05` · built from `hs912-science-h3` at `e7551b9`._
