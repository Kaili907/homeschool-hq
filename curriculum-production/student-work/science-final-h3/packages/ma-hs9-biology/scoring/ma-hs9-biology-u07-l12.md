# Scoring authority — Correction and reflection: group behaviour and survival

**High School Biology (Grade 9)** · Unit 7: Population Dynamics, Carrying Capacity, and Biodiversity · Day 12 · lesson `ma-hs9-biology-u07-l12`
...
_Topic `ma-hs9-biology-u07::group behaviour and survival` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs9-biology.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Group behaviours such as flocking, herding, cooperative hunting, and colonial nesting can increase individual survival and reproductive success.
- Group living also imposes costs, including competition within the group and faster transmission of disease and parasites.
- Whether group behaviour is favoured depends on the balance of those costs and benefits in the specific environment.
...
- Claiming group behaviour evolves for the good of the species irrespective of effects on individuals.
- Claiming group living carries benefits with no costs.
- Claiming animals adopt group behaviour because they understand its advantages.

**Grade boundary.** Kin selection, inclusive fitness calculations, and game-theoretic models are beyond this course.
...
**Q1 — explain with evidence.** _Serves objective 1:_ Explain group behaviour and survival using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q2 — apply new task.** _Serves objective 2:_ Apply group behaviour and survival to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q3 — check revise next step.** _Serves objective 3:_ Check and revise the work on group behaviour and survival against the stated success criteria and name the next step.
...
**Q4 — essential question.** _Serves objective 2:_ Apply group behaviour and survival to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q5 — evidence quality.** _Serves objective 1:_ Explain group behaviour and survival using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q6 — limitation.** _Serves objective 2:_ Apply group behaviour and survival to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q7 — provenance.** _Serves objective 1:_ Explain group behaviour and survival using evidence, a model, or a documented process rather than an unsupported answer.
...
- **prerequisite-gap** — Run the prerequisite reteach route for group behaviour and survival (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for group behaviour and survival (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for group behaviour and survival (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for group behaviour and survival (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for group behaviour and survival (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs9-biology-u07-l12` · built from `hs912-science-h3` at `e7551b9`._
