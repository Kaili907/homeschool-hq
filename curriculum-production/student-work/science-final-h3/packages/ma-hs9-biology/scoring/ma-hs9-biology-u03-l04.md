# Scoring authority — Independent application A: the cell cycle and mitosis

**High School Biology (Grade 9)** · Unit 3: Cells, Hierarchical Organization, and Cellular Division · Day 4 · lesson `ma-hs9-biology-u03-l04`
...
_Topic `ma-hs9-biology-u03::the cell cycle and mitosis` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs9-biology.correctness.json`._
...
- DNA is replicated during interphase, before mitosis begins.

**Accepted relationships and models.** What this lesson's learning target asserts:

- The cell cycle consists of interphase, during which the cell grows and replicates its DNA, followed by division.
- Mitosis distributes one complete copy of the replicated chromosomes to each daughter cell, so chromosome number is maintained.
- Checkpoints regulate progression, and loss of that regulation underlies uncontrolled division.

**Also correct.** Accept any of these framings — do not require the wording above:

- Naming the mitotic stages is correct but not required; describing the outcome accurately is what matters here.
...
- Claiming mitosis halves the chromosome number.
- Claiming DNA is replicated during mitosis itself rather than during interphase.
- Claiming mitosis produces genetically varied daughter cells.

**Grade boundary.** Cyclin and checkpoint kinase biochemistry, and cancer genetics, are beyond this course.
...
**Q1 — explain with evidence.** _Serves objective 1:_ Explain the cell cycle and mitosis using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q2 — apply new task.** _Serves objective 2:_ Apply the cell cycle and mitosis to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q3 — check revise next step.** _Serves objective 3:_ Check and revise the work on the cell cycle and mitosis against the stated success criteria and name the next step.
...
**Q4 — essential question.** _Serves objective 2:_ Apply the cell cycle and mitosis to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q5 — evidence quality.** _Serves objective 1:_ Explain the cell cycle and mitosis using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q6 — limitation.** _Serves objective 2:_ Apply the cell cycle and mitosis to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q7 — provenance.** _Serves objective 1:_ Explain the cell cycle and mitosis using evidence, a model, or a documented process rather than an unsupported answer.
...
- **prerequisite-gap** — Run the prerequisite reteach route for the cell cycle and mitosis (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for the cell cycle and mitosis (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for the cell cycle and mitosis (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for the cell cycle and mitosis (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for the cell cycle and mitosis (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs9-biology-u03-l04` · built from `hs912-science-h3` at `e7551b9`._
