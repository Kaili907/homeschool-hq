# Scoring authority — Investigation: light energy capture

**High School Biology (Grade 9)** · Unit 5: Photosynthesis, Cellular Respiration, and Energy in Living Systems · Day 7 · lesson `ma-hs9-biology-u05-l07`
...
_Topic `ma-hs9-biology-u05::light energy capture` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs9-biology.correctness.json`._
...
**Q1 — investigate.** _Serves objective 1:_ Plan and carry out a safe investigation of light energy capture, or its stated alternative, and record the learner's own data with its uncertainty.
...
**Q7 — limitation.** _Serves objective 1:_ Plan and carry out a safe investigation of light energy capture, or its stated alternative, and record the learner's own data with its uncertainty.
...
**Q8 — provenance.** _Serves objective 1:_ Plan and carry out a safe investigation of light energy capture, or its stated alternative, and record the learner's own data with its uncertainty.
...
_Package `swp-ma-hs9-biology-u05-l07` · built from `hs912-science-h3` at `e7551b9`._
