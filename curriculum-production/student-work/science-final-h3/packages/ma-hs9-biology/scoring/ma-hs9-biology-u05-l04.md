# Scoring authority — Independent application A: aerobic and anaerobic pathways

**High School Biology (Grade 9)** · Unit 5: Photosynthesis, Cellular Respiration, and Energy in Living Systems · Day 4 · lesson `ma-hs9-biology-u05-l04`
...
_Topic `ma-hs9-biology-u05::aerobic and anaerobic pathways` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs9-biology.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Anaerobic pathways yield far less ATP per glucose molecule than aerobic respiration.

**Accepted relationships and models.** What this lesson's learning target asserts:

- When oxygen is unavailable, cells use anaerobic pathways such as lactic acid fermentation or alcoholic fermentation.
- Fermentation regenerates the molecules glycolysis needs to continue, which is why it allows ATP production to keep going.
- The far lower ATP yield is why anaerobic activity cannot be sustained for long at high demand.

**Also correct.** Accept any of these framings — do not require the wording above:

- Describing fermentation's role as regenerating NAD+, or as allowing glycolysis to continue, are both correct.
...
- Claiming fermentation produces more ATP than aerobic respiration.
- Claiming fermentation produces no ATP at all.
- Claiming lactic acid accumulation is what causes delayed-onset muscle soreness.

**Grade boundary.** Detailed fermentation biochemistry and exercise physiology are beyond this course.
...
**Q1 — explain with evidence.** _Serves objective 1:_ Explain aerobic and anaerobic pathways using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q2 — apply new task.** _Serves objective 2:_ Apply aerobic and anaerobic pathways to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q3 — check revise next step.** _Serves objective 3:_ Check and revise the work on aerobic and anaerobic pathways against the stated success criteria and name the next step.
...
**Q4 — essential question.** _Serves objective 2:_ Apply aerobic and anaerobic pathways to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q5 — evidence quality.** _Serves objective 1:_ Explain aerobic and anaerobic pathways using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q6 — limitation.** _Serves objective 2:_ Apply aerobic and anaerobic pathways to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q7 — provenance.** _Serves objective 1:_ Explain aerobic and anaerobic pathways using evidence, a model, or a documented process rather than an unsupported answer.
...
- **prerequisite-gap** — Run the prerequisite reteach route for aerobic and anaerobic pathways (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for aerobic and anaerobic pathways (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for aerobic and anaerobic pathways (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for aerobic and anaerobic pathways (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for aerobic and anaerobic pathways (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs9-biology-u05-l04` · built from `hs912-science-h3` at `e7551b9`._
