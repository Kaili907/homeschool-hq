# Scoring authority — Reteach and varied practice: uncertainty and repeated trials

**High School Biology (Grade 9)** · Unit 1: Scientific Practice, Measurement, and the Molecules of Life · Day 8 · lesson `ma-hs9-biology-u01-l08`
...
_Topic `ma-hs9-biology-u01::uncertainty and repeated trials` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-hs9-biology.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Repeated trials estimate how much a measurement varies, which is what makes a difference between conditions interpretable.
- Biological variation between individuals is real variation, not measurement error, and the two are reported separately.
- A difference smaller than the spread within a condition is not evidence of an effect.

**Also correct.** Accept any of these framings — do not require the wording above:

- Reporting a range, a mean with a spread, or individual trial values are all acceptable at this level.
...
- Claiming an effect from a difference smaller than the variation between replicates.
- Treating biological variation between individuals as experimental error to be eliminated.
- Reporting a mean with no indication of the spread or the number of trials.

**Grade boundary.** Formal statistical tests, confidence intervals, and power analysis are beyond this course.
...
_Package `swp-ma-hs9-biology-u01-l08` · built from `hs912-science-h3` at `e7551b9`._
