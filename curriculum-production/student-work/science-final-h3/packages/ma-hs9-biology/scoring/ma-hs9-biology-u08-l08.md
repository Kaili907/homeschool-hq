# Scoring authority — Reteach and varied practice: meiosis and recombination

**High School Biology (Grade 9)** · Unit 8: Inheritance and Variation of Traits · Day 8 · lesson `ma-hs9-biology-u08-l08`
...
_Topic `ma-hs9-biology-u08::meiosis and recombination` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-hs9-biology.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Meiosis halves the chromosome number and produces four genetically distinct haploid cells from one diploid cell.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Meiosis involves two divisions after a single round of DNA replication, which is why the chromosome number is halved.
- Crossing over between homologous chromosomes, and the independent assortment of homologous pairs, produce genetically distinct gametes.
- Fertilisation restores the diploid number and adds a further source of combination.
...
- Claiming meiosis produces two genetically identical daughter cells.
- Claiming meiosis maintains the chromosome number rather than halving it.
- Claiming DNA is replicated between the first and second meiotic divisions.

**Grade boundary.** Synaptonemal complex biology and nondisjunction mechanisms in detail are beyond this course.


## What a complete response contains, question by question

**Q1 — explain with evidence.** _Serves objective 1:_ Explain meiosis and recombination using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q2 — apply new task.** _Serves objective 2:_ Apply meiosis and recombination to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q3 — check revise next step.** _Serves objective 3:_ Check and revise the work on meiosis and recombination against the stated success criteria and name the next step.
...
**Q4 — essential question.** _Serves objective 2:_ Apply meiosis and recombination to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q5 — evidence quality.** _Serves objective 1:_ Explain meiosis and recombination using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q6 — limitation.** _Serves objective 2:_ Apply meiosis and recombination to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q7 — provenance.** _Serves objective 1:_ Explain meiosis and recombination using evidence, a model, or a documented process rather than an unsupported answer.
...
- **prerequisite-gap** — Run the prerequisite reteach route for meiosis and recombination (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for meiosis and recombination (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for meiosis and recombination (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for meiosis and recombination (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for meiosis and recombination (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs9-biology-u08-l08` · built from `hs912-science-h3` at `e7551b9`._
