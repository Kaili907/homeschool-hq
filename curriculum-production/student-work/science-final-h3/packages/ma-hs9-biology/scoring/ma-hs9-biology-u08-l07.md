# Scoring authority — Investigation: chromosomes and gene loci

**High School Biology (Grade 9)** · Unit 8: Inheritance and Variation of Traits · Day 7 · lesson `ma-hs9-biology-u08-l07`
...
_Topic `ma-hs9-biology-u08::chromosomes and gene loci` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-hs9-biology.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- A gene occupies a specific locus on a specific chromosome, and different versions of a gene at that locus are alleles.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Genes occupy fixed positions on chromosomes, and homologous chromosomes carry the same genes at the same loci.
- Diploid organisms carry two copies of each locus, one from each parent, and those copies may be the same allele or different alleles.
...
- Using gene and allele as interchangeable terms.
- Claiming homologous chromosomes carry identical DNA sequences.
- Claiming every gene is on a different chromosome from every other.

**Grade boundary.** Linkage mapping, recombination frequencies, and chromosome banding are beyond this course.
...
**Q1 — investigate.** _Serves objective 1:_ Plan and carry out a safe investigation of chromosomes and gene loci, or its stated alternative, and record the learner's own data with its uncertainty.
...
**Q2 — explain with evidence.** _Serves objective 2:_ Explain chromosomes and gene loci using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q3 — apply new task.** _Serves objective 3:_ Apply chromosomes and gene loci to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q4 — check revise next step.** _Serves objective 4:_ Check and revise the work on chromosomes and gene loci against the stated success criteria and name the next step.
...
**Q5 — essential question.** _Serves objective 3:_ Apply chromosomes and gene loci to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q6 — evidence quality.** _Serves objective 2:_ Explain chromosomes and gene loci using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q7 — limitation.** _Serves objective 1:_ Plan and carry out a safe investigation of chromosomes and gene loci, or its stated alternative, and record the learner's own data with its uncertainty.
...
**Q8 — provenance.** _Serves objective 1:_ Plan and carry out a safe investigation of chromosomes and gene loci, or its stated alternative, and record the learner's own data with its uncertainty.
...
- **prerequisite-gap** — Run the prerequisite reteach route for chromosomes and gene loci (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for chromosomes and gene loci (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for chromosomes and gene loci (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for chromosomes and gene loci (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for chromosomes and gene loci (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs9-biology-u08-l07` · built from `hs912-science-h3` at `e7551b9`._
