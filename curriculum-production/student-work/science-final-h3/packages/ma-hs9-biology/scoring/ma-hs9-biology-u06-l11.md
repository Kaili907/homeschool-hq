# Scoring authority — Unit assessment: decomposition

**High School Biology (Grade 9)** · Unit 6: Ecosystems: Matter Cycling and Energy Flow · Day 11 · lesson `ma-hs9-biology-u06-l11`
...
_Topic `ma-hs9-biology-u06::decomposition` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs9-biology.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Decomposers break down dead organisms and waste, returning elements to soil, water, and air in forms producers can use.
- Decomposition rate depends on temperature, moisture, oxygen availability, and the material itself.
- Without decomposition, matter would remain locked in dead material and nutrient cycling would halt.

**Also correct.** Accept any of these framings — do not require the wording above:

- Naming bacteria, fungi, and detritivores as the agents are all correct.
...
- Claiming dead material disappears without any organism acting on it.
- Claiming decomposers are outside the ecosystem's energy and matter flows.
- Claiming decomposition proceeds at the same rate in all conditions.

**Grade boundary.** Soil biogeochemistry and litter decomposition modelling are beyond this course.
...
**Q1 — mastery fresh task.** _Serves objective 1:_ Demonstrate independent mastery evidence for decomposition on a fresh task.
...
**Q2 — explain with evidence.** _Serves objective 2:_ Explain decomposition using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q3 — apply new task.** _Serves objective 3:_ Apply decomposition to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q4 — check revise next step.** _Serves objective 4:_ Check and revise the work on decomposition against the stated success criteria and name the next step.
...
**Q5 — essential question.** _Serves objective 3:_ Apply decomposition to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q6 — evidence quality.** _Serves objective 2:_ Explain decomposition using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q7 — limitation.** _Serves objective 3:_ Apply decomposition to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q8 — provenance.** _Serves objective 1:_ Demonstrate independent mastery evidence for decomposition on a fresh task.
...
- **prerequisite-gap** — Run the prerequisite reteach route for decomposition (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for decomposition (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for decomposition (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for decomposition (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for decomposition (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs9-biology-u06-l11` · built from `hs912-science-h3` at `e7551b9`._
