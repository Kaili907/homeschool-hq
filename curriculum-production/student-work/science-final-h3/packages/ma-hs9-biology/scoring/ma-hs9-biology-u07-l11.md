# Scoring authority — Unit assessment: ecosystem resilience and disturbance

**High School Biology (Grade 9)** · Unit 7: Population Dynamics, Carrying Capacity, and Biodiversity · Day 11 · lesson `ma-hs9-biology-u07-l11`
...
_Topic `ma-hs9-biology-u07::ecosystem resilience and disturbance` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT`, `SUPPLIED_DATA_ANSWER_AUTHORITY` · authored in `policy/correctness/ma-hs9-biology.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Disturbance is a normal component of ecosystem dynamics, and many communities depend on it.
- Resilience is the capacity to recover ecosystem function after disturbance, and it generally rises with biodiversity.
- Severe or repeated disturbance can shift an ecosystem into a different state that does not return on its own.
...
- Claiming all disturbance damages ecosystems.
- Claiming an ecosystem always returns to its prior state after disturbance.
- Claiming resilience means the ecosystem is unchanged by disturbance.

**Grade boundary.** Alternative stable state theory and quantitative resilience metrics are beyond this course.
...
**Q1 — mastery fresh task.** _Serves objective 1:_ Demonstrate independent mastery evidence for ecosystem resilience and disturbance on a fresh task.
...
**Q2 — explain with evidence.** _Serves objective 2:_ Explain ecosystem resilience and disturbance using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q3 — apply new task.** _Serves objective 3:_ Apply ecosystem resilience and disturbance to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q4 — check revise next step.** _Serves objective 4:_ Check and revise the work on ecosystem resilience and disturbance against the stated success criteria and name the next step.
...
**Q5 — essential question.** _Serves objective 3:_ Apply ecosystem resilience and disturbance to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q6 — evidence quality.** _Serves objective 2:_ Explain ecosystem resilience and disturbance using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q7 — limitation.** _Serves objective 3:_ Apply ecosystem resilience and disturbance to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q8 — provenance.** _Serves objective 1:_ Demonstrate independent mastery evidence for ecosystem resilience and disturbance on a fresh task.
...
- **prerequisite-gap** — Run the prerequisite reteach route for ecosystem resilience and disturbance (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for ecosystem resilience and disturbance (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for ecosystem resilience and disturbance (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for ecosystem resilience and disturbance (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for ecosystem resilience and disturbance (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs9-biology-u07-l11` · built from `hs912-science-h3` at `e7551b9`._
