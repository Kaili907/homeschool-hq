# Scoring authority — Correction and reflection: comparing communication solutions

**Grade 4 Science** · Unit 5: Waves and Information · Day 12 · lesson `ma-g4-science-u05-l12`
...
_Topic `ma-g4-science-u05::comparing communication solutions` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Communication solutions are compared on how reliably, how far, and how quickly they carry the message, and on what they cost or require.
- A solution that works well in one setting can fail in another, so the setting is part of the comparison.
- The comparison uses the same criteria for every option.
...
- Declaring one method best without naming the criteria or the setting.
- Ignoring a failure mode because it did not appear in the one test run.
- Comparing options that were tested under different conditions.

**Grade boundary.** Signal-to-noise reasoning and quantitative reliability are later work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for comparing communication solutions, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of comparing communication solutions.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about comparing communication solutions using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for comparing communication solutions, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of comparing communication solutions.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for comparing communication solutions, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of comparing communication solutions.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for comparing communication solutions, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for comparing communication solutions works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of comparing communication solutions, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking comparing communication solutions mastered.
- **requests an experiment** — Explain the science and the safety rule for comparing communication solutions; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g4-science-u05-l12` · built from `g34-committed` at `4c6ca4e`._
