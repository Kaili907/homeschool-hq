# Scoring authority — Unit assessment: testing and refining

**Grade 4 Science** · Unit 4: Designing an Energy Converter · Day 11 · lesson `ma-g4-science-u04-l11`
...
_Topic `ma-g4-science-u04::testing and refining` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A test changes one thing at a time so an improvement can be attributed to a particular change.
- A failed test is evidence about the design and is the normal route to a better one.
- Refinement is judged against the original criteria, not against how much effort the change took.
...
- Changing several things between tests and crediting the improvement to one of them.
- Discarding a test result because it was disappointing.
- Declaring the design improved without retesting it against the criteria.
...
**Q1 — demonstrate mastery.** _Serves objective 1:_ Demonstrate current mastery of testing and refining through selected-response, constructed-response, and applied evidence.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of testing and refining.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about testing and refining using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Demonstrate current mastery of testing and refining through selected-response, constructed-response, and applied evidence.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of testing and refining.
...
**Q6 — limitation.** _Serves objective 1:_ Demonstrate current mastery of testing and refining through selected-response, constructed-response, and applied evidence.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of testing and refining.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for testing and refining, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for testing and refining works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of testing and refining, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking testing and refining mastered.
- **requests an experiment** — Explain the science and the safety rule for testing and refining; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g4-science-u04-l11` · built from `g34-committed` at `4c6ca4e`._
