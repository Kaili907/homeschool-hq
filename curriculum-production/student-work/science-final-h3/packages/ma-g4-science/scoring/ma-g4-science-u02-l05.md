# Scoring authority — Concept model B: predicting outcomes

**Grade 4 Science** · Unit 2: Energy and Speed · Day 5 · lesson `ma-g4-science-u02-l05`
...
**Q1 — model build.** _Serves objective 1:_ Build a clear mental model of predicting outcomes through an explicit worked example, demonstration, text, or phenomenon.
...
**Q4 — essential question.** _Serves objective 1:_ Build a clear mental model of predicting outcomes through an explicit worked example, demonstration, text, or phenomenon.
...
**Q6 — limitation.** _Serves objective 1:_ Build a clear mental model of predicting outcomes through an explicit worked example, demonstration, text, or phenomenon.
...
_Package `swp-ma-g4-science-u02-l05` · built from `g34-committed` at `4c6ca4e`._
