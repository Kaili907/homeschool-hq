# Scoring authority — Reteach and varied practice: fossils in rock layers

**Grade 4 Science** · Unit 8: Earth's Changing Landscape · Day 8 · lesson `ma-g4-science-u08-l08`
...
_Topic `ma-g4-science-u08::fossils in rock layers` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Fossils in rock layers are evidence of the organisms that lived when those layers were forming.
- Different layers often contain different fossils, which is evidence that the living things in a place changed over time.
- Fossils of organisms that lived in water, found in layers now far from water, are evidence that the environment there has changed.
...
- Dating a fossil by when it was collected rather than by the layer it came from.
- Claiming absence of a fossil proves the organism never lived there.
- Claiming the environment at a place has always been what it is today.

**Grade boundary.** Index fossils, biostratigraphy, and absolute dating are later work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for fossils in rock layers, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of fossils in rock layers.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about fossils in rock layers using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for fossils in rock layers, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of fossils in rock layers.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for fossils in rock layers, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of fossils in rock layers.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for fossils in rock layers, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for fossils in rock layers works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of fossils in rock layers, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking fossils in rock layers mastered.
- **requests an experiment** — Explain the science and the safety rule for fossils in rock layers; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g4-science-u08-l08` · built from `g34-committed` at `4c6ca4e`._
