# Scoring authority — Investigation or close reading: sound energy

**Grade 4 Science** · Unit 3: Energy Transfer · Day 7 · lesson `ma-g4-science-u03-l07`
...
_Topic `ma-g4-science-u03::sound energy` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Sound is produced by vibrating matter and needs matter to travel through.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Sound is produced when matter vibrates, and the vibration passes through the material around it.
- Sound travels through solids, liquids, and gases; it cannot travel through empty space.
- A larger vibration carries more energy and is heard as a louder sound.

**Also correct.** Accept any of these framings — do not require the wording above:

- Describing sound as a vibration passing through matter, or as a wave in matter, are both correct.
...
- Claiming sound travels through a vacuum.
- Claiming sound is made without anything vibrating.
- Claiming loudness comes from how fast the sound travels.

**Grade boundary.** Frequency and pitch as a formal relationship, the speed of sound in named materials, and wave equations are later work.
...
**Q1 — analyze evidence.** _Serves objective 1:_ Gather and analyze evidence related to sound energy, then record a defensible interpretation.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of sound energy.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about sound energy using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Gather and analyze evidence related to sound energy, then record a defensible interpretation.
...
**Q5 — evidence quality.** _Serves objective 1:_ Gather and analyze evidence related to sound energy, then record a defensible interpretation.
...
**Q6 — limitation.** _Serves objective 1:_ Gather and analyze evidence related to sound energy, then record a defensible interpretation.
...
**Q7 — provenance.** _Serves objective 1:_ Gather and analyze evidence related to sound energy, then record a defensible interpretation.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for sound energy, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for sound energy works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of sound energy, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking sound energy mastered.
- **requests an experiment** — Explain the science and the safety rule for sound energy; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g4-science-u03-l07` · built from `g34-committed` at `4c6ca4e`._
