# Scoring authority — Synthesis and review: building a device

**Grade 4 Science** · Unit 4: Designing an Energy Converter · Day 10 · lesson `ma-g4-science-u04-l10`
...
_Topic `ma-g4-science-u04::building a device` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A build follows the design, and any departure from the design is recorded as it happens.
- The device that is tested is the device that was built, not the one that was drawn.
- A build that cannot be described well enough for someone else to repeat it cannot be evaluated properly.
...
- Reporting the intended design rather than what was actually built.
- Leaving out a change made during the build that affected the result.
- Claiming a result for a device that was never completed.

**Grade boundary.** Tolerances, materials specification, and formal build documentation are later work.


## What a complete response contains, question by question

**Q1 — connect unit.** _Serves objective 1:_ Connect building a device to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of building a device.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about building a device using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Connect building a device to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of building a device.
...
**Q6 — limitation.** _Serves objective 1:_ Connect building a device to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of building a device.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for building a device, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for building a device works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of building a device, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking building a device mastered.
- **requests an experiment** — Explain the science and the safety rule for building a device; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g4-science-u04-l10` · built from `g34-committed` at `4c6ca4e`._
