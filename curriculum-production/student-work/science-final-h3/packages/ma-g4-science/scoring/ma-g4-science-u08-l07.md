# Scoring authority — Investigation or close reading: rock layers

**Grade 4 Science** · Unit 8: Earth's Changing Landscape · Day 7 · lesson `ma-g4-science-u08-l07`
...
_Topic `ma-g4-science-u08::rock layers` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- In undisturbed sedimentary layers, a lower layer formed before the layer above it.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Sedimentary rock forms as sediment settles in layers, with newer material on top.
- In an undisturbed sequence, deeper means older.
- Layers can be tilted, folded, faulted, or eroded after they form, so a sequence has to be checked for disturbance before the rule is applied.
...
- Claiming the topmost layer is the oldest.
- Reading an age in years straight off the layer order.
- Applying the deeper-is-older rule to visibly overturned layers without saying so.

**Grade boundary.** Radiometric dating, formal stratigraphic principles by name, and correlation between regions are Grade 8 and High School work.
...
**Q1 — analyze evidence.** _Serves objective 1:_ Gather and analyze evidence related to rock layers, then record a defensible interpretation.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of rock layers.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about rock layers using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Gather and analyze evidence related to rock layers, then record a defensible interpretation.
...
**Q5 — evidence quality.** _Serves objective 1:_ Gather and analyze evidence related to rock layers, then record a defensible interpretation.
...
**Q6 — limitation.** _Serves objective 1:_ Gather and analyze evidence related to rock layers, then record a defensible interpretation.
...
**Q7 — provenance.** _Serves objective 1:_ Gather and analyze evidence related to rock layers, then record a defensible interpretation.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for rock layers, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for rock layers works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of rock layers, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking rock layers mastered.
- **requests an experiment** — Explain the science and the safety rule for rock layers; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g4-science-u08-l07` · built from `g34-committed` at `4c6ca4e`._
