# Scoring authority — Synthesis and review: reducing hazard impacts

**Grade 4 Science** · Unit 9: Capstone: Energy Resources and Michigan Hazards · Day 10 · lesson `ma-g4-science-u09-l10`
...
_Topic `ma-g4-science-u09::reducing hazard impacts` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- The impact of a natural hazard can be reduced by design, by warning systems, and by where and how people build.
- Reducing impact is not the same as preventing the event; the event still happens.
- Every mitigation has costs and limits, and a solution that works for one hazard may not work for another.
...
- Claiming a design prevents the natural event itself.
- Claiming a mitigation removes all risk.
- Proposing a mitigation with no reference to the hazard it addresses.

**Grade boundary.** Engineering codes, cost-benefit analysis, and risk quantification are later work.


## What a complete response contains, question by question

**Q1 — connect unit.** _Serves objective 1:_ Connect reducing hazard impacts to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of reducing hazard impacts.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about reducing hazard impacts using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Connect reducing hazard impacts to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of reducing hazard impacts.
...
**Q6 — limitation.** _Serves objective 1:_ Connect reducing hazard impacts to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of reducing hazard impacts.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for reducing hazard impacts, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for reducing hazard impacts works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of reducing hazard impacts, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking reducing hazard impacts mastered.
- **requests an experiment** — Explain the science and the safety rule for reducing hazard impacts; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g4-science-u09-l10` · built from `g34-committed` at `4c6ca4e`._
