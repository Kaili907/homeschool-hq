# Scoring authority — Performance task build: models and diagrams

**Grade 4 Science** · Unit 1: Science and Engineering Practices · Day 9 · lesson `ma-g4-science-u01-l09`
...
_Topic `ma-g4-science-u01::models and diagrams` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A model or diagram represents something in order to explain or predict how it behaves.
- Every model simplifies, and what it leaves out is a limitation to be stated rather than hidden.
- A diagram's labels and arrows carry meaning; an unlabelled diagram does not communicate a model.

**Also correct.** Accept any of these framings — do not require the wording above:

- A labelled drawing, a flow diagram, a physical build, and an acted sequence are all legitimate models here.
...
- Claiming a model has to look like the real thing to be good.
- Claiming a good model has no limitations.
- Judging a diagram on neatness rather than on what it explains.

**Grade boundary.** Mathematical and computational modelling is later work.
...
**Q1 — build product.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies models and diagrams and the unit standards.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of models and diagrams.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about models and diagrams using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies models and diagrams and the unit standards.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of models and diagrams.
...
**Q6 — limitation.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies models and diagrams and the unit standards.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of models and diagrams.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for models and diagrams, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for models and diagrams works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of models and diagrams, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking models and diagrams mastered.
- **requests an experiment** — Explain the science and the safety rule for models and diagrams; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g4-science-u01-l09` · built from `g34-committed` at `4c6ca4e`._
