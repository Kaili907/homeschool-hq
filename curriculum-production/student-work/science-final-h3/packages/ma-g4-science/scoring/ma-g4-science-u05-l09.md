# Scoring authority — Performance task build: wavelength

**Grade 4 Science** · Unit 5: Waves and Information · Day 9 · lesson `ma-g4-science-u05-l09`
...
_Topic `ma-g4-science-u05::wavelength` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Wavelength is the distance from one point on a wave to the matching point on the next wave, such as crest to crest.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Wavelength is the distance from a point on one wave to the matching point on the next.
- Wavelength and amplitude are independent: changing one does not force the other to change.
- Wavelength is a distance and is reported with a length unit.

**Also correct.** Accept any of these framings — do not require the wording above:

- Crest-to-crest and trough-to-trough both give the wavelength.
...
- Reporting a wavelength with no length unit.
- Claiming a taller wave must have a longer wavelength.

**Grade boundary.** Frequency, period, and the wave speed relationship are Grade 8 and High School work.
...
**Q1 — build product.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies wavelength and the unit standards.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of wavelength.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about wavelength using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies wavelength and the unit standards.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of wavelength.
...
**Q6 — limitation.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies wavelength and the unit standards.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of wavelength.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for wavelength, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for wavelength works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of wavelength, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking wavelength mastered.
- **requests an experiment** — Explain the science and the safety rule for wavelength; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g4-science-u05-l09` · built from `g34-committed` at `4c6ca4e`._
