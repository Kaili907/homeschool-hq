# Scoring authority — Performance task build: evidence and explanation

**Grade 4 Science** · Unit 2: Energy and Speed · Day 9 · lesson `ma-g4-science-u02-l09`
...
_Topic `ma-g4-science-u02::evidence and explanation` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- An explanation says how or why something happens; evidence is the recorded observation or measurement that supports it.
- An explanation is only as strong as the evidence tied to it.
- Evidence that does not bear on the claim does not support it, however carefully it was collected.
...
- Presenting a claim with no evidence and calling it an explanation.
- Offering evidence that does not bear on the claim being made.
- Treating a confident statement as though it were evidence.

**Grade boundary.** Formal claim-evidence-reasoning terminology and rebuttal structure are later work.
...
**Q1 — build product.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies evidence and explanation and the unit standards.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of evidence and explanation.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about evidence and explanation using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies evidence and explanation and the unit standards.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of evidence and explanation.
...
**Q6 — limitation.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies evidence and explanation and the unit standards.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of evidence and explanation.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for evidence and explanation, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for evidence and explanation works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of evidence and explanation, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking evidence and explanation mastered.
- **requests an experiment** — Explain the science and the safety rule for evidence and explanation; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g4-science-u02-l09` · built from `g34-committed` at `4c6ca4e`._
