# Scoring authority — Investigation or close reading: energy of motion

**Grade 4 Science** · Unit 2: Energy and Speed · Day 7 · lesson `ma-g4-science-u02-l07`
...
_Topic `ma-g4-science-u02::energy of motion` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- A moving object has energy of motion; a faster-moving object of the same mass has more of it.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Any moving object has energy because of its motion.
- For objects of the same mass, the faster one has more energy of motion.
- For objects moving at the same speed, the more massive one has more energy of motion.

**Also correct.** Accept any of these framings — do not require the wording above:

- 'Energy of motion' and 'kinetic energy' are the same idea; either name is correct.
...
- Claiming a moving object has no energy until it hits something.
- Claiming energy of motion depends on speed alone, with mass making no difference.
- Claiming an object stores up force as it moves.

**Grade boundary.** The relationship that energy of motion goes with the square of the speed, and any energy formula, are later work; a learner who states it correctly is not wrong.
...
**Q1 — analyze evidence.** _Serves objective 1:_ Gather and analyze evidence related to energy of motion, then record a defensible interpretation.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of energy of motion.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about energy of motion using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Gather and analyze evidence related to energy of motion, then record a defensible interpretation.
...
**Q5 — evidence quality.** _Serves objective 1:_ Gather and analyze evidence related to energy of motion, then record a defensible interpretation.
...
**Q6 — limitation.** _Serves objective 1:_ Gather and analyze evidence related to energy of motion, then record a defensible interpretation.
...
**Q7 — provenance.** _Serves objective 1:_ Gather and analyze evidence related to energy of motion, then record a defensible interpretation.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for energy of motion, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for energy of motion works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of energy of motion, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking energy of motion mastered.
- **requests an experiment** — Explain the science and the safety rule for energy of motion; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g4-science-u02-l07` · built from `g34-committed` at `4c6ca4e`._
