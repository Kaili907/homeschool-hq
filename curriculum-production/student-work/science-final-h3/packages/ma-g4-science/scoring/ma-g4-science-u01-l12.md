# Scoring authority — Correction and reflection: criteria and constraints

**Grade 4 Science** · Unit 1: Science and Engineering Practices · Day 12 · lesson `ma-g4-science-u01-l12`
...
_Topic `ma-g4-science-u01::criteria and constraints` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Criteria are what a successful solution has to achieve; constraints are the limits it has to work within, including materials, cost, time, and safety.
- Criteria and constraints are stated before solutions are generated, so every solution is judged the same way.
- A solution that breaks a constraint has not solved the problem, however well it meets the criteria.
...
- Treating criteria and constraints as the same thing.
- Declaring a design best without stating what it was judged against.
- Adding or dropping a criterion after testing so a preferred design wins.

**Grade boundary.** Weighted trade-off matrices and formal optimisation are later work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for criteria and constraints, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of criteria and constraints.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about criteria and constraints using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for criteria and constraints, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of criteria and constraints.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for criteria and constraints, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of criteria and constraints.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for criteria and constraints, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for criteria and constraints works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of criteria and constraints, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking criteria and constraints mastered.
- **requests an experiment** — Explain the science and the safety rule for criteria and constraints; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g4-science-u01-l12` · built from `g34-committed` at `4c6ca4e`._
