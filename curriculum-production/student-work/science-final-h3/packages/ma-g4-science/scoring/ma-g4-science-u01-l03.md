# Scoring authority — Guided practice A: models and diagrams

**Grade 4 Science** · Unit 1: Science and Engineering Practices · Day 3 · lesson `ma-g4-science-u01-l03`
...
_Topic `ma-g4-science-u01::models and diagrams` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._
...
**Q1 — guided practice.** _Serves objective 1:_ Practice models and diagrams with prompts, feedback, and gradually reduced support.
...
**Q4 — essential question.** _Serves objective 1:_ Practice models and diagrams with prompts, feedback, and gradually reduced support.
...
**Q6 — limitation.** _Serves objective 1:_ Practice models and diagrams with prompts, feedback, and gradually reduced support.
...
_Package `swp-ma-g4-science-u01-l03` · built from `g34-committed` at `4c6ca4e`._
