# Scoring authority — Unit assessment: animal structures

**Grade 4 Science** · Unit 7: Structures That Support Survival · Day 11 · lesson `ma-g4-science-u07-l11`
...
_Topic `ma-g4-science-u07::animal structures` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Animal structures support taking in food and water, moving, sensing, protecting, and reproducing.
- A structure that supports one function often constrains another, such as heavy armour limiting speed.
- Structures that look alike can serve different functions in different animals, and structures that look different can serve the same one.
...
- Claiming a structure is present for no function at all without evidence.
- Claiming an animal grew a structure because it needed one.
- Claiming structures never involve trade-offs.

**Grade boundary.** Homology, analogy, and evolutionary relationship are Grade 8 and High School work.


## What a complete response contains, question by question

**Q1 — demonstrate mastery.** _Serves objective 1:_ Demonstrate current mastery of animal structures through selected-response, constructed-response, and applied evidence.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of animal structures.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about animal structures using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Demonstrate current mastery of animal structures through selected-response, constructed-response, and applied evidence.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of animal structures.
...
**Q6 — limitation.** _Serves objective 1:_ Demonstrate current mastery of animal structures through selected-response, constructed-response, and applied evidence.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of animal structures.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for animal structures, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for animal structures works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of animal structures, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking animal structures mastered.
- **requests an experiment** — Explain the science and the safety rule for animal structures; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g4-science-u07-l11` · built from `g34-committed` at `4c6ca4e`._
