# Scoring authority — Correction and reflection: asking scientific questions

**Grade 4 Science** · Unit 2: Energy and Speed · Day 12 · lesson `ma-g4-science-u02-l12`
...
_Topic `ma-g4-science-u02::asking scientific questions` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A scientific question about energy names what would be changed and what would be observed or measured.
- Good questions often come from something that does not fit an existing explanation.
- A question that cannot be answered by any observation is not a scientific question, whatever else it is.
...
- Framing a preference or a value judgement as a scientific question.
- Asking a question with no observable outcome and calling it testable.
- Claiming a question is unscientific merely because it is simple.

**Grade boundary.** Operational definitions and formal variable naming are later work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for asking scientific questions, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of asking scientific questions.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about asking scientific questions using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for asking scientific questions, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of asking scientific questions.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for asking scientific questions, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of asking scientific questions.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for asking scientific questions, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for asking scientific questions works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of asking scientific questions, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking asking scientific questions mastered.
- **requests an experiment** — Explain the science and the safety rule for asking scientific questions; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g4-science-u02-l12` · built from `g34-committed` at `4c6ca4e`._
