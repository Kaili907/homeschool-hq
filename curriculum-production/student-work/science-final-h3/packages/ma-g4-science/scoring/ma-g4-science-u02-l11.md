# Scoring authority — Unit assessment: predicting outcomes

**Grade 4 Science** · Unit 2: Energy and Speed · Day 11 · lesson `ma-g4-science-u02-l11`
...
_Topic `ma-g4-science-u02::predicting outcomes` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A prediction about a collision or a motion is based on a pattern established by earlier observation.
- A prediction is stated before the test; a statement made afterwards is an explanation.
- A prediction that turns out wrong is useful evidence and is recorded exactly as it was made.
...
- Changing a recorded prediction after seeing the result.
- Predicting for conditions the observed pattern never covered.
- Claiming a prediction is certain rather than expected.

**Grade boundary.** Quantitative prediction from equations is later work.


## What a complete response contains, question by question

**Q1 — demonstrate mastery.** _Serves objective 1:_ Demonstrate current mastery of predicting outcomes through selected-response, constructed-response, and applied evidence.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of predicting outcomes.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about predicting outcomes using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Demonstrate current mastery of predicting outcomes through selected-response, constructed-response, and applied evidence.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of predicting outcomes.
...
**Q6 — limitation.** _Serves objective 1:_ Demonstrate current mastery of predicting outcomes through selected-response, constructed-response, and applied evidence.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of predicting outcomes.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for predicting outcomes, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for predicting outcomes works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of predicting outcomes, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking predicting outcomes mastered.
- **requests an experiment** — Explain the science and the safety rule for predicting outcomes; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g4-science-u02-l11` · built from `g34-committed` at `4c6ca4e`._
