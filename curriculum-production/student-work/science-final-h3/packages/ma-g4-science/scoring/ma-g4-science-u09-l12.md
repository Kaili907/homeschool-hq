# Scoring authority — Correction and reflection: Michigan's people and places

**Grade 4 Science** · Unit 9: Capstone: Energy Resources and Michigan Hazards · Day 12 · lesson `ma-g4-science-u09-l12`
...
_Topic `ma-g4-science-u09::Michigan's people and places` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Where people in Michigan live and work is shaped by the Great Lakes, by farmland and forests, and by mineral and energy resources.
- Michigan's main weather-related hazards include severe thunderstorms, tornadoes, winter and lake-effect snow storms, flooding, and shoreline erosion.
- Decisions about resources and hazards affect different communities differently, so who is affected is part of the evidence.
...
- Claiming Michigan faces significant volcanic or major earthquake hazard.
- Claiming a resource decision affects every community in the same way.
- Claiming the Great Lakes have no effect on Michigan's weather.

**Grade boundary.** Formal environmental justice frameworks and policy analysis are Grade 8 and later work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for Michigan's people and places, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of Michigan's people and places.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about Michigan's people and places using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for Michigan's people and places, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of Michigan's people and places.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for Michigan's people and places, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of Michigan's people and places.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for Michigan's people and places, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for Michigan's people and places works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of Michigan's people and places, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking Michigan's people and places mastered.
- **requests an experiment** — Explain the science and the safety rule for Michigan's people and places; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g4-science-u09-l12` · built from `g34-committed` at `4c6ca4e`._
