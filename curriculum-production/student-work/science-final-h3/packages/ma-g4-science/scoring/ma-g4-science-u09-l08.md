# Scoring authority — Reteach and varied practice: fuels and the environment

**Grade 4 Science** · Unit 9: Capstone: Energy Resources and Michigan Hazards · Day 8 · lesson `ma-g4-science-u09-l08`
...
_Topic `ma-g4-science-u09::fuels and the environment` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._
...
- Burning fossil fuels releases carbon dioxide and other substances into the air.
- Extracting, transporting, and burning fuels affects land, water, and air, and those effects differ between fuels.
- Reducing the amount of fuel used reduces the effects, which is why efficiency and conservation matter.
...
- Claiming burning fuel produces no waste products because the flame looks clean.
- Claiming all fuels have identical environmental effects.
- Claiming an effect can be removed entirely rather than reduced.

**Grade boundary.** The greenhouse mechanism, combustion chemistry, and emissions figures are Grade 7 and later work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for fuels and the environment, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of fuels and the environment.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about fuels and the environment using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for fuels and the environment, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of fuels and the environment.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for fuels and the environment, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of fuels and the environment.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for fuels and the environment, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for fuels and the environment works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of fuels and the environment, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking fuels and the environment mastered.
- **requests an experiment** — Explain the science and the safety rule for fuels and the environment; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g4-science-u09-l08` · built from `g34-committed` at `4c6ca4e`._
