# Scoring authority — Concept model A: amplitude

**Grade 4 Science** · Unit 5: Waves and Information · Day 2 · lesson `ma-g4-science-u05-l02`
...
**Q1 — model build.** _Serves objective 1:_ Build a clear mental model of amplitude through an explicit worked example, demonstration, text, or phenomenon.
...
**Q4 — essential question.** _Serves objective 1:_ Build a clear mental model of amplitude through an explicit worked example, demonstration, text, or phenomenon.
...
**Q6 — limitation.** _Serves objective 1:_ Build a clear mental model of amplitude through an explicit worked example, demonstration, text, or phenomenon.
...
_Package `swp-ma-g4-science-u05-l02` · built from `g34-committed` at `4c6ca4e`._
