...
**Grade 4 Science** · Unit 1: Science and Engineering Practices · Day 7 · lesson `ma-g4-science-u01-l07`
...
_Topic `ma-g4-science-u01::careful observations` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- An observation is information taken in directly, through the senses or through an instrument.
- An inference goes beyond the observation to say what it might mean, and the same observation can support more than one inference.
- Observations recorded as they are made are more trustworthy than ones written up from memory afterwards.

**Also correct.** Accept any of these framings — do not require the wording above:

- Qualitative and quantitative, or words and numbers, are both correct ways to sort observations.
...
- Recording an inference as an observation, such as 'the circuit is broken' instead of 'the bulb did not light'.
- Treating an opinion about what happened as data.
- Claiming an observation is only valid if an instrument was used.

**Grade boundary.** Measurement uncertainty, calibration, and statistical treatment of repeats are later grades and must not be required here.
...
_Package `swp-ma-g4-science-u01-l07` · built from `g34-committed` at `4c6ca4e`._
