# Scoring authority — Launch and diagnostic: energy conversion

**Grade 4 Science** · Unit 4: Designing an Energy Converter · Day 1 · lesson `ma-g4-science-u04-l01`
...
_Topic `ma-g4-science-u04::energy conversion` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._
...
**Q1 — activate prior.** _Serves objective 1:_ Activate prior knowledge about energy conversion, surface initial thinking without penalty, and establish the unit question.
...
**Q4 — essential question.** _Serves objective 1:_ Activate prior knowledge about energy conversion, surface initial thinking without penalty, and establish the unit question.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of energy conversion.
...
**Q6 — limitation.** _Serves objective 1:_ Activate prior knowledge about energy conversion, surface initial thinking without penalty, and establish the unit question.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of energy conversion.
...
_Package `swp-ma-g4-science-u04-l01` · built from `g34-committed` at `4c6ca4e`._
