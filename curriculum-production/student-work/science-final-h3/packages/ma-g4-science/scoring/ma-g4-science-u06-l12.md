# Scoring authority — Correction and reflection: modeling information processing

**Grade 4 Science** · Unit 6: Light, Vision, and the Senses · Day 12 · lesson `ma-g4-science-u06-l12`
...
_Topic `ma-g4-science-u06::modeling information processing` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A model of information processing shows input, processing, and response as distinct stages.
- The model shows the direction of flow, from receptor to brain to response.
- A model that omits the processing stage cannot explain why responses differ between animals or situations.

**Also correct.** Accept any of these framings — do not require the wording above:

- Flow diagrams, labelled drawings, and written sequences are all acceptable model forms.
...
- Drawing a model that runs from response back to input as the normal direction.
- Leaving out the processing stage and calling the model complete.
- Claiming the model shows what actually happens inside the brain in detail.

**Grade boundary.** Neural circuitry and computational models of cognition are later work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for modeling information processing, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of modeling information processing.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about modeling information processing using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for modeling information processing, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of modeling information processing.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for modeling information processing, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of modeling information processing.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for modeling information processing, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for modeling information processing works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of modeling information processing, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking modeling information processing mastered.
- **requests an experiment** — Explain the science and the safety rule for modeling information processing; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g4-science-u06-l12` · built from `g34-committed` at `4c6ca4e`._
