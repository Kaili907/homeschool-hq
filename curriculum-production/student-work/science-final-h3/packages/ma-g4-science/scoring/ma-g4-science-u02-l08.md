# Scoring authority — Reteach and varied practice: speed and energy

**Grade 4 Science** · Unit 2: Energy and Speed · Day 8 · lesson `ma-g4-science-u02-l08`
...
_Topic `ma-g4-science-u02::speed and energy` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._
...
- Increasing an object's speed increases its energy of motion.
- Energy has to be transferred to an object to speed it up, and away from it to slow it down.

**Also correct.** Accept any of these framings — do not require the wording above:

- Describing speed in words, as a distance per time, or by comparison between two objects are all acceptable at this grade.
...
- Claiming an object speeds up or slows down without any energy transfer.
- Claiming that speed and energy are the same quantity.
- Comparing speeds measured over different distances or times without saying so.

**Grade boundary.** Calculating speed as distance divided by time is acceptable but not required; acceleration is later work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for speed and energy, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of speed and energy.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about speed and energy using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for speed and energy, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of speed and energy.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for speed and energy, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of speed and energy.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for speed and energy, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for speed and energy works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of speed and energy, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking speed and energy mastered.
- **requests an experiment** — Explain the science and the safety rule for speed and energy; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g4-science-u02-l08` · built from `g34-committed` at `4c6ca4e`._
