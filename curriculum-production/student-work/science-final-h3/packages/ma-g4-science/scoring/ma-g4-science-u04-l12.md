# Scoring authority — Correction and reflection: comparing designs

**Grade 4 Science** · Unit 4: Designing an Energy Converter · Day 12 · lesson `ma-g4-science-u04-l12`
...
_Topic `ma-g4-science-u04::comparing designs` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Designs are compared against the same criteria and constraints, using the same test.
- A design can win on one criterion and lose on another, and an honest comparison reports both.
- The comparison reports what the tests showed, not what the designer hoped.
...
- Naming a winner without saying what the criteria were.
- Testing two designs under different conditions and comparing the results.
- Omitting a criterion on which the preferred design performed badly.

**Grade boundary.** Weighted scoring and formal trade studies are later work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for comparing designs, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of comparing designs.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about comparing designs using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for comparing designs, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of comparing designs.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for comparing designs, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of comparing designs.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for comparing designs, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for comparing designs works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of comparing designs, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking comparing designs mastered.
- **requests an experiment** — Explain the science and the safety rule for comparing designs; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g4-science-u04-l12` · built from `g34-committed` at `4c6ca4e`._
