# Scoring authority — Synthesis and review: rate of erosion

**Grade 4 Science** · Unit 8: Earth's Changing Landscape · Day 10 · lesson `ma-g4-science-u08-l10`
...
_Topic `ma-g4-science-u08::rate of erosion` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- The rate of erosion depends on the slope, the amount and speed of moving water or wind, the material, and whether plants hold it in place.
- Faster-moving water carries more material and larger pieces than slower-moving water.
- Plant roots slow erosion by holding soil together, which is why removing vegetation increases it.
...
- Claiming erosion happens at the same rate everywhere regardless of slope or cover.
- Claiming slow-moving water carries larger material than fast-moving water.
- Claiming erosion only happens during storms.

**Grade boundary.** Sediment transport equations and quantitative erosion rates are later work.


## What a complete response contains, question by question

**Q1 — connect unit.** _Serves objective 1:_ Connect rate of erosion to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of rate of erosion.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about rate of erosion using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Connect rate of erosion to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of rate of erosion.
...
**Q6 — limitation.** _Serves objective 1:_ Connect rate of erosion to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of rate of erosion.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for rate of erosion, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for rate of erosion works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of rate of erosion, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking rate of erosion mastered.
- **requests an experiment** — Explain the science and the safety rule for rate of erosion; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g4-science-u08-l10` · built from `g34-committed` at `4c6ca4e`._
