# Scoring authority — Investigation or close reading: light reflection

**Grade 4 Science** · Unit 6: Light, Vision, and the Senses · Day 7 · lesson `ma-g4-science-u06-l07`
...
_Topic `ma-g4-science-u06::light reflection` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- An object is seen when light reflected from it enters the eye.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Light bounces off surfaces, and that bouncing is reflection.
- A smooth surface reflects light in a regular way and gives an image; a rough surface scatters it in many directions and does not.
- An object that gives out no light of its own is seen only because light from a source reflects off it.

**Also correct.** Accept any of these framings — do not require the wording above:

- Saying light bounces, reflects, or is scattered are all acceptable at this grade provided the direction of travel is right.
...
- Claiming the eye sends out light to see objects.
- Claiming a non-luminous object can be seen in complete darkness.
- Claiming a mirror makes its own light.

**Grade boundary.** The law of reflection stated with angles, refraction, and image formation are later work.
...
**Q1 — analyze evidence.** _Serves objective 1:_ Gather and analyze evidence related to light reflection, then record a defensible interpretation.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of light reflection.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about light reflection using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Gather and analyze evidence related to light reflection, then record a defensible interpretation.
...
**Q5 — evidence quality.** _Serves objective 1:_ Gather and analyze evidence related to light reflection, then record a defensible interpretation.
...
**Q6 — limitation.** _Serves objective 1:_ Gather and analyze evidence related to light reflection, then record a defensible interpretation.
...
**Q7 — provenance.** _Serves objective 1:_ Gather and analyze evidence related to light reflection, then record a defensible interpretation.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for light reflection, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for light reflection works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of light reflection, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking light reflection mastered.
- **requests an experiment** — Explain the science and the safety rule for light reflection; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g4-science-u06-l07` · built from `g34-committed` at `4c6ca4e`._
