# Scoring authority — Synthesis and review: collisions

**Grade 4 Science** · Unit 2: Energy and Speed · Day 10 · lesson `ma-g4-science-u02-l10`
...
_Topic `ma-g4-science-u02::collisions` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- In a collision, energy is transferred between the colliding objects and into sound, heat, and deformation.

**Accepted relationships and models.** What this lesson's learning target asserts:

- When objects collide, energy is transferred from one object to the other.
- Some of the energy in a collision is transferred to sound, to warming, and to changing the shape of the objects.
- A faster collision transfers more energy, which is why faster collisions do more damage.
...
- Claiming energy disappears in a collision.
- Claiming a collision creates new energy.
- Claiming the heavier object always transfers energy and never receives any.

**Grade boundary.** Momentum, elastic versus inelastic collisions, and conservation calculations are Grade 8 and High School work.


## What a complete response contains, question by question

**Q1 — connect unit.** _Serves objective 1:_ Connect collisions to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of collisions.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about collisions using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Connect collisions to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of collisions.
...
**Q6 — limitation.** _Serves objective 1:_ Connect collisions to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of collisions.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for collisions, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for collisions works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of collisions, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking collisions mastered.
- **requests an experiment** — Explain the science and the safety rule for collisions; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g4-science-u02-l10` · built from `g34-committed` at `4c6ca4e`._
