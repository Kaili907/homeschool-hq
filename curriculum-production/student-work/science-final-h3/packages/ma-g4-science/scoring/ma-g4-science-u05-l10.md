# Scoring authority — Synthesis and review: waves and motion

**Grade 4 Science** · Unit 5: Waves and Information · Day 10 · lesson `ma-g4-science-u05-l10`
...
_Topic `ma-g4-science-u05::waves and motion` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A wave can make an object in its path move, because it transfers energy to that object.
- An object floating on water bobs up and down as waves pass; it is not carried along by them.
- A wave with more energy makes a larger motion in the object it reaches.
...
- Claiming a floating object is carried forward by each passing wave.
- Claiming a wave moves an object without transferring energy to it.
- Claiming the object's motion is unrelated to the wave's amplitude.

**Grade boundary.** Wave-particle interaction models and orbital water motion are later work.


## What a complete response contains, question by question

**Q1 — connect unit.** _Serves objective 1:_ Connect waves and motion to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of waves and motion.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about waves and motion using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Connect waves and motion to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of waves and motion.
...
**Q6 — limitation.** _Serves objective 1:_ Connect waves and motion to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of waves and motion.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for waves and motion, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for waves and motion works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of waves and motion, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking waves and motion mastered.
- **requests an experiment** — Explain the science and the safety rule for waves and motion; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g4-science-u05-l10` · built from `g34-committed` at `4c6ca4e`._
