# Scoring authority — Performance task build: heat transfer

**Grade 4 Science** · Unit 3: Energy Transfer · Day 9 · lesson `ma-g4-science-u03-l09`
...
_Topic `ma-g4-science-u03::heat transfer` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Energy moves from the warmer object to the cooler one, never the other way on its own.

**Accepted relationships and models.** What this lesson's learning target asserts:

- When two objects at different temperatures touch, energy moves from the warmer one to the cooler one.
- Transfer continues until the two objects reach the same temperature.
- Some materials transfer energy quickly and others slowly, which is what makes insulators useful.

**Also correct.** Accept any of these framings — do not require the wording above:

- Saying energy is transferred, or that heat flows, are both acceptable at this grade provided the direction is right.
...
- Claiming cold moves into a warm object; only energy moves, and it moves from warmer to cooler.
- Claiming an insulator produces warmth rather than slowing transfer.
- Claiming a material feels colder because it is at a lower temperature than the air around it, when it is the rate of transfer that differs.

**Grade boundary.** Conduction, convection, and radiation as named mechanisms, and specific heat capacity, are Grade 7 and later work.
...
**Q1 — build product.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies heat transfer and the unit standards.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of heat transfer.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about heat transfer using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies heat transfer and the unit standards.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of heat transfer.
...
**Q6 — limitation.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies heat transfer and the unit standards.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of heat transfer.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for heat transfer, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for heat transfer works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of heat transfer, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking heat transfer mastered.
- **requests an experiment** — Explain the science and the safety rule for heat transfer; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g4-science-u03-l09` · built from `g34-committed` at `4c6ca4e`._
