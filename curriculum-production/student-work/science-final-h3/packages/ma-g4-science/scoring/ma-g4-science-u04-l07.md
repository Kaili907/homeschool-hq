# Scoring authority — Investigation or close reading: energy conversion

**Grade 4 Science** · Unit 4: Designing an Energy Converter · Day 7 · lesson `ma-g4-science-u04-l07`
...
_Topic `ma-g4-science-u04::energy conversion` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Energy is not created or destroyed by a device; it is converted from one form to another.

**Accepted relationships and models.** What this lesson's learning target asserts:

- A device converts energy from one form to another, such as electrical to light, or motion to sound.
- No device converts all the energy it receives into the form that is wanted; some always ends up warming the surroundings.
- The energy a device delivers comes from a source, never from the device itself.

**Also correct.** Accept any of these framings — do not require the wording above:

- Saying energy is converted, transformed, or changed in form are all correct.
...
- Claiming a device creates energy.
- Claiming a device converts all of its input into the useful output.
- Claiming energy is destroyed when a device stops working.

**Grade boundary.** Numerical efficiency, the conservation law stated formally, and the second law are later work.
...
**Q1 — analyze evidence.** _Serves objective 1:_ Gather and analyze evidence related to energy conversion, then record a defensible interpretation.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of energy conversion.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about energy conversion using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Gather and analyze evidence related to energy conversion, then record a defensible interpretation.
...
**Q5 — evidence quality.** _Serves objective 1:_ Gather and analyze evidence related to energy conversion, then record a defensible interpretation.
...
**Q6 — limitation.** _Serves objective 1:_ Gather and analyze evidence related to energy conversion, then record a defensible interpretation.
...
**Q7 — provenance.** _Serves objective 1:_ Gather and analyze evidence related to energy conversion, then record a defensible interpretation.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for energy conversion, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for energy conversion works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of energy conversion, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking energy conversion mastered.
- **requests an experiment** — Explain the science and the safety rule for energy conversion; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g4-science-u04-l07` · built from `g34-committed` at `4c6ca4e`._
