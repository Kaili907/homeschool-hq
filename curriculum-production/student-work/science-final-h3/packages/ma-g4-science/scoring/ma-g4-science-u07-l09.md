# Scoring authority — Performance task build: structure and function

**Grade 4 Science** · Unit 7: Structures That Support Survival · Day 9 · lesson `ma-g4-science-u07-l09`
...
_Topic `ma-g4-science-u07::structure and function` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A structure's shape and material relate to what it does; this is the structure-function relationship.
- Changing the structure changes what it can do.
- Similar functions in different organisms are often carried out by structures that are built differently.
...
- Claiming structure and function are unrelated.
- Claiming organisms with the same function must have the same structure.
- Claiming a structure changes during an organism's life to fit a new function it needs.

**Grade boundary.** Adaptation as an evolutionary process, and convergent evolution, are later work.
...
**Q1 — build product.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies structure and function and the unit standards.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of structure and function.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about structure and function using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies structure and function and the unit standards.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of structure and function.
...
**Q6 — limitation.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies structure and function and the unit standards.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of structure and function.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for structure and function, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for structure and function works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of structure and function, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking structure and function mastered.
- **requests an experiment** — Explain the science and the safety rule for structure and function; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g4-science-u07-l09` · built from `g34-committed` at `4c6ca4e`._
