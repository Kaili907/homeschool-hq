# Scoring authority — Synthesis and review: plant structures

**Grade 4 Science** · Unit 7: Structures That Support Survival · Day 10 · lesson `ma-g4-science-u07-l10`
...
_Topic `ma-g4-science-u07::plant structures` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Roots take in water and dissolved minerals; leaves are where the plant makes its food.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Roots anchor the plant and take in water and dissolved minerals from the soil.
- Stems support the plant and carry water and food between roots and leaves.
- Leaves are where the plant makes its own food, using light.

**Also correct.** Accept any of these framings — do not require the wording above:

- Saying leaves make food using light from the Sun, or that they carry out photosynthesis, are both correct.
...
- Claiming plants take in ready-made food from the soil.
- Claiming roots make the plant's food.
- Claiming a plant does not need light if it has enough water and soil.

**Grade boundary.** The chemistry of photosynthesis, xylem and phloem by name, and gas exchange detail are Grade 7 and High School work.


## What a complete response contains, question by question

**Q1 — connect unit.** _Serves objective 1:_ Connect plant structures to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of plant structures.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about plant structures using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Connect plant structures to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of plant structures.
...
**Q6 — limitation.** _Serves objective 1:_ Connect plant structures to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of plant structures.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for plant structures, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for plant structures works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of plant structures, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking plant structures mastered.
- **requests an experiment** — Explain the science and the safety rule for plant structures; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g4-science-u07-l10` · built from `g34-committed` at `4c6ca4e`._
