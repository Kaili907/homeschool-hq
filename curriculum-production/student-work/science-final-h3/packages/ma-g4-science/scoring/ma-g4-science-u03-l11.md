# Scoring authority — Unit assessment: observing transfer

**Grade 4 Science** · Unit 3: Energy Transfer · Day 11 · lesson `ma-g4-science-u03-l11`
...
_Topic `ma-g4-science-u03::observing transfer` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Energy transfer is observed through its effects: something moves, warms, lights up, makes sound, or changes shape.
- Observing an effect is evidence that energy was transferred, not a direct sight of the energy itself.
- The same transfer can often be detected by more than one effect, and agreement between them strengthens the evidence.
...
- Claiming energy itself was seen or held.
- Claiming no transfer happened because no effect was looked for.
- Treating a single ambiguous effect as proof of a particular transfer path.

**Grade boundary.** Quantifying energy transferred, and efficiency calculations, are later work.


## What a complete response contains, question by question

**Q1 — demonstrate mastery.** _Serves objective 1:_ Demonstrate current mastery of observing transfer through selected-response, constructed-response, and applied evidence.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of observing transfer.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about observing transfer using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Demonstrate current mastery of observing transfer through selected-response, constructed-response, and applied evidence.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of observing transfer.
...
**Q6 — limitation.** _Serves objective 1:_ Demonstrate current mastery of observing transfer through selected-response, constructed-response, and applied evidence.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of observing transfer.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for observing transfer, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for observing transfer works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of observing transfer, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking observing transfer mastered.
- **requests an experiment** — Explain the science and the safety rule for observing transfer; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g4-science-u03-l11` · built from `g34-committed` at `4c6ca4e`._
