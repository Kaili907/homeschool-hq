# Scoring authority — Performance task build: weathering

**Grade 4 Science** · Unit 8: Earth's Changing Landscape · Day 9 · lesson `ma-g4-science-u08-l09`
...
_Topic `ma-g4-science-u08::weathering` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Weathering breaks rock down in place; erosion moves the pieces away.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Weathering breaks rock into smaller pieces where it sits, by water, ice, wind, temperature change, plants, and chemical action.
- Water freezing in a crack expands and widens the crack, which is why freeze-thaw is a powerful weathering process in Michigan.
- Weathering and erosion are different processes: weathering breaks material down, erosion carries it away.

**Also correct.** Accept any of these framings — do not require the wording above:

- Physical and chemical weathering, or mechanical and chemical weathering, are both correct namings.
...
- Using weathering and erosion as though they meant the same thing.
- Claiming water contracts when it freezes.
- Claiming weathering only happens to rock that is exposed at the surface of a cliff.

**Grade boundary.** Named chemical weathering reactions and mineral stability series are later work.
...
**Q1 — build product.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies weathering and the unit standards.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of weathering.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about weathering using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies weathering and the unit standards.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of weathering.
...
**Q6 — limitation.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies weathering and the unit standards.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of weathering.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for weathering, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for weathering works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of weathering, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking weathering mastered.
- **requests an experiment** — Explain the science and the safety rule for weathering; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g4-science-u08-l09` · built from `g34-committed` at `4c6ca4e`._
