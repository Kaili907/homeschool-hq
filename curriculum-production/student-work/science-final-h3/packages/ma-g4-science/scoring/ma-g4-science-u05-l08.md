# Scoring authority — Reteach and varied practice: amplitude

**Grade 4 Science** · Unit 5: Waves and Information · Day 8 · lesson `ma-g4-science-u05-l08`
...
_Topic `ma-g4-science-u05::amplitude` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Amplitude is the height of a wave from its resting position, and a larger amplitude carries more energy.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Amplitude is measured from the resting position to the crest, not from trough to crest.
- A wave with larger amplitude carries more energy than an otherwise identical wave with smaller amplitude.
- In sound, larger amplitude is heard as louder; in water, larger amplitude is a taller wave.

**Also correct.** Accept any of these framings — do not require the wording above:

- Describing amplitude as wave height above rest, or as how far the material moves from rest, are both correct.
...
- Claiming amplitude sets the pitch of a sound.
- Measuring amplitude from trough to crest and reporting it as the amplitude.

**Grade boundary.** The relationship between energy and the square of the amplitude is later work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for amplitude, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of amplitude.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about amplitude using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for amplitude, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of amplitude.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for amplitude, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of amplitude.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for amplitude, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for amplitude works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of amplitude, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking amplitude mastered.
- **requests an experiment** — Explain the science and the safety rule for amplitude; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g4-science-u05-l08` · built from `g34-committed` at `4c6ca4e`._
