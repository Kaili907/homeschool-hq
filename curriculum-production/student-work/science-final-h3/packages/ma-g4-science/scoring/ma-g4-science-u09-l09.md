# Scoring authority — Performance task build: natural Earth processes

**Grade 4 Science** · Unit 9: Capstone: Energy Resources and Michigan Hazards · Day 9 · lesson `ma-g4-science-u09-l09`
...
_Topic `ma-g4-science-u09::natural Earth processes` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g4-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Natural Earth processes such as floods, storms, erosion, and, elsewhere, earthquakes and volcanic eruptions, happen whether or not people are present.
- These processes become hazards when they affect people and what they depend on.
- Where and when many of these processes occur follows patterns that can be studied and used for planning.
...
- Claiming natural Earth processes can be stopped from happening.
- Claiming these processes occur completely at random with no patterns at all.
- Claiming Michigan is at risk from active volcanoes.

**Grade boundary.** Probabilistic hazard assessment and return periods are later work.
...
**Q1 — build product.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies natural Earth processes and the unit standards.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of natural Earth processes.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about natural Earth processes using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies natural Earth processes and the unit standards.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of natural Earth processes.
...
**Q6 — limitation.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies natural Earth processes and the unit standards.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of natural Earth processes.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for natural Earth processes, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for natural Earth processes works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of natural Earth processes, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking natural Earth processes mastered.
- **requests an experiment** — Explain the science and the safety rule for natural Earth processes; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g4-science-u09-l09` · built from `g34-committed` at `4c6ca4e`._
