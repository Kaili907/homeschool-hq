# Scoring authority — Reteach and varied practice: the frequency-wavelength-speed relationship

**High School Physics (Grade 11)** · Unit 8: Waves and Their Mathematics · Day 8 · lesson `ma-hs11-physics-u08-l08`
...
_Topic `ma-hs11-physics-u08::the frequency-wavelength-speed relationship` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-hs11-physics.correctness.json`._
...
- In a given medium the wave speed is fixed by the medium, so frequency and wavelength vary inversely with each other.
- When a wave crosses into a new medium its frequency is unchanged, set by the source, while its speed and wavelength both change.
- The relationship holds for all waves, mechanical and electromagnetic alike.
...
- Claiming a wave's frequency changes when it enters a new medium.
- Claiming increasing the frequency of a wave in a fixed medium increases its speed.
- Claiming wavelength and frequency vary in direct proportion.

**Grade boundary.** Dispersion relations and group versus phase velocity are beyond this course.


## What a complete response contains, question by question

**Q1 — explain with evidence.** _Serves objective 1:_ Explain the frequency-wavelength-speed relationship using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q2 — apply new task.** _Serves objective 2:_ Apply the frequency-wavelength-speed relationship to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q3 — check revise next step.** _Serves objective 3:_ Check and revise the work on the frequency-wavelength-speed relationship against the stated success criteria and name the next step.
...
**Q4 — essential question.** _Serves objective 2:_ Apply the frequency-wavelength-speed relationship to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q5 — evidence quality.** _Serves objective 1:_ Explain the frequency-wavelength-speed relationship using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q6 — limitation.** _Serves objective 2:_ Apply the frequency-wavelength-speed relationship to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q7 — provenance.** _Serves objective 1:_ Explain the frequency-wavelength-speed relationship using evidence, a model, or a documented process rather than an unsupported answer.
...
- **prerequisite-gap** — Run the prerequisite reteach route for the frequency-wavelength-speed relationship (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for the frequency-wavelength-speed relationship (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for the frequency-wavelength-speed relationship (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for the frequency-wavelength-speed relationship (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for the frequency-wavelength-speed relationship (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs11-physics-u08-l08` · built from `hs912-science-h3` at `e7551b9`._
