# Scoring authority — Unit assessment: energy transfer and dissipation

**High School Physics (Grade 11)** · Unit 5: Energy: Modelling, Accounting, and Conservation · Day 11 · lesson `ma-hs11-physics-u05-l11`
...
_Topic `ma-hs11-physics-u05::energy transfer and dissipation` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-hs11-physics.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Energy transferred to the surroundings as thermal energy is dispersed and becomes far harder to use for work.
- Dissipation reduces the useful energy available; it does not reduce the total energy.
- Every real transfer dissipates some energy, which is why no device is completely efficient.
...
- Claiming dissipated energy has been destroyed.
- Claiming a device can transfer all of its input energy to useful output.
- Confusing conservation of total energy with conservation of useful energy.

**Grade boundary.** Quantitative entropy and exergy analysis are beyond this course.


## What a complete response contains, question by question

**Q1 — mastery fresh task.** _Serves objective 1:_ Demonstrate independent mastery evidence for energy transfer and dissipation on a fresh task.
...
**Q2 — explain with evidence.** _Serves objective 2:_ Explain energy transfer and dissipation using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q3 — apply new task.** _Serves objective 3:_ Apply energy transfer and dissipation to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q4 — check revise next step.** _Serves objective 4:_ Check and revise the work on energy transfer and dissipation against the stated success criteria and name the next step.
...
**Q5 — essential question.** _Serves objective 3:_ Apply energy transfer and dissipation to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q6 — evidence quality.** _Serves objective 2:_ Explain energy transfer and dissipation using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q7 — limitation.** _Serves objective 3:_ Apply energy transfer and dissipation to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q8 — provenance.** _Serves objective 1:_ Demonstrate independent mastery evidence for energy transfer and dissipation on a fresh task.
...
- **prerequisite-gap** — Run the prerequisite reteach route for energy transfer and dissipation (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for energy transfer and dissipation (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for energy transfer and dissipation (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for energy transfer and dissipation (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for energy transfer and dissipation (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs11-physics-u05-l11` · built from `hs912-science-h3` at `e7551b9`._
