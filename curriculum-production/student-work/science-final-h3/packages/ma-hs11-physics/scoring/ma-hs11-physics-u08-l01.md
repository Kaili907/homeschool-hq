# Scoring authority — Launch and diagnostic: wave properties and terminology

**High School Physics (Grade 11)** · Unit 8: Waves and Their Mathematics · Day 1 · lesson `ma-hs11-physics-u08-l01`
...
_Topic `ma-hs11-physics-u08::wave properties and terminology` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-hs11-physics.correctness.json`._
...
**Q1 — phenomenon question.** _Serves objective 1:_ Observe the anchoring phenomenon, surface initial thinking about wave properties and terminology without penalty, and pose a testable question.
...
**Q7 — limitation.** _Serves objective 3:_ Apply wave properties and terminology to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q8 — provenance.** _Serves objective 1:_ Observe the anchoring phenomenon, surface initial thinking about wave properties and terminology without penalty, and pose a testable question.
...
_Package `swp-ma-hs11-physics-u08-l01` · built from `hs912-science-h3` at `e7551b9`._
