# Scoring authority — Guided practice A: computational energy models

**High School Physics (Grade 11)** · Unit 5: Energy: Modelling, Accounting, and Conservation · Day 3 · lesson `ma-hs11-physics-u05-l03`
...
_Topic `ma-hs11-physics-u05::computational energy models` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-hs11-physics.correctness.json`._
...
_Package `swp-ma-hs11-physics-u05-l03` · built from `hs912-science-h3` at `e7551b9`._
