# Scoring authority — Investigation: free-body diagrams

**High School Physics (Grade 11)** · Unit 2: Forces and Newton's Second Law · Day 7 · lesson `ma-hs11-physics-u02-l07`
...
_Topic `ma-hs11-physics-u02::free-body diagrams` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-hs11-physics.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- A free-body diagram shows only the forces acting on the chosen object, not the forces that object exerts on others.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Each force on the diagram has an identified source: another object that is in contact with, or interacting at a distance with, the chosen body.
- The two forces of an interaction pair act on different objects and therefore never appear on the same free-body diagram.
- Motion itself is not a force, so no arrow is drawn for the object's own movement.
...
- Drawing a force of motion, a force of inertia, or a force the object carries with it.
- Including on one diagram both members of an action-reaction pair.
- Drawing a force with no identifiable source object.

**Grade boundary.** Fictitious forces in rotating frames are beyond this course.
...
**Q1 — investigate.** _Serves objective 1:_ Plan and carry out a safe investigation of free-body diagrams, or its stated alternative, and record the learner's own data with its uncertainty.
...
**Q2 — explain with evidence.** _Serves objective 2:_ Explain free-body diagrams using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q3 — apply new task.** _Serves objective 3:_ Apply free-body diagrams to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q4 — check revise next step.** _Serves objective 4:_ Check and revise the work on free-body diagrams against the stated success criteria and name the next step.
...
**Q5 — essential question.** _Serves objective 3:_ Apply free-body diagrams to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q6 — evidence quality.** _Serves objective 2:_ Explain free-body diagrams using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q7 — limitation.** _Serves objective 1:_ Plan and carry out a safe investigation of free-body diagrams, or its stated alternative, and record the learner's own data with its uncertainty.
...
**Q8 — provenance.** _Serves objective 1:_ Plan and carry out a safe investigation of free-body diagrams, or its stated alternative, and record the learner's own data with its uncertainty.
...
- The learner completes the central task about free-body diagrams.
...
- **prerequisite-gap** — Run the prerequisite reteach route for free-body diagrams (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for free-body diagrams (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for free-body diagrams (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for free-body diagrams (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for free-body diagrams (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs11-physics-u02-l07` · built from `hs912-science-h3` at `e7551b9`._
