# Scoring authority — Concept model B: energy transfer and dissipation

**High School Physics (Grade 11)** · Unit 5: Energy: Modelling, Accounting, and Conservation · Day 5 · lesson `ma-hs11-physics-u05-l05`
...
**Q1 — explain with evidence.** _Serves objective 1:_ Explain energy transfer and dissipation using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q2 — apply new task.** _Serves objective 2:_ Apply energy transfer and dissipation to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q3 — check revise next step.** _Serves objective 3:_ Check and revise the work on energy transfer and dissipation against the stated success criteria and name the next step.
...
**Q4 — essential question.** _Serves objective 2:_ Apply energy transfer and dissipation to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q5 — evidence quality.** _Serves objective 1:_ Explain energy transfer and dissipation using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q6 — limitation.** _Serves objective 2:_ Apply energy transfer and dissipation to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q7 — provenance.** _Serves objective 1:_ Explain energy transfer and dissipation using evidence, a model, or a documented process rather than an unsupported answer.
...
_Package `swp-ma-hs11-physics-u05-l05` · built from `hs912-science-h3` at `e7551b9`._
