# Scoring authority — Independent application A: energy at macroscopic and particle scales

**High School Physics (Grade 11)** · Unit 5: Energy: Modelling, Accounting, and Conservation · Day 4 · lesson `ma-hs11-physics-u05-l04`
...
_Topic `ma-hs11-physics-u05::energy at macroscopic and particle scales` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-hs11-physics.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- The thermal energy of an object is the energy associated with the random motion of its particles.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Macroscopic kinetic energy is associated with the ordered motion of an object as a whole; thermal energy is associated with the random motion of its particles.
- Friction and inelastic collisions convert ordered macroscopic energy into random particle energy, which is why they raise temperature.
- Energy is conserved across the two scales, so an apparent macroscopic loss appears as a particle-scale gain.
...
- Claiming energy is destroyed by friction rather than converted to thermal energy.
- Claiming a moving object's macroscopic kinetic energy is the same thing as its thermal energy.
- Claiming temperature measures the total energy of an object.

**Grade boundary.** Statistical mechanics and equipartition are beyond this course.


## What a complete response contains, question by question

**Q1 — explain with evidence.** _Serves objective 1:_ Explain energy at macroscopic and particle scales using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q2 — apply new task.** _Serves objective 2:_ Apply energy at macroscopic and particle scales to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q3 — check revise next step.** _Serves objective 3:_ Check and revise the work on energy at macroscopic and particle scales against the stated success criteria and name the next step.
...
**Q4 — essential question.** _Serves objective 2:_ Apply energy at macroscopic and particle scales to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q5 — evidence quality.** _Serves objective 1:_ Explain energy at macroscopic and particle scales using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q6 — limitation.** _Serves objective 2:_ Apply energy at macroscopic and particle scales to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q7 — provenance.** _Serves objective 1:_ Explain energy at macroscopic and particle scales using evidence, a model, or a documented process rather than an unsupported answer.
...
- **prerequisite-gap** — Run the prerequisite reteach route for energy at macroscopic and particle scales (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for energy at macroscopic and particle scales (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for energy at macroscopic and particle scales (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for energy at macroscopic and particle scales (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for energy at macroscopic and particle scales (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs11-physics-u05-l04` · built from `hs912-science-h3` at `e7551b9`._
