# Scoring authority — Unit assessment: wave and particle models of light

**High School Physics (Grade 11)** · Unit 8: Waves and Their Mathematics · Day 11 · lesson `ma-hs11-physics-u08-l11`
...
_Topic `ma-hs11-physics-u08::wave and particle models of light` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-hs11-physics.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Light shows wave behaviour such as diffraction and interference, and particle behaviour such as the photoelectric effect; neither model alone accounts for all observations.

**Accepted relationships and models.** What this lesson's learning target asserts:

- The wave model explains interference, diffraction, and refraction; the particle model explains the photoelectric effect and the discreteness of light emission and absorption.
- Which model applies depends on the experiment; the two are not competing claims about which is really true.
- Photon energy increases with frequency, which is why the effect of light on matter depends on frequency rather than on brightness alone.

**Also correct.** Accept any of these framings — do not require the wording above:

- Describing this as wave-particle duality, or as complementary models each with a domain, are equally correct.
...
- Claiming one of the two models has been shown to be the correct one and the other abandoned.
- Claiming photon energy depends on the brightness of the light rather than on its frequency.
- Claiming light requires a medium to travel through.

**Grade boundary.** Quantum mechanics, the photoelectric equation, and de Broglie wavelength are acceptable to reference but not required.


## What a complete response contains, question by question

**Q1 — mastery fresh task.** _Serves objective 1:_ Demonstrate independent mastery evidence for wave and particle models of light on a fresh task.
...
**Q2 — explain with evidence.** _Serves objective 2:_ Explain wave and particle models of light using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q3 — apply new task.** _Serves objective 3:_ Apply wave and particle models of light to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q4 — check revise next step.** _Serves objective 4:_ Check and revise the work on wave and particle models of light against the stated success criteria and name the next step.
...
**Q5 — essential question.** _Serves objective 3:_ Apply wave and particle models of light to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q6 — evidence quality.** _Serves objective 2:_ Explain wave and particle models of light using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q7 — limitation.** _Serves objective 3:_ Apply wave and particle models of light to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q8 — provenance.** _Serves objective 1:_ Demonstrate independent mastery evidence for wave and particle models of light on a fresh task.
...
- **prerequisite-gap** — Run the prerequisite reteach route for wave and particle models of light (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for wave and particle models of light (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for wave and particle models of light (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for wave and particle models of light (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for wave and particle models of light (evidence type: application, require explanation: True, review timing: same-day).
...
_Package `swp-ma-hs11-physics-u08-l11` · built from `hs912-science-h3` at `e7551b9`._
