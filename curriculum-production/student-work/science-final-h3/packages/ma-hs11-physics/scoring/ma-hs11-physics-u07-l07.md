# Scoring authority — Investigation: electric and magnetic fields

**High School Physics (Grade 11)** · Unit 7: Fields, Electromagnetism, and Induction · Day 7 · lesson `ma-hs11-physics-u07-l07`
...
_Topic `ma-hs11-physics-u07::electric and magnetic fields` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-hs11-physics.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Electric fields exert forces on charges whether or not they are moving; magnetic fields exert forces only on moving charges and on magnetic materials.

**Accepted relationships and models.** What this lesson's learning target asserts:

- A field is a model in which one object modifies the space around it, and a second object responds to the field at its own location.
- The electric field direction is defined as the direction of the force on a positive test charge.
- Magnetic field lines form closed loops; isolated magnetic poles have never been observed.
...
- Claiming a magnetic field exerts a force on a stationary charge.
- Claiming isolated magnetic north or south poles can be produced by cutting a magnet.
- Treating field lines as physical objects rather than a representation.

**Grade boundary.** Maxwell's equations, field energy density, and relativistic field transformation are beyond this course.
...
**Q1 — investigate.** _Serves objective 1:_ Plan and carry out a safe investigation of electric and magnetic fields, or its stated alternative, and record the learner's own data with its uncertainty.
...
**Q2 — explain with evidence.** _Serves objective 2:_ Explain electric and magnetic fields using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q3 — apply new task.** _Serves objective 3:_ Apply electric and magnetic fields to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q4 — check revise next step.** _Serves objective 4:_ Check and revise the work on electric and magnetic fields against the stated success criteria and name the next step.
...
**Q5 — essential question.** _Serves objective 3:_ Apply electric and magnetic fields to a task the learner has not seen before, showing the reasoning that produced the result.
...
**Q6 — evidence quality.** _Serves objective 2:_ Explain electric and magnetic fields using evidence, a model, or a documented process rather than an unsupported answer.
...
**Q7 — limitation.** _Serves objective 1:_ Plan and carry out a safe investigation of electric and magnetic fields, or its stated alternative, and record the learner's own data with its uncertainty.
...
**Q8 — provenance.** _Serves objective 1:_ Plan and carry out a safe investigation of electric and magnetic fields, or its stated alternative, and record the learner's own data with its uncertainty.
...
- **prerequisite-gap** — Run the prerequisite reteach route for electric and magnetic fields (representation: concrete, require explanation: True, retry count: 1).
- **procedure-without-understanding** — Run the conceptual explanation route for electric and magnetic fields (representation: visual, require explanation: True).
- **correct-low-confidence** — Run the confidence calibration route for electric and magnetic fields (representation: text, require explanation: False, retry count: 0).
- **repeated-error-pattern** — Run the error pattern contrast route for electric and magnetic fields (representation: worked-example, retry count: 2, review timing: next-session).
- **mastery-evidence** — Run the mastery evidence collection route for electric and magnetic fields (evidence type: application, require explanation: True, review timing: same-day).
...
- physical: Swallowed magnets are a surgical emergency: two or more magnets, or a magnet and any swallowed metal object, attract through the wall of the gut and cut off its blood supply. — mitigation: Count the magnets out and back in every session, work over a tray, never bring one near a mouth, and store them closed and labelled out of reach of children and pets. A suspected swallow is an emergency: go at once.
- physical: A wire connected across a battery heats rapidly and can burn skin or start a fire, and a nail is a magnetic core rather than a resistance. — mitigation: Use at least 1 m of thin 28-30 AWG enamelled wire so the coil has real resistance; a short or thick wire is a short circuit even with a nail through it. One 1.5 V cell only - NEVER mains, lithium, or button cell.
- physical: A multimeter left on a current range and placed across a battery ruptures its fuse and can arc. — mitigation: The multimeter stays on a voltage range for every measurement in this investigation. A current range is never placed across a cell.
- physical: Strong neodymium magnets pinch skin severely and destroy electronics and cards. — mitigation: Handle magnets one at a time, keep them well away from phones, laptops, bank cards, and any medical device such as a pacemaker, and store them separated.
...
_Package `swp-ma-hs11-physics-u07-l07` · built from `hs912-science-h3` at `e7551b9`._
