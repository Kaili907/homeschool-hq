# Scoring authority — Unit assessment: comparing past and present

**Grade 3 Science** · Unit 7: Fossils and Environments Long Ago · Day 11 · lesson `ma-g3-science-u07-l11`
...
_Topic `ma-g3-science-u07::comparing past and present` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Extinct means no members of that kind of organism are alive anywhere.
- People did not live alongside the large non-bird dinosaurs.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Some fossil organisms resemble organisms alive today; others resemble nothing now living.
- Organisms known only as fossils are extinct: none are alive anywhere.
- A resemblance between a fossil and a living organism is evidence of similarity, not proof that one descended from the other.
...
- Treating 'it might still be alive somewhere' as a scientific conclusion about an extinct organism.
- Claiming a fossil organism turned into a living organism during its own lifetime.
- Claiming people lived alongside the large non-bird dinosaurs.

**Grade boundary.** Evolutionary relationship and common ancestry are Grade 8 and High School work.


## What a complete response contains, question by question

**Q1 — demonstrate mastery.** _Serves objective 1:_ Demonstrate current mastery of comparing past and present through selected-response, constructed-response, and applied evidence.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of comparing past and present.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about comparing past and present using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Demonstrate current mastery of comparing past and present through selected-response, constructed-response, and applied evidence.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of comparing past and present.
...
**Q6 — limitation.** _Serves objective 1:_ Demonstrate current mastery of comparing past and present through selected-response, constructed-response, and applied evidence.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of comparing past and present.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for comparing past and present, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for comparing past and present works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of comparing past and present, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking comparing past and present mastered.
- **requests an experiment** — Explain the science and the safety rule for comparing past and present; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g3-science-u07-l11` · built from `g34-committed` at `4c6ca4e`._
