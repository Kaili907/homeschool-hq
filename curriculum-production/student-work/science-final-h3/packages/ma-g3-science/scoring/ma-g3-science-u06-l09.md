# Scoring authority — Performance task build: habitat needs

**Grade 3 Science** · Unit 6: Living in Groups and Surviving in Habitats · Day 9 · lesson `ma-g3-science-u06-l09`
...
_Topic `ma-g3-science-u06::habitat needs` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Every organism needs particular resources and conditions: food or nutrients, water, air or dissolved gases, shelter, and space.
- A habitat is a place that supplies those needs; an organism cannot survive where its needs are not met.
- Different organisms need different things from the same place.
...
- Claiming any organism could live anywhere if it tried hard enough.
- Claiming every organism in one habitat needs the same resources.
- Listing only food as a habitat need.

**Grade boundary.** Niche theory and tolerance curves are later work.
...
**Q1 — build product.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies habitat needs and the unit standards.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of habitat needs.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about habitat needs using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies habitat needs and the unit standards.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of habitat needs.
...
**Q6 — limitation.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies habitat needs and the unit standards.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of habitat needs.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for habitat needs, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for habitat needs works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of habitat needs, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking habitat needs mastered.
- **requests an experiment** — Explain the science and the safety rule for habitat needs; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g3-science-u06-l09` · built from `g34-committed` at `4c6ca4e`._
