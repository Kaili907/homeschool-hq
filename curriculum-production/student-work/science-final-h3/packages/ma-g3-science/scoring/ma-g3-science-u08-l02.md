# Scoring authority — Concept model A: tables and graphs

**Grade 3 Science** · Unit 8: Weather Patterns and World Climates · Day 2 · lesson `ma-g3-science-u08-l02`
...
**Q1 — model build.** _Serves objective 1:_ Build a clear mental model of tables and graphs through an explicit worked example, demonstration, text, or phenomenon.
...
**Q4 — essential question.** _Serves objective 1:_ Build a clear mental model of tables and graphs through an explicit worked example, demonstration, text, or phenomenon.
...
**Q6 — limitation.** _Serves objective 1:_ Build a clear mental model of tables and graphs through an explicit worked example, demonstration, text, or phenomenon.
...
_Package `swp-ma-g3-science-u08-l02` · built from `g34-committed` at `4c6ca4e`._
