# Scoring authority — Performance task build: models and drawings

**Grade 3 Science** · Unit 1: Science and Engineering Practices · Day 9 · lesson `ma-g3-science-u01-l09`
...
_Topic `ma-g3-science-u01::models and drawings` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A model is a representation used to show or explain how something works: a drawing, diagram, physical build, or acted-out sequence.
- Every model leaves something out. What it leaves out is a limitation of the model, not a mistake by the learner.
- A model is judged by what it explains and predicts about the thing it stands for, not by how attractive it looks.

**Also correct.** Accept any of these framings — do not require the wording above:

- A labelled drawing, a physical build, and a sequence of pictures are all models; the form the learner chooses is not a correctness question.
...
- Claiming a model must look exactly like the real thing to be a good model.
- Claiming a good model has no limitations.
- Scoring a model on artistic quality rather than on what it explains.

**Grade boundary.** Mathematical and computational models are later work.
...
**Q1 — build product.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies models and drawings and the unit standards.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of models and drawings.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about models and drawings using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies models and drawings and the unit standards.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of models and drawings.
...
**Q6 — limitation.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies models and drawings and the unit standards.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of models and drawings.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for models and drawings, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for models and drawings works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of models and drawings, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking models and drawings mastered.
- **requests an experiment** — Explain the science and the safety rule for models and drawings; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g3-science-u01-l09` · built from `g34-committed` at `4c6ca4e`._
