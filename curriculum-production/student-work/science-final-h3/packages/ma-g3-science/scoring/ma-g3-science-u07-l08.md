# Scoring authority — Reteach and varied practice: reading rock layers

**Grade 3 Science** · Unit 7: Fossils and Environments Long Ago · Day 8 · lesson `ma-g3-science-u07-l08`
...
_Topic `ma-g3-science-u07::reading rock layers` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- In undisturbed sedimentary layers, a lower layer is older than a layer above it.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Sedimentary rock forms in layers, with newer layers deposited on top of older ones.
- In undisturbed layers, a lower layer is older than the layer above it.
- Layers can be tilted, folded, or broken after they form, so whether a sequence is undisturbed has to be checked rather than assumed.
...
- Claiming the top layer is the oldest.
- Claiming the order of layers gives an age in years.
- Applying the deeper-is-older rule to layers that have visibly been tilted or overturned without saying so.

**Grade boundary.** Radiometric dating and the stratigraphic principles by their formal names are Grade 8 and High School work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for reading rock layers, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of reading rock layers.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about reading rock layers using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for reading rock layers, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of reading rock layers.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for reading rock layers, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of reading rock layers.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for reading rock layers, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for reading rock layers works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of reading rock layers, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking reading rock layers mastered.
- **requests an experiment** — Explain the science and the safety rule for reading rock layers; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g3-science-u07-l08` · built from `g34-committed` at `4c6ca4e`._
