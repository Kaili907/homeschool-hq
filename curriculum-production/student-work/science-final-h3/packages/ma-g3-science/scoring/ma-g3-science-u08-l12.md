# Scoring authority — Correction and reflection: combining information sources

**Grade 3 Science** · Unit 8: Weather Patterns and World Climates · Day 12 · lesson `ma-g3-science-u08-l12`
...
_Topic `ma-g3-science-u08::combining information sources` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A conclusion about weather or climate is stronger when it draws on more than one record or source.
- Each source is named so a reader can check it.
- Sources that disagree are information in themselves; the disagreement is reported, not hidden.
...
- Presenting a combined conclusion with no sources named.
- Dropping a source because it disagrees with the others.
- Treating two copies of the same source as two independent sources.

**Grade boundary.** Weighting and formal reconciliation of conflicting datasets are later work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for combining information sources, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of combining information sources.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about combining information sources using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for combining information sources, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of combining information sources.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for combining information sources, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of combining information sources.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for combining information sources, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for combining information sources works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of combining information sources, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking combining information sources mastered.
- **requests an experiment** — Explain the science and the safety rule for combining information sources; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g3-science-u08-l12` · built from `g34-committed` at `4c6ca4e`._
