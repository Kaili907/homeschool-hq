# Scoring authority — Correction and reflection: variation and advantage

**Grade 3 Science** · Unit 7: Fossils and Environments Long Ago · Day 12 · lesson `ma-g3-science-u07-l12`
...
_Topic `ma-g3-science-u07::variation and advantage` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Individuals in a past population varied, just as individuals do today.
- A variation that helped individuals survive and reproduce in their environment could become more common in later generations.
- Which variation counts as an advantage is set by the environment, not by the organism.
...
- Claiming an individual organism changes its own traits to suit its environment.
- Claiming a trait appeared because the organism needed it.
- Claiming an advantage in one environment is an advantage everywhere.

**Grade boundary.** The mechanism of natural selection and the genetics behind it are Grade 8 and High School work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for variation and advantage, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of variation and advantage.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about variation and advantage using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for variation and advantage, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of variation and advantage.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for variation and advantage, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of variation and advantage.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for variation and advantage, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for variation and advantage works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of variation and advantage, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking variation and advantage mastered.
- **requests an experiment** — Explain the science and the safety rule for variation and advantage; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g3-science-u07-l12` · built from `g34-committed` at `4c6ca4e`._
