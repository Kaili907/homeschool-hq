# Scoring authority — Reteach and varied practice: plant life cycles

**Grade 3 Science** · Unit 4: Life Cycles of Organisms · Day 8 · lesson `ma-g3-science-u04-l08`
...
_Topic `ma-g3-science-u04::plant life cycles` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- In a flowering plant, pollination and fertilisation must occur before seeds form.

**Accepted relationships and models.** What this lesson's learning target asserts:

- A flowering plant's cycle runs seed, germination, seedling, mature plant with flowers, pollination, then fruit and seed.
- Seeds form after pollination and fertilisation; a flower that is never pollinated does not produce seed.
- A seed contains a young plant and a store of food that supports early growth before the seedling has leaves of its own.

**Also correct.** Accept any of these framings — do not require the wording above:

- Pollination by wind, water, insects, or other animals are all correct; the agent is not fixed.
...
- Claiming a flowering plant produces seeds without pollination.
- Claiming a germinating seed grows because the soil feeds it; early growth runs on the seed's own stored food.
- Claiming plants take their food ready-made from the soil rather than making it themselves.

**Grade boundary.** Photosynthesis chemistry, double fertilisation, and the cycles of non-flowering plants are later work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for plant life cycles, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of plant life cycles.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about plant life cycles using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for plant life cycles, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of plant life cycles.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for plant life cycles, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of plant life cycles.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for plant life cycles, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for plant life cycles works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of plant life cycles, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking plant life cycles mastered.
- **requests an experiment** — Explain the science and the safety rule for plant life cycles; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g3-science-u04-l08` · built from `g34-committed` at `4c6ca4e`._
