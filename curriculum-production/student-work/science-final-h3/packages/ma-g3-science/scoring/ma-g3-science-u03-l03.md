# Scoring authority — Guided practice A: forces without contact

**Grade 3 Science** · Unit 3: Magnetic and Electric Interactions · Day 3 · lesson `ma-g3-science-u03-l03`
...
_Topic `ma-g3-science-u03::forces without contact` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._
...
**Q1 — guided practice.** _Serves objective 1:_ Practice forces without contact with prompts, feedback, and gradually reduced support.
...
**Q4 — essential question.** _Serves objective 1:_ Practice forces without contact with prompts, feedback, and gradually reduced support.
...
**Q6 — limitation.** _Serves objective 1:_ Practice forces without contact with prompts, feedback, and gradually reduced support.
...
_Package `swp-ma-g3-science-u03-l03` · built from `g34-committed` at `4c6ca4e`._
