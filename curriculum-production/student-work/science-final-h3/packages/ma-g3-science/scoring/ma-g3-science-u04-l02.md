# Scoring authority — Concept model A: plant life cycles

**Grade 3 Science** · Unit 4: Life Cycles of Organisms · Day 2 · lesson `ma-g3-science-u04-l02`
...
**Q1 — model build.** _Serves objective 1:_ Build a clear mental model of plant life cycles through an explicit worked example, demonstration, text, or phenomenon.
...
**Q4 — essential question.** _Serves objective 1:_ Build a clear mental model of plant life cycles through an explicit worked example, demonstration, text, or phenomenon.
...
**Q6 — limitation.** _Serves objective 1:_ Build a clear mental model of plant life cycles through an explicit worked example, demonstration, text, or phenomenon.
...
_Package `swp-ma-g3-science-u04-l02` · built from `g34-committed` at `4c6ca4e`._
