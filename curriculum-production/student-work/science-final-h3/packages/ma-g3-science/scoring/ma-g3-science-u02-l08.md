# Scoring authority — Reteach and varied practice: balanced and unbalanced forces

**Grade 3 Science** · Unit 2: Forces and Motion · Day 8 · lesson `ma-g3-science-u02-l08`
...
_Topic `ma-g3-science-u02::balanced and unbalanced forces` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Balanced forces do not change an object's motion; unbalanced forces do.

**Accepted relationships and models.** What this lesson's learning target asserts:

- When the forces on an object are balanced, its motion does not change: at rest it stays at rest, and moving it keeps the same speed and direction.
- When the forces on an object are unbalanced, its motion changes.
- Balanced does not mean no forces are acting; it means the forces cancel each other.
...
- Claiming an object sitting still has no forces acting on it.
- Claiming balanced forces bring a moving object to a stop.
- Claiming the larger or heavier object always wins in a push.

**Grade boundary.** Vector addition, free-body diagrams, and quantitative net force are later work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for balanced and unbalanced forces, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of balanced and unbalanced forces.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about balanced and unbalanced forces using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for balanced and unbalanced forces, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of balanced and unbalanced forces.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for balanced and unbalanced forces, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of balanced and unbalanced forces.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for balanced and unbalanced forces, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for balanced and unbalanced forces works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of balanced and unbalanced forces, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking balanced and unbalanced forces mastered.
- **requests an experiment** — Explain the science and the safety rule for balanced and unbalanced forces; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g3-science-u02-l08` · built from `g34-committed` at `4c6ca4e`._
