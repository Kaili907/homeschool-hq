# Scoring authority — Correction and reflection: evidence for a survival claim

**Grade 3 Science** · Unit 6: Living in Groups and Surviving in Habitats · Day 12 · lesson `ma-g3-science-u06-l12`
...
_Topic `ma-g3-science-u06::evidence for a survival claim` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Evidence for a survival claim names the habitat, names the trait, and connects the trait to a need in that habitat.
- Evidence can come from the learner's own observation or from a named published source.
- A survival claim covers the habitat the evidence came from, not every habitat.
...
- Supporting a survival claim with a trait that has no stated connection to a need in that habitat.
- Using an invented example as evidence.
- Extending a survival claim to habitats the evidence never covered.

**Grade boundary.** Field-study design and population data analysis are later work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for evidence for a survival claim, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of evidence for a survival claim.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about evidence for a survival claim using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for evidence for a survival claim, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of evidence for a survival claim.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for evidence for a survival claim, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of evidence for a survival claim.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for evidence for a survival claim, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for evidence for a survival claim works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of evidence for a survival claim, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking evidence for a survival claim mastered.
- **requests an experiment** — Explain the science and the safety rule for evidence for a survival claim; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g3-science-u06-l12` · built from `g34-committed` at `4c6ca4e`._
