# Scoring authority — Investigation or close reading: pushes and pulls

**Grade 3 Science** · Unit 2: Forces and Motion · Day 7 · lesson `ma-g3-science-u02-l07`
...
_Topic `ma-g3-science-u02::pushes and pulls` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._
...
- A force is a push or a pull on an object, and it comes from an interaction between two objects.
- A force has both a strength and a direction.
- A force can start motion, stop motion, change speed, or change direction.

**Also correct.** Accept any of these framings — do not require the wording above:

- Describing a force by an arrow, by words, or by a demonstration are all correct representations at this grade.
...
- Claiming an object exerts a force on itself, or that a moving object carries a stored force inside it.
- Claiming an object stopped because the force ran out, rather than because another force such as friction acted on it.
- Describing a force by strength only, with no direction.

**Grade boundary.** Newton's laws by name, the newton as a unit, and net-force arithmetic belong to later grades.
...
**Q1 — analyze evidence.** _Serves objective 1:_ Gather and analyze evidence related to pushes and pulls, then record a defensible interpretation.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of pushes and pulls.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about pushes and pulls using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Gather and analyze evidence related to pushes and pulls, then record a defensible interpretation.
...
**Q5 — evidence quality.** _Serves objective 1:_ Gather and analyze evidence related to pushes and pulls, then record a defensible interpretation.
...
**Q6 — limitation.** _Serves objective 1:_ Gather and analyze evidence related to pushes and pulls, then record a defensible interpretation.
...
**Q7 — provenance.** _Serves objective 1:_ Gather and analyze evidence related to pushes and pulls, then record a defensible interpretation.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for pushes and pulls, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for pushes and pulls works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of pushes and pulls, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking pushes and pulls mastered.
- **requests an experiment** — Explain the science and the safety rule for pushes and pulls; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g3-science-u02-l07` · built from `g34-committed` at `4c6ca4e`._
