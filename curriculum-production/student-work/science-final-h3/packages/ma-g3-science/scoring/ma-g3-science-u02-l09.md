# Scoring authority — Performance task build: patterns in motion

**Grade 3 Science** · Unit 2: Forces and Motion · Day 9 · lesson `ma-g3-science-u02-l09`
...
_Topic `ma-g3-science-u02::patterns in motion` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Motion that repeats regularly, such as a swing, a spinning wheel, or a ball rolling down the same ramp, can be observed, described, and used to predict what happens next.
- A pattern is established by repeated observation; something seen once is not yet a pattern.
- A pattern supports a prediction only while the conditions that produced it stay the same.
...
- Calling a single observation a pattern and predicting from it.
- Predicting from a pattern after the conditions have been changed, without saying so.
- Claiming a pattern explains why the motion happens; a pattern describes, it does not by itself explain.

**Grade boundary.** Position-time graphs and the mathematics of periodic motion are later work.
...
**Q1 — build product.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies patterns in motion and the unit standards.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of patterns in motion.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about patterns in motion using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies patterns in motion and the unit standards.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of patterns in motion.
...
**Q6 — limitation.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies patterns in motion and the unit standards.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of patterns in motion.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for patterns in motion, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for patterns in motion works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of patterns in motion, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking patterns in motion mastered.
- **requests an experiment** — Explain the science and the safety rule for patterns in motion; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g3-science-u02-l09` · built from `g34-committed` at `4c6ca4e`._
