# Scoring authority — Synthesis and review: traits influenced by environment

**Grade 3 Science** · Unit 5: Inherited Traits and Variation · Day 10 · lesson `ma-g3-science-u05-l10`
...
_Topic `ma-g3-science-u05::traits influenced by environment` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Some traits are affected by the environment: food, water, light, temperature, exercise, and injury.
- Two organisms with the same inheritance can end up different if they grow in different environments.
- An environmental effect on one organism is not passed to its offspring by inheritance.
...
- Claiming every difference between two organisms is inherited.
- Claiming a trait changed by the environment during an organism's life will be inherited by its offspring.
- Claiming the environment has no effect on any trait.

**Grade boundary.** Gene-environment interaction and epigenetics are later work.


## What a complete response contains, question by question

**Q1 — connect unit.** _Serves objective 1:_ Connect traits influenced by environment to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of traits influenced by environment.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about traits influenced by environment using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Connect traits influenced by environment to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of traits influenced by environment.
...
**Q6 — limitation.** _Serves objective 1:_ Connect traits influenced by environment to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of traits influenced by environment.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for traits influenced by environment, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for traits influenced by environment works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of traits influenced by environment, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking traits influenced by environment mastered.
- **requests an experiment** — Explain the science and the safety rule for traits influenced by environment; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g3-science-u05-l10` · built from `g34-committed` at `4c6ca4e`._
