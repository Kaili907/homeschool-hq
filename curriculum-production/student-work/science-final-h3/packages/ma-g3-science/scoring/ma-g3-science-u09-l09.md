# Scoring authority — Performance task build: design criteria and constraints

**Grade 3 Science** · Unit 9: Capstone: Weather Hazards and Changing Habitats · Day 9 · lesson `ma-g3-science-u09-l09`
...
_Topic `ma-g3-science-u09::design criteria and constraints` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A hazard-reduction design states what it must achieve, which are its criteria, and the limits it must respect, which are its constraints, including safety and cost.
- The problem is defined before solutions are generated.
- A design that breaks a stated constraint has not solved the problem, however well it meets the criteria.
...
- Proposing a solution before stating what it has to achieve.
- Ignoring a stated constraint and still calling the design successful.
- Treating safety as an optional constraint.

**Grade boundary.** Formal engineering standards and building codes are later work.
...
**Q1 — build product.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies design criteria and constraints and the unit standards.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of design criteria and constraints.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about design criteria and constraints using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies design criteria and constraints and the unit standards.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of design criteria and constraints.
...
**Q6 — limitation.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies design criteria and constraints and the unit standards.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of design criteria and constraints.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for design criteria and constraints, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for design criteria and constraints works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of design criteria and constraints, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking design criteria and constraints mastered.
- **requests an experiment** — Explain the science and the safety rule for design criteria and constraints; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g3-science-u09-l09` · built from `g34-committed` at `4c6ca4e`._
