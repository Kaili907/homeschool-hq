# Scoring authority — Synthesis and review: weather compared with climate

**Grade 3 Science** · Unit 8: Weather Patterns and World Climates · Day 10 · lesson `ma-g3-science-u08-l10`
...
_Topic `ma-g3-science-u08::weather compared with climate` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Climate is the long-term pattern of weather at a place, described over many years.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Weather is short-term and local; climate is the pattern of weather at a place over many years.
- One cold day does not contradict a warm climate, and one hot week is not a change in climate.
- Climate is described with long-term averages and ranges, not single readings.
...
- Using a single day's weather as evidence about climate.
- Treating weather and climate as the same thing.
- Claiming climate never changes.

**Grade boundary.** Climate classification systems and attribution of climate change are later work.


## What a complete response contains, question by question

**Q1 — connect unit.** _Serves objective 1:_ Connect weather compared with climate to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of weather compared with climate.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about weather compared with climate using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Connect weather compared with climate to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of weather compared with climate.
...
**Q6 — limitation.** _Serves objective 1:_ Connect weather compared with climate to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of weather compared with climate.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for weather compared with climate, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for weather compared with climate works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of weather compared with climate, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking weather compared with climate mastered.
- **requests an experiment** — Explain the science and the safety rule for weather compared with climate; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g3-science-u08-l10` · built from `g34-committed` at `4c6ca4e`._
