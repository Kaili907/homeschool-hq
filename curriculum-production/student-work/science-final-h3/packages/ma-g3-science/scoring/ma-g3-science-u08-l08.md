# Scoring authority — Reteach and varied practice: tables and graphs

**Grade 3 Science** · Unit 8: Weather Patterns and World Climates · Day 8 · lesson `ma-g3-science-u08-l08`
...
_Topic `ma-g3-science-u08::tables and graphs` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A table organises weather data so values can be compared; a graph shows the pattern in those values.
- A graph needs labelled axes with units, or a reader cannot tell what is shown.
- A graph shows what was recorded; it does not add information that was never measured.

**Also correct.** Accept any of these framings — do not require the wording above:

- Bar graphs and line graphs are both correct choices here, provided the graph type suits the data.
...
- Reading a trend off a graph with unlabelled axes.
- Extending a graph beyond the data and treating the extension as a measurement.
- Changing a plotted value so the graph looks smoother.

**Grade boundary.** Line of best fit, interpolation, and correlation are later work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for tables and graphs, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of tables and graphs.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about tables and graphs using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for tables and graphs, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of tables and graphs.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for tables and graphs, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of tables and graphs.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for tables and graphs, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for tables and graphs works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of tables and graphs, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking tables and graphs mastered.
- **requests an experiment** — Explain the science and the safety rule for tables and graphs; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g3-science-u08-l08` · built from `g34-committed` at `4c6ca4e`._
