# Scoring authority — Concept model B: measuring and recording data

**Grade 3 Science** · Unit 1: Science and Engineering Practices · Day 5 · lesson `ma-g3-science-u01-l05`
...
**Q1 — model build.** _Serves objective 1:_ Build a clear mental model of measuring and recording data through an explicit worked example, demonstration, text, or phenomenon.
...
**Q4 — essential question.** _Serves objective 1:_ Build a clear mental model of measuring and recording data through an explicit worked example, demonstration, text, or phenomenon.
...
**Q6 — limitation.** _Serves objective 1:_ Build a clear mental model of measuring and recording data through an explicit worked example, demonstration, text, or phenomenon.
...
_Package `swp-ma-g3-science-u01-l05` · built from `g34-committed` at `4c6ca4e`._
