# Scoring authority — Synthesis and review: comparing life cycles

**Grade 3 Science** · Unit 4: Life Cycles of Organisms · Day 10 · lesson `ma-g3-science-u04-l10`
...
_Topic `ma-g3-science-u04::comparing life cycles` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Comparing life cycles means matching stages that play the same role, not stages that share a name.
- Organisms that look very different can share the same overall cycle pattern.
- A difference between two life cycles is evidence about the organisms, not a fault in either of them.
...
- Claiming an organism with a shorter life cycle is less developed or less successful.
- Matching a plant's seed to an animal's adult stage as if they played the same role.
- Claiming two organisms with different stage names cannot be compared.

**Grade boundary.** Interpreting life-cycle similarity as evidence of relatedness is later work.


## What a complete response contains, question by question

**Q1 — connect unit.** _Serves objective 1:_ Connect comparing life cycles to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of comparing life cycles.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about comparing life cycles using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Connect comparing life cycles to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of comparing life cycles.
...
**Q6 — limitation.** _Serves objective 1:_ Connect comparing life cycles to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of comparing life cycles.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for comparing life cycles, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for comparing life cycles works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of comparing life cycles, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking comparing life cycles mastered.
- **requests an experiment** — Explain the science and the safety rule for comparing life cycles; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g3-science-u04-l10` · built from `g34-committed` at `4c6ca4e`._
