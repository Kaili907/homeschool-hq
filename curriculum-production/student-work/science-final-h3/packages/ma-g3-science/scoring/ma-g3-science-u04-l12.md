# Scoring authority — Correction and reflection: diverse but shared patterns

**Grade 3 Science** · Unit 4: Life Cycles of Organisms · Day 12 · lesson `ma-g3-science-u04-l12`
...
_Topic `ma-g3-science-u04::diverse but shared patterns` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Organisms are enormously varied, and yet all of them share the broad life-cycle pattern of birth, growth, reproduction, and death.
- A pattern shared across many kinds of organism is something to be explained, not a coincidence.
- A single organism's cycle is an example of the pattern, not the pattern itself.
...
- Claiming that because organisms look different they share nothing.
- Treating one organism's particular stages as the pattern that all organisms must follow.
- Claiming that a shared pattern means the organisms are the same kind.

**Grade boundary.** Common ancestry as the explanation for shared patterns is Grade 8 and High School work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for diverse but shared patterns, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of diverse but shared patterns.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about diverse but shared patterns using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for diverse but shared patterns, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of diverse but shared patterns.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for diverse but shared patterns, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of diverse but shared patterns.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for diverse but shared patterns, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for diverse but shared patterns works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of diverse but shared patterns, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking diverse but shared patterns mastered.
- **requests an experiment** — Explain the science and the safety rule for diverse but shared patterns; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g3-science-u04-l12` · built from `g34-committed` at `4c6ca4e`._
