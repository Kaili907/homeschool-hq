# Scoring authority — Investigation or close reading: careful observations

**Grade 3 Science** · Unit 1: Science and Engineering Practices · Day 7 · lesson `ma-g3-science-u01-l07`
...
_Topic `ma-g3-science-u01::careful observations` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- An observation is information taken in directly, through the senses or through a tool such as a hand lens, ruler, or thermometer.
- An inference is an explanation of what an observation might mean; the same observation can support more than one inference.
- An observation recorded at the time it is made is more reliable than one recalled later, because memory changes.

**Also correct.** Accept any of these framings — do not require the wording above:

- Describing observations as qualitative or quantitative is correct and so is describing them as words or numbers; neither wording is required.
...
- Recording an inference as an observation, such as writing 'the plant is thirsty' instead of 'the leaves are drooping'.
- Claiming that an opinion about what happened counts as data.
- Claiming an observation only counts if a tool was used; unaided senses give observations too.

**Grade boundary.** Measurement uncertainty, instrument calibration, and statistical treatment of repeated observations belong to later grades and must not be required here.
...
**Q1 — analyze evidence.** _Serves objective 1:_ Gather and analyze evidence related to careful observations, then record a defensible interpretation.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of careful observations.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about careful observations using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Gather and analyze evidence related to careful observations, then record a defensible interpretation.
...
**Q5 — evidence quality.** _Serves objective 1:_ Gather and analyze evidence related to careful observations, then record a defensible interpretation.
...
**Q6 — limitation.** _Serves objective 1:_ Gather and analyze evidence related to careful observations, then record a defensible interpretation.
...
**Q7 — provenance.** _Serves objective 1:_ Gather and analyze evidence related to careful observations, then record a defensible interpretation.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for careful observations, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for careful observations works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of careful observations, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking careful observations mastered.
- **requests an experiment** — Explain the science and the safety rule for careful observations; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g3-science-u01-l07` · built from `g34-committed` at `4c6ca4e`._
