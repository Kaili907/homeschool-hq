# Scoring authority — Independent application A: fair tests

**Grade 3 Science** · Unit 1: Science and Engineering Practices · Day 4 · lesson `ma-g3-science-u01-l04`
...
**Q1 — apply independent.** _Serves objective 1:_ Apply fair tests independently in a new representation, text, situation, or design constraint.
...
**Q4 — essential question.** _Serves objective 1:_ Apply fair tests independently in a new representation, text, situation, or design constraint.
...
**Q6 — limitation.** _Serves objective 1:_ Apply fair tests independently in a new representation, text, situation, or design constraint.
...
_Package `swp-ma-g3-science-u01-l04` · built from `g34-committed` at `4c6ca4e`._
