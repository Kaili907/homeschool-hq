# Scoring authority — Reteach and varied practice: testable questions

**Grade 3 Science** · Unit 1: Science and Engineering Practices · Day 8 · lesson `ma-g3-science-u01-l08`
...
_Topic `ma-g3-science-u01::testable questions` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A testable question is one that could be answered by observing something or by doing something and seeing what happens.
- A testable question names something to change or look at and something to notice or measure.
- Questions about what is best, prettiest, or fairest are not settled by a test on their own, because no observation decides them.

**Also correct.** Accept any of these framings — do not require the wording above:

- A question phrased as 'what happens if', 'how does X affect Y', or 'which of these' can all be testable; no single sentence frame is required.
...
- Calling a question testable when no possible observation could answer it.
- Claiming a question must begin with 'why' to be scientific.
- Treating 'what does the book say' as a testable question about the natural world.

**Grade boundary.** Naming independent and dependent variables, and formal hypothesis statements, are introduced later.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for testable questions, then demonstrate corrected understanding.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for testable questions, then demonstrate corrected understanding.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for testable questions, then demonstrate corrected understanding.
...
_Package `swp-ma-g3-science-u01-l08` · built from `g34-committed` at `4c6ca4e`._
