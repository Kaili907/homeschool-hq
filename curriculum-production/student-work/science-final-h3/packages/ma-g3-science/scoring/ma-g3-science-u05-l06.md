# Scoring authority — Guided practice B: evidence from observation

**Grade 3 Science** · Unit 5: Inherited Traits and Variation · Day 6 · lesson `ma-g3-science-u05-l06`
...
**Q1 — guided practice.** _Serves objective 1:_ Practice evidence from observation with prompts, feedback, and gradually reduced support.
...
**Q4 — essential question.** _Serves objective 1:_ Practice evidence from observation with prompts, feedback, and gradually reduced support.
...
**Q6 — limitation.** _Serves objective 1:_ Practice evidence from observation with prompts, feedback, and gradually reduced support.
...
_Package `swp-ma-g3-science-u05-l06` · built from `g34-committed` at `4c6ca4e`._
