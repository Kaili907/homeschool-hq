# Scoring authority — Guided practice A: design criteria and constraints

**Grade 3 Science** · Unit 9: Capstone: Weather Hazards and Changing Habitats · Day 3 · lesson `ma-g3-science-u09-l03`
...
_Topic `ma-g3-science-u09::design criteria and constraints` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._
...
**Q1 — guided practice.** _Serves objective 1:_ Practice design criteria and constraints with prompts, feedback, and gradually reduced support.
...
**Q4 — essential question.** _Serves objective 1:_ Practice design criteria and constraints with prompts, feedback, and gradually reduced support.
...
**Q6 — limitation.** _Serves objective 1:_ Practice design criteria and constraints with prompts, feedback, and gradually reduced support.
...
_Package `swp-ma-g3-science-u09-l03` · built from `g34-committed` at `4c6ca4e`._
