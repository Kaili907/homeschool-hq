# Scoring authority — Correction and reflection: evidence-based claims

**Grade 3 Science** · Unit 9: Capstone: Weather Hazards and Changing Habitats · Day 12 · lesson `ma-g3-science-u09-l12`
...
_Topic `ma-g3-science-u09::evidence-based claims` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A claim about a hazard or a design is supported by recorded data or by a named source.
- The reasoning states how the evidence supports the claim.
- A claim broader than the evidence covers is overstated and should be narrowed to what was actually shown.
...
- Making a claim broader than the evidence collected supports.
- Presenting an untested design as proven.
- Citing no source and no data for a factual claim.

**Grade boundary.** Quantified uncertainty and confidence statements are later work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for evidence-based claims, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of evidence-based claims.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about evidence-based claims using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for evidence-based claims, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of evidence-based claims.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for evidence-based claims, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of evidence-based claims.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for evidence-based claims, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for evidence-based claims works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of evidence-based claims, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking evidence-based claims mastered.
- **requests an experiment** — Explain the science and the safety rule for evidence-based claims; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g3-science-u09-l12` · built from `g34-committed` at `4c6ca4e`._
