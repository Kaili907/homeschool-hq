# Scoring authority — Synthesis and review: environments long ago

**Grade 3 Science** · Unit 7: Fossils and Environments Long Ago · Day 10 · lesson `ma-g3-science-u07-l10`
...
_Topic `ma-g3-science-u07::environments long ago` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Fossils of sea organisms in rock far from any sea are evidence that the area was once under water.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Fossils of organisms that live in particular conditions today are evidence that similar conditions existed where those fossils formed.
- Marine fossils found far inland are evidence that the area was once covered by water.
- Environments change over long spans of time.
...
- Claiming the environment where a fossil is found today must always have been the same.
- Concluding what a whole region was like from one fossil.
- Claiming an environment cannot change.

**Grade boundary.** Palaeoclimate proxies and isotope evidence are High School work.


## What a complete response contains, question by question

**Q1 — connect unit.** _Serves objective 1:_ Connect environments long ago to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of environments long ago.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about environments long ago using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Connect environments long ago to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of environments long ago.
...
**Q6 — limitation.** _Serves objective 1:_ Connect environments long ago to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of environments long ago.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for environments long ago, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for environments long ago works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of environments long ago, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking environments long ago mastered.
- **requests an experiment** — Explain the science and the safety rule for environments long ago; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g3-science-u07-l10` · built from `g34-committed` at `4c6ca4e`._
