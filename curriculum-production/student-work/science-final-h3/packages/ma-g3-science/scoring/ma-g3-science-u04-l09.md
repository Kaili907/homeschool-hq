# Scoring authority — Performance task build: insect life cycles

**Grade 3 Science** · Unit 4: Life Cycles of Organisms · Day 9 · lesson `ma-g3-science-u04-l09`
...
_Topic `ma-g3-science-u04::insect life cycles` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Complete metamorphosis is egg, larva, pupa, adult.
- Incomplete metamorphosis is egg, nymph, adult, with no pupal stage.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Many insects undergo complete metamorphosis: egg, larva, pupa, adult.
- Other insects undergo incomplete metamorphosis: egg, nymph, adult, with no pupal stage.
- The larva and the adult of one insect can look completely different and eat different food, and are still the same individual organism.

**Also correct.** Accept any of these framings — do not require the wording above:

- Caterpillar for larva and chrysalis or cocoon for the pupal stage are acceptable everyday names.
...
- Claiming every insect passes through a pupal stage.
- Claiming a caterpillar and the butterfly it becomes are two different organisms.
- Placing the pupa before the larva in the sequence.

**Grade boundary.** Hormonal control of moulting, and counting instars, are later work.
...
**Q1 — build product.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies insect life cycles and the unit standards.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of insect life cycles.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about insect life cycles using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies insect life cycles and the unit standards.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of insect life cycles.
...
**Q6 — limitation.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies insect life cycles and the unit standards.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of insect life cycles.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for insect life cycles, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for insect life cycles works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of insect life cycles, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking insect life cycles mastered.
- **requests an experiment** — Explain the science and the safety rule for insect life cycles; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g3-science-u04-l09` · built from `g34-committed` at `4c6ca4e`._
