# Scoring authority — Performance task build: comparing parents and offspring

**Grade 3 Science** · Unit 5: Inherited Traits and Variation · Day 9 · lesson `ma-g3-science-u05-l09`
...
_Topic `ma-g3-science-u05::comparing parents and offspring` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Offspring traits can be compared with parent traits to see which are similar and which differ.
- A trait can appear in an offspring that neither parent shows.
- Resemblance to a parent is evidence of inheritance; it does not establish which parent a particular trait came from.
...
- Claiming a trait must have come from whichever parent the offspring most resembles overall.
- Claiming a trait absent in both parents cannot have been inherited.
- Claiming offspring must show the average of their two parents.

**Grade boundary.** Recessive inheritance, carriers, and Punnett squares are Grade 8 and High School work.
...
**Q1 — build product.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies comparing parents and offspring and the unit standards.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of comparing parents and offspring.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about comparing parents and offspring using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies comparing parents and offspring and the unit standards.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of comparing parents and offspring.
...
**Q6 — limitation.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies comparing parents and offspring and the unit standards.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of comparing parents and offspring.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for comparing parents and offspring, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for comparing parents and offspring works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of comparing parents and offspring, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking comparing parents and offspring mastered.
- **requests an experiment** — Explain the science and the safety rule for comparing parents and offspring; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g3-science-u05-l09` · built from `g34-committed` at `4c6ca4e`._
