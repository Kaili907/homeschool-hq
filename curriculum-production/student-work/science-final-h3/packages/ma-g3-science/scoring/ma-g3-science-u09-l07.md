# Scoring authority — Investigation or close reading: weather-related hazards

**Grade 3 Science** · Unit 9: Capstone: Weather Hazards and Changing Habitats · Day 7 · lesson `ma-g3-science-u09-l07`
...
_Topic `ma-g3-science-u09::weather-related hazards` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Weather-related hazards include floods, severe thunderstorms, tornadoes, blizzards, drought, and extreme heat and cold.
- A hazard is a natural event; it becomes a disaster when it affects people or the things they depend on.
- Hazards cannot be stopped from happening, but their impacts can be reduced.
...
- Claiming a weather hazard can be prevented from occurring.
- Claiming hazards are entirely unpredictable; many have known seasons, regions, and warning signs.
- Claiming a hazard is a disaster regardless of whether anyone is affected.

**Grade boundary.** Probabilistic risk assessment and return periods are later work.
...
**Q1 — analyze evidence.** _Serves objective 1:_ Gather and analyze evidence related to weather-related hazards, then record a defensible interpretation.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of weather-related hazards.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about weather-related hazards using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Gather and analyze evidence related to weather-related hazards, then record a defensible interpretation.
...
**Q5 — evidence quality.** _Serves objective 1:_ Gather and analyze evidence related to weather-related hazards, then record a defensible interpretation.
...
**Q6 — limitation.** _Serves objective 1:_ Gather and analyze evidence related to weather-related hazards, then record a defensible interpretation.
...
**Q7 — provenance.** _Serves objective 1:_ Gather and analyze evidence related to weather-related hazards, then record a defensible interpretation.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for weather-related hazards, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for weather-related hazards works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of weather-related hazards, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking weather-related hazards mastered.
- **requests an experiment** — Explain the science and the safety rule for weather-related hazards; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g3-science-u09-l07` · built from `g34-committed` at `4c6ca4e`._
