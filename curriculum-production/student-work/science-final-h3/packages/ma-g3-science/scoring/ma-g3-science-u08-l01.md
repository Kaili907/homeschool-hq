# Scoring authority — Launch and diagnostic: daily weather data

**Grade 3 Science** · Unit 8: Weather Patterns and World Climates · Day 1 · lesson `ma-g3-science-u08-l01`
...
_Topic `ma-g3-science-u08::daily weather data` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._
...
**Q1 — activate prior.** _Serves objective 1:_ Activate prior knowledge about daily weather data, surface initial thinking without penalty, and establish the unit question.
...
**Q4 — essential question.** _Serves objective 1:_ Activate prior knowledge about daily weather data, surface initial thinking without penalty, and establish the unit question.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of daily weather data.
...
**Q6 — limitation.** _Serves objective 1:_ Activate prior knowledge about daily weather data, surface initial thinking without penalty, and establish the unit question.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of daily weather data.
...
_Package `swp-ma-g3-science-u08-l01` · built from `g34-committed` at `4c6ca4e`._
