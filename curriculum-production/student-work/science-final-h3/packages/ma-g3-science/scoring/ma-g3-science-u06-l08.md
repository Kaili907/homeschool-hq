# Scoring authority — Reteach and varied practice: benefits of living in groups

**Grade 3 Science** · Unit 6: Living in Groups and Surviving in Habitats · Day 8 · lesson `ma-g3-science-u06-l08`
...
_Topic `ma-g3-science-u06::benefits of living in groups` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Groups can help members find food, defend against predators, care for young, and cope with harsh conditions.
- Group living also has costs, such as competition for food inside the group and faster spread of disease.
- Whether group living helps depends on the environment; it is not an advantage everywhere.
...
- Claiming group living has benefits and no costs.
- Claiming animals live in groups because they have worked out that it is beneficial.
- Claiming a benefit without connecting it to a need the animals actually have.

**Grade boundary.** Quantitative fitness models and cost-benefit calculations are later work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for benefits of living in groups, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of benefits of living in groups.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about benefits of living in groups using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for benefits of living in groups, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of benefits of living in groups.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for benefits of living in groups, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of benefits of living in groups.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for benefits of living in groups, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for benefits of living in groups works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of benefits of living in groups, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking benefits of living in groups mastered.
- **requests an experiment** — Explain the science and the safety rule for benefits of living in groups; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g3-science-u06-l08` · built from `g34-committed` at `4c6ca4e`._
