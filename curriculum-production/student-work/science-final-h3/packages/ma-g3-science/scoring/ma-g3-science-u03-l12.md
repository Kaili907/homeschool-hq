# Scoring authority — Correction and reflection: solving a problem with magnets

**Grade 3 Science** · Unit 3: Magnetic and Electric Interactions · Day 12 · lesson `ma-g3-science-u03-l12`
...
_Topic `ma-g3-science-u03::solving a problem with magnets` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A magnetic solution only works on materials the magnet actually attracts, so the material is part of defining the problem.
- A design is tested against its stated criteria and constraints, not against how clever it seems.
- A stronger magnet, or a smaller gap, gives the design a larger force to work with.
...
- Proposing a magnetic solution for a material magnets do not attract.
- Declaring a design successful without testing it against the stated criteria.
- Claiming a magnet works through any material without checking.

**Grade boundary.** Electromagnet design and quantitative force calculations are later work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for solving a problem with magnets, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of solving a problem with magnets.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about solving a problem with magnets using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for solving a problem with magnets, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of solving a problem with magnets.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for solving a problem with magnets, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of solving a problem with magnets.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for solving a problem with magnets, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for solving a problem with magnets works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of solving a problem with magnets, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking solving a problem with magnets mastered.
- **requests an experiment** — Explain the science and the safety rule for solving a problem with magnets; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g3-science-u03-l12` · built from `g34-committed` at `4c6ca4e`._
