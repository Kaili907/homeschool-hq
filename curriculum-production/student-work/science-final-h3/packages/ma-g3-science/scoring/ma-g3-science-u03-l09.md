# Scoring authority — Performance task build: forces without contact

**Grade 3 Science** · Unit 3: Magnetic and Electric Interactions · Day 9 · lesson `ma-g3-science-u03-l09`
...
_Topic `ma-g3-science-u03::forces without contact` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Magnetic and electric forces act between objects that are not touching.
- Gravity also acts without contact.
- The strength of a non-contact force depends on the distance between the objects and on properties of the objects themselves.

**Also correct.** Accept any of these framings — do not require the wording above:

- Calling these 'forces at a distance' or 'non-contact forces' are both correct.
...
- Claiming every force needs contact.
- Claiming a non-contact force is equally strong at any distance.
- Claiming magnetism and static electricity are the same force.

**Grade boundary.** Fields as a formal representation, and inverse-square relationships, are later work.
...
**Q1 — build product.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies forces without contact and the unit standards.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of forces without contact.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about forces without contact using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies forces without contact and the unit standards.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of forces without contact.
...
**Q6 — limitation.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies forces without contact and the unit standards.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of forces without contact.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for forces without contact, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for forces without contact works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of forces without contact, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking forces without contact mastered.
- **requests an experiment** — Explain the science and the safety rule for forces without contact; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g3-science-u03-l09` · built from `g34-committed` at `4c6ca4e`._
