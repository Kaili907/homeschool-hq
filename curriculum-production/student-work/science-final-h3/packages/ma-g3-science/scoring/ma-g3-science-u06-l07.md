# Scoring authority — Investigation or close reading: animal groups

**Grade 3 Science** · Unit 6: Living in Groups and Surviving in Habitats · Day 7 · lesson `ma-g3-science-u06-l07`
...
_Topic `ma-g3-science-u06::animal groups` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Some animals live in groups that vary in size and organisation; others live alone for most of their lives.
- Living in a group is a behaviour, and like other traits it varies between kinds of animal.
- A group of animals is many organisms together, not one large organism.

**Also correct.** Accept any of these framings — do not require the wording above:

- Herd, flock, school, colony, and pack are all correct names for particular kinds of group.
...
- Claiming all animals of a kind live in groups.
- Claiming group living is always the better strategy.
- Treating a group of animals as a single organism.

**Grade boundary.** Kin selection and social-insect caste systems are later work.
...
**Q1 — analyze evidence.** _Serves objective 1:_ Gather and analyze evidence related to animal groups, then record a defensible interpretation.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of animal groups.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about animal groups using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Gather and analyze evidence related to animal groups, then record a defensible interpretation.
...
**Q5 — evidence quality.** _Serves objective 1:_ Gather and analyze evidence related to animal groups, then record a defensible interpretation.
...
**Q6 — limitation.** _Serves objective 1:_ Gather and analyze evidence related to animal groups, then record a defensible interpretation.
...
**Q7 — provenance.** _Serves objective 1:_ Gather and analyze evidence related to animal groups, then record a defensible interpretation.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for animal groups, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for animal groups works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of animal groups, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking animal groups mastered.
- **requests an experiment** — Explain the science and the safety rule for animal groups; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g3-science-u06-l07` · built from `g34-committed` at `4c6ca4e`._
