# Scoring authority — Synthesis and review: predicting motion

**Grade 3 Science** · Unit 2: Forces and Motion · Day 10 · lesson `ma-g3-science-u02-l10`
...
_Topic `ma-g3-science-u02::predicting motion` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- If the pattern of an object's past motion is known and the conditions stay the same, its future motion can be predicted.
- A prediction is stated before the observation; a statement made afterwards is an explanation, not a prediction.
- A prediction that turns out wrong is evidence, and it is recorded as it was made.
...
- Rewriting a prediction after seeing the result.
- Claiming a prediction is guaranteed rather than expected.
- Predicting motion for conditions the observed pattern never covered.

**Grade boundary.** Calculating a future position from speed and time is later work.


## What a complete response contains, question by question

**Q1 — connect unit.** _Serves objective 1:_ Connect predicting motion to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of predicting motion.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about predicting motion using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Connect predicting motion to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of predicting motion.
...
**Q6 — limitation.** _Serves objective 1:_ Connect predicting motion to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of predicting motion.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for predicting motion, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for predicting motion works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of predicting motion, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking predicting motion mastered.
- **requests an experiment** — Explain the science and the safety rule for predicting motion; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g3-science-u02-l10` · built from `g34-committed` at `4c6ca4e`._
