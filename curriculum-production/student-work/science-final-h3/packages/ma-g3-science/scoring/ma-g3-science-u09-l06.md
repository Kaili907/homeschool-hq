# Scoring authority — Guided practice B: evidence-based claims

**Grade 3 Science** · Unit 9: Capstone: Weather Hazards and Changing Habitats · Day 6 · lesson `ma-g3-science-u09-l06`
...
**Q1 — guided practice.** _Serves objective 1:_ Practice evidence-based claims with prompts, feedback, and gradually reduced support.
...
**Q4 — essential question.** _Serves objective 1:_ Practice evidence-based claims with prompts, feedback, and gradually reduced support.
...
**Q6 — limitation.** _Serves objective 1:_ Practice evidence-based claims with prompts, feedback, and gradually reduced support.
...
_Package `swp-ma-g3-science-u09-l06` · built from `g34-committed` at `4c6ca4e`._
