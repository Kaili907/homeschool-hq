# Scoring authority — Investigation or close reading: birth, growth, reproduction, and death

**Grade 3 Science** · Unit 4: Life Cycles of Organisms · Day 7 · lesson `ma-g3-science-u04-l07`
...
_Topic `ma-g3-science-u04::birth, growth, reproduction, and death` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- All organisms have life cycles that include being born or germinating, growing, reproducing, and dying.

**Accepted relationships and models.** What this lesson's learning target asserts:

- All organisms have life cycles that include being born or germinating, growing, reproducing, and dying.
- The particular stages differ between kinds of organism, but the overall birth-growth-reproduction-death pattern is shared.
- Different kinds of organism take characteristically different lengths of time to complete a life cycle.
...
- Claiming some organisms never die.
- Claiming every organism passes through the same stages, such as a larval stage.
- Claiming an organism grows up into a different kind of organism.

**Grade boundary.** Cell division, the genetics of reproduction, and alternation of generations are later work.
...
**Q1 — analyze evidence.** _Serves objective 1:_ Gather and analyze evidence related to birth, growth, reproduction, and death, then record a defensible interpretation.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of birth, growth, reproduction, and death.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about birth, growth, reproduction, and death using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Gather and analyze evidence related to birth, growth, reproduction, and death, then record a defensible interpretation.
...
**Q5 — evidence quality.** _Serves objective 1:_ Gather and analyze evidence related to birth, growth, reproduction, and death, then record a defensible interpretation.
...
**Q6 — limitation.** _Serves objective 1:_ Gather and analyze evidence related to birth, growth, reproduction, and death, then record a defensible interpretation.
...
**Q7 — provenance.** _Serves objective 1:_ Gather and analyze evidence related to birth, growth, reproduction, and death, then record a defensible interpretation.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for birth, growth, reproduction, and death, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for birth, growth, reproduction, and death works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of birth, growth, reproduction, and death, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking birth, growth, reproduction, and death mastered.
- **requests an experiment** — Explain the science and the safety rule for birth, growth, reproduction, and death; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g3-science-u04-l07` · built from `g34-committed` at `4c6ca4e`._
