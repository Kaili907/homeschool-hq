# Scoring authority — Investigation or close reading: daily weather data

**Grade 3 Science** · Unit 8: Weather Patterns and World Climates · Day 7 · lesson `ma-g3-science-u08-l07`
...
_Topic `ma-g3-science-u08::daily weather data` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Weather is the state of the atmosphere at a place at a particular time: temperature, precipitation, wind, and cloud.
- Weather is recorded with instruments, in units, at a stated time and place.
- A single day's weather does not describe what a place's weather is usually like.
...
- Recording a weather observation with no date, time, or place.
- Concluding what a place's weather is usually like from one day's record.
- Recording a temperature with no unit.

**Grade boundary.** Instrument calibration and station-siting standards are later work.
...
**Q1 — analyze evidence.** _Serves objective 1:_ Gather and analyze evidence related to daily weather data, then record a defensible interpretation.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of daily weather data.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about daily weather data using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Gather and analyze evidence related to daily weather data, then record a defensible interpretation.
...
**Q5 — evidence quality.** _Serves objective 1:_ Gather and analyze evidence related to daily weather data, then record a defensible interpretation.
...
**Q6 — limitation.** _Serves objective 1:_ Gather and analyze evidence related to daily weather data, then record a defensible interpretation.
...
**Q7 — provenance.** _Serves objective 1:_ Gather and analyze evidence related to daily weather data, then record a defensible interpretation.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for daily weather data, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for daily weather data works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of daily weather data, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking daily weather data mastered.
- **requests an experiment** — Explain the science and the safety rule for daily weather data; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g3-science-u08-l07` · built from `g34-committed` at `4c6ca4e`._
