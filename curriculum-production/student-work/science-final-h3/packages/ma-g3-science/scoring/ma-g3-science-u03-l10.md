# Scoring authority — Synthesis and review: static electric interactions

**Grade 3 Science** · Unit 3: Magnetic and Electric Interactions · Day 10 · lesson `ma-g3-science-u03-l10`
...
_Topic `ma-g3-science-u03::static electric interactions` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._
...
- Rubbing certain materials together transfers electric charge from one to the other, leaving each object charged.
- Objects with opposite charges attract each other; objects with the same charge repel each other.
- A charged object can attract an uncharged object such as paper, hair, or a thin stream of water.
...
- Claiming rubbing creates charge out of nothing, rather than moving it from one object to the other.
- Claiming static electricity and magnetism are the same thing.
- Claiming an uncharged object cannot be attracted to a charged one.

**Grade boundary.** Electrons by name, the conductor-insulator distinction, and current electricity are later work; a learner who uses them correctly is not wrong.


## What a complete response contains, question by question

**Q1 — connect unit.** _Serves objective 1:_ Connect static electric interactions to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of static electric interactions.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about static electric interactions using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Connect static electric interactions to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of static electric interactions.
...
**Q6 — limitation.** _Serves objective 1:_ Connect static electric interactions to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of static electric interactions.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for static electric interactions, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for static electric interactions works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of static electric interactions, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking static electric interactions mastered.
- **requests an experiment** — Explain the science and the safety rule for static electric interactions; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g3-science-u03-l10` · built from `g34-committed` at `4c6ca4e`._
