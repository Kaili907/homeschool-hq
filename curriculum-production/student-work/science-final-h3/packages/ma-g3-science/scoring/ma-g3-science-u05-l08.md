# Scoring authority — Reteach and varied practice: variation within a group

**Grade 3 Science** · Unit 5: Inherited Traits and Variation · Day 8 · lesson `ma-g3-science-u05-l08`
...
_Topic `ma-g3-science-u05::variation within a group` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g3-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Individuals of the same kind of organism differ from one another, and that difference is called variation.
- Variation exists even among siblings that share the same two parents.
- Variation is described by comparing many individuals, not by looking at one.
...
- Claiming all members of one kind of organism are the same.
- Treating a single individual as representing its whole group.
- Claiming variation means the organisms are different kinds.

**Grade boundary.** Mutation and recombination as the sources of variation are later work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for variation within a group, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of variation within a group.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about variation within a group using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for variation within a group, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of variation within a group.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for variation within a group, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of variation within a group.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for variation within a group, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for variation within a group works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of variation within a group, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking variation within a group mastered.
- **requests an experiment** — Explain the science and the safety rule for variation within a group; do not invent an investigation, procedure, result, or observation. Direct the learner to the adult-approved investigation in the lesson.
...
_Package `swp-ma-g3-science-u05-l08` · built from `g34-committed` at `4c6ca4e`._
