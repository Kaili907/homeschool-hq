# Scoring authority — Investigation or close reading: temperature and particle motion

**Grade 7 Science** · Unit 3: Thermal Energy and Energy Transfer · Day 7 · lesson `ma-g7-science-u03-l07`
...
_Topic `ma-g7-science-u03::temperature and particle motion` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._
...
- The particles in any sample of matter are in constant motion, and temperature measures the average kinetic energy of that motion.
- Temperature and total thermal energy are different: a large cool object can contain more thermal energy than a small hot one.
- Adding energy to a sample generally raises its temperature, except during a change of state, when it changes the arrangement of particles instead.

**Also correct.** Accept any of these framings — do not require the wording above:

- Describing temperature as average particle motion or as average kinetic energy per particle are both correct.
...
- Claiming temperature and thermal energy are the same quantity.
- Claiming particles stop moving at ordinary cold temperatures.
- Claiming temperature rises steadily while a substance is melting or boiling.

**Grade boundary.** Absolute zero, the kinetic theory in quantitative form, and specific heat calculations are High School work.
...
**Q1 — analyze evidence.** _Serves objective 1:_ Gather and analyze evidence related to temperature and particle motion, then record a defensible interpretation.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of temperature and particle motion.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about temperature and particle motion using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Gather and analyze evidence related to temperature and particle motion, then record a defensible interpretation.
...
**Q5 — evidence quality.** _Serves objective 1:_ Gather and analyze evidence related to temperature and particle motion, then record a defensible interpretation.
...
**Q6 — limitation.** _Serves objective 1:_ Gather and analyze evidence related to temperature and particle motion, then record a defensible interpretation.
...
**Q7 — provenance.** _Serves objective 1:_ Gather and analyze evidence related to temperature and particle motion, then record a defensible interpretation.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for temperature and particle motion, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for temperature and particle motion works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of temperature and particle motion, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking temperature and particle motion mastered.
...
_Package `swp-ma-g7-science-u03-l07` · built from `canonical-1.0.0` at `4056e31`._
