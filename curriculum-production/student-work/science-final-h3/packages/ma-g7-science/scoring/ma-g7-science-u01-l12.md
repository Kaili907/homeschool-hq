# Scoring authority — Correction and reflection: evidence from properties

**Grade 7 Science** · Unit 1: Matter, Particles, and Properties · Day 12 · lesson `ma-g7-science-u01-l12`
...
_Topic `ma-g7-science-u01::evidence from properties` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Measured properties are the evidence for a claim about what a substance is.
- The strength of the evidence depends on how characteristic the property is and how well it was measured.
- A property measurement that disagrees with the identification is reported and explained, not dropped.
...
- Claiming an identification is confirmed while omitting a measurement that disagrees.
- Using a non-characteristic property, such as mass, as identification evidence.
- Reporting a property measurement with no unit or no method.

**Grade boundary.** Uncertainty propagation and statistical comparison to reference values are High School work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for evidence from properties, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of evidence from properties.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about evidence from properties using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for evidence from properties, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of evidence from properties.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for evidence from properties, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of evidence from properties.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for evidence from properties, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for evidence from properties works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of evidence from properties, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking evidence from properties mastered.
...
_Package `swp-ma-g7-science-u01-l12` · built from `canonical-1.0.0` at `4056e31`._
