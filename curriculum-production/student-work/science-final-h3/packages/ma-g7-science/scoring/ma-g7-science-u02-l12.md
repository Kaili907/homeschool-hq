# Scoring authority — Correction and reflection: designing a heat-transfer device

**Grade 7 Science** · Unit 2: Chemical Reactions and Conservation · Day 12 · lesson `ma-g7-science-u02-l12`
...
_Topic `ma-g7-science-u02::designing a heat-transfer device` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A device that releases or absorbs thermal energy works by controlling the rate of transfer between a source and its surroundings.
- Insulating materials slow transfer; they do not produce warmth or cold.
- The device is judged against measurable criteria, such as how far the temperature changed and how long the effect lasted.
...
- Claiming an insulator generates warmth or cold.
- Claiming a device creates thermal energy rather than releasing or transferring it.
- Declaring a design successful without measuring against the stated criteria.

**Grade boundary.** Thermal conductivity values, heat-transfer coefficients, and efficiency calculation are High School work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for designing a heat-transfer device, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of designing a heat-transfer device.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about designing a heat-transfer device using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for designing a heat-transfer device, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of designing a heat-transfer device.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for designing a heat-transfer device, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of designing a heat-transfer device.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for designing a heat-transfer device, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for designing a heat-transfer device works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of designing a heat-transfer device, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking designing a heat-transfer device mastered.
...
_Package `swp-ma-g7-science-u02-l12` · built from `canonical-1.0.0` at `4056e31`._
