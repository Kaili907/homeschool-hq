# Scoring authority — Synthesis and review: population and consumption

**Grade 7 Science** · Unit 8: Natural Hazards and Human Impacts · Day 10 · lesson `ma-g7-science-u08-l10`
...
_Topic `ma-g7-science-u08::population and consumption` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Total impact depends on both the number of people and how much each consumes, so neither alone explains it.
- Per-person consumption differs greatly between regions, so equal populations can have very different impacts.
- Technology can change impact per person in either direction.
...
- Claiming per-person consumption is the same everywhere.
- Claiming technological change always reduces impact.

**Grade boundary.** Formal impact identities and demographic modelling are High School work.


## What a complete response contains, question by question

**Q1 — connect unit.** _Serves objective 1:_ Connect population and consumption to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q4 — essential question.** _Serves objective 1:_ Connect population and consumption to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q6 — limitation.** _Serves objective 1:_ Connect population and consumption to the unit’s other ideas and select evidence that shows readiness for assessment.
...
_Package `swp-ma-g7-science-u08-l10` · built from `canonical-1.0.0` at `4056e31`._
