# Scoring authority — Unit assessment: potential and kinetic energy

**Grade 7 Science** · Unit 3: Thermal Energy and Energy Transfer · Day 11 · lesson `ma-g7-science-u03-l11`
...
_Topic `ma-g7-science-u03::potential and kinetic energy` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Kinetic energy is energy of motion; potential energy is energy stored by position or configuration.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Kinetic energy depends on an object's mass and speed; potential energy depends on position or arrangement relative to something else.
- Energy converts between kinetic and potential forms while the total stays the same, apart from what is transferred out of the system.
- Potential energy is a property of a system, such as an object and Earth together, not of the object alone.

**Also correct.** Accept any of these framings — do not require the wording above:

- Gravitational, elastic, and chemical potential energy are all correct examples of stored energy.
...
- Claiming energy is destroyed when a moving object comes to rest, rather than transferred out.
- Claiming potential energy belongs to the object by itself with no reference position or system.
- Claiming kinetic energy depends only on speed, with mass making no difference.

**Grade boundary.** Energy equations, and kinetic energy going with the square of speed, are High School work; a learner who uses them correctly is not wrong.


## What a complete response contains, question by question

**Q1 — demonstrate mastery.** _Serves objective 1:_ Demonstrate current mastery of potential and kinetic energy through selected-response, constructed-response, and applied evidence.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of potential and kinetic energy.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about potential and kinetic energy using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Demonstrate current mastery of potential and kinetic energy through selected-response, constructed-response, and applied evidence.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of potential and kinetic energy.
...
**Q6 — limitation.** _Serves objective 1:_ Demonstrate current mastery of potential and kinetic energy through selected-response, constructed-response, and applied evidence.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of potential and kinetic energy.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for potential and kinetic energy, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for potential and kinetic energy works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of potential and kinetic energy, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking potential and kinetic energy mastered.
...
_Package `swp-ma-g7-science-u03-l11` · built from `canonical-1.0.0` at `4056e31`._
