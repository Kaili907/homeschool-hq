# Scoring authority — Performance task build: ocean and atmospheric circulation

**Grade 7 Science** · Unit 7: Weather, Climate, and Earth Systems · Day 9 · lesson `ma-g7-science-u07-l09`
...
_Topic `ma-g7-science-u07::ocean and atmospheric circulation` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Global circulation exists because the equator receives more solar energy per unit area than the poles.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Uneven heating of Earth's surface, with more energy per unit area near the equator, drives large-scale circulation in the atmosphere and ocean.
- Circulation moves energy from lower to higher latitudes, which is why the poles are not colder and the tropics not hotter than they are.
- Ocean currents and prevailing winds strongly influence the climate of the coasts they reach.

**Also correct.** Accept any of these framings — do not require the wording above:

- Describing the cause as uneven heating, or as the angle at which sunlight strikes the surface, are both correct.
...
- Claiming the equator is warmer because it is closer to the Sun.
- Claiming ocean currents have no effect on coastal climate.
- Claiming circulation moves air and water without transporting energy.

**Grade boundary.** Coriolis dynamics, Hadley cell mathematics, and thermohaline modelling are High School work.
...
**Q1 — build product.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies ocean and atmospheric circulation and the unit standards.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of ocean and atmospheric circulation.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about ocean and atmospheric circulation using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies ocean and atmospheric circulation and the unit standards.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of ocean and atmospheric circulation.
...
**Q6 — limitation.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies ocean and atmospheric circulation and the unit standards.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of ocean and atmospheric circulation.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for ocean and atmospheric circulation, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for ocean and atmospheric circulation works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of ocean and atmospheric circulation, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking ocean and atmospheric circulation mastered.
...
_Package `swp-ma-g7-science-u07-l09` · built from `canonical-1.0.0` at `4056e31`._
