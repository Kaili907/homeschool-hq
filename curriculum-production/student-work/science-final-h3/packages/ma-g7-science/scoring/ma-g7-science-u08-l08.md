# Scoring authority — Reteach and varied practice: risk and vulnerability

**Grade 7 Science** · Unit 8: Natural Hazards and Human Impacts · Day 8 · lesson `ma-g7-science-u08-l08`
...
_Topic `ma-g7-science-u08::risk and vulnerability` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Risk depends on the hazard, on what is exposed to it, and on how vulnerable that exposure is.
- Two communities facing the same hazard can face very different risk, because exposure and vulnerability differ.
- Reducing risk can act on exposure or on vulnerability, since the hazard itself cannot be prevented.
...
- Treating risk and hazard as the same thing.
- Claiming equal hazard means equal risk regardless of who is exposed.
- Claiming risk can be reduced to zero.

**Grade boundary.** Quantitative risk assessment and insurance modelling are High School work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for risk and vulnerability, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of risk and vulnerability.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about risk and vulnerability using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for risk and vulnerability, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of risk and vulnerability.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for risk and vulnerability, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of risk and vulnerability.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for risk and vulnerability, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for risk and vulnerability works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of risk and vulnerability, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking risk and vulnerability mastered.
...
_Package `swp-ma-g7-science-u08-l08` · built from `canonical-1.0.0` at `4056e31`._
