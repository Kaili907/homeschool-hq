# Scoring authority — Synthesis and review: tissues organs and systems

**Grade 7 Science** · Unit 4: Cells and Organism Organization · Day 10 · lesson `ma-g7-science-u04-l10`
...
_Topic `ma-g7-science-u04::tissues organs and systems` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- The levels of organisation run cells, tissues, organs, organ systems, organism.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Similar specialised cells form tissues, tissues form organs, organs form organ systems, and systems together form the organism.
- Each level does something the level below cannot do on its own; the organisation is what produces the capability.
- A failure at one level affects the levels above it.
...
- Claiming an organ is made of a single kind of cell.
- Claiming organ systems operate independently of one another.

**Grade boundary.** Histology and developmental biology are High School work.


## What a complete response contains, question by question

**Q1 — connect unit.** _Serves objective 1:_ Connect tissues organs and systems to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of tissues organs and systems.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about tissues organs and systems using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Connect tissues organs and systems to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of tissues organs and systems.
...
**Q6 — limitation.** _Serves objective 1:_ Connect tissues organs and systems to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of tissues organs and systems.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for tissues organs and systems, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for tissues organs and systems works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of tissues organs and systems, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking tissues organs and systems mastered.
...
_Package `swp-ma-g7-science-u04-l10` · built from `canonical-1.0.0` at `4056e31`._
