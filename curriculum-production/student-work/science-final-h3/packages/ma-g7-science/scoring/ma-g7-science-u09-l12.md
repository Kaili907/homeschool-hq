# Scoring authority — Correction and reflection: communicating tradeoffs

**Grade 7 Science** · Unit 9: Engineering Design Capstone · Day 12 · lesson `ma-g7-science-u09-l12`
...
_Topic `ma-g7-science-u09::communicating tradeoffs` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Communicating a design decision means stating the criteria, the evidence, what was given up, and why.
- A trade-off that is not stated has not been avoided; it has only been hidden from the reader.
- The audience decides what detail is needed, but the evidence and its limits are always included.
...
- Presenting a chosen design as having no drawbacks.
- Reporting a recommendation with no evidence behind it.
- Omitting the limits of the testing from the communication.

**Grade boundary.** Formal technical writing standards are later work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for communicating tradeoffs, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of communicating tradeoffs.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about communicating tradeoffs using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for communicating tradeoffs, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of communicating tradeoffs.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for communicating tradeoffs, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of communicating tradeoffs.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for communicating tradeoffs, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for communicating tradeoffs works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of communicating tradeoffs, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking communicating tradeoffs mastered.
...
_Package `swp-ma-g7-science-u09-l12` · built from `canonical-1.0.0` at `4056e31`._
