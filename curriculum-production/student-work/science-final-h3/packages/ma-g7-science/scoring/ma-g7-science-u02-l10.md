# Scoring authority — Synthesis and review: thermal changes

**Grade 7 Science** · Unit 2: Chemical Reactions and Conservation · Day 10 · lesson `ma-g7-science-u02-l10`
...
_Topic `ma-g7-science-u02::thermal changes` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- An exothermic process releases energy to its surroundings; an endothermic process absorbs energy from them.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Some reactions release energy to the surroundings and some absorb energy from them.
- A container that becomes warmer indicates energy released by the reaction inside it; one that becomes cooler indicates energy absorbed.
- Energy released or absorbed is transferred, not created or destroyed.

**Also correct.** Accept any of these framings — do not require the wording above:

- Describing a reaction as exothermic, or as releasing energy or giving out heat, are all correct.
...
- Claiming an endothermic reaction creates cold rather than absorbing energy.
- Claiming a reaction generates energy from nothing.
- Reading the container's temperature change as the reaction's own temperature without saying what was measured.

**Grade boundary.** Bond energies, enthalpy, and calorimetric calculation are High School work.


## What a complete response contains, question by question

**Q1 — connect unit.** _Serves objective 1:_ Connect thermal changes to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of thermal changes.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about thermal changes using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Connect thermal changes to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of thermal changes.
...
**Q6 — limitation.** _Serves objective 1:_ Connect thermal changes to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of thermal changes.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for thermal changes, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for thermal changes works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of thermal changes, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking thermal changes mastered.
...
_Package `swp-ma-g7-science-u02-l10` · built from `canonical-1.0.0` at `4056e31`._
