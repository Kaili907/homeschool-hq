# Scoring authority — Unit assessment: optimization

**Grade 7 Science** · Unit 9: Engineering Design Capstone · Day 11 · lesson `ma-g7-science-u09-l11`
...
_Topic `ma-g7-science-u09::optimization` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Optimising means improving performance against the criteria within the constraints, not improving everything at once.
- Improving one criterion often worsens another, so optimisation involves choosing which trade-off to accept.
- An optimum is relative to the criteria chosen; different criteria give a different optimum.
...
- Claiming a design was optimised on every criterion simultaneously.
- Optimising past a constraint and reporting the result as a solution.
- Presenting an optimum without stating the criteria it is optimal for.

**Grade boundary.** Mathematical optimisation methods are later work.


## What a complete response contains, question by question

**Q1 — demonstrate mastery.** _Serves objective 1:_ Demonstrate current mastery of optimization through selected-response, constructed-response, and applied evidence.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of optimization.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about optimization using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Demonstrate current mastery of optimization through selected-response, constructed-response, and applied evidence.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of optimization.
...
**Q6 — limitation.** _Serves objective 1:_ Demonstrate current mastery of optimization through selected-response, constructed-response, and applied evidence.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of optimization.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for optimization, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for optimization works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of optimization, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking optimization mastered.
...
_Package `swp-ma-g7-science-u09-l11` · built from `canonical-1.0.0` at `4056e31`._
