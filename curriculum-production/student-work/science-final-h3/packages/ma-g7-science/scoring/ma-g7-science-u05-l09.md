# Scoring authority — Performance task build: sensory receptors

**Grade 7 Science** · Unit 5: Body Systems, Senses, and Responses · Day 9 · lesson `ma-g7-science-u05-l09`
...
_Topic `ma-g7-science-u05::sensory receptors` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Each type of sensory receptor responds to a particular kind of stimulus, such as light, sound, pressure, temperature, or chemicals.
- An organism can only respond to stimuli it has receptors for, which is why different animals sense different things.
- Receptors convert the stimulus into a signal the nervous system can carry; they do not send the stimulus itself.
...
- Claiming one receptor type responds equally to every stimulus.
- Claiming an organism senses something it has no receptor for.
- Claiming the receptor sends the light or sound itself along the nerve.

**Grade boundary.** Transduction mechanisms and receptor molecular biology are High School work.
...
**Q1 — build product.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies sensory receptors and the unit standards.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of sensory receptors.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about sensory receptors using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies sensory receptors and the unit standards.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of sensory receptors.
...
**Q6 — limitation.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies sensory receptors and the unit standards.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of sensory receptors.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for sensory receptors, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for sensory receptors works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of sensory receptors, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking sensory receptors mastered.
...
_Package `swp-ma-g7-science-u05-l09` · built from `canonical-1.0.0` at `4056e31`._
