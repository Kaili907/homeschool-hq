# Scoring authority — Performance task build: resource use

**Grade 7 Science** · Unit 8: Natural Hazards and Human Impacts · Day 9 · lesson `ma-g7-science-u08-l09`
...
_Topic `ma-g7-science-u08::resource use` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Resources are distributed unevenly because of the geological and biological processes that formed them.
- Extracting and using a resource changes the environment where it is taken and where it is used.
- A renewable resource is only sustainable if the rate of use stays below the rate of replenishment.
...
- Claiming resource distribution is a matter of chance rather than of geological and biological process.
- Claiming resource use can have no environmental effect.

**Grade boundary.** Reserve estimation and resource economics are High School work.
...
**Q1 — build product.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies resource use and the unit standards.
...
**Q4 — essential question.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies resource use and the unit standards.
...
**Q6 — limitation.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies resource use and the unit standards.
...
_Package `swp-ma-g7-science-u08-l09` · built from `canonical-1.0.0` at `4056e31`._
