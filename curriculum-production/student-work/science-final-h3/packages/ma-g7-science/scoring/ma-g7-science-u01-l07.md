# Scoring authority — Investigation or close reading: atomic and molecular models

**Grade 7 Science** · Unit 1: Matter, Particles, and Properties · Day 7 · lesson `ma-g7-science-u01-l07`
...
_Topic `ma-g7-science-u01::atomic and molecular models` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Atoms are the particles that make up elements; molecules are groups of atoms bonded together.

**Accepted relationships and models.** What this lesson's learning target asserts:

- All matter is made of atoms, and atoms of a given element are alike in the properties that define that element.
- A molecule is two or more atoms held together by chemical bonds; a compound contains atoms of more than one element in a fixed ratio.
- Substances differ because their atoms differ, or because the same atoms are arranged and bonded differently.

**Also correct.** Accept any of these framings — do not require the wording above:

- Ball-and-stick, space-filling, and symbolic formula representations are all valid molecular models; the choice is judged on what it needs to show.
...
- Claiming atoms of a compound take on the bulk properties of the compound, such as a single water molecule being wet.
- Claiming a compound is a mixture of its elements that keeps their properties.
- Claiming atoms can be seen directly with a school microscope.

**Grade boundary.** Subatomic structure in detail, electron configuration, and bonding theory are Grade 8 and High School work.
...
**Q1 — analyze evidence.** _Serves objective 1:_ Gather and analyze evidence related to atomic and molecular models, then record a defensible interpretation.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of atomic and molecular models.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about atomic and molecular models using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Gather and analyze evidence related to atomic and molecular models, then record a defensible interpretation.
...
**Q5 — evidence quality.** _Serves objective 1:_ Gather and analyze evidence related to atomic and molecular models, then record a defensible interpretation.
...
**Q6 — limitation.** _Serves objective 1:_ Gather and analyze evidence related to atomic and molecular models, then record a defensible interpretation.
...
**Q7 — provenance.** _Serves objective 1:_ Gather and analyze evidence related to atomic and molecular models, then record a defensible interpretation.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for atomic and molecular models, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for atomic and molecular models works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of atomic and molecular models, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking atomic and molecular models mastered.
...
_Package `swp-ma-g7-science-u01-l07` · built from `canonical-1.0.0` at `4056e31`._
