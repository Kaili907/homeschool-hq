# Scoring authority — Synthesis and review: regional climates

**Grade 7 Science** · Unit 7: Weather, Climate, and Earth Systems · Day 10 · lesson `ma-g7-science-u07-l10`
...
_Topic `ma-g7-science-u07::regional climates` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A region's climate depends on latitude, elevation, distance from large water bodies, ocean currents, prevailing winds, and nearby mountains.
- Two regions at the same latitude can have very different climates because of these other factors.
- Climate is described by long-term averages and ranges, over decades rather than seasons.
...
- Claiming latitude alone determines climate.
- Using a single season's weather to characterise a climate.
- Claiming elevation has no effect on temperature.

**Grade boundary.** Köppen classification and climate reanalysis data are High School work.


## What a complete response contains, question by question

**Q1 — connect unit.** _Serves objective 1:_ Connect regional climates to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of regional climates.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about regional climates using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Connect regional climates to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of regional climates.
...
**Q6 — limitation.** _Serves objective 1:_ Connect regional climates to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of regional climates.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for regional climates, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for regional climates works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of regional climates, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking regional climates mastered.
...
_Package `swp-ma-g7-science-u07-l10` · built from `canonical-1.0.0` at `4056e31`._
