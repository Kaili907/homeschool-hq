# Scoring authority — Reteach and varied practice: cell structures and functions

**Grade 7 Science** · Unit 4: Cells and Organism Organization · Day 8 · lesson `ma-g7-science-u04-l08`
...
_Topic `ma-g7-science-u04::cell structures and functions` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- The nucleus contains the cell's genetic material; the cell membrane controls what enters and leaves; chloroplasts are found in plant cells and not in animal cells.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Each cell part carries out a particular function, and the parts work together as a system.
- The cell membrane controls what enters and leaves the cell; the nucleus holds the genetic material in cells that have one.
- Plant cells have a cell wall and chloroplasts that animal cells lack; both have a membrane, cytoplasm, and, in eukaryotes, a nucleus.

**Also correct.** Accept any of these framings — do not require the wording above:

- Naming a structure's function in everyday terms is acceptable, provided the function is right.
...
- Claiming animal cells contain chloroplasts or a cell wall.
- Claiming the cell wall, rather than the membrane, controls what enters and leaves a plant cell.
- Claiming every cell has a nucleus; bacterial cells do not.

**Grade boundary.** Organelle biochemistry, membrane transport mechanisms, and the endomembrane system are High School work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for cell structures and functions, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of cell structures and functions.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about cell structures and functions using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for cell structures and functions, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of cell structures and functions.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for cell structures and functions, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of cell structures and functions.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for cell structures and functions, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for cell structures and functions works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of cell structures and functions, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking cell structures and functions mastered.
...
_Package `swp-ma-g7-science-u04-l08` · built from `canonical-1.0.0` at `4056e31`._
