# Scoring authority — Unit assessment: microscope image interpretation

**Grade 7 Science** · Unit 4: Cells and Organism Organization · Day 11 · lesson `ma-g7-science-u04-l11`
...
_Topic `ma-g7-science-u04::microscope image interpretation` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A microscope image is a two-dimensional view of a thin slice or a thin sample, so what is seen depends on how the sample was prepared.
- Magnification and the scale bar are needed before any size can be read from an image.
- Stains and preparation can introduce features that are artefacts rather than parts of the living cell.
...
- Reading a size off a micrograph with no scale or magnification given.
- Claiming a structure is absent because it was not visible in one preparation.
- Treating a preparation artefact as a cell structure.

**Grade boundary.** Resolution limits, electron microscopy, and staining chemistry are High School work.


## What a complete response contains, question by question

**Q1 — demonstrate mastery.** _Serves objective 1:_ Demonstrate current mastery of microscope image interpretation through selected-response, constructed-response, and applied evidence.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of microscope image interpretation.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about microscope image interpretation using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Demonstrate current mastery of microscope image interpretation through selected-response, constructed-response, and applied evidence.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of microscope image interpretation.
...
**Q6 — limitation.** _Serves objective 1:_ Demonstrate current mastery of microscope image interpretation through selected-response, constructed-response, and applied evidence.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of microscope image interpretation.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for microscope image interpretation, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for microscope image interpretation works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of microscope image interpretation, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking microscope image interpretation mastered.
...
_Package `swp-ma-g7-science-u04-l11` · built from `canonical-1.0.0` at `4056e31`._
