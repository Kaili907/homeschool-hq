...
**Grade 7 Science** · Unit 3: Thermal Energy and Energy Transfer · Day 2 · lesson `ma-g7-science-u03-l02`
...
**Q1 — model build.** _Serves objective 1:_ Build a clear mental model of conduction convection and radiation through an explicit worked example, demonstration, text, or phenomenon.
...
**Q4 — essential question.** _Serves objective 1:_ Build a clear mental model of conduction convection and radiation through an explicit worked example, demonstration, text, or phenomenon.
...
**Q6 — limitation.** _Serves objective 1:_ Build a clear mental model of conduction convection and radiation through an explicit worked example, demonstration, text, or phenomenon.
...
_Package `swp-ma-g7-science-u03-l02` · built from `canonical-1.0.0` at `4056e31`._
