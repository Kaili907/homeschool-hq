# Scoring authority — Performance task build: mutualism

**Grade 7 Science** · Unit 6: Ecosystem Interactions and Dynamics · Day 9 · lesson `ma-g7-science-u06-l09`
...
_Topic `ma-g7-science-u06::mutualism` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- In mutualism both species benefit; in commensalism one benefits and the other is largely unaffected; in parasitism one benefits at the other's expense.

**Accepted relationships and models.** What this lesson's learning target asserts:

- In a mutualistic relationship both species gain something, such as food, protection, or transport.
- Mutualism is not cooperation by intention; each species is acting in ways that happen to benefit the other.
- Mutualism, commensalism, and parasitism are distinguished by who benefits and who is harmed.

**Also correct.** Accept any of these framings — do not require the wording above:

- Pollination, gut microbes, and lichen partnerships are all correct examples.
...
- Classifying a relationship as mutualism when only one species benefits.
- Claiming the species involved intend to help each other.
- Claiming parasitism always kills the host.

**Grade boundary.** Coevolution and symbiosis theory in depth are High School work.
...
**Q1 — build product.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies mutualism and the unit standards.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of mutualism.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about mutualism using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies mutualism and the unit standards.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of mutualism.
...
**Q6 — limitation.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies mutualism and the unit standards.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of mutualism.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for mutualism, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for mutualism works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of mutualism, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking mutualism mastered.
...
_Package `swp-ma-g7-science-u06-l09` · built from `canonical-1.0.0` at `4056e31`._
