# Scoring authority — Investigation or close reading: signs of reaction

**Grade 7 Science** · Unit 2: Chemical Reactions and Conservation · Day 7 · lesson `ma-g7-science-u02-l07`
...
_Topic `ma-g7-science-u02::signs of reaction` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A chemical reaction produces one or more substances with properties different from the starting substances.
- Signs that suggest a reaction include gas production, a temperature change not caused by external heating or cooling, a colour change, a precipitate, light, and a new odour.
- Each sign has non-chemical explanations too, so a conclusion rests on several lines of evidence together.
...
- Treating bubbling alone as proof of reaction when boiling or escaping dissolved gas explains it.
- Claiming any colour change establishes a chemical reaction.
- Claiming dissolving is always a chemical reaction.

**Grade boundary.** Reaction classification, equilibrium, and mechanism are High School work.
...
**Q1 — analyze evidence.** _Serves objective 1:_ Gather and analyze evidence related to signs of reaction, then record a defensible interpretation.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of signs of reaction.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about signs of reaction using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Gather and analyze evidence related to signs of reaction, then record a defensible interpretation.
...
**Q5 — evidence quality.** _Serves objective 1:_ Gather and analyze evidence related to signs of reaction, then record a defensible interpretation.
...
**Q6 — limitation.** _Serves objective 1:_ Gather and analyze evidence related to signs of reaction, then record a defensible interpretation.
...
**Q7 — provenance.** _Serves objective 1:_ Gather and analyze evidence related to signs of reaction, then record a defensible interpretation.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for signs of reaction, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for signs of reaction works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of signs of reaction, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking signs of reaction mastered.
...
_Package `swp-ma-g7-science-u02-l07` · built from `canonical-1.0.0` at `4056e31`._
