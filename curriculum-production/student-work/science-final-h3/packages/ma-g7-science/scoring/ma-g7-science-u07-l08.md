# Scoring authority — Reteach and varied practice: air masses and weather

**Grade 7 Science** · Unit 7: Weather, Climate, and Earth Systems · Day 8 · lesson `ma-g7-science-u07-l08`
...
_Topic `ma-g7-science-u07::air masses and weather` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Weather changes occur at the boundaries between air masses of different temperature and humidity.

**Accepted relationships and models.** What this lesson's learning target asserts:

- An air mass takes on the temperature and humidity of the region it forms over.
- Where air masses of different properties meet, the warmer, less dense air is forced upward, it cools, water vapour condenses, and clouds and precipitation form.
- The kind of weather depends on the properties of the air masses involved and on how they meet.

**Also correct.** Accept any of these framings — do not require the wording above:

- Warm front, cold front, and occluded front are correct terms; a plain description of the interaction is equally acceptable.
...
- Claiming warm air sinks below cold air.
- Claiming precipitation forms without air rising and cooling.
- Claiming an air mass has the same properties wherever it forms.

**Grade boundary.** Synoptic meteorology, adiabatic lapse rates, and numerical forecasting are High School work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for air masses and weather, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of air masses and weather.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about air masses and weather using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for air masses and weather, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of air masses and weather.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for air masses and weather, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of air masses and weather.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for air masses and weather, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for air masses and weather works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of air masses and weather, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking air masses and weather mastered.
...
_Package `swp-ma-g7-science-u07-l08` · built from `canonical-1.0.0` at `4056e31`._
