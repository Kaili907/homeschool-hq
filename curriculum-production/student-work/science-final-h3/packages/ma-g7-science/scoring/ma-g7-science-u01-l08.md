# Scoring authority — Reteach and varied practice: pure substances and mixtures

**Grade 7 Science** · Unit 1: Matter, Particles, and Properties · Day 8 · lesson `ma-g7-science-u01-l08`
...
_Topic `ma-g7-science-u01::pure substances and mixtures` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._
...
- A pure substance, whether an element or a compound, has a fixed composition and a characteristic set of properties.
- A mixture contains two or more substances in no fixed ratio, and each keeps its own properties.
- Mixtures are separated by physical means; the components of a compound are separated only by chemical change.

**Also correct.** Accept any of these framings — do not require the wording above:

- Homogeneous and heterogeneous, or uniform and non-uniform, are both acceptable ways to sort mixtures.
...
- Classifying a compound as a mixture because it contains more than one element.
- Claiming a solution is a pure substance because it looks uniform.
- Claiming a mixture has a fixed composition.

**Grade boundary.** Chromatographic and distillation theory, and phase diagrams, are High School work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for pure substances and mixtures, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of pure substances and mixtures.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about pure substances and mixtures using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for pure substances and mixtures, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of pure substances and mixtures.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for pure substances and mixtures, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of pure substances and mixtures.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for pure substances and mixtures, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for pure substances and mixtures works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of pure substances and mixtures, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking pure substances and mixtures mastered.
...
_Package `swp-ma-g7-science-u01-l08` · built from `canonical-1.0.0` at `4056e31`._
