# Scoring authority — Synthesis and review: stimulus and response

**Grade 7 Science** · Unit 5: Body Systems, Senses, and Responses · Day 10 · lesson `ma-g7-science-u05-l10`
...
_Topic `ma-g7-science-u05::stimulus and response` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A response follows a stimulus through a pathway of detection, processing, and action.
- The same stimulus can produce different responses in different circumstances, because processing takes context into account.
- Some responses are immediate and involuntary; others involve deliberate processing and take longer.
...
- Claiming every response to a stimulus is identical regardless of context.
- Describing a response with no stimulus identified.
- Claiming involuntary responses involve no signalling at all.

**Grade boundary.** Reflex arc anatomy and conditioning theory are later work.


## What a complete response contains, question by question

**Q1 — connect unit.** _Serves objective 1:_ Connect stimulus and response to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of stimulus and response.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about stimulus and response using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Connect stimulus and response to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of stimulus and response.
...
**Q6 — limitation.** _Serves objective 1:_ Connect stimulus and response to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of stimulus and response.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for stimulus and response, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for stimulus and response works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of stimulus and response, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking stimulus and response mastered.
...
_Package `swp-ma-g7-science-u05-l10` · built from `canonical-1.0.0` at `4056e31`._
