# Scoring authority — Investigation or close reading: system interactions

**Grade 7 Science** · Unit 5: Body Systems, Senses, and Responses · Day 7 · lesson `ma-g7-science-u05-l07`
...
_Topic `ma-g7-science-u05::system interactions` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Body systems interact: the digestive, circulatory, respiratory, excretory, nervous, and musculoskeletal systems each depend on the others.
- A substance taken in by one system is distributed by another and used or removed by a third.
- Because the systems are coupled, a change in one produces changes in others.
...
- Claiming each body system works independently.
- Tracing a substance through the body while skipping the system that actually transports it.
- Claiming an effect on one system leaves the others unchanged.

**Grade boundary.** Organ physiology in detail and quantitative modelling are High School work.
...
**Q1 — analyze evidence.** _Serves objective 1:_ Gather and analyze evidence related to system interactions, then record a defensible interpretation.
...
**Q4 — essential question.** _Serves objective 1:_ Gather and analyze evidence related to system interactions, then record a defensible interpretation.
...
**Q5 — evidence quality.** _Serves objective 1:_ Gather and analyze evidence related to system interactions, then record a defensible interpretation.
...
**Q6 — limitation.** _Serves objective 1:_ Gather and analyze evidence related to system interactions, then record a defensible interpretation.
...
**Q7 — provenance.** _Serves objective 1:_ Gather and analyze evidence related to system interactions, then record a defensible interpretation.
...
_Package `swp-ma-g7-science-u05-l07` · built from `canonical-1.0.0` at `4056e31`._
