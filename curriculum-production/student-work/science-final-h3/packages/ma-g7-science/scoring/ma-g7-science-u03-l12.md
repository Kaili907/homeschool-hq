# Scoring authority — Correction and reflection: device efficiency

**Grade 7 Science** · Unit 3: Thermal Energy and Energy Transfer · Day 12 · lesson `ma-g7-science-u03-l12`
...
_Topic `ma-g7-science-u03::device efficiency` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- No device converts all of its energy input into the useful output.

**Accepted relationships and models.** What this lesson's learning target asserts:

- A device's useful output is always less than its energy input, because some energy is transferred to the surroundings, usually as warming.
- Improving efficiency means reducing the unwanted transfers, not eliminating them.
- Efficiency claims are judged against measurements of input and useful output, not against the design intent.
...
- Claiming a device is or could be one hundred per cent efficient.
- Claiming a device produces more energy than it receives.
- Reporting an efficiency without saying what was measured as input and as useful output.

**Grade boundary.** Efficiency as a calculated percentage is acceptable but not required; the second law and Carnot limits are High School work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for device efficiency, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of device efficiency.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about device efficiency using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for device efficiency, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of device efficiency.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for device efficiency, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of device efficiency.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for device efficiency, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for device efficiency works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of device efficiency, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking device efficiency mastered.
...
_Package `swp-ma-g7-science-u03-l12` · built from `canonical-1.0.0` at `4056e31`._
