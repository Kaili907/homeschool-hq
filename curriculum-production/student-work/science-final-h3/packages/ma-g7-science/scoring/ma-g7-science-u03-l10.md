# Scoring authority — Synthesis and review: mass material and temperature change

**Grade 7 Science** · Unit 3: Thermal Energy and Energy Transfer · Day 10 · lesson `ma-g7-science-u03-l10`
...
_Topic `ma-g7-science-u03::mass material and temperature change` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- For the same energy input, a larger mass of the same material changes temperature less than a smaller mass.
- Different materials require different amounts of energy to change the temperature of the same mass by the same amount.
- Comparing materials fairly requires the same mass, the same energy input, and the same starting temperature.

**Also correct.** Accept any of these framings — do not require the wording above:

- Naming this property specific heat capacity is correct but not required at this grade.
...
- Claiming equal energy input produces equal temperature change regardless of mass.
- Claiming all materials respond identically to the same energy input.
- Comparing materials tested at different masses or starting temperatures without saying so.

**Grade boundary.** The specific heat equation and calorimetry calculations are High School work.


## What a complete response contains, question by question

**Q1 — connect unit.** _Serves objective 1:_ Connect mass material and temperature change to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of mass material and temperature change.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about mass material and temperature change using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Connect mass material and temperature change to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of mass material and temperature change.
...
**Q6 — limitation.** _Serves objective 1:_ Connect mass material and temperature change to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of mass material and temperature change.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for mass material and temperature change, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for mass material and temperature change works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of mass material and temperature change, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking mass material and temperature change mastered.
...
_Package `swp-ma-g7-science-u03-l10` · built from `canonical-1.0.0` at `4056e31`._
