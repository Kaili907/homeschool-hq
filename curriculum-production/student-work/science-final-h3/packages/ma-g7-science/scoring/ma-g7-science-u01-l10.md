# Scoring authority — Synthesis and review: synthetic materials

**Grade 7 Science** · Unit 1: Matter, Particles, and Properties · Day 10 · lesson `ma-g7-science-u01-l10`
...
_Topic `ma-g7-science-u01::synthetic materials` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Synthetic materials are made by processing natural resources so that new substances with new properties are produced.
- The properties of a synthetic material come from its composition and structure, which is why they can be designed for a purpose.
- Every synthetic material carries costs as well as benefits, in resources used, energy required, and what happens at the end of its life.

**Also correct.** Accept any of these framings — do not require the wording above:

- Plastics, alloys, synthetic fibres, and engineered ceramics are all correct examples.
...
- Claiming synthetic materials are not made from natural resources.
- Claiming synthetic means harmful and natural means safe.
- Claiming a material's properties can be chosen independently of its structure.

**Grade boundary.** Polymerisation chemistry and materials-science structure-property theory are High School work.


## What a complete response contains, question by question

**Q1 — connect unit.** _Serves objective 1:_ Connect synthetic materials to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of synthetic materials.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about synthetic materials using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Connect synthetic materials to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of synthetic materials.
...
**Q6 — limitation.** _Serves objective 1:_ Connect synthetic materials to the unit’s other ideas and select evidence that shows readiness for assessment.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of synthetic materials.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for synthetic materials, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for synthetic materials works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of synthetic materials, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking synthetic materials mastered.
...
_Package `swp-ma-g7-science-u01-l10` · built from `canonical-1.0.0` at `4056e31`._
