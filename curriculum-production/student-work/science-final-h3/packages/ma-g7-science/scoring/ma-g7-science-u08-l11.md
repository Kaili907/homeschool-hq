# Scoring authority — Unit assessment: climate evidence

**Grade 7 Science** · Unit 8: Natural Hazards and Human Impacts · Day 11 · lesson `ma-g7-science-u08-l11`
...
_Topic `ma-g7-science-u08::climate evidence` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Global average surface temperature has risen since the late nineteenth century, and the increase in atmospheric carbon dioxide from burning fossil fuels is the principal cause.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Evidence for climate change comes from many independent lines: instrument records, ice cores, sea level, glacier extent, and the timing of biological events.
- Independent lines of evidence agreeing is what makes the conclusion robust; no single record carries it alone.
- Climate change is a change in long-term patterns, so it is established from decades of record, not from individual seasons.

**Also correct.** Accept any of these framings — do not require the wording above:

- Describing the cause as greenhouse gases from human activity, or specifically as carbon dioxide from burning fossil fuels, are both correct.
...
- Citing one cold season as evidence against long-term warming.
- Claiming the observed warming has no established cause.
- Confusing the greenhouse effect, which is a natural and necessary process, with the enhanced effect caused by added greenhouse gases.

**Grade boundary.** Radiative forcing calculations, climate sensitivity, and attribution methodology are High School work.


## What a complete response contains, question by question

**Q1 — demonstrate mastery.** _Serves objective 1:_ Demonstrate current mastery of climate evidence through selected-response, constructed-response, and applied evidence.
...
**Q4 — essential question.** _Serves objective 1:_ Demonstrate current mastery of climate evidence through selected-response, constructed-response, and applied evidence.
...
**Q6 — limitation.** _Serves objective 1:_ Demonstrate current mastery of climate evidence through selected-response, constructed-response, and applied evidence.
...
_Package `swp-ma-g7-science-u08-l11` · built from `canonical-1.0.0` at `4056e31`._
