# Scoring authority — Performance task build: energy transfer

**Grade 7 Science** · Unit 3: Thermal Energy and Energy Transfer · Day 9 · lesson `ma-g7-science-u03-l09`
...
_Topic `ma-g7-science-u03::energy transfer` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Thermal energy is transferred spontaneously from the higher-temperature object to the lower-temperature one.

**Accepted relationships and models.** What this lesson's learning target asserts:

- When objects at different temperatures interact, energy is transferred from the warmer to the cooler until they reach the same temperature.
- The transfer is one-directional on its own; energy does not move spontaneously from cooler to warmer.
- Total energy is conserved during the transfer: what one object loses, the other and the surroundings gain.
...
- Claiming cold flows from the cooler object into the warmer one.
- Claiming energy is lost rather than transferred to the surroundings.
- Claiming a warmer object can spontaneously take energy from a cooler one.

**Grade boundary.** The second law stated formally, entropy, and refrigeration cycles are High School work.
...
**Q1 — build product.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies energy transfer and the unit standards.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of energy transfer.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about energy transfer using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies energy transfer and the unit standards.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of energy transfer.
...
**Q6 — limitation.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies energy transfer and the unit standards.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of energy transfer.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for energy transfer, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for energy transfer works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of energy transfer, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking energy transfer mastered.
...
_Package `swp-ma-g7-science-u03-l09` · built from `canonical-1.0.0` at `4056e31`._
