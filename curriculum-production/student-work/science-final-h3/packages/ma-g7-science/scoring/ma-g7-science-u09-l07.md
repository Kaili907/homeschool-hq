# Scoring authority — Investigation or close reading: defining criteria and constraints

**Grade 7 Science** · Unit 9: Engineering Design Capstone · Day 7 · lesson `ma-g7-science-u09-l07`
...
_Topic `ma-g7-science-u09::defining criteria and constraints` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A well-defined problem states criteria that can be measured and constraints that can be checked.
- The definition comes before solution generation, so that all candidates are judged the same way.
- Constraints include safety, cost, time, materials, and law, and none of them is traded away for performance.
...
- Writing a criterion that no test could evaluate.
- Generating solutions before the problem is defined and then fitting criteria to the favourite.
- Treating a safety constraint as negotiable.

**Grade boundary.** Formal requirements engineering is later work.
...
**Q1 — analyze evidence.** _Serves objective 1:_ Gather and analyze evidence related to defining criteria and constraints, then record a defensible interpretation.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of defining criteria and constraints.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about defining criteria and constraints using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Gather and analyze evidence related to defining criteria and constraints, then record a defensible interpretation.
...
**Q5 — evidence quality.** _Serves objective 1:_ Gather and analyze evidence related to defining criteria and constraints, then record a defensible interpretation.
...
**Q6 — limitation.** _Serves objective 1:_ Gather and analyze evidence related to defining criteria and constraints, then record a defensible interpretation.
...
**Q7 — provenance.** _Serves objective 1:_ Gather and analyze evidence related to defining criteria and constraints, then record a defensible interpretation.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for defining criteria and constraints, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for defining criteria and constraints works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of defining criteria and constraints, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking defining criteria and constraints mastered.
...
_Package `swp-ma-g7-science-u09-l07` · built from `canonical-1.0.0` at `4056e31`._
