...
**Grade 7 Science** · Unit 6: Ecosystem Interactions and Dynamics · Day 10 · lesson `ma-g7-science-u06-l10`
...
_Topic `ma-g7-science-u06::food webs` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A food web shows feeding relationships, with arrows running from the organism that is eaten to the organism that eats it.
- Because organisms appear in several chains, a change to one population can affect populations several links away.
- Producers form the base of every web, and decomposers act on organisms at every level.
...
- Drawing food-web arrows from predator to prey.
- Claiming the effect of removing a species is confined to its direct neighbours in the web.
- Omitting producers or decomposers and calling the web complete.

**Grade boundary.** Quantitative network analysis and trophic cascade modelling are High School work.
...
_Package `swp-ma-g7-science-u06-l10` · built from `canonical-1.0.0` at `4056e31`._
