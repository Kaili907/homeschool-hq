# Scoring authority — Correction and reflection: structure and function

**Grade 7 Science** · Unit 4: Cells and Organism Organization · Day 12 · lesson `ma-g7-science-u04-l12`
...
_Topic `ma-g7-science-u04::structure and function` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A cell's shape and contents relate to what it does, which is why nerve, muscle, and root-hair cells look so different.
- Specialisation trades generality for capability: a specialised cell does one job well and depends on others for the rest.
- Inferring function from structure is a hypothesis that must then be checked against evidence.
...
- Claiming a cell developed a structure because the organism needed it.
- Asserting a function from appearance alone with no supporting evidence.
- Claiming specialised cells can carry out every function independently.

**Grade boundary.** Gene regulation of differentiation is High School work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for structure and function, then demonstrate corrected understanding.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for structure and function, then demonstrate corrected understanding.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for structure and function, then demonstrate corrected understanding.
...
_Package `swp-ma-g7-science-u04-l12` · built from `canonical-1.0.0` at `4056e31`._
