# Scoring authority — Performance task build: conservation of atoms

**Grade 7 Science** · Unit 2: Chemical Reactions and Conservation · Day 9 · lesson `ma-g7-science-u02-l09`
...
_Topic `ma-g7-science-u02::conservation of atoms` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- The number of atoms of each element is the same before and after a chemical reaction, so the total mass is unchanged.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Atoms are neither created nor destroyed in a chemical reaction; they are rearranged.
- Because the atoms are conserved, the total mass of the system is the same before and after.
- An apparent mass change in an open container means matter crossed the boundary, most often as a gas.

**Also correct.** Accept any of these framings — do not require the wording above:

- Conservation of mass and conservation of atoms are two statements of the same principle at this grade.
...
- Claiming mass is lost when a substance burns, without accounting for gases released or oxygen consumed.
- Claiming atoms of one element convert into another element in a chemical reaction.
- Concluding conservation of mass fails from an open-system measurement.

**Grade boundary.** Nuclear reactions, where element identity does change, and mass-energy equivalence are High School work.
...
**Q1 — build product.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies conservation of atoms and the unit standards.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of conservation of atoms.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about conservation of atoms using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies conservation of atoms and the unit standards.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of conservation of atoms.
...
**Q6 — limitation.** _Serves objective 1:_ Create, test, or revise a meaningful product that applies conservation of atoms and the unit standards.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of conservation of atoms.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for conservation of atoms, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for conservation of atoms works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of conservation of atoms, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking conservation of atoms mastered.
...
_Package `swp-ma-g7-science-u02-l09` · built from `canonical-1.0.0` at `4056e31`._
