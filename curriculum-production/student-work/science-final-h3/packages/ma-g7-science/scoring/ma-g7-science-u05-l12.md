# Scoring authority — Correction and reflection: modeling body-system coordination

**Grade 7 Science** · Unit 5: Body Systems, Senses, and Responses · Day 12 · lesson `ma-g7-science-u05-l12`
...
_Topic `ma-g7-science-u05::modeling body-system coordination` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- A model of coordination shows the systems involved, what passes between them, and in which direction.
- The model has to include the detection step and the response step, or it cannot explain regulation.
- A model is judged on whether it explains the coordination, not on how many parts it includes.

**Also correct.** Accept any of these framings — do not require the wording above:

- Flow diagrams, labelled body diagrams, and written sequences are all valid model forms.
...
- Building a coordination model with no feedback path from response back to condition.
- Showing systems connected with no statement of what passes between them.
- Claiming the model represents the body completely.

**Grade boundary.** Computational physiological modelling is later work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for modeling body-system coordination, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of modeling body-system coordination.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about modeling body-system coordination using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for modeling body-system coordination, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of modeling body-system coordination.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for modeling body-system coordination, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of modeling body-system coordination.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for modeling body-system coordination, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for modeling body-system coordination works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of modeling body-system coordination, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking modeling body-system coordination mastered.
...
_Package `swp-ma-g7-science-u05-l12` · built from `canonical-1.0.0` at `4056e31`._
