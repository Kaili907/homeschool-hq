# Scoring authority — Launch and diagnostic: system interactions

**Grade 7 Science** · Unit 5: Body Systems, Senses, and Responses · Day 1 · lesson `ma-g7-science-u05-l01`
...
_Topic `ma-g7-science-u05::system interactions` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._
...
**Q1 — activate prior.** _Serves objective 1:_ Activate prior knowledge about system interactions, surface initial thinking without penalty, and establish the unit question.
...
**Q4 — essential question.** _Serves objective 1:_ Activate prior knowledge about system interactions, surface initial thinking without penalty, and establish the unit question.
...
**Q6 — limitation.** _Serves objective 1:_ Activate prior knowledge about system interactions, surface initial thinking without penalty, and establish the unit question.
...
_Package `swp-ma-g7-science-u05-l01` · built from `canonical-1.0.0` at `4056e31`._
