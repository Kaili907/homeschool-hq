# Scoring authority — Reteach and varied practice: competition and predation

**Grade 7 Science** · Unit 6: Ecosystem Interactions and Dynamics · Day 8 · lesson `ma-g7-science-u06-l08`
...
_Topic `ma-g7-science-u06::competition and predation` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Competition occurs when organisms use the same limited resource, whether they are of the same species or different ones.
- Predation transfers matter and energy from prey to predator and affects the population sizes of both.
- Predator and prey populations influence each other, so a change in one produces a change in the other, usually after a delay.
...
- Claiming competition only occurs between different species.
- Claiming predators eliminate their prey populations entirely as the normal outcome.
- Claiming predator and prey populations change simultaneously with no delay.

**Grade boundary.** Lotka-Volterra models and competitive exclusion by name are High School work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for competition and predation, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of competition and predation.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about competition and predation using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for competition and predation, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of competition and predation.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for competition and predation, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of competition and predation.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for competition and predation, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for competition and predation works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of competition and predation, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking competition and predation mastered.
...
_Package `swp-ma-g7-science-u06-l08` · built from `canonical-1.0.0` at `4056e31`._
