# Scoring authority — Correction and reflection: ecosystem change

**Grade 7 Science** · Unit 6: Ecosystem Interactions and Dynamics · Day 12 · lesson `ma-g7-science-u06-l12`
...
_Topic `ma-g7-science-u06::ecosystem change` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Ecosystems change over time through natural processes and through disturbance such as fire, flood, disease, and human activity.
- After a disturbance, the community that returns may differ from the one before it.
- An ecosystem's ability to recover depends on the severity of the disturbance and on what survives it.

**Also correct.** Accept any of these framings — do not require the wording above:

- Naming the process succession is correct but not required at this grade.
...
- Claiming an undisturbed ecosystem stays permanently unchanged.
- Claiming an ecosystem always returns to exactly its previous state after disturbance.
- Claiming all disturbance is damaging; some species and communities depend on it.

**Grade boundary.** Resilience metrics and succession modelling are High School work.


## What a complete response contains, question by question

**Q1 — error analysis.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for ecosystem change, then demonstrate corrected understanding.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of ecosystem change.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about ecosystem change using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for ecosystem change, then demonstrate corrected understanding.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of ecosystem change.
...
**Q6 — limitation.** _Serves objective 1:_ Use error evidence to choose a different representation or strategy for ecosystem change, then demonstrate corrected understanding.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of ecosystem change.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for ecosystem change, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for ecosystem change works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of ecosystem change, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking ecosystem change mastered.
...
_Package `swp-ma-g7-science-u06-l12` · built from `canonical-1.0.0` at `4056e31`._
