# Scoring authority — Investigation or close reading: hazard mapping

**Grade 7 Science** · Unit 8: Natural Hazards and Human Impacts · Day 7 · lesson `ma-g7-science-u08-l07`
...
_Topic `ma-g7-science-u08::hazard mapping` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `INVESTIGATION_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Natural hazards occur in patterns tied to geology, geography, and climate, so where they are likely can be mapped.
- A hazard map shows likelihood and, usually, severity; it does not predict a particular event on a particular day.
- Maps are built from historical records and physical understanding, and both have limits that belong in the reading.
...
- Reading a hazard map as a prediction of when an event will occur.
- Claiming an area with no recorded event has no hazard.
- Claiming hazards occur completely at random with no mappable pattern.

**Grade boundary.** Return-period statistics and probabilistic hazard analysis are High School work.
...
**Q1 — analyze evidence.** _Serves objective 1:_ Gather and analyze evidence related to hazard mapping, then record a defensible interpretation.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of hazard mapping.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about hazard mapping using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Gather and analyze evidence related to hazard mapping, then record a defensible interpretation.
...
**Q5 — evidence quality.** _Serves objective 1:_ Gather and analyze evidence related to hazard mapping, then record a defensible interpretation.
...
**Q6 — limitation.** _Serves objective 1:_ Gather and analyze evidence related to hazard mapping, then record a defensible interpretation.
...
**Q7 — provenance.** _Serves objective 1:_ Gather and analyze evidence related to hazard mapping, then record a defensible interpretation.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for hazard mapping, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for hazard mapping works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of hazard mapping, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking hazard mapping mastered.
...
_Package `swp-ma-g7-science-u08-l07` · built from `canonical-1.0.0` at `4056e31`._
