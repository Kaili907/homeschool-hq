# Scoring authority — Guided practice A: mutualism

**Grade 7 Science** · Unit 6: Ecosystem Interactions and Dynamics · Day 3 · lesson `ma-g7-science-u06-l03`
...
_Topic `ma-g7-science-u06::mutualism` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._
...
**Q1 — guided practice.** _Serves objective 1:_ Practice mutualism with prompts, feedback, and gradually reduced support.
...
**Q4 — essential question.** _Serves objective 1:_ Practice mutualism with prompts, feedback, and gradually reduced support.
...
**Q6 — limitation.** _Serves objective 1:_ Practice mutualism with prompts, feedback, and gradually reduced support.
...
_Package `swp-ma-g7-science-u06-l03` · built from `canonical-1.0.0` at `4056e31`._
