# Scoring authority — Unit assessment: homeostasis concept

**Grade 7 Science** · Unit 5: Body Systems, Senses, and Responses · Day 11 · lesson `ma-g7-science-u05-l11`
...
_Topic `ma-g7-science-u05::homeostasis concept` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._

**Fixed for this topic.** These are settled, and work that contradicts one is `Not yet` on Scientific correctness:

- Homeostasis is the maintenance of internal conditions within a range, not at a single fixed value.

**Accepted relationships and models.** What this lesson's learning target asserts:

- Organisms maintain internal conditions such as temperature, water balance, and blood sugar within a workable range.
- Maintenance requires detecting a departure from the range and acting to reverse it, which is a feedback process.
- Internal conditions fluctuate within the range; homeostasis is regulation, not constancy.

**Also correct.** Accept any of these framings — do not require the wording above:

- Describing the mechanism as negative feedback is correct, and describing it in plain terms as detecting and correcting is equally correct here.
...
- Claiming internal conditions are held perfectly constant.
- Claiming homeostasis happens without any detection of the change.
- Claiming a departure from the range is corrected by a process that pushes it further in the same direction.

**Grade boundary.** Endocrine signalling detail and quantitative feedback modelling are High School work.


## What a complete response contains, question by question

**Q1 — demonstrate mastery.** _Serves objective 1:_ Demonstrate current mastery of homeostasis concept through selected-response, constructed-response, and applied evidence.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of homeostasis concept.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about homeostasis concept using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Demonstrate current mastery of homeostasis concept through selected-response, constructed-response, and applied evidence.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of homeostasis concept.
...
**Q6 — limitation.** _Serves objective 1:_ Demonstrate current mastery of homeostasis concept through selected-response, constructed-response, and applied evidence.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of homeostasis concept.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for homeostasis concept, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for homeostasis concept works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of homeostasis concept, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking homeostasis concept mastered.
...
_Package `swp-ma-g7-science-u05-l11` · built from `canonical-1.0.0` at `4056e31`._
