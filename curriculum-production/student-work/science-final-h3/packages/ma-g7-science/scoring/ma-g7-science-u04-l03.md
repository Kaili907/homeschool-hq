# Scoring authority — Guided practice A: unicellular and multicellular organisms

**Grade 7 Science** · Unit 4: Cells and Organism Organization · Day 3 · lesson `ma-g7-science-u04-l03`
...
_Topic `ma-g7-science-u04::unicellular and multicellular organisms` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._
...
**Q1 — guided practice.** _Serves objective 1:_ Practice unicellular and multicellular organisms with prompts, feedback, and gradually reduced support.
...
**Q4 — essential question.** _Serves objective 1:_ Practice unicellular and multicellular organisms with prompts, feedback, and gradually reduced support.
...
**Q6 — limitation.** _Serves objective 1:_ Practice unicellular and multicellular organisms with prompts, feedback, and gradually reduced support.
...
_Package `swp-ma-g7-science-u04-l03` · built from `canonical-1.0.0` at `4056e31`._
