# Scoring authority — Guided practice A: ocean and atmospheric circulation

**Grade 7 Science** · Unit 7: Weather, Climate, and Earth Systems · Day 3 · lesson `ma-g7-science-u07-l03`
...
_Topic `ma-g7-science-u07::ocean and atmospheric circulation` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `FIXED_FACTUAL`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._
...
**Q1 — guided practice.** _Serves objective 1:_ Practice ocean and atmospheric circulation with prompts, feedback, and gradually reduced support.
...
**Q4 — essential question.** _Serves objective 1:_ Practice ocean and atmospheric circulation with prompts, feedback, and gradually reduced support.
...
**Q6 — limitation.** _Serves objective 1:_ Practice ocean and atmospheric circulation with prompts, feedback, and gradually reduced support.
...
_Package `swp-ma-g7-science-u07-l03` · built from `canonical-1.0.0` at `4056e31`._
