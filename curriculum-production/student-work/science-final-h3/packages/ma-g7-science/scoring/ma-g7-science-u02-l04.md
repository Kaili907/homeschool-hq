# Scoring authority — Independent application A: thermal changes

**Grade 7 Science** · Unit 2: Chemical Reactions and Conservation · Day 4 · lesson `ma-g7-science-u02-l04`
...
**Q1 — apply independent.** _Serves objective 1:_ Apply thermal changes independently in a new representation, text, situation, or design constraint.
...
**Q4 — essential question.** _Serves objective 1:_ Apply thermal changes independently in a new representation, text, situation, or design constraint.
...
**Q6 — limitation.** _Serves objective 1:_ Apply thermal changes independently in a new representation, text, situation, or design constraint.
...
_Package `swp-ma-g7-science-u02-l04` · built from `canonical-1.0.0` at `4056e31`._
