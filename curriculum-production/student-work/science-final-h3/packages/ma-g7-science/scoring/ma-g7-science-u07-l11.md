# Scoring authority — Unit assessment: weather maps

**Grade 7 Science** · Unit 7: Weather, Climate, and Earth Systems · Day 11 · lesson `ma-g7-science-u07-l11`
...
_Topic `ma-g7-science-u07::weather maps` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Weather maps show measured conditions and analysed features such as fronts, pressure centres, and precipitation, each with its own symbol.
- A map is a snapshot with a stated time; reading a forecast from it requires knowing how the features move.
- Air moves from higher pressure toward lower pressure, which is why pressure patterns indicate wind.
...
- Reading a weather map with no time stamp as showing current conditions.
- Claiming air moves from low pressure toward high pressure.
- Treating a map symbol as a measurement rather than as an analysed feature.

**Grade boundary.** Isobar spacing and geostrophic wind calculation are High School work.


## What a complete response contains, question by question

**Q1 — demonstrate mastery.** _Serves objective 1:_ Demonstrate current mastery of weather maps through selected-response, constructed-response, and applied evidence.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of weather maps.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about weather maps using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Demonstrate current mastery of weather maps through selected-response, constructed-response, and applied evidence.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of weather maps.
...
**Q6 — limitation.** _Serves objective 1:_ Demonstrate current mastery of weather maps through selected-response, constructed-response, and applied evidence.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of weather maps.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for weather maps, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for weather maps works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of weather maps, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking weather maps mastered.
...
_Package `swp-ma-g7-science-u07-l11` · built from `canonical-1.0.0` at `4056e31`._
