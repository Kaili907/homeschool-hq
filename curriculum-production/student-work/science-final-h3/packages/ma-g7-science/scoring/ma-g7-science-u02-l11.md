# Scoring authority — Unit assessment: reaction evidence

**Grade 7 Science** · Unit 2: Chemical Reactions and Conservation · Day 11 · lesson `ma-g7-science-u02-l11`
...
_Topic `ma-g7-science-u02::reaction evidence` · forms in force: `ACCEPTED_RELATIONSHIPS`, `EXPECTED_REASONING_CRITERIA`, `RUBRIC_CORRECTNESS_CONSTRAINT` · authored in `policy/correctness/ma-g7-science.correctness.json`._

**Accepted relationships and models.** What this lesson's learning target asserts:

- Evidence that a reaction occurred is a measured or observed change in properties, recorded before and after under the same conditions.
- A control, in which the suspected cause is absent, distinguishes the reaction from something else in the setup.
- The strength of the conclusion depends on how many independent signs point the same way.
...
- Concluding a reaction occurred from one ambiguous sign with no control.
- Reporting only the observations that support the expected conclusion.
- Comparing before and after under different conditions and attributing the difference to reaction.

**Grade boundary.** Analytical confirmation methods and quantitative yield are High School work.


## What a complete response contains, question by question

**Q1 — demonstrate mastery.** _Serves objective 1:_ Demonstrate current mastery of reaction evidence through selected-response, constructed-response, and applied evidence.
...
**Q2 — communicate representation.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of reaction evidence.
...
**Q3 — check revise.** _Serves objective 3:_ Check, revise, or improve work about reaction evidence using stated success criteria.
...
**Q4 — essential question.** _Serves objective 1:_ Demonstrate current mastery of reaction evidence through selected-response, constructed-response, and applied evidence.
...
**Q5 — evidence quality.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of reaction evidence.
...
**Q6 — limitation.** _Serves objective 1:_ Demonstrate current mastery of reaction evidence through selected-response, constructed-response, and applied evidence.
...
**Q7 — provenance.** _Serves objective 2:_ Use subject-appropriate evidence or representation to communicate understanding of reaction evidence.
...
- **prerequisite gap** — Return to the smallest prerequisite needed for reaction evidence, model it with a concrete or text-only representation, then retry one fresh item.
- **procedure without understanding** — Ask the learner to explain or represent why the process for reaction evidence works before continuing.
- **correct but low confidence** — Confirm the reasoning specifically, offer one varied example of reaction evidence, and avoid unnecessary remediation.
...
- **mastery evidence** — Require accurate independent application plus explanation on a later or different occasion before marking reaction evidence mastered.
...
_Package `swp-ma-g7-science-u02-l11` · built from `canonical-1.0.0` at `4056e31`._
