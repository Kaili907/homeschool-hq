 ...
 * read-only) against this branch's authored grade-12 corpus, projected
 * through gateProjection.ts. This is the "Run Production Quality Gate"
 * step: real gate code, real authored content, no fabricated pass/fail claim.
 */
describe('production-quality gate over the authored grade-12 batch corpus', () => {
