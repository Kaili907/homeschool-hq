...
export type CorpusStage = 'released' | 'authoring'
...
export interface CorpusEntry {
  ...
  /** Which root this entry was loaded from — distinguishes this batch's own authoring from the read-only R3 reference pair. */
  readonly origin: 'batch' | 'r3-reference'
}
