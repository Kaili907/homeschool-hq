# Grade 3 and Grade 4 Mathematics - Standards Map

**Jurisdiction:** Michigan  
**Status:** Locally authored curriculum aligned to published Michigan mathematics standards. Not a claim of state approval, accreditation, licensure, or automatic credit.

**Code format:** Codes are written without cluster letters (3.OA.1, not 3.OA.A.1), matching the Michigan K-12 Standards: Mathematics document and the Manuel Academy v1.0.0 Grade 5 mathematics course.

## Grade 3 (25 of 25 content standards covered)

- Grade 3 fractions are limited to denominators 2, 3, 4, 6, and 8.
- A range of algorithms may be used for base-ten computation.

Verified domain ceilings: 3.G ends at 2, 3.MD ends at 8, 3.NBT ends at 3, 3.NF ends at 3, 3.OA ends at 9. Codes beyond these do not exist and none are used.

| Code | Requirement | Units | Lessons | Independent-evidence lessons |
| --- | --- | --- | --- | --- |
| `3.G.1` | Understand that shapes in different categories may share attributes that define a larger category, such as quadrilaterals. | 10 | 9 | 1 |
| `3.G.2` | Partition shapes into parts with equal areas and express the area of each part as a unit fraction of the whole. | 5, 6, 10 | 8 | 3 |
...
Daily lessons carry the parent code, following the v1.0.0 convention. The sub-parts below are recorded so coverage can be inspected at finer grain.

| Sub-part | Requirement | Covered via |
| --- | --- | --- |
| `3.MD.5a` | Understand that a square with side length 1 unit has one square unit of area. | `3.MD.5` in unit(s) 9 |
| `3.MD.5b` | Understand that a plane figure covered by n unit squares without gaps or overlaps has an area of n square units. | `3.MD.5` in unit(s) 9 |
| `3.MD.7a` | Find the area of a rectangle by tiling it and show that the area is the same as multiplying the side lengths. | `3.MD.7` in unit(s) 9, 10 |
| `3.MD.7b` | Multiply side lengths to find areas of rectangles in real-world and mathematical problems. | `3.MD.7` in unit(s) 9, 10 |
| `3.MD.7c` | Use tiling to show that the area of a rectangle with side lengths a and b + c is a x b + a x c. | `3.MD.7` in unit(s) 9, 10 |
| `3.MD.7d` | Recognize area as additive and find areas of rectilinear figures by decomposing them into non-overlapping rectangles. | `3.MD.7` in unit(s) 9, 10 |
| `3.NF.2a` | Represent 1/b on a number line by partitioning the interval from 0 to 1 into b equal parts. | `3.NF.2` in unit(s) 5, 6 |
| `3.NF.2b` | Represent a/b on a number line by marking off a lengths of 1/b from 0. | `3.NF.2` in unit(s) 5, 6 |
| `3.NF.3a` | Understand two fractions as equivalent if they are the same size or the same point on a number line. | `3.NF.3` in unit(s) 6 |
| `3.NF.3b` | Recognize and generate simple equivalent fractions and explain why they are equivalent. | `3.NF.3` in unit(s) 6 |
| `3.NF.3c` | Express whole numbers as fractions and recognize fractions equivalent to whole numbers. | `3.NF.3` in unit(s) 6 |
| `3.NF.3d` | Compare two fractions with the same numerator or the same denominator and record the result with >, =, or <. | `3.NF.3` in unit(s) 6 |

### Standards for Mathematical Practice

| Code | Title | Lessons |
| --- | --- | --- |
| `MP.1` | Make sense of problems and persevere in solving them | 13 |
| `MP.3` | Construct viable arguments and critique the reasoning of others | 19 |
| `MP.4` | Model with mathematics | 18 |
| `MP.5` | Use appropriate tools strategically | 2 |
| `MP.6` | Attend to precision | 10 |
| `MP.7` | Look for and make use of structure | 3 |

## Grade 4 (28 of 28 content standards covered)
...
Verified domain ceilings: 4.G ends at 3, 4.MD ends at 7, 4.NBT ends at 6, 4.NF ends at 7, 4.OA ends at 5. Codes beyond these do not exist and none are used.
...
| `4.NF.5` | Express a fraction with denominator 10 as an equivalent fraction with denominator 100 and add fractions with denominators 10 and 100. | 8 | 6 | 1 |
...
| Sub-part | Requirement | Covered via |
| --- | --- | --- |
| `4.MD.5a` | Understand that an angle turning through 1/360 of a circle is called a one-degree angle. | `4.MD.5` in unit(s) 10 |
| `4.MD.5b` | Understand that an angle turning through n one-degree angles has a measure of n degrees. | `4.MD.5` in unit(s) 10 |
| `4.NF.3a` | Understand addition and subtraction of fractions as joining and separating parts referring to the same whole. | `4.NF.3` in unit(s) 7 |
| `4.NF.3b` | Decompose a fraction into a sum of fractions with the same denominator in more than one way. | `4.NF.3` in unit(s) 7 |
| `4.NF.3c` | Add and subtract mixed numbers with like denominators. | `4.NF.3` in unit(s) 7 |
| `4.NF.3d` | Solve word problems involving addition and subtraction of fractions with like denominators. | `4.NF.3` in unit(s) 7 |
| `4.NF.4a` | Understand a fraction a/b as a multiple of 1/b. | `4.NF.4` in unit(s) 7 |
| `4.NF.4b` | Understand a multiple of a/b as a multiple of 1/b and use this to multiply a fraction by a whole number. | `4.NF.4` in unit(s) 7 |
| `4.NF.4c` | Solve word problems involving multiplication of a fraction by a whole number. | `4.NF.4` in unit(s) 7 |

### Standards for Mathematical Practice

| Code | Title | Lessons |
| --- | --- | --- |
| `MP.1` | Make sense of problems and persevere in solving them | 11 |
| `MP.3` | Construct viable arguments and critique the reasoning of others | 19 |
| `MP.4` | Model with mathematics | 19 |
| `MP.5` | Use appropriate tools strategically | 2 |
| `MP.6` | Attend to precision | 3 |
| `MP.7` | Look for and make use of structure | 2 |

## Sources

| Source | URL | Role |
| --- | --- | --- |
| Michigan K-12 Standards: Mathematics (Michigan Department of Education) | https://www.michigan.gov/mde/-/media/Project/Websites/mde/Literacy/Content-Standards/Math_Standards.pdf | Source of record for every Grade 3 and Grade 4 code and paraphrase in this catalog. |
| Michigan Academic Standards (MDE service page) | https://www.michigan.gov/mde/services/academic-standards | Provenance page that links the mathematics standards document. |
| Michigan Mathematics Standards and Resources | https://www.michigan.gov/mde/services/academic-standards/mmc/curriculum/math | Cited by Manuel Academy v1.0.0; resolves, but the Academic Standards page is what actually serves the document. |

## Practice-code note

The MP.n prefix is a Manuel Academy package convention carried over from v1.0.0. The Michigan document numbers the Standards for Mathematical Practice 1-8 under that heading and does not print the string 'MP.1'. The practice titles are quoted from the document; the prefix is not.
