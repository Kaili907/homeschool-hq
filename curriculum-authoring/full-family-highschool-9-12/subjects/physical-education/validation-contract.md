...
| `transfer-evidence-authority` | All 216 second-pass lessons carry a valid `manuel-academy.pe-transfer-authority.v3` record for learner action, duration/continuity, rest authority, transfer, completion/evidence, equal credit, rubric, and adaptive/guardian expectations. Each record cryptographically binds the actual learner and adult authored fields; any prose-only drift fails without phrase matching. The 96 R1-repaired lessons retain their authored unit-evidence marker. |
