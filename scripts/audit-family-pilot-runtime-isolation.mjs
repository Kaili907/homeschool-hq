...
console.log(JSON.stringify({
  ...
  legacyEntry: legacyChunk?.fileName ?? null,
  legacyExcludedFromEnabledBuild: legacyChunk === null,
  legacyIsDynamicFromRoot: legacyChunk !== null && rootChunk.dynamicImports.includes(legacyChunk.fileName),
  familyIsDynamicFromRoot: rootChunk.dynamicImports.includes(familyChunk.fileName),
  familyImportsLegacyEntry: legacyChunk !== null && familyClosure.some((chunk) => chunk.fileName === legacyChunk.fileName),
