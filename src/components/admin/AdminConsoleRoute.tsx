...
export function AdminConsoleRoute() {
  ...
  return (
    ...
    >
        ...
        {!['learners', 'engines', 'costs', 'safety', 'curriculum', 'curriculum-studio', 'curriculum-validation', 'curriculum-standards-review', 'curriculum-preview', 'system-health', 'audit-log'].includes(section) && (
