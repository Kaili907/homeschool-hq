...
const projection: ProductionReadinessProjection = {
  ...
  status: 'BLOCKED',
  requiredSummary: { total: 16, ready: 15, blocking: 1 },
  domains: [
    ...
    { id: 'telemetry', label: 'Telemetry', status: 'READY', summary: 'Telemetry evidence.', checks: [check('telemetry.operational_aggregate', 'Operational aggregate', 'READY'), check('telemetry.provider_accounting', 'Provider accounting', 'READY')] },
    { id: 'curriculum', label: 'Curriculum', status: 'READY', summary: 'Curriculum evidence.', checks: [check('curriculum.release_registry', 'Release registry', 'READY'), check('curriculum.active_validation', 'Active validation', 'READY')] },
