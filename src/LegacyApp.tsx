...
import { leaveFamilyPilotPath } from './study/family-pilot/core/route'
import {
...
export default function LegacyApp({ initialScreen }: { initialScreen?: 'home' } = {}) {
  ...
  const [screen, setScreen] = useState<Screen>(() => {
    if (initialScreen === 'home' && loaded.state.activeProfileId) return { kind: 'home' }
