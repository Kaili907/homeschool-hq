...
import type {
  ParentCredentialAuthorizationEvidenceAuthority,
  ParentCredentialAuthorizationEvidenceReference,
...
export interface ParentCredentialOperationOptions extends CredentialOperationOptions {
  ...
  readonly authorizationEvidenceAuthority?: ParentCredentialAuthorizationEvidenceAuthority
...
/** Opaque selector for durable, issuer-signed, one-use reset evidence. */
export type ParentCredentialResetAuthorization =
  ParentCredentialAuthorizationEvidenceReference

/** Opaque selector for durable, issuer-signed, one-use recovery evidence. */
export type ParentCredentialRecoveryAuthorization =
  ParentCredentialAuthorizationEvidenceReference
