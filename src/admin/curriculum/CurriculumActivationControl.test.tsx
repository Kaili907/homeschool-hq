...
describe('Curriculum Activation & Rollback Admin surface', () => {
  it('shows current authority, revision, published candidates, history, and truthful controls', () => {
    ...
    expect(markup).toContain('PUBLISHED, NOT ACTIVE · ACTIVATION ELIGIBLE')
    expect(markup).toContain('PREVIOUSLY ACTIVE · ROLLBACK ELIGIBLE')
    expect(markup).toContain('PUBLISHED, NOT ACTIVE · ACTIVATION BLOCKED')
