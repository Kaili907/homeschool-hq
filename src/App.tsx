...
import { isScienceDirectorSamplePath } from './study/family-pilot/science-director-preview/route'
...
const ScienceDirectorSamplePreview = import.meta.env.DEV
  ? lazy(() => import('./study/family-pilot/science-director-preview/ScienceDirectorSamplePreview').then((module) => ({
      default: module.ScienceDirectorSamplePreview,
    })))
  : null
...
export default function App() {
  ...
  if (ScienceDirectorSamplePreview && isScienceDirectorSamplePath(window.location.pathname)) {
    return (
      <Suspense fallback={<main aria-busy="true">Loading the Science Director preview.</main>}>
        <ScienceDirectorSamplePreview />
      </Suspense>
    )
  }
