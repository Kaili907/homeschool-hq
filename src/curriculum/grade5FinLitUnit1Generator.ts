...
export const GRADE5_FIN_LIT_UNIT1_ITEM_DEFINITIONS: Record<Grade5FinLitUnit1ItemType, FinancialDefinition<Grade5FinLitUnit1ItemType>> = {
  'priority-budget-remainder': { itemType: 'priority-budget-remainder', standard: 'Michigan Personal Finance foundations', lessonFocus: 'needs wants and priorities', kind: 'subtract-two', workedExample: example('A plan has $12.00 and expenses of $3.00 and $2.00.', '$7.00') },
  'scarcity-tradeoff-cost': { itemType: 'scarcity-tradeoff-cost', standard: 'Grade 5 economics connections', lessonFocus: 'scarcity and tradeoffs', kind: 'subtract-two', workedExample: example('A plan has $10.00 and two chosen costs total $6.00.', '$4.00') },
  ...
  'decision-plan-remainder': { itemType: 'decision-plan-remainder', standard: 'Michigan Personal Finance foundations', lessonFocus: 'decision steps', kind: 'subtract-two', workedExample: example('A plan lists its starting amount and two fixed costs.', 'remaining amount') },
  'dignity-safe-budget': { itemType: 'dignity-safe-budget', standard: 'Michigan Personal Finance foundations', lessonFocus: 'family differences and dignity', kind: 'divide', workedExample: example('A fictional total is shared across equal items.', 'one equal share') },
}
