...
export interface FinalFamilyPilotHostProductionMaterial {
...
export type FinalFamilyPilotMaterialResolution =
  | { readonly status: 'ready'; readonly material: FinalFamilyPilotHostProductionMaterial }
...
export type FinalFamilyPilotHostSourceReadiness =
...
export interface FinalFamilyPilotSourceReadinessResolver {
  check(input: FinalFamilyPilotAssignmentBinding & { readonly lesson: HostLessonDescriptor }):
    | Promise<FinalFamilyPilotHostSourceReadiness>
...
export interface FinalFamilyPilotReadyStudy {
  ...
  readonly material: FinalFamilyPilotHostProductionMaterial
