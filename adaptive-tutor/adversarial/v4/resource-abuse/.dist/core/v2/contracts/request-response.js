...
import { GroundingAssessmentSchema, INSUFFICIENT_GROUNDED_CONTEXT, InsufficientGroundingAssessmentSchema, ProviderGroundingClaimSchema, } from "./grounding.js";
import { TutorBudgetRoutingContextSchema, TutorShortTermStateSchema, } from "./operations.js";
import { AssistanceLevelSchema, HintLevelSchema, OpaqueReferenceSchema, PolicyCodeSchema, } from "./primitives.js";
...
export const TutorRefusalOutcomeSchema = Type.Union([TutorInsufficientGroundingRefusalOutcomeSchema, TutorPolicyRefusalOutcomeSchema], { $id: "TutorV2RefusalOutcome" });
