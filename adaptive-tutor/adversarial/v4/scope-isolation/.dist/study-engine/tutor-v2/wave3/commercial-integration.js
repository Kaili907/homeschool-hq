...
import { CommercialExecutionScopeSchema, } from "../../../core/v3/commercial-operation/index.js";
...
function receiptMatchesCommercialScope(receipt, scope) {
    return (receipt.commercialExecutionScopeRef === scope.scopeRef &&
...
function deltaMatchesReceipt(delta, receipt) {
    return (delta.commercialExecutionScopeRef === receipt.commercialExecutionScopeRef &&
 ...
 */
export function recoverAcceptedCommercialEffect(receiptCandidate, advisoryCandidate, memoryDeltaCandidate, commercialExecutionScopeCandidate, coordinator) {
    const commercialScopeValidation = validateExact(CommercialExecutionScopeSchema, commercialExecutionScopeCandidate);
