...
const skillId = "english-complete-sentences";
...
export const englishTutorProgram = {
...
export const englishRuntimeHooks = {
    evidenceTagsFor: (item, input, evaluation) => {
        const selected = input.selectedOptionIds?.[0] ?? "no-selection";
        const tags = [evaluation.score === 1 ? "recognizes-independent-clause" : "sentence-boundary-uncertain", item.id];
        ...
        if (selected === "option-missing-predicate")
            tags.push("identifies-missing-predicate");
        return tags;
    },
...
//# sourceMappingURL=english-interaction.js.map