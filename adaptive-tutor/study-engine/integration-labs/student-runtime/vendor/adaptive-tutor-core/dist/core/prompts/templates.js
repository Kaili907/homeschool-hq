...
export const promptTemplates = [
    ...
    },
    {
        ...
        system: sharedTutorRules,
        userTemplate: "Teach {{concept}} using approved visual primitives {{visualPrimitives}}. Prior learner response: {{response}}. Give exactly one useful step, ask one participation question, and include a no-media text fallback.",
