...
function LearningScreen({
  ...
  return (
    <>
      ...
      />
      <section
        className="runtime-timer-row"
        aria-label="Session timing and completion"
      >
        <SessionTimer
            ...
            <form
              ...
              onSubmit={(event: FormEvent) => {
                ...
                if (feedback === "ready") {
                  ...
                  void submitCurrentResponse(workspace).then(onWorkspace);
                }
              }}
            >
              <ResponseControl
...
export default function App() {
  ...
  const runProbes = async () => {
    const results = await runAdversarialProbes();
    setProbes(results);
    setNotice(
