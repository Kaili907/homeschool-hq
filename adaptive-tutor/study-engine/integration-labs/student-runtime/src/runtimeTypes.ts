...
export interface TutorCoreBoundaryReceipt {
  readonly bridgeVersion: "student-runtime.session6-bridge.v2";
  ...
  readonly masteryAuthority: "withheld-pending-tutor-core";
  readonly misconceptionAuthority: "withheld-pending-tutor-core";
  readonly reasonCode:
