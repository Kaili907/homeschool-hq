...
/**
 * Card 5 DEC-018 is consumed for this adapter, but the missing Tutor Core
 * package still blocks production approval and final assembly.
 */
export const ROMEO_DEC_018_RECONCILIATION = {
  ...
  blockedProbe: "TC-P18",
  blocker:
    "Actual Tutor Core v0.2 support-reference resolution is unavailable.",
} as const;
