...
function advanceOpeningSegments(
...
describe("canonical contracts and integrated lifecycle", () => {
  ...
  it("runs the Grade 5 math cycle through a non-failure water break, evidence, review, and finish", () => {
    let workspace = advanceOpeningSegments("math");
    ...
    workspace = submitCurrentResponse(workspace, traceAt(44));
  ...
  it("runs the Grade 5 reading low-confidence save, refresh, and exact-resume path", () => {
    let workspace = advanceOpeningSegments("reading");
    const exactDraft =
    ...
    workspace = submitCurrentResponse(resumed, traceAt(43));
  ...
  it("records refresh loops as technical interruptions, never as learner breaks", () => {
