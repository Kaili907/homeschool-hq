      ...
      tutorCoreReceipts: [
        {
          ...
          eventId: `bridge:${base.canonicalSession.id}:${canonicalSegmentId("reading", "warm-up")}:1`,
          eventLedgerIdempotencyKey: "study-core-bridge:event:v1:test",
          ...
          directive: "continue",
          reasonCode: "tutor-core-continue",
          occurredAt: "2026-07-29T02:00:00.000Z",
          ledgerAccepted: true,
          outboxProposalCount: 0,
        },
      ],
    };
