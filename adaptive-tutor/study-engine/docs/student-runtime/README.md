...
- `src/bridges/acceptedStudyCoreBridge.ts`: accepted Session 6-R2 bridge
  orchestration with frozen Tutor Core v0.2 scoring and ledger receipts.
...
`SESSION-7-R2-STUDY-STUDENT-RUNTIME-FINAL.zip` preserves the
