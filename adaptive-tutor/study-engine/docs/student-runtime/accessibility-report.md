...
- Axe reported zero serious or critical violations in the scanned home,
...
- OS and in-app reduced motion stop nonessential computed animation.
...
- Missing media: instruction and read-aloud equivalent remain adjacent to the
  active response.
- Reduced motion: decorative animation stops without changing progress.
