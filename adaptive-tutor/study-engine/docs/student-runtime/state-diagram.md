...
stateDiagram-v2
    ...
    paused --> active: v2 envelope verified / session-resumed
...
5. A paused or break snapshot retains its exact segment and local draft
   reference; a v2 receipt must match that segment, draft, and submission
