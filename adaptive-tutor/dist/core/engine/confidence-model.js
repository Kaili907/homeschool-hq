...
export function estimateConfidence(skillId, observations) {
    ...
    let band;
    if (relevant.length < 3 || distinctContextCount < 2)
        band = "insufficient-evidence";
    else if (value >= 0.85 && uncertainty <= 0.3)
        band = "strong";
    else if (value >= 0.65)
        band = "developing";
    else if (value >= 0.4)
        ...
        band = "very-low";
    const explanation = band === "insufficient-evidence"
...
//# sourceMappingURL=confidence-model.js.map