...
export const evaluateAssessmentItem = (item, input) => {
    ...
    if (item.kind === "sequencing") {
        ...
        const isCorrect = ordered.length === item.correctOrder.length &&
    ...
    const normalize = (value) => {
        if (item.normalization === "numeric")
            return normalizeNumeric(value);
        if (item.normalization === "basic-text")
...
//# sourceMappingURL=assessment-evaluator.js.map