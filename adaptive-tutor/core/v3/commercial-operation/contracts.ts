...
export const COMMERCIAL_EXECUTION_SCOPE_VERSION =
  "study-tutor-v3.commercial-execution-scope.v1" as const;
...
export type CommercialExecutionScope = Static<typeof CommercialExecutionScopeSchema>;
