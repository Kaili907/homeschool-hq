...
export const STUDY_COMMERCIAL_TUTOR_INVOCATION_VERSION =
  "study-tutor-v3.commercial-invocation.v1" as const;
export const BOUNDED_COMMERCIAL_PROVIDER_RESPONSE_VERSION =
  "study-tutor-v3.bounded-provider-response.v1" as const;
...
export type StudyCommercialTutorInvocation = Static<
  typeof StudyCommercialTutorInvocationSchema
>;
...
export type BoundedCommercialProviderResponse = Static<
  typeof BoundedCommercialProviderResponseSchema
>;
...
const CommercialAdvisoryReasonCodeSchema = Type.Union(
  COMMERCIAL_ADVISORY_REASON_CODES.map((reason) => Type.Literal(reason)),
);
...
export type StudyCommercialTutorAdvisory = Static<
  typeof StudyCommercialTutorAdvisorySchema
>;
...
export type StudyCommercialEffectReceipt = Static<
  typeof StudyCommercialEffectReceiptSchema
>;
...
export type CommercialOperationTelemetryEnvelope = Static<
  typeof CommercialOperationTelemetryEnvelopeSchema
>;
