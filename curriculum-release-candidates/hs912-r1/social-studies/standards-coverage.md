# Standards Coverage Registry — social-studies
...
`curriculum-authoring/full-family-highschool-9-12/subjects/social-studies/`, which are copied verbatim into `source-docs/` beside this file.
...
| Class | Meaning | Count |
| --- | --- | --- |
| VERBATIM | the string occurs verbatim in the lane custody documents | 162 |
