...
export const COURSES = [
  {
    ...
    units: [
      ...
      },
      {
        ...
        secondPass: 'at activity speed against an opponent who is genuinely competing, where the decision has to be made before there is time to think it through',
        topics: [
      ...
      },
      {
        ...
        secondPass: 'in a scored rally, round, or innings where the score itself is the pressure and the routine has to hold anyway',
        topics: [
      ...
      },
      {
        ...
        secondPass: 'applied to the learner’s own real training week rather than to a worked example',
        topics: [
      ...
      },
      {
        ...
        secondPass: 'carried through a complete sequence run without stopping, where a lost count is recovered mid-phrase instead of restarting',
        topics: [
      ...
      },
      {
        ...
        secondPass: 'in a genuine trial session of the activity in the learner’s own setting, with their real access constraints applying',
        topics: [
      ...
      },
      {
        ...
        secondPass: 'on an outing the learner plans and leads through, where the weather, terrain, or timing does not cooperate',
        topics: [
      ...
      },
      {
        ...
        secondPass: 'inside a real activity with other people present, where the situation arises unplanned and has to be handled in the moment',
        topics: [
  ...
  },
  {
    ...
    units: [
      ...
      },
      {
        ...
        secondPass: 'across a full scored contest where selection and risk have to change as the score changes',
        topics: [
      ...
      },
      {
        ...
        secondPass: 'while actually leading a segment for other people, where a disagreement or a mixed-ability problem arises live',
        topics: [
  ...
  },
  {
    ...
    units: [
      ...
      },
      {
        ...
        secondPass: 'under a constraint-led practice the learner designs, then coached to another person who has to succeed with it',
        topics: [
      ...
      },
      {
        ...
        secondPass: 'on a planned outing with a real contingency triggered, where the plan changes without the activity becoming unsafe',
        topics: [
      ...
      },
      {
        ...
        secondPass: 'while running the event for real, evaluated by whether the least confident person present had a good time',
        topics: [
  ...
  },
  {
    ...
    units: [
      ...
      },
      {
        ...
        secondPass: 'run unsupervised across a full cycle, with the pre-committed rules honoured rather than renegotiated mid-cycle',
        topics: [
      ...
      },
      {
        ...
        secondPass: 'carried through an actual attempt at the goal, including a setback, and evaluated honestly afterwards',
        topics: [
      ...
      },
      {
        ...
        secondPass: 'facilitated live for a real group, adapted in the moment when the plan meets reality, and evaluated on inclusion',
        topics: [
      ...
      },
      {
        ...
        secondPass: 'practised as an unsupervised habit across a full training block, including one real stop decision',
        topics: [
