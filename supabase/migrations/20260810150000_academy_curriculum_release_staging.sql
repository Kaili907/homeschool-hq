...
-- Keep the filterable audit API aware of the staging action without widening
-- any authority or projection.
...
begin
  ...
  with bounded as (
    select event.* from academy_private.admin_audit_events as event
